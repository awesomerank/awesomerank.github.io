...
<p align="center">
	This list is a copy of <a href="https://github.com/sergeyklay/awesome-phalcon">https://github.com/sergeyklay/awesome-phalcon</a> with ranks
</p>
---
# Awesome Phalcon
...
* [Base App ★68 ⏳1Y](https://github.com/mruz/base-app) - The base application in Phalcon PHP Framework
* [INVO Application ★280](https://github.com/phalcon/invo) - Sample application for the Phalcon PHP Framework
* [Lightning ★24 ⏳1Y](https://github.com/zxz054321/lightning) - Lightning is a high performance framework with elegant syntax that sits on top of Phalcon.
* [MVC ★529](https://github.com/phalcon/mvc) - Examples of Phalcon MVC file structures
* [nest ★6 ⏳3Y](https://github.com/nexik/nest) - Phalcon SOLID Bootstrap for Rapid Application Development
* [phalanx ★18 ⏳3Y](https://github.com/Swader/phalanx) - A starter app with Phalcon PHP Framework and Angular
* [Phalcon Boilerplate ★73 ⏳1Y](https://github.com/mikegioia/phalcon-boilerplate) - Template for building large-scale Phalcon Applications
...
* [PhalconPHP-Setup-Example ★13 ⏳2Y](https://github.com/ewartx/PhalconPHP-Setup-Example) - Phalcon PHP Framework + Grunt + Composer + Bower
...
* [blog ★29 ⏳1Y](https://github.com/duythien/blog) - Blog project with multi-lingual support
...
* [Talon ★8 ⏳2Y](https://github.com/adamdama/Talon) - CMS built on Phalcon PHP Framework
...
* [phalcon-console ★6 ⏳1Y](https://github.com/viebig/phalcon-console) - Sample bootstraping application for command line applications using the outstanding Phalcon PHP Framework
...
* [php-cli-app-phalcon ★44 ⏳1Y](https://github.com/jeteokeeffe/php-cli-app-phalcon) - Command Line Application built using Phalcon PHP Framework
...
* [dasshy ★25 ⏳1Y](https://github.com/phalcon/dasshy) - Statistics dashboard with Mongo/Phalcon
...
* [dd ★3](https://github.com/phalcongelist/dd) - This package will add the `dd` helper to your Phalcon application
* [PDW ★91 ⏳1Y](https://github.com/jymboche/phalcon-debug-widget) - Frontend Debugger for Phalcon Applications
* [Phalcon Console ★14 ⏳1Y](https://github.com/vanchelo/phalcon-console) - AJAX console to execute PHP code in the browser with light, the ability to save the last code execution
...
* [Phalcon Whoops ★6 ⏳1Y](https://github.com/whoops-php/phalcon) - Integrating [Whoops](https://filp.github.io/whoops/) with Phalcon
...
* [phalcon-service-loader ★20 ⏳1Y](https://github.com/serebro/phalcon-service-loader) - Service loader for Phalcon PHP Framework
...
* [phaldoc ★3 ⏳1Y](https://github.com/Riu/phaldoc) - Create, translate and control changes in documentation for Phalcon & others projects
...
* [phalcon-form-decorators ★4 ⏳2Y](https://github.com/Michal-St/phalcon-form-decorators) - Form decorators to Phalcon PHP Framework
...
* [Phalcon Translate Service ★7 ⏳1Y](https://github.com/stanislav-web/phalcon-translate) - Phalcon Translate Service. Simple way to translate your custom part of templates
...
* [Phalcon Mailer ★23 ⏳1Y](https://github.com/phalcon-ext/mailer) - Mailer component wrapper over SwiftMailer for Phalcon Framework
...
* [Phalcon File Uploader ★55 ⏳1Y](https://github.com/stanislav-web/phalcon-uploader) - Handling and downloading files for Phalcon projects. Allowed multiple files, filters etc
...
* [phalcon-widget ★3 ⏳1Y](https://github.com/serebro/phalcon-widget) - Widgets for Phalcon apps
* [PhalconBlacklist ★4 ⏳1Y](https://github.com/touhonoob/PhalconBlacklist) - PHP IP/CIDR Blacklist Library Built With Phalcon + MySQL
* [PhalconPoll ★4 ⏳1Y](https://github.com/touhonoob/PhalconPoll) - Simple PHP Poll Service Built With Phalcon PHP Framework + MySQL + Redis
* [Phalcony ★19](https://github.com/ovr/phalcony) - Library for expansion the base functional of Phalcon PHP Framework
* [yarak ★7](https://github.com/zachleigh/yarak) - Laravel inspired Phalcon devtools
...
* [phalcon-mssql ★16 ⏳1Y](https://github.com/fishjerky/phalcon-mssql) - A Phalcon PHP Framework MSSQL PDO db adapter
* [phalcon-seeder ★7 ⏳1Y](https://github.com/SidRoberts/phalcon-seeder) - Database seeder component for Phalcon
...
* [Phalcon Restful Webservice ★56 ⏳1Y](https://github.com/praswicaksono/phalcon-restful-webservice) - Base project for creating powerful webservice based on Phalcon PHP Framework
* [phalcon-api-ouath2 ★31 ⏳2Y](https://github.com/goors/phalcon-api-oauth2) - Full Phalcon REST API example with is own OAuth2 server
...
* [PhalconRest ★203 ⏳1Y](https://github.com/cmoore4/phalcon-rest) - A Base project for APIs using the Phalcon PHP Framework
...
* [phalcon-bootstrap ★19 ⏳2Y](https://github.com/JimmDiGrizli/phalcon-bootstrap) - Bootstrap component for a quick start developing applications on Phalcon PHP Framework
...
* [phalcon_cart ★18 ⏳1Y](https://github.com/uno-de-piera/phalcon_cart) - Complete cart system for Phalcon PHP Framework
* [phasty ★14 ⏳1Y](https://github.com/chaban/phasty) - Shopping Cart on Phalcon PHP Framework
* [Cashier ★14](https://github.com/duythien/cashier) - Phalcon cashier
* [Yona E-commerce ★10 ⏳1Y](https://github.com/oleksandr-torosh/yona-ecommerce) - E-commerce CMF based on Phalcon PHP Framework
...
* [Multiple SMS Sender factory ★27 ⏳1Y](https://github.com/stanislav-web/phalcon-sms-factory) - Phalcon SMS Factory
...
* [phalcon-chat ★6 ⏳2Y](https://github.com/sintsov/phalcon-chat) - Sample classic chat development using Phalcon PHP Framework
...
* [Password Manager ★6 ⏳2Y](https://github.com/mrspartak/phalconPasswordManager) - Password manager for selfuse
* [URL-Shortener ★24 ⏳3Y](https://github.com/blackbunny/Url-Shortener) - Simple Fast Url-Shortener application
...
* [phalcon2-compose ★3 ⏳1Y](https://github.com/linxlad/phalcon2-compose) - Docker Phalcon 2 development environment
...
* [Blog Tutorial ★24 ⏳1Y](https://github.com/phalcon/blog-tutorial) - Blog Tutorial (source code for [Blog Tutorial](https://blog.phalconphp.com/post/tutorial-your-first-encounter-with-phalcon-part-2))
