...
#### Code
###### Rippled - The Guy!
- [rippled ★2220](https://github.com/ripple/rippled): Ripple peer-to-peer network daemon

###### Libs - Libraries for talking to the Ripple API
- [ripple-rest ★72](https://github.com/ripple/ripple-rest): A RESTful API for submitting payments and monitoring accounts on the Ripple Network
- [ripple-lib ★588](https://github.com/ripple/ripple-lib): Java Script
- [ripple-lib-java ★79](https://github.com/ripple/ripple-lib-java): Java
- [ripple-lib-ruby ★4 ⏳4Y](https://github.com/kevinejohn/ripple-lib-rpc-ruby): Ruby
- [ripple-python ★26](https://github.com/miracle2k/ripple-python): Python Lib
- [ripple-haskell ★1 ⏳2Y](https://github.com/singpolyma/ripple-haskell): Haskell
- [rubblelabs/ripple ★37](https://github.com/rubblelabs/ripple): Go packages to interact with the Ripple protocol
- [RippleKit ★4](https://github.com/xasos/RippleKit): Swift

###### Clients / Apps
- [ripple-client ★1317](https://github.com/ripple/ripple-client): Web client
- [ripple-client-desktop ★94 ⏳1Y](https://github.com/ripple/ripple-client-desktop): Desktop client
...
- [ripple-graph ★22 ⏳3Y](https://github.com/ripple-unmaintained/ripple-graph): Ripple graph
...
- [rippled-historical-database ★39](https://github.com/ripple/rippled-historical-database): SQL database as a canonical source of historical data in Ripple
...
- [Ripple Gen ★20 ⏳4Y](https://github.com/CodeShark/RippleGen)
...
- [RippleGen ★20 ⏳4Y](https://github.com/CodeShark/RippleGen): A simple multithreaded vanity generator for the ripple p2p network.
