...
* [Google Fonts](https://fonts.google.com/)
  * [Downloader for Google Fonts ★1252](https://github.com/qrpike/Web-Font-Load)
  * [Files of Google Fonts ★9564](https://github.com/google/fonts) ([sources](https://github.com/googlefonts))
  * [Noto Fonts ★1140](https://github.com/googlei18n/noto-fonts) - Internationalized font for all languages, with rich support for CJK and emoji
  * [Roboto ★2874](https://github.com/google/roboto) - Default font on Android & ChromeOS, and the recommended typeface for Material Design
...
* [The League of Moveable Type](https://www.theleagueofmoveabletype.com/) - The Open-Source Type Movement
  ...
  * ... And more
* [Zilla Slab ★122](https://github.com/mozilla/zilla-slab) - Mozilla font
...
## Emojis
* [alfred-emoji-workflow ★553](https://github.com/carlosgaldino/alfred-emoji-workflow) - Alfred 2 workflow for searching emoji codes
* [emoji-cheat-sheet.com ★5387](https://github.com/WebpageFX/emoji-cheat-sheet.com) - A one pager for emojis on Campfire and GitHub
* [emoji-data-js ★53 ⏳1Y](https://github.com/mroth/emoji-data-js) - Emoji encoding swiss army knife for NodeJS
* [emoji-minesweeper ★230](https://github.com/muan/emoji-minesweeper) - Minesweeper game made with emojis
* [emoji-regex ★296](https://github.com/mathiasbynens/emoji-regex) - A regular expression to match all Emoji-only symbols as per the Unicode Standard
* [emoji-rspec ★170 ⏳3Y](https://github.com/cupakromer/emoji-rspec) - Custom Emoji Formatters for RSpec
* [emoji-translate ★723](https://github.com/notwaldorf/emoji-translate) - Translate text to emoji
* [emoji ★229 ⏳3Y](https://github.com/leereilly/emoji) - All of the emoji supported on GitHub pull requests, issues, comments, commit messages, markdown files, etc
* [emoji ★1606](https://github.com/muan/emoji) - Find the emoji that echoes your mind
...
* [gemoji ★2868](https://github.com/github/gemoji) - Emoji images and names
...
* [vim-emoji ★348](https://github.com/junegunn/vim-emoji) - Emoji in Vim

## Iconic fonts
* [Appa Sariicon ★17 ⏳1Y](https://github.com/sariina/appa-sariicon) - 147 8-bit retro style webfont icons form web and mobile
* [Country Icons ★3927](https://github.com/lipis/flag-icon-css) - A collection of all country flags in SVG and CSS
...
* [Iconic ★2460 ⏳2Y](https://github.com/somerandomdude/Iconic) - Icon set in raster, vector and font formats
...
* [PE-Analog-Clock-icon-font ★300 ⏳1Y](https://github.com/jhogue/PE-Analog-Clock-icon-font) - A set of icons for displaying a visual ("analog") representation of time stamps
...
* [Adobe Fonts](https://github.com/adobe-fonts)
  ...
  * [Source Han Serif ★2616](https://github.com/adobe-fonts/source-han-serif)
...
* [Fixedsys Excelsior ★208](https://github.com/kika/fixedsys)
* [Hasklig ★2723](https://github.com/i-tu/Hasklig)
* [Iosevka ★4836](https://github.com/be5invis/Iosevka) - Spatially efficient monospace font family for programming. Built from code.
* [Monoid ★4728](https://github.com/larsenwork/monoid)
...
* [Typeset.js ★2201 ⏳1Y](https://github.com/davidmerfield/typeset) - HTML pre-processor for web typography
* [Typr.js ★310](https://github.com/photopea/Typr.js) - Parser and utility for working with fonts (TTF, OTF)

#### Event listeners for fonts loading on a web page
* [Font Face Observer ★2322](https://github.com/bramstein/fontfaceobserver)
* [Web Font Loader ★6056](https://github.com/typekit/webfontloader)
