...
* [Google Fonts](https://fonts.google.com/)
  * [Downloader for Google Fonts ★1236](https://github.com/qrpike/Web-Font-Load)
  * [Files of Google Fonts ★9269](https://github.com/google/fonts) ([sources](https://github.com/googlefonts))
  * [Noto Fonts ★1104](https://github.com/googlei18n/noto-fonts) - Internationalized font for all languages, with rich support for CJK and emoji
  * [Roboto ★2825](https://github.com/google/roboto) - Default font on Android & ChromeOS, and the recommended typeface for Material Design
...
* [Redacted ★4483](https://github.com/christiannaths/Redacted-Font) - Keep your wireframes free of distracting Lorem Ipsum
* [SansBullshitSans ★205](https://github.com/RoelN/SansBullshitSans)
* [WorkSans ★734 ⏳1Y](https://github.com/weiweihuanghuang/Work-Sans)

## Emojis
* [alfred-emoji-workflow ★542](https://github.com/carlosgaldino/alfred-emoji-workflow) - Alfred 2 workflow for searching emoji codes
* [emoji-cheat-sheet.com ★5207](https://github.com/WebpageFX/emoji-cheat-sheet.com) - A one pager for emojis on Campfire and GitHub
* [emoji-data-js ★53 ⏳1Y](https://github.com/mroth/emoji-data-js) - Emoji encoding swiss army knife for NodeJS
* [emoji-minesweeper ★222](https://github.com/muan/emoji-minesweeper) - Minesweeper game made with emojis
* [emoji-regex ★266](https://github.com/mathiasbynens/emoji-regex) - A regular expression to match all Emoji-only symbols as per the Unicode Standard
* [emoji-rspec ★171 ⏳3Y](https://github.com/cupakromer/emoji-rspec) - Custom Emoji Formatters for RSpec
* [emoji-translate ★700](https://github.com/notwaldorf/emoji-translate) - Translate text to emoji
...
* [emoji ★1559](https://github.com/muan/emoji) - Find the emoji that echoes your mind
...
* [emojify.js ★1676](https://github.com/emojione/emojify.js) - A Javascript module to convert Emoji keywords to images
...
* [gemoji ★2782](https://github.com/github/gemoji) - Emoji images and names
...
* [vim-emoji ★336](https://github.com/junegunn/vim-emoji) - Emoji in Vim

## Iconic fonts
* [Appa Sariicon ★15 ⏳1Y](https://github.com/sariina/appa-sariicon) - 147 8-bit retro style webfont icons form web and mobile
* [Country Icons ★3712](https://github.com/lipis/flag-icon-css) - A collection of all country flags in SVG and CSS
...
* [Iconic ★2459 ⏳1Y](https://github.com/somerandomdude/Iconic) - Icon set in raster, vector and font formats
* [icono](https://saeedalipoor.github.io/icono/) - One tag One icon, no font or svg, Pure CSS
* [ionicons](http://ionicons.com/) - The premium icon font for Ionic
* [Map Icons ★832](https://github.com/scottdejonge/map-icons) - Font for use with Google Maps API and Google Places API using SVG markers and icon labels
* [Material design icons ★30776](https://github.com/google/material-design-icons) - Official icon set from Google
* [mfglabs-iconset](http://mfglabs.github.io/mfglabs-iconset/) - Awesome web font icon by MFG Labs
* [Micon ★122](https://github.com/xtoolkit/Micon) - Iconic Windows 10 font and CSS toolkit
...
* [Zocial ★202 ⏳5Y](https://github.com/adamstac/zocial) - Sass and Compass CSS3 social buttons framework
  * [CSS social buttons ★1649](https://github.com/smcllns/css-social-buttons) - Entirely vector-based social buttons

## Programming fonts
* [Adobe Fonts](https://github.com/adobe-fonts)
  * [Source Code Pro](http://adobe-fonts.github.io/source-code-pro/)
  * [Source Han Serif ★2513](https://github.com/adobe-fonts/source-han-serif)
...
* [FiraCode ★16046](https://github.com/tonsky/FiraCode) - Monospaced font with programming ligatures
* [Fixedsys Excelsior ★183](https://github.com/kika/fixedsys)
* [Hasklig ★2515](https://github.com/i-tu/Hasklig)
* [Iosevka ★4440](https://github.com/be5invis/Iosevka) - Spatially efficient monospace font family for programming. Built from code.
* [Monoid ★4615](https://github.com/larsenwork/monoid)
...
* [Typeset.js ★2192 ⏳1Y](https://github.com/davidmerfield/typeset) - HTML pre-processor for web typography
* [Typr.js ★304](https://github.com/photopea/Typr.js) - Parser and utility for working with fonts (TTF, OTF)

#### Event listeners for fonts loading on a web page
* [Font Face Observer ★2180](https://github.com/bramstein/fontfaceobserver)
* [Web Font Loader ★5871](https://github.com/typekit/webfontloader)
