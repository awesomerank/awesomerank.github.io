...
---
# Awesome fonts [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★61331](https://github.com/sindresorhus/awesome)
...
* [Google Fonts](https://fonts.google.com/)
  * [Downloader for Google Fonts ★1219](https://github.com/qrpike/Web-Font-Load)
...
* [Redacted ★4474](https://github.com/christiannaths/Redacted-Font) - Keep your wireframes free of distracting Lorem Ipsum
* [SansBullshitSans ★203](https://github.com/RoelN/SansBullshitSans)
* [WorkSans ★728 ⏳1Y](https://github.com/weiweihuanghuang/Work-Sans)

## Emojis
* [alfred-emoji-workflow ★536](https://github.com/carlosgaldino/alfred-emoji-workflow) - Alfred 2 workflow for searching emoji codes
* [emoji-cheat-sheet.com ★5076](https://github.com/WebpageFX/emoji-cheat-sheet.com) - A one pager for emojis on Campfire and GitHub
* [emoji-data-js ★52 ⏳1Y](https://github.com/mroth/emoji-data-js) - Emoji encoding swiss army knife for NodeJS
* [emoji-minesweeper ★213](https://github.com/muan/emoji-minesweeper) - Minesweeper game made with emojis
* [emoji-regex ★251](https://github.com/mathiasbynens/emoji-regex) - A regular expression to match all Emoji-only symbols as per the Unicode Standard
* [emoji-rspec ★172 ⏳3Y](https://github.com/cupakromer/emoji-rspec) - Custom Emoji Formatters for RSpec
* [emoji-translate ★683](https://github.com/notwaldorf/emoji-translate) - Translate text to emoji
...
* [gemoji ★2744](https://github.com/github/gemoji) - Emoji images and names
* [gh-emoji ★135](https://github.com/zzarcon/gh-emoji) - Github emoji parsing done right
* [megamoji ★151](https://github.com/muan/megamoji) - Making megamojis like a pro
* [mojibar ★1701](https://github.com/muan/mojibar) - Emoji searcher but as a menubar app
* [mojime ★30](https://github.com/JuanitoFatas/mojime) - Outputs random emojis
* [php-emoji ★951](https://github.com/iamcal/php-emoji) - A PHP Emoji conversion library
* [twemoji ★6641](https://github.com/twitter/twemoji) - Twitter Emoji for Everyone
* [vim-emoji ★332](https://github.com/junegunn/vim-emoji) - Emoji in Vim

## Iconic fonts
* [Appa Sariicon ★14 ⏳1Y](https://github.com/sariina/appa-sariicon) - 147 8-bit retro style webfont icons form web and mobile
* [Country Icons ★3603](https://github.com/lipis/flag-icon-css) - A collection of all country flags in SVG and CSS
...
* [Font Custom ★3072](https://github.com/FontCustom/fontcustom) - Icon font generator
* [Font-Awesome](http://fontawesome.io) - The iconic font and CSS toolkit
* [font-mfizz ★386](https://github.com/fizzed/font-mfizz) - Vector Icons for Technology and Software Geeks
...
* [Iconic ★2454 ⏳1Y](https://github.com/somerandomdude/Iconic) - Icon set in raster, vector and font formats
* [icono](https://saeedalipoor.github.io/icono/) - One tag One icon, no font or svg, Pure CSS
* [ionicons](http://ionicons.com/) - The premium icon font for Ionic
* [Map Icons ★800](https://github.com/scottdejonge/map-icons) - Font for use with Google Maps API and Google Places API using SVG markers and icon labels
* [Material design icons ★30279](https://github.com/google/material-design-icons) - Official icon set from Google
...
* [WebHostingHub Glyphs ★272 ⏳3Y](https://github.com/whhglyphs/webhostinghub-glyphs)
* [Zocial ★202 ⏳5Y](https://github.com/adamstac/zocial) - Sass and Compass CSS3 social buttons framework
  * [CSS social buttons ★1638](https://github.com/smcllns/css-social-buttons) - Entirely vector-based social buttons
...
* [Hack ★9208](https://github.com/chrissimpkins/Hack)
* [Inconsolata](http://levien.com/type/myfonts/inconsolata.html)
* [Input](http://input.fontbureau.com) - Flexible system of fonts designed specifically for code
* [Meslo-Font ★1735 ⏳1Y](https://github.com/andreberg/Meslo-Font) - Customized version of Apple's Menlo font
* [Mononoki](http://madmalik.github.io/mononoki/)
* [Nerd Fonts ★4570](https://github.com/ryanoasis/nerd-fonts) - Collection of over 20 patched fonts for Powerline, Font Awesome, Octicons, Devicons, and Vim Devicons

#### Programming fonts with ligatures
* [FiraCode ★14474](https://github.com/tonsky/FiraCode) - Monospaced font with programming ligatures
* [Fixedsys Excelsior ★176](https://github.com/kika/fixedsys)
* [Hasklig ★2306](https://github.com/i-tu/Hasklig)
* [Iosevka ★4197](https://github.com/be5invis/Iosevka) - Spatially efficient monospace font family for programming. Built from code.
* [Monoid ★4381](https://github.com/larsenwork/monoid)
...
* [fontkit ★196](https://github.com/devongovett/fontkit) - An advanced font engine for Node and the browser ([demo](https://fontkit-demo.now.sh/))
* [fontmin ★2129](https://github.com/ecomfe/fontmin) - Font minifier
* [Lettering.js ★4839](https://github.com/davatron5000/Lettering.js)
* [localFont ★855 ⏳1Y](https://github.com/jaicab/localFont) - Save fonts in localStorage
* [opentype.js ★1635](https://github.com/nodebox/opentype.js) - Parser and writer for TrueType and OpenType fonts
* [Typefont ★1182](https://github.com/Sirvasile/Typefont) - Algorithm that tries to recognize the font of a text in a photo
* [Typeset.js ★2190 ⏳1Y](https://github.com/davidmerfield/typeset) - HTML pre-processor for web typography
* [Typr.js ★305](https://github.com/photopea/Typr.js) - Parser and utility for working with fonts (TTF, OTF)

#### Event listeners for fonts loading on a web page
* [Font Face Observer ★2092](https://github.com/bramstein/fontfaceobserver)
* [Web Font Loader ★5770](https://github.com/typekit/webfontloader)
...
* [FontForge ★1492](https://github.com/fontforge/fontforge) - Cross-platform font editor
* [Powerline Fonts ★8552](https://github.com/powerline/fonts) - Patched fonts for Powerline users
