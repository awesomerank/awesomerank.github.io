...
* [Google Fonts](https://fonts.google.com/)
  * [Downloader for Google Fonts ★1265](https://github.com/qrpike/Web-Font-Load)
  * [Files of Google Fonts ★9767](https://github.com/google/fonts) ([sources](https://github.com/googlefonts))
  * [Noto Fonts ★1169](https://github.com/googlei18n/noto-fonts) - Internationalized font for all languages, with rich support for CJK and emoji
  * [Roboto ★2912](https://github.com/google/roboto) - Default font on Android & ChromeOS, and the recommended typeface for Material Design
...
* [The League of Moveable Type](https://www.theleagueofmoveabletype.com/) - The Open-Source Type Movement
  ...
  * ... And more
* [Zilla Slab ★130](https://github.com/mozilla/zilla-slab) - Mozilla font
...
* [Inter ★3749](https://github.com/rsms/inter) - A typeface specially designed for user interfaces.
* [Open Baskerville](http://klepas.org/openbaskerville/)
* [Redacted ★4539 ⏳1Y](https://github.com/christiannaths/Redacted-Font) - Keep your wireframes free of distracting Lorem Ipsum
* [SansBullshitSans ★217](https://github.com/RoelN/SansBullshitSans)
* [WorkSans ★769](https://github.com/weiweihuanghuang/Work-Sans)
...
* [emoji ★231 ⏳4Y](https://github.com/leereilly/emoji) - All of the emoji supported on GitHub pull requests, issues, comments, commit messages, markdown files, etc
* [emoji ★1617](https://github.com/muan/emoji) - Find the emoji that echoes your mind
* [emoji ★415 ⏳1Y](https://github.com/wpeterson/emoji) - A gem. For Emoji. For everyone.
* [emojidex ★3](https://github.com/emojidex/emojidex) - Emoji-as-a-service provider and set of tools and assets
* [emojify.js ★1706](https://github.com/emojione/emojify.js) - A Javascript module to convert Emoji keywords to images
...
* [gemoji ★2904](https://github.com/github/gemoji) - Emoji images and names
...
* [vim-emoji ★360](https://github.com/junegunn/vim-emoji) - Emoji in Vim

## Iconic fonts
* [Appa Sariicon ★17 ⏳2Y](https://github.com/sariina/appa-sariicon) - 147 8-bit retro style webfont icons form web and mobile
* [Country Icons ★4035](https://github.com/lipis/flag-icon-css) - A collection of all country flags in SVG and CSS
...
* [Iconic ★2454 ⏳2Y](https://github.com/somerandomdude/Iconic) - Icon set in raster, vector and font formats
* [icono](https://saeedalipoor.github.io/icono/) - One tag One icon, no font or svg, Pure CSS
* [ionicons](http://ionicons.com/) - The premium icon font for Ionic
* [Map Icons ★859](https://github.com/scottdejonge/map-icons) - Font for use with Google Maps API and Google Places API using SVG markers and icon labels
...
* [stackicons ★969](https://github.com/parkerbennett/stackicons) - Icon font and Sass-based construction kit for Stackicons-Social, which supports multiple button shapes and a unique "multi-color" option in CSS for over 60 social brands
...
* [Zocial ★200 ⏳6Y](https://github.com/adamstac/zocial) - Sass and Compass CSS3 social buttons framework
  * [CSS social buttons ★1653](https://github.com/smcllns/css-social-buttons) - Entirely vector-based social buttons

## Programming fonts
* [Adobe Fonts](https://github.com/adobe-fonts)
  * [Source Code Pro](http://adobe-fonts.github.io/source-code-pro/)
  * [Source Han Serif ★2680](https://github.com/adobe-fonts/source-han-serif)
...
* [FiraCode ★18325](https://github.com/tonsky/FiraCode) - Monospaced font with programming ligatures
* [Fixedsys Excelsior ★217](https://github.com/kika/fixedsys)
* [Hasklig ★2815](https://github.com/i-tu/Hasklig)
* [Iosevka ★5003](https://github.com/be5invis/Iosevka) - Spatially efficient monospace font family for programming. Built from code.
* [Monoid ★4789](https://github.com/larsenwork/monoid)
...
* [Typeset.js ★2202 ⏳1Y](https://github.com/davidmerfield/typeset) - HTML pre-processor for web typography
* [Typr.js ★311](https://github.com/photopea/Typr.js) - Parser and utility for working with fonts (TTF, OTF)

#### Event listeners for fonts loading on a web page
* [Font Face Observer ★2379](https://github.com/bramstein/fontfaceobserver)
* [Web Font Loader ★6140](https://github.com/typekit/webfontloader)
