...
<p align="center">
	This list is a copy of <a href="ChromeDevTools/awesome-chrome-devtools">ChromeDevTools/awesome-chrome-devtools</a> with ranks
</p>
---
# Awesome chrome-devtools [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
...
#### DevTools as an IDE
- [Chrome DevTools App ★1394 ⏳1Y](auchenberg/chrome-devtools-app) - Standalone app which can inspect various targets.
- [DevTools Remote ★518](auchenberg/devtools-remote) - Remotely debug someone else's browser.
- [DevTools Snippets ★1194](bahmutov/code-snippets) - Collection of snippets.
...
#### Object formatting
- [immutable-devtools ★486 ⏳1Y](andrewdavey/immutable-devtools) - Custom formatter for Immutable-js values.

#### Network Inspection
- [betwixt ★3462](kdzwinel/betwixt) - System level network proxy, providing inspection via Network panel
...
- [call-trace ★11 ⏳1Y](brendankenny/call-trace) - Can instrument your JS with hooks, and then generate a `.cpuprofile`  of the of the complete (non-sampled) execution. View either time or call counts.
- [cpuprofilify ★101](thlorenz/cpuprofilify) - Converts output of various profiling/sampling tools to the `.cpuprofile` format.
...
#### Multimedia
- [snapline ★272 ⏳1Y](pmdartus/snapline) - Converts timeline screenshots to gif.
...
- [VS Code - Debugger for Chrome ★663](Microsoft/vscode-chrome-debug) - Chrome Debugger for Visual Studio Code
...
- [ChromeDevTools/devtools-protocol ★41](chromedevtools/devtools-protocol) - Issue tracker for protocol bugs
- [Remote Debug Gateway ★54 ⏳1Y](RemoteDebug/remotedebug-gateway) - Allows you to connect a client to multiple browsers at once.
...
- JavaScript/Node.js: [chrome-remote-interface ★1328](cyrus-and/chrome-remote-interface) - The most-used JavaScript API for the protocol
- TypeScript/Node.js: [chrome-debugging-client ★18](krisselden/chrome-debugging-client) - A TypeScript async/await-friendly debugging client
- Java: [cdp4j ★13](webfolderio/cdp4j) - Java library for CDP
- Python: [chromote ★228](iiSeymour/chromote) - Simple wrapper to drive Google Chrome from Python
- Go: [cdp ★8](mafredri/cdp) - A Golang library for the protocol
- Go: [gcd ★99](wirepair/gcd) - A different client library in Go
- Go: [godet ★142](raff/godet) - Also different, also Go.
...
- [crmux ★80](sidorares/crmux) - Multiplexes protocol connections.
- [automated-chrome-profiling ★636](paulirish/automated-chrome-profiling#readme) - Node.js recipes for automating JavaScript profiling in Chrome.
...
- [crconsole ★168](sidorares/crconsole) - Terminal based chrome console and debugger.

#### Browser Adapters
- [Remote Debug Firefox adapter ★103](RemoteDebug/remotedebug-firefox-adapter) - Translates Firefox's devtools protocol to the CDP
- [ios-webkit-debug-proxy ★2796](google/ios-webkit-debug-proxy) - Exposes Mobile Safari & UIWebView instances via the CDP.
- [Remote Debug iOS WebKit adapter ★184](RemoteDebug/remotedebug-ios-webkit-adapter) - Builts upon ios-webkit-debug-proxy and translates WebKit's Remote Debugging Protocol API to the CDP
- [IE Diagnostics Adapter ★526 ⏳1Y](Microsoft/IEDiagnosticsAdapter) - Protocol adaptor for Microsoft IE 10/11 to CDP.
...
##### Android
- [Facebook Stetho ★7694](facebook/stetho) - Native Android debugging with Chrome DevTools

##### ClosureScript
- [Dirac ★441](binaryage/dirac) - Debugging of ClojsureScript
 
##### Lua
- [Mare ★165](muzuiget/mare) - Lua debugging with Chrome DevTools

#### iOS
- [PonyDebugger ★5382](square/PonyDebugger) - Remote network and data debugging iOS apps with Chrome DevTools

##### Go
- [go-debugger-devtools ★11](allada/go-debugger-devtools)
...
- [devtool ★3696](Jam3/devtool) - Debug & profile Node.js apps with Chrome DevTools (using Electron).
- [buggerJS ★149](buggerjs/bugger) - Provides Chrome DevTools bindings for node.
...
- [VueJS Developer Tools ★3761](vuejs/vue-devtools) - Inspect VueJS components and manipulate their data.
...
- [Insight ★681](3Dparallax/insight) - A WebGL debugging toolkit which enables more productive WebGL development and more efficient WebGL applications.
- [BEM devtools ★36 ⏳1Y](escaton/bem-chrome-devtools) - Inspect BEM entities expressed in `i-bem` framework.
