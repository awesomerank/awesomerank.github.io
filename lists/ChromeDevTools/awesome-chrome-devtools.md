...
- [DevTools Remote ★526](https://github.com/auchenberg/devtools-remote) - Remotely debug someone else's browser.
- [DevTools Snippets ★1216](https://github.com/bahmutov/code-snippets) - Collection of snippets.
...
#### Object formatting
- [immutable-devtools ★510 ⏳1Y](https://github.com/andrewdavey/immutable-devtools) - Custom formatter for Immutable-js values.

#### Network Inspection
- [betwixt ★3519](https://github.com/kdzwinel/betwixt) - System level network proxy, providing inspection via Network panel
...
#### Multimedia
- [snapline ★278 ⏳1Y](https://github.com/pmdartus/snapline) - Converts timeline screenshots to gif.
...
- [VS Code - Debugger for Chrome ★742](https://github.com/Microsoft/vscode-chrome-debug) - Chrome Debugger for Visual Studio Code
...
- [ChromeDevTools/devtools-protocol ★77](https://github.com/chromedevtools/devtools-protocol) - Issue tracker for protocol bugs
...
- [crmux ★87](https://github.com/sidorares/crmux) - Multiplexes protocol connections.
- [automated-chrome-profiling ★665](https://github.com/paulirish/automated-chrome-profiling#readme) - Node.js recipes for automating JavaScript profiling in Chrome.
...
- [crconsole ★175](https://github.com/sidorares/crconsole) - Terminal based chrome console and debugger.
...
- [ios-webkit-debug-proxy ★2964](https://github.com/google/ios-webkit-debug-proxy) - Exposes Mobile Safari & UIWebView instances via the CDP.
- [Remote Debug iOS WebKit adapter ★271](https://github.com/RemoteDebug/remotedebug-ios-webkit-adapter) - Builts upon ios-webkit-debug-proxy and translates WebKit's Remote Debugging Protocol API to the CDP
...
##### Android
- [Facebook Stetho ★8248](https://github.com/facebook/stetho) - Native Android debugging with Chrome DevTools

##### ClosureScript
- [Dirac ★469](https://github.com/binaryage/dirac) - Debugging of ClojsureScript

##### Lua
- [Mare ★190](https://github.com/muzuiget/mare) - Lua debugging with Chrome DevTools
...
- [VueJS Developer Tools ★4495](https://github.com/vuejs/vue-devtools) - Inspect VueJS components and manipulate their data.
