...
* [stillir ★37](https://github.com/heroku/stillir) - Cache environment variables as Erlang app variables.
...
* [Axiom](https://github.com/tsujigiri/axiom) - A micro-framework, inspired by Ruby's [Sinatra ★10004](https://github.com/sinatra/sinatra).
...
* [cb_admin ★72 ⏳2Y](https://github.com/ChicagoBoss/cb_admin) - An admin interface for Chicago Boss.
...
* [simple_bridge ★92 ⏳1Y](https://github.com/nitrogen/simple_bridge) - An abstraction layer providing a unified interface to popular Erlang web servers (Cowboy, Inets, Mochiweb, Webmachine, and Yaws).
...
* [lager ★24 ⏳1Y](https://github.com/basho/lager) - A logging framework for Erlang/OTP.
* [lager_amqp_backend ★33 ⏳6Y](https://github.com/jbrisbin/lager_amqp_backend) - AMQP RabbitMQ Lager backend.
...
* [logplex ★839](https://github.com/heroku/logplex) - Heroku log router.
...
* [rebar ★929](https://github.com/rebar/rebar) - Erlang build tool that makes it easy to compile and test Erlang applications, port drivers and releases.
...
* [sync ★634](https://github.com/rustyio/sync) - On-the-fly recompiling for Erlang.
...
* [GeoCouch ★477](https://github.com/couchbase/geocouch) - A spatial extension for Couchbase and Apache CouchDB.
* [Teles ★12 ⏳1Y](https://github.com/armon/teles) - An Erlang network service for manipulating geographic data.

## Debugging
*Libraries and tools for debugging code and applications.*

* [tx ★64 ⏳3Y](https://github.com/kvakvs/tx) - An HTML Erlang term viewer, starts own webserver and displays any term you give it from your Erlang node.
...
* [erlang_localtime ★40 ⏳1Y](https://github.com/dmitryme/erlang_localtime) - Erlang library for conversion from one local time to another.
* [qdate ★202](https://github.com/choptastic/qdate) - Erlang date, time, and timezone management: formatting, conversion, and date arithmetic.

## ORM and Datamapping
*Libraries that implement object-relational mapping or datamapping techniques.*

* [boss_db ★256](https://github.com/ErlyORM/boss_db) - A sharded, caching, pooling, evented ORM for Erlang.
* [epgsql ★235](https://github.com/epgsql/epgsql) - PostgreSQL Driver for Erlang.
* [mysql-otp ★236](https://github.com/mysql-otp/mysql-otp) - MySQL/OTP – MySQL driver for Erlang/OTP.
* [pgsql_migration ★12](https://github.com/artemeff/pgsql_migration) – PostgreSQL migrations for Erlang.

## Queue
*Libraries for working with event and task queues.*

* [dq ★26 ⏳3Y](https://github.com/darach/dq) - Distributed Fault Tolerant Queue library.
* [ebqueue ★5 ⏳3Y](https://github.com/rgrinberg/ebqueue) - Tiny simple blocking queue in erlang.
* [pqueue ★104](https://github.com/okeuday/pqueue) - Erlang Priority Queues.
* [tinymq ★102](https://github.com/ChicagoBoss/tinymq) - A diminutive, in-memory message queue for Erlang.

## Authentication
*Libraries for implementing authentications schemes.*

* [oauth2 ★195](https://github.com/kivra/oauth2) - Erlang Oauth2 implementation.
...
* [cache ★97](https://github.com/fogfish/cache) - In-memory Segmented Cache

## Third Party APIs
*Libraries for accessing third party APIs.*

* [restc ★67](https://github.com/kivra/restclient) - An Erlang REST client
* [oauth2c ★58](https://github.com/kivra/oauth2_client) - An Erlang oAuth 2 client (uses restc)
...
* [gen_rpc ★159](https://github.com/priestjim/gen_rpc) - A scalable RPC library for Erlang-VM based languages.
* [gen_tcp_server ★9 ⏳3Y](https://github.com/rpt/gen_tcp_server) - A library that takes the concept of gen_server and introduces the same mechanics for operating a TCP server.
* [gossiperl ★36 ⏳3Y](https://github.com/gossiperl/gossiperl) - Language agnostic gossip middleware and message bus written in Erlang.
* [nat_upnp ★38](https://github.com/benoitc/nat_upnp) - Erlang library to map your internal port to an external using UNP IGD.
* [ranch ★808](https://github.com/ninenines/ranch) - Socket acceptor pool for TCP protocols.

## Internet of Things
*Libraries and tools for interacting with the physical world.*
* [lemma_erlang ★4](https://github.com/noam-io/lemma_erlang) - A lemma for IDEO's Noam internet-of-things prototyping platform.

## Algorithms and Datastructures
*Libraries and implementations of algorithms and datastructures.*

* [datum ★61](https://github.com/fogfish/datum) - A pure functional and generic programming for Erlang
* [erlando ★2 ⏳1Y](https://github.com/travelping/erlando) - A set of syntax extensions like currying and monads for Erlang.
* [statebox ★234 ⏳3Y](https://github.com/mochi/statebox) - Erlang state "monad" with merge/conflict-resolution capabilities.
* [riak_dt ★241](https://github.com/basho/riak_dt) - Erlang library of state based CRDTs.
...
* [erld ★194 ⏳2Y](https://github.com/ShoreTel-Inc/erld) - erld is a small program designed to solve the problem of running Erlang programs as a UNIX daemon.
