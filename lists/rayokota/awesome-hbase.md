---
layout: default
title: Awesome Rank for rayokota/awesome-hbase
---
...
* [asynchbase ★466](https://github.com/OpenTSDB/asynchbase) - Fully asynchronous, non-blocking HBase client.
* [gohbase ★165](https://github.com/tsuna/gohbase) - Pure Go client for HBase.
* [happybase ★350](https://github.com/wbolster/happybase) - Python client for HBase.
...
* [HDocDB ★9](https://github.com/rayokota/hdocdb) - HBase as a JSON document database.
...
* [Kundera ★741](https://github.com/impetus-opensource/Kundera) - JPA client with support for HBase.
...
#### Graph
* [Gradoop ★83](https://github.com/dbs-leipzig/gradoop) - Research framework for scalable graph analytics built on Flink and HBase.
...
* [Cascading ★9 ⏳1Y](https://github.com/Cascading/cascading.hbase) - HBase adapters for Cascading.
* [Cascalog ★20](https://github.com/sorenmacbeth/hbase-cascalog) - Wrapper around Cascading.HBase for use in Cascalog.
* [Drill](https://drill.apache.org/docs/querying-hbase/) - HBase storage plugin for Drill.
* [Elasticsearch ★22 ⏳3Y](https://github.com/mallocator/Elasticsearch-HBase-River) - Elasticsearch import river for HBase.
...
* [Spark ★157](https://github.com/hortonworks-spark/shc) - Spark-HBase connector.
...
* [h-rider ★98](https://github.com/NiceSystems/hrider) - GUI for viewing and manipulating data in HBase.
