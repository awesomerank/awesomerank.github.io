...
# Awesome Spark [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
...
* [Flambo ★505](yieldbot/flambo) - Clojure DSL.
* [Mobius ★597](Microsoft/Mobius) - C# bindings.
...
* [sparkmagic](https://github.com/jupyter-incubator/sparkmagic) - [Jupyter](https://jupyter.org/) magics and kernels for working with remote Spark clusters, for interactively working with remote Spark clusters through [Livy ★509](cloudera/livy), in Jupyter notebooks.
...
* [Spark CSV ★746](databricks/spark-csv) - CSV reader and writer (obsolete since Spark 2.0 [[SPARK-12833]](https://issues.apache.org/jira/browse/SPARK-12833)).
* [Spark Avro ★341](databricks/spark-avro) - [Apache Avro](https://avro.apache.org/) reader and writer.
* [Spark XML ★116](databricks/spark-xml) - XML parser and writer.
* [Spark-Mongodb ★276](Stratio/Spark-MongoDB) - MongoDB reader and writer.
* [Spark Cassandra Connector ★1194](datastax/spark-cassandra-connector) - Cassandra support including data source and API and support for arbitrary queries.
* [Spark Riak Connector ★34](basho/spark-riak-connector) - Riak TS & Riak KV connector.
* [Mongo-Spark ★251](mongodb/mongo-spark) - Official MongoDB connector.

### Bioinformatics

* [ADAM ★620](bigdatagenomics/adam) - Set of tools designed to analyse genomics data.
* [Hail ★165](hail-is/hail) - Genetic analysis framework.

### GIS

* [Magellan ★253](harsha2010/magellan) - Geospatial analytics using Spark.
...
* [Mazerunner ★305](neo4j-contrib/neo4j-mazerunner) - Graph analytics platform on top of Neo4j and GraphX.
* [GraphFrames ★246](graphframes/graphframes) - Data frame based graph API.
* [neo4j-spark-connector ★70](neo4j-contrib/neo4j-spark-connector) - Bolt protocol based, Neo4j Connector with RDD, DataFrame and GraphX / GraphFrames support.
...
* [spark-sklearn ★424](databricks/spark-sklearn) - Scikit-learn integration with distributed model training.
* [KeystoneML](http://keystone-ml.org/) - Type safe machine learning pipelines with RDDs.
* [JPMML-Spark ★24](jpmml/jpmml-spark) - PMML transformer library for Spark ML.
* [Distributed Keras ★190](cerndb/dist-keras) - Distributed deep learning framework with PySpark and Keras.
* [ModelDB](https://mitdbg.github.io/modeldb) - A system to manage machine learning models for `spark.ml` and [`scikit-learn` ★18792](scikit-learn/scikit-learn).
* [Sparkling Water ★498](h2oai/sparkling-water) -  [H2O](http://www.h2o.ai/) interoperability layer.
* [dist-keras ★190](cerndb/dist-keras) - Distributed Deep Learning with Apache Spark and Keras.

### Middleware

* [Livy ★509](cloudera/livy) - REST server with extensive language support (Python, R, Scala), ability to maintain interactive sessions and object sharing.
* [spark-jobserver ★1611](spark-jobserver/spark-jobserver) - Simple Spark as a Service which supports objects sharing using so called named objects. JVM only.
* [Mist ★79](Hydrospheredata/mist) - Service for exposing Spark analytical jobs and machine learning models as realtime, batch or reactive web services.
* [Apache Toree ★335](apache/incubator-toree) - IPython protocol based middleware for interactive applications.

### Utilities

* [silex ★13](willb/silex) - Collection of tools varying from ML extensions to additional RDD methods.
* [sparkly ★14](Tubular/sparkly) - Helpers & syntactic sugar for PySpark.
* [pyspark-stubs ★5](zero323/pyspark-stubs) - Static type annotations for PySpark.

### Natural Language Processing

* [spark-corenlp ★277](databricks/spark-corenlp) - DataFrame wrapper for [Stanford CoreNLP](https://stanfordnlp.github.io/CoreNLP/).
...
* [Blaze ★1983](blaze/blaze) - Interface for querying larger than memory datasets using Pandas-like syntax. It supports both Spark `DataFrames` and `RDDs`.

### Testing

* [spark-testing-base ★478](holdenk/spark-testing-base) - Collection of base test classes.

### Workflow Management

* [Cromwell](https://github.com/broadinstitute/cromwell#spark-backend) - Workflow management system with [Spark backend ★138](broadinstitute/cromwell#spark-backend).
...
* [Advanced Analytics with Spark](http://shop.oreilly.com/product/0636920035091.do) - Useful collection of Spark processing patterns. Accompanying GitHub repository: [sryza/aas ★796](sryza/aas).
...
* [Spark Gotchas ★88](awesome-spark/spark-gotchas) - Subjective compilation of tips, tricks and common programming mistakes.
* [Spark in Action](https://www.manning.com/books/spark-in-action) - New book in the Manning's "in action" family with +400 pages. Starts gently, step-by-step and covers large number of topics. Free excerpt on how to [setup Eclipse for Spark application development](http://freecontent.manning.com/how-to-start-developing-spark-applications-in-eclipse/) and how to bootstrap a new application using the provided Maven Archetype. You can find the accompanying GitHub repo [here ★130](spark-in-action/first-edition).
...
* [Oryx 2 ★1118](OryxProject/oryx) - [Lambda architecture](http://lambda-architecture.net/) platform built on Apache Spark and [Apache Kafka](http://kafka.apache.org/) with specialization for real-time large scale machine learning.
* [Photon ML ★434](linkedin/photon-ml) - A machine learning library supporting classical Generalized Mixed Model and Generalized Additive Mixed Effect Model.
...
* [Crossdata ★147](Stratio/Crossdata) - Data integration platform with extended DataSource API and multi-user environment.
...
- [sequenceiq/docker-spark ★622](sequenceiq/docker-spark) - Yarn images from [SequenceIQ](http://www.sequenceiq.com/).
