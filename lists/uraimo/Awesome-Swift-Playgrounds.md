...
* [The Swift Programming Language Playgrounds ★123](https://github.com/danielpi/Swift-Playgrounds) - 40+ playgrounds, one for each chapter of Apple's Swift book. 🌟 ☘️
* [Swift Hack Pack ★6](https://github.com/GuildSA/swift-hack-pack) - Collection of playgrounds that teaches Swift.☘️
* [The Swift Summary Book ★1624](https://github.com/jakarmy/swift-summary) - A summary of Apple's Swift language. 🌟 ☘️
...
* [A Swift Introduction to Core Data ★113](https://github.com/andyshep/CoreDataPlaygrounds) - Learn Core Data experimenting directly in this playground. 🌟 ☘️
* [TDDSwiftPlayground ★31](https://github.com/sshrpe/TDDSwiftPlayground) - Demonstration of using Swift Playgrounds in Test Driven Development with XCTest. ☘️
* [Concurrency on iOS ★10](https://github.com/sammyd/SwiftConf2016_Concurrency) - Concurrency and Parallelism in iOS. ☘️
...
* [iPad Swift Playgrounds ★9](https://github.com/kushtaneja/iPad_Swift_Playgrounds) - The sample playgroundbooks converted to playgrounds.☘️
...
* [Swift Algorithm Club ★12286](https://github.com/raywenderlich/swift-algorithm-club) - Algorithms and data structures in Swift with explanations. 🌟 ☘️
* [Sorting Experiments ★6](https://github.com/adrfer/Sort) - Alluring experiments with sorting algorithms in Swift, sort of. ☘️
* [Visual Binary Trees ★30](https://github.com/akpw/VisualBinaryTrees) - Effortless visualization of arbitrary Binary Trees, along with their pluggable traversal implementations. 🌟 ☘️
...
* [UIStackView Playground ★282](https://github.com/dasdom/UIStackViewPlayground) - Interesting examples of use of UIStackViews.🌟 ☘️
* [Bezier Path Playgrounds ★16](https://github.com/DigitalLeaves/BezierPathPlaygrounds) - Some playgrounds to better understand UIBezierPaths. ☘️
* [UIKit playground ★20](https://github.com/ralfebert/uikit-playground) - Playgrounds to experiment interactively with UIKit views. ☘️
* [Checkmark Button ★6](https://github.com/BilalReffas/CheckmarkButton) - Animated check mark button. ☘️ 
...
* [AudioKit Playground Book ★39](https://github.com/audiokit/AudioKitPlaygroundBook) - A set of playgrounds using AudioKit designed for the iOS10 Playgrounds app. 📱 ☘️
* [Bach Playground ★2](https://github.com/dreamwieber/BachPlayground) - A Simple Swift Playground that plays a brief piece by Bach with AVAudioEngine and AVMIDIPlayer. ☘️
* [PlayerNode Playground ★1](https://github.com/genedelisa/PlayerNodePlayground) - Playground using AVAudioEngine with a playernode and effects to play an audio file. 🌟 ☘️
...
* [Public Extensions ★196](https://github.com/Jasdev/Public-Extension) - A set of useful extensions from [@PublicExtension](https://twitter.com/publicextension). 🌟 ☘️
...
* [Icon Creator ★12](https://github.com/tnantoka/IconCreator) - Create app icons on Swift playground. ☘️
* [2048 Playground ★19](https://github.com/robin/2048_Playground) - The 2048 game implemented with a playground. ☘️
* [SwiftShell ★10](https://github.com/JustinJiaDev/SwiftShell) - Bash shell in a playground. ☘️
* [File Browser Playground ★182](https://github.com/steventroughtonsmith/files-playgroundbook) - Simple File Browser for Swift Playgrounds on iOS.📱 ☘️
