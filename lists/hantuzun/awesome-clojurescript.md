...
### Canvas
- [Monet ★134](https://github.com/rm-hull/monet) – A small ClojureScript library to make it easier to work with canvas and visuals.
...
- [Fetch ★193](https://github.com/LightTable/fetch) – A ClojureScript library that makes client/server interaction painless.


### Code Analysis
- [kibit ★1212](https://github.com/jonase/kibit) — Static code analyzer to find patterns of code that could be rewritten with a more idiomatic function or macro.
...
### Development
- [Ambly ★463](https://github.com/omcljs/ambly) — A ClojureScript REPL into iOS JavaScriptCore.
- [cljs-devtools ★683](https://github.com/binaryage/cljs-devtools) – Better presentation of ClojureScript values in Chrome Devtools.
- [Devcards ★1068](https://github.com/bhauman/devcards) – Devcards aims to provide a visual REPL experience for ClojureScript.
- [lein-cljsbuild ★905](https://github.com/emezeske/lein-cljsbuild) — A Leiningen plugin to make ClojureScript development easy.
- [lein-figwheel ★2105](https://github.com/bhauman/lein-figwheel) – Leiningen plugin that pushes ClojureScript code changes to the client.
- [Planck ★701](https://github.com/mfikes/planck) – A stand-alone ClojureScript REPL for macOS and Linux based on JavaScriptCore.
- [Ribol](http://docs.caudate.me/ribol/) – Conditional restarts for clojure/clojurescript.
- [shadow-build ★101](https://github.com/thheller/shadow-build) – A ClojureScript build library capable of compiling multiple output files.
...
- [Kioo ★384](https://github.com/ckirkendall/kioo) – DOM manipulation and templating library for Facebook's React and Om in ClojureScript.
- [Sablono ★538](https://github.com/r0man/sablono) – Lisp/Hiccup style templating for Facebook's React in ClojureScript.


### Documentation
- [codox ★408](https://github.com/weavejester/codox) – A tool for generating API documentation from Clojure or ClojureScript source code.


### Graphics
- [geom ★438](https://github.com/thi-ng/geom) – A 2D/3D geometry toolkit for Clojure/Clojurescript.


### HTTP Handler
- [Castra ★115](https://github.com/hoplon/castra) – An HTTP remote procedure call handler for Clojure.
...
- [core.async ★1346](https://github.com/clojure/core.async) – A Clojure(Script) library designed to provide facilities for async programming and communication.
- [Entanglement ★27](https://github.com/Frozenlock/entanglement) – It creates atoms from other atoms and links the data together.
- [Garden ★788](https://github.com/noprompt/garden) – A library for rendering CSS in Clojure and ClojureScript.
- [inflections-clj ★144](https://github.com/r0man/inflections-clj) – Rails-like inflection library for Clojure and ClojureScript.
...
- [markdown-clj ★319](https://github.com/yogthos/markdown-clj) – Markdown parser in Clojure/ClojureScript.
- [om-tools ★459](https://github.com/plumatic/om-tools) – It aims to provide higher-order abstractions and utilities frequently useful when building components with Om's API.
- [Quil ★1863](https://github.com/quil/quil) – A processing and graphics programming library.
...
- [Truss ★174](https://github.com/ptaoussanis/truss) – An opinionated assertions API for Clojure/ClojureScript.

### [React.js](https://facebook.github.io/react/) Interface
- [Brutha ★129](https://github.com/weavejester/brutha) – A simple and functional ClojureScript interface to React.
- [Om ★6030](https://github.com/omcljs/om) — A powerful interface to React, makes use of its object oriented structures.
- [Quiescent ★583](https://github.com/levand/quiescent) — It favors functional style, fully stateless.
- [re-com ★433](https://github.com/Day8/re-com) – A ClojureScript library of reusable components for Reagent.
- [Reagent](http://reagent-project.github.io/) — Minimalistic, feature complete.
- [Rum ★876](https://github.com/tonsky/rum) — Decomplected, extensible, simple.
...
- [Router ★72](https://github.com/darkleaf/router) – Bidirectional Ring router for Clojure/Script. REST oriented.
- [Secretary ★628](https://github.com/gf3/secretary) – A client-side router for ClojureScript.
- [Silk ★208](https://github.com/DomKM/silk) – An isomorphic routing library for Clojure & ClojureScript.
...
- [Speclj ★366](https://github.com/slagyr/speclj) – A TDD/BDD framework for Clojure and ClojureScript.
- [test.check ★738](https://github.com/clojure/test.check) – A generative property-based testing tool inspired by QuickCheck.
...
### WebSockets
- [Chord ★339](https://github.com/jarohen/chord) – Designed to bridge the gap between the triad of CLJ/CLJS, web-sockets and core.async.
