...
*You might also like [Awesome Django](https://gitlab.com/rosarior/awesome-django) and [Awesome Python ★33326](https://github.com/vinta/awesome-python). :snake:*
...
- [GitHub repository ★4294](https://github.com/wagtail/wagtail)
...
- [wagtail_blog ★117](https://github.com/thelabnyc/wagtail_blog) - A WordPress-like blog app implemented in Wagtail.
- [wagtailnews ★8](https://github.com/takeflight/wagtailnews) - A plugin for Wagtail that provides news / blogging functionality.
- [wagtail-blog-app ★28](https://github.com/Tivix/wagtail-blog-app) - A blog application for the Wagtail Django CMS.
- [Django Wagtail Feeds ★17](https://github.com/chrisdev/django-wagtail-feeds) - Add support for RSS Feeds, Facebook Instant Articles and Apple News Publisher to your Wagtail CMS Projects.
...
- [Wagtail-Geo-Widget ★17](https://github.com/Frojd/wagtail-geo-widget) - Google Maps widget for the GeoDjango PointField field in Wagtail.
- [wagtail-markdown ★30](https://github.com/torchbox/wagtail-markdown) - Markdown fields and blocks for Wagtail.

### Streamfield

- [Wagtail FontAwesome ★32](https://github.com/alexgleason/wagtailfontawesome) - Add FontAwesome icons to StreamField.
...
- [UWKM Streamfields ★1](https://github.com/UWKM/uwkm_streamfields) – A basic set of Wagtail Streamfields for fun and profit.
...
- [wagtail-metadata ★13](https://github.com/takeflight/wagtail-metadata) - A tool to assist with metadata for social media and search engines.
...
- [Wagtail Analytics ★52](https://github.com/tomdyson/wagalytics) - A Google Analytics dashboard in your Wagtail admin.
- [Wagtail Experiments ★24](https://github.com/torchbox/wagtail-experiments) – A/B testing for Wagtail.
...
- [Wagtail Modeltranslation](https://github.com/infoportugal/wagtail-modeltranslation) - Simple app containing a mixin model that integrates [django-modeltranslation ★481](https://github.com/deschler/django-modeltranslation) into Wagtail panels system.
- [wagtailtrans ★22](https://github.com/LUKKIEN/wagtailtrans) - A Wagtail add-on for supporting multilingual sites.

### Forms

- [wagtailpolls ★16](https://github.com/takeflight/wagtailpolls) - A plugin for adding polling capabilities to the Wagtail CMS.
...
- [Wagtail ReCaptcha](https://github.com/springload/wagtail-django-recaptcha) - wagtail-django-captcha provides an easy way to integrate the [django-recaptcha ★388](https://github.com/praekelt/django-recaptcha) field when using the Wagtail formbuilder.
...
- [Wagtail Postgres Search Backend ★2](https://github.com/leukeleu/wagtail-pg-search-backend) - PostgreSQL full text search backend for Wagtail CMS.
- [Wagtail Gridder ★5](https://github.com/wharton/wagtailgridder) - Grid card layout similar to Google image search results, with an expanded area for card details.

## Tools

- [Wagtail Cookiecutter Foundation ★77](https://github.com/chrisdev/wagtail-cookiecutter-foundation) - A Cookiecutter template for Wagtail CMS using Zurb Foundation 6.
...
- [Wagtail Starter Kit ★20](https://github.com/tkjone/starterkit-wagtail) – A cookiecutter complete with wagtail, django layout, vagrant, provisioning scrips, front end build system and more!
...
- [Torchbox ★21](https://github.com/torchbox/wagtail-torchbox) – Wagtail build of Torchbox.com.
...
- [NHS.UK Content Store ★5](https://github.com/nhsuk/nhsuk-content-store) – NHS.UK content store and editing app.
...
- [Secure the News ★20](https://github.com/freedomofpress/securethenews) – An automated scanner and web dashboard for tracking TLS deployment across news organizations.
- [HackSoft ★3](https://github.com/HackSoftware/hacksoft.io) – Website for HackSoft.
