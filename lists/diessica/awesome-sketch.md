...
---
# awesome Sketch [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★60916](https://github.com/sindresorhus/awesome)
...
###### Must-have :heart:
- [Content Generator ★3911](https://github.com/timuric/Content-generator-sketch-plugin)
- [RenameIt ★776](https://github.com/rodi01/RenameIt)
- [Sketch Measure ★4779](https://github.com/utom/sketch-measure)
- [Style Inventory ★1716](https://github.com/getflourish/Sketch-Style-Inventory)
- [Dynamic Button ★1062](https://github.com/ddwht/sketch-dynamic-button)
- [Page Switch ★66 ⏳3Y](https://github.com/mauehara/sketch-page-switch)
- [Sketch Flex Layout ★1700](https://github.com/hrescak/Sketch-Flex-Layout)

###### Nice-to-have :thumbsup:
- [Handy Tools ★121](https://github.com/webpatch/Handy-Tools)
- [Easier.cc](http://easier.cc/) (Files up to 5 MB)
- [User Flow ★1080](https://github.com/abynim/UserFlows)
...
- [Sketch Plugin Directory ★2644](https://github.com/sketchplugins/plugin-directory)
...
- [Teracy Wireframe Kit ★1209 ⏳2Y](https://github.com/teracyhq/wireframe), created to help speed up your wireframing process. Includes basics UI elements for web, mobile and other devices.
