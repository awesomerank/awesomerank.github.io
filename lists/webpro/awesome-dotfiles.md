...
A curated list of dotfiles resources. Inspired by the [awesome ★59088](https://github.com/sindresorhus/awesome) list thing.
...
:--|:--|:--
[Bash it ★6230](https://github.com/Bash-it/bash-it) | Community bash framework. | Autocompletion, themes, aliases, custom functions. Well-structured framework.
...
[Maximum Awesome ★4709](https://github.com/square/maximum-awesome) | Config files for vim and tmux | Vim, tmux. Built for Mac OS X.
[dev-setup ★2783](https://github.com/donnemartin/dev-setup) | Mac OS X development environment setup | Extensive setup of developer tools on OS X.
[webpro's dotfiles ★182](https://github.com/webpro/dotfiles) | macOS dotfiles | Bash, Homebrew, Brew Cask, Git, Node.js, Hammerspoon.

### Zsh

Title | Description | Focus
:--|:--|:--
[thoughtbot dotfiles](https://github.com/thoughtbot/dotfiles) | Set of vim, zsh, git, and tmux configuration files | Zsh, vim, tmux, git, homebrew. Uses [rcm ★1528](https://github.com/thoughtbot/rcm).
...
[Prezto ★7609](https://github.com/sorin-ionescu/prezto) | The configuration framework for Zsh. | Enriches the command line interface environment with sane defaults, aliases, functions, auto completion, and prompt themes.
...
[holman does dotfiles ★4476](https://github.com/holman/dotfiles) | holman does dotfiles | Organized well around topics. Author wants it to work for everyone.
...
[Dries's dotfiles ★149](https://github.com/driesvints/dotfiles) | Simplified approach to dotfiles for macOS | Zsh, Oh My Zsh, macOS, Homebrew, Mackup
...
* [Bork ★155](https://github.com/mattly/bork) - Bash DSL for config management.
* [dotbot ★1116](https://github.com/anishathalye/dotbot) - Tool that bootstraps your dotfiles.
* [dotfiles ★307](https://github.com/jbernard/dotfiles) - Tool to make managing your dotfile symlinks in $HOME easy.
* [Ellipsis ★147](https://github.com/ellipsis/ellipsis) - A package manager for dotfiles.
...
* [homesick ★1889](https://github.com/technicalpickles/homesick) - Your home directory is your castle. Don't leave your dotfiles behind ([article](http://technicalpickles.com/posts/never-leave-your-dotfiles-behind-again-with-homesick/)).
* [mackup ★6060](https://github.com/lra/mackup) - Keep your application settings in sync (OS X/Linux).
* [rcm ★1528](https://github.com/thoughtbot/rcm) - rc file (dotfile) management
...
* [vcsh ★1267](https://github.com/RichiH/vcsh) - Version Control System for $HOME, multiple Git repositories in $HOME.
* [yadm ★331](https://github.com/TheLocehiliosan/yadm) - Tool for managing a collection of files across multiple computers, using a shared Git repository and some additional features.

### macOS

* [Cider ★754](https://github.com/msanders/cider) - Hassle-free bootstrapping with Homebrew.
* [dockutil ★461](https://github.com/kcrawford/dockutil) - Command line tool for managing dock items
* [mas ★3130](https://github.com/mas-cli/mas) - Mac App Store command line interface
...
* [OS X Defaults](https://github.com/kevinSuttle/macOS-Defaults) - Centralized place for the awesome work started by [@mathiasbynens on .osx ★16773](https://github.com/mathiasbynens/dotfiles#sensible-os-x-defaults).

## Related Lists

* [Awesome Shell ★9491](https://github.com/alebcay/awesome-shell) - Curated list of awesome command-line frameworks, toolkits, guides and gizmos.
* [Awesome Zsh Plugins ★2757](https://github.com/unixorn/awesome-zsh-plugins) - List of Zsh plugins suitable for use with oh-my-zsh, antigen & Prezto.
* [Awesome Dev Env ★782](https://github.com/jondot/awesome-devenv) - Curated list of awesome tools, resources and workflow tips making an awesome development environment.

## Archive/abandoned projects

* [Bashstrap ★1444](https://github.com/barryclark/bashstrap)
* [battleschool ★410 ⏳1Y](https://github.com/spencergibb/battleschool)
* [Eduardo's dotfiles ★425](https://github.com/eduardolundgren/dotfiles)
* [Kevin's dotfiles ★48](https://github.com/kdeldycke/dotfiles) 
* [kody ★67 ⏳1Y](https://github.com/jh3y/kody)
