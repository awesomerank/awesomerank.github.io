...
This list covers only Python, as many are already familiar with this language. [Data Science tutorials using R ★873](https://github.com/ujjwalkarn/DataScienceR).
