...
---
# ![Awesome Löve](https://github.com/love2d-community/awesome-love2d/blob/master/logo.png) [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★69735](https://github.com/sindresorhus/awesome)
...
* [anim9 ★17](https://github.com/excessive/anim9) - 3D skeletal animation library (design to be used with IQM and IQE)
...
* [Lovox ★22 ⏳1Y](https://github.com/tjakka5/Lovox) - Pseudo-3D library for working with voxels


## AI
*Navigation, Decision-Making and AI Libraries*

* [Jumper ★416](https://github.com/Yonaba/Jumper) - Grid-based pathfinding library

## Animation
*Animation & Frame-Managing Libraries*

* [andross ★6](https://github.com/pfirsich/andross) - a Lua library for 2D skeletal/bone animations with a Löve backend
* [anim8 ★266](https://github.com/kikito/anim8) - Animation library
* [chiro ★10](https://github.com/bjornbytes/chiro) - Convenience wrapper around [Spine](http://esotericsoftware.com)
* [skeletor ★12 ⏳2Y](https://github.com/pelevesque/skeletor) - 2D skeletal animation system
* [Sodapop ★26](https://github.com/tesselode/sodapop) - Sprite and animation library
* [Walt ★26](https://github.com/davisdude/Walt) - Animation library
* [Lump ★13 ⏳1Y](https://github.com/sixFingers/lump) - Adobe Flash animation runtime
...
* [gamera ★110](https://github.com/kikito/gamera) - Camera system
...
* [STALKER-X ★1](https://github.com/SSYGEN/STALKER-X) - STALKER-X is a camera module for LÖVE
...
* [debugGraph ★16](https://github.com/Mechazawa/Love-Debug-Graph) - Small OO FPS graphing utillity based on FPSGraph
* [Lovebird ★149](https://github.com/rxi/lovebird) - Browser-based debug console
...
* [LoveDebug ★59 ⏳1Y](https://github.com/Ranguna/LOVEDEBUG) - Inline console-like debugger utility
* [lurker ★105 ⏳2Y](https://github.com/rxi/lurker) - Auto-swaps changed Lua files in a running game
* [LÖVE API ★90](https://github.com/love2d-community/love-api) - The complete API documentation of LÖVE in a Lua table
...
* [Artal ★22](https://github.com/unXedDani/Artal) - A .PSD parsing library for LÖVE
* [Autobatch ★39](https://github.com/rxi/autobatch) - Small LÖVE module to automate the use of SpriteBatches
* [HSLUV ★15](https://github.com/hsluv/hsluv-lua) - Lua implementation of HSLuv (a human-friendly alternative to HSL)
* [Maid64 ★18](https://github.com/adekto/maid64) - Low resolution scaler for LÖVE
* [Möan.lua ★35](https://github.com/twentytwoo/Moan.lua) - Multiple-choice VN-esque messagebox library for LÖVE
* [renderplanet ★9](https://github.com/meric/renderplanet) - realistic orthographic planet rendering
* [Sölar ★1](https://github.com/JanWerder/soelar) - a fairly simple solar system simulator
* [svglover ★17](https://github.com/globalcitizen/svglover) - Library to import and display simple SVGs in LÖVE

## Entity
*Entity and Gameobject Managing Libraries*

* [adorbs ★11](https://github.com/JosephShering/adorbs) - Minimal, Functional Entity Component System
* [knife.system](https://github.com/airstruck/knife/blob/master/readme/system.md) - Minimalist functional ECS
* [tiny-ecs ★125 ⏳1Y](https://github.com/bakpakin/tiny-ecs) - Entity Component System for Lua that's simple, flexible, and useful

## <a name="helper"></a>Helper Libraries
*Game specific Library bundles, that provide reuseable functions*

* [astray ★46 ⏳1Y](https://github.com/SiENcE/astray) - Astray is a lua based maze, room and dungeon generation library for dungeon crawlers and roguelike video games
* [hump ★437](https://github.com/vrld/hump) - Collection of tools for developing games with LÖVE (Gamestates, Timers/Tweens, Vectors, Classes, Signals, Cameras)
* [knife ★125](https://github.com/airstruck/knife) - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer)
* [lovely-windows ★3](https://github.com/flamendless/lovely-windows) - A Window/Screen Manager Module for virtual windows.
* [love-state-switcher ★4](https://github.com/nekromoff/love-state-switcher) - State switcher class for Lua LÖVE Engine
* [lue ★27](https://github.com/Ulydev/lue) - lue is a LÖVE library that allows you to display hue color effects in your game
* [lume ★229](https://github.com/rxi/lume) - Collection of functions for Lua, geared towards game development
* [rotLove ★113](https://github.com/paulofmandown/rotLove) - Roguelike Toolkit in Love. A Love2D/lua port of rot.js
* [ScreenManager ★16](https://github.com/rm-code/screenmanager) - Screen/State Management for the LÖVE framework
* [shack ★27 ⏳1Y](https://github.com/Ulydev/shack) - shack is a LÖVE library that lets you easily add screen effects such as shake and rotation
* [Simple Tiled Implementation ★312](https://github.com/karai17/Simple-Tiled-Implementation) - Tiled map loader and renderer
* [Vivid ★31 ⏳2Y](https://github.com/WetDesertRock/vivid) - Color math, manipulation and conversion library

## Input
*Input & Binding Libraries*

* [baton ★37](https://github.com/tesselode/baton) -  Input library for LÖVE that bridges the gap between keyboard and gamepad controls
* [boipushy ★55](https://github.com/SSYGEN/boipushy) - A simple and easy to use input handler
* [love-microphone ★45 ⏳1Y](https://github.com/LPGhatguy/love-microphone) - Simple microphone support for LÖVE
* [tactile ★36](https://github.com/tesselode/tactile) - A straightforward and flexible input library

## Lighting
*Lighting & Shadow Libraries*

* [Shädows ★45](https://github.com/matiasah/shadows) - A Shadows & Lights engine for löve
* [Light World ★156](https://github.com/tanema/light_world.lua) - A lighting model

## Math
*Math specific Libraries*

* [Cirno's Perfect Math Library ★101](https://github.com/excessive/cpml) - Math/intersection library designed for games
* [delaunay ★59 ⏳1Y](https://github.com/Yonaba/delaunay) - Delaunay triangulation for convex polygons
* [MLib ★43](https://github.com/davisdude/mlib) - Math and shape-intersection detection library written in Lua. It's aim is to be robust and easy to use
* [hump.vector](http://hump.readthedocs.io/en/latest/vector.html) - Powerful 2D vector class
* [Bresenham ★3](https://github.com/rm-code/Bresenham) - Bresenham's line algorithm written in Lua

## Music
*Music related libraries*

* [ripple ★15 ⏳1Y](https://github.com/tesselode/ripple) - An audio library for sound effects and music
* [wave ★50 ⏳1Y](https://github.com/Ulydev/wave) - A sound manager with audio parsing and rhythm functionalities
* [denver ★33 ⏳1Y](https://github.com/superzazu/denver.lua) - A Löve custom waveform generation library
...
* [NoobHub ★173](https://github.com/Overtorment/NoobHub) - OpenSource multiplayer and network messaging
* [Sock.lua ★57](https://github.com/camchenry/sock.lua) - A Lua networking library for LÖVE games
...
* [30log ★234](https://github.com/Yonaba/30log) - Minified framework for object-orientation in Lua. It features named (and unnamed) classes, single inheritance and a basic support for mixins
* [classic ★168](https://github.com/rxi/classic) - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction
...
* [middleclass ★892](https://github.com/kikito/middleclass) - Simple OOP library for Lua; has inheritance, metamethods (operators), class variables and weak mixin support (class-commons)

## Performance
*Performance measurement tools*

* [Piefiller ★9](https://github.com/Polynominal/Piefiller) - Graphical profiler for LÖVE
...
* [Bump ★375](https://github.com/kikito/bump.lua) - Collision detection library for Lua
* [HC](http://hc.readthedocs.io/en/latest/) - Collision detection with arbitrary polygons; allows rotation of objects
* [Windfield ★71](https://github.com/SSYGEN/windfield) - Physics module wrapper for LÖVE

## Platforms
*Ports for Platforms other than Windows, Mac and Linux*

* [LoveDos ★431](https://github.com/rxi/lovedos) - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API
* [LoveFTW](https://bitbucket.org/T-BoneISS/l-veftw) - Work-in-progress port to Windows phone 8.1
* [LovePotion ★127](https://github.com/videah/LovePotion) - Unofficial work-in-progress implementation of the LÖVE API for 3DS Homebrew
* [Love.js ★257](https://github.com/TannerRogalsky/love.js) - LÖVE ported to the web using Emscripten
* [LÖVR ★278](https://github.com/bjornbytes/lovr) - LÖVE for virtual reality devices

## Publishing
*Guides to distributing LÖVE games in 3rd party stores*

* [Love-Snap-Template ★14](https://github.com/popey/love-snap-template) - A template for packaging LÖVE games for distribution in the Snappy Store
* [AppImageKit ★2200](https://github.com/AppImage/AppImageKit) - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one game = one file

## Serialization
*Save Game & Storage Libraries*

* [binser ★60](https://github.com/bakpakin/binser) - Customizable Lua Serializer
* [bitser ★50](https://github.com/gvx/bitser) - Serializes and deserializes Lua values with LuaJIT
...
* [Lady ★27 ⏳1Y](https://github.com/gvx/Lady) - Saving and loading savegames; based on Ser
* [Ser ★51 ⏳1Y](https://github.com/gvx/Ser) - Fast, robust, richly-featured table serialization library for Lua
* [Smallfolk ★11 ⏳1Y](https://github.com/gvx/Smallfolk) - A fast, robust, secure, richly-featured table serialization library for Lua
* [trickle ★16 ⏳1Y](https://github.com/bjornbytes/trickle) - A bitstream library focused on high compression for use in networking
...
* [Luassert ★52](https://github.com/Olivine-Labs/luassert) - Extends `assert()` with additional, customizable tests
...
* [Flux ★132 ⏳1Y](https://github.com/rxi/flux) - A fast, lightweight tweening library for Lua
...
* [tween.lua ★271 ⏳1Y](https://github.com/kikito/tween.lua) - Tweening/Easing/Interpolating functions for Lua inspired on jQuery's animate method

## UI
*User Interface Libraries*

* [CatUI ★19 ⏳1Y](https://github.com/wilhantian/catui) - A very light-weight GUI library for LÖVE
* [GOOi ★83](https://github.com/tavuntu/gooi) - Android-oriented GUI library
* [Gspöt ★17](https://github.com/pgimeno/Gspot) - A stateful GUI lib for LÖVE
...
* [cargo ★68](https://github.com/bjornbytes/cargo) - Asset manager
* [chance.lua](http://ejmr.github.io/chance.lua/) - Library for generating random data
* [GifCat ★29 ⏳1Y](https://github.com/WetDesertRock/GifCat) - A simple module for saving gifs from LÖVE
* [i18n ★8 ⏳2Y](https://github.com/excessive/i18n) - Internationalization library designed to help localize your game
* [log.lua ★99](https://github.com/rxi/log.lua) - Library for configurable log output
* [love-loader ★78](https://github.com/kikito/love-loader) - Threaded resource loading
...
* [tick ★19 ⏳1Y](https://github.com/bjornbytes/tick) - Useful timing tweaks for LÖVE's run loop

## Tutorials
*Blogs and tutorials*

* [SSYGEN's ★632](https://github.com/SSYGEN/blog) - A blog by [SSYGEN](https://github.com/SSYGEN) with articles about game development using LÖVE
...
* [Atom](https://atom.io/) - A hackable text editor for the 21st Century
	...
	* [linter-luacheck ★9](https://github.com/AtomLinter/linter-luacheck) - Lint Lua on the fly, using luacheck
...
* [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE
	...
	* [LÖVE IDEA ★30](https://github.com/rm-code/love-IDEA-plugin) - Snippets and code completion for IntelliJ-IDEA
* [Vim](https://vim.sourceforge.io/) - Vim is a highly configurable text editor built to make creating and changing any kind of text very efficient
	* [Vim LOVE Docs ★19](https://github.com/davisdude/vim-love-docs) - Syntax highlighting for Vim
...
* [awesome-lua ★1545](https://github.com/LewisJEllis/awesome-lua) - A list like this one, but more general and encompassing all of Lua's uses
* [awesome-love-shaders ★35 ⏳2Y](https://github.com/karai17/awesome-love-shaders) - A collection of shaders designed to work in LÖVE
* [awesome-pico8 ★684](https://github.com/felipebueno/awesome-PICO-8) - A curated list of PICO-8 resources, tutorials, tools and more

Other awesome lists can be found in the [awesome-awesomeness ★20083](https://github.com/bayandin/awesome-awesomeness) list.
---
<p align="center">
	This list is a copy of <a href="https://github.com/love2d-community/awesome-love2d">love2d-community/awesome-love2d</a> with ranks
</p>
