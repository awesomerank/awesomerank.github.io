...
---
# ![Awesome Löve](https://github.com/love2d-community/awesome-love2d/blob/master/logo.png) [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★73813](https://github.com/sindresorhus/awesome)
...
* [anim8 ★273](https://github.com/kikito/anim8) - Animation library
...
* [LoveDebug ★60 ⏳1Y](https://github.com/Ranguna/LOVEDEBUG) - Inline console-like debugger utility
* [lurker ★105 ⏳2Y](https://github.com/rxi/lurker) - Auto-swaps changed Lua files in a running game
* [LÖVE API ★95](https://github.com/love2d-community/love-api) - The complete API documentation of LÖVE in a Lua table
...
* [Maid64 ★19](https://github.com/adekto/maid64) - Low resolution scaler for LÖVE
...
* [adorbs ★12](https://github.com/JosephShering/adorbs) - Minimal, Functional Entity Component System
* [knife.system](https://github.com/airstruck/knife/blob/master/readme/system.md) - Minimalist functional ECS
* [tiny-ecs ★129 ⏳1Y](https://github.com/bakpakin/tiny-ecs) - Entity Component System for Lua that's simple, flexible, and useful

## <a name="helper"></a>Helper Libraries
*Game specific Library bundles, that provide reuseable functions*

* [astray ★49 ⏳1Y](https://github.com/SiENcE/astray) - Astray is a lua based maze, room and dungeon generation library for dungeon crawlers and roguelike video games
* [hump ★446](https://github.com/vrld/hump) - Collection of tools for developing games with LÖVE (Gamestates, Timers/Tweens, Vectors, Classes, Signals, Cameras)
* [knife ★127](https://github.com/airstruck/knife) - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer)
* [lovely-windows ★3](https://github.com/flamendless/lovely-windows) - A Window/Screen Manager Module for virtual windows.
* [love-state-switcher ★5](https://github.com/nekromoff/love-state-switcher) - State switcher class for Lua LÖVE Engine
...
* [rotLove ★116](https://github.com/paulofmandown/rotLove) - Roguelike Toolkit in Love. A Love2D/lua port of rot.js
...
* [Simple Tiled Implementation ★319](https://github.com/karai17/Simple-Tiled-Implementation) - Tiled map loader and renderer
* [Vivid ★31 ⏳2Y](https://github.com/WetDesertRock/vivid) - Color math, manipulation and conversion library

## Input
*Input & Binding Libraries*

* [baton ★39](https://github.com/tesselode/baton) -  Input library for LÖVE that bridges the gap between keyboard and gamepad controls
* [boipushy ★59](https://github.com/SSYGEN/boipushy) - A simple and easy to use input handler
* [love-microphone ★46](https://github.com/LPGhatguy/love-microphone) - Simple microphone support for LÖVE
* [tactile ★37](https://github.com/tesselode/tactile) - A straightforward and flexible input library

## Lighting
*Lighting & Shadow Libraries*

* [Shädows ★47](https://github.com/matiasah/shadows) - A Shadows & Lights engine for löve
* [Light World ★158](https://github.com/tanema/light_world.lua) - A lighting model

## Math
*Math specific Libraries*

* [Cirno's Perfect Math Library ★101](https://github.com/excessive/cpml) - Math/intersection library designed for games
* [delaunay ★59](https://github.com/Yonaba/delaunay) - Delaunay triangulation for convex polygons
* [MLib ★44](https://github.com/davisdude/mlib) - Math and shape-intersection detection library written in Lua. It's aim is to be robust and easy to use
...
* [wave ★51 ⏳1Y](https://github.com/Ulydev/wave) - A sound manager with audio parsing and rhythm functionalities
...
* [Sock.lua ★59](https://github.com/camchenry/sock.lua) - A Lua networking library for LÖVE games

## <a name="object"></a>Object Orientation
*Object Orientation Libraries that support [Class-Commons ★33 ⏳2Y](https://github.com/bartbes/Class-Commons)*
...
* [classic ★175](https://github.com/rxi/classic) - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction
...
* [Windfield ★73](https://github.com/SSYGEN/windfield) - Physics module wrapper for LÖVE

## Platforms
*Ports for Platforms other than Windows, Mac and Linux*

* [LoveDos ★433](https://github.com/rxi/lovedos) - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API
* [LoveFTW](https://bitbucket.org/T-BoneISS/l-veftw) - Work-in-progress port to Windows phone 8.1
* [LovePotion ★130](https://github.com/videah/LovePotion) - Unofficial work-in-progress implementation of the LÖVE API for 3DS Homebrew
* [Love.js ★269](https://github.com/TannerRogalsky/love.js) - LÖVE ported to the web using Emscripten
* [LÖVR ★282](https://github.com/bjornbytes/lovr) - LÖVE for virtual reality devices
...
* [AppImageKit ★2310](https://github.com/AppImage/AppImageKit) - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one game = one file

## Serialization
*Save Game & Storage Libraries*

* [binser ★62](https://github.com/bakpakin/binser) - Customizable Lua Serializer
* [bitser ★52](https://github.com/gvx/bitser) - Serializes and deserializes Lua values with LuaJIT
...
* [trickle ★17 ⏳1Y](https://github.com/bjornbytes/trickle) - A bitstream library focused on high compression for use in networking
...
* [GOOi ★86](https://github.com/tavuntu/gooi) - Android-oriented GUI library
...
* [SUIT ★240](https://github.com/vrld/SUIT) - small immediate mode GUI library
...
* [tick ★20 ⏳1Y](https://github.com/bjornbytes/tick) - Useful timing tweaks for LÖVE's run loop

## Tutorials
*Blogs and tutorials*

* [SSYGEN's ★638](https://github.com/SSYGEN/blog) - A blog by [SSYGEN](https://github.com/SSYGEN) with articles about game development using LÖVE
...
* [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE
	...
	* [LÖVE IDEA ★32](https://github.com/rm-code/love-IDEA-plugin) - Snippets and code completion for IntelliJ-IDEA
...
* [awesome-love-shaders ★36 ⏳2Y](https://github.com/karai17/awesome-love-shaders) - A collection of shaders designed to work in LÖVE
* [awesome-pico8 ★713](https://github.com/felipebueno/awesome-PICO-8) - A curated list of PICO-8 resources, tutorials, tools and more

Other awesome lists can be found in the [awesome-awesomeness ★20295](https://github.com/bayandin/awesome-awesomeness) list.
---
<p align="center">
	This list is a copy of <a href="https://github.com/love2d-community/awesome-love2d">love2d-community/awesome-love2d</a> with ranks
</p>
