...
* [Jumper ★421](https://github.com/Yonaba/Jumper) - Grid-based pathfinding library
...
* [Lovebird ★153](https://github.com/rxi/lovebird) - Browser-based debug console
...
* [Möan.lua ★41](https://github.com/twentytwoo/Moan.lua) - Multiple-choice VN-esque messagebox library for LÖVE
...
* [lume ★232](https://github.com/rxi/lume) - Collection of functions for Lua, geared towards game development
...
* [30log ★239](https://github.com/Yonaba/30log) - Minified framework for object-orientation in Lua. It features named (and unnamed) classes, single inheritance and a basic support for mixins
...
* [middleclass ★908](https://github.com/kikito/middleclass) - Simple OOP library for Lua; has inheritance, metamethods (operators), class variables and weak mixin support (class-commons)
...
* [Bump ★383](https://github.com/kikito/bump.lua) - Collision detection library for Lua
...
* [Flux ★135 ⏳1Y](https://github.com/rxi/flux) - A fast, lightweight tweening library for Lua
...
* [tween.lua ★278 ⏳1Y](https://github.com/kikito/tween.lua) - Tweening/Easing/Interpolating functions for Lua inspired on jQuery's animate method
...
* [awesome-lua ★1566](https://github.com/LewisJEllis/awesome-lua) - A list like this one, but more general and encompassing all of Lua's uses
