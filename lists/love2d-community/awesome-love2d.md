...
* [LÖVE3D ★121](https://github.com/excessive/love3d) - 3D extensions to LÖVE
* [Lovox ★19](https://github.com/tjakka5/Lovox) - Pseudo-3D library for working with voxels

## AI
*Navigation, Decision-Making and AI Libraries*

* [Jumper ★379](https://github.com/Yonaba/Jumper) - Grid-based pathfinding library
...
* [svglover ★8](https://github.com/globalcitizen/svglover) - Library to import and display simple SVGs in LÖVE

## Entity
*Entity and Gameobject Managing Libraries*

* [adorbs ★8](https://github.com/JosephShering/adorbs) - Minimal, Functional Entity Component System
* [knife.system](https://github.com/airstruck/knife/blob/master/readme/system.md) - Minimalist functional ECS
* [tiny-ecs ★101](https://github.com/bakpakin/tiny-ecs) - Entity Component System for Lua that's simple, flexible, and useful
...
* [hump ★385](https://github.com/vrld/hump) - Collection of tools for developing games with LÖVE (Gamestates, Timers/Tweens, Vectors, Classes, Signals, Cameras)
...
* [Light World ★125](https://github.com/tanema/light_world.lua) - A lighting model
...
* [wave ★44](https://github.com/Ulydev/wave) - A sound manager with audio parsing and rhythm functionalities
* [denver ★27](https://github.com/superzazu/denver.lua) - A Löve custom waveform generation library
...
* [NoobHub ★153](https://github.com/Overtorment/NoobHub) - OpenSource multiplayer and network messaging
...
* [Bump ★304](https://github.com/kikito/bump.lua) - Collision detection library for Lua
...
* [LoveDos ★398](https://github.com/rxi/lovedos) - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API
* [LoveFTW](https://bitbucket.org/T-BoneISS/l-veftw) - Work-in-progress port to Windows phone 8.1
* [LovePotion ★109](https://github.com/videah/LovePotion) - Unofficial work-in-progress implementation of the LÖVE API for 3DS Homebrew
* [Love.js ★180](https://github.com/TannerRogalsky/love.js) - LÖVE ported to the web using Emscripten
* [LÖVR ★73](https://github.com/bjornbytes/lovr) - LÖVE for virtual reality devices
...
* [AppImageKit ★1721](https://github.com/probonopd/AppImageKit) - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one game = one file
...
* [shine ★158](https://github.com/vrld/shine) - Repository of common post-processing effects like blur, vignette, color-grading, etc.
...
* [CatUI ★10](https://github.com/wilhantian/catui) - A very light-weight GUI library for LÖVE
* [GOOi ★59](https://github.com/tavuntu/gooi) - Android-oriented GUI library
...
* [adonaac's ★539](https://github.com/adonaac/blog) - A blog by [adonaac](https://github.com/adonaac) with articles about game development using LÖVE
...
* [Atom](https://atom.io/) - A hackable text editor for the 21st Century
	...
	* [linter-luacheck ★5](https://github.com/AtomLinter/linter-luacheck) - Lint Lua on the fly, using luacheck
...
* [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE
	...
	* [LÖVE IDEA ★24](https://github.com/rm-code/love-IDEA-plugin) - Snippets and code completion for IntelliJ-IDEA
