...
* [LÖVE3D ★128](https://github.com/excessive/love3d) - 3D extensions to LÖVE
...
* [anim8 ★247](https://github.com/kikito/anim8) - Animation library
...
* [tiny-ecs ★115 ⏳1Y](https://github.com/bakpakin/tiny-ecs) - Entity Component System for Lua that's simple, flexible, and useful
...
* [hump ★415](https://github.com/vrld/hump) - Collection of tools for developing games with LÖVE (Gamestates, Timers/Tweens, Vectors, Classes, Signals, Cameras)
* [knife ★111](https://github.com/airstruck/knife) - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer)
...
* [Simple Tiled Implementation ★291](https://github.com/karai17/Simple-Tiled-Implementation) - Tiled map loader and renderer
...
* [Shädows ★30](https://github.com/matiasah/shadows) - A Shadows & Lights engine for löve
* [Light World ★137](https://github.com/tanema/light_world.lua) - A lighting model
...
* [wave ★46 ⏳1Y](https://github.com/Ulydev/wave) - A sound manager with audio parsing and rhythm functionalities
...
* [Sock.lua ★50](https://github.com/camchenry/sock.lua) - A Lua networking library for LÖVE games
...
* [classic ★148 ⏳1Y](https://github.com/rxi/classic) - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction
...
* [Windfield ★58](https://github.com/SSYGEN/windfield) - Physics module wrapper for LÖVE

## Platforms
*Ports for Platforms other than Windows, Mac and Linux*

* [LoveDos ★427](https://github.com/rxi/lovedos) - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API
...
* [Love.js ★229](https://github.com/TannerRogalsky/love.js) - LÖVE ported to the web using Emscripten
...
* [AppImageKit ★1962](https://github.com/AppImage/AppImageKit) - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, debian and derivatives; one game = one file

## Serialization
*Save Game & Storage Libraries*

* [binser ★53](https://github.com/bakpakin/binser) - Customizable Lua Serializer
* [bitser ★45](https://github.com/gvx/bitser) - Serializes and deserializes Lua values with LuaJIT
...
* [shine ★171](https://github.com/vrld/shine) - Repository of common post-processing effects like blur, vignette, color-grading, etc.
...
* [GOOi ★71](https://github.com/tavuntu/gooi) - Android-oriented GUI library
* [Gspöt ★13](https://github.com/pgimeno/Gspot) - A stateful GUI lib for LÖVE
* [LoveFrames Fork](https://github.com/unek/LoveFrames/commits/master) - 0.10 Fork of a GUI library
* [Love Imgui ★100](https://github.com/slages/love-imgui) - imgui module for the LÖVE game engine
...
* [cargo ★57](https://github.com/bjornbytes/cargo) - Asset manager
...
* [SSYGEN's ★606](https://github.com/SSYGEN/blog) - A blog by [SSYGEN](https://github.com/SSYGEN) with articles about game development using LÖVE
...
* [awesome-pico8 ★614](https://github.com/felipebueno/awesome-PICO-8) - A curated list of PICO-8 resources, tutorials, tools and more

Other awesome lists can be found in the [awesome-awesomeness ★19452](https://github.com/bayandin/awesome-awesomeness) list.
---
<p align="center">
	This list is a copy of <a href="https://github.com/love2d-community/awesome-love2d">love2d-community/awesome-love2d</a> with ranks
</p>
