...
* [Git-scribe ★1320 ⏳2Y](https://github.com/schacon/git-scribe): Good for writing ebooks.
...
* Themes
  ...
  * [Alabaster ★376](https://github.com/bitprophet/alabaster): Clean and simple
...
* [Theoretical Physics ★100](https://github.com/certik/theoretical-physics)
...
* [Pico ★2742](https://github.com/picocms/Pico) (`PHP`): Lightweight cms, open source, no database.
...
* [ReText ★734](https://github.com/retext-project/retext) (`Mac`,`Win`,`Linux`): ReText one of the best, even on Linux. It also supports reStructuredText input.
* [Madoko](https://www.madoko.net/) (`Cloud`): **LaTeX** &times; Markdown &sup2;
* [eme ★1650](https://github.com/egoist/eme) (`Win`,`Mac`,`Linux`): Math support.
...
* [ShareLaTeX Source Code ★4663](https://github.com/sharelatex/sharelatex): ShareLaTeX open sourced their codes. This is a great move I would say.
...
* [Scientific Python Lectures ★1977](https://github.com/jrjohansson/scientific-python-lectures)
...
* [KityMinder By Baidu ★2349 ⏳2Y](https://github.com/fex-team/kityminder) : Chinese Interface
* [my-mind](http://my-mind.github.io/): repo [here ★1784](https://github.com/ondras/my-mind).
...
* [mindmaps](http://drichard.org/mindmaps/): repo [here ★1253](https://github.com/drichard/mindmaps)
...
* [jsmind ★540](https://github.com/hizzgdev/jsmind)
* [jsmind](http://sourceforge.net/projects/jsmind/)
* [mindmaps ★1253](https://github.com/drichard/mindmaps)
...
* [Impressionist ★599 ⏳4Y](https://github.com/harish-io/Impressionist)
* [hovercraft ★959](https://github.com/regebro/hovercraft)
...
* [CSSS ★1488](https://github.com/LeaVerou/CSSS)
* [Scrolldeck ★694 ⏳2Y](https://github.com/johnpolacek/scrolldeck.js)
* [Deck.js ★5228](https://github.com/imakewebthings/deck.js)
* [Shower ★3836](https://github.com/shower/shower)
* [HTML5 Rocks](http://slides.html5rocks.com/#formula-outro-slide)
* [Flowtime.js ★1205](https://github.com/marcolago/flowtime.js)
* [Slides ★451 ⏳1Y](https://github.com/briancavalier/slides)
...
* [vim ★11083](https://github.com/vim/vim)(`Free`,`Cross-platform`,`Plugins`): no words can describe the almighty vim.
  * [Vundle ★16614](https://github.com/VundleVim/Vundle.vim): the vim plugin manager
  * [vimrc from amix ★11681](https://github.com/amix/vimrc): "The ultimate Vim configuration: vimrc"
...
* [duecredit ★91](https://github.com/duecredit/duecredit): Allows you to add decorators to Python functions that encode bibliographic details.
...
* [matplotlib ★750](https://github.com/jbmouret/matplotlib_for_papers)
...
* [LaTeXDraw ★157](https://github.com/arnobl/latexdraw)(`Linux`): "A vector drawing editor for LaTeX."
...
* [plot in terminal ★773](https://github.com/glamp/bashplotlib)
* [asciinema](https://asciinema.org/): Command line recording.
* [bashplot ★773](https://github.com/glamp/bashplotlib): plot in terminal.
* [fuck ★248 ⏳2Y](https://github.com/EricFreeman/fuck): correct the command by typing in fuck.
