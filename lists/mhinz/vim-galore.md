...
Or quickly open a cheatsheet from within Vim: [vim-cheat40 ★52](https://github.com/lifepillar/vim-cheat40).
...
[undotree ★704](https://github.com/mbbill/undotree) does a great job at visualizing
it.
...
[FastFold ★249](https://github.com/Konfekt/FastFold), which prevents Vim from
...
[Pathogen ★9309](https://github.com/tpope/vim-pathogen) was the first popular tool for
...
[multiple-cursors ★5455](https://github.com/terryma/vim-multiple-cursors).
...
- [spacevim ★3489](https://github.com/SpaceVim/SpaceVim)
- [spf13 ★10801](https://github.com/spf13/spf13-vim)
...
[xcape ★1082](https://github.com/alols/xcape).
...
| `:set foldmethod=syntax` | If the syntax file is slow already, this makes it even worse. | `:set foldmethod=manual`, `:set foldmethod=marker` or [FastFold ★249](https://github.com/Konfekt/FastFold) |
...
[bracketed-paste ★296](https://github.com/ConradIrwin/vim-bracketed-paste).
