...
## Related Lists
- [awesome-pcaptools ★781](https://github.com/caesar0301/awesome-pcaptools), useful in network traffic analysis.
- [awesome-malware-analysis ★2272](https://github.com/rshipp/awesome-malware-analysis), with some overlap here for artifact analysis.

## <a name="honeypots"></a> Honeypots

- Database Honeypots
    - [MongoDB-HoneyProxy ★43](https://github.com/Plazmaz/MongoDB-HoneyProxy) - A MongoDB honeypot proxy.
    - [Elastic honey ★88 ⏳2Y](https://github.com/jordan-wright/elastichoney) - A Simple Elasticsearch Honeypot.
    - [mysql ★10 ⏳4Y](https://github.com/schmalle/MysqlPot) - A mysql honeypot, still very very early stage.
    - [NoSQLpot ★79](https://github.com/torque59/nosqlpot) - The NoSQL Honeypot Framework.
...
- Web honeypots
    - [Glastopf ★277](https://github.com/mushorg/glastopf) - Web Application Honeypot.
    - Snare/Tanner - successors to Glastopf
      - [Snare ★52](https://github.com/mushorg/snare) - Super Next generation Advanced Reactive honEypot
      - [Tanner ★27](https://github.com/mushorg/tanner) - Evaluating SNARE events
    - [phpmyadmin_honeypot ★31 ⏳2Y](https://github.com/gfoss/phpmyadmin_honeypot) - - A simple and effective phpMyAdmin honeypot.
    ...
    - WordPress honeypots
        ...
        - [HoneyPress ★49](https://github.com/dustyfresh/HoneyPress) - python based WordPress honeypot in a docker container.
        ...
        - [wordpot ★101 ⏳2Y](https://github.com/gbrindisi/wordpot) - A WordPress Honeypot.
...
- Service Honeypots
    ...
    - [HoneyPy ★227](https://github.com/foospidy/HoneyPy) - A low interaction honeypot.
    - [Ensnare ★66](https://github.com/ahoernecke/ensnare) - Easy to deploy Ruby honeypot.
    - [RDPy ★573 ⏳1Y](https://github.com/citronneur/rdpy) - A Microsoft Remote Desktop Protocol (RDP) honeypot in python.
...
- ICS/SCADA honeypots
    - [Conpot ★338](https://github.com/mushorg/conpot) - ICS/SCADA honeypot.
    - [gridpot ★22 ⏳2Y](https://github.com/sk4ld/gridpot) - Open source tools for realistic-behaving electric grid honeynets .
...
- Other/random
    ...
    - [OpenCanary ★233](https://github.com/thinkst/opencanary) - Modular and decentralised honeypot.

- Botnet C2 tools
    - [Hale ★75 ⏳5Y](https://github.com/pjlantz/Hale) - Botnet command &amp; control monitor.
...
- Distributed sensor deployment
    ...
    - [Modern Honey Network ★1173](https://github.com/threatstream/mhn) - Multi-snort and honeypot sensor management, uses a network of VMs, small footprint SNORT installations, stealthy dionaeas, and a centralized server for management.
...
- System instrumentation
    ...
    - [Fibratus ★373](https://github.com/rabbitstack/fibratus) - tool for exploration and tracing of the Windows kernel.
...
- VM monitoring and tools
    ...
    - [Antivmdetect ★187](https://github.com/nsmfoo/antivmdetection) - Script to create templates to use with VirtualBox to make vm detection harder.
    - [VMCloak ★181](https://github.com/jbremer/vmcloak) - Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
...
- Mobile Analysis Tool
    - [APKinspector ★494 ⏳4Y](https://github.com/honeynet/apkinspector) - APKinspector is a powerful GUI tool for analysts to analyze the Android applications.
    - [Androguard ★1558](https://github.com/androguard/androguard) - Reverse engineering, Malware and goodware analysis of Android applications ... and more.
...
- Server
    ...
    - [Artillery ★273](https://github.com/trustedsec/artillery) - open-source blue team tool designed to protect Linux and Windows operating systems through multiple methods.
    ...
    - [Hontel ★52](https://github.com/stamparm/hontel) - Telnet Honeypot.
    - [MTPot](https://github.com/CymmetriaResearch/MTPot) - Open Source Telnet Honeypot, focused on Mirai malware.
    - [Heralding ★107](https://github.com/johnnykv/heralding) - A credentials catching honeypot.
    - [vnclowpot ★4](https://github.com/magisterquis/vnclowpot) - A low interaction VNC honeypot.
    - [SIREN ★3](https://github.com/blaverick62/SIREN) - Semi-Intelligent HoneyPot Network - HoneyNet Intelligent Virtual Environment.
    - [telnetlogger ★155](https://github.com/robertdavidgraham/telnetlogger) - A Telnet honeypot designed to track the Mirai botnet.
...
- Data Collection / Data Sharing
    ...
    - [HPFeeds ★134](https://github.com/rep/hpfeeds) - lightweight authenticated publish-subscribe protocol.
...
- Client
    ...
    - [PhoneyC ★12 ⏳2Y](https://github.com/honeynet/phoneyc)
    - [Jsunpack-n ★72 ⏳2Y](https://github.com/urule99/jsunpack-n)
...
- PDF document inspector
    - [peepdf ★236](https://github.com/jesparza/peepdf)
...
- SSH Honeypots
    ...
    - [Kippo ★909](https://github.com/desaster/kippo) - Medium interaction SSH honeypot
    ...
    - [Cowrie ★1177](https://github.com/micheloosterhof/cowrie) - Cowrie SSH Honeypot (based on kippo)
    ...
    - [ssh-honeypot ★97](https://github.com/droberson/ssh-honeypot) - Fake sshd that logs ip addresses, usernames, and passwords.    
...
- SSH proxy
    - [HonSSH ★144](https://github.com/tnich/honssh)
...
- Spamtrap
    - [Mailoney ★108](https://github.com/awhitehatter/mailoney) - SMTP honeypot, Open Relay, Cred Harvester written in python.
    ...
    - [Shiva ★91 ⏳1Y](https://github.com/shiva-spampot/shiva) - Spam Honeypot with Intelligent Virtual Analyzer
...
- Dockerized Low Interaction packaging
    ...
    - [Dockerpot ★97 ⏳2Y](https://github.com/mrschyte/dockerpot) A docker based honeypot.
...
- IOT Honeypot
    - [HoneyThing ★47 ⏳1Y](https://github.com/omererdem/honeything) - TR-069 Honeypot

- Honeytokens
    - [Honeybits ★46](https://github.com/0x4D31/honeybits) - A tool that can be used to create and place breadcrumbs and honeytokens to lead the attackers to honeypots (in production environment)
    - [CanaryTokens ★126](https://github.com/thinkst/canarytokens)
    - [dcept ★360](https://github.com/secureworks/dcept) - A tool for deploying and detecting use of Active Directory honeytokens
...
- Sandbox
    ...
    - [dorothy2 ★167 ⏳2Y](https://github.com/m4rco-/dorothy2) - A malware/botnet analysis framework written in Ruby
    - [COMODO automated sandbox](https://help.comodo.com/topic-72-1-451-4768-.html)
    - [Argos](http://www.few.vu.nl/argos/) - An emulator for capturing zero-day attacks
    - [libemu ★20](https://github.com/buffer/libemu) - Shellcode emulation library, useful for shellcode detection.
...
- Front Ends
    - [Tango ★193](https://github.com/aplura/Tango) - Honeypot Intelligence with Splunk.
    ...
    - [DionaeaFR ★35 ⏳2Y](https://github.com/rubenespadas/DionaeaFR) - Front Web to Dionaea low-interaction honeypot.
...
- Visualization
    ...
    - [HoneyMap ★174](https://github.com/fw42/honeymap) - Real-time websocket stream of GPS events on a fancy SVG world map. 
...
- [Honeypot (Dionaea and kippo) setup script ★61](https://github.com/andrewmichaelsmith/honeypot-setup-script)
