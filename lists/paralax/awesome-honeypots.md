...
## Related Lists
- [awesome-pcaptools ★1051](https://github.com/caesar0301/awesome-pcaptools), useful in network traffic analysis.
- [awesome-malware-analysis ★3040](https://github.com/rshipp/awesome-malware-analysis), with some overlap here for artifact analysis.

## <a name="honeypots"></a> Honeypots

- Database Honeypots
    - [MongoDB-HoneyProxy ★52](https://github.com/Plazmaz/MongoDB-HoneyProxy) - A MongoDB honeypot proxy.
    - [Elastic honey ★101 ⏳2Y](https://github.com/jordan-wright/elastichoney) - A Simple Elasticsearch Honeypot.
    - [mysql ★13 ⏳5Y](https://github.com/schmalle/MysqlPot) - A mysql honeypot, still very very early stage.
    - [NoSQLpot ★86](https://github.com/torque59/nosqlpot) - The NoSQL Honeypot Framework.
    - [ESPot ★10 ⏳3Y](https://github.com/mycert/ESPot) - An Elasticsearch honeypot written in NodeJS, to capture every attempts to exploit CVE-2014-3120.
    - [Delilah ★28 ⏳2Y](https://github.com/Novetta/delilah) - An Elasticsearch Honeypot written in Python.
    - [mysql-honeypotd ★3](https://github.com/sjinks/mysql-honeypotd) - Low interaction MySQL honeypot written in C.

- Web honeypots
    - [Glastopf ★313 ⏳1Y](https://github.com/mushorg/glastopf) - Web Application Honeypot.
    - Snare/Tanner - successors to Glastopf
      - [Snare ★70](https://github.com/mushorg/snare) - Super Next generation Advanced Reactive honEypot
      - [Tanner ★41](https://github.com/mushorg/tanner) - Evaluating SNARE events
    - [phpmyadmin_honeypot ★37 ⏳2Y](https://github.com/gfoss/phpmyadmin_honeypot) - - A simple and effective phpMyAdmin honeypot.
    - [Nodepot ★20 ⏳2Y](https://github.com/schmalle/Nodepot)  - A nodejs web application honeypot.
    ...
    - [Servletpot ★7 ⏳4Y](https://github.com/schmalle/servletpot) - Web application Honeypot.
    ...
    - [Laravel Application Honeypot ★298](https://github.com/msurguy/Honeypot) - Honeypot - Simple spam prevention package for Laravel applications.
    ...
    - WordPress honeypots
        ...
        - [wordpot ★111 ⏳2Y](https://github.com/gbrindisi/wordpot) - A WordPress Honeypot.

- Service Honeypots
    - [honeyntp ★36 ⏳3Y](https://github.com/fygrave/honeyntp) - NTP logger/honeypot.
    - [honeypot-camera ★32 ⏳2Y](https://github.com/alexbredo/honeypot-camera) - observation camera honeypot.
    - [troje ★34 ⏳3Y](https://github.com/dutchcoders/troje) - a honeypot built around lxc containers. It will run each connection with the service within a seperate lxc container.
    - [HoneyPy ★266](https://github.com/foospidy/HoneyPy) - A low interaction honeypot.
    - [Ensnare ★67](https://github.com/ahoernecke/ensnare) - Easy to deploy Ruby honeypot.
    - [RDPy ★717](https://github.com/citronneur/rdpy) - A Microsoft Remote Desktop Protocol (RDP) honeypot in python.
    - [Honeyprint ★8 ⏳1Y](https://github.com/glaslos/honeyprint) - Printer honeypot.
    - [Tom's Honeypot ★9 ⏳2Y](https://github.com/inguardians/toms_honeypot) - Low interaction Python honeypot.
    - [Honeyport ★19](https://github.com/securitygeneration/Honeyport) - A simple honeyport written in Bash and Python.
    - [AMTHoneypot ★5](https://github.com/packetflare/amthoneypot) - Honeypot for Intel's AMT Firmware Vulnerability CVE-2017-5689.
    - [Lyrebird](https://hub.docker.com/r/lyrebird/honeypot-base/) - A modern high-interaction honeypot framework.

- Distributed Honeypots
    - [DemonHunter ★13](https://github.com/RevengeComing/DemonHunter) - Low interaction Honepot Server.

- Anti-honeypot stuff
    - [kippo_detect ★38 ⏳3Y](https://github.com/andrew-morris/kippo_detect) - This is not a honeypot, but it detects kippo. (This guy has lots of more interesting stuff)

- ICS/SCADA honeypots
    - [Conpot ★388](https://github.com/mushorg/conpot) - ICS/SCADA honeypot.
    - [gridpot ★28 ⏳2Y](https://github.com/sk4ld/gridpot) - Open source tools for realistic-behaving electric grid honeynets .
...
- Other/random
    - [NOVA ★42 ⏳2Y](https://github.com/DataSoft/Nova) uses honeypots as detectors, looks like a complete system.
    ...
    - [OpenCanary ★273](https://github.com/thinkst/opencanary) - Modular and decentralised honeypot.
    - [DSHP ★2 ⏳1Y](https://github.com/naorlivne/dshp) - Damn Simple HoneyPot with pluggable handlers.

- Botnet C2 tools
    - [Hale ★88](https://github.com/pjlantz/Hale) - Botnet command &amp; control monitor.
...
- IPv6 attack detection tool
    - [ipv6-attack-detector ★19](https://github.com/mzweilin/ipv6-attack-detector)  - Google Summer of Code 2012 project, supported by The Honeynet Project organization.
...
- Distributed sensor deployment
    ...
    - [Modern Honey Network ★1327](https://github.com/threatstream/mhn) - Multi-snort and honeypot sensor management, uses a network of VMs, small footprint SNORT installations, stealthy dionaeas, and a centralized server for management.
...
- Low interaction honeypot (router back door)
    - [Honeypot-32764 ★8 ⏳3Y](https://github.com/knalli/honeypot-for-tcp-32764) - Honeypot for router backdoor (TCP 32764).
...
- Honeypot for USB-spreading malware
    - [Ghost-usb ★45 ⏳2Y](https://github.com/honeynet/ghost-usb-honeypot) -  honeypot for malware that propagates via USB storage devices.
...
- VM monitoring and tools
    ...
    - [Antivmdetect ★218](https://github.com/nsmfoo/antivmdetection) - Script to create templates to use with VirtualBox to make vm detection harder.
    - [VMCloak ★212](https://github.com/jbremer/vmcloak) - Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
...
- Mobile Analysis Tool
    - [APKinspector ★547 ⏳4Y](https://github.com/honeynet/apkinspector) - APKinspector is a powerful GUI tool for analysts to analyze the Android applications.
    - [Androguard ★1815](https://github.com/androguard/androguard) - Reverse engineering, Malware and goodware analysis of Android applications ... and more.
...
- Server
    ...
    - [UDPot Honeypot ★25 ⏳3Y](https://github.com/jekil/UDPot) - Simple UDP / DNS honeypot scripts.
    ...
    - [slipm-honeypot ★6 ⏳4Y](https://github.com/rshipp/slipm-honeypot) - A simple low-interaction port monitoring honeypot.
    ...
    - [TelnetHoney ★4 ⏳2Y](https://github.com/AnguisCaptor/TelnetHoney) - A simple telnet honeypot.
    - [Hontel ★81](https://github.com/stamparm/hontel) - Telnet Honeypot.
    - [MTPot ★82](https://github.com/Cymmetria/MTPot) - Open Source Telnet Honeypot, focused on Mirai malware.
    - [Heralding ★135](https://github.com/johnnykv/heralding) - A credentials catching honeypot.
    - [vnclowpot ★8](https://github.com/magisterquis/vnclowpot) - A low interaction VNC honeypot.
    - [SIREN ★4](https://github.com/blaverick62/SIREN) - Semi-Intelligent HoneyPot Network - HoneyNet Intelligent Virtual Environment.
    - [telnetlogger ★168](https://github.com/robertdavidgraham/telnetlogger) - A Telnet honeypot designed to track the Mirai botnet.
    - [honeytrap ★63](https://github.com/tillmannw/honeytrap) - a low-interaction honeypot and network security tool written to catch attacks against TCP and UDP services. 
    ...
    - [portlurker ★2](https://github.com/bartnv/portlurker) - Port listener / honeypot in Rust with protocol guessing and safe string display.
    - [arctic-swallow ★0](https://github.com/ajackal/arctic-swallow) - a low interaction honeypot.
    - [glutton ★67](https://github.com/mushorg/glutton) - All eating honeypot.
...
- Data Collection / Data Sharing
    ...
    - [HPFeeds ★144 ⏳1Y](https://github.com/rep/hpfeeds) - lightweight authenticated publish-subscribe protocol.
...
- Client
    - [Pwnypot ★28 ⏳4Y](https://github.com/shjalayeri/pwnypot) - High Interaction Client Honeypot
    ...
    - [Jsunpack-n ★89 ⏳2Y](https://github.com/urule99/jsunpack-n)
    ...
    - [YALIH (Yet Another Low Interaction Honeyclient) ★42 ⏳1Y](https://github.com/Masood-M/yalih) - a low Interaction Client honeypot designed to detect malicious websites through signature, anomaly and pattern matching techniques
...
- PDF document inspector
    - [peepdf ★286](https://github.com/jesparza/peepdf)
...
- SSH Honeypots
    ...
    - [Kippo ★998 ⏳1Y](https://github.com/desaster/kippo) - Medium interaction SSH honeypot
       - [LongTail Log Analysis @ Marist College](http://longtail.it.marist.edu/honey/) - analyzed SSH honeypot logs
    - [Cowrie ★1379](https://github.com/micheloosterhof/cowrie) - Cowrie SSH Honeypot (based on kippo)
    - [sshlowpot ★5](https://github.com/magisterquis/sshlowpot) - Yet another no-frills low-interaction ssh honeypot in Go.    
    - [sshhipot ★114](https://github.com/magisterquis/sshhipot) - High-interaction MitM SSH honeypot
    ...
    - [ssh-honeypot ★133](https://github.com/droberson/ssh-honeypot) - Fake sshd that logs ip addresses, usernames, and passwords.
    ...
    - [sshesame ★818 ⏳1Y](https://github.com/jaksi/sshesame) - A fake SSH server that lets everyone in and logs their activity.
...
- Client Web crawler
    - [HoneySpider Network ★21 ⏳1Y](https://github.com/CERT-Polska/hsn2-bundle)
...
- SSH proxy
    - [HonSSH ★252](https://github.com/tnich/honssh)
...
- Spamtrap
    - [Mailoney ★120](https://github.com/awhitehatter/mailoney) - SMTP honeypot, Open Relay, Cred Harvester written in python.
    ...
    - [Shiva ★98 ⏳1Y](https://github.com/shiva-spampot/shiva) - Spam Honeypot with Intelligent Virtual Analyzer
...
- Server (Bluetooth)
    - [Bluepot ★80 ⏳1Y](https://github.com/andrewmichaelsmith/bluepot)
...
- Dockerized Low Interaction packaging
    ...
    - [Dockerized Thug](https://hub.docker.com/r/honeynet/thug/) - A dockerized [Thug ★621](https://github.com/buffer/thug) to analyze malicious web content.
    - [Dockerpot ★106 ⏳2Y](https://github.com/mrschyte/dockerpot) - A docker based honeypot.
    - [Docker honeynet ★12 ⏳3Y](https://github.com/sreinhardt/Docker-Honeynet) - Several Honeynet tools set up for Docker containers.
    - [mhn-core-docker ★10](https://github.com/MattCarothers/mhn-core-docker) - Core elements of the Modern Honey Network implemented in Docker.
...
- IOT Honeypot
    - [HoneyThing ★53 ⏳1Y](https://github.com/omererdem/honeything) - TR-069 Honeypot

- Honeytokens
    - [Honeyλ ★349](https://github.com/0x4D31/honeylambda) - honeyLambda 'serverless trap' is a simple, serverless application designed to create and monitor URL honeytokens, on top of AWS Lambda and Amazon API Gateway.
    - [Honeybits ★90](https://github.com/0x4D31/honeybits) - A simple tool designed to enhance the effectiveness of your traps by spreading breadcrumbs & honeytokens across your production servers and workstations to lure the attacker toward your honeypots.
    - [CanaryTokens ★189](https://github.com/thinkst/canarytokens) - 
    - [dcept ★381 ⏳1Y](https://github.com/secureworks/dcept) - A tool for deploying and detecting use of Active Directory honeytokens.
...
- Sandbox
    ...
    - [dorothy2 ★174 ⏳3Y](https://github.com/m4rco-/dorothy2) - A malware/botnet analysis framework written in Ruby
    - [COMODO automated sandbox](https://help.comodo.com/topic-72-1-451-4768-.html)
    - [Argos](http://www.few.vu.nl/argos/) - An emulator for capturing zero-day attacks
    - [libemu ★30 ⏳1Y](https://github.com/buffer/libemu) - Shellcode emulation library, useful for shellcode detection.
    - [Pylibemu ★92 ⏳1Y](https://github.com/buffer/pylibemu) - A Libemu Cython wrapper.
    - [imalse ★5 ⏳4Y](https://github.com/hbhzwj/imalse) - Integrated MALware Simulator and Emulator.
...
- Front Ends
    - [Tango ★200](https://github.com/aplura/Tango) - Honeypot Intelligence with Splunk.
    ...
    - [DionaeaFR ★36](https://github.com/rubenespadas/DionaeaFR) - Front Web to Dionaea low-interaction honeypot.
...
- Visualization
    ...
    - [HoneyMap ★186 ⏳1Y](https://github.com/fw42/honeymap) - Real-time websocket stream of GPS events on a fancy SVG world map. 
    - [HoneyMalt ★10 ⏳3Y](https://github.com/SneakersInc/HoneyMalt) - Maltego tranforms for mapping Honeypot systems.
    - [Glastopf Analytics ★0 ⏳2Y](https://github.com/katkad/Glastopf-Analytics) - easy honeypot statistics
...
- [Honeypot (Dionaea and kippo) setup script ★68 ⏳1Y](https://github.com/andrewmichaelsmith/honeypot-setup-script)
...
- Deployment
    ...
    - [honeypotpi ★14 ⏳3Y](https://github.com/free5ty1e/honeypotpi) - Script for turning a Raspberry Pi into a HoneyPot Pi
