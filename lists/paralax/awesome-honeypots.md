...
## Related Lists
- [awesome-pcaptools ★1025](https://github.com/caesar0301/awesome-pcaptools), useful in network traffic analysis.
- [awesome-malware-analysis ★2937](https://github.com/rshipp/awesome-malware-analysis), with some overlap here for artifact analysis.

## <a name="honeypots"></a> Honeypots

- Database Honeypots
    - [MongoDB-HoneyProxy ★47](https://github.com/Plazmaz/MongoDB-HoneyProxy) - A MongoDB honeypot proxy.
    - [Elastic honey ★96 ⏳2Y](https://github.com/jordan-wright/elastichoney) - A Simple Elasticsearch Honeypot.
...
- Web honeypots
    ...
    - Snare/Tanner - successors to Glastopf
      - [Snare ★66](https://github.com/mushorg/snare) - Super Next generation Advanced Reactive honEypot
    ...
    - WordPress honeypots
        ...
        - [wordpot ★108 ⏳2Y](https://github.com/gbrindisi/wordpot) - A WordPress Honeypot.
...
- Service Honeypots
    ...
    - [HoneyPy ★262](https://github.com/foospidy/HoneyPy) - A low interaction honeypot.
    - [Ensnare ★67](https://github.com/ahoernecke/ensnare) - Easy to deploy Ruby honeypot.
    - [RDPy ★682 ⏳2Y](https://github.com/citronneur/rdpy) - A Microsoft Remote Desktop Protocol (RDP) honeypot in python.
    ...
    - [AMTHoneypot ★4](https://github.com/packetflare/amthoneypot) - Honeypot for Intel's AMT Firmware Vulnerability CVE-2017-5689.
...
- Anti-honeypot stuff
    - [kippo_detect ★36 ⏳3Y](https://github.com/andrew-morris/kippo_detect) - This is not a honeypot, but it detects kippo. (This guy has lots of more interesting stuff)
...
- Botnet C2 tools
    - [Hale ★85](https://github.com/pjlantz/Hale) - Botnet command &amp; control monitor.
...
- Distributed sensor deployment
    ...
    - [Modern Honey Network ★1317](https://github.com/threatstream/mhn) - Multi-snort and honeypot sensor management, uses a network of VMs, small footprint SNORT installations, stealthy dionaeas, and a centralized server for management.
...
- Mobile Analysis Tool
    - [APKinspector ★540 ⏳4Y](https://github.com/honeynet/apkinspector) - APKinspector is a powerful GUI tool for analysts to analyze the Android applications.
    - [Androguard ★1772](https://github.com/androguard/androguard) - Reverse engineering, Malware and goodware analysis of Android applications ... and more.
...
- Server
    ...
    - [Artillery ★280](https://github.com/trustedsec/artillery) - open-source blue team tool designed to protect Linux and Windows operating systems through multiple methods.
    ...
    - [TelnetHoney ★4 ⏳1Y](https://github.com/AnguisCaptor/TelnetHoney) - A simple telnet honeypot.
    - [Hontel ★73](https://github.com/stamparm/hontel) - Telnet Honeypot.
    - [MTPot ★82](https://github.com/Cymmetria/MTPot) - Open Source Telnet Honeypot, focused on Mirai malware.
    - [Heralding ★126](https://github.com/johnnykv/heralding) - A credentials catching honeypot.
    ...
    - [glutton ★64](https://github.com/mushorg/glutton) - All eating honeypot.
...
- Client
    - [Pwnypot ★27 ⏳4Y](https://github.com/shjalayeri/pwnypot) - High Interaction Client Honeypot
    ...
    - [Jsunpack-n ★88 ⏳2Y](https://github.com/urule99/jsunpack-n)
...
- PDF document inspector
    - [peepdf ★281](https://github.com/jesparza/peepdf)
...
- SSH Honeypots
    ...
    - [sshhipot ★115](https://github.com/magisterquis/sshhipot) - High-interaction MitM SSH honeypot
...
- SSH proxy
    - [HonSSH ★250](https://github.com/tnich/honssh)
...
- Spamtrap
    ...
    - [Shiva ★96 ⏳1Y](https://github.com/shiva-spampot/shiva) - Spam Honeypot with Intelligent Virtual Analyzer
...
- Dockerized Low Interaction packaging
    ...
    - [Dockerized Thug](https://hub.docker.com/r/honeynet/thug/) - A dockerized [Thug ★613](https://github.com/buffer/thug) to analyze malicious web content.
    ...
    - [mhn-core-docker ★8](https://github.com/MattCarothers/mhn-core-docker) - Core elements of the Modern Honey Network implemented in Docker.
...
- Honeytokens
    - [Honeyλ ★347](https://github.com/0x4D31/honeylambda) - honeyLambda 'serverless trap' is a simple, serverless application designed to create and monitor URL honeytokens, on top of AWS Lambda and Amazon API Gateway.
    ...
    - [CanaryTokens ★183](https://github.com/thinkst/canarytokens) - 
    - [dcept ★378 ⏳1Y](https://github.com/secureworks/dcept) - A tool for deploying and detecting use of Active Directory honeytokens.
...
- Sandbox
    ...
    - [Pylibemu ★91 ⏳1Y](https://github.com/buffer/pylibemu) - A Libemu Cython wrapper.
