...
---
# Machine Learning & Deep Learning Tutorials [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)

- This repository contains a topic-wise curated list of Machine Learning and Deep Learning tutorials, articles and other resources. Other awesome lists can be found in this [list ★59088](sindresorhus/awesome).
...
- [Curated list of R tutorials for Data Science, NLP and Machine Learning ★637](ujjwalkarn/DataScienceR).

- [Curated list of Python tutorials for Data Science, NLP and Machine Learning ★2514](ujjwalkarn/DataSciencePython).
...
- [Machine Learning for Software Engineers ★14945](ZuzooVn/machine-learning-for-software-engineers)

- [Dive into Machine Learning ★6649](hangtwenty/dive-into-machine-learning)

- [A curated list of awesome Machine Learning frameworks, libraries and software ★22923](josephmisiti/awesome-machine-learning)

- [A curated list of awesome data visualization libraries and resources. ★991](fasouto/awesome-dataviz)
...
- [List of Machine Learning University Courses ★19415](prakhar1989/awesome-courses#machine-learning)
...
- [TheAnalyticsEdge edX Notes and Codes ★12 ⏳2Y](pedrosan/TheAnalyticsEdge)

- [In-depth introduction to machine learning in 15 hours of expert videos](http://www.dataschool.io/15-hours-of-expert-machine-learning-videos/)

- [Have Fun With Machine Learning ★4174](humphd/have-fun-with-machine-learning)
...
- [Awesome Artificial Intelligence (GitHub Repo) ★2510](owainlewis/awesome-artificial-intelligence)
...
- [Genetic Programming](https://en.wikipedia.org/wiki/Genetic_programming)
    ...
    - [Genetic Programming in Python (GitHub) ★348](trevorstephens/gplearn)
...
- [Learn Statistics Using Python ★421 ⏳1Y](rouseguy/intro2stats) - Learn Statistics using an application-centric programming approach
...
- [Machine Learning Cheat Sheet ★1843](soulmachine/machine-learning-cheat-sheet)
...
- [A curated list of awesome Deep Learning tutorials, projects and communities ★4627](ChristosChristofidis/awesome-deep-learning)
...
- [Introduction to Deep Learning Using Python (GitHub) ★115 ⏳1Y](rouseguy/intro2deeplearning), [Good Introduction Slides](https://speakerdeck.com/bargava/introduction-to-deep-learning)
...
- Deep Learning Frameworks
    ...
    - [Theano](https://en.wikipedia.org/wiki/Theano_(software))
        ...
        - [All Codes ★2789](lisa-lab/DeepLearningTutorials)
        
        - [Deep Learning Implementation Tutorials - Keras and Lasagne ★275](vict0rsch/deep_learning)

    - [Torch](http://torch.ch/)
    
        - [Torch ML Tutorial](http://code.madbits.com/wiki/doku.php), [Code ★554](torch/tutorials)
        
        - [Intro to Torch](http://ml.informatik.uni-freiburg.de/_media/teaching/ws1415/presentation_dl_lect3.pdf)
        
        - [Learning Torch GitHub Repo ★27 ⏳1Y](chetannaik/learning_torch)
        
        - [Awesome-Torch (Repository on GitHub) ★434](carpedm20/awesome-torch)
    ...
    - TensorFlow
        ...
        - [TensorFlow Examples for Beginners ★11431](aymericdamien/TensorFlow-Examples)
        
        - [Stanford Tensorflow for Deep Learning Research Course](https://web.stanford.edu/class/cs20si/syllabus.html)
        
            - [GitHub Repo ★1440](chiphuyen/tf-stanford-tutorials)
            
        - [Simplified Scikit-learn Style Interface to TensorFlow ★2978](tensorflow/skflow)
        
        - [Learning TensorFlow GitHub Repo ★10 ⏳1Y](chetannaik/learning_tensorflow)
        
        - [Benchmark TensorFlow GitHub](https://github.com/soumith/convnet-benchmarks/issues/66)
        
        - [Awesome TensorFlow List ★7574](jtoy/awesome-tensorflow)
        
        - [TensorFlow Book ★2587](BinRoot/TensorFlow-Book)
        ...
        - [Android TensorFlow Machine Learning Example](https://blog.mindorks.com/android-tensorflow-machine-learning-example-ff0e9b2654cc)
            ...
            - [GitHub Repo ★446](MindorksOpenSource/AndroidTensorFlowMachineLearningExample)
...
- Feed Forward Networks
    ...
    - [Implementing a Neural Network from scratch](http://www.wildml.com/2015/09/implementing-a-neural-network-from-scratch/), [Code ★645](dennybritz/nn-from-scratch)
    
    - [Speeding up your Neural Network with Theano and the gpu](http://www.wildml.com/2015/09/speeding-up-your-neural-network-with-theano-and-the-gpu/), [Code ★51 ⏳1Y](dennybritz/nn-theano)
...
- Recurrent and LSTM Networks
    - [awesome-rnn: list of resources (GitHub Repo) ★3705](kjw0612/awesome-rnn)
    
    - [Recurrent Neural Net Tutorial Part 1](http://www.wildml.com/2015/09/recurrent-neural-networks-tutorial-part-1-introduction-to-rnns/), [Part 2](http://www.wildml.com/2015/09/recurrent-neural-networks-tutorial-part-2-implementing-a-language-model-rnn-with-python-numpy-and-theano/), [Part 3](http://www.wildml.com/2015/10/recurrent-neural-networks-tutorial-part-3-backpropagation-through-time-and-vanishing-gradients/), [Code ★517](dennybritz/rnn-tutorial-rnnlm)
    
    - [NLP RNN Representations](http://colah.github.io/posts/2014-07-NLP-RNNs-Representations/)
    
    - [The Unreasonable effectiveness of RNNs](http://karpathy.github.io/2015/05/21/rnn-effectiveness/), [Torch Code ★5758](karpathy/char-rnn), [Python Code](https://gist.github.com/karpathy/d4dee566867f8291f086)
    ...
    - [Music generation using RNNs (Keras) ★559 ⏳1Y](MattVitelli/GRUV)
    ...
    - Long Short Term Memory (LSTM)
        ...
        - [Implementing LSTM from scratch](http://www.wildml.com/2015/10/recurrent-neural-network-tutorial-part-4-implementing-a-grulstm-rnn-with-python-and-theano/), [Python/Theano code ★265 ⏳1Y](dennybritz/rnn-tutorial-gru-lstm)
        
        - [Torch Code for character-level language models using LSTM ★5758](karpathy/char-rnn)
        
        - [LSTM for Kaggle EEG Detection competition (Torch Code) ★56 ⏳1Y](apaszke/kaggle-grasp-and-lift)
        
        - [LSTM for Sentiment Analysis in Theano](http://deeplearning.net/tutorial/lstm.html#lstm)
        
        - [Deep Learning for Visual Q&A | LSTM | CNN](http://avisingh599.github.io/deeplearning/visual-qa/), [Code ★340](avisingh599/visual-qa)
        ...
        - [Torch code for Visual Question Answering using a CNN+LSTM model ★454 ⏳1Y](abhshkdz/neural-vqa)
...
- Convolutional Neural Networks
    ...
    - [Awesome Deep Vision: List of Resources (GitHub) ★4285](kjw0612/awesome-deep-vision)
    ...
    - [Stanford Notes](http://vision.stanford.edu/teaching/cs231n/), [Codes](http://cs231n.github.io/), [GitHub ★2661](cs231n/cs231n.github.io)
...
- [A curated list of speech and natural language processing resources ★1489](edobashira/speech-language-processing)
...
## Computer Vision
- [Awesome computer vision (github) ★2593](jbhuang0604/awesome-computer-vision)

- [Awesome deep vision (github) ★4285](kjw0612/awesome-deep-vision)
...
- [Awesome Reinforcement Learning (GitHub) ★1260](aikorea/awesome-rl)
...
- [Awesome Random Forest (GitHub)** ★505](kjw0612/awesome-random-forest)
...
- [Bayesian Methods for Hackers (using pyMC) ★12254](CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers)
...
- [Kalman & Bayesian Filters in Python ★2643](rlabbe/Kalman-and-Bayesian-Filters-in-Python)
...
- For a collection of Data Science Tutorials using R, please refer to [this list ★637](ujjwalkarn/DataScienceR).

- For a collection of Data Science Tutorials using Python, please refer to [this list ★2514](ujjwalkarn/DataSciencePython).
---
<p align="center">
	This list is a copy of <a href="ujjwalkarn/Machine-Learning-Tutorials">ujjwalkarn/Machine-Learning-Tutorials</a> with ranks
</p>
