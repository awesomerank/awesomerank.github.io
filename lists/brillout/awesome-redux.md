...
## Utilities
 ...
 - [redux-orm ★1114](https://github.com/tommikaikkonen/redux-orm) - Small, simple and immutable ORM to manage relational data in your Redux store.
 - [redux-api-middleware ★778](https://github.com/agraboso/redux-api-middleware) - Redux middleware for calling an API.
 - [redux-ignore ★464](https://github.com/omnidan/redux-ignore) - Higher-order reducer to ignore Redux actions.
 ...
 - [rereduce ★160](https://github.com/slorber/rereduce) - Reducer library for Redux.
...
### Store Persistence
 ...
 - [redux-storage ★590](https://github.com/michaelcontento/redux-storage) - Persistence layer for Redux with flexible backends.
 - [redux-persist ★2446](https://github.com/rt2zz/redux-persist) - Persist and rehydrate a Redux store.
...
*Side Effects / Asynchronous Actions*
 ...
 - [redux-promise-middleware ★877](https://github.com/pburtchaell/redux-promise-middleware) - Redux middleware for resolving and rejecting promises with conditional optimistic updates.
 - [redux-effects ★449](https://github.com/redux-effects/redux-effects) - You write pure functions, redux-effects handles the rest.
 - [redux-thunk ★5075](https://github.com/gaearon/redux-thunk) - Thunk middleware for Redux.
 - [redux-connect ★386](https://github.com/makeomatic/redux-connect) - Provides decorator for resolving async props in react-router, extremely useful for handling server-side rendering in React.
 - [redux-loop ★1171](https://github.com/redux-loop/redux-loop) - Port of elm-effects and the Elm Architecture to Redux that allows you to sequence your effects naturally and purely by returning them from your reducers.
 - [redux-side-effects ★157](https://github.com/salsita/redux-side-effects) - Redux toolset for keeping all the side effects inside your reducers while maintaining their purity.
 - [redux-logic ★624](https://github.com/jeffbski/redux-logic) - Redux middleware for organizing business logic and action side effects.
 ...
 - [redux-ship ★581](https://github.com/clarus/redux-ship) - Composable, testable and typable side effects.
...
*Aims to make parts of the source code easier to read/write.*
 ...
 - [redux-act ★713](https://github.com/pauldijou/redux-act) - Opinionated lib to create actions and reducers for Redux.
 - [redux-crud ★457](https://github.com/Versent/redux-crud) - Set of standard actions and reducers for Redux CRUD Applications.


## Dev tools / Inspection tools

 - [redux-devtools-inspector ★223](https://github.com/alexkuz/redux-devtools-inspector) - Another Redux DevTools Monitor.
 ...
 - [remote-redux-devtools ★867](https://github.com/zalmoxisus/remote-redux-devtools) - Redux DevTools remotely.
...
### Forms
 ...
 - [redux-form ★6151](https://github.com/erikras/redux-form) - Higher Order Component using react-redux to keep form state in a Redux store.
 - [react-redux-form ★1265](https://github.com/davidkpiano/react-redux-form) - Create forms easily in React with Redux.


### Component State

 - [redux-react-local ★296](https://github.com/threepointone/redux-react-local) - Local component state via Redux.
 - [redux-ui ★418](https://github.com/tonyhb/redux-ui) - Easy UI state management for React Redux.
...
### Flux
 ...
 - [redux-actions ★3169](https://github.com/acdlite/redux-actions) - Flux Standard Action utilities for Redux.
 - [redux-promise ★1528](https://github.com/acdlite/redux-promise) - FSA-compliant promise middleware for Redux.


### Backbone

 - [backbone-redux ★148](https://github.com/redbooth/backbone-redux) - Easy way to keep your backbone collections and Redux store in sync.
...
### Electron
 ...
 - [redux-electron-store ★244](https://github.com/samiskin/redux-electron-store) - Redux store enhancer that allows automatic synchronization between electron processes.
...
### Other
 ...
 - [kasia ★177](https://github.com/outlandishideas/kasia) - React Redux toolset for the WordPress API.
...
*Boilerplates /  Scaffolds / Starter Kits / Generators / Stack Ensembles*
 ...
 - [redux-cli ★737](https://github.com/SpencerCDixon/redux-cli) - Opinionated CLI for building Redux/React apps quicker.
 - [reactuate ★500](https://github.com/reactuate/reactuate) - React/Redux stack (not a boilerplate kit).
...
## Learning Material
 ...
 - **Side Effects**
    ...
    [Redux Loop's readme ★1171](https://github.com/redux-loop/redux-loop) gives a good insight on Side Effects in the context of Redux.
