...
---
# Awesome Serverless [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★85445](https://github.com/sindresorhus/awesome)
...
*Inspired by the [awesome ★85445](https://github.com/sindresorhus/awesome) list project.*
...
- [MoonMail technology stack](https://blog.moonmail.io/what-is-the-technology-stack-and-architecture-behind-moonmail-4d7d6a113ed6#.r2i0cxph6) - Post about the architecture of the [MoonMail ★1190](https://github.com/microapps/MoonMail) open source project.
...
- [The AWS Lambda power tuning project](https://www.linkedin.com/pulse/aws-lambda-power-tuning-alex-casalboni) - Introduction blog post about the [AWS Lambda power tuning project ★312](https://github.com/alexcasalboni/aws-lambda-power-tuning).
...
- [Serverless on Google with Cloud Functions and React](https://www.oreilly.com/learning/serverless-on-google-with-cloud-functions-and-react) - Tutorial on how to build a Google Cloud Functions powered React app (source code can be found [here ★23](https://github.com/odewahn/cloud-functions-with-react)).
...
- [Real-time serverless malware detection with BinaryAlert](https://medium.com/airbnb-engineering/binaryalert-real-time-serverless-malware-detection-ca44370c1b90) - Announcement blog post of the OpenSource project [BinaryAlert ★680](https://github.com/airbnb/binaryalert) by Airbnb.
...
- [Creating an OpenWhisk Alexa skill](https://akrabat.com/creating-an-openwhisk-alexa-skill) - Tutorial on how to create an Alexa skill with Apache OpenWhisk ([Code repository ★4](https://github.com/akrabat/alexa-binday)).
...
- [Building a live blog system](https://blog.flybase.io/2017/07/21/build-a-live-serverless-blog-with-flybase-twilio-and-stdlib) - How to build a serverless live blog system with Flybase, Twilio and StdLib ([Code repository ★2](https://github.com/flybaseio/flybase-stdlib)).
- [AWS Lambda face](http://blog.johnemmons.com/post/awslambdaface) - How to do serverless face recognition with AWS Lambda ([Code repository ★84](https://github.com/excamera/AWSLambdaFace)).
...
- [Event Gateway - The missing piece of serverless architectures](https://serverless.com/blog/introducing-serverless-event-gateway/) - Announcement blog post of Serverless Inc. introducing then [Event Gateway ★1231](https://github.com/serverless/event-gateway) product.
- [Serverless launches open source Event Gateway](https://venturebeat.com/2017/08/17/serverless-launches-open-source-event-gateway-to-tie-cloud-functions-together/) - Post about the recently launched [Event Gateway ★1231](https://github.com/serverless/event-gateway) Open Source project.
...
- [Building a serverless analytics service](https://sbstjn.com/serverless-analytics-with-kinesis-stream-lambda.html) - Post about the [Serverless Analytics ★106](https://github.com/sbstjn/serverless-analytics) project.
...
- [Definitive guide to serverless architectures](https://serverless.com/blog/definitive-guide-to-serverless-architectures/) - Announcement post about the new [Serverless Guide ★330](https://github.com/serverless/guide) project.
...
- [Introducing live debugging in AWS Lambda](https://www.trek10.com/blog/aws-lambda-debugger/) - Post which introduces and explains the [AWS Lambda debugger ★227](https://github.com/trek10inc/aws-lambda-debugger) project.
...
- [How (and why) we designed the Event Gateway](https://serverless.com/blog/designing-pragmatic-tool-event-gateway/) - Design decisions, Serverless, Inc. made to build the [Event Gateway ★1231](https://github.com/serverless/event-gateway).
...
- [Introducing Jazz - T-Mobile's serverless development platform](https://medium.com/@dev.satishm/introducing-jazz-t-mobiles-serverless-development-platform-da4c27aaf855) - Announcement blog post about T-Mobile's serverless development platform called [Jazz ★95](https://github.com/tmobile/jazz).
...
- [Building the communication fabric for an event-driven system](https://serverless.com/blog/austen-collins-communication-fabric-event-driven-system-emit-2017/) - Post about the [Event Gateway ★1231](https://github.com/serverless/event-gateway) project by Serverless, inc.
...
- [Nuclio and the future of serverless computing](https://thenewstack.io/whats-next-serverless/) - Post about the [Nuclio ★2056](https://github.com/nuclio/nuclio) serverless project.
...
- [VMWare Dispatch announcement](https://blogs.vmware.com/opensource/2018/01/12/dispatch-project-open-source-serverless-framework/) - Announcement blog post about the Dispatch project ([GitHub project ★428](https://github.com/vmware/dispatch)).
...
- [Event Gateway overview](https://stackstorm.com/2017/10/10/event-grid-event-gateway-explained-part2/) - Overview post about the [Event Gateway ★1231](https://github.com/serverless/event-gateway) Open Source project.
- [The CNCF takes steps toward serverless computing](https://www.cncf.io/blog/2018/02/14/cncf-takes-first-step-towards-serverless-computing/) - Post about the recent accomplishments of the CNCF [Serverless working group ★672](https://github.com/cncf/wg-serverless).
...
- [Scope - The Serverless open source status board](https://www.youtube.com/playlist?list=PLIIjEI2fYC-BtxWcDeTziRp7cIZVEepB3) -  Video series about the serverless open source software ["Scope" ★414](https://github.com/serverless/scope).
...
- [How the static site post scheduler works](https://www.youtube.com/watch?v=RaJw_6s5nWc) - Walktrough of the ["Post Scheduler" ★147](https://github.com/serverless/post-scheduler) project.
...
- [Using the Serverless step functions plugin](https://www.youtube.com/watch?v=bEB0zDHXXG4) - How to use the [step functions plugin ★294](https://github.com/horike37/serverless-step-functions) for the Serverless Framework.
...
- [Serverless pre register ★3 ⏳2Y](https://github.com/agentmilindu/Serverless-Pre-Register) - Product Pre-registration page.
...
- [Serverless example ★1 ⏳2Y](https://github.com/iblue/serverless-example) - Experimental example project.
- [DynamoDB CRUD example ★16 ⏳2Y](https://github.com/jagthedrummer/serverlessDynamoCrudExample) - How to use DynamoDB with Serverless.
- [GraphQL Blog ★730](https://github.com/serverless/serverless-graphql-blog) - A Blog powered by GraphQL and Serverless.
- [Password of the day ★7 ⏳2Y](https://github.com/ZeroSharp/ServerlessPotd) - Password of the day service. Utilizing TypeScript.
- [func4 ★0 ⏳2Y](https://github.com/ac360/func4) - Show and create users.
- [Boxify ★0 ⏳2Y](https://github.com/jankei/boxify) - Boxify API service.
- [MIDAAS API ★1 ⏳2Y](https://github.com/presidential-innovation-fellows/midaas-api) - MIDAAS API.
...
- [Slackbot scaffold ★84 ⏳1Y](https://github.com/localytics/serverless-slackbot-scaffold) - Scaffold for a Serverless slackbot.
- [Lambda-React-SSR ★74 ⏳2Y](https://github.com/dherault/Lambda-React-SSR) - Server-side rendering with React on Lambda.
- [Authentication boilerplate ★382](https://github.com/laardee/serverless-authentication-boilerplate) - Authentication boilerplate for Serverless.
- [Blog ★4 ⏳2Y](https://github.com/charltones/serverless_blog) - Blog example using Serverless.
- [MoonMail ★1190](https://github.com/microapps/MoonMail) - Serverless newsletter service.
- [Serverless GraphQL boilerplate ★1365](https://github.com/serverless/serverless-graphql) - Official Serverless GraphQL boilerplate.
...
- [Serverless MongoDB ★16 ⏳2Y](https://github.com/pcorey/serverless-mongodb) - Example project on how to use Serverless and MongoDB.
- [Serverless npm registry ★9 ⏳1Y](https://github.com/mgrenier/serverless-npm-registry) - Npm registry built with the help of the Serverless framework.
...
- [PhantomJS Lambda pack ★51 ⏳1Y](https://github.com/justengland/phantomjs-lambda-pack) - PhantomJS wrapper for AWS Lambda.
- [Garden Aid](https://github.com/garden-aid) - Serverless IoT project to track gardening related data.
- [Serverless Cloud Vision ★24 ⏳1Y](https://github.com/ramhiser/serverless-cloud-vision) - A project which uses Google Cloud Vision together with the Serverless framework.
...
- [Quotebot ★28 ⏳1Y](https://github.com/pmuens/quotebot) - Facebook Messenger chatbot which will return a random quote on message retrieval.
...
- [Serverless Example ★17 ⏳1Y](https://github.com/andymac4182/serverless_example) - Different, feature rich examples for Serverless v1.
...
- [React boilerplate ★179](https://github.com/99xt/serverless-react-boilerplate) - React boilerplate for applications which are powered by Serverless and React.
- [Serverless screenshot ★148](https://github.com/svdgraaf/serverless-screenshot) - Code for a screenshot service build with Serverless.
- [Serverless minimal ★0 ⏳1Y](https://github.com/mthenw/serverless-minimal) - The smallest possible Serverless service.
- [Serverless authorizer ★30 ⏳1Y](https://github.com/eahefnawy/serverless-authorizer) - Example of a service that uses API Gateway custom authorizer feature to authorize your endpoints.
- [Serverless artillery ★222](https://github.com/Nordstrom/serverless-artillery) - Instant and cheap performance testing at scale (combines [Serverless](http://serverless.com) and [Artillery](http://artillery.io)).
- [Delivery Framework ★31](https://github.com/99xt/serverless-delivery-framework) - Boilerplate for version release pipeline with the Serverless Framework.
- [Serverless Beer ★5 ⏳1Y](https://github.com/cassiozen/serverless-beer) - Example application which uses DynamoDB.
- [CRUD ★93](https://github.com/pmuens/serverless-crud) - CRUD service.
- [Mailer ★125 ⏳1Y](https://github.com/eahefnawy/serverless-mailer) - Service for sending E-Mails.
- [Kinesis streams ★15 ⏳1Y](https://github.com/pmuens/serverless-kinesis-streams) - Service to showcase Kinesis stream support.
- [DynamoDB streams ★20 ⏳1Y](https://github.com/pmuens/serverless-dynamodb-streams) - Service to showcase DynamoDB stream support.
- [Landingpage backend ★22 ⏳1Y](https://github.com/pmuens/serverless-landingpage-backend) - Landingpage backend service to store E-Mail addresses.
- [Facebook Messenger Chatbot ★25 ⏳1Y](https://github.com/pmuens/serverless-facebook-messenger-bot) - Chatbot for the Facebook Messenger platform.
- [Lambda chaining ★36](https://github.com/pmuens/serverless-lambda-chaining) - Service which chains Lambdas through SNS.
- [Secured API ★11 ⏳1Y](https://github.com/pmuens/serverless-secured-api) - Service which exposes an API key accessible API.
- [Authorizer ★30 ⏳1Y](https://github.com/eahefnawy/serverless-authorizer) - Service that uses API Gateway custom authorizers.
- [Thumbnails ★28 ⏳1Y](https://github.com/eahefnawy/serverless-thumbnails) - Service that takes an image url and returns a 100x100 thumbnail.
...
- [Serverless Artillery workshop ★67](https://github.com/Nordstrom/serverless-artillery-workshop) - Step by step workshop to create a load testing service which combines [Serverless](http://serverless.com) and [Artillery](http://artillery.io).
...
- [ES6 + Jest ★42 ⏳1Y](https://github.com/americansystems/serverless-es6-jest) - Serverless framework with ES6 via Webpack + Babel + Jest.
- [CRUD Scala ★28 ⏳1Y](https://github.com/jahangirmohammed/serverless-crud-scala) - CRUD example which uses Scala and the Java runtime.
- [Generator Serverless service ★17 ⏳1Y](https://github.com/ACloudGuru/generator-serverless-service) - A scaffold for a Node.js Serverless service.
- [SlackNorris ★2 ⏳1Y](https://github.com/robertoestivill/slacknorris) - Slack command to retrieve great Chuck Norris quotes.
...
- [Serverless Notifications ★103 ⏳1Y](https://github.com/zanon-io/serverless-notifications) - Project which uses the Serverless Framework and AWS IoT for notifications.
- [Redirect example ★7 ⏳1Y](https://github.com/GorillaStack/serverless-redirect-example) - Example of how to implement redirects in the Serverless framework.
- [Meetup event collector ★11 ⏳1Y](https://github.com/mavi888/meetup-event-collector-node) - Node project to collect events and create a calendar feed of meetup events.
- [Yesterdaytabase ★21 ⏳1Y](https://github.com/ryansb/yesterdaytabase) - Cascade data from production to staging with AWS RDS and Lambda.
...
- [Serverless PHP ★99](https://github.com/ZeroSharp/serverless-php) - Example using an AWS Lambda which runs a PHP function.
- [Newsletter Signup ★10](https://github.com/ivanderbu2/serverless-newsletter-signup) - Newsletter Signup API in Serverless.
- [Express Serverless Boilerplate ★4 ⏳1Y](https://github.com/SharathHuddar/express-serverless-boilerplate) - A simple boilerplate for using expressjs with serverless v1.2.1.
...
- [Serverless HTTP ★218](https://github.com/dougmoscrop/serverless-http) - Middleware wrapper for serverless use.
...
- [S3 CRUD ★41 ⏳1Y](https://github.com/tscanlin/serverless-s3-crud) - Serverless CRUD service using S3.
...
- [CloudWatch RDS Custom Metrics ★15 ⏳1Y](https://github.com/AndrewFarley/serverless-cloudwatch-rds-custom-metrics) - Serverless MySQL RDS Data Collection script to push Custom Metrics to CloudWatch on AWS.
- [Clouden Xmas](https://github.com/cloudenoy/clouden-xmas) - Serverless Project which uses IoT, MQTT and more.
- [Hello Retail ★226](https://github.com/Nordstrom/hello-retail) - Project with stream processing.
- [Slack app ★109 ⏳1Y](https://github.com/johnagan/serverless-slack-app) - Slack App Boilerplate with OAuth and Bot actions.
...
- [Swift service template ★130 ⏳1Y](https://github.com/choefele/swift-lambda-app) - Full-featured project template to develop Lambda functions in Swift.
...
- [Finpics ★11 ⏳1Y](https://github.com/rgfindl/finpics) - Use AWS Rekognition to provide a faces search of finpics.com.
- [Slack Emojibot ★12 ⏳1Y](https://github.com/markhobson/emojibot) - Serverless slack bot for emoji.
- [JRestless ★21](https://github.com/bbilger/jrestless-examples) - (Java / JAX-RS) examples.
- [Elm english dictionary ★1 ⏳1Y](https://github.com/ktonon/elm-english-dictionary) - English language dictionary for Elm derived from WordNet 3.0.
- [Nightshell ★4 ⏳1Y](https://github.com/siliconmagi/nightshell) - Nightshell.com Serverless website blog and portfolio.
- [Alexa Skill starter template ★75](https://github.com/rmtuckerphx/alexa-skill-serverless-starter-template) - Alexa Skill template that uses the Serverless Framework and the Alexa Skills Kit SDK for Node.js.
- [Golang](https://github.com/yunspace/serverless-golang) - Example project which uses [AWS Lambda Go Shim ★805](https://github.com/eawsy/aws-lambda-go-shim) to run Go in a Lambda.
- [Web monitor ★5](https://github.com/haw-itn/serverless-web-monitor) - Web monitor written in a serverless way.
- [GraphQL Apollo](https://github.com/serverless/serverless-graphql-apollo) - GraphQL boilerplate using Apollo.
- [Windclock ★3](https://github.com/douweh/windclock_serverless) - IoT example which pushes the wind-speed and wind-direction to a Particle Photon.
- [C# HipChat ★3 ⏳1Y](https://github.com/FLGMwt/serverless-csharp-hipchat) - Template for HipChat bot Serverless service using C#.
- [Blog to podcast ★26 ⏳1Y](https://github.com/SC5/serverless-blog-to-podcast) - Convert blog content to podcasts.
- [Serverless Todos ★26](https://github.com/nerdguru/serverlessTodos) - Enhanced todos application which uses Mocha tests and AWS CodePipeline as a CI / CD system.
- [Practical ★9 ⏳1Y](https://github.com/asantibanez/practical) - Practical ActiveRecord for DynamoDB.
- [Faceswap ★25 ⏳1Y](https://github.com/johncmckim/serverless-emoticon-faceswap) - A Serverless Project that overlays an Emoji on a face.
...
- [Slack to OpsGenie Alert Creator ★10](https://github.com/opsgenie/slack-to-opsgenie-alert-creator) - Create alerts from messages sent to a Slack channel.
- [Offset Trump ★5 ⏳1Y](https://github.com/FLGMwt/offset-trump) - Single page app using Serverless (C# runtime) and S3 site hosting.
- [CRUD FaunaDB](https://github.com/faunadb/serverless-crud) - CRUD service using FaunaDB.
- [Log group test ★1 ⏳1Y](https://github.com/geoffdutton/serverless-loggroup-test) - Service to test the behavior of log groups.
- [Stdlib Node.js](https://github.com/serverless/stdlib-nodejs) - Serverless Standard Library for Node.js.
- [Deployment Ansible light ★6 ⏳1Y](https://github.com/SC5/serverless-deployment-ansible-lite) - Deploy Serverless services with Ansible.
- [Scope ★414](https://github.com/serverless/scope) - Customizable birdeye's view of your GitHub project.
...
- [Boilerplate Azure Functions ★1 ⏳1Y](https://github.com/pragnagopa/boilerplate-azurefunctions) - Boilerplate which helps to use the Azure Functions provider plugin.
- [URL shortener ★51 ⏳1Y](https://github.com/aletheia/serverless-url-shortener) - A simple url-shortener, using Serverless Framework.
- [Falke ★1 ⏳1Y](https://github.com/sbstjn/falke) - Alexa skill to check when a Tatort is broadcasted.
- [LambdaAuth ★1209 ⏳1Y](https://github.com/danilop/LambdAuth) - Serverless authentication service.
- [Elasticpypi ★145](https://github.com/khornberg/elasticpypi) - Serverless PyPI service.
- [Lambda coding round evaluator ★25 ⏳1Y](https://github.com/shekhargulati/lambda-coding-round-evaluator) - Services which help to implement a code evaluator that organizations can use to automate coding round interviews.
- [TDD service ★3 ⏳1Y](https://github.com/laardee/my-tdd-service) - TDD example service.
- [HTML PDF ★36 ⏳1Y](https://github.com/calvintychan/serverless-html-pdf) - Convert HTML to PDF thru a lambda function using PhantomJS.
- [Codebox npm ★257](https://github.com/craftship/codebox-npm) - Serverless private npm registry.
- [Overwatch bot ★5 ⏳1Y](https://github.com/hectorleiva/overwatch-serverless-telegram-bot) - Overwatch stats bot for the messaging service Telegram.
- [Shimless Golang ★3 ⏳1Y](https://github.com/cristim/serverless-golang) - Shimless Golang AWS Lambda running on Serverless Framework.
- [Post Scheduler ★147](https://github.com/serverless/post-scheduler) - Service which helps you to schedule posts for static site generators (Jekyll, Hugo, Phenomic etc.).
- [Bucket events ★2 ⏳1Y](https://github.com/manwaring/serverless-bucket-events) - Service to test bucket events.
- [Cached RDS WS ★18 ⏳1Y](https://github.com/mugglmenzel/serverless-examples-cached-rds-ws) - Service that uses API Gateway, ElastiCache, and RDS PostgreSQL.
- [Candidates app ★3 ⏳1Y](https://github.com/connor11528/candidates-app) - The backend for the candidates app which is build step-by-step in [this](https://medium.com/@connorleech/deploy-node-js-serverless-framework-app-with-dynamodb-s3-and-cognito-in-10-steps-723d2f4ec08f#.1j0rrdite) blog post.
- [SSR demo ★5 ⏳1Y](https://github.com/AInvest/ssr-demo) - Server Side Rendering with create React app.
- [Inveats ★1 ⏳1Y](https://github.com/unravel-project/hackathon-project) - Allows startups and investors make a connection over a meal.
- [Chatbite ★2 ⏳1Y](https://github.com/JacopoDaeli/chatbite) - Easily connect Opentable to Facebook Messenger for your restaurant.
- [Bootie ★2 ⏳1Y](https://github.com/carlosmuvi/serverless-bootie) - Service which gathers different event types (such as Meetups, Eventbrite and Facebook events).
- [Surprise assist ★1 ⏳1Y](https://github.com/Masv-io/SurpriseAssist-Backend) - Surprise service.
- [Triptunes ★1 ⏳1Y](https://github.com/jahlela/triptunes) - Create a Spotify playlist of songs that mention towns you will drive through.
- [Allergic reaction ★1 ⏳1Y](https://github.com/billcheng-ucla/allergic-reaction-serverless) - Get info about allergens from restaurant menus.
- [BrokenTable ★6 ⏳1Y](https://github.com/MiLeung/BrokenTable) - Show places to avoid while traveling.
- [iReact ★2 ⏳1Y](https://github.com/DavidLopezWhite/iReact) - React hackathon team project.
- [Reactathon 2017 ★4 ⏳1Y](https://github.com/Baw25/TeamNoSleepReactathon2017) - Reactathon service project.
- [Reactathon Serverless ★1 ⏳1Y](https://github.com/ragingoctopus/reactathonServerless) - Example Reactathon serverless service.
- [Restaurant deals ★2 ⏳1Y](https://github.com/afr114/reactathon2017) - Deals for restaurants.
- [Profiles ★2 ⏳1Y](https://github.com/starbucks-hackers/reactathon-profiles) - A profiles microservice.
- [Appointments ★4 ⏳1Y](https://github.com/starbucks-hackers/reactathon-appointments) - An appointments microservice.
- [Alexa template ★1 ⏳1Y](https://github.com/chrishutchinson/alexa-serverless-template) - Alexa boilerplate service.
- [Policy generator ★83](https://github.com/dancrumb/generator-serverless-policy) - Yeoman Generator to create IAM policy for deploying a Serverless service.
- [Deployment CodePipeline ★1 ⏳1Y](https://github.com/SC5/serverless-deployment-codepipeline) - Use the Serverless Framework with AWS CodePipeline.
- [.Net core template](https://github.com/PageUpPeopleOrg/serverless-dotnetcore-template) - Sophisticated .Net core template.
- [Twilio Shippo ★6 ⏳1Y](https://github.com/shipping-api/serverless-twilio-shippo) - Service to send shipment tracking updates via SMS with Shippo & Twilio.
- ["Hello, Retail!" workshop ★129](https://github.com/Nordstrom/hello-retail-workshop) - A workshop to accompany the 100% serverless, event-driven "Hello, Retail!" code base.
- [Serverless validator ★2](https://github.com/futtetennista/ServerlessValidator) - A validator for serverless.yml files written in Haskell.
- [Midsomerplots ★13](https://github.com/matthewberryman/midsomerplots) - Midsomer murder plot generator bot.
- [Proxy ★5 ⏳1Y](https://github.com/dan-turner/serverless-proxy) - Run your existing HTTP middleware based apps in Serverless.
- [Chrome ★1339](https://github.com/adieuadieu/serverless-chrome) - Run headless Chrome on AWS Lambda.
...
- [Leto ★14 ⏳1Y](https://github.com/helixone/leto-serverless) - Angular server(less) side rendering.
- [Open bot ★166](https://github.com/open-bot/open-bot) - An unoptionated bot driven by a configuration file in the repository.
- [Endless commerce ★93 ⏳1Y](https://github.com/endless-commerce/endless) - Serverless open source e-commerce platform.
- [Slack Memebot ★5](https://github.com/GorillaStack/serverless-slack-memebot) - Slackbot used to generate memes.
- [Serverless getting started ★3](https://github.com/maingi4/Serverless_Getting_Started) - Example project using the Serverless Framework.
- [Serverless utilities ★5 ⏳1Y](https://github.com/silvermine/serverless-utils) - Collection of useful utilities for Serverless Framework users.
- [S3 API ★5 ⏳1Y](https://github.com/komushi/serverless-s3-api) - S3 proxy API in API Gateway / Lambda.
- [Serverless TypeScript demo ★16 ⏳1Y](https://github.com/gshackles/serverless-typescript-demo) - Basic project demonstrating how to build a Serverless application using TypeScript.
- [Binary test ★12 ⏳1Y](https://github.com/bni/binary-test) - Binary files in API Gateway / Lambda test.
- [Serverless PHP ★87](https://github.com/araines/serverless-php) - PHP for AWS Lambda via Serverless Framework.
- [Video preview and analysis ★27](https://github.com/laardee/video-preview-and-analysis-service) - Service for creating preview animation and labels from video file.
- [AWS Lambda power tuning ★312](https://github.com/alexcasalboni/aws-lambda-power-tuning) - Step Functions state machine generator for AWS Lambda power tuning.
- [YouTube podcasts ★6](https://github.com/sedden/serverless-youtube-podcasts) - Access YouTube playlists in podcast format.
- [Lambda view server ★3 ⏳1Y](https://github.com/kiva/lambda-view-server) - A no-db web server using AWS Lambda.
- [Thumbnail ★23 ⏳1Y](https://github.com/krisgholson/serverless-thumbnail) - Recreate the thumbnail service using the Serverless Framework.
- [Ruby ★74](https://github.com/stewartlord/serverless-ruby) - Call a Ruby function from AWS Lambda.
...
- [GitHub CodeBuild webhook ★56](https://github.com/svdgraaf/github-codebuild-webhook) - Service which shows how one can integrate CodeBuild and GitHub.
- [GraphQL API ★170](https://github.com/boazdejong/serverless-graphql-api) - GraphQL API using Lambda and DynamoDB.
- [Bittman ★9 ⏳1Y](https://github.com/rhlsthrm/bittman) - Follows a stock trading algorithm and uses scheduled functions to save data to DynamoDB and send emails through Mailgun.
- [Adoptable pet bot ★15](https://github.com/lynnaloo/adoptable-pet-bot) - Tweets adoptable pets using Node.js and AWS Lambda.
- [Owntracks ★4 ⏳1Y](https://github.com/dschep/owntracks-serverless) - Serverless implementation of the OwnTracks HTTP backend.
...
- [AWS SES example ★33](https://github.com/lakshmantgld/aws-ses-serverless-example) - AWS SES example in Node.js using Lambda.
- [ES6 / 7 CRUD API ★140](https://github.com/AnomalyInnovations/serverless-stack-demo-api) - [Serverless Stack](http://serverless-stack.com) examples of backend CRUD APIs (DynamoDB + Lambda + API Gateway + Cognito User Pool authorizer) for [React.js single-page app](http://demo.serverless-stack.com).
- [OSCON photo booth ★6 ⏳1Y](https://github.com/pselle/oscon-photo-booth) - Mobile Photo Booth (using AWS Lambda).
- [Odin ★2](https://github.com/manwaring/odin) - Periodically checks the status of CloudFormation stacks in your AWS environment and sends the stale ones to Valhalla.
- [AWS alias example ★11](https://github.com/HyperBrain/serverless-aws-alias-example) - Example project for the Serverless alias plugin.
...
- [Whim bot ★5 ⏳1Y](https://github.com/maasglobal/whim-bot) - Microsoft Bot Framewok powered serverless bot.
...
- [Slack sign-up ★17](https://github.com/dzimine/slack-signup-serverless) - Serverless sign-up to Slack (and other services).
- [Image resizer ★29](https://github.com/nicholasgubbins/Serverless-Image-Resizer) - Image resizer like imgix on API Gateway & Lambda.
- [2791 ★2](https://github.com/brendo/issue-2791) - Reproduction service of [serverless/serverless#2791](https://github.com/serverless/serverless/issues/2791).
- [Serverless sample ★4](https://github.com/MatiasComercio/serverless-sample) - Sample project for blog post introduction to Serverless Framework.
- [Analytics ★106](https://github.com/sbstjn/serverless-analytics) - Track website visitors with serverless analytics.
- [Medium TTS ★64](https://github.com/RafalWilinski/serverless-medium-text-to-speech) - Serverless-based, text-to-speech service for Medium articles.
- [Alain Twitterbot ★1](https://github.com/sergile/alain-twitterbot-serverless) - Serverless Twitterbot implementation.
- [Letter Avatar ★5](https://github.com/KevinColemanInc/letter-avatar-serverless) - Generates Google-like binary avatar images.
- [Serverless shop ★160](https://github.com/patrick-michelberger/serverless-shop) - Serverless E-Commerce app powered by AWS Lambda, Stripe and React.
...
- [Lambda config demo ★31](https://github.com/theburningmonk/lambda-config-demo) - Demo of approaches to config management for AWS Lambda.
- [Flask ★16](https://github.com/alexdebrie/serverless-flask) - Serverless Framework template for a Flask application.
- [jwtAuthorizr ★20](https://github.com/serverlessbuch/jwtAuthorizr) - Custom JWT authorizer Lambda function for Amazon API Gateway with bearer JWT.
- [honeyLambda ★382](https://github.com/0x4D31/honeyLambda) - Simple serverless application designed to create and monitor URL {honey}tokens, on top of AWS Lambda and Amazon API Gateway.
- [Stack Overflow Monitor ★12](https://github.com/picsoung/stackoverflowmonitor) - Monitor Stack Overflow questions and post them in a Slack channel.
- [Start with React example ★2](https://github.com/anoora17/serverlessStartwithReactexample) - Serverless React example app.
- ["Deploy with Serverless" ★44](https://github.com/RafalWilinski/deploy-with-serverless) - Infrastructure for processing Serverless projects and creating one-click deployments.
- [Raffleapp ★4](https://github.com/serverless/raffleapp) - Simple raffle application with a backend serverless service.
- [Architectures playground ★2](https://github.com/aletheia/sls-architectures-playground) - A playground project showing different serverless architectures.
- [DynamoDB backups ★23](https://github.com/alexdebrie/serverless-dynamodb-backups) - Automate your DynamoDB backups.
- [Stargazer ★2](https://github.com/alexdebrie/stargazer) - Get Slack notifications whenever someone stars your GitHub repository.
- [Webhooks ★2](https://github.com/jloh/serverless-webhooks) - Serverless webhooks ingester.
- [Serverless Go ★49](https://github.com/serverless/serverless-golang) - Serverless Framework template for Go.
- [Chat application](https://github.com/OmniPotent42/chat-app-serverless) - Full stack serverless chat application ([Code for the client ★30](https://github.com/OmniPotent42/chat-app-vuejs)).
- [Serverless multi-region](https://github.com/alexdebrie/serverless-multi-region) - A multi-region Serverless Framework project using regional endpoints & DynamoDB global tables ([Code for the client ★17](https://github.com/alexcasalboni/serverless-multi-region-client-demo)).
- [Serverless architecture boilerplate ★68](https://github.com/msfidelis/serverless-architecture-boilerplate) - Organize and deploy big projects using AWS API Gateway and AWS Lambda with the Serverless Framework.
- [CRUD Go ★25](https://github.com/yosriady/serverless-crud-go) - Example CRUD serverless application written in Go.
- [RealWorld DynamoDB ★16](https://github.com/anishkny/realworld-dynamodb-lambda) - An AWS DynamoDB + Lambda backend implementation for [RealWorld](http://realworld.io).
- [ES6 boilerplate ★5](https://github.com/artoliukkonen/serverless-es6-boilerplate) - Yet another Serverless Framework boilerplate with ES6 / ES7, Jest & ESLint support.
- [Boilerplate with React server-side rendering ★24](https://github.com/artoliukkonen/serverless-isomorphic-react-boilerplate) - React & Redux with server-side rendering on AWS, using the Serverless Framework.
- [Token authorizer ★4](https://github.com/mavi888/serverless-token-authorization) - Service which uses API Kayes and API Gateway authorizers to validate tokens.
- [API Keys test ★1](https://github.com/mavi888/serverless-apikeys-test) - Service which shows how to use API Keys and usage plans with AWS Lambda and AWS API Gateway.
- [Forms ★30](https://github.com/serverless/forms-service) - Serverless forms service to collect form data with an admin UI.
- [Scaffold serverless ★18](https://github.com/v-studios/scaffold-serverless) - A scaffold for serverless projects with test runner, multiple stages, CI/CD, doc creation).
- [Templates ★8](https://github.com/bytekast/serverless-templates) - Collection of Serverless templates and patterns.
- [GitHub stats bot ★10](https://github.com/threadheap/github-stats-bot) - GitHub stats rendering service.
- [AWS S3 Website ★8](https://github.com/ServerlessOpsIO/serverless-aws-s3-website) - Manage a static website hosted on S3.
- [Official joke API ★45](https://github.com/15Dkatz/official_joke_api) - Vue Jokester application backend.
- [Event Gateway Getting Started ★27](https://github.com/serverless/event-gateway-getting-started) - Walkthrough application for using the Event Gateway.
- [Utils ★6](https://github.com/serverless/utils) - General Serverless utilities.
- [CloudWatch public metrics ★20](https://github.com/RafalWilinski/cloudwatch-public-metrics) - Expose AWS CloudWatch metrics as a public HTML page.
...
- [Crop ★6 ⏳1Y](https://github.com/ryansb/crop) - Cloudformation'd Repeatable Operator Packages.
- [Microcule ★398](https://github.com/stackvana/microcule) - Think of it as serverless functions meets Unix Philosophy.
- [Azure Functions Introduction ★79](https://github.com/guitarrapc/AzureFunctionsIntroduction) - Sample Code for Azure Functions.
- [Hands-On serverless guide ★173](https://github.com/shekhargulati/hands-on-serverless-guide) - A hands-on guide for building serverless applications.
- [Serverless Z ★3 ⏳1Y](https://github.com/stashimi/serverless-z) - Unofficial development repository for the abandoned 0.x versions of Serverless.
...
- [Localstack ★12121](https://github.com/localstack/localstack) - A fully functional local AWS cloud stack.
- [Azure functions pack ★0](https://github.com/christopheranderson/azure-functions-pack) - Easily package your Node.js Functions for Azure Functions.
- [Azure Functions ★375](https://github.com/Azure/Azure-Functions) - Overview repository about Azure Functions.
- [Buildserverless ★2 ⏳1Y](https://github.com/jchorl/buildserverless) - [Serverless build system](https://hackernoon.com/free-node-js-builds-on-google-cloud-functions-6e305623e249) which runs on Google Cloud Functions.
...
- [Cerberus components ★12](https://github.com/Nike-Inc/cerberus-serverless-components) - A collection of AWS Serverless components for Cerberus.
...
- [NPM doc Serverless ★1 ⏳1Y](https://github.com/npmdoc/node-npmdoc-serverless) - API documentation for the Serverless Framework.
- [Gcdt ★21](https://github.com/glomex/gcdt) - Glomex cloud deployment tools to use infrastructure as code (IaC) on AWS.
- [NoDB ★223](https://github.com/Miserlou/NoDB) - Serverless database built atop of S3.
- [BitTorrent tracker ★37 ⏳1Y](https://github.com/Miserlou/zappa-bittorrent-tracker) - An experimental server-less BitTorrent tracker.
...
- [Serverless examples ★30](https://github.com/cfjedimaster/Serverless-Examples) - Repository with different serverless example projects.
- [Lambda Framework](https://github.com/lambadaframework/lambadaframework) - Build serverless REST API's with Java.
- [Node dash ★13](https://github.com/seriousme/node-dash) - Serverless setup using Node.js.
- [FaaSlang ★296](https://github.com/faaslang/faaslang) - FaaSlang defines FaaS execution semantics and type-safety mechanisms.
- [FDK ★72](https://github.com/serverless/fdk) - The serverless function development kit (FDK).
...
- [Open Lambda ★500](https://github.com/open-lambda/open-lambda) - Serverless computing project, written in Go and based on Linux containers.
- [Serverless patterns ★78 ⏳1Y](https://github.com/yochay/serverlesspatterns) - Repo with a collection of common serverless design patterns.
- [Serverless transceiver ★9 ⏳1Y](https://github.com/ACloudGuru/serverless-transceiver) - Plugin to support better inter-service communication.
- [Docker Serverless ★3](https://github.com/tomelliff/docker-serverless) - Minimal image for deploying Serverless Framework projects.
- [Local Lambda debug ★10](https://github.com/OneMuppet/local-lambda-debug) - Example setup for vscode for debugging AWS Lambda functions locally.
- [Sencha Microservices Framework](https://github.com/senecajs) - Sencha Microservices Framework project.
- [Node Lambda ★1044](https://github.com/motdotla/node-lambda) - Command line tool to locally run and deploy your Node.js application to AWS Lambda.
...
- [Squeezer.IO](https://squeezer.io) - Event-Driven APIs and web apps on serverless microservices ([GitHub project]([Squeezer ★45](https://github.com/SqueezerIO/squeezer))).
...
- [Serverless Architectures on AWS code ★1](https://github.com/sbarski/serverless-architectures-aws) - The code repository for the Serverless Architectures on AWS book.
- [Lambdacult](https://lambdacult.com) - Services on top of AWS Lambda.
- [Scar ★266](https://github.com/grycap/scar) - Serverless Container-aware Architectures (e.g. Docker containers in AWS Lambda).
...
- [Lambda session auth ★19 ⏳1Y](https://github.com/sedenardi/lambda-session-auth) - Cookie-based session authentication using AWS Lambda and Node.js.
- [CloudBoost ★1220](https://github.com/cloudboost/cloudboost) - One complete serverless platform for the next web.
- [Lambda test ★74 ⏳2Y](https://github.com/berezovskyi/lambda-test) - Test (pseudo) AWS Lambda runtime startup time.
- [StdLib ★3318](https://github.com/stdlib/lib) - The standard library for Functions as a Service ([StdLib](https://stdlib.com)).
- [Lambda toolkit ★118](https://github.com/lucioveloso/lambda-toolkit) - CLI which helps creating, building, DEBUG on your own machine real events, testing and deploying your Lambda functions.
- [Alexa skill Watson conversation ★0](https://github.com/nheidloff/alexa-skill-watson-conversation) - Alexa skill using IBM Watson Conversation and OpenWhisk.
- [Spring Cloud Functions ★340](https://github.com/spring-cloud/spring-cloud-function) - A new programming model for Spring Boot applications.
- [Azure Functions Durable extension ★132](https://github.com/Azure/azure-functions-durable-extension) - Durable Task Framework extension for Azure Functions.
- [Standup Lambda ★5](https://github.com/olivoil/standup-lambda) - Standup status app that integrates with Slack.
- [Face identification ★5](https://github.com/ericsk/serverless-face-identification) - Using Azure Functions to handle learning identifying faces.
...
- [Cloudfunc ★94](https://github.com/flowup/cloudfunc) - Deploying Google Cloud Functions written in Go with ease.
- [C# AWS](http://csharpaws.com) - AWS Lambda C# function package builder (source code can be found [here ★8](https://github.com/tenor/CSharpAWSLambdaFunctions)).
- [Serverless Java Container ★455](https://github.com/awslabs/aws-serverless-java-container) - Java wrapper to run Spring, Jersey, Spark, and other apps inside AWS Lambda.
- [Architect](https://arc.codes) - Provision and deploy cloud architecture as text.
- [BinaryAlert ★680](https://github.com/airbnb/binaryalert) - Real-time serverless malware detection.
- [Lambda ★181 ⏳1Y](https://github.com/smallwins/lambda) - Authoring tools for AWS Lambda functions.
...
- [AWS Chalice ★4361](https://github.com/aws/chalice) - Python serverless microframework for AWS.
- [Lambda RESTify ★10](https://github.com/kksharma1618/lambda-restify) - A restify / expressjs like interface for AWS Lamda with API Gateway event.
- [AWS SAM Local](https://github.com/awslabs/aws-sam-local) - Toolset to develop AWS SAM projects locally.
- [AWS Lambdas bootstrap ★2](https://github.com/Wolox/aws-lambdas-bootstrap) - Toolkit to bootstrap AWS Lambda functions.
...
- [Pwned passwords ★96](https://github.com/jthomas/serverless-pwned-passwords) - Checking passwords against an enormous corpus of passwords leaked from security breaches.
- [Zappa ★7064](https://github.com/Miserlou/Zappa) - Serverless Python web services.
- [Serverless guide ★330](https://github.com/serverless/guide) - The "definitive guide" to serverless architectures.
- [Seed](https://seed.run) - CI / CD solution for serverless applications.
- [Slspress ★16](https://github.com/withreason/slspress) - Library for rapidly developing serverless applications.
...
- [Lambda SES forwarder ★593](https://github.com/arithmetric/aws-lambda-ses-forwarder) - Serverless E-Mail forwarding using AWS Lambda and SES.
- [Sublime AWS Lambda ★9](https://github.com/revmischa/sublime-awslambda) - Sublime Text 3 plugin for editing AWS Lambda function sources easily.
- [Nuclio ★2056](https://github.com/nuclio/nuclio) - High-Performance serverless event and data processing framework.
...
- [Derek ★266](https://github.com/alexellis/derek) - A serverless bot to manage PRs and issues.
- [Serverless By Design ★131](https://github.com/danilop/ServerlessByDesign) - Visual tool to create serverless architectures.
- [Serverless Blog](https://serverlessblog.com) - Run your blog on AWS Lambda using [Flask-Blogging ★415](https://github.com/gouthambs/Flask-Blogging).
- [AWS Lambda debugger ★227](https://github.com/trek10inc/aws-lambda-debugger) - Debugging support for AWS Lambda Node 6.10.
- [Pyroclast](http://pyroclast.io) - Turn event streams into (micro)services.
- [Serverless Atom dashboard ★34](https://github.com/horike37/serverless-dashboard-for-atom) - Atom plugin which implements a dashboard for Serverless Framework applications.
...
- [Fission Workflows ★136](https://github.com/fission/fission-workflows) -  Fast, reliable and lightweight serverless function composition.
...
- [Serverless chat ★68](https://github.com/danilop/serverless-chat) - Web chat built using AWS Lambda, AWS IoT (for WebSockets) and Amazon DynamoDB.
- [Fn Project](http://fnproject.io) - The container native serverless framework ([GitHub repository ★2907](https://github.com/fnproject/fn)).
- [Bender ★124](https://github.com/nextdoor/bender) - Serverless ETL framework.
...
- [Shell ★37](https://github.com/ibm-functions/shell) - An Electron-based development tool for IBM Cloud Functions and Composer.
- [Composer ★110](https://github.com/ibm-functions/composer) - Programming model for composing IBM Cloud Functions, built on Apache OpenWhisk.
...
- [Jazz ★95](https://github.com/tmobile/jazz) - Jazz serverless development platform.
- [Firecamp ★132](https://github.com/cloudstax/firecamp) - Serverless platform for the stateful services.
- [Cloudstax](https://www.cloudstax.io) - Serverless and Open Source services.
- [Kuhiro](http://kuhiro.com) - Edge Compute Network.
- [Flogo ★625](https://github.com/TIBCOSoftware/flogo) - Project Flogo is an open source framework to simplify building efficient & modern serverless functions and edge microservices.
- [Add custom resource ★7](https://github.com/dougmoscrop/add-custom-resource) - Library which is meant to be used in a Serverless plugin when a custom resource is needed.
- [Reactive Interaction Gateway ★130](https://github.com/Accenture/reactive-interaction-gateway) - Scalable, Open Source gateway to your microservices.
...
- [Middy ★256](https://github.com/middyjs/middy) - The stylish Node.js middleware engine for AWS Lambda.
...
- [Tyk](https://tyk.io) - Tyk Open Source API Gateway ([GitHub project ★3423](https://github.com/TykTechnologies/tyk)).
- [ES2017 - AWS Lambda boilerplate ★139](https://github.com/irvinlim/es2017-lambda-boilerplate) - Boilerplate for implementing Node.js functions on AWS Lambda using ES2017 features, unit testing and CI/CD with Travis or AWS CodeBuild.
...
- [Riff](https://projectriff.io) - Function service designed to run on Kubernetes ([GitHub project ★443](https://github.com/projectriff/riff)).
- [HTTP Func ★4](https://github.com/mthenw/httpfunc) - AWS Lambda function that does HTTP requests.
- [Dispatch ★428](https://github.com/vmware/dispatch) - A framework for deploying and managing serverless style applications.
- [LambStatus](https://lambstatus.github.io) - Serverless status page system ([GitHub project ★953](https://github.com/ks888/LambStatus)).
- [AWS Lambda Go ★1322](https://github.com/aws/aws-lambda-go) - Libraries, samples and tools to help Go developers develop AWS Lambda functions.
- [URL Shortener ★34](https://github.com/danielireson/serverless-url-shortener) - URL shortener for AWS Lambda and S3.
- [Lambda transport ★9](https://github.com/ewindisch/lambda-transport) - C library and language bindings for AWS Lambda.
- [Step Functions local ★29](https://github.com/airware/stepfunctions-local) - Execute AWS Step Functions locally.
- [Qumli ★46](https://github.com/qmuli/qmuli) - Serverless framework for Haskell.
...
- [Scrappy Serverless ★13](https://github.com/beardedfoo/scrappy-serverless) - A basic FaaS, build for educational purposes.
- [Epsagon](https://www.epsagon.com) - End to end monitoring for serverless architectures.
- [Run](https://run.tools) - The resource runtime ([GitHub project ★75](https://github.com/runtools/run)).
- [Gloo ★547](https://github.com/solo-io/gloo) - The function gateway built on top of Envoy.
...
- [Go FaaS ★460](https://github.com/nzoschke/gofaas) - Boilerplate Go and AWS Lambda app.
- [PyWren ★482](https://github.com/pywren/pywren) - Like a mini condor, in the cloud, for often-complex calls.
...
- [Build plugin ★34](https://github.com/nfour/serverless-build-plugin) - Optimizes your Node.js functions before they're deployed.
- [Write env vars ★29](https://github.com/silvermine/serverless-plugin-write-env-vars) - Access environment variables in Lambda functions.
- [Alexa plugin ★16 ⏳1Y](https://github.com/rajington/serverless-alexa-plugin) - Support Alexa Lambda events.
- [Multi responses ★13](https://github.com/silvermine/serverless-plugin-multiple-responses) - Allow multiple content types in response templates.
- [Run function ★13](https://github.com/lithin/serverless-run-function-plugin) - Plugin to run your Serverless functions locally.
...
- [WSGI ★137](https://github.com/logandk/serverless-wsgi) - Helps you to deploy Python WSGI applications (Flask/Django etc.).
- [External SNS events ★21 ⏳1Y](https://github.com/silvermine/serverless-plugin-external-sns-events) - Let you use an already existent SNS topic as the event source.
- [CloudWatch Sumologic ★5](https://github.com/ACloudGuru/serverless-plugin-cloudwatch-sumologic) - Plugin which auto-subscribes a log delivery Lambda function to lambda log groups created by Serverless.
- [Browserify ★24 ⏳1Y](https://github.com/doapp-ryanp/serverless-plugin-browserify) - Add browserify to speedup Lambdas.
- [Optimize ★66](https://github.com/FidelLimited/serverless-plugin-optimize) - Optimize plugin for Serverless.
- [Include dependencies ★67](https://github.com/dougmoscrop/serverless-plugin-include-dependencies) - Explicitly include packages in your `node_modules` folder.
...
- [Snyk plugin ★26 ⏳1Y](https://github.com/Snyk/serverless-snyk) - Plugin for securing your dependencies with Snyk.
...
- [Crypt ★66](https://github.com/marcy-terui/serverless-crypt) - Securing Serverless secrets by AWS KMS encryption.
- [Diff ★14 ⏳1Y](https://github.com/nicka/serverless-plugin-diff) - Compares your local AWS CloudFormation templates against deployed ones.
- [Rollback function ★4 ⏳1Y](https://github.com/marcy-terui/serverless-rollback-function) - Rollback a single function.
- [CloudFormation Authorizer ★16 ⏳1Y](https://github.com/SC5/serverless-plugin-cfauthorizer) - Define your own API Gateway Authorizers as the Serverless CloudFormation resources and apply them to HTTP endpoints.
- [Babel ★23](https://github.com/serverless/serverless-babel-plugin) - Plugin to compile your JavaScript code with Babel before deployment.
- [External S3 event ★102](https://github.com/matt-filion/serverless-external-s3-event) - Overcomes the CloudFormation limitation on attaching an event to an uncontrolled bucket.
- [Inspect ★3](https://github.com/seek-oss/serverless-plugin-inspect) - Get AWS stack info in JSON.
...
- [Google Cloud Functions ★144](https://github.com/serverless/serverless-google-cloudfunctions) - Adds Google Cloud Functions support to the Serverless Framework.
- [Azure Functions ★110](https://github.com/serverless/serverless-azure-functions) - Add Azure Functions support to the Serverless Framework.
...
- [SWAG ★7 ⏳1Y](https://github.com/doapp-ryanp/serverless-plugin-swag) - Adds enterprise support for API Gateway and Lambda.
- [Alexa ★16 ⏳1Y](https://github.com/rajington/serverless-alexa-plugin) - Adds Alexa as a possible event source.
- [RAML ★18 ⏳1Y](https://github.com/andrewcurioso/raml-serverless) - Work with RAML documentation for Serverless v1.0 projects.
...
- [Dotnet ★15](https://github.com/fruffin/serverless-dotnet) - A Serverless plugin to run 'dotnet' commands as part of the deploy process.
- [Python requirements ★245](https://github.com/UnitedIncome/serverless-python-requirements) - Serverless plugin to bundle Python packages.
- [Subscription filter ★16](https://github.com/tsub/serverless-plugin-subscription-filter) - Extend subscription filter events.
- [Step Functions ★294](https://github.com/horike37/serverless-step-functions) - AWS Step Functions support for Serverless.
- [Python individually ★17](https://github.com/cfchou/serverless-python-individually) - Install multiple lambda functions written in Python.
- [Enable API logs ★9](https://github.com/paulSambolin/serverless-enable-api-logs) - Enables Cloudwatch logging for API Gateway events.
- [Containerless ★40](https://github.com/Reckon-Limited/containerless) - Plugin for configuring ECS deployment.
- [Swagger ★18](https://github.com/Reckon-Limited/serverless_swagger) - Configure serverless functions from swagger definition.
- [Plugin scripts ★34](https://github.com/mvila/serverless-plugin-scripts) - Adds scripting capabilities to the Serverless Framework.
- [Bind deployment id ★18 ⏳1Y](https://github.com/jacob-meacham/serverless-plugin-bind-deployment-id) - Bind the randomly generated deployment resource to your custom resources.
- [CoffeeScript ★6](https://github.com/duanefields/serverless-coffeescript) - Quick and dirty plugin to compile CoffeeScript files.
- [GraphiQL ★46](https://github.com/bencooling/serverless-plugin-graphiql) - Plugin to run a local HTTP server for GraphiQL and your GraphQL handler.
...
- [CLJS ★48](https://github.com/nervous-systems/serverless-cljs-plugin) - Enables Clojurescript as an implementation language for Lambda handlers.
...
- [Additional stacks ★37](https://github.com/SC5/serverless-plugin-additional-stacks) - Support for managing multiple AWS CloudFormation stacks.
- [Prune ★55](https://github.com/claygregory/serverless-prune-plugin) - Deletes old versions of functions from AWS, preserving recent and aliased versions.
- [Offline scheduler ★35](https://github.com/ajmath/serverless-offline-scheduler) - Runs scheduled functions offline while integrating with serverless-offline.
- [Simulate ★107](https://github.com/serverless-community-labs/serverless-plugin-simulate) - Simulate AWS Lambda and API Gateway locally using Docker.
- [Alias ★71](https://github.com/HyperBrain/serverless-aws-alias) - Alias support for Serverless 1.6+.
- [Package .env file ★10 ⏳1Y](https://github.com/ACloudGuru/serverless-plugin-package-dotenv-file) - Plugin to copy a .env file into the Serverless deployment package.
- [CI / CD](https://github.com/HyperBrain/serverless-cicd) - CI / CD support for Serverless v1.x.
- [Select ★20](https://github.com/FidelLimited/serverless-plugin-select) - Select which functions are to be deployed based on region and stage.
- [Webpack ★62](https://github.com/goldwasserexchange/serverless-plugin-webpack) - Plugin to automatically bundle your functions individually with Webpack.
- [OpenWhisk ★88](https://github.com/serverless/serverless-openwhisk) - Add OpenWhisk support to the Serverless Framework.
- [Warmup ★214](https://github.com/FidelLimited/serverless-plugin-warmup) - Keep Lambdas warm so to avoid slow cold starts.
- [ReasonML ★25 ⏳1Y](https://github.com/ReasonVienna/serverless-reason-plugin) - Use ReasonML with Serverless.
- [Gulp ★9](https://github.com/rhythminme/serverless-gulp) - A thin task wrapper around Serverless.
- [.env ★4](https://github.com/Jimdo/serverless-dotenv) - Plugin to fetch environment variables and write it to a .env file.
- [Common excludes ★11](https://github.com/dougmoscrop/serverless-plugin-common-excludes) - Exclude common things from your Serverless package.
...
- [Import swagger ★20](https://github.com/AKIRA-MIYAKE/serverless-import-swagger) - Import functions from swagger spec file to serverless.yml.
...
- [SQS alarms ★17](https://github.com/sbstjn/serverless-sqs-alarms-plugin) - Wrapper to setup CloudWatch Alarms on SQS queue length.
- [SQS fifo ★5](https://github.com/vortarian/serverless-sqs-fifo) - Plugin to handle creation of SQS fifo queue's in aws (stop-gap).
- [Wavefront rollback ★6 ⏳1Y](https://github.com/wavefrontHQ/wavefront-serverless-rollback-plugin) - Plugin for doing a Lambda rollback when Wavefront alert fires.
...
- [IOpipe ★27](https://github.com/iopipe/serverless-plugin-iopipe) - Automatically wrap your serverless framework functions with IOpipe.
- [API Gateway ★2 ⏳1Y](https://github.com/btxhuman/locision-serverless-plugin-api-gateway) - Replaces API Gateway resources.
- [Parameters ★9](https://github.com/svdgraaf/serverless-parameters) - Add parameters to the generated CloudFormation templates.
- [Pseudo parameters ★46](https://github.com/svdgraaf/serverless-pseudo-parameters) - Use ${AWS::AccountId} and other CloudFormation pseudo parameters in your `serverless.yml` values.
- [DynamoDB TTL ★14](https://github.com/Jimdo/serverless-dynamodb-ttl) - Configure DynamoDB TTL in serverless.yml (until CloudFormation supports this).
- [API stage ★11](https://github.com/leftclickben/serverless-api-stage) - Enables stage variables and logging for AWS API Gateway.
- [API Gateway auth ★4 ⏳1Y](https://github.com/frankleonrose/api-gateway-auth-plugin) - Plugin supporting AWS_IAM authorizer on API Gateway method.
- [Api Gateway auth](https://github.com/nochtap/serverless-plugin-api-gateway-auth) - Fork of the [API Gateway auth plugin ★4 ⏳1Y](https://github.com/frankleonrose/api-gateway-auth-plugin) with some enhancements.
- [Export env ★16](https://github.com/arabold/serverless-export-env) - Export environment variables into a .env file with automatic AWS CloudFormation reference resolution.
- [Split stacks ★44](https://github.com/dougmoscrop/serverless-plugin-split-stacks) - Generates nested stacks to get around the 200 resource CloudFormation limit.
- [OpenFaaS](https://github.com/openfaas/serverless-openfaas) - Provider plugin for the [OpenFaaS project ★10353](https://github.com/openfaas/faas).
- [Package Python functions ★44](https://github.com/ubaniabalogun/serverless-package-python-functions) - Packaging Python Lambda functions with only the dependencies/requirements they need.
- [Swagger to Serverless ★11 ⏳1Y](https://github.com/poi5305/swagger-to-serverless) - Convert `swagger.yml` to `serverless.yml`.
- [Custom domain ★2](https://github.com/Icenium/serverless-custom-domain) - Custom domain support.
- [Stack config ★5](https://github.com/rawphp/serverless-plugin-stack-config) - Manage configurations for a stack across micro-services.
- [SAM ★66](https://github.com/SAPessi/serverless-sam) - Exports an AWS SAM template for a service created with the Serverless Framework.
- [ElasticBeanstalk ★11](https://github.com/rawphp/serverless-plugin-elastic-beanstalk) - Deploy applications to AWS ElasticBeanstalk.
- [VPC discovery ★14](https://github.com/amplify-education/serverless-vpc-discovery) - Serverless plugin for discovering VPC / Subnet / Security Group configuration by name.
...
- [Export endpoints ★5](https://github.com/ar90n/serverless-plugin-export-endpoints) - Export Lambda endpoints as JSON.
- [Tracing](https://github.com/AlexanderMS/serverless-plugin-tracing) - Enables AWS X-Ray tracing.
- [Custom domain ★32](https://github.com/dougmoscrop/serverless-plugin-custom-domain) - Add API Gateway custom domain BasePathMappings reliably.
- [Kubeless](https://github.com/kubeless/serverless-plugin) - Provider plugin for deploying functions to Kubeless.
- [Client S3 ★6 ⏳1Y](https://github.com/bbandydd/serverless-client-s3) - Deploy front-end assets to S3.
- [API Gateway binary ★22](https://github.com/ryanmurakami/serverless-apigwy-binary) - Configure binary responses in API Gateway.
- [Domain manager ★187](https://github.com/amplify-education/serverless-domain-manager) - Plugin for managing custom domains with API Gateways.
- [Encrypted ★8](https://github.com/nalbion/serverless-plugin-encrypted) - Encrypts Lambda environment variables using a KMS key.
- [Localstack ★75](https://github.com/temyers/serverless-localstack) - Plugin for running against Atalssian Localstack.
- [Purdyrest](https://www.npmjs.com/package/serverless-purdyrest) - Use Purdyrest with the Serverless Framework.
- [S3 upload ★5 ⏳1Y](https://github.com/telerik/serverless-s3-upload) - Uploads files / folders to an AWS S3 bucket.
- [WSGI export env](https://github.com/phil-hachey/serverless-wsgi-export-env) - WSGI export env plugin.
- [Webpack ★3](https://github.com/sandfox/serverless-webpack-plugin) - Fork of the `serverless-webpack` plugin with some bugfixes and enhancements.
...
- [Stack output ★24](https://github.com/sbstjn/serverless-stack-output) - Store output from your AWS CloudFormation Stack in JSON/YAML/TOML files, or to pass it to a JavaScript function for further processing.
- [OpenAPI documentation ★22](https://github.com/temando/serverless-openapi-documentation) - Generate OpenAPI V3 documentation from a Serverless configuration.
- [Build substitute ★3 ⏳1Y](https://github.com/zyrorl/serverless-build-substitute-plugin) - Build plugin to substitute files into a build (eg. AWS binaries into node_modules).
- [Sentry ★71](https://github.com/arabold/serverless-sentry-plugin) - Sentry integration for Serverless v1.
- [Finch ★131](https://github.com/fernando-mc/serverless-finch) - Plugin for static site deployments.
- [Env generator ★18](https://github.com/DieProduktMacher/serverless-env-generator) - Manage environment variables with YAML and turn them into a .env file on deployment.
- [Local dev server ★14](https://github.com/DieProduktMacher/serverless-local-dev-server) - Local development server to speed up the development of Alexa Skills, chatbots, APIs and more.
- [Log forward ★15](https://github.com/amplify-education/serverless-log-forwarding) - Forwarding CloudWatch logs to another Lambda function.
- [S3 remover ★13](https://github.com/sinofseven/serverless-s3-remover) - Ensures that S3 buckets are empty before Serverless remove logic runs.
- [DynamoDB autoscaling ★103](https://github.com/sbstjn/serverless-dynamodb-autoscaling) - Configure Amazon DynamoDB native auto-scaling for your table capacities.
- [Bespoken ★22](https://github.com/bespoken/serverless-plugin-bespoken) - Creates a local server and a proxy so you don't have to deploy anytime you want to test your code for your [Bespoken](http://bespoken.tools) application.
- [S3 bucket sync ★13](https://github.com/sbstjn/serverless-s3bucket-sync) - Sync local folders with an S3 bucket.
- [S3 sync ★32](https://github.com/k1LoW/serverless-s3-sync) - Sync local directories and S3 prefixes.
- [Nested stacks ★16](https://github.com/jagdish-176/serverless-nested-stack) - Plugin to workaround the CloudFormation 200 resource limit.
- [Kubeless ★122](https://github.com/serverless/serverless-kubeless) - Official provider plugin to deploy functions to Kubeless.
- [LogSubscription ★8](https://github.com/dougmoscrop/serverless-plugin-log-subscription) - Adds a CloudWatch LogSubscription for functions.
- [Patch ★2](https://github.com/vinodsr/serverless-patch) - Patch Serverless with custom stack and API naming configuration.
- [PureSec CLI ★59](https://github.com/puresec/serverless-puresec-cli) - Plugin for least privileges.
- [CF vars](https://gitlab.com/kabo/serverless-cf-vars) - Enables use of AWS pseudo functions and `Fn::Sub` string substitution.
- [Custom packaging ★3](https://github.com/hypoport/serverless-custom-packaging-plugin) - Package your source code using a custom target path inside the `.zip`.
- [AWS Step Functions demo ★15 ⏳1Y](https://github.com/AgileVisionCompany/step-functions-demo) - AWS Step Functions demo service.
- [Reducer ★6](https://github.com/medikoo/serverless-plugin-reducer) - Reduce Lambda package so it hosts only Lambda dependencies.
- [Transpiler ★3](https://github.com/medikoo/serverless-plugin-transpiler) - Transpile Lambda files when packaging Lambda.
- [Log streaming ★6](https://github.com/rifflock/serverless-logstreaming-plugin) - Stream logs to a handler function.
- [Lambda@Edge ★63](https://github.com/silvermine/serverless-plugin-cloudfront-lambda-edge) - Adds Lambda@Edge support to Serverless.
- [API Gateway ★6](https://github.com/GFG/serverless-apigateway-plugin) - Configure the AWS API Gateway: Binary support, Headers and Body template mappings.
- [Spotinst Functions ★12](https://github.com/spotinst/serverless-spotinst-functions) - Spotinst Functions provider plugin for the Serverless Framework.
...
- [Develop ★8](https://github.com/RafalWilinski/serverless-develop) - Deploy your functions to AWS Lambda as you code, in realtime.
- [Micro ★20](https://github.com/barstoolsports/serverless-micro) - Plugin to help manage multiple microservices under one main service.
- [API Gateway <--> CloudFront ★53](https://github.com/Droplr/serverless-api-cloudfront) - Adds CloudFront distribution in front of your API Gateway for custom domain, CDN caching and access log.
- [Localstack SNS ★4](https://github.com/mj1618/serverless-localstack-sns) - Listens to localstack SNS and call Lambda functions with events.
- [Offline SNS ★33](https://github.com/mj1618/serverless-offline-sns) - Run an SNS server and call Lambdas with events notifications.
- [Alibaba Cloud Function Compute ★35](https://github.com/aliyun/serverless-aliyun-function-compute) - Alibaba Cloud Function Compute Plugin – Add Alibaba Cloud Function Compute support to the Serverless Framework.
- [Bootstrap ★4](https://github.com/dougmoscrop/serverless-plugin-bootstrap) - Checks that the environment around your Serverless service has been set up and is up-to-date.
...
- [SSM fetch ★10](https://github.com/gozup/serverless-ssm-fetch) - Sets SSM parameters into function environment variables.
- [Secrets ★38](https://github.com/serverless/serverless-secrets-plugin) - Plugin to manage Secrets.
- [State manager ★10](https://github.com/jeremydaly/serverless-stage-manager) - Super simple plugin for validating stage names before deployment.
- [StackStorm ★26](https://github.com/StackStorm/serverless-plugin-stackstorm) - Run StackStorm actions serverless and stackstormless.
- [SPA ★15](https://github.com/gilmarsquinelato/serverless-spa) - Deploy your static website with webpack to AWS using the Serverless Framework.
- [AWS resource names ★5](https://github.com/concon121/serverless-plugin-aws-resource-names) - Enable custom AWS resource names.
- [Nested stacks ★4](https://github.com/concon121/serverless-plugin-nested-stacks) - Nested stacks support.
- [Alexa skills ★24](https://github.com/marcy-terui/serverless-alexa-skills) - Manage your Alexa skills with Serverless Framework.
- [Attach Managed Policy ★6](https://github.com/Nordstrom/serverless-attach-managed-policy) - Automatically attach an AWS Managed IAM Policy (or Policies) to all IAM Roles created by the service.
- [DynamoDB auto scaling ★7](https://github.com/medikoo/serverless-plugin-dynamodb-autoscaling) - Auto generate auto scaling configuration for configured DynamoDB tables.
...
- [CloudFormation Change Sets ★20](https://github.com/trek10inc/serverless-cloudformation-changesets) - Natively deploy to CloudFormation via Change Sets, instead of directly.
- [CloudFormation cross region variables ★4](https://github.com/blueflag/serverless-plugin-cloudformation-cross-region-variables) - Adds new Serverless Variables syntax to share variables across regions via CloudFormation.
- [Tracer ★4](https://github.com/enykeev/serverless-plugin-tracer) - Trace Serverless Framework hooks as they execute.
- [IoT Local ★9](https://github.com/tradle/serverless-iot-local) - AWS Iot lifecycle and regular topic subscription events.
- [SNS Filter ★10](https://github.com/MechanicalRock/serverless-sns-filter) - Add SNS subscription filters to events.
- [Reqvalidator ★19](https://github.com/RafPe/serverless-reqvalidator-plugin) - Add request validator to API Gateway methods.
- [Ephemeral ★36](https://github.com/Accenture/serverless-ephemeral) - Plugin which helps bundling any stateless zipped library to AWS Lambda.
- [Step Functions Offline ★26](https://github.com/vkkis93/serverless-step-functions-offline) - Emulate step functions locally when developing your Serverless project.
- [S3 Encryption ★4](https://github.com/tradle/serverless-s3-encryption) - Set or remove the encryption settings on the S3 buckets in your Serverless stack.
- [CloudFormation Parameter Setter ★11](https://github.com/trek10inc/serverless-cloudformation-parameter-setter) - Set CloudFormation parameters when deploying using the Serverless Framework.
...
- [AppSync ★154](https://github.com/sid88in/serverless-appsync-plugin) - Serverless plugin for AWS AppSync.
- [CloudFormation resource counter ★1](https://github.com/drexler/serverless-cloudformation-resource-counter) - Count the resources generated in the AWS CloudFormation stack after deployment.
- [Serverless Haskell ★81](https://github.com/seek-oss/serverless-haskell) - Deploying Haskell applications to AWS Lambda.
- [IAM roles per function ★58](https://github.com/functionalone/serverless-iam-roles-per-function) - Plugin to define IAM roles per function.
- [Functions base path ★8](https://github.com/kevinrambaud/serverless-functions-base-path) - Easily define a base path where your serverless functions are located.
- [Metric ★6](https://github.com/alex20465/serverless-plugin-metric) - Automatically create `AWS::Logs::MetricFilter` resources.
- [Node shim ★11](https://github.com/jzimmek/serverless-plugin-node-shim) - Run your functions with Node.js version (8 LTS, 9+) on AWS Lambda.
- [Static ★9](https://github.com/iliasbhal/serverless-static) - Serve / deploy static files that works with the `serverless-offline` plugin.
- [Remove forced login ★0](https://github.com/pmuens/serverless-remove-forced-login) - Removes the forced login when using `serverless run` and `serverless emit`.
- [Go build ★15](https://github.com/sean9keenan/serverless-go-build) - Build go source files (or public functions) using yml definition file.
- [CloudFormation Sub variables ★5](https://github.com/santiagocardenas/serverless-cloudformation-sub-variables) - Add support for AWS CloudFormation Sub intrinsic function variables.
- [Local environment ★4](https://github.com/piercus/serverless-local-environment) - Set local environment variables.
- [Offline SSM ★10](https://github.com/janders223/serverless-offline-ssm) - Read SSM parameters from a `.env` file instead of AWS.
- [Nocode ★9](https://github.com/ServerlessOpsIO/serverless-nocode) - Deploy nocode via the Serverless Framework.
- [Canary deployments ★71](https://github.com/davidgf/serverless-plugin-canary-deployments) - Implement canary deployments of AWS Lambda functions.
- [Flow-based programming ★4 ⏳1Y](https://github.com/p0wl/serverless-fbp) - Flow-based programming plugin for Serverless.
- [Go serverless ★1](https://github.com/thepauleh/goserverless) - GoFormation for the Serverless Framework. Create Serverless configs with Go structs.
- [Event Gateway ★9](https://github.com/serverless/serverless-event-gateway-plugin) - Event Gateway plugin for the Serverless Framework.
- [Fn ★3](https://github.com/fnproject/serverless-fn) - Fn provider plugin.

## Literature / Education

- [Serverless book - By the Serverless team ★103](https://github.com/pmuens/serverless-book) - Book focused on v1 of the [serverless.com](http://serverless.com) framework.
...
- [Event Gateway Workshop ★14](https://github.com/serverless/event-gateway-workshop) - Learn what the Event Gateway is, how it works and build your first event-driven multi-cloud application.
...
- [AWSM ★172 ⏳2Y](https://github.com/awsm-org/awsm) - Official GitHub organization for modules.
...
- [Serverless starter ★172](https://github.com/serverless/serverless-starter) - Boilerplate for new projects.
...
- [Demo with DynamoDB ★89 ⏳2Y](https://github.com/abalone0204/serverless-demo-with-dynamodb-node) - Simple REST API with the Serverless Framework.

### Plugins (v0.5)

- [Plugin boilerplate ★23 ⏳1Y](https://github.com/serverless/serverless-plugin-boilerplate) - Boilerplate code if you want to develop your own plugin.
- [Serverless resources validation ★12 ⏳2Y](https://github.com/tmilewski/serverless-resources-validation-plugin) - Plugin which validates your CloudFormation template.
- [Alerting ★27 ⏳1Y](https://github.com/martinlindenberg/serverless-plugin-alerting) - Add Cloudwatch Alarms with SNS notifications.
- [Lambda prune ★22 ⏳2Y](https://github.com/Nopik/serverless-lambda-prune-plugin) - Automatically remove unused Lambda functions.
- [Autoprune ★4 ⏳2Y](https://github.com/kennu/serverless-plugin-autoprune) - Automatically remove unused Lambda functions.
- [Swagger](https://github.com/marklawlor/serverless-swagger) - Swagger.io plugin.
- [CORS ★72 ⏳1Y](https://github.com/joostfarla/serverless-cors-plugin) - CORS plugin.
- [Serve ★105 ⏳2Y](https://github.com/Nopik/serverless-serve) - Test your lambda functionality locally.
...
- [Cronjob ★12 ⏳2Y](https://github.com/martinlindenberg/serverless-plugin-cronjob) - Plugin for Cronjobs.
- [API Blueprint ★5 ⏳2Y](https://github.com/hiroara/serverless-api-blueprint) - API documentation generator.
- [VPC ★7 ⏳2Y](https://github.com/martinlindenberg/serverless-plugin-vpc) - VPC support.
- [Client S3 ★167](https://github.com/serverless/serverless-client-s3) - Handle static asset serving (like static frontends) via S3.
...
- [JSHint ★16 ⏳2Y](https://github.com/joostfarla/serverless-jshint-plugin) - Detect errors and potential problems in your Lambda functions.
- [Webpack ★66 ⏳1Y](https://github.com/asprouse/serverless-webpack-plugin) - Use Webpack to optimize your Serverless Node.js Functions.
- [Runtime Babel ★70 ⏳1Y](https://github.com/serverless/serverless-runtime-babel) - Babel runtime for the Serverless framework (so that ES6 and ES7 syntax can be used).
- [Runtime Streamline ★0 ⏳2Y](https://github.com/marclar/serverless-runtime-streamline) - Streamline.js for Serverless.
- [Meta Sync ★45 ⏳2Y](https://github.com/serverless/serverless-meta-sync) - Synchronize project credentials via AWS.
- [GraphiQL ★6 ⏳2Y](https://github.com/marclar/serverless-graphiql) - Deploys a GraphiQL client to a public S3 bucket.
- [S3 ★0 ⏳2Y](https://github.com/camhart/sls-s3) - Deploy files to S3.
- [Swagger ★40 ⏳1Y](https://github.com/serverless/serverless-swagger-plugin) - Swagger plugin.
- [Synchronous resource ★2 ⏳2Y](https://github.com/stelligent/serverless-synchronous-resource-plugin) - Plugin for deploying custom CFN stacks.
- [Models ★23 ⏳1Y](https://github.com/HyperBrain/serverless-models-plugin) - Plugin for model support.
- [Mocha](https://github.com/SC5/serverless-mocha-plugin) - Plugin to use Mocha.js.
- [Package ★5 ⏳2Y](https://github.com/HyperBrain/serverless-package-plugin) - Adds function packaging.
...
- [npm registry ★10 ⏳2Y](https://github.com/Inbot/awsm-npm-registry) - npm registry.
...
- [Stripe webhook ★21 ⏳2Y](https://github.com/eahefnawy/serverless-stripe-webhook) - Webhook for Stripe payments.
- [Slack webhook ★8 ⏳2Y](https://github.com/eahefnawy/serverless-slack-webhook) - Webhook for Slack.
- [Slack ★45 ⏳2Y](https://github.com/serverless/serverless-slack) - Slack boilerplate functionality.
- [Examples ★33 ⏳2Y](https://github.com/remicastaing/serverless-examples) - Module with example functions.
- [Slackbot ★137 ⏳2Y](https://github.com/serverless/serverless-slackbot) - Module to create your own slackbot.
- [Images ★22 ⏳2Y](https://github.com/awsm-org/awsm-images) - Image modifications.
- [Cloudfront ★27 ⏳2Y](https://github.com/boushley/awsm-cloudfront) - Puts CloudFront distribution in front of your project.
- [S3 token vendor ★4 ⏳1Y](https://github.com/binoculars/awsm-s3tokenvendor) - Return upload tokens for S3 objects.
- [Loggly ★4 ⏳2Y](https://github.com/jwulf/awsm-loggly) - Provide logging to your lambdas.
- [Middleware ★8 ⏳2Y](https://github.com/jwulf/awsm-middleware) - Middleware for your project.
- [GitHub Webhook ★0 ⏳2Y](https://github.com/bisque33/awsm-github-webhook) - GitHub webhook support.
- [Comments ★0 ⏳2Y](https://github.com/donleyp/awsm-comments) - Implements comments using DynamoDB.
- [3scale ★0 ⏳2Y](https://github.com/jerzyn/awsm-3scale) - Integrates 3scale API management platform.
