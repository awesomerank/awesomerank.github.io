...
---
# Awesome JVM [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
...
* [Jitescript ★139](qmx/jitescript) - Bytecode generation library similar to BiteScript. 
...
* [wrk2 ★958](giltene/wrk2) - A constant throughput, correct latency recording variant of wrk.
...
* [Frege ★2771](Frege/frege) - Pure functional programming language in the spirit of Haskell.
* [gojava ★141](sridharv/gojava) - Java bindings for Go packages.
...
* [Rembulan ★79](mjanicek/rembulan) - Rembulan is an implementation of Lua 5.3 for the JVM, written in pure Java with minimal dependencies.
...
* [Agera ★6525](google/agera) - Reactive Programming for Android by Google.
* [Agrona ★793](real-logic/Agrona) - Library of data structures and utility methods that are a common need when building high-performance applications.
* [Apache Arrow](http://arrow.apache.org/) - A high-performance cross-system data layer for columnar in-memory analytics.
* [bloofi ★52 ⏳1Y](lemire/bloofi) - Java implementation of multidimensional Bloom filters
* [Cap’n Proto](https://capnproto.org/) - Insanely fast data interchange format and capability-based RPC system.
* [caffeine ★2601](ben-manes/caffeine) - A high performance caching library for Java 8.
* [Chronicle-Bytes ★72](OpenHFT/Chronicle-Bytes) - Low level memory access wrappers.
* [Chronicle-Queue ★1096](OpenHFT/Chronicle-Queue) - Micro second messaging that stores everything to disk.
* [Chronicle-Map ★986](OpenHFT/Chronicle-Map) - In-memory key-value store designed for low-latency and/or multi-process applications.
* [clj-ds ★209 ⏳3Y](krukow/clj-ds) - Clojure's data structures modified for use outside of Clojure.
* [colfer ★225](pascaldekloe/colfer) - Binary serialization format and class generator.
...
* [CuckooFilter4J ★34](MGunlogson/CuckooFilter4J) - Bloom filter replacement for approximated set-membership queries.
* [cyclops ★349](aol/cyclops) - Integration modules for RxJava, Reactor, FunctionalJava, Guava & Javaslang.
* [java-concurrent-hash-trie-map ★100](romix/java-concurrent-hash-trie-map) - Java port of a concurrent trie hash map implementation from Scala collections.
* [java-hll ★182](aggregateknowledge/java-hll) - Java library for the HyperLogLog algorithm.
* [JavaFastPFOR ★259](lemire/JavaFastPFOR) - Library to compress and uncompress arrays of integers very fast.
* [fasttuple ★125](boundary/fasttuple) - Collections that are laid out adjacently in both on- and off-heap memory.
...
* [geohash ★184](davidmoten/geo) - Java utility methods for geohashing.
* [gs-collections ★1663 ⏳1Y](goldmansachs/gs-collections) - Goldman Sachs collections framework.
* [hollow ★483](Netflix/hollow) - Java library and comprehensive toolset for harnessing small to moderately sized in-memory datasets.
...
* [lwjgl3 ★1218](LWJGL/lwjgl3) - Java library that enables cross-platform access to popular native APIs useful in the development of graphics (OpenGL), audio (OpenAL) and parallel computing (OpenCL) applications.
...
* [ohc ★187](snazy/ohc) - Java large off heap cache developed for Apache Cassandra 3.0.
* [okio ★3848](square/okio) - Modern Java IO library that do clever things to save CPU and memory.
...
* [rtree ★500](davidmoten/rtree) - Immutable in-memory R-tree and R*-tree implementations in Java with reactive api.
...
* [RoaringBitmap ★555](RoaringBitmap/RoaringBitmap) - A better compressed bitset in Java.
* [rollinghashjava ★40 ⏳1Y](lemire/rollinghashjava) - Rolling hash functions in Java.
* [Reactor](http://projectreactor.io/) - Reactive data applications on the JVM for Java, Groovy, Clojure and other.
* [RxJava ★24565](ReactiveX/RxJava) - Library for composing asynchronous and event-based programs using observable sequences.
* [SmoothieMap ★117 ⏳1Y](OpenHFT/SmoothieMap) - java.util.Map impl with worst put latencies more than 100 times smaller than java.util.HashMap.
* [Simple Binary Encoding ★1107](real-logic/simple-binary-encoding) - High Performance Message Codec.
...
* [auto ★5059](google/auto) - A collection of source code generators for Java.
...
* [compile-testing ★356](google/compile-testing) - Testing tools for javac and annotation processors.
* [derive4j ★255](derive4j/derive4j) - Algebraic data types constructors, pattern-matching, morphisms, optics and typeclasses.
...
* [javaparser ★1101](javaparser/javaparser) - Java 1.8 Parser and Abstract Syntax Tree for Java.
* [JavaPoet ★3511](square/javapoet) - A Java API for generating .java source files.
* [jparsec ★173](jparsec/jparsec) - Builds mini parsers in pure Java a la Haskell Parsec.
...
* [parboiled ★1002](sirthias/parboiled) - Parsing of arbitrary input text based on parsing expression grammars.
* [Sulong ★318](graalvm/sulong) - LLVM IR interpreter written in Java using Truffle and Graal.
* [TeaVM ★417](konsoletyper/teavm) - Ahead-of-time translating compiler (transpiler) from Java bytecode to JavaScript.
...
* [hawtjni ★61](fusesource/hawtjni) - A JNI code generator based on the JNI generator used in Eclipse SWT.
* [j2v8 ★652](eclipsesource/j2v8) - Java API for Google's V8 JavaScript engine.
* [JavaCPP ★1946](bytedeco/javacpp) - JavaCPP provides efficient access to native C++ inside Java.
* [jnr-ffi ★410](jnr/jnr-ffi) - Load native libraries without writing JNI code by hand.
* [jssembly ★104](dvx/jssembly) - Execution of native assembly from Java.
* [NuProcess ★214](brettwooldridge/NuProcess) - A low-overhead, non-blocking I/O, external Process execution implementation for Java.
...
* [armeria ★783](line/armeria) - Asynchronous RPC/API client/server library built on top of Java 8, Netty 4.1, HTTP/2, and Thrift.
* [comcast ★4735](tylertreat/comcast) - Simulating shitty network connections.
...
* [jRT ★25](LatencyUtils/jRT) - Measures response time of a java application to socket-based requests.
* [K3PO ★28](k3po/k3po) - Create arbitrary network traffic and behavior to certify whether a network endpoint behaves correctly.
...
* [tcpflow ★681](simsong/tcpflow) - Captures TCP connections flows in a way that is convenient for protocol analysis and debugging.
* [tcpreplay ★231](appneta/tcpreplay) - Pcap editing and replay tools.
...
* [likwid ★406](RRZE-HPC/likwid) - Read hardware performance counters on Intel and AMD processors.
...
* [perf-tools ★3318](brendangregg/perf-tools) - Performance analysis tools based on Linux perf_events (aka perf) and ftrace.
...
* [allocation-instrumenter ★198](google/allocation-instrumenter) - Java agent that rewrites bytecode to instrument allocation sites.
* [aprof ★93](Devexperts/aprof) - Java memory allocation profiler.
...
* [GCViewer ★1692](chewiebug/GCViewer) - GCViewer is a tool that visualizes verbose GC output.
* [hawkshaw ★38 ⏳1Y](jClarity/hawkshaw) - Tools for tracking down memory / JVM problems & generating predictable-as-possible VM behaviour.
...
* [HdrLogProcessing ★20](nitsanw/HdrLogProcessing) - Utilities for HDR Histogram logs manipulation.
* [heapster ★331 ⏳1Y](mariusae/heapster) - Production heap profiling for the JVM.
...
* [jamm ★379](jbellis/jamm) - Measure actual object memory use including JVM overhead.
...
* [java-sizeof ★97 ⏳1Y](dweiss/java-sizeof) - Memory consumption estimator for Java.
...
* [jfr-flame-graph ★86](chrishantha/jfr-flame-graph) - Converting JFR Method Profiling Samples to FlameGraph compatible format.
* [jitwatch ★1102](AdoptOpenJDK/jitwatch) - Log analyser / visualiser for Java HotSpot JIT compiler.
* [jitwatch-intellij ★135](yole/jitwatch-intellij) - JITWatch plugin for IntelliJ IDEA.
...
* [jmh-compare-gui ★46](akarnokd/jmh-compare-gui) - GUI for comparing JMH results.
...
* [jvmtop ★531](patric-r/jvmtop) - Lightweight console application to monitor running jvms on a machine in top-like manner.
* [MAT](https://eclipse.org/mat/) - Java heap analyzer that help find memory leaks and reduce memory consumption.
* [leakcanary ★15263](square/leakcanary) - A memory leak detection library for Android and Java.
...
* [perfj ★280 ⏳1Y](coderplay/perfj) - Linux perf for java programs.
* [polarbear ★18 ⏳4Y](Cue/polarbear) - A tool to help diagnose OutOfMemoryError conditions.
* [Riemann JVM Profiler ★257 ⏳2Y](riemann/riemann-jvm-profiler) - JVM agent which sends function-level profiler telemetry to a Riemann server for analysis, visualization, and storage.
* [statsd-jvm-profiler ★235](etsy/statsd-jvm-profiler) - JVM agent profiler that sends profiling data to StatsD.
* [Swiss Java Knife ★1353](aragozin/jvm-tools) - Small set of tools for JVM troublshooting, monitoring and profiling.
* [Takipi](https://www.takipi.com/) - Tells you when and why code breaks in production.
* [Tracer ★52](zalando/tracer) - Manages custom trace identifiers and carries them through distributed systems.
* [YourKit](https://www.yourkit.com/) - Fully featured, easy to use, low overhead profiler.
* [Zipkin ★5840](openzipkin/zipkin) - A distributed tracing system gather timing data for disparate services developed by Twitter.


## Runtimes

*Tools for managing jvm runtime processes*
* [Capsule ★1033](puniverse/capsule) - Dead-Simple Packaging and Deployment for JVM Apps.
* [CRaSH](http://www.crashub.org/) - The shell for the Java Platform.
* [Drip ★1379 ⏳1Y](ninjudd/drip) - Fast JVM launching without the hassle of persistent JVMs.
* [HotswapAgent ★750](HotswapProjects/HotswapAgent) - Redefine classes at runtime and skip the redeploy process.
* [jvmkill ★41](airlift/jvmkill) - Agent that forcibly terminates the JVM when it is unable to allocate memory or create a thread.
...
* [Avian ★945](ReadyTalk/avian) - Lightweight highly portable JVM with an option for AOT compilation.
...
* [J2ObjC ★4746](google/j2objc) - Translator from Java source to Objective-C code. Keeps shared code between iOS native apps and Android native apps. 
* [jvm.go ★1882](zxh0/jvm.go) - A JVM written in Go.
...
* [An introduction to distributed systems ★3230](aphyr/distsys-class) - Kyle Kingsbury (author of Jepsen).
