...
* [dropwizard-swagger ★109](https://github.com/smoketurner/dropwizard-swagger) - Serves Swagger UI static content and loads Swagger endpoints.
* [dropwizard-jaxws ★43](https://github.com/roskart/dropwizard-jaxws) - enables building SOAP web services and clients using JAX-WS API.
...
* [dropwizard-xml ★29](https://github.com/yunspace/dropwizard-xml) - Dropwizard bundle for processing and validating XMLs
...
* [dropwizard-protobuf ★36](https://github.com/dropwizard/dropwizard-protobuf) - Support for reading and writing Google Protocol Buffer objects within Dropwizard
...
* [dropwizard-consul ★48](https://github.com/smoketurner/dropwizard-consul) - A Consul bundle for Dropwizard
* [dropwizard-zipkin ★33](https://github.com/smoketurner/dropwizard-zipkin) - A Zipkin bundle for Dropwizard
* [dropwizard-graphql ★17](https://github.com/smoketurner/dropwizard-graphql) - A GraphQL bundle for Dropwizard
* [dropwizard-money ★1](https://github.com/smoketurner/dropwizard-money) - A Money bundle for Dropwizard
* [breakerbox ★61](https://github.com/yammer/breakerbox) - Frontend for Tenacity + Archaius
* [tenacity ★206](https://github.com/yammer/tenacity) - A Hystrix bundle for Dropwizard
* [dropwizard-grpc ★16](https://github.com/msteinhoff/dropwizard-grpc) - use a gRPC server in a Dropwizard service
* [sqs-dropwizard ★10](https://github.com/bascan/aws-dropwizard) - Amazon SQS integration
...
* [dropwizard-elasticsearch ★50](https://github.com/dropwizard/dropwizard-elasticsearch) - A set of classes for using Elasticsearch in a Dropwizard service
...
* [dropwizard-cassandra ★59](https://github.com/composable-systems/dropwizard-cassandra) - Dropwizard support for Cassandra
...
* [dropwizard-atomix ★0](https://github.com/smoketurner/dropwizard-atomix) - Integration with [Atomix](http://atomix.io/atomix/)
...
* [dropwizard-raven ★16](https://github.com/tradier/dropwizard-raven) - Dropwizard integration for error logging to Sentry
...
* [dropwizard-quartz ★55 ⏳2Y](https://github.com/jaredstehler/dropwizard-quartz) - Simple Job Scheduler implementation integrating Guice and Quartz.
* [dropwizard-jobs ★101](https://github.com/spinscale/dropwizard-jobs) - Quartz integration for dropwizard
* [dropwizard-sundial ★26](https://github.com/timmolter/dropwizard-sundial) - Scheduled jobs in Dropwizard using Sundial

### Guice

* [dropwizard-guice ★241](https://github.com/HubSpot/dropwizard-guice) - Adds support for Guice.
* [dropwizard-guicey ★112](https://github.com/xvik/dropwizard-guicey) - Dropwizard guice integration
...
Check out more [awesome projects ★73813](https://github.com/sindresorhus/awesome).
