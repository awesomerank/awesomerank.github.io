...
* [HardCoreData ★203 ⏳2Y](Krivoblotsky/HardCoreData) - CoreData stack and controller that will never block UI thread.
...
* [AFNetworkActivityLogger ★472 ⏳1Y](AFNetworking/AFNetworkActivityLogger) - AFNetworking 2.0 Extension for Network Request Logging
...
* [PryntTrimmerView ★52](prynt/PryntTrimmerView) - A set of UI elements to trim, crop and select frames inside a video. :large_orange_diamond:
...
* [FlatBuffersSwift ★453](mzaks/FlatBuffersSwift) - This project brings FlatBuffers (an efficient cross platform serialization library) to Swift. :large_orange_diamond:
...
* [SwiftCssParser ★177](100mango/SwiftCssParser) - A Powerful , Extensible CSS Parser written in pure Swift. :large_orange_diamond:
...
* [MarkdownView ★758](keitaoouchi/MarkdownView) - Markdown View for iOS. 🔶
...
* [SendIndicator ★19](LeonardoCardoso/SendIndicator) - Yet another task indicator :large_orange_diamond:
...
* [Wave ★59 ⏳1Y](onmyway133/Wave) - :ocean: Declarative chainable animations in Swift :large_orange_diamond:
...
* [Dodo ★732](evgenyneu/Dodo) - A message bar for iOS written in Swift. :large_orange_diamond:
...
* [swift-badge ★188](evgenyneu/swift-badge) - Badge view for iOS written in swift :large_orange_diamond:
...
* [Toolbar ★312](1amageek/Toolbar) - Awesome autolayout Toolbar. :large_orange_diamond:
...
* [MIBlurPopup ★260](MarioIannotta/MIBlurPopup) - MIBlurPopup let you create amazing popups with a blurred background.
...
* [Cosmos ★624](evgenyneu/Cosmos) - A star rating control for iOS / Swift :large_orange_diamond:
...
* [mosaic-layout ★132](vinnyoodles/mosaic-layout) - A mosaic collection view layout inspired by Lightbox's Algorithm, written in Swift :large_orange_diamond:
...
* [Savory ★1](Nandiin/Savory) - A swift accordion view implementation. :large_orange_diamond:
* [PagingView ★231](KyoheiG3/PagingView) - Infinite paging, Smart auto layout, Interface of similar to UIKit. :large_orange_diamond:🔶
