...
* [Official GitHub Repo ★10513](https://github.com/aurelia/framework)
...
* [vscode-aurelia-snippets ★13 ⏳1Y](https://github.com/behzad888/vscode-aurelia-snippets) * HTML, JavaScript and TypeScript snippets for VSCode
* [aurelia-update ★17 ⏳1Y](https://github.com/SpoonX/aurelia-update) * Update all aurelia dependencies easily.
* [aurelia-template-lint ★0](https://github.com/MeirionHughes/aurelia-template-lint) * Sanity check of Aurelia-flavor template HTML
* [atom-aurelia-snippets](https://atom.io/packages/atom-aurelia-snippets) * JavaScript and TypeScript snippets for atom
* [aurelia-installer ★3 ⏳1Y](https://github.com/kristianmandrup/aurelia-installer) * CLI for managing Aurelia components and vendor libs
...
* [TypeScript + Webpack Starter Kit ★29](https://github.com/michaelbull/aurelia-typescript-webpack-starter) * A minimal Aurelia starter kit written in TypeScript and built using webpack.
* [**{{** add_your_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md)

#### Aurelia Generators

* [zewa666/generator-aurelia ★77 ⏳1Y](https://github.com/zewa666/generator-aurelia) Yeoman generator for the JavaScript Framework Aurelia by @zewa666
* [kristianmandrup/generator-aurelia-ts ★17 ⏳1Y](https://github.com/kristianmandrup/generator-aurelia-ts) Turbo Start generator for Aurelia apps by @kristianmandrup
...
* [Aurelia-styleguide ★19](https://github.com/behzad888/Aurelia-styleguide) * A starting point for Aurelia development teams to provide consistency through best practices.
...
* [Official Aurelia Material Design (Github) ★90 ⏳2Y](https://github.com/joelcoxokc/aurelia-interface)
* [aurelia-mdl ★23](https://github.com/genadis/aurelia-mdl)
* [aurelia-material ★50 ⏳2Y](https://github.com/redpelicans/aurelia-material)
* [aurelia-mdl-plugin ★20 ⏳1Y](https://github.com/arabsight/aurelia-mdl-plugin) * Material Design Lite plugin for Aurelia
* [**{{** add_your_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md)

#### Aurelia Plugins

* [aurelia-auth ★212](https://github.com/paulvanbladel/aurelia-auth) * Token-based authentication plugin for aurelia
...
* [aurelia-i18n ★80](https://github.com/aurelia/i18n) {official} * A plugin that provides i18n support
* [aurelia-ui-virtualization ★84](https://github.com/aurelia/ui-virtualization) {official} * A plugin that provides a virtualized repeater and other virtualization services
* [aurelia-bs-grid ★47 ⏳2Y](https://github.com/charlespockert/aurelia-bs-grid) * Aurelia and Bootstrap powered datagrid control
...
* [webpack-plugin ★84](https://github.com/aurelia/webpack-plugin) {official} * A plugin for webpack that enables bundling Aurelia applications
* [aurelia-cycle ★7 ⏳2Y](https://github.com/niieani/aurelia-cycle) * An Aurelia plugin that enables the use of Cycle.js inside of Aurelia
* [aurelia-kendoui-bridge ★113](https://github.com/aurelia-ui-toolkits/aurelia-kendoui-bridge) * Aurelia and KendoUI integration
* [aurelia-react-loader ★22 ⏳2Y](https://github.com/bryanrsmith/aurelia-react-loader) * Load React components directly from Aurelia views
* [aurelia-validatejs ★22 ⏳1Y](https://github.com/aurelia/validatejs) {official} * Enables expressive validation using decorators and/or a fluent API.
* [aurelia-view-pipeline ★1 ⏳2Y](https://github.com/behzad888/aurelia-view-pipeline) * A plugin for loading any Markdown into custom element
* [aurelia-routed-footer ★3 ⏳1Y](https://github.com/drivesoftware/aurelia-routed-footer) * An Aurelia plugin which adds the ability to control footer content via the router
...
* [aurelia-authentication ★88](https://github.com/SpoonX/aurelia-authentication) {ES6/TS/Webpack} * Authentication plugin for aurelia with aurelia-api support.
* [aurelia-orm ★81](https://github.com/SpoonX/aurelia-orm) {ES6/TS/Webpack} * Makes working with entities and calling your Rest API simple.
...
* [aurelia-binding-loader ★13 ⏳2Y](https://github.com/bryanrsmith/aurelia-binding-loader) * An Aurelia loader for using any module directly from a view template
* [aurelia-dragula ★28](https://github.com/michaelmalonenz/aurelia-dragula) * An ES2015 port of the Dragula library, targeted at the Aurelia Framework
* [aurelia-breeze ★66 ⏳1Y](https://github.com/jdanyow/aurelia-breeze) * Everything you need to use Breeze with Aurelia
...
* [Aurelia-Configuration ★101](https://github.com/vheissu/aurelia-configuration) * Smart configuration for your Aurelia applications.
...
* [aurelia-firebase ★24 ⏳1Y](https://github.com/pulsarblow/aurelia-firebase) * [A Firebase plugin for Aurelia](https://aureliaonfire.azurewebsites.net)
* [aurelia-flux ★76 ⏳2Y](https://github.com/tfrydrychewicz/aurelia-flux) * Flux dispatcher plugin for Aurelia
...
* [aurelia-google-analytics ★22](https://github.com/miguelzakharia/aurelia-google-analytics) * An Aurelia.io plugin that adds Google Analytics page tracking to your project.
...
* [aurelia-rethink-bindtable ★16 ⏳1Y](https://github.com/kristianmandrup/aurelia-rethink-bindtable) * Aurelia bind table integration for RethinkDB via Socket.io
* [aurelia-sails-socket-client ★22](https://github.com/Mordred/aurelia-sails-socket-client) * A simple, restful, message-based wrapper around sails.io client
...
* [Tseberechts/aurelia-place-picker ★2 ⏳2Y](https://github.com/Tseberechts/aurelia-place-picker) * A place picker inspired by the Autocomplete places with Aurelia
* [treacherous-aurelia](https://github.com/grofit/treacherous-aurelia) * An Aurelia plugin for the treacherous validation system
* [aurelia-filter ★8 ⏳1Y](https://github.com/SpoonX/aurelia-filter) * A plugin for aurelia to populate search/filter criteria. Works well with aurelia-orm
* [aurelia-charts ★11 ⏳1Y](https://github.com/SpoonX/aurelia-charts) * Graphs plugin for aurelia. Supports all libraries
...
* [aurelia-resize ★15 ⏳1Y](https://github.com/MeirionHughes/aurelia-resize) * aurelia plugin to observe DOM-element resize events
* [aurelia-keyboard-plugin ★7 ⏳2Y](https://github.com/Novatrox/aurelia-keyboard-plugin) * Simple keyboard plugin for aurelia
* [aurelia-ui-framework ★119](https://github.com/adarshpastakia/aurelia-ui-framework) * A bespoke UI Framework built on Aurelia for desktop business application
* [aurelia-tags-input ★7](https://github.com/TGMorais/aurelia-tags-input) * An aurelia tags input plugin
* [aurelia-formio ★4](https://github.com/formio/aurelia-formio) * A dynamic JSON Form Renderer and Form Builder - [See Example](https://formio.github.io/aurelia-formio/)
* [**{{** add_your_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md)

#### Aurelia Implementation

* [aurelia-animator-tinyanimate ★3 ⏳3Y](https://github.com/gooy/aurelia-animator-tinyanimate) * Implementation of the Aurelia base animator using TinyAnimate
* [sukobuto/aurelia-tinymce-sample ★1 ⏳2Y](https://github.com/sukobuto/aurelia-tinymce-sample) * Sample app with Aurelia and TinyMCE
* [stamp-web/stamp-web-aurelia ★17](https://github.com/stamp-web/stamp-web-aurelia) * Next Generation Stamp Web Editor written in Aurelio with Bootstrap
* [aurelia-tabs ★15 ⏳1Y](https://github.com/Vheissu/aurelia-tabs) * A dependency free tabs component for your Aurelia applications. Allows you to toggle between sections of content, with supports for dynamically composing views with optional data
* [aurelia-flickr-ts-memo-game ★0 ⏳2Y](https://github.com/kst83/aurelia-flickr-ts-memo-game) * Match the pairs type of game written with Aurelia in TypeScript using Flickr
...
* [aurelia-datatable ★30](https://github.com/SpoonX/aurelia-datatable) * A 100% aurelia based data table component [http://aurelia-datatable.spoonx.org](http://aurelia-datatable.spoonx.org)

#### Aurelia Custom Element

* [aurelia-v-grid ★22](https://github.com/aurelia-ui-toolkits/aurelia-v-grid) * aurelia-v-grid
* [aurelia-leaflet ★15](https://github.com/benib/aurelia-leaflet) * [A Leaflet CustomElement for Aurelia]( http://benib.github.io/aurelia-leaflet/)
* [aurelia-chart ★44 ⏳1Y](https://github.com/grofit/aurelia-chart) * A chart element for aurelia which is powered by chart js using html5 canvas
* [aurelia-toolbelt ★35](https://github.com/aurelia-toolbelt/aurelia-toolbelt) * A set of components for bootstrap4, it also includes other components and value converters.

#### Aurelia Auth

* [sentry ★51 ⏳2Y](https://github.com/Foursails/sentry) * An Aurelia template with a built in authentication shell
...
* [aurelia-identityserver-aspnetcore ★36 ⏳1Y](https://github.com/paulvanbladel/aurelia-identityserver-aspnetcore) * Sample integrating aurelia with identityserver 4 and docker
* [casl-aurelia-example ★3](https://github.com/stalniy/casl-aurelia-example) * Example applilcation of authorization in Aurelia app using CASL.

#### Aurelia Libraries

* [pollyfils ★22](https://github.com/aurelia/polyfills) * The minimal set of polyfills needed to run Aurelia
* [aurelia-sails-socket-client ★22](https://github.com/Mordred/aurelia-sails-socket-client) * A simple, restful, message-based wrapper around sails.io client
...
* [jdanyow/aurelia-breeze-northwind ★97 ⏳1Y](https://github.com/jdanyow/aurelia-breeze-northwind) * A Northwind demo using Aurelia and Breeze by @jdanyow.
* [jdanyow/aurelia-solitaire ★71 ⏳2Y](https://github.com/jdanyow/aurelia-solitaire) * Klondike solitaire built with Aurelia and dragula.
* [discosultan/aurelia-minesweeper ★9 ⏳1Y](https://github.com/discosultan/aurelia-minesweeper) * Classic Minesweeper game built with Aurelia by @discosultan.
* [electron-aurelia-example ★35 ⏳1Y](https://github.com/jimschubert/electron-aurelia-example) * An example desktop application written with Electron and Aurelia.
...
* [michaelbull/aurelia-hacker-news ★53](https://github.com/michaelbull/aurelia-hacker-news#aurelia-hacker-news-clone) * A recreation of the Hacker News website written in TypeScript and built using Aurelia, with webpack as a module bundler.
...
* [Aurelia Typescript ★151 ⏳2Y](https://github.com/cmichaelgraham/aurelia-typescript) * A starter kit for working with the Aurelia TypeScript type definitions by @cmichaelgraham
* [aurelia-axel ★1 ⏳2Y](https://github.com/cmichaelgraham/aurelia-axel) * As a Visual Studio TypeScript and C# developer building web-based, spatial information systems targeting a variety of platforms that leverage ESRI and SQL Server, I want a starter kit so that I can rapidly build implementations
* [aurelia-axel-northwind ★2 ⏳2Y](https://github.com/cmichaelgraham/aurelia-axel-northwind) * As a user, I want a walk through of creating a web app from the `aurelia-axel` starter kit, based of a familiar database (Northwind)
* [aurelia-skeleton-navigation-gulp-typescript ★12 ⏳3Y](https://github.com/Enrapt/aurelia-skeleton-navigation-gulp-typescript) * Aurelia navigation skeleton implemented with Gulp and Typescript
* [**{{** add_your_repo **}}**](https://github.com/behzad888/awesome/edit/master/README.md)
...
* [ahmedshuhel/nav-app-es5 ★9 ⏳3Y](https://github.com/ahmedshuhel/nav-app-es5) Skeleton that sets up a standard aurelia navigation-style app just using ES5, Bower and RequireJS by @ahmedshuhel.

#### ES5 Examples

* [aurelia-observer-patterns ★27 ⏳2Y](https://github.com/axwalker/aurelia-observer-patterns) * Simple examples for different methods of implementing observer patterns in Aurelia
...
Please note that this project is released with a [Contributor Code of Conduct](https://github.com/behzad888/awesome-aurelia/blob/master/code-of-conduct.md). By participating in this project you agree to abide by its terms.
