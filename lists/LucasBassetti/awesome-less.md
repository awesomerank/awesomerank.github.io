...
- [Official Repository ★14753](https://github.com/less/less.js)
...
- [Ant Design ★13882](https://github.com/ant-design/ant-design) - 	An enterprise-class UI design language and React-based implementation.
...
- [Material Design for Bootstrap ★18168](https://github.com/FezVrasta/bootstrap-material-design) - Material Design for Bootstrap is a Bootstrap V3 compatible theme; it is an easy way to use the new Material Design guidelines by Google in your Bootstrap 3 based application.
...
- [Bootstrap Grid Only ★340](https://github.com/zirafa/bootstrap-grid-only) - Bootstrap's responsive grid and responsive utility classes only, without any extras. Lightweight yet still powerful. Style to taste.
- [Framework ★728](https://github.com/jonikorpi/Less-Framework) - Less Framework is a CSS grid system for designing adaptive web sites. It contains 4 layouts and 3 sets of typography presets, all based on a single grid.
...
- [Est ★325](https://github.com/ecomfe/est) - 	Mixin library.
...
- [Normalize](https://github.com/segundofdez/normalize.less) - 	Modularized famous [normalize.css ★26324](https://github.com/necolas/normalize.css) using Less.
...
- [JLessC ★29](https://github.com/i-net-software/jlessc) - Less compiler written completely in Java.
...
- [Atom Linter ★16](https://github.com/josa42/atom-linter-less) - Linter plugin in the Atom text editor.
- [CSS 2 Convert](http://css2less.co/) - Quick way to automatically convert CSS to Less, easy as copy and paste.
- [CSS Less(ish) ★44 ⏳2Y](https://github.com/kizza/CSS-Less-ish) - Sublime Text 2 & 3 plugin that implements a stripped down version of the functionality in css preprocessors (such as Less).
...
- [Eclipse Transpiler Plugin ★18 ⏳2Y](https://github.com/gossi/eclipse-transpiler-plugin) - Eclipse plugin to automatically transpile your files (Less, SASS, CoffeeScript, etc.).
...
- [Gulp Less ★513](https://github.com/plus3network/gulp-less) - Plugin for Gulp.
- [Hayaky ★891 ⏳1Y](https://github.com/hayaku/hayaku) - Hayaku is a bundle of useful scripts aiming for rapid front-end web development.
...
- [Lesshint ★88](https://github.com/lesshint/lesshint) - Tool to aid you in writing clean and consistent Less.
