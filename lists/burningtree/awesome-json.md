# Awesome JSON [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★57421](https://github.com/sindresorhus/awesome)
...
* [JSONExport ★2513](https://github.com/Ahmed-Ali/JSONExport) - convert a object to a class of one of the currently supported languages.
...
* [PSON ★221](https://github.com/dcodeIO/PSON) - Protocol JSON, super efficient binary serialization format.
...
* [JSON Browser](https://chrome.google.com/webstore/detail/json-browser/hngfgkmimoikmpohakflgadcajkfnoba) ([github ★10](https://github.com/platy/json-browser)) - Browse a JSON web with the help of JSON schemas.
...
* [gron ★638](https://github.com/tomnomnom/gron) - Convert a JSON file into discrete assignments that are greppable.
* [jid ★4094](https://github.com/simeji/jid) - Incremental Digger. Drill down JSON interactively by using filtering queries like jq.
...
* [JSON Server ★20982](https://github.com/typicode/json-server) - Get a full fake REST API with zero coding in less than 30 seconds.
* [Kinto ★3131](https://github.com/Kinto/kinto) - A lightweight JSON storage service with synchronisation and sharing abilities.
...
## Datasets
* [countries ★3034](https://github.com/mledoze/countries) - World countries.
...
## Data generation
* [jsonymize ★8](https://github.com/cameronhunter/jsonymize) - Reads data from standard input, anonymizes, then writes to standard output.
...
* [JSON-stat ★11](https://github.com/jsonstat/jsonstat) - Simple lightweight format for data dissemination.
...
## Frontend components
* [JSON editor jQuery plugin ★430](https://github.com/DavidDurman/FlexiJsonEditor) - component for you web apps/pages. (jQuery)
...
**C++**
* [ArduinoJson ★1850](https://github.com/bblanchon/ArduinoJson) - An efficient library for embedded systems.
* [JSON++ ★31](https://github.com/tunnuz/json) - A self contained Flex/Bison parser for C++11.
* [json11 ★1273](https://github.com/dropbox/json11) - A tiny library for C++11.

**Clojure**
* [data.json ★291](https://github.com/clojure/data.json) - parser/generator to/from Clojure data structures.

**Fortran**
* [JSON-Fortran ★71](https://github.com/jacobwilliams/json-fortran) - A Fortran library for writing, reading, and manipulating JSON files and data structures.

**Haskell**
* [aeson-qq ★34](https://github.com/sol/aeson-qq) - JSON quasiquoter for Haskell.

**Java**
* [JSON-java ★2401](https://github.com/stleary/JSON-java) - A reference implementation.
* [Fast JSON Processor ★8878](https://github.com/alibaba/fastjson)
* [Gson ★8563](https://github.com/google/gson) - A Java library to convert JSON to Java objects and vice-versa.
* [Jackson](http://wiki.fasterxml.com/JacksonHome) - A multi-purpose Java library for processing JSON data format.
* [moshi ★2647](https://github.com/square/moshi) - A modern JSON library for Android and Java.

**Javascript**
* [JSON-js ★6815](https://github.com/douglascrockford/JSON-js) - JSON in JavaScript.
...
**Objective-C**
* [JSONKit ★6078](https://github.com/johnezang/JSONKit) - Objective-C library.
...
**PL/SQL**
* [PL/JSON ★140](https://github.com/pljson/pljson) - A generic JSON object written in PL/SQL.

**PHP**
* [Webmozart JSON ★312](https://github.com/webmozart/json) - A robust decoder/encoder with support for schema validation.

**Python**
* [simplejson ★800](https://github.com/simplejson/simplejson) - A simple, fast, extensible encoder/decoder
...
**Ruby**
* [oj ★1703](https://github.com/ohler55/oj) - A fast JSON parser and Object marshaller as a Ruby gem.
* [MultiJSON ★560](https://github.com/intridea/multi_json) - A generic swappable back-end for JSON handling.

**React**
* [json2react ★115](https://github.com/txgruppi/json2react) - Use JSON to create React Stateless Components.

**.NET**
* [jsonfx ★337](https://github.com/jsonfx/jsonfx) - serialization framework for .NET.

**Scala**
* [spray-json ★610](https://github.com/spray/spray-json) - A lightweight, clean and simple implementation in Scala.
* [circe ★833](https://github.com/circe/circe) - Yet another JSON library for Scala.
* [scala-jsonapi ★83](https://github.com/zalando/scala-jsonapi) - Support library for integrating the JSON:API spec with Play, Spray and/or Circe backends.

**Swift**
* [SwiftyJSON ★14286](https://github.com/SwiftyJSON/SwiftyJSON) - The better way to deal with data in Swift.
...
* [HanSON ★111](https://github.com/timjansen/hanson) - JSON for Humans - with unquoted identifiers, multi-line strings and comments.
...
* [TOML ★5796](https://github.com/toml-lang/toml) - A minimal configuration file format that's easy to read due to obvious semantics.
* [HCL ★984](https://github.com/hashicorp/hcl) - A structured configuration language that is both human and machine friendly.
...
* [CSON ★1006](https://github.com/bevry/cson) - CoffeeScript-Object-Notation. JSON for CoffeeScript objects.
* [MSON ★567](https://github.com/apiaryio/mson) - Markdown syntax compatible with describing JSON and JSON Schema.
...
* [JsonUnit ★185](https://github.com/lukas-krecan/JsonUnit) - A library that simplifies JSON comparison in unit tests. It's strongly inspired by XmlUnit.
...
* [searchjs ★127](https://github.com/deitch/searchjs) - A library for filtering based on a json SQL-like language.
...
## JSON Schema Tools
* [prmd ★1703](https://github.com/interagent/prmd) - Tools and doc generation for HTTP APIs.
* [generate-schema ★324](https://github.com/Nijikokun/generate-schema) - Effortlessly convert your JSON Object to JSON Schema, Mongoose Schema, or a Generic template for quick documentation / upstart.
* [Docson ★326](https://github.com/lbovet/docson) - Documentation for your types.
* [Orderly JSON ★184](https://github.com/lloyd/orderly) - A textual format for describing JSON compiled into JSONSchema.
* [jsonschema2pojo ★2716](https://github.com/joelittlejohn/jsonschema2pojo) - Generates Java types and annotates those types for data-binding with Jackson 1.x or 2.x, Gson, etc.
* [Matic ★150](https://github.com/mattyod/matic) - Build tool for generating HTML documentation.
* [JSON Schema + Faker ★763](https://github.com/json-schema-faker/json-schema-faker) - Fake your schemas.
...
* [JSON Archetypes ★131](https://github.com/servant-app/json-archetypes) - Community-Driven Standards For Popular Types Of Data.
...
* [json-schema-benchmark ★186](https://github.com/ebdrup/json-schema-benchmark) - Performance benchmark for Node.js validators.
* [is-my-json-valid ★675](https://github.com/mafintosh/is-my-json-valid) - A validator that uses code generation to be extremely fast.
* [jsen ★117](https://github.com/bugventure/jsen) - A validator built for speed.
* [themis ★57](https://github.com/playlyfe/themis) - A blazing fast validator.
* [jsck ★161](https://github.com/pandastrike/jsck) - JSON Schema Compiled checK.
* [z-schema ★219](https://github.com/zaggino/z-schema) - validator written in JavaScript for NodeJS and Browsers.
...
* [tv4 ★854](https://github.com/geraintluff/tv4) - Tiny Validator.
* [ajv ★1593](https://github.com/epoberezkin/ajv) - The fastest validator. Supports v5/6 proposals.


**PHP**
* [JSON Schema for PHP ★901](https://github.com/justinrainbow/json-schema) - PHP implementation of JSON schema.
* [JSON Guard](http://json-guard.thephpleague.com) - A validator for JSON Schema Draft 4.

**Python**
* [jsonschema ★1148](https://github.com/Julian/jsonschema) - Python implementation of jsonschema.
...
**Ruby**
* [Ruby JSON Schema Validator ★834](https://github.com/ruby-json-schema/json-schema) - validating against a JSON schema conforming to JSON Schema Draft 4.
