...
- [Android Material Drawer Template ★701 ⏳2Y](https://github.com/kanytu/android-material-drawer-template) An Android template with navigation drawer for material design.
- [material-design-icons-adt-template ★428 ⏳1Y](https://github.com/intrications/material-design-icons-adt-template) Android Studio / Eclipse ADT template for material-design-icons resources.
...
- [Android Cookbook Examples ★676](https://github.com/IanDarwin/Android-Cookbook-Examples) Collected code examples from the O'Reilly Android Cookbook.
- [Android Basic Samples ★763](https://github.com/playgameservices/android-basic-samples) Mostly game oriented samples.
- [Android Webview Sample App ★63 ⏳5Y](https://github.com/tscolari/android-webview-sample-app) Webview Sample App
- [Android Quickstart ★195](https://github.com/googledrive/android-quickstart) Quickstart application showing the Google Drive API for Android.
- [Beginning Android Resources](https://github.com/codepath/android_guides/wiki/Beginning-Android-Resources) Android Guide.
- [Universal Music Player ★8189](https://github.com/googlesamples/android-UniversalMusicPlayer) Google sample application that shows how to implement an audio media app that works across multiple form factors and provides a consistent user experience on Android phones, tablets, Auto, Wear and Cast devices.
- [Android Architecture Blueprints ★20371](https://github.com/googlesamples/android-architecture) Demonstrates a basic Model-View-Presenter architecture and showcases various TODO app implementations.
...
- [Amaro ★373](https://github.com/crushlovely/Amaro) Featureful iOS Boilerplate.
...
- [AngularJS](#angular-js)
    - [ng-boilerplate ★4158](https://github.com/ngbp/ngbp) An opinionated kickstarter for AngularJS projects.
    - [Yeoman Angular Generator ★5889](https://github.com/yeoman/generator-angular)
...
- [ReactJS](#react-js)
    - [React Boilerplate ★567 ⏳1Y](https://github.com/petehunt/react-boilerplate) Boilerplate for creating a React npm package
    - [React Boilerplate](https://github.com/rackt/react-boilerplate) React boilerplate with React Router and webpack
    - [React Transorm Boilerplate ★3464](https://github.com/gaearon/react-transform-boilerplate) A new Webpack boilerplate with hot reloading React components, and error handling on module and component level.
    - [Library Boilerplate ★381 ⏳1Y](https://github.com/gaearon/library-boilerplate) An opinionated boilerplate for React libraries including ESLint, Mocha, Babel, Webpack and an example powered by Webpack Dev Server and React Hot Loader
    - [React Isomorphic Starterkit ★2304 ⏳1Y](https://github.com/RickWong/react-isomorphic-starterkit) Isomorphic starterkit with server-side React rendering having many features
    ...
    - [Flask React Boilerplate ★270](https://github.com/alexkuz/flask-react-boilerplate) Flask and react Boilerplate
    ...
    - [React Redux Universal Hot Example ★10154](https://github.com/erikras/react-redux-universal-hot-example) A starter boilerplate for a universal webapp using express, react, redux, webpack, and react-transform
...
- [Polymer](#polymer)
    ...
    - [Yeoman Polymer Generator ★987](https://github.com/yeoman/generator-polymer) Yeoman's polymer Generator
- [Electron](#electron)
    - [Electron Boilerplate ★496](https://github.com/sindresorhus/electron-boilerplate) Boilerplate for electron-node
...
- [CookieCutter ★5499](https://github.com/audreyr/cookiecutter#python) List of various python templates by Audrey.
- [bootstrapy ★273 ⏳3Y](https://github.com/kirang89/bootstrapy) A bootstrap Python application, so that you can focus on writing code.
- [Fbone ★1411](https://github.com/imwilsonxu/fbone) Fbone (Flask bone) is a Flask (Python microframework) template/bootstrap/boilerplate application.
- [Flask-Bootstrap ★161](https://github.com/esbullington/flask-bootstrap) A Flask app template with integrated SQLAlchemy, authentication, and Bootstrap frontend.
- [Flask Boilerplate ★4 ⏳2Y](https://github.com/melvin0008/FlaskBoilerplate) A very simple flask boilerplate with folder structures.
- [Flask Foundation ★1046](https://github.com/JackStouffer/Flask-Foundation) App built with best practices.
...
- [Flask Appengine Template ★1006](https://github.com/kamalgill/flask-appengine-template) Flask App engine Template
...
- [AngularJS Rails Templates ★577](https://github.com/pitr/angular-rails-templates) Rails and Angular Tempate.  
...
- [Rails Bootstrap ★454](https://github.com/RailsApps/rails-bootstrap) Starter App for Rails and Bootstrap
...
- [Web Starter Kit ★17409](https://github.com/google/web-starter-kit) Web starter kit by Google.
...
- [Jekyll Starter Kit ★60](https://github.com/nirgn975/generator-jekyll-starter-kit) Jekyll Progressive Web App generator boilerplate.
...
- [Vim Template ★209](https://github.com/aperezdc/vim-template) Simple Vim Templates plugin.

##  GitHub

*Boilerplates and template files*

- [GitHub Template Guidelines ★58 ⏳1Y](https://github.com/cezaraugusto/github-template-guidelines) Collection of guidelines and boilerplate files for writing maintanable GitHub projects.
