...
---
# Awesome boilerplates[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★60916](https://github.com/sindresorhus/awesome)
...
- [Android Basic Samples ★756](https://github.com/playgameservices/android-basic-samples) Mostly game oriented samples.
- [Android Webview Sample App ★61 ⏳5Y](https://github.com/tscolari/android-webview-sample-app) Webview Sample App
- [Android Quickstart ★189](https://github.com/googledrive/android-quickstart) Quickstart application showing the Google Drive API for Android.
- [Beginning Android Resources](https://github.com/codepath/android_guides/wiki/Beginning-Android-Resources) Android Guide.
- [Universal Music Player ★7989](https://github.com/googlesamples/android-UniversalMusicPlayer) Google sample application that shows how to implement an audio media app that works across multiple form factors and provides a consistent user experience on Android phones, tablets, Auto, Wear and Cast devices.
- [Android Architecture Blueprints ★19548](https://github.com/googlesamples/android-architecture) Demonstrates a basic Model-View-Presenter architecture and showcases various TODO app implementations.

## IOS Development.

*Boilerplates and templates for IOS*

- [iOS Boilerplate ★2904 ⏳5Y](https://github.com/gimenete/iOS-boilerplate) Boilerplate by Gimeno.
...
- [Mega Boilerplate ★3472](https://github.com/sahat/megaboilerplate) Fullstack boilerplate generator with support for Node.js, a static site, or an Electron app. 
- [NodeJS](#node-js)
    - [Yeoman Node Generator ★425](https://github.com/yeoman/generator-node) Yeomans node generator   
    ...
    - [Express Boilerplate ★705](https://github.com/expressjs/generator) Boilerplate generator for Express.js Projects
    - [Hackathon Starter ★20233](https://github.com/sahat/hackathon-starter) A boilerplate for Node.js web applications.
...
- [AngularJS](#angular-js)
    ...
    - [Yeoman Angular Generator ★5872](https://github.com/yeoman/generator-angular)
...
- [ReactJS](#react-js)
    - [React Boilerplate ★569 ⏳1Y](https://github.com/petehunt/react-boilerplate) Boilerplate for creating a React npm package
    - [React Boilerplate](https://github.com/rackt/react-boilerplate) React boilerplate with React Router and webpack
    - [React Transorm Boilerplate ★3448](https://github.com/gaearon/react-transform-boilerplate) A new Webpack boilerplate with hot reloading React components, and error handling on module and component level.
    ...
    - [React Isomorphic Starterkit ★2298 ⏳1Y](https://github.com/RickWong/react-isomorphic-starterkit) Isomorphic starterkit with server-side React rendering having many features
    ...
    - [Flask React Boilerplate ★265](https://github.com/alexkuz/flask-react-boilerplate) Flask and react Boilerplate
    - [Boilerplate Webpack React ★47 ⏳1Y](https://github.com/tcoopman/boilerplate-webpack-react) Boilerplate project for Reactjs with webpack, gulp and stylus
    ...
    - [React Redux Universal Hot Example ★9928](https://github.com/erikras/react-redux-universal-hot-example) A starter boilerplate for a universal webapp using express, react, redux, webpack, and react-transform
...
- [Backbone](#backbone)
    ...
    - [benm ★181](https://github.com/shorttompkins/benm) Boilerplate web app using Backbone.js, ExpressJS, node.js, MongoDB.
- [Jquery](#jquery)
...
- [Electron](#electron)
    - [Electron Boilerplate ★485](https://github.com/sindresorhus/electron-boilerplate) Boilerplate for electron-node
...
- [Django Hackathon Starter ★1054](https://github.com/DrkSephy/django-hackathon-starter) A boilerplate for Django web applications, providing various social logins and several popular API examples.
- [CookieCutter ★5298](https://github.com/audreyr/cookiecutter#python) List of various python templates by Audrey.
...
- [Fbone ★1394](https://github.com/imwilsonxu/fbone) Fbone (Flask bone) is a Flask (Python microframework) template/bootstrap/boilerplate application.
- [Flask-Bootstrap ★160](https://github.com/esbullington/flask-bootstrap) A Flask app template with integrated SQLAlchemy, authentication, and Bootstrap frontend.
...
- [Flask Foundation ★1036](https://github.com/JackStouffer/Flask-Foundation) App built with best practices.
- [GoogleAppEngine Webapp2 Boilerplate ★708](https://github.com/coto/gae-boilerplate) A Complete boilerplate for Python Webapp2 on Google App Engine
- [Flask Appengine Template ★1001](https://github.com/kamalgill/flask-appengine-template) Flask App engine Template
- [Django Starter Template ★71](https://github.com/fasouto/django-starter-template) An easy to use project template for Django that follows best practices.
...
- [Rails Bootstrap ★446](https://github.com/RailsApps/rails-bootstrap) Starter App for Rails and Bootstrap

## .NET

*Boilerplates and templates for C#.NET and ASP.NET*

- [ASP.NET Boilerplate ★2904](https://github.com/aspnetboilerplate/aspnetboilerplate) ASP.NET Boilerplate is a starting point for new modern web applications using best practices and most popular tools.
...
- [Generator ChromeApp ★307](https://github.com/yeoman/generator-chromeapp) Yeoman generator for chrome app   
...
- [Meteor boilerplate ★921 ⏳1Y](https://github.com/Differential/meteor-boilerplate) Boilerplate for meteor framework.
- [Web Starter Kit ★17220](https://github.com/google/web-starter-kit) Web starter kit by Google.
...
- [Jekyll Starter Kit ★57](https://github.com/nirgn975/generator-jekyll-starter-kit) Jekyll Progressive Web App generator boilerplate.
...
- [Vim Template ★206](https://github.com/aperezdc/vim-template) Simple Vim Templates plugin.

##  GitHub

*Boilerplates and template files*

- [GitHub Template Guidelines ★56 ⏳1Y](https://github.com/cezaraugusto/github-template-guidelines) Collection of guidelines and boilerplate files for writing maintanable GitHub projects.
