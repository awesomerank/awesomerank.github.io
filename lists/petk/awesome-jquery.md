...
* [jQuery patterns ★1606 ⏳1Y](https://github.com/jquery-boilerplate/jquery-patterns) - A variety of jQuery plugin patterns for jump starting your plugin development.
...
* [jQuery fundamentals ★141 ⏳1Y](https://github.com/bocoup/jqfundamentals.com) - Comfortable working through common problems you'll be called upon to solve using jQuery.
...
* [Animsition ★3245](https://github.com/blivesta/animsition) - A simple and easy jQuery plugin for CSS animated page transitions.
* [fakeLoader.js ★549](https://github.com/joaopereirawd/fakeLoader.js) - Lightweight plugin that helps you create an animated spinner with a fullscreen loading mask to simulate the page preloading effect.
...
* [Midnight ★3149](https://github.com/Aerolab/midnight.js) - Switches fixed headers on the fly.
* [Parallax.js ★2230](https://github.com/pixelcog/parallax.js) - Scrolling effect.
* [Scrollify ★1068](https://github.com/lukehaas/Scrollify) - Assists scrolling and snaps to sections. Touch optimised.
...
* [Froala WYSIWYG HTML Editor ★1538](https://github.com/froala/wysiwyg-editor) - jQuery WYSIWYG Rich Text Editor based on HTML5.
* [Hallo ★2464](https://github.com/bergie/hallo) - Simple rich text editor (contentEditable) for jQuery UI.
...
* [Payform ★315](https://github.com/jondavidjohn/payform) - A library (with jQuery plugin) for building credit card forms, validating inputs, and formatting numbers.
...
* [selectize.js ★10154](https://github.com/selectize/selectize.js) - jQuery based hybrid of a textbox and \<select\> box.
...
* [Gridder ★343](https://github.com/oriongunning/gridder) - Displays a thumbnail grid expanding preview similar to the effect seen on Google Images.
* [jquery.sparkline ★1078](https://github.com/gwatts/jquery.sparkline) - Generate small sparkline charts.
* [jQuery.eraser ★253](https://github.com/boblemarin/jQuery.eraser) - Erasing image with mouse or touch movements.
* [jQuery Mapael ★820](https://github.com/neveldo/jQuery-Mapael) - Plugin based on raphael.js that allows you to display dynamic vector maps.
* [jQueryGantt ★1253](https://github.com/robicch/jQueryGantt) - Gantt editor.
* [Nivo Slider ★1178](https://github.com/Codeinwp/Nivo-Slider-jQuery) - Beautiful and easy to use image slider.
* [Owl Carousel 2 ★4739](https://github.com/OwlCarousel2/OwlCarousel2) - Responsive carousel slider.
...
* [jQuery contextMenu ★1546](https://github.com/swisnl/jQuery-contextMenu) - Management facility for context menus.
...
* [mmenu ★2008](https://github.com/FrDH/jQuery.mmenu) - App look-alike on- and off-canvas menus with sliding submenus.
* [Multi-level push menu ★771](https://github.com/adgsm/multi-level-push-menu) - Allows endless nesting of navigation elements.
* [Slidebars ★1443](https://github.com/adchsm/Slidebars) - jQuery framework for off-canvas menus and sidebars.
* [stickUp ★1497 ⏳1Y](https://github.com/LiranCohen/stickUp) - Sticks an element to the top of the browser window while scrolling past it, always keeping it in view.
* [Superfish ★836](https://github.com/joeldbirch/superfish) - Adds usability enhancements to existing multi-level drop-down menus.
* [Yamm ★1191 ⏳1Y](https://github.com/geedmo/yamm3) - Yet another megamenu for Bootstrap 3.
...
* [animatedModal.js ★806](https://github.com/joaopereirawd/animatedModal.js) - Plugin for creating fullscreen modals with CSS3 transitions. You can use the transitions from `animate.css` or create your own.
...
* [iziModal ★1428](https://github.com/dolce/iziModal) - Elegant, responsive, flexible and lightweight modal plugin with jQuery.
...
* [jQuery Modal ★1434](https://github.com/kylefox/jquery-modal) - Simple and lightweight method of displaying modal windows.
...
* [Lightbox ★3668](https://github.com/lokesh/lightbox2) - JavaScript library used to overlay images on top of the current page.
...
* [tipso ★267](https://github.com/object505/tipso) - A Lightweight Responsive jQuery Tooltip Plugin.
* [vex ★6309](https://github.com/hubspot/vex) - A modern dialog library which is highly configurable and easy to style.
...
* [jqGrid ★2353](https://github.com/tonytomov/jqGrid) - Grid plugin.
* [jQuery treetable ★620](https://github.com/ludo/jquery-treetable) - Show a tree structure in a table.
* [jsGrid ★930](https://github.com/tabalinas/jsgrid) - Lightweight grid plugin.
* [Stackable.js ★917](https://github.com/johnpolacek/stacktable.js) - Stacking tables on small screens.
* [Stupid Table Sort ★617](https://github.com/joequery/Stupid-Table-Plugin) - A stupidly small and simple jQuery table sorter plugin.
* [tableExport.jquery.plugin ★291](https://github.com/hhurz/tableExport.jquery.plugin) - Export HTML table to JSON, XML, CSV, TXT, SQL, Word, Excel, PNG or PDF.
...
* [jQuery Timer Plugin ★212](https://github.com/walmik/timer.jquery) - Start/Stop/Resume/Remove pretty timer inside any HTML element.
...
* [i18n properties ★173](https://github.com/jquery-i18n-properties/jquery-i18n-properties) - Lightweight plugin for providing internationalization to JavaScript from [.properties](https://en.wikipedia.org/wiki/.properties) files
* [jquery.i18n ★343](https://github.com/wikimedia/jquery.i18n) - jQuery based Javascript internationalization library for easy internationalization of web application
* [jquery.localize.js ★378](https://github.com/coderifous/jquery-localize) - Easy internationalization of your static web site
...
* [Boilerplate ★2527 ⏳1Y](https://github.com/jquery-boilerplate/jquery-boilerplate) - A jump-start for jQuery plugins development.
* [Interlink](https://gist.github.com/Golpha/c5c7ae9b6ed11dc93ce6) - Event interlink plugin.
* [Sisyphus ★1865](https://github.com/simsalabim/sisyphus) - Gmail-like client-side drafts and bit more.
...
* [OhSnap!.js ★264](https://github.com/justindomingue/ohSnap) - A simple jQuery/Zepto notification library designed to be used in mobile apps.
...
* [Dragula ★16495](https://github.com/bevacqua/dragula) - Framework agnostic drag and drop library, supports jQuery integration.
...
* [X-editable ★5738](https://github.com/vitalets/x-editable) - In-place editing with Twitter Bootstrap, jQuery UI or pure jQuery.
...
* [Mockjax ★2064](https://github.com/jakerella/jquery-mockjax) - Provides a simple and extremely flexible interface for mocking or simulating ajax requests and responses.
...
* PHP:
    ...
    * [symfony-collection ★213](https://github.com/ninsuo/symfony-collection) - jQuery Plugin that manages adding, deleting and moving elements from a Symfony2 collection.
* Python:
...
* Awesome lists:
    ...
    * [erichs/awesome-awesome ★124](https://github.com/erichs/awesome-awesome) - Awesome lists
