---
layout: default
title: Awesome Rank for PhantomYdn/awesome-wicket
---
...
---
# Awesome Wicket [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★85445](https://github.com/sindresorhus/awesome)
...
- [Wicket on Github ★424](https://github.com/apache/wicket) - Official mirror of Wicket on [GitHub](https://github.com).
...
- [wicket-bootstrap ★277](https://github.com/l0rdn1kk0n/wicket-bootstrap) - Integration of Bootstrap Toolkit for Wicket.
...
- [wicket-mustache ★8](https://github.com/l0rdn1kk0n/wicket-mustache) - Provides a specialized panel and some related utilities that enables users to work with Mustache and Wicket.
...
- [wicket-spring-boot ★79](https://github.com/MarcGiffing/wicket-spring-boot) - Makes it easy to create Wicket projects with a minimum of configuration effort by using Sprint Boot.
- [wicket-webjars ★27](https://github.com/l0rdn1kk0n/wicket-webjars) - Integration of webjars for Wicket.
...
### WicketStuff
[WicketStuff ★318](https://github.com/wicketstuff/core) based libraries
...
- [WHighCharts ★13](https://github.com/wicketstuff/wiquery-highcharts) - Provides WiQuery bindings for HighCharts.
...
- [WiQuery ★3](https://github.com/wicketstuff/wiquery) - Wicket integration with jQuery and jQuery UI.
...
- [Nocket ★8 ⏳2Y](https://github.com/Nocket/nocket) - Naked Object based framework for wicket.
...
- [Wicketopia ★17 ⏳1Y](https://github.com/jwcarman/Wicketopia) - Rapid Application Development (RAD) library for the Wicket.
...
- [Estatio ★162](https://github.com/estatio/estatio) - Open source estate management built on Apache Isis and wicket.
- [GeoServer ★1182](https://github.com/geoserver/geoserver) - Open source software server written in Java that allows users to share and edit geospatial data.
...
- [Yes Cart ★70](https://github.com/inspire-software/yes-cart) - Pure e-Commerse platform.
