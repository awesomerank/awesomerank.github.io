...
- [BlockPop ★12 ⏳1Y](https://github.com/vnen/blockpop) - A simple Breakout clone.
...
- [Dolphin Island 2 ★63](https://github.com/janmarcano/Dolphin-Island-2) - Platformer game made for the A Game By It's Cover 2015 Game Jam
- [DynaDungeons ★67](https://github.com/akien-mga/dynadungeons) - Bomberman clone in a fantasy universe.
...
- [Mountain of Hope ★3 ⏳1Y](https://github.com/w84death/mountain-of-hope) - Game made on Theater Game Jam (PGA 2015)
...
- [MouseBoat ★20 ⏳1Y](https://github.com/CowThing/MouseBoat) - Play as a mouse and sail around a pond. Cast your rod and try to catch some fish.
...
- [Pathfinding 2d ★26](https://github.com/FEDE0D/godot-pathfinding2d-demo) - A demo project demonstrating pathfinding using a tilemap.
...
- [Voxel Game ★22 ⏳1Y](https://github.com/toger5/Godot-Voxel-Game-MineCraftClone) - MineCraft like voxel terrain

## Themes

*Themes for your Godot games or user interface.*

- [Arc/Arc Dark ★17](https://github.com/Geequlim/godot-themes)
- [Iso Dark Theme ★25 ⏳1Y](https://github.com/GalanCM/Iso-Themes) - A clean, modern dark theme.
...
- [Open Adaptive Music Library ★11](https://github.com/oamldev/oamlGodotModule)
...
- [Add Primitives ★43](https://github.com/TheHX/add_primitives) - Add cylinders, spheres, cubes easily.
...
- [Create Tileset ★34](https://github.com/vinod8990/godot_plugins) - Plugin to generate Godot tilesets based on atlas images
- [CRT Shader ★30 ⏳1Y](https://github.com/henriquelalves/SimpleGodotCRTShader) - Godot shader that simulates CRT Displays.
- [Easing Script ★1 ⏳1Y](https://github.com/impmja/godot-easing) - A port of the Robert Penner's equations for easing
- [Escoria ★75](https://github.com/godotengine/escoria) - Point & click adventure game framework
...
- [GodotTIE ★43](https://github.com/henriquelalves/GodotTIE) - Text Interface Engine to control text output (like in a RPG dialogue)
...
- [GUT ★26](https://github.com/bitwes/Gut) - Utility for writing unit tests in GDScript.
...
- [Resolution Switcher ★34](https://github.com/vinod8990/godot_plugins) - Switch resolutions easily, for testing.
- [Simplex 2D/3D ★8 ⏳1Y](https://github.com/OvermindDL1/Godot-Helpers) - Simplex deterministic noise functions.
...
- [Tiled importer ★52 ⏳1Y](https://github.com/MrGreenTea/GodotTiledImporter) - Import maps from [Tiled](http://mapeditor.org).
...
- [Simple Adventure API ★6](https://github.com/Biarity/godot-adventure-api) - Create Adventure/VN/IF games with a simple API
