...
- [tap-dot ★23](https://github.com/scottcorgan/tap-dot) - Dotted output.
- [tap-spec ★227](https://github.com/scottcorgan/tap-spec) - Mocha-like spec reporter.
- [tap-nyan ★109](https://github.com/calvinmetcalf/tap-nyan) - Nyan cat.
- [tap-min ★30](https://github.com/gummesson/tap-min) - Minimal output.
- [tap-difflet ★40 ⏳1Y](https://github.com/namuol/tap-difflet) - Minimal output with diffing.
- [tap-diff ★67 ⏳1Y](https://github.com/axross/tap-diff) - Human-friendly output with diffing.
...
- [jasmine-reporters ★381](https://github.com/larrymyers/jasmine-reporters) - TAP output for Jasmine.
...
- [tap-out ★17](https://github.com/scottcorgan/tap-out) - TAP parser.
...
- [smokestack ★221 ⏳2Y](https://github.com/hughsk/smokestack) - Run TAP tests in a browser and write the output to `stdout`.
- [chutney](https://github.com/derhuerst/chutney) - Run TAP tests at Sauce Labs. Lightweight [smokestack ★221 ⏳2Y](https://github.com/hughsk/smokestack) alternative.
