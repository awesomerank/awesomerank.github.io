...
---
# Awesome Electron [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★73813](https://github.com/sindresorhus/awesome)
...
- [Beaker ★2462](https://github.com/beakerbrowser/beaker) - Browser with peer-to-peer web protocols.
- [Hyper ★20365](https://github.com/zeit/hyper) - Terminal.
- [WebTorrent](https://github.com/feross/webtorrent-app) - Streaming torrent client.
- [Kap ★6247](https://github.com/wulkano/kap) - Screen recorder with GIF support.
- [Min ★2235](https://github.com/minbrowser/min) - Minimal web browser.
- [Mancy ★2414](https://github.com/princejwesley/Mancy) - JavaScript REPL.
- [SpaceRadar ★701](https://github.com/zz85/space-radar) - Interactive disk space and memory visualization.
- [Nocturn ★566](https://github.com/k0kubun/Nocturn) - Twitter client.
- [Mojibar ★1771](https://github.com/muan/mojibar) - Emoji searcher in your menubar.
- [Playback ★1689 ⏳1Y](https://github.com/mafintosh/playback) - Video player.
- [Upterm ★17751](https://github.com/railsware/upterm) - Terminal.
- [Atom ★42401](https://github.com/atom/atom) - Code editor.
- [Visual Studio Code ★40622](https://github.com/Microsoft/vscode) - Cross-platform IDE.
- [Brave ★6363](https://github.com/brave/browser-laptop) - Privacy-focused web browser.

###### Other

- [Git-it ★1717](https://github.com/jlord/git-it-electron) - Teaches you Git and GitHub.
- [Caprine ★2745](https://github.com/sindresorhus/caprine) - Unofficial Facebook Messenger app.
- [Simplenote ★1457](https://github.com/Automattic/simplenote-electron) - Note keeper.
- [nuTorrent ★191 ⏳2Y](https://github.com/LeeChSien/nuTorrent) - BitTorrent client.
- [Abricotine ★1365](https://github.com/brrd/Abricotine) - Markdown editor with inline preview.
- [Medis ★5089](https://github.com/luin/medis) - Redis database management.
- [Kakapo ★327](https://github.com/bluedaniel/kakapo-app) - Ambient sound mixer for relaxation or productivity.
- [SmartMirror ★2058](https://github.com/evancohen/smart-mirror) - Voice controlled smart mirror.
- [Koko](https://github.com/hachibasu/koko) - IRC client.
- [KeeWeb ★5782](https://github.com/keeweb/keeweb) - Unofficial KeePass app.
- [Gitify](https://github.com/ekonstantinidis/gitify) - GitHub notifications in your menubar.
- [Friends ★2841](https://github.com/moose-team/friends) - P2P chat.
- [Cumulus ★898](https://github.com/gillesdemey/Cumulus) - SoundCloud player in your menubar.
- [Kitematic](https://kitematic.com) - Docker container management.
- [FatFileFinder ★121 ⏳1Y](https://github.com/pwambach/fat-file-finder) - Find large files on your machine.
- [ScreenCat ★2062 ⏳1Y](https://github.com/maxogden/screencat) - Screen sharing & remote collaboration.
- [Gulp ★973](https://github.com/sindresorhus/gulp-app) - Run Gulp tasks from your menubar.
...
- [Vmd ★733](https://github.com/yoshuawuyts/vmd) - Preview Markdown files.
- [Kyoku ★72](https://github.com/cheeaun/kyoku) - Displays current iTunes song.
- [GReader](https://github.com/Nekle/greader) - Collect and read offline readme files of GitHub repos.
- [Leanote ★1070](https://github.com/leanote/desktop-app) - Cloud notepad.
- [Snapper ★86](https://github.com/pt2121/Snapper) - Screen capturing & recording for Android devices.
- [Imagemin ★665](https://github.com/imagemin/imagemin-app) - Minify images.
- [We Build SG ★39 ⏳1Y](https://github.com/webuildsg/osx) - Upcoming events & recently updated repos from webuild.sg.
...
- [Loop Drop ★628](https://github.com/mmckegg/loop-drop-app) - MIDI looper and synth for live electronic music performances.
- [Toby ★97](https://github.com/frankhale/toby) - YouTube player.
- [Kaku ★741](https://github.com/EragonJ/Kaku) - Music player.
- [Yeoman ★964](https://github.com/yeoman/yeoman-app) - Scaffold projects using Yeoman.
- [Markn ★124 ⏳1Y](https://github.com/minodisk/markn) - Markdown viewer.
- [Shiba ★555](https://github.com/rhysd/Shiba) - Live Markdown preview with linting.
...
- [Monu ★1086 ⏳1Y](https://github.com/maxogden/monu) - Process monitoring.
...
- [google-music-electron ★241](https://github.com/twolfson/google-music-electron) - Unofficial Google music app.
...
- [Mongotron ★2333](https://github.com/officert/mongotron) - MongoDB management tool.
- [Colonizers ★115 ⏳2Y](https://github.com/colonizers/colonizers-desktop) - "Catan" inspired board game.
- [Eintopf ★59 ⏳1Y](https://github.com/mazehall/eintopf) - Manage development projects with Docker.
- [WhatsDesktop ★204](https://github.com/mawie81/whatsdesktop) - Unofficial WhatsApp app.
- [Sqlectron ★1936](https://github.com/sqlectron/sqlectron-gui) - SQL client.
- [docker-indicator ★30 ⏳1Y](https://github.com/khornberg/docker-indicator) - Unofficial Docker menubar app.
- [Light Table ★9960](https://github.com/LightTable/LightTable) - Code editor with instant feedback.
- [Tubehead](https://github.com/makotot/Tubehead) - YouTube music player in your menubar.
- [Google Play Music Desktop Player ★5733](https://github.com/MarshallOfSound/Google-Play-Music-Desktop-Player-UNOFFICIAL-) - Unofficial Google Play Music app.
- [Chrome DevTools ★1444 ⏳2Y](https://github.com/auchenberg/chrome-devtools-app) - Chrome DevTools packaged as an app.
...
- [Inbox ★231](https://github.com/fgnass/inbox-app) - Unofficial Google Inbox app.
...
- [Snippet Bar ★79 ⏳1Y](https://github.com/teesloane/snippet-bar) - Copy-paste & re-use text snippets in your menubar.
- [Electronic WeChat ★9048](https://github.com/geeeeeeeeek/electronic-wechat) - Unofficial WeChat app.
- [dida ★22 ⏳1Y](https://github.com/xwartz/dida) - Add tasks to TickTick (滴答清单).
- [FromScratch ★388](https://github.com/kilian/fromscratch) - Autosaving scratchpad.
- [Hawkpass ★32 ⏳1Y](https://github.com/kalpetros/hawkpass-desktop) - Password generator.
- [Gokotta ★427](https://github.com/Zhangdroid/Gokotta) - Music player.
- [Shake ★24 ⏳1Y](https://github.com/lumios/shake) - Japanese Earthquake Early Warning Notifier.
- [Fog ★116](https://github.com/vitorgalvao/fog) - Unofficial Overcast podcast app.
- [Wmail ★2151](https://github.com/Thomas101/wmail) - Unofficial Gmail & Google Inbox app.
- [Boostnote ★5472](https://github.com/BoostIO/Boostnote) - Markdown note & code snippet app for developers.
- [Before Dawn ★44](https://github.com/muffinista/before-dawn) - Screensaver tool.
...
- [Minira ★76](https://github.com/jenslind/minira) - JIRA issues in your menubar.
- [Ansel ★89](https://github.com/m0g/ansel) - Image organizer.
...
- [Ghost ★844](https://github.com/tryghost/ghost-desktop) - Professional publishing platform.
- [Mattermost ★624](https://github.com/mattermost/desktop) - Mattermost client.
- [PupaFM ★280 ⏳1Y](https://github.com/xwartz/PupaFM) - DoubanFM music player.
- [MediumDesk](https://github.com/sivragav/mediumdesk) - Unofficial Medium app.
- [Lightgallery ★798 ⏳1Y](https://github.com/sachinchoolur/lightgallery-desktop) - Image viewer.
- [Crypter ★230](https://github.com/HR/Crypter) - Secure encryption client.
- [YakYak ★3139](https://github.com/yakyak/yakyak) - Unofficial Google Hangouts app.
- [Museeks ★503](https://github.com/KeitIG/museeks) - Music player.
- [VOX ★150 ⏳1Y](https://github.com/fresk-nc/VOX) - Unofficial VOX music player.
...
- [DBGlass ★1147](https://github.com/web-pal/DBGlass) - PostgreSQL client.
- [Slide Beacon ★111](https://github.com/dermike/slide-beacon-app) - Physical web beacon broadcast.
- [Rambox ★3043](https://github.com/saenzramiro/rambox) - Chat and email app that combines multiple services like Discord, Hangouts, Gmail and Outlook.
- [Extraterm ★333](https://github.com/sedwards2009/extraterm) - Terminal.
- [Materialette ★993](https://github.com/mike-schultz/materialette) - Material design color palette in your menubar.
- [Dext ★579](https://github.com/vutran/dext) - Launcher.
...
- [ndm ★1250](https://github.com/720kb/ndm) - npm desktop manager.
- [GIFBar ★41](https://github.com/dcrousso/GIFBar) - Search GIFs in your menubar.
- [Stacer ★2737](https://github.com/oguzhaninan/Stacer) - Ubuntu system optimizer.
- [Zazu ★1517](https://github.com/tinytacoteam/zazu) - Launcher.
- [Inpad](https://github.com/sarah-seo/Inpad) - Notes app with GitHub-flavored Markdown.
- [Cerebro ★4236](https://github.com/KELiON/cerebro) - Launcher with inline previews.
- [Desktop Dimmer ★106](https://github.com/sidneys/desktop-dimmer) - Control the brightness of any display.
- [LosslessCut ★1238](https://github.com/mifi/lossless-cut) - Lossless video trimming & cutting.
...
- [Electron API usage ★1914](https://github.com/hokein/electron-sample-apps) - Sample apps illustrating usage of Electron APIs.
- [Screen Recorder ★126](https://github.com/hokein/electron-screen-recorder) - WebRTC screen recorder.
...
- [electron-boilerplate ★540](https://github.com/sindresorhus/electron-boilerplate) *(by sindresorhus)* - Boilerplate to kickstart creating an app.
- [generator-electron ★554](https://github.com/sindresorhus/generator-electron) - Scaffold out an app boilerplate.
- [electron-boilerplate ★2270](https://github.com/szwacz/electron-boilerplate) *(by szwacz)* - Comprehensive boilerplate which even generates installers.
- [electron-react-boilerplate ★7533](https://github.com/chentsulin/electron-react-boilerplate) - Boilerplate based on React and webpack.
- [descjop ★331](https://github.com/karad/lein_template_descjop) - ClojureScript boilerplate for creating an app.
...
- [electron-builder ★3990](https://github.com/electron-userland/electron-builder) - Create installers.
- [devtron ★1197](https://github.com/electron/devtron) - Official DevTools extension.
- [electron-packager ★4603](https://github.com/electron-userland/electron-packager) - Package and distribute your app.
- [electron-debug ★375](https://github.com/sindresorhus/electron-debug) - Adds useful debug features.
- [electron-is-dev ★130](https://github.com/sindresorhus/electron-is-dev) - Check if Electron is running in development.
- [electron-localshortcut ★168](https://github.com/parro-it/electron-localshortcut) - Add keyboard shortcuts locally to a window.
- [electron-gh-release ★189](https://github.com/jenslind/electron-gh-releases) - Auto-update by releasing on GitHub.
...
- [fix-path ★89 ⏳1Y](https://github.com/sindresorhus/fix-path) - Fix the $PATH on macOS when run from a GUI app. Useful when spawning a child process.
- [auto-launch ★436](https://github.com/Teamwork/node-auto-launch) - Launch apps at system startup.
- [nuts ★718](https://github.com/GitbookIO/nuts) - Releases server with auto-updater and GitHub as a backend.
- [electron-dl ★321](https://github.com/sindresorhus/electron-dl) - Simplified file downloads.
- [electron-release-server ★722](https://github.com/ArekSredzki/electron-release-server) - Self-hosted release server with front-end & auto-updater support.
- [electron-rebuild ★332](https://github.com/electron/electron-rebuild) - Rebuild native Node.js modules against the currently installed Electron version.
...
- [electron-positioner ★123](https://github.com/jenslind/electron-positioner) - Position windows at common spots.
- [electron-window-state ★234](https://github.com/mawie81/electron-window-state) - Persist window sizes and positions.
- [electron-drag ★124](https://github.com/kapetan/electron-drag) - Improved window dragging.
- [debug-menu ★87](https://github.com/parro-it/debug-menu) - Chrome-like "inspect element" context-menu.
- [electron-installer-debian ★120](https://github.com/unindented/electron-installer-debian) - Create a Debian package.
- [electron-installer-redhat ★26](https://github.com/unindented/electron-installer-redhat) - Create a Red Hat package.
- [electron-installer-windows ★162](https://github.com/unindented/electron-installer-windows) - Create a Windows package.
- [electron-sudo ★224](https://github.com/automation-stack/electron-sudo) - Subprocesses with administrative privileges.
- [electron-json-storage](https://github.com/jviotti/electron-json-storage) - Write and read user settings.
- [electron-download ★113](https://github.com/electron-userland/electron-download) - Download the Electron release zip from GitHub.
- [ipc-stream ★82 ⏳1Y](https://github.com/jprichardson/electron-ipc-stream) - Duplex stream over IPC.
...
- [electron-osx-sign ★220](https://github.com/electron-userland/electron-osx-sign) - Code-signing for macOS apps.
- [electron-detach ★48 ⏳2Y](https://github.com/parro-it/electron-detach) - Restart an Electron app as a detached process.
- [ember-electron ★705](https://github.com/felixrieseberg/ember-electron) - Build, test, and package Ember apps.
- [electrify ★239 ⏳1Y](https://github.com/arboleya/electrify) - Package Meteor apps.
- [spectron ★825](https://github.com/electron/spectron) - Test Electron apps using ChromeDriver.
...
- [electron-is ★87 ⏳1Y](https://github.com/delvedor/electron-is) - Utility functions.
- [electron-osx-appearance ★132 ⏳1Y](https://github.com/danhp/electron-osx-appearance) - Simplified API for accessing macOS's appearance settings.
- [electron-store ★668](https://github.com/sindresorhus/electron-store) - Save and load data like user preferences, app state, cache, etc.
- [electron-context-menu ★368](https://github.com/sindresorhus/electron-context-menu) - Extensible context menu.
- [electron-require ★17 ⏳1Y](https://github.com/brrd/electron-require) - Simplified require.
- [NeDB ★7516](https://github.com/louischatriot/nedb) - Embedded persistent or in-memory database.
...
- [electron-log ★182](https://github.com/megahertz/electron-log) - Simple logging.
- [electron-redux ★231](https://github.com/hardchor/electron-redux) - Synchronize Redux state across windows.
- [electron-vibrancy ★221](https://github.com/arkenthera/electron-vibrancy) - Add vibrancy (blur) to windows.
- [electron-about-window ★117](https://github.com/rhysd/electron-about-window) - 'About This App' window.
- [elemon ★32](https://github.com/manidlou/elemon) - Live-reload your app during development.
- [electron-is-accelerator ★4](https://github.com/brrd/electron-is-accelerator) - Check if a string is a valid accelerator.
- [electron-pdf-window ★74](https://github.com/gerhardberger/electron-pdf-window) - View PDF files in browser windows.
- [electron-router ★25](https://github.com/m0n0l0c0/electron-router) - Router tidying up IPC message passing.
- [electron-lets-move ★161](https://github.com/tommoor/electron-lets-move) - Automatically move your app to `/Applications` on macOS.
- [electron-settings ★300](https://github.com/nathanbuchar/electron-settings) - Reads and writes user settings to disk.
- [got ★2242](https://github.com/sindresorhus/got) - Simplified HTTP requests.
...
- [devtool ★3763](https://github.com/Jam3/devtool) - Debug Node.js with Chrome DevTools.
- [nativefier ★12850](https://github.com/jiahaog/nativefier) - Create an app of any website.
- [electron-stream ★86](https://github.com/juliangruber/electron-stream) - Streaming wrapper.
- [Nightmare](http://www.nightmarejs.org) - High-level browser automation library (alternative to PhantomJS).
- [electron-pdf ★729](https://github.com/fraserxu/electron-pdf) - Generate PDF from URL, HTML, or Markdown files on the command-line.
- [Geojsonapp ★306 ⏳2Y](https://github.com/mick/geojsonapp) - Preview GeoJSON locally.
- [electron-mocha ★269](https://github.com/jprichardson/electron-mocha) - Run Mocha tests in Electron.
- [electron-har ★25](https://github.com/shyiko/electron-har) - Command-line tool for generating HTTP Archive (HAR).
...
- [React PhotonKit ★292 ⏳1Y](https://github.com/react-photonkit/react-photonkit) - Photon components built with React.
- [menubar ★4296](https://github.com/maxogden/menubar) - Menubar app framework.
- [cookies ★103 ⏳1Y](https://github.com/hstove/electron-cookies) - Adds support for `document.cookie`.
- [window ★204](https://github.com/jprichardson/electron-window) - Create and manage windows.
- [React Desktop ★6935](https://github.com/gabrielbull/react-desktop) - UI toolkit for macOS and Windows built with React.
- [electron-input-menu ★62](https://github.com/parro-it/electron-input-menu) - Context menu for input elements.
- [chrome-tabs ★695](https://github.com/adamschwartz/chrome-tabs) - Chrome like tabs.
- [titlebar ★358](https://github.com/kapetan/titlebar) - Emulate the macOS window titlebar.
- [Brightwheel ★54](https://github.com/loranallensmith/brightwheel) - Build and manage UI components with Photon and Etch.
