...
- [The Art of Node ★7046](https://github.com/maxogden/art-of-node#modules) - An introduction to Node.js and client-side development with npm.
...
- [pkgfiles ★59 ⏳1Y](https://github.com/timoxley/pkgfiles) - List all files which would be published in a package.
- [semantic-release ★3377](https://github.com/semantic-release/semantic-release) - Fully automated package publishing.

### Registry

- [npm-name ★101](https://github.com/sindresorhus/npm-name-cli) - Check whether a package name is available on npm.
- [package-json ★57](https://github.com/sindresorhus/package-json) - Get the package.json of a package from the npm registry.
...
- [nrm ★874](https://github.com/Pana/nrm) - Registry manager.
- [npm-register](https://github.com/dickeyxxx/npm-register) - Easy to set up and maintain npm registry and proxy.
- [verdaccio ★1595](https://github.com/verdaccio/verdaccio) - Lightweight private npm proxy registry.
...
- [npm-check ★3776](https://github.com/dylang/npm-check) - Check for outdated, incorrect, and unused dependencies, as well as interactive update.
- [npm-upgrade ★96](https://github.com/th0r/npm-upgrade) - Update outdated npm dependencies interactively.
- [npm-shrinkwrap ★783](https://github.com/uber/npm-shrinkwrap) - A consistent shrinkwrap tool.
- [npm-windows-upgrade ★1313](https://github.com/felixrieseberg/npm-windows-upgrade) - Upgrade npm on Windows.
- [generator-nm ★505](https://github.com/sindresorhus/generator-nm) - Scaffold out an npm package.
- [pkg-up ★34](https://github.com/sindresorhus/pkg-up) - Find the closest package.json file.
- [read-pkg-up ★56](https://github.com/sindresorhus/read-pkg-up) - Read the closest package.json file.
- [normalize-package-data ★77](https://github.com/npm/normalize-package-data) - Normalize package metadata.
...
- [ntl ★397](https://github.com/ruyadorno/ntl) - Interactive CLI menu to list & run npm tasks.
- [decheck ★8](https://github.com/egoist/decheck) - Explore dependencies of npm packages in the command-line.
- [shrinkpack ★758](https://github.com/JamieMason/shrinkpack) - Lock down your dependencies and install offline.
- [redrun ★55](https://github.com/coderaiser/redrun) - Expand scripts from package.json to improve execution speed.
- [package-size ★116](https://github.com/egoist/package-size) - Get the bundle size of an npm package.
- [synp ★89](https://github.com/imsnif/synp) - Convert yarn.lock to package-lock.json and vice versa.
...
*[Windows users, read more. ★1313](https://github.com/felixrieseberg/npm-windows-upgrade)*
...
- [Stats API ★206](https://github.com/npm/download-counts)
