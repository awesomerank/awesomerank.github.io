...
- [The Art of Node ★6740](https://github.com/maxogden/art-of-node#modules) - An introduction to Node.js and client-side development with npm.
...
- [zsh-better-npm-completion ★66](https://github.com/lukechilds/zsh-better-npm-completion) - Better ZSH completion for npm.
...
- [np ★2402](https://github.com/sindresorhus/np) - A better `npm publish`.
- [publish-please ★705](https://github.com/inikulin/publish-please) - Publish packages safely and gracefully.
- [npm-release](https://github.com/phuu/npm-release) - Making releasing to npm so easy a kitten could probably do it™.
- [pkgfiles ★51](https://github.com/timoxley/pkgfiles) - List all files which would be published in a package.
- [semantic-release ★2790](https://github.com/semantic-release/semantic-release) - Fully automated package publishing.

### Registry

- [npm-name ★98](https://github.com/sindresorhus/npm-name-cli) - Check whether a package name is available on npm.
- [package-json ★50](https://github.com/sindresorhus/package-json) - Get the package.json of a package from the npm registry.
- [latest-version ★26](https://github.com/sindresorhus/latest-version-cli) - Get the latest version of an npm package.
- [npm-keyword ★29 ⏳1Y](https://github.com/sindresorhus/npm-keyword) - Get a list of npm packages with a certain keyword.
- [npm-user ★36 ⏳1Y](https://github.com/sindresorhus/npm-user) - Get user info of an npm user.
...
- [dpn ★23 ⏳1Y](https://github.com/gillstrom/dpn) - Get the dependents of a user's npm packages.
- [npm-stats ★44 ⏳1Y](https://github.com/hughsk/npm-stats) - Get data from an npm registry.
- [npm-cli-login ★12](https://github.com/postmanlabs/npm-cli-login) - Log in to npm.
- [nrm ★733](https://github.com/Pana/nrm) - Registry manager.
- [npm-register ★250](https://github.com/dickeyxxx/npm-register) - Easy to set up and maintain npm registry and proxy.
- [verdaccio ★1128](https://github.com/verdaccio/verdaccio) - Lightweight private npm proxy registry.

### Other

- [npm-home ★53](https://github.com/sindresorhus/npm-home) - Open the npm page of a package.
- [gh-home ★80](https://github.com/sindresorhus/gh-home) - Open the GitHub page of a package.
- [david ★761](https://github.com/alanshaw/david) - Check if your package dependencies are out of date.
- [npm-check ★3544](https://github.com/dylang/npm-check) - Check for outdated, incorrect, and unused dependencies, as well as interactive update.
- [npm-upgrade ★77](https://github.com/th0r/npm-upgrade) - Update outdated npm dependencies interactively.
- [npm-shrinkwrap ★778](https://github.com/uber/npm-shrinkwrap) - A consistent shrinkwrap tool.
- [npm-windows-upgrade ★1192](https://github.com/felixrieseberg/npm-windows-upgrade) - Upgrade npm on Windows.
- [generator-nm ★477](https://github.com/sindresorhus/generator-nm) - Scaffold out an npm package.
...
- [normalize-package-data ★71](https://github.com/npm/normalize-package-data) - Normalize package metadata.
- [pkg-conf ★57](https://github.com/sindresorhus/pkg-conf) - Get namespaced config from the closest package.json.
- [npm-run-path ★37](https://github.com/sindresorhus/npm-run-path) - Run locally installed binaries in the terminal by name like with global ones.
...
- [ntl ★387](https://github.com/ruyadorno/ntl) - Interactive CLI menu to list & run npm tasks.
- [decheck ★8](https://github.com/egoist/decheck) - Explore dependencies of npm packages in the command-line.
- [shrinkpack ★749](https://github.com/JamieMason/shrinkpack) - Lock down your dependencies and install offline.
- [redrun ★47](https://github.com/coderaiser/redrun) - Expand scripts from package.json to improve execution speed.
- [package-size ★80](https://github.com/egoist/package-size) - Get the bundle size of an npm package.


## Clients

- [yarn ★26820](https://github.com/yarnpkg/yarn) - Fast, reliable, and secure dependency management.
- [npm ★13504](https://github.com/npm/npm) - The official client.
- [pnpm ★2727](https://github.com/pnpm/pnpm) - Fast, disk space efficient npm installs.
- [ied ★1939](https://github.com/alexanderGugel/ied) - Faster npm.
...
*[Windows users, read more. ★1192](https://github.com/felixrieseberg/npm-windows-upgrade)*
...
With `npx` (Comes bundled with npm v5.2.0 or newer) and the [`node-bin`](https://www.npmjs.com/package/node-bin) package, you can easily try out code in different Node.js versions without having to use a version manager like [`nvm`](http://nvm.sh), [`nave`](https://github.com/isaacs/nave), or [`n` ★7389](https://github.com/tj/n).
...
- [Stats API ★192](https://github.com/npm/download-counts)
