...
- [The Art of Node ★7547](https://github.com/maxogden/art-of-node#modules) - An introduction to Node.js and client-side development with npm.
...
- [zsh-better-npm-completion ★149 ⏳1Y](https://github.com/lukechilds/zsh-better-npm-completion) - Better ZSH completion for npm.
...
- [publish-please ★724](https://github.com/inikulin/publish-please) - Publish packages safely and gracefully.
...
- [semantic-release ★4553](https://github.com/semantic-release/semantic-release) - Fully automated package publishing.

### Registry

- [npm-name ★162](https://github.com/sindresorhus/npm-name-cli) - Check whether a package name is available on npm.
- [package-json ★74](https://github.com/sindresorhus/package-json) - Get the package.json of a package from the npm registry.
...
- [nrm ★1092](https://github.com/Pana/nrm) - Registry manager.
- [npm-register](https://github.com/dickeyxxx/npm-register) - Easy to set up and maintain npm registry and proxy.
- [verdaccio ★3405](https://github.com/verdaccio/verdaccio) - Lightweight private npm proxy registry.
...
- [npm-check ★4183](https://github.com/dylang/npm-check) - Check for outdated, incorrect, and unused dependencies, as well as interactive update.
- [npm-upgrade ★127](https://github.com/th0r/npm-upgrade) - Update outdated npm dependencies interactively.
- [npm-shrinkwrap ★793](https://github.com/uber/npm-shrinkwrap) - A consistent shrinkwrap tool.
- [npm-windows-upgrade ★1507](https://github.com/felixrieseberg/npm-windows-upgrade) - Upgrade npm on Windows.
...
- [read-pkg-up ★92](https://github.com/sindresorhus/read-pkg-up) - Read the closest package.json file.
- [normalize-package-data ★96](https://github.com/npm/normalize-package-data) - Normalize package metadata.
- [pkg-conf ★81](https://github.com/sindresorhus/pkg-conf) - Get namespaced config from the closest package.json.
- [npm-run-path ★55 ⏳1Y](https://github.com/sindresorhus/npm-run-path) - Run locally installed binaries in the terminal by name like with global ones.
- [local-npm](https://github.com/nolanlawson/local-npm) - Use npm [offline](https://addyosmani.com/blog/using-npm-offline/).
- [npe ★41 ⏳1Y](https://github.com/zeke/npe) - CLI for inspecting and editing properties in package.json.
...
- [ntl ★506](https://github.com/ruyadorno/ntl) - Interactive CLI menu to list & run npm tasks.
- [decheck ★8](https://github.com/egoist/decheck) - Explore dependencies of npm packages in the command-line.
- [shrinkpack ★778](https://github.com/JamieMason/shrinkpack) - Lock down your dependencies and install offline.
- [redrun ★61](https://github.com/coderaiser/redrun) - Expand scripts from package.json to improve execution speed.
- [package-size ★158](https://github.com/egoist/package-size) - Get the bundle size of an npm package.
- [synp ★168](https://github.com/imsnif/synp) - Convert yarn.lock to package-lock.json and vice versa.
- [npm-run-all ★1935](https://github.com/mysticatea/npm-run-all) - CLI tool to run multiple npm-scripts in parallel or serial.
- [onchange ★393](https://github.com/Qard/onchange) - Watch files and folders and run a command when something changed.
- [cli-error-notifier ★38](https://github.com/micromata/cli-error-notifier) - Sends native desktop notifications when npm scripts fail.


## Clients

- [yarn ★32162](https://github.com/yarnpkg/yarn) - Fast, reliable, and secure dependency management.
- [npm ★16798](https://github.com/npm/npm) - The official client.
- [pnpm ★3955](https://github.com/pnpm/pnpm) - Fast, disk space efficient package manager.
...
*[Windows users, read more. ★1507](https://github.com/felixrieseberg/npm-windows-upgrade)*
...
- [Stats API ★229](https://github.com/npm/download-counts)
