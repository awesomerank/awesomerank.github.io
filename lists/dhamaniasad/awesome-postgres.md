...
* [Patroni ★1230](https://github.com/zalando/patroni) - Template for PostgreSQL HA with ZooKeeper or etcd.
* [Stolon ★1042](https://github.com/sorintlab/stolon) - PostgreSQL HA based on Consul or etcd, with Kubernetes integration.
* [pglookout ★73](https://github.com/ohmu/pglookout) - Replication monitoring and failover daemon.
...
* [Postbird ★190](https://github.com/Paxa/postbird) - PostgreSQL Client for macOS.
...
* [Check\_postgres ★273](https://github.com/bucardo/check_postgres) - Nagios check\_postgres plugin for checking status of PostgreSQL databases.
...
* [libzbxpgsql ★78](https://github.com/cavaliercoder/libzbxpgsql) - Comprehensive PostgreSQL monitoring module for Zabbix.
...
* [plpgsql\_check ★86](https://github.com/okbob/plpgsql_check) - Extension that allows to check plpgsql source code.
...
* [ERAlchemy ★314](https://github.com/Alexis-benoist/eralchemy) - ERAlchemy generates Entity Relation (ER) diagram from databases.
...
* [pgCenter ★495](https://github.com/lesovsky/pgcenter) - Provides convenient interface to various statistics, management task, reloading services, viewing log files and canceling or terminating database backends.
* [pgclimb ★247](https://github.com/lukasmartinelli/pgclimb) - Export data from PostgreSQL into different data formats.
* [pgfutter ★610](https://github.com/lukasmartinelli/pgfutter) - Import CSV and JSON into PostgreSQL the easy way.
* [PGInsight](http://pginsight.io/) - CLI tool to easily dig deep inside your PostgreSQL database.
* [pgloader ★1270](https://github.com/dimitri/pgloader) - Loads data into PostgreSQL using the COPY streaming protocol, and does so with separate threads for reading and writing data.
...
* [pgsync ★420](https://github.com/ankane/pgsync) - Tool to sync PostgreSQL data to your local machine.
...
* Elixir: [postgrex ★480](https://github.com/elixir-ecto/postgrex)
