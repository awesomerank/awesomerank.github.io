...
---
# Awesome Standard [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★67308](https://github.com/sindresorhus/awesome)
...
- **[prettier-standard](https://www.npmjs.com/package/prettier-standard)** - format with [prettier ★15795](https://github.com/prettier/prettier) configured to standard rules
...
## editor plugins
- Every major text editor has a plugin or built-in support for `standard`. See the [full list ★13825](https://github.com/standard/standard#are-there-text-editor-plugins) of supported editors.
...
- Emacs: see [readme ★13825](https://github.com/standard/standard#emacs)
...
- Vim: see [readme ★13825](https://github.com/standard/standard#vim)
...
- WebStorm (PhpStorm, IntelliJ, RubyMine, JetBrains, etc.): built-in support. see [readme ★13825](https://github.com/standard/standard#webstorm-phpstorm-intellij-rubymine-jetbrains-etc)
...
- **[videojs-standard](https://www.npmjs.com/package/videojs-standard)** - fork by the [video.js ★17899](https://github.com/videojs/video.js) team
