...
---
# awesome-opengl [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★61331](https://github.com/sindresorhus/awesome)
...
* [GLIntercept ★239](https://github.com/dtrebilco/glintercept) - OpenGL function call interceptor for Windows.
...
* [vogl ★1296](https://github.com/ValveSoftware/vogl) - OpenGL capture and playback debugger developed by Valve.
...
* [GLFM ★96](https://github.com/brackeen/glfm) - Supplies an OpenGL ES context and input events for mobile devices and the web.
* [glm](http://glm.g-truc.net/0.9.6/index.html) - Mathematics library for graphics software based on the GLSL specifications.
* [Magnum ★1377](https://github.com/mosra/magnum) - It is a 2D/3D graphics engine for modern OpenGL.
...
* [Pangolin ★303](https://github.com/stevenlovegrove/Pangolin) - Lightweight portable rapid development library for managing OpenGL display / interaction and abstracting video input.
...
* [gl3w ★267](https://github.com/skaslev/gl3w) - Simple OpenGL core profile loader.
* [glad ★408](https://github.com/Dav1dde/glad) - Multi profile loader-generator based on the official specs.
* [glbindify ★3 ⏳1Y](https://github.com/nnesse/glbindify) - Commmand line tool to generate C bindings for OpenGL, wgl, and glX.
* [glbinding ★443](https://github.com/cginternals/glbinding) - Profile loader leveraging C++11 features to provide type safety.
...
* [OpenGL Examples ★758](https://github.com/McNopper/OpenGL) by **Norbert Nopper**
...
* [awesome-computer-vision ★2740](https://github.com/jbhuang0604/awesome-computer-vision) - A curated list of awesome computer vision resources.
* [awesome-webgl ★90](https://github.com/sjfricke/awesome-webgl) - A curated list of awesome WebGL libraries, resources and much more.
* [awesome-vulkan ★546](https://github.com/vinjn/awesome-vulkan) - A curated list of awesome Vulkan projects and ecosystem.
