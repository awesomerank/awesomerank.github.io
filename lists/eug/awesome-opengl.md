...
* [GLIntercept ★226](https://github.com/dtrebilco/glintercept) - OpenGL function call interceptor for Windows.
...
* [vogl ★1287](https://github.com/ValveSoftware/vogl) - OpenGL capture and playback debugger developed by Valve.
...
* [GLFM ★77](https://github.com/brackeen/glfm) - Supplies an OpenGL ES context and input events for mobile devices and the web.
* [glm](http://glm.g-truc.net/0.9.6/index.html) - Mathematics library for graphics software based on the GLSL specifications.
* [Magnum ★1345](https://github.com/mosra/magnum) - It is a 2D/3D graphics engine for modern OpenGL.
...
* [OpenGL Examples ★720](https://github.com/McNopper/OpenGL) by **Norbert Nopper**
...
* [awesome-computer-vision ★2467](https://github.com/jbhuang0604/awesome-computer-vision) - A curated list of awesome computer vision resources.
* [awesome-webgl ★60](https://github.com/sjfricke/awesome-webgl) - A curated list of awesome WebGL libraries, resources and much more.
* [awesome-vulkan ★501](https://github.com/vinjn/awesome-vulkan) - A curated list of awesome Vulkan projects and ecosystem.
