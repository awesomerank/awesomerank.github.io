...
* [GLIntercept ★256](https://github.com/dtrebilco/glintercept) - OpenGL function call interceptor for Windows.
...
* [vogl ★1309](https://github.com/ValveSoftware/vogl) - OpenGL capture and playback debugger developed by Valve.
...
* [GLFM ★132](https://github.com/brackeen/glfm) - Supplies an OpenGL ES context and input events for mobile devices and the web.
* [glm](http://glm.g-truc.net/0.9.6/index.html) - Mathematics library for graphics software based on the GLSL specifications.
* [Magnum ★1429](https://github.com/mosra/magnum) - It is a 2D/3D graphics engine for modern OpenGL.
...
* [Pangolin ★341](https://github.com/stevenlovegrove/Pangolin) - Lightweight portable rapid development library for managing OpenGL display / interaction and abstracting video input.
...
* [gl3w ★298](https://github.com/skaslev/gl3w) - Simple OpenGL core profile loader.
* [glad ★488](https://github.com/Dav1dde/glad) - Multi profile loader-generator based on the official specs.
* [glbindify ★3 ⏳1Y](https://github.com/nnesse/glbindify) - Commmand line tool to generate C bindings for OpenGL, wgl, and glX.
* [glbinding ★455](https://github.com/cginternals/glbinding) - Profile loader leveraging C++11 features to provide type safety.
...
* [OpenGL Examples ★816](https://github.com/McNopper/OpenGL) by **Norbert Nopper**
