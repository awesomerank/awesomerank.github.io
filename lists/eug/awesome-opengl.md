...
* [CodeXL ★721](https://github.com/GPUOpen-Tools/CodeXL) - AMD's tool suite that includes debugger, profiler and frame/shader analysis.
* [GL-SL Debugger](http://glsl-debugger.github.io) - Tool for debugging OpenGL programs.
* [GLIntercept ★305](https://github.com/dtrebilco/glintercept) - OpenGL function call interceptor for Windows.
...
* [vogl ★1334](https://github.com/ValveSoftware/vogl) - OpenGL capture and playback debugger developed by Valve.
...
* [assimp ★3155](https://github.com/assimp/assimp) - Portable library to import 3D models in a uniform manner.
...
* [GLFM ★192](https://github.com/brackeen/glfm) - Supplies an OpenGL ES context and input events for mobile devices and the web.
* [glm](http://glm.g-truc.net/0.9.6/index.html) - Mathematics library for graphics software based on the GLSL specifications.
* [Magnum ★1791](https://github.com/mosra/magnum) - It is a 2D/3D graphics engine for modern OpenGL.
...
* [Pangolin ★489](https://github.com/stevenlovegrove/Pangolin) - Lightweight portable rapid development library for managing OpenGL display / interaction and abstracting video input.
...
* [gl3w ★368](https://github.com/skaslev/gl3w) - Simple OpenGL core profile loader.
* [glad ★718](https://github.com/Dav1dde/glad) - Multi profile loader-generator based on the official specs.
* [glbindify ★3 ⏳2Y](https://github.com/nnesse/glbindify) - Commmand line tool to generate C bindings for OpenGL, wgl, and glX.
* [glbinding ★511](https://github.com/cginternals/glbinding) - Profile loader leveraging C++11 features to provide type safety.
...
* [OpenGL Examples ★983 ⏳1Y](https://github.com/McNopper/OpenGL) by **Norbert Nopper**
...
* [gamedev ★4946](https://github.com/ellisonleao/magictools) - A awesome list about game development.
* [graphics-resources ★1143 ⏳1Y](https://github.com/mattdesl/graphics-resources) - A list of graphic programming resources.
