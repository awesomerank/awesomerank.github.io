...
---
# Awesome IPFS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★65640](https://github.com/sindresorhus/awesome)
...
[ipfs/notes ★125](https://github.com/ipfs/notes)._
...
* [beets ★6152](https://github.com/beetbox/beets) - Beets has a plugin which allows for easy sharing of music libraries using IPFS
* [Blokaly](https://www.blokaly.com) - A badge issuing, sharing and display platform based on IPFS.
* [Boards](https://ipfs.io/ipns/boards.ydns.eu) - Distributed social platform that runs in the browser. [GitHub ★139 ⏳1Y](https://github.com/fazo96/ipfs-boards)
...
* [git-ipfs-rehost ★75 ⏳1Y](https://github.com/whyrusleeping/git-ipfs-rehost) - A script to rehost your git repos in ipfs.
...
* [ipfs.pics ★803](https://github.com/ipfspics/ipfspics-server) - Upload and share pics.
* [IPFSBin ★89 ⏳1Y](https://github.com/victorbjelkholm/ipfsbin) - Pastebin clone build.
...
* [ipfs-chrome-station ★42](https://github.com/fbaiodias/ipfs-chrome-station) - Chrome extension to redirect ipfs.io traffic to local gateway
...
* [ipfs-companion ★107](https://github.com/ipfs/ipfs-companion) - Firefox addon to provide access to IPFS via local gateway
* [ipfs-gui ★10](https://github.com/marcin212/ipfs-gui) - Windows UI integration and IPFS installer
* [ipfs-linux-service ★32 ⏳2Y](https://github.com/dylanPowers/ipfs-linux-service) - IPFS Linux Init Daemon
...
* [ipfscrape ★112 ⏳1Y](https://github.com/victorbjelkholm/ipfscrape) - Scrape a webpage with all assets and put it in IPFS
* [ipget ★63](https://github.com/ipfs/ipget) - :satellite: wget for IPFS: retrieve files over IPFS and save them locally.
...
* [ipscend ★151](https://github.com/diasdavid/ipscend) - Tool for hosting web apps and static websites in IPFS
* [pinbot ★15](https://github.com/whyrusleeping/pinbot) - Pin content via IRC
* [ipfs-mount ★14](https://github.com/richardschneider/net-ipfs-mount) - Mount IPFS as a mapped drive on Windows
