...
---
# Awesome IPFS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★61331](https://github.com/sindresorhus/awesome)
...
place to ask about it might be in [ipfs/apps ★39](https://github.com/ipfs/apps) or
[ipfs/notes ★112 ⏳1Y](https://github.com/ipfs/notes)._
...
* [beets ★5959](https://github.com/beetbox/beets) - Beets has a plugin which allows for easy sharing of music libraries using IPFS
* [Blokaly](https://www.blokaly.com) - A badge issuing, sharing and display platform based on IPFS.
* [Boards](https://ipfs.io/ipns/boards.ydns.eu) - Distributed social platform that runs in the browser. [GitHub ★134](https://github.com/fazo96/ipfs-boards)
...
* [git-ipfs-rehost ★71 ⏳1Y](https://github.com/whyrusleeping/git-ipfs-rehost) - A script to rehost your git repos in ipfs.
* [Global Upload](https://globalupload.io/) - File transportation service for IPFS, upload files to the future of distributed web.
* [HydrusNetwork ★209](https://github.com/hydrusnetwork/hydrus) - A booru-style media tagging application with a multitude of features, recently added basic ipfs support.
* [InterPlanetary Wayback ★82](https://github.com/oduwsdl/ipwb) - Web Archive (WARC) indexing and replay using IPFS.
* [Interplanetary Wiki ★45 ⏳1Y](https://github.com/jamescarlyle/ipfs-wiki) - Wiki built on top of IPFS
...
* [ipfs.ink](https://ipfs.ink) - Publish and render markdown essays to and from ipfs. [GitHub ★11](https://github.com/kpcyrd/ipfs.ink)
...
* [ipfs.pics ★779](https://github.com/ipfspics/ipfspics-server) - Upload and share pics.
* [IPFSBin ★86 ⏳1Y](https://github.com/victorbjelkholm/ipfsbin) - Pastebin clone build.
...
* [cachewarmer ★30](https://github.com/BrendanBenshoof/cachewarmer) - Donate ipfs gateways to cache other people's content
* [git-remote-ipfs ★91](https://github.com/cryptix/git-remote-ipfs) - push/pull repositories from/to IPFS
...
* [ipfs-chrome-station ★40](https://github.com/fbaiodias/ipfs-chrome-station) - Chrome extension to redirect ipfs.io traffic to local gateway
* [ipfs-chrome-extension ★55 ⏳1Y](https://github.com/dylanPowers/ipfs-chrome-extension) - Chrome extension to redirect ipfs.io traffic to local gateway
...
* [ipfscrape ★104 ⏳1Y](https://github.com/victorbjelkholm/ipfscrape) - Scrape a webpage with all assets and put it in IPFS
* [ipget ★57](https://github.com/ipfs/ipget) - :satellite: wget for IPFS: retrieve files over IPFS and save them locally.
...
* [ipscend ★133](https://github.com/diasdavid/ipscend) - Tool for hosting web apps and static websites in IPFS
* [pinbot ★15](https://github.com/whyrusleeping/pinbot) - Pin content via IRC
* [ipfs-mount ★11](https://github.com/richardschneider/net-ipfs-mount) - Mount IPFS as a mapped drive on Windows
