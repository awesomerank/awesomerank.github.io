...
---
# Awesome Magento 2 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome) [![Build Status](https://travis-ci.org/DavidLambauer/awesome-magento2.svg?branch=master)](https://travis-ci.org/DavidLambauer/awesome-magento2)
...
- [Documentation Search for Alfred ★4](DavidLambauer/Alfred-Workflow-Magento-2-DevDocs-Search) - Easily integrate the official Magento 2 Search into your Alfred Workflows.
- [Tablerates Generator](https://elgentos.nl/tablerates/) - Generate Tablerates with an online Tool.
- [Pestle ★224](astorm/pestle) - Code Generation Tool by Alan Storm.
- [Mage2Gen](https://mage2gen.com/) - Online Module Creator.
- [Magento 2 Code Generator ★50](staempfli/magento2-code-generator) - Code Generator by Juan Alonso.
...
- [Mage Chrome Toolbar ★46](magespecialist/mage-chrome-toolbar) - A MUST-HAVE Chrome Extension for Magento 2 by [MageSpecialist](https://github.com/magespecialist).
...
- [Config ImportExport ★53](semaio/Magento2-ConfigImportExport) - CLI Based Config Management.
- [Codesniffer ★221](magento-ecg/coding-standard) - Magento 2 Codesniffer.
- [Whoops Exceptions ★15](yireo/Yireo_Whoops) - PHP Exceptions for Cool Kids in Magento 2.
- [Developer Toolbar ★116](mgtcommerce/Mgt_Developertoolbar) - Magento 2 Developer Toolbar.
- [Advanced Template Hints ★64](ho-nl/magento2-Ho_Templatehints) - Magento 2 Template Hints Helper.
- [Magento2 PHPStorm Templates ★44](staempfli/magento2-phpstorm-templates) - Live templates for Magento2
- [Technical Dept Collector ★13](Vinai/m2-tech-debt) - Console Command to aggregates technical debt information on Magento 2 modules into a CSV format by [Vinai Kopp](https://commercehero.io/vinai).
- [Magento 2 Dockerize ★55](arvatoSCM/dockerize-magento2) - A composer package for dockerizing Magento 2.
- [Mage2 Vagrant ★243 ⏳1Y](rgranadino/mage2_vagrant) - Simple Magento 2 Vagrant Box.
- [frontools ★188](SnowdogApps/magento2-frontools) - Set of front-end tools for Magento 2, based on Gulp.js.
- [Scopehints ★19](avstudnitz/AvS_ScopeHint2) - Displays additional information in the Store Configuration by [Andreas von Studnitz](https://commercehero.io/avstudnitz).
- [PreferencesInfoCommand ★8](dmanners/DavidAndVinai_PreferencesInfoCommand) - bin/magento command to display configured preferences for classes or interfaces
...
- [de_DE ★42](splendidinternet/Magento2_German_LocalePack_de_DE) :de: - German Language 	Package.
- [de_CH ★2](staempfli/magento2-language-de-ch) 🇨🇭 - Swiss Language Package.
- [fr_FR ★21](Imaginaerum/magento2-language-fr-fr) :fr: - French Language Package.
- [da_DK](https://magentodanmark.dk/) 🇩🇰 - Danish Language Package.
- [es_ES ★5](eusonlito/magento2-language-es_es) :es: - Spanish Language Package.
- [it_IT ★9](antoniocarboni/magento2-traduzione-italiana) :it: - Italian Language Package.
- [nl_NL ★13](ho-nl/magento2-nl_NL) [alt.](https://bitbucket.org/creaminternet/language-nl_nl.git) 🇳🇱 - Dutch Language Package.
- [pl_PL ★13](SnowdogApps/magento2-pl_pl) 🇵🇱 - Polish Language Package.
- [tr_TR ★8](hidonet/magento2-language-tr_tr) :tr: - Turkish Language Package.
- [ro_RO ★1](EaDesgin/magento2-romanian-language-pack) 🇷🇴 - Romanian Language Package.
- [fi_FL ★0](mageplaza/magento-2-finnish-language-pack) 🇫🇮 - Finnish Language Package.
- [ko_KR ★0](mageplaza/magento-2-korean-language-pack) 🇰🇷 - Korean Language Package.
- [sk_SK ★0](mageplaza/magento-2-slovak-language-pack) 🇸🇰 - Slovakian Language Package.
- [sl_SI ★5](symfony-si/magento2-sl-si) 🇸🇮 - Slovenian Language Package.

### Search

- [Algolia Search Integration ★47](algolia/algoliasearch-magento-2) - Algolia Search(SaaS) Integration.
- [Elastic Suite Integration ★150](Smile-SA/elasticsuite) - Elastic Suite Integration.
- [FastSimpleImport2 ★55](firegento/FireGento_FastSimpleImport2) - Wrapper for Magento 2 ImportExport functionality, which imports products and customers from arrays.
...
- [PageDesigner ★17](Magenerds/PageDesigner) - Easily create and drag and drop your CMS contents in the Magento Backend.

### Marketing

- [MagePlaza Seo](https://github.com/mageplaza/magento-2-seo-extension) - Well documented multi purpose SEO Extension.
- [Magemonkey Mailchimp Integration ★35](ebizmarts/magento2-magemonkey) - Plug & Play Mailchimp Integration.
- [Magento 2 PDF ★20](staempfli/magento2-module-pdf) - PDF Generator based on [wkhtmltopdf](http://wkhtmltopdf.org/).

### Adminhtml / Backend

- [Customer Force Login ★35](bitExpert/magento2-force-login) - Login as a Customer for support reasons.
- [Checkout Tester ★9](yireo/Yireo_CheckoutTester2) - Extension to quickly test Checkout changes.
...
- [Image Resizer ★26](staempfli/magento2-module-image-resizer) - Magento 2 Module to add simple image resizing capabilities in all blocks and .phtml templates by [Staempfli](https://commercehero.io/staempfli).
- [Excel Spreadsheet ★4](staempfli/magento2-module-spreadsheet) - Magento 2 Module for parsing xlsx, xlsm and csv files from Excel by [Staempfli](https://commercehero.io/staempfli).
- [PDF Generator ★6](EaDesgin/magento2-pdf-generator2) - Invoice PDF Generator For Magento 2 by [EaDesign](https://commercehero.io/eadesign).
- [Mobile Detection ★7](EaDesgin/magento2-mobiledetect) - Mobile detect change theme and redirect based on device type by [EaDesign](https://commercehero.io/eadesign).
...
- [Kraken.io ★13](kraken-io/kraken-magento) - High Quality Image reduction Service as a SaaS Integration.
---
...
- [MASE2 Optimus theme ★16](studioemma/magento2-theme-optimus)
- [Magento2 - Blank Theme - SASS version ★174](SnowdogApps/magento2-theme-blank-sass)
---
...
- [Magento Github Repository ★4421](magento/magento2) - Github Repository.
- [Magento PHP CS Fixer ★83](magento/marketplace-eqp) - CS Fixer specific for Magento 2.
- [Magento Developer Blog](https://community.magento.com/t5/Magento-DevBlog/bg-p/devblog?nobounce=) - Developer Blog by Magento.
- [Magento 2 Code Samples ★15](magento/magento2-samples) - Samples to introduce and demonstrate new technologies in Magento 2.
- [Magento 2 DevBox ★134](magento/magento2devbox-web) - Dockerbox built by Magento.
...
- [Mageres ★258](aleron75/mageres) - Alessandro Ronchi's List of resources for Magento 1 and Magento 2.
- [Awesome PHP ★15483](ziadoz/awesome-php) - A curated List of Awesome PHP Resources.
- [Awesome Magento ★28](sunel/awesome-magento) - An Awesome Magento List with mixed M1 and M2 Content by [sunel](https://github.com/sunel).
- [Headless Magento 2 ★22](sitewards/headless-magento2-resources) - A list of resources about running Magento 2 headless by [Sitewards](https://commercehero.io/sitewards)
