...
A curated list of awesome R packages and tools. Inspired by [awesome-machine-learning ★22112](https://github.com/josephmisiti/awesome-machine-learning).
...
* [lambda.r ★99](https://github.com/zatonovo/lambda.r) - Functional programming and simple pattern matching in R.
...
* [data.table <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1040](https://github.com/Rdatatable/data.table) - Fast data manipulation in a short and flexible syntax.
...
* [rlist ★101](https://github.com/renkun-ken/rlist) - A toolbox for non-tabular data manipulation with lists.
...
* [fuzzyjoin ★212](https://github.com/dgrtwo/fuzzyjoin) - Join tables together on inexact matching.
...
* [ggfortify ★261](https://github.com/sinhrks/ggfortify) - A unified interface to ggplot2 popular statistical packages using one line of code.
* [ggrepel ★360](https://github.com/slowkow/ggrepel) - Repel overlapping text labels away from each other.
* [ggalt ★233](https://github.com/hrbrmstr/ggalt) - Extra Coordinate Systems, Geoms and Statistical Transformations for ggplot2.
* [ggtree ★155](https://github.com/GuangchuangYu/ggtree) - Visualization and annotation of phylogenetic tree.
* [ggtech ★141](https://github.com/ricardo-bion/ggtech) - ggplot2 tech themes and scales
...
* [hrbrthemes ★226](https://github.com/hrbrmstr/hrbrthemes) -  🔏 Opinionated, typographic-centric ggplot2 themes and theme components.
...
* [DiagrammeR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★770](https://github.com/rich-iannone/DiagrammeR) - Create JS graph diagrams and flowcharts in R.
* [dygraphs ★190](https://github.com/rstudio/dygraphs) - Charting time-series data in R.
* [formattable](http://renkun.me/formattable/) - Formattable Data Structures.
* [ggvis <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★603](https://github.com/rstudio/ggvis) - Interactive grammar of graphics for R.
...
* [scatterD3 ★79](https://github.com/juba/scatterD3) - Interactive scatterplots with D3.
* [plotly <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★914](https://github.com/ropensci/plotly) - Interactive ggplot2 and Shiny plotting with [plot.ly](https://plot.ly).
* [rCharts <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1060](https://github.com/ramnathv/rCharts) - Interactive JS Charts from R.
* [rbokeh](http://hafen.github.io/rbokeh/) - R Interface to [Bokeh](http://bokeh.pydata.org/en/latest/).
* [threejs ★150](https://github.com/bwlewis/rthreejs) - Interactive 3D scatter plots and globes.
* [timevis ★159](https://github.com/daattali/timevis) - Create fully interactive timeline visualizations.
* [visNetwork ★142](https://github.com/datastorm-open/visNetwork) - Using vis.js library for network visualization.
* [wordcloud2 ★154](https://github.com/Lchiffon/wordcloud2) - R interface to wordcloud2.js.
...
* [slidify <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★762](https://github.com/ramnathv/slidify) - Generate reproducible html5 slides from R markdown.
...
* [checkpoint ★67](https://github.com/RevolutionAnalytics/checkpoint) - Install packages from snapshots on the checkpoint server.
...
* [Web Technologies List ★123](https://github.com/ropensci/webservices) - Information about how to use R and the world wide web together.
* [shiny <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★2254](https://github.com/rstudio/shiny) - Easy interactive web applications with R.
* [RCurl](http://cran.r-project.org/web/packages/RCurl/index.html) - General network (HTTP/FTP/...) client interface for R.
* [httr <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★607](https://github.com/hadley/httr) - User-friendly RCurl wrapper.
...
* [rvest <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★759](https://github.com/hadley/rvest) - Simple web scraping for R, using CSSSelect or XPath syntax.
...
* [Rfacebook ★217](https://github.com/pablobarbera/Rfacebook) - Access to Facebook API via R.
* [RSiteCatalyst ★97](https://github.com/randyzwitch/RSiteCatalyst) - R client library for the Adobe Analytics.
* [plumber ★306](https://github.com/trestletech/plumber) - A library to expose existing R code as web API.
...
* [RJulia ★113](https://github.com/armgong/RJulia) - R package Call Julia.
...
* [DBI ★88](https://github.com/rstats-db/DBI) - Defines a common interface between the R and database management systems.
* [elastic ★138](https://github.com/ropensci/elastic) - Wrapper for the Elasticsearch HTTP API
...
* [AnomalyDetection <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1958](https://github.com/twitter/AnomalyDetection) - AnomalyDetection R package from Twitter.
...
* [prophet <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★3149](https://github.com/facebookincubator/prophet) - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
...
* [lme4 <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★215](https://github.com/lme4/lme4) - Mixed-effects models 
...
* [Machine Learning For Hackers <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★2954](https://github.com/johnmyleswhite/ML_for_Hackers)
* [mlr <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★647](https://github.com/mlr-org/mlr) - Extensible framework for classification, regression, survival analysis and clustering
...
* [text2vec ★279](https://github.com/dselivanov/text2vec) - Fast Text Mining Framework for Vectorization and Word Embeddings.
...
* [LDAvis ★252](https://github.com/cpsievert/LDAvis) - Interactive visualization of topic models.
...
* [ddpcr ★14](https://github.com/daattali/ddpcr) - Analysis and visualization of Droplet Digital PCR data.

## Network Analysis
*Packages to construct, analyze and visualize network data.*

* [Network Analysis List ★494](https://github.com/briatte/awesome-network-analysis) - Network Analysis related resources.
...
* [Leaflet](http://rstudio.github.io/leaflet/) - One of the most popular JavaScript libraries interactive maps.
* [ggmap ★265](https://github.com/dkahle/ggmap) -  Plotting maps in R with ggplot2.
* [REmap ★122](https://github.com/Lchiffon/REmap) - R interface to the JavaScript library ECharts for interactive map data visualization.
...
* [spatstat ★30](https://github.com/spatstat/spatstat) - Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
...
* [Package Development List ★14](https://github.com/ropensci/PackageDevelopment) - R packages to improve package development.
* [devtools <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1445](https://github.com/hadley/devtools) - Tools to make an R developer's life easier.
* [testthat <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★390](https://github.com/hadley/testthat) - An R package to make testing fun.
...
* [lintr ★262](https://github.com/jimhester/lintr) - Static code analysis for R to enforce code style.
...
* [engsoccerdata ★238](https://github.com/jalapic/engsoccerdata) - English and European soccer results 1871-2016.
...
* [git2r ★103](https://github.com/ropensci/git2r) - Gives you programmatic access to Git repositories from R.
...
* [DataScienceR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★624](https://github.com/ujjwalkarn/DataScienceR) - a list of R tutorials for Data Science, NLP and Machine Learning.
...
* [R Books List ★53](https://github.com/RomanTsegelskyi/rbooks) - List of R Books.
...
* [Books ★53](https://github.com/RomanTsegelskyi/rbooks) - List of R Books.
* [DataScienceR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★624](https://github.com/ujjwalkarn/DataScienceR) - a list of R tutorials for Data Science, NLP and Machine Learning.
* [ggplot2 Extensions](https://ggplot2-exts.github.io/ggiraph.html) - Showcases of ggplot2 extensions.
...
* [Network Analysis ★494](https://github.com/briatte/awesome-network-analysis) - Network Analysis related resources.
...
* [Package Development ★14](https://github.com/ropensci/PackageDevelopment) - R packages to improve package development.
