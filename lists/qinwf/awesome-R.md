...
A curated list of awesome R packages and tools. Inspired by [awesome-machine-learning ★22923](josephmisiti/awesome-machine-learning).
...
* [prophet ★3308](facebookincubator/prophet) - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
* [tidyverse ★323](tidyverse/tidyverse) - Easily install and load packages from the tidyverse
* [purrr ★459](tidyverse/purrr) - A functional programming toolkit for R
* [hrbrthemes ★240](hrbrmstr/hrbrthemes) -  🔏 Opinionated, typographic-centric ggplot2 themes and theme components 
* [xaringan ★228](yihui/xaringan) - Create HTML5 slides with R Markdown and the JavaScript library
* [blogdown ★380](rstudio/blogdown) - Create Blogs and Websites with R Markdown
* [glue ★156](tidyverse/glue) -  Glue strings to data in R. Small, fast, dependency free interpreted string literals. 
* [covr ★163](jimhester/covr) - Test coverage reports for R
* [lintr ★289](jimhester/lintr) - Static Code Analysis for R
* [reprex](https://github.com/jennybc/reprex) - Render bits of R code for sharing, e.g., on GitHub or StackOverflow.
* [reticulate ★241](rstudio/reticulate) - R Interface to Python 
* [tensorflow ★721](rstudio/tensorflow) -  TensorFlow for R 
...
* [TextMate + r.tmblundle ★22](textmate/r.tmbundle) - Add-on package for TextMate 1/2.
...
* [IRkernel <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★689](IRkernel/IRkernel) - R kernel for Jupyter.
...
* [Vim-R ★110 ⏳1Y](vim-scripts/Vim-R-plugin) - Vim plugin for R. 
* [Nvim-R ★200](jalvesaq/Nvim-R) - Neovim plugin for R.
...
* [pipeR ★119](renkun-ken/pipeR) - Multi-paradigm Pipeline Implementation.
* [lambda.r ★101](zatonovo/lambda.r) - Functional programming and simple pattern matching in R.
...
* [data.table <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1074](Rdatatable/data.table) - Fast data manipulation in a short and flexible syntax.
* [reshape2  <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★153](hadley/reshape) - Flexible rearrange, reshape and aggregate data.
...
* [rlist ★103](renkun-ken/rlist) - A toolbox for non-tabular data manipulation with lists.
...
* [bigmemory](http://cran.r-project.org/web/packages/bigmemory/index.html) - Shared memory and memory-mapped matrices. The big* pacakges provide additional tools including linear models ([biglm](http://cran.r-project.org/web/packages/biglm/index.html)) and Random Forests ([bigrf ★84 ⏳1Y](aloysius-lim/bigrf)).
* [fuzzyjoin ★223](dgrtwo/fuzzyjoin) - Join tables together on inexact matching.
...
* [ggfortify ★266](sinhrks/ggfortify) - A unified interface to ggplot2 popular statistical packages using one line of code.
* [ggrepel ★366](slowkow/ggrepel) - Repel overlapping text labels away from each other.
* [ggalt ★236](hrbrmstr/ggalt) - Extra Coordinate Systems, Geoms and Statistical Transformations for ggplot2.
* [ggtree ★157](GuangchuangYu/ggtree) - Visualization and annotation of phylogenetic tree.
* [ggtech ★144](ricardo-bion/ggtech) - ggplot2 tech themes and scales
...
* [corrplot ★98](taiyun/corrplot) - A graphical display of a correlation matrix or general matrix. It also contains some algorithms to do matrix reordering.
...
* [extrafont ★120 ⏳1Y](wch/extrafont) - Tools for using fonts in R graphics.
* [showtext ★123](yixuan/showtext) - Enable R graphics device to show text using system fonts.
...
* [gganimate ★403](dgrtwo/gganimate) - Create easy animations with ggplot2.
...
* [d3heatmap ★175](rstudio/d3heatmap) - Interactive heatmaps with D3.
* [DataTables](http://rstudio.github.io/DT/) - Displays R matrices or data frames as interactive HTML tables.
* [DiagrammeR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★792](rich-iannone/DiagrammeR) - Create JS graph diagrams and flowcharts in R.
* [dygraphs ★192](rstudio/dygraphs) - Charting time-series data in R.
* [formattable](http://renkun.me/formattable/) - Formattable Data Structures.
* [ggvis <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★606](rstudio/ggvis) - Interactive grammar of graphics for R.
...
* [scatterD3 ★82](juba/scatterD3) - Interactive scatterplots with D3.
* [plotly <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★939](ropensci/plotly) - Interactive ggplot2 and Shiny plotting with [plot.ly](https://plot.ly).
* [rCharts <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1069](ramnathv/rCharts) - Interactive JS Charts from R.
* [rbokeh](http://hafen.github.io/rbokeh/) - R Interface to [Bokeh](http://bokeh.pydata.org/en/latest/).
* [threejs ★157](bwlewis/rthreejs) - Interactive 3D scatter plots and globes.
* [timevis ★166](daattali/timevis) - Create fully interactive timeline visualizations.
* [visNetwork ★150](datastorm-open/visNetwork) - Using vis.js library for network visualization.
* [wordcloud2 ★167](Lchiffon/wordcloud2) - R interface to wordcloud2.js.
...
* [slidify <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★764](ramnathv/slidify) - Generate reproducible html5 slides from R markdown.
...
* [checkpoint ★68](RevolutionAnalytics/checkpoint) - Install packages from snapshots on the checkpoint server.
...
* [Web Technologies List ★124](ropensci/webservices) - Information about how to use R and the world wide web together.
* [shiny <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★2289](rstudio/shiny) - Easy interactive web applications with R.
* [RCurl](http://cran.r-project.org/web/packages/RCurl/index.html) - General network (HTTP/FTP/...) client interface for R.
* [httr <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★615](hadley/httr) - User-friendly RCurl wrapper.
* [httpuv ★80](rstudio/httpuv) - HTTP and WebSocket server library.
...
* [rvest <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★778](hadley/rvest) - Simple web scraping for R, using CSSSelect or XPath syntax.
...
* [Rfacebook ★226](pablobarbera/Rfacebook) - Access to Facebook API via R.
* [RSiteCatalyst ★99](randyzwitch/RSiteCatalyst) - R client library for the Adobe Analytics.
* [plumber ★333](trestletech/plumber) - A library to expose existing R code as web API.
...
* [Rcpp11 ★71 ⏳1Y](Rcpp11/Rcpp11) - Rcpp11 is a complete redesign of Rcpp, targetting C++11.
...
* [jvmr ★12 ⏳2Y](cran/jvmr) - Integration of R, Java, and Scala.
...
* [runr ★64](yihui/runr) - Run Julia and Bash from R.
* [RJulia ★114](armgong/RJulia) - R package Call Julia.
...
* [RcppOctave ★10](renozao/RcppOctave) - Seamless Interface to Octave and Matlab.
...
* [DBI ★91](rstats-db/DBI) - Defines a common interface between the R and database management systems.
* [elastic ★140](ropensci/elastic) - Wrapper for the Elasticsearch HTTP API
...
* [RHive ★118 ⏳1Y](nexr/RHive) - R extension facilitating distributed computing via Apache Hive.
* [RNeo4j ★189](nicolewhite/Rneo4j) - Neo4j graph database driver.
* [rpostgis ★19](mablab/rpostgis) - R interface to PostGIS database and get spatial objects in R.

## Machine Learning
*Packages for making R cleverer.*

* [AnomalyDetection <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1994](twitter/AnomalyDetection) - AnomalyDetection R package from Twitter.
...
* [BreakoutDetection <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★561 ⏳2Y](twitter/BreakoutDetection) - Breakout Detection via Robust E-Statistics from Twitter.
* [bst](http://cran.r-project.org/web/packages/bst/index.html) - Gradient Boosting
* [CausalImpact <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★652](google/CausalImpact) - Causal inference using Bayesian structural time-series models.
...
* [prophet <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★3308](facebookincubator/prophet) - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
...
* [lme4 <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★222](lme4/lme4) - Mixed-effects models 
...
* [Machine Learning For Hackers <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★2981](johnmyleswhite/ML_for_Hackers)
* [mlr <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★665](mlr-org/mlr) - Extensible framework for classification, regression, survival analysis and clustering
...
* [text2vec ★295](dselivanov/text2vec) - Fast Text Mining Framework for Vectorization and Word Embeddings.
...
* [LDAvis ★260](cpsievert/LDAvis) - Interactive visualization of topic models.
...
* [quanteda ★244](kbenoit/quanteda) - R functions for Quantitative Analysis of Textual Data.
* [Topic Models Resources ★99 ⏳1Y](trinker/topicmodels_learning) - Topic Models learning and R related resources.
...
* [ddpcr ★17](daattali/ddpcr) - Analysis and visualization of Droplet Digital PCR data.

## Network Analysis
*Packages to construct, analyze and visualize network data.*

* [Network Analysis List ★533](briatte/awesome-network-analysis) - Network Analysis related resources.
...
* [netdiffuseR ★15](USCCANA/netdiffuseR) - Tools for Analysis of Network Diffusion.
...
* [Leaflet](http://rstudio.github.io/leaflet/) - One of the most popular JavaScript libraries interactive maps.
* [ggmap ★269](dkahle/ggmap) -  Plotting maps in R with ggplot2.
* [REmap ★123](Lchiffon/REmap) - R interface to the JavaScript library ECharts for interactive map data visualization.
...
* [gstat ★21](edzer/gstat) - Spatial and spatio-temporal geostatistical modelling, prediction and simulation.
* [spacetime ★20](edzer/spacetime) - R classes and methods for spatio-temporal data.
* [RColorBrewer](https://cran.r-project.org/web/packages/RColorBrewer/index.html) - Provides color schemes for maps
* [spatstat ★31](spatstat/spatstat) - Spatial Point Pattern Analysis, Model-Fitting, Simulation, Tests
...
* [Package Development List ★15](ropensci/PackageDevelopment) - R packages to improve package development.
* [devtools <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1460](hadley/devtools) - Tools to make an R developer's life easier.
* [testthat <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★394](hadley/testthat) - An R package to make testing fun.
* [R6 <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★156](wch/R6) - simpler, faster, lighter-weight alternative to R's built-in classes.
* [pryr <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★118](hadley/pryr) - Make it easier to understand what's going on in R.
* [roxygen <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★222](klutometis/roxygen) - Describe your functions in comments next to their definitions.
* [lineprof ★92 ⏳1Y](hadley/lineprof) - Visualise line profiling results in R.
* [packrat ★204](rstudio/packrat) - Make your R projects more isolated, portable, and reproducible.
* [installr ★100](talgalili/installr) - Functions for installing softwares from within R (for Windows).
* [import ★66](smbache/import) - An import mechanism for R.
* [modules ★101](klmr/modules) - An alternative (Python style) module system for R.
...
* [drat ★66](eddelbuettel/drat) - Creation and use of R repositories on GitHub or other repos.
* [covr ★163](jimhester/covr) - Test coverage for your R package and (optionally) upload the results to [coveralls](https://coveralls.io/) or [codecov](https://codecov.io/).
* [lintr ★289](jimhester/lintr) - Static code analysis for R to enforce code style.
* [staticdocs](https://github.com/hadley/staticdocs) - Generate static html documentation for an R package.

## Logging
*Packages for Logging*

* [futile.logger ★73](zatonovo/futile.logger) - A logging package in R similar to log4j
* [log4r ★38](johnmyleswhite/log4r) - A log4j derivative for R
* [logging](https://cran.r-project.org/web/packages/logging/index.html) - A logging package emulating the python logging package.

## Data Packages
*Handy Data Packages*

* [engsoccerdata ★245](jalapic/engsoccerdata) - English and European soccer results 1871-2016.
...
* [git2r ★105](ropensci/git2r) - Gives you programmatic access to Git repositories from R.
...
* [rho ★126](rho-devel/rho) - Refactor the interpreter of the R language into a fully-compatible, efficient, VM for R.
* [riposte ★72 ⏳1Y](jtalbot/riposte) - a fast interpreter and JIT for R.
...
* [DataScienceR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★637](ujjwalkarn/DataScienceR) - a list of R tutorials for Data Science, NLP and Machine Learning.
...
* [R Books List ★55 ⏳1Y](RomanTsegelskyi/rbooks) - List of R Books.
...
* [Books ★55 ⏳1Y](RomanTsegelskyi/rbooks) - List of R Books.
* [DataScienceR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★637](ujjwalkarn/DataScienceR) - a list of R tutorials for Data Science, NLP and Machine Learning.
* [ggplot2 Extensions](https://ggplot2-exts.github.io/ggiraph.html) - Showcases of ggplot2 extensions.
...
* [Network Analysis ★533](briatte/awesome-network-analysis) - Network Analysis related resources.
* [Open Data ★84](ropensci/opendata) - Using R to obtain, parse, manipulate, create, and share open data.
* [Posts](https://github.com/qinwf/awesome-R/blob/master/posts.md) - Great R blog posts or Rticles.
* [Package Development ★15](ropensci/PackageDevelopment) - R packages to improve package development.
* [R Project Conferences](https://www.r-project.org/conferences.html) -  Information about useR! Conferences and DSC Conferences.
* [RStartHere ★253](rstudio/RStartHere) - A guide to some of the most useful R packages, organized by workflow.
* [RStudio Addins ★239](daattali/addinslist) - List of RStudio addins.
* [Topic Models ★99 ⏳1Y](trinker/topicmodels_learning) - Topic Models learning and R related resources.
* [Web Technologies ★124](ropensci/webservices) - Information about how to use R and the world wide web together.
