...
A curated list of awesome R packages and tools. Inspired by [awesome-machine-learning ★24671](https://github.com/josephmisiti/awesome-machine-learning).
...
* [prophet ★3607](https://github.com/facebookincubator/prophet) - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
* [tidyverse ★351](https://github.com/tidyverse/tidyverse) - Easily install and load packages from the tidyverse
* [purrr ★489](https://github.com/tidyverse/purrr) - A functional programming toolkit for R
* [hrbrthemes ★265](https://github.com/hrbrmstr/hrbrthemes) -  🔏 Opinionated, typographic-centric ggplot2 themes and theme components 
* [xaringan ★253](https://github.com/yihui/xaringan) - Create HTML5 slides with R Markdown and the JavaScript library
* [blogdown ★448](https://github.com/rstudio/blogdown) - Create Blogs and Websites with R Markdown
* [glue ★178](https://github.com/tidyverse/glue) -  Glue strings to data in R. Small, fast, dependency free interpreted string literals. 
* [covr ★168](https://github.com/jimhester/covr) - Test coverage reports for R
* [lintr ★327](https://github.com/jimhester/lintr) - Static Code Analysis for R
* [reprex](https://github.com/jennybc/reprex) - Render bits of R code for sharing, e.g., on GitHub or StackOverflow.
* [reticulate ★277](https://github.com/rstudio/reticulate) - R Interface to Python 
* [tensorflow ★796](https://github.com/rstudio/tensorflow) -  TensorFlow for R 
...
* [IRkernel <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★728](https://github.com/IRkernel/IRkernel) - R kernel for Jupyter.
...
* [lambda.r ★102](https://github.com/zatonovo/lambda.r) - Functional programming and simple pattern matching in R.
...
* [data.table <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1141](https://github.com/Rdatatable/data.table) - Fast data manipulation in a short and flexible syntax.
* [reshape2  <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★155](https://github.com/hadley/reshape) - Flexible rearrange, reshape and aggregate data.
...
* [rlist ★106](https://github.com/renkun-ken/rlist) - A toolbox for non-tabular data manipulation with lists.
...
* [bigmemory](http://cran.r-project.org/web/packages/bigmemory/index.html) - Shared memory and memory-mapped matrices. The big* pacakges provide additional tools including linear models ([biglm](http://cran.r-project.org/web/packages/biglm/index.html)) and Random Forests ([bigrf ★85 ⏳1Y](https://github.com/aloysius-lim/bigrf)).
* [fuzzyjoin ★243](https://github.com/dgrtwo/fuzzyjoin) - Join tables together on inexact matching.
...
* [ggfortify ★280](https://github.com/sinhrks/ggfortify) - A unified interface to ggplot2 popular statistical packages using one line of code.
* [ggrepel ★379](https://github.com/slowkow/ggrepel) - Repel overlapping text labels away from each other.
* [ggalt ★247](https://github.com/hrbrmstr/ggalt) - Extra Coordinate Systems, Geoms and Statistical Transformations for ggplot2.
* [ggtree ★166](https://github.com/GuangchuangYu/ggtree) - Visualization and annotation of phylogenetic tree.
* [ggtech ★147 ⏳1Y](https://github.com/ricardo-bion/ggtech) - ggplot2 tech themes and scales
...
* [corrplot ★107](https://github.com/taiyun/corrplot) - A graphical display of a correlation matrix or general matrix. It also contains some algorithms to do matrix reordering.
...
* [extrafont ★125 ⏳1Y](https://github.com/wch/extrafont) - Tools for using fonts in R graphics.
* [showtext ★131](https://github.com/yixuan/showtext) - Enable R graphics device to show text using system fonts.
...
* [gganimate ★446](https://github.com/dgrtwo/gganimate) - Create easy animations with ggplot2.
...
* [d3heatmap ★178](https://github.com/rstudio/d3heatmap) - Interactive heatmaps with D3.
* [DataTables](http://rstudio.github.io/DT/) - Displays R matrices or data frames as interactive HTML tables.
* [DiagrammeR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★833](https://github.com/rich-iannone/DiagrammeR) - Create JS graph diagrams and flowcharts in R.
* [dygraphs ★203](https://github.com/rstudio/dygraphs) - Charting time-series data in R.
* [formattable](http://renkun.me/formattable/) - Formattable Data Structures.
* [ggvis <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★610 ⏳1Y](https://github.com/rstudio/ggvis) - Interactive grammar of graphics for R.
...
* [scatterD3 ★89](https://github.com/juba/scatterD3) - Interactive scatterplots with D3.
* [plotly <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★985](https://github.com/ropensci/plotly) - Interactive ggplot2 and Shiny plotting with [plot.ly](https://plot.ly).
* [rCharts <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1081](https://github.com/ramnathv/rCharts) - Interactive JS Charts from R.
* [rbokeh](http://hafen.github.io/rbokeh/) - R Interface to [Bokeh](http://bokeh.pydata.org/en/latest/).
* [threejs ★167](https://github.com/bwlewis/rthreejs) - Interactive 3D scatter plots and globes.
* [timevis ★180](https://github.com/daattali/timevis) - Create fully interactive timeline visualizations.
* [visNetwork ★173](https://github.com/datastorm-open/visNetwork) - Using vis.js library for network visualization.
* [wordcloud2 ★179](https://github.com/Lchiffon/wordcloud2) - R interface to wordcloud2.js.
...
* [slidify <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★773 ⏳1Y](https://github.com/ramnathv/slidify) - Generate reproducible html5 slides from R markdown.
...
* [checkpoint ★75](https://github.com/RevolutionAnalytics/checkpoint) - Install packages from snapshots on the checkpoint server.
...
* [Web Technologies List ★127](https://github.com/ropensci/webservices) - Information about how to use R and the world wide web together.
* [shiny <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★2407](https://github.com/rstudio/shiny) - Easy interactive web applications with R.
* [shinyjs ★259](https://github.com/daattali/shinyjs) -  Easily improve the user interaction and user experience in your Shiny apps in seconds.
...
* [httpuv ★82](https://github.com/rstudio/httpuv) - HTTP and WebSocket server library.
...
* [rvest <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★817](https://github.com/hadley/rvest) - Simple web scraping for R, using CSSSelect or XPath syntax.
...
* [Rfacebook ★247](https://github.com/pablobarbera/Rfacebook) - Access to Facebook API via R.
* [RSiteCatalyst ★100](https://github.com/randyzwitch/RSiteCatalyst) - R client library for the Adobe Analytics.
* [plumber ★391](https://github.com/trestletech/plumber) - A library to expose existing R code as web API.
...
* [SparkR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★640 ⏳1Y](https://github.com/amplab-extras/SparkR-pkg) - R frontend for Spark.
...
* [Rcpp11 ★73 ⏳1Y](https://github.com/Rcpp11/Rcpp11) - Rcpp11 is a complete redesign of Rcpp, targetting C++11.
...
* [runr ★71](https://github.com/yihui/runr) - Run Julia and Bash from R.
* [RJulia ★117](https://github.com/armgong/RJulia) - R package Call Julia.
...
* [DBI ★95](https://github.com/rstats-db/DBI) - Defines a common interface between the R and database management systems.
* [elastic ★154](https://github.com/ropensci/elastic) - Wrapper for the Elasticsearch HTTP API
...
* [RNeo4j ★195](https://github.com/nicolewhite/Rneo4j) - Neo4j graph database driver.
* [rpostgis ★23](https://github.com/mablab/rpostgis) - R interface to PostGIS database and get spatial objects in R.

## Machine Learning
*Packages for making R cleverer.*

* [AnomalyDetection <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★2144](https://github.com/twitter/AnomalyDetection) - AnomalyDetection R package from Twitter.
...
* [BreakoutDetection <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★579](https://github.com/twitter/BreakoutDetection) - Breakout Detection via Robust E-Statistics from Twitter.
* [bst](http://cran.r-project.org/web/packages/bst/index.html) - Gradient Boosting
* [CausalImpact <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★680](https://github.com/google/CausalImpact) - Causal inference using Bayesian structural time-series models.
...
* [prophet <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★3607](https://github.com/facebookincubator/prophet) - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
...
* [lme4 <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★234](https://github.com/lme4/lme4) - Mixed-effects models 
...
* [Machine Learning For Hackers <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★3065](https://github.com/johnmyleswhite/ML_for_Hackers)
* [mlr <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★725](https://github.com/mlr-org/mlr) - Extensible framework for classification, regression, survival analysis and clustering
...
* [text2vec ★334](https://github.com/dselivanov/text2vec) - Fast Text Mining Framework for Vectorization and Word Embeddings.
...
* [LDAvis ★274](https://github.com/cpsievert/LDAvis) - Interactive visualization of topic models.
...
* [quanteda ★267](https://github.com/kbenoit/quanteda) - R functions for Quantitative Analysis of Textual Data.
* [Topic Models Resources ★106 ⏳1Y](https://github.com/trinker/topicmodels_learning) - Topic Models learning and R related resources.
...
* [Network Analysis List ★605](https://github.com/briatte/awesome-network-analysis) - Network Analysis related resources.
...
* [Leaflet](http://rstudio.github.io/leaflet/) - One of the most popular JavaScript libraries interactive maps.
* [ggmap ★288](https://github.com/dkahle/ggmap) -  Plotting maps in R with ggplot2.
* [REmap ★135](https://github.com/Lchiffon/REmap) - R interface to the JavaScript library ECharts for interactive map data visualization.
...
* [gstat ★24](https://github.com/edzer/gstat) - Spatial and spatio-temporal geostatistical modelling, prediction and simulation.
* [spacetime ★21](https://github.com/edzer/spacetime) - R classes and methods for spatio-temporal data.
...
* [devtools <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★1491](https://github.com/hadley/devtools) - Tools to make an R developer's life easier.
* [testthat <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★419](https://github.com/hadley/testthat) - An R package to make testing fun.
...
* [pryr <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★124](https://github.com/hadley/pryr) - Make it easier to understand what's going on in R.
* [roxygen <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★232](https://github.com/klutometis/roxygen) - Describe your functions in comments next to their definitions.
* [lineprof ★92 ⏳1Y](https://github.com/hadley/lineprof) - Visualise line profiling results in R.
* [packrat ★216](https://github.com/rstudio/packrat) - Make your R projects more isolated, portable, and reproducible.
* [installr ★117](https://github.com/talgalili/installr) - Functions for installing softwares from within R (for Windows).
* [import ★67](https://github.com/smbache/import) - An import mechanism for R.
* [modules ★107](https://github.com/klmr/modules) - An alternative (Python style) module system for R.
...
* [drat ★69](https://github.com/eddelbuettel/drat) - Creation and use of R repositories on GitHub or other repos.
* [covr ★168](https://github.com/jimhester/covr) - Test coverage for your R package and (optionally) upload the results to [coveralls](https://coveralls.io/) or [codecov](https://codecov.io/).
* [lintr ★327](https://github.com/jimhester/lintr) - Static code analysis for R to enforce code style.
* [staticdocs](https://github.com/hadley/staticdocs) - Generate static html documentation for an R package.

## Logging
*Packages for Logging*

* [futile.logger ★79](https://github.com/zatonovo/futile.logger) - A logging package in R similar to log4j
* [log4r ★41](https://github.com/johnmyleswhite/log4r) - A log4j derivative for R
* [logging](https://cran.r-project.org/web/packages/logging/index.html) - A logging package emulating the python logging package.

## Data Packages
*Handy Data Packages*

* [engsoccerdata ★260](https://github.com/jalapic/engsoccerdata) - English and European soccer results 1871-2016.
...
* [git2r ★107](https://github.com/ropensci/git2r) - Gives you programmatic access to Git repositories from R.
...
* [DataScienceR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★750](https://github.com/ujjwalkarn/DataScienceR) - a list of R tutorials for Data Science, NLP and Machine Learning.
...
* [R Books List ★69](https://github.com/RomanTsegelskyi/rbooks) - List of R Books.
...
* [Books ★69](https://github.com/RomanTsegelskyi/rbooks) - List of R Books.
* [DataScienceR <img class="emoji" alt="heart" src="https://awesome-r.com/heart.png" height="20" align="absmiddle" width="20"> ★750](https://github.com/ujjwalkarn/DataScienceR) - a list of R tutorials for Data Science, NLP and Machine Learning.
* [ggplot2 Extensions](https://ggplot2-exts.github.io/ggiraph.html) - Showcases of ggplot2 extensions.
...
* [Network Analysis ★605](https://github.com/briatte/awesome-network-analysis) - Network Analysis related resources.
* [Open Data ★96](https://github.com/ropensci/opendata) - Using R to obtain, parse, manipulate, create, and share open data.
...
* [RStartHere ★270](https://github.com/rstudio/RStartHere) - A guide to some of the most useful R packages, organized by workflow.
* [RStudio Addins ★256](https://github.com/daattali/addinslist) - List of RStudio addins.
* [Topic Models ★106 ⏳1Y](https://github.com/trinker/topicmodels_learning) - Topic Models learning and R related resources.
* [Web Technologies ★127](https://github.com/ropensci/webservices) - Information about how to use R and the world wide web together.
