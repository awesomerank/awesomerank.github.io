...
#### -= Awesome TypeScript =- [Awesome Elasticsearch ★1065](https://github.com/dzharii/awesome-elasticsearch) →
...
* :octocat: [Microsoft/TypeScript on Github ★25725](https://github.com/Microsoft/TypeScript) fork TypeScript on Github! Or... just read the code
...
* :octocat: [DefinitelyTyped](http://definitelytyped.org/), the repository for high quality TypeScript type definitions maintained by [Boris Yankov ★12141](https://github.com/DefinitelyTyped/DefinitelyTyped)
...
* [NodeJS Tools for Visual Studio ★1590](https://github.com/Microsoft/nodejstools)
...
* [TypeScript Sublime Plugin ★1160](https://github.com/Microsoft/TypeScript-Sublime-Plugin) by @Microsoft
* [Atom TypeScript ★932](https://github.com/TypeStrong/atom-typescript) by @TypeStrong
* [TypeScript Interactive Development Environment for Emacs ★379](https://github.com/ananthakumaran/tide) by @ananthakumaran
* [TypeScript IDE for Eclipse](http://typecsdev.com/)
* [TypeScript Syntax for VIM ★683](https://github.com/leafgarland/typescript-vim)
...
##### Playground
* [TypeScript playground-on-ace](https://github.com/hi104/typescript-playground-on-ace) by @hi104 [updated to TypeScript 1.5 ★54 ⏳2Y](https://github.com/basarat/TypeScriptEditor)
...
### TypeScript for...
#### React
* :octocat: [wmonk/create-react-app-typescript ★999](https://github.com/wmonk/create-react-app-typescript) Create React apps using typescript with no build configuration; based on `create-react-app`
* :octocat: [Microsoft/TypeScript-React-Starter ★2652](https://github.com/Microsoft/TypeScript-React-Starter) A starter template for TypeScript and React with a detailed README describing how to use the two together; based on `create-react-app`
...
* :guardsman: [**vortigern** - A universal boilerplate for building web applications w/ TypeScript, React, Redux and more. ★470](https://github.com/barbar/vortigern)
* :robot: [Convert React code to TypeScript automatically ★29](https://github.com/lyft/react-javascript-to-typescript-transform)
## Aspect Oriented Programming
* [Agent Framework ★20](https://github.com/agentframework/agentframework) Create interceptor for your class and method using @decorators
...
* [TsLint ★2298](https://github.com/palantir/tslint) - TypeScript linter by @palantir
...
### Web
* :octocat: [Angular ★27683](https://github.com/angular/angular) - Angular is a development platform for building mobile and desktop web applications
* :octocat: [React-UWP ★314](https://github.com/myxvisual/react-uwp) - React Components that Implement Microsoft's UWP Design & Fluent Design.
* :octocat: [palantir/plottable ★2188](https://github.com/palantir/plottable) - A library of modular chart components, built on `D3` (see also: http://plottablejs.org)
* :octocat: [APIs-guru/graphql-voyager ★2275](https://github.com/APIs-guru/graphql-voyager) - Represent any GraphQL API as an interactive graph 🛰️
* :octocat: [Rebilly/ReDoc ★1383](https://github.com/Rebilly/Redoc) - OpenAPI/Swagger-generated API Reference Documentation
...
### Design patterns
* :octocat: [Design Patterns implementation ★837](https://github.com/torokmark/design_patterns_in_typescript) - Implementation of the well-known 23 patterns of GoF
