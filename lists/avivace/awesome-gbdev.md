...
A curated list of awesome Game Boy (Color) Development resources, tools, docs, related projects and open-source ROMs. Inspired by the [awesome ★63835](https://github.com/sindresorhus/awesome) list thing.
...
### Peripherals
- [Game Boy Camera RE ★19 ⏳2Y](https://github.com/AntonioND/gbcam-rev-engineer) - Documentation about GB Camera and tools used to reverse engineer it by using Arduino UNO.
...
- [jsGB ★430 ⏳7Y](https://github.com/Two9A/jsGB) - Javascript.
- [php-terminal-Game Boy-emulator ★1197](https://github.com/gabrielrcouto/php-terminal-gameboy-emulator) - PHP Terminal
- [gameboy-Online ★183 ⏳1Y](https://github.com/taisel/gameboy-Online) - Javascript, HTML5 canvas and JavaScript audio APIs.
- [cboy ★15](https://github.com/jkbenaim/cboy) - C. Mac OS X and Linux.
- [weplay ★506](https://github.com/rauchg/weplay) - Collaborative Game Boy emulation powered by JavaScript.
- [giibiiadvance ★58 ⏳1Y](https://github.com/AntonioND/giibiiadvance) -  A GB, GBC emulator with GB Camera support. Written in C.
- [GBE+ ★67](https://github.com/shonumi/gbe-plus) - Built in C++ and SDL. Focused on enhancements.
- [Sameboy ★36](https://github.com/LIJI32/SameBoy) - Portable C.
- [GameYob ★120](https://github.com/Drenn1/GameYob) - Emulator for Nintendo (3)DS.
...
- [Gearboy ★254](https://github.com/drhelius/Gearboy) - C++. iOS, Raspberry Pi, Mac, Windows and Linux.
- [AndroidGameBoyEmulator ★188 ⏳1Y](https://github.com/pedrovgs/AndroidGameBoyEmulator)
- [GameLad ★249](https://github.com/Dooskington/GameLad) - C++/SDL almost fully featured emulator.
- [Wadatsumi ★8](https://github.com/arrow-lang/wadatsumi) - Arrow.
- [Binjgb ★35](https://github.com/binji/binjgb) - 5kloc emulator in C that passes most of the tests.
- [jgilchrist ★21](https://github.com/jgilchrist/emulator) - Modern C++.
- [gameboyGO ★11](https://github.com/gonccalo/gameboyGO) - Go.
- [GameBoyEmulator-GBS ★22 ⏳1Y](https://github.com/Salgat/GameBoyEmulator-GBS) - C++ 14 with a single library dependency of SFML.
- [PyBoy ★40](https://github.com/Baekalfen/PyBoy) - Python. Mac, Linux and Windows.
- [scimitar ★2](https://github.com/tompko/scimitar) - Rust.
- [FunGBC ★8](https://github.com/andreasjhkarlsson/fungbc) - F#.
...
### Assemblers
- [rgbds ★259](https://github.com/rednex/rgbds) - Assembler and linker package (a fork currently updated).
- [wla-dx ★166](https://github.com/vhelin/wla-dx) - Yet Another GB-Z80/Z80/.. Multi Platform Cross Assembler Package.
- [gbasm ★101 ⏳1Y](https://github.com/BonsaiDen/gbasm) - A JavaScript based compiler for Gameboy z80 assembly code.
- [tniASM](http://www.tni.nl/products/tniasm.html) - Macro Assembler.
- [Assembler ★90](https://github.com/ulrikdamm/Assembler) - Assembler written in Swift.
...
- [Gambatte ★228](https://github.com/sinamas/gambatte) - Open-source, cross-platform and accurate emulator for Game Boy and Game Boy Color.

### Tools
- [ZGB ★73](https://github.com/Zal0/ZGB) - A little engine for creating games for the original Game Boy (expands gbdk, more info [here](http://zalods.blogspot.com/2017/01/zgb-little-engine-for-game-boy.html)).
...
- [GBT PLAYER ★43](https://github.com/AntonioND/gbt-player) - A music player library and converter kit for Game Boy that can be used with RGBDS.
...
- [bmp2cgb ★4](https://github.com/gitendo/bmp2cgb) - 8bpp bitmap converter for Gameboy Color development.
...
- [gb-template ★4 ⏳1Y](https://github.com/exezin/gb-template) - A template with basic functions pre-made such as joypad input, DMA transfers, and map/tile data loading.
- [assemblydigest ★37 ⏳3Y](https://github.com/assemblydigest/gameboy) - Exploring Game Boy programming techniques.
...
- [Grooves Game Boy Programming ★29 ⏳3Y](https://github.com/gbdk-salvage/grooves-game-boy-programming) - A complete set of lessons about implementing various game mechanics in a Game Boy game.
...
## Games
- [Infinity ★386 ⏳1Y](https://github.com/infinity-gbc/infinity)

### ASM
- [RedPlusPlus ★73](https://github.com/TheFakeMateo/RedPlusPlus) - An upgrade to Pokémon Red. Fixes several bugs and adds a lot of new features.
- [Tuff ★270 ⏳1Y](https://github.com/BonsaiDen/Tuff.gb)
- [2048-gb ★64 ⏳2Y](https://github.com/Sanqui/2048-gb)
...
- [µCity ★126](https://github.com/AntonioND/ucity)
- [Carazu ★8](https://github.com/mholtkamp/carazu)
- [Snake-gb ★8](https://github.com/DonaldHays/snake-gb)
...
- [Flappy-boy-asm ★7](https://github.com/bitnenfer/flappy-boy-asm)
...
- [Pokémon Red/Blue ★1282](https://github.com/pret/pokered)
- [Pokémon Crystal ★883](https://github.com/pret/pokecrystal)
- [Pokémon Pinball ★26](https://github.com/pret/pokepinball)
- [Pokémon TCG ★40](https://github.com/pret/poketcg)
- [Reverse engineering Kirby's Dreamland 2](http://ecc-comp.blogspot.it/2016/03/reverse-engineering-kirbys-dreamland-2.html)
- [pokemontools ★131](https://github.com/pret/pokemon-reverse-engineering-tools) - a python module that provides various reverse engineering components for various Pokémon games.

## Related sites, posts and projects
- [ArduinoBoy ★86](https://github.com/trash80/Arduinoboy) - Serial communication (MIDI) from an Arduino to the Game Boy for music applications such as LittleSoundDJ, Nanoloop., and mGB.
...
- [Piglet ★33 ⏳2Y](https://github.com/danShumway/Piglet) - A LUA-driven AI that plays classic Game Boy color games using experimentation. In active development.
...
- [Wiz ★7 ⏳1Y](https://github.com/Bananattack/wiz) - A high-level assembly language for writing homebrew on retro console platforms (Game Boy, NES, Atari 2600, and more).
...
- [Ostrich ★4](https://github.com/PumpMagic/ostrich) - A Game Boy Sound System player written in Swift.
...
- [GBVideoPlayer ★37](https://github.com/LIJI32/GBVideoPlayer) - A technical demo demonstrating how the Gameboy LCD controller can be hacked to make a Gameboy Color play a full motion video in color, together with music.
...
- [ArduinoGameBoy ★47 ⏳2Y](https://github.com/drhelius/arduinogameboy) - Arduino based Game Boy cartridge reader and writer.
