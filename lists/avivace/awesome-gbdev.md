...
- [Related custom hardware ★11](https://github.com/Gekkio/gb-hardware) - by gekkio.
...
- [Mooneye-gb ★203](https://github.com/Gekkio/mooneye-gb) -  A Game Boy research project and emulator written in Rust.
...
- [PlutoBoy ★30](https://github.com/RossMeikleham/PlutoBoy) - Cross platform (Windows, OSX, Linux/Unix, Android, iOS, Web Browsers, and Sony PSP) emulator.
...
- [GBT PLAYER ★46 ⏳1Y](https://github.com/AntonioND/gbt-player) - A music player library and converter kit for Game Boy that can be used with RGBDS.
...
- [png2gb ★11 ⏳2Y](https://github.com/LuckyLights/png2gb) - CLI tool to convert image file to game boy .c array.
...
- [Game Boy Text Tools ★4](https://github.com/raphaklaus/gameboy-text-tools) - Set of tools for text manipulation and translation of Game Boy ROMs written in NodeJS
- [mmlgb ★6](https://github.com/SimonLarsen/mmlgb) - MML to Game Boy parser and driver.
- [mgbdis ★1](https://github.com/mattcurrie/mgbdis) - Game Boy ROM disassembler with RGBDS compatible output.

#### Syntax highlighting packages

- [Atom language package for RGBASM](https://atom.io/packages/language-rgbasm) - Atom syntax highlighting for RGBDS assembly.
- [gbz80-highlight ★1](https://github.com/ISSOtm/gbz80-highlight) - Notepad++ and gedit syntax highlighting files for RGBDS assembly.
...
- [Aevilia ★20](https://github.com/ISSOtm/Aevilia-GB)
...
- [flappybird-gameboy ★2](https://github.com/pashutk/flappybird-gameboy) - Flappy Bird clone (gbdk)
- [fbgb ★1](https://github.com/gb-archive/fbgb) - Flappy Bird clone (gbdk)
...
- [Bubble Factory ★8](https://github.com/DonaldHays/bubblefactory) - *Vanilla* SDCC (no gbdk).
...
- [Tobu Tobu Girl ★113](https://github.com/SimonLarsen/tobutobugirl) - An arcade platformer for the Game Boy.
...
- [Disassembly of Tetris ★9](https://github.com/osnr/tetris) - Based on Jeff Frohwein's original disassembly.
...
- [llvm-gbz80 ★5 ⏳2Y](https://github.com/euclio/llvm-gbz80) - LLVM with a Game Boy Z80 Assembly Backend.
...
- [The Game Boy Archive - Salvage ★1](https://github.com/gb-archive/salvage) - Old articles, FAQs and various documents.
