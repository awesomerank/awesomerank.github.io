...
* [LinkedIn ★613](https://github.com/linkedin/swift-style-guide) - LinkedIn's Official Style Guide.
* [Raywenderlich ★8034](https://github.com/raywenderlich/swift-style-guide) - Raywenderlich guide, a must read.

### Third party Guides
[back to top](#readme) 

* [30 Days of Swift ★9519](https://github.com/allenwong/30DaysofSwift) - A cool 30 days tutorial.
* [About Swift ★31](https://github.com/NicolaLancellotti-About/About-Swift) - A playground about the Swift language.
...
* [SwiftGuide CN ★12515](https://github.com/ipader/SwiftGuide) - A Chinese written guide.
* [SwiftIntro ★52 ⏳1Y](https://github.com/Sajjon/SwiftIntro) - Memory game implementation that also teaches Swift.
...
* [swift-mode ★254](https://github.com/swift-emacs/swift-mode) - Emacs support, including partial flycheck error support.

### Vim
[back to top](#readme) 

* [swift-vim ★546](https://github.com/keith/swift.vim) - Vim runtime files.
* [vim-polyglot ★1658](https://github.com/sheerun/vim-polyglot) - Language pack for vim that includes vim-swift.
...
* [xcprofiler ★223](https://github.com/giginet/xcprofiler) - Command line utility to profile compilation time.
...
* [CocoaPods ★10116](https://github.com/CocoaPods/CocoaPods) - The most used dependency manager.
* [Mint ★286](https://github.com/yonaskolb/Mint) - A package manager that installs and runs Swift command line tools.
...
* [Design-Patterns-In-Swift ★9002](https://github.com/ochococo/Design-Patterns-In-Swift) - Design Patterns.
...
* [InteractivePlayground ★47 ⏳1Y](https://github.com/dasdom/InteractivePlayground) - A playground exploring the interactivity of Xcode 7.3 playgrounds.
...
* [SwagGen ★81](https://github.com/yonaskolb/SwagGen) :penguin: - A command line tool for generating a REST API from a Swagger spec based off Stencil templates.
...
* [Toybox ★66](https://github.com/giginet/Toybox) - Xcode Playground management made easy.
...
* [MLKit ★94](https://github.com/Somnibyte/MLKit) - A simple machine learning framework.
...
* [SwiftLCS ★176](https://github.com/Frugghi/SwiftLCS) :penguin: - implementation of the longest common subsequence (LCS) algorithm.

### Analytics
*Analytics related libraries to easily track your app usage* [back to top](#readme) 

* [Umbrella ★245](https://github.com/devxoul/Umbrella) - Analytics abstraction layer.
...
* [ChainPageCollectionView ★569](https://github.com/jindulys/ChainPageCollectionView) - Fancy two-level collection view layout and animation.
...
* [Pulsator ★821](https://github.com/shu223/pulsator) - Pulse animation for iOS.
...
* [Federal Data SDK ★65 ⏳1Y](https://github.com/USDepartmentofLabor/Swift-Federal-Data-SDK) - Eases access to multiple federal government OpenGov APIs.
* [GithubPilot ★50 ⏳1Y](https://github.com/jindulys/GithubPilot) - Github API V3 wrapper.
* [GooglePlacesAutocomplete ★248](https://github.com/watsonbox/ios_google_places_autocomplete) - Simple Google Places address entry for iOS.
...
* [reddift ★168](https://github.com/sonsongithub/reddift) - reddit API wrapper.
...
* [AudioPlayerSwift ★109](https://github.com/tbaranes/AudioPlayerSwift) - AudioPlayer is a simple class for playing audio (basic and advanced usage) in iOS, OS X and tvOS apps.
...
* [ARCharts ★576](https://github.com/Boris-Em/ARCharts) - Lovely Augmented Reality Charts for iOS - Built with ARKit
...
* [ARKit-Navigation ★96](https://github.com/chriswebb09/ARKitNavigationDemo) - Navigation in augmented reality with MapKit.
* [ARVoxelKit ★23](https://github.com/VoxxxelAR/ARVoxelKit) - Voxel graphic framework using ARKit
...
* [InstagramLogin ★19](https://github.com/AnderGoig/InstagramLogin) - Simple way to authenticate Instagram accounts.
...
* [SpotifyLogin ★223](https://github.com/spotify/SpotifyLogin) - Authenticate with the Spotify API.
...
* [Telegram Bot SDK ★144](https://github.com/zmeyc/telegram-bot-swift) :penguin: - Unofficial SDK.
...
* [PNChart-Swift ★1240](https://github.com/kevinzhow/PNChart-Swift) - A simple and beautiful chart lib with animation.
...
* [SwiftChart ★412](https://github.com/gpbl/SwiftChart) - A simple line and area charting library for iOS. Supports multiple series, partially filled series and touch events.
...
* [HexColor ★94](https://github.com/artman/HexColor) - Define UIColors as Hex integers.
...
* [SwiftGen-Colors ★4138](https://github.com/SwiftGen/SwiftGen#uicolor) - A tool to auto-generate Swift `enums` for your `UIColor` constants.
...
* [SwiftCLI ★200](https://github.com/jakeheis/SwiftCLI) :penguin: - A powerful framework that can be used to develop a CLI.
...
* [TextTable ★46 ⏳1Y](https://github.com/cfilipov/TextTable) - Easily print textual tables. Inspired by the Python tabulate library.
...
* [Alexander ★37 ⏳1Y](https://github.com/hodinkee/alexander) - An extremely simple JSON helper.
...
* [Brick ★53 ⏳1Y](https://github.com/hyperoslo/Brick) - A generic view model for both basic and complex scenarios.
...
* [Himotoki ★679](https://github.com/ikesyo/Himotoki) - A type-safe JSON decoding library.
...
* [Pistachio ★169 ⏳1Y](https://github.com/felixjendrusch/Pistachio) - Generic model framework.
...
* [Palau ★391](https://github.com/symentis/Palau) - Typesafe NSUserDefaults with custom rules.
...
* [MongoKitten ★320](https://github.com/OpenKitten/MongoKitten) :penguin: - MongoDB Connector.
...
* [CSVParser ★59](https://github.com/Nero5023/CSVParser) :penguin: - Fast parser for CSV.
...
* [Realm+JSON ★673](https://github.com/matthewcheok/Realm-JSON) - A concise Mantle-like way of working with Realm and JSON.

#### SQL drivers
[back to top](#readme) 

* [MySQL Swift ★99](https://github.com/novi/mysql-swift) :penguin: - MySQL client library.
* [Perfect-MySQL ★67](https://github.com/PerfectlySoft/Perfect-MySQL) :penguin: - A stand-alone wrapper around the MySQL client library, enabling access to MySQL servers.
* [Perfect-PostgreSQL ★31](https://github.com/PerfectlySoft/Perfect-PostgreSQL) :penguin: - A stand-alone wrapper around the libpq client library, enabling access to PostgreSQL servers.
...
* [SQLiteDB ★451](https://github.com/FahimF/SQLiteDB) - SQLite wrapper.
...
* [YamlSwift ★265](https://github.com/behrang/YamlSwift) - Load YAML and JSON documents.
* [Yams ★93](https://github.com/jpsim/Yams) :penguin: - Sweet YAML parser.
...
* [Chronology ★797](https://github.com/davedelong/Chronology) - Building a better date/time library.
...
* [Datify ★38](https://github.com/hemangshah/Datify) - Easypeasy date functions.
* [NSDate-Extensions ★1377 ⏳1Y](https://github.com/erica/NSDate-Extensions) - Practical real-world dates.
* [Punctual.swift ★321 ⏳1Y](https://github.com/harlanhaskins/Punctual.swift) :penguin: - Date handler.
...
* [Dip ★582](https://github.com/AliSoftware/Dip) - A simple Dependency Injection Container.
...
* [Device.swift ★126](https://github.com/schickling/Device.swift) - Super-lightweight library to detect used device.
...
* [Hedwig ★951](https://github.com/onevcat/Hedwig) :penguin: - Send email to any SMTP server like a boss.
...
* [SwiftyGPIO ★652](https://github.com/uraimo/SwiftyGPIO) :penguin: - Interact with Linux GPIO/SPI/PWM on ARM.
...
* [Caravel ★136](https://github.com/coshx/caravel) - Event bus for UIWebView and JS.
* [EmitterKit ★522](https://github.com/aleclarson/emitter-kit) - Implementation of event emitters and listeners.
...
* [ReactorKit ★847](https://github.com/ReactorKit/ReactorKit) - A framework for reactive and unidirectional application architecture.
...
* [Signals ★279](https://github.com/artman/Signals) - Replaces delegates and notifications.
...
* [PathKit ★895](https://github.com/kylef/PathKit) :penguin: - Effortless path operations.
...
* [SwipyCell ★131](https://github.com/moritzsternemann/SwipyCell) - UITableViewCell implementing swiping to trigger actions (known from the Mailbox App).
...
* [RxBluetoothKit ★676](https://github.com/polidea/RxBluetoothKit) - iOS & OSX Bluetooth library for RxSwift.
...
* [QRCodeReader.swift ★724](https://github.com/yannickl/QRCodeReader.swift) - Simple QRCode reader.
...
* [AXPhotoViewer ★260](https://github.com/alexhillc/AXPhotoViewer) - An iPhone/iPad photo gallery viewer, useful for viewing a large (or small!) number of photos.
...
* [Filterpedia ★1721](https://github.com/FlexMonkey/Filterpedia) - Core image filter.
...
* [LetterAvatarKit ★51](https://github.com/vpeschenkov/LetterAvatarKit) - A UIImage extension that generates letter-based avatars.
...
* [PassportScanner ★247](https://github.com/evermeer/PassportScanner) - Scan the MRZ code of a passport and extract the first name, last name, passport number, nationality, date of birth, expiration date and personal number.
* [Sharaku ★1288](https://github.com/makomori/Sharaku) - Image filtering UI library like Instagram.
* [Snowflake ★814](https://github.com/onmyway133/Snowflake) - Work with SVG.
* [SwiftGen-Assets ★4138](https://github.com/SwiftGen/SwiftGen#assets-catalogs) - A tool to auto-generate `enums` for all your `UIImages` from your Assets Catalogs.
...
* [WDImagePicker ★84](https://github.com/justwudi/WDImagePicker) - Image picker with customizable crop rectangle (getting update).
...
* [IHKeyboardAvoiding ★1084](https://github.com/IdleHandsApps/IHKeyboardAvoiding) - An elegant solution for keeping any UIView visible when the keyboard is being shown. No UIScrollView required.
...
* [C4iOS ★861](https://github.com/C4Labs/C4iOS) - Harnesses the power of native iOS programming with a simplified API.

### Layout
*Libs to help you with layout.* [back to top](#readme) 

* [BrickKit ★575](https://github.com/wayfair/brickkit-ios) - Create complex and responsive layouts in a simple way.
* [FlexLayout ★194](https://github.com/layoutBox/FlexLayout) - Nice and clean interface to the highly optimized Facebook yoga Flexbox implementation.
* [JustUiKit ★34](https://github.com/lfkdsk/JustUiKit) - iOS UI Kit With Android-Style. It is designed to make Android developers build iOS UI easily.
...
* [Cassowary ★85](https://github.com/tribalworldwidelondon/CassowarySwift) - A linear constraint solving library using the same algorithm as AutoLayout.
...
* [KVConstraintKit ★82](https://github.com/keshavvishwkarma/KVConstraintKit) - An Impressive Autolayout DSL for iOS, tvOS & OSX.
...
* [L10n-swift ★47](https://github.com/Decybel07/L10n-swift) - Localization of an application with ability to change language "on the fly" and support for plural forms in any language.
...
* [SwiftGen-L10n ★4138](https://github.com/SwiftGen/SwiftGen#localizablestrings) - A tool to auto-generate `enums` for all your Localizable.strings keys (with appropriate associated values if those strings contains printf-format placeholders like `%@`).
...
* [Printer ★45](https://github.com/hemangshah/printer) - A fancy logger for your next app.
...
* [ArcKit ★933](https://github.com/sobri909/ArcKit) - A location and activity recording framework for iOS.
...
* [BigInt ★345](https://github.com/attaswift/BigInt) - Arbitrary-precision arithmetic.
* [DDMathParser ★690](https://github.com/davedelong/DDMathParser) - DDMathParser makes it easy to parse a String and evaluate it as a mathematical expression.
...
* [swix ★536](https://github.com/stsievert/swix) - A general matrix language.
* [Upsurge ★128](https://github.com/aleph7/Upsurge) - Simple and fast matrix and vector math.

### Natural Language Processing
[back to top](#readme) 

* [CoreLinguistics ★62](https://github.com/rxwei/CoreLinguistics) - Natural Language Processing (NLP) toolkit.
...
* [NEKit ★1708](https://github.com/zhuhaow/NEKit) - A toolkit for Network Extension Framework.
...
* [Reachability.swift ★4535](https://github.com/ashleymills/Reachability.swift) - A replacement for Apple's Reachability with closures.
...
* [ShadowsocksX-NG ★8722](https://github.com/shadowsocks/ShadowsocksX-NG) - A fast tunnel proxy that helps you bypass firewalls.
...
* [SwiftSoup ★551](https://github.com/scinfu/SwiftSoup) :penguin: - HTML Parser, with best of DOM, CSS, and jquery.
...
* [Perfect-Notifications ★55](https://github.com/PerfectlySoft/Perfect-Notifications) - iOS Notifications for Linux and OS X.

#### Socket
[back to top](#readme) 

* [BlueSocket ★584](https://github.com/IBM-Swift/BlueSocket) :penguin: - IBM's low level socket framework.
...
* [Ambassador ★50](https://github.com/envoy/Ambassador) - Super lightweight web framework based on SWSGI.
...
* [Embassy ★141](https://github.com/envoy/Embassy) :penguin: - Super lightweight async HTTP server library.
...
* [SwiftyHTTP ★109](https://github.com/AlwaysRightInstitute/SwiftyHTTP) - A simple GCD based HTTP client and server.
...
* [Unreachable ★88](https://github.com/nvzqz/Unreachable) :penguin: - Unreachable code path optimization hint.
...
* [UXMPDFKit ★165](https://github.com/uxmstudio/UXMPDFKit) - A PDF viewer and annotator that can be embedded in iOS applications.
...
* [Siphash ★199](https://github.com/attaswift/SipHash) - Simple and secure hashing with the SipHash algorithm.
...
* [keychain-swift ★873](https://github.com/evgenyneu/keychain-swift) - Helper functions for saving text in Keychain securely for iOS, OS X, tvOS and watchOS.
...
* [Live ★1993](https://github.com/ltebean/Live) - Demonstrate how to build a live broadcast app.

### Styling
[back to top](#readme) 

* [Stylist ★81](https://github.com/yonaskolb/Stylist) - Define UI styles in a hot-loadable external yaml or json file.
* [SwiftTheme ★991](https://github.com/jiecao-fm/SwiftTheme) - Powerful theme/skin manager for iOS 8+.
...
* [SystemKit ★126](https://github.com/beltex/SystemKit) - OS X system library.
...
* [Spectre ★285](https://github.com/kylef/Spectre) :penguin: - BDD Framework.
...
* [Mockingjay ★927](https://github.com/kylef/Mockingjay) - An elegant library for stubbing HTTP requests with ease.
* [Mockit ★62](https://github.com/sabirvirtuoso/Mockit) - A simple mocking framework, inspired by the famous Mockito for Java.
* [SwiftMock ★221 ⏳1Y](https://github.com/mflint/SwiftMock) - A mocking framework.
...
* [edhita ★908](https://github.com/tnantoka/edhita) - Fully open source text editor for iOS.
* [Format ★1150](https://github.com/marmelroy/Format) - Formatting kit for numbers, addresses and colors.
* [Markdown ★71 ⏳1Y](https://github.com/crossroadlabs/Markdown) :penguin: - Markdown templates for Swift. Based on Discount library (a library used deep down by GitHub markdown).
...
* [MarkyMark ★69](https://github.com/M2Mobi/Marky-Mark) - Converts Markdown into native views or attributed strings.
* [Mustard ★668 ⏳1Y](https://github.com/mathewsanders/Mustard) - Library for tokenizing strings when splitting by whitespace doesn't cut it.
...
* [SyntaxKit ★426](https://github.com/soffes/SyntaxKit) - TextMate-style syntax highlighting.
...
* [AwaitKit ★335](https://github.com/yannickl/AwaitKit) - The ES7 Async/Await control flow.
...
* [Each ★740](https://github.com/dalu93/Each) - Each is a NSTimer bridge library.
* [EKI ★36](https://github.com/kodlian/Eki) - Make Grand Central Dispatch easy and fun to use (queue, task, group, timer and semaphore).
...
* [BulletinBoard ★2210](https://github.com/alexaubry/BulletinBoard) - Generates and manages contextual cards displayed at the bottom of the screen.
...
* [CustomSegue ★73](https://github.com/phimage/CustomSegue) - Custom segue for OSX Storyboards with slide and cross fade effects.
* [DeckTransition ★1636](https://github.com/HarshilShah/DeckTransition) - A library to recreate the iOS 10 Apple Music now playing transition.
...
* [Element ★790](https://github.com/eonist/Element) - Programmatic UI framework for macOS.
* [Elissa ★134](https://github.com/KitchenStories/Elissa) - Displays a notification on top of a UITabBarItem or any UIView anchor view to reveal additional information.
...
* [FAQView ★366](https://github.com/mukeshthawani/faqview) - An easy to use FAQ view for iOS.
...
* [GMStepper ★578](https://github.com/gmertk/GMStepper) - A stepper with a sliding label in the middle.
* [GRMustache ★419](https://github.com/groue/GRMustache.swift) - Flexible Mustache templates.
...
* [MantleModal ★66](https://github.com/canalesb93/MantleModal) - A simple modal resource that uses a UIScrollView to allow the user to close the modal by dragging it down.
...
* [MaterialKit ★2527](https://github.com/nghialv/MaterialKit) - Material design components.
* [MediaBrowser ★273](https://github.com/younatics/MediaBrowser) - Simple iOS photo and video browser with optional grid view, captions and selections.
...
* [MXParallaxHeader ★1099](https://github.com/maxep/MXParallaxHeader) - Simple parallax header for UIScrollView.
...
* [Sonar ★102](https://github.com/thefuntasty/Sonar) - Cool radar-style view.
...
* [TouchVisualizer ★565](https://github.com/morizotter/TouchVisualizer) - Lightweight touch visualization library with a single line of code.
* [Twinkle ★447](https://github.com/piemonte/Twinkle) - Easy way to make elements in your iOS app twinkle.
* [UIDropDown ★63](https://github.com/igongora/UIDropDown) - An elegant dropdown for iOS.
...
* [URLEmbeddedView ★428](https://github.com/marty-suzuki/URLEmbeddedView) - Automatically caches the object that is confirmed the Open Graph Protocol, and displays it as URL embedded card.
* [URWeatherView ★336](https://github.com/jegumhon/URWeatherView) - Show weather effects onto a view.
* [Wallet ★238](https://github.com/rshevchuk/Wallet) - A replica of the Apple's Wallet interface. Add, delete or present your cards and passes.
...
* [GoogleWearAlert ★443 ⏳1Y](https://github.com/AshRobinson/GoogleWearAlert) - Google Wear Alert style.
...
* [HYAlertController ★58 ⏳1Y](https://github.com/castial/HYAlertController) - A simple and minimalist iOS AlertController.
...
* [SuperDelegate ★391](https://github.com/Square/SuperDelegate) - SuperDelegate provides a clean application delegate interface and protects you from bugs in the application lifecycle.

#### Blur
[back to top](#readme) 

* [Blurable ★824](https://github.com/FlexMonkey/Blurable) - Apply a Gaussian Blur to any UIView with Protocol Extensions.
* [PCLBlurEffectAlert ★129](https://github.com/hryk224/PCLBlurEffectAlert) - AlertController with UIVisualeffectview.
* [VisualEffectView ★459](https://github.com/efremidze/VisualEffectView) - UIVisualEffectView subclass with tint color.
...
* [CRNetworkButton ★622 ⏳1Y](https://github.com/Cleveroad/CRNetworkButton) - Send Button for iOS.
* [DOFavoriteButton ★2939](https://github.com/okmr-d/DOFavoriteButton) - Cute Animated Button.
* [Floaty ★607](https://github.com/kciter/Floaty) - Floating Action Button for iOS.
* [Hamburger button transition ★2226 ⏳1Y](https://github.com/robb/hamburger-button) - Hamburger button transition.
* [HamburgerButton ★188 ⏳1Y](https://github.com/fastred/HamburgerButton) - Hamburger button with a slick animation.
* [LGButton ★1527](https://github.com/loregr/LGButton) - A fully customisable subclass of the native UIControl which allows you to create beautiful buttons without writing any line of code.
* [LTHRadioButton ★196](https://github.com/rolandleth/LTHRadioButton) - A radio button with a pretty animation.
* [MIBadgeButton ★293](https://github.com/mustafaibrahim989/MIBadgeButton-Swift) - Notification badge for UIButtons.
* [MultiToggleButton ★29](https://github.com/yonat/MultiToggleButton) - A UIButton subclass that implements tap-to-toggle button text (like the camera flash and timer buttons).
* [NFDownloadButton ★282](https://github.com/LeonardoCardoso/NFDownloadButton) - Revamped Download Button. It's kinda a reverse engineering of Netflix's app download button.
...
* [CalendarKit ★797](https://github.com/richardtop/CalendarKit) - Fully customizable calendar day view.
* [DateTimePicker ★1299](https://github.com/itsmeichigo/DateTimePicker) - A nicer iOS UI component for picking date and time.
* [JTAppleCalendar ★4048](https://github.com/patchthecode/JTAppleCalendar) - UI calendar handler.
* [Karmadust ★108](https://github.com/mmick66/CalendarView) - Unidirectional Calendar Component with Native Events Support.
* [Koyomi ★507](https://github.com/shoheiyokoyama/Koyomi) - Simple customizable calendar component.
* [Workaholic ★64](https://github.com/hemangshah/Workaholic) - A GitHub-like work contribution timeline.

#### Form
[back to top](#readme) 

* [Eureka ★7416](https://github.com/xmartlabs/Eureka) - Elegant iOS form builder.
* [Former ★953](https://github.com/ra1028/Former) - A fully customizable library for easy creating UITableView based form.
* [SwiftForms ★1140](https://github.com/ortuman/SwiftForms) - Forms are now easy as 1-2-3.
* [SwiftyFORM ★722](https://github.com/neoneye/SwiftyFORM) - Forms that can be validated.

#### HUD
[back to top](#readme) 

* [EZLoadingActivity ★528](https://github.com/goktugyil/EZLoadingActivity) - Lightweight loading activity HUD.
* [HUDKit ★62 ⏳1Y](https://github.com/cockscomb/HUDKit) - HUD interface as UIPresentationController.
* [KRProgressHUD ★240](https://github.com/krimpedance/KRProgressHUD) - A beautiful and customizable progress HUD.
* [PKHUD ★2626](https://github.com/pkluz/PKHUD) - Reimplementation of the Apple HUD.

#### Label
[back to top](#readme) 

* [ActiveLabel ★2077](https://github.com/optonaut/ActiveLabel.swift) - UILabel drop-in replacement supporting Hashtags (#), Mentions (@) and URLs (http://).
* [CharacterText ★337 ⏳1Y](https://github.com/hulsizer/CharacterText) - Perform fx on UILabel.
* [CountdownLabel ★348](https://github.com/suzuki-0000/CountdownLabel) - Simple countdown UILabel with morphing animation, and some useful function.
* [FloatLabelFields ★1061](https://github.com/FahimF/FloatLabelFields) - Text entry controls which contain a built-in title/label so that you don't have to add a separate title for each field.
* [GlitchLabel ★693](https://github.com/kciter/GlitchLabel) - Glitching UILabel for iOS.
...
* [LTMorphingLabel ★6063](https://github.com/lexrus/LTMorphingLabel) - Graceful morphing effects for UILabel.
* [NumberMorphView ★1329](https://github.com/me-abhinav/NumberMorphView) - A label view for displaying numbers which can transition or animate using a technique called number tweening or number morphing.
...
* [Translucid ★525](https://github.com/Ekhoo/Translucid) - Lightweight library to set an Image as text background.
* [TriLabelView ★113](https://github.com/mukeshthawani/TriLabelView) - A triangle shaped corner label view for iOS.

#### Menu
[back to top](#readme) 

* [AKSwiftSlideMenu ★197](https://github.com/ashishkakkad8/AKSwiftSlideMenu) - Slide Menu (Drawer).
* [ENSwiftSideMenu ★1715](https://github.com/evnaz/ENSwiftSideMenu) - Sliding side menu.
* [FanMenu ★225](https://github.com/exyte/fan-menu) - Menu with a circular layout based on Macaw.
* [FlowingMenu ★762](https://github.com/yannickl/FlowingMenu) - Interactive view transition to display menus with flowing and bouncing effects.
* [FrostedSidebar ★435](https://github.com/edekhayser/FrostedSidebar) - Hamburger Menu and iOS 8 API's.
* [GuillotineMenu ★2579](https://github.com/Yalantis/GuillotineMenu) - Guillotine style menu.
* [HHFloatingView ★32](https://github.com/hemangshah/HHFloatingView) - An easy to use and setup floating view for your app.
* [InteractiveSideMenu ★347](https://github.com/handsomecode/InteractiveSideMenu) - Customizable iOS Interactive Side Menu.
* [KWDrawerController ★56](https://github.com/Kawoou/KWDrawerController) - Drawer view controller that easy to use.
* [MediumMenu ★299](https://github.com/pixyzehn/MediumMenu) - A menu based on Medium iOS app.
* [MenuItemKit ★335](https://github.com/cxa/MenuItemKit) - `UIMenuItem` with image and block (closure) support.
* [Pagemenu ★4464](https://github.com/PageMenu/PageMenu) - Pagination enabled view controller.
* [PagingKit ★554](https://github.com/kazuhiro4949/PagingKit) - PagingKit provides customizable menu UI
...
* [CHIPageControl ★1643](https://github.com/ChiliLabs/CHIPageControl) - A set of cool animated page controls to replace boring UIPageControl.
* [Pageboy ★901](https://github.com/uias/Pageboy) - A simple, highly informative page view controller.
* [PageController ★209](https://github.com/hirohisa/PageController) - Infinite paging controller.
* [PageControls ★645](https://github.com/popwarsweet/PageControls) - Custom UIPageControl.
...
* [AREK ★798](https://github.com/ennioma/arek) - AREK is a clean and easy to use wrapper over any kind of iOS permission.
* [Permission ★2299](https://github.com/delba/Permission) - A unified API to ask for permissions on iOS.
* [PermissionScope ★4663](https://github.com/nickoneill/PermissionScope) - A Periscope-inspired way to ask for iOS permissions.

#### StackView
[back to top](#readme) 

* [StackViewController ★627](https://github.com/seedco/StackViewController) - Simplify the use of UIStackView.
* [TZStackView ★1142](https://github.com/tomvanzummeren/TZStackView) - An iOS9 UIStackView layout component re-implemented for iOS 7 and 8.

#### Switch
[back to top](#readme) 

* [AIFlatSwitch ★649](https://github.com/cocoatoucher/AIFlatSwitch) - Flat animated switch.
* [LTJelloSwitch ★363 ⏳2Y](https://github.com/lexrus/LTJelloSwitch) - UISwitch prototype.
* [Switch ★77](https://github.com/T-Pham/Switch) - A switch control with full Interface Builder support.
...
* [HHTabBarView ★47](https://github.com/hemangshah/HHTabBarView) - A lightweight customized tab bar view.
...
* [Stencil ★1235](https://github.com/kylef/Stencil) - Simple and powerful template language.
* [SwiftCssParser ★234](https://github.com/100mango/SwiftCssParser) - Extensible CSS parser.
* [TemplateKit ★130 ⏳1Y](https://github.com/mcudich/TemplateKit) - React-inspired framework for building component-based user interfaces.

#### TextField
[back to top](#readme) 

* [CBPinEntryView ★33](https://github.com/Fawxy/CBPinEntryView) - Easy to use, very customisable pin entry.
* [DTTextField ★81](https://github.com/iDhaval/DTTextField) - DTTextField is a custom textfield with floating placeholder and error label.
* [HTYTextField ★226](https://github.com/hanton/HTYTextField) - A UITextField with bouncy placeholder.
* [PasswordTextField ★149](https://github.com/PiXeL16/PasswordTextField) - A custom TextField with a switchable icon which shows or hides the password and enforces good password policies.
* [SkyFloatingLabelTextField ★2334](https://github.com/Skyscanner/SkyFloatingLabelTextField) - A beautiful and flexible text field control implementation of "Float Label Pattern".
...
* [TextFieldEffects ★4354](https://github.com/raulriera/TextFieldEffects) - Several ready to use effects for UITextFields.
* [UITextField-Navigation ★345](https://github.com/T-Pham/UITextField-Navigation) - UITextField-Navigation adds next, previous and done buttons to the keyboard for your UITextFields. Highly customizable.
...
* [MusicPlayerTransition ★448](https://github.com/xxxAIRINxxx/MusicPlayerTransition) - Custom interactive transition like Apple Music iOS App.
* [PinterestSwift ★1601](https://github.com/demonnico/PinterestSwift) - Pinterest style transition.
...
* [SendIndicator ★37](https://github.com/LeonardoCardoso/SendIndicator) - Yet another task indicator.
* [StarWars.iOS ★3050](https://github.com/Yalantis/StarWars.iOS) - Transition animation to crumble view-controller into tiny pieces.
...
* [TransitionManager ★197](https://github.com/cemolcay/TransitionManager) - Painless custom transitioning. Easy extend, easy setup, just focus on animations.

#### UICollectionView
[back to top](#readme) 

* [BouncyLayout ★2756](https://github.com/roberthein/BouncyLayout) - Collection view layout that makes your cells bounce.
* [CardsLayout ★316](https://github.com/filletofish/CardsLayout) - Nice card-designed custom CollectionView layout.
...
* [CollectionViewShelfLayout ★225](https://github.com/pitiphong-p/CollectionViewShelfLayout) - A UICollectionViewLayout subclass displays its items as rows of items similar to the App Store Feature tab without a nested UITableView/UICollectionView hack.
...
* [GravitySlider ★76](https://github.com/ApplikeySolutions/GravitySlider) - Beautiful alternative to the standard UICollectionView flow layout.
* [RAReorderableLayout ★793](https://github.com/ra1028/RAReorderableLayout) - A UICollectionView layout which can move an item with drag and drop.
* [ReplaceAnimation ★819 ⏳1Y](https://github.com/fruitcoder/ReplaceAnimation) - Pull-to-refresh animation in UICollectionView with a sticky header flow layout.
* [Sapporo ★232 ⏳1Y](https://github.com/nghialv/Sapporo) - A cellmodel-driven CollectionView manager.
* [ShelfView-iOS ★200](https://github.com/tdscientist/ShelfView-iOS) - iOS custom view to display books on shelf.
...
* [AZTableViewController ★41](https://github.com/AfrozZaheer/AZTableViewController) - Elegant and easy way to integrate pagination with placeholder views.
* [DTTableViewManager ★318](https://github.com/DenHeadless/DTTableViewManager) - Protocol-oriented UITableView management, powered by generics and associated types.
* [ExpandableCell ★193](https://github.com/younatics/ExpandableCell) - Fully refactored YNExapnadableCell with more concise, bug free. Easiest usage of expandable & collapsible cell for iOS. You can customize expandable UITableViewCell whatever you like. ExpandableCell is made because insertRows and deleteRows is hard to use. Just inheirt ExpandableDelegate
...
* [folding-cell ★6770](https://github.com/Ramotion/folding-cell) - Folding cell transition.
* [GridView ★570](https://github.com/KyoheiG3/GridView) - Can be customized as a time table, spreadsheet, paging and more.
* [Hakuba ★490 ⏳1Y](https://github.com/nghialv/Hakuba) - A new way to manage UITableView without the code of UITableViewDelegate and UITableViewDataSource.
* [HGPlaceholders ★978](https://github.com/HamzaGhazouani/HGPlaceholders) - Nice library to show placeholders and Empty States for any UITableView/UICollectionView in your project.
* [ParallaxHeader ★381](https://github.com/romansorochak/ParallaxHeader) - Simple way to add parallax header to UIScrollView/UITableView.
* [Persei ★2873](https://github.com/Yalantis/Persei) - Animated top menu for UITableView / UICollectionView / UIScrollView.
* [PullToRefreshSwift ★494](https://github.com/dekatotoro/PullToRefreshSwift) - PullToRefresh library.
* [ReverseExtension ★1172](https://github.com/marty-suzuki/ReverseExtension) - UITableView extension that enables the insertion of cells the from bottom of a table view.
* [SectionScrubber ★145](https://github.com/bakkenbaeck/SectionScrubber) - A component to quickly scroll between collection view sections.
* [Shoyu ★262](https://github.com/yukiasai/Shoyu) - Easier way to represent the structure of UITableView.
* [SwipeCellKit ★2633](https://github.com/SwipeCellKit/SwipeCellKit) - Swipeable UITableViewCell based on the stock Mail.app.
* [YNExpandableCell ★340](https://github.com/younatics/YNExpandableCell) - Awesome expandable, collapsible tableview cell for iOS.

#### Walkthrough
[back to top](#readme) 

* [AwesomeSpotlightView ★53](https://github.com/aleksandrshoshiashvili/AwesomeSpotlightView) - Create tutorial or coach tour.
* [BWWalkthrough ★2517](https://github.com/ariok/BWWalkthrough) - A class to build custom walkthroughs for your iOS App.
* [Gecco ★1589](https://github.com/yukiasai/Gecco) - Spotlight view for iOS.
* [Instructions ★3042](https://github.com/ephread/Instructions) - A library to create app walkthroughs and guided tours.
* [RazzleDazzle ★2873](https://github.com/IFTTT/RazzleDazzle) - A simple keyframe-based animation framework for iOS. Perfect for scrolling app intros.
* [SwiftyOnboard ★607](https://github.com/juanpablofernandez/SwiftyOnboard) - An iOS framework that allows developers to create beautiful onboarding experiences.
* [SwiftyWalkthrough ★212](https://github.com/ruipfcosta/SwiftyWalkthrough) - The easiest way to create a great walkthrough experience in your apps.
...
* [AlexaSkillsKit ★120](https://github.com/choefele/AlexaSkillsKit) - Develop custom Alexa Skills.
* [ArrayDiff ★91 ⏳1Y](https://github.com/Adlai-Holler/ArrayDiff) - A fast, UITableView/UICollectionView-compatible array diffing microframework.
* [Basis ★310 ⏳1Y](https://github.com/typelift/Basis) - Pure Declarative Programming.
...
* [CallbackURLKit ★200](https://github.com/phimage/CallbackURLKit) - Implementation of x-callback-url (Inter app communication).
...
* [Curry ★376](https://github.com/thoughtbot/Curry) - Function currying.
* [Dollar ★3772](https://github.com/ankurp/Dollar) - Similar to Lo-Dash or Underscore in Javascript.
* [ExSwift ★3338 ⏳1Y](https://github.com/pNre/ExSwift) - Extensions for standard types and classes.
* [EZSwiftExtensions ★2307](https://github.com/goktugyil/EZSwiftExtensions) - How standard types and classes were supposed to work.
...
* [Focus ★148](https://github.com/typelift/Focus) - Optics library (includes Lens, Prisms, and Isos) that is inspired by Haskell's Lens library.
...
* [LifetimeTracker ★1425](https://github.com/krzysztofzablocki/LifetimeTracker) - Surface retain cycle / memory issues right as you develop your application.
...
* [Pythonic.swift ★518 ⏳1Y](https://github.com/practicalswift/Pythonic.swift) - Selected parts of Python standard library.
* [R.swift ★4424](https://github.com/mac-cain13/R.swift) - Tool to get strong typed, autocompleted resources like images, cells and segues.
* [RandomKit ★1264](https://github.com/nvzqz/RandomKit) :penguin: - Random data generation.
* [ReactiveArray ★55 ⏳1Y](https://github.com/Wolox/ReactiveArray) - An array class that can be observed using ReactiveCocoa's Signals.
* [ReadabilityKit ★630](https://github.com/exyte/ReadabilityKit) - Preview extractor for news, articles and full-texts.
* [ResourceKit ★66](https://github.com/bannzai/ResourceKit) - Enable autocomplete use resources.
* [Result ★1909](https://github.com/antitypical/Result) - Type modelling the success/failure of arbitrary operations.
* [Runes ★673](https://github.com/thoughtbot/Runes) - Functional operators: flatMap, map, apply.
...
* [Solar ★138](https://github.com/ceeK/Solar) - Calculate sunrise and sunset times given a location.
* [SpriteKit+Spring ★163](https://github.com/ataugeron/SpriteKit-Spring) - SpriteKit API reproducing UIView's spring animations with SKAction.
* [Sugar ★894](https://github.com/hyperoslo/Sugar) - Something sweet that goes great with your Cocoa.
...
* [SwifterSwift ★4186](https://github.com/SwifterSwift/SwifterSwift) - A handy collection of more than 500 native Swift 3 extensions to boost your productivity. 
* [SwiftGen-Storyboard ★4138](https://github.com/SwiftGen/SwiftGen#uistoryboard) - A tool to auto-generate `enums` for all your Storyboards, Scenes and Segues constants + appropriate convenience accessors.
* [SwiftLinkPreview ★753](https://github.com/LeonardoCardoso/SwiftLinkPreview) - It makes a preview from an url, grabbing all information such as title, relevant texts and images.
* [SwiftRandom ★471](https://github.com/thellimist/SwiftRandom) - A tiny generator of random data.
* [SwiftRater ★53](https://github.com/takecian/SwiftRater) - A utility that reminds your iPhone app's users to review the app.
...
* [SwiftTweaks ★1042](https://github.com/khan/swifttweaks) - Tweak your iOS app without recompiling.
* [Swiftx ★183](https://github.com/typelift/Swiftx) - Functional data types and functions for any project.
* [SwiftyStateMachine ★324](https://github.com/macoscope/SwiftyStateMachine) - Framework for creating state machines.
* [SwiftyUtils ★200](https://github.com/tbaranes/SwiftyUtils) - All the reusable code that we need in each project.
...
* [WhatsNew ★1230](https://github.com/BalestraPatrick/WhatsNew) - Showcase new features after an app update similar to Pages, Numbers and Keynote.
...
* [FormValidatorSwift ★461](https://github.com/ustwo/formvalidator-swift) - Allows you to validate inputs of text fields and text views in a convenient way.
* [Honour ★50 ⏳1Y](https://github.com/jeanpimentel/Honour) - Simple and powerful Validation Library.
* [Input Mask ★123](https://github.com/RedMadRobot/input-mask-ios) - Pattern-based user input formatter, parser and validator for iOS.
* [SwiftValidator ★986](https://github.com/SwiftValidatorCommunity/SwiftValidator) - A rule-based validation library.
* [SwiftValidators ★130](https://github.com/gkaimakas/SwiftValidators) - String validation for iOS (inspired by validator.js).
* [Validator ★952](https://github.com/adamwaite/Validator) - Drop in user input validation for your iOS apps.

#### Phone Numbers
[back to top](#readme) 

* [PhoneNumberKit ★2178](https://github.com/marmelroy/PhoneNumberKit) - Framework for parsing, formatting and validating international phone numbers. Inspired by Google's libphonenumber.

### Version Manager
[back to top](#readme) 

* [AppVersionMonitor ★224](https://github.com/eure/AppVersionMonitor) - Monitor iOS app version easily.
* [Siren ★2284](https://github.com/ArtSabintsev/Siren) - Notify users when a new version of your app is available and prompt them to upgrade.
* [Version ★94](https://github.com/mrackwitz/Version) - Version represents and compares semantic versions.
* [Version Tracker Swift ★57](https://github.com/tbaranes/VersionTrackerSwift) - Versions tracker for your iOS, OS X, and tvOS app.
* [Version Update ★4 ⏳1Y](https://github.com/tenric/VersionUpdate) - Check and update app's version for both AppStore & Fir.
* [Versions ★184 ⏳1Y](https://github.com/zenangst/Versions) - Helping you find inner peace when comparing version numbers.
* [VersionsTracker ★22](https://github.com/martnst/VersionsTracker) - Versions tracker keeping track of os and app version installation history including dates.

### Video
[back to top](#readme) 

* [BMPlayer ★843](https://github.com/BrikerMan/BMPlayer) - A video player for iOS, based on AVPlayer, support the horizontal, vertical screen. support adjust volume, brigtness and seek by slide.
* [MMPlayerView ★425](https://github.com/MillmanY/MMPlayerView) - Custom AVPlayerLayer on view and transition player with good effect like YouTube and Facebook.
...
* [Player ★975](https://github.com/piemonte/Player) - iOS video player, simple drop in component for playing and streaming media.
* [PlayerView ★96 ⏳1Y](https://github.com/davidlondono/PlayerView) - Easy to use video player using a UIView, manage rate of reproduction, screenshots and callbacks-delegate for player state.
* [PryntTrimmerView ★111](https://github.com/prynt/PryntTrimmerView) - Trim and crop videos.
* [SwiftVideoBackground ★92](https://github.com/dingwilson/SwiftVideoBackground) - Easy to Use UIView subclass for implementating a video background.
* [VGPlayer ★201](https://github.com/VeinGuo/VGPlayer) - A simple iOS video player, support play local and network, background playback mode, automatic caching while playing.
---
<p align="center">
	This list is a copy of <a href="https://github.com/matteocrippa/awesome-swift">matteocrippa/awesome-swift</a> with ranks
</p>
