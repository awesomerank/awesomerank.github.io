...
### EHR
  ...
  * [Odoo Medical ★118](https://github.com/OCA/vertical-medical) - Universal Health and Hospital Information System.
...
### Frameworks
  ...
  * [CareKit ★1332](https://github.com/carekit-apple/CareKit) - CareKit is an open source software framework for creating apps that help people better understand and manage their health.
  ...
  * [Intervention Engine FHIR Server ★45](https://github.com/intervention-engine/fhir) - Generic FHIR server implementation in GoLang.
  * [Opal](http://opal.openhealthcare.org.uk/) - Framework for building clinical applications.
  * [ResearchKit ★4841](https://github.com/ResearchKit/ResearchKit) - Software framework that makes it easy to create apps for medical research or for other research projects.
  * [Spark ★75](https://github.com/furore-fhir/spark) - FHIR server.
  * [Swift-SMART ★45](https://github.com/smart-on-fhir/Swift-SMART) - Swift SMART on FHIR framework for iOS and OS X.

### Libraries
  * [FHIR .NET API ★174](https://github.com/ewoutkramer/fhir-net-api) - The official .NET API for HL7 FHIR.
  * [fhir.js ★86](https://github.com/FHIR/fhir.js) - JavaScript client for FHIR.
  * [HAPI FHIR ★382](https://github.com/jamesagnew/hapi-fhir) - Java API for HL7 FHIR Clients and Servers.
...
### Hardware
  ...
  * [MobilECG II ★305](https://github.com/xdever/MobilECG-II) - Clinical grade Holter ECG.
...
### Bioinformatics
  * [ADAM ★620](https://github.com/bigdatagenomics/adam) - Genomics analysis platform.
  * [Bcbio ★434](https://github.com/chapmanb/bcbio-nextgen) - Validated, scalable, community developed variant calling, RNA-seq and small RNA analysis.
...
### Data
  ...
  * [Synthea Patient Generator ★33](https://github.com/synthetichealth/synthea) - Synthetic patient generator that models the medical history of synthetic patients.

### Datasets
  * [Medical Data for Machine Learning ★624](https://github.com/beamandrew/medical-data) - A curated list of medical data for machine learning.
