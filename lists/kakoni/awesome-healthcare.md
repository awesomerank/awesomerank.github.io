...
---
# Awesome Health [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
...
### EHR
  ...
  * [EHRServer ★42](ppazos/cabolabs-ehrserver) - Generic, minimal, standards-based, service-oriented, openEHR clinical data storage.
  ...
  * [Odoo Medical ★118](OCA/vertical-medical) - Universal Health and Hospital Information System.
  ...
  * [openMAXIMS ★38](IMS-MAXIMS/openMAXIMS) - Full Patient Administration System designed for the NHS.
...
### Frameworks
  * [API Server ★75](smart-on-fhir/api-server) - FHIR Server to support patient and clinician-facing apps.
  * [C3-PRO-Server](https://github.com/chb/c3-pro-server) - Highly reliable and scalable FHIR compliant web server.
  * [CareKit ★1332](carekit-apple/CareKit) - CareKit is an open source software framework for creating apps that help people better understand and manage their health.
  ...
  * [Intervention Engine FHIR Server ★45](intervention-engine/fhir) - Generic FHIR server implementation in GoLang.
  * [Opal](http://opal.openhealthcare.org.uk/) - Framework for building clinical applications.
  * [ResearchKit ★4841](ResearchKit/ResearchKit) - Software framework that makes it easy to create apps for medical research or for other research projects.
  * [Spark ★75](furore-fhir/spark) - FHIR server.
  * [Swift-SMART ★45](smart-on-fhir/Swift-SMART) - Swift SMART on FHIR framework for iOS and OS X.

### Libraries
  * [FHIR .NET API ★174](ewoutkramer/fhir-net-api) - The official .NET API for HL7 FHIR.
  * [fhir.js ★86](FHIR/fhir.js) - JavaScript client for FHIR.
  * [HAPI FHIR ★382](jamesagnew/hapi-fhir) - Java API for HL7 FHIR Clients and Servers.
  * [Health data standards ★76](projectcypress/health-data-standards) - Ruby library for generating and consuming various healthcare related formats. These include HITSP C32, QRDA Category I, and QRDA Category III.
  * [MITK](http://mitk.org/wiki/MITK) - The Medical Imaging Interaction Toolkit.
  * [Node HL7 ★5](MatthewVita/node-hl7-complete) - Node module that is bridged with the Java Hapi HL7 library.
  * [Python HL7 ★88](johnpaulett/python-hl7) - Simple library for parsing messages of HL7 version 2.x into Python objects.
  * [Ruby FHIR ★23](fhir-crucible/fhir_client) - FHIR client implementation in Ruby.
  * [Ruby HL7 ★89 ⏳3Y](segfault/ruby-hl7) - Ruby HL7 library.

### Applications
  * [Intervention Engine ★11](intervention-engine/ie) - The Intervention Engine project provides a web-application for data-driven team huddles.
  * [SMART Pediatric Growth Chart ★18](smart-on-fhir/growth-chart-app) - Pediatric growth charts.
...
### Hardware
  ...
  * [Gluco ★8 ⏳1Y](nebulabio/gluco) - Glucometer.
  * [MobilECG II ★305](xdever/MobilECG-II) - Clinical grade Holter ECG.
...
### Bioinformatics
  * [ADAM ★620](bigdatagenomics/adam) - Genomics analysis platform.
  * [Bcbio ★434](chapmanb/bcbio-nextgen) - Validated, scalable, community developed variant calling, RNA-seq and small RNA analysis.
...
### Data
  ...
  * [Synthea Patient Generator ★33](synthetichealth/synthea) - Synthetic patient generator that models the medical history of synthetic patients.

### Datasets
  * [Medical Data for Machine Learning ★624](beamandrew/medical-data) - A curated list of medical data for machine learning.

### EMPI
  * [MEDIC Client Registry RI ★2](MohawkMEDIC/client-registry) - The Mohawk College MARC-HI/MEDIC Client Registry EMPI Implementation.
---
<p align="center">
	This list is a copy of <a href="kakoni/awesome-healthcare">kakoni/awesome-healthcare</a> with ranks
</p>
