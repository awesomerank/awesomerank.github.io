...
* [TodoMVC/Firebase](https://github.com/ThomasWeiser/todomvc-elmfire) - Fork of TodoMVC demonstrating start-app, [The Elm Architecture ★3332](https://github.com/evancz/elm-architecture-tutorial) and Firebase as backend.
* [\<elm-ement\> ★23 ⏳1Y](https://github.com/ohanhi/elm-ement) – Minimal example of a custom element.
* [Elm Playground](http://elm-playground.maciejsmolinski.com/) - Tiny Elm projects implemented for the sake of learning by example.
* [TodoMVC in Electron ★72](https://github.com/nirgn975/Elmctron) -  Documented and tested implementation of the Elm TodoMVC app in Electron.
* [Gipher ★201](https://github.com/matthieu-beteille/gipher) - A Tinder-like application for gifs built with elm and firebase!
* [Elm Architecture in Android ★38](https://github.com/glung/elm-architecture-android) - An example Android application implemented with the Elm Architecture using the Kotlin programming language and Anko library.
* [Collection of examples ★116](https://github.com/halfzebra/elm-examples) - A collection of examples with advanced techniques for real-world Elm apps.
...
* [Architecture Tutorial ★3332](https://github.com/evancz/elm-architecture-tutorial) - How to create modular Elm code that scales nicely with your app.
* [Start app ★410 ⏳1Y](https://github.com/evancz/start-app) - Make an app, start it up.
...
* [Elm cheat sheet ★583](https://github.com/izdi/elm-cheat-sheet) - Syntax and features overview.
...
* [Elm Koans ★166](https://github.com/robertjlooby/elm-koans) - Practice exercises for learning Elm.
...
* [core ★1096](https://github.com/elm-lang/core) - Elm Core Libraries.
* [html ★180](https://github.com/elm-lang/html) - Use HTML in Elm, based on the idea of a "virtual DOM".
* [elm-test ★204](https://github.com/elm-community/elm-test) - A unit testing framework for Elm.
* [elm-router ★93 ⏳1Y](https://github.com/TheSeamau5/elm-router) - Easy routing in Elm.
* [http ★39](https://github.com/elm-lang/http) - Make HTTP requests in Elm.
...
* [elm-ui ★547](https://github.com/gdotdesign/elm-ui) - UI Library in Elm.
* [elm-mdl ★688](https://github.com/debois/elm-mdl) - Material Design component library in Elm. With [demo](https://debois.github.io/elm-mdl/).
...
* [elm-bootstrap ★122](https://github.com/rundis/elm-bootstrap) - Comprehensive Bootstrap 4 library for Elm. [Docs site](http://elm-bootstrap.info).
...
* [elm-compiler ★3841](https://github.com/elm-lang/elm-compiler) - Compiler for the Elm programming language.
* [elm-make ★128](https://github.com/elm-lang/elm-make) - A build tool for Elm projects.
* [elm-reactor ★361](https://github.com/elm-lang/elm-reactor) - Interactive development tool that makes it easy to develop and debug Elm programs.
* [elm-live ★365](https://github.com/tomekwi/elm-live) - A flexible dev server for Elm. Live reload included!
* [elm-repl ★145](https://github.com/elm-lang/elm-repl) - A REPL for Elm.
* [elm-package ★157](https://github.com/elm-lang/elm-package) - CLI to share Elm libraries.
* [elm-init ★9](https://github.com/JustusAdam/elm-init) - Interactive setup for new Elm projects.
* [elm-new ★58](https://github.com/simonewebdesign/elm-new) - Generate initial project scaffolding based on a template.
* [elm-format ★712](https://github.com/avh4/elm-format) - Automatic Elm code formatter adhering to [Elm Style Guide](http://elm-lang.org/docs/style-guide).
...
* [elm-oracle ★123](https://github.com/ElmCast/elm-oracle) - Query for information about values in elm source files. Used by most editor plugins.
...
* [emacs-elm-mode ★210](https://github.com/jcollard/elm-mode) - Syntax highlighting, Elm REPL, Elm make and Elm format integration for the Emacs editor.
* [elm-light-table ★109](https://github.com/rundis/elm-light) - Syntax highlighting, REPL, autocompletion, package management and much more for Light Table.
...
* [Elm-vim ★289](https://github.com/ElmCast/elm-vim) - Elm mode for vim.
* [vim-elm-help ★5](https://github.com/hoelzro/vim-elm-help) - Offline Elm documentation access in your editor.
* [emmet-vim ★3743](https://github.com/mattn/emmet-vim) - Markup expansion with elm support.
...
* [elm-package ★157](https://github.com/elm-lang/elm-package) - Command line tool to share Elm libraries.
...
* [elm-app-boilerplate ★98](https://github.com/gkubisa/elm-app-boilerplate) - A fully-featured base project for Elm apps: Webpack, HMR, ES6, JS and Elm tests, Semantic UI, sample code and more.
* [elmkit ★21](https://github.com/khusnetdinov/elmkit) - A lightweight Brunch based setup for web app. Includes Brunch, Hot Module Replacement, Elm, Scss, Elm tests.
...
* [404 Elm Street ★137](https://github.com/zalando/elm-street-404) - A fun WebGL game built with Elm.
* [Debug Elm](http://debug.elm-lang.org/try) - Debug elm code online.
* [Haskell to Elm ★50](https://github.com/eeue56/haskell-to-elm) - Collection of examples on places where Elm is different to Haskell, targetted at Elm beginners coming from Haskell backgrounds.
