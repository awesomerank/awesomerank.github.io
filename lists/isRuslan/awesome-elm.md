...
* [TodoMVC ★830](https://github.com/evancz/elm-todomvc) - Proper implementation of the TodoMVC app.
...
* [TodoMVC/Firebase](https://github.com/ThomasWeiser/todomvc-elmfire) - Fork of TodoMVC demonstrating start-app, [The Elm Architecture ★3436](https://github.com/evancz/elm-architecture-tutorial) and Firebase as backend.
...
* [Gipher ★211](https://github.com/matthieu-beteille/gipher) - A Tinder-like application for gifs built with elm and firebase!
* [Elm Architecture in Android ★43](https://github.com/glung/elm-architecture-android) - An example Android application implemented with the Elm Architecture using the Kotlin programming language and Anko library.
* [Collection of examples ★127](https://github.com/halfzebra/elm-examples) - A collection of examples with advanced techniques for real-world Elm apps.
* [Elm Flatris ★239](https://github.com/w0rm/elm-flatris) - A Flatris clone in Elm language v0.18.
* [Elm + Phoenix + Webpack ★29](https://github.com/ronanyeah/elm-phoenix-example) - A minimal Elm + Phoenix setup, using webpack instead of Brunch.
* [Elm SPA Example](http://rtfeldman.github.io/elm-spa-example/) - Full stack Elm app w/ CRUD operations, Auth, routing, pagination and more. [Code ★1034](https://github.com/rtfeldman/elm-spa-example) / [Article](https://dev.to/rtfeldman/tour-of-an-open-source-elm-spa)
...
* [Architecture Tutorial ★3436](https://github.com/evancz/elm-architecture-tutorial) - How to create modular Elm code that scales nicely with your app.
...
* [Elm cheat sheet ★625](https://github.com/izdi/elm-cheat-sheet) - Syntax and features overview.
...
* [core ★1255](https://github.com/elm-lang/core) - Elm Core Libraries.
* [html ★203](https://github.com/elm-lang/html) - Use HTML in Elm, based on the idea of a "virtual DOM".
* [elm-test ★238](https://github.com/elm-community/elm-test) - A unit testing framework for Elm.
* [elm-router ★96 ⏳1Y](https://github.com/TheSeamau5/elm-router) - Easy routing in Elm.
* [http ★45](https://github.com/elm-lang/http) - Make HTTP requests in Elm.
* [elm-http-builder ★97](https://github.com/lukewestby/elm-http-builder) - Build and handle JSON requests more naturally than with low-level elm-http.
...
* [elm-ui ★585](https://github.com/gdotdesign/elm-ui) - UI Library in Elm.
* [elm-mdl ★760](https://github.com/debois/elm-mdl) - Material Design component library in Elm. With [demo](https://debois.github.io/elm-mdl/).
...
* [elm-bootstrap ★147](https://github.com/rundis/elm-bootstrap) - Comprehensive Bootstrap 4 library for Elm. [Docs site](http://elm-bootstrap.info).
...
* [elm-compiler ★3972](https://github.com/elm-lang/elm-compiler) - Compiler for the Elm programming language.
* [elm-make ★131](https://github.com/elm-lang/elm-make) - A build tool for Elm projects.
* [elm-reactor ★375](https://github.com/elm-lang/elm-reactor) - Interactive development tool that makes it easy to develop and debug Elm programs.
* [elm-live ★408](https://github.com/tomekwi/elm-live) - A flexible dev server for Elm. Live reload included!
...
* [elm-new ★62](https://github.com/simonewebdesign/elm-new) - Generate initial project scaffolding based on a template.
* [elm-format ★773](https://github.com/avh4/elm-format) - Automatic Elm code formatter adhering to [Elm Style Guide](http://elm-lang.org/docs/style-guide).
...
* [elm-oracle ★129](https://github.com/ElmCast/elm-oracle) - Query for information about values in elm source files. Used by most editor plugins.
* [create-elm-app ★495](https://github.com/halfzebra/create-elm-app) - Create Elm apps with no build configuration.
...
* [elm-analyse ★134](https://github.com/stil4m/elm-analyse) - Linter for the Elm programming language.
...
* [emacs-elm-mode ★221](https://github.com/jcollard/elm-mode) - Syntax highlighting, Elm REPL, Elm make and Elm format integration for the Emacs editor.
...
* [Elm-vim ★316](https://github.com/ElmCast/elm-vim) - Elm mode for vim.
* [vim-elm-help ★5](https://github.com/hoelzro/vim-elm-help) - Offline Elm documentation access in your editor.
* [emmet-vim ★3822](https://github.com/mattn/emmet-vim) - Markup expansion with elm support.
...
* [elm-app-boilerplate ★107](https://github.com/gkubisa/elm-app-boilerplate) - A fully-featured base project for Elm apps: Webpack, HMR, ES6, JS and Elm tests, Semantic UI, sample code and more.
...
* [404 Elm Street ★146](https://github.com/zalando/elm-street-404) - A fun WebGL game built with Elm.
