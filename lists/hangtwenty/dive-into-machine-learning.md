...
* **You know Python.** (At least the basics! If you want to learn more Python, [try this ★177](https://github.com/hangtwenty/python-is-for-lovers))
...
- [Election Forecasting ★224 ⏳1Y](https://github.com/jseabold/538model): A replication of the model Nate Silver used to make [predictions about the 2012 US Presidential Election for the New York Times](https://fivethirtyeight.blogs.nytimes.com/fivethirtyeights-2012-forecast/))
...
* [Bayesian Modelling in Python ★1842](https://github.com/markdregan/Bayesian-Modelling-in-Python)
...
There are [other lists of Awesome Machine Learning tools ★28131](https://github.com/josephmisiti/awesome-machine-learning), so I won't re-do all that. But in the Big Data section, I would be remiss if I didn't mention...
