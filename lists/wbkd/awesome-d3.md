...
---
# Awesome D3 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★61331](https://github.com/sindresorhus/awesome)
...
- [britecharts ★2473](https://github.com/eventbrite/britecharts) - Client-side reusable Charting Library
...
- [dagre-d3 ★1006](https://github.com/cpettitt/dagre-d3) - Layout directed graphs on the client-side
...
- [d3.chart.sankey ★61](https://github.com/q-m/d3.chart.sankey) - Reusable D3 Sankey diagram
- [d3-bar ★136](https://github.com/tj/d3-bar) - Bar chart
- [d3-bumps-chart ★1](https://github.com/johnwalley/d3-bumps-chart) - Plugin for visualizing bumps charts
- [d3-circle ★111](https://github.com/tj/d3-circle) - Circle chart
- [d3-dot ★110](https://github.com/tj/d3-dot) - Dot chart
- [d3-heatmap ★187 ⏳1Y](https://github.com/tj/d3-heatmap) - Heatmap
- [d3-line ★105](https://github.com/tj/d3-line) - Line chart
- [d3-flame-graph ★204](https://github.com/spiermar/d3-flame-graph) - Flame graphs from hierarchical data
...
- [d3-timeline ★562](https://github.com/commodityvectors/d3-timeline) - responsive timeline charts
- [d3fc](http://scottlogic.github.io/d3fc/) - A collection of interactive chart components
- [D3Funnel ★151](https://github.com/jakezatecky/d3-funnel) - A funnel and pyramid chart library
- [d3panels ★24](https://github.com/kbroman/d3panels) - Interactive charts with linked brushing
- [d3pie ★295](https://github.com/benkeen/d3pie) - A configurable pie chart lib and generator
- [D3xter ★346](https://github.com/NathanEpstein/D3xter) - Straight forward plotting
- [d3 timeseries](http://mcaule.github.io/d3-timeseries/) - Time series charting library
- [D4](http://visible.io/) - Re-usable charts DSL
- [dTree ★69](https://github.com/ErikGartner/dTree) - Family tree library
- [epoch](http://epochjs.github.io/epoch/) - A general purpose, real-time visualization library
- [EventDrops ★752](https://github.com/marmelab/EventDrops) - A time based/event series interactive visualization
- [fancycharts ★89 ⏳1Y](https://github.com/ahoiin/Fancycharts.js) - Library to visualize percentage values
...
- [Gantt-Chart ★247](https://github.com/dk8996/Gantt-Chart) - Gantt chart library
- [insights ★181 ⏳1Y](https://github.com/ignacioola/insights) -  Library to visualize and navigate graphs
...
- [plotly ★6481](https://github.com/plotly/plotly.js) - High level charting library
...
- [radar chart ★292](https://github.com/alangrafu/radar-chart-d3) - Radar chart module
- [rickshaw ★6052](https://github.com/shutterstock/rickshaw) - Toolkit for creating interactive real-time graphs
...
- [xkcdgraphs ★298 ⏳1Y](https://github.com/imkevinxu/xkcdgraphs) - Xkcd style graphs

##### Third Party

- [angular-nvd3](http://krispo.github.io/angular-nvd3) - NVd3 for Angular
- [d3act ★284](https://github.com/AnSavvides/d3act) - d3 with React
...
- [react-d3 ★1618 ⏳1Y](https://github.com/esbullington/react-d3) - Charts for React
- [react-d3-components ★1230](https://github.com/codesuki/react-d3-components) - D3 Components
...
- [victory ★4482](https://github.com/FormidableLabs/victory) - A collection of composable React components for building interactive data visualizations
- [vx ★2096](https://github.com/hshoff/vx) - Visualization components for React
...
- [carto map ★208 ⏳2Y](https://github.com/emeeks/d3-carto-map) - A mapping API that uses D3 geospatial functionality
...
- [d3 geo projection ★517](https://github.com/d3/d3-geo-projection) - Extended geographic projections
- [d3 geomap](http://d3-geomap.github.io/) - Library for creating geographic maps
- [d3.geo2rect ★141](https://github.com/sebastian-meier/d3.geo2rect) - Morphing geojson polygons into rectangles
...
- [leaflet-d3 ★141](https://github.com/Asymmetrik/leaflet-d3) - Collection of plugins for using D3 with Leaflet
...
- [d3-component ★46](https://github.com/curran/d3-component) - Lightweight component abstraction
- [d3-extended ★251](https://github.com/wbkd/d3-extended) - Extends d3 with some common jQuery functions
...
- [d3-iconarray ★50 ⏳1Y](https://github.com/tomgp/d3-iconarray) - A plug-in for aligning elements in grids
- [d3-kit ★320](https://github.com/twitter/d3kit) - A set of tools to speed D3 related project development
- [d3-Labeler ★143](https://github.com/tinker10/D3-Labeler) - Plug-in for automatic label placement
...
- [d3-scale-cluster ★68](https://github.com/schnerd/d3-scale-cluster) - Scale that clusters data into discrete groups
- [d3-starterkit ★121](https://github.com/1wheel/d3-starterkit) - Helper functions simplifying common and verbose d3 patterns
- [d3-tip ★921](https://github.com/Caged/d3-tip) - Tooltip helper
- [d3-tipy ★82](https://github.com/tj/d3-tipy) - Tooltip helper
...
- [jetpack ★396](https://github.com/gka/d3-jetpack) - Nifty convenience wrappers that speed up your daily work
- [kodama](http://darkmarmot.github.io/kodama/) - Tooltip Plugin
- [swoopyarrows ★78](https://github.com/bizweekgraphics/swoopyarrows) - Plugin to create swoopy arrows
- [swoopyDrag ★99](https://github.com/1wheel/swoopy-drag) - Artisanal label placement for d3 graphics
...
- [comic.js ★105 ⏳1Y](https://github.com/balint42/comic.js) - Cartoon style drawing (works also for canvas, Raphael & SVG.js)
...
- [d3-cloud ★2118](https://github.com/jasondavies/d3-cloud) - Word clouds
...
- [d3-resume ★22 ⏳2Y](https://github.com/glena/d3-resume) - Resume visualizer
- [d3.sketchy ★205 ⏳1Y](https://github.com/sebastian-meier/d3.sketchy) - Creates sketchy backgrounds, shapes and lines
...
## Server side 
- [d3-node ★304](https://github.com/d3-node/d3-node) - Static chart and map generation 
