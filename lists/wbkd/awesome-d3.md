...
- [billboard ★1626](https://github.com/naver/billboard.js) - Re-usable easy interface JavaScript chart library, based on D3 v4+ (fork of C3)
- [britecharts ★2779](https://github.com/eventbrite/britecharts) - Client-side reusable Charting Library
...
- [d3-heatmap ★195 ⏳1Y](https://github.com/tj/d3-heatmap) - Heatmap
- [d3-line ★105](https://github.com/tj/d3-line) - Line chart
- [d3-flame-graph ★228](https://github.com/spiermar/d3-flame-graph) - Flame graphs from hierarchical data
...
- [dTree ★86](https://github.com/ErikGartner/dTree) - Family tree library
- [epoch](http://epochjs.github.io/epoch/) - A general purpose, real-time visualization library
- [EventDrops ★791](https://github.com/marmelab/EventDrops) - A time based/event series interactive visualization
- [fancycharts ★89 ⏳2Y](https://github.com/ahoiin/Fancycharts.js) - Library to visualize percentage values
- [firespray ★85 ⏳2Y](https://github.com/boundary/firespray) - Streaming charts
- [forest-d3 ★51 ⏳1Y](https://github.com/robinfhu/forest-d3) - A time series charting library
- [Gantt-Chart ★267](https://github.com/dk8996/Gantt-Chart) - Gantt chart library
...
- [d3act ★294](https://github.com/AnSavvides/d3act) - d3 with React
...
- [carto map ★218 ⏳2Y](https://github.com/emeeks/d3-carto-map) - A mapping API that uses D3 geospatial functionality
...
- [spam ★86](https://github.com/newsappsio/spam) - Create maps with D3 and Canvas, easily

##### Third Party

- [leaflet-d3 ★147](https://github.com/Asymmetrik/leaflet-d3) - Collection of plugins for using D3 with Leaflet
...
- [d3-Labeler ★145 ⏳1Y](https://github.com/tinker10/D3-Labeler) - Plug-in for automatic label placement
...
- [d3-loom ★49](https://github.com/nbremer/d3-loom) - Plugin to create a "loom" visualization
...
- [d3-ring-note ★96 ⏳1Y](https://github.com/armollica/d3-ring-note) - Plugin for placing circle and text annotations
- [d3-scale-cluster ★71](https://github.com/schnerd/d3-scale-cluster) - Scale that clusters data into discrete groups
- [d3-sparql ★27](https://github.com/zazuko/d3-sparql) - Utility for accessing data from SPARQL Endpoints
...
- [jetpack ★432](https://github.com/gka/d3-jetpack) - Nifty convenience wrappers that speed up your daily work
...
- [d3.sketchy ★211 ⏳2Y](https://github.com/sebastian-meier/d3.sketchy) - Creates sketchy backgrounds, shapes and lines
...
## Server side
- [d3-node ★342](https://github.com/d3-node/d3-node) - Static chart and map generation
