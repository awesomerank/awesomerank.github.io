...
- [billboard ★1279](https://github.com/naver/billboard.js) - Re-usable easy interface JavaScript chart library, based on D3 v4+ (fork of C3)
- [britecharts ★2701](https://github.com/eventbrite/britecharts) - Client-side reusable Charting Library
...
- [dagre-d3 ★1070](https://github.com/cpettitt/dagre-d3) - Layout directed graphs on the client-side
...
- [d3-timeline ★575](https://github.com/commodityvectors/d3-timeline) - responsive timeline charts
- [d3fc](http://scottlogic.github.io/d3fc/) - A collection of interactive chart components
- [D3Funnel ★163](https://github.com/jakezatecky/d3-funnel) - A funnel and pyramid chart library
- [d3panels ★25](https://github.com/kbroman/d3panels) - Interactive charts with linked brushing
- [d3pie ★298](https://github.com/benkeen/d3pie) - A configurable pie chart lib and generator
...
- [dTree ★83](https://github.com/ErikGartner/dTree) - Family tree library
- [epoch](http://epochjs.github.io/epoch/) - A general purpose, real-time visualization library
- [EventDrops ★778](https://github.com/marmelab/EventDrops) - A time based/event series interactive visualization
...
- [forest-d3 ★49 ⏳1Y](https://github.com/robinfhu/forest-d3) - A time series charting library
- [Gantt-Chart ★260](https://github.com/dk8996/Gantt-Chart) - Gantt chart library
- [insights ★183 ⏳1Y](https://github.com/ignacioola/insights) -  Library to visualize and navigate graphs
...
- [d3act ★292](https://github.com/AnSavvides/d3act) - d3 with React
...
- [carto map ★214 ⏳2Y](https://github.com/emeeks/d3-carto-map) - A mapping API that uses D3 geospatial functionality
...
- [d3 geo projection ★543](https://github.com/d3/d3-geo-projection) - Extended geographic projections
- [d3 geomap](http://d3-geomap.github.io/) - Library for creating geographic maps
- [d3.geo2rect ★147](https://github.com/sebastian-meier/d3.geo2rect) - Morphing geojson polygons into rectangles
...
- [spam ★84](https://github.com/newsappsio/spam) - Create maps with D3 and Canvas, easily

##### Third Party

- [leaflet-d3 ★145](https://github.com/Asymmetrik/leaflet-d3) - Collection of plugins for using D3 with Leaflet
...
- [d3-area-label ★20](https://github.com/curran/d3-area-label) - A library for placing labels in areas
- [d3-component ★52](https://github.com/curran/d3-component) - Lightweight component abstraction
- [d3-extended ★254](https://github.com/wbkd/d3-extended) - Extends d3 with some common jQuery functions
...
- [d3-scale-cluster ★71](https://github.com/schnerd/d3-scale-cluster) - Scale that clusters data into discrete groups
- [d3-sparql ★26](https://github.com/zazuko/d3-sparql) - Utility for accessing data from SPARQL Endpoints
- [d3-starterkit ★122](https://github.com/1wheel/d3-starterkit) - Helper functions simplifying common and verbose d3 patterns
- [d3-tip ★951](https://github.com/Caged/d3-tip) - Tooltip helper
...
- [d3.slider ★217](https://github.com/MasterMaps/d3-slider) - jQuery UI inspired slider
...
- [jetpack ★415](https://github.com/gka/d3-jetpack) - Nifty convenience wrappers that speed up your daily work
- [kodama](http://darkmarmot.github.io/kodama/) - Tooltip Plugin
- [swoopyarrows ★80](https://github.com/bizweekgraphics/swoopyarrows) - Plugin to create swoopy arrows
- [swoopyDrag ★102](https://github.com/1wheel/swoopy-drag) - Artisanal label placement for d3 graphics
...
- [d3.sketchy ★208 ⏳2Y](https://github.com/sebastian-meier/d3.sketchy) - Creates sketchy backgrounds, shapes and lines
...
## Server side
- [d3-node ★335](https://github.com/d3-node/d3-node) - Static chart and map generation
