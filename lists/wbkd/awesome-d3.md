...
---
# Awesome D3 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★62884](https://github.com/sindresorhus/awesome)
...
- [billboard ★1177](https://github.com/naver/billboard.js) - Re-usable easy interface JavaScript chart library, based on D3 v4+ (fork of C3)
- [britecharts ★2563](https://github.com/eventbrite/britecharts) - Client-side reusable Charting Library
...
- [dagre-d3 ★1032](https://github.com/cpettitt/dagre-d3) - Layout directed graphs on the client-side
...
- [d3.chart.sankey ★64](https://github.com/q-m/d3.chart.sankey) - Reusable D3 Sankey diagram
...
- [d3-heatmap ★191 ⏳1Y](https://github.com/tj/d3-heatmap) - Heatmap
- [d3-line ★105](https://github.com/tj/d3-line) - Line chart
- [d3-flame-graph ★212](https://github.com/spiermar/d3-flame-graph) - Flame graphs from hierarchical data
...
- [d3-timeline ★570](https://github.com/commodityvectors/d3-timeline) - responsive timeline charts
- [d3fc](http://scottlogic.github.io/d3fc/) - A collection of interactive chart components
- [D3Funnel ★157](https://github.com/jakezatecky/d3-funnel) - A funnel and pyramid chart library
- [d3panels ★24](https://github.com/kbroman/d3panels) - Interactive charts with linked brushing
- [d3pie ★297](https://github.com/benkeen/d3pie) - A configurable pie chart lib and generator
...
- [dTree ★78](https://github.com/ErikGartner/dTree) - Family tree library
- [epoch](http://epochjs.github.io/epoch/) - A general purpose, real-time visualization library
- [EventDrops ★760](https://github.com/marmelab/EventDrops) - A time based/event series interactive visualization
- [fancycharts ★90 ⏳1Y](https://github.com/ahoiin/Fancycharts.js) - Library to visualize percentage values
- [firespray ★84 ⏳2Y](https://github.com/boundary/firespray) - Streaming charts
- [forest-d3 ★48 ⏳1Y](https://github.com/robinfhu/forest-d3) - A time series charting library
- [Gantt-Chart ★254](https://github.com/dk8996/Gantt-Chart) - Gantt chart library
- [insights ★182 ⏳1Y](https://github.com/ignacioola/insights) -  Library to visualize and navigate graphs
...
- [plotly ★6647](https://github.com/plotly/plotly.js) - High level charting library
...
- [xkcdgraphs ★299 ⏳1Y](https://github.com/imkevinxu/xkcdgraphs) - Xkcd style graphs

##### Third Party

- [angular-nvd3](http://krispo.github.io/angular-nvd3) - NVd3 for Angular
- [d3act ★290](https://github.com/AnSavvides/d3act) - d3 with React
...
- [react-d3-components ★1248](https://github.com/codesuki/react-d3-components) - D3 Components
...
- [victory ★4659](https://github.com/FormidableLabs/victory) - A collection of composable React components for building interactive data visualizations
- [vx ★2372](https://github.com/hshoff/vx) - Visualization components for React
...
- [carto map ★210 ⏳2Y](https://github.com/emeeks/d3-carto-map) - A mapping API that uses D3 geospatial functionality
...
- [d3 geo projection ★526](https://github.com/d3/d3-geo-projection) - Extended geographic projections
- [d3 geomap](http://d3-geomap.github.io/) - Library for creating geographic maps
- [d3.geo2rect ★145](https://github.com/sebastian-meier/d3.geo2rect) - Morphing geojson polygons into rectangles
...
- [spam ★82](https://github.com/newsappsio/spam) - Create maps with D3 and Canvas, easily

##### Third Party

- [leaflet-d3 ★143](https://github.com/Asymmetrik/leaflet-d3) - Collection of plugins for using D3 with Leaflet
...
- [d3-area-label ★16](https://github.com/curran/d3-area-label) - A library for placing labels in areas
- [d3-component ★50](https://github.com/curran/d3-component) - Lightweight component abstraction
- [d3-extended ★252](https://github.com/wbkd/d3-extended) - Extends d3 with some common jQuery functions
- [d3-helpers ★24 ⏳2Y](https://github.com/bahmutov/d3-helpers) - Little utility functions
- [d3-history ★37](https://github.com/vijithassar/d3-history) - Proper URL bar history
- [d3-iconarray ★51 ⏳1Y](https://github.com/tomgp/d3-iconarray) - A plug-in for aligning elements in grids
- [d3-kit ★322](https://github.com/twitter/d3kit) - A set of tools to speed D3 related project development
- [d3-Labeler ★143 ⏳1Y](https://github.com/tinker10/D3-Labeler) - Plug-in for automatic label placement
...
- [d3-loom ★39](https://github.com/nbremer/d3-loom) - Plugin to create a "loom" visualization
...
- [d3-scale-cluster ★70](https://github.com/schnerd/d3-scale-cluster) - Scale that clusters data into discrete groups
- [d3-sparql ★16](https://github.com/zazuko/d3-sparql) - Utility for accessing data from SPARQL Endpoints
- [d3-starterkit ★121](https://github.com/1wheel/d3-starterkit) - Helper functions simplifying common and verbose d3 patterns
- [d3-tip ★938](https://github.com/Caged/d3-tip) - Tooltip helper
- [d3-tipy ★83](https://github.com/tj/d3-tipy) - Tooltip helper
- [d3-trail ★124 ⏳2Y](https://github.com/bmschmidt/D3-trail) - A layout for creating better path elements
- [d3-xray](http://www.vijithassar.com/d3-xray) - Bookmarklet which logs the results of the data joins as you mouse over
- [d3.slider ★214](https://github.com/MasterMaps/d3-slider) - jQuery UI inspired slider
- [d3.svg.circularbrush ★45 ⏳1Y](https://github.com/emeeks/d3.svg.circularbrush) - A brush for selecting cyclical data
...
- [jetpack ★404](https://github.com/gka/d3-jetpack) - Nifty convenience wrappers that speed up your daily work
- [kodama](http://darkmarmot.github.io/kodama/) - Tooltip Plugin
- [swoopyarrows ★79](https://github.com/bizweekgraphics/swoopyarrows) - Plugin to create swoopy arrows
- [swoopyDrag ★100](https://github.com/1wheel/swoopy-drag) - Artisanal label placement for d3 graphics
...
- [d3plus-text ★26](https://github.com/d3plus/d3plus-text) - Smart SVG text box with line wrapping and automatic font scaling
...
- [netvis ★9 ⏳2Y](https://github.com/dborzov/netvis) - Tool to visualize network communication for arbitrary protocols

## Server side
- [d3-node ★323](https://github.com/d3-node/d3-node) - Static chart and map generation

## Code Editors
- [Snippets for Atom ★28](https://github.com/martgnz/d3-snippets)
