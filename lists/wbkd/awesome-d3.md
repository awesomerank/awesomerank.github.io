...
- [billboard ★1187](https://github.com/naver/billboard.js) - Re-usable easy interface JavaScript chart library, based on D3 v4+ (fork of C3)
- [britecharts ★2588](https://github.com/eventbrite/britecharts) - Client-side reusable Charting Library
...
- [dagre-d3 ★1042](https://github.com/cpettitt/dagre-d3) - Layout directed graphs on the client-side
...
- [d3.chart.sankey ★65](https://github.com/q-m/d3.chart.sankey) - Reusable D3 Sankey diagram
...
- [d3-flame-graph ★214](https://github.com/spiermar/d3-flame-graph) - Flame graphs from hierarchical data
...
- [d3-timeline ★572](https://github.com/commodityvectors/d3-timeline) - responsive timeline charts
- [d3fc](http://scottlogic.github.io/d3fc/) - A collection of interactive chart components
- [D3Funnel ★159](https://github.com/jakezatecky/d3-funnel) - A funnel and pyramid chart library
...
- [EventDrops ★763](https://github.com/marmelab/EventDrops) - A time based/event series interactive visualization
...
- [Gantt-Chart ★255](https://github.com/dk8996/Gantt-Chart) - Gantt chart library
...
- [plotly ★6685](https://github.com/plotly/plotly.js) - High level charting library
...
- [radar chart ★295](https://github.com/alangrafu/radar-chart-d3) - Radar chart module
...
- [xkcdgraphs ★298 ⏳2Y](https://github.com/imkevinxu/xkcdgraphs) - Xkcd style graphs
...
- [victory ★4699](https://github.com/FormidableLabs/victory) - A collection of composable React components for building interactive data visualizations
- [vx ★2401](https://github.com/hshoff/vx) - Visualization components for React
...
- [carto map ★211 ⏳2Y](https://github.com/emeeks/d3-carto-map) - A mapping API that uses D3 geospatial functionality
...
- [d3 geo projection ★534](https://github.com/d3/d3-geo-projection) - Extended geographic projections
...
- [d3-area-label ★18](https://github.com/curran/d3-area-label) - A library for placing labels in areas
- [d3-component ★51](https://github.com/curran/d3-component) - Lightweight component abstraction
- [d3-extended ★253](https://github.com/wbkd/d3-extended) - Extends d3 with some common jQuery functions
...
- [d3-iconarray ★52 ⏳1Y](https://github.com/tomgp/d3-iconarray) - A plug-in for aligning elements in grids
...
- [d3-loom ★45](https://github.com/nbremer/d3-loom) - Plugin to create a "loom" visualization
...
- [d3-sparql ★23](https://github.com/zazuko/d3-sparql) - Utility for accessing data from SPARQL Endpoints
- [d3-starterkit ★121](https://github.com/1wheel/d3-starterkit) - Helper functions simplifying common and verbose d3 patterns
- [d3-tip ★941](https://github.com/Caged/d3-tip) - Tooltip helper
...
- [jetpack ★407](https://github.com/gka/d3-jetpack) - Nifty convenience wrappers that speed up your daily work
...
## Server side
- [d3-node ★328](https://github.com/d3-node/d3-node) - Static chart and map generation

## Code Editors
- [Snippets for Atom ★29](https://github.com/martgnz/d3-snippets)
