...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) list thing. You might want to read the complete [awesome ★59088](https://github.com/sindresorhus/awesome) list.*
...
*Validators are tools for checking authenticity of a move.*
 ...
 - [chess.js ★1015](https://github.com/jhlywa/chess.js) - chess.js, Structured code for chess authentication.
...
*Boards are tools for encapsulating the process of rendering a board.*
 ...
 - [Chessboard.js ★905](https://github.com/oakmac/chessboardjs) - chessboard.js is a standalone JavaScript chess board.
