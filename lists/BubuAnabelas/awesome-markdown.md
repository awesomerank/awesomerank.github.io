...
---
# Awesome Markdown [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★73813](https://github.com/sindresorhus/awesome)
...
_Please read the [contribution guidelines](https://github.com/BubuAnabelas/awesome-markdown/blob/master/contributing.md) before contributing._
...
- [Hoedown ★720](https://github.com/hoedown/hoedown) - Standards compliant, fast, secure Markdown processing library in C (Sundown fork).
- [peg-markdown ★559](https://github.com/jgm/peg-markdown) - An implementation of Markdown in C, using a PEG grammar.
- [Sundown ★1569](https://github.com/vmg/sundown) - Standards compliant, fast, secure Markdown processing library in C.

### Java

- [commonmark-java ★643](https://github.com/atlassian/commonmark-java) - Java implementation of CommonMark, a specification of the Markdown format.
- [flexmark-java ★423](https://github.com/vsch/flexmark-java) - Java Implementation of Markdown parser with source level AST.
- [pegdown ★1188 ⏳1Y](https://github.com/sirthias/pegdown) - A pure-Java Markdown processor based on a parboiled PEG parser supporting a number of extensions.

### JavaScript

- [markdown-it ★4513](https://github.com/markdown-it/markdown-it) - Markdown parser, done right. 100% CommonMark support, extensions, syntax plugins & high speed.
- [markdown-js ★6367](https://github.com/evilstreak/markdown-js) - Yet another Markdown parser, this time for JavaScript.
- [marked ★15027](https://github.com/chjj/marked) - Full-featured Markdown parser and compiler, written in JavaScript. Built for speed.
- [Showdown ★5999](https://github.com/showdownjs/showdown) - Showdown is a JavaScript Markdown to HTML converter, based on the original works by John Gruber.
- [Snarkdown ★674](https://github.com/developit/snarkdown) - Snarkdown is a dead simple 1kb Markdown parser.
...
- [markdown2 ★1443](https://github.com/trentm/python-markdown2) - Fast and complete implementation of Markdown in Python.
- [Mistune ★1099](https://github.com/lepture/mistune) - The fastest Markdown parser in pure Python with renderer feature.
- [Python-Markdown](https://github.com/waylan/Python-Markdown) - Python implementation of John Gruber's Markdown.

### Ruby

- [kramdown ★1166](https://github.com/gettalong/kramdown) - kramdown is a fast, pure Ruby Markdown superset converter, using a strict syntax definition and supporting several common extensions.
- [Redcarpet ★4126](https://github.com/vmg/redcarpet) - Redcarpet is a Ruby library for Markdown processing that smells like butterflies and popcorn.
...
- [csvtomd ★399](https://github.com/mplewis/csvtomd) - Convert your CSV files into Markdown tables. ![Apple][apple] ![Linux][linux] ![Windows 8][windows8]
- [HTML To Markdown for PHP ★674](https://github.com/thephpleague/html-to-markdown) - Convert HTML to Markdown with PHP.
- [markdown-pdf ★1189](https://github.com/alanshaw/markdown-pdf) - Markdown to PDF converter.
...
- [Torsimany ★10](https://github.com/PolBaladas/torsimany) - Translate format-independent JSON to stylish, human-readable Markdown. ![Apple][apple] ![Linux][linux] ![Windows 8][windows8]
- [yamp ★21](https://github.com/angrykoala/yamp) - Wasy-to-use cli toolbox for markdown-related task. ![Apple][apple] ![Linux][linux] ![Windows 8][windows8]
...
- [MarkRight ★906](https://github.com/dvcrn/markright) - Minimalistic github flavored Markdown editor. ![Apple][apple] ![Linux][linux] ![Windows 8][windows8]
...
- [Markdownlint ★39](https://github.com/igorshubovych/markdownlint-cli) - Node.js style checker and lint tool for Markdown/CommonMark files.
...
- [GitDown ★369](https://github.com/gajus/gitdown) – GitHub's Markdown preprocessor. :octocat:
...
- [mdp ★2898](https://github.com/visit1985/mdp) - Command-line based Markdown presentation tool. :gem: _Like PowerPoint and Vim but with Markdown!_ ![Apple][apple] ![Linux][linux]
...
- [how-to-markdown ★95](https://github.com/workshopper/how-to-markdown) - This workshopper will teach you how to use Markdown.
