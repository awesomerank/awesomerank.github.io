...
<p align="center">
	This list is a copy of <a href="BubuAnabelas/awesome-markdown">BubuAnabelas/awesome-markdown</a> with ranks
</p>
---
# Awesome Markdown [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
...
- [Hoedown ★662](hoedown/hoedown) - Standards compliant, fast, secure Markdown processing library in C (Sundown fork).
- [peg-markdown ★539 ⏳3Y](jgm/peg-markdown) - An implementation of Markdown in C, using a PEG grammar.
- [Sundown ★1496](vmg/sundown) - Standards compliant, fast, secure Markdown processing library in C.

### Java

- [commonmark-java ★417](atlassian/commonmark-java) - Java implementation of CommonMark, a specification of the Markdown format.
- [flexmark-java ★188](vsch/flexmark-java) - Java Implementation of Markdown parser with source level AST.
- [pegdown ★1146](sirthias/pegdown) - A pure-Java Markdown processor based on a parboiled PEG parser supporting a number of extensions.

### JavaScript

- [marked ★12936](chjj/marked) - Full-featured Markdown parser and compiler, written in JavaScript. Built for speed.
- [markdown-it ★3552](markdown-it/markdown-it) - Markdown parser, done right. 100% CommonMark support, extensions, syntax plugins & high speed.
- [markdown-js ★5896](evilstreak/markdown-js) - Yet another Markdown parser, this time for JavaScript.
- [Showdown ★4881](showdownjs/showdown) - Showdown is a JavaScript Markdown to HTML converter, based on the original works by John Gruber.
- [Snarkdown ★470](developit/snarkdown) - Snarkdown is a dead simple 1kb Markdown parser.
...
- [parsedown ★4316](erusev/parsedown) - Better Markdown Parser in PHP.
- [php-markdown ★2419](michelf/php-markdown) - Parser for Markdown and Markdown Extra derived from the original Markdown.pl by John Gruber.

### Python

- [markdown2 ★1335](trentm/python-markdown2) - Fast and complete implementation of Markdown in Python.
- [Mistune ★928](lepture/mistune) - The fastest Markdown parser in pure Python with renderer feature.
- [Python-Markdown ★1062](waylan/Python-Markdown) - Python implementation of John Gruber's Markdown.

### Ruby

- [kramdown ★1080](gettalong/kramdown) - kramdown is a fast, pure Ruby Markdown superset converter, using a strict syntax definition and supporting several common extensions.
- [Redcarpet ★3927](vmg/redcarpet) - Redcarpet is a Ruby library for Markdown processing that smells like butterflies and popcorn.
...
- [Torsimany ★4](PolBaladas/torsimany) - Translate format-independent JSON to stylish, human-readable Markdown. <img src="https://maxcdn.icons8.com/Android_L/PNG/24/Operating_Systems/mac_os-24.png" title="Apple" width="24"> <img src="https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/linux-24.png" title="Linux" width="24"> <img src="https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/windows8_copyrighted-24.png" title="Windows8" width="24">
- [yamp ★16](angrykoala/yamp) - Wasy-to-use cli toolbox for markdown-related task. <img src="https://maxcdn.icons8.com/Android_L/PNG/24/Operating_Systems/mac_os-24.png" title="Apple" width="24"> <img src="https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/linux-24.png" title="Linux" width="24"> <img src="https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/windows8_copyrighted-24.png" title="Windows8" width="24">
...
- [MarkRight ★865](dvcrn/markright) - Minimalistic github flavored Markdown editor. <img src="https://maxcdn.icons8.com/Android_L/PNG/24/Operating_Systems/mac_os-24.png" title="Apple" width="24"> <img src="https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/linux-24.png" title="Linux" width="24"> <img src="https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/windows8_copyrighted-24.png" title="Windows8" width="24">
...
- [Markdownlint ★19](igorshubovych/markdownlint-cli) - Node.js style checker and lint tool for Markdown/CommonMark files.
- [MDL ★340](mivok/markdownlint) - Tool to check Markdown files and flag style issues.
...
- [GitDown ★343](gajus/gitdown) – GitHub's Markdown preprocessor. :octocat:
