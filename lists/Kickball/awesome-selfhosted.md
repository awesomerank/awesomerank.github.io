...
## Analytics
For personal analytics/dashboards, see [Personal Dashboards ★15276](https://github.com/Kickball/awesome-selfhosted#personal-dashboards)
...
_Web Analytics_
  ...
  * [Druid](http://druid.io/) - A distributed, column-oriented, real-time analytics data store. ([Source Code ★4789](https://github.com/druid-io/druid)) `Apache` `Java`
  ...
  * [Open Web Analytics](http://www.openwebanalytics.com/) - Google Analytics and Piwik alternative. ([Source Code ★450](https://github.com/padams/Open-Web-Analytics)) `GPLv2` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [CouchPotato](https://couchpota.to/) - CouchPotato is an automatic Video Library Manager for Movies. Automatic torrent/nzb searching, downloading, and processing at the qualities you want. ([Source Code ★2983](https://github.com/CouchPotato/CouchPotatoServer)) `GPLv3` `Python`
  * [Episodes ★52](https://github.com/guptachetan1997/Episodes) - `⚠` Self Hosted TV show Episode tracker and recommender built using django, bootstrap4. `MIT` `Python`
  ...
  * [Headphones ★2320](https://github.com/rembo10/headphones) - An automated music downloader for NZB and Torrent, written in Python. It supports SABnzbd, NZBget, Transmission, µTorrent, Deluge and Blackhole. `GPLv3` `Python`
  ...
  * [homebank-converter ★7](https://github.com/Binnette/homebank-converter) - A web app to convert an export bank file to compatible Homebank csv. ([Demo](http://binnette.github.io/homebank-converter/)) `AGPLv3` `HTML5`
  * [Huginn ★16066](https://github.com/cantino/huginn) - Allows you to build agents that monitor and act on your behalf. `MIT` `Ruby`
  ...
  * [RSS Merger ★6](https://github.com/taophp/rss-merger) - PHP script which will take multiple RSS / Atom feeds as input and merge them into a single RSS feed. `GPLv2` `PHP`
  * [SickRage](http://sickrage.github.io/) - SickRage is an automatic Video Library Manager for TV Shows. Automatic torrent/nzb searching, downloading, and processing at the qualities you want. ([Source Code ★1090](https://github.com/SickRage/SickRage)) `GPLv3` `Python`
  ...
  * [WebUI-aria2 ★3036](https://github.com/ziahamza/webui-aria2) - Interface to interact with the aria2 downloader. Very simple to use, just download and open index.html in any web browser. ([Demo](http://ziahamza.github.io/webui-aria2/)) `MIT` `HTML5`
...
See also [Static Site Generators](#static-site-generators), [Content Management Systems](#content-management-systems-cms) and [WeblogMatrix](http://www.weblogmatrix.org/)
  ...
  * [Chyrp ★202](https://github.com/chyrp/chyrp) - An extra-awesome, extra-lightweight blog engine. `MIT` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Bookie ★597](https://github.com/bookieio/Bookie) - Python based delicious.com replacement. `AGPLv3` `Python`
  * [dyu/bookmarks ★3](https://github.com/dyu/bookmarks) - Single-threaded/process bookmark app powered by leveldb and uWebSockets. Supports importing from Delicious and Chrome. ([Demo](https://dyuproject.com/bookmarks/)) `Apache` `Java`
  ...
  * [Shaarli ★825](https://github.com/shaarli/Shaarli) - Personal, minimalist, super-fast, no-database bookmarking and link sharing plaform. ([Demo](https://demo.shaarli.org)) `Zlib` `PHP`
...
### Custom
  ...
  * [Centrifugo](https://github.com/centrifugal/centrifugo) - Language-agnostic real-time messaging (Websocket or SockJS) server. ([Demo ★1811](https://github.com/centrifugal/centrifugo#demo)) `MIT` `Go`
  * [Cherry ★116](https://github.com/rafael-santiago/cherry) - A tiny webchat server. `GPLv2` `Go`
  ...
  * [Node-Chat ★352](https://github.com/IgorAntun/node-chat) - A not-so-basic open-source chat with admin features. `MIT` `Nodejs`
  ...
  * [TextBelt ★1260](https://github.com/typpo/textbelt) `⚠` - An outgoing SMS API that uses carrier-specific gateways to deliver your text messages for free, and without ads. `MIT` `Javascript`
...
* [Maildrop ★583](https://github.com/m242/maildrop) - Disposable email SMTP server, also useful for development. `MIT` `Scala`
* [MailHog ★1982](https://github.com/mailhog/MailHog) - Small Golang executable which runs an SMTP MTA gateway that accepts all mail and displays in web interface. Useful for debugging or development. `MIT` `Go`
...
#### Webmail clients
  ...
  * [Roundcube](https://roundcube.net) - Browser-based IMAP client with an application-like user interface. ([Source Code ★2101](https://github.com/roundcube/roundcubemail)) `GPLv3` `PHP`
...
CMS are a practical way to setup a website with many features. CMS often come with third party plugins, themes and functionality that is easy to add and customize to your needs. See also [Blogging Platforms](#blogging-platforms) and [Static Site Generators](#static-site-generators)
  ...
  * [Roadiz](https://www.roadiz.io/) -  Modern CMS based on a node system which can handle many types of services. ([Source Code ★278](https://github.com/roadiz/roadiz)) `MIT` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Paperless ★3439](https://github.com/danielquinn/paperless) - Scan, index, and archive all of your paper documents. `GPLv3` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [RSS Monster ★154](https://github.com/pietheinstrengholt/rssmonster) - RSS Monster is an easy to use web-based RSS aggregator and reader compatible with the Fever API, created as an alternative for Google Reader. `MIT` `PHP`
  * [Screaming Liquid Tiger ★86](https://github.com/herrbischoff/screaming-liquid-tiger) - Simple script to automatically generate valid RSS and Atom feeds from a list of media files in the same folder. `MIT` `PHP`
  ...
  * [Stringer ★2647](https://github.com/swanson/stringer) - A work-in-progress self-hosted, anti-social RSS reader. `MIT` `Ruby`
  * [Tiny Tiny RSS](https://tt-rss.org/gitlab/fox/tt-rss) - Open source web-based news feed (RSS/Atom) reader and aggregator. ([Demo](http://framanews.org/)) `GPLv3` `PHP`
    ...
    * [ttrss-mobile ★180](https://github.com/mboinet/ttrss-mobile) - A mobile webapp for Tiny Tiny RSS. `AGPLv3` `Javascript`
    * [ttrss-reader ★24](https://github.com/kucrut/ttrss-reader) - Light and responsive client for TTRSS. `GPLv2` `Javascript`
...
#### Peer-to-peer filesharing
  ...
  * [peerflix-server ★573](https://github.com/asapach/peerflix-server) - Downloads torrent files and provides a direct link download or a direct link stream. `MIT` `Nodejs`
  * [rartracker ★107](https://github.com/swetorrentking/rartracker) - Complete private bittorrent tracker. `WTFPL` `PHP`
...
#### Single-click/drag-n-drop upload
  ...
  * [BoZoN ★210](https://github.com/broncowdd/BoZoN) - Minimalist Drag & drop file sharing app. `AGPLv3` `PHP`
  ...
  * [droppy ★318](https://github.com/silverwind/droppy) - droppy is a self-hosted cloud server with an interface similar to desktop file managers and has capabilites to edit files on-the-fly as well as view and playback media directly in the browser. ([Demo](http://droppy.silverwind.io/)) `BSD` `Nodejs`
  * [FileShelter ★23](https://github.com/epoupon/fileshelter) - FileShelter is a self-hosted software that allows you to easily share files over the Internet. ([Demo](http://fileshelter.suroot.com/)) `GPLv3` `C++`
  * [img.bi ★184](https://github.com/imgbi/img.bi) - img.bi is a secure image hosting. Images are encrypted using AES-256 with random key in browser before upload. `GPLv3` `Nodejs`
  ...
  * [linx ★276](https://github.com/andreimarcu/linx-server) - File sharing application and pastebin with API, auto-expiry, deletion keys, and web seed support. ([Demo](https://linx.li/)) `GPLv3` `Go`
  ...
  * [lutim ★125](https://github.com/ldidry/lutim) - Let's Upload That Image. `AGPLv3` `Perl`
  ...
  * [Nimbus ★140](https://github.com/ethanal/nimbus) - A drag-and-drop shortlink file sharer for OS X. `MIT` `Python`
  * [OnionShare ★1871](https://github.com/micahflee/onionshare) - Securely and anonymously share a file of any size. `GPLv2` `Python`
  ...
  * [Pomf ★145](https://github.com/Pomf/Pomf) - Simple file uploading and sharing, source for the now shut down site Pomf.se. `MIT` `PHP`
  ...
  * [PsiTransfer ★208](https://github.com/psi-4ward/psitransfer) - Simple open source self-hosted file sharing solution with robust up-/download-resume and password protection. ([Demo](https://transfer.psi.cx/)) `BSD` `Nodejs`
  ...
  * [Up1 ★504](https://github.com/Upload/Up1) - A Client-side Encrypted Image Host. ([Demo](https://up1.ca/)) `MIT` `Nodejs`
...
**[`^        back to top        ^`](#)**
  ...
  * [A Dark Room ★3417](https://github.com/doublespeakgames/adarkroom) - A minimalist text adventure game for your browser. ([Demo](http://adarkroom.doublespeakgames.com/)) `MPLv2` `HTML5`
  * [Agar.IO Clone ★1761](https://github.com/huytd/agar.io-clone) - Agar.io clone written with Socket.IO and HTML5 canvas. `MIT` `Nodejs`
  * [battlecraft ★1](https://github.com/jbreindel/battlecraft) - A fully distributed multiplayer browser game. ([Demo](http://battlecraft.online)) `Apache` `Erlang`
  * [Clumsy Bird ★1067](https://github.com/ellisonleao/clumsy-bird) - A MelonJS port of the famous Flappy Bird Game. ([Demo](http://www.ellison.rocks/clumsy-bird/)) `MIT` `Nodejs`
  * [Hextris ★1221](https://github.com/Hextris/hextris) - Fast paced HTML5 puzzle game inspired by Tetris. ([Demo](http://hextris.io/)) `GPLv3` `HTML5`
...
**[`^        back to top        ^`](#)**
  ...
  * [GateOne](http://liftoffsoftware.com/Products/GateOne) - Gate One is an HTML5 web-based terminal emulator and SSH client. ([Source Code ★4375](https://github.com/liftoff/GateOne)) `AGPLv3` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [IceHrm](https://icehrm.com/) - IceHrm employee management system allows companies to centralize confidential employee information. ([Demo](https://icehrm.com/demo.php), [Source Code ★85](https://github.com/gamonoid/icehrm)) `Apache` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [RELATE](https://documen.tician.de/relate/) - RELATE is a web-based courseware package, includes features such as: flexible rules, statistics, multi-course support, class calender. ([Source Code ★108](https://github.com/inducer/relate)) `MIT` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [OwnTracks Recorder ★181](https://github.com/owntracks/recorder) `⚠` - Store and access data published by [OwnTracks](http://owntracks.org/) location tracking apps. `GPLv2` `C`/`Lua`
...
### Audio Streaming
  ...
  * [Mopidy](http://mopidy.readthedocs.org/) - Extensible music server. Offers a superset of the mpd API, as well as integration with 3rd party services like Spotify, SoundCloud etc. ([Source Code](https://github.com/mopidy/mopidy)) `Apache` `Python`
   * [Moped ★337](https://github.com/martijnboland/moped) - Responisve HTML5 + Javascript client for the Mopidy music server. `MIT` `HTML5`
   * [Mopidy MusicBox ★278](https://github.com/pimusicbox/mopidy-musicbox-webclient) - Web Client for Mopidy Music Server. `Apache` `HTML5`
   * [Mopidy-Party ★35](https://github.com/Lesterpig/mopidy-party) - Mopidy web extension designed for party! Let your guests manage the sound. `Apache` `Python`
...
### Video Streaming
  ...
  * [CyTube ★518](https://github.com/calzoneman/sync) - CyTube is a web application providing media synchronization, chat, and more for an arbitrary number of channels. ([Demo](http://cytu.be)) `MIT` `Nodejs`
  ...
  * [Streama ★6260](https://github.com/dularion/streama) - Self-hosted Netflix alternative. `MIT` `Java`
...
**[`^        back to top        ^`](#)**
  ...
  * [Flox ★221](https://github.com/devfake/flox) `⚠` - Self hosted movie, TV series and anime watch list with a 3-point rating system. Uses The Movie Database backend for information. ([Demo](http://80.240.132.120/flox-demo/public/)) `MIT` `PHP`
  ...
  * [google-webfonts-helper ★1869](https://github.com/majodev/google-webfonts-helper) `⚠` - A Hassle-Free Way to Self-Host Google Fonts. Get eot, ttf, svg, woff and woff2 files + CSS snippets. ([Demo](https://google-webfonts-helper.herokuapp.com/)) `MIT` `Nodejs`
  * [King Phisher ★358](https://github.com/securestate/king-phisher) - King Phisher is a tool for testing and promoting user awareness by simulating real world phishing attacks. `BSD` `Python`
  ...
  * [Mindmaps ★1069](https://github.com/drichard/mindmaps) - An open source, offline capable, mind mapping application. ([Demo](http://drichard.org/mindmaps/)) `AGPLv3` `HTML5`
  ...
  * [Trello Burndown ★3](https://github.com/swordbeta/trello-burndown) `⚠` - An easy to use SCRUM burndown chart for Trello boards. `MIT` `Go/Docker`
...
See also https://github.com/n1trux/awesome-sysadmin#it-asset-management
  ...
  * [Benedetto ★276](https://github.com/arecker/bennedetto) - Bennedetto is a simple, turn-based budget management app. `GPLv3` `Python`
  ...
  * [ExMoney ★58](https://github.com/gaynetdinov/ex_money) - A [work-in-progress] self-hosted personal finance app. `ISC` `Elixir`
  ...
  * [Hospital Run](http://hospitalrun.io/) - Hospital Run is offline enabled hospital management software. ([Source Code ★268](https://github.com/HospitalRun/hospitalrun-server), [Demo](http://hospitalrun.io/demo/)) `GPLv3` `Nodejs`
...
*See also [Wikis](#wikis)*
  ...
  * [dillinger](http://dillinger.io/) - The last Markdown editor, ever. ([Source Code ★5359](https://github.com/joemccann/dillinger)) `MIT` `Nodejs`
  ...
  * [minimalist-web-notepad ★63](https://github.com/pereorga/minimalist-web-notepad) - A minimalist notepad.cc clone. `Apache` `PHP`
  * [notes ★12](https://github.com/SSilence/notes) - Simple script for personal notes with a single page with a WYSIWYG Editor. `GPLv3` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [EtherDraw ★332](https://github.com/JohnMcLear/draw) - An intuitive collaborative drawing web based tool. ([Demo](http://draw.etherpad.org/)) `Apache` `Nodejs`
 ...
 * [Teampass](http://teampass.net/) - Password manager dedicated for managing passwords in a collaborative way on any server Apache, MySQL and PHP. ([Source Code ★636](https://github.com/nilsteampassnet/TeamPass)) `GPLv3` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [0bin ★608](https://github.com/sametmax/0bin) - Client side encrypted pastebin. `WTFPL` `Python`
  ...
  * [SharpPaste ★2](https://github.com/phonicmouse/SharpPaste) - A simple and modern open-source pastebin made with C# and NancyFX that just works. `MIT` `C#/ASP.NET`
  * [snipt](https://snipt.net/) - Long-term memory for coders. Share and store code snippets. ([Source Code ★219](https://github.com/nicksergeant/snipt)) `BSD` `Python`
  ...
  * [Stikked ★583](https://github.com/claudehohl/Stikked) - An advanced and beautiful pastebin. `GPLv3` `PHP`
  * [tastebin ★18](https://github.com/andreineculau/tastebin) - Updated version of hastebin plus additional features. `Apache` `Nodejs`
...
**[`^        back to top        ^`](#)**
  ...
  * [Dj Diabetes ★29](https://github.com/foxmask/dj-diabetes) - My Glucose Manager - follow your daily health. `BSD` `Python`
  ...
  * [Homepage ★34](https://github.com/thetomester13/homepage) - A simple, standalone, self-hosted PHP page that is your window to your server and the web. `MIT` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Photato ★24](https://github.com/trebonius0/Photato) - A self-hosted photo gallery, accessible through a responsive WebUI. Directly uses and indexes a specific folder in the filesystem. `AGPLv3` `Java`
  ...
  * [PhotoLight ★13](https://github.com/thibaud-rohmer/PhotoLight) - The easiest photo gallery there is. `GPLv3` `PHP`
  ...
  * [sigal ★332](https://github.com/saimn/sigal) - Yet another simple static gallery generator. `MIT` `Python`
...
**[`^        back to top        ^`](#)**
  ...
  * [PHPBack](http://www.phpback.org) - The open source feedback system. ([Demo](http://www.phpback.org/demo/), [Source Code ★204](https://github.com/ivandiazwm/phpback)) `GPLv3` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [miniProxy](https://github.com/joshdick/miniProxy/) - Simple web proxy written in PHP that can allow you to bypass Internet content filters, or to browse the internet anonymously. Only one php file. ([Source Code ★282](https://github.com/joshdick/miniProxy)) `GPLv3` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Searx ★1757](https://github.com/asciimoo/searx) - A privacy-respecting, hackable metasearch engine. ([Demo](https://searx.me/)) `AGPLv3` `Python`
...
See also [Ticketing](#ticketing), [Task management/To-do lists](#task-managementto-do-lists)*
  ...
  * [Gitprep](http://gitprep.yukikimoto.com/) - Portable Github clone. ([Source Code ★694](https://github.com/yuki-kimoto/gitprep), [Demo](http://perlcodesample.sakura.ne.jp/gitprep/gitprep.cgi)) `GPL` `Perl`
  * [Git WebUI ★437](https://github.com/alberthier/git-webui) - A standalone web based user interface for git repositories. `Apache` `Python`
  * [Gogs ★18892](https://github.com/gogits/gogs) - A painless self-hosted Git Service written in Go. ([Demo](https://try.gogs.io/)) `MIT` `Go`
  ...
  * [Klaus ★420](https://github.com/jonashaag/klaus) - A simple, easy-to-set-up Git web viewer that Just Works. ([Demo](http://klausdemo.lophus.org/)) `ISC` `Python`
...
### IDE/Tools
  ...
  * [Regexr](http://regexr.com/) - RegExr is a HTML/JS based tool for creating, testing, and learning about Regular Expressions. ([Source Code ★3596](https://github.com/gskinner/regexr)) `MIT` `Nodejs`
  * [RStudio Server](https://www.rstudio.com/products/rstudio/#Server) - Web browser based IDE for R. ([Source Code ★1707](https://github.com/rstudio/rstudio)) `AGPLv3` `Java/C++`
  * [Wide ★2005](https://github.com/b3log/wide) - A Web-based IDE for Teams using Go programming language/Golang. ([Demo](http://wide.b3log.org/signup)) `Apache` `Go`
...
### Continuous Integration
  ...
  * [Jenkins](https://jenkins-ci.org/) - Continuous Integration Server. ([Source Code ★8383](https://github.com/jenkinsci/jenkins)) `MIT` `Java`
 ...
 * [Endpoint ★39](https://github.com/LINKIWI/endpoint) - Super simple mock HTTP API endpoints that return static JSON data, for testing webhooks and client libraries in development. `MIT` `Nodejs`
...
See also [Static site generators](#static-site-generators)
  ...
  * [markdown-tree ★68](https://github.com/mil/markdown-tree) - Serve a hierarchy / tree directory of markdown files. Use intended for small sites built in markdown. `MIT` `Ruby`
...
*See also [Project Management](#project-management) and [Ticketing](#ticketing).*
  ...
  * [PHP Task/Todo list ★2](https://github.com/lgg/tasks.php) - A simple task/todo list that uses a JSON text file for the tasks. `MIT` `PHP`
  ...
  * [Tasks ★292](https://github.com/thewhitetulip/Tasks) - Kanban based to-do list manager written in Go. `MIT` `Go`
  * [tasks.php ★35](https://github.com/RaymiiOrg/tasks.php) - A simple task/todo list manager. `MIT` `PHP`
...
*See also [Task management/To-do lists](#task-managementto-do-lists) and [Project Management](#project-management)*
  ...
  * [Deskulu ★453](https://github.com/Taskulu/deskulu) - Opensource helpdesk and ticketing system based on Drupal 7. ([Demo](https://help.taskulu.com)) `GPLv2` `PHP`
...
**[`^        back to top        ^`](#)**
  ...
  * [Lstu ★61](https://github.com/ldidry/lstu) - _Let's SHorten That Url_ - Lightweight URL shortener. `WTFPL` `Perl`
  * [Nimbus ★140](https://github.com/ethanal/nimbus) - A URL shortener and file sharer with a drag-and-drop OS X menu bar client and web interface. `MIT` `Python`
  ...
  * [YOURLS](http://yourls.org/) - YOURLS is a set of PHP scripts that will allow you to run Your Own URL Shortener. Features include password protection, URL customization, bookmarklets, statistics, API, plugins, jsonp. ([Source Code ★3056](https://github.com/YOURLS/YOURLS)) `MIT` `PHP`
...
See also [Documentation Generators](#documentation-generators), [Wikimatrix](http://www.wikimatrix.org/), [Wiki Engines on WikiIndex](http://wikiindex.org/Category:Wiki_Engine), [List of wiki software on wikipedia](https://en.wikipedia.org/wiki/List_of_wiki_software), [Comparison of wiki software on wikipedia](https://en.wikipedia.org/wiki/Comparison_of_wiki_software).
  ...
  * [django-wiki ★712](https://github.com/django-wiki/django-wiki) - A wiki system with complex functionality for simple integration and a superb interface. Store your knowledge with style: Use django models. ([Demo](https://demo.django.wiki/)) `GPLv3` `Python`
  ...
  * [Gitit ★1360](https://github.com/jgm/gitit) - A wiki program that stores pages and uploaded files in a git repository, which can then be modified using the VCS command line tools or the wiki's web interface. `GPLv2` `Haskell`
  * [Gollum ★8172](https://github.com/gollum/gollum) - A simple, Git-powered wiki with a sweet API and local frontend. `MIT` `Ruby`
  ...
  * [Olelo ★227](https://github.com/minad/olelo) - Olelo is a wiki that stores pages in a Git repository, supports many markup styles and has an extensible, hackable architecture. ([Demo](http://gitwiki.org/)) `MIT` `Ruby`
...
**[`^        back to top        ^`](#)**
  ...
  * [FreedomBone ★89](https://github.com/bashrc/freedombone) - Home server configuration based on Debian. `GPLv3` `Shell`
  ...
  * [sovereign ★6264](https://github.com/sovereign/sovereign) - A set of Ansible playbooks to build and maintain your own private cloud: email, calendar, contacts, file sync, IRC bouncer, VPN, and more. `GPLv3` `YAML/Other`
 ...
 * [Awesome Big Data ★4544](https://github.com/onurakpolat/awesome-bigdata) - A curated list of awesome big data frameworks, resources and other awesomeness.
 * [Awesome Sysadmin ★5106](https://github.com/n1trux/awesome-sysadmin) - A curated list of amazingly awesome open source sysadmin resources.
