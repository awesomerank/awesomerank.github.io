...
---
# Awesome Dev Env [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★69735](https://github.com/sindresorhus/awesome)
...
* [hydra ★8](https://github.com/sdegutis/hydra) - script your desktop
  `/OSX/`
* [Keycastr ★228 ⏳1Y](https://github.com/sdeken/keycastr) - show your keys while
...
* [Zach Holman's ★4725](https://github.com/holman/dotfiles) - oh-my-zsh, osx, Zsh, vi, Ruby, Git, and more
* [Mathias Bynens's ★17868](https://github.com/mathiasbynens/dotfiles) - .files, including ~/.osx — sensible hacker defaults for OS X
* [Thoughtbot's ★4549](https://github.com/thoughtbot/dotfiles) - A set of vim, zsh, git, and tmux configuration files
...
* [atom-beautify ★1121](https://github.com/Glavin001/atom-beautify) - Beautify HTML (including Handlebars), CSS (including Sass and Less), JavaScript, and much more in Atom.
* [file-icons](https://github.com/DanBrooker/file-icons) - Adds file specific icons to atom for improved visual grepping.
* [highlight-selected ★185](https://github.com/richrace/highlight-selected) - Double click on a word to highlight it throughout the open file.
* [minimap ★560](https://github.com/atom-minimap/minimap) - A graphical map (preview) of the full source code.
...
* [atom-project-manager ★467](https://github.com/danielbrodin/atom-project-manager) - Get easy access to all your projects and manage them with project specific settings and options.
* [atom-tree-view-git-status ★17](https://github.com/subesokun/atom-tree-view-git-status) - Show the Git repository status in the Atom tree-view.
* [atom-pigments ★473](https://github.com/abe33/atom-pigments) - An Atom package to display colors in project and files.
...
* [Emmet ★5049](https://github.com/sergeche/emmet-sublime)
...
* [Sublime Git ★2724](https://github.com/kemayo/sublime-text-git) - Git Integration for Sublime.
...
* [awesome-github ★177](https://github.com/fffaraz/awesome-github) - Faraz Fallahi maintains a curated list of GitHub & Git resources.
...
* [deck.js ★5215](https://github.com/imakewebthings/deck.js) - markdown based presentation on your browser
* [vimdeck ★1092](https://github.com/tybenz/vimdeck) - present inside your Vim
...
* [awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) - List of zsh plugins usable with [zgen](https://github.com/tarjoilija/zgen) and other [oh-my-zsh ★61965](https://github.com/robbyrussell/oh-my-zsh) compatible zsh frameworks
* [fish-shell ★8539](https://github.com/fish-shell/fish-shell) - The user-friendly command line shell
...
* [oh-my-zsh ★61965](https://github.com/robbyrussell/oh-my-zsh) - A community driven framework for managing zsh configuration.
...
* [zsh quickstart kit ★121](https://github.com/unixorn/zsh-quickstart-kit) - Quick intro for getting set up with zsh and zgen
...
* [ag ★13775](https://github.com/ggreer/the_silver_searcher) - A C based code-searching tool similar to ack, but faster
...
* [oh-my-zsh ★61965](https://github.com/robbyrussell/oh-my-zsh) - the
...
* [LiveReload](http://livereload.com/) - FS watch and preprocessor as a desktop app for `/OSX/` and `/WIN/` with complementary browser extensions
  * [guard-livereload ★1934 ⏳1Y](https://github.com/guard/guard-livereload) - Guard plugin compatible with LiveReload's browser extensions
