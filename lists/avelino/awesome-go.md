...
A curated list of awesome Go frameworks, libraries and software. Inspired by [awesome-python ★36876](https://github.com/vinta/awesome-python).
...
* [flac ★48](https://github.com/mewkiz/flac) - A native Go FLAC decoder.
* [gaad ★31](https://github.com/Comcast/gaad) - A native Go AAC bitstream parser
...
* [mp3 ★58](https://github.com/tcolgate/mp3) - A native Go MP3 decoder.
...
* [authboss ★0](https://github.com/go-authboss/authboss) - A modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time.
...
* [go-jose ★702](https://github.com/square/go-jose) - A fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
* [go-oauth2-server ★604](https://github.com/RichardKnop/go-oauth2-server) - A standalone, specification-compliant,  OAuth2 server written in Golang.
...
* [sessions ★22](https://github.com/adam-hanna/sessions) - A dead simple, highly performant, highly customizable sessions service for go http servers.
* [traefik ★9077](https://github.com/containous/traefik) - A reverse proxy and load balancer with support for multiple backends.
...
* [argv ★2](https://github.com/cosiner/argv) - A Go library to split command line string as arguments array using the bash syntax.
* [cli ★290](https://github.com/mkideal/cli) - A feature-rich and easy to use command-line package based on golang tag
...
* [cobra ★4822](https://github.com/spf13/cobra) - A Commander for modern Go CLI interactions
* [complete ★186](https://github.com/posener/complete) - Write bash completions in Go + Go command bash completion.
* [docopt.go ★843](https://github.com/docopt/docopt.go) - A command-line arguments parser that will make you smile.
...
* [kingpin ★1334](https://github.com/alecthomas/kingpin) - A command line and flag parser supporting sub commands.
* [liner ★386](https://github.com/peterh/liner) - A Go readline-like library for command-line interfaces.
* [mitchellh/cli ★635](https://github.com/mitchellh/cli) - A Go library for implementing command-line interfaces.
* [mow.cli ★415](https://github.com/jawher/mow.cli) - A Go library for building CLI applications with sophisticated flag and argument parsing and validation.
* [pflag ★221](https://github.com/spf13/pflag) - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
* [readline ★837](https://github.com/chzyer/readline) - A pure golang implementation that provide most of features in GNU-Readline under MIT license.
...
* [urfave/cli ★6261](https://github.com/urfave/cli) - A simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
* [wlog ★19](https://github.com/dixonwille/wlog) - A simple logging interface that supports cross-platform color and concurrency.
* [wmenu ★32](https://github.com/dixonwille/wmenu) - An easy to use menu structure for cli applications that prompts users to make choices.
...
* [termtables](https://github.com/apcera/termtables) - A Go port of the Ruby library [terminal-tables ★907](https://github.com/tj/terminal-table) for simple ASCII table generation as well as providing markdown and HTML output.
...
* [uilive ★555](https://github.com/gosuri/uilive) - A library for updating terminal output in realtime.
* [uiprogress ★974](https://github.com/gosuri/uiprogress) - A flexible library to render progress bars in terminal applications.
* [uitable ★385 ⏳1Y](https://github.com/gosuri/uitable) - A library to improve readability in terminal apps using tabular data.
...
* [godotenv ★555](https://github.com/joho/godotenv) - A Go port of Ruby's dotenv library (Loads environment variables from `.env`.)
...
* [joshbetz/config ★139](https://github.com/joshbetz/config) - A small configuration library for Go that parses environment variables, JSON files, and reloads automatically on SIGHUP.
* [mini ★10](https://github.com/sasbury/mini) - A golang package for parsing ini-style configuration files
* [store ★206](https://github.com/tucnak/store) - A lightweight configuration manager for Go
* [viper ★3448](https://github.com/spf13/viper) - Go configuration with fangs
* [xdg ★0](https://github.com/OpenPeeDeeP/xdg) - A cross platform package that follows the [XDG Standard](https://standards.freedesktop.org/basedir-spec/basedir-spec-latest.html)
...
* [go-datastructures ★3342](https://github.com/Workiva/go-datastructures) - A collection of useful, performant, and thread-safe data structures
...
* [goskiplist ★133](https://github.com/ryszard/goskiplist) - A skip list implementation in Go.
* [gota ★304](https://github.com/kniren/gota) - An implementation of dataframes, series, and data wrangling methods for Go.
...
* [buntdb ★1524](https://github.com/tidwall/buntdb) - A fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
* [cache2go ★287](https://github.com/muesli/cache2go) - An in-memory key:value cache which supports automatic invalidation based on timeouts.
* [cockroach ★10786](https://github.com/cockroachdb/cockroach) - A Scalable, Geo-Replicated, Transactional Datastore
...
* [geocache ★67 ⏳1Y](https://github.com/melihmucuk/geocache) - An in-memory cache that is suitable for geolocation based applications.
* [go-cache](https://github.com/pmylund/go-cache) - An in-memory key:value store/cache (similar to Memcached) library for Go, suitable for single-machine applications.
* [goleveldb](https://github.com/syndtr/goleveldb) - An implementation of the [LevelDB ★10125](https://github.com/google/leveldb) key/value database in the Go.
...
* [Scribble ★66](https://github.com/nanobox-io/golang-scribble) - A tiny flat file JSON store.
...
* [Tile38 ★3288](https://github.com/tidwall/tile38) - A geolocation DB with spatial index and realtime geofencing.
...
* [go-mysql ★597](https://github.com/siddontang/go-mysql) - A go toolset to handle MySQL protocol and replication.
...
* [pgweb ★4378](https://github.com/sosedoff/pgweb) - A web-based PostgreSQL database browser
...
* [goqu ★330](https://github.com/doug-martin/goqu) - An idiomatic SQL builder and query library.
...
* NoSQL Databases
    ...
    * [redis ★537 ⏳1Y](https://github.com/hoisie/redis) - A simple, powerful Redis client for Go.
...
* Search and Analytic Databases
    * [bleve ★3413](https://github.com/blevesearch/bleve) - A modern text indexing library for go.
    ...
    * [elastigo ★871](https://github.com/mattbaird/elastigo) - A Elasticsearch client library.
    * [goes ★75](https://github.com/belogik/goes) - A library to interact with Elasticsearch.
    * [skizze ★44 ⏳1Y](https://github.com/seiflotfy/skizze) - A probabilistic data-structures service and storage.

## Date and Time

*Libraries for working with dates and times.*

* [carbon ★113](https://github.com/uniplaces/carbon) - A simple Time extension with a lot of util methods, ported from PHP Carbon library.
* [durafmt ★164](https://github.com/hako/durafmt) - A time duration formatting library for Go.
* [feiertage ★4](https://github.com/wlbr/feiertage) - A set of functions to calculate public holidays in Germany, incl. specialization on the states of Germany (Bundesländer). Things like Easter, Pentecoast, Thanksgiving...
...
* [celeriac ★26](https://github.com/svcavallar/celeriac.v1) - A library for adding support for interacting and monitoring Celery workers, tasks and events in Go
...
* [go-kit ★7400](https://github.com/go-kit/kit) - A Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
...
* [hprose ★596](https://github.com/hprose/hprose-golang) - A very newbility RPC Library, support 25+ languages now.
...
* [micro ★3409](https://github.com/micro/micro) - A pluggable microservice toolkit and distributed systems platform.
* [NATS ★3237](https://github.com/nats-io/gnatsd) - A lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
...
* [rpcx ★1288](https://github.com/smallnest/rpcx) - A distributed pluggable RPC service framework like alibaba Dubbo.
* [sleuth](https://github.com/ursiform/sleuth) - A library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ ★3567](https://github.com/zeromq/libzmq)).
...
* [go-dkim ★30](https://github.com/toorop/go-dkim) - A DKIM library, to sign & verify email.
* [go-imap ★259](https://github.com/emersion/go-imap) - An IMAP library for clients and servers
* [go-message ★21](https://github.com/emersion/go-message) - A streaming library for the Internet Message Format and mail messages
...
* [go-lua ★1017](https://github.com/Shopify/go-lua) - A port of the Lua 5.2 VM to pure Go
...
* [gopher-lua ★1724](https://github.com/yuin/gopher-lua) - a Lua 5.1 VM and compiler written in Go
* [ngaro ★8](https://github.com/db47h/ngaro) - Embeddable Ngaro VM implementation enabling scripting in Retro
* [otto ★3081](https://github.com/robertkrimen/otto) - A JavaScript interpreter written in Go
...
* [afero ★1076](https://github.com/spf13/afero) - A FileSystem Abstraction System for Go.
...
* [skywalker ★2](https://github.com/dixonwille/skywalker) - A package to allow one to concurrently go through a filesystem with ease.
* [tarfs ★10](https://github.com/posener/tarfs) - An implementation of the [`FileSystem` interface](https://godoc.org/github.com/kr/fs#FileSystem) for tar files.
...
* [nosurf ★763](https://github.com/justinas/nosurf) - A CSRF protection middleware for Go.

## Game Development

*Awesome game development libraries.*

* [Azul3D ★289](https://github.com/azul3d/engine) - A 3D game engine written in Go
* [Ebiten ★399](https://github.com/hajimehoshi/ebiten) - A simple 2D game library in Go
...
* [gonet ★833](https://github.com/xtaci/gonet) - A game server skeleton implemented with golang
* [Leaf ★1422](https://github.com/name5566/leaf) - A lightweight game server framework
* [Pixel ★624](https://github.com/faiface/pixel) - A hand-crafted 2D game library in Go
...
* [pkgreflect ★56](https://github.com/ungerik/pkgreflect) - A Go preprocessor for package scoped reflection.

## Go Compilers

*Tools for compiling Go to other languages.*

* [gopherjs ★5390](https://github.com/gopherjs/gopherjs) - A compiler from Go to JavaScript.
...
* [pool ★294](https://github.com/go-playground/pool) - a limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation.
...
* [tunny ★545](https://github.com/Jeffail/tunny) - A goroutine pool for golang.
...
* [bild ★1505](https://github.com/anthonynsimon/bild) - A collection of image processing algorithms in pure Go.
...
* [img ★105 ⏳2Y](https://github.com/hawx/img) - A selection of image manipulation tools.
...
* [pt ★1439](https://github.com/fogleman/pt) - A path tracing engine written in Go.
...
* [connectordb ★71](https://github.com/connectordb/connectordb) - An Open-Source Platform for Quantified Self & IoT.
...
* [go-cronowriter ★1](https://github.com/utahta/go-cronowriter) A simple writer that rotate log files automatically based on current date and time, like cronolog.
* [go-log ★14 ⏳3Y](https://github.com/siddontang/go-log) - Log lib supports level and multi handlers.
* [go-log ★24](https://github.com/ian-kent/go-log) - A log4j implementation in Go.
...
* [logrus ★5226](https://github.com/Sirupsen/logrus) - a structured logger for Go.
...
* [logxi ★298](https://github.com/mgutz/logxi) - A 12-factor app logger that is fast and makes you happy.
...
* [tail ★797](https://github.com/hpcloud/tail) - A Go package striving to emulate the features of the BSD tail program.
...
* [xlog ★105](https://github.com/rs/xlog) - A structured logger for `net/context` aware HTTP handlers with flexible dispatching.
...
* [neural-go ★54 ⏳3Y](https://github.com/schuyler/neural-go) - A multilayer perceptron network implemented in Go, with training via backpropagation.
...
* [guble ★98](https://github.com/smancke/guble) - A messaging server using push notifications (Google Firebase Cloud Messaging, Apple Push Notification services, SMS) as well as websockets, a REST API, featuring distributed operation and message-persistence.
* [machinery ★1617](https://github.com/RichardKnop/machinery) - An asynchronous task queue/job queue based on distributed message passing.
...
* [sarama ★2020](https://github.com/Shopify/sarama) - A Go library for Apache Kafka.
* [Uniqush-Push ★912](https://github.com/uniqush/uniqush-push) - A redis backed unified push service for server-side notifications to mobile devices.
...
* [errors ★2097](https://github.com/pkg/errors) - A package that provides simple error handling primitives.
* [go-chat-bot ★222](https://github.com/go-chat-bot/bot) - IRC, Slack & Telegram bot written in Go.
* [go-commons-pool ★371](https://github.com/jolestar/go-commons-pool) - A generic object pool for Golang.
* [go-multierror ★321](https://github.com/hashicorp/go-multierror) - A Go (golang) package for representing a list of errors as a single error.
...
* [go-sarah ★12](https://github.com/oklahomer/go-sarah) - A framework to build bot for desired chat services including LINE, Slack, Gitter and more.
...
* [gopsutil ★1825](https://github.com/shirou/gopsutil) - A cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
* [gosms ★1029](https://github.com/haxpax/gosms) - Your own local SMS gateway in Go that can be used to send SMS
* [gountries ★128](https://github.com/pariz/gountries) - A package that exposes country and subdivision data.
* [hanu ★31](https://github.com/sbstjn/hanu) - Framework for writing Slack bots.
* [health ★238](https://github.com/dimiro1/health) - A Easy to use, extensible health check library.
* [indigo ★22](https://github.com/osamingo/indigo) - A distributed unique ID generator of using Sonyflake and encoded by Base58.
* [jobs ★397](https://github.com/albrow/jobs) - A persistent and flexible background jobs library.
* [margelet ★46](https://github.com/zhulik/margelet) - A framework for building Telegram bots.
* [secdl ★5 ⏳1Y](https://github.com/xor-gate/secdl) - Lighttpd ModSecDownload algorithm ported to go to secure download urls.
* [slacker ★101](https://github.com/shomali11/slacker) - An easy to use framework to create Slack bots
...
* [xstrings ★385 ⏳1Y](https://github.com/huandu/xstrings) - A collection of useful string functions ported from other languages.
...
* [go-i18n ★456](https://github.com/nicksnyder/go-i18n) - A package and an accompanying tool to work with localized text.
...
* [gojieba](https://github.com/yanyiwu/gojieba) - This is a Go implementation of [jieba ★9445](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.
...
* [prose ★176](https://github.com/jdkato/prose) - A library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more.
* [RAKE.go ★17](https://github.com/Obaied/RAKE.go) - A Go port of the Rapid Automatic Keyword Extraction Algorithm (RAKE)
...
* [sentences ★205](https://github.com/neurosnap/sentences) - A sentence tokenizer:  converts text into a list of sentences.
...
* [whatlanggo ★218](https://github.com/abadojack/whatlanggo) - A natural language detection package for Go. Supports 84 languages and 24 scripts (writing systems e.g. Latin, Cyrillic, etc).
* [when ★727](https://github.com/olebedev/when) - A natural EN and RU language date/time parser with pluggable rules
...
* [go-getter ★354](https://github.com/hashicorp/go-getter) - A Go library for downloading files or directories from various sources using a URL.
* [go-stun ★154](https://github.com/ccding/go-stun) - A go implementation of the STUN client (RFC 3489 and RFC 5389).
...
* [gopacket ★1346](https://github.com/google/gopacket) - A Go library for packet processing with libpcap bindings
* [gopcap ★272](https://github.com/akrennmair/gopcap) - A Go wrapper for libpcap
...
* [gotcp ★276](https://github.com/gansidui/gotcp) - A Go package for quickly writing tcp applications
...
* [kcp-go ★711](https://github.com/xtaci/kcp-go) - KCP - A Fast and Reliable ARQ Protocol.
* [kcptun ★5852](https://github.com/xtaci/kcptun) - An extremely simple & fast udp tunnel based on KCP protocol
* [lhttp ★338](https://github.com/fanux/lhttp) - A powerful websocket framework, build your IM server more easily.
...
* [tcp_server ★131](https://github.com/firstrow/tcp_server) - A Go library for building tcp servers faster.
* [utp ★104](https://github.com/anacrolix/utp) - Go uTP micro transport protocol implementation.
* [water ★249](https://github.com/songgao/water) - A simple TUN/TAP library
* [winrm ★123](https://github.com/masterzen/winrm) - A Go WinRM client to remotely execute commands on Windows machines
* [xtcp ★17](https://github.com/xfxdev/xtcp) - A TCP Server Framework with simultaneous full duplex communication,graceful shutdown,custom protocol.
...
* [go-store ★81](https://github.com/gosuri/go-store) - A simple and fast Redis backed key-value store library for Go.
* [gomodel ★54](https://github.com/cosiner/gomodel) - A lightweight, fast, orm-like library helps interactive with database.
...
* [reform ★539](https://github.com/go-reform/reform) - A better ORM for Go, based on non-empty interfaces and code generation.
* [SQLBoiler ★0](https://github.com/vattle/sqlboiler) - An ORM generator. Generate a featureful and blazing-fast ORM tailored to your database schema.
...
* [Zoom ★161 ⏳1Y](https://github.com/albrow/zoom) - A blazing-fast datastore and querying engine built on Redis.
...
* [graphql-go ★1694](https://github.com/graphql-go/graphql) - An implementation of GraphQL for Go.
...
* [evaler ★30](https://github.com/soniah/evaler) - A simple floating point arithmetic expression evaluator
...
* [goraph ★391](https://github.com/gyuho/goraph) - A pure Go graph theory library(data structure, algorith visualization)
* [gostat ★18 ⏳2Y](https://github.com/ematvey/gostat) - A statistics library for the go language
* [graph ★10](https://github.com/yourbasic/graph) - A library of basic graph algorithms
...
* [stats ★739](https://github.com/montanaflynn/stats) - A statistics package with common functions missing from the Golang standard library.
...
* [BadActor ★210](https://github.com/jaredfolkins/badactor) - An in-memory, application-driven jailer built in the spirit of fail2ban
...
* [simple-scrypt ★113](https://github.com/elithrar/simple-scrypt) - an scrypt package with a simple, obvious API and automatic cost calibration built-in.
...
* [colfer ★248](https://github.com/pascaldekloe/colfer) - Code generation for the Colfer binary format
...
* [jsoniter ★931](https://github.com/json-iterator/go) - A high-performance 100% compatible drop-in replacement of "encoding/json"
...
* [devd ★2370](https://github.com/cortesi/devd) - A local webserver for developers
* [etcd ★14344](https://github.com/coreos/etcd) - A highly-available key value store for shared configuration and service discovery.
* [minio ★7616](https://github.com/minio/minio) - Minio is a distributed object storage server.
* [nsq](http://nsq.io/) - A realtime distributed messaging platform
* [yakvs ★18](https://github.com/sci4me/yakvs) - A small, networked, in-memory key-value store.
...
* [ego ★319](https://github.com/benbjohnson/ego) - A lightweight templating language that lets you write templates in Go. Templates are translated into Go and compiled.
...
* [gofpdf ★684](https://github.com/jung-kurt/gofpdf) - A PDF document generator with high level support for text, drawing and images.
...
* [liquid ★20](https://github.com/osteele/liquid) - A Go implementation of Shopify Liquid templates.
* [mustache ★846](https://github.com/hoisie/mustache) - A Go implementation of the Mustache template language.
* [pongo2 ★1004](https://github.com/flosch/pongo2) - A Django-like template-engine for Go.
...
* [raymond ★182](https://github.com/aymerick/raymond) - A complete handlebars implementation in Go.
...
* [velvet ★52](https://github.com/gobuffalo/velvet) - A complete handlebars implementation in Go.
...
* Testing Frameworks
    ...
    * [frisby ★200](https://github.com/verdverm/frisby) - a REST API testing framework
    ...
    * [Testify ★3524](https://github.com/stretchr/testify) - A sacred extension to the standard go testing package.
    * [wstest ★20](https://github.com/posener/wstest) - A websocket client for unit-testing a websocket http.Handler.
...
* Fuzzing and delta-debugging/reducing/shrinking
    * [go-fuzz ★1921](https://github.com/dvyukov/go-fuzz) - A randomized testing system
    * [gofuzz ★336](https://github.com/google/gofuzz) - A library for populating go objects with random values
    * [Tavor ★165](https://github.com/zimmski/tavor) - A generic fuzzing and delta-debugging framework
...
* Selenium and browser control tools
    ...
    * [chromedp ★1363](https://github.com/knq/chromedp) - a way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
    * [ggr ★4](https://github.com/aandryashin/ggr) - a lightweight server that routes and proxies Selenium Wedriver requests to multiple Selenium hubs.
...
* Specific Formats
    ...
    * [goregen ★26 ⏳1Y](https://github.com/zach-klippenstein/goregen) - A library for generating random strings from regular expressions.
    ...
    * [sh ★585](https://github.com/mvdan/sh) - A shell parser and formatter
    * [slug ★122](https://github.com/gosimple/slug) - URL-friendly slugify with multiple languages support.
    * [Slugify ★13 ⏳2Y](https://github.com/avelino/slugify) - A Go slugify application that handles string.
...
* Utility
    ...
    * [radix ★23](https://github.com/yourbasic/radix) - A fast string sorting algorithm.
...
* [anaconda ★746](https://github.com/ChimeraCoder/anaconda) - A Go client library for the Twitter 1.1 API
* [aws-sdk-go ★3323](https://github.com/aws/aws-sdk-go) - The official AWS SDK for the Go programming language.
...
* [circleci ★13](https://github.com/jszwedko/go-circleci) - A Go client library for interacting with CircleCI's API
...
* [go-marathon ★144](https://github.com/gambol99/go-marathon) - A Go library for interacting with Mesosphere's Marathon PAAS.
* [go-myanimelist ★9](https://github.com/nstratos/go-myanimelist) - A Go client library for accessing the [MyAnimeList API](http://myanimelist.net/modules.php?go=api).
...
* [Medium ★78](https://github.com/Medium/medium-sdk-go) - A Golang SDK for Medium's OAuth2 API.
* [megos ★47](https://github.com/andygrunwald/megos) - A client library for accessing an [Apache Mesos](http://mesos.apache.org/) cluster
...
* [apm ★89](https://github.com/topfreegames/apm) - A process manager for Golang applications with an HTTP API.
...
* [fzf ★9711](https://github.com/junegunn/fzf) - A command-line fuzzy finder written in Go
...
* [go-cron ★146 ⏳2Y](https://github.com/rk/go-cron) - A simple Cron library for go that can execute closures or functions at varying intervals, from once a second to once a year on a specific date and time. Primarily for web applications and long running daemons.
...
* [go-funk ★256](https://github.com/thoas/go-funk) - A modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...)
* [go-httpheader ★8](https://github.com/mozillazg/go-httpheader) - A Go library for encoding structs into Header fields.
* [go-rate ★217 ⏳2Y](https://github.com/beefsack/go-rate) -  A timed rate limiter for Go.
...
* [go-underscore ★909 ⏳2Y](https://github.com/tobyhede/go-underscore) - A useful collection of helpfully functional Go collection utilities.
...
* [grequests ★899](https://github.com/levigross/grequests) - An elegant and simple `net/http` wrapper that follows Python's requests library
...
* [immortal ★406](https://github.com/immortal/immortal) - A *nix cross-platform (OS agnostic) supervisor
...
* [jsonhal ★4](https://github.com/RichardKnop/jsonhal) - A simple Go package to make custom structs marshal into HAL compatible JSON responses.
...
* [mc ★531](https://github.com/minio/mc) - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
* [mergo ★301](https://github.com/imdario/mergo) - A helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
* [moldova ★134](https://github.com/StabbyCutyou/moldova) - A utility for generating random data based on an input template.
...
* [onecache ★53](https://github.com/adelowo/onecache) - A caching library with support for multiple backend stores (Redis, Memcached, filesystem etc)
...
* [UNIS ★63](https://github.com/esemplastic/unis) - A Common Architecture™ for String Utilities in Go.
* [usql ★2040](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.
* [util ★22](https://github.com/shomali11/util) - A collection of useful utility functions. (strings, concurrency, manipulations, ...)
...
* [v4l ★11](https://github.com/korandiz/v4l) - A video capture library for Linux, written in Go.
...
* [Air ★39](https://github.com/sheng/air) - An ideal RESTful web framework for Go.
...
* [Fireball ★23](https://github.com/zpatrick/fireball) - A more "natural" feeling web framework.
* [Florest ★30](https://github.com/jabong/florest-core) - High-performance workflow based REST API framework
* [Gem ★142](https://github.com/go-gem/gem) - A simple and fast web framework, friendly to REST API.
...
* [go-json-rest ★2848](https://github.com/ant0ine/go-json-rest) - A quick and easy way to setup a RESTful JSON API.
* [go-relax ★142](https://github.com/codehack/go-relax) - A framework of pluggable components to build RESTful API's.
* [go-rest ★102](https://github.com/ungerik/go-rest) - A small and evil REST framework for Go.
* [goa](https://github.com/raphael/goa) - Framework for developing microservices based on the design of Ruby's Praxis.
* [Goat ★137](https://github.com/bahlo/goat) - A minimalistic REST API server in Go.
...
* [gongular ★377](https://github.com/mustafaakin/gongular) - A fast Go web framework with input mapping/validation and (DI) Dependency Injection
...
* [Revel ★8573](https://github.com/revel/revel) - A high-productivity web framework for the Go language.
...
* [tigertonic ★945](https://github.com/rcrowley/go-tigertonic) - A Go framework for building JSON web services inspired by Dropwizard
* [traffic ★513 ⏳1Y](https://github.com/pilu/traffic) - Sinatra inspired regexp/pattern mux and web framework for Go.
* [utron ★1904](https://github.com/gernest/utron) - A lightweight MVC framework for Go(Golang).
...
* [stats ★429 ⏳1Y](https://github.com/thoas/stats) - A Go middleware that stores various information about your web application.
...
* [alien ★78](https://github.com/gernest/alien) - A lightweight and fast http router from outer space
...
* [fasthttprouter ★335](https://github.com/buaazp/fasthttprouter) - A high performance router forked from `httprouter`. The first router fit for `fasthttp`.
* [gocraft/web ★1224](https://github.com/gocraft/web) - A mux and middleware package in Go.
...
* [gowww/router ★121](https://github.com/gowww/router) - A lightning fast HTTP router fully compatible with the net/http.Handler interface.
* [httprouter ★5332](https://github.com/julienschmidt/httprouter) - A high performance router. Use this and the standard http handlers to form a very high performance web framework.
...
* [mux ★4269](https://github.com/gorilla/mux) - A powerful URL router and dispatcher for golang.
...
* [vestigo ★164](https://github.com/husobee/vestigo) -  A performant, stand-alone, HTTP compliant URL Router for go web applications.
* [xmux ★72](https://github.com/rs/xmux) - A high performance muxer based on `httprouter` with `net/context` support.
...
* [dupl ★87](https://github.com/mibk/dupl) - A tool for code clone detection.
...
* [gostatus ★206](https://github.com/shurcooL/gostatus) - A command line tool, shows the status of repositories that contain Go packages.
* [interfacer ★650](https://github.com/mvdan/interfacer) - A linter that suggests interface types.
...
* [Goclipse ★702](https://github.com/GoClipse/goclipse) - An Eclipse plugin for Go.
* [gocode ★3793](https://github.com/nsf/gocode) - An autocompletion daemon for the Go programming language.
* [GoSublime ★2659](https://github.com/DisposaBoy/GoSublime) - A Golang plugin collection for the text editor SublimeText 2 providing code completion and other IDE-like features.
* [velour ★14 ⏳1Y](https://github.com/velour/velour) - An IRC client for the acme editor.
* [vim-compiler-go ★72 ⏳1Y](https://github.com/rjohnsondev/vim-compiler-go) - A Vim plugin to highlight syntax errors on save.
* [vim-go ★6932](https://github.com/fatih/vim-go) - Go development plugin for Vim.
* [vscode-go ★2700](https://github.com/Microsoft/vscode-go) - An extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [awsenv ★11](https://github.com/soniah/awsenv) - a small binary that loads Amazon (AWS) environment variables for a profile.
...
* [Gitea ★3294](https://github.com/go-gitea/gitea) - A fork of Gogs, entirely community driven.
...
* [gox ★2244](https://github.com/mitchellh/gox) - A dead simple, no frills Go cross compile tool.
...
* [Moby ★44827](https://github.com/moby/moby) - A collaborative project for the container ecosystem to assemble container-based systems
...
* [s3gof3r ★834](https://github.com/rlmcpherson/s3gof3r) - A small utility/library optimized for high speed transfer of large objects into and out of Amazon S3.
...
* [winrm-cli ★21](https://github.com/masterzen/winrm-cli) - A cli tool to remotely execute commands on Windows machines
...
* [Cherry ★127](https://github.com/rafael-santiago/cherry) - A tiny webchat server in Go.
...
* [fleet ★2398](https://github.com/coreos/fleet) - A Distributed init System.
* [Go Package Store ★762](https://github.com/shurcooL/Go-Package-Store#go-package-store-) - An app that displays updates for the Go packages in your GOPATH.
...
* [ipe ★197](https://github.com/dimiro1/ipe) - An open source Pusher server implementation compatible with Pusher client libraries written in GO.
* [JayDiff ★7](https://github.com/yazgazan/jaydiff) - A JSON diff utility written in Go.
* [Juju](https://jujucharms.com/) - Cloud-agnostic service deployment and orchestration - supports EC2, Azure, Openstack, MAAS and more.
* [Leaps ★478](https://github.com/jeffail/leaps) - A pair programming service using Operational Transforms.
...
* [nes ★2774](https://github.com/fogleman/nes) - A Nintendo Entertainment System (NES) emulator written in Go.
* [orange-cat ★153 ⏳1Y](https://github.com/noraesae/orange-cat) - A Markdown previewer written in Go.
...
* [snap ★1538](https://github.com/intelsdi-x/snap) - A powerful telemetry framework.
...
* [go-benchmarks ★72 ⏳1Y](https://github.com/tylertreat/go-benchmarks) - A few miscellaneous Go microbenchmarks. Compare some language features to alternative approaches.
...
* [Awesome Remote Job ★9558](https://github.com/lukasz-madon/awesome-remote-job) - A curated list of awesome remote jobs. A lot of them is looking for Go hackers.
* [awesome-awesomeness ★19353](https://github.com/bayandin/awesome-awesomeness) - List of other amazingly awesome lists.
...
* [golang-graphics ★112 ⏳1Y](https://github.com/mholt/golang-graphics) - A collection of Go images, graphics, and art.
...
* [Build web application with Golang ★17203](https://github.com/astaxie/build-web-application-with-golang) - A golang ebook intro how to build a web app with golang.
* [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin) - Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
* [Go By Example](https://gobyexample.com/) - A hands-on introduction to Go using annotated example programs.
* [Go Cheat Sheet ★2218](https://github.com/a8m/go-lang-cheat-sheet) - A Go's reference card.
* [Go database/sql tutorial](http://go-database-sql.org/) - Introduction to database/sql.
* [Golangbot](https://golangbot.com/learn-golang-series/) - Tutorials to get started with programming in Go.
* [How to Use Godog for Behavior-driven Development in Go](https://semaphoreci.com/community/tutorials/how-to-use-godog-for-behavior-driven-development-in-go) - Get started with Godog — a Behavior-driven development framework for building and testing Go applications.
* [Working with Go ★750](https://github.com/mkaz/working-with-go) - An intro to go for experienced programmers.
---
<p align="center">
	This list is a copy of <a href="https://github.com/avelino/awesome-go">avelino/awesome-go</a> with ranks
</p>
