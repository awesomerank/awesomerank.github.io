...
* [mix ★60](https://github.com/go-mix/mix) - Sequence-based Go-native audio mixer for music apps.
* [mp3 ★59](https://github.com/tcolgate/mp3) - Native Go MP3 decoder.
* [music-theory ★166 ⏳1Y](https://github.com/go-music-theory/music-theory) - Music theory models in Go.
...
* [go-jose ★706](https://github.com/square/go-jose) - Fairly complete implementation of the JOSE working group's JSON Web Token, JSON Web Signatures, and JSON Web Encryption specs.
* [go-oauth2-server ★606](https://github.com/RichardKnop/go-oauth2-server) - Standalone, specification-compliant,  OAuth2 server written in Golang.
* [go.auth ★348 ⏳2Y](https://github.com/bradrydzewski/go.auth) - Authentication API for Go web applications.
* [gologin ★766](https://github.com/dghubble/gologin) - chainable handlers for login with OAuth1 and OAuth2 authentication providers.
* [gorbac ★581](https://github.com/mikespook/gorbac) - provides a lightweight role-based access control (RBAC) implementation in Golang.
* [goth ★1274](https://github.com/markbates/goth) - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple provides out of the box.
...
* [jwt-go ★2408](https://github.com/dgrijalva/jwt-go) - Golang implementation of JSON Web Tokens (JWT).
* [loginsrv ★390](https://github.com/tarent/loginsrv) - JWT login microservice with plugable backends such as OAuth2 (Github), htpasswd, osiam.
* [oauth2 ★1220](https://github.com/golang/oauth2) - Successor of goauth2. Generic OAuth 2.0 package that comes with JWT, Google APIs, Compute Engine and App Engine support.
* [osin ★1200](https://github.com/RangelReale/osin) - Golang OAuth2 server library.
...
* [traefik ★9159](https://github.com/containous/traefik) - Reverse proxy and load balancer with support for multiple backends.
...
* [cli ★293](https://github.com/mkideal/cli) - Feature-rich and easy to use command-line package based on golang tag
* [cli-init ★723](https://github.com/tcnksm/gcli) - The easy way to start building Golang command line application.
* [climax](http://github.com/tucnak/climax) - Alternative CLI with "human face", in spirit of Go command
* [cobra ★4859](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions
* [complete ★187](https://github.com/posener/complete) - Write bash completions in Go + Go command bash completion.
* [docopt.go ★844](https://github.com/docopt/docopt.go) - Command-line arguments parser that will make you smile.
* [drive ★3393](https://github.com/odeke-em/drive) - Google Drive client for the commandline
* [flag ★69](https://github.com/cosiner/flag) - Simple but powerful command line option parsing library for Go support subcommand
* [go-arg ★420](https://github.com/alexflint/go-arg) - Struct-based argument parsing in Go
* [go-flags ★846](https://github.com/jessevdk/go-flags) - go command line option parser
* [kingpin ★1341](https://github.com/alecthomas/kingpin) - Command line and flag parser supporting sub commands.
* [liner ★389](https://github.com/peterh/liner) - Go readline-like library for command-line interfaces.
* [mitchellh/cli ★642](https://github.com/mitchellh/cli) - Go library for implementing command-line interfaces.
* [mow.cli ★416](https://github.com/jawher/mow.cli) - Go library for building CLI applications with sophisticated flag and argument parsing and validation.
* [pflag ★225](https://github.com/spf13/pflag) - Drop-in replacement for Go's flag package, implementing POSIX/GNU-style --flags.
* [readline ★842](https://github.com/chzyer/readline) - Pure golang implementation that provide most of features in GNU-Readline under MIT license.
...
* [urfave/cli ★6279](https://github.com/urfave/cli) - Simple, fast, and fun package for building command line apps in Go (formerly codegangsta/cli).
...
* [aurora ★240](https://github.com/logrusorgru/aurora) - ANSI terminal colors that supports fmt.Printf/Sprintf
* [chalk ★205 ⏳1Y](https://github.com/ttacon/chalk) - Intuitive package for prettifying terminal/console output.
* [color ★1743](https://github.com/fatih/color) - Versatile package for colored terminal output.
...
* [go-colorable ★192](https://github.com/mattn/go-colorable) - Colorable writer for windows.
* [go-colortext ★158](https://github.com/daviddengcn/go-colortext) - Go library for color output in terminals.
* [go-isatty ★168](https://github.com/mattn/go-isatty) - isatty for golang.
* [gocui ★1822](https://github.com/jroimartin/gocui) - Minimalist Go library aimed at creating Console User Interfaces.
* [gommon/color](https://github.com/labstack/gommon/tree/master/color) - Style terminal text.
* [mpb ★90](https://github.com/vbauerster/mpb) - Multi progress bar for terminal applications.
* [termbox-go ★2300](https://github.com/nsf/termbox-go) - Termbox is a library for creating cross-platform text-based interfaces.
* [termtables](https://github.com/apcera/termtables) - Go port of the Ruby library [terminal-tables ★909](https://github.com/tj/terminal-table) for simple ASCII table generation as well as providing markdown and HTML output.
* [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib ★10073](https://github.com/yaronn/blessed-contrib).
* [uilive ★559](https://github.com/gosuri/uilive) - Library for updating terminal output in realtime.
* [uiprogress ★976](https://github.com/gosuri/uiprogress) - Flexible library to render progress bars in terminal applications.
...
* [config ★121](https://github.com/olebedev/config) - JSON or YAML configuration wrapper with environment variables and flags parsing.
...
* [env ★292](https://github.com/caarlos0/env) - Parse environment variables to Go structs (with defaults).
...
* [godotenv ★625](https://github.com/joho/godotenv) - Go port of Ruby's dotenv library (Loads environment variables from `.env`.)
...
* [ini ★639](https://github.com/go-ini/ini) - Go package for read and write INI files
* [joshbetz/config ★141](https://github.com/joshbetz/config) - Small configuration library for Go that parses environment variables, JSON files, and reloads automatically on SIGHUP.
...
* [viper ★3477](https://github.com/spf13/viper) - Go configuration with fangs
...
* [drone ★10576](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go
* [goveralls ★404](https://github.com/mattn/goveralls) - Go integration for Coveralls.io continuous code coverage tracking system.
...
* [binpacker ★47](https://github.com/zhuangsirui/binpacker) - Binary packer and unpacker helps user build custom binary stream.
* [bit ★3](https://github.com/yourbasic/bit) - Golang set data structure with bonus bit-twiddling functions.
...
* [boomfilters ★838](https://github.com/tylertreat/BoomFilters) - Probabilistic data structures for processing continuous, unbounded streams
...
* [go-datastructures ★3354](https://github.com/Workiva/go-datastructures) - Collection of useful, performant, and thread-safe data structures
* [go-geoindex ★257 ⏳1Y](https://github.com/hailocab/go-geoindex) - In-memory geo index.
...
* [gods ★3043](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.
* [golang-set ★575](https://github.com/deckarep/golang-set) - Thread-Safe and Non-Thread-Safe high-performance sets for Go.
* [goskiplist ★133](https://github.com/ryszard/goskiplist) - Skip list implementation in Go.
* [gota ★306](https://github.com/kniren/gota) - Implementation of dataframes, series, and data wrangling methods for Go.
...
* [roaring ★266](https://github.com/RoaringBitmap/roaring) - Go package implementing compressed bitsets.
...
* [willf/bloom ★346](https://github.com/willf/bloom) - Go package implementing Bloom filters.

## Database

*Databases implemented in Go.*

* [BigCache ★1030](https://github.com/allegro/bigcache) - Efficient key/value cache for gigabytes of data.
* [bolt ★6693](https://github.com/boltdb/bolt) - Low-level key/value database for Go.
* [buntdb ★1546](https://github.com/tidwall/buntdb) - Fast, embeddable, in-memory key/value database for Go with custom indexing and spatial support.
* [cache2go ★294](https://github.com/muesli/cache2go) - In-memory key:value cache which supports automatic invalidation based on timeouts.
...
* [dgraph ★3573](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.
* [diskv ★467](https://github.com/peterbourgon/diskv) - Home-grown disk-backed key-value store.
* [eliasdb ★429](https://github.com/krotik/eliasdb) - Dependency-free, transactional graph database with REST API, phrase search and SQL-like query language.
* [forestdb ★27](https://github.com/couchbase/goforestdb) - Go bindings for ForestDB.
* [GCache ★224](https://github.com/bluele/gcache) - Cache library with support for expirable Cache, LFU, LRU and ARC.
...
* [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB ★10214](https://github.com/google/leveldb) key/value database in the Go.
...
* [moss ★339](https://github.com/couchbase/moss) - Moss is a simple LSM key-value storage engine written in 100% Go.
* [piladb ★138](https://github.com/fern4lvarez/piladb) - Lightweight RESTful database engine based on stack data structures.
* [prometheus ★10985](https://github.com/prometheus/prometheus) - Monitoring system and time series database.
* [rqlite ★3096](https://github.com/rqlite/rqlite) - The lightweight, distributed, relational database built on SQLite.
...
* [Tile38 ★3301](https://github.com/tidwall/tile38) - Geolocation DB with spatial index and realtime geofencing.
...
* [gormigrate ★53](https://github.com/go-gormigrate/gormigrate) - Database schema migration helper for Gorm ORM.
* [migrate ★1473](https://github.com/mattes/migrate) - Database migrations. CLI and Golang library.
...
* [sql-migrate ★735](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.

*Database tools.*

* [go-mysql ★609](https://github.com/siddontang/go-mysql) - Go toolset to handle MySQL protocol and replication.
* [go-mysql-elasticsearch ★801](https://github.com/siddontang/go-mysql-elasticsearch) - Sync your MySQL data into Elasticsearch automatically.
* [kingshard ★2818](https://github.com/flike/kingshard) - kingshard is a high performance proxy for MySQL powered by Golang.
...
* [orchestrator ★794](https://github.com/github/orchestrator) - MySQL replication topology manager & visualizer
* [pgweb ★4396](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser
* [pREST](https://github.com/nuveo/prest) - Serve a RESTful API from any PostgreSQL database.
* [vitess ★4849](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.

*SQL query builder, libraries for building and using SQL.*

* [dat ★449](https://github.com/mgutz/dat) - Go Postgres Data Access Toolkit
...
* [ozzo-dbx ★169](https://github.com/go-ozzo/ozzo-dbx) - Powerful data retrieval methods as well as DB-agnostic query building capabilities.
* [scaneo ★105](https://github.com/variadico/scaneo) - Generate Go code to convert database rows into arbitrary structs.
* [sqrl ★76](https://github.com/elgris/sqrl) - SQL query builder, fork of Squirrel with improved performance.
* [Squirrel ★1182](https://github.com/Masterminds/squirrel) - Go library that helps you build SQL queries.
* [xo ★1194](https://github.com/knq/xo) - Generate idiomatic Go code for databases based on existing schema definitions or custom queries supporting PostgreSQL, MySQL, SQLite, Oracle, and Microsoft SQL Server.
...
* Relational Databases
    ...
    * [go-mssqldb ★580](https://github.com/denisenkom/go-mssqldb) - Microsoft MSSQL driver for Go.
    * [go-oci8 ★226](https://github.com/mattn/go-oci8) - Oracle driver for go that using database/sql.
    * [go-sql-driver/mysql ★3945](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.
    * [go-sqlite3 ★1917](https://github.com/mattn/go-sqlite3) - SQLite3 driver for go that using database/sql.
    * [gofreetds ★48](https://github.com/minus5/gofreetds) Microsoft MSSQL driver. Go wrapper over [FreeTDS](http://www.freetds.org).
    * [pgx ★1071](https://github.com/jackc/pgx) - PostgreSQL driver supporting features beyond those exposed by database/sql.
    * [pq ★3073](https://github.com/lib/pq) - Pure Go Postgres driver for database/sql.
...
* NoSQL Databases
    ...
    * [dynago ★39](https://github.com/underarmour/dynago) - Dynago is a principle of least surprise client for DynamoDB
    ...
    * [gomemcache ★794](https://github.com/bradfitz/gomemcache) - memcache client library for the Go programming language.
    ...
    * [redigo ★3394](https://github.com/garyburd/redigo) - Redigo is a Go client for the Redis database.
    * [redis ★2103](https://github.com/go-redis/redis) - Redis client for Golang
...
* Search and Analytic Databases
    * [bleve ★3428](https://github.com/blevesearch/bleve) - Modern text indexing library for go.
    * [elastic ★1560](https://github.com/olivere/elastic) - Elasticsearch client for Go.
    * [elasticsql ★86](https://github.com/cch123/elasticsql) - Convert sql to elasticsearch dsl in Go.
    * [elastigo ★872](https://github.com/mattbaird/elastigo) - Elasticsearch client library.
...
* [carbon ★115](https://github.com/uniplaces/carbon) - Simple Time extension with a lot of util methods, ported from PHP Carbon library.
...
* [now ★920](https://github.com/jinzhu/now) - Now is a time toolkit for golang.
* [NullTime ★3](https://github.com/kirillDanshin/nulltime) - Nullable time.Time
* [timeutil ★137 ⏳2Y](https://github.com/leekchan/timeutil) - Useful extensions (Timedelta, Strftime, ...) to the golang's time package.
...
* [gleam ★816](https://github.com/chrislusf/gleam) - Fast and scalable distributed map/reduce system written in pure Go and Luajit, combining Go's high concurrency with Luajit's high performance, runs standalone or distributed.
* [glow ★1690](https://github.com/chrislusf/glow) - Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.
* [go-jump ★127](https://github.com/dgryski/go-jump) - Port of Google's "Jump" Consistent Hash function.
* [go-kit ★7438](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
* [gorpc ★383](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.
* [grpc-go ★3707](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.
* [hprose ★601](https://github.com/hprose/hprose-golang) - Very newbility RPC Library, support 25+ languages now.
...
* [KrakenD ★88](https://github.com/devopsfaith/krakend) - Ultra performant API Gateway framework with middlewares.
* [micro ★3428](https://github.com/micro/micro) - Pluggable microservice toolkit and distributed systems platform.
* [NATS ★3265](https://github.com/nats-io/gnatsd) - Lightweight, high performance messaging system for microservices, IoT, and cloud native systems.
* [raft ★1277](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.
* [raft](https://github.com/coreos/etcd/tree/master/raft#readme) - Go implementation of the Raft consensus protocol, by CoreOS.
* [ringpop-go ★352](https://github.com/uber/ringpop-go) - Scalable, fault-tolerant application-layer sharding for Go applications
* [rpcx ★1313](https://github.com/smallnest/rpcx) - Distributed pluggable RPC service framework like alibaba Dubbo.
* [sleuth](https://github.com/ursiform/sleuth) - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ ★3587](https://github.com/zeromq/libzmq)).
* [tendermint ★584](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.
* [torrent ★1758](https://github.com/anacrolix/torrent) - BitTorrent client package.
...
* [go-imap ★261](https://github.com/emersion/go-imap) - IMAP library for clients and servers
* [go-message ★23](https://github.com/emersion/go-message) - Streaming library for the Internet Message Format and mail messages
* [Gomail ★1298](https://github.com/go-gomail/gomail) - Gomail is a very simple and powerful package to send emails.
* [Hectane ★117](https://github.com/hectane/hectane) - Lightweight SMTP client providing an HTTP API
* [hermes ★955](https://github.com/matcornic/hermes) - Golang package that generates clean, responsive HTML e-mails
* [MailHog ★2327](https://github.com/mailhog/MailHog) - Email and SMTP testing with web and API interface
...
* [anko ★421](https://github.com/mattn/anko) - Scriptable interpreter written in Go
* [binder](https://github.com/alexeyco/binder) - Go to Lua binding library, based on [gopher-lua ★1734](https://github.com/yuin/gopher-lua)
* [gisp ★363 ⏳3Y](https://github.com/jcla1/gisp) - Simple LISP in Go
* [go-duktape ★512](https://github.com/olebedev/go-duktape) - Duktape JavaScript engine bindings for Go
* [go-lua ★1023](https://github.com/Shopify/go-lua) - Port of the Lua 5.2 VM to pure Go
* [go-php ★331](https://github.com/deuill/go-php) - PHP bindings for Go
* [go-python ★521](https://github.com/sbinet/go-python) - naive go bindings to the CPython C-API
* [golua ★343](https://github.com/aarzilli/golua) - Go bindings for Lua C API
* [gopher-lua ★1734](https://github.com/yuin/gopher-lua) - Lua 5.1 VM and compiler written in Go
* [ngaro ★8](https://github.com/db47h/ngaro) - Embeddable Ngaro VM implementation enabling scripting in Retro
* [otto ★3104](https://github.com/robertkrimen/otto) - JavaScript interpreter written in Go
...
* [afero ★1086](https://github.com/spf13/afero) - FileSystem Abstraction System for Go.
* [go-csv-tag ★6](https://github.com/artonge/go-csv-tag) - Load csv file using tag.
...
* [skywalker ★9](https://github.com/dixonwille/skywalker) - Package to allow one to concurrently go through a filesystem with ease.
...
* [accounting ★294](https://github.com/leekchan/accounting) - money and currency formatting for golang
* [decimal ★574](https://github.com/shopspring/decimal) - Arbitrary-precision fixed-point decimal numbers
...
* [conform ★82](https://github.com/leebenson/conform) - Keeps user input in check. Trims, sanitizes & scrubs data based on struct tags.
...
* [gorilla/csrf ★216](https://github.com/gorilla/csrf) - CSRF protection for Go web applications & services.
* [nosurf ★764](https://github.com/justinas/nosurf) - CSRF protection middleware for Go.
...
* [Ebiten ★403](https://github.com/hajimehoshi/ebiten) - simple 2D game library in Go
* [engo ★626](https://github.com/EngoEngine/engo) - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.
* [GarageEngine ★278 ⏳3Y](https://github.com/vova616/GarageEngine) - 2d game engine written in Go working on OpenGL.
* [glop ★77 ⏳1Y](https://github.com/runningwild/glop) - Glop (Game Library Of Power) is a fairly simple cross-platform game library.
* [go-astar ★202](https://github.com/beefsack/go-astar) - Go implementation of the A\* path finding algorithm
* [go-collada ★11 ⏳3Y](https://github.com/GlenKelley/go-collada) - Go package for working with the Collada file format.
* [go-sdl2 ★642](https://github.com/veandco/go-sdl2) - Go bindings for the [Simple DirectMedia Layer](https://www.libsdl.org/).
* [go3d ★124 ⏳2Y](https://github.com/ungerik/go3d) - Performance oriented 2D/3D math package for Go
* [gonet ★837](https://github.com/xtaci/gonet) - Game server skeleton implemented with golang
* [Leaf ★1439](https://github.com/name5566/leaf) - Lightweight game server framework
* [Pixel ★636](https://github.com/faiface/pixel) - Hand-crafted 2D game library in Go
...
* [termloop ★775](https://github.com/JoelOtter/termloop) - Terminal-based game engine for Go, built on top of Termbox
...
* [gen ★821](https://github.com/clipperhouse/gen) - Code generation tool for ‘generics’-like functionality.
...
* [jennifer ★498](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.
...
* [gopherjs ★5420](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.
* [llgo ★835 ⏳2Y](https://github.com/go-llvm/llgo) - LLVM-based compiler for Go.
...
* [go-floc ★8](https://github.com/workanator/go-floc) - Orchestrate goroutines with ease.
* [go-flow ★49](https://github.com/kamildrazkiewicz/go-flow) - Control goroutines execution order.
* [goworker ★1749](https://github.com/benmanns/goworker) - goworker is a Go-based background worker
* [grpool ★219](https://github.com/ivpusic/grpool) - Lightweight Goroutine pool.
* [pool ★295](https://github.com/go-playground/pool) - Limited consumer goroutine or unlimited goroutine pool for easier goroutine handling and cancellation.
...
* [tunny ★549](https://github.com/Jeffail/tunny) - Goroutine pool for golang.
...
* [app ★1746](https://github.com/murlokswarm/app) - Package to create apps with GO, HTML and CSS. Supports: MacOS, Windows in progress.
* [go-astilectron ★408](https://github.com/asticode/go-astilectron) - Build cross platform GUI apps with GO and HTML/JS/CSS. (powered by Electron)
* [go-gtk](http://mattn.github.io/go-gtk/) - Go bindings for GTK
* [go-qml ★1806](https://github.com/go-qml/qml) - QML support for the Go language
* [go-sciter ★667](https://github.com/sciter-sdk/go-sciter) - Go bindings for Sciter: the Embeddable HTML/CSS/script engine for modern desktop UI development. Cross platform.
* [goqt ★1287](https://github.com/visualfc/goqt) - Golang bindings to the Qt cross-platform application framework.
* [gotk3 ★261](https://github.com/gotk3/gotk3) - Go bindings for GTK3.
* [gowd ★28](https://github.com/dtylman/gowd) - Rapid and simple desktop UI development with GO, HTML, CSS and NW.js. Cross platform.
* [qt ★2771](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)
* [ui ★4348](https://github.com/andlabs/ui) - Platform-native GUI library for Go. Cross platform.
* [walk ★1960](https://github.com/lxn/walk) - Windows application library kit for Go.

*Interaction*

* [gosx-notifier ★375](https://github.com/deckarep/gosx-notifier) - OSX Desktop Notifications library for Go.
* [robotgo ★1951](https://github.com/go-vgo/robotgo) - Go Native cross-platform GUI system automation;Control the mouse, keyboard and other.
* [systray ★208](https://github.com/getlantern/systray) - Cross platform Go library to place an icon and menu in the notification area
...
See [go-hardware ★545](https://github.com/rakyll/go-hardware) for a comprehensive list.

## Images

*Libraries for manipulating images.*

* [bild ★1513](https://github.com/anthonynsimon/bild) - Collection of image processing algorithms in pure Go.
* [bimg ★341](https://github.com/h2non/bimg) - Small package for fast and efficient image processing using libvips.
* [geopattern ★910](https://github.com/pravj/geopattern) - Create beautiful generative image patterns from a string.
* [gg ★1011](https://github.com/fogleman/gg) - 2D rendering in pure Go.
* [gift ★925](https://github.com/disintegration/gift) - Package of image processing filters.
...
* [imagick ★605](https://github.com/gographics/imagick) - Go binding to ImageMagick's MagickWand C API.
* [imaginary ★1275](https://github.com/h2non/imaginary) - Fast and simple HTTP microservice for image resizing.
* [imaging ★1229](https://github.com/disintegration/imaging) - Simple Go image processing package.
* [img ★105 ⏳2Y](https://github.com/hawx/img) - Selection of image manipulation tools.
* [ln ★1963](https://github.com/fogleman/ln) - 3D line art rendering in Go.
* [mpo ★3](https://github.com/donatj/mpo) - Decoder and conversion tool for MPO 3D Photos.
* [picfit ★662](https://github.com/thoas/picfit) - An image resizing server written in Go.
* [pt ★1443](https://github.com/fogleman/pt) - Path tracing engine written in Go.
* [resize ★1491](https://github.com/nfnt/resize) - Image resizing for the Go with common interpolation methods.
* [rez ★138](https://github.com/bamiaux/rez) - Image resizing in pure Go and SIMD.
* [smartcrop ★459](https://github.com/muesli/smartcrop) - Finds good crops for arbitrary images and crop sizes.
...
* [gatt ★529](https://github.com/paypal/gatt) - Gatt is a Go package for building Bluetooth Low Energy peripherals.
* [gobot ★3343](https://github.com/hybridgroup/gobot) - Gobot is a framework for robotics, physical computing, and the Internet of Things.
* [mainflux ★202](https://github.com/Mainflux/mainflux) - Industrial IoT Messaging and Device Management Server.
...
* [glog ★1459](https://github.com/golang/glog) - Leveled execution logs for Go.
...
* [log ★416](https://github.com/apex/log) - Structured logging package for Go.
...
* [logrus ★5272](https://github.com/Sirupsen/logrus) - Structured logger for Go.
* [logrusly](https://github.com/sebest/logrusly) - [logrus ★5272](https://github.com/sirupsen/logrus) plug-in to send errors to a [Loggly](https://www.loggly.com/).
...
* [logxi ★299](https://github.com/mgutz/logxi) - 12-factor app logger that is fast and makes you happy.
* [lumberjack ★550](https://github.com/natefinch/lumberjack) - Simple rolling logger, implements io.WriteCloser.
...
* [seelog ★939](https://github.com/cihub/seelog) -   logging functionality with flexible dispatching, filtering, and formatting.
...
* [spew ★1516](https://github.com/davecgh/go-spew) - Implements a deep pretty printer for Go data structures to aid in debugging
...
* [tail ★802](https://github.com/hpcloud/tail) - Go package striving to emulate the features of the BSD tail program.
...
* [zap ★2662](https://github.com/uber-go/zap) - Fast, structured, leveled logging in Go.
* [zerolog ★409](https://github.com/rs/zerolog) - Zero-allocation JSON logger.

## Machine Learning

*Libraries for Machine Learning.*

* [bayesian ★470](https://github.com/jbrukh/bayesian) - Naive Bayesian Classification for Golang.
* [CloudForest ★540](https://github.com/ryanbressler/CloudForest) - Fast, flexible, multi-threaded ensembles of decision trees for machine learning in pure Go.
* [gago ★334](https://github.com/MaxHalford/gago) - Multi-population, flexible, parallel genetic algorithm.
...
* [GoLearn ★4374](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.
* [golinear ★34](https://github.com/danieldk/golinear) - liblinear bindings for Go
* [goml ★745](https://github.com/cdipaolo/goml) - On-line Machine Learning in Go
* [goRecommend ★81 ⏳3Y](https://github.com/timkaye11/goRecommend) - Recommendation Algorithms library written in Go.
* [gorgonia ★1228](https://github.com/chewxy/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.
...
* [regommend ★160](https://github.com/muesli/regommend) - Recommendation & collaborative filtering engine
...
* [Centrifugo ★2020](https://github.com/centrifugal/centrifugo) - Real-time messaging (Websockets or SockJS) server in Go.
...
* [emitter ★135](https://github.com/olebedev/emitter) - Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins.
* [EventBus ★274](https://github.com/asaskevich/EventBus) - The lightweight event bus with async compatibility.
...
* [go-nsq ★847](https://github.com/nsqio/go-nsq) - the official Go package for NSQ
* [go-socket.io ★1782](https://github.com/googollee/go-socket.io) - socket.io library for golang, a realtime application framework.
* [go-vitotrol ★1](https://github.com/maxatome/go-vitotrol) - Client library to Viessmann Vitotrol web service.
* [golongpoll ★338](https://github.com/jcuga/golongpoll) - HTTP longpoll server library that makes web pub-sub simple.
...
* [machinery ★1634](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.
* [mangos ★1179](https://github.com/go-mangos/mangos) - Pure go implementation of the Nanomsg ("Scalable Protocols") with transport interoperability.
* [melody ★661](https://github.com/olahol/melody) - Minimalist framework for dealing with websocket sessions, includes broadcasting and automatic ping/pong handling.
...
* [sarama ★2034](https://github.com/Shopify/sarama) - Go library for Apache Kafka.
...
* [archiver ★628](https://github.com/mholt/archiver) - Library and command for making and extracting .zip and .tar.gz archives
...
* [bitio ★28](https://github.com/icza/bitio) - Highly optimized bit-level Reader and Writer for Go.
...
* [errors ★2118](https://github.com/pkg/errors) - Package that provides simple error handling primitives.
* [go-chat-bot ★227](https://github.com/go-chat-bot/bot) - IRC, Slack & Telegram bot written in Go.
* [go-commons-pool ★374](https://github.com/jolestar/go-commons-pool) - Generic object pool for Golang.
...
* [go-resiliency ★509](https://github.com/eapache/go-resiliency) - Resiliency patterns for golang
...
* [go.uuid ★1289](https://github.com/satori/go.uuid) - Implementation of Universally Unique Identifier (UUID). Supported both creation and parsing of UUIDs.
* [gofakeit ★37](https://github.com/brianvoe/gofakeit) - Random data generator written in go
* [goid ★11](https://github.com/jakehl/goid) - Generate and Parse RFC4122 compliant V4 UUIDs.
* [gopsutil ★1831](https://github.com/shirou/gopsutil) - Cross-platform library for retrieving process and system utilization(CPU, Memory, Disks, etc).
* [gosms ★1032](https://github.com/haxpax/gosms) - Your own local SMS gateway in Go that can be used to send SMS
...
* [stats ★68](https://github.com/go-playground/stats) - Monitors Go MemStats + System stats such as Memory, Swap and CPU and sends via UDP anywhere you want for logging etc...
...
* [xstrings ★386 ⏳1Y](https://github.com/huandu/xstrings) - Collection of useful string functions ported from other languages.
...
* [go-i18n ★457](https://github.com/nicksnyder/go-i18n) - Package and an accompanying tool to work with localized text.
...
* [prose ★187](https://github.com/jdkato/prose) - Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more.
...
* [when ★728](https://github.com/olebedev/when) - Natural EN and RU language date/time parser with pluggable rules
...
* [dns ★2267](https://github.com/miekg/dns) - Go library for working with DNS
* [ether ★41 ⏳1Y](https://github.com/songgao/ether) - Cross-platform Go package for sending and receiving ethernet frames.
* [ethernet ★106](https://github.com/mdlayher/ethernet) - Package ethernet implements marshaling and unmarshaling of IEEE 802.3 Ethernet II frames and IEEE 802.1Q VLAN tags.
* [fasthttp ★4755](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http
* [ftp ★244](https://github.com/jlaffaye/ftp) - Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959).
* [go-getter ★356](https://github.com/hashicorp/go-getter) - Go library for downloading files or directories from various sources using a URL.
* [go-stun ★157](https://github.com/ccding/go-stun) - Go implementation of the STUN client (RFC 3489 and RFC 5389).
* [gobgp ★1006](https://github.com/osrg/gobgp) - BGP implemented in the Go Programming Language.
...
* [gopacket ★1379](https://github.com/google/gopacket) - Go library for packet processing with libpcap bindings
...
* [gosnmp ★213](https://github.com/soniah/gosnmp) - Native Go library for performing SNMP actions
* [gotcp ★280](https://github.com/gansidui/gotcp) - Go package for quickly writing tcp applications
* [grab ★201](https://github.com/cavaliercoder/grab) - Go package for managing file downloads
...
* [kcp-go ★732](https://github.com/xtaci/kcp-go) - KCP - Fast and Reliable ARQ Protocol.
* [kcptun ★5895](https://github.com/xtaci/kcptun) - Extremely simple & fast udp tunnel based on KCP protocol
...
* [mdns ★341](https://github.com/hashicorp/mdns) - Simple mDNS (Multicast DNS) client/server library in Golang
...
* [raw ★99](https://github.com/mdlayher/raw) - Package raw enables reading and writing data at the device driver level for a network interface.
...
* [ssh ★455](https://github.com/gliderlabs/ssh) - Higher-level API for building SSH servers (wraps crypto/ssh).
...
* [tcp_server ★134](https://github.com/firstrow/tcp_server) - Go library for building tcp servers faster.
* [utp ★106](https://github.com/anacrolix/utp) - Go uTP micro transport protocol implementation.
* [water ★272](https://github.com/songgao/water) - Simple TUN/TAP library
...
* [gl ★380](https://github.com/go-gl/gl) - Go bindings for OpenGL (generated via glow).
* [glfw ★396](https://github.com/go-gl/glfw) - Go bindings for GLFW 3.
...
* [mathgl ★181 ⏳1Y](https://github.com/go-gl/mathgl) - Pure Go math package specialized for 3D math, with inspiration from GLM.
...
* [go-pg ★979](https://github.com/go-pg/pg) - PostgreSQL ORM with focus on PostgreSQL specific features and performance.
...
* [GORM ★6316](https://github.com/jinzhu/gorm) - The fantastic ORM library for Golang, aims to be developer friendly.
* [gorp ★2538](https://github.com/go-gorp/gorp) - Go Relational Persistence, ORM-ish library for Go.
* [pop/soda ★255](https://github.com/markbates/pop) - Database migration, creation, ORM, etc... for MySQL, PostgreSQL, and SQLite.
...
* [upper.io/db ★930](https://github.com/upper/db) - Single interface for interacting with different data sources through the use of adapters that wrap mature database drivers.
* [Xorm ★2174](https://github.com/go-xorm/xorm) - Simple and powerful ORM for Go.
* [Zoom ★162](https://github.com/albrow/zoom) - Blazing-fast datastore and querying engine built on Redis.

## Package Management

*Libraries for package and dependency management.*

* [dep ★4064](https://github.com/golang/dep) - Go dependency tool.
...
* [glide ★5113](https://github.com/Masterminds/glide) - Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.
* [godep ★4823](https://github.com/tools/godep) - dependency tool for go, godep helps build packages reproducibly by fixing their dependencies.
...
* [gopm ★1487](https://github.com/gpmgo/gopm) - Go Package Manager
* [govendor ★2283](https://github.com/kardianos/govendor) - Go Package Manager. Go vendor tool that works with the standard vendor file.
* [gpm ★1145](https://github.com/pote/gpm) - Barebones dependency manager for Go.
...
* [graphql ★658](https://github.com/neelance/graphql-go) - GraphQL server with a focus on ease of use.
* [graphql-go ★1758](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.
* [jsonql ★103 ⏳1Y](https://github.com/elgs/jsonql) - JSON query expression library in Golang.
...
* [go-bindata ★3019](https://github.com/jteeuwen/go-bindata) - Package that converts any file into managable Go source code.
...
* [go.rice ★1041](https://github.com/GeertJohan/go.rice) - go.rice is a Go package that makes working with resources such as html,js,css,images and templates very easy.
...
* [statik ★630](https://github.com/rakyll/statik) - Embeds static files into a Go executable
* [templify ★4](https://github.com/wlbr/templify) - Embed external template files into Go code to create single file binaries.
* [vfsgen ★173](https://github.com/shurcooL/vfsgen) - Generates a vfsdata.go file that statically implements the given virtual filesystem.
...
* [chart ★420 ⏳1Y](https://github.com/vdobler/chart) - Simple Chart Plotting library for Go. Supports many graphs types.
* [evaler ★30](https://github.com/soniah/evaler) - Simple floating point arithmetic expression evaluator
* [ewma ★183](https://github.com/VividCortex/ewma) - Exponentially-weighted moving averages
...
* [gonum/plot ★551](https://github.com/gonum/plot) - gonum/plot provides an API for building and drawing plots in Go.
...
* [stats ★742](https://github.com/montanaflynn/stats) - Statistics package with common functions missing from the Golang standard library.
* [streamtools ★1293 ⏳2Y](https://github.com/nytlabs/streamtools) - general purpose, graphical tool for dealing with streams of data.
...
* [acmetool ★1290](https://github.com/hlandau/acme) — ACME (Let's Encrypt) client tool with automatic renewal.
* [BadActor ★209](https://github.com/jaredfolkins/badactor) - In-memory, application-driven jailer built in the spirit of fail2ban
* [go-yara](https://github.com/hillu/go-yara) - Go Bindings for [YARA ★42 ⏳1Y](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)"
* [lego ★2027](https://github.com/xenolf/lego) - Pure Go ACME client library and CLI tool (for use with Let's Encrypt)
* [passlib ★160](https://github.com/hlandau/passlib) - Futureproof password hashing library.
* [secure ★724](https://github.com/unrolled/secure) - HTTP middleware for Go that facilitates some quick security wins.
...
* [ssh-vault ★61](https://github.com/ssh-vault/ssh-vault) - encrypt/decrypt using ssh keys
...
* [go-codec ★806](https://github.com/ugorji/go) - High Performance, feature-Rich, idiomatic encode, decode and rpc library for msgpack, cbor and json, with runtime-based OR code-generation support
* [gogoprotobuf ★1089](https://github.com/gogo/protobuf) - Protocol Buffers for Go with Gadgets
* [goprotobuf ★2000](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
* [jsoniter ★950](https://github.com/json-iterator/go) - High-performance 100% compatible drop-in replacement of "encoding/json"
* [mapstructure ★1038](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.
...
* [structomap ★60 ⏳2Y](https://github.com/tuvistavie/structomap) - Library to easily and dynamically generate maps from static structures.

## Server Applications

* [algernon ★356](https://github.com/xyproto/algernon) - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
* [Caddy ★13434](https://github.com/mholt/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
* [consul](https://www.consul.io/) - Consul is a tool for service discovery, monitoring and configuration.
* [devd ★2373](https://github.com/cortesi/devd) - Local webserver for developers
* [etcd ★14436](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.
...
* [amber ★739](https://github.com/eknkc/amber) - Amber is an elegant templating engine for Go Programming Language It is inspired from HAML and Jade.
...
* [gofpdf ★691](https://github.com/jung-kurt/gofpdf) - PDF document generator with high level support for text, drawing and images.
...
* [hero ★772](https://github.com/shiyanhui/hero) Hero is a handy, fast and powerful go template engine.
...
* [liquid ★21](https://github.com/osteele/liquid) - Go implementation of Shopify Liquid templates.
* [mustache ★846](https://github.com/hoisie/mustache) - Go implementation of the Mustache template language.
* [pongo2 ★1008](https://github.com/flosch/pongo2) - Django-like template-engine for Go.
* [quicktemplate ★777](https://github.com/valyala/quicktemplate) - Fast, powerful, yet easy to use template engine. Converts templates into Go code and then compiles it.
* [raymond ★182](https://github.com/aymerick/raymond) - Complete handlebars implementation in Go.
* [Razor ★590 ⏳1Y](https://github.com/sipin/gorazor) - Razor view engine for Golang.
...
* Testing Frameworks
    ...
    * [baloo ★267](https://github.com/h2non/baloo) - Expressive and versatile end-to-end HTTP API testing made easy.
    ...
    * [go-vcr ★147](https://github.com/dnaeon/go-vcr) - Record and replay your HTTP interactions for fast, deterministic and accurate tests
    * [goblin ★401](https://github.com/franela/goblin) - Mocha like testing framework fo Go
    * [gocheck](http://labix.org/gocheck) - More advanced testing framework alternative to gotest.
    * [GoConvey ★3003](https://github.com/smartystreets/goconvey) - BDD-style framework with web UI and live reload
    * [godog ★223](https://github.com/DATA-DOG/godog) - Cucumber or Behat like BDD framework for Go.
    ...
    * [testfixtures ★110](https://github.com/go-testfixtures/testfixtures) - A helper for Rails' like test fixtures to test database applications.
    * [Testify ★3569](https://github.com/stretchr/testify) - Sacred extension to the standard go testing package.
...
* Mock
    ...
    * [go-sqlmock ★516](https://github.com/DATA-DOG/go-sqlmock) - Mock SQL driver for testing database interactions
    * [go-txdb ★33](https://github.com/DATA-DOG/go-txdb) - Single transaction based database driver mainly for testing purposes.
    * [gock ★332](https://github.com/h2non/gock) - Versatile HTTP mocking made easy.
    * [gomock ★740](https://github.com/golang/mock) - Mocking framework for the Go programming language.
    * [govcr ★26](https://github.com/seborama/govcr) -  HTTP mock for Golang: record and replay HTTP interactions for offline testing
    * [minimock ★69](https://github.com/gojuno/minimock) - Mock generator for Go interfaces
    * [mockhttp ★18 ⏳2Y](https://github.com/tv42/mockhttp) - Mock object for Go http.ResponseWriter

* Fuzzing and delta-debugging/reducing/shrinking
    * [go-fuzz ★1926](https://github.com/dvyukov/go-fuzz) - Randomized testing system
...
* Selenium and browser control tools
    ...
    * [chromedp ★1371](https://github.com/knq/chromedp) - Way to drive/test Chrome, Safari, Edge, Android Webviews, and other browsers supporting the Chrome Debugging Protocol.
...
* Specific Formats
    ...
    * [blackfriday ★2555](https://github.com/russross/blackfriday) - Markdown processor in Go
    * [bluemonday ★703](https://github.com/microcosm-cc/bluemonday) - HTML Sanitizer
    ...
    * [go-humanize ★1077](https://github.com/dustin/go-humanize) - Formatters for time, numbers, and memory size to human readable format.
    ...
    * [gofeed ★657](https://github.com/mmcdole/gofeed) - Parse RSS and Atom feeds in Go
    * [gographviz ★122](https://github.com/awalterschulze/gographviz) - Parses the Graphviz DOT language.
    * [gommon/bytes](https://github.com/labstack/gommon/tree/master/bytes) - Format bytes to string.
    * [gonameparts ★24](https://github.com/polera/gonameparts) - Parses human names into individual name parts
    * [goq ★34](https://github.com/andrewstuart/goq) - Declarative unmarshaling of HTML using struct tags with jQuery syntax (uses GoQuery).
    * [GoQuery ★4453](https://github.com/PuerkitoBio/goquery) - GoQuery brings a syntax and a set of features similar to jQuery to the Go language.
    ...
    * [inject ★697](https://github.com/facebookgo/inject) - Package inject provides a reflect based injector.
    ...
    * [sh ★588](https://github.com/mvdan/sh) - Shell parser and formatter
    * [slug ★124](https://github.com/gosimple/slug) - URL-friendly slugify with multiple languages support.
    * [Slugify ★13 ⏳2Y](https://github.com/avelino/slugify) - Go slugify application that handles string.
    * [toml ★1523](https://github.com/BurntSushi/toml) - TOML configuration format (encoder/decoder with reflection).
* Utility
    ...
    * [xurls ★276](https://github.com/mvdan/xurls) - Extract urls from text
...
* [anaconda ★749](https://github.com/ChimeraCoder/anaconda) - Go client library for the Twitter 1.1 API
...
* [discordgo ★347](https://github.com/bwmarrin/discordgo) -  Go bindings for the Discord Chat API
* [facebook ★483](https://github.com/huandu/facebook) - Go Library that supports the Facebook Graph API
...
* [github ★2792](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.
...
* [go-jira ★159](https://github.com/andygrunwald/go-jira) - Go client library for [Atlassian JIRA](https://www.atlassian.com/software/jira)
* [go-marathon ★146](https://github.com/gambol99/go-marathon) - Go library for interacting with Mesosphere's Marathon PAAS.
...
* [go-twitter ★292](https://github.com/dghubble/go-twitter) - Go client library for the Twitter v1.1 APIs.
...
* [google ★1085](https://github.com/google/google-api-go-client) - Auto-generated Google APIs for Go.
...
* [minio-go ★352](https://github.com/minio/minio-go) - Minio Go Library for Amazon S3 compatible cloud storage.
...
* [stripe ★581](https://github.com/stripe/stripe-go) - Go client for the Stripe API
* [tbot ★108](https://github.com/yanzay/tbot) - Telegram bot server with API similar to net/http.
* [telebot ★313](https://github.com/tucnak/telebot) - Telegram bot framework written in Go.
...
* [webhooks ★96](https://github.com/go-playground/webhooks) - Webhook receiver for GitHub and Bitbucket.
...
* [boilr ★520](https://github.com/tmrts/boilr) - Blazingly fast CLI tool for creating projects from boilerplate templates.
* [circuitbreaker ★480](https://github.com/rubyist/circuitbreaker) - Circuit Breakers in Go
...
* [ctop ★5849](https://github.com/bcicen/ctop) - [Top-like](http://ctop.sh) interface (e.g. htop) for container metrics.
* [Death ★62](https://github.com/vrecan/death) - Managing go application shutdown with signals.
* [Deepcopier ★115](https://github.com/ulule/deepcopier) - Simple struct copying for Go.
* [delve ★6162](https://github.com/derekparker/delve) - Go debugger.
...
* [filetype ★156](https://github.com/h2non/filetype) - Small package to infer the file type checking the magic numbers signature.
* [filler ★8](https://github.com/yaronsumel/filler) - small utility to fill structs using "fill" tag.
* [fzf ★9760](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go
...
* [git-time-metric ★355](https://github.com/git-time-metric/gtm) - Simple, seamless, lightweight time tracking for Git
* [GJSON ★1618](https://github.com/tidwall/gjson) - Get a JSON value with one line of code.
...
* [go-funk ★259](https://github.com/thoas/go-funk) - Modern Go utility library which provides helpers (map, find, contains, filter, chunk, reverse, ...)
* [go-httpheader ★9](https://github.com/mozillazg/go-httpheader) - Go library for encoding structs into Header fields.
* [go-rate ★219 ⏳2Y](https://github.com/beefsack/go-rate) - Timed rate limiter for Go.
...
* [go-torch ★2104](https://github.com/uber/go-torch) - Stochastic flame graph profiler for Go programs.
* [go-trigger ★93](https://github.com/sadlil/go-trigger) - Go-lang global event triggerer, Register Events with an id and trigger the event from anywhere from your project.
...
* [godropbox ★3346](https://github.com/dropbox/godropbox) - Common libraries for writing Go services/applications from Dropbox.
* [gohper ★221](https://github.com/cosiner/gohper) - Various tools/modules help for development.
* [gojq ★75 ⏳1Y](https://github.com/elgs/gojq) - JSON query in Golang.
* [gojson ★1408](https://github.com/ChimeraCoder/gojson) - Automatically generate Go (golang) struct definitions from example JSON.
...
* [goreleaser ★1609](https://github.com/goreleaser/goreleaser) - Deliver Go binaries as fast and easily as possible
...
* [goreq ★50 ⏳1Y](https://github.com/smallnest/goreq) - Enhanced simplified HTTP client based on gorequest.
* [gorequest ★1247](https://github.com/parnurzeal/gorequest) - Simplified HTTP client with rich features for Go.
...
* [goxlsxwriter ★6](https://github.com/fterrag/goxlsxwriter) - Golang bindings for libxlsxwriter for writing XLSX (Microsoft Excel) files
* [gpath ★17](https://github.com/tenntenn/gpath) - Library to simplify access struct fields with Go's expression in reflection.
* [grequests ★903](https://github.com/levigross/grequests) - Elegant and simple `net/http` wrapper that follows Python's requests library
...
* [hub ★11115](https://github.com/github/hub) - wrap git commands with additional functionality to interact with github from the terminal.
* [hystrix-go ★669](https://github.com/afex/hystrix-go) - Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker.
* [immortal ★408](https://github.com/immortal/immortal) - *nix cross-platform (OS agnostic) supervisor
* [intrinsic ★8](https://github.com/mengzhuo/intrinsic) - Use x86 SIMD without writing any assembly code.
* [JobRunner ★379](https://github.com/bamzi/jobrunner) - Smart and featureful cron job scheduler with job queuing and live monitoring built in.
...
* [kazaam ★36](https://github.com/Qntfy/kazaam) - API for arbitrary transformation of JSON documents.
...
* [mergo ★303](https://github.com/imdario/mergo) - Helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
* [minify ★1012](https://github.com/tdewolff/minify) - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.
* [mmake ★1250](https://github.com/tj/mmake) - Modern Make.
...
* [ngrok ★10909](https://github.com/inconshreveable/ngrok) - Introspected tunnels to localhost.
...
* [panicparse ★1443](https://github.com/maruel/panicparse) - Groups similar goroutines and colorizes stack dump.
* [peco ★4020](https://github.com/peco/peco) - Simplistic interactive filtering tool.
...
* [profile ★626](https://github.com/pkg/profile) - Simple profiling support package for Go.
* [rclient ★18](https://github.com/zpatrick/rclient) - Readable, flexible, simple-to-use client for REST APIs.
* [realize ★1449](https://github.com/tockins/realize) - Go build system with file watchers and live reload. Run, build and watch file changes with custom paths.
* [request ★212](https://github.com/mozillazg/request) - Go HTTP Requests for Humans™.
...
* [resty ★550](https://github.com/go-resty/resty) - Simple HTTP and REST client for Go inspired by Ruby rest-client.
...
* [scheduler ★159](https://github.com/carlescere/scheduler) - Cronjobs scheduling made easy.
* [sling ★540](https://github.com/dghubble/sling) - Go HTTP requests builder for API clients.
* [spinner ★354](https://github.com/briandowns/spinner) - Go package to easily provide a terminal spinner with options.
* [sqlx ★3148](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.
* [Storm ★605](https://github.com/asdine/storm) - Simple and powerful toolkit for BoltDB.
* [Task ★301](https://github.com/go-task/task) - simple "Make" alternative
...
* [usql ★2042](https://github.com/knq/usql) - usql is a universal command-line interface for SQL databases.
* [util ★24](https://github.com/shomali11/util) - Collection of useful utility functions. (strings, concurrency, manipulations, ...)
* [wuzz ★6471](https://github.com/asciimoo/wuzz) - Interactive cli tool for HTTP inspection.
* [xferspdy ★41](https://github.com/monmohan/xferspdy) - Xferspdy provides binary diff and patch library in golang
* [xlsx ★1813](https://github.com/tealeg/xlsx) - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.

## Validation

*Libraries for validation.*

* [govalidator ★1976](https://github.com/asaskevich/govalidator) - Validators and sanitizers for strings, numerics, slices and structs.
* [ozzo-validation ★401](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.
...
* [validator ★1090](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.
...
* [git2go ★1015](https://github.com/libgit2/git2go) - Go bindings for libgit2.
* [go-vcs ★50](https://github.com/sourcegraph/go-vcs) - manipulate and inspect VCS repositories in Go.
...
* [goav ★340](https://github.com/giorgisio/goav) - Comphrensive Go bindings for FFmpeg.
...
* [Beego ★11886](https://github.com/astaxie/beego) - beego is an open-source, high-performance web framework for the Go programming language.
* [Buffalo](http://gobuffalo.io) - Bringing the productivity of Rails to Go!
* [Echo ★7993](https://github.com/labstack/echo) - High performance, minimalist Go web framework.
...
* [Gin ★11186](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
* [Gizmo ★1866](https://github.com/NYTimes/gizmo) - Microservice toolkit used by the New York Times.
* [go-json-rest ★2858](https://github.com/ant0ine/go-json-rest) - Quick and easy way to setup a RESTful JSON API.
* [go-relax ★142](https://github.com/codehack/go-relax) - Framework of pluggable components to build RESTful API's.
* [go-rest ★103](https://github.com/ungerik/go-rest) - Small and evil REST framework for Go.
...
* [Macaron ★1972](https://github.com/go-macaron/macaron) - Macaron is a high productive and modular design web framework in Go.
...
* [Revel ★8616](https://github.com/revel/revel) - High-productivity web framework for the Go language.
...
* [tango ★613](https://github.com/lunny/tango) - Micro & pluggable web framework for Go.
...
* [traffic ★512 ⏳1Y](https://github.com/pilu/traffic) - Sinatra inspired regexp/pattern mux and web framework for Go.
* [utron ★1905](https://github.com/gernest/utron) - Lightweight MVC framework for Go(Golang).
...
* [d3d9 ★53](https://github.com/gonutz/d3d9) - Go bindings for Direct3D9
* [go-ole ★312](https://github.com/go-ole/go-ole) - Win32 OLE implementation for golang.
...
* [xquery ★67](https://github.com/antchfx/xquery) - XQuery lets you extract data from HTML/XML documents using XPath expression.

### Middlewares

#### Actual middlewares

* [CORS ★550](https://github.com/rs/cors) - Easily add CORS capabilities to your API.
...
* [Tollbooth ★576](https://github.com/didip/tollbooth) - Rate limit HTTP request handler.
* [XFF ★60](https://github.com/sebest/xff) - Handle `X-Forwarded-For` header and friends.

#### Libraries for creating HTTP middlewares

* [alice ★1311](https://github.com/justinas/alice) - Painless middleware chaining for Go.
...
* [negroni ★4832](https://github.com/urfave/negroni) - Idiomatic HTTP middleware for Golang.
* [render ★920](https://github.com/unrolled/render) - Go package for easily rendering JSON, XML, and HTML template responses.
...
* [chi ★2311](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.
* [fasthttprouter ★336](https://github.com/buaazp/fasthttprouter) - High performance router forked from `httprouter`. The first router fit for `fasthttp`.
* [gocraft/web ★1227](https://github.com/gocraft/web) - Mux and middleware package in Go.
* [Goji ★496](https://github.com/goji/goji) - Goji is a minimalistic and flexible HTTP request multiplexer with support for `net/context`.
...
* [httprouter ★5352](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.
* [httptreemux ★253](https://github.com/dimfeld/httptreemux) - High-speed, flexible tree-based HTTP router for Go. Inspiration from httprouter.
* [lars ★327](https://github.com/go-playground/lars) - Is a lightweight, fast and extensible zero allocation HTTP router for Go used to create customizable frameworks.
...
* [mux ★4300](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.
* [ozzo-routing ★199](https://github.com/go-ozzo/ozzo-routing) - An extremely fast Go (golang) HTTP router that supports regular expression route matching. Comes with full support for building RESTful APIs.
* [pat ★1050](https://github.com/bmizerany/pat) - Sinatra style pattern muxer for Go’s net/http library, by the author of Sinatra.
...
* [apicompat ★82](https://github.com/bradleyfalzon/apicompat) - Checks recent changes to a Go project for backwards incompatible changes.
* [dupl ★87](https://github.com/mibk/dupl) - Tool for code clone detection.
* [errcheck ★856](https://github.com/kisielk/errcheck) - Errcheck is a program for checking for unchecked errors in Go programs.
* [gcvis ★706 ⏳1Y](https://github.com/davecheney/gcvis) - Visualise Go program GC trace data in real time.
* [Go Metalinter ★1819](https://github.com/alecthomas/gometalinter) - Metalinter is a tool to automatically apply all static analysis tool and report their output in normalized form.
...
* [go-cleanarch ★160](https://github.com/roblaszczak/go-cleanarch) - go-cleanarch was created to validate Clean Architecture rules, like a The Dependency Rule and interaction between packages in your Go projects.
...
* [GoLint ★1937](https://github.com/golang/lint) - Golint is a linter for Go source code.
...
* [interfacer ★652](https://github.com/mvdan/interfacer) - Linter that suggests interface types.
...
* [go-lang-idea-plugin ★4362](https://github.com/go-lang-plugin-org/go-lang-idea-plugin) (deprecated) - The previous Go plugin for IntelliJ (JetBrains) IDEA, now replaced by the official plugin (above).
* [go-mode ★633](https://github.com/dominikh/go-mode.el) - Go mode for GNU/Emacs.
* [go-plus ★1279](https://github.com/joefitzgerald/go-plus) - Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting
* [Goclipse ★705](https://github.com/GoClipse/goclipse) - Eclipse plugin for Go.
* [gocode ★3806](https://github.com/nsf/gocode) - Autocompletion daemon for the Go programming language.
* [GoSublime ★2667](https://github.com/DisposaBoy/GoSublime) - Golang plugin collection for the text editor SublimeText 2 providing code completion and other IDE-like features.
...
* [vim-go ★6973](https://github.com/fatih/vim-go) - Go development plugin for Vim.
* [vscode-go ★2717](https://github.com/Microsoft/vscode-go) - Extension for Visual Studio Code (VS Code) which provides support for the Go language.
...
* [depth ★135](https://github.com/KyleBanks/depth) - Visualize dependency trees of any package by analyzing imports.
* [gb](https://getgb.io/) - An easy to use project based build tool for the Go programming language.
* [go-callvis ★860](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.
* [go-pkg-complete ★30](https://github.com/skelterjohn/go-pkg-complete) - Bash completion for go and wgo.
* [go-swagger ★1345](https://github.com/go-swagger/go-swagger) - Swagger 2.0 implementation for go. Swagger is a simple yet powerful representation of your RESTful API.
* [OctoLinker ★2262](https://github.com/OctoLinker/browser-extension) - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.
...
* [aptly ★1380](https://github.com/smira/aptly) - aptly is a Debian repository management tool.
...
* [Banshee ★824](https://github.com/eleme/banshee) - Anomalies detection system for periodic metrics.
* [bombardier ★582](https://github.com/codesenberg/bombardier) - Fast cross-platform HTTP benchmarking tool.
* [bosun ★2326](https://github.com/bosun-monitor/bosun) - Time Series Alerting Framework.
* [dogo ★142](https://github.com/liudng/dogo) - Monitoring changes in the source file and automatically compile and run (restart).
...
* [Gitea ★3347](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.
* [Go Metrics ★1637](https://github.com/rcrowley/go-metrics) - Go port of Coda Hale's Metrics library: https://github.com/codahale/metrics.
* [go-selfupdate ★507](https://github.com/sanbornm/go-selfupdate) - Enable your Go applications to self update.
...
* [gox ★2256](https://github.com/mitchellh/gox) - Dead simple, no frills Go cross compile tool.
* [goxc ★1444](https://github.com/laher/goxc) - build tool for Go, with a focus on cross-compiling and packaging.
* [grapes ★39](https://github.com/yaronsumel/grapes) -  lightweight tool designed to distribute commands over ssh with ease.
* [GVM ★2939](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.
* [Hey ★1750](https://github.com/rakyll/hey) - Hey is a tiny program that sends some load to a web application.
* [kala ★1046](https://github.com/ajvb/kala) - Simplistic, modern, and performant job scheduler.
* [kubernetes ★25744](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.
* [Moby ★44937](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems
...
* [Scaleway-cli ★335](https://github.com/scaleway/scaleway-cli) - Manage BareMetal Servers from Command Line (as easily as with Docker).
...
* [StatusOK ★779](https://github.com/sanathp/statusok) - Monitor your Website and REST APIs.Get Notified through Slack, E-mail when your server is down or response time is more than expected.
* [Vegeta ★6111](https://github.com/tsenart/vegeta) - HTTP load testing tool and library. It's over 9000!
* [webhook ★1862](https://github.com/adnanh/webhook) - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
* [Cherry ★128](https://github.com/rafael-santiago/cherry) - Tiny webchat server in Go.
* [Circuit ★1546](https://github.com/gocircuit/circuit) - Circuit is a programmable platform-as-a-service (PaaS) and/or Infrastructure-as-a-Service (IaaS), for management, discovery, synchronization and orchestration of services and hosts comprising cloud applications.
* [Comcast ★4837](https://github.com/tylertreat/Comcast) - Simulate bad network connections.
* [confd ★4054](https://github.com/kelseyhightower/confd) - Manage local application configuration files using templates and data from etcd or consul.
...
* [Documize ★189](https://github.com/documize/community) - Modern wiki software that integrates data from SaaS tools.
* [fleet ★2397](https://github.com/coreos/fleet) - Distributed init System.
...
* [Leaps ★480](https://github.com/jeffail/leaps) - Pair programming service using Operational Transforms.
* [limetext](http://limetext.org/) Lime Text is a powerful and elegant text editor primarily developed in Go that aims to be a Free and open-source software successor to Sublime Text.
* [LiteIDE ★3864](https://github.com/visualfc/liteide) LiteIDE is a simple, open source, cross-platform Go IDE.
* [mockingjay ★327](https://github.com/quii/mockingjay-server) Fake HTTP servers and consumer driven contracts from one configuration file. You can also make the server randomly misbehave to help do more realistic performance tests.
* [myLG ★1819](https://github.com/mehrdadrad/mylg) - Command Line Network Diagnostic tool written in Go.
* [naclpipe ★11](https://github.com/unix4fun/naclpipe) - Simple NaCL EC25519 based crypto pipe tool written in Go.
* [nes ★2779](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.
* [orange-cat ★153 ⏳1Y](https://github.com/noraesae/orange-cat) - Markdown previewer written in Go.
* [peg ★415](https://github.com/pointlander/peg) - Peg, Parsing Expression Grammar, is an implementation of a Packrat parser generator.
* [Postman ★681](https://github.com/zachlatta/postman) - Command-line utility for batch-sending email.
* [restic ★2184](https://github.com/restic/restic) - De-duplicating backup program.
...
* [Seaweed File System ★4521](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.
...
* [snap ★1543](https://github.com/intelsdi-x/snap) - Powerful telemetry framework.
...
* [toxiproxy ★2046](https://github.com/shopify/toxiproxy) - Proxy to simulate network and system conditions for automated tests.
...
* [go-http-routing-benchmark ★930](https://github.com/julienschmidt/go-http-routing-benchmark) - Go HTTP request router benchmark and comparison.
...
* [go-web-framework-benchmark ★485](https://github.com/smallnest/go-web-framework-benchmark) - Go web framework benchmark.
* [go_serialization_benchmarks ★536](https://github.com/alecthomas/go_serialization_benchmarks) - Benchmarks of Go serialization methods.
...
* [gospeed ★63 ⏳1Y](https://github.com/feyeleanor/GoSpeed) - Go micro-benchmarks for calculating the speed of language constructs.
* [kvbench ★11 ⏳3Y](https://github.com/jimrobinson/kvbench) - Key/Value database benchmark.
* [skynet ★769 ⏳1Y](https://github.com/atemerev/skynet) - Skynet 1M threads microbenchmark.
...
* [GoBooks ★3786](https://github.com/dariubs/GoBooks) - A curated list of Go books
* [Learning Go](https://www.miek.nl/downloads/Go/Learning-Go-latest.pdf)
* [Network Programming With Go](https://jan.newmarch.name/go/)
* [The Go Programming Language](http://www.gopl.io/)
* [Web Application with Go the Anti-Textbook ★1743](https://github.com/thewhitetulip/web-dev-golang-anti-textbook)
...
* [Awesome Remote Job ★9636](https://github.com/lukasz-madon/awesome-remote-job) - Curated list of awesome remote jobs. A lot of them is looking for Go hackers.
...
* [Build web application with Golang ★17317](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.
* [Building Go Web Applications and Microservices Using Gin](https://semaphoreci.com/community/tutorials/building-go-web-applications-and-microservices-using-gin) - Get familiar with Gin and find out how it can help you reduce boilerplate code and build a request handling pipeline.
* [Go By Example](https://gobyexample.com/) - Hands-on introduction to Go using annotated example programs.
* [Go Cheat Sheet ★2234](https://github.com/a8m/go-lang-cheat-sheet) - Go's reference card.
* [Go database/sql tutorial](http://go-database-sql.org/) - Introduction to database/sql.
* [Golangbot](https://golangbot.com/learn-golang-series/) - Tutorials to get started with programming in Go.
* [How to Use Godog for Behavior-driven Development in Go](https://semaphoreci.com/community/tutorials/how-to-use-godog-for-behavior-driven-development-in-go) - Get started with Godog — a Behavior-driven development framework for building and testing Go applications.
* [Working with Go ★751](https://github.com/mkaz/working-with-go) - Intro to go for experienced programmers.
---
<p align="center">
	This list is a copy of <a href="https://github.com/avelino/awesome-go">avelino/awesome-go</a> with ranks
</p>
