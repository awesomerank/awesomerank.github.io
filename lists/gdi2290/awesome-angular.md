...
* [GitHub Repo ★29957](https://github.com/angular/angular)
...
* [Angular 2 Universal Repository (GitHub) ★2648](https://github.com/angular/universal)

#### Material Design
* [Official Angular 2 Material Design (GitHub) ★11807](https://github.com/angular/material2)
...
* [ng2-materialize ★186](https://github.com/sherweb/ng2-materialize) An Angular 2 wrap around Materialize library
...
* [Angular Performance Checklist ★1301](https://github.com/mgechev/angular-performance-checklist)
...
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/View.md)
...
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/Templates.md)

##### Change detection
Every component gets a change detector responsible for checking the bindings defined in its template.
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/ChangeDetection.md)
...
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/DI.md)

##### Pipes
Pipes can be appended on the end of the expressions to translate the value to a different format.
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/Pipes.md)
...
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/WebWorkers.md)
...
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/HTTP.md)

##### Router
* [Offical Router](https://angular.io/guide/router.html#sts=Router%20imports)
* [ui-router ★13646](https://github.com/angular-ui/ui-router)
<br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/Router.md)
...
* [Official repository ★13704](https://github.com/angular/angular-cli)

#### Webpack
* [Official web page](https://webpack.github.io/)
* [Angular Starter from AngularClass ★9182](https://github.com/AngularClass/angular-starter)
* [Angular Webpack from preboot ★1342](https://github.com/preboot/angular-webpack)
* [Angular Nightly Webpack Starter ★757](https://github.com/qdouble/angular-webpack2-starter)
* [Angular Webpack with Visual Studio ASP.NET Core from Damien Bowden ★398](https://github.com/damienbod/AngularWebpackVisualStudio)
...
* [Shared Webpack config for Angular development by fulls1z3 ★11](https://github.com/ng-seed/angular-webpack-config)
...
* [Shared TSLint & codelyzer rules by fulls1z3 ★21](https://github.com/ng-seed/angular-tslint-rules)
...
* [ng2-dragula ★1058](https://github.com/valor-software/ng2-dragula) Drag and Drop so simple it hurts!
* [ng2-file-upload ★1012](https://github.com/valor-software/ng2-file-upload) Easy to use file upload directives
* [ng2-handsontable ★200](https://github.com/valor-software/ng2-handsontable) Excel-like data grid / spreadsheet
* [ng2-select ★535](https://github.com/valor-software/ng2-select) Angular2 based replacement for select boxes
* [ng2-safe-img ★4 ⏳1Y](https://github.com/hyzhak/ng2-safe-img) Very tiny and safe img for Angular 2
* [ng2-table ★441](https://github.com/valor-software/ng2-table) Simple table extension with sorting, filtering, paging... for Angular2 apps
* [ng2-smart-table ★729](https://github.com/akveo/ng2-smart-table) Smart data table library with sorting, filtering, pagination & add/edit/delete functions.
...
* [angular2-fontawesome ★68](https://github.com/travelist/angular2-fontawesome) Angular2 Components and Directives for Fontawesome
...
* [angular2-google-maps ★949](https://github.com/SebastianM/angular-google-maps) Angular2 directives for Google Maps
...
* [fuel-ui ★285](https://github.com/FuelInteractive/fuel-ui) Bootstrap 4 components and directives for use in Angular 2
* [prime-ng](https://www.primefaces.org/primeng/)  Collection of rich UI components for Angular 2
* [ng2-ace ★27](https://github.com/seiyria/ng2-ace) Ace editor directive made for Angular 2
...
* [angular2-text-mask ★2336](https://github.com/text-mask/text-mask) Angular 2 input mask directive
* [ng2-fullpage ★148](https://github.com/meiblorn/ngx-fullpage) Fullpage scrolling for Angular2 based on fullPage.js
* [file-droppa ★52](https://github.com/ptkach/fileDroppa) Simple files drop and upload component with files list
* [ngx-img-fallback ★27](https://github.com/VadimDez/ngx-img-fallback) Load placeholder image on image error
* [angular2-busy ★264](https://github.com/devyumao/angular2-busy) Show busy/loading indicators on any promise, or on any Observable's subscription
* [ng2-pdf-viewer ★201](https://github.com/VadimDez/ng2-pdf-viewer) PDF viewer component
...
* [ngSemantic ★886](https://github.com/vladotesanovic/ngSemantic) - UI components based on Semantic UI
* [vmware clarity ★2610](https://github.com/vmware/clarity) - Mostly a CSS only framework but some components are ported to Angular 2
* [Teradata covalent ★1341](https://github.com/Teradata/covalent) - UI Platform built on @angular/material 2.0
* [ng2-quill-editor ★103](https://github.com/surmon-china/ngx-quill-editor) - Quill editor component for Angular2
* [ngx-charts ★1383](https://github.com/swimlane/ngx-charts) - Declarative Charting Framework for Angular2 and beyond!
* [ngx-datatable ★1957](https://github.com/swimlane/ngx-datatable)  A feature-rich yet lightweight data-table crafted for Angular2 and beyond!
* [ngx-ui ★251](https://github.com/swimlane/ngx-ui) - Style and Component Library for Angular2 and beyond!
...
* [lottie-angular2 ★97](https://github.com/chenqingspring/ng-lottie) - Render After Effects animations on Angular2 based on Bodymovin.
* [ngx-restangular ★507](https://github.com/2muchcoffeecom/ngx-restangular) - Restangular for Angular 2 and higher versions.
...
* [angular-split ★92](https://github.com/bertrandg/angular-split) Angular split component
* [od-virtualscroll ★74](https://github.com/dinony/od-virtualscroll) Observable-based virtual scroll implementation in Angular
* [angular2-froala-wysiwyg ★192](https://github.com/froala/angular-froala-wysiwyg) Angular 2 wrapper for Froala WYSIWYG HTML Editor
* [ngx-meta ★135](https://github.com/fulls1z3/ngx-meta) - Dynamic page title & meta tags utility for Angular (w/server-side rendering) by @fulls1z3
* [ngx-config ★55](https://github.com/fulls1z3/ngx-config) - Configuration utility for Angular (incl. Angular Universal loader) by @fulls1z3
* [ngx-cache ★33](https://github.com/fulls1z3/ngx-cache) - Cache utility for Angular (incl. browser & server platform implementations) by @fulls1z3
* [ngx-i18n-router ★15](https://github.com/fulls1z3/ngx-i18n-router) - Route internationalization utility for Angular by @fulls1z3
* [ngx-auth ★7](https://github.com/fulls1z3/ngx-auth) -Authentication utility for Angular by @fulls1z3
* [angular2-promise-buttons ★34](https://github.com/johannesjo/angular2-promise-buttons) - Loading buttons for Angular 2 by @johannesjo
* [ng2-archwizard ★71](https://github.com/madoar/ng2-archwizard) - Wizard component for Angular 2
* [ngx-popper ★43](https://github.com/MrFrankel/ngx-popper) - Tooltip managment, wrapper for popper.js(https://popper.js.org/)
* [ngx-avatar ★41](https://github.com/HaithemMosbahi/ngx-avatar) - Avatar component that makes it possible to genearte / fetch avatar based on the information you have about the user.
...
* [ng-katex ★2](https://github.com/garciparedes/ng-katex) Angular module to write beautiful math expressions with TeX syntax boosted by KaTeX library
...
#### Pipes
* [fuel-ui ★285](https://github.com/FuelInteractive/fuel-ui) OrderBy and Range pipes ported from Angular 1.x to Angular 2
* [ngx-filter-pipe ★48](https://github.com/VadimDez/ngx-filter-pipe) Pipe for filtering arrays
* [ngx-pipes ★511](https://github.com/danrevah/ngx-pipes) Bunch of useful pipes for Angular2 and beyond!
* [ngx-order-pipe ★68](https://github.com/VadimDez/ngx-order-pipe) OrderBy pipe for Angular4+ - sort collection by a field
...
* Node.js
  ...
  * ngX-Rocket: Extensible Angular 4+ enterprise-grade generator and tools
    * [ngx-rocket/generator-ngx-rocket ★215](https://github.com/ngx-rocket/generator-ngx-rocket)
    * [ngx-rocket/cli ★14](https://github.com/ngx-rocket/cli)
    * [ngx-rocket/core ★4](https://github.com/ngx-rocket/core)
* Dart
  * Stagehand
...
* [Compodoc ★956](https://github.com/compodoc/compodoc) : "The missing documentation tool for your Angular 2 application", integrate well with npm scripts
...
* [Universal Angular 2 Repository (GitHub) ★2648](https://github.com/angular/universal)

#### Universal Seed Projects
* [universal-starter ★1481](https://github.com/angular/universal-starter) - Angular 2 Universal starter kit by @Angular-Class
* [ng-seed/universal ★326](https://github.com/ng-seed/universal) - Seed project for Angular Universal apps featuring Server-Side Rendering (SSR), Webpack, dev/prod modes, DLLs, AoT compilation, HMR, SCSS compilation, lazy loading, config, cache, i18n, SEO, and TSLint/codelyzer by @fulls1z3
...
* [TypeScript Repository (GitHub) ★27889](https://github.com/Microsoft/TypeScript) Official GitHub Repo for TypeScript
* [DefinitelyTyped Repository (GitHub) ★13026](https://github.com/DefinitelyTyped/DefinitelyTyped) The repository for high quality TypeScript type definitions.


#### TypeScript Seed Projects
* [Angular Seed](https://mgechev.github.io/angular-seed/) Seed project for Angular apps
* [ng2-play ★575 ⏳1Y](https://github.com/pkozlowski-opensource/ng2-play) A minimal Angular2 playground using TypeScript and SystemJS loader
* [Angular Lab](https://github.com/rolandjitsu/angular-lab) A simple Angular 2+ setup using [Angular CLI](https://cli.angular.io), [TypeScript](http://www.typescriptlang.org), [Angular Flex Layout ★1819](https://github.com/angular/flex-layout), [Material 2](https://material.angular.io), [AOT](https://angular.io/docs/ts/latest/cookbook/aot-compiler.html), and unit and e2e tests on [Travis CI](https://travis-ci.org) and [Saucelabs](https://saucelabs.com).
* [Angular2Go ★282](https://github.com/johnpapa/angular-go) Angular 2 Go !
* [Angular 2 Samples ★966](https://github.com/thelgevold/angular-2-samples) Angular 2.0 sample components
* [Todo app with Firebase, OAuth, and Immutable ★466](https://github.com/r-park/todo-angular-firebase)
...
* [Angular 2 Goldilocks seed ★44 ⏳1Y](https://github.com/ColinEberhardt/angular2-goldilocks-seed) - A seed project for Angular 2 and TypeScript that is not too simple, yet not too complex. In fact it's just right!
* [Angular 2 Starter ★544](https://github.com/antonybudianto/angular-starter) - Simple Angular 2 Starter with Gulp workflow and Travis CI
* [Angular 2 Leaflet Starter ★162](https://github.com/haoliangyu/ngx-leaflet-starter) - A map application starter based on Angular 2 and Leaflet
...
* [ng-kitchen-sink ★758](https://github.com/born2net/Angular-kitchen-sink) - The ultimate Angular 2 bootstrap single page app - touches on all key and advanced aspects of Angular
...
* [Angular NPM Module Seed ★43](https://github.com/davguij/angular-npm-module-seed) - Starting point for developing Angular modules and publishing them on NPM.
...
* [Ionic 2 Awesome ★610](https://github.com/candelibas/awesome-ionic)
...
* [Angular 2 Seed CLI Admin (Template) ★37](https://github.com/jvitor83/angular-pwa-seed) Multi-platform Angular 2 project (Web/PWA, Mobile and Desktop) with Ionic 2 (and optionally Bootstrap).
...
* [angular2-es6-starter ★518](https://github.com/blacksonic/angular2-babel-esnext-starter) A skeleton Angular 2 ES6 application built with Babel, Webpack, Gulp.
...
* [angular2-es6-todomvc ★139](https://github.com/blacksonic/angular2-esnext-todomvc) Angular 2 TodoMVC implementation with ES6.
...
* [sample-Angular2 ★49 ⏳1Y](https://github.com/NativeScript/sample-Angular2)
* [angular2-seed-advanced ★2045](https://github.com/NathanWalker/angular-seed-advanced)
* [**{{** add_your_repo **}}**](https://github.com/angularclass/awesome-angular/edit/gh-pages/README.md)
...
* [Angular 2 React Native Renderer (GitHub) ★715](https://github.com/angular/react-native-renderer)
...
* [Angular 2 bootstrap4 OAuth2 Webpack from Michael Oryl ★189](https://github.com/michaeloryl/angular2-bootstrap4-oauth2-webpack)
...
* [Angular 2 authentication sample from auth0-blog ★1011](https://github.com/auth0-blog/angular2-authentication-sample)
