---
layout: default
title: Awesome Rank for gdi2290/awesome-angular
---

<p align="center">
	This list is a copy of <a href="https://github.com/gdi2290/awesome-angular">gdi2290/awesome-angular</a> with ranks
</p>
---
<p align="center">
...
* [GitHub Repo ★36970](https://github.com/angular/angular)
...
* [Angular Universal Repository (GitHub) ★3006](https://github.com/angular/universal)

#### Material Design

* [Official Angular Material Design (GitHub) ★14647](https://github.com/angular/material2)
...
* [Angular Dart cheatsheet ★10 ⏳2Y](https://github.com/andresaraujo/angular2_cheatsheet_dart)
* [Angular Performance Checklist ★1800](https://github.com/mgechev/angular-performance-checklist)
...
* [ui-router ★13864](https://github.com/angular-ui/ui-router)
...
* [Testing UI Components with the TestComponentBuilder](http://chariotsolutions.com/blog/post/testing-angular-2-components-unit-tests-testcomponentbuilder/)
  ...
  <br>[Read more »](https://github.com/gdi2290/awesome-angular/blob/master/features/Test.md)
...
* [Code Example with Webpack ★336](https://github.com/blacksonic/angular2-aot-webpack)
* [Code Example with Rollup ★83 ⏳1Y](https://github.com/mgechev/angular2-ngc-rollup-build)

#### Angular CLI

* [Official web page](https://cli.angular.io/)
* [Official repository ★18053](https://github.com/angular/angular-cli)

#### Webpack

* [Official web page](https://webpack.js.org)
* [Angular Webpack Starter from PatrickJS ★9812](https://github.com/gdi2290/angular-starter)
* [Angular Webpack from preboot ★1363](https://github.com/preboot/angular-webpack)
* [Angular Nightly Webpack Starter](https://github.com/qdouble/angular-webpack2-starter)
* [Angular Webpack with Visual Studio ASP.NET Core from Damien Bowden ★460](https://github.com/damienbod/AngularWebpackVisualStudio)
* [Angular Typescript Webpack from schempy ★74 ⏳1Y](https://github.com/schempy/angular2-typescript-webpack)
...
* [Shared Webpack config for Angular development by fulls1z3 ★22](https://github.com/ng-seed/angular-webpack-config)
...
* [Shared TSLint & codelyzer rules by fulls1z3 ★63](https://github.com/ng-seed/angular-tslint-rules)
...
* [nativescript-angular ★830](https://github.com/NativeScript/nativescript-angular)
* [react-native-renderer ★756](https://github.com/angular/react-native-renderer)
* [GraphQL + Angular ★425](https://github.com/apollographql/apollo-angular)

#### Third Party Components

* [Material 2 ★14647](https://github.com/angular/material2) - Angular team's Material Design components built on top of Angular 2
  [![GitHub stars](https://img.shields.io/github/stars/angular/material2.svg) ★14647](https://github.com/angular/material2)
  [![GitHub last commit](https://img.shields.io/github/last-commit/google/skia.svg) ★14647](https://github.com/angular/material2)
  [![GitHub commit activity the past week, 4 weeks, year](https://img.shields.io/github/commit-activity/y/eslint/eslint.svg) ★14647](https://github.com/angular/material2)

* [NG ZORRO ★3028](https://github.com/NG-ZORRO/ng-zorro-antd) - An enterprise-class UI components based on Ant Design and Angular.
...
* [angular-epic-spinners ★33](https://github.com/hackafro/angular-epic-spinners) Reusable spinner components for angular
* [ng2-bootstrap ★4074](https://github.com/valor-software/ngx-bootstrap) Native Angular2 Bootstrap 3&4 components
* [ng2-charts ★1222](https://github.com/valor-software/ng2-charts) Beautiful charts for Angular2 based on Chart.js
* [ng2-dragula ★1316](https://github.com/valor-software/ng2-dragula) Drag and Drop so simple it hurts!
* [ng2-file-upload ★1348](https://github.com/valor-software/ng2-file-upload) Easy to use file upload directives
* [ng2-handsontable ★231](https://github.com/valor-software/ng2-handsontable) Excel-like data grid / spreadsheet
* [ng2-markdown ★20](https://github.com/evanplaice/ng2-markdown) Angular2 Markdown Web Component
* [ng2-select ★623](https://github.com/valor-software/ng2-select) Angular2 based replacement for select boxes
* [ng2-safe-img ★5 ⏳1Y](https://github.com/hyzhak/ng2-safe-img) Very tiny and safe img for Angular 2
* [ng2-table ★504](https://github.com/valor-software/ng2-table) Simple table extension with sorting, filtering, paging... for Angular2 apps
* [ng2-smart-table ★971](https://github.com/akveo/ng2-smart-table) Smart data table library with sorting, filtering, pagination & add/edit/delete functions.
* [ng2-bs ★12 ⏳2Y](https://github.com/pkozlowski-opensource/ng2-bs) Experiments with Angular 2 directives for Bootstrap.
* [ng-lightning ★653](https://github.com/ng-lightning/ng-lightning) Native Angular 2 components & directives for Lightning Design System
* [ag-grid](https://www.ag-grid.com/) Advanced Datagrid for Pure Javascript / AngularJS 1.x / AngularJS 2 / Web Components
* [angular2-query-builder ★44](https://github.com/zebzhao/Angular-QueryBuilder) Modernized query builder based on jquery QueryBuilder
* [angular2-grid ★324](https://github.com/BTMorton/angular2-grid) A drag/drop/resize grid-based plugin directive for angular2.
* [angular2-jwt ★1782](https://github.com/auth0/angular2-jwt) Library for sending authenticated HTTP requests and decoding JWTs
* [angular2-cookie ★107 ⏳1Y](https://github.com/salemdar/angular2-cookie) Library that implements Angular 1.x $cookies service in Angular 2
* [angular2-fontawesome ★84](https://github.com/travelist/angular2-fontawesome) Angular2 Components and Directives for Fontawesome
* [angular-safeguard ★70](https://github.com/MikaAK/angular-safeguard) Wrapper around cookies/sessionStorage/localStorage for angular2. If all are unavailable will use an in memory storage.
* [angular2-google-maps ★1327](https://github.com/SebastianM/angular-google-maps) Angular2 directives for Google Maps
* [angular-cesium ★54](https://github.com/TGFTech/angular-cesium) Creating map based web apps using Cesium and Angular
* [ng2-radio-group ★45 ⏳1Y](https://github.com/pleerock/ngx-select-controls) Angular2 directives for radio and checkbox inputs and radio input groups
* [ng2-dropdown ★75 ⏳1Y](https://github.com/pleerock/ngx-dropdown) Dropdown menu for angular2 and bootstrap 3
* [angular2-multiselect-dropdown ★111](https://github.com/CuppaLabs/angular2-multiselect-dropdown) Angular 2 multiselect dropdown component for web applications
* [ng2-progress-bar ★21 ⏳1Y](https://github.com/pleerock/ngx-progress-bar) Simple progress bar for angular2 and bootstrap 3
* [ng2-tabs ★37](https://github.com/pleerock/ngx-tabs) Tabs control for angular2 and bootstrap 3
* [ng2-modal ★113 ⏳1Y](https://github.com/pleerock/ngx-modal) Modal window for angular2 and bootstrap 3
...
* [ng2-paginator ★28 ⏳1Y](https://github.com/pleerock/ngx-paginator) Pagination control for angular2 and bootstrap 3
* [fuel-ui ★294](https://github.com/FuelInteractive/fuel-ui) Bootstrap 4 components and directives for use in Angular 2
* [prime-ng](https://www.primefaces.org/primeng/) Collection of rich UI components for Angular 2
* [ng2-ace ★34 ⏳1Y](https://github.com/seiyria/ng2-ace) Ace editor directive made for Angular 2
* [ng2-storage ★19 ⏳1Y](https://github.com/seiyria/ng2-storage) A localStorage and sessionStorage wrapper written using ES6 Proxies for Angular 2
* [ng2-fontawesome ★20 ⏳1Y](https://github.com/seiyria/ng2-fontawesome) A small directive making font awesome even easier to use.
* [ng2-sweetalert2 ★51](https://github.com/seiyria/ng2-sweetalert2) A wrapper for sweetalert2 for use with Angular 2.
* [angular2-text-mask ★5760](https://github.com/text-mask/text-mask) Angular 2 input mask directive
* [angular-imask](https://github.com/uNmAnNeR/imaskjs/tree/gh-pages/plugins/angular) Angular 4+ input mask
* [ng2-fullpage ★191](https://github.com/meiblorn/ngx-fullpage) Fullpage scrolling for Angular2 based on fullPage.js
* [file-droppa ★54](https://github.com/ptkach/fileDroppa) Simple files drop and upload component with files list
* [ngx-img-fallback ★41](https://github.com/VadimDez/ngx-img-fallback) Load placeholder image on image error
* [angular2-busy ★308](https://github.com/devyumao/angular2-busy) Show busy/loading indicators on any promise, or on any Observable's subscription
* [ng2-pdf-viewer ★392](https://github.com/VadimDez/ng2-pdf-viewer) PDF viewer component
...
* [ng2-card ★6 ⏳1Y](https://github.com/c-bata/ng2-card) - Card view component for Angular2
* [Wijmo 5](http://wijmo.com/products/wijmo-5/) - Set of UI components for Angular2
* [ng2-swipeable-card ★14 ⏳1Y](https://github.com/JayKan/ng2-swipeable-card) - Swipeable card component for Angular2
* [ngSemantic ★939](https://github.com/vladotesanovic/ngSemantic) - UI components based on Semantic UI
* [vmware clarity ★3607](https://github.com/vmware/clarity) - Mostly a CSS only framework but some components are ported to Angular 2
* [Teradata covalent ★1684](https://github.com/Teradata/covalent) - UI Platform built on @angular/material 2.0
* [ng2-quill-editor ★158](https://github.com/surmon-china/ngx-quill-editor) - Quill editor component for Angular2
* [ngx-charts ★2071](https://github.com/swimlane/ngx-charts) - Declarative Charting Framework for Angular2 and beyond!
* [ngx-datatable ★2785](https://github.com/swimlane/ngx-datatable) A feature-rich yet lightweight data-table crafted for Angular2 and beyond!
* [ngx-ui ★332](https://github.com/swimlane/ngx-ui) - Style and Component Library for Angular2 and beyond!
...
* [angular2-simple-countdown ★19](https://github.com/previousdeveloper/angular2-simple-countdown) - a simple countdown angular2 directive with multiple language
* [ng-http-cache ★23 ⏳1Y](https://github.com/davguij/angular-http-cache) - Speed up your remote requests by automatically caching them on client.
* [ng-animate ★248](https://github.com/jiayihu/ng-animate) - 🌙 A collection of cool, reusable and flexible animations for Angular
* [lottie-angular2 ★152](https://github.com/chenqingspring/ng-lottie) - Render After Effects animations on Angular2 based on Bodymovin.
* [ngx-restangular ★610](https://github.com/2muchcoffeecom/ngx-restangular) - Restangular for Angular 2 and higher versions.
* [ngfb-sortable-table ★19](https://github.com/NodeArt/Angular-Firebase-Sortable-Table) - Angular Firebase Sortable Table. Ability to filter and sort data with own firebase quering tools.
* [angular-split ★175](https://github.com/bertrandg/angular-split) Angular split component
* [od-virtualscroll ★105](https://github.com/dinony/od-virtualscroll) Observable-based virtual scroll implementation in Angular
* [angular2-froala-wysiwyg ★369](https://github.com/froala/angular-froala-wysiwyg) Angular 2 wrapper for Froala WYSIWYG HTML Editor
* [ngx-meta ★200](https://github.com/fulls1z3/ngx-meta) - Dynamic page title & meta tags utility for Angular (w/server-side rendering) by @fulls1z3
* [ngx-config ★78](https://github.com/fulls1z3/ngx-config) - Configuration utility for Angular (incl. Angular Universal loader) by @fulls1z3
* [ngx-cache ★66](https://github.com/fulls1z3/ngx-cache) - Cache utility for Angular (incl. browser & server platform implementations) by @fulls1z3
* [ngx-i18n-router ★25](https://github.com/fulls1z3/ngx-i18n-router) - Route internationalization utility for Angular by @fulls1z3
* [ngx-auth ★31](https://github.com/fulls1z3/ngx-auth) -Authentication utility for Angular by @fulls1z3
* [angular2-promise-buttons ★61](https://github.com/johannesjo/angular2-promise-buttons) - Loading buttons for Angular 2 by @johannesjo
* [ng2-archwizard](https://github.com/madoar/ng2-archwizard) - Wizard component for Angular 2
* [ngx-popper ★91](https://github.com/MrFrankel/ngx-popper) - Tooltip managment, wrapper for popper.js(https://popper.js.org/)
...
* [ng-snotify ★182](https://github.com/artemsky/ng-snotify) - Angular 4 Notification Center
* [ngx-permissions ★274](https://github.com/AlexKhymenko/ngx-permissions) - Permission and roles based access control for your angular(angular 2, angular 4,5+) applications(AOT, lazy modules compatible)
* [Nebular ★1654](https://github.com/akveo/nebular) - set of essential (Theme, UI Kit, Auth, Security) modules for complex Angular applications
* [ng-select ★577](https://github.com/ng-select/ng-select) Angular ng-select - All in One UI Select, Multiselect and Autocomplete
* [ng-katex ★36](https://github.com/garciparedes/ng-katex) Angular module to write beautiful math expressions with TeX syntax boosted by KaTeX library
* [ng-fullcalendar ★59](https://github.com/Jamaks/ng-fullcalendar) Jquery fullcalendar module for Angular
* [angular-bootstrap-md](https://mdbootstrap.com/angular/) Material Design for Bootstrap 4 (Angular)
* [ngx-konami ★6](https://github.com/lauthieb/ngx-konami) - Simple directive to add easter eggs in Angular 2+ applications
* [ngx-mapbox-gl ★44](https://github.com/Wykks/ngx-mapbox-gl) - Angular binding of mapbox-gl-js
* [ng-chat ★29](https://github.com/rpaschoal/ng-chat) - A simple facebook/linkedin lookalike chat module for Angular applications
* [ngx-store ★57](https://github.com/zoomsphere/ngx-store) - Complex library for managing `localStorage`, `sessionStorage` and cookies, allows to watch data changes, provides decorators and API based on builder pattern
* [angular-esc ★1](https://github.com/DanielKucal/angular-esc) - Adds `(esc)` output fired by the Escape key
* [angular-clickable-click ★1](https://github.com/DanielKucal/angular-clickable-click) - Sets pointer cursor on elements using  standard `(click)` output and allows to disable such events

#### Site Templates

* [NG-Dashboard ★46](https://github.com/YagoLopez/ng-dashboard) - Dashboard for Angular 4+. UI Components based on [Material Light](https://github.com/YagoLopez/material-light?ref=awesome-angular). Chart Component based on [MetricsGraficsJS](https://www.metricsgraphicsjs.org). Map Directive based on [LeafletJS](http://leafletjs.com). [DEMO ONLINE](http://yagolopez.js.org/ng-dashboard/dist/)

#### Pipes

* [fuel-ui ★294](https://github.com/FuelInteractive/fuel-ui) OrderBy and Range pipes ported from Angular 1.x to Angular 2
* [ngx-filter-pipe ★73](https://github.com/VadimDez/ngx-filter-pipe) Pipe for filtering arrays
* [ngx-pipes ★705](https://github.com/danrevah/ngx-pipes) Bunch of useful pipes for Angular2 and beyond!
* [ngx-order-pipe ★135](https://github.com/VadimDez/ngx-order-pipe) OrderBy pipe for Angular4+ - sort collection by a field
* [angular2-camelcase ★1 ⏳1Y](https://github.com/previousdeveloper/angular2-camelcase) Angular2 pipe to convert camelCase strings to human readable strings Edit
...
* Node.js
  ...
  * ngX-Rocket: Extensible Angular 4+ enterprise-grade generator and tools
    * [ngx-rocket/generator-ngx-rocket ★510](https://github.com/ngx-rocket/generator-ngx-rocket)
    * [ngx-rocket/cli ★14](https://github.com/ngx-rocket/cli)
    * [ngx-rocket/core ★7](https://github.com/ngx-rocket/core)
* Dart
  * Stagehand
...
* [Storybook ★24644](https://github.com/storybooks/storybook) : "The UI development environment you'll love to use"

* [Compodoc ★1693](https://github.com/compodoc/compodoc) : "The missing documentation tool for your Angular 2 application", integrate well with npm scripts
...
* [NgModule-Viz ★23 ⏳1Y](https://github.com/politie/ngmodule-viz) : Visualize the dependencies between the NgModules in your Angular 2+ application.
...
* [Universal Angular 2 Repository (GitHub) ★3006](https://github.com/angular/universal)

#### Universal Seed Projects

* [universal-starter ★1769](https://github.com/angular/universal-starter) - Angular 2 Universal starter kit by @Angular-Class
* [ng-seed/universal ★455](https://github.com/ng-seed/universal) - Seed project for Angular Universal apps featuring Server-Side Rendering (SSR), Webpack, dev/prod modes, DLLs, AoT compilation, HMR, SCSS compilation, lazy loading, config, cache, i18n, SEO, and TSLint/codelyzer by @fulls1z3
* [angular-universal ★28](https://github.com/enten/angular-universal) - Angular 6 Universal starter kit based on @angular/cli featuring Server-Side Rendering (SSR) and HMR on browser/server sides
...
* [TypeScript Repository (GitHub) ★35079](https://github.com/Microsoft/TypeScript) Official GitHub Repo for TypeScript
* [DefinitelyTyped Repository (GitHub) ★15896](https://github.com/DefinitelyTyped/DefinitelyTyped) The repository for high quality TypeScript type definitions.

#### TypeScript Seed Projects

* [Angular Seed](https://mgechev.github.io/angular-seed/) Seed project for Angular apps
* [ng2-play ★563 ⏳2Y](https://github.com/pkozlowski-opensource/ng2-play) A minimal Angular2 playground using TypeScript and SystemJS loader
...
* [Angular 2 Leaflet Starter ★188](https://github.com/haoliangyu/ngx-leaflet-starter) - A map application starter based on Angular 2 and Leaflet
* [Angular 2 MapboxGL Starter ★44](https://github.com/haoliangyu/ngx-mapboxgl-starter) - Another map application starter based on Angular 2 and MapboxGL JS
...
* [ng-kitchen-sink ★771](https://github.com/born2net/Angular-kitchen-sink) - The ultimate Angular 2 bootstrap single page app - touches on all key and advanced aspects of Angular
* [ng-skeleton ★34 ⏳1Y](https://github.com/born2net/ng-skeleton) - The ultimate Angular seed with ngrx, bootstrap and two factor auth
* [angular2-demo ★91 ⏳1Y](https://github.com/amcdnl/angular2-demo) Minimal Angular2 Demo using TypeScript / Sass / Npm Tasks
* [Angular 2 Dashboard Starter ★105 ⏳1Y](https://github.com/hasanhameed07/angular2-dashboard-starter) - Ready to use dashboard control panel seed project based on Angular 2 and AdminLTE bootstrap theme.
* [ngx-admin ★11805](https://github.com/akveo/ngx-admin) - Admin template based on Nebular framework (Angular 4+, Bootstrap 4+)
* [Angular 2 quickstart seed ★88 ⏳1Y](https://github.com/valor-software/angular2-quickstart)
...
* [Angular Webpack Starter ★92](https://github.com/antonybudianto/angular-webpack-starter) - Angular Webpack Starter with AoT compilation, Lazy-loading, and Tree-shaking
* [Reaper ★8](https://github.com/Xamber/Reaper) - Angular 2 Webpack Starter Boilerplate w/o 2269 dependencies
* [famn ★26 ⏳1Y](https://github.com/implustech/famn) - Angular 2 + FeathersJS application framework for both client and server side
* [Angular NPM Module Seed ★53 ⏳1Y](https://github.com/davguij/angular-npm-module-seed) - Starting point for developing Angular modules and publishing them on NPM.
* [Angular2 D3v4 Seed ★13](https://github.com/gp187/angular2-d3v4-graph) - Angular2 D3v4 implementation of charts, graphs, area and view porting seed project
...
* [Reboard ★29](https://github.com/ksiabani/reboard) - Angular 4 + Material 2 starter dashboard with ngx-charts, based on generator-ngx-rocket (Typescript, SASS, Webpack, Jasmine+Karma, Protractor, TSLint, Codelyzer, Stylelint, ngx-translate, Lodash, Angular Flex-Layout)
* [Angular5 + Redux + Graphql + MySQL quickstart ★38](https://github.com/rafaesc/fullstack-graphql-angular) - Simple Fullstack GraphQL Application with Angular CLI + Redux + Express + GraphQL + Sequelize (supports MySQL, Postgres, Sqlite and MSSQL).
* [Angular5 + Firebase + Structure ★40](https://github.com/naologic/angular5-starter) - Angular 5 + Firebase + a very good router/module structure to make it your own so easy
...
* [Angular 2 Seed CLI Admin (Template) ★56](https://github.com/jvitor83/angular-pwa-seed) Multi-platform Angular 2 project (Web/PWA, Mobile and Desktop) with Ionic 2 (and optionally Bootstrap).
...
* [babel-angular2-app ★275 ⏳1Y](https://github.com/shuhei/babel-angular2-app) A skeleton Angular 2 app built with [Babel](https://babeljs.io/) and [Browserify](http://browserify.org/).
* [angular2-fullstack-starter ★34 ⏳2Y](https://github.com/jgodi/angular2-fullstack-starter) A full stack skeleton Angular 2 app built with Webpack/Babel.
* [angular2-es6-starter ★515 ⏳1Y](https://github.com/blacksonic/angular2-babel-esnext-starter) A skeleton Angular 2 ES6 application built with Babel, Webpack, Gulp.
...
* [babel-preset-angular2 ★15 ⏳1Y](https://github.com/shuhei/babel-preset-angular2) Babel presets for Angular2
...
* [sample-Angular2 ★48 ⏳1Y](https://github.com/NativeScript/sample-Angular2)
* [angular2-seed-advanced ★2197](https://github.com/NathanWalker/angular-seed-advanced)
* [**{{** add_your_repo **}}**](https://github.com/angularclass/awesome-angular/edit/gh-pages/README.md)
...
* [Angular 2 React Native Renderer (GitHub) ★756](https://github.com/angular/react-native-renderer)
...
* [angular2haxe ★27 ⏳2Y](https://github.com/nweedon/angular2haxe) Haxe Language Bindings for Angular 2
* [**{{** add_your_repo **}}**](https://github.com/angularclass/awesome-angular/edit/gh-pages/README.md)
...
* [play-angular2 ★10 ⏳2Y](https://github.com/gdi2290/play-angular2)
* [**{{** add_your_repo **}}**](https://github.com/angularclass/awesome-angular/edit/gh-pages/README.md)
...
* [Angular 2 bootstrap4 OAuth2 Webpack from Michael Oryl ★195 ⏳1Y](https://github.com/michaeloryl/angular2-bootstrap4-oauth2-webpack)
...
* [Angular 2 authentication sample from auth0-blog ★1005](https://github.com/auth0-blog/angular2-authentication-sample)
