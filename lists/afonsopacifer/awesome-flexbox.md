...
---
[![awesome flexbox](https://github.com/afonsopacifer/awesome-flexbox/blob/master/awesome-flexbox.jpg) ★646](afonsopacifer/awesome-flexbox)
...
Inspired by [awesome-webcomponents](https://github.com/obetomuniz/awesome-webcomponents) and [awesome-svg ★3201](willianjusten/awesome-svg).
...
* [Sass flex mixin ★1054](mastastealth/sass-flex-mixin)
* [Stylus flex mixin ★9 ⏳3Y](differui/stylus-flex-mixin)

#### Polyfills
* [Flexibility](https://github.com/10up/flexibility):metal:
* [Flexie ★1107](doctyper/flexie)
* [Reflexie ★259 ⏳3Y](doctyper/reflexie)
...
* [CSS Flexbox snippets for Atom ★5 ⏳1Y](brenopolanski/css-flexbox-atom-snippets)
* [CSS Flexbox snippets for Sublime Text 2/3 ★12 ⏳1Y](brenopolanski/css-flexbox-sublime-snippets)
* [Fibonacci ★417 ⏳2Y](maxsteenbergen/Fibonacci)
...
* [Flexboxgrid ★5989](kristoferjoseph/flexboxgrid):metal:
* [Flex Grid Framework](https://afonsopacifer.github.io/flex-grid-framework/):metal:
* [Flexbox Grid for Stylus](http://stylusgrid.com)
* [Ginger Grid ★23](erwstout/ginger) - A Flexbox grid framework named after a cute dog.
...
* [flex-box ★2 ⏳2Y](potch/flex-box) - A Custom Element to make the basics of flexbox easier to use.
* [Flexbugs ★6954](philipwalton/flexbugs) - A community-curated list of flexbox issues and cross-browser workarounds for them.
...
* [Flexbox layout ★8015](google/flexbox-layout) - FlexboxLayout is a library project which brings the similar capabilities of CSS Flexible Box Layout Module to Android.
* [Post Apocalypse Flexbox ★24 ⏳1Y](afonsopacifer/post-apocalypse-flexbox)
* [React-flexbox ★148](tcoopman/react-flexbox) - Implementation of css flexbox in react with inline styles.
* [Reflexbox ★903](jxnblk/reflexbox) - Responsive React flexbox grid system higher order component.
* [Solved by flexbox ★9831](philipwalton/solved-by-flexbox) - A showcase of problems once hard or impossible to solve with CSS alone, now made trivially easy with Flexbox.:metal:
