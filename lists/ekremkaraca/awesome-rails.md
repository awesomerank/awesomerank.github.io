...
- [Rails Source Code ★36940](https://github.com/rails/rails)
...
- [adopt-a-hydrant ★388](https://github.com/codeforamerica/adopt-a-hydrant) - A Ruby on Rails application that allows citizens to "adopt" civic infrastructure, such as fire hydrants  [Live](http://adopt-a-hydrant.herokuapp.com)
...
- [alaveteli ★210](https://github.com/mysociety/alaveteli) - Provide a Freedom of Information request system for your jurisdiction  [Live](http://alaveteli.org)
...
- [brimir ★1312](https://github.com/ivaldi/brimir) -  Email helpdesk built using Ruby on Rails and Zurb Foundation
- [calagator ★343](https://github.com/calagator/calagator) - An event aggregator based in Portland, OR
...
- [canvas-lms ★2188](https://github.com/instructure/canvas-lms) -  A new, open-source learning management system by Instructure Inc  
- [catarse ★1295](https://github.com/catarse/catarse) - The first open source crowdfunding platform for creative projects in the world  [Live](https://catarse.me/)
- [coderwall](https://github.com/assemblymade/coderwall) - Professional network for software engineers  [Live](https://coderwall.com)
- [codetriage.com ★757](https://github.com/codetriage/codetriage) -  Help out your favorite open source projects and become a better developer while doing it.  [Live](https://www.codetriage.com/)
...
- [covoiturage-libre ★52](https://github.com/covoiturage-libre/covoiturage-libre) - a Carpooling Open Source platform in Rails 5
...
- [crowdAI ★62](https://github.com/crowdAI/crowdai) - Fighting for Open Science with Open Data, a machine learning challenges platform. [Live](https://www.crowdai.org/)
...
- [expertiza ★119](https://github.com/expertiza/expertiza) - web application where students can submit and peer-review learning objects (articles, code, web sites, etc).
...
- [feedbin ★1869](https://github.com/feedbin/feedbin) -  A simple, fast and nice looking RSS reader [Live](https://feedbin.com)
...
- [gitlabhq ★19821](https://github.com/gitlabhq/gitlabhq) -  Open source software to collaborate on code  [Live](https://gitlab.com/gitlab-org/gitlab-ce) -
...
- [growstuff ★237](https://github.com/Growstuff/growstuff) -  An open source/open data project to create a website for food gardeners  [Live](http://www.growstuff.org/)
- [Hashrobot ★43 ⏳1Y](https://github.com/rysmith/hashrobot) - A social media assistant  [Live](http://www.hashrobot.com)
- [Helpy ★24](https://github.com/scott/helpy) - Rails 4 Helpdesk. Includes Multilingual Knowledgebase, Email Tickets, Community [Live](https://helpy.io/)
...
- [hours ★822](https://github.com/defactosoftware/hours) - A complete time registration app for teams [Live](https://happyhours.io)
...
- [lobsters ★1468](https://github.com/jcs/lobsters) -  Rails code running the lobste.rs link aggregation site  
- [loomio ★1475](https://github.com/loomio/loomio) -  A collaborative decision-making tool that makes it easy for anyone [Live](https://www.loomio.org)
- [Mastodon ★10389](https://github.com/tootsuite/mastodon) - GNU Social-compatible microblogging server [Live](https://mastodon.social)
- [mumuki-laboratory ★108](https://github.com/mumuki/mumuki-laboratory) - Where students practice and receive automated and human feedback [Live](http://mumuki.io)
- [obtvse2 ★261 ⏳3Y](https://github.com/natew/obtvse2) - A clean and simple markdown blogging platform on Rails
- [onebody ★1356](https://github.com/churchio/onebody) - A private member portal for churches built with Ruby on Rails [Live](https://church.io)
- [opencongress ★45 ⏳1Y](https://github.com/sunlightlabs/opencongress) - An open website for opening Congress
- [OpenFarm ★489](https://github.com/openfarmcc/OpenFarm) -  A free and open database for farming and gardening knowledge  
- [openproject ★1581](https://github.com/opf/openproject) - A web based project management system built on Ruby on Rails  [Live](https://www.openproject.org)
- [opensit ★44](https://github.com/danbartlett/opensit) - An open source meditation community [Live](http://opensit.com)
- [openstreetmap-website ★676](https://github.com/openstreetmap/openstreetmap-website) - Mirror of the Rails application powering  [Live](http://www.openstreetmap.org)
- [ossfriday ★507](https://github.com/ossfriday/ossfriday) - a movement to encourage companies, people and maintainers to contribute to open source every Friday
- [otwarchive ★277](https://github.com/otwcode/otwarchive) -  An open-source web application intended for hosting archives of fanworks, including fanfic, fanart, and fan vids  [Live](http://archiveofourown.org)
- [PasswordPusher ★167](https://github.com/pglombardo/PasswordPusher) - A Ruby on Rails application to communicate passwords over the web  [Live](https://pwpush.com)
- [peatio ★1439](https://github.com/peatio/peatio) -  An open-source crypto currency exchange  [Live](http://www.peatio.com)
...
- [rubygems.org ★1577](https://github.com/rubygems/rubygems.org) -  The Ruby community's gem hosting service  [Live](https://rubygems.org)
...
- [selfstarter ★3097 ⏳1Y](https://github.com/lockitron/selfstarter) - Roll your own crowdfunding  [Live](http://www.selfstarter.us)
...
- [trado ★105](https://github.com/Jellyfishboy/trado) - lightweight, easy to use e-commerce platform designed for sole traders and SME businesses  
- [WebsiteOne ★92](https://github.com/AgileVentures/WebsiteOne) - A platform for online collaboration and crowdsourced project development [Live](https://www.agileventures.org/)
- [whitehall ★412](https://github.com/alphagov/whitehall) - Inside Government: how the UK Government works, what it's doing, and how you can get involved  
