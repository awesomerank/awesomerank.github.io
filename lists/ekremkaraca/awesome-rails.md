...
- [Rails Source Code ★35413](https://github.com/rails/rails)
...
- [selfstarter ★3067](https://github.com/lockitron/selfstarter) - Roll your own crowdfunding  [Live](http://www.selfstarter.us)
- [catarse ★1245](https://github.com/catarse/catarse) - The first open source crowdfunding platform for creative projects in the world  [Live](http://catarse.me/)
...
- [gitlabhq ★19338](https://github.com/gitlabhq/gitlabhq) -  Open source software to collaborate on code  [Live](https://gitlab.com/gitlab-org/gitlab-ce/) -
- [rubygems.org ★1523](https://github.com/rubygems/rubygems.org) -  The Ruby community's gem hosting service  [Live](https://rubygems.org/)
- [codetriage.com ★663](https://github.com/codetriage/codetriage) -  Help out your favorite open source projects and become a better developer while doing it.  [Live](http://www.codetriage.com/)
- [intercityup.com ★27](https://github.com/intercity/intercity-next) -  Control Panel for hosting Ruby on Rails  [Live](https://intercityup.com/)

#### E-commerce

- [Spree ★8358](https://github.com/spree/spree) -  Spree is a complete open source e-commerce solution for Ruby on Rails.  [Live](http://spreecommerce.com)
...
- [canvas-lms ★2020](https://github.com/instructure/canvas-lms) -  A new, open-source learning management system by Instructure Inc  
- [theodinproject ★478](https://github.com/TheOdinProject/theodinproject) -  A project that aims to teach web development for free  [Live](http://www.theodinproject.com/)
...
- [growstuff ★221](https://github.com/Growstuff/growstuff) -  An open source/open data project to create a website for food gardeners  [Live](http://growstuff.org/)
- [inaturalist ★130](https://github.com/inaturalist/inaturalist) -  Open source Rails app behind iNaturalist.org [Live](http://www.inaturalist.org)
- [OpenFarm ★448](https://github.com/openfarmcc/OpenFarm) -  A free and open database for farming and gardening knowledge  

#### Personal Management

- [tracks ★836](https://github.com/TracksApp/tracks) - A "Getting Things Done" application  [Live](http://www.getontracks.org/)
- [hummingbird ★1819](https://github.com/hummingbird-me/hummingbird) - A modern anime discovery platform that helps you track the anime you're watching, discover new anime and socialize with other fans  [Live](https://hummingbird.me/)
...
- [hours ★789](https://github.com/defactosoftware/hours) - A complete time registration app for teams [Live](https://happyhours.io)
...
-  [bike_index ★123](https://github.com/bikeindex/bike_index) -  An online bike registry [Live](https://bikeindex.org/)
...
-  [feedbin ★1812](https://github.com/feedbin/feedbin) -  A simple, fast and nice looking RSS reader [Live](https://feedbin.com)
-  [brimir ★1259](https://github.com/ivaldi/brimir) -  Email helpdesk built using Ruby on Rails and Zurb Foundation
-  [lobsters ★1307](https://github.com/jcs/lobsters) -  Rails code running the lobste.rs link aggregation site  
-  [otwarchive ★251](https://github.com/otwcode/otwarchive) -  An open-source web application intended for hosting archives of fanworks, including fanfic, fanart, and fan vids  [Live](http://archiveofourown.org/)
-  [peatio ★1041](https://github.com/peatio/peatio) -  An open-source crypto currency exchange  [Live](http://www.peatio.com/)
-  [openstreetmap-website ★612](https://github.com/openstreetmap/openstreetmap-website) - Mirror of the Rails application powering  [Live](http://www.openstreetmap.org)
-  [RapidFTR ★290](https://github.com/rapidftr/RapidFTR) -  An Android-based mobile application that lets aid workers collect, sort and share information about children in emergency situations [Live](http://www.rapidftr.com/)
...
-  [fairnopoly ★75](https://github.com/fairmondo/fairmondo) - A free market place in the hand of the users  [Live](https://www.fairmondo.de/)
...
-  [ekylibre ★102](https://github.com/ekylibre/ekylibre) - Simple agricultural ERP [Live](http://ekylibre.org)
-  [calcentral ★69](https://github.com/ets-berkeley-edu/calcentral) - An online portal that provides a unified and personalized one-stop way to access email, calendars, shared documents and class collaboration spaces [Live](https://calcentral.berkeley.edu)
-  [encrypt.to ★80](https://github.com/encrypt-to/encrypt.to) - Send encrypted messages by one click  [Live](https://encrypt.to/)
...
-  [covoiturage-libre ★32](https://github.com/covoiturage-libre/covoiturage-libre) - a Carpooling Open Source platform in Rails 5
...
| ------ | ------ | ------ | ------ | ------ |
|[Rails Composer ★3096](https://github.com/RailsApps/rails-composer)|yes, but Stripe needs to be configured|Example apps reaching a SaaS with Stripe.|yes|yes|
