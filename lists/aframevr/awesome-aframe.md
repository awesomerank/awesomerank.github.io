...
---
# awesome-aframe [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
...
- [Inspector ★183](aframevr/aframe-inspector)
- [Registry ★38](aframevr/aframe-registry)
- [Presentation Kit ★44](aframevr/aframe-presentation-kit)
- [School ★23](aframevr/aframe-school)
- [Command Line Interface ★23](aframevr/angle)
...
- [A-Frame &mdash; Kevin Ngo](https://www.youtube.com/watch?list=PLo3w8EB99pqIj_XNvNEMAaBtL_jyxSLmz&v=FWqgP3-9mOw) - 5-minute A-Frame talk at the [W3C Workshop on Web & Virtual Reality](https://www.w3.org/2016/06/vr-workshop/) [[Slides] ★2](ngokevin/w3c-webvr-presentation)
...
- [A-Frame: VR for Developers &mdash; Diego Marcos & Kevin Ngo](https://www.youtube.com/watch?v=wRqoSdPZQBY) - Talk on A-Frame at the [SFHTML5 "WebVR Ecosystem and API Update" meetup](https://www.meetup.com/sfhtml5/events/230072340/) [[Slides] ★6 ⏳1Y](ngokevin/aframe-sfhtml5-presentation)
...
[angle ★23](aframevr/angle)'s `initcomponent` tool. For curated
components, see the [A-Frame Registry](https://aframe.io/aframe-registry/).

- [Along Path ★12](protyze/aframe-alongpath-component) - Interpolating an entity's position along a path
- [Always Fullscreen ★8](protyze/aframe-always-fullscreen-component) - Provide ways to enable Fullscreen on iOS (Scroll to Minimal-UI) and Android/Desktop (Fullscreen API)
- [Ammo Physics Component](https://github.com/jeromeetienne/threex.ammo) - Library integrating [three.js](https://threejs.org/) and [ammo.js ★1081](kripken/ammo.js) to enable physics in objects
- [Animation](https://ngokevin.github.io/aframe-animation-component) - New and improved animation system using components. [[Code] ★13](ngokevin/aframe-animation-component)
- [Asset Lazy Load ★10 ⏳1Y](youmustfight/aframe-asset-lazy-load) - Assign asset loading order and delays
- [Asset On-Demand ★5](protyze/aframe-asset-on-demand-component) - Load Assets dynamically when needed (and properly clean them up if not)
- [Audio Visualizer ★17](ngokevin/aframe-audio-visualizer-components) - Audio visualizations using WebAudio API
- [Broadcast ★14 ⏳1Y](ngokevin/aframe-broadcast-component) - Multiuser with WebSockets
- [ChartBuilder ★3](impronunciable/aframe-chartbuilder-component) - Use [ChartBuilder](http://quartz.github.io/Chartbuilder) charts
...
- [Crawling Cursor ★17](jujunjun110/aframe-crawling-cursor) - Cursor projected onto surfaces
- [Crease ★3 ⏳1Y](andreasplesch/aframe-crease-component) - Creased shading
- [Chromakey Material ★3](nikolaiwarner/aframe-chromakey-material) - Chromakey material for green screen effects
- [Cubemap ★18](bryik/aframe-cubemap-component) - Create a skybox from a cubemap
- [Daydream Controller ★21](ryanbetts/aframe-daydream-controller-component) - Daydream controls
- [Drag Look ★7](mayognaise/aframe-drag-look-controls-component) - Look controls in the opposite direction with changing cursor style
- [Draw ★40](maxkrieger/aframe-draw-component) - HTML5 `<canvas>` as a material texture, with support for extension components
- [Entity Generator ★4](ngokevin/aframe-entity-generator-component) - Generate entities
- [Event Set ★6](ngokevin/aframe-event-set-component) - Set properties in response to events, replacement for declarative events
- [Extras ★203](donmccurdy/aframe-extras) - Don's collection of A-Frame components
- [Extrude and Lathe ★6 ⏳1Y](JosePedroDias/aframe-extrude-and-lathe) - Extrude and lathe geometries
- [Faceset ★3 ⏳1Y](andreasplesch/aframe-faceset-component) - Geometry from vertices and faces
- [Fence ★3](atomicguy/aframe-fence-component) - Set boundaries on entity position
- [Firebase ★30](ngokevin/aframe-firebase-component) - Multiuser with Firebase
- [Fit Texture ★8](nylki/aframe-fit-texture-component) - Automatically scale entities relative to their texture, so you don't need to set width/height manually
- [Force-directed Graph](https://github.com/vasturiano/aframe-forcegraph-component) - Represent a graph data structure in a 3D force-directed iterative layout, using [d3-force-3d ★11](vasturiano/d3-force-3d) for the physics simulation engine.
- [FPS Look ★7 ⏳1Y](cemkod/aframe-fps-look-component) - Facilitates controlling entity rotation directly with captured mouse
- [Gamepad Controls ★34](donmccurdy/aframe-gamepad-controls) - Gamepad controls using HTML5 Gamepad API
- [GIF](https://github.com/gtk2k/gtk2k.github.io/tree/master/animation_gif) - Display GIF as a texture by using a Canvas
- [Gradient Sky ★5](zcanter/aframe-gradient-sky) - Use two colors to create a gradient shader for colorful skies
- [Grid Helper ★9](dbradleyfl/aframe-gridhelper) - Create customizable grids
- [Heatmap3d ★5](morandd/aframe-heatmap3d) - Yet another heatmap/heightmap component
- [Height Grid ★8 ⏳1Y](andreasplesch/aframe-heightgrid-component) - Terrain
- [Hexmap ★0](morandd/aframe-hexgraph-hexmap) - A hex grid/map for data viz (inspired by deck.gl's hexmap layer)
- [href ★29](gasolin/aframe-href-component) - Link to other pages using cursor component
- [HTML Texture ★39](scenevr/htmltexture-component) - Using HTML as a texture, powered by html2canvas
- [Interpolation ★5 ⏳1Y](scenevr/interpolation-component) - Interpolate positional and rotational updates for entities, useful for fetching from server for multiplayer
- [k-frame](https://github.com/ngokevin/k-frame) - Kevin's collection of A-Frame components
- [Keyboard ★5](richardanaya/aframe-keyboard) - Full VR keyboard for use with WebVR controllers
- [L-System ★19](nylki/aframe-lsystem-component) - Render [Lindenmayer](https://en.wikipedia.org/wiki/L-system) systems
- [Layout ★29](ngokevin/aframe-layout-component) - 3D layout of child entities
- [Leap Hands ★91](openleap/aframe-leap-hands) - [Leap Motion](https://www.leapmotion.com/) controller support
- [Lens Flare ★2](mokargas/aframe-lensflare-component) - Lens flare
- [Look-At and Billboard ★5](blairmacintyre/aframe-look-at-billboard-component) - Component to tell an entity to face another entity, or to face the camera
- [Mario Star Texture ★0](casonclagg/aframe-mario-star-component) - Texture that cycles colors like stars in Mario using canvas
- [Mesh Line ★7](andreasplesch/aframe-meshline-component) - Draw thick lines
...
- [Motion Capture ★20](dmarcos/aframe-motion-capture-components) - Record and replay headset and controller pose and events
- [Mouse Cursor Component ★44](mayognaise/aframe-mouse-cursor-component) - Add interaction to the hardware mouse, by raycasting from `XY` position on canvas
- [Multitouch-look-controls ★0](morandd/aframe-multitouch-look-controls) - Touch-driven freelook camera; drop-in replacement for look-controls
- [No-click Look Controls ★37](alexrkass/aframe-no-click-look-controls) - Intuitive desktop view controls without requiring mouse click + drag
...
- [Orbit Controls Component ★13](tizzle/aframe-orbit-controls-component) - Allow desktop users to rotate the camera around an object
- [Particle System ★36](IdeaSpaceVR/aframe-particle-system-component) - Particle systems (e.g., rain, dust, snow, fire)
- [Passthrough ★12](flysonic10/aframe-passthrough) - Show a video feed from the device's camera
- [Persist Component ★6](Utopiah/aframe-persist-component) - Use localStorage to make data persist over experiences
- [Physics + Vive Controls](https://github.com/donmccurdy/aframe-extras/tree/master/src/misc) - `grab` and `sphere-collider` components for combining the HTC Vive's controllers with the [`aframe-physics-system` ★56](donmccurdy/aframe-physics-system) component
- [Physics ★56](donmccurdy/aframe-physics-system) - Rigid-body physics using [Cannon.js](http://www.cannonjs.org/)
- [Pipe ★0](jellix79/aframe-pipe-component) - A pipe with inner and outer radii
...
- [Polygon ★1 ⏳1Y](andreasplesch/aframe-polygon-primitive) - `n`-sided polygons
...
- [Randomizer ★5](ngokevin/aframe-randomizer-components) - Set random values
- [Scatterplot ★4](zcanter/aframe-scatterplot) - Scatterplot data visualization
- [Selectable ★7 ⏳1Y](scenevr/selectable-component) by [@scenevr](https://twitter.com/scenevr) - Click on an entity to select it (handy for editors)
- [Shake-to-Show ★4](rdub80/aframe-shake2show-component) - Using shake.js to toggle UI
- [Slice9 ★5](fernandojsg/aframe-slice9-component) - 9-Slice for creating sharp panels and tooltips for UI
- [Sprite ★4](tizzle/aframe-sprite-component) - Creates bitmap images that always face the camera
- [Star ★4 ⏳1Y](andreasplesch/aframe-star-component) - 2D stars
- [Stereo ★53](oscarmarinmiro/aframe-stereo-component) - Enable rendering different entities for each eye, using three.js layers so you can render 3D stereoscopic videos (full and half-dome)
- [Stereo Cube ★8](wallabyway/aframe-stereocube) - Use stereoscopic cube-map textures (i.e., left and right eye textures)
- [Teleport Controls ★31](fernandojsg/aframe-teleport-controls) - Teleportation with tracked controllers
...
- [Terrain Model ★7](bryik/aframe-terrain-model-component) - Generating terrains using TerrainLoader
- [Text Wrap ★24 ⏳1Y](maxkrieger/aframe-textwrap-component) - Wrapping text dynamically rendered onto the `draw` component
...
- [Trigger Box ★1](Utopiah/aframe-triggerbox-component) - A component that emits an event when it enters or leaves a predefined area
...
- [UI Components ★13](gmarty/aframe-ui-components) - A collection of components related to UI
- [UI Modal ★13](IdeaSpaceVR/aframe-ui-modal-component) - Show dialog box or a menu in front of the camera
- [UI Widgets ★37](caseyyee/aframe-ui-widgets) - Another set of UI components, including buttons, switchs, sliders, and knobs
- [Universal Controls](https://github.com/donmccurdy/aframe-extras/tree/master/src/controls) - Refactored A-Frame controls that supports gamepad, HMD, keyboard, mouse + pointerlock, touch-to-move, with [physics ★56](donmccurdy/aframe-physics-system) compatibility
- [Video Controls ★26](oscarmarinmiro/aframe-video-controls) - Video controls (play/pause/jump) for A-Frame video assets
- [Vive Cursor](https://github.com/bryik/aframe-vive-cursor-component) - A cursor for the HTC Vive's controllers
- [WebVR Controller ★27](richardanaya/aframe-webvr-controller) - HTC Vive controllers
...
- [Draw ★5](mayognaise/aframe-draw-shader) - Render from canvas
- [HTML ★64](mayognaise/aframe-html-shader) - Render from HTML
- [Video ★17](mayognaise/aframe-video-shader) - iOS-compatible video material
- [GIF ★19](mayognaise/aframe-gif-shader) - Render animated GIFs
...
- [aframe-templating-examples ★1 ⏳1Y](ngokevin/aframe-templating-examples) - A-Frame with templating engines such as Handlebars, mustache, Nunjucks
- [SpineFrame ★10 ⏳1Y](JoshGalvin/SpineFrame) - Component for 2D sprite animation with [Spine](http://esotericsoftware.com/)
- [Meteor ★12 ⏳1Y](vladbalan/meteor-aframe) - A-Frame with [Meteor](https://www.meteor.com/), a JavaScript app framework
- [Altspace ★28](AltspaceVR/aframe-altspace-component) - Integration with AltspaceVR
- [Drupal](https://www.drupal.org/project/aframe) - Drupal module for integration with A-Frame
- [Mixin Style Sheets](https://github.com/ngokevin/aframe-mss) - CSS-like stylesheets for A-Frame for declaring mixins [[Code] ★18](ngokevin/aframe-mss)
...
- [aframe-phantomjs-continuous-streaming ★21](cjroth/aframe-phantomjs-continuous-streaming) - Browse the web in VR by live streaming a web page into A-Frame using PhantomJS and ffmpeg
- [aframe-keyboard ★7](cjroth/aframe-keyboard) - A virtual-reality keyboard and text editor in A-Frame

### Scenes

- [a-invaders](http://swimminglessonsformodernlife.com/a-invaders) - Space invaders game. [[Code] ★20 ⏳1Y](dmarcos/a-invaders)
...
- [Cardboard Dungeon](https://chrismwaite.github.io/cardboard-dungeon) - A first-person dungeon crawler designed for mobile. [[Code] ★27 ⏳1Y](chrismwaite/cardboard-dungeon)
- [Don McCurdy's Sandbox](https://sandbox.donmccurdy.com/vr/) - Don McCurdy's A-Frame scenes including [MagicaVoxel](https://ephtracy.github.io/) models, physics playgrounds, and controls [[Code] ★203](donmccurdy/aframe-extras)
- [Kevin Ngo's Scenes](http://ngokevin.com/kframe/) - Kevin Ngo's A-Frame scenes including MagicaVoxel models, audio visualizations, and a Minecraft demo [[Code] ★282](ngokevin/kframe)
- [Aztec Pong](http://meta-meta.github.io/aztec-pong) - Play Pong floating atop an Aztec monument. [[Code] ★1 ⏳1Y](meta-meta/aztec-pong)
- [Hello, Pizza!](http://carpedmt.github.io) - If a pizza spins in a forest and no one is around to eat it, does it make a sound? [[Code] ★1](carpedmt/carpedmt.github.io)
...
- [Sketch VR](https://uniform-futures.github.io/sketch-vr) - Doodle on paper, take a picture, and view it in VR. [[Code] ★8 ⏳1Y](uniform-futures/sketch-vr)
...
- [Ball Throw](https://bryik.github.io/aframe-ball-throw) - Throw balls at blocks using Vive controllers and [Don McCurdy's](https://twitter.com/donrmccurdy) [physics](https://github.com/donmccurdy/aframe-physics-system). [[Code] ★10](bryik/aframe-ball-throw)
...
- [Stand at the Edge of Geologic Time](https://apps.npr.org/rockymountain-vr/) - A virtual-reality tour from [NPR](http://www.npr.org/) of Rocky Mountain National Park. [[Code] ★4](nprapps/rockymountain)
...
- [Procedural Forest](https://nylki.github.io/aframe-lsystem-component/forrest/) - A procedural forest with procedural trees using the [L-System Component ★19](nylki/aframe-lsystem-component)
- [iStaging LiveTour](http://vrviewer.istaging.co/#!/684173) - 360&deg; real estate tours with a neat mini-map
- [Choose Your Own VR ★0](dannielle/tinier-house) - Which cup will you choose?
...
- [Head-Tracked Transformations](https://armthethinker.github.io/webVR-experiments/6--head-tracked-transformations.html) - VR UX prototype of transforming objects’ orientations with your head to enhance VR experiences that don’t have positional tracking. Read the instructions listed at [#6](https://armthethinker.github.io/webVR-experiments/). [[Code] ★16](armthethinker/webVR-experiments)
- [Weather Room](https://weatherroom.herokuapp.com/) - What’s the forecast for WebVR? Sunny with no chance of rain. [[Code] ★1 ⏳1Y](sebscholl/weatherroom)
...
- [WebVR Soccer Stadium Complex](https://s3.amazonaws.com/cassell-webvr/webvr-soccer-stadium-multiplex/index.html) - Watch several video feeds at once in a soccer stadium. [[Code] ★5 ⏳1Y](cassell/webvr-soccer-stadium-multiplex)
...
- [GuriVR](https://gurivr.com/) - Create sharable VR scenes using natural language and zero code. [[Code] ★114](opennewslabs/guri-vr)
...
- [Miradas 360](https://miradas360.github.io/miradas360-01) - 360&deg; experiences created by media-production teams. [[Code] ★1](Miradas360/miradas360-01)
...
- [Unity Exporter to A-Frame ★40](if1live/unity-scene-web-exporter) - Export Unity scenes to three.js or A-Frame with lightmapping
...
- [City Builder](https://kfarr.github.io/aframe-city-builder) - Room-scale city builder. [[Code] ★34](kfarr/aframe-city-builder)
