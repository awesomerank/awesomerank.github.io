...
- [Inspector ★240](https://github.com/aframevr/aframe-inspector)
- [Registry ★49](https://github.com/aframevr/aframe-registry)
- [Presentation Kit ★50](https://github.com/aframevr/aframe-presentation-kit)
- [School ★41](https://github.com/aframevr/aframe-school)
...
- [Along Path ★22](https://github.com/protyze/aframe-alongpath-component) - Interpolating an entity's position along a path
- [Always Fullscreen ★11](https://github.com/protyze/aframe-always-fullscreen-component) - Provide ways to enable Fullscreen on iOS (Scroll to Minimal-UI) and Android/Desktop (Fullscreen API)
- [Ammo Physics Component](https://github.com/jeromeetienne/threex.ammo) - Library integrating [three.js](https://threejs.org/) and [ammo.js ★1201](https://github.com/kripken/ammo.js) to enable physics in objects
- [Animation](https://ngokevin.github.io/aframe-animation-component) - New and improved animation system using components. [[Code] ★16 ⏳1Y](https://github.com/ngokevin/aframe-animation-component)
- [Asset Lazy Load ★12 ⏳1Y](https://github.com/youmustfight/aframe-asset-lazy-load) - Assign asset loading order and delays
- [Asset On-Demand ★14](https://github.com/protyze/aframe-asset-on-demand-component) - Load Assets dynamically when needed (and properly clean them up if not)
- [Audio Visualizer ★17](https://github.com/ngokevin/aframe-audio-visualizer-components) - Audio visualizations using WebAudio API
- [Broadcast ★16 ⏳1Y](https://github.com/ngokevin/aframe-broadcast-component) - Multiuser with WebSockets
- [ChartBuilder ★4](https://github.com/impronunciable/aframe-chartbuilder-component) - Use [ChartBuilder](http://quartz.github.io/Chartbuilder) charts
...
- [Crawling Cursor ★21](https://github.com/jujunjun110/aframe-crawling-cursor) - Cursor projected onto surfaces
- [Crease ★4 ⏳1Y](https://github.com/andreasplesch/aframe-crease-component) - Creased shading
- [Chromakey Material ★9](https://github.com/nikolaiwarner/aframe-chromakey-material) - Chromakey material for green screen effects
- [Cubemap ★24](https://github.com/bryik/aframe-cubemap-component) - Create a skybox from a cubemap
...
- [Draw ★44](https://github.com/maxkrieger/aframe-draw-component) - HTML5 `<canvas>` as a material texture, with support for extension components
...
- [Extras ★269](https://github.com/donmccurdy/aframe-extras) - Don's collection of A-Frame components
...
- [Fit Texture ★11](https://github.com/nylki/aframe-fit-texture-component) - Automatically scale entities relative to their texture, so you don't need to set width/height manually
- [Force-directed Graph](https://github.com/vasturiano/aframe-forcegraph-component) - Represent a graph data structure in a 3D force-directed iterative layout, using [d3-force-3d ★42](https://github.com/vasturiano/d3-force-3d) for the physics simulation engine.
...
- [Hexmap ★7](https://github.com/morandd/aframe-hexgraph-hexmap) - A hex grid/map for data viz (inspired by deck.gl's hexmap layer)
- [href ★38 ⏳1Y](https://github.com/gasolin/aframe-href-component) - Link to other pages using cursor component
- [HTML Texture ★40](https://github.com/scenevr/htmltexture-component) - Using HTML as a texture, powered by html2canvas
- [Interpolation ★7 ⏳1Y](https://github.com/scenevr/interpolation-component) - Interpolate positional and rotational updates for entities, useful for fetching from server for multiplayer
- [k-frame](https://github.com/ngokevin/k-frame) - Kevin's collection of A-Frame components
- [Keyboard ★6 ⏳1Y](https://github.com/richardanaya/aframe-keyboard) - Full VR keyboard for use with WebVR controllers
...
- [Layout ★30 ⏳1Y](https://github.com/ngokevin/aframe-layout-component) - 3D layout of child entities
- [Leap Hands ★98](https://github.com/openleap/aframe-leap-hands) - [Leap Motion](https://www.leapmotion.com/) controller support
- [Lens Flare ★6](https://github.com/mokargas/aframe-lensflare-component) - Lens flare
- [Look-At and Billboard ★8 ⏳1Y](https://github.com/blairmacintyre/aframe-look-at-billboard-component) - Component to tell an entity to face another entity, or to face the camera
...
- [Motion Capture ★38](https://github.com/dmarcos/aframe-motion-capture-components) - Record and replay headset and controller pose and events
- [Mouse Cursor Component ★59](https://github.com/mayognaise/aframe-mouse-cursor-component) - Add interaction to the hardware mouse, by raycasting from `XY` position on canvas
- [Multitouch-look-controls ★4](https://github.com/morandd/aframe-multitouch-look-controls) - Touch-driven freelook camera; drop-in replacement for look-controls
- [No-click Look Controls ★42](https://github.com/alexrkass/aframe-no-click-look-controls) - Intuitive desktop view controls without requiring mouse click + drag
...
- [Orbit Controls Component ★27](https://github.com/tizzle/aframe-orbit-controls-component) - Allow desktop users to rotate the camera around an object
- [Particle System ★46](https://github.com/IdeaSpaceVR/aframe-particle-system-component) - Particle systems (e.g., rain, dust, snow, fire)
- [Passthrough ★16](https://github.com/flysonic10/aframe-passthrough) - Show a video feed from the device's camera
- [Persist Component ★9](https://github.com/Utopiah/aframe-persist-component) - Use localStorage to make data persist over experiences
- [Physics + Vive Controls](https://github.com/donmccurdy/aframe-extras/tree/master/src/misc) - `grab` and `sphere-collider` components for combining the HTC Vive's controllers with the [`aframe-physics-system` ★90](https://github.com/donmccurdy/aframe-physics-system) component
- [Physics ★90](https://github.com/donmccurdy/aframe-physics-system) - Rigid-body physics using [Cannon.js](http://www.cannonjs.org/)
...
- [Shake-to-Show ★6](https://github.com/rdub80/aframe-shake2show-component) - Using shake.js to toggle UI
- [Slice9 ★6](https://github.com/fernandojsg/aframe-slice9-component) - 9-Slice for creating sharp panels and tooltips for UI
- [Sprite ★11](https://github.com/tizzle/aframe-sprite-component) - Creates bitmap images that always face the camera
- [Star ★5 ⏳1Y](https://github.com/andreasplesch/aframe-star-component) - 2D stars
- [Stereo ★63](https://github.com/oscarmarinmiro/aframe-stereo-component) - Enable rendering different entities for each eye, using three.js layers so you can render 3D stereoscopic videos (full and half-dome)
- [Stereo Cube ★12 ⏳1Y](https://github.com/wallabyway/aframe-stereocube) - Use stereoscopic cube-map textures (i.e., left and right eye textures)
- [SVG File ★8](https://github.com/7dir/aframe-svgfile-component) - Load basic SVG files as 3d geometry
- [Teleport Controls ★44](https://github.com/fernandojsg/aframe-teleport-controls) - Teleportation with tracked controllers
...
- [Terrain Model ★14](https://github.com/bryik/aframe-terrain-model-component) - Generating terrains using TerrainLoader
- [Text Wrap ★29 ⏳1Y](https://github.com/maxkrieger/aframe-textwrap-component) - Wrapping text dynamically rendered onto the `draw` component
...
- [UI Components ★20 ⏳1Y](https://github.com/gmarty/aframe-ui-components) - A collection of components related to UI
- [UI Modal ★19](https://github.com/IdeaSpaceVR/aframe-ui-modal-component) - Show dialog box or a menu in front of the camera
- [UI Widgets ★46](https://github.com/caseyyee/aframe-ui-widgets) - Another set of UI components, including buttons, switchs, sliders, and knobs
- [Universal Controls](https://github.com/donmccurdy/aframe-extras/tree/master/src/controls) - Refactored A-Frame controls that supports gamepad, HMD, keyboard, mouse + pointerlock, touch-to-move, with [physics ★90](https://github.com/donmccurdy/aframe-physics-system) compatibility
- [Video Controls ★36](https://github.com/oscarmarinmiro/aframe-video-controls) - Video controls (play/pause/jump) for A-Frame video assets
- [Vive Cursor](https://github.com/bryik/aframe-vive-cursor-component) - A cursor for the HTC Vive's controllers
- [WebVR Controller ★25 ⏳1Y](https://github.com/richardanaya/aframe-webvr-controller) - HTC Vive controllers
...
- [HTML ★91](https://github.com/mayognaise/aframe-html-shader) - Render from HTML
- [Video ★21 ⏳1Y](https://github.com/mayognaise/aframe-video-shader) - iOS-compatible video material
...
- [aframe-react ★683](https://github.com/ngokevin/aframe-react) - Thin and performant React layer on top of A-Frame
...
- [Meteor ★13 ⏳1Y](https://github.com/vladbalan/meteor-aframe) - A-Frame with [Meteor](https://www.meteor.com/), a JavaScript app framework
...
- [Mixin Style Sheets](https://github.com/ngokevin/aframe-mss) - CSS-like stylesheets for A-Frame for declaring mixins [[Code] ★23 ⏳1Y](https://github.com/ngokevin/aframe-mss)
...
- [aframe-phantomjs-continuous-streaming ★30](https://github.com/cjroth/aframe-phantomjs-continuous-streaming) - Browse the web in VR by live streaming a web page into A-Frame using PhantomJS and ffmpeg
- [aframe-keyboard ★12](https://github.com/cjroth/aframe-keyboard) - A virtual-reality keyboard and text editor in A-Frame
...
- [a-invaders](http://swimminglessonsformodernlife.com/a-invaders) - Space invaders game. [[Code] ★22](https://github.com/dmarcos/a-invaders)
...
- [Cardboard Dungeon](https://chrismwaite.github.io/cardboard-dungeon) - A first-person dungeon crawler designed for mobile. [[Code] ★31 ⏳1Y](https://github.com/chrismwaite/cardboard-dungeon)
- [Don McCurdy's Sandbox](https://sandbox.donmccurdy.com/vr/) - Don McCurdy's A-Frame scenes including [MagicaVoxel](https://ephtracy.github.io/) models, physics playgrounds, and controls [[Code] ★269](https://github.com/donmccurdy/aframe-extras)
- [Kevin Ngo's Scenes](https://ngokevin.github.io/kframe/) - Kevin Ngo's A-Frame scenes including MagicaVoxel models, audio visualizations, and a Minecraft demo [[Code] ★399](https://github.com/ngokevin/kframe)
...
- [Sketch VR](https://uniform-futures.github.io/sketch-vr) - Doodle on paper, take a picture, and view it in VR. [[Code] ★9 ⏳1Y](https://github.com/uniform-futures/sketch-vr)
...
- [Ball Throw](https://bryik.github.io/aframe-ball-throw) - Throw balls at blocks using Vive controllers and [Don McCurdy's](https://twitter.com/donrmccurdy) [physics](https://github.com/donmccurdy/aframe-physics-system). [[Code] ★11 ⏳1Y](https://github.com/bryik/aframe-ball-throw)
...
- [Procedural Forest](https://nylki.github.io/aframe-lsystem-component/forrest/) - A procedural forest with procedural trees using the [L-System Component ★25](https://github.com/nylki/aframe-lsystem-component)
- [iStaging LiveTour](http://vrviewer.istaging.co/#!/684173) - 360&deg; real estate tours with a neat mini-map
- [Choose Your Own VR ★1 ⏳1Y](https://github.com/dannielle/tinier-house) - Which cup will you choose?
...
- [Head-Tracked Transformations](https://armthethinker.github.io/webVR-experiments/6--head-tracked-transformations.html) - VR UX prototype of transforming objects’ orientations with your head to enhance VR experiences that don’t have positional tracking. Read the instructions listed at [#6](https://armthethinker.github.io/webVR-experiments/). [[Code] ★18](https://github.com/armthethinker/webVR-experiments)
- [Weather Room](https://weatherroom.herokuapp.com/) - What’s the forecast for WebVR? Sunny with no chance of rain. [[Code] ★2 ⏳1Y](https://github.com/sebscholl/weatherroom)
...
- [WebVR Soccer Stadium Complex](https://s3.amazonaws.com/cassell-webvr/webvr-soccer-stadium-multiplex/index.html) - Watch several video feeds at once in a soccer stadium. [[Code] ★7 ⏳1Y](https://github.com/cassell/webvr-soccer-stadium-multiplex)
...
- [GuriVR](https://gurivr.com/) - Create sharable VR scenes using natural language and zero code. [[Code] ★135](https://github.com/opennewslabs/guri-vr)
...
- [Unity Exporter to A-Frame ★57](https://github.com/if1live/unity-scene-web-exporter) - Export Unity scenes to three.js or A-Frame with lightmapping
