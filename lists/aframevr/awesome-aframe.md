...
- [Inspector ★183](https://github.com/aframevr/aframe-inspector)
- [Registry ★38](https://github.com/aframevr/aframe-registry)
- [Presentation Kit ★44](https://github.com/aframevr/aframe-presentation-kit)
- [School ★23](https://github.com/aframevr/aframe-school)
- [Command Line Interface ★23](https://github.com/aframevr/angle)
...
[angle ★23](https://github.com/aframevr/angle)'s `initcomponent` tool. For curated
...
- [Always Fullscreen ★8](https://github.com/protyze/aframe-always-fullscreen-component) - Provide ways to enable Fullscreen on iOS (Scroll to Minimal-UI) and Android/Desktop (Fullscreen API)
- [Ammo Physics Component](https://github.com/jeromeetienne/threex.ammo) - Library integrating [three.js](https://threejs.org/) and [ammo.js ★1081](https://github.com/kripken/ammo.js) to enable physics in objects
- [Animation](https://ngokevin.github.io/aframe-animation-component) - New and improved animation system using components. [[Code] ★13](https://github.com/ngokevin/aframe-animation-component)
- [Asset Lazy Load ★10 ⏳1Y](https://github.com/youmustfight/aframe-asset-lazy-load) - Assign asset loading order and delays
- [Asset On-Demand ★5](https://github.com/protyze/aframe-asset-on-demand-component) - Load Assets dynamically when needed (and properly clean them up if not)
- [Audio Visualizer ★17](https://github.com/ngokevin/aframe-audio-visualizer-components) - Audio visualizations using WebAudio API
- [Broadcast ★14 ⏳1Y](https://github.com/ngokevin/aframe-broadcast-component) - Multiuser with WebSockets
...
- [Crease ★3 ⏳1Y](https://github.com/andreasplesch/aframe-crease-component) - Creased shading
...
- [Cubemap ★18](https://github.com/bryik/aframe-cubemap-component) - Create a skybox from a cubemap
...
- [Draw ★40](https://github.com/maxkrieger/aframe-draw-component) - HTML5 `<canvas>` as a material texture, with support for extension components
- [Entity Generator ★4](https://github.com/ngokevin/aframe-entity-generator-component) - Generate entities
- [Event Set ★6](https://github.com/ngokevin/aframe-event-set-component) - Set properties in response to events, replacement for declarative events
- [Extras ★203](https://github.com/donmccurdy/aframe-extras) - Don's collection of A-Frame components
- [Extrude and Lathe ★6 ⏳1Y](https://github.com/JosePedroDias/aframe-extrude-and-lathe) - Extrude and lathe geometries
- [Faceset ★3 ⏳1Y](https://github.com/andreasplesch/aframe-faceset-component) - Geometry from vertices and faces
...
- [Fit Texture ★8](https://github.com/nylki/aframe-fit-texture-component) - Automatically scale entities relative to their texture, so you don't need to set width/height manually
- [Force-directed Graph](https://github.com/vasturiano/aframe-forcegraph-component) - Represent a graph data structure in a 3D force-directed iterative layout, using [d3-force-3d ★11](https://github.com/vasturiano/d3-force-3d) for the physics simulation engine.
...
- [Gamepad Controls ★34](https://github.com/donmccurdy/aframe-gamepad-controls) - Gamepad controls using HTML5 Gamepad API
...
- [Grid Helper ★9](https://github.com/dbradleyfl/aframe-gridhelper) - Create customizable grids
...
- [Motion Capture ★20](https://github.com/dmarcos/aframe-motion-capture-components) - Record and replay headset and controller pose and events
- [Mouse Cursor Component ★44](https://github.com/mayognaise/aframe-mouse-cursor-component) - Add interaction to the hardware mouse, by raycasting from `XY` position on canvas
- [Multitouch-look-controls ★0](https://github.com/morandd/aframe-multitouch-look-controls) - Touch-driven freelook camera; drop-in replacement for look-controls
- [No-click Look Controls ★37](https://github.com/alexrkass/aframe-no-click-look-controls) - Intuitive desktop view controls without requiring mouse click + drag
...
- [Orbit Controls Component ★13](https://github.com/tizzle/aframe-orbit-controls-component) - Allow desktop users to rotate the camera around an object
- [Particle System ★36](https://github.com/IdeaSpaceVR/aframe-particle-system-component) - Particle systems (e.g., rain, dust, snow, fire)
...
- [Physics + Vive Controls](https://github.com/donmccurdy/aframe-extras/tree/master/src/misc) - `grab` and `sphere-collider` components for combining the HTC Vive's controllers with the [`aframe-physics-system` ★56](https://github.com/donmccurdy/aframe-physics-system) component
- [Physics ★56](https://github.com/donmccurdy/aframe-physics-system) - Rigid-body physics using [Cannon.js](http://www.cannonjs.org/)
...
- [Slice9 ★5](https://github.com/fernandojsg/aframe-slice9-component) - 9-Slice for creating sharp panels and tooltips for UI
- [Sprite ★4](https://github.com/tizzle/aframe-sprite-component) - Creates bitmap images that always face the camera
- [Star ★4 ⏳1Y](https://github.com/andreasplesch/aframe-star-component) - 2D stars
- [Stereo ★53](https://github.com/oscarmarinmiro/aframe-stereo-component) - Enable rendering different entities for each eye, using three.js layers so you can render 3D stereoscopic videos (full and half-dome)
- [Stereo Cube ★8](https://github.com/wallabyway/aframe-stereocube) - Use stereoscopic cube-map textures (i.e., left and right eye textures)
- [SVG File ★6](https://github.com/7dir/aframe-svgfile-component) - Load basic SVG files as 3d geometry
- [Teleport Controls ★31](https://github.com/fernandojsg/aframe-teleport-controls) - Teleportation with tracked controllers
...
- [Terrain Model ★7](https://github.com/bryik/aframe-terrain-model-component) - Generating terrains using TerrainLoader
- [Text Wrap ★24 ⏳1Y](https://github.com/maxkrieger/aframe-textwrap-component) - Wrapping text dynamically rendered onto the `draw` component
...
- [UI Widgets ★37](https://github.com/caseyyee/aframe-ui-widgets) - Another set of UI components, including buttons, switchs, sliders, and knobs
...
- [Mixin Style Sheets](https://github.com/ngokevin/aframe-mss) - CSS-like stylesheets for A-Frame for declaring mixins [[Code] ★18](https://github.com/ngokevin/aframe-mss)
...
- [aframe-phantomjs-continuous-streaming ★21](https://github.com/cjroth/aframe-phantomjs-continuous-streaming) - Browse the web in VR by live streaming a web page into A-Frame using PhantomJS and ffmpeg
- [aframe-keyboard ★7](https://github.com/cjroth/aframe-keyboard) - A virtual-reality keyboard and text editor in A-Frame

### Scenes

- [a-invaders](http://swimminglessonsformodernlife.com/a-invaders) - Space invaders game. [[Code] ★20 ⏳1Y](https://github.com/dmarcos/a-invaders)
...
- [Cardboard Dungeon](https://chrismwaite.github.io/cardboard-dungeon) - A first-person dungeon crawler designed for mobile. [[Code] ★27 ⏳1Y](https://github.com/chrismwaite/cardboard-dungeon)
- [Don McCurdy's Sandbox](https://sandbox.donmccurdy.com/vr/) - Don McCurdy's A-Frame scenes including [MagicaVoxel](https://ephtracy.github.io/) models, physics playgrounds, and controls [[Code] ★203](https://github.com/donmccurdy/aframe-extras)
- [Kevin Ngo's Scenes](http://ngokevin.com/kframe/) - Kevin Ngo's A-Frame scenes including MagicaVoxel models, audio visualizations, and a Minecraft demo [[Code] ★282](https://github.com/ngokevin/kframe)
...
- [Sketch VR](https://uniform-futures.github.io/sketch-vr) - Doodle on paper, take a picture, and view it in VR. [[Code] ★8 ⏳1Y](https://github.com/uniform-futures/sketch-vr)
...
- [Procedural Forest](https://nylki.github.io/aframe-lsystem-component/forrest/) - A procedural forest with procedural trees using the [L-System Component ★19](https://github.com/nylki/aframe-lsystem-component)
...
- [Weather Room](https://weatherroom.herokuapp.com/) - What’s the forecast for WebVR? Sunny with no chance of rain. [[Code] ★1 ⏳1Y](https://github.com/sebscholl/weatherroom)
...
- [WebVR Soccer Stadium Complex](https://s3.amazonaws.com/cassell-webvr/webvr-soccer-stadium-multiplex/index.html) - Watch several video feeds at once in a soccer stadium. [[Code] ★5 ⏳1Y](https://github.com/cassell/webvr-soccer-stadium-multiplex)
...
- [GuriVR](https://gurivr.com/) - Create sharable VR scenes using natural language and zero code. [[Code] ★114](https://github.com/opennewslabs/guri-vr)
...
- [Unity Exporter to A-Frame ★40](https://github.com/if1live/unity-scene-web-exporter) - Export Unity scenes to three.js or A-Frame with lightmapping
...
- [City Builder](https://kfarr.github.io/aframe-city-builder) - Room-scale city builder. [[Code] ★34](https://github.com/kfarr/aframe-city-builder)
