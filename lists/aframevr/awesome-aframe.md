# awesome-aframe [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★57421](https://github.com/sindresorhus/awesome)
...
- [Inspector ★174](https://github.com/aframevr/aframe-inspector)
- [Registry ★37](https://github.com/aframevr/aframe-registry)
- [Presentation Kit ★36](https://github.com/aframevr/aframe-presentation-kit)
- [School ★22](https://github.com/aframevr/aframe-school)
- [Command Line Interface ★21](https://github.com/aframevr/angle)
...
- [A-Frame: VR for Developers &mdash; Diego Marcos & Kevin Ngo](https://www.youtube.com/watch?v=wRqoSdPZQBY) - Talk on A-Frame at the [SFHTML5 "WebVR Ecosystem and API Update" meetup](https://www.meetup.com/sfhtml5/events/230072340/) [[Slides] ★6](https://github.com/ngokevin/aframe-sfhtml5-presentation)
...
[angle ★21](https://github.com/aframevr/angle)'s `initcomponent` tool. For curated
components, see the [A-Frame Registry](https://aframe.io/aframe-registry/).

- [Along Path ★12](https://github.com/protyze/aframe-alongpath-component) - Interpolating an entity's position along a path
...
- [Ammo Physics Component](https://github.com/jeromeetienne/threex.ammo) - Library integrating [three.js](https://threejs.org/) and [ammo.js ★1062](https://github.com/kripken/ammo.js) to enable physics in objects
- [Animation](https://ngokevin.github.io/aframe-animation-component) - New and improved animation system using components. [[Code] ★12](https://github.com/ngokevin/aframe-animation-component)
- [Asset Lazy Load ★10](https://github.com/youmustfight/aframe-asset-lazy-load) - Assign asset loading order and delays
...
- [Audio Visualizer ★16](https://github.com/ngokevin/aframe-audio-visualizer-components) - Audio visualizations using WebAudio API
- [Broadcast ★14](https://github.com/ngokevin/aframe-broadcast-component) - Multiuser with WebSockets
- [ChartBuilder ★3](https://github.com/impronunciable/aframe-chartbuilder-component) - Use [ChartBuilder](http://quartz.github.io/Chartbuilder) charts
...
- [Crawling Cursor ★17](https://github.com/jujunjun110/aframe-crawling-cursor) - Cursor projected onto surfaces
- [Crease ★3](https://github.com/andreasplesch/aframe-crease-component) - Creased shading
- [Chromakey Material ★3](https://github.com/nikolaiwarner/aframe-chromakey-material) - Chromakey material for green screen effects
- [Cubemap ★17](https://github.com/bryik/aframe-cubemap-component) - Create a skybox from a cubemap
- [Daydream Controller ★20](https://github.com/ryanbetts/aframe-daydream-controller-component) - Daydream controls
...
- [Draw ★39](https://github.com/maxkrieger/aframe-draw-component) - HTML5 `<canvas>` as a material texture, with support for extension components
- [Entity Generator ★4](https://github.com/ngokevin/aframe-entity-generator-component) - Generate entities
- [Event Set ★4](https://github.com/ngokevin/aframe-event-set-component) - Set properties in response to events, replacement for declarative events
- [Extras ★184](https://github.com/donmccurdy/aframe-extras) - Don's collection of A-Frame components
- [Extrude and Lathe ★6](https://github.com/JosePedroDias/aframe-extrude-and-lathe) - Extrude and lathe geometries
...
- [Firebase ★30](https://github.com/ngokevin/aframe-firebase-component) - Multiuser with Firebase
- [Fit Texture ★7](https://github.com/nylki/aframe-fit-texture-component) - Automatically scale entities relative to their texture, so you don't need to set width/height manually
- [FPS Look ★7](https://github.com/cemkod/aframe-fps-look-component) - Facilitates controlling entity rotation directly with captured mouse
- [Gamepad Controls ★31](https://github.com/donmccurdy/aframe-gamepad-controls) - Gamepad controls using HTML5 Gamepad API
- [GIF](https://github.com/gtk2k/gtk2k.github.io/tree/master/animation_gif) - Display GIF as a texture by using a Canvas
- [glTF ★16](https://github.com/xirvr/aframe-gltf) - glTF models
- [Gradient Sky ★5](https://github.com/zcanter/aframe-gradient-sky) - Use two colors to create a gradient shader for colorful skies
- [Grid Helper ★8](https://github.com/dbradleyfl/aframe-gridhelper) - Create customizable grids
- [Height Grid ★8](https://github.com/andreasplesch/aframe-heightgrid-component) - Terrain
- [href ★25](https://github.com/gasolin/aframe-href-component) - Link to other pages using cursor component
- [HTML Texture ★37](https://github.com/scenevr/htmltexture-component) - Using HTML as a texture, powered by html2canvas
- [Interpolation ★5](https://github.com/scenevr/interpolation-component) - Interpolate positional and rotational updates for entities, useful for fetching from server for multiplayer
...
- [L-System ★20](https://github.com/nylki/aframe-lsystem-component) - Render [Lindenmayer](https://en.wikipedia.org/wiki/L-system) systems
- [Layout ★29](https://github.com/ngokevin/aframe-layout-component) - 3D layout of child entities
- [Leap Hands ★85](https://github.com/openleap/aframe-leap-hands) - [Leap Motion](https://www.leapmotion.com/) controller support
- [Lens Flare ★2](https://github.com/mokargas/aframe-lensflare-component) - Lens flare
- [Look-At and Billboard ★5](https://github.com/blairmacintyre/aframe-look-at-billboard-component) - Component to tell an entity to face another entity, or to face the camera
- [Mario Star Texture ★0](https://github.com/casonclagg/aframe-mario-star-component) - Texture that cycles colors like stars in Mario using canvas
- [Mesh Line ★7](https://github.com/andreasplesch/aframe-meshline-component) - Draw thick lines
...
- [Motion Capture ★17](https://github.com/dmarcos/aframe-motion-capture-components) - Record and replay headset and controller pose and events
- [Mouse Cursor Component ★41](https://github.com/mayognaise/aframe-mouse-cursor-component) - Add interaction to the hardware mouse, by raycasting from `XY` position on canvas
- [No-click Look Controls ★35](https://github.com/alexrkass/aframe-no-click-look-controls) - Intuitive desktop view controls without requiring mouse click + drag
...
- [Orbit Controls ★6](https://github.com/subsumo/aframe-orbit-controls) - Orbit camera around an entity
- [Orbit Controls Component ★10](https://github.com/tizzle/aframe-orbit-controls-component) - Allow desktop users to rotate the camera around an object
- [Particle System](https://github.com/IdeaSpaceVR/aframe-particle-system-component) - Particle systems (e.g., rain, dust, snow, fire)
- [Passthrough ★12](https://github.com/flysonic10/aframe-passthrough) - Show a video feed from the device's camera
- [Persist Component ★6](https://github.com/Utopiah/aframe-persist-component) - Use localStorage to make data persist over experiences
- [Physics + Vive Controls](https://github.com/donmccurdy/aframe-extras/tree/master/src/misc) - `grab` and `sphere-collider` components for combining the HTC Vive's controllers with the [`aframe-physics-system` ★45](https://github.com/donmccurdy/aframe-physics-system) component
- [Physics ★45](https://github.com/donmccurdy/aframe-physics-system) - Rigid-body physics using [Cannon.js](http://www.cannonjs.org/)
...
- [Polygon ★1](https://github.com/andreasplesch/aframe-polygon-primitive) - `n`-sided polygons
...
- [Scatterplot ★4](https://github.com/zcanter/aframe-scatterplot) - Scatterplot data visualization
- [Selectable ★7](https://github.com/scenevr/selectable-component) by [@scenevr](https://twitter.com/scenevr) - Click on an entity to select it (handy for editors)
- [Shake-to-Show ★4](https://github.com/rdub80/aframe-shake2show-component) - Using shake.js to toggle UI
- [Slice9 ★4](https://github.com/fernandojsg/aframe-slice9-component) - 9-Slice for creating sharp panels and tooltips for UI
- [Sprite ★4](https://github.com/tizzle/aframe-sprite-component) - Creates bitmap images that always face the camera
- [Star ★4](https://github.com/andreasplesch/aframe-star-component) - 2D stars
...
- [Teleport Controls ★29](https://github.com/fernandojsg/aframe-teleport-controls) - Teleportation with tracked controllers
...
- [Terrain Model ★6](https://github.com/bryik/aframe-terrain-model-component) - Generating terrains using TerrainLoader
- [Text Wrap ★23](https://github.com/maxkrieger/aframe-textwrap-component) - Wrapping text dynamically rendered onto the `draw` component
...
- [Trigger Box ★1](https://github.com/Utopiah/aframe-triggerbox-component) - A component that emits an event when it enters or leaves a predefined area
...
- [UI Components ★13](https://github.com/gmarty/aframe-ui-components) - A collection of components related to UI
- [UI Modal ★13](https://github.com/IdeaSpaceVR/aframe-ui-modal-component) - Show dialog box or a menu in front of the camera
- [UI Widgets ★35](https://github.com/caseyyee/aframe-ui-widgets) - Another set of UI components, including buttons, switchs, sliders, and knobs
- [Universal Controls](https://github.com/donmccurdy/aframe-extras/tree/master/src/controls) - Refactored A-Frame controls that supports gamepad, HMD, keyboard, mouse + pointerlock, touch-to-move, with [physics ★45](https://github.com/donmccurdy/aframe-physics-system) compatibility
- [Video Controls ★25](https://github.com/oscarmarinmiro/aframe-video-controls) - Video controls (play/pause/jump) for A-Frame video assets
- [Vive Cursor](https://github.com/bryik/aframe-vive-cursor-component) - A cursor for the HTC Vive's controllers
- [WebVR Controller ★25](https://github.com/richardanaya/aframe-webvr-controller) - HTC Vive controllers
...
- [HTML ★59](https://github.com/mayognaise/aframe-html-shader) - Render from HTML
- [Video ★15](https://github.com/mayognaise/aframe-video-shader) - iOS-compatible video material
- [GIF ★15](https://github.com/mayognaise/aframe-gif-shader) - Render animated GIFs
...
- [aframe-templating-examples ★1](https://github.com/ngokevin/aframe-templating-examples) - A-Frame with templating engines such as Handlebars, mustache, Nunjucks
- [SpineFrame ★10](https://github.com/JoshGalvin/SpineFrame) - Component for 2D sprite animation with [Spine](http://esotericsoftware.com/)
- [Meteor ★12](https://github.com/vladbalan/meteor-aframe) - A-Frame with [Meteor](https://www.meteor.com/), a JavaScript app framework
- [Altspace ★28](https://github.com/AltspaceVR/aframe-altspace-component) - Integration with AltspaceVR
- [Drupal](https://www.drupal.org/project/aframe) - Drupal module for integration with A-Frame
- [Mixin Style Sheets](https://github.com/ngokevin/aframe-mss) - CSS-like stylesheets for A-Frame for declaring mixins. [[Code] ★16](https://github.com/ngokevin/aframe-mss)

### Scenes

- [a-invaders](http://swimminglessonsformodernlife.com/a-invaders) - Space invaders game. [[Code] ★18](https://github.com/dmarcos/a-invaders)
...
- [Cardboard Dungeon](https://chrismwaite.github.io/cardboard-dungeon) - A first-person dungeon crawler designed for mobile. [[Code] ★26](https://github.com/chrismwaite/cardboard-dungeon)
- [Don McCurdy's Sandbox](https://sandbox.donmccurdy.com/vr/) - Don McCurdy's A-Frame scenes including [MagicaVoxel](https://ephtracy.github.io/) models, physics playgrounds, and controls [[Code] ★184](https://github.com/donmccurdy/aframe-extras)
- [Kevin Ngo's Scenes](http://ngokevin.com/kframe/) - Kevin Ngo's A-Frame scenes including MagicaVoxel models, audio visualizations, and a Minecraft demo [[Code] ★261](https://github.com/ngokevin/kframe)
- [Aztec Pong](http://meta-meta.github.io/aztec-pong) - Play Pong floating atop an Aztec monument. [[Code] ★1](https://github.com/meta-meta/aztec-pong)
...
- [Sketch VR](https://uniform-futures.github.io/sketch-vr) - Doodle on paper, take a picture, and view it in VR. [[Code] ★8](https://github.com/uniform-futures/sketch-vr)
...
- [Ball Throw](https://bryik.github.io/aframe-ball-throw) - Throw balls at blocks using Vive controllers and [Don McCurdy's](https://twitter.com/donrmccurdy) [physics](https://github.com/donmccurdy/aframe-physics-system). [[Code] ★10](https://github.com/bryik/aframe-ball-throw)
...
- [Procedural Forest](https://nylki.github.io/aframe-lsystem-component/forrest/) - A procedural forest with procedural trees using the [L-System Component ★20](https://github.com/nylki/aframe-lsystem-component)
- [iStaging LiveTour](http://vrviewer.istaging.co/#!/684173) - 360&deg; real estate tours with a neat mini-map
- [Choose Your Own VR ★0](https://github.com/dannielle/tinier-house) - Which cup will you choose?
...
- [Head-Tracked Transformations](https://armthethinker.github.io/webVR-experiments/6--head-tracked-transformations.html) - VR UX prototype of transforming objects’ orientations with your head to enhance VR experiences that don’t have positional tracking. Read the instructions listed at [#6](https://armthethinker.github.io/webVR-experiments/). [[Code] ★16](https://github.com/armthethinker/webVR-experiments)
- [Weather Room](https://weatherroom.herokuapp.com/) - What’s the forecast for WebVR? Sunny with no chance of rain. [[Code] ★1](https://github.com/sebscholl/weatherroom)
...
- [WebVR Soccer Stadium Complex](https://s3.amazonaws.com/cassell-webvr/webvr-soccer-stadium-multiplex/index.html) - Watch several video feeds at once in a soccer stadium. [[Code] ★6](https://github.com/cassell/webvr-soccer-stadium-multiplex)
...
- [GuriVR](https://gurivr.com/) - Create sharable VR scenes using natural language and zero code. [[Code] ★111](https://github.com/opennewslabs/guri-vr)
...
- [Unity Exporter to A-Frame ★35](https://github.com/if1live/unity-scene-web-exporter) - Export Unity scenes to three.js or A-Frame with lightmapping
...
- [City Builder](https://kfarr.github.io/aframe-city-builder) - Room-scale city builder. [[Code] ★30](https://github.com/kfarr/aframe-city-builder)
