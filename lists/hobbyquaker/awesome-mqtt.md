...
* [mqtt-benchmark ★105](https://github.com/chirino/mqtt-benchmark) - A benchmarking tool for MQTT Servers.
* [mqtt-fuzz ★30](https://github.com/F-Secure/mqtt_fuzz) - A simple fuzzer for the MQTT protocol.
...
* [mqtt-malaria ★144](https://github.com/remakeelectric/mqtt-malaria) - scalability and load testing utilities for MQTT environments.
* [mqtt-spy](http://kamilfb.github.io/mqtt-spy/) - Java based MQTT frontend. Supports scripting.
* [mqtt-utils ★6](https://github.com/dsell/mqtt-utils) - a collection of MQTT utilities.
...
* [Wireshark-MQTT ★54](https://github.com/menudoproblema/Wireshark-MQTT) - MQTT dissector for Wireshark.
...
* [mqtt.dart ★7](https://github.com/jnguillerme/mqtt.dart) - dart mqtt client.
* [mqtt-elements ★18](https://github.com/mqttjs/mqtt-elements) - Polymer elements for MQTT.
* [mqttex ★38](https://github.com/alfert/mqttex) - MQTT implementation in Elixir.
...
* [tcl-mqtt ★2](https://github.com/Tingenek/tcl-mqtt) - Small library to connect to a matt broker. Very, very basic.
...
* [logic4mqtt ★9](https://github.com/owagner/logic4mqtt) - Java based Logic and scripting engine for use with MQTT. Uses Java's general scripting interface, so scripts can be written in a multitude of languages like Javascript, Groovy etc.
* [mqtt-scripts ★8](https://github.com/hobbyquaker/mqtt-scripts) - Node.js based script runner.
...
* [arduinoTemps2mqtt ★8](https://github.com/matbor/arduinoTemps2mqtt) - Arduino sketch, grab Onewire Temperature's and publish to a mqtt broker.
...
* [xbee2mqtt ★15](https://github.com/xoseperez/xbee2mqtt) - XBee to MQTT gateway.
...
* [agi-mqtt ★16](https://github.com/zeha/agi-mqtt) - Interface between Asterisk and MQTT.
* [fritz2mqtt ★2](https://github.com/akentner/fritz2mqtt) - Connect FRITZ!Box to MQTT.


#### Operating System

* [mqttlauncher ★19](https://github.com/jpmens/mqtt-launcher) - Execute shell commands triggered by published MQTT messages.
* [mqtt-os-status ★6](https://github.com/oskarhagberg/mqtt-os-status) - Operating-system related data, published to an MQTT broker at fixed intervals.
...
* [mqttwatchdir ★15](https://github.com/jpmens/mqtt-watchdir) - Recursively watch a directory for modifications and publish file content to an MQTT broker.
...
* [notify-by-mqtt ★10](https://github.com/jpmens/notify-by-mqtt) - a Nagios/Icinga notification module which wraps data into JSON and fires it off to an MQTT broker.
...
* [graylog-plugin-mqtt ★5](https://github.com/graylog-labs/graylog-plugin-mqtt) - MQTT Input Plugin for Graylog.
* [mqtt2graphite ★44](https://github.com/jpmens/mqtt2graphite) - Subscribe to MQTT topics and push to Graphite's Carbon server.
* [influx4mqtt ★5](https://github.com/hobbyquaker/influx4mqtt) - Subscribe to MQTT topics and insert into InfluxDB.
* [mqtthandler ★5](https://github.com/changyuheng/MQTTHandler) - A Python logging handler module for MQTT.
...
* [knx2mqtt ★9](https://github.com/owagner/knx2mqtt) - Interface between the KNX home automation standard and MQTT.
* [mqtt-dss-bridge ★3](https://github.com/cgHome/mqtt-dss-bridge) - MQTT digitalSTROM-Server Bridge.
...
* [Home.Pi ★172](https://github.com/denschu/home.pi) is based on MQTT.
...
* [mqtt-dmx-sequencer ★3](https://github.com/hobbyquaker/mqtt-dmx-sequencer) - Control DMX devices via Art-Net by MQTT.
* [TRADFRI2MQTT ★14](https://github.com/hardillb/TRADFRI2MQTT) - MQTT Bridge for IKEA TRÅDFRI Light Gateway.


#### Home Entertainment

* [airtunes2mqtt ★7](https://github.com/hobbyquaker/airtunes2mqtt) - MQTT controlled Multi-Room Audio with Airplay/Airtunes Devices.
...
* [yamaha-avr2mqtt ★2](https://github.com/akentner/yamaha-avr2mqtt)
...
* [flowerpower2mqtt ★3](https://github.com/hobbyquaker/flowerpower2mqtt) - Publish measurements from Parrot Flower Power plant sensors to MQTT.


#### Smart Metering

* [bcontrol2mqtt ★0](https://github.com/hobbyquaker/bcontrol2mqtt) - Publish measurements from [TQ Energy Manager](https://www.tq-group.com/produkte/produktdetail/prod/energy-manager/extb/Main/) to MQTT.


#### Messaging

* [mqtt-irc-bot ★12](https://github.com/dobermai/mqtt-irc-bot) - A MQTT to IRC / IRC to MQTT bridge or bot.
* [mqttwarn](https://github.com/jpmens/mqttwarn) - Subscribe to MQTT topics (with wildcards) and notifiy pluggable services.
* [twitter-to-mqtt ★13](https://github.com/knolleary/twitter-to-mqtt) - A python daemon that uses the Twitter Streaming API to access tweets and republishes them to an MQTT topic.
...
* [mqtt-svg-dash ★29](https://github.com/jpmens/mqtt-svg-dash) - Subscribe to MQTT, extract JSON from a message and make lights blink on an SVG page.
