...
* [hbmqtt ★195](https://github.com/beerfactory/hbmqtt) - Python MQTT broker using asyncio.
* [hrotti ★78](https://github.com/alsm/hrotti) - A MQTT broker written in Go.
* [HiveMQ](http://www.hivemq.com/) - Java based commercial MQTT Broker.
* [Moquette ★624](https://github.com/andsel/moquette) - Java MQTT lightweight broker.
...
* [Vert.x MQTT server ★31](https://github.com/vert-x3/vertx-mqtt-server) - This Vert.x component provides a server which is able to handle connections, communication and messages exchange with remote MQTT clients.
...
* [mqtt-benchmark ★107 ⏳5Y](https://github.com/chirino/mqtt-benchmark) - A benchmarking tool for MQTT Servers.
...
* [MQTTInspector ★51 ⏳1Y](https://github.com/ckrey/MQTTInspector) - A general MQTT testing app for iOS (iPhone and iPad).
...
* [mqtt-malaria ★153 ⏳1Y](https://github.com/remakeelectric/mqtt-malaria) - scalability and load testing utilities for MQTT environments.
...
* [mqtt-wall ★13](https://github.com/bastlirna/mqtt-wall) - Subscription only web-based client – like Twitter wall for MQTT.
* [mqtt-wildcard ★4](https://github.com/hobbyquaker/mqtt-wildcard) - Node.js Module to match a MQTT Topic against Wildcards.
* [Python MQTT Client Shell ★12](https://github.com/bapowell/python-mqtt-client-shell) - a text console-based, interactive shell for exercising various tasks associated with MQTT client communications.
* [Wireshark-MQTT ★56 ⏳1Y](https://github.com/menudoproblema/Wireshark-MQTT) - MQTT dissector for Wireshark.

### Clients

* [CocoaMQTT ★470](https://github.com/emqtt/CocoaMQTT) - MQTT for iOS and OS X written with Swift.
* [emqttc ★95](https://github.com/emqtt/emqttc) - Asynchronous Erlang MQTT Client.
* [Moscapsule ★160](https://github.com/flightonary/Moscapsule) - MQTT Client for iOS written in Swift.
* [hbmqtt ★195](https://github.com/beerfactory/hbmqtt) - Python MQTT client using asyncio.
...
* [Mosquitto-PHP ★187](https://github.com/mgdm/Mosquitto-PHP) - A wrapper for the Mosquitto MQTT client library for PHP.
...
* [MQTT-Client-Framework ★668](https://github.com/ckrey/MQTT-Client-Framework) - iOS, OSX, tvOS native ObjectiveC MQTT Client Framework.
* [mqtt.dart ★8 ⏳2Y](https://github.com/jnguillerme/mqtt.dart) - dart mqtt client.
...
* [MQTTKit ★360](https://github.com/mobile-web-messaging/MQTTKit) - MQTT Objective-C client for iOS.
...
* [mqtt-rs ★21](https://github.com/zonyitoo/mqtt-rs) - MQTT protocol library for Rust.
* [Paho](http://www.eclipse.org/paho/) - open-source client implementations (C/C++, Java, Python, Javascript, Go, C#).
* [pubsubclient ★1221](https://github.com/knolleary/pubsubclient) - A client library for the Arduino Ethernet Shield that provides support for MQTT.
* [rumqtt ★18](https://github.com/AtherEnergy/rumqtt) - A fast, lock free pure rust mqtt cilent.
* [ruby-mqtt ★270](https://github.com/njh/ruby-mqtt) - Pure Ruby gem that implements the MQTT protocol.
...
* [mqtt-scripts ★10 ⏳1Y](https://github.com/hobbyquaker/mqtt-scripts) - Node.js based script runner.
...
* [esp_mqtt ★700](https://github.com/tuanpmt/esp_mqtt) - MQTT client library for ESP8266.
* [mqtt-ir-transceiver ★28](https://github.com/enc-X/mqtt-ir-transceiver) - ESP8266 based bidirectional gateway between MQTT and IR. Use with PlatformIO.
...
* [modbus2mqtt ★28](https://github.com/owagner/modbus2mqtt) - Modbus master which publishes register values via MQTT.
* [mqtt2opcua ★21](https://github.com/nzfarmer1/mqtt2opcua) - Bi Directional MQTT to OPCUA Bridge.
...
* [mqttlauncher ★25 ⏳3Y](https://github.com/jpmens/mqtt-launcher) - Execute shell commands triggered by published MQTT messages.
...
* [mqtt2graphite ★45](https://github.com/jpmens/mqtt2graphite) - Subscribe to MQTT topics and push to Graphite's Carbon server.
...
* [aqara-mqtt ★31](https://github.com/monster1025/aqara-mqtt) - Aqara (Xiaomi) Gateway to MQTT bridge.
...
* [hm2mqtt.js ★6](https://github.com/hobbyquaker/hm2mqtt.js) - Interface between EQ-3's Homematic line of smarthome devices and MQTT. Supports Homematic IP.
* [knx2mqtt ★10 ⏳1Y](https://github.com/owagner/knx2mqtt) - Interface between the KNX home automation standard and MQTT.
* [mqtt2homekit](https://github.com/forty2/mqtt2homekit) - Roughly the opposite of [homekit2mqtt ★81](https://github.com/hobbyquaker/homekit2mqtt): Control your HomeKit-enabled devices with MQTT and without Siri or iPhone.
...
* [control-freak ★3](https://github.com/xblox/control-freak) - IDE for IoT & friends. Built in MQTT support.
...
* [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) - Interface between [HAP-NodeJS ★1452](https://github.com/KhaosT/HAP-NodeJS) and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.
* [Home.Pi ★175 ⏳2Y](https://github.com/denschu/home.pi) is based on MQTT.
...
* [TRADFRI2MQTT ★24](https://github.com/hardillb/TRADFRI2MQTT) - MQTT Bridge for IKEA TRÅDFRI Light Gateway.
...
* [kodi2mqtt ★42](https://github.com/owagner/kodi2mqtt) - Interface between a Kodi mediacenter instance and MQTT.
* [harmony-api ★129](https://github.com/maddox/harmony-api) - A simple server allowing you to query/control multiple local Harmony Home Hubs over HTTP or MQTT.
* [lgtv2mqtt ★11](https://github.com/hobbyquaker/lgtv2mqtt) - Interface between LG WebOS Smart TVs and MQTT.
* [lirc2mqtt ★6](https://github.com/hobbyquaker/lirc2mqtt) - Send and receive infrared via [LIRC](www.lirc.org).
* [mqtt2atlonamatrix ★0](https://github.com/forty2/mqtt2atlonamatrix) - Control Atlona HDMI matrix switches with MQTT.
* [mqtt2tivoremote ★0](https://github.com/forty2/mqtt2tivoremote) - Make TiVo DVR remote control available through an mqtt-smarthome style interface.
...
* [mqttwarn ★550](https://github.com/jpmens/mqttwarn) - Subscribe to MQTT topics (with wildcards) and notifiy pluggable services.
...
* [node-mqtt-for-anki-overdrive ★33 ⏳1Y](https://github.com/IBM-Bluemix/node-mqtt-for-anki-overdrive) - Node.js Controller and MQTT API for Anki Overdrive.
...
* [d3-MQTT-Topic-Tree ★59](https://github.com/hardillb/d3-MQTT-Topic-Tree) - A MQTT Topic Tree viewer using the d3 collapsable tree and MQTT over websockets.
...
* [node-red-dashboard ★225](https://github.com/node-red/node-red-dashboard) - A dashboard UI for Node-RED.
...
* [mqtt-panel ★148](https://github.com/fabaff/mqtt-panel) - A web interface for MQTT.
...
* [Homie ★208](https://github.com/marvinroger/homie) - A lightweight MQTT convention for the IoT.
* [mqtt-smarthome ★96](https://github.com/mqtt-smarthome/mqtt-smarthome) - Smart home automation with MQTT as the central message bus - Architectural proposal.
