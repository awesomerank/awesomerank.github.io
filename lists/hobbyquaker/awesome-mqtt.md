...
* [esp_uMQTT_broker ★38](https://github.com/martin-ger/esp_mqtt) - A basic MQTT Broker on the ESP8266.
* [hbmqtt ★232](https://github.com/beerfactory/hbmqtt) - Python MQTT broker using asyncio.
* [hrotti ★84](https://github.com/alsm/hrotti) - A MQTT broker written in Go.
* [HiveMQ](https://www.hivemq.com/) - Java based commercial MQTT Broker.
* [Moquette ★717](https://github.com/andsel/moquette) - Java MQTT lightweight broker.
...
* [mqtt-admin ★47](https://github.com/hobbyquaker/mqtt-admin) - Web based MQTT frontend. [Direct Link](https://hobbyquaker.github.io/mqtt-admin/).
* [mqtt-benchmark ★111 ⏳5Y](https://github.com/chirino/mqtt-benchmark) - A benchmarking tool for MQTT Servers.
* [mqttcli ★54 ⏳1Y](https://github.com/shirou/mqttcli) - MQTT Client for shell scripting.
...
* [mqtt-malaria ★163 ⏳1Y](https://github.com/remakeelectric/mqtt-malaria) - scalability and load testing utilities for MQTT environments.
...
* [Wireshark-MQTT ★58 ⏳2Y](https://github.com/menudoproblema/Wireshark-MQTT) - MQTT dissector for Wireshark.
...
* [Hulaaki ★85](https://github.com/suvash/hulaaki) - An Elixir library for clients communicating with MQTT brokers.
...
* [Mosquitto-PHP ★215](https://github.com/mgdm/Mosquitto-PHP) - A wrapper for the Mosquitto MQTT client library for PHP.
...
* [MQTT-Client-Framework ★780](https://github.com/ckrey/MQTT-Client-Framework) - iOS, OSX, tvOS native ObjectiveC MQTT Client Framework.
...
* [MQTTKit ★373 ⏳1Y](https://github.com/mobile-web-messaging/MQTTKit) - MQTT Objective-C client for iOS.
...
* [mqtt-rs ★29](https://github.com/zonyitoo/mqtt-rs) - MQTT protocol library for Rust.
...
* [rumqtt ★27](https://github.com/AtherEnergy/rumqtt) - A fast, lock free pure rust MQTT client.
* [ruby-mqtt ★292](https://github.com/njh/ruby-mqtt) - Pure Ruby gem that implements the MQTT protocol.
...
* [modbus2mqtt ★33](https://github.com/owagner/modbus2mqtt) - Modbus master which publishes register values via MQTT.
...
* [mqttlauncher ★34](https://github.com/jpmens/mqtt-launcher) - Execute shell commands triggered by published MQTT messages.
...
* [check-mqtt ★22](https://github.com/jpmens/check-mqtt) - A Nagios/Icinga plugin for checking connectivity to an MQTT broker.
...
* [aqara-mqtt ★42](https://github.com/monster1025/aqara-mqtt) - Aqara (Xiaomi) Gateway to MQTT bridge.
...
* [mqtt2homekit](https://github.com/forty2/mqtt2homekit) - Roughly the opposite of [homekit2mqtt ★104](https://github.com/hobbyquaker/homekit2mqtt): Control your HomeKit-enabled devices with MQTT and without Siri or iPhone.
* [mqtt-dss-bridge ★3 ⏳2Y](https://github.com/cgHome/mqtt-dss-bridge) - MQTT digitalSTROM-Server Bridge.
* [node-lox-mqtt-gateway ★10](https://github.com/alladdin/node-lox-mqtt-gateway) - Gateway for Loxone™ mini server to communicate with MQTT broker.
* [xiaomi2mqtt ★5](https://github.com/svrooij/node-xiaomi2mqtt) - bridge between the Xiaomi Smart Home Gateway Aquara and a MQTT server.
* [smartthings-mqtt-bridge ★143](https://github.com/stjohnjohnson/smartthings-mqtt-bridge) - Bridge between [SmartThings](https://www.smartthings.com/) and MQTT.
...
* [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) - Interface between [HAP-NodeJS ★1614](https://github.com/KhaosT/HAP-NodeJS) and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.
* [Home.Pi ★183 ⏳2Y](https://github.com/denschu/home.pi) is based on MQTT.
...
* [TRADFRI2MQTT ★35](https://github.com/hardillb/TRADFRI2MQTT) - MQTT Bridge for IKEA TRÅDFRI Light Gateway.
...
* [broadlink-mqtt ★47](https://github.com/eschava/broadlink-mqtt) - MQTT client to control BroadLink RM devices.
...
* [harmony-api ★168](https://github.com/maddox/harmony-api) - A simple server allowing you to query/control multiple local Harmony Home Hubs over HTTP or MQTT.
...
* [bcontrol2mqtt ★0 ⏳2Y](https://github.com/hobbyquaker/bcontrol2mqtt) - Publish measurements from [TQ Energy Manager](https://www.tq-group.com/produkte/produktdetail/prod/energy-manager/extb/Main/) to MQTT.
...
* [AlexaMqttBridge ★9](https://github.com/mhdawson/AlexaMqttBridge) - Bridge between Amazon Alexa and Mqtt.
...
* [leaf-python-mqtt ★12](https://github.com/glynhudson/leaf-python-mqtt) - Extract data from Nissan Leaf API and post to mqtt.
* [miflora-mqtt-daemon ★20](https://github.com/ThomDietrich/miflora-mqtt-daemon) - Linux service to send Xiaomi Mi Flora plant sensor data to an MQTT broker.
* [mqtt2ble ★9](https://github.com/hardillb/mqtt2ble) - A way to bridge MQTT topics to BLE Gatt characteristics.
...
* [node-mqtt-for-anki-overdrive ★37 ⏳1Y](https://github.com/IBM-Bluemix/node-mqtt-for-anki-overdrive) - Node.js Controller and MQTT API for Anki Overdrive.
...
* [node-red-dashboard ★301](https://github.com/node-red/node-red-dashboard) - A dashboard UI for Node-RED.
...
* [mqtt-panel ★165](https://github.com/fabaff/mqtt-panel) - A web interface for MQTT.
* [mqtt-svg-dash ★33 ⏳4Y](https://github.com/jpmens/mqtt-svg-dash) - Subscribe to MQTT, extract JSON from a message and make lights blink on an SVG page.
...
* [Homie ★254](https://github.com/marvinroger/homie) - A lightweight MQTT convention for the IoT.
* [mqtt-smarthome ★132](https://github.com/mqtt-smarthome/mqtt-smarthome) - Smart home automation with MQTT as the central message bus - Architectural proposal.
