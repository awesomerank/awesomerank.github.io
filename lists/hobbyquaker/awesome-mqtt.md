...
* [esp_uMQTT_broker ★5](https://github.com/martin-ger/esp_mqtt) - A basic MQTT Broker on the ESP8266.
* [hbmqtt ★202](https://github.com/beerfactory/hbmqtt) - Python MQTT broker using asyncio.
...
* [Moquette ★643](https://github.com/andsel/moquette) - Java MQTT lightweight broker.
...
* [Vert.x MQTT ★32](https://github.com/vert-x3/vertx-mqtt) - Vert.x component to handle connections, communication and messages exchange with remote MQTT clients.
...
* [mqtt-benchmark ★108 ⏳5Y](https://github.com/chirino/mqtt-benchmark) - A benchmarking tool for MQTT Servers.
...
* [CocoaMQTT ★507](https://github.com/emqtt/CocoaMQTT) - MQTT for iOS and OS X written with Swift.
* [emqttc ★96](https://github.com/emqtt/emqttc) - Asynchronous Erlang MQTT Client.
* [Moscapsule ★167](https://github.com/flightonary/Moscapsule) - MQTT Client for iOS written in Swift.
* [hbmqtt ★202](https://github.com/beerfactory/hbmqtt) - Python MQTT client using asyncio.
...
* [Mosquitto-PHP ★198](https://github.com/mgdm/Mosquitto-PHP) - A wrapper for the Mosquitto MQTT client library for PHP.
...
* [MQTT-Client-Framework ★719](https://github.com/ckrey/MQTT-Client-Framework) - iOS, OSX, tvOS native ObjectiveC MQTT Client Framework.
...
* [MQTTKit ★367 ⏳1Y](https://github.com/mobile-web-messaging/MQTTKit) - MQTT Objective-C client for iOS.
...
* [mqtt-rs ★22](https://github.com/zonyitoo/mqtt-rs) - MQTT protocol library for Rust.
* [Paho](http://www.eclipse.org/paho/) - open-source client implementations (C/C++, Java, Python, Javascript, Go, C#).
* [pubsubclient ★1252](https://github.com/knolleary/pubsubclient) - A client library for the Arduino Ethernet Shield that provides support for MQTT.
* [rumqtt ★19](https://github.com/AtherEnergy/rumqtt) - A fast, lock free pure rust mqtt cilent.
* [ruby-mqtt ★281](https://github.com/njh/ruby-mqtt) - Pure Ruby gem that implements the MQTT protocol.
...
* [Vert.x MQTT ★32](https://github.com/vert-x3/vertx-mqtt) - Vert.x component that provides methods for connecting/disconnecting to a broker, publishing messages and subscribing to topics.
...
* [mqtt-scripts ★10](https://github.com/hobbyquaker/mqtt-scripts) - Node.js based script runner.
...
* [esp_mqtt ★722](https://github.com/tuanpmt/esp_mqtt) - MQTT client library for ESP8266.
...
* [aqara-mqtt ★32](https://github.com/monster1025/aqara-mqtt) - Aqara (Xiaomi) Gateway to MQTT bridge.
...
* [mqtt2homekit](https://github.com/forty2/mqtt2homekit) - Roughly the opposite of [homekit2mqtt ★87](https://github.com/hobbyquaker/homekit2mqtt): Control your HomeKit-enabled devices with MQTT and without Siri or iPhone.
...
* [smartthings-mqtt-bridge ★121](https://github.com/stjohnjohnson/smartthings-mqtt-bridge) - Bridge between [SmartThings](https://www.smartthings.com/) and MQTT.


#### Smart Home Integration Software

* [control-freak ★4](https://github.com/xblox/control-freak) - IDE for IoT & friends. Built in MQTT support.
...
* [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) - Interface between [HAP-NodeJS ★1497](https://github.com/KhaosT/HAP-NodeJS) and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.
* [Home.Pi ★177 ⏳2Y](https://github.com/denschu/home.pi) is based on MQTT.
...
* [MQTT DMX Controller ★3](https://github.com/hobbyquaker/mqtt-dmx-controller) - DMX Controller with MQTT support.
...
* [TRADFRI2MQTT ★26](https://github.com/hardillb/TRADFRI2MQTT) - MQTT Bridge for IKEA TRÅDFRI Light Gateway.
...
* [broadlink-mqtt ★33](https://github.com/eschava/broadlink-mqtt) - MQTT client to control BroadLink RM devices.
* [chromecast-mqtt-connector ★7](https://github.com/nohum/chromecast-mqtt-connector) - Control your Google Chromecast devices using MQTT.
* [kodi2mqtt ★43](https://github.com/owagner/kodi2mqtt) - Interface between a Kodi mediacenter instance and MQTT.
* [harmony-api ★138](https://github.com/maddox/harmony-api) - A simple server allowing you to query/control multiple local Harmony Home Hubs over HTTP or MQTT.
* [lgtv2mqtt ★13](https://github.com/hobbyquaker/lgtv2mqtt) - Interface between LG WebOS Smart TVs and MQTT.
...
* [mqttwarn ★569](https://github.com/jpmens/mqttwarn) - Subscribe to MQTT topics (with wildcards) and notifiy pluggable services.
...
* [AlexaMqttBridge ★3](https://github.com/mhdawson/AlexaMqttBridge) - Bridge between Amazon Alexa and Mqtt.
...
* [leaf-python-mqtt ★9](https://github.com/glynhudson/leaf-python-mqtt) - Extract data from Nissan Leaf API and post to mqtt.
...
* [d3-MQTT-Topic-Tree ★61](https://github.com/hardillb/d3-MQTT-Topic-Tree) - A MQTT Topic Tree viewer using the d3 collapsable tree and MQTT over websockets.
...
* [node-red-dashboard ★246](https://github.com/node-red/node-red-dashboard) - A dashboard UI for Node-RED.
...
* [Homie ★218](https://github.com/marvinroger/homie) - A lightweight MQTT convention for the IoT.
* [mqtt-smarthome ★100](https://github.com/mqtt-smarthome/mqtt-smarthome) - Smart home automation with MQTT as the central message bus - Architectural proposal.
