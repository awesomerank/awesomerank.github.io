...
* [hbmqtt ★185](https://github.com/beerfactory/hbmqtt) - Python MQTT broker using asyncio.
* [hrotti ★74](https://github.com/alsm/hrotti) - A MQTT broker written in Go.
* [HiveMQ](http://www.hivemq.com/) - Java based commercial MQTT Broker.
* [Moquette ★597](https://github.com/andsel/moquette) - Java MQTT lightweight broker.
...
* [Vert.x MQTT server ★27](https://github.com/vert-x3/vertx-mqtt-server) - This Vert.x component provides a server which is able to handle connections, communication and messages exchange with remote MQTT clients.


### Tools

* [imqtt ★18](https://github.com/shafreeck/imqtt) - Interactive MQTT packet manipulation shell based on IPython.
* [mqtt-admin ★41](https://github.com/hobbyquaker/mqtt-admin) - Web based MQTT frontend. [Direct Link](https://hobbyquaker.github.io/mqtt-admin/).
...
* [mqtt-malaria ★150 ⏳1Y](https://github.com/remakeelectric/mqtt-malaria) - scalability and load testing utilities for MQTT environments.
...
* [CocoaMQTT ★452](https://github.com/emqtt/CocoaMQTT) - MQTT for iOS and OS X written with Swift.
* [emqttc ★90](https://github.com/emqtt/emqttc) - Asynchronous Erlang MQTT Client.
* [Moscapsule ★159](https://github.com/flightonary/Moscapsule) - MQTT Client for iOS written in Swift.
* [hbmqtt ★185](https://github.com/beerfactory/hbmqtt) - Python MQTT client using asyncio.
...
* [Mosquitto-PHP ★182](https://github.com/mgdm/Mosquitto-PHP) - A wrapper for the Mosquitto MQTT client library for PHP.
...
* [MQTT-Client-Framework ★634](https://github.com/ckrey/MQTT-Client-Framework) - iOS, OSX, tvOS native ObjectiveC MQTT Client Framework.
...
* [MQTTKit ★355](https://github.com/mobile-web-messaging/MQTTKit) - MQTT Objective-C client for iOS.
* [mqtt_client_cpp ★17](https://github.com/redboltz/mqtt_client_cpp) - MQTT client for C++14 based on Boost.Asio.
...
* [pubsubclient ★1184](https://github.com/knolleary/pubsubclient) - A client library for the Arduino Ethernet Shield that provides support for MQTT.
* [rumqtt ★16](https://github.com/AtherEnergy/rumqtt) - A fast, lock free pure rust mqtt cilent.
* [ruby-mqtt ★266](https://github.com/njh/ruby-mqtt) - Pure Ruby gem that implements the MQTT protocol.
...
* [esp_mqtt ★682](https://github.com/tuanpmt/esp_mqtt) - MQTT client library for ESP8266.
* [mqtt-ir-transceiver ★25](https://github.com/enc-X/mqtt-ir-transceiver) - ESP8266 based bidirectional gateway between MQTT and IR. Use with PlatformIO.
...
* [aqara-mqtt ★26](https://github.com/monster1025/aqara-mqtt) - Aqara (Xiaomi) Gateway to MQTT bridge.
...
* [mqtt2homekit](https://github.com/forty2/mqtt2homekit) - Roughly the opposite of [homekit2mqtt ★73](https://github.com/hobbyquaker/homekit2mqtt): Control your HomeKit-enabled devices with MQTT and without Siri or iPhone.
...
* [control-freak ★2](https://github.com/xblox/control-freak) - IDE for IoT & friends. Built in MQTT support.
...
* [homekit2mqtt](https://github.com/hobbyquaker/homekit2mqtt) - Interface between [HAP-NodeJS ★1386](https://github.com/KhaosT/HAP-NodeJS) and MQTT. Control MQTT connected devices with Siri or HomeKit Apps.
* [Home.Pi ★174 ⏳2Y](https://github.com/denschu/home.pi) is based on MQTT.
...
* [kodi2mqtt ★41](https://github.com/owagner/kodi2mqtt) - Interface between a Kodi mediacenter instance and MQTT.
* [harmony-api ★121](https://github.com/maddox/harmony-api) - A simple server allowing you to query/control multiple local Harmony Home Hubs over HTTP or MQTT.
...
* [onkyo2mqtt ★5 ⏳1Y](https://github.com/owagner/onkyo2mqtt) - Interface between Onkyo AVR's EISCP network remote protocol and MQTT. Uses the onkyo-eiscp library.
...
* [mqttwarn ★543](https://github.com/jpmens/mqttwarn) - Subscribe to MQTT topics (with wildcards) and notifiy pluggable services.
...
* [mqtt-panel ★144](https://github.com/fabaff/mqtt-panel) - A web interface for MQTT.
...
* [Homie ★197](https://github.com/marvinroger/homie) - A lightweight MQTT convention for the IoT.
* [mqtt-smarthome ★94](https://github.com/mqtt-smarthome/mqtt-smarthome) - Smart home automation with MQTT as the central message bus - Architectural proposal.
