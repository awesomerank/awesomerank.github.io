...
<p align="center">
	This list is a copy of <a href="http://github.com/Urigo/awesome-meteor">Urigo/awesome-meteor</a> with ranks
</p>
---
# Awesome Meteor [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](https://github.com/sindresorhus/awesome)
...
* [dburles:collection-helpers ★483](https://github.com/dburles/meteor-collection-helpers) – Transform your collections with helpers that you define.
* [matb33:collection-hooks ★568](https://github.com/matb33/meteor-collection-hooks) - Extends Mongo.Collection with before/after hooks for insert/update/remove/find/findOne.
* [reywood:publish-composite ★487](https://github.com/englue/meteor-publish-composite) - publish a set of related documents from various collections using a reactive join
* [jagi:astronomy ★549](https://github.com/jagi/meteor-astronomy) - The Model layer for Meteor

## REST

*REST support for Meteor*

* [simple:rest ★319](https://github.com/stubailo/meteor-rest) - automatically make your Meteor app accessible over HTTP and DDP alike.
* [nimble:restivus ★504](https://github.com/kahmali/meteor-restivus) - Make REST endpoints for your Meteor app with incredible ease.

## Forms and Templates

*Helpers for templates*

* [aldeed:autoform ★1413](https://github.com/aldeed/meteor-autoform) - UI components and helpers to easily create basic forms with automatic insert and update events, and automatic reactive validation.
...
* [webix:webix ★341](https://github.com/dandv/meteor-webix) - Meteor.js - Webix UI integration

## Users and Authentication

*Tools for handling users and authentication*

* [alanning:roles ★824](https://github.com/alanning/meteor-roles) - Roles support for the built-in accounts packages.
...
* [meteorhacks:kadira ★189](https://github.com/meteorhacks/kadira) - Performance Monitoring for Meteor.
...
* [percolate:migrations ★194](https://github.com/percolatestudio/meteor-migrations) - Simple migration system for Meteor
* [meteorhacks:fast-render ★585](https://github.com/kadirahq/fast-render) - Render you app even before the DDP connection is live
* [meteorhacks:cluster ★633](https://github.com/meteorhacks/cluster) - Clustering solution for Meteor with load balancing and service discovery
* [yogiben:admin ★806](https://github.com/yogiben/meteor-admin) - A complete admin dashboard solution
...
* [houston:admin ★819](https://github.com/gterrono/houston) - A zero-config, Django Admin-like admin for Meteor
...
* [meteorhacks:flow-router ★1057](https://github.com/kadirahq/flow-router) - Client Side Router for Meteor.

## Offline

*Tools for Meteor offline support*

* [ground:db ★531](https://github.com/GroundMeteor/db) - GroundDB is a thin layer providing Meteor offline database and methods
...
* [xolvio:chimp ★631](https://github.com/xolvio/chimp) - Testing so easy, a primate could do it! Supports mocha, Cucumber, jasmine, and chai.
...
* [Meteor-CollectionFS ★1051](https://github.com/CollectionFS/Meteor-CollectionFS) - Meteor webbased filesystem handling up and downloads.
* [netanelgilad:excel ★49](https://github.com/netanelgilad/meteor-excel) - Parsing and generating excel files (xlsx, xls).
...
* [percolate:find-from-publication ★30](https://github.com/versolearning/find-from-publication) - Enable finding all documents that have been published by a given publication.
...
* [meteoric:ionic ★1587](https://github.com/meteoric/meteor-ionic) - Ionic components for Meteor.
* [driftyco:ionic ★29729](https://github.com/driftyco/ionic) - Official Ionic support for Meteor.
* [raix:push ★439](https://github.com/raix/push) - Push notifications for cordova (ios, android) browser (Chrome, Safari, Firefox).
...
* [delight-im/Android-DDP ★245](https://github.com/delight-im/Android-DDP) - DDP for clients on Android.
...
* [okgrow:analytics ★176](https://github.com/okgrow/analytics) - Google Analytics, Mixpanel, KISSmetrics (and more) integration for meteor.

## Cron Jobs

*Cron Jobs in Meteor*

* [percolate:synced-cron ★425](https://github.com/percolatestudio/meteor-synced-cron) - Cron system for Meteor. It supports syncronizing jobs between multiple processes.
* [vsivsi:job-collection ★341](https://github.com/vsivsi/meteor-job-collection) - A persistent and reactive job queue for Meteor, supporting distributed workers that can run anywhere.

## Debugging Tools

*Debugging Tools*

* [msavin:mongol ★806 ⏳1Y](https://github.com/msavin/Mongol) - Visual Editing Tool for Meteor for MongoDB Collections.
* [msavin:jetsetter ★186 ⏳1Y](https://github.com/msavin/JetSetter) - Visual Get/Set Tool for Meteor Session Variables.
...
* [iron-cli ★654](https://github.com/iron-meteor/iron-cli) - A scaffolding command line tool for Meteor applications 
* [Differential - meteor-boilerplate ★920 ⏳1Y](https://github.com/Differential/meteor-boilerplate)
* [matteodem - meteor-boilerplate ★843](https://github.com/matteodem/meteor-boilerplate)
* [meteoris2 ★269 ⏳1Y](https://github.com/radiegtya/meteoris2)
* [Base ★639](https://github.com/themeteorchef/base)

## Tooling

* [ESLint-plugin-Meteor ★87](https://github.com/dferber90/eslint-plugin-meteor) - ESLint plugin for Meteor
...
* [Microscope ★911](https://github.com/DiscoverMeteor/Microscope) - The Discover Meteor book's example app
* [Wekan ★9766](https://github.com/wekan/wekan) - Open source Trello-like kanban
* [Reaction Commerce ★4693](https://github.com/reactioncommerce/reaction) - Open source Commerce platform developed with Meteor
* [Crowducate Platform ★174](https://github.com/Crowducate/crowducate-platform) - Open source education platform Powered by meteor
...
* [Angular ★2168](https://github.com/Urigo/angular-meteor) - Working with Angular and Meteor
* [Angular 2 ★328](https://github.com/Urigo/angular2-meteor) - Working with Angular 2 and Meteor
...
* [frozeman:build-client ★212](https://github.com/frozeman/meteor-build-client) - A tool to bundle the client part of a Meteor app.
* [Asteroid ★679](https://github.com/mondora/asteroid) - An alternative client for a Meteor backend
* [ddp.js ★164](https://github.com/mondora/ddp.js) - Isomorphic JavaScript DDP client
...
* [numtel:pg ★306 ⏳1Y](https://github.com/numtel/meteor-pg) - Reactive PostgreSQL for Meteor
* [numtel:mysql ★330](https://github.com/numtel/meteor-mysql) - Reactive MySQL for Meteor
...
* [Meteor Learning ★1538](https://github.com/ericdouglas/Meteor-Learning) - List of resources to learn
