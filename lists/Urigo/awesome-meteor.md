...
---
# Awesome Meteor [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★62884](https://github.com/sindresorhus/awesome)
...
* [reywood:publish-composite ★499](https://github.com/englue/meteor-publish-composite) - publish a set of related documents from various collections using a reactive join
...
* [simple:rest ★323](https://github.com/stubailo/meteor-rest) - automatically make your Meteor app accessible over HTTP and DDP alike.
...
* [aldeed:template-extension ★210](https://github.com/aldeed/meteor-template-extension) - A Meteor package: Replace already defined templates, inherit helpers and events from other templates.
...
* [meteorhacks:kadira ★195](https://github.com/meteorhacks/kadira) - Performance Monitoring for Meteor.
...
* [percolate:migrations ★198](https://github.com/percolatestudio/meteor-migrations) - Simple migration system for Meteor
...
* [pm2-meteor ★118](https://github.com/andruschka/pm2-meteor) - Simplest way to deploy, scale and run Meteor Apps with PM2.
...
* [kadira:flow-router ★1070](https://github.com/kadirahq/flow-router) - Client Side Router for Meteor.
* [meteorhacks:picker ★155 ⏳1Y](https://github.com/meteorhacks/picker) - Server Side Router for Meteor.
...
* [xolvio:chimp ★664](https://github.com/xolvio/chimp) - Testing so easy, a primate could do it! Supports mocha, Cucumber, jasmine, and chai.
...
* [Meteor-CollectionFS ★1057](https://github.com/CollectionFS/Meteor-CollectionFS) - Meteor webbased filesystem handling up and downloads.
* [ostrio:files ★630](https://github.com/VeliovGroup/Meteor-Files) - Upload files via DDP, HTTP and WebRTC/DC. To Meteor server FS, AWS, GridFS, DropBox or Google Drive. Fast, secure and robust.
...
* [percolate:find-from-publication ★33 ⏳1Y](https://github.com/versolearning/find-from-publication) - Enable finding all documents that have been published by a given publication.
...
* [martijnwalraven:meteor-ios ★757 ⏳1Y](https://github.com/martijnwalraven/meteor-ios) - Integrates native iOS apps with the Meteor platform through DDP.
...
* [percolate:synced-cron ★434](https://github.com/percolatestudio/meteor-synced-cron) - Cron system for Meteor. It supports syncronizing jobs between multiple processes.
* [vsivsi:job-collection ★347](https://github.com/vsivsi/meteor-job-collection) - A persistent and reactive job queue for Meteor, supporting distributed workers that can run anywhere.
...
* [meteorhacks:npm ★544 ⏳1Y](https://github.com/meteorhacks/npm) - Use Npm Modules with Your Meteor App.
* [cosmos:browserify ★79 ⏳1Y](https://github.com/elidoran/cosmos-browserify) - Browserify npm modules for client side in Meteor packages.
...
* [Base ★656](https://github.com/themeteorchef/base)

## Tooling

* [ESLint-plugin-Meteor ★91](https://github.com/dferber90/eslint-plugin-meteor) - ESLint plugin for Meteor
...
## Open source apps
* [VulcanJS ★5985](https://github.com/VulcanJS/Vulcan) - A toolkit to quickly build apps with React, GraphQL & Meteor
* [Microscope ★916](https://github.com/DiscoverMeteor/Microscope) - The Discover Meteor book's example app
* [Wekan ★10115](https://github.com/wekan/wekan) - Open source Trello-like kanban
* [Reaction Commerce ★5221](https://github.com/reactioncommerce/reaction) - Open source Commerce platform developed with Meteor
...
* [Angular ★2211](https://github.com/Urigo/angular-meteor) - Working with Angular and Meteor
...
* [frozeman:build-client ★222](https://github.com/frozeman/meteor-build-client) - A tool to bundle the client part of a Meteor app.
* [Asteroid ★688](https://github.com/mondora/asteroid) - An alternative client for a Meteor backend
...
* [meteor-pg ★12](https://github.com/Richie765/meteor-pg) - New and improved PostgreSQL support for Meteor
* [numtel:pg ★306 ⏳2Y](https://github.com/numtel/meteor-pg) - Reactive PostgreSQL for Meteor
* [numtel:mysql ★333](https://github.com/numtel/meteor-mysql) - Reactive MySQL for Meteor
...
* [Meteor Learning ★1550](https://github.com/ericdouglas/Meteor-Learning) - List of resources to learn
...
* [Unofficial Meteor FAQ ★1011 ⏳2Y](https://github.com/oortcloud/unofficial-meteor-faq)
