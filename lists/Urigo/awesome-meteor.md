...
---
# Awesome Meteor [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★61331](https://github.com/sindresorhus/awesome)
...
* [aldeed:collection2 ★962](https://github.com/aldeed/meteor-collection2) - Automatic validation of insert and update operations on the client and server.
* [dburles:collection-helpers ★489](https://github.com/dburles/meteor-collection-helpers) – Transform your collections with helpers that you define.
* [matb33:collection-hooks ★570](https://github.com/matb33/meteor-collection-hooks) - Extends Mongo.Collection with before/after hooks for insert/update/remove/find/findOne.
* [reywood:publish-composite ★494](https://github.com/englue/meteor-publish-composite) - publish a set of related documents from various collections using a reactive join
* [jagi:astronomy ★559](https://github.com/jagi/meteor-astronomy) - The Model layer for Meteor

## REST

*REST support for Meteor*

* [simple:rest ★322](https://github.com/stubailo/meteor-rest) - automatically make your Meteor app accessible over HTTP and DDP alike.
* [nimble:restivus ★510](https://github.com/kahmali/meteor-restivus) - Make REST endpoints for your Meteor app with incredible ease.

## Forms and Templates

*Helpers for templates*

* [aldeed:autoform ★1417](https://github.com/aldeed/meteor-autoform) - UI components and helpers to easily create basic forms with automatic insert and update events, and automatic reactive validation.
...
* [themeteorites:blaze-magic-events ★22](https://github.com/themeteorites/blaze-magic-events) - A new way of binding event handlers to html elements for Meteor's Blaze
* [manuel:viewmodel ★206](https://github.com/ManuelDeLeon/viewmodel) - MVVM for Meteor
* [webix:webix ★340](https://github.com/dandv/meteor-webix) - Meteor.js - Webix UI integration

## Users and Authentication

*Tools for handling users and authentication*

* [alanning:roles ★828](https://github.com/alanning/meteor-roles) - Roles support for the built-in accounts packages.
...
* [meteorhacks:kadira ★192](https://github.com/meteorhacks/kadira) - Performance Monitoring for Meteor.
...
* [percolate:migrations ★195](https://github.com/percolatestudio/meteor-migrations) - Simple migration system for Meteor
...
* [yogiben:admin ★810](https://github.com/yogiben/meteor-admin) - A complete admin dashboard solution
...
* [iron:router ★2048](https://github.com/iron-meteor/iron-router) - A client and server side router designed specifically for Meteor.
* [meteorhacks:flow-router ★1066](https://github.com/kadirahq/flow-router) - Client Side Router for Meteor.

## Offline

*Tools for Meteor offline support*

* [ground:db ★534](https://github.com/GroundMeteor/db) - GroundDB is a thin layer providing Meteor offline database and methods
...
* [xolvio:chimp ★645](https://github.com/xolvio/chimp) - Testing so easy, a primate could do it! Supports mocha, Cucumber, jasmine, and chai.
...
* [Meteor-CollectionFS ★1053](https://github.com/CollectionFS/Meteor-CollectionFS) - Meteor webbased filesystem handling up and downloads.
...
* [tmeasday:publish-counts ★187](https://github.com/percolatestudio/publish-counts) - Publish the count of a cursor, in real time.
...
* [alethes:pages ★409](https://github.com/alethes/meteor-pages) - Out of the box Meteor pagination
...
* [meteoric:ionic ★1584](https://github.com/meteoric/meteor-ionic) - Ionic components for Meteor.
* [driftyco:ionic](https://github.com/driftyco/ionic) - Official Ionic support for Meteor.
* [raix:push ★444](https://github.com/raix/push) - Push notifications for cordova (ios, android) browser (Chrome, Safari, Firefox).
* [martijnwalraven:meteor-ios ★757](https://github.com/martijnwalraven/meteor-ios) - Integrates native iOS apps with the Meteor platform through DDP.
* [delight-im/Android-DDP ★244](https://github.com/delight-im/Android-DDP) - DDP for clients on Android.
...
* [okgrow:analytics ★180](https://github.com/okgrow/analytics) - Google Analytics, Mixpanel, KISSmetrics (and more) integration for meteor.

## Cron Jobs

*Cron Jobs in Meteor*

* [percolate:synced-cron ★428](https://github.com/percolatestudio/meteor-synced-cron) - Cron system for Meteor. It supports syncronizing jobs between multiple processes.
* [vsivsi:job-collection ★345](https://github.com/vsivsi/meteor-job-collection) - A persistent and reactive job queue for Meteor, supporting distributed workers that can run anywhere.

## Debugging Tools

*Debugging Tools*

* [msavin:mongol ★808](https://github.com/msavin/Mongol) - Visual Editing Tool for Meteor for MongoDB Collections.
* [msavin:jetsetter ★187 ⏳2Y](https://github.com/msavin/JetSetter) - Visual Get/Set Tool for Meteor Session Variables.
* [meteorhacks:kadira-debug ★158 ⏳1Y](https://github.com/kadirahq/meteor-debug) - Full Stack Debugging Solution for Meteor.
...
* [Differential - meteor-boilerplate ★921 ⏳1Y](https://github.com/Differential/meteor-boilerplate)
* [matteodem - meteor-boilerplate ★844](https://github.com/matteodem/meteor-boilerplate)
* [meteoris2 ★268 ⏳1Y](https://github.com/radiegtya/meteoris2)
* [Base ★650](https://github.com/themeteorchef/base)

## Tooling

* [ESLint-plugin-Meteor ★88](https://github.com/dferber90/eslint-plugin-meteor) - ESLint plugin for Meteor
...
* [Microscope ★914](https://github.com/DiscoverMeteor/Microscope) - The Discover Meteor book's example app
* [Wekan ★9930](https://github.com/wekan/wekan) - Open source Trello-like kanban
* [Reaction Commerce ★4940](https://github.com/reactioncommerce/reaction) - Open source Commerce platform developed with Meteor
* [Crowducate Platform ★175](https://github.com/Crowducate/crowducate-platform) - Open source education platform Powered by meteor
...
* [Angular ★2199](https://github.com/Urigo/angular-meteor) - Working with Angular and Meteor
* [Angular 2 ★327](https://github.com/Urigo/angular2-meteor) - Working with Angular 2 and Meteor
* [Famo.us ★349](https://github.com/gadicc/meteor-famous-views) - Famo.us and Meteor
* [Vue](https://github.com/Akryum/meteor-vue-component) - Working with Vue and Meteor (plus single-file components & apollo support)

* [frozeman:build-client ★217](https://github.com/frozeman/meteor-build-client) - A tool to bundle the client part of a Meteor app.
* [Asteroid ★685](https://github.com/mondora/asteroid) - An alternative client for a Meteor backend
* [ddp.js ★168](https://github.com/mondora/ddp.js) - Isomorphic JavaScript DDP client

## Alternative Databases

**Alternative Databases for MongoDB

* [meteor-pg ★11](https://github.com/Richie765/meteor-pg) - New and improved PostgreSQL support for Meteor
* [numtel:pg ★307 ⏳1Y](https://github.com/numtel/meteor-pg) - Reactive PostgreSQL for Meteor
* [numtel:mysql ★331](https://github.com/numtel/meteor-mysql) - Reactive MySQL for Meteor
* [simple:rethink ★310 ⏳1Y](https://github.com/Slava/meteor-rethinkdb) - RethinkDB integration for Meteor
...
* [Meteor Learning ★1545](https://github.com/ericdouglas/Meteor-Learning) - List of resources to learn
