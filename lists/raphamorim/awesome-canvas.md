...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python ★34408](vinta/awesome-python).
...
* [Cloth Effect](http://raphamorim.io/canvas-experiments/cloth) [[show me the code ★8 ⏳1Y](raphamorim/canvas-experiments)] • A cloth 3D effect fork.
* [Colorful Particles](http://raphamorim.io/canvas-experiments/particles) [[show me the code ★8 ⏳1Y](raphamorim/canvas-experiments)] • Experiment show how to generates random particles. Very simple code for assimilate.
...
* [Draw Table](http://raphamorim.io/canvas-experiments/draw) - [[show me the code ★8 ⏳1Y](raphamorim/canvas-experiments)] • A simple example about events using canvas.
...
* [Inception](http://raphamorim.io/canvas-experiments/inception) [[show me the code ★8 ⏳1Y](raphamorim/canvas-experiments)] • Generates a scrawl of a city, a canvas HTML5 experiment. Based on Inception movie 
...
* [Just Canvas](http://raphamorim.io/just-canvas/) [[show me the code ★12 ⏳2Y](raphamorim/just-canvas)]• This is a JavaScript experiment to capture movements. Just Dance Idea + HTML5 Canvas Implementation.
...
* [Raining Day](http://raphamorim.io/raining-day/) [[show me the code ★8 ⏳1Y](raphamorim/canvas-experiments)] • Raindrops using canvas. It's Neatnait Canvas Rain fork.
...
- [Origami.js ★609](raphamorim/origami.js) - JS Lib to redesign canvas API interface
- [Paper.js ★7850](paperjs/paper.js) - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
- [Sketch ★2626](soulwire/sketch.js) - Cross-Platform JavaScript Creative Coding Framework
...
- [Visualize ★348 ⏳2Y](filamentgroup/jQuery-Visualize) is a JQuery plugin who creates charts and graphs from tabular data using the HTML canvas element.


### For other purposes, but still use canvas
- [React Canvas ★10069](Flipboard/react-canvas) - High performance <canvas> rendering for React components.
...
* [@jeresig](https://twitter.com/jeresig) - Creator of [Processing.js ★1775](jeresig/processing-js)
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js ★33048](mrdoob/three.js)
* [@soulwire](https://twitter.com/soulwire) - Creator of [sketch.js ★2626](soulwire/sketch.js) and actively creating and sharing canvas/WebGL experiments
