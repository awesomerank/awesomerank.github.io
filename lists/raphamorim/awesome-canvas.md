...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python ★34408](https://github.com/vinta/awesome-python).
...
- [Origami.js ★609](https://github.com/raphamorim/origami.js) - JS Lib to redesign canvas API interface
- [Paper.js ★7850](https://github.com/paperjs/paper.js) - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
- [Sketch ★2626](https://github.com/soulwire/sketch.js) - Cross-Platform JavaScript Creative Coding Framework
...
- [React Canvas ★10069](https://github.com/Flipboard/react-canvas) - High performance <canvas> rendering for React components.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js ★33048](https://github.com/mrdoob/three.js)
* [@soulwire](https://twitter.com/soulwire) - Creator of [sketch.js ★2626](https://github.com/soulwire/sketch.js) and actively creating and sharing canvas/WebGL experiments
