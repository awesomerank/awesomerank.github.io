...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python ★37548](https://github.com/vinta/awesome-python).
...
- [d3 ★67281](https://github.com/d3/d3) (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
...
- [Konva ★1423](https://github.com/konvajs/konva) - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications. 
- [Origami.js ★623](https://github.com/raphamorim/origami.js) - JS Lib to redesign canvas API interface
- [Paper.js ★8132](https://github.com/paperjs/paper.js) - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js ★34678](https://github.com/mrdoob/three.js)
