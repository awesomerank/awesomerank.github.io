...
* [ag ★11963](https://github.com/ggreer/the_silver_searcher) - Super fast string search through a directory hierarchy
* [aliases ★55](https://github.com/sebglazebrook/aliases) - Contextual, dynamic, organized aliases for bash
...
* [borg ★1229](https://github.com/ok-borg/borg) - A terminal based search engine for bash commands
...
* [commacd ★177](https://github.com/shyiko/commacd) - A faster way to move around in Bash
* [desk ★1933](https://github.com/jamesob/desk) - A lightweight workspace manager for the shell
* [direnv ★2204](https://github.com/direnv/direnv) - An environment switcher for the shell, compare with autoenv
* [enhancd ★626](https://github.com/b4b4r07/enhancd) - :rocket: A next-generation cd command with an interactive filter
* [fasd ★3073](https://github.com/clvv/fasd) - Command-line productivity booster, offers quick access to files and directories
...
* [fzf ★8558](https://github.com/junegunn/fzf) - A command-line fuzzy finder
* [googler ★1560](https://github.com/jarun/googler) - Google Search, Google Site Search, Google News from the terminal
* [hhighlighter ★205](https://github.com/paoloantinori/hhighlighter) - Colorize words in a command output
* [hr ★998](https://github.com/LuRsT/hr) - `<hr />` for your terminal
* [hstr ★661](https://github.com/dvorka/hstr) - Bash History Suggest Box
* [k ★754](https://github.com/supercrabtree/k) - k is a Zsh script to make directory listings more readable, adding Git status, fileweight colors and rotting dates
* [k alias](https://github.com/lingtalfi/k) - get kool aliases (and more) working with a simple one-liner
* [marker ★578](https://github.com/pindexis/marker) - Bookmark your shell commands
...
* [base16-builder ★188](https://github.com/base16-builder/base16-builder) - Base16-Builder
* [bash-full-of-colors ★14](https://github.com/slomkowski/bash-full-of-colors) - Powerful prompt with screen, tmux, git support and many more
* [bash-git-prompt ★2940](https://github.com/magicmonty/bash-git-prompt) - An informative and fancy Bash prompt for Git users
* [bash-powerline ★406](https://github.com/riobard/bash-powerline) - Powerline-style Bash prompt in pure Bash script
* [bashstrap ★1440](https://github.com/barryclark/bashstrap) - A quick way to spruce up OSX terminal
...
* [mysql-colorize ★37](https://github.com/zpm-zsh/mysql-colorize) -  Colorization for mysql comand-line client
* [oh-my-git ★2458](https://github.com/arialdomartini/oh-my-git) - An opinionated git prompt for bash and zsh
* [sexy-bash-prompt ★742](https://github.com/twolfson/sexy-bash-prompt) - Bash prompt with colors, Git statuses, and Git branches
...
* [git-extra-commands ★160](https://github.com/unixorn/git-extra-commands) - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
* [git-extras ★9872](https://github.com/tj/git-extras) - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
* [git-open ★932](https://github.com/paulirish/git-open) - Type `git open` to open the GitHub page or website for a repository in your browser
* [git-semver ★103](https://github.com/markchalloner/git-semver) - Git plugin for easing semantic versioning and changelog validation
* [git-sh ★669](https://github.com/rtomayko/git-sh) - A customized Bash environment suitable for Git work
* [git-up ★2745](https://github.com/aanand/git-up) - Automatically rebase incoming changes instead of merging. Be polite!
* [hub ★10294](https://github.com/github/hub) - hub helps you win at git.
...
* [ccat ★1604](https://github.com/jingweno/ccat) - ccat is the colorizing cat. It works similar to cat but displays content with syntax highlighting.
* [colorex](https://bitbucket.org/linibou/colorex/wiki/Home) - Displays files or sdtin with pretty colors for matched patterns.
* [progress ★3262](https://github.com/Xfennec/progress) - Linux tool to show progress for cp, rm, dd, ...
* [glances ★7236](https://github.com/nicolargo/glances) - Glances an Eye on your system
* [goaccess ★5188](https://github.com/allinurl/goaccess) - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [histstat ★27](https://github.com/vesche/histstat) - History for netstat
...
* [aria2 ★5057](https://github.com/aria2/aria2) - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [balls ★660](https://github.com/jneen/balls) - Bash on Balls
* [bashttpd ★802](https://github.com/avleen/bashttpd) - A web server written in Bash
...
* [image-scraper ★339](https://github.com/sananth12/ImageScraper) - A cool command line image scraper with a lot of features.
* [imgp ★205](https://github.com/jarun/imgp) - Blazing fast batch image resizer and rotator
* [jq ★8692](https://github.com/stedolan/jq) - Sed for json data. You can use it to slice and filter and map and transform structured data
...
* [PiCAST ★1247](https://github.com/lanceseidman/PiCAST) - PiCAST turns your $35 Raspberry Pi in to a Chromecast like Device
* [sejda ★131](https://github.com/torakiki/sejda) - Command line manipulation of PDF documents (split, merge, rotate, convert to jpg, extract text, etc)
* [xidel ★60](https://github.com/benibela/xidel) - Cli tool to filter, map and create HTML/XML/JSON data with (Turing-complete) XPath and XQuery.
...
* [wego ★4825](https://github.com/schachmat/wego) - Weather app for the terminal
* [whereami ★41](https://github.com/rafaelrinaldi/whereami) - Get your geolocation information from the CLI

## Games

*All work and no play is a cruddy way to spend your day.*

* [bash2048 ★588](https://github.com/mydzor/bash2048) - Bash implementation of 2048 game
...
* [bash-it ★6114](https://github.com/Bash-it/bash-it) - A community Bash framework
* [basher ★263](https://github.com/basherpm/basher) - A package manager for shell scripts
* [bpkg](http://www.bpkg.io/) - JavaScript has npm, Ruby has Gems, Python has pip and now Shell has bpkg
* [dotfiler ★121](https://github.com/svetlyak40wt/dotfiler) – Shell agnostic git based dotfiles package manager, written in Python.
* [fresh ★778](https://github.com/freshshell/fresh) - Keep your dotfiles fresh
* [homeshick ★1039](https://github.com/andsens/homeshick) - Git dotfile synchronizer written in Bash
* [shundle ★61](https://github.com/chilicuil/shundle) - Plugin manager for shell scripts
* [vcsh ★1265](https://github.com/RichiH/vcsh) - Config manager based on Git
...
* [Fishtape ★206](https://github.com/fisherman/fishtape) - TAP producer and test harness for fish
* [composure ★200](https://github.com/erichs/composure) - Compose, document, version and organize your shell functions
...
* [is.sh ★33](https://github.com/qzb/is.sh) - An alternative for builtin test command, it will make your "if" statements pretty
* [lumberjack ★9](https://github.com/molovo/lumberjack) - A logging interface for shell scripts
* [mo ★116](https://github.com/tests-always-included/mo) - Mustache templates in pure bash
* [optparse ★82](https://github.com/nk412/optparse) - A BASH wrapper for getopts, for simple command line arguments.
* [rerun ★290](https://github.com/rerun/rerun) - A modular shell automation framework to organize your keeper scripts
* [revolver ★25](https://github.com/molovo/revolver) - A reusable progress spinner for shell scripts
* [semver_bash ★95](https://github.com/cloudflare/semver_bash) - Semantic Versioning in Bash
* [sh-semver] (https://github.com/qzb/sh-semver) - Semver tool for bash - finds versions matching to specified rules
* [shellcheck ★7081](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts
...
* [The Art of Command Line ★30436](https://github.com/jlevy/the-art-of-command-line)
* [Learn Enough Command Line to Be Dangerous](https://www.learnenough.com/command-line-tutorial)
* [A guide to learn bash ★7101](https://github.com/Idnan/bash-guide)

# Other Awesome Lists

Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) and [awesome-awesomeness ★18656](https://github.com/bayandin/awesome-awesomeness).

### See also
* [awesome-fish][awesome-fish]
* [awesome-zsh][awesome-zsh]
* [terminals-are-sexy ★4694](https://github.com/k4m4/terminals-are-sexy)
