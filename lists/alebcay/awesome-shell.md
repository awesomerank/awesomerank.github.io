...
* [autoenv ★3673](https://github.com/kennethreitz/autoenv) - Directory-based environments
* [autojump ★5993](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line
...
* [commacd ★190](https://github.com/shyiko/commacd) - A faster way to move around in Bash
* [desk ★2005](https://github.com/jamesob/desk) - A lightweight workspace manager for the shell
* [direnv ★2680](https://github.com/direnv/direnv) - An environment switcher for the shell, compare with autoenv
* [enhancd ★732](https://github.com/b4b4r07/enhancd) - :rocket: A next-generation cd command with an interactive filter
...
* [spark ★4912](https://github.com/holman/spark) - ▁▂▃▅▂▇ in your shell
* [Shark ★140](https://github.com/fisherman/shark) - ▁▂▃▅ Sparkline Generator
* [sheet ★223 ⏳4Y](https://github.com/oscardelben/sheet) -  Text snippets for the command line
* [spot ★628](https://github.com/rauchg/spot) - Tiny file search utility
- [snips ★21 ⏳1Y](https://github.com/srijanshetty/snips) - Commandline tool to manage snippets of code.
* [sshfs ★481](https://github.com/osxfuse/sshfs) - A tool for mounting remote file systems over SSH
* [sshrc ★3817](https://github.com/Russell91/sshrc) - Bring your .bashrc, .vimrc, etc. with you when you SSH
...
* [tldr ★130](https://github.com/raylee/tldr) - A fully-functional bash client for tldr, simplified and community-driven man pages
* [tmux](http://tmux.github.io/) - Amazing terminal multiplexer
* [up ★40](https://github.com/shannonmoeller/up) - Ascend directories by name or count; for bash, zsh, and fish.
* [v ★285 ⏳1Y](https://github.com/rupa/v) - z for vim.
* [wemux ★2827](https://github.com/zolrath/wemux) - Multi-User Tmux Made Easy
* [z ★7348](https://github.com/rupa/z) - z is the new j, yo

## Customization

*Custom prompts, color themes, etc.*

* [base16-builder ★216](https://github.com/base16-builder/base16-builder) - Base16-Builder
...
* [git-extras ★10566](https://github.com/tj/git-extras) - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
...
* [ccat ★1912](https://github.com/jingweno/ccat) - ccat is the colorizing cat. It works similar to cat but displays content with syntax highlighting.
* [colorex](https://bitbucket.org/linibou/colorex/wiki/Home) - Displays files or sdtin with pretty colors for matched patterns.
* [progress ★3460](https://github.com/Xfennec/progress) - Linux tool to show progress for cp, rm, dd, ...
* [glances ★8631](https://github.com/nicolargo/glances) - Glances an Eye on your system
* [goaccess ★5897](https://github.com/allinurl/goaccess) - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [histstat ★34](https://github.com/vesche/histstat) - History for netstat
* [htop ★2556](https://github.com/hishamhm/htop) - A ncurses based interactive process viewer which aims to be a better `top`
* [lnav](http://lnav.org) - An advanced log file viewer for the small-scale
* [ls++ ★341](https://github.com/trapd00r/ls--) - Colorized ls on steroids
* [lsp ★426 ⏳1Y](https://github.com/dborzov/lsp) - An improved `ls`, with file descriptions in plain language and intelligent file grouping
* [mtr ★732](https://github.com/traviscross/mtr) - The functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
* [ncdu](https://dev.yorhel.nl/ncdu) - NCurses Disk Usage
* [powertop ★269](https://github.com/fenrus75/powertop) - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
* [procdog ★45 ⏳2Y](https://github.com/jlevy/procdog) - Lightweight command-line control of long-lived processes like servers
* [quick-secure ★270 ⏳2Y](https://github.com/marshyski/quick-secure) - Quickly secure and harden UNIX/Linux systems

## Downloading and Serving

*Self-hosted, lightweight servers and networking tools written in shell scripts.*

* [aria2 ★6923](https://github.com/aria2/aria2) - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [balls ★675 ⏳1Y](https://github.com/jneen/balls) - Bash on Balls
...
* [cmus ★2271](https://github.com/cmus/cmus) - Cross-platform cli audio player.
...
* [xidel ★72](https://github.com/benibela/xidel) - Cli tool to filter, map and create HTML/XML/JSON data with (Turing-complete) XPath and XQuery.
...
* [bashblog ★622](https://github.com/cfenollosa/bashblog) - A Bash script that handles blog posting
* [choosealicense-cli ★34 ⏳1Y](https://github.com/lord63/choosealicense-cli) - Choose an OSS license from the comfort of your terminal
* [facebook-cli ★143](https://github.com/specious/facebook-cli) - Facebook command line tool
* [fanyi ★330](https://github.com/afc163/fanyi) - Translate English to Chinese in terminal
...
* [bash2048 ★600](https://github.com/mydzor/bash2048) - Bash implementation of 2048 game
* [minesweeper](https://github.com/feherke/Bash-script/tree/master/minesweeper) - Bash implementation of minesweeper
* [nudoku ★63](https://github.com/jubalh/nudoku) - ncurses based sudoku game written in C
* [sedtris ★234](https://github.com/uuner/sedtris) - Tetris in sed
* [sed-scripts ★26 ⏳4Y](https://github.com/aureliojargas/sed-scripts) - Arkanoid and Sokoban written using sed
* [tty-solitaire ★71](https://github.com/mpereira/tty-solitaire) - Play solitaire in your terminal!
...
* [basher ★292](https://github.com/basherpm/basher) - A package manager for shell scripts
* [bpkg](http://www.bpkg.sh/) - JavaScript has npm, Ruby has Gems, Python has pip and now Shell has bpkg
* [dotdrop ★63](https://github.com/deadc0de6/dotdrop) - Save your dotfiles once, deploy them everywhere
...
* [homeshick ★1116](https://github.com/andsens/homeshick) - Git dotfile synchronizer written in Bash
* [shundle ★60](https://github.com/javier-lopez/shundle) - Plugin manager for shell scripts
* [vcsh ★1311](https://github.com/RichiH/vcsh) - Config manager based on Git
...
* [ansi ★111](https://github.com/fidian/ansi) - ANSI escape codes in pure bash - change text color, position the cursor, much more
* [assert.sh ★314](https://github.com/lehmannro/assert.sh) - Bash unit testing framework
* [bashful ★342 ⏳1Y](https://github.com/jmcantrell/bashful) - A collection of libraries to simplify writing Bash scripts
* [bashmanager ★35 ⏳1Y](https://github.com/lingtalfi/bashmanager) - mini bash framework for creating command line tools
...
* [composure ★204](https://github.com/erichs/composure) - Compose, document, version and organize your shell functions
...
* [lumberjack ★12 ⏳1Y](https://github.com/molovo/lumberjack) - A logging interface for shell scripts
* [mo ★149](https://github.com/tests-always-included/mo) - Mustache templates in pure bash
* [optparse ★87](https://github.com/nk412/optparse) - A BASH wrapper for getopts, for simple command line arguments.
* [rerun ★311](https://github.com/rerun/rerun) - A modular shell automation framework to organize your keeper scripts
* [revolver ★40](https://github.com/molovo/revolver) - A reusable progress spinner for shell scripts
* [semver_bash ★107](https://github.com/cloudflare/semver_bash) - Semantic Versioning in Bash
* [sh-semver ★10](https://github.com/qzb/sh-semver) - Semver tool for bash - finds versions matching to specified rules
* [shellcheck ★9318](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts
* [shellfire ★1080 ⏳1Y](https://github.com/shellfire-dev/shellfire) -  A repository of namespaced, composable shell (bash, sh and dash) function libraries
...
* [The Art of Command Line ★31989](https://github.com/jlevy/the-art-of-command-line)
* [Learn Enough Command Line to Be Dangerous](https://www.learnenough.com/command-line-tutorial)
* [A guide to learn bash ★8057](https://github.com/Idnan/bash-guide)
...
* [awesome-cli-apps ★1297](https://github.com/agarrharr/awesome-cli-apps) 
