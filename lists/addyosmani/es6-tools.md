...
* [es6ify ★608](https://github.com/thlorenz/es6ify) - Traceur compiler wrapped as a [Browserify](http://browserify.org/) v2 transform
* [babelify ★1416](https://github.com/babel/babelify) - Babel transpiler wrapped as a [Browserify](http://browserify.org/) transform
...
* Facebook's [regenerator ★2004](https://github.com/facebook/regenerator) - transform ES6 yield/generator functions to ES5
* Facebook's [jstransform ★445 ⏳1Y](https://github.com/facebookarchive/jstransform) - A simple utility for pluggable JS syntax transforms. Comes with a small set of ES6 -> ES5 transforms
...
### Gulp Plugins
* Babel: [gulp-babel ★961](https://github.com/babel/gulp-babel)
...
* TypeScript: [gulp-typescript ★577](https://github.com/ivogabe/gulp-typescript)
...
* TypeScript: [grunt-ts ★263](https://github.com/TypeStrong/grunt-ts) - ES6+ > ES5/ES3 transpilation
...
## Webpack plugins
* Babel: [babel-loader ★2023](https://github.com/babel/babel-loader)
* Traceur: [traceur-compiler-loader ★5 ⏳2Y](https://github.com/gdi2290/traceur-compiler-loader)
* TypeScript: [awesome-typescript-loader ★993](https://github.com/s-panferov/awesome-typescript-loader)
...
## Browser plugins
* [Scratch JS ★330 ⏳1Y](https://github.com/richgilbank/Scratch-JS) - A Chrome/Opera DevTools extension to run ES6 on a page with either Babel or Traceur
...
* [Babel Module Loader ★2023](https://github.com/babel/babel-loader)
...
* [`Object.assign` ★669](https://github.com/sindresorhus/object-assign)
...
* [ES6 Symbol polyfill ★91](https://github.com/medikoo/es6-symbol)
...
* Grammar and transpilation [package ★332](https://github.com/gandm/language-babel)  for [Atom](https://atom.io/)
...
* [Esprima](http://esprima.org) - JavaScript parser supporting ES6, parses to [ESTree AST format ★1261](https://github.com/estree/estree)
...
* [Traceur compiler ★7381](https://github.com/google/traceur-compiler) also has built-in parser available under `traceur.syntax.Parser`.
...
* [let-er ★134 ⏳2Y](https://github.com/getify/let-er) - transpiles [let-block block-scoping](http://wiki.ecmascript.org/doku.php?id=proposals:block_expressions#let_statement) (not accepted into ES6) into either ES3 or ES6
...
* [Isparta ★637 ⏳1Y](https://github.com/douglasduteil/isparta)
