...
<p align="center">
	This list is a copy of <a href="https://github.com/addyosmani/es6-tools">https://github.com/addyosmani/es6-tools</a> with ranks
</p>
---
...
* [es6ify ★609 ⏳1Y](https://github.com/thlorenz/es6ify) - Traceur compiler wrapped as a [Browserify](http://browserify.org/) v2 transform
...
* Square's [es6-module-transpiler ★1227 ⏳1Y](https://github.com/esnext/es6-module-transpiler) - ES6 modules to AMD or CJS
...
* [Some Sweet.js macros ★221 ⏳2Y](https://github.com/jlongster/es6-macros) that compile from ES6 to ES5
...
* TypeScript: [broccoli-tsc ★1 ⏳1Y](https://github.com/ngParty/broccoli-tsc)
...
* TypeScript: [duo-typescript ★0 ⏳1Y](https://github.com/frankwallis/duo-typescript)
...
## Karma plugins
* Babel: [karma-babel-preprocessor ★136 ⏳1Y](https://github.com/babel/karma-babel-preprocessor)
...
## Mocha plugins
* [Mocha Traceur ★16 ⏳2Y](https://github.com/domenic/mocha-traceur) - A simple plugin for Mocha to pass JS files through the Traceur compiler
...
## Boilerplates
* [es6-boilerplate ★85 ⏳2Y](https://github.com/davidjnelson/es6-boilerplate) - Tooling to allow the community to use es6 now via traceur in conjunction with amd and browser global modules, with source maps, concatenation, minification, compression, and unit testing in real browsers.
...
* [`String.prototype.startsWith` ★68 ⏳2Y](https://github.com/mathiasbynens/String.prototype.startsWith)
...
* [`String.fromCodePoint` ★36 ⏳2Y](https://github.com/mathiasbynens/String.fromCodePoint)
...
* [es-dependency-graph](https://github.com/yahoo/es-dependency-graph) and [grunt-es-dependency-graph ★3 ⏳2Y](https://github.com/yahoo/grunt-es-dependency-graph) - Generate a list of imports and exports from ES6 module files, useful for preloading, bundling, etc.
...
* [let-er ★122 ⏳2Y](https://github.com/getify/let-er) - transpiles [let-block block-scoping](http://wiki.ecmascript.org/doku.php?id=proposals:block_expressions#let_statement) (not accepted into ES6) into either ES3 or ES6
