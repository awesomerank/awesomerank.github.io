...
---
# <img src="http://i.imgur.com/yy1sACZ.png" width="100px"/> ECMAScript 6 Tools [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★62884](https://github.com/sindresorhus/awesome)
...
* Facebook's [regenerator ★1996](https://github.com/facebook/regenerator) - transform ES6 yield/generator functions to ES5
* Facebook's [jstransform ★445](https://github.com/facebookarchive/jstransform) - A simple utility for pluggable JS syntax transforms. Comes with a small set of ES6 -> ES5 transforms
* [defs ★119 ⏳1Y](https://github.com/olov/defs) - ES6 block-scoped const and let variables to ES3 vars
...
* [regexpu ★114](https://github.com/mathiasbynens/regexpu) — Transform Unicode-aware ES6 regular expressions to ES5
* [Lebab](https://github.com/mohebifar/lebab) - Transformations for ES5 code to ES6 (approximates)

## Build-time transpilation

### Gulp Plugins
* Babel: [gulp-babel ★958](https://github.com/babel/gulp-babel)
* Traceur: [gulp-traceur ★179 ⏳1Y](https://github.com/sindresorhus/gulp-traceur)
...
* TypeScript: [gulp-typescript ★578](https://github.com/ivogabe/gulp-typescript)

### Grunt Tasks
* Babel: [grunt-babel ★365](https://github.com/babel/grunt-babel) - Turn ES6+ code into vanilla ES5 with no runtime
...
* TypeScript: [grunt-ts ★264](https://github.com/TypeStrong/grunt-ts) - ES6+ > ES5/ES3 transpilation

### Broccoli Plugins
* Babel: [broccoli-babel-transpiler ★44](https://github.com/babel/broccoli-babel-transpiler)
...
## Webpack plugins
* Babel: [babel-loader ★2010](https://github.com/babel/babel-loader)
* Traceur: [traceur-compiler-loader ★5 ⏳2Y](https://github.com/gdi2290/traceur-compiler-loader)
* TypeScript: [awesome-typescript-loader ★969](https://github.com/s-panferov/awesome-typescript-loader)
...
## Gobble plugins
* Babel: [gobble-babel ★7 ⏳1Y](https://github.com/babel/gobble-babel)
...
## Karma plugins
* Babel: [karma-babel-preprocessor ★141 ⏳1Y](https://github.com/babel/karma-babel-preprocessor)
* Traceur: [karma-traceur-preprocessor ★15 ⏳1Y](https://github.com/karma-runner/karma-traceur-preprocessor)
* TypeScript: [karma-typescript-preprocessor ★40](https://github.com/sergeyt/karma-typescript-preprocessor)
...
* TypeScript: [typescript-rails ★212](https://github.com/typescript-ruby/typescript-rails)

## Browser plugins
* [Scratch JS ★329 ⏳1Y](https://github.com/richgilbank/Scratch-JS) - A Chrome/Opera DevTools extension to run ES6 on a page with either Babel or Traceur
* [generator-typescript ★20](https://github.com/mrkev/generator-typescript) - Yeoman generator for TypeScript apps
...
* [Babel Module Loader ★2010](https://github.com/babel/babel-loader)
* [beck.js ★5 ⏳3Y](https://github.com/unscriptable/beck) - toolkit for ES6 Module Loader pipelines, shim for legacy environments

## Boilerplates
* [es6-boilerplate ★85 ⏳3Y](https://github.com/davidjnelson/es6-boilerplate) - Tooling to allow the community to use es6 now via traceur in conjunction with amd and browser global modules, with source maps, concatenation, minification, compression, and unit testing in real browsers.
* [es6-jspm-gulp-boilerplate ★147 ⏳1Y](https://github.com/alexweber/es6-jspm-gulp-boilerplate) - Tooling to allow the community to use es6 now via babel in conjunction jspm, with source maps, concatenation, minification, compression, and unit testing in real browsers using es6.
...
* [`Array.prototype.find` ★28](https://github.com/paulmillr/Array.prototype.find)
...
* [`Object.assign` ★664](https://github.com/sindresorhus/object-assign)
...
* [ES6 Symbol polyfill ★88](https://github.com/medikoo/es6-symbol)
* [ES6 Map, Set, WeakMap ★5 ⏳1Y](https://github.com/EliSnow/Blitz-Collections)
* [harmony-reflect ★343](https://github.com/tvcutsem/harmony-reflect) - ES6 [reflection module](http://wiki.ecmascript.org/doku.php?id=harmony:reflect_api) (contains the [Proxy API](http://soft.vub.ac.be/~tvcutsem/proxies/))
...
* Grammar and transpilation [package ★328](https://github.com/gandm/language-babel)  for [Atom](https://atom.io/)
...
* [Esprima](http://esprima.org) - JavaScript parser supporting ES6, parses to [ESTree AST format ★1255](https://github.com/estree/estree)
* [Acorn ★2649](https://github.com/ternjs/acorn) - A small, fast, JavaScript-based JavaScript parser with ES6 support, parses to [SpiderMonkey AST](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/SpiderMonkey/Parser_API) format.
* [esparse ★98](https://github.com/zenparsing/esparse) - ES6 parser written in ES6.
* [Traceur compiler ★7377](https://github.com/google/traceur-compiler) also has built-in parser available under `traceur.syntax.Parser`.
...
* [let-er ★133 ⏳2Y](https://github.com/getify/let-er) - transpiles [let-block block-scoping](http://wiki.ecmascript.org/doku.php?id=proposals:block_expressions#let_statement) (not accepted into ES6) into either ES3 or ES6
* [Recast](https://github.com/benjamn/recast) - Esprima-based JavaScript syntax tree transformer, conservative pretty-printer, and automatic source map generator. Used by several of the transpilers listed above, including [regenerator](https://github.com/facebook/regenerator) and [es6-arrow-function ★52 ⏳2Y](https://github.com/esnext/es6-arrow-function).
* [Paws on ES6 ★286](https://github.com/hemanth/paws-on-es6) -  Minimalist examples of ES6 functionalities.
...
* [Isparta ★636](https://github.com/douglasduteil/isparta)
