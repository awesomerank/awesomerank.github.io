...
* [babelify ★1462](https://github.com/babel/babelify) - Babel transpiler wrapped as a [Browserify](http://browserify.org/) transform
...
* Square's [es6-module-transpiler ★1233 ⏳2Y](https://github.com/esnext/es6-module-transpiler) - ES6 modules to AMD or CJS
* Facebook's [regenerator ★2123](https://github.com/facebook/regenerator) - transform ES6 yield/generator functions to ES5
* Facebook's [jstransform ★453 ⏳1Y](https://github.com/facebookarchive/jstransform) - A simple utility for pluggable JS syntax transforms. Comes with a small set of ES6 -> ES5 transforms
...
* [Some Sweet.js macros ★227 ⏳3Y](https://github.com/jlongster/es6-macros) that compile from ES6 to ES5
* Bitovi's [transpile ★20](https://github.com/stealjs/transpile) - Converts ES6 to AMD, CJS, and StealJS.
* [regexpu ★125](https://github.com/mathiasbynens/regexpu) — Transform Unicode-aware ES6 regular expressions to ES5
* [Lebab](https://github.com/mohebifar/lebab) - Transformations for ES5 code to ES6 (approximates)

## Build-time transpilation

### Gulp Plugins
* Babel: [gulp-babel ★1002](https://github.com/babel/gulp-babel)
...
* TypeScript: [gulp-typescript ★595](https://github.com/ivogabe/gulp-typescript)

### Grunt Tasks
* Babel: [grunt-babel ★380](https://github.com/babel/grunt-babel) - Turn ES6+ code into vanilla ES5 with no runtime
...
* TypeScript: [grunt-ts ★268](https://github.com/TypeStrong/grunt-ts) - ES6+ > ES5/ES3 transpilation
...
### Brunch Plugins
* Babel: [babel-brunch ★56](https://github.com/babel/babel-brunch)
...
## Webpack plugins
* Babel: [babel-loader ★2233](https://github.com/babel/babel-loader)
* Traceur: [traceur-compiler-loader ★5 ⏳2Y](https://github.com/gdi2290/traceur-compiler-loader)
* TypeScript: [awesome-typescript-loader ★1190](https://github.com/s-panferov/awesome-typescript-loader)
...
## Jest plugins
* Babel: [babel-jest ★124](https://github.com/babel/babel-jest)

## Karma plugins
* Babel: [karma-babel-preprocessor ★145](https://github.com/babel/karma-babel-preprocessor)
...
* TypeScript: [typescript-rails ★217 ⏳1Y](https://github.com/typescript-ruby/typescript-rails)

## Browser plugins
* [Scratch JS ★336](https://github.com/richgilbank/Scratch-JS) - A Chrome/Opera DevTools extension to run ES6 on a page with either Babel or Traceur
...
* [es6-jspm-gulp-boilerplate ★148 ⏳1Y](https://github.com/alexweber/es6-jspm-gulp-boilerplate) - Tooling to allow the community to use es6 now via babel in conjunction jspm, with source maps, concatenation, minification, compression, and unit testing in real browsers using es6.
...
* [`String.prototype.startsWith` ★87](https://github.com/mathiasbynens/String.prototype.startsWith)
* [`String.prototype.endsWith` ★22 ⏳3Y](https://github.com/mathiasbynens/String.prototype.endsWith)
* [`String.prototype.at` ★38 ⏳3Y](https://github.com/mathiasbynens/String.prototype.at)
* [`String.prototype.repeat` ★25 ⏳2Y](https://github.com/mathiasbynens/String.prototype.repeat)
* [`String.prototype.includes` ★58 ⏳2Y](https://github.com/mathiasbynens/String.prototype.includes)
* [`String.prototype.codePointAt` ★34 ⏳3Y](https://github.com/mathiasbynens/String.prototype.codePointAt)
* [`String.fromCodePoint` ★41 ⏳3Y](https://github.com/mathiasbynens/String.fromCodePoint)
...
* [`Object.assign` ★695](https://github.com/sindresorhus/object-assign)
...
* [ES6 Symbol polyfill ★102](https://github.com/medikoo/es6-symbol)
...
* ES6 syntax highlighting for [Sublime Text and TextMate ★3](https://github.com/Benvie/JavaScriptNext.tmLanguage)
...
* Grammar and transpilation [package ★368](https://github.com/gandm/language-babel)  for [Atom](https://atom.io/)
...
* [Esprima](http://esprima.org) - JavaScript parser supporting ES6, parses to [ESTree AST format ★1353](https://github.com/estree/estree)
...
* [looper ★17 ⏳4Y](https://github.com/wycats/looper) - static analysis tools for ES6
...
* [let-er ★144 ⏳3Y](https://github.com/getify/let-er) - transpiles [let-block block-scoping](http://wiki.ecmascript.org/doku.php?id=proposals:block_expressions#let_statement) (not accepted into ES6) into either ES3 or ES6
...
* [Paws on ES6 ★293](https://github.com/hemanth/paws-on-es6) -  Minimalist examples of ES6 functionalities.
