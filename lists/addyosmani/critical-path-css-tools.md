...
* [Penthouse ★1397](https://github.com/pocketjoso/penthouse) - by Jonas Ohlsson generates critical-path CSS
...
* [CriticalCSS ★913](https://github.com/filamentgroup/criticalcss) - by FilamentGroup finds & outputs critical CSS


## Server-side modules

* [mod_pagespeed ★359](https://github.com/pagespeed/mod_pagespeed) - Apache module for automatic PageSpeed optimization
* [ngx_pagespeed ★3406](https://github.com/pagespeed/ngx_pagespeed) - Nginx module for automatic PageSpeed optimization

## Grunt tasks

* [grunt-penthouse ★69](https://github.com/fatso83/grunt-penthouse)
* [grunt-critical-css ★540](https://github.com/filamentgroup/grunt-criticalcss)
* [grunt-critical ★103](https://github.com/bezoerb/grunt-critical)
...
* [gulp-inline-source ★151](https://github.com/fmal/gulp-inline-source) - by Filip Malinowski, replaces `<link>` tags with inline `<style>` tags, and replaces `<script src="">` tags with their inline content
...
* [isomorphic-style-loader](https://github.com/kriasoft/isomorphic-style-loader/) for Webpack - allows to extract critical CSS for any given page/screen in React apps and inline it into HTML during server-side rendering (SSR). See [React Starter Kit ★13688](https://github.com/kriasoft/react-starter-kit) as an example.
