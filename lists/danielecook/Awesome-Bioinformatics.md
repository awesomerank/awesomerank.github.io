...
---
Awesome Bioinformatics [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★63395](https://github.com/sindresorhus/awesome)
======================
...
* __[Bioinformatics One Liners ★584](https://github.com/stephenturner/oneliners)__ - Git repo of useful single line commands.
* __[CSVKit](https://github.com/onyxfish/csvkit)__ - Utilities for working with CSV/Tab-delimited files.
* __[csvtk ★170](https://github.com/shenwei356/csvtk)__ - Another cross-platform, efficient, practical and pretty CSV/TSV toolkit.
* __[easy_qsub ★11](https://github.com/shenwei356/easy_qsub)__ - Easily submitting PBS jobs with script template. Multiple input files supported.
...
* __[zindex ★434](https://github.com/mattgodbolt/zindex)__ - Create an index on a compressed text file.
...
* __[Awesome-Pipeline ★814](https://github.com/pditommaso/awesome-pipeline)__ - A list of pipeline resources.
...
* __[Cromwell ★153](https://github.com/broadinstitute/cromwell)__ - A Workflow Management System geared towards scientific workflows. 
...
* __[Fastqp ★39](https://github.com/mdshw5/fastqp)__ - FASTQ and SAM quality control using Python.
...
* __[Seqtk ★324](https://github.com/lh3/seqtk)__ - Toolkit for processing sequences in FASTA/Q formats.
* __[SeqKit ★129](https://github.com/shenwei356/seqkit)__ - A cross-platform and ultrafast toolkit for FASTA/Q file manipulation in Golang.
* __[seqmagick](http://seqmagick.readthedocs.org/en/latest/)__ - file format conversion in Biopython in a convenient way
* __[AfterQC ★57](https://github.com/OpenGene/AfterQC)__ - Automatic Filtering, Trimming, Error Removing and Quality Control for fastq data
...
* __[BWA ★440](https://github.com/lh3/bwa)__ - Burrow-Wheeler Aligner for pairwise alignment between DNA sequences.
...
* __[samtools/bcftools/htslib ★508](https://github.com/samtools/samtools)__ - A suite of tools for manipulating next-generation sequencing data.
* __[freebayes ★273](https://github.com/ekg/freebayes)__ - Bayesian haplotype-based polymorphism discovery and genotyping.
* __[GATK](https://software.broadinstitute.org/gatk/)__ - Variant Discovery in High-Throughput Sequencing Data.

### BAM File Utilities

* __[Bamtools ★213](https://github.com/pezmaster31/bamtools)__ - Collection of tools for working with BAM files.
...
* __[bcftools ★125](https://github.com/samtools/bcftools)__ - Set of tools for manipulating VCF files.
...
* __[Bedtools2 ★358](https://github.com/arq5x/bedtools2)__ - A Swiss Army knife for genome arithmetic.
...
* __[wgsim ★101 ⏳1Y](https://github.com/lh3/wgsim)__ - __Comes with samtools!__ - Reads simulator.
...
* __[pyensembl ★111](https://github.com/hammerlab/pyensembl)__ - Pythonic Access to the Ensembl database.
...
* __[pysam](https://github.com/pysam-developers/pysam)__ - Python wrapper for [samtools ★508](https://github.com/samtools/samtools).
* __[pyVCF ★230](https://github.com/jamescasbon/PyVCF)__ - A VCF Parser for Python.
* __[cyvcf](https://github.com/arq5x/cyvcf)__ - A port of [pyVCF ★230](https://github.com/jamescasbon/PyVCF) using Cython for speed.
* __[cyvcf2 ★74](https://github.com/brentp/cyvcf2)__ - Cython + HTSlib == fast VCF parsing; even faster parsing than pyVCF.
...
* [RNA-seq Analysis ★130](https://github.com/crazyhottommy/RNA-seq-analysis) - [@crazyhottommy](https://github.com/crazyhottommy)'s notes on various steps and considerations when doing RNA-seq analysis.

### ChIP-Seq

* [ChIP-seq analysis notes from Tommy Tang ★127](https://github.com/crazyhottommy/ChIP-seq-analysis) - Resources on ChIP-seq data which include papers, methods, links to software, and analysis.
...
* [The Leek group guide to genomics papers ★246](https://github.com/jtleek/genomicspapers) - Expertly curated genomics papers to get up to speed on genomics, RNA-seq, statistics (used in genomics), software development, and more.
