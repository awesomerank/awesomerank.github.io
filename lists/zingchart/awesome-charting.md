...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](https://github.com/sindresorhus/awesome) [![Build Status](https://travis-ci.org/zingchart/awesome-charting.svg?branch=master)](https://travis-ci.org/zingchart/awesome-charting)
...
* [Chartkick ★4301](https://github.com/ankane/chartkick) - JavaScript charts with one line of Ruby.
...
* [dygraphs ★2175](https://github.com/danvk/dygraphs) - Interactive zoomable time series charts.
* [ECharts ★18131](https://github.com/ecomfe/echarts) - A powerful charting and visualization library for browser.
* [EJSChart ★20 ⏳1Y](https://github.com/EmpriseCorporation/EJSCharts) - enterprise ready charting library.
* [Graphosaurus ★246](https://github.com/frewsxcv/graphosaurus) - 3D graph viewer powered by WebGL (three.js)
* [Morris.js](http://morrisjs.github.io/morris.js) - Simple API to render line, bar, area, and donut charts
* [Plotly ★6320](https://github.com/plotly/plotly.js) - Built on top of d3 and stack.gl, allowing users to create basic charts and SVG maps.
* [Plottable ★2103](https://github.com/palantir/plottable) - Library with OOP style syntax to build charts.
* [rgraph](http://www.rgraph.net/) - 2D/3D javascript charts with google sheets import capabilites.
* [sigma.js ★7238](https://github.com/jacomyal/sigma.js) - Graphs / Network diagram library built with canvas.
* [Smoothie Charts ★1618](https://github.com/joewalnes/smoothie) - JavaScript charts for realtime streaming data.
...
* [uvCharts ★226](https://github.com/imaginea/uvCharts) - JavaScript Charting library built using d3.js
...
* [n3-charts ★1206](https://github.com/n3-charts/line-chart) - Easy to use library written with AngularJS, rendering charts with D3.
...
### React
* [Formiddable ★4322](https://github.com/FormidableLabs/victory) - A collection of composable React components for building interactive data visualizations
* [react-d3 ★1587 ⏳1Y](https://github.com/esbullington/react-d3) - Charting library that relies on React for generating SVG markup and d3 to calculate path values.
