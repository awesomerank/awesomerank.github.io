...
**Table of Contents**  *generated with [DocToc ★1436](https://github.com/thlorenz/doctoc)*
...
### [antigen ★3326](https://github.com/zsh-users/antigen)
...
### [fresh ★804](https://github.com/freshshell/fresh)
...
### [zim ★880](https://github.com/Eriner/zim)
...
### [zplug ★1684](https://github.com/zplug/zplug)

**:hibiscus: Zplug** is a next-generation zsh plugin manager.

### [zplugin ★60](https://github.com/zdharma/zplugin)
...
**ZPM** ( Zsh plugin manager ) is a plugin manager for [zsh](http://www.zsh.org/) similar to vim-plug. ZPM plugins are compatible with [oh-my-zsh ★57192](https://github.com/robbyrussell/oh-my-zsh). ZPM runs on Linux, Android, FreeBSD and OS X.
...
* [ansiweather ★1287](https://github.com/fcambus/ansiweather) - Weather in your terminal, with ANSI colors and Unicode symbols.
...
* [anyframe ★108](https://github.com/mollifier/anyframe) - A peco/percol/fzf wrapper plugin for zsh.
...
* [autojump ★5723](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line. Install autojump-zsh for best results.
...
* [blackbox ★3593](https://github.com/StackExchange/blackbox) - Stack Exchange's toolkit for storing keys/credentials securely in a git repository.
...
* [emoji-cli ★145](https://github.com/b4b4r07/emoji-cli) - :scream: Emoji completion on the command line.
* [enhancd ★691](https://github.com/b4b4r07/enhancd) - A simple tool that provides enhanced `cd` command.
...
* [git-secret ★573](https://github.com/sobolevn/git-secret) - A bash-tool to store your private data inside a git repository.
...
* [gtm-terminal-plugin ★4](https://github.com/git-time-metric/gtm-terminal-plugin) - terminal plugin for [git time metrics](https://github.com/git-time-metric/gtm/blob/master/README.md).
* [hipchat ★14 ⏳1Y](https://github.com/robertzk/hipchat.zsh) - Send hipchat messages from the shell.
* [history-search-multi-word ★48](https://github.com/zdharma/history-search-multi-word) - syntax highlighted, multi-word history searcher for Zsh, bound to Ctrl-R, with advanced functions (e.g. bump of history entry to top of history).
* [history-sync ★19](https://github.com/wulfgarpro/history-sync) - An Oh My Zsh plugin for GPG encrypted, Internet synchronized Zsh history using Git.
...
* [tipz](https://github.com/molovo/tipz) - Displays your alias if you have an alias for the command you just ran (Similar to [alias-tips ★185](https://github.com/djui/alias-tips))
* [tsm ★6](https://github.com/RobertAudi/tsm) - Adds a tmux Session Manager.
* [tumult ★43](https://github.com/unixorn/tumult.plugin.zsh) - Adds tools for OS X.
...
* [vimman ★9 ⏳3Y](https://github.com/yonchu/vimman) - View vim plugin manuals (help) like man in zsh.
...
* [warhol](https://github.com/unixorn/warhol.plugin.zsh) - Configures colorization with [grc ★371](https://github.com/garabik/grc).
* [watson.zsh](https://github.com/bcho/Watson.zsh) - A plugin for [watson ★743](https://github.com/TailorDev/Watson).
...
* [zaw ★372](https://github.com/zsh-users/zaw) - ZSH anything.el-like widget.
...
* [zsh-async ★146](https://github.com/mafredri/zsh-async) - Library for running asynchronous tasks in zsh without requiring any external tools.
* [zsh-autoenv ★240](https://github.com/Tarrasch/zsh-autoenv) - If a directory contains a .env file, it will automatically be executed when you cd into it.
* [zsh-autopair ★52](https://github.com/hlissner/zsh-autopair) - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters.
* [zsh-autosuggestions ★3171](https://github.com/zsh-users/zsh-autosuggestions) - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for zsh.
...
* [zsh-history-substring-search ★604](https://github.com/zsh-users/zsh-history-substring-search) - Needs to be loaded after zsh-syntax-highlighting, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
...
* [zsh-iterm-touchbar ★98](https://github.com/iam4x/zsh-iterm-touchbar) - Display iTerm2 feedback in the MacbookPro TouchBar (Current directory, git branch & status)
...
* [zsh-navigation-tools ★141](https://github.com/psprint/zsh-navigation-tools) - Adds `htop`-like `kill`, directory bookmarks browser, multi-word incremental history searcher and more.
* [zsh-notify ★193](https://github.com/marzocchi/zsh-notify) - A plugin for the Z shell (on OS X and Linux) that posts desktop notifications when a command terminates with a non-zero exit status or when it took more than 30 seconds to complete, if the terminal application is in the background (or the command's terminal tab is inactive).
* [zsh-nvm ★285](https://github.com/lukechilds/zsh-nvm) - Zsh plugin for installing, updating and loading nvm.
...
* [zsh-syntax-highlighting ★3837](https://github.com/zsh-users/zsh-syntax-highlighting) - Add syntax highlighting to your zsh. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
...
* [docker-enter-completion](https://github.com/primait/docker-enter-completion) - Command completion for [docker-enter ★1765 ⏳1Y](https://github.com/jpetazzo/nsenter).
...
* [gcloud-zsh-completion ★42 ⏳2Y](https://github.com/littleq0903/gcloud-zsh-completion) - Add completions for the Google Cloud SDK.
...
* [git-flow-completion ★1864 ⏳1Y](https://github.com/bobthecow/git-flow-completion) - ZSH completion support for git-flow.
...
* [newman](https://github.com/selop/newman-autocomplete) - Provides autocompletion for the [Newman CLI ★1927](https://github.com/postmanlabs/newman).
...
* [agnosterAfro](https://github.com/afrozalm/agnosterAfro) - Based on [Powerline](https://github.com/Lokaltog/vim-powerline) and [Agnoster Theme](https://gist.github.com/agnoster/3712874) and inspired by the [agnosterzak ★92](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme).
* [agnosterzak ★92](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme) - Based on Agnoster, shows battery life, date & time, git status, current directory and user & host information.
...
* [bklyn](https://github.com/gporrata/bklyn-zsh) - Variant of [Powerlevel9k ★2455](https://github.com/bhilburn/powerlevel9k) with customizations applied.
...
* [bronze](https://github.com/reujab/bronze) - A cross-shell customizable powerline-like prompt with icons written in go. Requires [nerd-fonts ★4981](https://github.com/ryanoasis/nerd-fonts).
...
* [cobalt2 ★560](https://github.com/wesbos/Cobalt2-iterm) - Wes Bos' Cobalt 2 theme for ZSH and iTerm 2.
...
* [garrett ★93](https://github.com/chauncey-garrett/zsh-prompt-garrett) - Prezto prompt with the information you need the moment you need it.
...
* [gitsome](https://github.com/mtully/gitsome) - Super simple prompt with git info, optimized for the [Flat Terminal ★518 ⏳4Y](https://github.com/ahmetsulek/flat-terminal) color scheme.
...
* [hackersaurus](https://github.com/bhilburn/hackersaurus) - A theme with git status and exit code of last command run embedded in the prompt. Related to [powerlevel9k ★2455](https://github.com/bhilburn/powerlevel9k).
...
* [honukai-iterm-zsh ★810](https://github.com/oskarkrawczyk/honukai-iterm-zsh) - Honukai theme and colors for oh-my-zsh and iTerm.
...
* [hyperzsh ★193](https://github.com/tylerreckart/hyperzsh) - Gives you a comprehensive overview of the branch you're working on and the status of your repository without cluttering your terminal.
...
* [liquidprompt ★3148](https://github.com/nojhan/liquidprompt) - A full-featured & carefully designed adaptive prompt for Bash & ZSH.
...
* [neat](https://github.com/andrepolischuk/neat) - Minimalistic prompt inspired by [odin](https://github.com/tylerreckart/Odin) and [pure ★3668](https://github.com/sindresorhus/pure).
...
* [oh-my-git ★2554](https://github.com/arialdomartini/oh-my-git) - An opinionated prompt for bash and zsh.
...
* [oh-my-zsh-node-theme ★29 ⏳1Y](https://github.com/skuridin/oh-my-zsh-node-theme) - OMZ's node theme.
...
* [phi φ](https://github.com/LasaleFamine/phi-zsh-theme) - A clean and simple theme for ZSH inspired and forked from [Lambda (Mod) ZSH Theme ★264](https://github.com/halfo/lambda-mod-zsh-theme).
* [plain ★0](https://github.com/jimeh/plain.zsh-theme) - A plain and simple theme for ZSH which shows basic git information.
* [planet](https://github.com/aphlor/planet-zsh) - A slimmed down version of [steef](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/steeef.zsh-theme) from [oh-my-zsh ★57192](https://github.com/robbyrussell/oh-my-zsh).
...
* [powerlevel9k ★2455](https://github.com/bhilburn/powerlevel9k) - A very flexible theme based on the well-known agnoster-theme with support for various VCS, AWS, rbenv, virtualenv, etc.
...
* [powerline-shell](https://github.com/banga/powerline-shell) - A [powerline ★2815 ⏳4Y](https://github.com/Lokaltog/vim-powerline)-like prompt for Bash, ZSH and Fish. Shows important details about git/svn/hg/fossil branch and is easy to customize/extend.
...
* [punctual](https://github.com/dannynimmo/punctual-zsh-theme) - Easily customizable, influenced by [spaceship ★1316](https://github.com/denysdovhan/spaceship-zsh-theme).
* [pure ★3668](https://github.com/sindresorhus/pure) - Pretty, minimal and fast ZSH prompt.
...
* [shellder ★133](https://github.com/simnalamburt/shellder) - Minimal theme with git branch display. Requires a powerline font.
...
* [statusline ★36](https://github.com/el1t/statusline) - A responsive zsh theme that provides informational segments when you need them.
...
* [sugarfree](https://github.com/cbrock/sugar-free) - Based on the [Pure ★3668](https://github.com/sindresorhus/pure) and [Candy](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/candy.zsh-theme) themes.
...
* [wild-cherry ★286](https://github.com/mashaal/wild-cherry) - A fairy-tale inspired theme for Zsh, iTerm, Sublime, Atom, & Mou.
...
* [Awesome Terminal Fonts ★992](https://github.com/gabrielelana/awesome-terminal-fonts) - A family of fonts that includes some nice monospaced Icons.
...
* [Fantasque-sans ★3225](https://github.com/belluzj/fantasque-sans) - Another powerline font.
...
* [awesome-devenv ★841](https://github.com/jondot/awesome-devenv) - A curated list of awesome tools, resources and workflow tips making an awesome development environment
