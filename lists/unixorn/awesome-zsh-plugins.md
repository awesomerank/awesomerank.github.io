...
### [alf ★31 ⏳1Y](https://github.com/psyrendust/alf)
...
### [ansible-role-zsh ★40](https://github.com/viasite-ansible/ansible-role-zsh)
...
### [antigen-hs ★168](https://github.com/Tarrasch/antigen-hs)
...
### [antigen ★3227](https://github.com/zsh-users/antigen)
...
### [dotzsh ★131](https://github.com/dotphiles/dotzsh)

**Dotzsh** strives to be platform and version independent. Some functionality may be lost when running under older versions of zsh, but it should degrade cleanly and allow you to use the same setup on multiple machines of differing OSes without problems.

### [fresh ★790](https://github.com/freshshell/fresh)
...
### [prezto ★7704](https://github.com/sorin-ionescu/prezto)
...
### [zgen ★756](https://github.com/tarjoilija/zgen)
...
### [zim ★854](https://github.com/Eriner/zim)
...
### [zplug ★1621](https://github.com/zplug/zplug)

**:hibiscus: Zplug** is a next-generation zsh plugin manager.

### [zplugin ★57](https://github.com/zdharma/zplugin)
...
**ZPM** ( Zsh plugin manager ) is a plugin manager for [zsh](http://www.zsh.org/) similar to vim-plug. ZPM plugins are compatible with [oh-my-zsh ★55581](https://github.com/robbyrussell/oh-my-zsh). ZPM runs on Linux, Android, FreeBSD and OS X.

### [ZR ★17](https://github.com/jedahan/zr)

**ZR** is a zsh plugin manager written in Rust.

### [ztanesh ★238](https://github.com/miohtama/ztanesh)

**Ztanesh** aims to improve your UNIX command line experience and productivity with the the configuration provided by the ztanesh project: the tools will make your shell more powerful and easier to use.

### [zulu ★48](https://github.com/zulu-zsh/zulu)
...
* [ZSH Pony ★82 ⏳6Y](https://github.com/mika/zsh-pony) - Covers customizing ZSH without a framework.
...
* [ansiweather ★1286](https://github.com/fcambus/ansiweather) - Weather in your terminal, with ANSI colors and Unicode symbols.
...
* [anyframe ★107](https://github.com/mollifier/anyframe) - A peco/percol/fzf wrapper plugin for zsh.
...
* [auto-ls ★4](https://github.com/desyncr/auto-ls) - Automatically `ls` when cding to a new directory.
* [autoenv](https://github.com/horosgrisa/autoenv) - Extended version of the zsh-autoenv plugin.
* [autojump ★5612](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line. Install autojump-zsh for best results.
* [autoupdate-antigen.zshplugin ★11 ⏳2Y](https://github.com/unixorn/autoupdate-antigen.zshplugin) - Antigen doesn't do automatic updates like oh-my-zsh. This plugin adds auto updating for antigen, both of antigen and the bundles loaded in your configuration.
...
* [blackbox ★3527](https://github.com/StackExchange/blackbox) - Stack Exchange's toolkit for storing keys/credentials securely in a git repository.
...
* [calc.plugin.zsh ★28 ⏳1Y](https://github.com/arzzen/calc.plugin.zsh) - A calculator for zsh.
* [caniuse.plugin.zsh ★11](https://github.com/walesmd/caniuse.plugin.zsh) - Add [Can I Use...](https://caniuse.com) support to ZSH.
* [cd-gitroot ★24 ⏳1Y](https://github.com/mollifier/cd-gitroot) - A zsh plugin to cd to the git repository root directory.
...
* [deer ★191 ⏳1Y](https://github.com/Vifon/deer) - A file navigator for zsh heavily inspired by [ranger](http://ranger.nongnu.org/).
...
* [docker-compose ★23 ⏳1Y](https://github.com/sroze/docker-compose-zsh-plugin) Show docker container status in your prompt.
...
* [elixir-oh-my-zsh ★78](https://github.com/gusaiani/elixir-oh-my-zsh) - Adds shortcuts for Elixir, IEX, Mix and Phoenix.
* [emoji-cli ★139](https://github.com/b4b4r07/emoji-cli) - :scream: Emoji completion on the command line.
* [enhancd ★664](https://github.com/b4b4r07/enhancd) - A simple tool that provides enhanced `cd` command.
...
* [fast-syntax-highlighting ★82](https://github.com/zdharma/fast-syntax-highlighting) - Optimized an improved `zsh-users/zsh-syntax-highlighting` – better response times, `zed/vared` can edit `10 kB` functions.
...
* [fzf-marks](https://github.com/uvaes/fzf-marks) - Little script to create, navigate and delete bookmarks in Bash and Zsh, using the fuzzy finder [fzf ★9412](https://github.com/junegunn/fzf).
* [fzf-widgets](https://github.com/ytet5uy4/fzf-widgets) - Adds some ZLE widgets for [fzf ★9412](https://github.com/junegunn/fzf).
...
* [git-extra-commands ★170](https://github.com/unixorn/git-extra-commands) - Extra git helper scripts packaged as a plugin.
...
* [git-secret ★543](https://github.com/sobolevn/git-secret) - A bash-tool to store your private data inside a git repository.
...
* [history-search-multi-word ★44](https://github.com/zdharma/history-search-multi-word) - syntax highlighted, multi-word history searcher for Zsh, bound to Ctrl-R, with advanced functions (e.g. bump of history entry to top of history).
* [history-sync ★17](https://github.com/wulfgarpro/history-sync) - An Oh My Zsh plugin for GPG encrypted, Internet synchronized Zsh history using Git.
...
* [noreallyjustfuckingstopalready ★264 ⏳1Y](https://github.com/eventi/noreallyjustfuckingstopalready) - OS X users know the pain of trying to figure out what command actually flushes the DNS cache on their version of OS X, and this plugin makes that annoyance go away.
...
* [nvm-auto ★9](https://github.com/dijitalmunky/nvm-auto) - Aims to alleviate needing to type `nvm use` as much as possible, especially if you often switch between versions of node.js and use `.nvmrc` files in your project to manage what version of node your project needs.
...
* [phpcs.plugin.zsh](https://github.com/voronkovich/phpcs.plugin.zsh) - Plugin for [PHP code sniffer ★3620](https://github.com/squizlabs/PHP_CodeSniffer).
...
* [revolver ★29](https://github.com/molovo/revolver) - A progress spinner for ZSH scripts.
...
* [snippets ★17 ⏳1Y](https://github.com/willghatch/zsh-snippets) - Command line snippet expansion.
...
* [sysadmin-util ★416 ⏳1Y](https://github.com/skx/sysadmin-util) - Steve Kemp's collection of tool scripts for sysadmins.
...
* [tipz](https://github.com/molovo/tipz) - Displays your alias if you have an alias for the command you just ran (Similar to [alias-tips ★171](https://github.com/djui/alias-tips))
* [tsm ★5](https://github.com/RobertAudi/tsm) - Adds a tmux Session Manager.
* [tumult ★42](https://github.com/unixorn/tumult.plugin.zsh) - Adds tools for OS X.
...
* [warhol](https://github.com/unixorn/warhol.plugin.zsh) - Configures colorization with [grc ★353](https://github.com/garabik/grc).
* [watson.zsh](https://github.com/bcho/Watson.zsh) - A plugin for [watson ★619](https://github.com/TailorDev/Watson).
* [wd ★164](https://github.com/mfaerevaag/wd) - Warp directory lets you jump to custom directories in zsh, without using cd. Why? Because cd seems inefficient when the folder is frequently visited or has a long path.
...
* [zaw ★369](https://github.com/zsh-users/zaw) - ZSH anything.el-like widget.
...
* [zsh-256color ★34 ⏳1Y](https://github.com/chrissicool/zsh-256color) - Enhances the terminal environment with 256 colors. It looks at the chosen TERM environment variable and sees if there is respective ncurses' terminfo with 256 colors available. The result is a multicolor terminal, if available.
...
* [zsh-async ★140](https://github.com/mafredri/zsh-async) - Library for running asynchronous tasks in zsh without requiring any external tools.
* [zsh-autoenv ★228](https://github.com/Tarrasch/zsh-autoenv) - If a directory contains a .env file, it will automatically be executed when you cd into it.
* [zsh-autopair ★51](https://github.com/hlissner/zsh-autopair) - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters.
* [zsh-autosuggestions ★2950](https://github.com/zsh-users/zsh-autosuggestions) - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for zsh.
...
* [zsh-bd ★221 ⏳1Y](https://github.com/Tarrasch/zsh-bd) - Jump back to a specific directory, without doing `cd ../../..`.
* [zsh-carthage](https://github.com/cfdrake/zsh-carthage) - Provides completions and aliases for use with [Carthage ★9703](https://github.com/Carthage/Carthage)
...
* [zsh-completion-generator ★61](https://github.com/RobSis/zsh-completion-generator) - This plugin tries to read the list of options from the help text of programs and generate a completion function automatically. Note that this doesn't do it automatically, you have to explicitly call the generator.
* [zsh-dircolors-solarized ★23](https://github.com/joel-porquet/zsh-dircolors-solarized) - Solarized dircolors plugin.
...
* [zsh-functional ★73 ⏳2Y](https://github.com/Tarrasch/zsh-functional) - ZSH higher order functions.
...
* [zsh-histdb ★23](https://github.com/larkery/zsh-histdb) - Stores your history in an SQLite database.
* [zsh-history-substring-search ★596](https://github.com/zsh-users/zsh-history-substring-search) - Needs to be loaded after zsh-syntax-highlighting, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
* [zsh-history ★39](https://github.com/b4b4r07/zsh-history) - Extend history so that it can be queried by SQL.
* [zsh-interactive-cd ★45](https://github.com/changyuheng/zsh-interactive-cd) - Fish like interactive tab completion for `cd`.
* [zsh-iterm-touchbar ★83](https://github.com/iam4x/zsh-iterm-touchbar) - Display iTerm2 feedback in the MacbookPro TouchBar (Current directory, git branch & status)
...
* [zsh-mercurial ★1](https://github.com/hcgraf/zsh-mercurial) - extracted from oh-my-zsh so you can use it without omz.
...
* [zsh-navigation-tools ★137](https://github.com/psprint/zsh-navigation-tools) - Adds `htop`-like `kill`, directory bookmarks browser, multi-word incremental history searcher and more.
* [zsh-notify ★188](https://github.com/marzocchi/zsh-notify) - A plugin for the Z shell (on OS X and Linux) that posts desktop notifications when a command terminates with a non-zero exit status or when it took more than 30 seconds to complete, if the terminal application is in the background (or the command's terminal tab is inactive).
* [zsh-nvm ★272](https://github.com/lukechilds/zsh-nvm) - Zsh plugin for installing, updating and loading nvm.
...
* [zsh-peco-history ★12](https://github.com/jimeh/zsh-peco-history) - Search shell history with Peco when pressing ctrl+r.
...
* [zsh-syntax-highlighting-filetypes ★57 ⏳3Y](https://github.com/trapd00r/zsh-syntax-highlighting-filetypes) - zsh syntax highlighting with dircolors in realtime.
* [zsh-syntax-highlighting ★3714](https://github.com/zsh-users/zsh-syntax-highlighting) - Add syntax highlighting to your zsh. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
...
* [zsh-tmux-simple ★2](https://github.com/TBSliver/zsh-plugin-tmux-simple) - Simple plugin for using tmux with zsh.
...
* [zsh-you-should-use ★93](https://github.com/MichaelAquilina/zsh-you-should-use)- ZSH plugin that reminds you to use those aliases you defined
* [zshmarks ★124](https://github.com/jocelynmallon/zshmarks) - A port of Bashmarks (by Todd Werth), a simple command line bookmarking plugin, for oh-my-zsh.
...
* [ZUI ★14](https://github.com/zdharma/zui) - Zsh User Interface library – CGI+DHTML-like rapid TUI application development with Zsh.
...
* [docker-enter-completion](https://github.com/primait/docker-enter-completion) - Command completion for [docker-enter ★1737](https://github.com/jpetazzo/nsenter).
* [docker-zsh-completion ★200](https://github.com/felixr/docker-zsh-completion) - Add completions for docker.
* [dropbox](https://github.com/horosgrisa/zsh-dropbox) - A dropbox plugin for Zsh that provides `dropbox-cli` and `dropbox-uploader` commands.
...
* [git-annex-completion ★14](https://github.com/Schnouki/git-annex-zsh-completion) - Allows tab completion for most git-annex commands
* [git-flow-completion ★1836 ⏳1Y](https://github.com/bobthecow/git-flow-completion) - ZSH completion support for git-flow.
...
* [gulp ★30 ⏳1Y](https://github.com/akoenig/gulp.plugin.zsh) - Autocompletion for your gulp.js tasks in the Z-Shell (zsh).
* [jumpstorm-zsh-plugin](https://github.com/netresearch/jumpstorm-zsh-plugin) - Adds autocompletion for [jumpstorm ★44 ⏳4Y](https://github.com/netresearch/jumpstorm)
* [keybase ★6 ⏳1Y](https://github.com/rbirnie/oh-my-zsh-keybase) - Completions for [keybase](https://keybase.io/docs/command_line).
* [newman](https://github.com/selop/newman-autocomplete) - Provides autocompletion for the [Newman CLI ★1854](https://github.com/postmanlabs/newman).
* [nix-zsh-completions ★32](https://github.com/spwhitt/nix-zsh-completions) - Completions for [nix](https://nixos.org/nix/), [NixOS](https://nixos.org/), and [NixOps](http://nixos.org/nixops/).
...
* [zsh-better-npm-completion ★62](https://github.com/lukechilds/zsh-better-npm-completion) - Better completion for `npm`.
* [zsh-cabal-completion ★0 ⏳2Y](https://github.com/ehamberg/zsh-cabal-completion) - Add tab completion for cabal.
* [zsh-completions ★1639](https://github.com/zsh-users/zsh-completions) - A collection of extra completions for ZSH.
...
If you're using [Antigen](https://github.com/zsh-users/antigen), you can test these themes in a running zsh with `antigen theme githubuser/repo`. If you're using [zgen ★756](https://github.com/tarjoilija/zgen), add them to your `init.zsh` with `zgen load githubuser/reponame`.
...
* [agkozak ★2](https://github.com/agkozak/agkozak-zsh-theme) - Displays git branch and status and vi editing mode in the main prompt and also displays non-zero exit codes in zsh's right prompt. An SSH connection is indicated by the presence of a hostname in the prompt; local connections show only a username.
* [agnosterAfro](https://github.com/afrozalm/agnosterAfro) - Based on [Powerline](https://github.com/Lokaltog/vim-powerline) and [Agnoster Theme](https://gist.github.com/agnoster/3712874) and inspired by the [agnosterzak ★91](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme).
* [agnosterzak ★91](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme) - Based on Agnoster, shows battery life, date & time, git status, current directory and user & host information.
* [alien-minimal ★6](https://github.com/eendroroy/alien-minimal) - Minimalist Zsh theme with git status displayed.
* [alien ★8](https://github.com/eendroroy/alien) - Powerline-esque Zsh theme that shows git branch and the exit code of the last command.
...
* [bashi](https://github.com/eli-oat/bashi) - Optimized for Ahmet Sülek's [Flat UI Terminal Theme](https://github.com/ahmetsulek/flat-terminal) and Pasquale D'Silva's [Saturn Terminal Theme ★72 ⏳1Y](https://github.com/psql/saturn-colors).
* [bilibili ★5](https://github.com/jingjinghack/bilibili-zshtheme) - BiliBili Theme
* [bklyn](https://github.com/gporrata/bklyn-zsh) - Variant of [Powerlevel9k ★2207](https://github.com/bhilburn/powerlevel9k) with customizations applied.
...
* [classyTouch ★17](https://github.com/yarisgutierrez/classyTouch_oh-my-zsh) - Minimal, clean theme with git support.
...
* [cobalt2 ★541](https://github.com/wesbos/Cobalt2-iterm) - Wes Bos' Cobalt 2 theme for ZSH and iTerm 2.
...
* [cute-theme ★15 ⏳2Y](https://github.com/dogrocker/oh-my-zsh-powerline-cute-theme) - An OSX oh-my-zsh shell theme with Cute emoji based on the Powerline Vim plugin.
...
* [gitsome](https://github.com/mtully/gitsome) - Super simple prompt with git info, optimized for the [Flat Terminal ★510 ⏳4Y](https://github.com/ahmetsulek/flat-terminal) color scheme.
...
* [hackersaurus](https://github.com/bhilburn/hackersaurus) - A theme with git status and exit code of last command run embedded in the prompt. Related to [powerlevel9k ★2207](https://github.com/bhilburn/powerlevel9k).
...
* [honukai-iterm-zsh ★799](https://github.com/oskarkrawczyk/honukai-iterm-zsh) - Honukai theme and colors for oh-my-zsh and iTerm.
...
* [hyperzsh ★169](https://github.com/tylerreckart/hyperzsh) - Gives you a comprehensive overview of the branch you're working on and the status of your repository without cluttering your terminal.
...
* [kimwz ★3 ⏳1Y](https://github.com/kimwz/kimwz-oh-my-zsh-theme) - Minimal theme.
...
* [lambda-pure ★26](https://github.com/marszall87/lambda-pure) - A minimal zsh theme, based on Pure, with added NodeJS version.
* [lambda ★254](https://github.com/halfo/lambda-mod-zsh-theme) - A zsh theme optimized for git users who use unicode-compatible fonts and terminal applications.
...
* [liquidprompt ★3113](https://github.com/nojhan/liquidprompt) - A full-featured & carefully designed adaptive prompt for Bash & ZSH.
...
* [neat](https://github.com/andrepolischuk/neat) - Minimalistic prompt inspired by [odin](https://github.com/tylerreckart/Odin) and [pure ★3507](https://github.com/sindresorhus/pure).
...
* [oh-my-git ★2519](https://github.com/arialdomartini/oh-my-git) - An opinionated prompt for bash and zsh.
...
* [oh-my-zsh-node-theme ★28 ⏳1Y](https://github.com/skuridin/oh-my-zsh-node-theme) - OMZ's node theme.
...
* [phi φ](https://github.com/LasaleFamine/phi-zsh-theme) - A clean and simple theme for ZSH inspired and forked from [Lambda (Mod) ZSH Theme ★254](https://github.com/halfo/lambda-mod-zsh-theme).
* [planet](https://github.com/aphlor/planet-zsh) - A slimmed down version of [steef](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/steeef.zsh-theme) from [oh-my-zsh ★55581](https://github.com/robbyrussell/oh-my-zsh).
...
* [powerlevel9k ★2207](https://github.com/bhilburn/powerlevel9k) - A very flexible theme based on the well-known agnoster-theme with support for various VCS, AWS, rbenv, virtualenv, etc.
...
* [powerline-shell](https://github.com/banga/powerline-shell) - A [powerline ★2807 ⏳4Y](https://github.com/Lokaltog/vim-powerline)-like prompt for Bash, ZSH and Fish. Shows important details about git/svn/hg/fossil branch and is easy to customize/extend.
...
* [pre-theme ★28](https://github.com/leandromatos/pre-theme) - A collection of themes for Sublime Text, Terminal, iTerm2 and zsh.
* [predawn-shell ★23](https://github.com/jamiewilson/predawn-shell) - Theme for dark terminal themes.
...
* [punctual](https://github.com/dannynimmo/punctual-zsh-theme) - Easily customizable, influenced by [spaceship ★1115](https://github.com/denysdovhan/spaceship-zsh-theme).
* [pure ★3507](https://github.com/sindresorhus/pure) - Pretty, minimal and fast ZSH prompt.
...
* [shellder ★132](https://github.com/simnalamburt/shellder) - Minimal theme with git branch display. Requires a powerline font.
...
* [sobole ★4](https://github.com/sobolevn/sobole-zsh-theme) - A minimalistic zsh theme. Works well on a light background.
...
* [spaceship ★1115](https://github.com/denysdovhan/spaceship-zsh-theme) - A zsh theme with git, nvm, rvm/rbenv/chruby, python, ssh and other useful indicators.
...
* [statusline ★35](https://github.com/el1t/statusline) - A responsive zsh theme that provides informational segments when you need them.
...
* [sugarfree](https://github.com/cbrock/sugar-free) - Based on the [Pure ★3507](https://github.com/sindresorhus/pure) and [Candy](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/candy.zsh-theme) themes.
...
* [wild-cherry ★284](https://github.com/mashaal/wild-cherry) - A fairy-tale inspired theme for Zsh, iTerm, Sublime, Atom, & Mou.
...
* [zeta ★46](https://github.com/skylerlee/zeta-zsh-theme) - Shows username, git information, machine name, current working directory.
...
* [Awesome Terminal Fonts ★941](https://github.com/gabrielelana/awesome-terminal-fonts) - A family of fonts that includes some nice monospaced Icons.
...
* [Fantasque-sans ★3191](https://github.com/belluzj/fantasque-sans) - Another powerline font.
...
* [nerd fonts ★4570](https://github.com/ryanoasis/nerd-fonts) - Collection of over 20 patched fonts (over 2,000 variations) & FontForge font patcher python script for Powerline, Font Awesome, Octicons, Devicons, and Vim Devicons. Includes: Droid Sans, Meslo, Source Code, AnonymousPro, Hack, ProFont, Inconsolata, and many more.
* [Powerline patched font collection ★8552](https://github.com/powerline/fonts) - A collection of a dozen or so fonts patched to include powerline gylphs.
...
* [zshdb ★110](https://github.com/rocky/zshdb) - A ZSH debugger
* [zunit ★23](https://github.com/molovo/zunit) - A powerful unit testing framework for ZSH

### Other Useful Lists

* [awesome-devenv ★817](https://github.com/jondot/awesome-devenv) - A curated list of awesome tools, resources and workflow tips making an awesome development environment
