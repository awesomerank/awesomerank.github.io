...
**Table of Contents**  *generated with [DocToc ★1529](https://github.com/thlorenz/doctoc)*
...
### [alf ★33 ⏳1Y](https://github.com/psyrendust/alf)
...
### [ansible-role-zsh ★56](https://github.com/viasite-ansible/ansible-role-zsh)
...
### [antigen-hs ★171](https://github.com/Tarrasch/antigen-hs)
...
### [antigen ★3469](https://github.com/zsh-users/antigen)
...
### [zim ★926](https://github.com/Eriner/zim)
...
### [zplug ★1835](https://github.com/zplug/zplug)

**:hibiscus: Zplug** is a next-generation zsh plugin manager.

### [zplugin ★71](https://github.com/zdharma/zplugin)
...
**ZPM** ( Zsh plugin manager ) is a plugin manager for [zsh](http://www.zsh.org/) similar to vim-plug. ZPM plugins are compatible with [oh-my-zsh ★60452](https://github.com/robbyrussell/oh-my-zsh). ZPM runs on Linux, Android, FreeBSD and macOS.
...
### [zulu ★61](https://github.com/zulu-zsh/zulu)
...
* [ansiweather ★1308](https://github.com/fcambus/ansiweather) - Weather in your terminal, with ANSI colors and Unicode symbols.
...
* [autojump ★5993](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line. Install autojump-zsh for best results.
...
* [docker-run ★6](https://github.com/rawkode/zsh-docker-run) - Go back to running your commands "naturally", we'll handle the container.
...
* [fzf-mpd](https://github.com/piotryordanov/fzf-mpd/) - A zsh plugin that allows you to control mpd using [fzf ★10323](https://github.com/junegunn/fzf).
...
* [git-extra-commands ★190](https://github.com/unixorn/git-extra-commands) - Extra git helper scripts packaged as a plugin.
* [git-it-on.zsh ★44](https://github.com/peterhurford/git-it-on.zsh) - Adds ability to open a folder in your current branch on GitHub.
...
* [git-secret ★647](https://github.com/sobolevn/git-secret) - A bash-tool to store your private data inside a git repository.
...
* [history-search-multi-word ★51](https://github.com/zdharma/history-search-multi-word) - syntax highlighted, multi-word history searcher for Zsh, bound to Ctrl-R, with advanced functions (e.g. bump of history entry to top of history).
* [history-sync ★23](https://github.com/wulfgarpro/history-sync) - An Oh My Zsh plugin for GPG encrypted, Internet synchronized Zsh history using Git.
...
* [lumberjack ★12 ⏳1Y](https://github.com/molovo/lumberjack) - Lumberjack is a logging interface for shell scripts.
...
* [mage2docker ★4](https://github.com/lukaszolszewski/mage2docker) - Makes it easy to work with Docker and Magento 2. Speeds up and simplifies common commands like clean cache, setup upgrade, compile di and much more in Magento 2 on containers.
...
* [noreallyjustfuckingstopalready ★266 ⏳1Y](https://github.com/eventi/noreallyjustfuckingstopalready) - macOS users know the pain of trying to figure out what command actually flushes the DNS cache on their version of macOS, and this plugin makes that annoyance go away.
...
* [nvm-auto ★14 ⏳1Y](https://github.com/dijitalmunky/nvm-auto) - Aims to alleviate needing to type `nvm use` as much as possible, especially if you often switch between versions of node.js and use `.nvmrc` files in your project to manage what version of node your project needs.
...
* [ssh-connect ★15](https://github.com/gko/ssh-connect) - A simple ssh manager.
...
* [tipz](https://github.com/molovo/tipz) - Displays your alias if you have an alias for the command you just ran (Similar to [alias-tips ★202](https://github.com/djui/alias-tips)).
* [tsm ★6](https://github.com/RobertAudi/tsm) - Adds a tmux Session Manager.
* [tumult ★44](https://github.com/unixorn/tumult.plugin.zsh) - Adds tools for macOS.
...
* [vox ★5 ⏳1Y](https://github.com/andrewbonnington/vox.plugin.zsh) - An oh-my-zsh plugin to control [VOX](https://coppertino.com/vox/mac), a lightweight full-featured audio player for macOS that can play a variety of formats including FLAC and Ogg Vorbis.
...
* [wakatime ★36](https://github.com/wbinglee/zsh-wakatime) - Automatic time tracking for commands in ZSH using [wakatime](https://wakatime.com/).
* [warhol](https://github.com/unixorn/warhol.plugin.zsh) - Configures colorization with [grc ★414](https://github.com/garabik/grc).
* [watson.zsh](https://github.com/bcho/Watson.zsh) - A plugin for [watson ★795](https://github.com/TailorDev/Watson).
...
* [zedzsh](https://github.com/eendroroy/zed-zsh) - A simple wrapper for [z ★7348](https://github.com/rupa/z) to install as zsh plugin.
...
* [zsh-256color ★37 ⏳2Y](https://github.com/chrissicool/zsh-256color) - Enhances the terminal environment with 256 colors. It looks at the chosen TERM environment variable and sees if there is respective ncurses' terminfo with 256 colors available. The result is a multicolor terminal, if available.
...
* [zsh-async ★160](https://github.com/mafredri/zsh-async) - Library for running asynchronous tasks in zsh without requiring any external tools.
* [zsh-autoenv ★254](https://github.com/Tarrasch/zsh-autoenv) - If a directory contains a `.env` file, it will automatically be executed when you cd into it.
* [zsh-autopair ★57](https://github.com/hlissner/zsh-autopair) - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters.
* [zsh-autosuggestions ★3608](https://github.com/zsh-users/zsh-autosuggestions) - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
* [zsh-autoswitch-virtualenv ★40](https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv) - ZSH plugin to automatically switch python virtualenvs when traversing directories.
* [zsh-basex ★2 ⏳3Y](https://github.com/dirkk/zsh-basex) - Adds several [BaseX](http://basex.org/) aliases for simplified usage.
* [zsh-bash ★14 ⏳3Y](https://github.com/chrissicool/zsh-bash) - Makes ZSH more Bash compatible. It redefines the source command to act more like Bash does. It also enables Bash completions.
* [zsh-bd ★229](https://github.com/Tarrasch/zsh-bd) - Jump back to a specific directory, without doing `cd ../../..`.
* [zsh-carthage](https://github.com/cfdrake/zsh-carthage) - Provides completions and aliases for use with [Carthage ★10255](https://github.com/Carthage/Carthage).
* [zsh-cmd-architect ★35](https://github.com/psprint/zsh-cmd-architect) - Build commands from what's in history and at prompt, move, delete, add command segments and search history with multi-word queries.
* [zsh-colors ★26 ⏳1Y](https://github.com/Tarrasch/zsh-colors) - Makes it easier to colorize text from the CLI. `red foo` just works.
* [zsh-command-time ★11](https://github.com/popstas/zsh-command-time) - Show execution time for long commands in zsh and powerlevel9k.
* [zsh-completion-generator ★67](https://github.com/RobSis/zsh-completion-generator) - This plugin tries to read the list of options from the help text of programs and generate a completion function automatically. Note that this doesn't do it automatically, you have to explicitly call the generator.
* [zsh-dircolors-solarized ★31 ⏳1Y](https://github.com/joel-porquet/zsh-dircolors-solarized) - Solarized dircolors plugin.
* [zsh-dircycle ★0](https://github.com/michaelxmcbride/zsh-dircycle) - Cycle through the directory stack.
* [zsh-directory-history ★80](https://github.com/tymm/zsh-directory-history) - A per directory history for ZSH.
...
* [zsh-functional ★75 ⏳2Y](https://github.com/Tarrasch/zsh-functional) - ZSH higher order functions.
...
* [zsh-histdb ★381](https://github.com/larkery/zsh-histdb) - Stores your history in an SQLite database.
* [zsh-history-substring-search ★633](https://github.com/zsh-users/zsh-history-substring-search) - Needs to be loaded after zsh-syntax-highlighting, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
* [zsh-history ★41](https://github.com/b4b4r07/zsh-history) - Extend history so that it can be queried by SQL.
* [zsh-interactive-cd ★53](https://github.com/changyuheng/zsh-interactive-cd) - Fish-like interactive tab completion for `cd`.
* [zsh-iterm-touchbar ★156](https://github.com/iam4x/zsh-iterm-touchbar) - Display iTerm2 feedback in the MacbookPro TouchBar (Current directory, git branch & status).
* [zsh-konsole-theme-changer ★0 ⏳1Y](https://github.com/rocknrollMarc/zsh-konsole-theme-changer) - Toggle konsole theme from ZSH.
* [zsh-kubernetes ★1](https://github.com/Dbz/zsh-kubernetes) - Add kubernetes helper functions and aliases.
...
* [zsh-morpho ★7](https://github.com/psprint/zsh-morpho) - Terminal screen savers written in pure ZSH, and also screen saver framework.
* [zsh-navigation-tools ★148](https://github.com/psprint/zsh-navigation-tools) - Adds `htop`-like `kill`, directory bookmarks browser, multi-word incremental history searcher and more.
...
* [zsh-plugin-vscode ★6 ⏳1Y](https://github.com/wuotr/zsh-plugin-vscode) - Plugin for Visual Studio Code, a text editor for macOS, Windows, and Linux.
...
* [zsh-syntax-highlighting-filetypes ★60 ⏳3Y](https://github.com/trapd00r/zsh-syntax-highlighting-filetypes) - ZSH syntax highlighting with dircolors in realtime.
* [zsh-syntax-highlighting ★4141](https://github.com/zsh-users/zsh-syntax-highlighting) - Add syntax highlighting to your ZSH. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
...
* [zsh-you-should-use ★112](https://github.com/MichaelAquilina/zsh-you-should-use)- ZSH plugin that reminds you to use those aliases you defined.
...
* [ZUI ★17](https://github.com/zdharma/zui) - ZSH User Interface library – CGI+DHTML-like rapid TUI application development with ZSH.
...
* [gentoo-zsh-completions ★13 ⏳1Y](https://github.com/gentoo/gentoo-zsh-completions) - providing ZSH completion support to various Gentoo tools that lack completion scripts upstream.
...
* [git-flow-completion ★1919 ⏳1Y](https://github.com/bobthecow/git-flow-completion) - ZSH completion support for git-flow.
...
* [newman](https://github.com/selop/newman-autocomplete) - Provides autocompletion for the [Newman CLI ★2099](https://github.com/postmanlabs/newman).
...
* [agkozak ★5](https://github.com/agkozak/agkozak-zsh-theme) - Displays git branch and status and vi editing mode in the main prompt and also displays non-zero exit codes in ZSH's right prompt. An SSH connection is indicated by the presence of a hostname in the prompt; local connections show only a username.
* [agnosterAfro](https://github.com/afrozalm/agnosterAfro) - Based on [Powerline](https://github.com/Lokaltog/vim-powerline) and [Agnoster Theme](https://gist.github.com/agnoster/3712874) and inspired by the [agnosterzak ★112](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme).
* [agnosterzak ★112](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme) - Based on Agnoster, shows battery life, date & time, git status, current directory and user & host information.
* [alien-minimal ★11](https://github.com/eendroroy/alien-minimal) - Minimalist ZSH theme with git status displayed.
* [alien ★19](https://github.com/eendroroy/alien) - Powerline-esque ZSH theme that shows git branch and the exit code of the last command.
...
* [aterminal ★9](https://github.com/guiferpa/aterminal) - Displays Nodejs, NPM, Docker, Go, Python, Elixir and Ruby information in the prompt.
...
* [bronze](https://github.com/reujab/bronze) - A cross-shell customizable powerline-like prompt with icons written in go. Requires [nerd-fonts ★5771](https://github.com/ryanoasis/nerd-fonts).
...
* [dexter ★1 ⏳1Y](https://github.com/shvenkat/zsh-theme-dexter) - A theme with an emphasis on the right side (hence the name) of the terminal.
...
* [dracula ★18](https://github.com/dracula/zsh) - A dark theme for Atom, Alfred, Chrome DevTools, iTerm, Sublime Text, Textmate, Terminal.app, Vim, Xcode, ZSH.
...
* [filthy ★13](https://github.com/molovo/filthy) - A disgustingly clean ZSH prompt
...
* [gitsome](https://github.com/mtully/gitsome) - Super simple prompt with git info, optimized for the [Flat Terminal ★548 ⏳4Y](https://github.com/ahmetsulek/flat-terminal) color scheme.
...
* [hackersaurus](https://github.com/bhilburn/hackersaurus) - A theme with git status and exit code of last command run embedded in the prompt. Related to [powerlevel9k ★2969](https://github.com/bhilburn/powerlevel9k).
...
* [honukai-iterm-zsh ★826](https://github.com/oskarkrawczyk/honukai-iterm-zsh) - Honukai theme and colors for oh-my-zsh and iTerm.
...
* [hyperzsh ★220](https://github.com/tylerreckart/hyperzsh) - Gives you a comprehensive overview of the branch you're working on and the status of your repository without cluttering your terminal.
...
* [lambda-pure ★34](https://github.com/marszall87/lambda-pure) - A minimal ZSH theme, based on Pure, with added NodeJS version.
* [lambda ★281](https://github.com/halfo/lambda-mod-zsh-theme) - A ZSH theme optimized for git users who use unicode-compatible fonts and terminal applications.
...
* [minimal ★46](https://github.com/subnixr/minimal) - Minimal yet feature-rich theme.
...
* [neat](https://github.com/andrepolischuk/neat) - Minimalistic prompt inspired by [odin](https://github.com/tylerreckart/Odin) and [pure ★4024](https://github.com/sindresorhus/pure).
...
* [oh-my-git ★2624](https://github.com/arialdomartini/oh-my-git) - An opinionated prompt for bash and ZSH.
* [oh-my-via ★6](https://github.com/badouralix/oh-my-via) - Theme for ZSH which mainly forks the historical theme used on VIA servers.
...
* [phi φ](https://github.com/LasaleFamine/phi-zsh-theme) - A clean and simple theme for ZSH inspired and forked from [Lambda (Mod) ZSH Theme ★281](https://github.com/halfo/lambda-mod-zsh-theme).
* [plain ★0](https://github.com/jimeh/plain.zsh-theme) - A plain and simple theme for ZSH which shows basic git information.
* [planet](https://github.com/aphlor/planet-zsh) - A slimmed down version of [steef](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/steeef.zsh-theme) from [oh-my-zsh ★60452](https://github.com/robbyrussell/oh-my-zsh).
...
* [powerless ★41](https://github.com/martinrotter/powerless) - Tiny & simple pure ZSH prompt inspired by powerline.
* [powerlevel9k ★2969](https://github.com/bhilburn/powerlevel9k) - A very flexible theme based on the well-known agnoster-theme with support for various VCS, AWS, rbenv, virtualenv, etc. Works with vanilla ZSH as well as the various ZSH frameworks.
...
* [pure ★4024](https://github.com/sindresorhus/pure) - Pretty, minimal and fast ZSH prompt.
...
* [shellder ★141](https://github.com/simnalamburt/shellder) - Minimal theme with git branch display. Requires a powerline font.
...
* [sugarfree](https://github.com/cbrock/sugar-free) - Based on the [Pure ★4024](https://github.com/sindresorhus/pure) and [Candy](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/candy.zsh-theme) themes.
