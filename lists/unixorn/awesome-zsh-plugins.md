...
### [alf ★27](https://github.com/psyrendust/alf)
...
### [ansible-role-zsh ★33](https://github.com/viasite-ansible/ansible-role-zsh)
...
### [antigen-hs ★164](https://github.com/Tarrasch/antigen-hs)
...
### [antigen ★3063](https://github.com/zsh-users/antigen)
...
### [fresh ★778](https://github.com/freshshell/fresh)
...
### [pumice ★3](https://github.com/ryutamaki/pumice)
...
### [zgen ★739](https://github.com/tarjoilija/zgen)
...
### [zilsh ★22](https://github.com/zilsh/zilsh)

**zilsh** is a zsh config system that aims to appeal more to power-users and follow the simplistic approach of vim-pathogen.

### [zim ★810](https://github.com/Eriner/zim)
...
### [zplug ★1494](https://github.com/zplug/zplug)

**:hibiscus: Zplug** is a next-generation zsh plugin manager.

### [zplugin ★48](https://github.com/zdharma/zplugin)
...
**ZPM** ( Zsh plugin manager ) is a plugin manager for [zsh](http://www.zsh.org/) similar to vim-plug. ZPM plugins are compatible with [oh-my-zsh ★52892](https://github.com/robbyrussell/oh-my-zsh). ZPM runs on Linux, Android, FreeBSD and OS X.

### [ztanesh ★236](https://github.com/miohtama/ztanesh)

**Ztanesh** aims to improve your UNIX command line experience and productivity with the the configuration provided by the ztanesh project: the tools will make your shell more powerful and easier to use.

### [zulu ★42](https://github.com/zulu-zsh/zulu)
...
* [ZSH Pony ★79](https://github.com/mika/zsh-pony) - Covers customizing ZSH without a framework.
...
* [zsh-quickstart-kit ★96](https://github.com/unixorn/zsh-quickstart-kit) - A simple quickstart for using zsh with zgen. This includes a curated collection of plugins, and will automatically configure zsh to use zgen to load them, configures zgen to periodically automatically update itself, the plugins, and the quickstart kit itself.

## Plugins

* [accurev-zsh ★1](https://github.com/dalefukami/accurev-zsh) - ZSH plugin for accurev.
* [alias-tips ★164](https://github.com/djui/alias-tips) - An oh-my-zsh plugin to help remembering those aliases you defined once.
* [allergen ★1](https://github.com/stanislas/allergen) - A collection of custom zsh plugins to use with antigen
* [almostontop ★32](https://github.com/Valiev/almostontop) - Clears previous command output every time before new command executed in shell. Inspired by alwaysontop plugin for bash.
...
* [antigen-git-rebase ★0](https://github.com/smallhadroncollider/antigen-git-rebase) - Antigen/zsh script to aid with Git rebasing.
...
* [anyframe ★103](https://github.com/mollifier/anyframe) - A peco/percol/fzf wrapper plugin for zsh.
...
* [auto-fu.zsh ★326](https://github.com/hchbaw/auto-fu.zsh) - Automatic complete-word and list-choices. Originally incr-0.2.zsh by y.fujii <y-fujii at mimosa-pudica.net>.
* [autoenv](https://github.com/horosgrisa/autoenv) - Extended version of the zsh-autoenv plugin.
* [autojump ★5396](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line. Install autojump-zsh for best results.
* [autoupdate-antigen.zshplugin ★10](https://github.com/unixorn/autoupdate-antigen.zshplugin) - Antigen doesn't do automatic updates like oh-my-zsh. This plugin adds auto updating for antigen, both of antigen and the bundles loaded in your configuration.
...
* [blackbox ★3237](https://github.com/StackExchange/blackbox) - Stack Exchange's toolkit for storing keys/credentials securely in a git repository.
* [branch-manager ★0](https://github.com/elstgav/branch-manager) - A plugin for managing git branches.
* [browse-commit ★10](https://github.com/adolfoabegg/browse-commit) - A plugin that lets you open any commit in your browser from the command line.
* [calc.plugin.zsh ★22](https://github.com/arzzen/calc.plugin.zsh) - A calculator for zsh.
* [caniuse.plugin.zsh ★11](https://github.com/walesmd/caniuse.plugin.zsh) - Add [Can I Use...](http://caniuse.com) support to ZSH.
* [cd-gitroot ★22](https://github.com/mollifier/cd-gitroot) - A zsh plugin to cd to the git repository root directory.
...
* [cdr ★4](https://github.com/willghatch/zsh-cdr) - Easy setup of cdr for zsh.
...
* [crash ★8](https://github.com/molovo/crash) - Adds proper error handling, exceptions and try/catch for ZSH.
* [crayon-syntax-zsh ★0](https://github.com/Stibbons/crayon-syntax-zsh) - ZSH syntax highlighting for the Crayon Plugin for Wordpress.
* [crystal](https://github.com/veelenga/crystal-zsh) - A plugin for [Crystal](https://github.com/manastech/crystal).
* [czhttpd ★22](https://github.com/jsks/czhttpd) - A simple http server written in 99.9% pure zsh.
* [deer ★186](https://github.com/Vifon/deer) - A file navigator for zsh heavily inspired by [ranger](http://ranger.nongnu.org/).
* [depot-tools ★0](https://github.com/jgrowl/depot_tools) - Simple oh-my-zsh plugin for installing the chromium depot_tools. Installing this plugin will put all of the chromium depot_tools in your path automatically.
* [docker-aliases ★2](https://github.com/webyneter/docker-aliases) Docker aliases for everyday use.
* [docker-compose ★21](https://github.com/sroze/docker-compose-zsh-plugin) Show docker container status in your prompt.
* [docker-fun ★2](https://github.com/johnlabarge/docker_fun) - Adds docker convenience functions.
...
* [elixir-oh-my-zsh ★69](https://github.com/gusaiani/elixir-oh-my-zsh) - Adds shortcuts for Elixir, IEX, Mix and Phoenix.
* [emoji-cli ★128](https://github.com/b4b4r07/emoji-cli) - :scream: Emoji completion on the command line.
* [enhancd ★626](https://github.com/b4b4r07/enhancd) - A simple tool that provides enhanced `cd` command.
* [exercism ★3](https://github.com/fabiokiatkowski/exercism.plugin.zsh) - A plugin for [exercism.io](http://exercism.io/).
* [expand-ealias ★4](https://github.com/zigius/expand-ealias.plugin.zsh) - Expand specific aliases with space.
* [fast-syntax-highlighting ★55](https://github.com/zdharma/fast-syntax-highlighting) - Optimized an improved `zsh-users/zsh-syntax-highlighting` – better response times, `zed/vared` can edit `10 kB` functions.
...
* [fzf-marks](https://github.com/uvaes/fzf-marks) - Little script to create, navigate and delete bookmarks in Bash and Zsh, using the fuzzy finder [fzf ★8558](https://github.com/junegunn/fzf).
* [fzf-widgets](https://github.com/ytet5uy4/fzf-widgets) - Adds some ZLE widgets for [fzf ★8558](https://github.com/junegunn/fzf).
...
* [ghost-zeus ★3](https://github.com/fontno/ghost_zeus) - Lets you use zeus with normal rails commands.
...
* [git-extra-commands ★160](https://github.com/unixorn/git-extra-commands) - Extra git helper scripts packaged as a plugin.
...
* [git-prune ★16](https://github.com/Seinh/git-prune) - Plugin that simplifies deleting merged branches.
* [git-secret ★517](https://github.com/sobolevn/git-secret) - A bash-tool to store your private data inside a git repository.
* [git-prompt-useremail ★0](https://github.com/mroth/git-prompt-useremail) - Adds prompt reminders for git user.email.
* [gitfast ★2](https://github.com/tevren/gitfast-zsh-plugin) - Updated fork of oh-my-zsh gitfast plugin.
* [gitignore.plugin.zsh ★15](https://github.com/voronkovich/gitignore.plugin.zsh) - Plugin for creating `.gitignore` files.
* [gitio-zsh ★9](https://github.com/denysdovhan/gitio-zsh) - A zsh plugin for generating a GitHub short URL using [git.io](https://git.io).
* [gitsync ★1](https://github.com/washtubs/gitsync) - zsh plugin to improve workflows for one person developing on the same repository on multiple machines.
* [goenv ★3](https://github.com/bbenne10/goenv) - Antigen plugin to manage `$GOPATH` similarly to Python's virtualenvwrapper.
...
* [grep2awk ★11](https://github.com/joepvd/grep2awk) - ZLE widget to transform grep command into awk command.
...
* [hipchat ★14](https://github.com/robertzk/hipchat.zsh) - Send hipchat messages from the shell.
...
* [history-sync ★14](https://github.com/wulfgarpro/history-sync) - An Oh My Zsh plugin for GPG encrypted, Internet synchronized Zsh history using Git.
* [hooks ★14](https://github.com/willghatch/zsh-hooks) - Add missing hooks - for plugins and personal use.
...
* [iterm-tab-colors ★5](https://github.com/tysonwolker/iterm-tab-colors) - Automatically changes iTerm tab color based on the current working directory
...
* [jhipster-oh-my-zsh-plugin ★12](https://github.com/jhipster/jhipster-oh-my-zsh-plugin) - Adds commands for [jHipster](http://jhipster.github.io/).
* [jvm ★2](https://github.com/mgryszko/jvm) - Allows selection of JDK on OS X.
* [k](https://github.com/rimraf/k) - Directory listings for zsh with git features.
* [kitsunebook.plugin.zsh ★0](https://github.com/d12frosted/kitsunebook.plugin.zsh) - KitsuneBook plugin for oh-my-zsh.
* [laravel ★0](https://github.com/crazybooot/laravel-zsh-plugin) - Add shortcuts for Laravel 5, 5.1, 5.2 & 5.3.
* [lesaint-mvn ★0](https://github.com/lesaint/lesaint-mvn) - Maven plugins for Oh-My-Zsh.
* [linuxbrew ★0](https://github.com/zpm-zsh/linuxbrew) - Zsh plugin for [linuxbrew](http://linuxbrew.sh/)
* [listbox ★9](https://github.com/gko/listbox) - Listbox element for shell.
...
* [mac-packaging ★1](https://github.com/Temikus/mac-packaging) - A set of common functions used for enterprise Mac packaging with Munki.
* [macos-zsh-plugin ★0](https://github.com/joow/macos-zsh-plugin) - A zsh plugin for macOS.
* [mage2docker ★1](https://github.com/lukaszolszewski/mage2docker) - Makes it easy to work with Docker and Magento 2. Speeds up and simplifies common commands like clean cache, setup upgrade, compile di and much more in Magento 2 on containers.
* [markjump ★0](https://github.com/zakariaGatter/MarkGate) - Allows you to mark directories so you can jump directly to them.
* [mfunc ★3](https://github.com/hlohm/mfunc) - Allows you to define persistent functions on-the-fly, without the need to add them to your config files. These functions are permanently available until you delete them.
...
* [mysql.plugin.zsh ★9](https://github.com/voronkovich/mysql.plugin.zsh) - Adds some functions for dealing with mysql.
* [nice-exit-code ★16](https://github.com/bric3/nice-exit-code) - Maps exit status code to human readable string.
* [node.plugin.zsh ★5](https://github.com/srijanshetty/node.plugin.zsh) - Srijan Shetty's nodejs plugin for zsh with caching of nvm completions and autoloading of nvm if present.
* [nodenv.plugin.zsh ★0](https://github.com/jsahlen/nodenv.plugin.zsh) - Auto-load nodenv and its completions into the shell.
* [noreallyjustfuckingstopalready ★263](https://github.com/eventi/noreallyjustfuckingstopalready) - OS X users know the pain of trying to figure out what command actually flushes the DNS cache on their version of OS X, and this plugin makes that annoyance go away.
* [nvm-auto-use ★2](https://github.com/tomsquest/nvm-auto-use.zsh) - calls `nvm use` automatically whenever you enter a directory that contains an `.nvmrc` file with a string telling nvm which node to use.
...
* [oh-my-dogesh ★3](https://github.com/keithhamilton/oh-my-dogesh) - Dogification plugin.
* [oh-my-zsh-dirstack ★1](https://github.com/gepoch/oh-my-zsh-dirstack) - Plugin for displaying dirstack info on a single line.
...
* [oh-my-zsh-jira-plus ★2](https://github.com/gerges/oh-my-zsh-jira-plus) - Create JIRAs from the command line.
* [oh-my-zsh-opera-git-plugin ★0](https://github.com/aswitalski/oh-my-zsh-opera-git-plugin) - Git aliases.
* [oh-my-zsh-reminder ★8](https://github.com/AlexisBRENON/oh-my-zsh-reminder) - A plugin which displays reminders above every prompt.
...
* [opp.zsh ★224](https://github.com/hchbaw/opp.zsh) - Vim's text-objects-ish for zsh.
* [osx-dev-zsh-plugin ★7](https://github.com/marshallmick007/osx-dev-zsh-plugin) - This plugin adds some commands for maintaining various server programs on my OSX install.
* [pantheon-terminal-notify-zsh-plugin ★9](https://github.com/deyvisonrocha/pantheon-terminal-notify-zsh-plugin) - Background notifications for long running commands. Supports Elementary OS Freya.
* [pctl ★2](https://github.com/ytet5uy4/pctl) - Toggle the environment variables for proxying.
...
* [pretty-time-zsh ★30](https://github.com/sindresorhus/pretty-time-zsh) - Convert seconds to a human readable string: 165392 → 1d 21h 56m 32s.
...
* [revolver ★25](https://github.com/molovo/revolver) - A progress spinner for ZSH scripts.
* [ripz ★4](https://github.com/jedahan/ripz) - A ripgrep-powered zsh plugin alias reminder.
...
* [safe-paste ★5](https://github.com/oz/safe-paste) - A safe-paste plugin. See <[http://cirw.in/blog/bracketed-paste](http://cirw.in/blog/bracketed-paste).
* [saneopt ★7](https://github.com/willghatch/zsh-saneopt) - Sane defaults for zsh options, in the spirit of vim-sensible.
* [schroot ★0](https://github.com/fshp/schroot.plugin.zsh) - Show current chroot name in your prompt.
* [send.zsh ★6](https://github.com/robertzk/send.zsh) - Single command to git add, git commit, and git push for much faster git workflow.
...
* [smart-cd ★12](https://github.com/dbkaplun/smart-cd) - Runs `ls` and `git status` after chpwd.
* [snippets ★15](https://github.com/willghatch/zsh-snippets) - Command line snippet expansion.
...
* [ssh-connect ★8](https://github.com/gko/ssh-connect) - Simple ssh manager
* [startup-timer ★5](https://github.com/paulmelnikow/zsh-startup-timer) - Print the time it takes for the shell to start up.
* [statify ★2](https://github.com/vladmrnv/statify) - Plugin that does basic statistical analysis.
* [sterror.plugin.zsh ★2](https://github.com/aphelionz/strerror.plugin.zsh) - Interprets error messages from programs and displays a human readable error message when available.
* [symfony.plugin.zsh ★1](https://github.com/voronkovich/symfony.plugin.zsh) - ZSH plugin for Symfony 2 and 3.
* [sysadmin-util ★403](https://github.com/skx/sysadmin-util) - Steve Kemp's collection of tool scripts for sysadmins.
...
* [up.zsh ★14](https://github.com/peterhurford/up.zsh) - Adds an up command to cd multiple levels up.
...
* [vox ★4](https://github.com/andrewbonnington/vox.plugin.zsh) - An oh-my-zsh plugin to control [VOX](http://coppertino.com/vox/mac), a lightweight full-featured audio player for OS X that can play a variety of formats including FLAC and Ogg Vorbis.
* [vsc ★0](https://github.com/davidtong/vsc.plugin.zsh) - Plugin for Visual Studio Code on MacOS.
* [vscode ★2](https://github.com/qianxinfeng/vscode) - Plugin for Visual Studio Code.
* [wakatime ★29](https://github.com/wbinglee/zsh-wakatime) - Automatic time tracking for commands in ZSH using [wakatime](https://wakatime.com/).
* [warhol](https://github.com/unixorn/warhol.plugin.zsh) - Configures colorization with [grc ★327](https://github.com/garabik/grc).
* [watson.zsh](https://github.com/bcho/Watson.zsh) - A plugin for [watson ★567](https://github.com/TailorDev/Watson).
* [wd ★157](https://github.com/mfaerevaag/wd) - Warp directory lets you jump to custom directories in zsh, without using cd. Why? Because cd seems inefficient when the folder is frequently visited or has a long path.
...
* [zaw ★363](https://github.com/zsh-users/zaw) - ZSH anything.el-like widget.
* [zce ★25](https://github.com/hchbaw/zce.zsh) - Vim’s EasyMotion / Emacs’s ace-jump-mode for zsh.
...
* [zero ★11](https://github.com/arlimus/zero.zsh) - Zero is both a plugin and a theme. See the github page for installation details.
* [zinfo_line ★1](https://github.com/kmhjs/zinfo_line) - Makes more information available to zsh themes.
* [zsh-256color ★33](https://github.com/chrissicool/zsh-256color) - Enhances the terminal environment with 256 colors. It looks at the chosen TERM environment variable and sees if there is respective ncurses' terminfo with 256 colors available. The result is a multicolor terminal, if available.
...
* [zsh-async ★128](https://github.com/mafredri/zsh-async) - Library for running asynchronous tasks in zsh without requiring any external tools.
* [zsh-autoenv ★212](https://github.com/Tarrasch/zsh-autoenv) - If a directory contains a .env file, it will automatically be executed when you cd into it.
* [zsh-autopair ★48](https://github.com/hlissner/zsh-autopair) - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters.
* [zsh-autosuggestions ★2541](https://github.com/zsh-users/zsh-autosuggestions) - [Fish](http://fishshell.com/)-like fast/unobtrusive autosuggestions for zsh.
...
* [zsh-basex ★2](https://github.com/dirkk/zsh-basex) - Adds several [BaseX](http://basex.org/) aliases for simplified usage.
* [zsh-bash ★12](https://github.com/chrissicool/zsh-bash) - Makes ZSH more Bash compatible. It redefines the source command to act more like Bash does. It also enables Bash completions.
* [zsh-bd ★210](https://github.com/Tarrasch/zsh-bd) - Jump back to a specific directory, without doing `cd ../../..`.
* [zsh-carthage ★0](https://github.com/cfdrake/zsh-carthage) - Provides completions and aliases for use with [Carthage](http://github.com/Carthage/Carthage)
...
* [zsh-command-time ★7](https://github.com/popstas/zsh-command-time) - Show execution time for long commands in zsh and powerlevel9k.
* [zsh-completion-generator ★57](https://github.com/RobSis/zsh-completion-generator) - This plugin tries to read the list of options from the help text of programs and generate a completion function automatically. Note that this doesn't do it automatically, you have to explicitly call the generator.
* [zsh-dircolors-solarized ★21](https://github.com/joel-porquet/zsh-dircolors-solarized) - Solarized dircolors plugin.
* [zsh-directory-history ★76](https://github.com/tymm/zsh-directory-history) - A per directory history for zsh.
...
* [zsh-functional ★70](https://github.com/Tarrasch/zsh-functional) - ZSH higher order functions.
...
* [zsh-geeknote ★11](https://github.com/s7anley/zsh-geeknote) - Geeknote plugin for zsh.
* [zsh-git-plugin ★2](https://github.com/rcruzper/zsh-git-plugin) - Adds some functions for git
* [zsh-git-sync ★16](https://github.com/caarlos0/zsh-git-sync) - A ZSH plugin to sync git repositories and clean them up.
* [zsh-grunt-plugin ★8](https://github.com/clauswitt/zsh-grunt-plugin) - Add autocompletion for grunt.
* [zsh-gvm (yerinle)](https://github.com/yerinle/zsh-gvm) - Provides autocompletion for gvm (Groovy enVironment Manager).
* [zsh-hints ★25](https://github.com/joepvd/zsh-hints) - Display glob and parameter flags and other non completable info right under your editing buffer.
* [zsh-histdb ★9](https://github.com/larkery/zsh-histdb) - Stores your history in an SQLite database.
* [zsh-history-substring-search ★575](https://github.com/zsh-users/zsh-history-substring-search) - Needs to be loaded after zsh-syntax-highlighting, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
* [zsh-history ★35](https://github.com/b4b4r07/zsh-history) - Extend history so that it can be queried by SQL.
* [zsh-interactive-cd ★31](https://github.com/changyuheng/zsh-interactive-cd) - Fish like interactive tab completion for `cd`.
...
* [zsh-manydots-magic ★19](https://github.com/knu/zsh-manydots-magic) - A zle tweak for emulating `...'==`../..' etc.
* [zsh-maven-plugin ★0](https://github.com/KyleChamberlin/zsh_maven_plugin) - A fork of the oh-my-zsh maven plugin.
...
* [zsh-navigation-tools ★133](https://github.com/psprint/zsh-navigation-tools) - Adds `htop`-like `kill`, directory bookmarks browser, multi-word incremental history searcher and more.
...
* [zsh-nvm ★234](https://github.com/lukechilds/zsh-nvm) - Zsh plugin for installing, updating and loading nvm.
* [zsh-open-pr ★25](https://github.com/caarlos0/zsh-open-pr) - A ZSH plugin to open pull requests from command line.
* [zsh-opt-path ★2](https://github.com/jreese/zsh-opt-path) - Automatically add `~/opt` subpaths to your `$PATH`.
* [zsh-osx ★8](https://github.com/mwilliammyers/plugin-osx) - Add some common OS X related aliases and functions.
...
* [zsh-plugin-ibtool ★0](https://github.com/RudthMael/zsh-plugin-ibtool) - Adds ibtool shortcuts to generate localized XIB files.
* [zsh-plugin-rails ★3](https://github.com/paraqles/zsh-plugin-rails) - ZSH plugin for Rails.
* [zsh-plugin-vscode ★3](https://github.com/wuotr/zsh-plugin-vscode) - Plugin for Visual Studio Code, a text editor for Mac OS X, Windows, and Linux.
* [zsh-reentry-hook ★2](https://github.com/RobSis/zsh-reentry-hook) - Plugin that re-enters working directory if it has been removed and re-created.
...
* [zsh-syntax-highlighting-filetypes ★52](https://github.com/trapd00r/zsh-syntax-highlighting-filetypes) - zsh syntax highlighting with dircolors in realtime.
* [zsh-syntax-highlighting ★3527](https://github.com/zsh-users/zsh-syntax-highlighting) - Add syntax highlighting to your zsh. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
* [zsh-t32 ★1](https://github.com/chrissicool/zsh-t32) - Plugin for the Lauterbach Trace32 toolset. It automatically registers fonts and sets all necessary environment variables to run the t32 toolset.
...
* [zsh-url-highlighter ★14](https://github.com/ascii-soup/zsh-url-highlighter) - A plugin for the zsh syntax highlighter that turns URLs green if they respond with a "good" status, and red otherwise. Useful for checking URL typos.
...
* [zsh-vim-mode ★30](https://github.com/sharat87/zsh-vim-mode) - Shrikant Sharat's bindings for zsh's vi mode so it behaves more vim-like.
...
* [ZUI ★12](https://github.com/zdharma/zui) - Zsh User Interface library – CGI+DHTML-like rapid TUI application development with Zsh.

## Even more completions

These plugins add tab completion without adding extra functions or aliases.

* [autopkg-zsh-completion ★6](https://github.com/fuzzylogiq/autopkg-zsh-completion) - Completions for autopkg.
* [aws_manager_plugin ★0](https://github.com/EslamElHusseiny/aws_manager_plugin) - Add completions for the aws_manager CLI.
* [berkshelf-zsh-plugin ★16](https://github.com/berkshelf/berkshelf-zsh-plugin) - Adds tab completion for berkshelf.
* [bosh-zsh-autocompletion ★2](https://github.com/krujos/bosh-zsh-autocompletion) - Adds BOSH autocompletion.
* [brew-services ★12](https://github.com/vasyharan/zsh-brew-services) - Completion plugin for homebrew services.
* [cabal ★0](https://github.com/d12frosted/cabal.plugin.zsh) - Adds autocompletion for cabal.
...
* [codeception-zsh-plugin ★10](https://github.com/shengyou/codeception-zsh-plugin) - Adds command completion for the Codeception Testing Framework.
* [codemachine ★3](https://github.com/CodeMonkeyMike/ZshTheme-CodeMachine) - Displays git info, whether you're logged in via ssh, return code of last command.
...
* [docker-enter-completion](https://github.com/primait/docker-enter-completion) - Command completion for [docker-enter ★1699](https://github.com/jpetazzo/nsenter).
* [docker-zsh-completion ★192](https://github.com/felixr/docker-zsh-completion) - Add completions for docker.
* [dropbox](https://github.com/horosgrisa/zsh-dropbox) - A dropbox plugin for Zsh that provides `dropbox-cli` and `dropbox-uploader` commands.
* [drush_zsh_completion ★39](https://github.com/webflo/drush_zsh_completion) - Drush autocomplete awesomeness for zsh.
* [duell](https://github.com/jcxavier/oh-my-zsh-duell) - A zsh plugin for [duell ★41](https://github.com/gameduell/duell).
* [etcdctl-zsh ★2](https://github.com/sheax0r/etcdctl-zsh) - Adds etcdctl tab completions.
* [exercism ★3](https://github.com/fabiokiatkowski/exercism.plugin.zsh) - A plugin for [exercism.io](http://exercism.io/).
* [fly-zsh-autocomplete-plugin ★0](https://github.com/Sbodiu-pivotal/fly-zsh-autocomplete-plugin) - Adds autocompletion options for all [Concourse CLI](http://concourse.ci/fly-cli.html) commands.
* [gcloud-zsh-completion ★39](https://github.com/littleq0903/gcloud-zsh-completion) - Add completions for the Google Cloud SDK.
* [gentoo-zsh-completions ★10](https://github.com/gentoo/gentoo-zsh-completions) - providing Zsh completion support to various Gentoo tools that lack completion scripts upstream.
* [git-flow-completion ★1789](https://github.com/bobthecow/git-flow-completion) - ZSH completion support for git-flow.
* [gradle-completion](https://github.com/eriwen/gradle-completion) - Bash and ZSH completion support for gradle.
* [grid5000-zsh-plugin ★2](https://github.com/pmorillon/grid5000-zsh-plugin) - Grid 5000 plugin - adds theme, autocompletions.
* [gulp-autocompletion-zsh ★10](https://github.com/srijanshetty/gulp-autocompletion-zsh) - Autocompletion for gulp.
* [gulp](https://github.com/akoenig/gulp.plugin.zsh) - Autocompletion for your gulp.js tasks in the Z-Shell (zsh).
* [jumpstorm-zsh-plugin](https://github.com/netresearch/jumpstorm-zsh-plugin) - Adds autocompletion for [jumpstorm ★43](https://github.com/netresearch/jumpstorm)
* [keybase ★6](https://github.com/rbirnie/oh-my-zsh-keybase) - Completions for [keybase](https://keybase.io/docs/command_line).
* [newman](https://github.com/selop/newman-autocomplete) - provides autocompletion for the [Newman CLI ★1708](https://github.com/postmanlabs/newman).
* [nix-zsh-completions ★27](https://github.com/spwhitt/nix-zsh-completions) - Completions for [nix](https://nixos.org/nix/), [NixOS](https://nixos.org/), and [NixOps](http://nixos.org/nixops/).
* [npm-run.plugin.zsh ★20](https://github.com/akoenig/npm-run.plugin.zsh) - Autocompletion support for `npm run`.
* [oh-my-zsh-nova ★6](https://github.com/rbirnie/oh-my-zsh-nova) - Provides auto-complete for nova.
* [oh-my-zsh-spring-boot-plugin ★8](https://github.com/linux-china/oh-my-zsh-spring-boot-plugin) - Adds autocompletions for [spring-boot](http://projects.spring.io/spring-boot/) commands.
* [oh-my-zsh_razor_plugin](https://github.com/dalang/oh-my-zsh_razor_plugin) - Provides autocomplete for [Razor ★17](https://github.com/puppetlabs/Razor).
* [parallels-zsh-plugin ★6](https://github.com/benclark/parallels-zsh-plugin) - Add completions for Parallels desktop.
* [pebble-zsh-completion ★11](https://github.com/Neal/pebble-zsh-completion) - completion script for [pebble](https://developer.getpebble.com/guides/publishing-tools/pebble-tool).
...
* [surf.plugin.zsh ★2](https://github.com/markussom/surf.plugin.zsh) - Add completions for surf.
* [test-kitchen-zsh-plugin ★3](https://github.com/pelletiermaxime/test-kitchen-zsh-plugin) - Add completions for [Test Kitchen](http://kitchen.ci/).
...
* [vert.x-omz-plugin ★0](https://github.com/davidafsilva/vert.x-omz-plugin) - Provides autocomplete features for the [vertx](http://vertx.io/) command.
* [zsh-_url-httplink ★2](https://github.com/Valodim/zsh-_url-httplink) - Extends zsh's \_urls completion, allowing it to complete urls from html pages.
* [zsh-better-npm-completion ★51](https://github.com/lukechilds/zsh-better-npm-completion) - Better completion for `npm`.
* [zsh-cabal-completion ★0](https://github.com/ehamberg/zsh-cabal-completion) - Add tab completion for cabal.
* [zsh-completions ★1560](https://github.com/zsh-users/zsh-completions) - A collection of extra completions for ZSH.
* [zsh-ipfs ★3](https://github.com/aramboi/zsh-ipfs) - Completions for the [Interplanetary File System](https://ipfs.io).
* [zsh-packer ★2](https://github.com/wakeful/zsh-packer) - Adds tab completion for packer.
* [zsh-pandoc-completion ★6](https://github.com/srijanshetty/zsh-pandoc-completion) - Pandoc completion plugin.
* [zsh-pip-completion ★8](https://github.com/srijanshetty/zsh-pip-completion) - Autocompletion plugin for pip.
* [zsh-ssh-agent ★0](https://github.com/bobsoppe/zsh-ssh-agent) - Manage ssh-agent
* [zsh.plugin.haxelib ★1](https://github.com/tong/zsh.plugin.haxelib) - Completions for haxelib.

## Themes

If you're using [Antigen](https://github.com/zsh-users/antigen), you can test these themes in a running zsh with `antigen theme githubuser/repo`. If you're using [zgen ★739](https://github.com/tarjoilija/zgen), add them to your `init.zsh` with `zgen load githubuser/reponame`.

* [aaron-zsh-theme ★3](https://github.com/aaronjamesyoung/aaron-zsh-theme) - Based on the Sorin theme.
...
* [agnosterAfro](https://github.com/afrozalm/agnosterAfro) - Based on [Powerline](https://github.com/Lokaltog/vim-powerline) and [Agnoster Theme](https://gist.github.com/agnoster/3712874) and inspired by the [agnosterzak ★83](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme).
* [agnosterzak ★83](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme) - Based on Agnoster, shows battery life, date & time, git status, current directory and user & host information.
* [alien-minimal ★5](https://github.com/eendroroy/alien-minimal) - Minimalist Zsh theme with git status displayed.
* [alien ★5](https://github.com/eendroroy/alien) - Powerline-esque Zsh theme that shows git branch and the exit code of the last command.
* [alpharized ★6](https://github.com/NicoSantangelo/Alpharized) - Optimized to work with [solarized](http://ethanschoonover.com/solarized) dark. It's a modified version of the [avit theme](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/avit.zsh-theme).
* [angry fly ★2](https://github.com/russjohnson/angry-fly-zsh) - Shows git information in right hand prompt.
...
* [avit-d2k ★6](https://github.com/fdaciuk/avit-da2k) - Based on Avit, with small changes.
* [bandit ★0](https://github.com/Holger-Will/zsh_bandit) - Another Powerline variant.
* [bashi](https://github.com/eli-oat/bashi) - Optimized for Ahmet Sülek's [Flat UI Terminal Theme](https://github.com/ahmetsulek/flat-terminal) and Pasquale D'Silva's [Saturn Terminal Theme ★69](https://github.com/psql/saturn-colors).
* [bilibili ★5](https://github.com/jingjinghack/bilibili-zshtheme) - BiliBili Theme
* [bklyn](https://github.com/gporrata/bklyn-zsh) - Variant of [Powerlevel9k ★1828](https://github.com/bhilburn/powerlevel9k) with customizations applied.
...
* [bureau ★11](https://github.com/isqua/bureau) - A clear and informative two-lined prompt. Includes git status optimized for large repositories.
* [candy-light ★1](https://github.com/RanaExMachina/oh-my-zsh-candy-light) - Light version of the candy theme.
* [carcassoid ★0](https://github.com/denmord/carcassoid-zsh-theme) - Easily customizable zsh theme.
* [charged ★4](https://github.com/robwierzbowski/charged-zsh-theme) - A zsh prompt optimized for the solarized dark terminal theme.
* [chi](https://github.com/andela-abankole/chi) - A zsh theme optimized for iTerm users on OS X.
* [ciacho ★1](https://github.com/Ciacho/ciacho-ohmyzsh-theme) - Based on Agnoster
...
* [cobalt2 ★498](https://github.com/wesbos/Cobalt2-iterm) - Wes Bos' Cobalt 2 theme for ZSH and iTerm 2.
* [codemachine ★3](https://github.com/CodeMonkeyMike/ZshTheme-CodeMachine) - Codemachine theme.
* [cordial ★8](https://github.com/stevelacy/cordial-zsh-theme) - Clean and effective zsh theme with git and npm support.
* [cute-theme ★13](https://github.com/dogrocker/oh-my-zsh-powerline-cute-theme) - An OSX oh-my-zsh shell theme with Cute emoji based on the Powerline Vim plugin.
* [darkblood-modular ★0](https://github.com/InAnimaTe/darkblood-modular) - This version of the popular [darkblood](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/darkblood.zsh-theme) theme has been enhanced with a near complete rewrite enabling modularity and a few new features.
...
* [dracula ★12](https://github.com/dracula/zsh) - A dark theme for Atom, Alfred, Chrome DevTools, iTerm, Sublime Text, Textmate, Terminal.app, Vim, Xcode, Zsh.
...
* [excess ★0](https://github.com/davydovanton/excess.zsh-theme) - Simple zsh color theme.
...
* [filthy ★9](https://github.com/molovo/filthy) - A disgustingly clean ZSH prompt
* [friendly-fiesta ★0](https://github.com/bruino/friendly-fiesta) - Fork of terminal-party theme.
* [frisk-arrow ★0](https://github.com/BakeRolls/frisk-arrow) - A theme based on the [frisk](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/frisk.zsh-theme) oh-my-zsh-theme.
...
* [furio ★16](https://github.com/hectorpalmatellez/furio-theme) - Fork of the Cloud oh-my-zsh theme. with different colors and emojis.
* [garrett ★85](https://github.com/chauncey-garrett/zsh-prompt-garrett) - Prezto prompt with the information you need the moment you need it.
...
* [gitsome](https://github.com/mtully/gitsome) - Super simple prompt with git info, optimized for the [Flat Terminal ★499](https://github.com/ahmetsulek/flat-terminal) color scheme.
...
* [glimmer ★1](https://github.com/martnu/glimmer) - Includes git branch, time and user@host.
* [hacker-quotes ★9](https://github.com/oldratlee/hacker-quotes) - Outputs a hacker quote randomly when you open a terminal.
* [hackersaurus](https://github.com/bhilburn/hackersaurus) - A theme with git status and exit code of last command run embedded in the prompt. Related to [powerlevel9k ★1828](https://github.com/bhilburn/powerlevel9k).
* [haribo ★3](https://github.com/haribo/omz-haribo-theme) - Simple git status + timestamp in prompt.
...
* [honukai-iterm-zsh ★783](https://github.com/oskarkrawczyk/honukai-iterm-zsh) - Honukai theme and colors for oh-my-zsh and iTerm.
...
* [hyperzsh ★148](https://github.com/tylerreckart/hyperzsh) - Gives you a comprehensive overview of the branch you're working on and the status of your repository without cluttering your terminal.
* [iggy ★10](https://github.com/eugenk/zsh-prompt-iggy) - A super happy awesome Powerline-style, Git-aware **prezto only** theme.
* [igorsilva ★2](https://github.com/igor9silva/zsh-theme) - Shows current directory, customizable delimiter, current branch, git status.
...
* [intheloop-powerline ★0](https://github.com/zyphrus/intheloop-powerline) - An extension of the intheloop theme to use powerline fonts.
* [itg ★28](https://github.com/itsthatguy/itg.zsh-theme) - itsthatguy's theme.
* [jcl-zsh-theme ★2](https://github.com/jasonlewis/jcl-zsh-theme) - Loosely based on the ys theme.
...
* [klendathu ★0](https://github.com/kegonomics/klendathu) - Uses Powerline iconsolas.
* [lagune ★0](https://github.com/noplay/lagune) - a minimal zsh theme.
* [lambda-pure ★18](https://github.com/marszall87/lambda-pure) - A minimal zsh theme, based on Pure, with added NodeJS version.
* [lambda ★225](https://github.com/halfo/lambda-mod-zsh-theme) - A zsh theme optimized for git users who use unicode-compatible fonts and terminal applications.
* [lazyprodigy ★0](https://github.com/drewlustro/lazyprodigy-zsh-theme) - Optimized for dark terminals, has variants for local and remote systems.
* [lime ★10](https://github.com/yous/lime) - Simple standalone Zsh theme.
...
* [megaprompt](https://github.com/willghatch/zsh-megaprompt) - A maximalist prompt including keyboard mode, ownership info, and other contextual info, with λ as the prompt character. Requires the [hooks ★14](https://github.com/willghatch/zsh-hooks) plugin.
...
* [molokai-powerline-zsh ★5](https://github.com/prikhi/molokai-powerline-zsh) - Based on [agnoster](https://gist.github.com/agnoster/3712874).
...
* [nanofish ★1](https://github.com/tweekmonster/nanofish) - Adds fish-style directory prompt to nanotech theme.
* [neat](https://github.com/andrepolischuk/neat) - Minimalistic prompt inspired by [odin](https://github.com/tylerreckart/Odin) and [pure ★3242](https://github.com/sindresorhus/pure).
...
* [odin ★60](https://github.com/tylerreckart/odin) - Odin is a git-flavored zsh theme.
* [oh-my-git ★2458](https://github.com/arialdomartini/oh-my-git) - An opinionated prompt for bash and zsh.
...
* [oh-my-zsh-node-theme ★25](https://github.com/skuridin/oh-my-zsh-node-theme) - OMZ's node theme.
* [oh-my-zsh-robbl ★5](https://github.com/robbl/oh-my-zsh-config) - Shows the git/svn status including the time since last commit, rvm status in prompt.
...
* [phi φ](https://github.com/LasaleFamine/phi-zsh-theme) - A clean and simple theme for ZSH inspired and forked from [Lambda (Mod) ZSH Theme ★225](https://github.com/halfo/lambda-mod-zsh-theme).
* [planet](https://github.com/aphlor/planet-zsh) - A slimmed down version of [steef](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/steeef.zsh-theme) from [oh-my-zsh ★52892](https://github.com/robbyrussell/oh-my-zsh).
* [platypus ★0](https://github.com/fdv/platypus) - Platypus is a simple and convenient theme for oh-my-zsh used by Frédéric de Villamil.
* [poncho ★4](https://github.com/RainyDayMedia/oh-my-zsh-poncho) - RDM's basic oh-my-zsh custom theme.
* [powerless ★9](https://github.com/martinrotter/powerless) - Tiny & simple pure ZSH prompt inspired by powerline.
* [powerlevel9k ★1828](https://github.com/bhilburn/powerlevel9k) - A very flexible theme based on the well-known agnoster-theme with support for various VCS, AWS, rbenv, virtualenv, etc.
...
* [predawn-shell ★20](https://github.com/jamiewilson/predawn-shell) - Theme for dark terminal themes.
* [prezto-cloud-prompt ★0](https://github.com/klaude/prezto-cloud-prompt) - Prezto port of oh-my-zsh's cloud prompt.
...
* [punctual](https://github.com/dannynimmo/punctual-zsh-theme) - Easily customizable, influenced by [spaceship ★570](https://github.com/denysdovhan/spaceship-zsh-theme).
* [pure ★3242](https://github.com/sindresorhus/pure) - Pretty, minimal and fast ZSH prompt.
...
* [remiii ★5](https://github.com/Remiii/remiii.zsh-theme) - Based on agnoster, optimized for solarized terminal themes.
...
* [shellder ★125](https://github.com/simnalamburt/shellder) - Minimal theme with git branch display. Requires a powerline font.
* [sinon ★0](https://github.com/k-kinzal/oh-my-zsh-sinon-theme) - k-kinzal's sinon theme.
* [sk9-zsh ★0](https://github.com/skeiter9/sk9-zsh) - Skeiter9's zsh theme.
...
* [slimline ★13](https://github.com/mgee/slimline) - Minimal, fast and elegant ZSH prompt. Displays the right information at the right time.
* [smiley ★4](https://github.com/gsamokovarov/smiley.zsh-theme) - A prompt with happy and sad faces.
* [solarized-powerline ★4](https://github.com/houjunchen/solarized-powerline) - Solarized powerline-style theme for zsh.
* [solarizsh ★3](https://github.com/paddykontschak/Solarizsh) - Color fix for robbyrussell's oh-my-zsh theme to work with [Solarized](http://ethanschoonover.com/solarized).
* [spaceship ★570](https://github.com/denysdovhan/spaceship-zsh-theme) - A zsh theme with git, nvm, rvm/rbenv/chruby, python, ssh and other useful indicators.
...
* [statusline ★31](https://github.com/el1t/statusline) - A responsive zsh theme that provides informational segments when you need them.
* [sugarfree](https://github.com/cbrock/sugar-free) - Based on the [Pure ★3242](https://github.com/sindresorhus/pure) and [Candy](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/candy.zsh-theme) themes.
* [tahuri ★0](https://github.com/Tahuri/oh-my-zshel-theme-tahuri) - Zsh theme for Arch Linux.
* [the-time-lord ★0](https://github.com/jhwhite/the-time-lord) - A theme based on gallifrey.
* [theme-line ★0](https://github.com/yw9381/oh-my-zsh_theme_line) - Colorful theme with Git status.
...
* [tvline ★2](https://github.com/thvitt/tvline) - Derived from [agnoster's theme](https://gist.github.com/agnoster/3712874), adds powerline font enhancements.
...
* [vinhnx ★7](https://github.com/vinhnx/vinhnx.zsh-theme) - Modified from themes/mgutz.zsh-theme.Looks great when using with Solarized color scheme.
* [wang-iterm-zsh ★5](https://github.com/0532/wang-iterm-zsh) - based on the 0532 theme.
* [wild-cherry ★276](https://github.com/mashaal/wild-cherry) - A fairy-tale inspired theme for Zsh, iTerm, Sublime, Atom, & Mou.
...
* [yuki ★1](https://github.com/yuki-torii/yuki-zsh-theme) - dark optimized ZSH theme.
* [z4rr3t ★1](https://github.com/inimicus/z4rr3t) - Based on sindresorhus' pure theme.
* [zemm-blinks ★8](https://github.com/aranasaurus/zemm-blinks.zsh-theme) - Customized version of oh-my-zsh blinks with mercurial support and other changes.
* [zero ★11](https://github.com/arlimus/zero.zsh) - Zero's theme & plugin.
* [zeta ★41](https://github.com/skylerlee/zeta-zsh-theme) - Shows username, git information, machine name, current working directory.
* [zsh-blackrain ★4](https://github.com/ginfuru/zsh-blackrain) - git-aware theme.
* [zsh-megaprompt](https://github.com/willghatch/zsh-megaprompt) - A maximalist prompt including keyboard mode, ownership info, and other contextual info, with λ as the prompt character. Requires the [hooks ★14](https://github.com/willghatch/zsh-hooks) plugin.
* [zsh-prompt-powerline ★46](https://github.com/Valodim/zsh-prompt-powerline) - A fairly heavyweight zsh prompt, based on the powerline font from the popular eponymous vim plugin, which works well for a dark background.
* [zsh-theme-nerdish ★2](https://github.com/nyarla/zsh-theme-nerdish) - prompt theme for zsh with Nerd Fonts.
...
* [zshcomrade ★3](https://github.com/landongn/zshcomrade) - A ZSH theme, comrade!

### Fonts

Some of the themes listed here require Powerline-compatible fonts, here are a few:

* [Awesome Terminal Fonts ★864](https://github.com/gabrielelana/awesome-terminal-fonts) - A family of fonts that includes some nice monospaced Icons.
* [Fantasque Awesome Font ★16](https://github.com/ztomer/fantasque_awesome_powerline) - A nice monospaced font, patched with Font-Awesome, Octoicons and Powerline-Glyphs.
* [Fantasque-sans ★3094](https://github.com/belluzj/fantasque-sans) - Another powerline font.
...
* [Powerline patched font collection ★8043](https://github.com/powerline/fonts) - A collection of a dozen or so fonts patched to include powerline gylphs.
...
* [zunit ★21](https://github.com/molovo/zunit) - A powerful unit testing framework for ZSH

### Other Useful Lists

* [awesome-devenv ★749](https://github.com/jondot/awesome-devenv) - A curated list of awesome tools, resources and workflow tips making an awesome development environment
* [awesome-sysadmin ★5106](https://github.com/n1trux/awesome-sysadmin) - A curated list of awesome open source sysadmin resources
* [Terminals Are Sexy ★4694](https://github.com/k4m4/terminals-are-sexy) - A curated list for CLI lovers.

Find other useful awesome-* lists at the [awesome collection ★57421](https://github.com/sindresorhus/awesome)
