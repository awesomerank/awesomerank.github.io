...
<p align="center">
	This list is a copy of <a href="https://github.com/unixorn/awesome-zsh-plugins">https://github.com/unixorn/awesome-zsh-plugins</a> with ranks
</p>
---
...
### [alf ★27 ⏳1Y](https://github.com/psyrendust/alf)
...
* [ZSH Pony ★79 ⏳5Y](https://github.com/mika/zsh-pony) - Covers customizing ZSH without a framework.
...
* [auto-ls ★1](https://github.com/desyncr/auto-ls) - Automatically `ls` when cding to a new directory.
...
* [calc.plugin.zsh ★22 ⏳1Y](https://github.com/arzzen/calc.plugin.zsh) - A calculator for zsh.
* [caniuse.plugin.zsh ★11 ⏳1Y](https://github.com/walesmd/caniuse.plugin.zsh) - Add [Can I Use...](http://caniuse.com) support to ZSH.
...
* [cdr ★4 ⏳1Y](https://github.com/willghatch/zsh-cdr) - Easy setup of cdr for zsh.
...
* [czhttpd ★22 ⏳1Y](https://github.com/jsks/czhttpd) - A simple http server written in 99.9% pure zsh.
* [deer ★186](https://github.com/Vifon/deer) - A file navigator for zsh heavily inspired by [ranger](http://ranger.nongnu.org/).
* [depot-tools ★0 ⏳3Y](https://github.com/jgrowl/depot_tools) - Simple oh-my-zsh plugin for installing the chromium depot_tools. Installing this plugin will put all of the chromium depot_tools in your path automatically.
* [docker-aliases ★2](https://github.com/webyneter/docker-aliases) Docker aliases for everyday use.
* [docker-compose ★21 ⏳1Y](https://github.com/sroze/docker-compose-zsh-plugin) Show docker container status in your prompt.
...
* [exercism ★3 ⏳1Y](https://github.com/fabiokiatkowski/exercism.plugin.zsh) - A plugin for [exercism.io](http://exercism.io/).
...
* [goenv ★3 ⏳1Y](https://github.com/bbenne10/goenv) - Antigen plugin to manage `$GOPATH` similarly to Python's virtualenvwrapper.
...
* [mac-packaging ★1 ⏳1Y](https://github.com/Temikus/mac-packaging) - A set of common functions used for enterprise Mac packaging with Munki.
...
* [nvm-auto-use ★2 ⏳1Y](https://github.com/tomsquest/nvm-auto-use.zsh) - calls `nvm use` automatically whenever you enter a directory that contains an `.nvmrc` file with a string telling nvm which node to use.
...
* [opp.zsh ★224 ⏳1Y](https://github.com/hchbaw/opp.zsh) - Vim's text-objects-ish for zsh.
...
* [safe-paste ★5 ⏳2Y](https://github.com/oz/safe-paste) - A safe-paste plugin. See <[http://cirw.in/blog/bracketed-paste](http://cirw.in/blog/bracketed-paste).
...
* [smart-cd ★12 ⏳1Y](https://github.com/dbkaplun/smart-cd) - Runs `ls` and `git status` after chpwd.
* [snippets ★15 ⏳1Y](https://github.com/willghatch/zsh-snippets) - Command line snippet expansion.
...
* [vox ★4 ⏳1Y](https://github.com/andrewbonnington/vox.plugin.zsh) - An oh-my-zsh plugin to control [VOX](http://coppertino.com/vox/mac), a lightweight full-featured audio player for OS X that can play a variety of formats including FLAC and Ogg Vorbis.
...
* [zsh-bash ★12 ⏳2Y](https://github.com/chrissicool/zsh-bash) - Makes ZSH more Bash compatible. It redefines the source command to act more like Bash does. It also enables Bash completions.
* [zsh-bd ★210 ⏳1Y](https://github.com/Tarrasch/zsh-bd) - Jump back to a specific directory, without doing `cd ../../..`.
...
* [zsh-functional ★70 ⏳2Y](https://github.com/Tarrasch/zsh-functional) - ZSH higher order functions.
...
* [zsh-plugin-vscode ★3 ⏳1Y](https://github.com/wuotr/zsh-plugin-vscode) - Plugin for Visual Studio Code, a text editor for Mac OS X, Windows, and Linux.
...
* [zsh-syntax-highlighting-filetypes ★52 ⏳2Y](https://github.com/trapd00r/zsh-syntax-highlighting-filetypes) - zsh syntax highlighting with dircolors in realtime.
...
* [zsh-t32 ★1 ⏳2Y](https://github.com/chrissicool/zsh-t32) - Plugin for the Lauterbach Trace32 toolset. It automatically registers fonts and sets all necessary environment variables to run the t32 toolset.
...
* [brew-services ★12 ⏳1Y](https://github.com/vasyharan/zsh-brew-services) - Completion plugin for homebrew services.
...
* [gcloud-zsh-completion ★39 ⏳2Y](https://github.com/littleq0903/gcloud-zsh-completion) - Add completions for the Google Cloud SDK.
* [gentoo-zsh-completions ★10 ⏳1Y](https://github.com/gentoo/gentoo-zsh-completions) - providing Zsh completion support to various Gentoo tools that lack completion scripts upstream.
* [git-flow-completion ★1789 ⏳1Y](https://github.com/bobthecow/git-flow-completion) - ZSH completion support for git-flow.
...
* [gulp-autocompletion-zsh ★10 ⏳1Y](https://github.com/srijanshetty/gulp-autocompletion-zsh) - Autocompletion for gulp.
...
* [oh-my-zsh_razor_plugin](https://github.com/dalang/oh-my-zsh_razor_plugin) - Provides autocomplete for [Razor ★17 ⏳2Y](https://github.com/puppetlabs/Razor).
...
* [test-kitchen-zsh-plugin ★3 ⏳2Y](https://github.com/pelletiermaxime/test-kitchen-zsh-plugin) - Add completions for [Test Kitchen](http://kitchen.ci/).
...
* [zsh-pip-completion ★8 ⏳2Y](https://github.com/srijanshetty/zsh-pip-completion) - Autocompletion plugin for pip.
...
* [charged ★4 ⏳2Y](https://github.com/robwierzbowski/charged-zsh-theme) - A zsh prompt optimized for the solarized dark terminal theme.
...
* [cute-theme ★13 ⏳2Y](https://github.com/dogrocker/oh-my-zsh-powerline-cute-theme) - An OSX oh-my-zsh shell theme with Cute emoji based on the Powerline Vim plugin.
...
* [gitsome](https://github.com/mtully/gitsome) - Super simple prompt with git info, optimized for the [Flat Terminal ★499 ⏳4Y](https://github.com/ahmetsulek/flat-terminal) color scheme.
...
* [iggy ★10 ⏳2Y](https://github.com/eugenk/zsh-prompt-iggy) - A super happy awesome Powerline-style, Git-aware **prezto only** theme.
...
* [oh-my-zsh-node-theme ★25 ⏳1Y](https://github.com/skuridin/oh-my-zsh-node-theme) - OMZ's node theme.
...
* [solarizsh ★3 ⏳4Y](https://github.com/paddykontschak/Solarizsh) - Color fix for robbyrussell's oh-my-zsh theme to work with [Solarized](http://ethanschoonover.com/solarized).
...
* [tvline ★2 ⏳1Y](https://github.com/thvitt/tvline) - Derived from [agnoster's theme](https://gist.github.com/agnoster/3712874), adds powerline font enhancements.
...
* [zeta ★41 ⏳1Y](https://github.com/skylerlee/zeta-zsh-theme) - Shows username, git information, machine name, current working directory.
...
* [zshcomrade ★3 ⏳4Y](https://github.com/landongn/zshcomrade) - A ZSH theme, comrade!
...
* [Fantasque Awesome Font ★16 ⏳2Y](https://github.com/ztomer/fantasque_awesome_powerline) - A nice monospaced font, patched with Font-Awesome, Octoicons and Powerline-Glyphs.
