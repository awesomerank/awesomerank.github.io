...
**Table of Contents**  *generated with [DocToc ★1450](https://github.com/thlorenz/doctoc)*
...
### [ansible-role-zsh ★44](https://github.com/viasite-ansible/ansible-role-zsh)
...
### [antigen-hs ★167](https://github.com/Tarrasch/antigen-hs)
...
### [antigen ★3348](https://github.com/zsh-users/antigen)
...
### [dotzsh ★132](https://github.com/dotphiles/dotzsh)

**Dotzsh** strives to be platform and version independent. Some functionality may be lost when running under older versions of zsh, but it should degrade cleanly and allow you to use the same setup on multiple machines of differing OSes without problems.

### [fresh ★806](https://github.com/freshshell/fresh)
...
### [zim ★888](https://github.com/Eriner/zim)
...
### [zplug ★1717](https://github.com/zplug/zplug)

**:hibiscus: Zplug** is a next-generation zsh plugin manager.

### [zplugin ★61](https://github.com/zdharma/zplugin)
...
**ZPM** ( Zsh plugin manager ) is a plugin manager for [zsh](http://www.zsh.org/) similar to vim-plug. ZPM plugins are compatible with [oh-my-zsh ★57655](https://github.com/robbyrussell/oh-my-zsh). ZPM runs on Linux, Android, FreeBSD and OS X.

### [ZR ★18](https://github.com/jedahan/zr)

**ZR** is a zsh plugin manager written in Rust.

### [ztanesh ★240](https://github.com/miohtama/ztanesh)

**Ztanesh** aims to improve your UNIX command line experience and productivity with the the configuration provided by the ztanesh project: the tools will make your shell more powerful and easier to use.

### [zulu ★49](https://github.com/zulu-zsh/zulu)
...
* [anyframe ★109](https://github.com/mollifier/anyframe) - A peco/percol/fzf wrapper plugin for zsh.
...
* [auto-fu.zsh ★330](https://github.com/hchbaw/auto-fu.zsh) - Automatic complete-word and list-choices. Originally incr-0.2.zsh by y.fujii <y-fujii at mimosa-pudica.net>.
...
* [autojump ★5753](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line. Install autojump-zsh for best results.
...
* [blackbox ★3613](https://github.com/StackExchange/blackbox) - Stack Exchange's toolkit for storing keys/credentials securely in a git repository.
...
* [calc.plugin.zsh ★32 ⏳1Y](https://github.com/arzzen/calc.plugin.zsh) - A calculator for zsh.
...
* [deer ★194](https://github.com/Vifon/deer) - A file navigator for zsh heavily inspired by [ranger](http://ranger.nongnu.org/).
...
* [docker-run ★4](https://github.com/rawkode/zsh-docker-run) - Go back to running your commands "naturally", we'll handle the container.
...
* [elixir-oh-my-zsh ★79](https://github.com/gusaiani/elixir-oh-my-zsh) - Adds shortcuts for Elixir, IEX, Mix and Phoenix.
* [emoji-cli ★146](https://github.com/b4b4r07/emoji-cli) - :scream: Emoji completion on the command line.
* [enhancd ★698](https://github.com/b4b4r07/enhancd) - A simple tool that provides enhanced `cd` command.
...
* [fast-syntax-highlighting ★95](https://github.com/zdharma/fast-syntax-highlighting) - Optimized an improved `zsh-users/zsh-syntax-highlighting` – better response times, `zed/vared` can edit `10 kB` functions.
...
* [git-aliases.zsh ★30](https://github.com/peterhurford/git-aliases.zsh) - Creates a lot of useful aliases for combinations of commonly used git commands.
* [git-extra-commands ★172](https://github.com/unixorn/git-extra-commands) - Extra git helper scripts packaged as a plugin.
* [git-it-on.zsh ★41](https://github.com/peterhurford/git-it-on.zsh) - Adds ability to open a folder in your current branch on GitHub.
...
* [git-secret ★577](https://github.com/sobolevn/git-secret) - A bash-tool to store your private data inside a git repository.
* [gitfast ★3 ⏳2Y](https://github.com/tevren/gitfast-zsh-plugin) - Updated fork of oh-my-zsh gitfast plugin.
* [gitignore.plugin.zsh ★16](https://github.com/voronkovich/gitignore.plugin.zsh) - Plugin for creating `.gitignore` files.
...
* [gtm-terminal-plugin ★5](https://github.com/git-time-metric/gtm-terminal-plugin) - terminal plugin for [git time metrics](https://github.com/git-time-metric/gtm/blob/master/README.md).
...
* [history-search-multi-word ★49](https://github.com/zdharma/history-search-multi-word) - syntax highlighted, multi-word history searcher for Zsh, bound to Ctrl-R, with advanced functions (e.g. bump of history entry to top of history).
* [history-sync ★20](https://github.com/wulfgarpro/history-sync) - An Oh My Zsh plugin for GPG encrypted, Internet synchronized Zsh history using Git.
...
* [iterm-tab-colors ★7](https://github.com/tysonwolker/iterm-tab-colors) - Automatically changes iTerm tab color based on the current working directory
...
* [jhipster-oh-my-zsh-plugin ★14](https://github.com/jhipster/jhipster-oh-my-zsh-plugin) - Adds commands for [jHipster](https://jhipster.github.io/).
...
* [noreallyjustfuckingstopalready ★265 ⏳1Y](https://github.com/eventi/noreallyjustfuckingstopalready) - OS X users know the pain of trying to figure out what command actually flushes the DNS cache on their version of OS X, and this plugin makes that annoyance go away.
...
* [oh-my-zsh-reminder ★10](https://github.com/AlexisBRENON/oh-my-zsh-reminder) - A plugin which displays reminders above every prompt.
...
* [opp.zsh ★221 ⏳2Y](https://github.com/hchbaw/opp.zsh) - Vim's text-objects-ish for zsh.
...
* [revolver ★33](https://github.com/molovo/revolver) - A progress spinner for ZSH scripts.
...
* [solarized-man ★8](https://github.com/zlsun/solarized-man) - A modified version of oh-my-zsh's plugin colored-man-pages, optimized for solarized dark theme in terminal.
...
* [sysadmin-util ★423 ⏳1Y](https://github.com/skx/sysadmin-util) - Steve Kemp's collection of tool scripts for sysadmins.
...
* [tipz](https://github.com/molovo/tipz) - Displays your alias if you have an alias for the command you just ran (Similar to [alias-tips ★186](https://github.com/djui/alias-tips)).
...
* [warhol](https://github.com/unixorn/warhol.plugin.zsh) - Configures colorization with [grc ★376](https://github.com/garabik/grc).
* [watson.zsh](https://github.com/bcho/Watson.zsh) - A plugin for [watson ★760](https://github.com/TailorDev/Watson).
* [wd ★169](https://github.com/mfaerevaag/wd) - Warp directory lets you jump to custom directories in zsh, without using cd. Why? Because cd seems inefficient when the folder is frequently visited or has a long path.
* [yeoman-zsh-plugin ★34 ⏳1Y](https://github.com/edouard-lopez/yeoman-zsh-plugin) - Edouard Lopez's Yeoman plugin for oh-my-zsh, compatible with yeoman version ≥1.0 (includes options and command auto-completion).
* [zaw ★374](https://github.com/zsh-users/zaw) - ZSH anything.el-like widget.
* [zce ★25](https://github.com/hchbaw/zce.zsh) - Vim’s EasyMotion / Emacs’s ace-jump-mode for ZSH.
* [zconvey ★9](https://github.com/zdharma/zconvey) - Adds ability to send commands to other Zsh sessions, you can use this to `cd $PWD` on all active Zshells, for example.
* [zedzsh](https://github.com/eendroroy/zed-zsh) - A simple wrapper for [z ★7044](https://github.com/rupa/z) to install as zsh plugin.
...
* [zsh-256color ★35 ⏳1Y](https://github.com/chrissicool/zsh-256color) - Enhances the terminal environment with 256 colors. It looks at the chosen TERM environment variable and sees if there is respective ncurses' terminfo with 256 colors available. The result is a multicolor terminal, if available.
...
* [zsh-async ★148](https://github.com/mafredri/zsh-async) - Library for running asynchronous tasks in zsh without requiring any external tools.
* [zsh-autoenv ★244](https://github.com/Tarrasch/zsh-autoenv) - If a directory contains a `.env` file, it will automatically be executed when you cd into it.
* [zsh-autopair ★54](https://github.com/hlissner/zsh-autopair) - A ZSH plugin for auto-closing, deleting and skipping over matching delimiters.
* [zsh-autosuggestions ★3203](https://github.com/zsh-users/zsh-autosuggestions) - [Fish](https://fishshell.com/)-like fast/unobtrusive autosuggestions for ZSH.
* [zsh-autoswitch-virtualenv ★37](https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv) - ZSH plugin to automatically switch python virtualenvs when traversing directories.
...
* [zsh-bd ★223](https://github.com/Tarrasch/zsh-bd) - Jump back to a specific directory, without doing `cd ../../..`.
* [zsh-carthage](https://github.com/cfdrake/zsh-carthage) - Provides completions and aliases for use with [Carthage ★9937](https://github.com/Carthage/Carthage).
...
* [zsh-hints ★27 ⏳3Y](https://github.com/joepvd/zsh-hints) - Display glob and parameter flags and other non completable info right under your editing buffer.
* [zsh-histdb ★36](https://github.com/larkery/zsh-histdb) - Stores your history in an SQLite database.
* [zsh-history-substring-search ★611](https://github.com/zsh-users/zsh-history-substring-search) - Needs to be loaded after zsh-syntax-highlighting, or they'll both break. You'll also need to bind keys to its functions, details are in the README.md.
* [zsh-history ★39](https://github.com/b4b4r07/zsh-history) - Extend history so that it can be queried by SQL.
* [zsh-interactive-cd ★49](https://github.com/changyuheng/zsh-interactive-cd) - Fish-like interactive tab completion for `cd`.
* [zsh-iterm-touchbar ★105](https://github.com/iam4x/zsh-iterm-touchbar) - Display iTerm2 feedback in the MacbookPro TouchBar (Current directory, git branch & status).
...
* [zsh-manydots-magic ★20](https://github.com/knu/zsh-manydots-magic) - A zle tweak for emulating `...'==`../..' etc.
...
* [zsh-navigation-tools ★143](https://github.com/psprint/zsh-navigation-tools) - Adds `htop`-like `kill`, directory bookmarks browser, multi-word incremental history searcher and more.
* [zsh-notify ★195](https://github.com/marzocchi/zsh-notify) - A plugin for the Z shell (on OS X and Linux) that posts desktop notifications when a command terminates with a non-zero exit status or when it took more than 30 seconds to complete, if the terminal application is in the background (or the command's terminal tab is inactive).
* [zsh-nvm ★290](https://github.com/lukechilds/zsh-nvm) - ZSH plugin for installing, updating and loading nvm.
...
* [zsh-peco-history ★13](https://github.com/jimeh/zsh-peco-history) - Search shell history with Peco when pressing ctrl+r.
...
* [zsh-syntax-highlighting ★3857](https://github.com/zsh-users/zsh-syntax-highlighting) - Add syntax highlighting to your ZSH. Make sure you load this _before_ zsh-users/zsh-history-substring-search or they will both break.
...
* [zsh-you-should-use ★106](https://github.com/MichaelAquilina/zsh-you-should-use)- ZSH plugin that reminds you to use those aliases you defined.
* [zshmarks ★127](https://github.com/jocelynmallon/zshmarks) - A port of Bashmarks (by Todd Werth), a simple command line bookmarking plugin, for oh-my-zsh.
...
* [docker-enter-completion](https://github.com/primait/docker-enter-completion) - Command completion for [docker-enter ★1771 ⏳1Y](https://github.com/jpetazzo/nsenter).
* [docker-zsh-completion ★202](https://github.com/felixr/docker-zsh-completion) - Add completions for docker.
* [dropbox](https://github.com/horosgrisa/zsh-dropbox) - A dropbox plugin for Zsh that provides `dropbox-cli` and `dropbox-uploader` commands.
...
* [gcloud-zsh-completion ★43 ⏳2Y](https://github.com/littleq0903/gcloud-zsh-completion) - Add completions for the Google Cloud SDK.
...
* [git-flow-completion ★1869 ⏳1Y](https://github.com/bobthecow/git-flow-completion) - ZSH completion support for git-flow.
...
* [newman](https://github.com/selop/newman-autocomplete) - Provides autocompletion for the [Newman CLI ★1942](https://github.com/postmanlabs/newman).
* [nix-zsh-completions ★35](https://github.com/spwhitt/nix-zsh-completions) - Completions for [nix](https://nixos.org/nix/), [NixOS](https://nixos.org/), and [NixOps](http://nixos.org/nixops/).
...
* [zsh-completions ★1685](https://github.com/zsh-users/zsh-completions) - A collection of extra completions for ZSH.
...
* [agnosterAfro](https://github.com/afrozalm/agnosterAfro) - Based on [Powerline](https://github.com/Lokaltog/vim-powerline) and [Agnoster Theme](https://gist.github.com/agnoster/3712874) and inspired by the [agnosterzak ★93](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme).
* [agnosterzak ★93](https://github.com/zakaziko99/agnosterzak-ohmyzsh-theme) - Based on Agnoster, shows battery life, date & time, git status, current directory and user & host information.
* [alien-minimal ★6](https://github.com/eendroroy/alien-minimal) - Minimalist ZSH theme with git status displayed.
* [alien ★10](https://github.com/eendroroy/alien) - Powerline-esque ZSH theme that shows git branch and the exit code of the last command.
...
* [bklyn](https://github.com/gporrata/bklyn-zsh) - Variant of [Powerlevel9k ★2527](https://github.com/bhilburn/powerlevel9k) with customizations applied.
...
* [bronze](https://github.com/reujab/bronze) - A cross-shell customizable powerline-like prompt with icons written in go. Requires [nerd-fonts ★5063](https://github.com/ryanoasis/nerd-fonts).
...
* [cobalt2 ★565](https://github.com/wesbos/Cobalt2-iterm) - Wes Bos' Cobalt 2 theme for ZSH and iTerm 2.
...
* [gitsome](https://github.com/mtully/gitsome) - Super simple prompt with git info, optimized for the [Flat Terminal ★530 ⏳4Y](https://github.com/ahmetsulek/flat-terminal) color scheme.
...
* [hacker-quotes ★13](https://github.com/oldratlee/hacker-quotes) - Outputs a hacker quote randomly when you open a terminal.
...
* [hyperzsh ★196](https://github.com/tylerreckart/hyperzsh) - Gives you a comprehensive overview of the branch you're working on and the status of your repository without cluttering your terminal.
...
* [minimal ★47 ⏳1Y](https://github.com/S1cK94/minimal) - S1ck94's minimal theme.
...
* [odin ★66](https://github.com/tylerreckart/odin) - Odin is a git-flavored ZSH theme.
* [oh-my-git ★2567](https://github.com/arialdomartini/oh-my-git) - An opinionated prompt for bash and ZSH.
...
* [oh-my-zsh-node-theme ★32 ⏳1Y](https://github.com/skuridin/oh-my-zsh-node-theme) - OMZ's node theme.
...
* [phi φ](https://github.com/LasaleFamine/phi-zsh-theme) - A clean and simple theme for ZSH inspired and forked from [Lambda (Mod) ZSH Theme ★266](https://github.com/halfo/lambda-mod-zsh-theme).
* [plain ★0](https://github.com/jimeh/plain.zsh-theme) - A plain and simple theme for ZSH which shows basic git information.
* [planet](https://github.com/aphlor/planet-zsh) - A slimmed down version of [steef](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/steeef.zsh-theme) from [oh-my-zsh ★57655](https://github.com/robbyrussell/oh-my-zsh).
...
* [shellder ★135](https://github.com/simnalamburt/shellder) - Minimal theme with git branch display. Requires a powerline font.
...
* [sugarfree](https://github.com/cbrock/sugar-free) - Based on the [Pure ★3705](https://github.com/sindresorhus/pure) and [Candy](https://github.com/BinaryMuse/oh-my-zsh/blob/binarymuse/themes/candy.zsh-theme) themes.
...
* [ultimate](https://github.com/b4b4r07/ultimate) - Minimalist theme forked from [S1cK94/minimal ★47 ⏳1Y](https://github.com/S1cK94/minimal).
...
* [nerd fonts ★5063](https://github.com/ryanoasis/nerd-fonts) - Collection of over 20 patched fonts (over 2,000 variations) & FontForge font patcher python script for Powerline, Font Awesome, Octicons, Devicons, and Vim Devicons. Includes: Droid Sans, Meslo, Source Code, AnonymousPro, Hack, ProFont, Inconsolata, and many more.
...
* [awesome-devenv ★850](https://github.com/jondot/awesome-devenv) - A curated list of awesome tools, resources and workflow tips making an awesome development environment
* [awesome-sysadmin ★5511](https://github.com/n1trux/awesome-sysadmin) - A curated list of awesome open source sysadmin resources
* [Terminals Are Sexy ★5063](https://github.com/k4m4/terminals-are-sexy) - A curated list for CLI lovers.
