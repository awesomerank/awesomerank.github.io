...
* [CMetrics ★15](https://github.com/MetricsGrimoire/CMetrics) - Measures size and complexity for C files
...
* [flen ★31](https://github.com/lafolle/flen) - Get info on length of functions in a Go package
...
* [DesignPatternDetector ★60](https://github.com/Halleck45/DesignPatternDetector) - detection of design patterns in PHP code
...
* [Tuli ★161](https://github.com/ircmaxell/Tuli) - A static analysis engine
...
* [py-find-injection ★32](https://github.com/uber/py-find-injection) - find SQL injection vulnerabilities in Python code
...
<!--- * [pytype ★250](https://github.com/google/pytype) - a static type inferencer for Python code - commented out because it is very buggy and is not even installable from pypi --->
...
* [laser ★391](https://github.com/michaeledgar/laser) - Static analysis and style linter for Ruby code.
...
* [Docker Label Inspector ★64](https://github.com/garethr/docker-label-inspector) - Lint and validate Dockerfile labels
...
* [Specificity Graph ★559](https://github.com/pocketjoso/specificity-graph) - CSS Specificity Graph Generator
