...
5.  [neuraltalk ★4376](https://github.com/karpathy/neuraltalk) by Andrej Karpathy : numpy-based RNN/LSTM implementation
...
### Papers
*You can also find the most cited deep learning papers from [here ★11823](https://github.com/terryum/awesome-deep-learning-papers)*
...
10.  [The Best Machine Learning Tutorials On The Web ★355 ⏳6Y](https://github.com/josephmisiti/machine-learning-module)
11. [VGG Convolutional Neural Networks Practical](http://www.robots.ox.ac.uk/~vgg/practicals/cnn/index.html)
12. [TensorFlow tutorials ★4132](https://github.com/nlintz/TensorFlow-Tutorials)
13. [More TensorFlow tutorials ★3702](https://github.com/pkmital/tensorflow_tutorials)
13. [TensorFlow Python Notebooks ★15535](https://github.com/aymericdamien/TensorFlow-Examples)
14. [Keras and Lasagne Deep Learning Tutorials ★315](https://github.com/Vict0rSch/deep_learning)
15. [Classification on raw time series in TensorFlow with a LSTM RNN ★995](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition)
...
17. [TensorFlow-World ★3512](https://github.com/astorfi/TensorFlow-World)
...
134. [DeepMind QA Corpus ★893](https://github.com/deepmind/rc-data) - Textual QA corpus from CNN and DailyMail. More than 300K documents in total. [Paper](http://arxiv.org/abs/1506.03340) for reference.
...
136. [Open Images dataset ★1928](https://github.com/openimages/dataset) - Open Images is a dataset of ~9 million URLs to images that have been annotated with labels spanning over 6000 categories.
...
12.  [JavaNN ★1118](https://github.com/ivan-vasilev/neuralnetworks)
13.  [hebel ★1159 ⏳2Y](https://github.com/hannes-brt/hebel)
14.  [Mocha.jl ★943](https://github.com/pluskid/Mocha.jl)
...
18.  [Knet.jl ★353](https://github.com/denizyuret/Knet.jl)
19.  [Nvidia DIGITS - a web app based on Caffe ★2471](https://github.com/NVIDIA/DIGITS)
20.  [Neon - Python based Deep Learning Framework ★3212](https://github.com/NervanaSystems/neon)
...
25.  [char-rnn ★6608](https://github.com/karpathy/char-rnn)
...
39.  [Torchnet - Torch based Deep Learning Library ★910](https://github.com/torchnet/torchnet)
...
42.  [Lasagne - a lightweight library to build and train neural networks in Theano ★3225](https://github.com/Lasagne/Lasagne)
...
6.  [TorontoDeepLEarning convnet ★476 ⏳1Y](https://github.com/TorontoDeepLearning/convnet)
8.  [gfx.js ★118 ⏳1Y](https://github.com/clementfarabet/gfx.js)
...
23. [Face recognition with Google's FaceNet deep neural network. ★8034](https://github.com/cmusatyalab/openface)
...
26. [Proof of concept for loading Caffe models in TensorFlow ★1544](https://github.com/ethereon/caffe-tensorflow)
