...
---
# Awesome Deep Learning [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★69735](https://github.com/sindresorhus/awesome)
...
5.  [neuraltalk ★4443](https://github.com/karpathy/neuraltalk) by Andrej Karpathy : numpy-based RNN/LSTM implementation
...
### Papers
*You can also find the most cited deep learning papers from [here ★12188](https://github.com/terryum/awesome-deep-learning-papers)*
...
10.  [The Best Machine Learning Tutorials On The Web ★357 ⏳6Y](https://github.com/josephmisiti/machine-learning-module)
11. [VGG Convolutional Neural Networks Practical](http://www.robots.ox.ac.uk/~vgg/practicals/cnn/index.html)
12. [TensorFlow tutorials ★4249](https://github.com/nlintz/TensorFlow-Tutorials)
13. [More TensorFlow tutorials ★3800](https://github.com/pkmital/tensorflow_tutorials)
13. [TensorFlow Python Notebooks ★17176](https://github.com/aymericdamien/TensorFlow-Examples)
14. [Keras and Lasagne Deep Learning Tutorials ★321](https://github.com/Vict0rSch/deep_learning)
15. [Classification on raw time series in TensorFlow with a LSTM RNN ★1041](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition)
...
17. [TensorFlow-World ★3563](https://github.com/astorfi/TensorFlow-World)
...
134. [DeepMind QA Corpus ★911](https://github.com/deepmind/rc-data) - Textual QA corpus from CNN and DailyMail. More than 300K documents in total. [Paper](http://arxiv.org/abs/1506.03340) for reference.
...
136. [Open Images dataset ★2015](https://github.com/openimages/dataset) - Open Images is a dataset of ~9 million URLs to images that have been annotated with labels spanning over 6000 categories.
...
5.  [convetjs ★8123](https://github.com/karpathy/convnetjs)
5.  [Ccv](http://libccv.org/doc/doc-convnet/)
6.  [NuPIC](http://numenta.org/nupic.html)
7.  [DeepLearning4J](http://deeplearning4j.org/)
8.  [Brain ★7877](https://github.com/harthur/brain)
9.  [DeepLearnToolbox ★2675](https://github.com/rasmusbergpalm/DeepLearnToolbox)
10.  [Deepnet ★774 ⏳3Y](https://github.com/nitishsrivastava/deepnet)
11.  [Deeppy ★1164 ⏳1Y](https://github.com/andersbll/deeppy)
12.  [JavaNN ★1125](https://github.com/ivan-vasilev/neuralnetworks)
13.  [hebel ★1161 ⏳2Y](https://github.com/hannes-brt/hebel)
14.  [Mocha.jl ★953](https://github.com/pluskid/Mocha.jl)
15.  [OpenDL ★212 ⏳2Y](https://github.com/guoding83128/OpenDL)
16.  [cuDNN](https://developer.nvidia.com/cuDNN)
17.  [MGL](http://melisgl.github.io/mgl-pax-world/mgl-manual.html)
18.  [Knet.jl ★374](https://github.com/denizyuret/Knet.jl)
19.  [Nvidia DIGITS - a web app based on Caffe ★2563](https://github.com/NVIDIA/DIGITS)
20.  [Neon - Python based Deep Learning Framework ★3253](https://github.com/NervanaSystems/neon)
...
25.  [char-rnn ★6767](https://github.com/karpathy/char-rnn)
26.  [MatConvNet: CNNs for MATLAB ★839](https://github.com/vlfeat/matconvnet)
27.  [Minerva - a fast and flexible tool for deep learning on multi-GPU ★614 ⏳1Y](https://github.com/dmlc/minerva)
28.  [Brainstorm - Fast, flexible and fun neural networks. ★1268](https://github.com/IDSIA/brainstorm)
...
30.  [DMTK - Microsoft Distributed Machine Learning Tookit ★2272](https://github.com/Microsoft/DMTK)
...
34.  [Marvin - A Minimalist GPU-only N-Dimensional ConvNets Framework ★376](https://github.com/PrincetonVision/marvin)
...
39.  [Torchnet - Torch based Deep Learning Library ★911](https://github.com/torchnet/torchnet)
...
42.  [Lasagne - a lightweight library to build and train neural networks in Theano ★3259](https://github.com/Lasagne/Lasagne)
43.  [nolearn - wrappers and abstractions around existing neural network libraries, most notably Lasagne ★844](https://github.com/dnouri/nolearn)
44.  [Sonnet - a library for constructing neural networks by Google's DeepMind ★5407](https://github.com/deepmind/sonnet)
45.  [PyTorch - Tensors and Dynamic neural networks in Python with strong GPU acceleration ★8219](https://github.com/pytorch/pytorch)
...
6.  [TorontoDeepLEarning convnet ★479 ⏳1Y](https://github.com/TorontoDeepLearning/convnet)
...
15. [A chess AI that learns to play chess using deep learning. ★555](https://github.com/erikbern/deep-pink)
16. [Reproducing the results of "Playing Atari with Deep Reinforcement Learning" by DeepMind ★622 ⏳2Y](https://github.com/kristjankorjus/Replicating-DeepMind)
17. [Wiki2Vec. Getting Word2vec vectors for entities and word from Wikipedia Dumps ★412 ⏳1Y](https://github.com/idio/wiki2vec)
18. [The original code from the DeepMind article + tweaks ★1508](https://github.com/kuz/DeepMind-Atari-Deep-Q-Learner)
19. [Google deepdream - Neural Network art ★10615 ⏳2Y](https://github.com/google/deepdream)
20. [An efficient, batched LSTM.](https://gist.github.com/karpathy/587454dc0146a6ae21fc)
21. [A recurrent neural network designed to generate classical music. ★1388](https://github.com/hexahedria/biaxial-rnn-music-composition)
22. [Memory Networks Implementations - Facebook ★1208](https://github.com/facebook/MemNN)
23. [Face recognition with Google's FaceNet deep neural network. ★8258](https://github.com/cmusatyalab/openface)
24. [Basic digit recognition neural network ★78 ⏳4Y](https://github.com/joeledenberg/DigitRecognition)
25. [Emotion Recognition API Demo - Microsoft](https://www.projectoxford.ai/demo/emotion#detection)
26. [Proof of concept for loading Caffe models in TensorFlow ★1633](https://github.com/ethereon/caffe-tensorflow)
...
29. [Machine Learning for Software Engineers ★16720](https://github.com/ZuzooVn/machine-learning-for-software-engineers)
