...
5.  [neuraltalk ★4491](https://github.com/karpathy/neuraltalk) by Andrej Karpathy : numpy-based RNN/LSTM implementation
...
### Papers
*You can also find the most cited deep learning papers from [here ★12611](https://github.com/terryum/awesome-deep-learning-papers)*
...
10.  [The Best Machine Learning Tutorials On The Web ★361 ⏳6Y](https://github.com/josephmisiti/machine-learning-module)
11. [VGG Convolutional Neural Networks Practical](http://www.robots.ox.ac.uk/~vgg/practicals/cnn/index.html)
12. [TensorFlow tutorials ★4451](https://github.com/nlintz/TensorFlow-Tutorials)
13. [More TensorFlow tutorials ★3991](https://github.com/pkmital/tensorflow_tutorials)
13. [TensorFlow Python Notebooks ★17982](https://github.com/aymericdamien/TensorFlow-Examples)
14. [Keras and Lasagne Deep Learning Tutorials ★323](https://github.com/Vict0rSch/deep_learning)
15. [Classification on raw time series in TensorFlow with a LSTM RNN ★1105](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition)
...
17. [TensorFlow-World ★3610](https://github.com/astorfi/TensorFlow-World)
...
134. [DeepMind QA Corpus ★927](https://github.com/deepmind/rc-data) - Textual QA corpus from CNN and DailyMail. More than 300K documents in total. [Paper](http://arxiv.org/abs/1506.03340) for reference.
...
136. [Open Images dataset ★2181](https://github.com/openimages/dataset) - Open Images is a dataset of ~9 million URLs to images that have been annotated with labels spanning over 6000 categories.
...
5.  [convetjs ★8285](https://github.com/karpathy/convnetjs)
5.  [Ccv](http://libccv.org/doc/doc-convnet/)
6.  [NuPIC](http://numenta.org/nupic.html)
7.  [DeepLearning4J](http://deeplearning4j.org/)
8.  [Brain ★7915](https://github.com/harthur/brain)
9.  [DeepLearnToolbox ★2717](https://github.com/rasmusbergpalm/DeepLearnToolbox)
10.  [Deepnet ★779 ⏳3Y](https://github.com/nitishsrivastava/deepnet)
11.  [Deeppy ★1174 ⏳1Y](https://github.com/andersbll/deeppy)
12.  [JavaNN ★1133](https://github.com/ivan-vasilev/neuralnetworks)
13.  [hebel ★1164 ⏳2Y](https://github.com/hannes-brt/hebel)
14.  [Mocha.jl ★970](https://github.com/pluskid/Mocha.jl)
15.  [OpenDL ★213 ⏳2Y](https://github.com/guoding83128/OpenDL)
16.  [cuDNN](https://developer.nvidia.com/cuDNN)
17.  [MGL](http://melisgl.github.io/mgl-pax-world/mgl-manual.html)
18.  [Knet.jl ★389](https://github.com/denizyuret/Knet.jl)
19.  [Nvidia DIGITS - a web app based on Caffe ★2657](https://github.com/NVIDIA/DIGITS)
20.  [Neon - Python based Deep Learning Framework ★3306](https://github.com/NervanaSystems/neon)
...
39.  [Torchnet - Torch based Deep Learning Library ★912](https://github.com/torchnet/torchnet)
...
42.  [Lasagne - a lightweight library to build and train neural networks in Theano ★3296](https://github.com/Lasagne/Lasagne)
...
6.  [TorontoDeepLEarning convnet ★481 ⏳1Y](https://github.com/TorontoDeepLearning/convnet)
...
15. [A chess AI that learns to play chess using deep learning. ★568](https://github.com/erikbern/deep-pink)
16. [Reproducing the results of "Playing Atari with Deep Reinforcement Learning" by DeepMind ★627 ⏳2Y](https://github.com/kristjankorjus/Replicating-DeepMind)
17. [Wiki2Vec. Getting Word2vec vectors for entities and word from Wikipedia Dumps ★421](https://github.com/idio/wiki2vec)
18. [The original code from the DeepMind article + tweaks ★1531](https://github.com/kuz/DeepMind-Atari-Deep-Q-Learner)
19. [Google deepdream - Neural Network art ★10706 ⏳2Y](https://github.com/google/deepdream)
20. [An efficient, batched LSTM.](https://gist.github.com/karpathy/587454dc0146a6ae21fc)
21. [A recurrent neural network designed to generate classical music. ★1421](https://github.com/hexahedria/biaxial-rnn-music-composition)
22. [Memory Networks Implementations - Facebook ★1235](https://github.com/facebook/MemNN)
23. [Face recognition with Google's FaceNet deep neural network. ★8518](https://github.com/cmusatyalab/openface)
24. [Basic digit recognition neural network ★79 ⏳4Y](https://github.com/joeledenberg/DigitRecognition)
25. [Emotion Recognition API Demo - Microsoft](https://www.projectoxford.ai/demo/emotion#detection)
26. [Proof of concept for loading Caffe models in TensorFlow ★1721](https://github.com/ethereon/caffe-tensorflow)
