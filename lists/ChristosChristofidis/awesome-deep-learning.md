...
5.  [neuraltalk ★4157](https://github.com/karpathy/neuraltalk) by Andrej Karpathy : numpy-based RNN/LSTM implementation
...
### Papers
*You can also find the most cited deep learning papers from [here ★10286](https://github.com/terryum/awesome-deep-learning-papers)*
...
12. [TensorFlow tutorials ★3678](https://github.com/nlintz/TensorFlow-Tutorials)
13. [More TensorFlow tutorials ★3365](https://github.com/pkmital/tensorflow_tutorials)
13. [TensorFlow Python Notebooks ★10831](https://github.com/aymericdamien/TensorFlow-Examples)
14. [Keras and Lasagne Deep Learning Tutorials ★263](https://github.com/Vict0rSch/deep_learning)
15. [Classification on raw time series in TensorFlow with a LSTM RNN ★694](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition)
...
134. [DeepMind QA Corpus ★745](https://github.com/deepmind/rc-data) - Textual QA corpus from CNN and DailyMail. More than 300K documents in total. [Paper](http://arxiv.org/abs/1506.03340) for reference.
...
136. [Open Images dataset ★1487](https://github.com/openimages/dataset) - Open Images is a dataset of ~9 million URLs to images that have been annotated with labels spanning over 6000 categories.
...
5.  [convetjs ★6982](https://github.com/karpathy/convnetjs)
...
19.  [Nvidia DIGITS - a web app based on Caffe ★2108](https://github.com/NVIDIA/DIGITS)
20.  [Neon - Python based Deep Learning Framework ★2960](https://github.com/NervanaSystems/neon)
...
32.  [MXnet - Lightweight, Portable, Flexible Distributed/Mobile Deep Learning framework ★9418](https://github.com/dmlc/mxnet)
33.  [Veles - Samsung Distributed machine learning platform ★818](https://github.com/Samsung/veles)
34.  [Marvin - A Minimalist GPU-only N-Dimensional ConvNets Framework ★353](https://github.com/PrincetonVision/marvin)
35.  [Apache SINGA - A General Distributed Deep Learning Platform](http://singa.incubator.apache.org/)
36.  [DSSTNE - Amazon's library for building Deep Learning models ★3701](https://github.com/amznlabs/amazon-dsstne)
...
39.  [Torchnet - Torch based Deep Learning Library ★891](https://github.com/torchnet/torchnet)
...
42.  [Lasagne - a lightweight library to build and train neural networks in Theano ★3013](https://github.com/Lasagne/Lasagne)
...
29. [Machine Learning for Software Engineers ★14579](https://github.com/ZuzooVn/machine-learning-for-software-engineers)
