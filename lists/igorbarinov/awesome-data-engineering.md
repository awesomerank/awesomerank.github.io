...
A curated list of data engineering tools for software developers [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★57421](https://github.com/sindresorhus/awesome)
...
- Relational
	...
	* [MySQL](http://www.mysql.com/) The world's most popular open source database.
		* [TiDB ★7820](https://github.com/pingcap/tidb) TiDB is a distributed NewSQL database compatible with MySQL protocol 	
		...
		* [mysql_utils ★728](https://github.com/pinterest/mysql_utils) Pinterest MySQL Management Tools
...
- Key-Value
	...
	* [HyperDex ★1173](https://github.com/rescrv/HyperDex) HyperDex is a scalable, searchable key-value store
	...
	* [IonDB ★449](https://github.com/iondbproject/iondb) A key-value store for microcontroller and IoT applications
- Column
	* [Cassandra](http://cassandra.apache.org/) The right choice when you need scalability and high availability without compromising performance.
		...
		* [CCM ★862](https://github.com/pcmanus/ccm) A script to easily create and destroy an Apache Cassandra cluster on localhost
		* [ScyllaDB ★2968](https://github.com/scylladb/scylla) NoSQL data store using the seastar framework, compatible with Apache Cassandra http://www.scylladb.com/
...
- Timeseries
	* [InfluxDB ★10473](https://github.com/influxdata/influxdb) Scalable datastore for metrics, events, and real-time analytics.
	* [OpenTSDB ★2479](https://github.com/OpenTSDB/opentsdb) A scalable, distributed Time Series Database.
	* [kairosdb ★1038](https://github.com/kairosdb/kairosdb) Fast scalable time series database.
	* [Heroic ★527](https://github.com/spotify/heroic) A scalable time series database based on Cassandra and Elasticsearch, by Spotify
...
- Other
	* [Tarantool ★1452](https://github.com/tarantool/tarantool) Tarantool is an in-memory database and application server.
	...
	* [Snappydata ★541](https://github.com/SnappyDataInc/snappydata)SnappyData: OLTP + OLAP Database built on Apache Spark
...
* [Kafka](http://kafka.apache.org/) Publish-subscribe messaging rethought as a distributed commit log.
	...
	* [kafka-node ★800](https://github.com/SOHU-Co/kafka-node) Node.js client for Apache Kafka 0.8
	* [Secor ★912](https://github.com/pinterest/secor) Pinterest's Kafka to S3 distributed consumer
...
* [Heka ★3251](https://github.com/mozilla-services/heka) Data Acquisition and Processing Made Easy
* [Gobblin ★931](https://github.com/linkedin/gobblin) Universal data ingestion framework for Hadoop from Linkedin

# File System
* [HDFS](https://hadoop.apache.org/docs/r1.2.1/hdfs_design.html)
	* [Snakebite ★563](https://github.com/spotify/snakebite) A pure python HDFS client
...
* [Apache Parquet](https://parquet.apache.org) Apache Parquet is a columnar storage format available to any project in the Hadoop ecosystem, regardless of the choice of data processing framework, data model or programming language.
	* [Snappy ★1884](https://github.com/google/snappy) A fast compressor/decompressor. Used with Parquet
	* [PigZ](http://zlib.net/pigz/) A parallel implementation of gzip for modern
multi-processor, multi-core machines
* [Apache ORC](https://orc.apache.org/) The smallest, fastest columnar storage for Hadoop workloads 
* [Apache Thrift](https://thrift.apache.org) The Apache Thrift software framework, for scalable cross-language services development
* [ProtoBuf ★16935](https://github.com/google/protobuf) Protocol Buffers - Google's data interchange format
...
* [Kryo ★2590](https://github.com/EsotericSoftware/kryo) Kryo is a fast and efficient object graph serialization framework for Java
...
* [PipelineDB ★1273](https://github.com/pipelinedb/pipelinedb) The Streaming SQL Database https://www.pipelinedb.com
...
* [Spark](https://spark.apache.org/)
	...
	* [Deep Spark ★180](https://github.com/Stratio/deep-spark) Connecting Apache Spark with different data stores 
...
- Batch SQL
	...
	* [Hive](http://hive.apache.org) Data warehouse software facilitates querying and managing large datasets residing in distributed storage. 
		* [Hivemall ★485](https://github.com/myui/hivemall) Scalable machine learning library for Hive/Hadoop.
...
* [Pinball ★720](https://github.com/pinterest/pinball) DAG based workflow manager. Job flows are defined programmaticaly in Python. Support output passing between jobs.
...
* [elasticsearch-jdbc ★1942](https://github.com/jprante/elasticsearch-jdbc) JDBC importer for Elasticsearch
...
* [Eventsim ★157](https://github.com/Interana/eventsim) Event data simulator. Generates a stream of pseudo-random events from a set of users, designed to simulate web traffic.
...
## Prometheus
* [Prometheus.io ★9281](https://github.com/prometheus/prometheus) An open-source service monitoring system and time series database
* [HAProxy Exporter ★96](https://github.com/prometheus/haproxy_exporter) Simple server that scrapes HAProxy stats and exports them via HTTP for Prometheus consumption

Cheers to [The Data Engineering Ecosystem: An Interactive Map](http://xyz.insightdataengineering.com/blog/pipeline_map.html)

Inspired by the [awesome ★57421](https://github.com/sindresorhus/awesome) list. Created by [Insight Data Engineering](http://insightdataengineering.com) fellows.
