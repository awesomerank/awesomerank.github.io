...
#### APIs
- [PokeAPI ★985](https://github.com/PokeAPI/pokeapi) - A RESTful API for Pokémon (http://pokeapi.co/).
- [Pokemon_Go_API ★16](https://github.com/Mila432/Pokemon_Go_API) - Pokémon GO API in Python.
- [pgoapi ★1469](https://github.com/tejado/pgoapi) - Pokémon GO API lib/demo.
- [Pokemon-GO-node-api ★931](https://github.com/Armax/Pokemon-GO-node-api) - Pokémon GO API Node.js library.
- [Pokemon-Go-Rocket-API ★430](https://github.com/FeroxRev/Pokemon-Go-Rocket-API) - Client API library for Pokémon GO in C#.
...
#### Apps
- [Pokemon-Showdown ★1168](https://github.com/Zarel/Pokemon-Showdown) - Pokémon battle simulator.
- [pokemongo-webspoof ★2089](https://github.com/iam4x/pokemongo-webspoof) - Play Pokémon GO from your Mac.
- [iPokeMon ★416](https://github.com/Kjuly/iPokeMon) - Pokémon like game on iOS with Location Based Service.
- [pokemon-online ★226](https://github.com/po-devs/pokemon-online) - Online Pokémon Battle Simulator.
- [Shuffle-Move ★69](https://github.com/Loreinator/Shuffle-Move) - A program to identify and display the best next move for the game Pokémon Shuffle.
...
- [PokemonGo-Bot ★3691](https://github.com/PokemonGoF/PokemonGo-Bot) - The Pokémon GO bot script, baking with community.
...
- [PokeBuddy ★487](https://github.com/finndev/PokeBuddy) - A Pokémon GO bot.

#### Miscellaneous
- [alfred-pokedex ★19](https://github.com/vutran/alfred-pokedex) - Alfred 3 workflow to lookup information about Pokémon.
- [hyper-pokemon ★320](https://github.com/hyper-pokemon/hyper-pokemon) - Wondrous, tailor-made Pokémon themes for your Hyper terminal.
- [Pokemon-Go-Controller ★2474](https://github.com/kahopoon/Pokemon-Go-Controller) - Play Pokémon GO safely or at unavailable area.
- [pokecrystal ★865](https://github.com/pret/pokecrystal) - Disassembly of Pokémon Crystal.
- [x-pokemon ★90 ⏳1Y](https://github.com/passy/x-pokemon) - A web component to display Pokémon.
- [pokered ★1191](https://github.com/pret/pokered) - Disassembly of Pokémon Red/Blue.
- [pokemon-reverse-engineering-tools ★126](https://github.com/pret/pokemon-reverse-engineering-tools) - Tools for compiling and disassembling Pokémon Red and Pokémon Crystal.
...
- [pogo-optimizer ★537](https://github.com/justinleewells/pogo-optimizer) - Shows you the IVs and information necessary to determine which Pokémon get ground into candy.
...
- [pokemongo-game-master ★18](https://github.com/BrunnerLivio/pokemongo-game-master) - Collection of Pokémon GO Game Master versions.
...
#### Maps
- [PokemonGo-Map ★8388](https://github.com/AHAAAAAAA/PokemonGo-Map) - Live visualization of all the Pokémon in your area and more.
- [PokemonGo-DesktopMap ★1965](https://github.com/mchristopher/PokemonGo-DesktopMap) - Electron app for Pokémon GO that shows Pokémon nearby.
- [pokelocater ★153](https://github.com/emeth-/pokelocater) - Display Pokémon nearby your location on a map.
- [Pokemap ★1166](https://github.com/omkarmoghe/Pokemap) - A native Android client to map the Pokémon around you.
...
#### Wiki
- [Pokedex ★600](https://github.com/veekun/pokedex) - More than you ever wanted to know about Pokémon.
- [Pokedex.org ★1795](https://github.com/nolanlawson/pokedex.org) - Offline-capable Pokédex web site https://www.pokedex.org.
