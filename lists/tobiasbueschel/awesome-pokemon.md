...
#### APIs
- [PokeAPI ★1052](https://github.com/PokeAPI/pokeapi) - A RESTful API for Pokémon (http://pokeapi.co/).
- [Pokemon_Go_API ★17 ⏳1Y](https://github.com/Mila432/Pokemon_Go_API) - Pokémon GO API in Python.
- [pgoapi ★1456 ⏳1Y](https://github.com/tejado/pgoapi) - Pokémon GO API lib/demo.
- [Pokemon-GO-node-api ★923](https://github.com/Armax/Pokemon-GO-node-api) - Pokémon GO API Node.js library.
- [Pokemon-Go-Rocket-API ★427 ⏳1Y](https://github.com/FeroxRev/Pokemon-Go-Rocket-API) - Client API library for Pokémon GO in C#.
- [Pokemon GO Java API ★1078](https://github.com/Grover-c13/PokeGOAPI-Java) - Pokémon GO API for Java.
- [Pokemon Name API ★182](https://github.com/sindresorhus/pokemon) - Get a list of Pokémon names in JSON.
- [PokemonGO-Pokedex ★46](https://github.com/Biuni/PokemonGO-Pokedex) - Pokédex of Pokémon GO in JSON.

#### Apps
- [Pokemon-Showdown ★1231](https://github.com/Zarel/Pokemon-Showdown) - Pokémon battle simulator.
...
- [Shuffle-Move ★74](https://github.com/Loreinator/Shuffle-Move) - A program to identify and display the best next move for the game Pokémon Shuffle.
...
- [slack-pokemon ★320](https://github.com/rvinluan/slack-pokemon) - A bot for having Pokémon battles in Slack.
...
- [PokemonGo-Bot ★3676](https://github.com/PokemonGoF/PokemonGo-Bot) - The Pokémon GO bot script, baking with community.
...
- [PokemonGoBot ★612](https://github.com/jabbink/PokemonGoBot) - Bot that plays Pokémon GO.
- [Bot Builder for PokemonGoBot ★17 ⏳1Y](https://github.com/shilch/pogobot-builder) - Simply build your Pokémon GO bot.
- [PokeBuddy ★478 ⏳1Y](https://github.com/finndev/PokeBuddy) - A Pokémon GO bot.
...
- [Pokemon-Terminal ★2523](https://github.com/LazoCoder/Pokemon-Terminal) - Pokémon terminal themes for iTerm2.
...
#### Maps
- [PokemonGo-Map ★8251](https://github.com/AHAAAAAAA/PokemonGo-Map) - Live visualization of all the Pokémon in your area and more.
- [PokemonGo-DesktopMap ★1943](https://github.com/mchristopher/PokemonGo-DesktopMap) - Electron app for Pokémon GO that shows Pokémon nearby.
- [pokelocater ★150 ⏳1Y](https://github.com/emeth-/pokelocater) - Display Pokémon nearby your location on a map.
- [Pokemap ★1147](https://github.com/omkarmoghe/Pokemap) - A native Android client to map the Pokémon around you.
- [Poke Vision](https://pokevision.com/) - Find Pokémon by location.
- [iPokeGo ★657](https://github.com/istornz/iPokeGo) - A native iOS client to map the Pokémon around you.
...
#### Wiki
- [Pokedex ★622](https://github.com/veekun/pokedex) - More than you ever wanted to know about Pokémon.
- [Pokedex.org ★1839](https://github.com/nolanlawson/pokedex.org) - Offline-capable Pokédex web site https://www.pokedex.org.
