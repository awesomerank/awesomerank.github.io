...
You might also like [awesome-php ★17604](https://github.com/ziadoz/awesome-php).
...
- [OctoLinker Browser Extension ★2470](https://github.com/OctoLinker/browser-extension) - Enables you to navigate Composer/NPM dependencies on Github.
...
- [Satis Server ★13](https://github.com/lukaszlach/satis-server) - This docker container provides a Satis Server and enables you to run a private, self-hosted Composer repository with support for Git, Mercurial, and Subversion, HTTP API, HTTPs support, webhook handler and scheduled builds.
