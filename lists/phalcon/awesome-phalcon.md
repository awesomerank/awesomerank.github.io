...
* [PhalconUserPlugin ★178](https://github.com/calinrada/PhalconUserPlugin) - Plugin based on Vökuró ACL idea
...
* [MVC ★565](https://github.com/phalcon/mvc) - Examples of Phalcon MVC file structures
...
* [Phalcon Boilerplate ★75 ⏳1Y](https://github.com/mikegioia/phalcon-boilerplate) - Template for building large-scale Phalcon Applications
...
* [Vökuró ★290](https://github.com/phalcon/vokuro) - Sample application for Phalcon PHP Framework (Acl, Auth, Security)
...
* [Yona CMS ★330](https://github.com/oleksandr-torosh/yona-cms) - CMS based on Phalcon PHP Framework with modular structure
* [PhalconCMS ★58](https://github.com/KevinJay/PhalconCMS) - A blog built on Phalcon PHP Framework
...
* [phalcon-logentries ★8](https://github.com/phalcon/phalcon-logentries) - Sends log messages to the [Logentries](https://logentries.com/) log management service
...
* [Phalcon Mailer ★25](https://github.com/phalcon-ext/mailer) - Mailer component wrapper over SwiftMailer for Phalcon Framework
...
* [Breadcrumbs ★29](https://github.com/phalcon/breadcrumbs) - Powerful and flexible component for building site breadcrumbs in Phalcon 2+.
...
* [Incubator ★620](https://github.com/phalcon/incubator) - Repository to publish/share/experiment with new adapters, prototypes or functionality that can potentially be incorporated into the Phalcon PHP Framework
...
* [Phalcon Rest JWT ★20](https://github.com/nerfe/phalconphp-rest-jwt-acl) - This project uses Phalcon Micro Framework for REST API with JWT and ACL
...
* [phalcon-rest-boilerplate ★81](https://github.com/redound/phalcon-rest-boilerplate) - Phalcon REST Boilerplate
...
* [phalcon-json-api-package ★29](https://github.com/gte451f/phalcon-json-api-package) - A composer package designed to help you create a JSON:API in Phalcon
...
* [php-hmac-rest-api ★155](https://github.com/jeteokeeffe/php-hmac-rest-api) - PHP HMAC Restful API that uses Phalcon Micro Application
...
* [phalcon-demo ★21](https://github.com/Codeception/phalcon-demo) - A modified Phalcon INVO Application to demonstrate basics of Codeception testing.
...
* [Phalcon Box ★185](https://github.com/phalcon/box) - Phalcon Box is an official, pre-packaged Vagrant box that provides you a wonderful development environment
...
* [phalcon-compose ★72](https://github.com/phalcon/phalcon-compose) - Open-source and community-driven boilerplate for Phalcon projects that run on Docker
