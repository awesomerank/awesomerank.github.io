...
* [PhalconUserPlugin ★177](https://github.com/calinrada/PhalconUserPlugin) - Plugin based on Vökuró ACL idea
...
* [INVO Application ★289](https://github.com/phalcon/invo) - Sample application for the Phalcon PHP Framework
...
* [MVC ★557](https://github.com/phalcon/mvc) - Examples of Phalcon MVC file structures
...
* [Solid Layer ★64](https://github.com/solid-layer/solid-layer) - A framework/large wrapper built under Phalcon PHP Framework
* [Vökuró ★288](https://github.com/phalcon/vokuro) - Sample application for Phalcon PHP Framework (Acl, Auth, Security)
* [Webird ★77](https://github.com/perchlayer/webird) - Webird was created to merge the latest PHP and Node.js innovations into a single application stack
...
* [phalcon-oauth2-server](https://github.com/nueko/phalcon-oauth2-server) - Phalcon wrapper for oAuth2 [thephpleague/oauth2-server ★3023](https://github.com/thephpleague/oauth2-server)
...
* [blog ★29 ⏳2Y](https://github.com/duythien/blog) - Blog project with multi-lingual support
* [giada-www ★6](https://github.com/monocasual/giada-www) - Official website of [Giada Loop Machine](https://www.giadamusic.com/)
* [phalconBlog ★20 ⏳2Y](https://github.com/eristoddle/phalconBlog) - A blog using the Phalcon PHP Framework
* [PhalconEye ★433](https://github.com/PhalconEye/phalconeye) - PhalconEye CMS
...
* [PhalconCMS ★49](https://github.com/KevinJay/PhalconCMS) - A blog built on Phalcon PHP Framework
...
* [phalcon-console ★6 ⏳2Y](https://github.com/viebig/phalcon-console) - Sample bootstraping application for command line applications using the outstanding Phalcon PHP Framework
* [phalcon-cron ★53](https://github.com/SidRoberts/phalcon-cron) - Cron component for Phalcon
* [phalcon_cron ★13 ⏳2Y](https://github.com/temafey/phalcon_cron) - Cron manager library based on Phalcon PHP Framework
* [php-cli-app-phalcon ★45 ⏳2Y](https://github.com/jeteokeeffe/php-cli-app-phalcon) - Command Line Application built using Phalcon PHP Framework
...
* [dasshy ★27 ⏳2Y](https://github.com/phalcon/dasshy) - Statistics dashboard with Mongo/Phalcon
...
* [Prophiler ★410](https://github.com/fabfuel/prophiler) - PHP Profiler & Developer Toolbar (built for Phalcon)
...
* [kolibri ★8 ⏳1Y](https://github.com/philippgerard/kolibri) - A Phalcon based wiki software with simplicity in mind
...
* [Phact ★8 ⏳2Y](https://github.com/wandersonwhcr/phact) -  A Simple Event Propagation with Phalcon PHP Framework
...
* [Phalcon Preserve Post ★2 ⏳3Y](https://github.com/JREAM/phalcon-preserve-post) - Preserve Form Data after a `POST` and redirect
* [phalcon-form-decorators ★4 ⏳3Y](https://github.com/Michal-St/phalcon-form-decorators) - Form decorators to Phalcon PHP Framework
* [phalconCssForm ★3 ⏳2Y](https://github.com/Zheness/phalconCssForm) - Generate a form with a CSS Framework (Bootstrap, Foundation, Pure, etc.)
* [Superform ★6 ⏳2Y](https://github.com/encodez/superform) - Simple way to create and validate Phalcon 2 form inspired by the Laravel request
...
* [Phalcon Translate Service ★7 ⏳2Y](https://github.com/stanislav-web/phalcon-translate) - Phalcon Translate Service. Simple way to translate your custom part of templates
* [xgettext-template ★62](https://github.com/gmarty/xgettext) - Extract gettext messages from Volt templates using a command line program that is identical to the [xgettext invocation](http://www.gnu.org/software/gettext/manual/gettext.html#xgettext-Invocation).
...
* [Phalcon Mailer ★24](https://github.com/phalcon-ext/mailer) - Mailer component wrapper over SwiftMailer for Phalcon Framework
...
* [nova ★7 ⏳1Y](https://github.com/nohatssir/nova) - A media manager project in PHP and Phalcon PHP Framework
...
* [Breadcrumbs ★28](https://github.com/phalcon/breadcrumbs) - Powerful and flexible component for building site breadcrumbs in Phalcon 2+.
...
* [Incubator ★611](https://github.com/phalcon/incubator) - Repository to publish/share/experiment with new adapters, prototypes or functionality that can potentially be incorporated into the Phalcon PHP Framework
* [Phalcon Enterprise ★8](https://github.com/techpivot/phalcon-enterprise) - Provides extended enterprise functionality for the Phalcon PHP framework
...
* [phalcon-expressive ★1 ⏳1Y](https://github.com/theDisco/phalcon-expressive) - Phalcon 2 integration for Zend Expressive
...
* [phalcon-boundmodels ★1 ⏳1Y](https://github.com/SidRoberts/phalcon-boundmodels) - Automatically get models based on dispatcher parameters within the Phalcon framework
* [phalcon-mssql ★17 ⏳2Y](https://github.com/fishjerky/phalcon-mssql) - A Phalcon PHP Framework MSSQL PDO db adapter
* [phalcon-seeder ★8 ⏳1Y](https://github.com/SidRoberts/phalcon-seeder) - Database seeder component for Phalcon
...
* [Phalcon Development Boards ★15 ⏳1Y](https://github.com/stanislav-web/Phalcon-development) - An example development of the REST application by Phalcon PHP Framework
* [Phalcon REST ★98](https://github.com/redound/phalcon-rest) - Phalcon REST Library
* [Phalcon Rest JWT ★19](https://github.com/nerfe/phalconphp-rest-jwt-acl) - This project uses Phalcon Micro Framework for REST API with JWT and ACL
* [Phalcon Restful Webservice ★57 ⏳2Y](https://github.com/praswicaksono/phalcon-restful-webservice) - Base project for creating powerful webservice based on Phalcon PHP Framework
* [phalcon-api-oauth2 ★33](https://github.com/goors/phalcon-api-oauth2) - Full Phalcon REST API example with is own OAuth2 server
* [phalcon-rest-boilerplate ★79](https://github.com/redound/phalcon-rest-boilerplate) - Phalcon REST Boilerplate
* [phalcon-json-api ★15](https://github.com/gte451f/phalcon-json-api) - A reference application combining Phalcon + JSON:API + Composer
* [phalcon-json-api-package ★23](https://github.com/gte451f/phalcon-json-api-package) - A composer package designed to help you create a JSON:API in Phalcon
* [PhalconRest ★207 ⏳1Y](https://github.com/cmoore4/phalcon-rest) - A Base project for APIs using the Phalcon PHP Framework
* [phest ★23 ⏳1Y](https://github.com/ovide/phest) - REST API library for Phalcon
* [php-hmac-rest-api ★154](https://github.com/jeteokeeffe/php-hmac-rest-api) - PHP HMAC Restful API that uses Phalcon Micro Application
...
* [Phalcon-autorouter ★27 ⏳1Y](https://github.com/kamilhurajt/Phalcon-autorouter) - Simple way to auto load modules without complicate definition of routes
...
* [generator-phalcon ★39 ⏳3Y](https://github.com/michaelkrone/generator-phalcon) - Yeoman generator for Phalcon Multi-Module Applications
...
* [phalcon-datatables ★41](https://github.com/m1ome/phalcon-datatables) - Phalcon adapter for DataTables
...
* [Multiple SMS Sender factory ★28 ⏳2Y](https://github.com/stanislav-web/phalcon-sms-factory) - Phalcon SMS Factory
...
* [phanbook ★276](https://github.com/phanbook/phanbook) - The source for code phanbook.com website
* [Phosphorum ★289](https://github.com/phalcon/forum) - The source for official Phalcon Forum
...
* [jade-phalcon ★6 ⏳1Y](https://github.com/kylekatarnls/jade-phalcon) - Jade Template Engine for Phalcon PHP Framework
* [phalcon-xslt-view-engine ★2 ⏳1Y](https://github.com/racztiborzoltan/phalcon-xslt-view-engine) - Adapter to use XSLT as templating engine for Phalcon PHP Framework
...
* [phalcon-demo ★18](https://github.com/Codeception/phalcon-demo) - A modified Phalcon INVO Application to demonstrate basics of Codeception testing.
...
* [PHP Request Validator ★20 ⏳1Y](https://github.com/progsmile/request-validator) - Easy PHP validation with the Phalcon support
...
* [Password Manager ★6 ⏳3Y](https://github.com/mrspartak/phalconPasswordManager) - Password manager for selfuse
* [URL-Shortener ★25 ⏳3Y](https://github.com/blackbunny/Url-Shortener) - Simple Fast Url-Shortener application


# Server Applications

* [ansible-phalcon-role ★0 ⏳2Y](https://github.com/sarrubia/ansible-phalcon-role) - Ansible Role to install Phalcon PHP Framework in Debian/Ubuntu
...
* [packagecloud ★20](https://github.com/phalcongelist/packagecloud) - Phalcon distribution hosted on PackageCloud
* [perfect-php-vagrant ★53](https://github.com/ovr/perfect-php-vagrant) - Web development Vagrant machine with PHP + Phalcon/Lynx/Zephir, Nginx, Node+Bower/Gulp/Grunt
* [Phalcon Box ★184](https://github.com/phalcon/box) - Phalcon Box is an official, pre-packaged Vagrant box that provides you a wonderful development environment
* [phalcon-ci-installer ★27](https://github.com/techpivot/phalcon-ci-installer) - Composer integration for PHP applications to install the Phalcon framework as an extension in the PHP runtime for various hosted CI services
* [phalcon-compose ★67](https://github.com/phalcon/phalcon-compose) - Open-source and community-driven boilerplate for Phalcon projects that run on Docker
* [phalcon-docker-nginx ★14](https://github.com/viebig/phalcon-docker-nginx) - Phalcon 3, PHP7, Docker sample starter application
...
* [Phalconist ★27](https://github.com/phalcon/phalconist) - Resources catalog for Phalcon PHP Framework on [Phalconist](https://phalconist.phalconphp.com/)


### Tutorials

* [Blog Tutorial ★24 ⏳2Y](https://github.com/phalcon/blog-tutorial) - Blog Tutorial (source code for [Blog Tutorial](https://blog.phalconphp.com/post/tutorial-your-first-encounter-with-phalcon-part-2))
