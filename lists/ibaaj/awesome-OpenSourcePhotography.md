...
- [PhotoFlow ★132](https://github.com/aferrero2707/PhotoFlow) - *A non-destructive photo retouching program including RAW image development.*
...
- [Autoexec Hack ★377](https://github.com/KonradIT/autoexechack) - *Compilation of hacks for GoPro Cameras.*
...
### GoPro
- [GoPro ★130 ⏳4Y](https://github.com/kschzt/gopro) - *API for controlling GoPro Hero 3 Camera from Node.js.*
- [GoPro ★74](https://github.com/DenisCarriere/gopro) - *GoPro Hero 4 - Python API.*
- [GoPro ★243](https://github.com/joshvillbrandt/goprohero) - *a Python library and a CLI that can interface with GoPro HERO3, HERO3+, and HERO4 cameras over http.*
...
- [Timelapse-sony ★66](https://github.com/ThibaudM/timelapse-sony) - *Android app for creating timelapse via "Ctrl with Smartphone" mode or connected by NFC.*
- [Remoteyourcam-usb ★95 ⏳4Y](https://github.com/crazymaik/remoteyourcam-usb) - *Control your Canon or Nikon DSLR camera from your Android device through USB.*
...
- [Raw Studio ★41](https://github.com/rawstudio/rawstudio) - *Read and manipulate RAW images from digital cameras.*
...
- [Luminance ★274](https://github.com/LuminanceHDR/LuminanceHDR) - *A complete workflow for HDR imaging*
...
- [Leaf Pic ★2128](https://github.com/HoraApps/LeafPic) - *material-designed android gallery alternative.*
- [A Photo Manager ★68](https://github.com/k3b/APhotoManager) - *Manage local photos on Android: gallery, geotag with photomap, tags, find, sort, view, copy, delete, send,...*
## EXIF Editors
...
- [Natron ★1217](https://github.com/MrKepzie/Natron) - *A node-based compositor based on the same principles as state-of-the art tools used in film and television post-production.*
- [ButtleOFX ★75](https://github.com/buttleofx/ButtleOFX) - *A simple, user-friendly and open source compositing software.* 
- [Blender](https://www.blender.org/) - *This open source 3D graphics has tools for video editing.*
- [Shotcut ★1374](https://github.com/mltframework/shotcut) - *A free, open source, cross-platform video editor.*

### Video Libraries

- [OpenFX](http://openfx.sourceforge.net/) - *An Open Plug-in API for 2D Visual Effects.*
- [TuttleOFX ★116](https://github.com/tuttleofx/TuttleOFX) - *An image processing framework based on OpenFX plugin format.*
- [Vid.stab ★240](https://github.com/georgmartius/vid.stab) - *A video stabilization library which can be plugged-in with Ffmpeg and Transcode*.
