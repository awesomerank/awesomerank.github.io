...
---
#Awesome-OpenSourcePhotography [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★65640](https://github.com/sindresorhus/awesome)

A list of awesome free open source software & libraries for photography. Also tools for video. For more awesomeness, check out [awesome ★65640](https://github.com/sindresorhus/awesome).
...
- [PhotoFlow ★116](https://github.com/aferrero2707/PhotoFlow) - *A non-destructive photo retouching program including RAW image development.*
...
- [Autoexec Hack ★365](https://github.com/KonradIT/autoexechack) - *Compilation of hacks for GoPro Cameras.*
...
- [Xiaomi Yi Autoexec ★170](https://github.com/PJanisio/Xiaomi_Yi_autoexec) - *Compilation of autoexec scripts and mods for Xiaomi Yi camera.*
...
- [GoPro ★233](https://github.com/joshvillbrandt/goprohero) - *a Python library and a CLI that can interface with GoPro HERO3, HERO3+, and HERO4 cameras over http.*
- [GoPro.Hero ★45 ⏳1Y](https://github.com/r1pper/GoPro.Hero) - *a lightweight c# library to access and control GoPro HERO.*

### Sony

- [SonyPy ★16 ⏳3Y](https://github.com/storborg/sonypy) - *Python module for Sony Camera Remote API.*

## Utilities

- [Timelapse-sony ★63](https://github.com/ThibaudM/timelapse-sony) - *Android app for creating timelapse via "Ctrl with Smartphone" mode or connected by NFC.*
- [Remoteyourcam-usb ★92 ⏳4Y](https://github.com/crazymaik/remoteyourcam-usb) - *Control your Canon or Nikon DSLR camera from your Android device through USB.*
...
- [Luminance ★255](https://github.com/LuminanceHDR/LuminanceHDR) - *A complete workflow for HDR imaging*
...
- [Leaf Pic ★1915](https://github.com/HoraApps/LeafPic) - *material-designed android gallery alternative.*
- [A Photo Manager ★63](https://github.com/k3b/APhotoManager) - *Manage local photos on Android: gallery, geotag with photomap, tags, find, sort, view, copy, delete, send,...*
## EXIF Editors
...
- [Natron ★1138](https://github.com/MrKepzie/Natron) - *A node-based compositor based on the same principles as state-of-the art tools used in film and television post-production.*
- [ButtleOFX ★73](https://github.com/buttleofx/ButtleOFX) - *A simple, user-friendly and open source compositing software.* 
- [Blender](https://www.blender.org/) - *This open source 3D graphics has tools for video editing.*
- [Shotcut ★1261](https://github.com/mltframework/shotcut) - *A free, open source, cross-platform video editor.*

### Video Libraries

- [OpenFX](http://openfx.sourceforge.net/) - *An Open Plug-in API for 2D Visual Effects.*
- [TuttleOFX ★108](https://github.com/tuttleofx/TuttleOFX) - *An image processing framework based on OpenFX plugin format.*
- [Vid.stab ★227](https://github.com/georgmartius/vid.stab) - *A video stabilization library which can be plugged-in with Ffmpeg and Transcode*.
