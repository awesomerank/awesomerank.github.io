...
* [Blackbox ★15 ⏳1Y](https://github.com/bradleythughes/blackbox) - Lightweight window manager for the X window system, without library dependencies. Built using C++.
* [bspwm ★2161](https://github.com/baskerville/bspwm) - Tiling window manager that represents windows as the leaves of a full binary tree.
...
If you're looking for some pro-tips for your favorite text editor, you might be interested in [awesome-atom](https://github.com/mehcode/awesome-atom), [sublime-bookmarks](https://github.com/dreikanter/sublime-bookmarks), [vim-galore](https://github.com/mhinz/vim-galore), [awesome-emacs](https://github.com/emacs-tw/awesome-emacs), or [awesome-vscode ★5913](https://github.com/viatsko/awesome-vscode).
...
* [Spice-Up ★351](https://github.com/Philip-Scott/Spice-up) - Desktop presentation app.
...
* [Caprine ★3288](https://github.com/sindresorhus/caprine) - Facebook's Messenger client with some added privacy features.
* [PB for Desktop ★279](https://github.com/sidneys/pb-for-desktop) - Pushbullet client.
* [ramme ★2782](https://github.com/terkelg/ramme) - Instagram client.
* [ScudCloud ★1244](https://github.com/raelgc/scudcloud) - Slack client with additional features (compared to the original Slack client).
...
* [Aura ★648](https://github.com/aurapm/aura) (Arch) - Secure, multilingual package manager.
...
* [fuck ★35911](https://github.com/nvbn/thefuck) - Command line tool which corrects your previously mistyped command.
...
* [ranger ★3741](https://github.com/ranger/ranger) - Vim-inspired file manager for the console.
* [screenFetch ★2119](https://github.com/KittyKatt/screenFetch) - Fetches system/theme information in terminal.
* [shellcheck ★11463](https://github.com/koalaman/shellcheck) - Static analysis tool for shell scripts.
* [speed-test ★2987](https://github.com/sindresorhus/speed-test) - Test your Internet connection speed and ping using [speedtest.net](http://www.speedtest.net/).
...
* [wavemon ★200](https://github.com/uoaerg/wavemon) - Monitoring application for wireless network devices.
* [youtube-dl ★37991](https://github.com/rg3/youtube-dl) - A tool to download videos from YouTube and other video sites.
