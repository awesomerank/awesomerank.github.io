...
* [AddThis Hydra ★392](https://github.com/addthis/hydra) - distributed data processing and storage system originally developed at AddThis.
...
* [Twitter Heron ★2841](https://github.com/twitter/heron) - Heron is a realtime, distributed, fault-tolerant stream processing engine from Twitter replacing Storm.
* [Twitter Scalding ★2859](https://github.com/twitter/scalding) - Scala library for Map Reduce jobs, built on Cascading.
* [Twitter Summingbird ★1878](https://github.com/twitter/summingbird) - Streaming MapReduce with Scalding and Storm, by Twitter.
...
* [Baidu Tera ★1417](https://github.com/baidu/tera) - an Internet-scale database, inspired by BigTable.
...
* [InfiniDB ★205](https://github.com/infinidb/infinidb) - is accessed through a MySQL interface and use massive parallel processing to parallelize queries.
...
* [GridDB ★296](https://github.com/griddb/griddb_nosql) - suitable for sensor data stored in a timeseries.
* [HyperDex ★1205](https://github.com/rescrv/HyperDex) - a scalable, next generation key-value and document store with a wide array of features, including consistency, fault tolerance and high performance.
...
* [Riak ★2802](https://github.com/basho/riak) - a decentralized datastore.
...
* [Gremlin ★1620](https://github.com/tinkerpop/gremlin) - graph traversal Language.
...
* [IndexR ★231](https://github.com/shunfei/indexr) an open-source columnar storage format for fast & realtime analytic with big data.
...
* [Haeinsa ★138](https://github.com/VCNC/haeinsa) - linearly scalable multi-row, multi-table transaction library for HBase based on Percolator.
...
* [Kairosdb ★1089](https://github.com/kairosdb/kairosdb) - similar to OpenTSDB but allows for Cassandra.
...
* [Beringei ★2360](https://github.com/facebookincubator/beringei) - Facebook's in-memory time-series database.
* [TrailDB](http://traildb.io/) - an efficient tool for storing and querying series of events.
* [Druid ★5221](https://github.com/druid-io/druid) Column oriented distributed data store ideal for powering interactive applications
...
* [Akumuli ★282](https://github.com/akumuli/Akumuli) Akumuli is a numeric time-series database. It can be used to capture, store and process time-series data in real-time. The word "akumuli" can be translated from esperanto as "accumulate".
...
* [Dalmatiner DB ★475](https://github.com/dalmatinerdb/dalmatinerdb) Fast distributed metrics database
* [Blueflood ★540](https://github.com/rackerlabs/blueflood) A distributed system designed to ingest and process time series data
* [Timely ★192](https://github.com/NationalSecurityAgency/timely) Timely is a time series database application that provides secure access to time series data based on Accumulo and Grafana.
...
* [Facebook Scribe ★3525](https://github.com/facebookarchive/scribe) - streamed log data aggregator.
...
* [Netflix Suro ★621 ⏳1Y](https://github.com/Netflix/suro) - log agregattor like Storm and Samza based on Chukwa.
* [Pinterest Secor ★983](https://github.com/pinterest/secor) - is a service implementing Kafka log persistance.
...
* [StreamSets Data Collector ★317](https://github.com/streamsets/datacollector) - continuous big data ingest infrastructure with a simple to use IDE.
* [Yahoo Pulsar ★1263](https://github.com/apache/incubator-pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
...
* [Hydrosphere Mist ★91](https://github.com/Hydrospheredata/mist) - a service for exposing Apache Spark analytics jobs and machine learning models as realtime, batch or reactive web services.
...
* [Spotify Luigi ★7475](https://github.com/spotify/luigi) - a Python package for building complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization, handling failures, command line integration, and much more.
...
* [Airflow ★5763](https://github.com/apache/incubator-airflow) -  a platform to programmatically author, schedule and monitor workflows.
...
* [brain ★7782](https://github.com/harthur/brain) - Neural networks in JavaScript.
...
* [DataVec ★122](https://github.com/deeplearning4j/DataVec) - A vectorization and data preprocessing library for deep learning in Java and Scala. Part of the Deeplearning4j ecosystem. 
...
* [Decider ★395](https://github.com/danielsdeleo/Decider) - Flexible and Extensible Machine Learning in Ruby.
...
* [Keras ★18443](https://github.com/fchollet/keras) - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
...
* [MLPNeuralNet ★911](https://github.com/nikolaypavlov/MLPNeuralNet) - Fast multilayer perceptron neural network library for iOS and Mac OS X.
...
* [ND4J ★1091](https://github.com/deeplearning4j/nd4j) - A matrix library for the JVM. Numpy for Java. 
* [nupic ★5133](https://github.com/numenta/nupic) - Numenta Platform for Intelligent Computing: a brain-inspired machine intelligence platform, and biologically accurate neural network based on cortical learning algorithms.
...
* [RL4J ★157](https://github.com/deeplearning4j/rl4j) - Reinforcement learning for Java and Scala. Includes Deep-Q learning and A3C algorithms, and integrates with Open AI's Gym. Runs in the Deeplearning4j ecosystem. 
* [SAMOA](http://samoa.incubator.apache.org/) - distributed streaming machine learning framework.
* [scikit-learn ★20323](https://github.com/scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* [TensorFlow ★66317](https://github.com/tensorflow/tensorflow) - Library from Google for machine learning using data flow graphs.
...
* [Intel HiBench ★529](https://github.com/intel-hadoop/HiBench) - a Hadoop benchmark suite.
...
* [Marathon ★3385](https://github.com/mesosphere/marathon) - Mesos framework for long-running services.

## Applications

* [411 ★685](https://github.com/etsy/411) - an web application for alert management resulting from scheduled searches into Elasticsearch.
* [Adobe spindle ★316 ⏳2Y](https://github.com/adobe-research/spindle) - Next-generation web analytics processing with Scala, Spark, and Parquet.
...
* [Argus ★257](https://github.com/salesforce/Argus) - Time series monitoring and alerting platform.
* [Atlas ★1438](https://github.com/Netflix/atlas) - a backend for managing dimensional time series data.
...
* [ElastAert ★3405](https://github.com/Yelp/elastalert) - ElastAlert is a simple framework for alerting on anomalies, spikes, or other patterns of interest from data in ElasticSearch.
* [Eventhub ★1218 ⏳3Y](https://github.com/Codecademy/EventHub) - open source event analytics platform.
* [Hermes ★273](https://github.com/allegro/hermes) - asynchronous message broker built on top of Kafka.
...
* [Kapacitor ★1042](https://github.com/influxdata/kapacitor) - an open source framework for processing, monitoring, and alerting on time series data.
...
* [Rakam ★544](https://github.com/rakam-io/rakam) - open-source real-time custom analytics platform powered by Postgresql, Kinesis and PrestoDB. 
...
* [SnappyData ★601](https://github.com/SnappyDataInc/snappydata) - a distributed in-memory data store for real-time operational analytics, delivering stream analytics, OLTP (online transaction processing) and OLAP (online analytical processing) built on Spark in a single integrated cluster.
* [Snowplow ★3498](https://github.com/snowplow/snowplow) - enterprise-strength web and event analytics, powered by Hadoop, Kinesis, Redshift and Postgres.
...
* [Elassandra ★737](https://github.com/strapdata/elassandra) - is a fork of Elasticsearch modified to run on top of Apache Cassandra in a scalable and resilient peer-to-peer architecture.
...
* [LinkedIn Cleo ★517 ⏳3Y](https://github.com/linkedin/cleo) - is a flexible software library for enabling rapid development of partial, out-of-order and real-time typeahead search.
...
* [Twemproxy ★7032](https://github.com/twitter/twemproxy) - A fast, light-weight proxy for memcached and redis.
* [Twitter Fatcache ★1195](https://github.com/twitter/fatcache) - key/value cache for flash storage.
* [Twitter Twemcache ★790 ⏳1Y](https://github.com/twitter/twemcache) - fork of Memcache.
...
* [Airpal ★2112](https://github.com/airbnb/airpal) - Web UI for PrestoDB.
* [AnyChart](http://www.anychart.com) - fast, simple and flexible JavaScript (HTML5) charting library featuring pure JS API.
* [Arbor ★2415 ⏳1Y](https://github.com/samizdatco/arbor) - graph visualization library using web workers and jQuery.
...
* [CartoDB ★1521](https://github.com/CartoDB/cartodb) - open-source or freemium hosting for geospatial databases with powerful front-end editing capabilities and a robust API.
...
* [Chartist.js ★9747](https://github.com/gionkunz/chartist-js) - another open source HTML5 Charts visualization.
...
* [Cubism ★4554](https://github.com/square/cubism) - JavaScript library for time series visualization.
...
* [Echarts ★19763](https://github.com/ecomfe/echarts) - Baidus enterprise charts.
...
* [Matplotlib ★5678](https://github.com/matplotlib/matplotlib) - plotting with Python.
...
* [Plotly.js ★6647](https://github.com/plotly/plotly.js) The open source javascript graphing library that powers plotly.
* [Recline ★1948](https://github.com/okfn/recline) - simple but powerful library for building data applications in pure Javascript and HTML.
* [Redash ★7076](https://github.com/getredash/redash) - open-source platform to query and visualize data.
* [ReCharts](http://recharts.org/) - A composable charting library built on React components
* [Shiny](http://shiny.rstudio.com/) - a web application framework for R.
* [Sigma.js ★7399](https://github.com/jacomyal/sigma.js) - JavaScript library dedicated to graph drawing.
* [Superset ★15201](https://github.com/apache/incubator-superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
