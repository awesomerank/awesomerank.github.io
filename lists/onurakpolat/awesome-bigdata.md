...
* [Tigon ★241](https://github.com/caskdata/tigon) - High Throughput Real-time Stream Processing Framework.
...
* [AddThis Hydra ★393](https://github.com/addthis/hydra) - distributed data processing and storage system originally developed at AddThis.
...
* [Damballa Parkour ★259 ⏳1Y](https://github.com/damballa/parkour) - MapReduce library for Clojure.
...
* [Netflix PigPen ★468](https://github.com/Netflix/PigPen) - map-reduce for Clojure which compiles to Apache Pig.
...
* [Twitter Heron ★2851](https://github.com/twitter/heron) - Heron is a realtime, distributed, fault-tolerant stream processing engine from Twitter replacing Storm.
* [Twitter Scalding ★2861](https://github.com/twitter/scalding) - Scala library for Map Reduce jobs, built on Cascading.
* [Twitter Summingbird ★1879](https://github.com/twitter/summingbird) - Streaming MapReduce with Scalding and Storm, by Twitter.
...
* [Ambry ★919](https://github.com/linkedin/ambry) - a distributed object store that supports storage of trillion of small immutable objects as well as billions of large objects.
...
* [Baidu File System ★2074](https://github.com/baidu/bfs) - distributed filesystem.
...
* [Baidu Tera ★1426](https://github.com/baidu/tera) - an Internet-scale database, inspired by BigTable.
...
* [InfiniDB ★208](https://github.com/infinidb/infinidb) - is accessed through a MySQL interface and use massive parallel processing to parallelize queries.
* [Tephra ★156](https://github.com/caskdata/tephra) - Transactions for HBase.
...
* [HyperDex ★1208](https://github.com/rescrv/HyperDex) - a scalable, next generation key-value and document store with a wide array of features, including consistency, fault tolerance and high performance.
...
* [Riak ★2809](https://github.com/basho/riak) - a decentralized datastore.
* [Storehaus ★418](https://github.com/twitter/storehaus) - library to work with asynchronous key value stores, by Twitter.
* [SummitDB ★966](https://github.com/tidwall/summitdb) - an in-memory, NoSQL key/value database, with disk persistance and using the Raft consensus algorithm.
* [Tarantool ★1579](https://github.com/tarantool/tarantool) - an efficient NoSQL database and a Lua application server.
...
* [GCHQ Gaffer ★1345](https://github.com/gchq/Gaffer) - Gaffer by GCHQ is a framework that makes it easy to store large-scale graphs in which the nodes and edges have statistics.
* [Google Cayley ★10355](https://github.com/cayleygraph/cayley) - open-source graph database.
...
* [Gremlin ★1621](https://github.com/tinkerpop/gremlin) - graph traversal Language.
...
* [Phoebus ★376 ⏳5Y](https://github.com/xslogic/phoebus) - framework for large scale graph processing.
...
* [IndexR ★237](https://github.com/shunfei/indexr) an open-source columnar storage format for fast & realtime analytic with big data.
...
* [Comdb2 ★643](https://github.com/bloomberg/comdb2) - a clustered RDBMS built on optimistic concurrency control techniques.
...
* [Kairosdb ★1099](https://github.com/kairosdb/kairosdb) - similar to OpenTSDB but allows for Cassandra.
...
* [Beringei ★2376](https://github.com/facebookincubator/beringei) - Facebook's in-memory time-series database.
* [TrailDB](http://traildb.io/) - an efficient tool for storing and querying series of events.
* [Druid ★5272](https://github.com/druid-io/druid) Column oriented distributed data store ideal for powering interactive applications
...
* [Akumuli ★287](https://github.com/akumuli/Akumuli) Akumuli is a numeric time-series database. It can be used to capture, store and process time-series data in real-time. The word "akumuli" can be translated from esperanto as "accumulate".
...
* [Dalmatiner DB ★478](https://github.com/dalmatinerdb/dalmatinerdb) Fast distributed metrics database
* [Blueflood ★540](https://github.com/rackerlabs/blueflood) A distributed system designed to ingest and process time series data
* [Timely ★197](https://github.com/NationalSecurityAgency/timely) Timely is a time series database application that provides secure access to time series data based on Accumulo and Grafana.
...
* [Facebook Scribe ★3529](https://github.com/facebookarchive/scribe) - streamed log data aggregator.
...
* [Heka ★3273](https://github.com/mozilla-services/heka) - open source stream processing software system.
...
* [LinkedIn White Elephant ★183 ⏳3Y](https://github.com/linkedin/white-elephant) - log aggregator and dashboard.
* [Logstash](https://www.elastic.co/products/logstash) - a tool for managing events and logs.
* [Netflix Suro ★623 ⏳1Y](https://github.com/Netflix/suro) - log agregattor like Storm and Samza based on Chukwa.
* [Pinterest Secor ★993](https://github.com/pinterest/secor) - is a service implementing Kafka log persistance.
* [Linkedin Gobblin](https://github.com/linkedin/gobblin) - linkedin's universal data ingestion framework.
* [Skizze ★747 ⏳1Y](https://github.com/skizzehq/skizze) - sketch data store to deal with all problems around counting and sketching using probabilistic data-structures.
* [StreamSets Data Collector ★322](https://github.com/streamsets/datacollector) - continuous big data ingest infrastructure with a simple to use IDE.
* [Yahoo Pulsar ★1269](https://github.com/apache/incubator-pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
...
* [Hydrosphere Mist ★94](https://github.com/Hydrospheredata/mist) - a service for exposing Apache Spark analytics jobs and machine learning models as realtime, batch or reactive web services.
...
* [Spring XD ★431](https://github.com/spring-projects/spring-xd) - distributed and extensible system for data ingestion, real time analytics, batch processing, and data export.
* [Twitter Elephant Bird ★1041](https://github.com/twitter/elephant-bird) - libraries for working with LZOP-compressed data.
...
* [Airflow ★5827](https://github.com/apache/incubator-airflow) -  a platform to programmatically author, schedule and monitor workflows.
...
* [Schedoscope ★62](https://github.com/ottogroup/schedoscope) - Scala DSL for agile scheduling of Hadoop jobs.
* [Sparrow ★231 ⏳3Y](https://github.com/radlab/sparrow) - scheduling platform.
...
* [DataVec ★126](https://github.com/deeplearning4j/DataVec) - A vectorization and data preprocessing library for deep learning in Java and Scala. Part of the Deeplearning4j ecosystem. 
...
* [Etsy Conjecture ★336](https://github.com/etsy/Conjecture) - scalable Machine Learning in Scalding.
...
* [H2O ★2302](https://github.com/h2oai/h2o-3) - statistical, machine learning and math runtime with Hadoop. R and Python.
...
* [MLPNeuralNet ★913](https://github.com/nikolaypavlov/MLPNeuralNet) - Fast multilayer perceptron neural network library for iOS and Mac OS X.
...
* [ND4J ★1099](https://github.com/deeplearning4j/nd4j) - A matrix library for the JVM. Numpy for Java. 
...
* [RL4J ★159](https://github.com/deeplearning4j/rl4j) - Reinforcement learning for Java and Scala. Includes Deep-Q learning and A3C algorithms, and integrates with Open AI's Gym. Runs in the Deeplearning4j ecosystem. 
* [SAMOA](http://samoa.incubator.apache.org/) - distributed streaming machine learning framework.
* [scikit-learn ★20562](https://github.com/scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* [Intel HiBench ★532](https://github.com/intel-hadoop/HiBench) - a Hadoop benchmark suite.
...
* [Marathon ★3399](https://github.com/mesosphere/marathon) - Mesos framework for long-running services.

## Applications

* [411 ★687](https://github.com/etsy/411) - an web application for alert management resulting from scheduled searches into Elasticsearch.
* [Adobe spindle ★317 ⏳2Y](https://github.com/adobe-research/spindle) - Next-generation web analytics processing with Scala, Spark, and Parquet.
...
* [Argus ★258](https://github.com/salesforce/Argus) - Time series monitoring and alerting platform.
* [Atlas ★1446](https://github.com/Netflix/atlas) - a backend for managing dimensional time series data.
...
* [ElastAert ★3446](https://github.com/Yelp/elastalert) - ElastAlert is a simple framework for alerting on anomalies, spikes, or other patterns of interest from data in ElasticSearch.
* [Eventhub ★1218 ⏳3Y](https://github.com/Codecademy/EventHub) - open source event analytics platform.
* [Hermes ★276](https://github.com/allegro/hermes) - asynchronous message broker built on top of Kafka.
...
* [Kapacitor ★1051](https://github.com/influxdata/kapacitor) - an open source framework for processing, monitoring, and alerting on time series data.
* [Kylin](http://kylin.apache.org/) - open source Distributed Analytics Engine from eBay.
* [PivotalR ★104](https://github.com/pivotalsoftware/PivotalR) - R on Pivotal HD / HAWQ and PostgreSQL.
* [Rakam ★547](https://github.com/rakam-io/rakam) - open-source real-time custom analytics platform powered by Postgresql, Kinesis and PrestoDB. 
...
* [SnappyData ★604](https://github.com/SnappyDataInc/snappydata) - a distributed in-memory data store for real-time operational analytics, delivering stream analytics, OLTP (online transaction processing) and OLAP (online analytical processing) built on Spark in a single integrated cluster.
...
* [Elassandra ★739](https://github.com/strapdata/elassandra) - is a fork of Elasticsearch modified to run on top of Apache Cassandra in a scalable and resilient peer-to-peer architecture.
...
* [LinkedIn Cleo ★516 ⏳3Y](https://github.com/linkedin/cleo) - is a flexible software library for enabling rapid development of partial, out-of-order and real-time typeahead search.
...
* [Airpal ★2120](https://github.com/airbnb/airpal) - Web UI for PrestoDB.
...
* [Banana ★485](https://github.com/LucidWorks/banana) - visualize logs and time-stamped data stored in Solr. Port of Kibana.
* [Bloomery ★7](https://github.com/ufukomer/bloomery) - Web UI for Impala.
...
* [CartoDB ★1528](https://github.com/CartoDB/cartodb) - open-source or freemium hosting for geospatial databases with powerful front-end editing capabilities and a robust API.
...
* [D3.compose ★710](https://github.com/CSNW/d3.compose) - Compose complex, data-driven visualizations from reusable charts and components.
...
* [Freeboard ★4616](https://github.com/Freeboard/freeboard) - pen source real-time dashboard builder for IOT and other web mashups.
...
* [Matplotlib ★5722](https://github.com/matplotlib/matplotlib) - plotting with Python.
...
* [Plotly.js ★6685](https://github.com/plotly/plotly.js) The open source javascript graphing library that powers plotly.
* [Recline ★1949](https://github.com/okfn/recline) - simple but powerful library for building data applications in pure Javascript and HTML.
...
* [Superset ★15381](https://github.com/apache/incubator-superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
...
- Analytics [awesome-analytics ★751](https://github.com/onurakpolat/awesome-analytics).
---
<p align="center">
	This list is a copy of <a href="https://github.com/onurakpolat/awesome-bigdata">onurakpolat/awesome-bigdata</a> with ranks
</p>
