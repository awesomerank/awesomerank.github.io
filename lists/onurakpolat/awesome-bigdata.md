...
* [Tigon ★248](https://github.com/caskdata/tigon) - High Throughput Real-time Stream Processing Framework.
...
* [AddThis Hydra ★404](https://github.com/addthis/hydra) - distributed data processing and storage system originally developed at AddThis.
...
* [Damballa Parkour ★262 ⏳1Y](https://github.com/damballa/parkour) - MapReduce library for Clojure.
...
* [Netflix PigPen ★469](https://github.com/Netflix/PigPen) - map-reduce for Clojure which compiles to Apache Pig.
...
* [streamsx.topology ★17](https://github.com/IBMStreams/streamsx.topology) - Libraries to enable building IBM Streams application in Java, Python or Scala.
...
* [Twitter Heron ★3019](https://github.com/twitter/heron) - Heron is a realtime, distributed, fault-tolerant stream processing engine from Twitter replacing Storm.
* [Twitter Scalding ★2922](https://github.com/twitter/scalding) - Scala library for Map Reduce jobs, built on Cascading.
* [Twitter Summingbird ★1907](https://github.com/twitter/summingbird) - Streaming MapReduce with Scalding and Storm, by Twitter.
...
* [Ambry ★980](https://github.com/linkedin/ambry) - a distributed object store that supports storage of trillion of small immutable objects as well as billions of large objects.
...
* [Seaweed-FS ★4871](https://github.com/chrislusf/seaweedfs) - simple and highly scalable distributed file system.
...
* [Baidu File System ★2227](https://github.com/baidu/bfs) - distributed filesystem.
...
* [Baidu Tera ★1529](https://github.com/baidu/tera) - an Internet-scale database, inspired by BigTable.
...
* [InfiniDB ★211](https://github.com/infinidb/infinidb) - is accessed through a MySQL interface and use massive parallel processing to parallelize queries.
* [Tephra ★160 ⏳1Y](https://github.com/caskdata/tephra) - Transactions for HBase.
...
* [Bolt ★7427](https://github.com/boltdb/bolt) - an embedded key-value database for Go.
* [BTDB ★61](https://github.com/Bobris/BTDB) - Key Value Database in .Net with Object DB Layer, RPC, dynamic IL and much more
* [BuntDB ★1644](https://github.com/tidwall/buntdb) - a fast, embeddable, in-memory key/value database for Go with custom indexing and geospatial support.
* [Edis ★428 ⏳2Y](https://github.com/cbd/edis) - is a protocol-compatible Server replacement for Redis.
* [ElephantDB ★527 ⏳3Y](https://github.com/nathanmarz/elephantdb) - Distributed database specialized in exporting data from Hadoop.
* [EventStore](https://geteventstore.com/) - distributed time series database.
* [GridDB ★302](https://github.com/griddb/griddb_nosql) - suitable for sensor data stored in a timeseries.
* [HyperDex ★1232 ⏳1Y](https://github.com/rescrv/HyperDex) - a scalable, next generation key-value and document store with a wide array of features, including consistency, fault tolerance and high performance.
...
* [Riak ★2904](https://github.com/basho/riak) - a decentralized datastore.
* [Storehaus ★427](https://github.com/twitter/storehaus) - library to work with asynchronous key value stores, by Twitter.
* [SummitDB ★1036](https://github.com/tidwall/summitdb) - an in-memory, NoSQL key/value database, with disk persistance and using the Raft consensus algorithm.
* [Tarantool ★1755](https://github.com/tarantool/tarantool) - an efficient NoSQL database and a Lua application server.
* [TiKV ★2473](https://github.com/pingcap/tikv) - a distributed key-value database powered by Rust and inspired by Google Spanner and HBase.
* [Tile38 ★3608](https://github.com/tidwall/tile38) - a geolocation data store, spatial index, and realtime geofence, supporting a variety of object types including latitude/longitude points, bounding boxes, XYZ tiles, Geohashes, and GeoJSON
* [TreodeDB ★173 ⏳2Y](https://github.com/Treode/store) - key-value store that's replicated and sharded and provides atomic multirow writes.
...
* [DGraph ★4222](https://github.com/dgraph-io/dgraph) - A scalable, distributed, low latency, high throughput graph database aimed at providing Google production level scale and throughput, with low enough latency to be serving real time user queries, over terabytes of structured data.
* [EliasDB ★451](https://github.com/krotik/eliasdb) - a lightweight graph based database that does not require any third-party libraries.
...
* [GCHQ Gaffer ★1383](https://github.com/gchq/Gaffer) - Gaffer by GCHQ is a framework that makes it easy to store large-scale graphs in which the nodes and edges have statistics.
* [Google Cayley ★10772](https://github.com/cayleygraph/cayley) - open-source graph database.
...
* [Gremlin ★1658](https://github.com/tinkerpop/gremlin) - graph traversal Language.
* [Infovore ★143 ⏳3Y](https://github.com/paulhoule/infovore) - RDF-centric Map/Reduce framework.
...
* [Phoebus ★376 ⏳6Y](https://github.com/xslogic/phoebus) - framework for large scale graph processing.
* [Titan](http://thinkaurelius.github.io/titan/) - distributed graph database, built over Cassandra.
* [Twitter FlockDB ★3119](https://github.com/twitter-archive/flockdb) - distributed graph database.
...
* [IndexR ★287](https://github.com/shunfei/indexr) an open-source columnar storage format for fast & realtime analytic with big data.
...
* [Comdb2 ★684](https://github.com/bloomberg/comdb2) - a clustered RDBMS built on optimistic concurrency control techniques.
...
* [Haeinsa ★142](https://github.com/VCNC/haeinsa) - linearly scalable multi-row, multi-table transaction library for HBase based on Percolator.
...
* [Kairosdb ★1150](https://github.com/kairosdb/kairosdb) - similar to OpenTSDB but allows for Cassandra.
...
* [Beringei ★2519](https://github.com/facebookincubator/beringei) - Facebook's in-memory time-series database.
* [TrailDB](http://traildb.io/) - an efficient tool for storing and querying series of events.
* [Druid ★5835](https://github.com/druid-io/druid) Column oriented distributed data store ideal for powering interactive applications
...
* [Akumuli ★327](https://github.com/akumuli/Akumuli) Akumuli is a numeric time-series database. It can be used to capture, store and process time-series data in real-time. The word "akumuli" can be translated from esperanto as "accumulate".
...
* [Facebook Scribe ★3586 ⏳1Y](https://github.com/facebookarchive/scribe) - streamed log data aggregator.
...
* [Heka ★3293 ⏳1Y](https://github.com/mozilla-services/heka) - open source stream processing software system.
...
* [Netflix Suro ★645 ⏳2Y](https://github.com/Netflix/suro) - log agregattor like Storm and Samza based on Chukwa.
* [Pinterest Secor ★1076](https://github.com/pinterest/secor) - is a service implementing Kafka log persistance.
...
* [StreamSets Data Collector ★378](https://github.com/streamsets/datacollector) - continuous big data ingest infrastructure with a simple to use IDE.
* [Yahoo Pulsar ★1472](https://github.com/apache/incubator-pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
...
* [Spotify Luigi ★8174](https://github.com/spotify/luigi) - a Python package for building complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization, handling failures, command line integration, and much more.
* [Spring XD ★435](https://github.com/spring-projects/spring-xd) - distributed and extensible system for data ingestion, real time analytics, batch processing, and data export.
* [Twitter Elephant Bird ★1053](https://github.com/twitter/elephant-bird) - libraries for working with LZOP-compressed data.
* [Twitter Finagle](https://twitter.github.io/finagle/) - asynchronous network stack for the JVM.

## Scheduling

* [Apache Airflow ★6763](https://github.com/apache/incubator-airflow) - a platform to programmatically author, schedule and monitor workflows.
...
* [Schedoscope ★66](https://github.com/ottogroup/schedoscope) - Scala DSL for agile scheduling of Hadoop jobs.
* [Sparrow ★233 ⏳4Y](https://github.com/radlab/sparrow) - scheduling platform.


## Machine Learning

* [Azure ML Studio](https://studio.azureml.net/) - Cloud-based AzureML, R, Python Machine Learning platform
* [brain ★7947](https://github.com/harthur/brain) - Neural networks in JavaScript.
...
* [DataVec ★167](https://github.com/deeplearning4j/DataVec) - A vectorization and data preprocessing library for deep learning in Java and Scala. Part of the Deeplearning4j ecosystem. 
...
* [Decider ★399](https://github.com/danielsdeleo/Decider) - Flexible and Extensible Machine Learning in Ruby.
...
* [Etsy Conjecture ★345](https://github.com/etsy/Conjecture) - scalable Machine Learning in Scalding.
...
* [H2O ★2680](https://github.com/h2oai/h2o-3) - statistical, machine learning and math runtime with Hadoop. R and Python.
* [Keras ★22564](https://github.com/fchollet/keras) - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
...
* [MLPNeuralNet ★922 ⏳1Y](https://github.com/nikolaypavlov/MLPNeuralNet) - Fast multilayer perceptron neural network library for iOS and Mac OS X.
...
* [ND4J ★1261](https://github.com/deeplearning4j/nd4j) - A matrix library for the JVM. Numpy for Java. 
* [nupic ★5310](https://github.com/numenta/nupic) - Numenta Platform for Intelligent Computing: a brain-inspired machine intelligence platform, and biologically accurate neural network based on cortical learning algorithms.
...
* [RL4J ★209](https://github.com/deeplearning4j/rl4j) - Reinforcement learning for Java and Scala. Includes Deep-Q learning and A3C algorithms, and integrates with Open AI's Gym. Runs in the Deeplearning4j ecosystem. 
* [SAMOA](http://samoa.incubator.apache.org/) - distributed streaming machine learning framework.
* [scikit-learn ★23850](https://github.com/scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* [TensorFlow ★80786](https://github.com/tensorflow/tensorflow) - Library from Google for machine learning using data flow graphs.
...
* [Velox ★107](https://github.com/amplab/velox-modelserver) - System for serving machine learning predictions.
...
* [Intel HiBench ★592](https://github.com/intel-hadoop/HiBench) - a Hadoop benchmark suite.
...
* [Deeplearning4j Benchmarks ★19](https://github.com/deeplearning4j/dl4j-benchmark)
...
* [BDA ★221](https://github.com/kotobukki/BDA) - The vulnerability detector for Hadoop and Spark
...
* [Apache Slider ★61](https://github.com/apache/incubator-slider) - is a YARN application to deploy existing distributed applications on YARN.
...
* [Marathon ★3536](https://github.com/mesosphere/marathon) - Mesos framework for long-running services.

## Applications

* [411 ★724](https://github.com/etsy/411) - an web application for alert management resulting from scheduled searches into Elasticsearch.
...
* [ElastAert ★3850](https://github.com/Yelp/elastalert) - ElastAlert is a simple framework for alerting on anomalies, spikes, or other patterns of interest from data in ElasticSearch.
* [Eventhub ★1224 ⏳3Y](https://github.com/Codecademy/EventHub) - open source event analytics platform.
* [Hermes ★301](https://github.com/allegro/hermes) - asynchronous message broker built on top of Kafka.
...
* [Kapacitor ★1199](https://github.com/influxdata/kapacitor) - an open source framework for processing, monitoring, and alerting on time series data.
* [Kylin](http://kylin.apache.org/) - open source Distributed Analytics Engine from eBay.
* [PivotalR ★108](https://github.com/pivotalsoftware/PivotalR) - R on Pivotal HD / HAWQ and PostgreSQL.
* [Rakam ★601](https://github.com/rakam-io/rakam) - open-source real-time custom analytics platform powered by Postgresql, Kinesis and PrestoDB. 
...
* [SnappyData ★669](https://github.com/SnappyDataInc/snappydata) - a distributed in-memory data store for real-time operational analytics, delivering stream analytics, OLTP (online transaction processing) and OLAP (online analytical processing) built on Spark in a single integrated cluster.
* [Snowplow ★3727](https://github.com/snowplow/snowplow) - enterprise-strength web and event analytics, powered by Hadoop, Kinesis, Redshift and Postgres.
...
* [Elassandra ★832](https://github.com/strapdata/elassandra) - is a fork of Elasticsearch modified to run on top of Apache Cassandra in a scalable and resilient peer-to-peer architecture.
...
* [LinkedIn Cleo ★519 ⏳4Y](https://github.com/linkedin/cleo) - is a flexible software library for enabling rapid development of partial, out-of-order and real-time typeahead search.
* [LinkedIn Galene](https://engineering.linkedin.com/search/did-you-mean-galene) - search architecture at LinkedIn.
* [LinkedIn Zoie ★331 ⏳3Y](https://github.com/senseidb/zoie) - is a realtime search/indexing system written in Java.
...
* [ProxySQL ★16](https://github.com/renecannao/proxysql) - High Performance Proxy for MySQL.
...
* [Twemproxy ★7421](https://github.com/twitter/twemproxy) - A fast, light-weight proxy for memcached and redis.
* [Twitter Fatcache ★1204](https://github.com/twitter/fatcache) - key/value cache for flash storage.
* [Twitter Twemcache ★806](https://github.com/twitter/twemcache) - fork of Memcache.
...
* [HanoiDB ★262 ⏳1Y](https://github.com/krestenkrab/hanoidb) - Erlang LSM BTree Storage.
* [LevelDB ★11815](https://github.com/google/leveldb) - a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
...
* [Metabase ★7689](https://github.com/metabase/metabase) - The simplest, fastest way to get business intelligence and analytics to everyone in your company

## Data Visualization

* [Airpal ★2198](https://github.com/airbnb/airpal) - Web UI for PrestoDB.
* [AnyChart](http://www.anychart.com) - fast, simple and flexible JavaScript (HTML5) charting library featuring pure JS API.
* [Arbor ★2460 ⏳1Y](https://github.com/samizdatco/arbor) - graph visualization library using web workers and jQuery.
* [Banana ★508](https://github.com/LucidWorks/banana) - visualize logs and time-stamped data stored in Solr. Port of Kibana.
* [Bloomery ★9](https://github.com/ufukomer/bloomery) - Web UI for Impala.
...
* [CartoDB ★1675](https://github.com/CartoDB/cartodb) - open-source or freemium hosting for geospatial databases with powerful front-end editing capabilities and a robust API.
...
* [Chartist.js ★10270](https://github.com/gionkunz/chartist-js) - another open source HTML5 Charts visualization.
...
* [Cubism ★4614](https://github.com/square/cubism) - JavaScript library for time series visualization.
...
* [D3.compose ★707](https://github.com/CSNW/d3.compose) - Compose complex, data-driven visualizations from reusable charts and components.
* [D3Plus](http://d3plus.org) - A fairly robust set of reusable charts and styles for d3.js.
* [Echarts ★22786](https://github.com/ecomfe/echarts) - Baidus enterprise charts.
...
* [Freeboard ★4842](https://github.com/Freeboard/freeboard) - pen source real-time dashboard builder for IOT and other web mashups.
* [Gephi ★2372](https://github.com/gephi/gephi) - An award-winning open-source platform for visualizing and manipulating large graphs and network connections. It's like Photoshop, but for graphs. Available for Windows and Mac OS X.
...
* [Matplotlib ★6403](https://github.com/matplotlib/matplotlib) - plotting with Python.
...
* [Plotly.js ★7266](https://github.com/plotly/plotly.js) The open source javascript graphing library that powers plotly.
* [Recline ★1978](https://github.com/okfn/recline) - simple but powerful library for building data applications in pure Javascript and HTML.
* [Redash ★8019](https://github.com/getredash/redash) - open-source platform to query and visualize data.
* [ReCharts](http://recharts.org/) - A composable charting library built on React components
* [Shiny](http://shiny.rstudio.com/) - a web application framework for R.
* [Sigma.js ★7672](https://github.com/jacomyal/sigma.js) - JavaScript library dedicated to graph drawing.
* [Superset ★17229](https://github.com/apache/incubator-superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
* [Vega ★18 ⏳2Y](https://github.com/trifacta/vega) - a visualization grammar.
* [Zeppelin ★426](https://github.com/ZEPL/zeppelin) - a notebook-style collaborative data analysis.
...
- Analytics [awesome-analytics ★898](https://github.com/onurakpolat/awesome-analytics).
---
<p align="center">
	This list is a copy of <a href="https://github.com/onurakpolat/awesome-bigdata">onurakpolat/awesome-bigdata</a> with ranks
</p>
