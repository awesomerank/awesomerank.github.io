...
* [Tigon ★235](caskdata/tigon) - High Throughput Real-time Stream Processing Framework.
...
* [AddThis Hydra ★380](addthis/hydra) - distributed data processing and storage system originally developed at AddThis.
...
* [Damballa Parkour ★258 ⏳1Y](damballa/parkour) - MapReduce library for Clojure.
* [Datasalt Pangool ★59](datasalt/pangool) - alternative MapReduce paradigm.
...
* [Netflix PigPen ★466](Netflix/PigPen) - map-reduce for Clojure which compiles to Apache Pig.
...
* [Skale ★128](skale-me/skale-engine) - High performance distributed data processing in NodeJS.
...
* [streamsx.topology ★14](IBMStreams/streamsx.topology) - Libraries to enable building IBM Streams application in Java, Python or Scala.
* [Tuktu ★47](UnderstandLingBV/Tuktu) - Easy-to-use platform for batch and streaming computation, built using Scala, Akka and Play!
* [Twitter Heron ★2717](twitter/heron) - Heron is a realtime, distributed, fault-tolerant stream processing engine from Twitter replacing Storm.
* [Twitter Scalding ★2821](twitter/scalding) - Scala library for Map Reduce jobs, built on Cascading.
* [Twitter Summingbird ★1851](twitter/summingbird) - Streaming MapReduce with Scalding and Storm, by Twitter.
* [Twitter TSAR](https://blog.twitter.com/2014/tsar-a-timeseries-aggregator) - TimeSeries AggregatoR by Twitter.

## Distributed Filesystem

* [Ambry ★883](linkedin/ambry) - a distributed object store that supports storage of trillion of small immutable objects as well as billions of large objects.
...
* [Seaweed-FS ★4332](chrislusf/seaweedfs) - simple and highly scalable distributed file system.
...
* [Baidu File System ★1998](baidu/bfs) - distributed filesystem.
...
* [Baidu Tera ★1350](baidu/tera) - an Internet-scale database, inspired by BigTable.
...
* [InfiniDB ★201](infinidb/infinidb) - is accessed through a MySQL interface and use massive parallel processing to parallelize queries.
* [Tephra ★151](caskdata/tephra) - Transactions for HBase.
...
* [Bolt ★6290](boltdb/bolt) - an embedded key-value database for Go.
* [BuntDB ★1442](tidwall/buntdb) - a fast, embeddable, in-memory key/value database for Go with custom indexing and geospatial support.
* [Edis ★424 ⏳1Y](cbd/edis) - is a protocol-compatible Server replacement for Redis.
* [ElephantDB ★521 ⏳2Y](nathanmarz/elephantdb) - Distributed database specialized in exporting data from Hadoop.
* [EventStore](https://geteventstore.com/) - distributed time series database.
* [GridDB ★289](griddb/griddb_nosql) - suitable for sensor data stored in a timeseries.
* [HyperDex ★1177](rescrv/HyperDex) - a scalable, next generation key-value and document store with a wide array of features, including consistency, fault tolerance and high performance.
...
* [Riak ★2771](basho/riak) - a decentralized datastore.
* [Storehaus ★410](twitter/storehaus) - library to work with asynchronous key value stores, by Twitter.
* [SummitDB ★937](tidwall/summitdb) - an in-memory, NoSQL key/value database, with disk persistance and using the Raft consensus algorithm.
* [Tarantool ★1515](tarantool/tarantool) - an efficient NoSQL database and a Lua application server.
* [TiKV ★1842](pingcap/tikv) - a distributed key-value database powered by Rust and inspired by Google Spanner and HBase.
* [Tile38 ★3062](tidwall/tile38) - a geolocation data store, spatial index, and realtime geofence, supporting a variety of object types including latitude/longitude points, bounding boxes, XYZ tiles, Geohashes, and GeoJSON
* [TreodeDB ★170 ⏳1Y](Treode/store) - key-value store that's replicated and sharded and provides atomic multirow writes.
...
* [DGraph ★3239](dgraph-io/dgraph) - A scalable, distributed, low latency, high throughput graph database aimed at providing Google production level scale and throughput, with low enough latency to be serving real time user queries, over terabytes of structured data.
* [EliasDB ★417](krotik/eliasdb) - a lightweight graph based database that does not require any third-party libraries.
...
* [Gremlin ★1604](tinkerpop/gremlin) - graph traversal Language.
* [Infovore ★137 ⏳2Y](paulhoule/infovore) - RDF-centric Map/Reduce framework.
...
* [Phoebus ★374 ⏳5Y](xslogic/phoebus) - framework for large scale graph processing.
...
* [IndexR ★148](shunfei/indexr) an open-source columnar storage format for fast & realtime analytic with big data.
...
* [Cockroach ★10346](cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
...
* [Haeinsa ★134](VCNC/haeinsa) - linearly scalable multi-row, multi-table transaction library for HBase based on Percolator.
...
* [Kairosdb ★1055](kairosdb/kairosdb) - similar to OpenTSDB but allows for Cassandra.
...
* [Beringei ★2233](facebookincubator/beringei) - Facebook's in-memory time-series database.
* [TrailDB](http://traildb.io/) - an efficient tool for storing and querying series of events.
* [Druid ★4933](druid-io/druid) Column oriented distributed data store ideal for powering interactive applications
...
* [Akumuli ★244](akumuli/Akumuli) Akumuli is a numeric time-series database. It can be used to capture, store and process time-series data in real-time. The word "akumuli" can be translated from esperanto as "accumulate".
* [Rhombus ★120 ⏳2Y](Pardot/Rhombus) A time-series object store for Cassandra that handles all the complexity of building wide row indexes.
* [Dalmatiner DB ★430](dalmatinerdb/dalmatinerdb) Fast distributed metrics database
* [Blueflood ★528](rackerlabs/blueflood) A distributed system designed to ingest and process time series data
* [Timely ★65](NationalSecurityAgency/timely) Timely is a time series database application that provides secure access to time series data based on Accumulo and Grafana.
...
* [Facebook Scribe ★3497](facebookarchive/scribe) - streamed log data aggregator.
...
* [Heka ★3262](mozilla-services/heka) - open source stream processing software system.
* [HIHO ★82 ⏳4Y](sonalgoyal/hiho) - framework for connecting disparate data sources with Hadoop.
* [Kestrel ★4 ⏳1Y](papertrail/kestrel) - distributed message queue system.
* [LinkedIn Databus](http://data.linkedin.com/projects/databus) - stream of change capture events for a database.
* [LinkedIn Kamikaze ★21 ⏳3Y](linkedin/kamikaze) - utility package for compressing sorted integer arrays.
* [LinkedIn White Elephant ★179 ⏳3Y](linkedin/white-elephant) - log aggregator and dashboard.
* [Logstash](https://www.elastic.co/products/logstash) - a tool for managing events and logs.
* [Netflix Suro ★610 ⏳1Y](Netflix/suro) - log agregattor like Storm and Samza based on Chukwa.
* [Pinterest Secor ★928](pinterest/secor) - is a service implementing Kafka log persistance.
* [Linkedin Gobblin ★967](linkedin/gobblin) - linkedin's universal data ingestion framework.
* [Skizze ★742 ⏳1Y](skizzehq/skizze) - sketch data store to deal with all problems around counting and sketching using probabilistic data-structures.
* [StreamSets Data Collector ★283](streamsets/datacollector) - continuous big data ingest infrastructure with a simple to use IDE.
* [Yahoo Pulsar ★1213](yahoo/pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
...
* [Hydrosphere Mist ★79](Hydrospheredata/mist) - a service for exposing Apache Spark analytics jobs and machine learning models as realtime, batch or reactive web services.
...
* [Spotify Luigi ★7041](spotify/luigi) - a Python package for building complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization, handling failures, command line integration, and much more.
* [Spring XD ★419](spring-projects/spring-xd) - distributed and extensible system for data ingestion, real time analytics, batch processing, and data export.
* [Twitter Elephant Bird ★1037](twitter/elephant-bird) - libraries for working with LZOP-compressed data.
...
* [Schedoscope ★59](ottogroup/schedoscope) - Scala DSL for agile scheduling of Hadoop jobs.
* [Sparrow ★228 ⏳3Y](radlab/sparrow) - scheduling platform.


## Machine Learning

* [Azure ML Studio](https://studio.azureml.net/) - Cloud-based AzureML, R, Python Machine Learning platform
* [brain ★7707](harthur/brain) - Neural networks in JavaScript.
* [Cloudera Oryx ★1422](cloudera/oryx) - real-time large-scale machine learning.
...
* [DataVec ★99](deeplearning4j/DataVec) - A vectorization and data preprocessing library for deep learning in Java and Scala. Part of the Deeplearning4j ecosystem. 
...
* [Decider ★393](danielsdeleo/Decider) - Flexible and Extensible Machine Learning in Ruby.
...
* [Etsy Conjecture ★335](etsy/Conjecture) - scalable Machine Learning in Scalding.
...
* [H2O ★2070](h2oai/h2o-3) - statistical, machine learning and math runtime with Hadoop. R and Python.
* [Keras ★15981](fchollet/keras) - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
...
* [MLPNeuralNet ★906](nikolaypavlov/MLPNeuralNet) - Fast multilayer perceptron neural network library for iOS and Mac OS X.
...
* [ND4J ★1026](deeplearning4j/nd4j) - A matrix library for the JVM. Numpy for Java. 
* [nupic ★5022](numenta/nupic) - Numenta Platform for Intelligent Computing: a brain-inspired machine intelligence platform, and biologically accurate neural network based on cortical learning algorithms.
* [PredictionIO](https://prediction.io/) - machine learning server buit on Hadoop, Mahout and Cascading.
* [RL4J ★137](deeplearning4j/rl4j) - Reinforcement learning for Java and Scala. Includes Deep-Q learning and A3C algorithms, and integrates with Open AI's Gym. Runs in the Deeplearning4j ecosystem. 
* [SAMOA](http://samoa.incubator.apache.org/) - distributed streaming machine learning framework.
* [scikit-learn ★18792](scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* [TensorFlow ★58822](tensorflow/tensorflow) - Library from Google for machine learning using data flow graphs.
...
* [Velox ★105](amplab/velox-modelserver) - System for serving machine learning predictions.
...
* [Intel HiBench ★502](intel-hadoop/HiBench) - a Hadoop benchmark suite.
...
* [Deeplearning4j Benchmarks ★12](deeplearning4j/dl4j-benchmark)
...
* [Apache Slider ★55](apache/incubator-slider) - is a YARN application to deploy existing distributed applications on YARN.
...
* [Marathon ★3260](mesosphere/marathon) - Mesos framework for long-running services.

## Applications

* [411 ★664](etsy/411) - an web application for alert management resulting from scheduled searches into Elasticsearch.
* [Adobe spindle ★313 ⏳2Y](adobe-research/spindle) - Next-generation web analytics processing with Scala, Spark, and Parquet.
...
* [Atlas ★1375](Netflix/atlas) - a backend for managing dimensional time series data.
...
* [ElastAert ★3176](Yelp/elastalert) - ElastAlert is a simple framework for alerting on anomalies, spikes, or other patterns of interest from data in ElasticSearch.
* [Eventhub ★1210 ⏳2Y](Codecademy/EventHub) - open source event analytics platform.
* [Hermes ★255](allegro/hermes) - asynchronous message broker built on top of Kafka.
...
* [Kapacitor ★965](influxdata/kapacitor) - an open source framework for processing, monitoring, and alerting on time series data.
* [Kylin](http://kylin.apache.org/) - open source Distributed Analytics Engine from eBay.
* [PivotalR ★101](pivotalsoftware/PivotalR) - R on Pivotal HD / HAWQ and PostgreSQL.
* [Rakam ★505](rakam-io/rakam) - open-source real-time custom analytics platform powered by Postgresql, Kinesis and PrestoDB. 
...
* [SnappyData ★559](SnappyDataInc/snappydata) - a distributed in-memory data store for real-time operational analytics, delivering stream analytics, OLTP (online transaction processing) and OLAP (online analytical processing) built on Spark in a single integrated cluster.
* [Snowplow ★3356](snowplow/snowplow) - enterprise-strength web and event analytics, powered by Hadoop, Kinesis, Redshift and Postgres.
...
* [LinkedIn Cleo ★514 ⏳3Y](linkedin/cleo) - is a flexible software library for enabling rapid development of partial, out-of-order and real-time typeahead search.
* [LinkedIn Galene](http://engineering.linkedin.com/search/did-you-mean-galene) - search architecture at LinkedIn.
* [LinkedIn Zoie ★332 ⏳3Y](senseidb/zoie) - is a realtime search/indexing system written in Java.
...
* [ProxySQL ★14 ⏳1Y](renecannao/proxysql) - High Performance Proxy for MySQL.
...
* [Twemproxy ★6788](twitter/twemproxy) - A fast, light-weight proxy for memcached and redis.
* [Twitter Fatcache ★1186](twitter/fatcache) - key/value cache for flash storage.
* [Twitter Twemcache ★782 ⏳1Y](twitter/twemcache) - fork of Memcache.
...
* [HanoiDB ★256](krestenkrab/hanoidb) - Erlang LSM BTree Storage.
* [LevelDB ★9465](google/leveldb) - a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
...
* [Metabase ★5769](metabase/metabase) - The simplest, fastest way to get business intelligence and analytics to everyone in your company

## Data Visualization

* [Airpal ★2047](airbnb/airpal) - Web UI for PrestoDB.
* [AnyChart](http://www.anychart.com) - fast, simple and flexible JavaScript (HTML5) charting library featuring pure JS API.
* [Arbor ★2391 ⏳1Y](samizdatco/arbor) - graph visualization library using web workers and jQuery.
* [Banana ★472](LucidWorks/banana) - visualize logs and time-stamped data stored in Solr. Port of Kibana.
* [Bloomery ★6](ufukomer/bloomery) - Web UI for Impala.
...
* [CartoDB ★1478](CartoDB/cartodb) - open-source or freemium hosting for geospatial databases with powerful front-end editing capabilities and a robust API.
...
* [Chartist.js ★9525](gionkunz/chartist-js) - another open source HTML5 Charts visualization.
...
* [Cubism ★4523](square/cubism) - JavaScript library for time series visualization.
...
* [D3.compose ★713](CSNW/d3.compose) - Compose complex, data-driven visualizations from reusable charts and components.
* [D3Plus](http://d3plus.org) - A fairly robust set of reusable charts and styles for d3.js.
* [Echarts ★18131](ecomfe/echarts) - Baidus enterprise charts.
...
* [Freeboard ★4373](Freeboard/freeboard) - pen source real-time dashboard builder for IOT and other web mashups.
* [Gephi ★2022](gephi/gephi) - An award-winning open-source platform for visualizing and manipulating large graphs and network connections. It's like Photoshop, but for graphs. Available for Windows and Mac OS X.
...
* [Matplotlib ★5304](matplotlib/matplotlib) - plotting with Python.
...
* [Plotly.js ★6320](plotly/plotly.js) The open source javascript graphing library that powers plotly.
* [Recline ★1933](okfn/recline) - simple but powerful library for building data applications in pure Javascript and HTML.
* [Redash ★6696](getredash/redash) - open-source platform to query and visualize data.
* [ReCharts](http://recharts.org/) - A composable charting library built on React components
* [Shiny](http://shiny.rstudio.com/) - a web application framework for R.
* [Sigma.js ★7238](jacomyal/sigma.js) - JavaScript library dedicated to graph drawing.
* [Superset ★14165](airbnb/superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
...
# Other Awesome Lists
- Other awesome lists [awesome-awesomeness ★18868](bayandin/awesome-awesomeness).
- Even more lists [awesome ★59088](sindresorhus/awesome).
- Another list? [list ★4263](jnv/lists).
- WTF! [awesome-awesome-awesome ★880](t3chnoboy/awesome-awesome-awesome).
- Analytics [awesome-analytics ★689](onurakpolat/awesome-analytics).
---
<p align="center">
	This list is a copy of <a href="onurakpolat/awesome-bigdata">onurakpolat/awesome-bigdata</a> with ranks
</p>
