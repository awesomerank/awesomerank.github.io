...
* [Tigon ★234](https://github.com/caskdata/tigon) - High Throughput Real-time Stream Processing Framework.
...
* [AddThis Hydra ★381](https://github.com/addthis/hydra) - distributed data processing and storage system originally developed at AddThis.
...
* [Netflix PigPen ★461](https://github.com/Netflix/PigPen) - map-reduce for Clojure which compiles to Apache Pig.
...
* [Skale ★114](https://github.com/skale-me/skale-engine) - High performance distributed data processing in NodeJS.
...
* [Tuktu ★46](https://github.com/UnderstandLingBV/Tuktu) - Easy-to-use platform for batch and streaming computation, built using Scala, Akka and Play!
* [Twitter Heron ★2685](https://github.com/twitter/heron) - Heron is a realtime, distributed, fault-tolerant stream processing engine from Twitter replacing Storm.
* [Twitter Scalding ★2788](https://github.com/twitter/scalding) - Scala library for Map Reduce jobs, built on Cascading.
* [Twitter Summingbird ★1844](https://github.com/twitter/summingbird) - Streaming MapReduce with Scalding and Storm, by Twitter.
* [Twitter TSAR](https://blog.twitter.com/2014/tsar-a-timeseries-aggregator) - TimeSeries AggregatoR by Twitter.

## Distributed Filesystem

* [Ambry ★865](https://github.com/linkedin/ambry) - a distributed object store that supports storage of trillion of small immutable objects as well as billions of large objects.
...
* [Seaweed-FS ★4238](https://github.com/chrislusf/seaweedfs) - simple and highly scalable distributed file system.
...
* [Baidu File System ★1974](https://github.com/baidu/bfs) - distributed filesystem.
...
* [Baidu Tera ★1291](https://github.com/baidu/tera) - an Internet-scale database, inspired by BigTable.
...
* [InfiniDB ★202](https://github.com/infinidb/infinidb) - is accessed through a MySQL interface and use massive parallel processing to parallelize queries.
...
* [Bolt ★6117](https://github.com/boltdb/bolt) - an embedded key-value database for Go.
* [BuntDB ★1419](https://github.com/tidwall/buntdb) - a fast, embeddable, in-memory key/value database for Go with custom indexing and geospatial support.
* [Edis ★424](https://github.com/cbd/edis) - is a protocol-compatible Server replacement for Redis.
* [ElephantDB ★521](https://github.com/nathanmarz/elephantdb) - Distributed database specialized in exporting data from Hadoop.
* [EventStore](https://geteventstore.com/) - distributed time series database.
* [GridDB ★287](https://github.com/griddb/griddb_nosql) - suitable for sensor data stored in a timeseries.
* [HyperDex ★1173](https://github.com/rescrv/HyperDex) - a scalable, next generation key-value and document store with a wide array of features, including consistency, fault tolerance and high performance.
...
* [Riak ★2752](https://github.com/basho/riak) - a decentralized datastore.
* [Storehaus ★408](https://github.com/twitter/storehaus) - library to work with asynchronous key value stores, by Twitter.
* [SummitDB ★922](https://github.com/tidwall/summitdb) - an in-memory, NoSQL key/value database, with disk persistance and using the Raft consensus algorithm.
* [Tarantool ★1452](https://github.com/tarantool/tarantool) - an efficient NoSQL database and a Lua application server.
* [TiKV ★1767](https://github.com/pingcap/tikv) - a distributed key-value database powered by Rust and inspired by Google Spanner and HBase.
* [Tile38 ★3022](https://github.com/tidwall/tile38) - a geolocation data store, spatial index, and realtime geofence, supporting a variety of object types including latitude/longitude points, bounding boxes, XYZ tiles, Geohashes, and GeoJSON
* [TreodeDB ★170](https://github.com/Treode/store) - key-value store that's replicated and sharded and provides atomic multirow writes.
...
* [DGraph ★2549](https://github.com/dgraph-io/dgraph) - A scalable, distributed, low latency, high throughput graph database aimed at providing Google production level scale and throughput, with low enough latency to be serving real time user queries, over terabytes of structured data.
* [EliasDB ★414](https://github.com/krotik/eliasdb) - a lightweight graph based database that does not require any third-party libraries.
...
* [Gremlin ★1589](https://github.com/tinkerpop/gremlin) - graph traversal Language.
* [Infovore ★137](https://github.com/paulhoule/infovore) - RDF-centric Map/Reduce framework.
...
* [Phoebus ★374](https://github.com/xslogic/phoebus) - framework for large scale graph processing.
...
* [IndexR ★140](https://github.com/shunfei/indexr) an open-source columnar storage format for fast & realtime analytic with big data.
...
* [Cockroach ★9368](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.
...
* [Haeinsa ★133](https://github.com/VCNC/haeinsa) - linearly scalable multi-row, multi-table transaction library for HBase based on Percolator.
...
* [Kairosdb ★1038](https://github.com/kairosdb/kairosdb) - similar to OpenTSDB but allows for Cassandra.
...
* [Beringei ★2157](https://github.com/facebookincubator/beringei) - Facebook's in-memory time-series database.
...
* [Facebook Scribe ★3475](https://github.com/facebookarchive/scribe) - streamed log data aggregator.
...
* [Heka ★3251](https://github.com/mozilla-services/heka) - open source stream processing software system.
* [HIHO ★82](https://github.com/sonalgoyal/hiho) - framework for connecting disparate data sources with Hadoop.
...
* [LinkedIn Kamikaze ★21](https://github.com/linkedin/kamikaze) - utility package for compressing sorted integer arrays.
* [LinkedIn White Elephant ★178](https://github.com/linkedin/white-elephant) - log aggregator and dashboard.
* [Logstash](https://www.elastic.co/products/logstash) - a tool for managing events and logs.
* [Netflix Suro ★601](https://github.com/Netflix/suro) - log agregattor like Storm and Samza based on Chukwa.
* [Pinterest Secor ★912](https://github.com/pinterest/secor) - is a service implementing Kafka log persistance.
* [Linkedin Gobblin ★931](https://github.com/linkedin/gobblin) - linkedin's universal data ingestion framework.
* [Skizze ★742](https://github.com/skizzehq/skizze) - sketch data store to deal with all problems around counting and sketching using probabilistic data-structures.
* [StreamSets Data Collector ★269](https://github.com/streamsets/datacollector) - continuous big data ingest infrastructure with a simple to use IDE.
* [Yahoo Pulsar ★1193](https://github.com/yahoo/pulsar) - a distributed pub-sub messaging platform with a very flexible messaging model and an intuitive client API.
...
* [Hydrosphere Mist ★72](https://github.com/Hydrospheredata/mist) - a service for exposing Apache Spark analytics jobs and machine learning models as realtime, batch or reactive web services.
...
* [Spotify Luigi ★6826](https://github.com/spotify/luigi) - a Python package for building complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization, handling failures, command line integration, and much more.
* [Spring XD ★418](https://github.com/spring-projects/spring-xd) - distributed and extensible system for data ingestion, real time analytics, batch processing, and data export.
* [Twitter Elephant Bird ★1032](https://github.com/twitter/elephant-bird) - libraries for working with LZOP-compressed data.
...
* [Schedoscope ★60](https://github.com/ottogroup/schedoscope) - Scala DSL for agile scheduling of Hadoop jobs.
* [Sparrow ★227](https://github.com/radlab/sparrow) - scheduling platform.


## Machine Learning

* [Azure ML Studio](https://studio.azureml.net/) - Cloud-based AzureML, R, Python Machine Learning platform
* [brain ★7651](https://github.com/harthur/brain) - Neural networks in JavaScript.
* [Cloudera Oryx ★1415](https://github.com/cloudera/oryx) - real-time large-scale machine learning.
...
* [DataVec ★93](https://github.com/deeplearning4j/DataVec) - A vectorization and data preprocessing library for deep learning in Java and Scala. Part of the Deeplearning4j ecosystem. 
...
* [Etsy Conjecture ★332](https://github.com/etsy/Conjecture) - scalable Machine Learning in Scalding.
...
* [H2O ★1975](https://github.com/h2oai/h2o-3) - statistical, machine learning and math runtime with Hadoop. R and Python.
* [Keras ★15082](https://github.com/fchollet/keras) - An intuitive neural net API inspired by Torch that runs atop Theano and Tensorflow.
...
* [ND4J ★994](https://github.com/deeplearning4j/nd4j) - A matrix library for the JVM. Numpy for Java. 
* [nupic ★4974](https://github.com/numenta/nupic) - Numenta Platform for Intelligent Computing: a brain-inspired machine intelligence platform, and biologically accurate neural network based on cortical learning algorithms.
* [PredictionIO](https://prediction.io/) - machine learning server buit on Hadoop, Mahout and Cascading.
* [RL4J ★130](https://github.com/deeplearning4j/rl4j) - Reinforcement learning for Java and Scala. Includes Deep-Q learning and A3C algorithms, and integrates with Open AI's Gym. Runs in the Deeplearning4j ecosystem. 
* [SAMOA](http://samoa.incubator.apache.org/) - distributed streaming machine learning framework.
* [scikit-learn ★18260](https://github.com/scikit-learn/scikit-learn) - scikit-learn: machine learning in Python.
...
* [TensorFlow ★55594](https://github.com/tensorflow/tensorflow) - Library from Google for machine learning using data flow graphs.
...
* [Intel HiBench ★491](https://github.com/intel-hadoop/HiBench) - a Hadoop benchmark suite.
...
* [Deeplearning4j Benchmarks ★11](https://github.com/deeplearning4j/dl4j-benchmark)
...
* [Apache Slider ★54](https://github.com/apache/incubator-slider) - is a YARN application to deploy existing distributed applications on YARN.
...
* [Marathon ★3227](https://github.com/mesosphere/marathon) - Mesos framework for long-running services.

## Applications

* [411 ★644](https://github.com/etsy/411) - an web application for alert management resulting from scheduled searches into Elasticsearch.
* [Adobe spindle ★311](https://github.com/adobe-research/spindle) - Next-generation web analytics processing with Scala, Spark, and Parquet.
...
* [Atlas ★1336](https://github.com/Netflix/atlas) - a backend for managing dimensional time series data.
...
* [ElastAert ★3074](https://github.com/Yelp/elastalert) - ElastAlert is a simple framework for alerting on anomalies, spikes, or other patterns of interest from data in ElasticSearch.
* [Eventhub ★1204](https://github.com/Codecademy/EventHub) - open source event analytics platform.
* [Hermes ★250](https://github.com/allegro/hermes) - asynchronous message broker built on top of Kafka.
...
* [Kapacitor ★921](https://github.com/influxdata/kapacitor) - an open source framework for processing, monitoring, and alerting on time series data.
...
* [Rakam ★346](https://github.com/rakam-io/rakam) - open-source real-time custom analytics platform powered by Postgresql, Kinesis and PrestoDB. 
...
* [Snowplow ★3289](https://github.com/snowplow/snowplow) - enterprise-strength web and event analytics, powered by Hadoop, Kinesis, Redshift and Postgres.
...
* [LinkedIn Cleo ★513](https://github.com/linkedin/cleo) - is a flexible software library for enabling rapid development of partial, out-of-order and real-time typeahead search.
* [LinkedIn Galene](http://engineering.linkedin.com/search/did-you-mean-galene) - search architecture at LinkedIn.
* [LinkedIn Zoie ★334](https://github.com/senseidb/zoie) - is a realtime search/indexing system written in Java.
...
* [ProxySQL ★13](https://github.com/renecannao/proxysql) - High Performance Proxy for MySQL.
...
* [Twemproxy ★6708](https://github.com/twitter/twemproxy) - A fast, light-weight proxy for memcached and redis.
* [Twitter Fatcache ★1178](https://github.com/twitter/fatcache) - key/value cache for flash storage.
* [Twitter Twemcache ★778](https://github.com/twitter/twemcache) - fork of Memcache.
...
* [HanoiDB ★255](https://github.com/krestenkrab/hanoidb) - Erlang LSM BTree Storage.
* [LevelDB ★9177](https://github.com/google/leveldb) - a fast key-value storage library written at Google that provides an ordered mapping from string keys to string values.
...
* [Metabase ★5365](https://github.com/metabase/metabase) - The simplest, fastest way to get business intelligence and analytics to everyone in your company

## Data Visualization

* [Airpal ★2018](https://github.com/airbnb/airpal) - Web UI for PrestoDB.
* [AnyChart](http://www.anychart.com) - fast, simple and flexible JavaScript (HTML5) charting library featuring pure JS API.
* [Arbor ★2383](https://github.com/samizdatco/arbor) - graph visualization library using web workers and jQuery.
* [Banana ★464](https://github.com/LucidWorks/banana) - visualize logs and time-stamped data stored in Solr. Port of Kibana.
...
* [CartoDB ★1454](https://github.com/CartoDB/cartodb) - open-source or freemium hosting for geospatial databases with powerful front-end editing capabilities and a robust API.
...
* [Chartist.js ★9431](https://github.com/gionkunz/chartist-js) - another open source HTML5 Charts visualization.
...
* [Cubism ★4505](https://github.com/square/cubism) - JavaScript library for time series visualization.
...
* [Echarts ★17534](https://github.com/ecomfe/echarts) - Baidus enterprise charts.
* [Envisionjs ★1548](https://github.com/HumbleSoftware/envisionjs) - dynamic HTML5 visualization.
* [FnordMetric](http://fnordmetric.io/) - write SQL queries that return SVG charts rather than tables
* [Freeboard ★4287](https://github.com/Freeboard/freeboard) - pen source real-time dashboard builder for IOT and other web mashups.
* [Gephi ★1962](https://github.com/gephi/gephi) - An award-winning open-source platform for visualizing and manipulating large graphs and network connections. It's like Photoshop, but for graphs. Available for Windows and Mac OS X.
...
* [Matplotlib ★5201](https://github.com/matplotlib/matplotlib) - plotting with Python.
...
* [Plotly.js ★6220](https://github.com/plotly/plotly.js) The open source javascript graphing library that powers plotly.
* [Recline ★1930](https://github.com/okfn/recline) - simple but powerful library for building data applications in pure Javascript and HTML.
* [Redash ★6454](https://github.com/getredash/redash) - open-source platform to query and visualize data.
* [ReCharts](http://recharts.org/) - A composable charting library built on React components
* [Shiny](http://shiny.rstudio.com/) - a web application framework for R.
* [Sigma.js ★7185](https://github.com/jacomyal/sigma.js) - JavaScript library dedicated to graph drawing.
* [Superset ★13427](https://github.com/airbnb/superset) - a data exploration platform designed to be visual, intuitive and interactive, making it easy to slice, dice and visualize data and perform analytics at the speed of thought.
* [Vega ★16](https://github.com/trifacta/vega) - a visualization grammar.
...
# Other Awesome Lists
- Other awesome lists [awesome-awesomeness ★18656](https://github.com/bayandin/awesome-awesomeness).
- Even more lists [awesome ★57421](https://github.com/sindresorhus/awesome).
...
- Analytics [awesome-analytics ★657](https://github.com/onurakpolat/awesome-analytics).
