...
* [assetic-extra-bundle ★21](https://github.com/alexandresalome/assetic-extra-bundle) - Asset Directory filter for Assetic.
...
* [AsseticMinifierBundle ★9](https://github.com/Djeg/AsseticMinifierBundle) - An assetic minifier in pure PHP for CSS and JS files.
...
* [JmikolaJsAssetsHelperBundle ★21](https://github.com/jmikola/JmikolaJsAssetsHelperBundle) - Exposes the AssetsHelper service from Symfony2's templating component to JavaScript, allowing relative or absolute asset URI's to be generated client-side.
...
* [SalvaJshrinkBundle ★19](https://github.com/nibsirahsieu/SalvaJshrinkBundle) - This bundle integrate jshrink library as Assetic filter and twig extension.
* [SpritesBundle ★40](https://github.com/pminnieur/SpritesBundle) - Bundle for the Sprites library.
* [ZakharovviHumansTxtBundle ★2](https://github.com/zakharovvi/ZakharovviHumansTxtBundle) - Generate humans.txt file from git repository.
...
* [LiipCodeBundle ★27](https://github.com/liip/LiipCodeBundle) - A set of Symfony2 console commands to help developers deal with the various ways of identifying classes, templates, bundles, services, etc.
...
* [TwigReflectionBundle ★16](https://github.com/arnaud-lb/TwigReflectionBundle) - Displays what's in Twig.
* [WebfactoryExceptionsBundle ★64](https://github.com/webfactory/exceptions-bundle) - Easily develop custom, user-friendly error pages.
...
* [API Platform framework ★1478](https://github.com/api-platform/api-platform)
...
* [Symfony Biga Edition ★10](https://github.com/JoshuaEstes/symfony-biga-edition)
* [Symfony Bootstrap Edition ★76](https://github.com/phiamo/symfony-bootstrap)
* [Symfony CMF Standard Edition ★102](https://github.com/symfony-cmf/standard-edition)
* [Symfony EmberJs Edition ★50](https://github.com/ucsf-ckm/symfony-emberjs-edition)
* [Symfony Empty Edition ★70](https://github.com/gnugat/symfony-empty-edition)
...
* [Symfony Sonata Edition ★51](https://github.com/jmather/symfony-sonata-distribution)
...
* [AutoFormFillBundle ★3](https://github.com/AppVentus/AutoFormFillBundle) - This bundle fill automaticly creation forms in your application.
...
* [FilterFormBundle ★5](https://github.com/IDCI-Consulting/FilterFormBundle) - Filter form bundle.
...
* [SharkLoggerBundle ★9](https://github.com/agiuliano/SharkLoggerBundle) - A Symfony 2 bundle that allows you to log form errors and data.

## Internationalization

* [BazingaJsTranslationBundle ★369](https://github.com/willdurand/BazingaJsTranslationBundle) - A pretty nice way to expose your Symfony2 translation messages to your client applications.
...
* [AnhTaggableBundle ★5](https://github.com/hilobok/AnhTaggableBundle) - Bundle provides integration of doctrine-extensions-taggable, adds form types for editing tag and tagging.
...
* [BackupManagerBundle ★11](https://github.com/lhpalacio/BackupManagerBundle) - A simple database backup manager for Symfony2 with support for S3, Rackspace, Dropbox, FTP, SFTP.
...
* [CacheToolBundle ★20](https://github.com/gordalina/CacheToolBundle) - Bundle to integrate cachetool library in Symfony2 (Clear acp/opcache from the command line).
...
* [CsvBundle ★6](https://github.com/EGYG33K/CsvBundle) - An integration for thephpleague/csv into Symfony.
...
* [FeatureToggleBundle ★35](https://github.com/marekkalnik/FeatureToggleBundle) - Configure your feature toggling in Symfony2 by adding some simple tags to twig and extending it's configuration.
...
* [GnugatWizardBundle ★23](https://github.com/gnugat/GnugatWizardBundle) - Magically shrinks bundle installation steps into a single command.
* [godfather ★23](https://github.com/PUGX/godfather) - A library for the strategy pattern in PHP.
...
* [KitpagesDataGridBundle ★69](https://github.com/kitpages/KitpagesDataGridBundle) - This bundle provides a simple datagrid bundle.
...
* [MultiParamBundle ★18](https://github.com/jaytaph/MultiParamBundle) - MultiParam Annotation Bundle.
...
* [OneupUploaderBundle ★399](https://github.com/1up-lab/OneupUploaderBundle) - Provides server implementations for several multi file uploader.
...
* [query-bus-bundle ★1](https://github.com/gnugat/query-bus-bundle) - QueryBus integration in Symfony.
...
* [TbbcCacheBundle ★38](https://github.com/TheBigBrainsCompany/TbbcCacheBundle) - Cache abstraction bundle.
...
* [WozbeRedirectBundle ★4](https://github.com/wozbe/WozbeRedirectBundle) - A short bundle to manage many domains.
...
* [CartBundle ★101](https://github.com/leaphly/CartBundle) - High quality cart for developers.
...
* [PaymentAdyenBundle ★7](https://github.com/ruudk/PaymentAdyenBundle) - Provides access to the Adyen API. Based on JMSPaymentCoreBundle.
...
* [CraueConfigBundle ★83](https://github.com/craue/CraueConfigBundle) - Manages configuration settings stored in the database and makes them accessible via a service in your Symfony 2 project.
* [JMDSettingsBundle ★0](https://github.com/mops1k/settings-bundle) - Simple service for store configuration in database an accessible via service and twig in your project.
...
* [WizadDoctrineDocBundle ★13](https://github.com/wpottier/WizadDoctrineDocBundle) - Allows you to generate a decent documentation for your doctrine model schema.

## Template Engine

* [CgKintBundle ★22](https://github.com/carlos-granados/CgKintBundle) - This bundle lets you use the Kint library in your Twig templates.
...
* [swift-css-inliner-bundle ★10](https://github.com/toretto460/swift-css-inliner-bundle) - A Swiftmailer plugin that provides css inline features.
* [TwigCacheBundle ★42](https://github.com/EmanueleMinotto/TwigCacheBundle) - Bundle for asm89/twig-cache-extension.
* [TwigExtraBundle ★8](https://github.com/csanquer/TwigExtraBundle) - Twig Extra Tools Extensions.
...
* [UcoTwigExtensionsBundle ★8](https://github.com/sgomez/UcoTwigExtensionsBundle) - Provides some filters.
...
* [YuccaPrerenderBundle ★50](https://github.com/rjanot/YuccaPrerenderBundle) - Symfony2 Bundle to use prerender.io.
...
* [KnpUGuardBundle ★48](https://github.com/knpuniversity/KnpUGuardBundle) - Adds simple and beautiful authentication to your Symfony project.
...
* [PasswordStrengthBundle ★24](https://github.com/jbafford/PasswordStrengthBundle) - Validator for ensuring strong passwords.
...
* [KnpJsonSchemaBundle ★71](https://github.com/KnpLabs/KnpJsonSchemaBundle) - Provide a service which allow you to generate json schema based on validation metadata.
...
* [RequestLimitBundle ★10](https://github.com/zim32/Symfony2-RequestLimitBundle) - With this bundle you can easy limit requests to your application.
* [ResourceBundle ★33](https://github.com/ProgrammingAreHard/ResourceBundle) - Bundle that helps in developing REST APIs.
