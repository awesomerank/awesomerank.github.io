...
---
# Nginx Resources [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★85445](https://github.com/sindresorhus/awesome)
...
- [Nginx HTTP server boilerplate configs ★6898](https://github.com/h5bp/server-configs-nginx)
- [Nginx Boilerplate - Configuration template and a set of handy must-have snippets ★2271](https://github.com/nginx-boilerplate/nginx-boilerplate)
...
- [agentzh's Nginx Tutorials](https://openresty.org/download/agentzh-nginx-tutorials-en.html) ([Source ★2015](https://github.com/openresty/nginx-tutorials))
...
- [JSONP Proxy - Get JSONP from APIs not supporting it natively ★9 ⏳1Y](https://github.com/fcambus/jsonp-proxy)
...
- [Building an OpenResty events server ★66 ⏳4Y](https://github.com/cagerton/dropthat)
...
- [VeryNginx - Nginx distribution which provides WAF, Control Panel, and Dashboards ★4111](https://github.com/alexazhou/VeryNginx)
