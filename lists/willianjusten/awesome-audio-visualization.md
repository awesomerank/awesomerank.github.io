...
- [MIDI.js ★2351](https://github.com/mudcube/MIDI.js) - Making life easy to create a MIDI-app on the web.
- [Beep.js ★1183 ⏳2Y](https://github.com/stewdio/beep.js) - A JavaScript toolkit for building browser-based synthesizers.
- [p5.sound ★257](https://github.com/processing/p5.js-sound) - Brings the Processing approach to Web Audio and p5.js.
...
- [audiowaveform ★406](https://github.com/bbc/audiowaveform) - C++ program to generate waveform data and render waveform images from audio files.
...
- [The Force ★89](https://github.com/shawnlawson/The_Force) - Live coded shader editing with audio input.
- [Hylogen ★351](https://github.com/sleexyz/hylogen) - Purely functional language embedded in Haskell for expressive live coding of fragment shaders (with audio input).
...
- [Clubber.js ★174](https://github.com/wizgrav/clubber) - Application of music theory in audio reactive visualizations.
