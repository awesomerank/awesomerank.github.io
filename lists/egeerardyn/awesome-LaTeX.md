...
- [Atom](https://atom.io) [![Atom][awesome] ★1136](https://github.com/mehcode/awesome-atom) ![foss][foss]
	- [LaTeXTools](https://atom.io/packages/latextools) - An Atom port of the Sublime Text package of the same name. ![foss][foss]

- [Sublime Text](http://www.sublimetext.com) [![Sublime Text][awesome] ★510](https://github.com/dreikanter/sublime-bookmarks)
	- [LaTeXing](http://www.latexing.com) - Commercial plug-in to edit LaTeX.
	- [LaTeXTools ★1466](https://github.com/SublimeText/LaTeXTools) - Free LaTeX plugin for Sublime Text. ![foss][foss]

- [Emacs](https://www.gnu.org/software/emacs/)  [![Emacs][awesome] ★2826](https://github.com/emacs-tw/awesome-emacs) ![foss][foss]
...
- [Vim](http://www.vim.org) [![Vim][awesome] ★6593](https://github.com/mhinz/vim-galore) ![foss][foss]
	- [Vim-LaTeX](http://vim-latex.sourceforge.net) ![foss][foss]
	- [LaTeX Live Preview ★190 ⏳1Y](https://github.com/xuhdev/vim-latex-live-preview) - Instantly previews your LaTeX document. ![foss][foss]

- [IntelliJ](https://www.jetbrains.com/idea/)
	- [TeXiFy-IDEA ★12](https://github.com/Ruben-Sten/TeXiFy-IDEA) - Free LaTeX plugin for IntelliJ IDEA. ![foss][foss]
...
- [Arara](https://www.ctan.org/pkg/arara) ([GitHub repo ★155](https://github.com/cereda/arara)) - Simple tool that allows you to specify which tools to call inside your document and it can be extended quite easily. ![foss][foss]
...
- [CaTeX ★4](https://github.com/Alexis-benoist/CaTeX) - Concatenates LaTeX documents with attention for properly merging the preamble.
...
- [TikZ-Editor ★75](https://github.com/fredokun/TikZ-Editor) - Live-previewing editor for TikZ figures. ![Mac][Mac] ![Linux][Linux] ![foss][foss]
...
- [PetarV-/TikZ ★10](https://github.com/PetarV-/TikZ) - A collection of publication-ready PGF/TikZ figures by Petar Veličković.
...
- [Ultimate Beamer Theme List ★155 ⏳1Y](https://github.com/martinbjeldbak/ultimate-beamer-theme-list) - Links to various beamer themes along with PDF previews.
...
- [MartinThoma's LaTeX example ★302](https://github.com/MartinThoma/LaTeX-examples) - GitHub repository containing example LaTeX documents.
