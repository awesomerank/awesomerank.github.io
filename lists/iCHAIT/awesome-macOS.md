...
- [BackgroundMusic](https://github.com/kyleneideck/BackgroundMusic) - Record system audio, control audio levels for individual apps, and automatically pauses your music player when other audio starts playing and unpauses it afterwards. [![Open-Source Software][OSS Icon] ★3390](https://github.com/kyleneideck/BackgroundMusic) ![Freeware][Freeware Icon]
...
- [Goofy](http://www.goofyapp.com/) - Unofficial Facebook Messenger client. [![Open-Source Software][OSS Icon] ★654](https://github.com/danielbuechele/goofy) ![Freeware][Freeware Icon]
- [Telegram](https://itunes.apple.com/us/app/telegram/id747648890?mt=12) - A messaging app with a focus on speed and security, it’s super fast, simple and free. [![Open-Source Software][OSS Icon] ★1479](https://github.com/overtake/telegram) ![Freeware][Freeware Icon]
- [Textual 5](https://www.codeux.com/textual/) - An Internet Relay Chat (IRC) client. [![Open-Source Software][OSS Icon] ★1453](https://github.com/Codeux-Software/Textual)
...
- [Cakebrew](https://www.cakebrew.com/) - The Homebrew GUI App. [![Open-Source Software][OSS Icon] ★2509](https://github.com/brunophilipe/Cakebrew) ![Freeware][Freeware Icon]
- [CocoaRestClient](https://mmattozzi.github.io/cocoa-rest-client) - An app for testing REST endpoints. [![Open-Source Software][OSS Icon] ★1773](https://github.com/mmattozzi/cocoa-rest-client) ![Freeware][Freeware Icon]
- [Dash](https://kapeli.com/dash) - An API Documentation Browser and Code Snippet Manager.
- [Gas Mask](https://github.com/2ndalpha/gasmask) - A simple hosts file manager which allows editing of host files and switching between them. [![Open-Source Software][OSS Icon] ★1770](https://github.com/2ndalpha/gasmask) ![Freeware][Freeware Icon]
- [gitbar](https://github.com/Shikkic/gitbar) - Open source github contribution stats on your Menu Bar. [![Open-Source Software][OSS Icon] ★245 ⏳1Y](https://github.com/Shikkic/gitbar) ![Freeware][Freeware Icon]
- [GitHub Desktop](https://desktop.github.com/) - A GUI for using GitHub. ![Freeware][Freeware Icon]
- [GitUp](http://gitup.co/) - A simple but powerful Git macOS app. [![Open-Source Software][OSS Icon] ★6763](https://github.com/git-up/GitUp) ![Freeware][Freeware Icon]
- [Hosts](https://github.com/specialunderwear/Hosts.prefpane) - Edit hosts file. [![Open-Source Software][OSS Icon] ★1130](https://github.com/specialunderwear/Hosts.prefpane) ![Freeware][Freeware Icon]
- [ImageAlpha](https://pngmini.com/) - Apply lossy compression on PNG files with or without transparency for more efficient files. [![Open-Source Software][OSS Icon] ★339](https://github.com/pornel/ImageAlpha) ![Freeware][Freeware Icon]
- [ImageOptim](https://imageoptim.com/mac) - Makes images take up less disk space and load faster. [![Open-Source Software][OSS Icon] ★4161](https://github.com/ImageOptim/ImageOptim) ![Freeware][Freeware Icon]
...
- [Knuff](https://github.com/KnuffApp/Knuff) - The debug application for Apple Push Notification Service (APNs). [![Open-Source Software][OSS Icon] ★3802](https://github.com/KnuffApp/Knuff) ![Freeware][Freeware Icon]
- [Paw](https://luckymarmot.com/paw) - The ultimate REST client.
- [Postico](https://eggerapps.at/postico/) - A modern PostgreSQL client.
- [Postgres.app](http://postgresapp.com/) - The easiest way to get started with PostgreSQL. [![Open-Source Software][OSS Icon] ★3640](https://github.com/PostgresApp/PostgresApp) ![Freeware][Freeware Icon]
...
- [Sequel Pro](http://www.sequelpro.com/) - A MySQL database manager. [![Open-Source Software][OSS Icon] ★3525](https://github.com/sequelpro/sequelpro) ![Freeware][Freeware Icon]
...
- [Touch Bar Simulator](https://github.com/sindresorhus/touch-bar-simulator) - The macOS Touch Bar Simulator as a standalone app. [![Open-Source Software][OSS Icon] ★552](https://github.com/sindresorhus/touch-bar-simulator) ![Freeware][Freeware Icon]
- [Tower](https://www.git-tower.com/) - The most powerful Git client.
- [Unused](https://jeffhodnett.github.io/Unused/) - An app for checking Xcode projects for unused resources. [![Open-Source Software][OSS Icon] ★1268 ⏳1Y](https://github.com/jeffhodnett/Unused) ![Freeware][Freeware Icon]
- [Vagrant Manager](http://vagrantmanager.com) - Manage your vagrant machines in one place with Vagrant Manager for macOS. [![Open-Source Software][OSS Icon] ★1585](https://github.com/lanayotech/vagrant-manager) ![Freeware][Freeware Icon]
- [Versions](http://versionsapp.com/) - SVN GUI client for Mac.
- [WWDC](https://github.com/insidegui/WWDC) - The WWDC app. [![Open-Source Software][OSS Icon] ★5858](https://github.com/insidegui/WWDC)
...
- [CotEditor](https://coteditor.com) - Lightweight plain-text editor for macOS. [![Open-Source Software][OSS Icon] ★2114](https://github.com/coteditor/CotEditor) ![Freeware][Freeware Icon]
...
- [MacVim](https://github.com/macvim-dev/macvim) - Vim, the text editor. [![Open-Source Software][OSS Icon] ★3374](https://github.com/macvim-dev/macvim) ![Freeware][Freeware Icon]
- [Sublime Text 3](http://www.sublimetext.com/) - The sophisticated text editor.
- [TextMate](https://macromates.com/) - A graphical text editor. [![Open-Source Software][OSS Icon] ★11368](https://github.com/textmate/textmate)
- [VimR](http://vimr.org) - Vim, refined. [![Open-Source Software][OSS Icon] ★2842](https://github.com/qvacua/vimr) ![Freeware][Freeware Icon]
...
- [Quicklook-Plugins ★9387](https://github.com/sindresorhus/quick-look-plugins) - List of extra quicklook plugins to enable previewing more filetypes in the Finder.
...
- [Boxer](http://boxerapp.com/) - The DOS game emulator that’s fit for your Mac. [![Open-Source Software][OSS Icon] ★449](https://github.com/alunbestor/Boxer) ![Freeware][Freeware Icon]
- [Dolphin](https://dolphin-emu.org) - A powerful, Open Source emulator for Nintendo GameCube and Wii games. [![Open-Source Software][OSS Icon] ★3613](https://github.com/dolphin-emu/dolphin) ![Freeware][Freeware Icon]
- [OpenEmu](http://openemu.org/) - Multiple Video Game System. [![Open-Source Software][OSS Icon] ★7888](https://github.com/OpenEmu/OpenEmu) ![Freeware][Freeware Icon]
- [Screentendo](http://aaronrandall.com/blog/screentendo/) - Turn your screen into a playable level of Mario. [![Open-Source Software][OSS Icon] ★908 ⏳2Y](https://github.com/AaronRandall/Screentendo) ![Freeware][Freeware Icon]
- [Stockfish](http://stockfishchess.org/mac/) - Beautiful, powerful chess application. [![Open-Source Software][OSS Icon] ★248](https://github.com/daylen/stockfish-mac) ![Freeware][Freeware Icon]
...
- [Sketch Toolbox](http://sketchtoolbox.com/) - A super simple plugin manager for Sketch. [![Open-Source Software][OSS Icon] ★2179](https://github.com/buzzfeed/Sketch-Toolbox)
...
- [ClipMenu](http://www.clipmenu.com/) - ClipBoard History Manager. [![Open-Source Software][OSS Icon] ★548 ⏳1Y](https://github.com/naotaka/ClipMenu) ![Freeware][Freeware Icon]
...
- [Karabiner](https://pqrs.org/osx/karabiner/) - A powerful keyboard customizer. [![Open-Source Software][OSS Icon] ★3447](https://github.com/tekezo/Karabiner) ![Freeware][Freeware Icon]
...
- [Quicksilver](https://qsapp.com/) - Control your Mac quickly and elegantly. [![Open-Source Software][OSS Icon] ★2190](https://github.com/quicksilver/Quicksilver) ![Freeware][Freeware Icon]
...
- [SelfControl](https://selfcontrolapp.com/) - Block access to distracting websites. [![Open-Source Software][OSS Icon] ★2227](https://github.com/SelfControlApp/selfcontrol) ![Freeware][Freeware Icon]
...
- [iTerm 2](https://www.iterm2.com/) - A terminal emulator. [![Open-Source Software][OSS Icon] ★6036](https://github.com/gnachman/iTerm2) ![Freeware][Freeware Icon]
...
- [AnyBar](https://github.com/tonsky/AnyBar) - A menubar status indicator. [![Open-Source Software][OSS Icon] ★4301](https://github.com/tonsky/AnyBar) ![Freeware][Freeware Icon]
...
- [BeardedSpice](https://github.com/beardedspice/beardedspice) - Control web based media players with the media keys found on Mac keyboards. [![Open-Source Software][OSS Icon] ★1533](https://github.com/beardedspice/beardedspice) ![Freeware][Freeware Icon]
- [BetterZip](https://macitbetter.com/) - A very capable and full-featured archive manager.
- [BitBar](https://github.com/matryer/bitbar) - Display output of any script to the menu bar. [![Open-Source Software][OSS Icon] ★8047](https://github.com/matryer/bitbar) ![Freeware][Freeware Icon]
...
- [DisableMonitor](https://github.com/Eun/DisableMonitor) - Easily disable or enable a monitor on your Mac. [![Open-Source Software][OSS Icon] ★723 ⏳1Y](https://github.com/Eun/DisableMonitor) ![Freeware][Freeware Icon]
- [EtreCheck](http://etrecheck.com) - Output system information and configuration to get more informed help from Apple support professionals. [![Open-Source Software][OSS Icon] ★131](https://github.com/etresoft/EtreCheck) ![Freeware][Freeware Icon]
- [Fanny](http://fannywidget.com/) - Notification Center widget and menu bar application to monitor your Mac's fans and CPU temperature. [![Open-Source Software][OSS Icon] ★61](https://github.com/DanielStormApps/Fanny) ![Freeware][Freeware Icon]
- [Finicky](https://johnste.github.io/finicky/) - App that allows you to set rules that decide which browser is opened for every link. [![Open-Source Software][OSS Icon] ★145](https://github.com/johnste/finicky) ![Freeware][Freeware Icon]
...
- [Helium](http://heliumfloats.com/) - A floating browser window that allows you to watch media while you work. [![Open-Source Software][OSS Icon] ★2645](https://github.com/JadenGeller/Helium) ![Freeware][Freeware Icon]
...
- [Irvue](http://irvue.tumblr.com) - Thousands of stunning photos and wallpapers from Unsplash on your Mac. [![Open-Source Software][OSS Icon] ★58](https://github.com/leonspok/Irvue-Screensaver) ![Freeware][Freeware Icon]
- [iStat Menus](https://bjango.com/mac/istatmenus/) - An advanced system monitor for your menubar.
- [Kawa](https://github.com/noraesae/kawa) - A better input source switcher with shortcuts. [![Open-Source Software][OSS Icon] ★171](https://github.com/noraesae/kawa) ![Freeware][Freeware Icon]
- [KeepingYouAwake](https://github.com/newmarcel/KeepingYouAwake) - Menu bar utility that prevents Mac from going to sleep. [![Open-Source Software][OSS Icon] ★1980](https://github.com/newmarcel/KeepingYouAwake) ![Freeware][Freeware Icon]
...
- [MacDown](http://macdown.uranusjr.com/) - Markdown editor. [![Open-Source Software][OSS Icon] ★6166](https://github.com/MacDownApp/macdown) ![Freeware][Freeware Icon]
- [Mackup](https://github.com/lra/mackup) - Keep your application settings in sync. [![Open-Source Software][OSS Icon] ★6251](https://github.com/lra/mackup) ![Freeware][Freeware Icon]
- [MacPass](http://mstarke.github.io/MacPass/) - Password Manager. [![Open-Source Software][OSS Icon] ★3106](https://github.com/mstarke/MacPass) ![Freeware][Freeware Icon]
...
- [Menubar Colors](https://github.com/nvzqz/Menubar-Colors) - Convenient access to the system color panel. [![Open-Source Software][OSS Icon] ★58 ⏳1Y](https://github.com/nvzqz/Menubar-Colors) ![Freeware][Freeware Icon]
- [MenuMeters](http://member.ipmu.jp/yuji.tachikawa/MenuMetersElCapitan/) - A set of CPU, memory, disk, and network monitoring tools for macOS. [![Open-Source Software][OSS Icon] ★960](https://github.com/yujitach/MenuMeters)
...
- [Notational Velocity](http://notational.net/) - Store, retrieve and sync notes within a minimal GUI. [![Open-Source Software][OSS Icon] ★1729](https://github.com/scrod/nv) ![Freeware][Freeware Icon]
- [Noti](https://noti.center/) - Receive Android notifications on your mac (with PushBullet). [![Open-Source Software][OSS Icon] ★397](https://github.com/jariz/Noti) ![Freeware][Freeware Icon]
...
- [ShiftIt](https://github.com/fikovnik/ShiftIt) - Managing windows size and position. [![Open-Source Software][OSS Icon] ★3715](https://github.com/fikovnik/ShiftIt) ![Freeware][Freeware Icon]
- [SlowQuitApps](https://github.com/dteoh/SlowQuitApps) - Prevent accidental Cmd-Q. [![Open-Source Software][OSS Icon] ★140](https://github.com/dteoh/SlowQuitApps) ![Freeware][Freeware Icon]
...
- [Übersicht](http://tracesof.net/uebersicht/) - Run system commands and display their output on your desktop as widgets. [![Open-Source Software][OSS Icon] ★1687](https://github.com/felixhageloh/uebersicht) ![Freeware][Freeware Icon]
...
- [HandBrake](https://handbrake.fr/) - High performance video encoding and conversion tools with a nice GUI. [![Open-Source Software][OSS Icon] ★2233](https://github.com/HandBrake/HandBrake)
- [mpv](https://mpv.io/) - Media player. [![Open-Source Software][OSS Icon] ★6081](https://github.com/mpv-player/mpv)
...
- [Amethyst](http://ianyh.com/amethyst/) - Window manager (automatically keep windows sized in grids). [![Open-Source Software][OSS Icon] ★4168](https://github.com/ianyh/Amethyst) ![Freeware][Freeware Icon]
- [Divvy Window Manager](http://mizage.com/divvy/) - Window management for tiling your windows.
- [Hammerspoon](http://www.hammerspoon.org/) - Extremely powerful scripting engine for macOS. [![Open-Source Software][OSS Icon] ★3002](https://github.com/Hammerspoon/hammerspoon) ![Freeware][Freeware Icon]
- [kwm](https://koekeishiya.github.io/kwm/) - Tiling window manager with focus follows mouse. [![Open-Source Software][OSS Icon] ★3339](https://github.com/koekeishiya/kwm) ![Freeware][Freeware Icon]
- [Moom](https://manytricks.com/moom/) - Move and zoom windows, super light weight and customizable.
- [Phoenix](https://github.com/kasper/phoenix) - A lightweight window and app manager scriptable with JavaScript. [![Open-Source Software][OSS Icon] ★3002](https://github.com/Hammerspoon/hammerspoon) ![Freeware][Freeware Icon]
- [Spectacle](https://www.spectacleapp.com/) - Easily organize windows without using a mouse. [![Open-Source Software][OSS Icon] ★8048](https://github.com/eczarny/spectacle) ![Freeware][Freeware Icon]
- [Stay](https://cordlessdog.com/stay/) - Resize/position windows when displays change.

### Others

- [Aerial](https://github.com/JohnCoates/Aerial) - Apple TV Aerial Screensaver for Mac. [![Open-Source Software][OSS Icon] ★9176](https://github.com/JohnCoates/Aerial) ![Freeware][Freeware Icon]
...
- [SoundCleod](http://soundcleod.com/) - A browser for SoundCloud. [![Open-Source Software][OSS Icon] ★721](https://github.com/salomvary/soundcleod) ![Freeware][Freeware Icon]
- [Juice](https://github.com/brianmichel/Juice) - Make your battery information a bit more interesting. [![Open-Source Software][OSS Icon] ★494](https://github.com/brianmichel/Juice) ![Freeware][Freeware Icon]
- [Transmit](https://panic.com/transmit/) - A FTP client.
- [Vienna](http://viennarss.github.io/) - RSS/Atom newsreader. [![Open-Source Software][OSS Icon] ★770](https://github.com/ViennaRSS/vienna-rss) ![Freeware][Freeware Icon]


## Command Line Utilities

- [Awesome macOS Command Line ★17359](https://github.com/herrbischoff/awesome-osx-command-line) - Use your macOS terminal shell to do awesome things.
- [m-cli ★5878](https://github.com/rgcr/m-cli) -  Swiss Army Knife for macOS.
- [Mac-CLI ★6778](https://github.com/guarinogabriel/Mac-CLI) -  macOS command line tools for developers.
...
- [mas](https://github.com/mas-cli/mas) - A CLI for the Mac App Store. [![Open-Source Software][OSS Icon] ★3347](https://github.com/mas-cli/mas) ![Freeware][Freeware Icon]
...
- [EnvPane](https://github.com/hschmidt/EnvPane) - An preference pane for environment variables. [![Open-Source Software][OSS Icon] ★253](https://github.com/hschmidt/EnvPane) ![Freeware][Freeware Icon]
- [Glances](https://github.com/nicolargo/glances) - System monitoring tool that runs in terminal. [![Open-Source Software][OSS Icon] ★7808](https://github.com/nicolargo/glances) ![Freeware][Freeware Icon]
...
* [Tunnelblick](https://tunnelblick.net) - Easy to use OpenVPN client and GUI. [![Open-Source Software][OSS Icon] ★588](https://github.com/Tunnelblick/Tunnelblick) ![Freeware][Freeware Icon]
