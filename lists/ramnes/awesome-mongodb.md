...
### More
 - [MongoDB source code ★12728](https://github.com/mongodb/mongo)
...
## Libraries
### C
 - [mongo-c-driver ★368](https://github.com/mongodb/mongo-c-driver) - Official C driver

### C++
 - [mongo-cxx-driver ★424](https://github.com/mongodb/mongo-cxx-driver) - Official C++ driver
...
### C#/.NET ###
 ...
 - [MongoRepository ★196](https://github.com/RobThree/MongoRepository) - Repository abstraction layer on top of the C# driver
...
### Go
 - [mgo ★1829](https://github.com/go-mgo/mgo) - Community Go driver

### Haskell
 - [mongodb ★78](https://github.com/mongodb-haskell/mongodb) - Community Haskell driver

### Java
 - [Jongo ★474](https://github.com/bguerout/jongo) - Query in Java as in Mongo shell
 - [Hibernate OGM ★239](https://github.com/hibernate/hibernate-ogm) - The power and simplicity of JPA for NoSQL datastores
 - [mongo-java-driver ★1883](https://github.com/mongodb/mongo-java-driver) - Official Java driver
 ...
 - [Mongojack ★186](https://github.com/mongojack/mongojack) - Based on Jackson, allows you to easily handle your mongo objects as POJOs
 - [Morphia ★1225](https://github.com/mongodb/morphia) - Official Java ODM
 - [Morphium ★43](https://github.com/sboesebeck/morphium) - Java ODM and caching layer
 - [Mungbean ★20 ⏳6Y](https://github.com/jannehietamaki/mungbean) - Community driver for languages running on the JVM
 - [Spring Data MongoDB ★770](https://github.com/spring-projects/spring-data-mongodb) - Spring based, object-document support and repositories for MongoDB

### JavaScript
 - [Camo ★383](https://github.com/scottwrobinson/camo) - Class-based ES6 ODM for Mongo-like databases
 - [MEAN.JS ★4403](https://github.com/meanjs/mean) - Full-Stack based on MongoDB, Express, AngularJS, and Node.js
 - [MERN (mern-starter) ★4242](https://github.com/Hashnode/mern-starter) - Full-Stack based on MongoDB, Express, React and Node.js
...
### Python
 ...
 - [Motor ★882](https://github.com/mongodb/motor) - Non-blocking Python driver for Tornado applications
 - [PyMongo ★2179](https://github.com/mongodb/mongo-python-driver) - Official (and recommended) Python driver
 - [minimongo ★298](https://github.com/slacy/minimongo) - A lightweight, schemaless, Pythonic Object-Oriented interface
 - [scrapy-mongodb ★235](https://github.com/sebdah/scrapy-mongodb) - MongoDB pipeline for Scrapy
 - [μMongo ★64](https://github.com/Scille/umongo) - Driver-independent (async/sync) ODM based on marshmallow

### R
 - [mongolite](https://github.com/jeroenooms/mongolite) - Fast and Simple MongoDB Client for R

### Ruby
 - [mongo-ruby-driver ★1321](https://github.com/mongodb/mongo-ruby-driver) - Official Ruby driver
 - [Mongoid ★3566](https://github.com/mongodb/mongoid) - Ruby ODM framework

### Rust
 - [mongo-rust-driver-prototype ★221](https://github.com/mongodb-labs/mongo-rust-driver-prototype) - Prototype driver written for Rust 1.x and MongoDB 3.0.x
...
### Administration
 ...
 - [mongodb-tools ★247 ⏳2Y](https://github.com/jwilder/mongodb-tools) - Three neat Python scripts to work with collections and indexes
 - [Mongoeye ★17](https://github.com/mongoeye/mongoeye) - Schema and data analyzer: explore data in your collections
 - [Mongolastic ★61](https://github.com/ozlerhakan/mongolastic) - A dataset migration tool from MongoDB to Elasticsearch and vice versa
 - [MongoMultiMaster ★54 ⏳5Y](https://github.com/rick446/mmm) - Multi-Master MongoDB replication
 - [MoSQL ★1407](https://github.com/stripe/mosql) - MongoDB to PostgreSQL streaming replication
 - [mtools ★1014](https://github.com/rueckstiess/mtools) - Collection of scripts to set up MongoDB test environments and parse and visualize MongoDB log files
 - [nginx-gridfs ★766 ⏳4Y](https://github.com/mdirolf/nginx-gridfs) - Nginx module for serving files from MongoDB's GridFS
 - [nginx-mongodb-rest ★31 ⏳6Y](https://github.com/minhajuddin/nginx-mongodb-rest) - MongoDB REST client written as an Nginx module
 - [Variety ★1068](https://github.com/variety/variety) - Schema analyzer: see what fields are in your collection and what's their content

### Big Data
 - [mongo-hadoop ★1306](https://github.com/mongodb/mongo-hadoop) - MongoDB connector for Hadoop

### Deployment
 - [ansible-role-mongodb ★120](https://github.com/UnderGreen/ansible-role-mongodb) - Ansible role
 - [chef-mongodb ★381](https://github.com/edelight/chef-mongodb) - Chef cookbook
 - [Dockerfile ★227](https://github.com/dockerfile/mongodb)
 - [Helm Chart](https://github.com/kubernetes/charts/tree/master/stable/mongodb) - Bootstraps a MongoDB deployment on a [Kubernetes](https://kubernetes.io/docs/whatisk8s/) cluster using the [Helm ★3269](https://github.com/kubernetes/helm) package manager.
...
### Desktop
 ...
 - [MongoHub ★2229 ⏳2Y](https://github.com/jeromelebel/MongoHub-Mac) - Mac native client
...
### Shell
 - [mongo-hacker ★1331](https://github.com/TylerBrock/mongo-hacker) - MongoDB shell enhancements

### Web
 - [adminMongo ★1164](https://github.com/mrvautin/adminMongo) - Web-based user interface to handle connections and databases needs
 ...
 - [mongo-express ★2446](https://github.com/mongo-express/mongo-express) - Web-based admin interface written with Node.js, Express and Bootstrap3
 - [mongoadmin ★260](https://github.com/thomasst/mongoadmin) - Admin interface for MongoDB built using Django and Bootstrap
 - [mongri ★64 ⏳1Y](https://github.com/dongri/mongri) - Web-based user interface for MongoDB (written in JavaScript)
 - [Rockmongo ★797](https://github.com/iwind/rockmongo) - PHPMyAdmin for MongoDB, sort of
