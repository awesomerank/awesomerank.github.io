...
# Awesome MongoDB [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★65640](https://github.com/sindresorhus/awesome)

> A curated list of awesome MongoDB resources, libraries, tools and applications

Inspired by the [awesome ★65640](https://github.com/sindresorhus/awesome) list thing. Feel free to improve this list by [contributing](https://github.com/ramnes/awesome-mongodb/blob/master/CONTRIBUTING.md)!
...
### More
 - [MongoDB source code ★12352](https://github.com/mongodb/mongo)
...
## Libraries
### C
 - [mongo-c-driver ★357](https://github.com/mongodb/mongo-c-driver) - Official C driver

### C++
 - [mongo-cxx-driver ★403](https://github.com/mongodb/mongo-cxx-driver) - Official C++ driver
...
### C#/.NET ###
 ...
 - [MongoDB Messaging ★37](https://github.com/loresoft/MongoDB.Messaging) - Lightweight queue pub/sub processing library
 - [MongoRepository ★189](https://github.com/RobThree/MongoRepository) - Repository abstraction layer on top of the C# driver

### Delphi
 - [TMongoWire ★66](https://github.com/stijnsanders/TMongoWire) - Minimal community Delphi driver

### Erlang
 - [mongodb-erlang ★256](https://github.com/comtihon/mongodb-erlang) - Community Erlang driver

### Go
 - [mgo ★1690](https://github.com/go-mgo/mgo) - Community Go driver

### Haskell
 - [mongodb ★75](https://github.com/mongodb-haskell/mongodb) - Community Haskell driver

### Java
 - [Jongo ★469](https://github.com/bguerout/jongo) - Query in Java as in Mongo shell
 - [Hibernate OGM ★233](https://github.com/hibernate/hibernate-ogm) - The power and simplicity of JPA for NoSQL datastores
 - [mongo-java-driver ★1841](https://github.com/mongodb/mongo-java-driver) - Official Java driver
 - [mongo-queue-java ★27](https://github.com/gaillard/mongo-queue-java) - Java message queue backed by MongoDB
 ...
 - [Mongojack ★182](https://github.com/mongojack/mongojack) - Based on Jackson, allows you to easily handle your mongo objects as POJOs
 - [Morphia ★1198](https://github.com/mongodb/morphia) - Official Java ODM
 ...
 - [Spring Data MongoDB ★742](https://github.com/spring-projects/spring-data-mongodb) - Spring based, object-document support and repositories for MongoDB

### JavaScript
 - [Camo ★359](https://github.com/scottwrobinson/camo) - Class-based ES6 ODM for Mongo-like databases
 - [MEAN.JS ★4340](https://github.com/meanjs/mean) - Full-Stack based on MongoDB, Express, AngularJS, and Node.js
 - [MERN (mern-starter) ★4081](https://github.com/Hashnode/mern-starter) - Full-Stack based on MongoDB, Express, React and Node.js
 - [Mongoose ★13495](https://github.com/Automattic/mongoose) - Node.js asynchronous ODM
 ...
 - [node-mongodb-native ★6002](https://github.com/mongodb/node-mongodb-native) - Official Node.js driver
...
### PHP
 - [Doctrine MongoDB ★298](https://github.com/doctrine/mongodb) - Wrapper around the native PHP Mongo PECL extension to provide additional functionality
 ...
 - [pecl/mongodb ★411](https://github.com/mongodb/mongo-php-driver) - Official PHP driver

### Python
 - [Flask-PyMongo ★347](https://github.com/dcrosta/flask-pymongo) - PyMongo support for Flask applications
 - [MongoEngine ★1898](https://github.com/MongoEngine/mongoengine) - Python ODM on top of PyMongo
 ...
 - [Motor ★850](https://github.com/mongodb/motor) - Non-blocking Python driver for Tornado applications
 - [PyMongo ★2114](https://github.com/mongodb/mongo-python-driver) - Official (and recommended) Python driver
 - [minimongo ★295](https://github.com/slacy/minimongo) - A lightweight, schemaless, Pythonic Object-Oriented interface
 - [scrapy-mongodb ★227](https://github.com/sebdah/scrapy-mongodb) - MongoDB pipeline for Scrapy
 - [μMongo ★58](https://github.com/Scille/umongo) - Driver-independent (async/sync) ODM based on marshmallow

### R
 - [mongolite](https://github.com/jeroenooms/mongolite) - Fast and Simple MongoDB Client for R

### Ruby
 - [mongo-ruby-driver ★1310](https://github.com/mongodb/mongo-ruby-driver) - Official Ruby driver
 - [Mongoid ★3538](https://github.com/mongodb/mongoid) - Ruby ODM framework

### Rust
 - [mongo-rust-driver-prototype ★206](https://github.com/mongodb-labs/mongo-rust-driver-prototype) - Prototype driver written for Rust 1.x and MongoDB 3.0.x

### Scala
 - [mongo-scala-driver ★170](https://github.com/mongodb/mongo-scala-driver) - Official Scala driver
 - [ReactiveMongo ★726](https://github.com/ReactiveMongo/ReactiveMongo) - Non-blocking Scala driver
 - [Spark-MongoDB ★284 ⏳1Y](https://github.com/Stratio/Spark-MongoDB) - Read/write data with Spark SQL

## Tools
### Administration
 - [mongo_fdw ★114](https://github.com/EnterpriseDB/mongo_fdw) - PostgreSQL foreign data wrapper for MongoDB
 - [mongoctl ★164](https://github.com/mongolab/mongoctl) - Manage MongoDB servers and replica sets using JSON configurations
 ...
 - [mongodb-tools ★240 ⏳1Y](https://github.com/jwilder/mongodb-tools) - Three neat Python scripts to work with collections and indexes
 - [Mongoeye ★12](https://github.com/mongoeye/mongoeye) - Schema and data analyzer: explore data in your collections
 ...
 - [MoSQL ★1388](https://github.com/stripe/mosql) - MongoDB to PostgreSQL streaming replication
 - [mtools ★967](https://github.com/rueckstiess/mtools) - Collection of scripts to set up MongoDB test environments and parse and visualize MongoDB log files
 - [nginx-gridfs ★760 ⏳3Y](https://github.com/mdirolf/nginx-gridfs) - Nginx module for serving files from MongoDB's GridFS
 - [nginx-mongodb-rest ★31 ⏳6Y](https://github.com/minhajuddin/nginx-mongodb-rest) - MongoDB REST client written as an Nginx module
 - [Variety ★1033](https://github.com/variety/variety) - Schema analyzer: see what fields are in your collection and what's their content

### Big Data
 - [mongo-hadoop ★1283](https://github.com/mongodb/mongo-hadoop) - MongoDB connector for Hadoop

### Deployment
 - [ansible-role-mongodb ★111](https://github.com/UnderGreen/ansible-role-mongodb) - Ansible role
 - [chef-mongodb ★382](https://github.com/edelight/chef-mongodb) - Chef cookbook
 - [Dockerfile ★217](https://github.com/dockerfile/mongodb)
 - [Helm Chart](https://github.com/kubernetes/charts/tree/master/stable/mongodb) - Bootstraps a MongoDB deployment on a [Kubernetes](https://kubernetes.io/docs/whatisk8s/) cluster using the [Helm ★2587](https://github.com/kubernetes/helm) package manager.
...
### Desktop
 ...
 - [MongoHub ★2211 ⏳1Y](https://github.com/jeromelebel/MongoHub-Mac) - Mac native client
...
### Monitoring
 ...
 - [nagios-plugin-mongodb ★319](https://github.com/mzupan/nagios-plugin-mongodb) - Nagios plugin (in Python)

### Shell
 - [mongo-hacker ★1298](https://github.com/TylerBrock/mongo-hacker) - MongoDB shell enhancements

### Web
 - [adminMongo ★994](https://github.com/mrvautin/adminMongo) - Web-based user interface to handle connections and databases needs
 ...
 - [mongo-express ★2333](https://github.com/mongo-express/mongo-express) - Web-based admin interface written with Node.js, Express and Bootstrap3
 ...
 - [Rockmongo ★776](https://github.com/iwind/rockmongo) - PHPMyAdmin for MongoDB, sort of

## Applications
 - [Leanote ★6018](https://github.com/leanote/leanote) - Evernote clone built with Go and MongoDB
 - [Quokka ★1709](https://github.com/quokkaproject/quokka) - Python CMS built on top of Flask and MongoDB
 - [uptime ★3345](https://github.com/fzaninotto/uptime) - Remote monitoring application using Node.js, MongoDB, and Bootstrap
