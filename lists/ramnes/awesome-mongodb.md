...
### More
 - [MongoDB source code ★12874](https://github.com/mongodb/mongo)
...
## Libraries
### C
 - [mongo-c-driver ★371](https://github.com/mongodb/mongo-c-driver) - Official C driver

### C++
 - [mongo-cxx-driver ★429](https://github.com/mongodb/mongo-cxx-driver) - Official C++ driver

### C#/.NET ###
 - [mongo-csharp-driver ★1734](https://github.com/mongodb/mongo-csharp-driver) - Official C# driver
 - [mongo-queue-csharp ★0 ⏳2Y](https://github.com/dominionenterprises/mongo-queue-csharp) - C# message queue backed by MongoDB
 - [MongoDB Messaging ★38](https://github.com/loresoft/MongoDB.Messaging) - Lightweight queue pub/sub processing library
 - [MongoRepository ★200](https://github.com/RobThree/MongoRepository) - Repository abstraction layer on top of the C# driver

### Delphi
 - [TMongoWire ★68](https://github.com/stijnsanders/TMongoWire) - Minimal community Delphi driver
...
### Erlang
 - [mongodb-erlang ★262](https://github.com/comtihon/mongodb-erlang) - Community Erlang driver

### Go
 - [mgo ★1907](https://github.com/go-mgo/mgo) - Community Go driver

### Haskell
 - [mongodb ★82](https://github.com/mongodb-haskell/mongodb) - Community Haskell driver

### Java
 - [Jongo ★478](https://github.com/bguerout/jongo) - Query in Java as in Mongo shell
 - [Hibernate OGM ★241](https://github.com/hibernate/hibernate-ogm) - The power and simplicity of JPA for NoSQL datastores
 - [mongo-java-driver ★1909](https://github.com/mongodb/mongo-java-driver) - Official Java driver
 ...
 - [Mongojack ★188](https://github.com/mongojack/mongojack) - Based on Jackson, allows you to easily handle your mongo objects as POJOs
 - [Morphia ★1230](https://github.com/mongodb/morphia) - Official Java ODM
 - [Morphium ★44](https://github.com/sboesebeck/morphium) - Java ODM and caching layer
 - [Mungbean ★20 ⏳6Y](https://github.com/jannehietamaki/mungbean) - Community driver for languages running on the JVM
 - [Spring Data MongoDB ★785](https://github.com/spring-projects/spring-data-mongodb) - Spring based, object-document support and repositories for MongoDB

### JavaScript
 - [Camo ★389](https://github.com/scottwrobinson/camo) - Class-based ES6 ODM for Mongo-like databases
 - [MEAN.JS ★4447](https://github.com/meanjs/mean) - Full-Stack based on MongoDB, Express, AngularJS, and Node.js
 - [MERN (mern-starter) ★4306](https://github.com/Hashnode/mern-starter) - Full-Stack based on MongoDB, Express, React and Node.js
 - [Mongoose ★14438](https://github.com/Automattic/mongoose) - Node.js asynchronous ODM
...
### Lisp
 - [cl-mongo ★111](https://github.com/fons/cl-mongo) - Community Common Lisp interface
 - [mongo-cl-driver ★29 ⏳2Y](https://github.com/archimag/mongo-cl-driver) Community Common Lisp driver
 - [mongo-el ★42 ⏳2Y](https://github.com/m2ym/mongo-el) - Community Emacs Lisp driver

### Mathematica
 - [MongoDBLink ★14 ⏳1Y](https://github.com/zbjornson/MongoDBLink) - Community Mathematica driver

### Perl
 - [mongo-perl-driver ★188](https://github.com/mongodb/mongo-perl-driver) - Official Perl driver

### PHP
 - [Doctrine MongoDB ★322](https://github.com/doctrine/mongodb) - Wrapper around the native PHP Mongo PECL extension to provide additional functionality
 ...
 - [pecl/mongodb ★450](https://github.com/mongodb/mongo-php-driver) - Official PHP driver

### Python
 - [Flask-PyMongo ★370](https://github.com/dcrosta/flask-pymongo) - PyMongo support for Flask applications
 - [MongoEngine ★2043](https://github.com/MongoEngine/mongoengine) - Python ODM on top of PyMongo
 - [MongoLog ★105 ⏳4Y](https://github.com/puentesarrin/mongodb-log) - MongoDB logging handler
 - [Mongo-Thingy ★10](https://github.com/numberly/mongo-thingy) - The most Pythonic and friendly-yet-powerful way to use MongoDB
 - [Motor ★898](https://github.com/mongodb/motor) - Non-blocking Python driver for Tornado applications
 - [PyMongo ★2204](https://github.com/mongodb/mongo-python-driver) - Official (and recommended) Python driver
 - [minimongo ★302](https://github.com/slacy/minimongo) - A lightweight, schemaless, Pythonic Object-Oriented interface
 - [scrapy-mongodb ★237](https://github.com/sebdah/scrapy-mongodb) - MongoDB pipeline for Scrapy
 - [μMongo ★66](https://github.com/Scille/umongo) - Driver-independent (async/sync) ODM based on marshmallow

### R
 - [mongolite](https://github.com/jeroenooms/mongolite) - Fast and Simple MongoDB Client for R

### Ruby
 - [mongo-ruby-driver ★1326](https://github.com/mongodb/mongo-ruby-driver) - Official Ruby driver
 - [Mongoid ★3578](https://github.com/mongodb/mongoid) - Ruby ODM framework

### Rust
 - [mongo-rust-driver-prototype ★225](https://github.com/mongodb-labs/mongo-rust-driver-prototype) - Prototype driver written for Rust 1.x and MongoDB 3.0.x

### Scala
 - [mongo-scala-driver ★187](https://github.com/mongodb/mongo-scala-driver) - Official Scala driver
...
### Administration
 ...
 - [mongo_fdw ★123](https://github.com/EnterpriseDB/mongo_fdw) - PostgreSQL foreign data wrapper for MongoDB
 - [mongoctl ★167](https://github.com/mongolab/mongoctl) - Manage MongoDB servers and replica sets using JSON configurations
 ...
 - [mongodb-tools ★248 ⏳2Y](https://github.com/jwilder/mongodb-tools) - Three neat Python scripts to work with collections and indexes
 - [Mongoeye ★17](https://github.com/mongoeye/mongoeye) - Schema and data analyzer: explore data in your collections
 - [Mongolastic ★65](https://github.com/ozlerhakan/mongolastic) - A dataset migration tool from MongoDB to Elasticsearch and vice versa
 - [MongoMultiMaster ★54 ⏳5Y](https://github.com/rick446/mmm) - Multi-Master MongoDB replication
 - [MoSQL ★1417](https://github.com/stripe/mosql) - MongoDB to PostgreSQL streaming replication
 - [mtools ★1030](https://github.com/rueckstiess/mtools) - Collection of scripts to set up MongoDB test environments and parse and visualize MongoDB log files
 - [nginx-gridfs ★764 ⏳4Y](https://github.com/mdirolf/nginx-gridfs) - Nginx module for serving files from MongoDB's GridFS
 - [nginx-mongodb-rest ★31 ⏳6Y](https://github.com/minhajuddin/nginx-mongodb-rest) - MongoDB REST client written as an Nginx module
 - [Variety ★1085](https://github.com/variety/variety) - Schema analyzer: see what fields are in your collection and what's their content

### Big Data
 - [mongo-hadoop ★1313](https://github.com/mongodb/mongo-hadoop) - MongoDB connector for Hadoop

### Deployment
 - [ansible-role-mongodb ★122](https://github.com/UnderGreen/ansible-role-mongodb) - Ansible role
 - [chef-mongodb ★384](https://github.com/edelight/chef-mongodb) - Chef cookbook
 - [Dockerfile ★232](https://github.com/dockerfile/mongodb)
 - [Helm Chart](https://github.com/kubernetes/charts/tree/master/stable/mongodb) - Bootstraps a MongoDB deployment on a [Kubernetes](https://kubernetes.io/docs/whatisk8s/) cluster using the [Helm ★3569](https://github.com/kubernetes/helm) package manager.
...
### Desktop
 ...
 - [MongoHub ★2243 ⏳2Y](https://github.com/jeromelebel/MongoHub-Mac) - Mac native client
...
### Monitoring
 ...
 - [Motop ★61 ⏳2Y](https://github.com/tart/motop) - MongoDB top clone
 ...
 - [nagios-plugin-mongodb ★322](https://github.com/mzupan/nagios-plugin-mongodb) - Nagios plugin (in Python)

### Shell
 - [mongo-hacker ★1341](https://github.com/TylerBrock/mongo-hacker) - MongoDB shell enhancements

### Web
 - [adminMongo ★1216](https://github.com/mrvautin/adminMongo) - Web-based user interface to handle connections and databases needs
 ...
 - [mongo-express ★2488](https://github.com/mongo-express/mongo-express) - Web-based admin interface written with Node.js, Express and Bootstrap3
 - [mongoadmin ★259](https://github.com/thomasst/mongoadmin) - Admin interface for MongoDB built using Django and Bootstrap
 - [mongri ★64](https://github.com/dongri/mongri) - Web-based user interface for MongoDB (written in JavaScript)
 - [Rockmongo ★807](https://github.com/iwind/rockmongo) - PHPMyAdmin for MongoDB, sort of

## Applications
 - [Leanote ★6487](https://github.com/leanote/leanote) - Evernote clone built with Go and MongoDB
 - [Quokka ★1752](https://github.com/quokkaproject/quokka) - Python CMS built on top of Flask and MongoDB
 - [uptime ★3381](https://github.com/fzaninotto/uptime) - Remote monitoring application using Node.js, MongoDB, and Bootstrap
