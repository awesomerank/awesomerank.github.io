...
```
[Source ★1874](https://github.com/h5bp/server-configs-apache)
...
If you don’t control versioning with filename-based cache busting, consider lowering the cache time for resources like CSS and JS to something like 1 week. [Source ★1874](https://github.com/h5bp/server-configs-apache)
``` apacheconf
