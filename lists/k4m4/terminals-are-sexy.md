...
* Base Shells
    ...
    * [PowerShell ★8234](https://github.com/PowerShell/PowerShell) - Automation and configuration tool/framework that is optimized for dealing with structured data.
    * [Ammonite-Shell ★1453](https://github.com/lihaoyi/ammonite) - An object shell with a Scala-like scripting language.
* ZSH
    * [oh-my-zsh ★61965](https://github.com/robbyrussell/oh-my-zsh) - Delightful community-driven framework for managing your zsh configuration.
    * [prezto ★8253](https://github.com/sorin-ionescu/prezto) - Configuration framework for Zsh.
    * [zsh-syntax-highlighting ★4269](https://github.com/zsh-users/zsh-syntax-highlighting) - Fish shell like syntax highlighting for Zsh.
    * [antigen ★3541](https://github.com/zsh-users/antigen) - Plugin manager for zsh, inspired by oh-my-zsh and vundle.
    * [slimzsh ★125](https://github.com/changs/slimzsh) - Small, usable configuration for ZSH.
    * [antibody ★468](https://github.com/getantibody/antibody) - Faster and simpler antigen written in Golang.
    * [pure ★4178](https://github.com/sindresorhus/pure) - Pretty, minimal and fast ZSH prompt.
    * [powerlevel9k ★3220](https://github.com/bhilburn/powerlevel9k) - Super flexible awesome powerline ZSH theme.
    * [liquidprompt ★3278](https://github.com/nojhan/liquidprompt) - Full-featured & carefully designed adaptive prompt for Bash & Zsh.
    * [dotzsh ★135](https://github.com/dotphiles/dotzsh) - Community driven framework for zsh.
    * [zgen ★812](https://github.com/tarjoilija/zgen) - Lightweight and simple plugin manager for ZSH.
    * [zplug ★1898](https://github.com/zplug/zplug) - Next-generation plugin manager for zsh.
    * [zunit](https://github.com/molovo/zunit) - Powerful unit testing framework for ZSH.
    * [zshdb ★121](https://github.com/rocky/zshdb) - ZSH debugger.
    * [zsh-quickstart-kit ★121](https://github.com/unixorn/zsh-quickstart-kit) - Simple zsh quickstart for using zsh and zgen.
    * [zsh-autosuggestions ★3870](https://github.com/zsh-users/zsh-autosuggestions) - Fish-like autosuggestions for zsh.
    ...
    * [zim ★947](https://github.com/Eriner/zim) - Zsh configuration framework with blazing speed and modular extensions.
    * [zoppo ★26](https://github.com/zoppo/zoppo) - Crippled configuration framework for Zsh.
    * [zpm ★27](https://github.com/zpm-zsh/zpm) - Plugin manager for zsh similar to vim-plug.
    * [ztanesh ★246](https://github.com/miohtama/ztanesh) - Aims to improve your UNIX command line experience and productivity with the the configuration provided by the ztanesh project.
    * [zulu ★65](https://github.com/zulu-zsh/zulu) - Total environment manager for ZSH 5+.
    * [zsh-pony ★89 ⏳6Y](https://github.com/mika/zsh-pony) - Covers customizing ZSH without a framework.
* Bash
    * [bash-sensible ★1459](https://github.com/mrzool/bash-sensible) - Attempt at saner Bash defaults.
    ...
    * [aliases ★100](https://github.com/sebglazebrook/aliases) - Contextual, dynamic, organized aliases for the bash shell.
    * [bash-it ★7029](https://github.com/Bash-it/bash-it) - Collection of community Bash commands and scripts.
* Git
    * [git-prompt ★318 ⏳1Y](https://github.com/lvv/git-prompt) - Bash prompt with Git, SVN and HG modules.
    * [gittify ★22 ⏳1Y](https://github.com/momeni/gittify) - Colorful Bash prompt + customized Git aliases.
    * [oh-my-git ★2723](https://github.com/arialdomartini/oh-my-git) - Opinionated git prompt for bash and zsh.
    * [bash-git-prompt ★3496](https://github.com/magicmonty/bash-git-prompt) - Informative and fancy Bash prompt for Git users.
    * [sexy-bash-prompt ★799](https://github.com/twolfson/sexy-bash-prompt) - Bash prompt with colors, Git statuses, and Git branches.
    * [git-sh ★678](https://github.com/rtomayko/git-sh) - Customized Bash environment suitable for Git work.
    * [git-radar ★2540](https://github.com/michaeldfallen/git-radar) - Heads up display for git
    * [git-extra-commands ★216](https://github.com/unixorn/git-extra-commands) - Collection of useful extra commands for git
* Fish
    * [Fisherman ★2590](https://github.com/fisherman/fisherman) - Concurrent plugin manager for fish.
    * [oh-my-fish ★2812](https://github.com/oh-my-fish/oh-my-fish) - The Fishshell Framework.

## Terminal Emulation Applications

*Sexy 3rd party terminal emulation applications.*

* [iTerm2 ★6440](https://github.com/gnachman/iTerm2) - Terminal emulator for macOS that does amazing things.
* [ConEmu ★4098](https://github.com/Maximus5/ConEmu) - Customizable Windows terminal with tabs, splits, quake-style and more.
...
* [Alacritty ★7751](https://github.com/jwilm/alacritty) - Cross-platform, GPU-accelerated terminal emulator.
* [Termite ★1408](https://github.com/thestinger/termite) - Keyboard-centric terminal, aimed at use within a tiling window manager.
* [Cmder ★12137](https://github.com/cmderdev/cmder) - Lovely console emulator package for Windows.
...
* Universal
    ...
    * [duo ★3559 ⏳1Y](https://github.com/duojs/duo) - Next-generation package manager for the front-end.
    * [basher ★299](https://github.com/basherpm/basher) - Package manager for shell scripts.
...
* FreeBSD
    * [pkg ★510](https://github.com/freebsd/pkg) - Package management tool for FreeBSD.
* Windows
    * [oneget ★1664](https://github.com/OneGet/oneget) - PackageManagement (aka OneGet) is a package manager for Windows.
...
* [micro ★7846](https://github.com/zyedidia/micro) - Modern and intuitive terminal-based text editor.
...
* [howdoi ★5900](https://github.com/gleitz/howdoi) - Instant code answers and examples from the command line
* [htop](http://hisham.hm/htop/) - Cool looking and interactive process viewer 'replacement' for the top command.
* [lolcat ★2473](https://github.com/busyloop/lolcat) - Rainbows and unicorns!
* [ack](https://beyondgrep.com/) - Tool like grep, optimized for programmers.
* [the_silver_searcher ★13775](https://github.com/ggreer/the_silver_searcher) - Code-searching tool similar to ack, but faster.
* [lunchy ★2530](https://github.com/eddiezane/lunchy) - Friendly wrapper for launchctl.
* [bro](http://bropages.org/) - Examples for command line programs.
* [tldr ★10850](https://github.com/tldr-pages/tldr) - Simplified and community-driven man pages.
* [tmux](https://tmux.github.io/) - Terminal multiplexer.
* [ranger](http://ranger.nongnu.org/) - Console file manager with vi key bindings.
* [googler ★2008](https://github.com/jarun/googler) - Search Google from your terminal.
* [jq.node ★192](https://github.com/FGRibreau/jq.node) - Command-line JSON/string processor, JavaScript and Lodash in your shell.
* [screenfetch ★1870](https://github.com/KittyKatt/screenFetch) - Fetches system/theme information in terminal for Linux desktop screenshots.
* [neofetch ★2345](https://github.com/dylanaraps/neofetch) - Fetches system/theme information in terminal for Linux desktop screenshots. Alternative to screenfetch.
...
* [getnews.tech ★8](https://github.com/omgimanerd/getnews.tech) - Checking the latest news headlines from various news outlets on the web.
* [hub](https://hub.github.com/) - Command-line wrapper for git that makes working with GitHub easy.
* [exa ★3594](https://github.com/ogham/exa) - Replacement for 'ls' written in Rust.
...
* Awesome
    * [awesome-devenv ★953](https://github.com/jondot/awesome-devenv) - Curated list of delightful Bash scripts and resources.
    * [awesome-sysadmin ★16204](https://github.com/kahun/awesome-sysadmin) - Curated list of amazingly awesome open source sysadmin resources.
    * [awesome-zsh-plugins ★3434](https://github.com/unixorn/awesome-zsh-plugins) - Collection of ZSH frameworks, plugins & themes inspired by the various awesome list collections out there.
    * [awesome-emacs ★3225](https://github.com/emacs-tw/awesome-emacs) - A community driven list of useful Emacs packages, libraries and others.
* Misc
    * [the-art-of-command-line ★32423](https://github.com/jlevy/the-art-of-command-line) - Master the command line, in one page.
    * [bash-guide ★8101](https://github.com/Idnan/bash-guide) - Guide to learn bash.
