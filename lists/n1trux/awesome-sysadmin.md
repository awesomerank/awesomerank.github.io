...
# Awesome Sysadmin [![certified awesome!](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)

**A curated list of amazingly awesome open source sysadmin resources.** Please read [CONTRIBUTING](./CONTRIBUTING.md) if you wish to add software and consider [donating ★9 ⏳2Y](n1trux/awesome-donations) to the FLOSS projects you use regularly.
...
* [Awesome Sysadmin](#awesome-sysadmin)
  ...
  * Cloud Storage: [see awesome-selfhosted#file-transfersynchronization ★15892](Kickball/awesome-selfhosted#file-transfersynchronization)
  ...
  * Mail servers/webmail: [see awesome-selfhosted#email ★15892](kickball/awesome-selfhosted#email)
  ...
  * Security: [see awesome-security ★1682](sbilly/awesome-security)
  * [Service Discovery](#service-discovery)
  * [Software Containers](#software-containers)
  * SSH: [see awesome-ssh ★547](moul/awesome-ssh)
  * Statistics: [see awesome-selfhosted#analytics ★15892](Kickball/awesome-selfhosted#analytics)
  * [Status Pages](#status-pages)
  * Ticketing systems: [see awesome-selfhosted#ticketing ★15892](Kickball/awesome-selfhosted#ticketing)
  * [Troubleshooting](#troubleshooting)
  * [Version control](#version-control)
  * [Virtualization](#virtualization)
  * [VPN](#vpn)
  * XMPP: [see awesome-selfhosted#xmpp ★15892](Kickball/awesome-selfhosted#xmpp)
  * [Web](#web)
  * Wiki Software: [see awesome-selfhosted#wikis ★15892](Kickball/awesome-selfhosted#wikis), Sysadmin Wikis: [see #wikis](#wikis)
* [Resources](#resources)
  * [Blogs](#blogs)
  * [Books](#books)
...
*Automation build.*
  ...
  * [Rake ★967](ruby/rake) - Build automation tool similar to Make, written in and extensible in Ruby.
...
*Backup software.*
  ...
  * [BorgBackup ★2338](borgbackup/borg) - A fork of [Attic](https://attic-backup.org) deduplicating backup program written in Python.
  * [Burp](http://burp.grke.org/) - Network backup and restore program.
  * [Duplicity](http://duplicity.nongnu.org/) - Encrypted bandwidth-efficient backup using the rsync algorithm.
  * [Elkarbackup ★74](elkarbackup/elkarbackup) - Backup solution based on RSnapshot with a simple web interface
  * [Lsyncd ★2191](axkibe/lsyncd) - File Monitor which spawns a process to synchronize the changes (rsync by default).
  ...
  * [Shield ★117](starkandwayne/shield) - A pluggable architecture for backup and restore of database systems.
  * [Snebu](http://www.snebu.com/) – Snapshot backup with global multi-client deduplication and transparent compression.
  * [UrBackup](http://www.urbackup.org/) - Another client-server backup system.
  * [DREBS ★32 ⏳2Y](dojo4/drebs) - AWS EBS backup script that supports strategies.
...
*Conversation-driven development and management. See https://www.reddit.com/r/chatops for more information.*
  ...
  * [CloudBot ★197](CloudBotIRC/CloudBot) - The simple, fast, expandable Python IRC bot.
...
## Cloud Computing
  ...
  * [AppScale ★2265](AppScale/appscale) - Cloud software with Google App Engine compatibility.
...
## Cloud Orchestration
  ...
  * [Genesis ★30](starkandwayne/genesis) - A template framework for multi-environment BOSH deployments.
  ...
  * [Kubernetes](http://kubernetes.io/) - Orchestration system for Docker containers - ([Source Code ★23545](kubernetes/kubernetes), [Documentation](http://kubernetes.io/docs/)) `Apache` `Go`
  ...
  * [Spruce](https://github.com/geofffranks/spruce) - A tool that merges separate YAML files into one.  Works well with [Genesis ★30](starkandwayne/genesis).
...
*Configuration management database (CMDB) software.*
  ...
  * [Ralph ★609](allegro/ralph) - Asset management, DCIM and CMDB system for large Data Centers as well as smaller LAN networks.
  * [Clusto ★221](clusto/clusto) - Helps you keep track of your inventory, where it is, how it's connected, and provides an abstracted interface for interacting with the elements of the infrastructure.
  * [Collins](http://tumblr.github.io/collins/) - At Tumblr, it's the infrastructure source of truth and knowledge.
  * [netbox ★2406](digitalocean/netbox) - IP address management (IPAM) and data center infrastructure management (DCIM) tool
...
*Continuous integration/deployment software.*
  ...
  * [CapsuleCD ★29](AnalogJ/capsulecd) - CD script for automating package/library releases (npm, cookbooks, gems, pip, jars, etc).
...
*Web hosting and server or service control panels*
  ...
  * DNS
    ...
    * [nsedit ★104](tuxis-ie/nsedit) - nsedit is a DNS editor for PowerDNS, working with PowerDNS's new API.
    * [PDNS Gui ★17 ⏳1Y](odoucet/pdns-gui) - WebGUI which aids in administering domains and records for PowerDNS with MySQL.
  ...
  * Virtualization
    ...
    * [OpenVZ Web Panel ★249](sibprogrammer/owp) - Web panel to control OpenVZ virtual machines.
...
*Tools and scripts to support deployments to your servers.*
  ...
  * [Vlad the Deployer ★346](seattlerb/vlad) - Deployment automation (rake based).
...
*Network distributed filesystems.*
  ...
  * [Go IPFS ★2920](ipfs/go-ipfs) - Implementation of [IPFS](http://ipfs.io/), a global, versioned, peer-to-peer filesystem that seeks to connect all computing devices with the same system of files.
...
*Open source code editors.*
  ...
  * [jotgit ★169 ⏳2Y](jdleesmiller/jotgit) - Git-backed real-time collaborative code editing.
  ...
  * [TextMate ★11279](textmate/textmate) - A graphical text editor for OS X.
...
*Log management tools: collect, parse, visualize ...*
  ...
  * [GoAccess](http://goaccess.io/) - Real-time web log analyzer and interactive viewer that runs in a terminal or through the browser. ([Source Code ★5331](allinurl/goaccess)) `MIT` `C`
...
*Monitoring software.*
  ...
  * [Adagios](http://adagios.org/) - Web based Nagios interface for configuration and monitoring (replacement to the standard interface), and a REST interface, [SourceCode ★263](opinkerfi/adagios), [Documentation](https://github.com/opinkerfi/adagios/wiki))
  * [Alerta ★830](guardian/alerta) - Distributed, scaleable and flexible monitoring system.
  ...
  * [Bosun](http://bosun.org/) - Monitoring and alerting system by Stack Exchange ([Source Code ★2258](bosun-monitor/bosun), [Documentation](http://bosun.org/quickstart.html)) `MIT` `Go`
  * [Cacti](http://www.cacti.net) - Web-based network monitoring and graphing tool.
  * [Cabot](http://cabotapp.com/) - Monitoring and alerts, similar to PagerDuty.
  * [cadvisor](https://github.com/google/cadvisor) - Analyzes resource usage and performance characteristics of running containers ([Source Code ★5689](google/cadvisor)) `Apache` `Go`
  * [check_mk](http://mathias-kettner.com/check_mk.html) - Collection of extensions for Nagios.
  * [Dash ★7646](afaqurk/linux-dash) - A low-overhead monitoring web dashboard for a GNU/Linux machine.
  ...
  * [Node-Bell ★277 ⏳1Y](eleme/bell.js) - Real-time anomalies detection for periodic time series, metrics monitor.
  ...
  * [psdash ★1960](Jahaja/psdash) - A linux system information web dashboard using psut
ils and flask.
  ...
  * [ServerStatus BotoX ★211](BotoX/ServerStatus) - Display and monitor your servers statistics in a beatiful way.
  * [ServerStatus moejda ★258](mojeda/ServerStatus) - Server Status website script, displays uptime (days), free RAM, free HDD
...
* Collectors only
  * [Diamond ★1247](BrightcoveOS/Diamond) - Python based statistic collection daemon.
  * [Collectd](http://collectd.org/) - System statistic collection daemon.
  * [Collectl](http://collectl.sourceforge.net/) - High precision system performance metrics collecting tool.
  * [PGObserver ★187](zalando/PGObserver) - Monitoring solution for PostgreSQL databases that also works with AWS RDS.
  * [Statsd ★11427](etsy/statsd) - Application statistic listener.
...
* Dashboards
  ...
  * [Freeboard ★4373](Freeboard/freeboard) - A damn-sexy front-end real-time dashboard for the internet of things. Transforms raw JSON into delicious UI.
...
* Storage
  ...
  * [KairosDB ★1055](kairosdb/kairosdb) - Fast distributed scalable time series database, fork of OpenTSDB 1.x.
...
*Network configuration management tools.*
  ...
  * [Oxidized ★570](ytti/oxidized) - A modern take on network device configuration monitoring with web interface and GIT storage.
  ...
  * [trigger ★380](trigger/trigger) - Robust network automation toolkit written in Python.
...
*Newsletter software.*
  ...
  * [LibreMailer ★16 ⏳2Y](averna-syd/LibreMailer) - Libre Mailer is a modest and simple web based email marketing application.
  * [Lewsnetter ★294 ⏳1Y](bborn/lewsnetter) - E-mail marketing application (create and send e-mail newsletter via SES). Includes subscription management, delivery, bounce and complaint notification, templates, and some stats.
...
* Key-Value
  * [LevelDB ★9465](google/leveldb) - Google's high performance key/value database.
...
## Packaging
  ...
  * [fpm ★7723](jordansissel/fpm) - Versatile multi format package creator.
  * [omnibus-ruby ★876](chef/omnibus) - Full stack, cross distro packaging software (Ruby).
  * [packman](http://packman.readthedocs.org) - Full stack, cross distro packaging software (Python).
  * [tito ★214](dgoodwin/tito) - Builds RPMs for git-based projects.
...
*Relational DBMS.*
  ...
  * [MariaDB](https://mariadb.org/) - Community-developed fork of the MySQL.
    * [adminer](https://www.adminer.org/) -  Database management in a single PHP file ([Source code ★2187](vrana/adminer))
...
## Service Discovery
  ...
  * [Doozerd ★2862 ⏳1Y](ha/doozerd) - Doozer is a highly-available, completely consistent store for small amounts of extremely important data.
  * [etcd ★13531](coreos/etcd) - distributed K/V-Store, authenticating via SSL PKI and a REST HTTP Api for shared configuration and service discovery.
...
*Troubleshooting Tools.*
  ...
  * [Dripcap ★1457](dripcap/dripcap) - Caffeinated Packet Analyzer.
...
*VPN software.*
  ...
  * [sshuttle ★8101](apenwarr/sshuttle) - Poor man's VPN.
...
*Web servers.*
  ...
  * [uWSGI ★1771](unbit/uwsgi) - The uWSGI project aims at developing a full stack for building hosting services.
