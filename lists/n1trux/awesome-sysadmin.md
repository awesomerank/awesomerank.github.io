...
# Awesome Sysadmin [![certified awesome!](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★63395](https://github.com/sindresorhus/awesome)
...
* [Awesome Sysadmin](#awesome-sysadmin)
  ...
  * Cloud Storage: [see awesome-selfhosted#file-transfersynchronization ★16964](https://github.com/Kickball/awesome-selfhosted#file-transfersynchronization)
  ...
  * Mail servers/webmail: [see awesome-selfhosted#email ★16964](https://github.com/kickball/awesome-selfhosted#email)
  ...
  * Security: [see awesome-security ★1856](https://github.com/sbilly/awesome-security)
  * [Service Discovery](#service-discovery)
  * [Software Containers](#software-containers)
  * SSH: [see awesome-ssh ★582](https://github.com/moul/awesome-ssh)
  * Statistics: [see awesome-selfhosted#analytics ★16964](https://github.com/Kickball/awesome-selfhosted#analytics)
  * [Status Pages](#status-pages)
  * Ticketing systems: [see awesome-selfhosted#ticketing ★16964](https://github.com/Kickball/awesome-selfhosted#ticketing)
  * [Troubleshooting](#troubleshooting)
  * [Version control](#version-control)
  * [Virtualization](#virtualization)
  * [VPN](#vpn)
  * XMPP: [see awesome-selfhosted#xmpp ★16964](https://github.com/Kickball/awesome-selfhosted#xmpp)
  * [Web](#web)
  * Wiki Software: [see awesome-selfhosted#wikis ★16964](https://github.com/Kickball/awesome-selfhosted#wikis), Sysadmin Wikis: [see #wikis](#wikis)
* [Resources](#resources)
  * [Blogs](#blogs)
  * [Books](#books)
...
*Backup software.*
  ...
  * [BorgBackup ★2604](https://github.com/borgbackup/borg) - A fork of [Attic](https://attic-backup.org) deduplicating backup program written in Python.
  * [Burp](http://burp.grke.org/) - Network backup and restore program.
  * [Duplicity](http://duplicity.nongnu.org/) - Encrypted bandwidth-efficient backup using the rsync algorithm.
  * [Elkarbackup ★87](https://github.com/elkarbackup/elkarbackup) - Backup solution based on RSnapshot with a simple web interface
  * [Lsyncd ★2300](https://github.com/axkibe/lsyncd) - File Monitor which spawns a process to synchronize the changes (rsync by default).
  ...
  * [Shield ★134](https://github.com/starkandwayne/shield) - A pluggable architecture for backup and restore of database systems.
...
*Conversation-driven development and management. See https://www.reddit.com/r/chatops for more information.*
  ...
  * [CloudBot ★201](https://github.com/CloudBotIRC/CloudBot) - The simple, fast, expandable Python IRC bot.
  ...
  * [Lazlo ★98 ⏳1Y](https://github.com/djosephsen/lazlo) - A chatops automation framework in Go.
...
## Cloud Computing
  ...
  * [AppScale ★2288](https://github.com/AppScale/appscale) - Cloud software with Google App Engine compatibility.
...
## Cloud Orchestration
  ...
  * [Kubernetes](http://kubernetes.io/) - Orchestration system for Docker containers - ([Source Code ★25744](https://github.com/kubernetes/kubernetes), [Documentation](http://kubernetes.io/docs/)) `Apache` `Go`
...
*Configuration management database (CMDB) software.*
  ...
  * [Ralph ★673](https://github.com/allegro/ralph) - Asset management, DCIM and CMDB system for large Data Centers as well as smaller LAN networks.
  * [Clusto ★227](https://github.com/clusto/clusto) - Helps you keep track of your inventory, where it is, how it's connected, and provides an abstracted interface for interacting with the elements of the infrastructure.
  * [Collins](http://tumblr.github.io/collins/) - At Tumblr, it's the infrastructure source of truth and knowledge.
  * [netbox ★2669](https://github.com/digitalocean/netbox) - IP address management (IPAM) and data center infrastructure management (DCIM) tool
...
*Continuous integration/deployment software.*
  ...
  * [CapsuleCD ★38](https://github.com/AnalogJ/capsulecd) - CD script for automating package/library releases (npm, cookbooks, gems, pip, jars, etc).
...
*Web hosting and server or service control panels*
  ...
  * DNS
    ...
    * [nsedit ★109](https://github.com/tuxis-ie/nsedit) - nsedit is a DNS editor for PowerDNS, working with PowerDNS's new API.
  ...
  * Virtualization
    ...
    * [OpenVZ Web Panel ★251](https://github.com/sibprogrammer/owp) - Web panel to control OpenVZ virtual machines.
...
*Tools and scripts to support deployments to your servers.*
  ...
  * [sup ★1497](https://github.com/pressly/sup) - Super simple deployment tool - just Unix - think of it like 'make' for a network of servers.
...
*Network distributed filesystems.*
  ...
  * [Go IPFS ★3175](https://github.com/ipfs/go-ipfs) - Implementation of [IPFS](http://ipfs.io/), a global, versioned, peer-to-peer filesystem that seeks to connect all computing devices with the same system of files.
...
*Log management tools: collect, parse, visualize ...*
  ...
  * [GoAccess](http://goaccess.io/) - Real-time web log analyzer and interactive viewer that runs in a terminal or through the browser. ([Source Code ★5612](https://github.com/allinurl/goaccess)) `MIT` `C`
...
*Monitoring software.*
  ...
  * [Alerta ★866](https://github.com/guardian/alerta) - Distributed, scaleable and flexible monitoring system.
  ...
  * [Bosun](http://bosun.org/) - Monitoring and alerting system by Stack Exchange ([Source Code ★2326](https://github.com/bosun-monitor/bosun), [Documentation](http://bosun.org/quickstart.html)) `MIT` `Go`
  * [Cacti](http://www.cacti.net) - Web-based network monitoring and graphing tool.
  * [Cabot](http://cabotapp.com/) - Monitoring and alerts, similar to PagerDuty.
  * [cadvisor](https://github.com/google/cadvisor) - Analyzes resource usage and performance characteristics of running containers ([Source Code ★5993](https://github.com/google/cadvisor)) `Apache` `Go`
  * [check_mk](http://mathias-kettner.com/check_mk.html) - Collection of extensions for Nagios.
  * [Dash ★7777](https://github.com/afaqurk/linux-dash) - A low-overhead monitoring web dashboard for a GNU/Linux machine.
  ...
  * [psdash ★1989](https://github.com/Jahaja/psdash) - A linux system information web dashboard using psut
ils and flask.
  * [pyDash](https://k3oni.github.io/pydash/) - Small web-based monitoring dashboard for linux.
  * [Riemann](http://riemann.io/) - Flexible and fast events processor allowing complex events/metrics analysis.
  * [rtop ★1562](https://github.com/rapidloop/rtop) - an interactive, remote system monitoring tool based on SSH.
  * [Sensu](https://sensuapp.org/) - Monitoring framework.
  * [ServerStatus BotoX ★226](https://github.com/BotoX/ServerStatus) - Display and monitor your servers statistics in a beatiful way.
  * [ServerStatus moejda ★271](https://github.com/mojeda/ServerStatus) - Server Status website script, displays uptime (days), free RAM, free HDD
  ...
  * [Vector ★2365](https://github.com/Netflix/vector) - An on-host performance monitoring framework.
...
* Dashboards
  ...
  * [Freeboard ★4576](https://github.com/Freeboard/freeboard) - A damn-sexy front-end real-time dashboard for the internet of things. Transforms raw JSON into delicious UI.
...
* Storage
  ...
  * [KairosDB ★1089](https://github.com/kairosdb/kairosdb) - Fast distributed scalable time series database, fork of OpenTSDB 1.x.
...
*Network configuration management tools.*
  ...
  * [Oxidized ★624](https://github.com/ytti/oxidized) - A modern take on network device configuration monitoring with web interface and GIT storage.
  ...
  * [trigger ★387](https://github.com/trigger/trigger) - Robust network automation toolkit written in Python.
...
*Newsletter software.*
  ...
  * [Lewsnetter ★295 ⏳1Y](https://github.com/bborn/lewsnetter) - E-mail marketing application (create and send e-mail newsletter via SES). Includes subscription management, delivery, bounce and complaint notification, templates, and some stats.
...
* Key-Value
  * [LevelDB ★10214](https://github.com/google/leveldb) - Google's high performance key/value database.
...
## Packaging
  ...
  * [fpm ★7940](https://github.com/jordansissel/fpm) - Versatile multi format package creator.
  * [omnibus-ruby ★904](https://github.com/chef/omnibus) - Full stack, cross distro packaging software (Ruby).
  * [packman](http://packman.readthedocs.org) - Full stack, cross distro packaging software (Python).
  * [tito ★230](https://github.com/dgoodwin/tito) - Builds RPMs for git-based projects.
...
*Relational DBMS.*
  ...
  * [MariaDB](https://mariadb.org/) - Community-developed fork of the MySQL.
    * [adminer](https://www.adminer.org/) -  Database management in a single PHP file ([Source code ★2302](https://github.com/vrana/adminer))
...
## Service Discovery
  ...
  * [Doozerd ★2894 ⏳1Y](https://github.com/ha/doozerd) - Doozer is a highly-available, completely consistent store for small amounts of extremely important data.
  * [etcd ★14436](https://github.com/coreos/etcd) - distributed K/V-Store, authenticating via SSL PKI and a REST HTTP Api for shared configuration and service discovery.
...
*VPN software.*
  ...
  * [sshuttle ★8374](https://github.com/apenwarr/sshuttle) - Poor man's VPN.
...
*Web servers.*
  ...
  * [uWSGI ★1835](https://github.com/unbit/uwsgi) - The uWSGI project aims at developing a full stack for building hosting services.
