...
*Log management tools: collect, parse, visualize ...*
  ...
  * [GoAccess](http://goaccess.io/) - Real-time web log analyzer and interactive viewer that runs in a terminal or through the browser. ([Source Code ★6024](https://github.com/allinurl/goaccess)) `MIT` `C`
...
*Monitoring software.*
  ...
  * [psdash ★2034](https://github.com/Jahaja/psdash) - A linux system information web dashboard using psut
ils and flask.
