...
* [Awesome Sysadmin](#awesome-sysadmin)
  ...
  * Cloud Storage: [see awesome-selfhosted#file-transfersynchronization ★23931](https://github.com/Kickball/awesome-selfhosted#file-transfersynchronization)
  ...
  * Mail servers/webmail: [see awesome-selfhosted#email ★23931](https://github.com/kickball/awesome-selfhosted#email)
  ...
  * Statistics: [see awesome-selfhosted#analytics ★23931](https://github.com/Kickball/awesome-selfhosted#analytics)
  * [Status Pages](#status-pages)
  * Ticketing systems: [see awesome-selfhosted#ticketing ★23931](https://github.com/Kickball/awesome-selfhosted#ticketing)
  * [Troubleshooting](#troubleshooting)
  * [Version control](#version-control)
  * [Virtualization](#virtualization)
  * [VPN](#vpn)
  * XMPP: [see awesome-selfhosted#xmpp ★23931](https://github.com/Kickball/awesome-selfhosted#xmpp)
  * [Web](#web)
  * Wiki Software: [see awesome-selfhosted#wikis ★23931](https://github.com/Kickball/awesome-selfhosted#wikis), Sysadmin Wikis: [see #wikis](#wikis)
* [Resources](#resources)
  * [Blogs](#blogs)
  * [Books](#books)
...
* [BorgBackup ★3685](https://github.com/borgbackup/borg) - A fork of [Attic](https://attic-backup.org) deduplicating backup program written in Python.
* [Burp](http://burp.grke.org/) - Network backup and restore program.
* [Duplicity](http://duplicity.nongnu.org/) - Encrypted bandwidth-efficient backup using the rsync algorithm.
* [Elkarbackup ★135](https://github.com/elkarbackup/elkarbackup) - Backup solution based on RSnapshot with a simple web interface
* [Lsyncd ★2926](https://github.com/axkibe/lsyncd) - File Monitor which spawns a process to synchronize the changes (rsync by default).
...
* [Shield ★178](https://github.com/starkandwayne/shield) - A pluggable architecture for backup and restore of database systems.
...
* [CloudBot ★238](https://github.com/CloudBotIRC/CloudBot) - The simple, fast, expandable Python IRC bot.
...
* [Lazlo ★126 ⏳2Y](https://github.com/djosephsen/lazlo) - A chatops automation framework in Go.
...
* [AppScale ★2332](https://github.com/AppScale/appscale) - Cloud software with Google App Engine compatibility.
...
* [Spruce](https://github.com/geofffranks/spruce) - A tool that merges separate YAML files into one.  Works well with [Genesis ★39](https://github.com/starkandwayne/genesis).
...
* [Ralph ★860](https://github.com/allegro/ralph) - Asset management, DCIM and CMDB system for large Data Centers as well as smaller LAN networks.
* [Clusto ★242 ⏳1Y](https://github.com/clusto/clusto) - Helps you keep track of your inventory, where it is, how it's connected, and provides an abstracted interface for interacting with the elements of the infrastructure.
* [Collins](http://tumblr.github.io/collins/) - At Tumblr, it's the infrastructure source of truth and knowledge.
* [netbox ★3804](https://github.com/digitalocean/netbox) - IP address management (IPAM) and data center infrastructure management (DCIM) tool
...
* DNS
  ...
  * [nsedit ★141](https://github.com/tuxis-ie/nsedit) - nsedit is a DNS editor for PowerDNS, working with PowerDNS's new API.
  * [PDNS Gui ★18 ⏳2Y](https://github.com/odoucet/pdns-gui) - WebGUI which aids in administering domains and records for PowerDNS with MySQL.
...
* Virtualization
  ...
  * [OpenVZ Web Panel ★267 ⏳1Y](https://github.com/sibprogrammer/owp) - Web panel to control OpenVZ virtual machines.
...
* [Go IPFS ★5772](https://github.com/ipfs/go-ipfs) - Implementation of [IPFS](http://ipfs.io/), a global, versioned, peer-to-peer filesystem that seeks to connect all computing devices with the same system of files.
...
* [GoAccess](http://goaccess.io/) - Real-time web log analyzer and interactive viewer that runs in a terminal or through the browser. ([Source Code ★6974](https://github.com/allinurl/goaccess)) `MIT` `C`
...
* [Adagios](http://adagios.org/) - Web based Nagios interface for configuration and monitoring (replacement to the standard interface), and a REST interface, [SourceCode ★279](https://github.com/opinkerfi/adagios), [Documentation](https://github.com/opinkerfi/adagios/wiki))
...
* [Dash ★8353](https://github.com/afaqurk/linux-dash) - A low-overhead monitoring web dashboard for a GNU/Linux machine.
* [ElastiFlow ★363](https://github.com/robcowart/elastiflow) - Network flow Monitoring (Netflow, sFlow and IPFIX) with the Elastic Stack.
...
* [psdash ★2117](https://github.com/Jahaja/psdash) - A linux system information web dashboard using psut ils and flask.
* [pyDash](https://k3oni.github.io/pydash/) - Small web-based monitoring dashboard for linux.
* [Riemann](http://riemann.io/) - Flexible and fast events processor allowing complex events/metrics analysis.
* [rtop ★1663](https://github.com/rapidloop/rtop) - an interactive, remote system monitoring tool based on SSH.
* [Sensu](https://sensuapp.org/) - Monitoring framework.
* [ServerStatus BotoX ★342](https://github.com/BotoX/ServerStatus) - Display and monitor your servers statistics in a beatiful way.
* [ServerStatus moejda ★296 ⏳1Y](https://github.com/mojeda/ServerStatus) - Server Status website script, displays uptime (days), free RAM, free HDD
* [Shinken](http://www.shinken-monitoring.org/) - Another monitoring framework.
* [SWMP - Server Web Monitor Page](https://swmp.fuzzytek.ml/) - A responsive, eye-pleasing Linux server statistics dashboard.([Source Code ★221](https://github.com/fuzzymannerz/swmp))
...
* [Vector ★2745](https://github.com/Netflix/vector) - An on-host performance monitoring framework.
...
* Collectors only
  * [Diamond ★1228 ⏳1Y](https://github.com/BrightcoveOS/Diamond) - Python based statistic collection daemon.
  * [Collectd](http://collectd.org/) - System statistic collection daemon.
  * [Collectl](http://collectl.sourceforge.net/) - High precision system performance metrics collecting tool.
  * [PGObserver ★251](https://github.com/zalando/PGObserver) - Monitoring solution for PostgreSQL databases that also works with AWS RDS.
  * [Statsd ★12972](https://github.com/etsy/statsd) - Application statistic listener.
...
* Dashboards
  ...
  * [Freeboard ★5201](https://github.com/Freeboard/freeboard) - A damn-sexy front-end real-time dashboard for the internet of things. Transforms raw JSON into delicious UI.
...
* Storage
  ...
  * [KairosDB ★1269](https://github.com/kairosdb/kairosdb) - Fast distributed scalable time series database, fork of OpenTSDB 1.x.
...
* [GNS3](https://www.gns3.com/) - Graphical network simulator that provides a variety of virtual appliances - ([Source Code ★700](https://github.com/GNS3/gns3-gui), [Documentation](https://docs.gns3.com/)) - `GPLv3`
* [Oxidized ★851](https://github.com/ytti/oxidized) - A modern take on network device configuration monitoring with web interface and GIT storage.
...
* [trigger ★426](https://github.com/trigger/trigger) - Robust network automation toolkit written in Python.
...
* [Lewsnetter ★304 ⏳2Y](https://github.com/bborn/lewsnetter) - E-mail marketing application (create and send e-mail newsletter via SES). Includes subscription management, delivery, bounce and complaint notification, templates, and some stats.
...
* [MariaDB](https://mariadb.org/) - Community-developed fork of the MySQL.
  * [adminer](https://www.adminer.org/) -  Database management in a single PHP file ([Source code ★2864](https://github.com/vrana/adminer))
...
* [rdpwrap ★3436](https://github.com/stascorp/rdpwrap) - RDP wrapper library allowing Remote Desktop Host support and concurrent RDP sessions on reduced functionality systems for home usage.
...
* [sshuttle ★1831](https://github.com/sshuttle/sshuttle) - Poor man's VPN.
...
* [uWSGI ★2121](https://github.com/unbit/uwsgi) - The uWSGI project aims at developing a full stack for building hosting services.
