...
# Awesome Sysadmin [![certified awesome!](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★60916](https://github.com/sindresorhus/awesome)
...
* [Awesome Sysadmin](#awesome-sysadmin)
  ...
  * Cloud Storage: [see awesome-selfhosted#file-transfersynchronization ★16438](https://github.com/Kickball/awesome-selfhosted#file-transfersynchronization)
  ...
  * Mail servers/webmail: [see awesome-selfhosted#email ★16438](https://github.com/kickball/awesome-selfhosted#email)
  ...
  * Security: [see awesome-security ★1769](https://github.com/sbilly/awesome-security)
  * [Service Discovery](#service-discovery)
  * [Software Containers](#software-containers)
  * SSH: [see awesome-ssh ★565](https://github.com/moul/awesome-ssh)
  * Statistics: [see awesome-selfhosted#analytics ★16438](https://github.com/Kickball/awesome-selfhosted#analytics)
  * [Status Pages](#status-pages)
  * Ticketing systems: [see awesome-selfhosted#ticketing ★16438](https://github.com/Kickball/awesome-selfhosted#ticketing)
  * [Troubleshooting](#troubleshooting)
  * [Version control](#version-control)
  * [Virtualization](#virtualization)
  * [VPN](#vpn)
  * XMPP: [see awesome-selfhosted#xmpp ★16438](https://github.com/Kickball/awesome-selfhosted#xmpp)
  * [Web](#web)
  * Wiki Software: [see awesome-selfhosted#wikis ★16438](https://github.com/Kickball/awesome-selfhosted#wikis), Sysadmin Wikis: [see #wikis](#wikis)
* [Resources](#resources)
  * [Blogs](#blogs)
  * [Books](#books)
...
*Automation build.*
  ...
  * [Rake ★998](https://github.com/ruby/rake) - Build automation tool similar to Make, written in and extensible in Ruby.
...
*Backup software.*
  ...
  * [BorgBackup ★2493](https://github.com/borgbackup/borg) - A fork of [Attic](https://attic-backup.org) deduplicating backup program written in Python.
  * [Burp](http://burp.grke.org/) - Network backup and restore program.
  * [Duplicity](http://duplicity.nongnu.org/) - Encrypted bandwidth-efficient backup using the rsync algorithm.
  * [Elkarbackup ★80](https://github.com/elkarbackup/elkarbackup) - Backup solution based on RSnapshot with a simple web interface
  * [Lsyncd ★2239](https://github.com/axkibe/lsyncd) - File Monitor which spawns a process to synchronize the changes (rsync by default).
  ...
  * [Shield ★128](https://github.com/starkandwayne/shield) - A pluggable architecture for backup and restore of database systems.
...
*Conversation-driven development and management. See https://www.reddit.com/r/chatops for more information.*
  ...
  * [CloudBot ★199](https://github.com/CloudBotIRC/CloudBot) - The simple, fast, expandable Python IRC bot.
  ...
  * [Lazlo ★93 ⏳1Y](https://github.com/djosephsen/lazlo) - A chatops automation framework in Go.
...
## Cloud Computing
  ...
  * [AppScale ★2277](https://github.com/AppScale/appscale) - Cloud software with Google App Engine compatibility.
...
## Cloud Orchestration
  ...
  * [Genesis ★30](https://github.com/starkandwayne/genesis) - A template framework for multi-environment BOSH deployments.
  ...
  * [Kubernetes](http://kubernetes.io/) - Orchestration system for Docker containers - ([Source Code ★24533](https://github.com/kubernetes/kubernetes), [Documentation](http://kubernetes.io/docs/)) `Apache` `Go`
  ...
  * [Spruce](https://github.com/geofffranks/spruce) - A tool that merges separate YAML files into one.  Works well with [Genesis ★30](https://github.com/starkandwayne/genesis).
...
*Configuration management database (CMDB) software.*
  ...
  * [Ralph ★644](https://github.com/allegro/ralph) - Asset management, DCIM and CMDB system for large Data Centers as well as smaller LAN networks.
  * [Clusto ★222](https://github.com/clusto/clusto) - Helps you keep track of your inventory, where it is, how it's connected, and provides an abstracted interface for interacting with the elements of the infrastructure.
  * [Collins](http://tumblr.github.io/collins/) - At Tumblr, it's the infrastructure source of truth and knowledge.
  * [netbox ★2606](https://github.com/digitalocean/netbox) - IP address management (IPAM) and data center infrastructure management (DCIM) tool
...
*Continuous integration/deployment software.*
  ...
  * [CapsuleCD ★30](https://github.com/AnalogJ/capsulecd) - CD script for automating package/library releases (npm, cookbooks, gems, pip, jars, etc).
...
*Web hosting and server or service control panels*
  ...
  * DNS
    ...
    * [nsedit ★106](https://github.com/tuxis-ie/nsedit) - nsedit is a DNS editor for PowerDNS, working with PowerDNS's new API.
  ...
  * Virtualization
    ...
    * [OpenVZ Web Panel ★250](https://github.com/sibprogrammer/owp) - Web panel to control OpenVZ virtual machines.
...
*Tools and scripts to support deployments to your servers.*
  ...
  * [sup ★1483](https://github.com/pressly/sup) - Super simple deployment tool - just Unix - think of it like 'make' for a network of servers.
...
*Network distributed filesystems.*
  ...
  * [Go IPFS ★3043](https://github.com/ipfs/go-ipfs) - Implementation of [IPFS](http://ipfs.io/), a global, versioned, peer-to-peer filesystem that seeks to connect all computing devices with the same system of files.
...
*Open source code editors.*
  ...
  * [jotgit ★172 ⏳2Y](https://github.com/jdleesmiller/jotgit) - Git-backed real-time collaborative code editing.
  ...
  * [TextMate ★11316](https://github.com/textmate/textmate) - A graphical text editor for OS X.
...
*Log management tools: collect, parse, visualize ...*
  ...
  * [GoAccess](http://goaccess.io/) - Real-time web log analyzer and interactive viewer that runs in a terminal or through the browser. ([Source Code ★5509](https://github.com/allinurl/goaccess)) `MIT` `C`
...
*Monitoring software.*
  ...
  * [Adagios](http://adagios.org/) - Web based Nagios interface for configuration and monitoring (replacement to the standard interface), and a REST interface, [SourceCode ★266](https://github.com/opinkerfi/adagios), [Documentation](https://github.com/opinkerfi/adagios/wiki))
  * [Alerta ★853](https://github.com/guardian/alerta) - Distributed, scaleable and flexible monitoring system.
  ...
  * [Bosun](http://bosun.org/) - Monitoring and alerting system by Stack Exchange ([Source Code ★2291](https://github.com/bosun-monitor/bosun), [Documentation](http://bosun.org/quickstart.html)) `MIT` `Go`
  * [Cacti](http://www.cacti.net) - Web-based network monitoring and graphing tool.
  * [Cabot](http://cabotapp.com/) - Monitoring and alerts, similar to PagerDuty.
  * [cadvisor](https://github.com/google/cadvisor) - Analyzes resource usage and performance characteristics of running containers ([Source Code ★5841](https://github.com/google/cadvisor)) `Apache` `Go`
  * [check_mk](http://mathias-kettner.com/check_mk.html) - Collection of extensions for Nagios.
  * [Dash ★7710](https://github.com/afaqurk/linux-dash) - A low-overhead monitoring web dashboard for a GNU/Linux machine.
  ...
  * [Node-Bell ★278 ⏳1Y](https://github.com/eleme/bell.js) - Real-time anomalies detection for periodic time series, metrics monitor.
  ...
  * [psdash ★1981](https://github.com/Jahaja/psdash) - A linux system information web dashboard using psut
ils and flask.
  * [pyDash](https://k3oni.github.io/pydash/) - Small web-based monitoring dashboard for linux.
  * [Riemann](http://riemann.io/) - Flexible and fast events processor allowing complex events/metrics analysis.
  * [rtop ★1549](https://github.com/rapidloop/rtop) - an interactive, remote system monitoring tool based on SSH.
  * [Sensu](https://sensuapp.org/) - Monitoring framework.
  * [ServerStatus BotoX ★217](https://github.com/BotoX/ServerStatus) - Display and monitor your servers statistics in a beatiful way.
  * [ServerStatus moejda ★264](https://github.com/mojeda/ServerStatus) - Server Status website script, displays uptime (days), free RAM, free HDD
  ...
  * [Vector ★2325](https://github.com/Netflix/vector) - An on-host performance monitoring framework.
...
* Collectors only
  * [Diamond ★1247](https://github.com/BrightcoveOS/Diamond) - Python based statistic collection daemon.
  * [Collectd](http://collectd.org/) - System statistic collection daemon.
  * [Collectl](http://collectl.sourceforge.net/) - High precision system performance metrics collecting tool.
  * [PGObserver ★236](https://github.com/zalando/PGObserver) - Monitoring solution for PostgreSQL databases that also works with AWS RDS.
  * [Statsd ★11594](https://github.com/etsy/statsd) - Application statistic listener.
...
* Dashboards
  ...
  * [Freeboard ★4493](https://github.com/Freeboard/freeboard) - A damn-sexy front-end real-time dashboard for the internet of things. Transforms raw JSON into delicious UI.
...
* Storage
  ...
  * [KairosDB ★1069](https://github.com/kairosdb/kairosdb) - Fast distributed scalable time series database, fork of OpenTSDB 1.x.
...
*Network configuration management tools.*
  ...
  * [Oxidized ★600](https://github.com/ytti/oxidized) - A modern take on network device configuration monitoring with web interface and GIT storage.
  ...
  * [trigger ★382](https://github.com/trigger/trigger) - Robust network automation toolkit written in Python.
...
*Newsletter software.*
  ...
  * [LibreMailer ★18 ⏳2Y](https://github.com/averna-syd/LibreMailer) - Libre Mailer is a modest and simple web based email marketing application.
  * [Lewsnetter ★294 ⏳1Y](https://github.com/bborn/lewsnetter) - E-mail marketing application (create and send e-mail newsletter via SES). Includes subscription management, delivery, bounce and complaint notification, templates, and some stats.
...
* Key-Value
  * [LevelDB ★9759](https://github.com/google/leveldb) - Google's high performance key/value database.
...
## Packaging
  ...
  * [fpm ★7835](https://github.com/jordansissel/fpm) - Versatile multi format package creator.
  * [omnibus-ruby ★895](https://github.com/chef/omnibus) - Full stack, cross distro packaging software (Ruby).
  * [packman](http://packman.readthedocs.org) - Full stack, cross distro packaging software (Python).
  * [tito ★220](https://github.com/dgoodwin/tito) - Builds RPMs for git-based projects.
...
*Relational DBMS.*
  ...
  * [MariaDB](https://mariadb.org/) - Community-developed fork of the MySQL.
    * [adminer](https://www.adminer.org/) -  Database management in a single PHP file ([Source code ★2240](https://github.com/vrana/adminer))
...
## Service Discovery
  ...
  * [Doozerd ★2883 ⏳1Y](https://github.com/ha/doozerd) - Doozer is a highly-available, completely consistent store for small amounts of extremely important data.
  * [etcd ★13903](https://github.com/coreos/etcd) - distributed K/V-Store, authenticating via SSL PKI and a REST HTTP Api for shared configuration and service discovery.
...
*Troubleshooting Tools.*
  ...
  * [Dripcap ★1477](https://github.com/dripcap/dripcap) - Caffeinated Packet Analyzer.
...
*VPN software.*
  ...
  * [sshuttle ★8191](https://github.com/apenwarr/sshuttle) - Poor man's VPN.
...
*Web servers.*
  ...
  * [uWSGI ★1805](https://github.com/unbit/uwsgi) - The uWSGI project aims at developing a full stack for building hosting services.
