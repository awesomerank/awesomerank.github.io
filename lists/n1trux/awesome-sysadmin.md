...
* [Awesome Sysadmin](#awesome-sysadmin)
  ...
  * Cloud Storage: [see awesome-selfhosted#file-transfersynchronization ★15272](https://github.com/Kickball/awesome-selfhosted#file-transfersynchronization)
  ...
  * Mail servers/webmail: [see awesome-selfhosted#email ★15272](https://github.com/kickball/awesome-selfhosted#email)
  ...
  * Security: [see awesome-security ★1595](https://github.com/sbilly/awesome-security)
  * [Service Discovery](#service-discovery)
  * [Software Containers](#software-containers)
  * SSH: [see awesome-ssh ★526](https://github.com/moul/awesome-ssh)
  * Statistics: [see awesome-selfhosted#analytics ★15272](https://github.com/Kickball/awesome-selfhosted#analytics)
  * [Status Pages](#status-pages)
  * Ticketing systems: [see awesome-selfhosted#ticketing ★15272](https://github.com/Kickball/awesome-selfhosted#ticketing)
  * [Troubleshooting](#troubleshooting)
  * [Version control](#version-control)
  * [Virtualization](#virtualization)
  * [VPN](#vpn)
  * XMPP: [see awesome-selfhosted#xmpp ★15272](https://github.com/Kickball/awesome-selfhosted#xmpp)
  * [Web](#web)
  * Wiki Software: [see awesome-selfhosted#wikis ★15272](https://github.com/Kickball/awesome-selfhosted#wikis), Sysadmin Wikis: [see #wikis](#wikis)
* [Resources](#resources)
  * [Blogs](#blogs)
  * [Books](#books)
...
*Automation build.*
  ...
  * [Rake ★935](https://github.com/ruby/rake) - Build automation tool similar to Make, written in and extensible in Ruby.
...
*Backup software.*
  ...
  * [Elkarbackup ★68](https://github.com/elkarbackup/elkarbackup) - Backup solution based on RSnapshot with a simple web interface
...
*Conversation-driven development and management. See https://www.reddit.com/r/chatops for more information.*
  ...
  * [CloudBot ★189](https://github.com/CloudBotIRC/CloudBot) - The simple, fast, expandable Python IRC bot.
  ...
  * [Lazlo ★89](https://github.com/djosephsen/lazlo) - A chatops automation framework in Go.
...
## Cloud Computing
  ...
  * [AppScale ★2260](https://github.com/AppScale/appscale) - Cloud software with Google App Engine compatibility.
...
## Cloud Orchestration
  ...
  * [Genesis ★29](https://github.com/starkandwayne/genesis) - A template framework for multi-environment BOSH deployments.
  ...
  * [Kubernetes](http://kubernetes.io/) - Orchestration system for Docker containers - ([Source Code ★22756](https://github.com/kubernetes/kubernetes), [Documentation](http://kubernetes.io/docs/)) `Apache` `Go`
  ...
  * [Spruce](https://github.com/geofffranks/spruce) - A tool that merges separate YAML files into one.  Works well with [Genesis ★29](https://github.com/starkandwayne/genesis).
...
*Configuration management database (CMDB) software.*
  ...
  * [Ralph ★590](https://github.com/allegro/ralph) - Asset management, DCIM and CMDB system for large Data Centers as well as smaller LAN networks.
  * [Clusto ★219](https://github.com/clusto/clusto) - Helps you keep track of your inventory, where it is, how it's connected, and provides an abstracted interface for interacting with the elements of the infrastructure.
...
*Web hosting and server or service control panels*
  ...
  * Virtualization
    ...
    * [OpenVZ Web Panel ★248](https://github.com/sibprogrammer/owp) - Web panel to control OpenVZ virtual machines.
...
*Network distributed filesystems.*
  ...
  * [Go IPFS ★2832](https://github.com/ipfs/go-ipfs) - Implementation of [IPFS](http://ipfs.io/), a global, versioned, peer-to-peer filesystem that seeks to connect all computing devices with the same system of files.
...
*Open source code editors.*
  ...
  * [TextMate ★11243](https://github.com/textmate/textmate) - A graphical text editor for OS X.
...
*Monitoring software.*
  ...
  * [Adagios](http://adagios.org/) - Web based Nagios interface for configuration and monitoring (replacement to the standard interface), and a REST interface, [SourceCode ★261](https://github.com/opinkerfi/adagios), [Documentation](https://github.com/opinkerfi/adagios/wiki))
  * [Alerta ★816](https://github.com/guardian/alerta) - Distributed, scaleable and flexible monitoring system.
  ...
  * [Bosun](http://bosun.org/) - Monitoring and alerting system by Stack Exchange ([Source Code ★2230](https://github.com/bosun-monitor/bosun), [Documentation](http://bosun.org/quickstart.html)) `MIT` `Go`
  ...
  * [Dash ★7573](https://github.com/afaqurk/linux-dash) - A low-overhead monitoring web dashboard for a GNU/Linux machine.
...
ils and flask.
  ...
  * [ServerStatus BotoX ★195](https://github.com/BotoX/ServerStatus) - Display and monitor your servers statistics in a beatiful way.
...
* Collectors only
  * [Diamond ★1249](https://github.com/BrightcoveOS/Diamond) - Python based statistic collection daemon.
  * [Collectd](http://collectd.org/) - System statistic collection daemon.
  * [Collectl](http://collectl.sourceforge.net/) - High precision system performance metrics collecting tool.
  * [PGObserver ★186](https://github.com/zalando/PGObserver) - Monitoring solution for PostgreSQL databases that also works with AWS RDS.
  * [Statsd ★11298](https://github.com/etsy/statsd) - Application statistic listener.
...
* Dashboards
  ...
  * [Freeboard ★4287](https://github.com/Freeboard/freeboard) - A damn-sexy front-end real-time dashboard for the internet of things. Transforms raw JSON into delicious UI.
...
* Storage
  ...
  * [KairosDB ★1038](https://github.com/kairosdb/kairosdb) - Fast distributed scalable time series database, fork of OpenTSDB 1.x.
...
* Key-Value
  * [LevelDB ★9177](https://github.com/google/leveldb) - Google's high performance key/value database.
...
## Packaging
  ...
  * [fpm ★7619](https://github.com/jordansissel/fpm) - Versatile multi format package creator.
  * [omnibus-ruby](https://github.com/chef/omnibus) - Full stack, cross distro packaging software (Ruby).
  * [packman](http://packman.readthedocs.org) - Full stack, cross distro packaging software (Python).
  * [tito ★212](https://github.com/dgoodwin/tito) - Builds RPMs for git-based projects.
...
*Troubleshooting Tools.*
  ...
  * [Dripcap ★1435](https://github.com/dripcap/dripcap) - Caffeinated Packet Analyzer.
...
*VPN software.*
  ...
  * [sshuttle ★7993](https://github.com/apenwarr/sshuttle) - Poor man's VPN.
...
*Web servers.*
  ...
  * [uWSGI ★1747](https://github.com/unbit/uwsgi) - The uWSGI project aims at developing a full stack for building hosting services.
