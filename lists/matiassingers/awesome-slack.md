...
<p align="center">
	This list is a copy of <a href="https://github.com/matiassingers/awesome-slack">https://github.com/matiassingers/awesome-slack</a> with ranks
</p>
---
...
- [slack-hooks ★17 ⏳1Y](https://github.com/papertrail/slack-hooks) - Papertrail's collection of webhook receivers for Slack
...
- [go-bot ★23 ⏳1Y](https://github.com/fabioxgn/go-bot) - IRC bot written in go
...
- [slack-markov ★45 ⏳1Y](https://github.com/grantmd/slack-markov) - A markov chain bot for your Slack channel
- [slack-oldbot ★12 ⏳3Y](https://github.com/grantmd/slack-oldbot) - A bot for Slack that politely reports when a link has been used before in the channel
...
- [SlackMS ★8 ⏳2Y](https://github.com/ueg1990/SlackMS) - SMS your team channel in Slack
...
- [bitbucket-slack-pr-hook ★55 ⏳1Y](https://github.com/lfilho/bitbucket-slack-pr-hook) - Receive Pull Request notifications from BitBucket and send them to Slack
...
- [camayak-to-slack ★1 ⏳2Y](https://github.com/tcu360/camayak-to-slack) - Node.js app that allows Slack to work as a Camayak publishing destination
...
- [giphyslack ★3 ⏳2Y](https://github.com/dotfury/giphyslack) - Giphy integration for Slack built in node.js
- [good-slack](https://github.com/dmacosta/good-slack) - Slack Webhook message posting for Good process monitor
- [grunt-alert ★5 ⏳1Y](https://github.com/mmarcon/grunt-alert) - Sends alerts about failing builds using different channels
...
- [irc-slack-echo ★43 ⏳2Y](https://github.com/rknLA/irc-slack-echo) - Echoes IRC activity to Slack, and supports IRC/Slack username mapping
...
- [node-slack-cli ★22 ⏳2Y](https://github.com/juanpabloaj/node-slack-cli) - Send messages to Slack from the command line with nodejs
...
- [Send-to-Slack ★355 ⏳1Y](https://github.com/shahruz/Send-to-Slack) - A plugin for Sketch.app to share artboards to Slack
...
- [slack-currency ★15 ⏳1Y](https://github.com/matiassingers/slack-currency) - Slash command for converting currency
- [slack-dnd ★29 ⏳2Y](https://github.com/toddself/slack-dnd) - D&D slash commands for Slack
...
- [slack-integrations ★1 ⏳1Y](https://github.com/CollectiveDS/slack-integrations) - The Collective Digital Studio Slack integration server
- [slack-integrator ★0 ⏳1Y](https://github.com/way2-technology/slack-integrator) - Easily integrate Slack with your apps!
- [slack-invite ★10 ⏳2Y](https://github.com/wski/slack-invite) - Invite people to your awesome slack group
...
- [slack-news ★127 ⏳1Y](https://github.com/karan/slack-news) - Read news from multiple sources within Slack by just typing /news
...
- [slack-pongbot ★79 ⏳1Y](https://github.com/andrewvy/slack-pongbot) - Slack bot for ping pong tracking
...
- [slack-tableflip ★17 ⏳1Y](https://github.com/josheverett/slack-tableflip) - A tableflip slash command
...
- [slackarma ★7 ⏳1Y](https://github.com/gdroel/slackarma) - Give your teammates reputation points in Slack
...
- [slackey ★17 ⏳1Y](https://github.com/FredKSchott/slackey) - A JavaScript SDK for the Slack API
...
- [SnooBot ★0 ⏳1Y](https://github.com/nobe4/SnooBot) - Look up information about Reddit subs
...
- [swolebot ★35 ⏳1Y](https://github.com/robinpowered/swolebot) - A Slack bot for keeping your team fit through open pull requests
...
- [breezBot ★4 ⏳2Y](https://github.com/picsoung/breezBot) - Air quality index bot for Slack using the breezometer API
...
- [uberSlackBot ★26 ⏳2Y](https://github.com/picsoung/uberSlackBot) - Get Uber price estimates directly in Slack

### Matlab

- [SlackMatlab ★12 ⏳2Y](https://github.com/DylanMuir/SlackMatlab) - Basic integration for Slack notifications for Matlab
...
- [slack-integrations ★19 ⏳1Y](https://github.com/khera/slack-integrations) - Scripts to integrate Slack with subversion and nagios
...
- [ExceptionHandler ★12 ⏳1Y](https://github.com/hexa2k9/ExceptionHandler) - PHP Exception Handler to post exceptions to a Slack channel
...
- [notifyme ★176 ⏳1Y](https://github.com/notifymehq/notifyme) - Provides a common interface for notification services
...
- [pslackr ★8 ⏳1Y](https://github.com/fullybaked/pslackr) - Library for sending messages from your app to Slack
- [redmine-command ★14 ⏳1Y](https://github.com/digitalicagroup/redmine-command) - Redmine-Slack integration to manage issues
- [rocketeer-slack ★25](https://github.com/rocketeers/rocketeer-slack) - Slack plugin for Rocketeer
- [Shooker ★22 ⏳1Y](https://github.com/jwenzler/Shooker) - Slack WebHooks PHP Class
- [Slack ★832](https://github.com/maknz/slack) - Laravel 4 package for sending messages to Slack
- [slack-api ★27 ⏳2Y](https://github.com/10w042/slack-api) - A super simple wrapper for the Slack API
- [slack-notifier ★57 ⏳1Y](https://github.com/polem/slack-notifier) - Simple PHP wrapper for Slack notifications
- [slack-sdk](https://packagist.org/packages/threadmeup/slack-sdk) - PHP SDK
- [slack-tea ★6 ⏳1Y](https://github.com/liquidlight/slack-tea) - Decide who makes the tea using Slack
...
- [Slacker ★523 ⏳1Y](https://github.com/TidalLabs/Slacker) - Simple Slack client for the CLI
...
- [slackuntappd ★16 ⏳1Y](https://github.com/gregavola/slackuntappd) - A webhook that allows you to search for beer information within Slack via Untappd
- [SlackWamp ★4](https://github.com/voryx/SlackWamp) - A WAMP wrapper for the Slack API
- [Sqwack ★13 ⏳2Y](https://github.com/heyupdate/Sqwack) - Semi-realtime profile photos in Slack
...
- [asterisk-slack ★9 ⏳2Y](https://github.com/firehooper/asterisk-slack) - Publishes Asterisk call information to Slack
- [butterfield ★2 ⏳2Y](https://github.com/sunlightlabs/butterfield) - Python Slack bot framework using asyncio and Slack's RTM API
...
- [slack ★86 ⏳1Y](https://github.com/kn/slack) - A simple and comprehensive Slack API client
...
- [slack-imgur ★17 ⏳1Y](https://github.com/juanpabloaj/slack-imgur) - A random image from Imgur to Slack
...
- [slackbot-python ★47 ⏳2Y](https://github.com/fsalum/slackbot-python) - A Slack.com bot in Python integrated with Amazon SQS
- [slackbridge ★14 ⏳1Y](https://github.com/ossobv/slackbridge) - Bridge Slack channels between companies
...
- [beach ★13 ⏳1Y](https://github.com/willrax/beach) - Small Sinatra app to host web hooks for Slack
...
- [gifbot ★39 ⏳3Y](https://github.com/schuyler/gifbot) - Integrated animated GIF search for Slack
...
- [mslabs-slack-bridge ★1 ⏳2Y](https://github.com/ms-digital-labs/mslabs-slack-bridge) - Bridge between our cloud services and Slack
...
- [puppet-slack ★2 ⏳2Y](https://github.com/orlando/puppet-slack) - Slack Puppet Module for Boxen
...
- [slack-shuffle ★4 ⏳2Y](https://github.com/romulomachado/slack-shuffle) - Slack integration for shuffling a list with your team members
...
- [slackbotsy ★77 ⏳1Y](https://github.com/rlister/slackbotsy) - Ruby bot for Slack, inspire by botsy
...
- [tarumi ★8 ⏳1Y](https://github.com/IcaliaLabs/tarumi) - A simple library to interact with Slack webhooks
...
- [scala-slack ★9 ⏳1Y](https://github.com/flyberry-capital/scala-slack) - A Slack client for Scala
