...
---
# awesome-slack [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★61331](https://github.com/sindresorhus/awesome)
...
- Linux - [ScudCloud ★1159](https://github.com/raelgc/scudcloud)
...
- [Log4Slack ★46](https://github.com/jonfreeland/Log4Slack) - simple, asynchronous Slack log4net appender
...
- [Slack.Webhooks ★86](https://github.com/nerdfury/Slack.Webhooks) - Even simpler integration with Slack's Incoming / Outgoing webhooks
- [SlackAPI ★184](https://github.com/Inumedia/SlackAPI) - Full Slack API library, including WebSockets
...
- [svn-slack-notifier ★16 ⏳1Y](https://github.com/robertmiles3/svn-slack-notifier) - A simple app to send VisualSVN Server commit notifications to Slack
- [TfsNotificationRelay ★112](https://github.com/kria/TfsNotificationRelay) - A plugin for TFS 2013 that sends notifications to Slack
...
- [clj-slack ★78](https://github.com/julienXX/clj-slack) - Use Slack REST API from Clojure
...
- [slack-node-sdk ★128](https://github.com/clonn/slack-node-sdk) - Slack Node SDK with Webhook and API support
...
- [hal ★262](https://github.com/danryan/hal) - A chat bot in Go
...
- [slackcat ★127](https://github.com/paulhammond/slackcat) - Post messages to Slack from the command line
- [slacker-news ★3 ⏳1Y](https://github.com/munrocape/slacker-news) - Slack integration that reports current news items
- [slackline ★188 ⏳1Y](https://github.com/ernesto-jimenez/slackline) - Create a Slack channel shared by two organizations
...
- [slackrus ★51](https://github.com/johntdyer/slackrus) - Slack hook for Logrus
...
- [webhook ★1796](https://github.com/adnanh/webhook) - Easily run commands in response to HTTP webhook requests from Slack
...
- [rundeck-slack-incoming-webhook-plugin ★47 ⏳1Y](https://github.com/higanworks/rundeck-slack-incoming-webhook-plugin) - A Rundeck Plugin for Slack Incoming WebHooks
- [rundeck-slack-plugin ★29 ⏳1Y](https://github.com/bitplaces/rundeck-slack-plugin) - A Rundeck Plugin for Slack
- [simple-slack-api ★297](https://github.com/Ullink/simple-slack-api) - A Slack client library in Java
- [SlackMC ★50](https://github.com/CircuitSoftGroup/SlackMC) - Bukkit/Bungee plugin for Slack
...
- [slack-webhook ★99](https://github.com/gpedro/slack-webhook) - Slack WebHook Integration for Java
- [stash2slack ★46](https://github.com/pragbits/stash2slack) - Send Stash server events as notifications to Slack
- [tcSlackBuildNotifier ★264](https://github.com/PeteGoo/tcSlackBuildNotifier) - Post TeamCity build notifications to Slack

### JavaScript

- [bip-pod-slack ★3](https://github.com/bipio-server/bip-pod-slack) - Slack Pod for BipIO
- [bitbucket-slack-pr-hook ★57 ⏳1Y](https://github.com/lfilho/bitbucket-slack-pr-hook) - Receive Pull Request notifications from BitBucket and send them to Slack
...
- [bunyan-slack ★60](https://github.com/qualitybath/bunyan-slack) - Bunyan stream for Slack chat integration
...
- [crispyfi ★118 ⏳1Y](https://github.com/crispymtn/crispyfi) - A local pseudo-bot that controls Spotify through Slack
...
- [Overcast ★399 ⏳1Y](https://github.com/andrewchilds/overcast) - A SSH-based cloud management CLI with Slack support
- [passport-slack ★73](https://github.com/mjpearson/passport-slack) - Slack OAuth2 strategy for Passport
...
- [slack-api ★38](https://github.com/ustice/slack-api) - a javascript wrapper for the Slack API
...
- [slack-bot-api ★858](https://github.com/mishk0/slack-bot-api) - Simple way to control your Slack Bot
...
- [slack-cli ★193](https://github.com/candrholdings/slack-cli) - A command line interface for Slack using node
- [slack-clicky ★28](https://github.com/joshfarrant/slack-clicky) - Chrome Extension that lets you share links to Slack in a single click
...
- [slack-harvest ★115](https://github.com/Neverbland/slack-harvest) - Send a daily Slack message with a list of tracked time from Harvest
...
- [slack-irc ★459](https://github.com/ekmartin/slack-irc) - Connects Slack and IRC channels by sending messages back and forth
- [slack-irc-plugin ★74 ⏳2Y](https://github.com/jimmyhillis/slack-irc-plugin) - Sync IRC with your Slack account
- [slack-jira-plugin ★205](https://github.com/gsingers/slack-jira-plugin) - Watches Slack channels for messages about JIRA and acts accordingly
...
- [slack-notify ★149](https://github.com/andrewchilds/slack-notify) - A Node.js wrapper around the Slack Webhook API
- [slack-pokemon ★315](https://github.com/rvinluan/slack-pokemon) - A bot for having Pokemon battles in Slack
- [slack-poker-bot ★1507](https://github.com/CharlieHess/slack-poker-bot) - A bot that deals Texas Hold'em games in Slack
...
- [slack-texts ★14](https://github.com/nishanths/slack-texts) - Receive SMS notifications in Slack using Twilio
...
- [slackbox ★501](https://github.com/benchmarkstudios/slackbox) - Spotify playlist collaboration through Slack
...
- [terminal-slack ★568](https://github.com/evanyeung/terminal-slack) - Terminal client for Slack
...
- [SlackMatlab ★14 ⏳2Y](https://github.com/DylanMuir/SlackMatlab) - Basic integration for Slack notifications for Matlab

### OCaml

- [slacko ★41](https://github.com/Leonidas-from-XIV/slacko) - A neat interface for Slack

### Perl

- [slack-integrations ★20 ⏳1Y](https://github.com/khera/slack-integrations) - Scripts to integrate Slack with subversion and nagios
- [slappyhour ★11 ⏳1Y](https://github.com/obra/slappyhour) - A CGI script to bridge a channel between multiple Slack instances

### PHP

- [AlfredSlackSearch ★35 ⏳3Y](https://github.com/tylerhall/AlfredSlackSearch) - Alfred.app workflow that searches your team's Slack history
...
- [CLSlackBundle ★37](https://github.com/cleentfaar/CLSlackBundle) - Symfony bundle that lets you interact with the Slack API and webhooks
...
- [Gifbot ★21 ⏳2Y](https://github.com/josephschmitt/gifbot) - GIFs for your Slack channel
- [GifBot ★75 ⏳2Y](https://github.com/gstjohn/GifBot) - Random GIF generator for your Slack channels
- [jira-slack-php ★21 ⏳1Y](https://github.com/HotAlexx/jira-slack-php) - JIRA-Slack Integration in PHP
...
- [monolog ★6197](https://github.com/Seldaek/monolog) - Sends your logs to Slack
...
- [php-slack ★123](https://github.com/Frlnc/php-slack) - A lightweight PHP implementation of Slack's API
...
- [Slack ★862](https://github.com/maknz/slack) - Laravel 4 package for sending messages to Slack
...
- [SlackAgainstHumanity ★64 ⏳1Y](https://github.com/michaeljhopkins/SlackAgainstHumanity) - A laravel 5 package for playing Cards Against Humanity in your Slack channel
...
- [Slacker ★540 ⏳1Y](https://github.com/TidalLabs/Slacker) - Simple Slack client for the CLI
...
- [django-slack ★125](https://github.com/lamby/django-slack) - Slack integration for Django, using the templating engine to generate messages
- [django-slack-oauth ★25](https://github.com/izdi/django-slack-oauth) - Slack OAuth module for Django
- [ellie-slack ★82](https://github.com/christinac/ellie-slack) - Eliza's younger, hipper, psychobabble-friendly successor as a Slackbot
- [errbot ★1322](https://github.com/errbotio/errbot) - A plugin-based chatbot designed to be easily deployable, extensible and maintainable
- [flask-slack ★71 ⏳1Y](https://github.com/VeryCB/flask-slack) - Flask extension which makes it easy to interact with Slack slash commands
...
- [limbo ★273](https://github.com/llimllib/limbo) - A simple, clean, easy-to-modify Slack chatbot
- [morgenbot ★203](https://github.com/eelzon/morgenbot) - A standup bot for Slack
- [mqttwarn ★550](https://github.com/jpmens/mqttwarn#slack) - Notify Slack from MQTT
- [openduty ★592](https://github.com/ustream/openduty) - An open source alerting and incident escalation tool
...
- [scudcloud ★1159](https://github.com/raelgc/scudcloud) - Ubuntu client for Slack
...
- [slack-emojis ★111](https://github.com/jkloo/slack-emojis) - images for custom Slack emojis
- [slack-imgur ★19 ⏳2Y](https://github.com/juanpabloaj/slack-imgur) - A random image from Imgur to Slack
- [slack-overflow ★805 ⏳1Y](https://github.com/karan/slack-overflow) - Search Stack Overflow right from within Slack
...
- [slack-workout ★534](https://github.com/brandonshin/slackbot-workout) - A fun hack that gets Slackbot to force your teammates to work out!
...
- [slackbot ★571](https://github.com/lins05/slackbot) - A chat bot for Slack
- [slackbot-python ★48 ⏳3Y](https://github.com/fsalum/slackbot-python) - A Slack.com bot in Python integrated with Amazon SQS
- [slackbridge ★15](https://github.com/ossobv/slackbridge) - Bridge Slack channels between companies
...
- [slacker ★1079](https://github.com/os/slacker) - Slack API Wrapper for Python
- [slacker-cli ★150](https://github.com/juanpabloaj/slacker-cli) - Messages to slack from the command line
- [slackfred ★199](https://github.com/fspinillo/slackfred) - Interact with Slack via Alfred
...
- [slacksocket ★57](https://github.com/vektorlab/slacksocket) - Python interface to the Slack RTM API
...
- [slackr ★121](https://github.com/hrbrmstr/slackr) - A package to send webhook API messages to Slack channels/users from R
...
- [capistrano-slack ★69 ⏳1Y](https://github.com/j-mcnally/capistrano-slack) - Send Capistrano deployment messages to Slack
- [capistrano-slack](https://github.com/nextupdate/capistrano-slack) (II) - Send Capistrano deployment messages to Slack
- [capistrano-slackify ★52](https://github.com/onthebeach/capistrano-slackify) - Send Capistrano deployment messages to Slack
...
- [dogetip-slack ★9](https://github.com/tenforwardconsulting/dogetip-slack) - Sinatra app to enable Dogecoin tipping via slack
...
- [fastlane ★16698](https://github.com/fastlane/fastlane) - iOS deployment workflow that posts notifications to Slack
...
- [omniauth-slack ★65](https://github.com/kmrshntr/omniauth-slack) - Omniauth provider for Slack
- [pagerbot ★215](https://github.com/stripe-contrib/pagerbot) - Manage Pagerduty on-call schedules from within your internal chat channels
...
- [redmine-slack ★294](https://github.com/sciyoshi/redmine-slack) - Send Redmine updates to Slack
...
- [slack-notifier ★956](https://github.com/stevenosloan/slack-notifier) - A simple wrapper for posting to Slack
...
- [slackbotsy ★78 ⏳1Y](https://github.com/rlister/slackbotsy) - Ruby bot for Slack, inspire by botsy
- [slackcat ★276](https://github.com/rlister/slackcat) - Upload files to Slack from the command-line
...
- [slackistrano ★288](https://github.com/phallstrom/slackistrano) - Send Capistrano deployment messages to Slack
...
- [rust-slack ★66](https://github.com/frostly/rust-slack) - A rust crate for sending messages to Slack via webhooks.
...
- [slack-scala-client ★93](https://github.com/gilbertw1/slack-scala-client) - A Scala Slack client for the Web and RTM API

### Shell

- [git-slack-hook ★259](https://github.com/chriseldredge/git-slack-hook) - Git receive hook to notify Slack channels
...
- [slacktee ★441](https://github.com/course-hero/slacktee) - A bash script that works like _tee_ command
...
- [zabbix-slack-alertscript ★235](https://github.com/ericoc/zabbix-slack-alertscript) - Custom Zabbix AlertScript for Slack
