...
- [Log4Slack ★49](https://github.com/jonfreeland/Log4Slack) - simple, asynchronous Slack log4net appender
...
- [Slack.Webhooks ★89](https://github.com/nerdfury/Slack.Webhooks) - Even simpler integration with Slack's Incoming / Outgoing webhooks
- [SlackAPI ★212](https://github.com/Inumedia/SlackAPI) - Full Slack API library, including WebSockets
...
- [TfsNotificationRelay ★118](https://github.com/kria/TfsNotificationRelay) - A plugin for TFS 2013 that sends notifications to Slack
...
- [clj-slack ★83](https://github.com/julienXX/clj-slack) - Use Slack REST API from Clojure
...
- [enotify-slack ★23 ⏳1Y](https://github.com/daikikohara/enotify-slack) - A tool to get event information and send it to Slack
- [gdrive2slack ★76 ⏳1Y](https://github.com/optionfactory/gdrive2slack) - Frictionless integration between Google Drive and Slack
- [go-bot ★22 ⏳1Y](https://github.com/fabioxgn/go-bot) - IRC bot written in go
- [hal ★267 ⏳1Y](https://github.com/danryan/hal) - A chat bot in Go
...
- [slackbot ★228](https://github.com/trinchan/slackbot) (II) - Framework for building slash commands for Slack
- [slackcat ★130](https://github.com/paulhammond/slackcat) - Post messages to Slack from the command line
...
- [slackrus ★54](https://github.com/johntdyer/slackrus) - Slack hook for Logrus
...
- [webhook ★2080](https://github.com/adnanh/webhook) - Easily run commands in response to HTTP webhook requests from Slack
...
- [rundeck-slack-incoming-webhook-plugin ★50 ⏳1Y](https://github.com/higanworks/rundeck-slack-incoming-webhook-plugin) - A Rundeck Plugin for Slack Incoming WebHooks
- [rundeck-slack-plugin ★30 ⏳1Y](https://github.com/bitplaces/rundeck-slack-plugin) - A Rundeck Plugin for Slack
- [simple-slack-api ★320](https://github.com/Ullink/simple-slack-api) - A Slack client library in Java
...
- [slack-webhook ★107](https://github.com/gpedro/slack-webhook) - Slack WebHook Integration for Java
- [stash2slack ★47](https://github.com/pragbits/stash2slack) - Send Stash server events as notifications to Slack
- [tcSlackBuildNotifier ★269](https://github.com/PeteGoo/tcSlackBuildNotifier) - Post TeamCity build notifications to Slack
...
- [node-slackr ★65](https://github.com/chenka/node-slackr) - A node.js library for sending messages to Slack
...
- [Overcast ★406](https://github.com/andrewchilds/overcast) - A SSH-based cloud management CLI with Slack support
- [passport-slack ★79](https://github.com/mjpearson/passport-slack) - Slack OAuth2 strategy for Passport
- [skynet ★2 ⏳2Y](https://github.com/johnhof/skynet) - A framework for slack bots
- [Send-to-Slack ★363 ⏳1Y](https://github.com/shahruz/Send-to-Slack) - A plugin for Sketch.app to share artboards to Slack
...
- [slack-api ★41](https://github.com/ustice/slack-api) - a javascript wrapper for the Slack API
...
- [slack-bot-api ★889](https://github.com/mishk0/slack-bot-api) - Simple way to control your Slack Bot
...
- [slack-cli ★216](https://github.com/candrholdings/slack-cli) - A command line interface for Slack using node
- [slack-clicky ★32](https://github.com/joshfarrant/slack-clicky) - Chrome Extension that lets you share links to Slack in a single click
- [slack-currency ★16 ⏳2Y](https://github.com/matiassingers/slack-currency) - Slash command for converting currency
- [slack-dnd ★30 ⏳3Y](https://github.com/toddself/slack-dnd) - D&D slash commands for Slack
...
- [slack-irc ★479](https://github.com/ekmartin/slack-irc) - Connects Slack and IRC channels by sending messages back and forth
...
- [slack-stuart ★91](https://github.com/gtracy/slack-stuart) - An extendable bot server for Slack
...
- [slackbox ★520](https://github.com/benchmarkstudios/slackbox) - Spotify playlist collaboration through Slack
...
- [terminal-slack ★632](https://github.com/evanyeung/terminal-slack) - Terminal client for Slack
...
- [slack-integrations ★22 ⏳1Y](https://github.com/khera/slack-integrations) - Scripts to integrate Slack with subversion and nagios
...
- [Slack ★912](https://github.com/maknz/slack) - Laravel 4 package for sending messages to Slack
...
- [django-slack-oauth ★26](https://github.com/izdi/django-slack-oauth) - Slack OAuth module for Django
...
- [mqttwarn ★587](https://github.com/jpmens/mqttwarn#slack) - Notify Slack from MQTT
- [openduty ★631](https://github.com/ustream/openduty) - An open source alerting and incident escalation tool
...
- [slack-overflow ★811 ⏳1Y](https://github.com/karan/slack-overflow) - Search Stack Overflow right from within Slack
...
- [slack-workout ★541](https://github.com/brandonshin/slackbot-workout) - A fun hack that gets Slackbot to force your teammates to work out!
...
- [slackbot ★660](https://github.com/lins05/slackbot) - A chat bot for Slack
...
- [slacker ★1165](https://github.com/os/slacker) - Slack API Wrapper for Python
- [slacker-cli ★160](https://github.com/juanpabloaj/slacker-cli) - Messages to slack from the command line
- [slackfred ★207](https://github.com/fspinillo/slackfred) - Interact with Slack via Alfred
...
- [slouch ★61 ⏳1Y](https://github.com/venmo/slouch) - Lightweight Python framework for building cli-inspired Slack bots
...
- [slackr ★141](https://github.com/hrbrmstr/slackr) - A package to send webhook API messages to Slack channels/users from R
...
- [capistrano-slackify ★57 ⏳1Y](https://github.com/onthebeach/capistrano-slackify) - Send Capistrano deployment messages to Slack
...
- [omniauth-slack ★72](https://github.com/kmrshntr/omniauth-slack) - Omniauth provider for Slack
- [pagerbot ★221](https://github.com/stripe-contrib/pagerbot) - Manage Pagerduty on-call schedules from within your internal chat channels
...
- [redmine-slack ★313](https://github.com/sciyoshi/redmine-slack) - Send Redmine updates to Slack
...
- [slack-gamebot ★90](https://github.com/dblock/slack-gamebot) - A game bot for Slack
- [slack\_notifier ★7 ⏳3Y](https://github.com/nacyot/slack_notifier) - Send notifications to Slack
- [slack-notifier ★1022](https://github.com/stevenosloan/slack-notifier) - A simple wrapper for posting to Slack
...
- [slack-ruby-bot ★33](https://github.com/dblock/slack-ruby-bot) - The easiest way to write a Slack bot in Ruby
...
- [slackcat ★287 ⏳1Y](https://github.com/rlister/slackcat) - Upload files to Slack from the command-line
...
- [slackistrano ★303](https://github.com/phallstrom/slackistrano) - Send Capistrano deployment messages to Slack
...
- [rust-slack ★70](https://github.com/frostly/rust-slack) - A rust crate for sending messages to Slack via webhooks.
...
- [slack-scala-client ★99](https://github.com/gilbertw1/slack-scala-client) - A Scala Slack client for the Web and RTM API

### Shell

- [git-slack-hook ★271](https://github.com/chriseldredge/git-slack-hook) - Git receive hook to notify Slack channels
...
- [slacktee ★477](https://github.com/course-hero/slacktee) - A bash script that works like _tee_ command
...
- [zabbix-slack-alertscript ★257](https://github.com/ericoc/zabbix-slack-alertscript) - Custom Zabbix AlertScript for Slack
