---
layout: default
title: Awesome Rank for matiassingers/awesome-slack
---
...
## Unofficial clients
- Linux - [PlaidChat ★511 ⏳1Y](https://github.com/plaidchat/plaidchat)
- Linux - [ScudCloud ★1198](https://github.com/raelgc/scudcloud)
- Windows - [SlackUI ★93](https://github.com/rfgamaral/SlackUI)
...
- [Cake.Slack ★0](https://github.com/WCOMAB/Cake.Slack) - Cake AddIn that extends Cake with Slack messaging features
- [CCNetSlackPublisher ★10 ⏳1Y](https://github.com/jrjackso/CCNetSlackPublisher) - Slack integration with CruiseControl.NET
- [Log4Slack ★54](https://github.com/jonfreeland/Log4Slack) - simple, asynchronous Slack log4net appender
...
- [mmbot ★226](https://github.com/mmbot/mmbot) - a C\# port of hubot, with Slack support
- [Slack-Contour ★1 ⏳3Y](https://github.com/warrenbuckley/Slack-Contour) - Umbraco Contour workflow item that allows you to post the form data to a Slack channel
- [Slack.Webhooks ★97](https://github.com/nerdfury/Slack.Webhooks) - Even simpler integration with Slack's Incoming / Outgoing webhooks
- [SlackAPI ★223](https://github.com/Inumedia/SlackAPI) - Full Slack API library, including WebSockets
- [SlackCommander ★19 ⏳2Y](https://github.com/Hihaj/SlackCommander) - Useful (?) slash commands and miscellaneous integrations for Slack
- [SqlServerSlackAPI ★21 ⏳1Y](https://github.com/WCOMAB/SqlServerSlackAPI) - A SQL Server CLR assembly for direct communication with Slack via TSQL
- [svn-slack-notifier ★20 ⏳1Y](https://github.com/robertmiles3/svn-slack-notifier) - A simple app to send VisualSVN Server commit notifications to Slack
- [TfsNotificationRelay ★123](https://github.com/kria/TfsNotificationRelay) - A plugin for TFS 2013 that sends notifications to Slack
- [TSJ.Gemini.Slack ★3 ⏳2Y](https://github.com/thesoftwarejedi/TSJ.Gemini.Slack) - Posts issue changes to a channel in Slack
- [WooCode.Slack ★26 ⏳3Y](https://github.com/WooCode/WooCode.Slack) - Library for slacking with Slack.com in .Net
...
- [clj-slack ★90](https://github.com/julienXX/clj-slack) - Use Slack REST API from Clojure
- [clj-slack-client ★5](https://github.com/tonyvanriet/clj-slack-client) - A Clojure client for the Slack RTM and Web APIs
- [lunch-bot ★25](https://github.com/tonyvanriet/lunch-bot) - A Slack bot that manages group lunch activities
- [markov-chainz ★2 ⏳2Y](https://github.com/sorenmacbeth/markov-chainz) - A Markov chain bot written in Clojure
- [slack-hooks ★19](https://github.com/papertrail/slack-hooks) - Papertrail's collection of webhook receivers for Slack
- [slack.clj](https://gist.github.com/mikebroberts/9604828) - Example of sending a message to Slack from Clojure
- [slacks ★1 ⏳3Y](https://github.com/pnf/slacks) - Deliver quotes to a Slack channel

### CoffeeScript

- [bugsnag-notification-plugins ★12 ⏳1Y](https://github.com/bugsnag/bugsnag-notification-plugins) - Notification plugins for Bugsnag error tracker
- [gifmatic ★14 ⏳3Y](https://github.com/adammulligan/gifmatic) - Search Giphy and send a matching image back to Slack
- [hubot-basecamp ★15 ⏳2Y](https://github.com/hubot-scripts/hubot-basecamp) - Expands Basecamp URLs in chat with more useful information
- [humors ★5 ⏳3Y](https://github.com/AugustMiller/humors) - Custom Hubot
- [jinora ★78](https://github.com/sdslabs/jinora) - Slack webhook app to create anonymous public channels
...
- [slack-node-sdk ★142](https://github.com/clonn/slack-node-sdk) - Slack Node SDK with Webhook and API support
...
- [slacker ★46](https://github.com/julienXX/slacker) - Erlang Slack REST API wrapper

### Go

- [amiando-slack ★0 ⏳3Y](https://github.com/dotconferences/amiando-slack) - Push Amiando ticket sales to Slack
- [anonymous-slack ★13 ⏳2Y](https://github.com/recursionpharma/anonymous-slack) - A service you can run on Heroku to send anonymous messages to colleagues
...
- [hal ★275 ⏳1Y](https://github.com/danryan/hal) - A chat bot in Go
...
- [phoenix ★20 ⏳3Y](https://github.com/ehazlett/phoenix) - Pluggable bot for Slack
...
- [slack-markov ★50](https://github.com/grantmd/slack-markov) - A markov chain bot for your Slack channel
...
- [slackbot ★233](https://github.com/trinchan/slackbot) (II) - Framework for building slash commands for Slack
...
- [slackrus ★58](https://github.com/johntdyer/slackrus) - Slack hook for Logrus
...
- [webhook ★2555](https://github.com/adnanh/webhook) - Easily run commands in response to HTTP webhook requests from Slack
...
- [jpgtobot ★16 ⏳2Y](https://github.com/hlian/jpegbot) - jpg.to bot for Slack
- [slack ★32](https://github.com/owainlewis/slack) - A Haskell client for the Slack web API
...
- [rundeck-slack-incoming-webhook-plugin ★55 ⏳1Y](https://github.com/higanworks/rundeck-slack-incoming-webhook-plugin) - A Rundeck Plugin for Slack Incoming WebHooks
- [rundeck-slack-plugin ★30 ⏳2Y](https://github.com/bitplaces/rundeck-slack-plugin) - A Rundeck Plugin for Slack
- [simple-slack-api ★348](https://github.com/Ullink/simple-slack-api) - A Slack client library in Java
...
- [slack-webhook ★120](https://github.com/gpedro/slack-webhook) - Slack WebHook Integration for Java
- [stash2slack ★49](https://github.com/pragbits/stash2slack) - Send Stash server events as notifications to Slack
- [tcSlackBuildNotifier ★272](https://github.com/PeteGoo/tcSlackBuildNotifier) - Post TeamCity build notifications to Slack

### JavaScript

- [bip-pod-slack ★3](https://github.com/bipio-server/bip-pod-slack) - Slack Pod for BipIO
- [bitbucket-slack-pr-hook ★63 ⏳1Y](https://github.com/lfilho/bitbucket-slack-pr-hook) - Receive Pull Request notifications from BitBucket and send them to Slack
...
- [bunyan-slack ★64](https://github.com/qualitybath/bunyan-slack) - Bunyan stream for Slack chat integration
...
- [crispyfi ★123 ⏳1Y](https://github.com/crispymtn/crispyfi) - A local pseudo-bot that controls Spotify through Slack
...
- [generator-slack-command ★8 ⏳2Y](https://github.com/matiassingers/generator-slack-command) - [Yeoman](http://yeoman.io/) generator to create a simple Slack slash command server
...
- [LOUDBOT-SLACK ★32](https://github.com/ceejbot/LOUDBOT-SLACK) - LOUDBOT FOR SLACK
- [nasa-slack](https://github.com/seanrose/nasa-slack) - a slack integration to post the nasa photo of the day
- [node-slack-cli ★24 ⏳2Y](https://github.com/juanpabloaj/node-slack-cli) - Send messages to Slack from the command line with nodejs
- [node-slack-irc ★15 ⏳2Y](https://github.com/IgorAntun/node-slack-irc) - Node.js solution to integrate IRC chats to Slack
- [node-slackbot ★25](https://github.com/rmcdaniel/node-slackbot) - Slackbot for node.js using RTM API
- [node-slackhook ★20 ⏳2Y](https://github.com/joezo/node-slackhook) - A node module for Slack custom hooks
- [node-slackr ★67](https://github.com/chenka/node-slackr) - A node.js library for sending messages to Slack
...
- [Overcast ★410](https://github.com/andrewchilds/overcast) - A SSH-based cloud management CLI with Slack support
- [passport-slack ★83](https://github.com/mjpearson/passport-slack) - Slack OAuth2 strategy for Passport
- [skynet ★2 ⏳2Y](https://github.com/johnhof/skynet) - A framework for slack bots
- [Send-to-Slack ★367 ⏳1Y](https://github.com/shahruz/Send-to-Slack) - A plugin for Sketch.app to share artboards to Slack
- [slack-alias-plugin ★15 ⏳1Y](https://github.com/gsingers/slack-alias-plugin) - Auto-expand mentions of certain aliases to their respective users
- [slack-api ★42](https://github.com/ustice/slack-api) - a javascript wrapper for the Slack API
- [slack-assembla-plugin ★3 ⏳3Y](https://github.com/Ramzi-Alqrainy/slack-assembla-plugin) - Watches Slack channels for messages about Assembla and acts accordingly
- [slack-bill-sharing ★2](https://github.com/gsellator/slack-bill-sharing) - Bill sharing bot for Slack
- [slack-bot-api ★926](https://github.com/mishk0/slack-bot-api) - Simple way to control your Slack Bot
...
- [slack-cli ★230](https://github.com/candrholdings/slack-cli) - A command line interface for Slack using node
...
- [slack-integrator ★1 ⏳2Y](https://github.com/way2-technology/slack-integrator) - Easily integrate Slack with your apps!
- [slack-invite ★13 ⏳2Y](https://github.com/wski/slack-invite) - Invite people to your awesome slack group
- [slack-irc ★492](https://github.com/ekmartin/slack-irc) - Connects Slack and IRC channels by sending messages back and forth
- [slack-irc-plugin ★75 ⏳3Y](https://github.com/jimmyhillis/slack-irc-plugin) - Sync IRC with your Slack account
- [slack-jira-plugin ★214](https://github.com/gsingers/slack-jira-plugin) - Watches Slack channels for messages about JIRA and acts accordingly
- [slack-meme ★15 ⏳2Y](https://github.com/chrismeyersfsu/slack-meme) - Slack meme integration
- [slack-middle-server ★0 ⏳3Y](https://github.com/clonn/slack-middle-server) - Intermediate webhook server for Slack
- [slack-movie ★14 ⏳2Y](https://github.com/matiassingers/slack-movie) - slack command for getting movie info
- [slack-news ★129 ⏳2Y](https://github.com/karan/slack-news) - Read news from multiple sources within Slack by just typing /news
- [slack-notify ★158](https://github.com/andrewchilds/slack-notify) - A Node.js wrapper around the Slack Webhook API
- [slack-pokemon ★325](https://github.com/rvinluan/slack-pokemon) - A bot for having Pokemon battles in Slack
- [slack-poker-bot ★1520 ⏳1Y](https://github.com/CharlieHess/slack-poker-bot) - A bot that deals Texas Hold'em games in Slack
...
- [slackapi-angularjs ★28](https://github.com/nickaranz/slackapi-angularjs) - AngularJS module wrapper for the Slack Web API
- [slackarma ★7 ⏳2Y](https://github.com/gdroel/slackarma) - Give your teammates reputation points in Slack
- [slackbot-says ★6 ⏳3Y](https://github.com/smilledge/slackbot-says) - Chrome extension to post messages to Slack as Slackbot
- [slackbotapi ★128](https://github.com/xBytez/slackbotapi) - node.js Slack RTM API module
- [slackbox ★533](https://github.com/benchmarkstudios/slackbox) - Spotify playlist collaboration through Slack
...
- [slackdraw ★9](https://github.com/caiosba/slack-draw) - A Google Chrome extension to draw and share the drawings on Slack
- [slackey ★18](https://github.com/FredKSchott/slackey) - A JavaScript SDK for the Slack API
...
- [slackus ★22](https://github.com/jonathanwiesel/slackus) - New Disqus comment notifier for Slack
...
- [swolebot ★39 ⏳2Y](https://github.com/robinpowered/swolebot) - A Slack bot for keeping your team fit through open pull requests
- [terminal-slack ★736](https://github.com/evanyeung/terminal-slack) - Terminal client for Slack
...
- [SlackMatlab ★14 ⏳3Y](https://github.com/DylanMuir/SlackMatlab) - Basic integration for Slack notifications for Matlab
...
- [slack-integrations ★24 ⏳1Y](https://github.com/khera/slack-integrations) - Scripts to integrate Slack with subversion and nagios
- [slappyhour ★12 ⏳2Y](https://github.com/obra/slappyhour) - A CGI script to bridge a channel between multiple Slack instances
...
- [CLSlackBundle ★44](https://github.com/cleentfaar/CLSlackBundle) - Symfony bundle that lets you interact with the Slack API and webhooks
...
- [GifBot ★73 ⏳2Y](https://github.com/gstjohn/GifBot) - Random GIF generator for your Slack channels
...
- [php-slack ★123 ⏳1Y](https://github.com/Frlnc/php-slack) - A lightweight PHP implementation of Slack's API
...
- [Slack ★951](https://github.com/maknz/slack) - Laravel 4 package for sending messages to Slack
- [slack-api ★27 ⏳3Y](https://github.com/10w042/slack-api) - A super simple wrapper for the Slack API
- [slack-notifier ★60 ⏳2Y](https://github.com/polem/slack-notifier) - Simple PHP wrapper for Slack notifications
...
- [SlackAgainstHumanity ★68 ⏳2Y](https://github.com/michaeljhopkins/SlackAgainstHumanity) - A laravel 5 package for playing Cards Against Humanity in your Slack channel
- [SlackBundle ★38](https://github.com/DZunke/SlackBundle) - SlackBundle for Symfony2
- [slackcamp ★63 ⏳1Y](https://github.com/jamescarlos/slackcamp) - Post Basecamp events to Slack
...
- [tourdefrance-slack-bot ★16 ⏳1Y](https://github.com/j0k3r/tourdefrance-slack-bot) - Notifies a Slack channel/group for every stage during the Tour de France 2014
- [versioneye-slack ★6 ⏳3Y](https://github.com/heyupdate/versioneye-slack) - Post VersionEye notifications to Slack
...
- [changetip-slack ★30](https://github.com/changecoin/changetip-slack) - ChangeTip Slack Tip bot
- [django-slack ★140](https://github.com/lamby/django-slack) - Slack integration for Django, using the templating engine to generate messages
- [django-slack-oauth ★29](https://github.com/izdi/django-slack-oauth) - Slack OAuth module for Django
...
- [errbot ★1589](https://github.com/errbotio/errbot) - A plugin-based chatbot designed to be easily deployable, extensible and maintainable
- [flask-slack ★79 ⏳2Y](https://github.com/VeryCB/flask-slack) - Flask extension which makes it easy to interact with Slack slash commands
- [fs-slack ★9 ⏳2Y](https://github.com/slackhappy/fs-slack) - Silly slash command synthesis for Slack
- [gmail2slack ★25 ⏳1Y](https://github.com/brooksc/gmail2slack) - Send a Slack notification whenever a new gmail arrives
- [limbo ★310](https://github.com/llimllib/limbo) - A simple, clean, easy-to-modify Slack chatbot
- [morgenbot ★210](https://github.com/eelzon/morgenbot) - A standup bot for Slack
- [mqttwarn ★616](https://github.com/jpmens/mqttwarn#slack) - Notify Slack from MQTT
- [openduty ★656](https://github.com/ustream/openduty) - An open source alerting and incident escalation tool
- [pyslack ★143](https://github.com/loisaidasam/pyslack) - Python API Wrapper
...
- [slack ★93 ⏳2Y](https://github.com/kn/slack) - A simple and comprehensive Slack API client
...
- [slack-emojis ★116](https://github.com/jkloo/slack-emojis) - images for custom Slack emojis
- [slack-imgur ★19 ⏳2Y](https://github.com/juanpabloaj/slack-imgur) - A random image from Imgur to Slack
- [slack-overflow ★818 ⏳1Y](https://github.com/karan/slack-overflow) - Search Stack Overflow right from within Slack
...
- [slack-workout ★553](https://github.com/brandonshin/slackbot-workout) - A fun hack that gets Slackbot to force your teammates to work out!
...
- [slackbot ★721](https://github.com/lins05/slackbot) - A chat bot for Slack
- [slackbot-python ★49 ⏳3Y](https://github.com/fsalum/slackbot-python) - A Slack.com bot in Python integrated with Amazon SQS
- [slackbridge ★20](https://github.com/ossobv/slackbridge) - Bridge Slack channels between companies
...
- [slacker ★1233](https://github.com/os/slacker) - Slack API Wrapper for Python
- [slacker-cli ★163](https://github.com/juanpabloaj/slacker-cli) - Messages to slack from the command line
- [slackfred ★218](https://github.com/fspinillo/slackfred) - Interact with Slack via Alfred
- [slackotron ★13 ⏳1Y](https://github.com/lettier/slackotron) - A Slack bot customizable via plugins
- [slackpy ★18 ⏳1Y](https://github.com/iktakahiro/slackpy) - Slack client library for specific logging
- [slacksocket ★59](https://github.com/vektorlab/slacksocket) - Python interface to the Slack RTM API
- [slouch ★65](https://github.com/venmo/slouch) - Lightweight Python framework for building cli-inspired Slack bots
...
- [sublime-slack-integration ★73](https://github.com/simion/sublime-slack-integration) - Post to Slack from Sublime Text 3
- [tracslack](https://github.com/grexi/snippets/tree/master/tracslack) - Trac notifications for Slack
- [webhook-bridge ★7 ⏳3Y](https://github.com/calvingiles/webhook-bridge) - micro-service to convert webhook POST formats including Slack
- [wee-slack](https://github.com/rawdigits/wee-slack) - A WeeChat plugin for Slack

### R

- [slackr ★168](https://github.com/hrbrmstr/slackr) - A package to send webhook API messages to Slack channels/users from R
...
- [capistrano-slack ★69](https://github.com/j-mcnally/capistrano-slack) - Send Capistrano deployment messages to Slack
- [capistrano-slack](https://github.com/nextupdate/capistrano-slack) (II) - Send Capistrano deployment messages to Slack
- [capistrano-slackify ★58 ⏳1Y](https://github.com/onthebeach/capistrano-slackify) - Send Capistrano deployment messages to Slack
...
- [omniauth-slack ★76](https://github.com/kmrshntr/omniauth-slack) - Omniauth provider for Slack
- [pagerbot ★226](https://github.com/stripe-contrib/pagerbot) - Manage Pagerduty on-call schedules from within your internal chat channels
...
- [redmine-slack ★329](https://github.com/sciyoshi/redmine-slack) - Send Redmine updates to Slack
...
- [slack-gamebot ★97](https://github.com/dblock/slack-gamebot) - A game bot for Slack
- [slack\_notifier ★7 ⏳4Y](https://github.com/nacyot/slack_notifier) - Send notifications to Slack
- [slack-notifier ★1089](https://github.com/stevenosloan/slack-notifier) - A simple wrapper for posting to Slack
...
- [slack-post ★31](https://github.com/CozyCo/slack-post) - Post messages to Slack
- [slack-poster ★42](https://github.com/rikas/slack-poster) - Simple gem to post messages on Slack using webhooks
...
- [slack-ruby-bot ★35](https://github.com/dblock/slack-ruby-bot) - The easiest way to write a Slack bot in Ruby
- [slack-ruby-client ★14](https://github.com/dblock/slack-ruby-client) - A Ruby client for the Slack Web and RealTime Messaging APIs
...
- [slack-timezone-converter ★38](https://github.com/caiosba/slack-timezone-converter) - Converts any time string in a message to all timezones where the team is
- [slackbot ★12 ⏳4Y](https://github.com/typekit/slackbot) - The laziest bot around
...
- [slackbotsy ★79](https://github.com/rlister/slackbotsy) - Ruby bot for Slack, inspire by botsy
- [slackcat ★300 ⏳1Y](https://github.com/rlister/slackcat) - Upload files to Slack from the command-line
...
- [slacker ★25 ⏳2Y](https://github.com/ttaylorr/slacker) - A collection of scripts for making Slack a little better
- [slackfire ★6 ⏳3Y](https://github.com/RokkinCat/slackfire) - Send real time events from Firebase to Slack
- [slackistrano ★317](https://github.com/phallstrom/slackistrano) - Send Capistrano deployment messages to Slack
...
- [snarkov ★24](https://github.com/gesteves/snarkov) - Sinatra-based Markov bot for Slack
- [spoilerbot ★1 ⏳1Y](https://github.com/austra/spoilerbot) - Displays a random card from the latest Magic: The Gathering set
...
- [trebekbot ★135](https://github.com/gesteves/trebekbot) - A Jeopardy! bot for Slack
- [vip-notify ★5 ⏳2Y](https://github.com/doejo/vip-notify) - Send VIP deployment notifications to Slack
- [slack-webistrano ★5 ⏳3Y](https://github.com/caiosba/slack-webistrano) - Send Webistrano deploys to Slack
- [yobot ★6 ⏳3Y](https://github.com/voxmedia/yobot) - YOs a Slack channel of your choice

### Rust

- [rust-slack ★73](https://github.com/frostly/rust-slack) - A rust crate for sending messages to Slack via webhooks.

### Scala

- [scala-slack ★11](https://github.com/flyberry-capital/scala-slack) - A Slack client for Scala
- [sslack ★32 ⏳3Y](https://github.com/webpay/sslack) - Search Slack by ElasticSearch
- [slack-scala-client ★117](https://github.com/gilbertw1/slack-scala-client) - A Scala Slack client for the Web and RTM API

### Shell

- [git-slack-hook ★276](https://github.com/chriseldredge/git-slack-hook) - Git receive hook to notify Slack channels
...
- [slack ★98 ⏳1Y](https://github.com/rcrowley/slack) - Runs the test suite of a Ruby On Rails application and post the results to Slack
...
- [slacktee ★521](https://github.com/course-hero/slacktee) - A bash script that works like _tee_ command
...
- [zabbix-slack-alertscript ★279](https://github.com/ericoc/zabbix-slack-alertscript) - Custom Zabbix AlertScript for Slack
