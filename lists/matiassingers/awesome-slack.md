...
## Lists
- [awesome-open-slack ★16](https://github.com/tyshgc/awesome-open-slack) - repository of Slack open team list
...
- [Cake.Slack ★11](https://github.com/WCOMAB/Cake.Slack) - Cake AddIn that extends Cake with Slack messaging features
- [CCNetSlackPublisher ★10 ⏳1Y](https://github.com/jrjackso/CCNetSlackPublisher) - Slack integration with CruiseControl.NET
- [Log4Slack ★47](https://github.com/jonfreeland/Log4Slack) - simple, asynchronous Slack log4net appender
...
- [mmbot ★222](https://github.com/mmbot/mmbot) - a C\# port of hubot, with Slack support
...
- [Slack.Webhooks ★88](https://github.com/nerdfury/Slack.Webhooks) - Even simpler integration with Slack's Incoming / Outgoing webhooks
- [SlackAPI ★193](https://github.com/Inumedia/SlackAPI) - Full Slack API library, including WebSockets
...
- [SqlServerSlackAPI ★20 ⏳1Y](https://github.com/WCOMAB/SqlServerSlackAPI) - A SQL Server CLR assembly for direct communication with Slack via TSQL
- [svn-slack-notifier ★17 ⏳1Y](https://github.com/robertmiles3/svn-slack-notifier) - A simple app to send VisualSVN Server commit notifications to Slack
- [TfsNotificationRelay ★114](https://github.com/kria/TfsNotificationRelay) - A plugin for TFS 2013 that sends notifications to Slack
- [TSJ.Gemini.Slack ★3 ⏳2Y](https://github.com/thesoftwarejedi/TSJ.Gemini.Slack) - Posts issue changes to a channel in Slack
- [WooCode.Slack ★24 ⏳3Y](https://github.com/WooCode/WooCode.Slack) - Library for slacking with Slack.com in .Net
...
- [clj-slack ★80](https://github.com/julienXX/clj-slack) - Use Slack REST API from Clojure
...
- [slack-node-sdk ★130](https://github.com/clonn/slack-node-sdk) - Slack Node SDK with Webhook and API support
...
- [hal ★264 ⏳1Y](https://github.com/danryan/hal) - A chat bot in Go
...
- [slackbot ★226](https://github.com/trinchan/slackbot) (II) - Framework for building slash commands for Slack
- [slackcat ★129](https://github.com/paulhammond/slackcat) - Post messages to Slack from the command line
- [slacker-news ★3 ⏳1Y](https://github.com/munrocape/slacker-news) - Slack integration that reports current news items
- [slackline ★192 ⏳1Y](https://github.com/ernesto-jimenez/slackline) - Create a Slack channel shared by two organizations
...
- [rundeck-slack-incoming-webhook-plugin ★48 ⏳1Y](https://github.com/higanworks/rundeck-slack-incoming-webhook-plugin) - A Rundeck Plugin for Slack Incoming WebHooks
- [rundeck-slack-plugin ★29 ⏳1Y](https://github.com/bitplaces/rundeck-slack-plugin) - A Rundeck Plugin for Slack
- [simple-slack-api ★302](https://github.com/Ullink/simple-slack-api) - A Slack client library in Java
...
- [slack-webhook ★103](https://github.com/gpedro/slack-webhook) - Slack WebHook Integration for Java
- [stash2slack ★47](https://github.com/pragbits/stash2slack) - Send Stash server events as notifications to Slack
- [tcSlackBuildNotifier ★265](https://github.com/PeteGoo/tcSlackBuildNotifier) - Post TeamCity build notifications to Slack
...
- [bunyan-slack ★61](https://github.com/qualitybath/bunyan-slack) - Bunyan stream for Slack chat integration
...
- [crispyfi ★119 ⏳1Y](https://github.com/crispymtn/crispyfi) - A local pseudo-bot that controls Spotify through Slack
...
- [Overcast ★401](https://github.com/andrewchilds/overcast) - A SSH-based cloud management CLI with Slack support
- [passport-slack ★75](https://github.com/mjpearson/passport-slack) - Slack OAuth2 strategy for Passport
- [skynet ★2 ⏳2Y](https://github.com/johnhof/skynet) - A framework for slack bots
- [Send-to-Slack ★360 ⏳1Y](https://github.com/shahruz/Send-to-Slack) - A plugin for Sketch.app to share artboards to Slack
...
- [slack-bot-api ★875](https://github.com/mishk0/slack-bot-api) - Simple way to control your Slack Bot
...
- [slack-cli ★201](https://github.com/candrholdings/slack-cli) - A command line interface for Slack using node
...
- [slack-irc ★468](https://github.com/ekmartin/slack-irc) - Connects Slack and IRC channels by sending messages back and forth
- [slack-irc-plugin ★75 ⏳2Y](https://github.com/jimmyhillis/slack-irc-plugin) - Sync IRC with your Slack account
- [slack-jira-plugin ★206](https://github.com/gsingers/slack-jira-plugin) - Watches Slack channels for messages about JIRA and acts accordingly
...
- [slack-notify ★151](https://github.com/andrewchilds/slack-notify) - A Node.js wrapper around the Slack Webhook API
- [slack-pokemon ★317](https://github.com/rvinluan/slack-pokemon) - A bot for having Pokemon battles in Slack
...
- [slack-pongbot ★81 ⏳1Y](https://github.com/andrewvy/slack-pongbot) - Slack bot for ping pong tracking
...
- [slack-stuart ★90](https://github.com/gtracy/slack-stuart) - An extendable bot server for Slack
- [slack-tableflip ★18 ⏳2Y](https://github.com/josheverett/slack-tableflip) - A tableflip slash command
- [slack-texts ★16](https://github.com/nishanths/slack-texts) - Receive SMS notifications in Slack using Twilio
...
- [slackbox ★510](https://github.com/benchmarkstudios/slackbox) - Spotify playlist collaboration through Slack
...
- [terminal-slack ★586](https://github.com/evanyeung/terminal-slack) - Terminal client for Slack
...
- [slack-integrations ★21 ⏳1Y](https://github.com/khera/slack-integrations) - Scripts to integrate Slack with subversion and nagios
...
- [php-slack-error-reporter ★6 ⏳2Y](https://github.com/tailored-tunes/php-slack-error-reporter) - Library to report errors to slack.
- [pslackr ★7 ⏳2Y](https://github.com/fullybaked/pslackr) - Library for sending messages from your app to Slack
...
- [Slacker ★549 ⏳1Y](https://github.com/TidalLabs/Slacker) - Simple Slack client for the CLI
...
- [slackuntappd ★17 ⏳2Y](https://github.com/gregavola/slackuntappd) - A webhook that allows you to search for beer information within Slack via Untappd
...
- [tourdefrance-slack-bot ★17 ⏳1Y](https://github.com/j0k3r/tourdefrance-slack-bot) - Notifies a Slack channel/group for every stage during the Tour de France 2014
...
- [django-slack ★129](https://github.com/lamby/django-slack) - Slack integration for Django, using the templating engine to generate messages
- [django-slack-oauth ★25](https://github.com/izdi/django-slack-oauth) - Slack OAuth module for Django
- [ellie-slack ★83 ⏳1Y](https://github.com/christinac/ellie-slack) - Eliza's younger, hipper, psychobabble-friendly successor as a Slackbot
- [errbot ★1377](https://github.com/errbotio/errbot) - A plugin-based chatbot designed to be easily deployable, extensible and maintainable
- [flask-slack ★72 ⏳1Y](https://github.com/VeryCB/flask-slack) - Flask extension which makes it easy to interact with Slack slash commands
...
- [limbo ★284](https://github.com/llimllib/limbo) - A simple, clean, easy-to-modify Slack chatbot
- [morgenbot ★206](https://github.com/eelzon/morgenbot) - A standup bot for Slack
- [mqttwarn ★569](https://github.com/jpmens/mqttwarn#slack) - Notify Slack from MQTT
- [openduty ★611](https://github.com/ustream/openduty) - An open source alerting and incident escalation tool
...
- [slack-emojis ★112](https://github.com/jkloo/slack-emojis) - images for custom Slack emojis
- [slack-imgur ★19 ⏳2Y](https://github.com/juanpabloaj/slack-imgur) - A random image from Imgur to Slack
- [slack-overflow ★810 ⏳1Y](https://github.com/karan/slack-overflow) - Search Stack Overflow right from within Slack
...
- [slack-workout ★537](https://github.com/brandonshin/slackbot-workout) - A fun hack that gets Slackbot to force your teammates to work out!
...
- [slackbot ★611](https://github.com/lins05/slackbot) - A chat bot for Slack
...
- [slacker ★1101](https://github.com/os/slacker) - Slack API Wrapper for Python
- [slacker-cli ★155](https://github.com/juanpabloaj/slacker-cli) - Messages to slack from the command line
...
- [slackr ★131](https://github.com/hrbrmstr/slackr) - A package to send webhook API messages to Slack channels/users from R
...
- [capistrano-slackify ★54 ⏳1Y](https://github.com/onthebeach/capistrano-slackify) - Send Capistrano deployment messages to Slack
...
- [omniauth-slack ★68](https://github.com/kmrshntr/omniauth-slack) - Omniauth provider for Slack
- [pagerbot ★216](https://github.com/stripe-contrib/pagerbot) - Manage Pagerduty on-call schedules from within your internal chat channels
...
- [redmine-slack ★299](https://github.com/sciyoshi/redmine-slack) - Send Redmine updates to Slack
...
- [slackbot ★11 ⏳3Y](https://github.com/typekit/slackbot) - The laziest bot around
...
- [rust-slack ★67](https://github.com/frostly/rust-slack) - A rust crate for sending messages to Slack via webhooks.
...
- [git-slack-hook ★266](https://github.com/chriseldredge/git-slack-hook) - Git receive hook to notify Slack channels
...
- [slacktee ★453](https://github.com/course-hero/slacktee) - A bash script that works like _tee_ command
...
- [zabbix-slack-alertscript ★243](https://github.com/ericoc/zabbix-slack-alertscript) - Custom Zabbix AlertScript for Slack
