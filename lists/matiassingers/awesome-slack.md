...
- [mmbot ★227](https://github.com/mmbot/mmbot) - a C\# port of hubot, with Slack support
...
- [Slack.Webhooks ★96](https://github.com/nerdfury/Slack.Webhooks) - Even simpler integration with Slack's Incoming / Outgoing webhooks
- [SlackAPI ★218](https://github.com/Inumedia/SlackAPI) - Full Slack API library, including WebSockets
...
- [TfsNotificationRelay ★122](https://github.com/kria/TfsNotificationRelay) - A plugin for TFS 2013 that sends notifications to Slack
- [TSJ.Gemini.Slack ★3 ⏳2Y](https://github.com/thesoftwarejedi/TSJ.Gemini.Slack) - Posts issue changes to a channel in Slack
- [WooCode.Slack ★27 ⏳3Y](https://github.com/WooCode/WooCode.Slack) - Library for slacking with Slack.com in .Net
...
- [clj-slack ★87](https://github.com/julienXX/clj-slack) - Use Slack REST API from Clojure
- [clj-slack-client ★5 ⏳1Y](https://github.com/tonyvanriet/clj-slack-client) - A Clojure client for the Slack RTM and Web APIs
- [lunch-bot ★25 ⏳1Y](https://github.com/tonyvanriet/lunch-bot) - A Slack bot that manages group lunch activities
...
- [jinora ★77](https://github.com/sdslabs/jinora) - Slack webhook app to create anonymous public channels
...
- [slack-node-sdk ★138](https://github.com/clonn/slack-node-sdk) - Slack Node SDK with Webhook and API support
...
- [slackrus ★57](https://github.com/johntdyer/slackrus) - Slack hook for Logrus
...
- [webhook ★2478](https://github.com/adnanh/webhook) - Easily run commands in response to HTTP webhook requests from Slack
- [worktile-events-to-slack ★12 ⏳2Y](https://github.com/cybertk/worktile-events-to-slack) - Forward Worktile events to Slack
...
- [hi5bot ★18 ⏳2Y](https://github.com/hlian/hi5bot) - Get and give high-fives on Slack
- [jpgtobot ★17 ⏳2Y](https://github.com/hlian/jpegbot) - jpg.to bot for Slack
- [slack ★33](https://github.com/owainlewis/slack) - A Haskell client for the Slack web API
...
- [rundeck-slack-incoming-webhook-plugin ★53 ⏳1Y](https://github.com/higanworks/rundeck-slack-incoming-webhook-plugin) - A Rundeck Plugin for Slack Incoming WebHooks
- [rundeck-slack-plugin ★30 ⏳2Y](https://github.com/bitplaces/rundeck-slack-plugin) - A Rundeck Plugin for Slack
- [simple-slack-api ★335](https://github.com/Ullink/simple-slack-api) - A Slack client library in Java
...
- [slack-webhook ★114](https://github.com/gpedro/slack-webhook) - Slack WebHook Integration for Java
- [stash2slack ★49](https://github.com/pragbits/stash2slack) - Send Stash server events as notifications to Slack
- [tcSlackBuildNotifier ★271](https://github.com/PeteGoo/tcSlackBuildNotifier) - Post TeamCity build notifications to Slack
...
- [node-slackr ★66](https://github.com/chenka/node-slackr) - A node.js library for sending messages to Slack
...
- [Overcast ★409](https://github.com/andrewchilds/overcast) - A SSH-based cloud management CLI with Slack support
- [passport-slack ★81](https://github.com/mjpearson/passport-slack) - Slack OAuth2 strategy for Passport
- [skynet ★2 ⏳2Y](https://github.com/johnhof/skynet) - A framework for slack bots
- [Send-to-Slack ★368 ⏳1Y](https://github.com/shahruz/Send-to-Slack) - A plugin for Sketch.app to share artboards to Slack
...
- [slack-invite ★12 ⏳2Y](https://github.com/wski/slack-invite) - Invite people to your awesome slack group
- [slack-irc ★486](https://github.com/ekmartin/slack-irc) - Connects Slack and IRC channels by sending messages back and forth
...
- [slack-meme ★14 ⏳2Y](https://github.com/chrismeyersfsu/slack-meme) - Slack meme integration
...
- [slackbox ★529](https://github.com/benchmarkstudios/slackbox) - Spotify playlist collaboration through Slack
...
- [Slack ★936](https://github.com/maknz/slack) - Laravel 4 package for sending messages to Slack
...
- [morgenbot ★211](https://github.com/eelzon/morgenbot) - A standup bot for Slack
- [mqttwarn ★607](https://github.com/jpmens/mqttwarn#slack) - Notify Slack from MQTT
- [openduty ★651](https://github.com/ustream/openduty) - An open source alerting and incident escalation tool
...
- [slack-emojis ★117](https://github.com/jkloo/slack-emojis) - images for custom Slack emojis
...
- [slack-workout ★550](https://github.com/brandonshin/slackbot-workout) - A fun hack that gets Slackbot to force your teammates to work out!
...
- [slackbot ★703](https://github.com/lins05/slackbot) - A chat bot for Slack
- [slackbot-python ★49 ⏳3Y](https://github.com/fsalum/slackbot-python) - A Slack.com bot in Python integrated with Amazon SQS
- [slackbridge ★18](https://github.com/ossobv/slackbridge) - Bridge Slack channels between companies
...
- [slacker ★1213](https://github.com/os/slacker) - Slack API Wrapper for Python
- [slacker-cli ★162](https://github.com/juanpabloaj/slacker-cli) - Messages to slack from the command line
- [slackfred ★217](https://github.com/fspinillo/slackfred) - Interact with Slack via Alfred
...
- [slackr ★161](https://github.com/hrbrmstr/slackr) - A package to send webhook API messages to Slack channels/users from R
...
- [omniauth-slack ★75](https://github.com/kmrshntr/omniauth-slack) - Omniauth provider for Slack
- [pagerbot ★225](https://github.com/stripe-contrib/pagerbot) - Manage Pagerduty on-call schedules from within your internal chat channels
...
- [slack-ruby-bot ★34](https://github.com/dblock/slack-ruby-bot) - The easiest way to write a Slack bot in Ruby
...
- [slackcat ★299 ⏳1Y](https://github.com/rlister/slackcat) - Upload files to Slack from the command-line
...
- [slackistrano ★314](https://github.com/phallstrom/slackistrano) - Send Capistrano deployment messages to Slack
...
- [rust-slack ★72](https://github.com/frostly/rust-slack) - A rust crate for sending messages to Slack via webhooks.
...
- [slack-scala-client ★112](https://github.com/gilbertw1/slack-scala-client) - A Scala Slack client for the Web and RTM API

### Shell

- [git-slack-hook ★274 ⏳1Y](https://github.com/chriseldredge/git-slack-hook) - Git receive hook to notify Slack channels
...
- [slacktee ★509](https://github.com/course-hero/slacktee) - A bash script that works like _tee_ command
...
- [zabbix-slack-alertscript ★271](https://github.com/ericoc/zabbix-slack-alertscript) - Custom Zabbix AlertScript for Slack
