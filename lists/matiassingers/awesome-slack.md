...
- [Log4Slack ★51](https://github.com/jonfreeland/Log4Slack) - simple, asynchronous Slack log4net appender
...
- [Slack.Webhooks ★93](https://github.com/nerdfury/Slack.Webhooks) - Even simpler integration with Slack's Incoming / Outgoing webhooks
- [SlackAPI ★216](https://github.com/Inumedia/SlackAPI) - Full Slack API library, including WebSockets
...
- [svn-slack-notifier ★19 ⏳1Y](https://github.com/robertmiles3/svn-slack-notifier) - A simple app to send VisualSVN Server commit notifications to Slack
- [TfsNotificationRelay ★121](https://github.com/kria/TfsNotificationRelay) - A plugin for TFS 2013 that sends notifications to Slack
...
- [clj-slack-client ★4 ⏳1Y](https://github.com/tonyvanriet/clj-slack-client) - A Clojure client for the Slack RTM and Web APIs
- [lunch-bot ★24 ⏳1Y](https://github.com/tonyvanriet/lunch-bot) - A Slack bot that manages group lunch activities
...
- [jinora ★75](https://github.com/sdslabs/jinora) - Slack webhook app to create anonymous public channels
...
- [slack-node-sdk ★137 ⏳1Y](https://github.com/clonn/slack-node-sdk) - Slack Node SDK with Webhook and API support
...
- [slacker ★45](https://github.com/julienXX/slacker) - Erlang Slack REST API wrapper

### Go

- [amiando-slack ★0 ⏳3Y](https://github.com/dotconferences/amiando-slack) - Push Amiando ticket sales to Slack
- [anonymous-slack ★13 ⏳1Y](https://github.com/recursionpharma/anonymous-slack) - A service you can run on Heroku to send anonymous messages to colleagues
...
- [webhook ★2147](https://github.com/adnanh/webhook) - Easily run commands in response to HTTP webhook requests from Slack
...
- [slack-webhook ★110](https://github.com/gpedro/slack-webhook) - Slack WebHook Integration for Java
- [stash2slack ★47](https://github.com/pragbits/stash2slack) - Send Stash server events as notifications to Slack
...
- [bitbucket-slack-pr-hook ★61 ⏳1Y](https://github.com/lfilho/bitbucket-slack-pr-hook) - Receive Pull Request notifications from BitBucket and send them to Slack
...
- [Overcast ★407](https://github.com/andrewchilds/overcast) - A SSH-based cloud management CLI with Slack support
- [passport-slack ★82](https://github.com/mjpearson/passport-slack) - Slack OAuth2 strategy for Passport
- [skynet ★2 ⏳2Y](https://github.com/johnhof/skynet) - A framework for slack bots
- [Send-to-Slack ★364 ⏳1Y](https://github.com/shahruz/Send-to-Slack) - A plugin for Sketch.app to share artboards to Slack
...
- [slack-bot-api ★900](https://github.com/mishk0/slack-bot-api) - Simple way to control your Slack Bot
...
- [slack-cli ★224](https://github.com/candrholdings/slack-cli) - A command line interface for Slack using node
- [slack-clicky ★33](https://github.com/joshfarrant/slack-clicky) - Chrome Extension that lets you share links to Slack in a single click
- [slack-currency ★16 ⏳2Y](https://github.com/matiassingers/slack-currency) - Slash command for converting currency
- [slack-dnd ★31 ⏳3Y](https://github.com/toddself/slack-dnd) - D&D slash commands for Slack
...
- [slack-news ★127 ⏳2Y](https://github.com/karan/slack-news) - Read news from multiple sources within Slack by just typing /news
...
- [slack-poker-bot ★1518](https://github.com/CharlieHess/slack-poker-bot) - A bot that deals Texas Hold'em games in Slack
...
- [slack-proxy ★10 ⏳3Y](https://github.com/phamann/slack-proxy) - Simple proxy between AWS SQS queue and Slack
...
- [slack-stuart ★92](https://github.com/gtracy/slack-stuart) - An extendable bot server for Slack
...
- [slackbotapi ★127](https://github.com/xBytez/slackbotapi) - node.js Slack RTM API module
...
- [slacklink ★20 ⏳1Y](https://github.com/robjmills/slacklink) - Post links to Slack from Chrome
...
- [slackus ★20](https://github.com/jonathanwiesel/slackus) - New Disqus comment notifier for Slack
...
- [terminal-slack ★664](https://github.com/evanyeung/terminal-slack) - Terminal client for Slack
...
- [slack-integrations ★23 ⏳1Y](https://github.com/khera/slack-integrations) - Scripts to integrate Slack with subversion and nagios
...
- [Slack ★920](https://github.com/maknz/slack) - Laravel 4 package for sending messages to Slack
...
- [django-slack ★138](https://github.com/lamby/django-slack) - Slack integration for Django, using the templating engine to generate messages
...
- [errbot ★1516](https://github.com/errbotio/errbot) - A plugin-based chatbot designed to be easily deployable, extensible and maintainable
...
- [gmail2slack ★23](https://github.com/brooksc/gmail2slack) - Send a Slack notification whenever a new gmail arrives
- [limbo ★302](https://github.com/llimllib/limbo) - A simple, clean, easy-to-modify Slack chatbot
- [morgenbot ★208](https://github.com/eelzon/morgenbot) - A standup bot for Slack
- [mqttwarn ★597](https://github.com/jpmens/mqttwarn#slack) - Notify Slack from MQTT
- [openduty ★638](https://github.com/ustream/openduty) - An open source alerting and incident escalation tool
...
- [slack-emojis ★114](https://github.com/jkloo/slack-emojis) - images for custom Slack emojis
- [slack-imgur ★19 ⏳2Y](https://github.com/juanpabloaj/slack-imgur) - A random image from Imgur to Slack
- [slack-overflow ★814 ⏳1Y](https://github.com/karan/slack-overflow) - Search Stack Overflow right from within Slack
...
- [slacker ★1197](https://github.com/os/slacker) - Slack API Wrapper for Python
- [slacker-cli ★162](https://github.com/juanpabloaj/slacker-cli) - Messages to slack from the command line
- [slackfred ★212](https://github.com/fspinillo/slackfred) - Interact with Slack via Alfred
- [slackotron ★11 ⏳1Y](https://github.com/lettier/slackotron) - A Slack bot customizable via plugins
- [slackpy ★18](https://github.com/iktakahiro/slackpy) - Slack client library for specific logging
- [slacksocket ★60](https://github.com/vektorlab/slacksocket) - Python interface to the Slack RTM API
...
- [sublime-slack-integration ★72](https://github.com/simion/sublime-slack-integration) - Post to Slack from Sublime Text 3
- [tracslack](https://github.com/grexi/snippets/tree/master/tracslack) - Trac notifications for Slack
- [webhook-bridge ★6 ⏳3Y](https://github.com/calvingiles/webhook-bridge) - micro-service to convert webhook POST formats including Slack
- [wee-slack](https://github.com/rawdigits/wee-slack) - A WeeChat plugin for Slack

### R

- [slackr ★155](https://github.com/hrbrmstr/slackr) - A package to send webhook API messages to Slack channels/users from R
...
- [omniauth-slack ★73](https://github.com/kmrshntr/omniauth-slack) - Omniauth provider for Slack
- [pagerbot ★223](https://github.com/stripe-contrib/pagerbot) - Manage Pagerduty on-call schedules from within your internal chat channels
...
- [redmine-slack ★319](https://github.com/sciyoshi/redmine-slack) - Send Redmine updates to Slack
...
- [slack-gamebot ★91](https://github.com/dblock/slack-gamebot) - A game bot for Slack
- [slack\_notifier ★7 ⏳3Y](https://github.com/nacyot/slack_notifier) - Send notifications to Slack
- [slack-notifier ★1046](https://github.com/stevenosloan/slack-notifier) - A simple wrapper for posting to Slack
...
- [slackcat ★294 ⏳1Y](https://github.com/rlister/slackcat) - Upload files to Slack from the command-line
...
- [slackistrano ★309](https://github.com/phallstrom/slackistrano) - Send Capistrano deployment messages to Slack
...
- [rust-slack ★71](https://github.com/frostly/rust-slack) - A rust crate for sending messages to Slack via webhooks.

### Scala

- [scala-slack ★10](https://github.com/flyberry-capital/scala-slack) - A Slack client for Scala
- [sslack ★32 ⏳3Y](https://github.com/webpay/sslack) - Search Slack by ElasticSearch
- [slack-scala-client ★103](https://github.com/gilbertw1/slack-scala-client) - A Scala Slack client for the Web and RTM API
...
- [slacktee ★490](https://github.com/course-hero/slacktee) - A bash script that works like _tee_ command
...
- [zabbix-slack-alertscript ★266](https://github.com/ericoc/zabbix-slack-alertscript) - Custom Zabbix AlertScript for Slack
