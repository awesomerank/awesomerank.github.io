...
---
# awesome-slack [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★63835](https://github.com/sindresorhus/awesome)
...
- Linux - [ScudCloud ★1171](https://github.com/raelgc/scudcloud)
...
- [Log4Slack ★48](https://github.com/jonfreeland/Log4Slack) - simple, asynchronous Slack log4net appender
...
- [mmbot ★223](https://github.com/mmbot/mmbot) - a C\# port of hubot, with Slack support
...
- [SlackAPI ★198](https://github.com/Inumedia/SlackAPI) - Full Slack API library, including WebSockets
...
- [gdrive2slack ★75 ⏳1Y](https://github.com/optionfactory/gdrive2slack) - Frictionless integration between Google Drive and Slack
- [go-bot ★22 ⏳1Y](https://github.com/fabioxgn/go-bot) - IRC bot written in go
- [hal ★266 ⏳1Y](https://github.com/danryan/hal) - A chat bot in Go
...
- [slackline ★194 ⏳1Y](https://github.com/ernesto-jimenez/slackline) - Create a Slack channel shared by two organizations
...
- [simple-slack-api ★307](https://github.com/Ullink/simple-slack-api) - A Slack client library in Java
...
- [slack-webhook ★105](https://github.com/gpedro/slack-webhook) - Slack WebHook Integration for Java
...
- [crispyfi ★120 ⏳1Y](https://github.com/crispymtn/crispyfi) - A local pseudo-bot that controls Spotify through Slack
...
- [passport-slack ★77](https://github.com/mjpearson/passport-slack) - Slack OAuth2 strategy for Passport
...
- [slack-api ★40](https://github.com/ustice/slack-api) - a javascript wrapper for the Slack API
...
- [slack-bot-api ★879](https://github.com/mishk0/slack-bot-api) - Simple way to control your Slack Bot
...
- [slack-cli ★210](https://github.com/candrholdings/slack-cli) - A command line interface for Slack using node
...
- [slack-irc ★471](https://github.com/ekmartin/slack-irc) - Connects Slack and IRC channels by sending messages back and forth
- [slack-irc-plugin ★75 ⏳2Y](https://github.com/jimmyhillis/slack-irc-plugin) - Sync IRC with your Slack account
- [slack-jira-plugin ★208](https://github.com/gsingers/slack-jira-plugin) - Watches Slack channels for messages about JIRA and acts accordingly
...
- [slack-notify ★152](https://github.com/andrewchilds/slack-notify) - A Node.js wrapper around the Slack Webhook API
- [slack-pokemon ★316](https://github.com/rvinluan/slack-pokemon) - A bot for having Pokemon battles in Slack
...
- [slackbox ★513](https://github.com/benchmarkstudios/slackbox) - Spotify playlist collaboration through Slack
...
- [terminal-slack ★595](https://github.com/evanyeung/terminal-slack) - Terminal client for Slack
...
- [django-slack ★133](https://github.com/lamby/django-slack) - Slack integration for Django, using the templating engine to generate messages
...
- [errbot ★1402](https://github.com/errbotio/errbot) - A plugin-based chatbot designed to be easily deployable, extensible and maintainable
...
- [limbo ★287](https://github.com/llimllib/limbo) - A simple, clean, easy-to-modify Slack chatbot
- [morgenbot ★206](https://github.com/eelzon/morgenbot) - A standup bot for Slack
- [mqttwarn ★576](https://github.com/jpmens/mqttwarn#slack) - Notify Slack from MQTT
- [openduty ★616](https://github.com/ustream/openduty) - An open source alerting and incident escalation tool
...
- [scudcloud ★1171](https://github.com/raelgc/scudcloud) - Ubuntu client for Slack
- [sscaas ★40](https://github.com/danielsamuels/sscaas) - Slack Slash Commands as a Service
- [slack ★89 ⏳1Y](https://github.com/kn/slack) - A simple and comprehensive Slack API client
...
- [slack-overflow ★812 ⏳1Y](https://github.com/karan/slack-overflow) - Search Stack Overflow right from within Slack
...
- [slackbot ★623](https://github.com/lins05/slackbot) - A chat bot for Slack
...
- [slacker ★1121](https://github.com/os/slacker) - Slack API Wrapper for Python
- [slacker-cli ★157](https://github.com/juanpabloaj/slacker-cli) - Messages to slack from the command line
...
- [slackr ★137](https://github.com/hrbrmstr/slackr) - A package to send webhook API messages to Slack channels/users from R
...
- [capistrano-slackify ★55 ⏳1Y](https://github.com/onthebeach/capistrano-slackify) - Send Capistrano deployment messages to Slack
...
- [omniauth-slack ★69](https://github.com/kmrshntr/omniauth-slack) - Omniauth provider for Slack
- [pagerbot ★218](https://github.com/stripe-contrib/pagerbot) - Manage Pagerduty on-call schedules from within your internal chat channels
...
- [redmine-slack ★304](https://github.com/sciyoshi/redmine-slack) - Send Redmine updates to Slack
...
- [slack-gamebot ★89](https://github.com/dblock/slack-gamebot) - A game bot for Slack
- [slack\_notifier ★7 ⏳3Y](https://github.com/nacyot/slack_notifier) - Send notifications to Slack
- [slack-notifier ★1005](https://github.com/stevenosloan/slack-notifier) - A simple wrapper for posting to Slack
...
- [slack-scala-client ★94](https://github.com/gilbertw1/slack-scala-client) - A Scala Slack client for the Web and RTM API

### Shell

- [git-slack-hook ★267](https://github.com/chriseldredge/git-slack-hook) - Git receive hook to notify Slack channels
...
- [slack ★96 ⏳1Y](https://github.com/rcrowley/slack) - Runs the test suite of a Ruby On Rails application and post the results to Slack
