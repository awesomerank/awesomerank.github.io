...
* [Genie ★907](https://github.com/Netflix/genie) - Genie provides REST-ful APIs to run Hadoop, Hive and Pig jobs, and to manage multiple Hadoop resources and perform job submissions across them.
...
* [Crunch ★164 ⏳3Y](https://github.com/jondot/crunch) - Go-based toolkit for ETL and feature extraction on Hadoop
...
* [mpich2-yarn ★95](https://github.com/alibaba/mpich2-yarn) - Running MPICH2 on Yarn
...
* [Confluent Schema registry for Kafka ★667](https://github.com/confluentinc/schema-registry) - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
* [Hortonworks Schema Registry ★77](https://github.com/hortonworks/registry) - Schema Registry is a framework to build metadata repositories.
...
* [Apache AirFlow ★8345](https://github.com/apache/incubator-airflow) - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
* [Suro ★675 ⏳2Y](https://github.com/Netflix/suro) - Netflix's distributed Data Pipeline
...
* [vahara ★52 ⏳4Y](https://github.com/thedatachef/varaha) - Machine learning and natural language processing with Apache Pig
* [packetpig ★296](https://github.com/packetloop/packetpig) - Open Source Big Data Security Analytics
* [akela ★80 ⏳4Y](https://github.com/mozilla-metrics/akela) - Mozilla's utility library for Hadoop, HBase, Pig, etc.
...
* [Lipstick ★423](https://github.com/Netflix/Lipstick) - Pig workflow visualization tool. [Introducing Lipstick on A(pache) Pig](http://techblog.netflix.com/2013/06/introducing-lipstick-on-apache-pig.html)
* [PigPen ★481 ⏳1Y](https://github.com/Netflix/PigPen) - PigPen is map-reduce for Clojure, or distributed Clojure. It compiles to Apache Pig, but you don't need to know much about Pig to use it.

## Libraries and Tools

* [Kite Software Development Kit](http://kitesdk.org/) - A set of libraries, tools, examples, and documentation
* [gohadoop ★287](https://github.com/hortonworks/gohadoop) - Native go clients for Apache Hadoop YARN.
...
* [Elephant Bird ★1061](https://github.com/twitter/elephant-bird) - Twitter's collection of LZO and Protocol Buffer-related Hadoop, Pig, Hive, and HBase code.
* [Spring for Apache Hadoop](http://projects.spring.io/spring-hadoop/)
* [hdfs - A native go client for HDFS ★481](https://github.com/colinmarc/hdfs)
...
* [Schema Registry UI ★187](https://github.com/Landoop/schema-registry-ui) - Web tool for the Confluent Schema Registry in order to create / view / search / evolve / view history & configure Avro schemas of your Kafka cluster.
...
* [Buildoop ★30 ⏳2Y](https://github.com/keedio/buildoop) - Hadoop Ecosystem Builder
...
* [inviso ★165 ⏳1Y](https://github.com/Netflix/inviso) - Inviso is a lightweight tool that provides the ability to search for Hadoop jobs, visualize the performance, and view cluster utilization.
...
* [Banana ★531](https://github.com/LucidWorks/banana) - Kibana port for Apache Solr
...
* [Project Rhino ★90 ⏳3Y](https://github.com/intel-hadoop/project-rhino) - Intel's open source effort to enhance the existing data protection capabilities of the Hadoop ecosystem to address security and compliance challenges, and contribute the code back to Apache.

## Benchmark

* [Big Data Benchmark](https://amplab.cs.berkeley.edu/benchmark/)
* [HiBench ★674](https://github.com/intel-hadoop/HiBench)
* [Big-Bench ★80](https://github.com/intel-hadoop/Big-Data-Benchmark-for-Big-Bench)
* [hive-benchmarks ★3 ⏳4Y](https://github.com/yhuai/hive-benchmarks)
* [hive-testbench ★54](https://github.com/cartershanklin/hive-testbench) - Testbench for experimenting with Apache Hive at any data scale.
* [YCSB ★2054](https://github.com/brianfrankcooper/YCSB) - The Yahoo! Cloud Serving Benchmark (YCSB) is an open-source specification and program suite for evaluating retrieval and maintenance capabilities of computer programs. It is often used to compare relative performance of NoSQL database management systems.

## Machine learning and Big Data analytics

* [Apache Mahout](http://mahout.apache.org)
* [Oryx 2 ★1437](https://github.com/OryxProject/oryx) - Lambda architecture on Spark, Kafka for real-time large scale machine learning
 ...
 * Libraries and tools
     ...
     * [shib ★162 ⏳1Y](https://github.com/tagomoris/shib) - WebUI for query engines: Hive and Presto
     * [clive ★4 ⏳6Y](https://github.com/bmuller/clive) - Clojure library for interacting with Hive via Thrift
     ...
     * [HiveRunner ★116](https://github.com/klarna/HiveRunner) - An Open Source unit test framework for hadoop hive queries based on JUnit4
     * [Beetest ★62 ⏳1Y](https://github.com/kawaa/Beetest) - A super simple utility for testing Apache Hive scripts locally for non-Java developers.
     * [Hive_test ★66 ⏳1Y](https://github.com/edwardcapriolo/hive_test)- Unit test framework for hive and hive-service
* Flume Plugins
  * [Flume MongoDB Sink ★55 ⏳1Y](https://github.com/leonlee/flume-ng-mongodb-sink)
  * [Flume HornetQ Channel ★0 ⏳5Y](https://github.com/btoddb/flume-ng-hornetq-channel)
  * [Flume MessagePack Source ★0 ⏳5Y](https://github.com/leonlee/flume-ng-msgpack-source)
  * [Flume RabbitMQ source and sink ★55 ⏳1Y](https://github.com/jcustenborder/flume-ng-rabbitmq)
  * [Flume UDP Source ★8 ⏳4Y](https://github.com/whitepages/flume-udp-source)
