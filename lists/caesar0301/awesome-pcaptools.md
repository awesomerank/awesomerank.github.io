...
* [Moloch ★2323](https://github.com/aol/moloch): Moloch is a open source large scale full PCAP capturing, indexing and database system.
...
* [CapTipper ★483](https://github.com/omriher/CapTipper): Malicious HTTP traffic explorer

* [Chopshop ★315](https://github.com/MITRECND/chopshop): is a MITRE developed framework to aid analysts in the creation and execution of pynids based decoders and detectors of APT tradecraft.
...
* [HttpSniffer ★93 ⏳2Y](https://github.com/caesar0301/http-sniffer): A multi-threading tool to sniff TCP flow statistics and embedded HTTP headers from PCAP file. Each TCP flow carrying HTTP is exported to text file in JSON format.
...
* [scalpel ★172](https://github.com/sleuthkit/scalpel): Scalpel is an open source data carving tool.
