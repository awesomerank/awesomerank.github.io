...
---
# Awesome REST [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★73813](https://github.com/sindresorhus/awesome)
...
* [HTTP API design guide extracted from work on the Heroku Platform API ★12615 ⏳1Y](https://github.com/interagent/http-api-design)
...
* [API-Security-Checklist ★10177](https://github.com/shieldfy/API-Security-Checklist) - Best practices about REST API security
...
* [Buzz ★1396](https://github.com/kriswallsmith/buzz) - Another lightweight HTTP client.
* [unirest for PHP](https://github.com/Mashape/unirest-php) - Simplified, lightweight HTTP client library.

### JavaScript Clients

* [restangular ★8190](https://github.com/mgonto/restangular) - AngularJS service to handle REST API properly and easily.
* [restful.js ★895](https://github.com/marmelab/restful.js) - JS client for interacting with server-side RESTful resources.
 ...
 * [restler ★1956](https://github.com/danwrong/restler) - REST client library for node.js.
...
* [postgrest ★10165](https://github.com/begriffs/postgrest) - Serve a fully RESTful API directly from an existing PostgreSQL database.
...
* [node-restify ★7655](https://github.com/restify/node-restify) - Framework specifically meant for REST API.
...
* [Baucis ★637](https://github.com/wprl/baucis) - Build scalable REST API based on your Mongoose entities.
* [flatiron/resourceful ★359 ⏳3Y](https://github.com/flatiron/resourceful) - Isomorphic Resource engine for JavaScript.
...
* [Expressa ★206](https://github.com/thomas4019/expressa) - Express middleware for creating APIs from JSON schemas with a simple admin editor and permissions model.
...
* [Negotiation ★414](https://github.com/willdurand/Negotiation) - Content negotiation library.
* [Drest ★83](https://github.com/leedavis81/drest) - Library for exposing Doctrine entities as REST resource endpoints.
* [Restler ★1226](https://github.com/Luracast/Restler) - Lightweight framework to expose PHP methods as RESTful web API.
* [HAL ★189](https://github.com/blongden/hal) - Hypertext Application Language (HAL) builder library.
* [Apigility ★464](https://github.com/zfcampus/zf-apigility-skeleton) - API builder built with Zend Framework 2.
* [phprest ★315 ⏳1Y](https://github.com/phprest/phprest) - Specialized REST microframework for PHP.
* [Hateoas ★777](https://github.com/willdurand/Hateoas) - PHP library to support implementing representations for HATEOAS REST web services.
* [Fusio ★349](https://github.com/apioo/fusio) - Open source API management platform.
...
* [FOSRestBundle ★1649](https://github.com/FriendsOfSymfony/FOSRestBundle) - Bundle handling view, routing, error handling, etc. for your REST API.
...
* [BazingaHateoasBundle](https://github.com/willdurand/BazingaHateoasBundle) - Integrate the [Hateoas ★777](https://github.com/willdurand/Hateoas) library into a Symfony2 application.
...
* [API Platform ★2238](https://github.com/api-platform/api-platform) - Specialize Symfony edition for the creation of hypermedia REST APIs.
* [NelmioApiDocBundle ★1369](https://github.com/nelmio/NelmioApiDocBundle) - Generate documentation for your REST API from annotations.
...
* [go-json-rest ★3009](https://github.com/ant0ine/go-json-rest) - Thin layer on top of `net/http` that helps building RESTful APIs easily.
...
* [go-restful ★2486](https://github.com/emicklei/go-restful) - A declarative highly readable framework for building restful API's.
...
* [RestExpress ★803](https://github.com/RestExpress/RestExpress) - Netty-based, highly performant, lightweight, container-less, plugin-extensible, framework that is ideal for microservice architectures.
...
### Haskell
* [Rest for Haskell ★374](https://github.com/silkapp/rest) - This package allows you to create REST APIs in Haskell. These APIs can be run in different web frameworks. They can also be used to automatically generate documentation as well as client libraries.
...
* [resty ★2244](https://github.com/micha/resty) - Little command line REST client that you can use in pipelines (bash or zsh).
* [jq ★10332](https://github.com/stedolan/jq) - Command line JSON processor, to use in combination with a command-line HTTP client like cURL.
...
* [rest-assured ★2691](https://github.com/rest-assured/rest-assured) - Java DSL for easy testing of REST services.
...
* [FakeRest ★241](https://github.com/marmelab/FakeRest) - Patch XMLHttpRequest to fake a REST API client-side.
* [json-server ★27964](https://github.com/typicode/json-server) - Serve a REST API from fixture files using quick prototyping.
* [Mocky.io](http://www.mocky.io/) - Free online service to create fake HTTP responses.
* [Swagger API Mock ★18 ⏳2Y](https://github.com/bulkismaslom/swagger-api-mock) - Mock RESTful API based on swagger schema
...
* [raml2html ★897](https://github.com/raml2html/raml2html) - Generates HTML documentation from a RAML file.
* [ReDoc ★1934](https://github.com/Rebilly/ReDoc) - OpenAPI/Swagger-powered three-panel documentation.
...
* [ng-admin ★3805](https://github.com/marmelab/ng-admin) - Add an AngularJS admin GUI to any RESTful API.
* [admin-on-rest ★3348](https://github.com/marmelab/admin-on-rest) - Add a ReactJS admin GUI to any RESTful API.
* [swagger-codegen ★5870](https://github.com/swagger-api/swagger-codegen) - Auto generation of client libraries or server stubs given an OpenAPI specification (formerly known as the Swagger Specification).
* [Lumber ★1536](https://github.com/ForestAdmin/lumber) - Generate the admin interface of your application.
