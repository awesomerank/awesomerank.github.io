...
* [C# ★51](https://github.com/influxdata/influxdb-csharp) - A .NET library for efficiently sending points to InfluxDB
...
* [Java ★347](https://github.com/influxdata/influxdb-java) - Java client for InfluxDB
* [PHP ★140](https://github.com/influxdata/influxdb-php) - PHP client for InfluxDB
* [Python ★602](https://github.com/influxdata/influxdb-python) - Python client for InfluxDB
* [Rails ★83](https://github.com/influxdata/influxdb-rails) - Ruby on Rails bindings to automatically write metrics into InfluxDB
* [Ruby ★247](https://github.com/influxdata/influxdb-ruby) - Ruby client for InfluxDB
...
* [fluxter ★51](https://github.com/lexmag/fluxter) - An InfluxDB writer for Elixir
...
* [InfluxDB.NET ★89](https://github.com/ziyasal/InfluxDB.Net) - .NET client for InfluxDB
* [InfluxDB PHP SDK ★74](https://github.com/corley/influxdb-php-sdk) - UDP/IP or HTTP adapters for read and write data
* [influxdbr ★32](https://github.com/dleutnant/influxdbr) - R library for InfluxDB
* [instream ★83](https://github.com/mneudert/instream) - InfluxDB driver for Elixir
* [node-influx ★428](https://github.com/node-influx/node-influx) - InfluxDB Node.js Client
* [node-influx-udp ★13](https://github.com/mediocre/node-influx-udp) - Write to InfluxDB using its UDP interface
* [scala-influxdb-client ★60](https://github.com/paulgoldbaum/scala-influxdb-client) - Asynchronous InfluxDB client for Scala
...
* [influxdb-sqlserver ★29](https://github.com/zensqlmonitor/influxdb-sqlserver) - Collect Microsoft SQL Server metrics for reporting to InfluxDB and visualize them with Grafana
* [k6 ★2924](https://github.com/loadimpact/k6) - A modern load testing tool, using Go and JavaScript
...
* [mqforward ★36](https://github.com/shirou/mqforward) - [MQTT](http://mqtt.org/) to influxdb forwarder
...
* [Telegraf ★3341](https://github.com/influxdata/telegraf) - (Official) plugin-driven server agent for reporting metrics into InfluxDB
...
* [vsphere-influxdb-go ★49](https://github.com/Oxalide/vsphere-influxdb-go) - Collect VMware vSphere, vCenter and ESXi performance metrics and send them to InfluxDB
...
* [cernan ★150](https://github.com/postmates/cernan) - A telemetry and logging aggregation server
...
* [Riemann ★3330](https://github.com/riemann/riemann) - A network event stream processing system, in Clojure
* [statsd-jvm-profiler ★239](https://github.com/etsy/statsd-jvm-profiler) - Simple JVM Profiler Using StatsD
* [statsite ★1540](https://github.com/statsite/statsite) - C implementation of statsd
...
* [embulk-output-influxdb](https://github.com/joker1007/embulk-output-influxdb) - InfluxDB output plugin for [Embulk ★913](https://github.com/embulk/embulk)
...
* [kafka-influxdb ★109](https://github.com/mre/kafka-influxdb) - A [Kafka](https://kafka.apache.org/) consumer for InfluxDB written in Python
...
* [metrics-influxdb ★185](https://github.com/davidB/metrics-influxdb) - A reporter for [dropwizard](http://www.dropwizard.io/0.9.1/docs/) metrics which announces measurements to an InfluxDB server
...
* [Chronograf ★338](https://github.com/influxdata/chronograf) - Official InfluxDB data visualization tool
* [facette ★909](https://github.com/facette/facette) - Time series data visualization and graphing software
* [FluxDash ★18 ⏳1Y](https://github.com/vrecan/FluxDash) - Terminal based InfluxDB dashboard
* [grafana ★17057](https://github.com/grafana/grafana) - Gorgeous metric viz, dashboards & editors for Graphite, InfluxDB & OpenTSDB
* [InfluxGraph ★41](https://github.com/InfluxGraph/influxgraph) - Graphite InfluxDB storage finder for Graphite-API
...
* [Morgoth ★180](https://github.com/nathanielc/morgoth) - Metric anomaly detection
...
* [awesome-bigdata ★4971](https://github.com/onurakpolat/awesome-bigdata)
