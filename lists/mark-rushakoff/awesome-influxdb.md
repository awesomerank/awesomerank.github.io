...
* [C# ★47](https://github.com/influxdata/influxdb-csharp) - A .NET library for efficiently sending points to InfluxDB
...
* [Java ★323](https://github.com/influxdata/influxdb-java) - Java client for InfluxDB
* [PHP ★138](https://github.com/influxdata/influxdb-php) - PHP client for InfluxDB
* [Python ★582](https://github.com/influxdata/influxdb-python) - Python client for InfluxDB
* [Rails ★81](https://github.com/influxdata/influxdb-rails) - Ruby on Rails bindings to automatically write metrics into InfluxDB
* [Ruby ★238](https://github.com/influxdata/influxdb-ruby) - Ruby client for InfluxDB
...
* [fluxter ★49](https://github.com/lexmag/fluxter) - An InfluxDB writer for Elixir
...
* [InfluxDB.NET ★87](https://github.com/ziyasal/InfluxDB.Net) - .NET client for InfluxDB
* [InfluxDB PHP SDK ★71](https://github.com/corley/influxdb-php-sdk) - UDP/IP or HTTP adapters for read and write data
* [influxdbr ★31](https://github.com/dleutnant/influxdbr) - R library for InfluxDB
* [instream ★80](https://github.com/mneudert/instream) - InfluxDB driver for Elixir
* [node-influx ★412](https://github.com/node-influx/node-influx) - InfluxDB Node.js Client
...
* [influxdb-sqlserver ★27](https://github.com/zensqlmonitor/influxdb-sqlserver) - Collect Microsoft SQL Server metrics for reporting to InfluxDB and visualize them with Grafana
* [k6 ★2882](https://github.com/loadimpact/k6) - A modern load testing tool, using Go and JavaScript
...
* [mesos-influxdb-collector ★14 ⏳1Y](https://github.com/kpacha/mesos-influxdb-collector) - Lightweight [mesos](https://mesos.apache.org/) stats collector for InfluxDB
* [mqforward ★34](https://github.com/shirou/mqforward) - [MQTT](http://mqtt.org/) to influxdb forwarder
...
* [Telegraf ★3175](https://github.com/influxdata/telegraf) - (Official) plugin-driven server agent for reporting metrics into InfluxDB
...
* [vsphere-influxdb-go ★44](https://github.com/Oxalide/vsphere-influxdb-go) - Collect VMware vSphere, vCenter and ESXi performance metrics and send them to InfluxDB

#### Non-dedicated

Tools that generate data that feed into multiple backends, InfluxDB included.

* [cAdvisor ★5841](https://github.com/google/cadvisor) - Analyzes resource usage and performance characteristics of running containers
* [cernan ★144](https://github.com/postmates/cernan) - A telemetry and logging aggregation server
* [cloudwatch-sender ★48 ⏳1Y](https://github.com/BBC-News/cloudwatch-sender) - Send metrics to InfluxDB/Graphite from [Amazon Cloudwatch](https://aws.amazon.com/cloudwatch/)
* [crankshaftd](https://github.com/fullcontact/crankshaftd) - Simple Go agent to ingest streaming data from [Turbine ★538](https://github.com/Netflix/Turbine) via SSE and push it into StatsD as a gauge or to InfluxDB
* [gatling ★3048](https://github.com/gatling/gatling) - Async Scala-Akka-Netty based Stress Tool
* [Glances ★7565](https://github.com/nicolargo/glances) - Glances an Eye on your system
* [Graphios ★260](https://github.com/shawn-sterling/graphios) - A program to send nagios perf data to graphite (carbon) / statsd / librato / influxDB
* [heapster ★1276](https://github.com/kubernetes/heapster) - Monitor container resource usage of a [Kubernetes](https://kubernetes.io/) cluster
* [heka ★3268](https://github.com/mozilla-services/heka) - General purpose data collection and processing tool
...
* [jmxtrans ★1179](https://github.com/jmxtrans/jmxtrans) - Effectively the missing connector between speaking to a JVM via JMX on one end and whatever logging / monitoring / graphing package that you can dream up on the other end.
* [logary ★277](https://github.com/logary/logary) - High performance, multi-target logging, metric and health-check library for mono and .Net
* [metrics.sh ★45](https://github.com/pstadler/metrics.sh) - Collect and forward metrics using portable shell scripts
* [OpenHAB](http://www.openhab.org/) - a universal integration platform for all things around home automation
* [Riemann ★3308](https://github.com/riemann/riemann) - A network event stream processing system, in Clojure
* [statsd-jvm-profiler ★237](https://github.com/etsy/statsd-jvm-profiler) - Simple JVM Profiler Using StatsD
* [statsite ★1522](https://github.com/statsite/statsite) - C implementation of statsd
...
* [go-runtime-metrics ★137](https://github.com/tevjef/go-runtime-metrics) - Collect golang runtime Metrics, outputting to InfluxDB or through Telegraf
* [lua-resty-influx ★4](https://github.com/p0pr0ck5/lua-resty-influx) - [OpenResty](https://openresty.org/en/) client for InfluxDB
* [metrics ★198](https://github.com/beberlei/metrics) - (PHP) Simple library that abstracts different metrics collectors. "I find this necessary to have a consistent and simple metrics (functional) API that doesn't cause vendor lock-in"
...
* [go-metrics-influxdb](https://github.com/vrischmann/go-metrics-influxdb) - A reporter for the [go-metrics library ★1611](https://github.com/rcrowley/go-metrics) which will post the metrics to InfluxDB
* [logrus_influxdb](https://github.com/Abramovic/logrus_influxdb) - InfluxDB Hook for [Logrus ★4997](https://github.com/Sirupsen/logrus)

### Plugins

Plugins to allow other standalone tools to send their data into InfluxDB.

* [embulk-output-influxdb](https://github.com/joker1007/embulk-output-influxdb) - InfluxDB output plugin for [Embulk ★897](https://github.com/embulk/embulk)
* [exometer_influxdb](https://github.com/travelping/exometer_influxdb) - [Exometer ★396](https://github.com/Feuerlabs/exometer) reporter for InfluxDB
...
* [influx-nagios-plugin ★29 ⏳1Y](https://github.com/shaharke/influx-nagios-plugin) - [Nagios](https://www.nagios.org/) plugin for querying monitoring stats from InfluxDB
...
* [kafka-influxdb ★107](https://github.com/mre/kafka-influxdb) - A [Kafka](https://kafka.apache.org/) consumer for InfluxDB written in Python
...
* [metrics-influxdb ★182](https://github.com/davidB/metrics-influxdb) - A reporter for [dropwizard](http://www.dropwizard.io/0.9.1/docs/) metrics which announces measurements to an InfluxDB server
...
* [nmon2influxdb ★29](https://github.com/adejoux/nmon2influxdb) - Import [nmon](http://nmon.sourceforge.net/pmwiki.php) file into InfluxDB

## Consuming data from InfluxDB

### Dashboards and visualization

* [Chronograf ★305](https://github.com/influxdata/chronograf) - Official InfluxDB data visualization tool
* [facette ★903](https://github.com/facette/facette) - Time series data visualization and graphing software
* [FluxDash ★18 ⏳1Y](https://github.com/vrecan/FluxDash) - Terminal based InfluxDB dashboard
* [grafana ★16626](https://github.com/grafana/grafana) - Gorgeous metric viz, dashboards & editors for Graphite, InfluxDB & OpenTSDB
* [InfluxGraph ★37](https://github.com/InfluxGraph/influxgraph) - Graphite InfluxDB storage finder for Graphite-API
...
* [Morgoth ★176](https://github.com/nathanielc/morgoth) - Metric anomaly detection
...
* [tutum-docker-influxdb ★237](https://github.com/tutumcloud/influxdb) - Docker image to run an out-of-the-box InfluxDB server
...
* [influxer ★62](https://github.com/palkan/influxer) - InfluxDB ActiveRecord-style

## Miscellaneous

Projects that don't seem to fit in any other category.

* [influx-protector ★7](https://github.com/ve-interactive/influx-protector) - proxy to prevent dangerous queries getting to influxdb

## Other awesome lists

### Awesome lists that include links to InfluxDB

* [awesome-bigdata ★4845](https://github.com/onurakpolat/awesome-bigdata)
* [awesome-dashboard ★393](https://github.com/obazoud/awesome-dashboard)
* [awesome-data-engineering ★1002](https://github.com/igorbarinov/awesome-data-engineering)
* [awesome-db ★432](https://github.com/numetriclabz/awesome-db)
* [awesome-go ★21726](https://github.com/avelino/awesome-go)
* [awesome-sysadmin ★15461](https://github.com/kahun/awesome-sysadmin)
