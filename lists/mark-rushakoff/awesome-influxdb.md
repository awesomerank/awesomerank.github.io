...
* [C# ★55](https://github.com/influxdata/influxdb-csharp) - A .NET library for efficiently sending points to InfluxDB
...
* [Java ★371](https://github.com/influxdata/influxdb-java) - Java client for InfluxDB
* [PHP ★149](https://github.com/influxdata/influxdb-php) - PHP client for InfluxDB
* [Python ★639](https://github.com/influxdata/influxdb-python) - Python client for InfluxDB
* [Rails ★85](https://github.com/influxdata/influxdb-rails) - Ruby on Rails bindings to automatically write metrics into InfluxDB
* [Ruby ★251](https://github.com/influxdata/influxdb-ruby) - Ruby client for InfluxDB
...
* [erflux ★18](https://github.com/gossiperl/erflux) - InfluxDB client for Erlang
...
* [InfluxDB-Client-LabVIEW ★1 ⏳2Y](https://github.com/johanvandenbroek/InfluxDB-Client-LabVIEW) - LabVIEW client for InfluxDB
* [influxdb-haskell ★36](https://github.com/maoe/influxdb-haskell) - Haskell client library for InfluxDB
* [InfluxDB.NET ★93](https://github.com/ziyasal/InfluxDB.Net) - .NET client for InfluxDB
* [InfluxDB PHP SDK ★75](https://github.com/corley/influxdb-php-sdk) - UDP/IP or HTTP adapters for read and write data
...
* [node-influx ★451](https://github.com/node-influx/node-influx) - InfluxDB Node.js Client
* [node-influx-udp ★13](https://github.com/mediocre/node-influx-udp) - Write to InfluxDB using its UDP interface
* [scala-influxdb-client ★63](https://github.com/paulgoldbaum/scala-influxdb-client) - Asynchronous InfluxDB client for Scala
...
* [grade ★8](https://github.com/influxdata/grade) - Track Go benchmark performance over time by storing results in InfluxDB
...
* [influxdb-sqlserver ★31](https://github.com/zensqlmonitor/influxdb-sqlserver) - Collect Microsoft SQL Server metrics for reporting to InfluxDB and visualize them with Grafana
* [k6 ★3033](https://github.com/loadimpact/k6) - A modern load testing tool, using Go and JavaScript
...
* [Telegraf ★3637](https://github.com/influxdata/telegraf) - (Official) plugin-driven server agent for reporting metrics into InfluxDB
...
* [django-influxdb-metrics ★54](https://github.com/bitlabstudio/django-influxdb-metrics) - A reusable Django app that sends metrics about your project to InfluxDB
...
* [metrics ★211](https://github.com/beberlei/metrics) - (PHP) Simple library that abstracts different metrics collectors. "I find this necessary to have a consistent and simple metrics (functional) API that doesn't cause vendor lock-in"
...
* [go-metrics-influxdb](https://github.com/vrischmann/go-metrics-influxdb) - A reporter for the [go-metrics library ★1692](https://github.com/rcrowley/go-metrics) which will post the metrics to InfluxDB
* [logrus_influxdb](https://github.com/Abramovic/logrus_influxdb) - InfluxDB Hook for [Logrus ★5618](https://github.com/Sirupsen/logrus)
...
* [metrics-influxdb ★188](https://github.com/davidB/metrics-influxdb) - A reporter for [dropwizard](http://www.dropwizard.io/0.9.1/docs/) metrics which announces measurements to an InfluxDB server
...
* [nmon2influxdb ★34](https://github.com/adejoux/nmon2influxdb) - Import [nmon](http://nmon.sourceforge.net/pmwiki.php) file into InfluxDB

## Consuming data from InfluxDB

### Dashboards and visualization

* [Chronograf ★390](https://github.com/influxdata/chronograf) - Official InfluxDB data visualization tool
* [facette ★923](https://github.com/facette/facette) - Time series data visualization and graphing software
* [FluxDash ★20 ⏳1Y](https://github.com/vrecan/FluxDash) - Terminal based InfluxDB dashboard
* [grafana ★17937](https://github.com/grafana/grafana) - Gorgeous metric viz, dashboards & editors for Graphite, InfluxDB & OpenTSDB
* [InfluxGraph ★46](https://github.com/InfluxGraph/influxgraph) - Graphite InfluxDB storage finder for Graphite-API
...
* [InfluxDB Studio ★37](https://github.com/CymaticLabs/InfluxDBStudio) - InfluxDB Studio is a UI management tool, its inspiration comes from other similar SQL database management tools (use InfluxData.Net run on MS Windows)
...
* [Morgoth ★191](https://github.com/nathanielc/morgoth) - Metric anomaly detection
...
* [rossmcdonald/influxdb ★17](https://github.com/rossmcdonald/influxdb) - Ansible role for installing, configuring, and maintaining InfluxDB
