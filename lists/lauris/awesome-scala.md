...
* [Scio ★647](https://github.com/spotify/scio) - A Scala API for [Apache Beam](https://beam.apache.org/) and [Google Cloud Dataflow](https://cloud.google.com/dataflow/) - None
...
* [Each ★ 146 ⧗ 0](https://github.com/ThoughtWorksInc/each) - A macro library that converts native imperative syntax to [Scalaz ★3186](https://github.com/scalaz/scalaz)'s monadic expressions.
...
* [pprint ★16](https://github.com/lihaoyi/pprint) - Pretty-printer for Scala values and types for easier reading and debugging
...
* [Simple Scala Config ★ 43 ⧗ 5](https://github.com/ElderResearch/ssc) - Thin, idiomatic Scala wrapper around [Typesafe Config ★2944](https://github.com/typesafehub/config) with custom `Reader[T]` suppport.
...
* [Akka HTTP ★ 306 ⧗ 1](https://github.com/akka/akka-http) - The Streaming-first HTTP server/module of [Akka ★7504](https://github.com/akka/akka).
* [Dispatch ★ 366 ⧗ 6](https://github.com/dispatch/reboot) - Library for asynchronous HTTP interaction. It provides a Scala vocabulary for Java’s [async-http-client ★3875](https://github.com/AsyncHttpClient/async-http-client).
* **[Finch.io ★ 1005 ⧗ 3](https://github.com/finagle/finch)** - Purely Functional REST API atop of [Finagle ★5885](https://github.com/twitter/finagle).
* [Fintrospect ★ 37 ⧗ 0](http://fintrospect.io) - Implement fast, type-safe HTTP webservices for [Finagle ★5885](https://github.com/twitter/finagle).
...
* [sbt-cppp ★ 4 ⧗ 272](https://github.com/Atry/sbt-cppp) - A sbt plugin to support [Protocol Buffers ★19431](https://github.com/google/protobuf), especially in multi-project builds.
...
* [sbt](http://www.scala-sbt.org/) ([repo ★3204](https://github.com/sbt/sbt)) - The interactive build tool for Scala
