...
* [Casbah](http://mongodb.github.io/casbah/) ([repo ★524](https://github.com/mongodb/casbah)) - Officially supported Scala driver for MongoDB
...
* [Scio ★549](https://github.com/spotify/scio) - A Scala API for [Apache Beam](https://beam.apache.org/) and [Google Cloud Dataflow](https://cloud.google.com/dataflow/) - None
...
* [Each ★ 146 ⧗ 0](https://github.com/ThoughtWorksInc/each) - A macro library that converts native imperative syntax to [Scalaz ★3090](https://github.com/scalaz/scalaz)'s monadic expressions.
...
* [Rapture](http://rapture.io/) ([repo ★171](https://github.com/propensive/rapture)) - a collection of libraries for common, everyday programming tasks (I/O, JSON, i18n, etc.)
...
* [pprint ★4](https://github.com/lihaoyi/pprint) - Pretty-printer for Scala values and types for easier reading and debugging
...
* [Simple Scala Config ★ 43 ⧗ 5](https://github.com/ElderResearch/ssc) - Thin, idiomatic Scala wrapper around [Typesafe Config ★2780](https://github.com/typesafehub/config) with custom `Reader[T]` suppport.
...
* [Akka HTTP ★ 306 ⧗ 1](https://github.com/akka/akka-http) - The Streaming-first HTTP server/module of [Akka ★7162](https://github.com/akka/akka).
* [Dispatch ★ 366 ⧗ 6](https://github.com/dispatch/reboot) - Library for asynchronous HTTP interaction. It provides a Scala vocabulary for Java’s [async-http-client ★3704](https://github.com/AsyncHttpClient/async-http-client).
* **[Finch.io ★ 1005 ⧗ 3](https://github.com/finagle/finch)** - Purely Functional REST API atop of [Finagle ★5721](https://github.com/twitter/finagle).
* [Fintrospect ★ 37 ⧗ 0](http://fintrospect.io) - Implement fast, type-safe HTTP webservices for [Finagle ★5721](https://github.com/twitter/finagle).
...
* [sbt-cppp ★ 4 ⧗ 272](https://github.com/Atry/sbt-cppp) - A sbt plugin to support [Protocol Buffers ★17605](https://github.com/google/protobuf), especially in multi-project builds.
...
* [Scala.js](http://www.scala-js.org/) ([repo ★2952](https://github.com/scala-js/scala-js)) - Scala to JavaScript compiler
...
* [sbt](http://www.scala-sbt.org/) ([repo ★3065](https://github.com/sbt/sbt)) - The interactive build tool for Scala
...
* [Scaps](http://scala-search.org/) ([repo ★24 ⏳1Y](https://github.com/scala-search/scaps)) - A search engine for Scala libraries
