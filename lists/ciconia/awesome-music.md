...
* [audio.js ★1828](https://github.com/kolber/audiojs) - audio.js is a drop-in javascript library that allows HTML5's &lt;audio&gt; tag to be used anywhere.
* [howler.js ★8975](https://github.com/goldfire/howler.js) - a Javascript audio library for the modern web.
* [JSyn](http://www.softsynth.com/jsyn/) - an audio synthesis software API for Java.
* [Librosa ★1518](https://github.com/librosa/librosa) - a python package for music and audio analysis, providing the building blocks necessary to create music information retrieval systems.
* [midi.js ★2376](https://github.com/mudcube/MIDI.js) - a framework for creating web-based MIDI apps.
...
* [Soundpipe ★517](https://github.com/PaulBatchelor/Soundpipe) - a lightweight DSP library written in C.
...
* [Frescobaldi ★277](https://github.com/wbsoft/frescobaldi) - a free Lilypond sheet music editor.
...
* [Inknote ★130 ⏳1Y](https://github.com/MichalPaszkiewicz/inknote) - free, open source, browser based music notation and composition software.
...
* [MuseScore ★1885](https://github.com/musescore/MuseScore) - free open-source music notation and composition software.
...
* [Verovio ★136](https://github.com/rism-ch/verovio) - a library and a toolkit for engraving MEI music notation into SVG.
* [Vexflow ★1945](https://github.com/0xfe/vexflow) - a JavaScript library for rendering music notation and guitar tablature.

## Music Programming

* [Alda ★2797](https://github.com/alda-lang/alda) - a music programming language for musicians.
...
* [Chuck ★232](https://github.com/ccrma/chuck) - strongly-timed, concurrent, and on-the-fly music programming language.
...
* [Leipzig ★328](https://github.com/ctford/leipzig) - a composition library for Overtone.
...
* [Overtone ★3935](https://github.com/overtone/overtone) - an Open Source toolkit for designing synthesizers and collaborating with music.
...
* [Sporth ★123](https://github.com/PaulBatchelor/Sporth) - a small stack based audio language.
...
* [Awesome Music Production ★37 ⏳1Y](https://github.com/adius/awesome-music-production) - A curated list of software and resources to create music.
