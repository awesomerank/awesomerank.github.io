...
---
# Awesome Music [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
...
* [Audacity ★779](audacity/audacity) - a free, cross-platform digital audio editor.
...
* [audio.js ★1742](kolber/audiojs) - audio.js is a drop-in javascript library that allows HTML5's &lt;audio&gt; tag to be used anywhere.
* [howler.js ★7938](goldfire/howler.js) - a Javascript audio library for the modern web.
* [JSyn](http://www.softsynth.com/jsyn/) - an audio synthesis software API for Java.
* [Librosa ★1126](librosa/librosa) - a python package for music and audio analysis, providing the building blocks necessary to create music information retrieval systems.
* [midi.js ★2184](mudcube/MIDI.js) - a framework for creating web-based MIDI apps.
* [mxml ★2](venturemedia/mxml) - MusicXML parsing and layout library.
...
* [Soundpipe ★444](PaulBatchelor/Soundpipe) - a lightweight DSP library written in C.

## Audio Tools

* [Beets](http://beets.radbox.org/) - a powerful command-line music organizer and manipulator.
* [Koel ★7700](phanan/koel) - an open-source personal audio streaming server.
...
* [Musikernel ★48](j3ffhubb/musikernel) - a futuristic audio production platform (hardware support, APIs, hosts, plugins and more)
* [SoX](http://sox.sourceforge.net/) - a free open-source command line utility for playing, converting and manipulating audio files.

## Free Music Scores

* [cellist/Lilypond-Sheet-Music ★44](cellist/Lilypond-Sheet-Music) - a collection of music typeset with lilypond (mostly chamber music and music for cello).
* [ciconia/music ★9](ciconia/music) - a collection of mostly baroque music, lots of sacred works by J. S. Bach, coded in lilypond/ripple.
* [CPDL](http://www.cpdl.org/) - the choral public domain library contains more than 20K free scores of vocal music.
* [Éditions Nicolas Sceaux ★21](nsceaux/nenuvar) - baroque music scores (mainly French music), typeset using lilypond.
...
* [Mutopia ★92](MutopiaProject/MutopiaProject) - sheet music based on editions in the public domain.
* [wbsoft/lilymusic ★21](wbsoft/lilymusic) - beautiful LilyPond scores under free licenses.
...
* [Frescobaldi ★259](wbsoft/frescobaldi) - a free Lilypond sheet music editor.
...
* [Inknote ★124](MichalPaszkiewicz/inknote) - free, open source, browser based music notation and composition software.
* [LibMEI ★30](DDMAL/libmei) - a C++ library for reading and writing MEI files.
...
* [Lilyvm ★2 ⏳1Y](olsonpm/lilyvm) - Lilypond version manager.
* [Lydown ★8](ciconia/lydown) - a modern language for music notation, based on Lilypond.
* [Lyp ★39](noteflakes/lyp) - the Lilypond swiss army knife - easily install packages, manage multiple versions of Lilypond, and other tools for power users.
* [MuseScore ★1553](musescore/MuseScore) - free open-source music notation and composition software.
* [MusicKit ★24](venturemedia/musickit) - Music sheet rendering for iOS and OSX.
* [NOTATIO](http://notat.io/) - a forum devoted to the practice of music notation.
* [OpenLilyLib ★69](openlilylib/snippets) - LilyPond tools - snippets, templates, and extensions.
* [Python-ly](https://pypi.python.org/pypi/python-ly) - a tool and library for manipulating LilyPond files.
* [Ripple ★15 ⏳3Y](ciconia/ripple) - DRY for Lilypond - generate scores and parts with minimal fuss.
* [Scorelib](http://scorelib.sapp.org/) - a C++ library for parsing SCORE data files.
* [Tunefl ★19 ⏳1Y](tiredpixel/tunefl) - LilyPond mini-score engraving and sharing service for musicians.
* [Verovio ★101](rism-ch/verovio) - a library and a toolkit for engraving MEI music notation into SVG.
* [Vexflow ★1818](0xfe/vexflow) - a JavaScript library for rendering music notation and guitar tablature.

## Music Programming

* [Alda ★2646](alda-lang/alda) - a music programming language for musicians.
...
* [Chuck ★202](ccrma/chuck) - strongly-timed, concurrent, and on-the-fly music programming language.
* [CoffeeCollider ★184 ⏳1Y](mohayonao/CoffeeCollider) - a language for real time audio synthesis and algorithmic composition in HTML5. "Write CoffeeScript, and be processed as SuperCollider."
...
* [Leipzig ★310](ctford/leipzig) - a composition library for Overtone.
...
* [Overtone ★3696](overtone/overtone) - an Open Source toolkit for designing synthesizers and collaborating with music.
...
* [Sporth ★94](PaulBatchelor/Sporth) - a small stack based audio language.
...
* [Awesome Music Production ★23](adius/awesome-music-production) - A curated list of software and resources to create music.
* [Awesome Web Audio ★225](notthetup/awesome-webaudio) - A curated list of awesome WebAudio packages and resources.

Other amazingly awesome lists can be found in the [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome) list.
