...
---
# Awesome Music [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★69735](https://github.com/sindresorhus/awesome)
...
* [Audacity ★1016](https://github.com/audacity/audacity) - a free, cross-platform digital audio editor.
...
* [audio.js ★1814](https://github.com/kolber/audiojs) - audio.js is a drop-in javascript library that allows HTML5's &lt;audio&gt; tag to be used anywhere.
* [howler.js ★8804](https://github.com/goldfire/howler.js) - a Javascript audio library for the modern web.
* [JSyn](http://www.softsynth.com/jsyn/) - an audio synthesis software API for Java.
* [Librosa ★1430](https://github.com/librosa/librosa) - a python package for music and audio analysis, providing the building blocks necessary to create music information retrieval systems.
* [midi.js ★2351](https://github.com/mudcube/MIDI.js) - a framework for creating web-based MIDI apps.
...
* [Soundpipe ★503](https://github.com/PaulBatchelor/Soundpipe) - a lightweight DSP library written in C.

## Audio Tools

* [Beets](http://beets.radbox.org/) - a powerful command-line music organizer and manipulator.
* [Koel ★8386](https://github.com/phanan/koel) - an open-source personal audio streaming server.
...
* [Musikernel ★47](https://github.com/j3ffhubb/musikernel) - a futuristic audio production platform (hardware support, APIs, hosts, plugins and more)
...
* [Mutopia ★101](https://github.com/MutopiaProject/MutopiaProject) - sheet music based on editions in the public domain.
* [wbsoft/lilymusic ★22](https://github.com/wbsoft/lilymusic) - beautiful LilyPond scores under free licenses.
...
* [Frescobaldi ★276](https://github.com/wbsoft/frescobaldi) - a free Lilypond sheet music editor.
...
* [Inknote ★128 ⏳1Y](https://github.com/MichalPaszkiewicz/inknote) - free, open source, browser based music notation and composition software.
...
* [Lyp ★44](https://github.com/noteflakes/lyp) - the Lilypond swiss army knife - easily install packages, manage multiple versions of Lilypond, and other tools for power users.
* [MuseScore ★1827](https://github.com/musescore/MuseScore) - free open-source music notation and composition software.
* [MusicKit ★29](https://github.com/venturemedia/musickit) - Music sheet rendering for iOS and OSX.
* [NOTATIO](http://notat.io/) - a forum devoted to the practice of music notation.
* [OpenLilyLib ★69](https://github.com/openlilylib/snippets) - LilyPond tools - snippets, templates, and extensions.
...
* [Verovio ★130](https://github.com/rism-ch/verovio) - a library and a toolkit for engraving MEI music notation into SVG.
* [Vexflow ★1916](https://github.com/0xfe/vexflow) - a JavaScript library for rendering music notation and guitar tablature.

## Music Programming

* [Alda ★2767](https://github.com/alda-lang/alda) - a music programming language for musicians.
...
* [Chuck ★221](https://github.com/ccrma/chuck) - strongly-timed, concurrent, and on-the-fly music programming language.
* [CoffeeCollider ★190 ⏳2Y](https://github.com/mohayonao/CoffeeCollider) - a language for real time audio synthesis and algorithmic composition in HTML5. "Write CoffeeScript, and be processed as SuperCollider."
...
* [Leipzig ★325](https://github.com/ctford/leipzig) - a composition library for Overtone.
...
* [Overtone ★3893](https://github.com/overtone/overtone) - an Open Source toolkit for designing synthesizers and collaborating with music.
...
* [Sporth ★118](https://github.com/PaulBatchelor/Sporth) - a small stack based audio language.
...
* [Awesome Music Production ★36 ⏳1Y](https://github.com/adius/awesome-music-production) - A curated list of software and resources to create music.
* [Awesome Web Audio ★288](https://github.com/notthetup/awesome-webaudio) - A curated list of awesome WebAudio packages and resources.
