...
* [Audacity ★779](https://github.com/audacity/audacity) - a free, cross-platform digital audio editor.
...
* [audio.js ★1742](https://github.com/kolber/audiojs) - audio.js is a drop-in javascript library that allows HTML5's &lt;audio&gt; tag to be used anywhere.
* [howler.js ★7938](https://github.com/goldfire/howler.js) - a Javascript audio library for the modern web.
* [JSyn](http://www.softsynth.com/jsyn/) - an audio synthesis software API for Java.
* [Librosa ★1126](https://github.com/librosa/librosa) - a python package for music and audio analysis, providing the building blocks necessary to create music information retrieval systems.
* [midi.js ★2184](https://github.com/mudcube/MIDI.js) - a framework for creating web-based MIDI apps.
...
* [Soundpipe ★444](https://github.com/PaulBatchelor/Soundpipe) - a lightweight DSP library written in C.

## Audio Tools

* [Beets](http://beets.radbox.org/) - a powerful command-line music organizer and manipulator.
* [Koel ★7700](https://github.com/phanan/koel) - an open-source personal audio streaming server.
...
* [ciconia/music ★9](https://github.com/ciconia/music) - a collection of mostly baroque music, lots of sacred works by J. S. Bach, coded in lilypond/ripple.
* [CPDL](http://www.cpdl.org/) - the choral public domain library contains more than 20K free scores of vocal music.
* [Éditions Nicolas Sceaux ★21](https://github.com/nsceaux/nenuvar) - baroque music scores (mainly French music), typeset using lilypond.
...
* [Mutopia ★92](https://github.com/MutopiaProject/MutopiaProject) - sheet music based on editions in the public domain.
...
* [Frescobaldi ★259](https://github.com/wbsoft/frescobaldi) - a free Lilypond sheet music editor.
...
* [Inknote ★124](https://github.com/MichalPaszkiewicz/inknote) - free, open source, browser based music notation and composition software.
...
* [Verovio ★101](https://github.com/rism-ch/verovio) - a library and a toolkit for engraving MEI music notation into SVG.
* [Vexflow ★1818](https://github.com/0xfe/vexflow) - a JavaScript library for rendering music notation and guitar tablature.

## Music Programming

* [Alda ★2646](https://github.com/alda-lang/alda) - a music programming language for musicians.
...
* [Chuck ★202](https://github.com/ccrma/chuck) - strongly-timed, concurrent, and on-the-fly music programming language.
* [CoffeeCollider ★184 ⏳1Y](https://github.com/mohayonao/CoffeeCollider) - a language for real time audio synthesis and algorithmic composition in HTML5. "Write CoffeeScript, and be processed as SuperCollider."
...
* [Leipzig ★310](https://github.com/ctford/leipzig) - a composition library for Overtone.
...
* [Overtone ★3696](https://github.com/overtone/overtone) - an Open Source toolkit for designing synthesizers and collaborating with music.
...
* [Sporth ★94](https://github.com/PaulBatchelor/Sporth) - a small stack based audio language.
...
* [Awesome Music Production ★23](https://github.com/adius/awesome-music-production) - A curated list of software and resources to create music.
* [Awesome Web Audio ★225](https://github.com/notthetup/awesome-webaudio) - A curated list of awesome WebAudio packages and resources.

Other amazingly awesome lists can be found in the [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](https://github.com/sindresorhus/awesome) list.
