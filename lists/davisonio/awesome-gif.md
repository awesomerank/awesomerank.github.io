...
- [Gifify ★3599](https://github.com/vvo/gifify) - Convert any video file to an optimized animated GIF
- [Gifify (not the same) ★816](https://github.com/jclem/gifify) - convert screen recording into GIF
- [Gifsicle ★419](https://github.com/pornel/giflossy) - lossy GIF compressor
- [Gifs ★1509](https://github.com/jglovier/gifs) - storage place for GIFs - [demo](http://gifs.joelglovier.com)
- [Gifshot ★2788](https://github.com/yahoo/gifshot) - create animated GIFs from media by Yahoo - [demo](http://yahoo.github.io/gifshot/)
- [Gifsockets ★1570 ⏳4Y](https://github.com/videlalvaro/gifsockets) - Real Time communication library using Animated GIFs as a transport
- [X-gif ★1877](https://github.com/geelen/x-gif) - a web component for flexible GIF playback
- [gifme ★325 ⏳3Y](https://github.com/holman/gifme) - generate animated GIFs
- [GifW00t ★659 ⏳2Y](https://github.com/yaronn/GifW00t) - javascript web recorder
- [gif-machine ★55 ⏳2Y](https://github.com/lelandbatey/gif-machine) - GIF creation from Youtube videos
- [gifstreaming ★126 ⏳3Y](https://github.com/jbochi/gifstreaming) - Live video streaming server
- [Screengif ★908](https://github.com/dergachev/screengif) - Create animated GIF screencasts
...
- [Tty2gif ★138 ⏳2Y](https://github.com/z24/tty2gif) - record scripts and their outputs into both binary and GIF formats
- [Giftoppr ★35 ⏳3Y](https://github.com/desktoppr/giftoppr) - Sync your favourite GIFs with Dropbox
- [Gifit ★94](https://github.com/Fauntleroy/GIFit) - Chrome extension to make a GIF from a YouTube video
- [Ccapture.js ★808](https://github.com/spite/ccapture.js) - Capture animations created with HTML5 canvas
...
- [Node-gif ★155 ⏳1Y](https://github.com/pkrumins/node-gif) - C++ library to make GIF
- [Gif-h ★130 ⏳3Y](https://github.com/ginsweater/gif-h) - C++ one-header library for the creation of animated GIFs
...
- [XamlAnimatedGif ★13](https://github.com/thomaslevesque/XamlAnimatedGif) - A simple library to display animated GIF images in XAML apps (WPF, WinRT, Windows Phone)

#### Haxe

- [Gif ★24](https://github.com/snowkit/gif) - Haxe GIF encoder

#### Java

- [Android-gif-drawable ★4502](https://github.com/koral--/android-gif-drawable) - Views and Drawable for displaying animated GIFs on Android
- [gifanimateddrawable ★216 ⏳3Y](https://github.com/Hipmob/gifanimateddrawable) - Use an animated GIF as an Android Drawable
- [GifView ★80 ⏳4Y](https://github.com/RoiSoleil/GifView) - android library to deal with GIF
- [Gif Movie View ★432 ⏳1Y](https://github.com/sbakhtiarov/gif-movie-view) - Android View widget for displaying GIF animations
- [GifImageView ★840](https://github.com/felipecsl/GifImageView) - Android ImageView that handles animated GIF images
- [Gif-animation ★95](https://github.com/extrapixel/gif-animation) - Processing library to play and export GIF
- [Android-gif-encoder ★185 ⏳5Y](https://github.com/nbadal/android-gif-encoder) - animated GIF encoder for Android
- [GIFDroid ★83 ⏳1Y](https://github.com/quackware/GIFDroid) - Android video to GIF converter
- [Android-GifStitch ★38 ⏳5Y](https://github.com/CaptPhunkosis/Android-GifStitch) - create and share animated GIFs

#### JavaScript

- [Gif.js ★2213](https://github.com/jnordberg/gif.js) - Javascript - create GIF from the DOM
- [Omggif ★363 ⏳1Y](https://github.com/deanm/omggif) - Javascript - GIF 89a encoder and decoder
...
- [node-youtube ★122](https://github.com/javascipt/node-youtube) - Youtube to snapshots and GIFs.

#### PHP

- [GifCreator ★225](https://github.com/Sybio/GifCreator) - PHP class that creates animated GIF from multiple images
- [Spacer.gif ★16 ⏳1Y](https://github.com/msng/spacer.gif) - PHP script offering spacer.gif 1x1
- [GifFrameExtractor ★96](https://github.com/Sybio/GifFrameExtractor) - PHP class that separates all the frames of an animated GIF

#### Objective-C

- [AnimatedGIFImageSerialization ★1009](https://github.com/mattt/AnimatedGIFImageSerialization) - decodes an UIImage from Animated GIFs image data
- [UIimage from GIF ★786 ⏳1Y](https://github.com/mayoff/uiimage-from-animated-gif) - UIImage category that loads animated GIFs
- [GIFRefreshControl ★307 ⏳2Y](https://github.com/cyndibaby905/GIFRefreshControl) - "Twitter music" and "Yahoo! Weather" like pull-to-refresh control
- [UIImageView-PlayGIF ★401](https://github.com/yfme/UIImageView-PlayGIF) - UIImageView category/subclass for playing GIF
- [FLAnimatedImage ★5660](https://github.com/Flipboard/FLAnimatedImage) - Gif engine for iOS by FlipBoard
- [Animated-GIF-iPhone ★132 ⏳2Y](https://github.com/arturogutierrez/Animated-GIF-iPhone) - Support for Animated GIF on iOS
- [UzysAnimatedGifPullToRefresh ★1387](https://github.com/uzysjung/UzysAnimatedGifPullToRefresh) - PullToRefresh using animated GIF to any scrollView
...
- [Video-Background GIF ★143](https://github.com/ElvinJin/Video-Background-GIF) - iOS Video Background GIF
...
- [Gifu ★1698](https://github.com/kaishin/gifu) - animated GIF support for iOS in Swift
- [SwiftGif ★608](https://github.com/bahlo/SwiftGif) - UIImage extension with GIF support
...
- [GIFs ★581](https://github.com/orta/GIFs) - Mac App for finding GIFs
- [VineGifR ★86 ⏳4Y](https://github.com/esten/VineGifR) - Mac app to turn Vine videos into GIFs
- [GifPro ★41 ⏳5Y](https://github.com/unixpickle/GifPro) - GIF encoder for Mac
- [Gif Maker](https://gifmaker.movielala.com) - High quailty GIF maker with filters for Mac
- [AnimatedGif ★32](https://github.com/Waitsnake/AnimatedGif) - Mac Screensaver for playing GIFs
...
- [Starwars-dot-gif ★466](https://github.com/LindseyB/starwars-dot-gif) - Python script to generate GIFs from star wars
...
```
From [DeepDreamVideo ★1775](https://github.com/graphific/DeepDreamVideo), [source](https://github.com/graphific/DeepDreamVideo/blob/master/frames2gif.sh)
...
```
or use [ccapture.js ★808](https://github.com/spite/ccapture.js).
