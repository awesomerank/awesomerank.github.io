...
- [gifstreaming ★129](https://github.com/jbochi/gifstreaming) - Live video streaming server
- [Screengif ★952](https://github.com/dergachev/screengif) - Create animated GIF screencasts
...
- [Ccapture.js ★870](https://github.com/spite/ccapture.js) - Capture animations created with HTML5 canvas
...
- [Android-gif-drawable ★4913](https://github.com/koral--/android-gif-drawable) - Views and Drawable for displaying animated GIFs on Android
...
- [Gif.js ★2281](https://github.com/jnordberg/gif.js) - Javascript - create GIF from the DOM
- [Omggif ★370](https://github.com/deanm/omggif) - Javascript - GIF 89a encoder and decoder
- [Animated_GIF ★151](https://github.com/sole/Animated_GIF) - Javascript library for creating animated GIFs
- [Gifffer ★560](https://github.com/krasimir/gifffer) JavaScript library that prevents the autoplaying of the animated GIFs
- [Gifplayer ★329](https://github.com/rubentd/gifplayer) - jquery plugin to play and stop animated GIFs
- [Jsgif ★380 ⏳1Y](https://github.com/shachaf/jsgif) - JavaScript GIF parser and player
- [node-gify ★211 ⏳1Y](https://github.com/tj/node-gify) - Javascript convert videos to GIFs using ffmpeg and gifsicle
- [Gifencoder ★187](https://github.com/eugeneware/gifencoder) - Server side animated GIF generation for node.js
...
- [node-youtube ★130 ⏳1Y](https://github.com/javascipt/node-youtube) - Youtube to snapshots and GIFs.
...
- [UIimage from GIF ★801 ⏳1Y](https://github.com/mayoff/uiimage-from-animated-gif) - UIImage category that loads animated GIFs
...
- [Gifu ★1770](https://github.com/kaishin/gifu) - animated GIF support for iOS in Swift
- [SwiftGif ★665](https://github.com/bahlo/SwiftGif) - UIImage extension with GIF support
...
- [Starwars-dot-gif ★467 ⏳1Y](https://github.com/LindseyB/starwars-dot-gif) - Python script to generate GIFs from star wars
...
```
From [DeepDreamVideo ★1805](https://github.com/graphific/DeepDreamVideo), [source](https://github.com/graphific/DeepDreamVideo/blob/master/frames2gif.sh)
...
```
or use [ccapture.js ★870](https://github.com/spite/ccapture.js).
