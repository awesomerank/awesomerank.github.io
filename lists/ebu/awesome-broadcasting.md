...
* [dvbcss-synctiming ★9](https://github.com/BBC/dvbcss-synctiming) - A system for measuring how accurately a TV or companion are synchronised.
...
* [HbbPlayer ★26](https://github.com/Samsung/HbbPlayer) - An HbbTV application which can playback media from a URL. Conforms to HbbTV and W3C specifications.
...
* [Aurena ★78 ⏳2Y](https://github.com/thaytan/aurena) - A network distributed media playback system.
...
* [Kodi ★6622](https://github.com/xbmc/xbmc) - A software media player and entertainment hub for digital media.
...
* [rx-player ★279](https://github.com/canalplus/rx-player) - HTML5/Javascript video player with some reactive programming inside, supporting MPEG-DASH and SmoothStreaming transports.
...
* [TV-Anytime ★5](https://github.com/ebu/tvanytime) - The TV-Anytime schema github maintenance page.
...
* [Photon ★97](https://github.com/Netflix/photon) - Implementation of the SMPTE Interoperable Master Format (IMF) standard.
* [QCTools ★112](https://github.com/bavc/qctools) - Quality Control tools for video preservation to analyse digitized video files.
...
* [VMAF ★467](https://github.com/Netflix/vmaf) - Perceptual video quality assessment based on multi-method fusion.
...
* [AvTranscoder ★57](https://github.com/avTranscoder/avTranscoder) - Based on FFmpeg/LibAV libraries to support various video and audio formats, avTranscoder provides the high level API to re-wrap or transcode media easily. It also provide bindings for any usage in Java or Python.
* [Bento4 ★392](https://github.com/axiomatic-systems/Bento4) - Full-featured MP4 format and MPEG DASH C++ class library and tools.
...
* [Flowblade ★640](https://github.com/jliljebl/flowblade) - A multitrack non-linear video editor.
...
* [L-SMASH ★107](https://github.com/l-smash/l-smash) - A rigidly spec-compliant ISOBMFF library, which has full DASH muxing support.
...
* [MP4Box.js ★422](https://github.com/gpac/mp4box.js) - JavaScript library to process MP4 files in the browser (and in NodeJS).
* [MXFLib](http://sourceforge.net/projects/mxflib) - A multi-platform C++ library for reading and writing MXF files.
* [OBS-Studio ★8121](https://github.com/jp9000/obs-studio) - Software for live streaming and screen recording.
...
* [Fio ★887](https://github.com/axboe/fio) - Flexible I/O Tester
* [iPerf3](https://iperf.fr/) - The TCP, UDP and SCTP network bandwidth measurement tool.
* [SMPTE 2110-20 Analyzer ★9](https://github.com/ebu/smpte2110-analyzer) - An analyzer to inspect network packets generated in accordance with the SMPTE ST 2110 specification.
...
* [Liquidsoap ★333](https://github.com/savonet/liquidsoap) - A Swiss army knife for multimedia streaming ([documentation](http://liquidsoap.fm/index.html)).
* [OpenBroadcaster](https://github.com/openbroadcaster/observer) Open source broadcast automation server. [Player here ★9 ⏳1Y](https://github.com/openbroadcaster/obplayer).
...
* [imscJS ★21](https://github.com/sandflow/imscJS) - JavaScript library for rendering IMSC1 Text and Image Profile documents to HTML5.
...
* [Timed Text Toolkit (ttt) ★21](https://github.com/skynav/ttt) - A collection of related tools that provide support for or make use of the W3C Timed Text Markup Language (TTML).
