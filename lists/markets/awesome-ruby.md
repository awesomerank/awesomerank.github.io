...
* [Annotate ★2949](https://github.com/ctran/annotate_models) - Add a comment documenting the current schema to the top or bottom of each of your ActiveRecord models.
...
* Import
  ...
  * [bulk_insert ★622](https://github.com/jamis/bulk_insert) - A little ActiveRecord extension for helping to insert lots of rows in a single insert statement.
...
* Frameworks
  ...
  * [Spinach ★536](https://github.com/codegram/spinach) - Spinach is a high-level BDD framework that leverages the expressive Gherkin language (used by Cucumber) to help you define executable specifications of your application or library's acceptance criteria.
...
* [soundcloud-ruby ★337 ⏳1Y](https://github.com/soundcloud/soundcloud-ruby) - Official SoundCloud API Wrapper for Ruby.
* [t ★4549](https://github.com/sferik/t) - A command-line power tool for Twitter.
* [terjira ★423](https://github.com/keepcosmos/terjira) - A command-line power tool for Jira.
* [tweetstream ★1111](https://github.com/tweetstream/tweetstream) - A simple library for consuming Twitter's Streaming API.
* [twilio-ruby ★1076](https://github.com/twilio/twilio-ruby) - A module for using the Twilio REST API and generating valid TwiML.
* [twitter ★4054](https://github.com/sferik/twitter) - A Ruby interface to the Twitter API.
* [wikipedia ★224](https://github.com/kenpratt/wikipedia-client) - Ruby client for the Wikipedia API.
* [Yt ★579](https://github.com/Fullscreen/yt) - An object-oriented Ruby client for YouTube API V3.

## Video

* [Streamio FFMPEG ★1309](https://github.com/streamio/streamio-ffmpeg) - Simple yet powerful wrapper around the ffmpeg command for reading metadata and transcoding movies.
* [Video Transcoding ★1455](https://github.com/donmelton/video_transcoding) - Tools to transcode, inspect and convert videos.

## View helpers

* [auto_html ★739](https://github.com/dejan/auto_html) - Rails extension for transforming URLs to appropriate resource (image, link, YouTube, Vimeo video...).
* [Bh ★831](https://github.com/fullscreen/bh) - Bootstrap Helpers for Ruby.
* [gon ★2634](https://github.com/gazay/gon) - If you need to send some data to your js files and you don't want to do this with long way through views and parsing - use gon.
* [PluggableJs ★52 ⏳2Y](https://github.com/peresleguine/pluggable_js) - Page-specific javascript for Rails applications with the ability of passing data from a controller.

## Web Crawling

* [anemone ★1610 ⏳1Y](https://github.com/chriskite/anemone) - Ruby library and CLI for crawling websites.
* [LinkThumbnailer ★407](https://github.com/gottfrois/link_thumbnailer) - Ruby gem that generates thumbnail images and videos from a given URL. Much like popular social website with link preview.
* [Mechanize ★3682](https://github.com/sparklemotion/mechanize) - Mechanize is a ruby library that makes automated web interaction easy.
* [MetaInspector ★797](https://github.com/jaimeiniesta/metainspector) - Ruby gem for web scraping purposes.
* [Upton ★1593](https://github.com/propublica/upton) - A batteries-included framework for easy web-scraping.
* [Wombat ★1084](https://github.com/felipecsl/wombat) - Web scraper with an elegant DSL that parses structured data from web pages.

## Web Frameworks

* [Camping ★599](https://github.com/camping/camping) - A web microframework which consistently stays at less than 4kB of code.
* [Cuba](http://cuba.is) - A microframework for web development.
* [Hobbit ★257](https://github.com/patriciomacadden/hobbit) - A minimalistic microframework built on top of Rack.
...
* [Rack::App ★342](https://github.com/rack-app/rack-app) - Bare bone minimalistic framework for building rack apps.
...
* [Syro ★89](https://github.com/soveran/syro) - Simple router for web applications.
* [Volt ★3313](https://github.com/voltrb/volt) - A Ruby web framework where your ruby code runs on both the server and the client.

## Web Servers

* [Goliath ★2439](https://github.com/postrank-labs/goliath) - A non-blocking Ruby web server framework.
* [Iodine ★439](https://github.com/boazsegev/iodine) - An non-blocking HTTP and Websocket web server optimized for Linux/BDS/macOS and Ruby MRI.
* [Phusion Passenger](https://www.phusionpassenger.com) - Fast and robust web server and application server.
* [Puma ★5309](https://github.com/puma/puma) - A modern, concurrent web server for Ruby.
...
* [Reel ★616](https://github.com/celluloid/reel) - Celluloid::IO-powered web server.
...
* [Firehose ★698](https://github.com/firehoseio/firehose) - Build realtime Ruby web applications.
* [Slanger ★1602](https://github.com/stevegraham/slanger) - Open Pusher implementation compatible with Pusher libraries.
* [RenderSync ★1370 ⏳1Y](https://github.com/chrismccord/render_sync) - Real-time Rails Partials.
* [Websocket-Rails ★1719](https://github.com/websocket-rails/websocket-rails) - Creates a built in WebSocket server inside a Rails application with ease, and also support streaming HTTP.
...
* [Nanobox ★1230](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, Ruby environments deployable anywhere https://nanobox.io.
...
* [Ruby Bookmarks ★1430](https://github.com/dreikanter/ruby-bookmarks) - Ruby and Ruby on Rails bookmarks collection.
