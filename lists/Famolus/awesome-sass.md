...
## Frameworks
- [Bootstrap 4 ★113451](https://github.com/twbs/bootstrap) - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
- [Bootstrap-sass ★12278](https://github.com/twbs/bootstrap-sass) - Official Sass port of Bootstrap 2 and 3.
- [Foundation for Sites ★25998](https://github.com/zurb/foundation-sites) - The most advanced responsive front-end framework in the world. Quickly create prototypes and production code for sites that work on any kind of device.
...
- [Bulma ★17896](https://github.com/jgthms/bulma) - Modern CSS framework based on Flexbox.
...
- [Jeet ★3020](https://github.com/mojotech/jeet) - Simple fractional grid system for Sass and Stylus.
...
- [Sass MQ ★1254](https://github.com/sass-mq/sass-mq) - Sass mixin that helps you compose media queries in an elegant way.
- [Breakpoint ★1953](https://github.com/at-import/breakpoint) - Breakpoint makes writing media queries in Sass super simple.
- [mq-scss ★77](https://github.com/Dan503/mq-scss) - An extreamly powerful but easy to use Sass media query mixin.
...
- [Typi ★650](https://github.com/zellwk/typi) - Sass mixin to make responsive typography easy.
...
- [Animate.scss ★462 ⏳1Y](https://github.com/geoffgraham/animate.scss) -  Port of Dan Eden's [Animate.css](https://daneden.github.io/animate.css/) for SASS.
...
- [Buttons ★5060](https://github.com/alexwolfe/Buttons) - CSS button library built using Sass and Compass.
...
- [Sass flexbox mixin ★1086](https://github.com/mastastealth/sass-flex-mixin) - Set of mixins for those who want to mess around with flexbox using the native support of current browsers.
...
- [Airbnb Sass and CSS Style Guide ★2979](https://github.com/airbnb/css) - Sass and CSS style guide by Airbnb.
...
- [Dropbox (S)CSS Style Guide ★564 ⏳1Y](https://github.com/dropbox/css-style-guide) - Dropbox’s (S)CSS authoring style guide.

## Articles
- [Hugo Giraudel Personal Awesome Sass List ★642](https://github.com/HugoGiraudel/awesome-sass) - Records of Hugo Giraudel's works on Sass.
...
- [libsass-python ★327](https://github.com/dahlia/libsass-python) - Binding of libsass for Python.
