...
- [Bulma ★19231](https://github.com/jgthms/bulma) - Modern CSS framework based on Flexbox.
...
- [Kaliber ★2](https://github.com/robbinfellow/kaliber) - Tiny but powerful CSS framework based on Flexbox.
...
- [Susy ★3814](https://github.com/oddbird/susy) - Responsive layout toolkit for Sass.
...
- [Jeet ★3031](https://github.com/mojotech/jeet) - Simple fractional grid system for Sass and Stylus.
...
- [Sass MQ ★1281](https://github.com/sass-mq/sass-mq) - Sass mixin that helps you compose media queries in an elegant way.
- [Breakpoint ★1963](https://github.com/at-import/breakpoint) - Breakpoint makes writing media queries in Sass super simple.
- [mq-scss ★85](https://github.com/Dan503/mq-scss) - An extreamly powerful but easy to use Sass media query mixin.

### Color
- [scss-blend-modes ★817](https://github.com/heygrady/scss-blend-modes) - Using standard color blending functions in Sass.
...
- [Typi ★666](https://github.com/zellwk/typi) - Sass mixin to make responsive typography easy.
- [Sassy-Gridlover ★184](https://github.com/hiulit/Sassy-Gridlover) - Super easy to use Sass mixins to establish a typographic system with modular scale and vertical rhythm. Based on the Gridlover app.
...
- [Animate.scss ★472 ⏳1Y](https://github.com/geoffgraham/animate.scss) -  Port of Dan Eden's [Animate.css](https://daneden.github.io/animate.css/) for SASS.
...
- [normalize-scss ★1204](https://github.com/JohnAlbin/normalize-scss) -  Sass/Compass version of Normalize.css, a collection of HTML element and attribute rulesets to normalize styles across all browsers.
...
- [Sass Deprecate ★211](https://github.com/salesforce-ux/sass-deprecate) - Sass mixin that helps managing code deprecation.
...
## Articles
- [Hugo Giraudel Personal Awesome Sass List ★647](https://github.com/HugoGiraudel/awesome-sass) - Records of Hugo Giraudel's works on Sass.
...
- [libsass-python ★332](https://github.com/dahlia/libsass-python) - Binding of libsass for Python.
...
- [scss-lint](https://github.com/brigade/scss-lint) - Configurable tool for writing clean and consistent SCSS. [(deprecated) ★2842](https://github.com/brigade/scss-lint#notice-consider-other-tools-before-adopting-scss-lint)
...
- [node-sass-magic-importer ★50](https://github.com/maoberlehner/node-sass-magic-importer) - Custom node-sass importer for selector specific imports, node importing, module importing, globbing support and importing files only once.
