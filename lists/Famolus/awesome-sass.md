...
## Frameworks
- [Bootstrap 4 ★109973](https://github.com/twbs/bootstrap) - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
- [Bootstrap 3 ★12012](https://github.com/twbs/bootstrap-sass) - Bootstrap version 3, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
- [Foundation for Sites ★25345](https://github.com/zurb/foundation-sites) - The most advanced responsive front-end framework in the world. Quickly create prototypes and production code for sites that work on any kind of device.
...
- [Bulma ★14840](https://github.com/jgthms/bulma) - A modern CSS framework based on Flexbox.
...
- [Susy ★3732](https://github.com/oddbird/susy) - Responsive layout toolkit for Sass.
...
- [Jeet ★2980](https://github.com/mojotech/jeet) - Simple fractional grid system for Sass and Stylus.
...
- [Sass MQ ★1156](https://github.com/sass-mq/sass-mq) - Sass mixin that helps you compose media queries in an elegant way.
- [Breakpoint ★1915](https://github.com/at-import/breakpoint) - Breakpoint makes writing media queries in Sass super simple.
...
- [Typi ★597](https://github.com/zellwk/typi) - Sass mixin to make responsive typography easy.
...
- [Sassdash ★279](https://github.com/davidkpiano/sassdash) - The Sass implementation of lodash ([API documentation](http://davidkpiano.github.io/sassdash)).
- [Juice](http://kylebrumm.com/juice/) - Collection of Sass mixins and functions.
- [Sass Deprecate ★206](https://github.com/salesforce-ux/sass-deprecate) - Sass mixin that helps managing code deprecation.

## Style Guides
- [Hugo Giraudel's Sass Guidelines](https://sass-guidelin.es/) - Guidelines for writing sane, maintainable and scalable Sass.
- [BigCommerce Sass Coding Guidelines ★220](https://github.com/bigcommerce/sass-style-guide) - Guidelines in use at BigCommerce.
- [Airbnb Sass and CSS Style Guide ★2606](https://github.com/airbnb/css) - Sass and CSS style guide by Airbnb.
...
## Articles
- [Hugo Giraudel Personal Awesome Sass List ★627](https://github.com/HugoGiraudel/awesome-sass) - Records of Hugo Giraudel's works on Sass.
...
## Tools
- [libsass ★3472](https://github.com/sass/libsass) - C/C++ implementation of a Sass compiler.
- [node-sass ★3769](https://github.com/sass/node-sass) - Node.js bindings to libsass.
- [dart-sass ★281](https://github.com/sass/dart-sass) - Dart implementation of Sass.
...
- [libsass-python ★309](https://github.com/dahlia/libsass-python) - Binding of libsass for Python.
...
- [scss-lint](https://github.com/brigade/scss-lint) - Configurable tool for writing clean and consistent SCSS. [(deprecated) ★2732](https://github.com/brigade/scss-lint#notice-consider-other-tools-before-adopting-scss-lint)
- [OctoLinker ★2105](https://github.com/OctoLinker/browser-extension) - Navigate through *.scss and *.sass files efficiently with the OctoLinker browser extension for GitHub.
