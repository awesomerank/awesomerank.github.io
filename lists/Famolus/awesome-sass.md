...
# Awesome Sass [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★61331](https://github.com/sindresorhus/awesome)
...
## Frameworks
- [Bootstrap 4 ★112194](https://github.com/twbs/bootstrap) - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
- [Bootstrap-sass ★12185](https://github.com/twbs/bootstrap-sass) - Official Sass port of Bootstrap 2 and 3.
- [Foundation for Sites ★25771](https://github.com/zurb/foundation-sites) - The most advanced responsive front-end framework in the world. Quickly create prototypes and production code for sites that work on any kind of device.
...
- [Bulma ★16732](https://github.com/jgthms/bulma) - Modern CSS framework based on Flexbox.
...
- [Susy ★3781](https://github.com/oddbird/susy) - Responsive layout toolkit for Sass.
...
- [Jeet ★3003](https://github.com/mojotech/jeet) - Simple fractional grid system for Sass and Stylus.
...
- [Sass MQ ★1219](https://github.com/sass-mq/sass-mq) - Sass mixin that helps you compose media queries in an elegant way.
- [Breakpoint ★1943](https://github.com/at-import/breakpoint) - Breakpoint makes writing media queries in Sass super simple.
- [mq-scss ★69](https://github.com/Dan503/mq-scss) - An extreamly powerful but easy to use Sass media query mixin.
...
- [Typi ★637](https://github.com/zellwk/typi) - Sass mixin to make responsive typography easy.
...
### Animation
- [Sass Burger ★617 ⏳1Y](https://github.com/jorenvanhee/sass-burger) - Sass mixin for creating animated hamburger icon.
- [SpinThatShit](https://matejkustec.github.io/SpinThatShit/) - Set of SCSS mixins for single element loaders and spinners.
- [Animate.scss ★456 ⏳1Y](https://github.com/geoffgraham/animate.scss) -  Port of Dan Eden's [Animate.css](https://daneden.github.io/animate.css/) for SASS.
...
- [normalize-scss ★1176](https://github.com/JohnAlbin/normalize-scss) -  Sass/Compass version of Normalize.css, a collection of HTML element and attribute rulesets to normalize styles across all browsers.
- [Buttons ★5034](https://github.com/alexwolfe/Buttons) - CSS button library built using Sass and Compass.
- [Modular Scale ★1652](https://github.com/modularscale/modularscale-sass) - Modular scale calculator built into your Sass.
...
- [Sass flexbox mixin ★1072](https://github.com/mastastealth/sass-flex-mixin) - Set of mixins for those who want to mess around with flexbox using the native support of current browsers.
- [Angled Edges ★716](https://github.com/josephfusco/angled-edges) - Sass mixin for creating angled edges on sections by dynamically encoding SVGs.
...
- [Sassdash ★289](https://github.com/davidkpiano/sassdash) - The Sass implementation of lodash ([API documentation](http://davidkpiano.github.io/sassdash)).
- [Juice](http://kylebrumm.com/juice/) - Collection of Sass mixins and functions.
- [Sass Deprecate ★209](https://github.com/salesforce-ux/sass-deprecate) - Sass mixin that helps managing code deprecation.

## Style Guides
- [Hugo Giraudel's Sass Guidelines](https://sass-guidelin.es/) - Guidelines for writing sane, maintainable and scalable Sass.
- [BigCommerce Sass Coding Guidelines ★222](https://github.com/bigcommerce/sass-style-guide) - Guidelines in use at BigCommerce.
- [Airbnb Sass and CSS Style Guide ★2835](https://github.com/airbnb/css) - Sass and CSS style guide by Airbnb.
...
- [Dropbox (S)CSS Style Guide ★542 ⏳1Y](https://github.com/dropbox/css-style-guide) - Dropbox’s (S)CSS authoring style guide.

## Articles
- [Hugo Giraudel Personal Awesome Sass List ★637](https://github.com/HugoGiraudel/awesome-sass) - Records of Hugo Giraudel's works on Sass.
...
## Tools
- [libsass ★3531](https://github.com/sass/libsass) - C/C++ implementation of a Sass compiler.
- [node-sass ★3987](https://github.com/sass/node-sass) - Node.js bindings to libsass.
- [dart-sass ★298](https://github.com/sass/dart-sass) - Dart implementation of Sass.
...
- [libsass-python ★320](https://github.com/dahlia/libsass-python) - Binding of libsass for Python.
- [Scout-App](http://scout-app.io/) - Process your Sass and SCSS files into CSS without needing any knowledge of the command line.
- [sass-rails ★718](https://github.com/rails/sass-rails) - Ruby on Rails stylesheet engine for Sass.
- [scss-lint](https://github.com/brigade/scss-lint) - Configurable tool for writing clean and consistent SCSS. [(deprecated) ★2786](https://github.com/brigade/scss-lint#notice-consider-other-tools-before-adopting-scss-lint)
- [OctoLinker ★2197](https://github.com/OctoLinker/browser-extension) - Navigate through *.scss and *.sass files efficiently with the OctoLinker browser extension for GitHub.
...
- [node-sass-magic-importer ★41](https://github.com/maoberlehner/node-sass-magic-importer) - Custom node-sass importer for selector specific imports, node importing, module importing, globbing support and importing files only once.
