---
layout: default
title: Awesome Rank for aharris88/awesome-cli-apps
---

<p align="center">
	This list is a copy of <a href="https://github.com/aharris88/awesome-cli-apps">aharris88/awesome-cli-apps</a> with ranks
</p>
---
<h1 align="center">
	<br>
...
- [movie ★29 ⏳1Y](https://github.com/mayankchd/movie) - Get movie info or compare movies in terminal.
- [somafm-cli ★12](https://github.com/rockymadden/somafm-cli) - Listen to SomaFM in your terminal.
- [nehm ★22](https://github.com/bogem/nehm) - Console tool, which downloads, sets IDv3 tags and adds to your iTunes (if you use macOS) your SoundCloud likes in convenient way
- [football-cli ★111](https://github.com/ManrajGrover/football-cli) - Get live scores, fixtures, standings of almost every football competition/league in your terminal.
- [pockyt ★178](https://github.com/arvindch/pockyt) - Read, Manage, and Automate your [Pocket](https://getpocket.com) collection.

### Social Media

- [facebook-cli ★114](https://github.com/specious/facebook-cli) - Facebook command line interface
- [TTYtter ★177](https://github.com/oysttyer/oysttyer) - Twitter client- ([original](http://www.floodgap.com/software/ttytter/)).
...
- [open-pip-cli ★64](https://github.com/albinekb/open-pip-cli) - Watch movies in macOS native picture-in-picture player from your terminal.

## Development

- [bcal ★42](https://github.com/jarun/bcal) - Byte CALculator for storage conversions and calculations.
- [boilr ★499](https://github.com/tmrts/boilr) - Dependency free CLI to create projects from boilerplate templates.
- [cookiecutter ★5274](https://github.com/audreyr/cookiecutter) - creates projects from cookiecutters (project templates)
- [dockly ★72](https://github.com/lirantal/dockly) - Interactive CLI for managing Docker containers.

### Web Development

- [bower-name-cli ★13 ⏳1Y](https://github.com/sindresorhus/bower-name-cli) - Check whether a package name is available on bower.
- [caniuse-cmd ★1186](https://github.com/sgentle/caniuse-cmd) - Searches [caniuse.com](caniuse.com) about browser support of feature.
- [htconvert ★133](https://github.com/lukechilds/htconvert) - Convert .htaccess redirects to nginx.conf redirects.
- [is-up-cli ★72 ⏳1Y](https://github.com/sindresorhus/is-up-cli) - Check whether a website is up or down.
- [npm-name-cli ★96](https://github.com/sindresorhus/npm-name-cli) - Check whether a package name is available on npm.
- [npm-user-cli ★12 ⏳1Y](https://github.com/sindresorhus/npm-user-cli) - Get user info of a npm user.
- [pageres-cli ★663](https://github.com/sindresorhus/pageres-cli) - Capture website screenshots.
- [strip-css-comments-cli ★19 ⏳1Y](https://github.com/sindresorhus/strip-css-comments-cli) - Strip comments from CSS.
...
- [cycli ★183](https://github.com/nicolewhite/cycli) - A terminal client for Neo4j with autocompletion and syntax highlighting.
- [mycli ★4270](https://github.com/dbcli/mycli) - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
- [pgcli ★5645](https://github.com/dbcli/pgcli) - A Terminal Client for Postgre with AutoCompletion and Syntax Highlighting.
...
- [bitly-client ★11](https://github.com/specious/bitly-client) - Make and manage Bitly shortlinks with this command line utility
- [doing ★503 ⏳1Y](https://github.com/ttscoff/doing) - A command line tool for keeping track of what you’re doing and tracking what you’ve done.
- [ffscreencast ★690](https://github.com/cytopia/ffscreencast) - ffmpeg screencast with video overlay and multi monitor support.
...
- [Timetrap ★786](https://github.com/samg/timetrap) - Simple command line timetracker.
...
- [uber-cli ★978](https://github.com/jaebradley/uber-cli) - Uber, at your fingertips.
- [moro ★107](https://github.com/omidfi/moro) - Time Tracker with a single command
...
- [battery-level ★133](https://github.com/gillstrom/battery-level) - Get current battery level.
...
- [mklicense ★70 ⏳1Y](https://github.com/cezaraugusto/mklicense) - Create a custom LICENSE file painlessly with customized info. Busy people & beginner's friendly.
- [share-cli ★21 ⏳1Y](https://github.com/marionebl/share-cli) - Quickly share files from command line with your local network.
- [remote-share-cli ★19 ⏳1Y](https://github.com/marionebl/remote-share-cli) - Quickly share files from your command line with the world.
- [moeda ★71](https://github.com/thompsonemerson/moeda) - A foreign exchange rates and currency conversion using cli
- [wego ★4887](https://github.com/schachmat/wego) - Get the weather right in your browser or your console.
- [mapscii ★1933](https://github.com/rastapasta/mapscii) - Terminal Map Viewer - the whole world in your console!
...
- [bundle-id-cli ★10 ⏳1Y](https://github.com/sindresorhus/bundle-id-cli) - Get bundle identifier from a bundle name (macOS): Safari → com.apple.Safari.
...
- [osx-wifi-cli ★29](https://github.com/danyshaanan/osx-wifi-cli) - A cli for managing wifi connections on OSX.
...
- [how2 ★4539](https://github.com/santinic/how2) - Finds the simplest way to do something on a unix bash command line (Nodejs implementation of howdoi).
- [shortcutfoo](https://www.shortcutfoo.com/) - Learn shortcuts for VIM, Emacs, git, bash and more.
- [The Fuck ★28678](https://github.com/nvbn/thefuck) - Magnificent app which corrects your previous console command.
- [tldr ★9618](https://github.com/tldr-pages/tldr) - Simplified and community-driven man pages.
- [Wat ★362](https://github.com/dthree/wat) - Instant, central, community-built docs.


## Data Manipulation

- [jq ★9186](https://github.com/stedolan/jq) - Command-line JSON processor [http://stedolan.github.io/jq/](http://stedolan.github.io/jq/).
- [underscore-cli ★1448](https://github.com/ddopson/underscore-cli) - Command-line utility-belt for hacking JSON and Javascript.
- [ramda-cli ★325](https://github.com/raine/ramda-cli) - A CLI tool for processing data with functional pipelines.
- [yaml-cli ★15](https://github.com/pandastrike/yaml-cli) - A simple CLI for querying and updating YAML files

## Files and Directories

### File managers
- [ranger ★2428](https://github.com/ranger/ranger) - a console file manager with VI key bindings.
- [midnight-commander ★546](https://github.com/MidnightCommander/mc) - a feature rich visual file manager

### Deleting, Copying, and Renaming

- [trash-cli ★283](https://github.com/sindresorhus/trash-cli) - Move files and directories to the trash.
...
- [del-cli ★68](https://github.com/sindresorhus/del-cli) - Delete files and folders.
- [cpy-cli ★55 ⏳1Y](https://github.com/sindresorhus/cpy-cli) - Copies files.
...
- [DocToc ★1397](https://github.com/thlorenz/doctoc) - Generates table of contents for markdown files inside local git repository. Links are compatible with anchors generated by github or other sites.

### Directory Listing

- [alder ★95](https://github.com/aweary/alder) - A minimal implementation of the UNIX tree command with colors!

### Directory Navigation

- [autojump ★5612](https://github.com/wting/autojump) - A cd command that learns - easily navigate directories from the command line- [https://github.com/wting/autojump/wiki](https://github.com/wting/autojump/wiki).
- [fasd ★3160](https://github.com/clvv/fasd) - Command-line productivity booster, offers quick access to files and directories, inspired by autojump, z and v.
...
- [happyfinder ★276 ⏳2Y](https://github.com/hugows/hf) - (another) Fuzzy file finder for the command line.
- [PathPicker ★3404](https://github.com/facebook/pathpicker) - After parsing the output from a command, PathPicker presents you with a nice UI to select which files you're interested in.
- [find-up-cli ★14](https://github.com/sindresorhus/find-up-cli) - Find a file by walking up parent directories.
...
- [gotty ★7872](https://github.com/yudai/gotty) - Share your terminal as a web application.
...
- [CLI GitHub ★262](https://github.com/IonicaBizau/cli-github) - :tv: A fancy GitHub client for command line.
- [Gistup ★370](https://github.com/mbostock/gistup) - Create a gist from terminal, then use git to update it.
...
- [clog ★12](https://github.com/kentcdodds/clog-cli) - A conventional changelog for the rest of us.
...
- [SVGO ★7371](https://github.com/svg/svgo) - SVG Optimizer is a Nodejs-based tool for optimizing SVG vector graphics files.
...
- [pipes.sh ★399](https://github.com/pipeseroni/pipes.sh) - Shows random pipes that grow across the screen.

## Graphics
- [cli-mandelbrot ★17](https://github.com/danyshaanan/cli-mandelbrot) - A cli for traversing the Mandelbrot fractal.
- [WOPR ★2357 ⏳1Y](https://github.com/yaronn/wopr) - A simple markup language for creating rich terminal reports, presentations and infographics.
- [sparkly-cli ★50 ⏳1Y](https://github.com/sindresorhus/sparkly-cli) - Generate sparklines ▁▂▃▅▂▇..
- [JackPaper ★3](https://github.com/jackel27/jackpaper) - Pull random/queried images from unplash.com and apply to your desktop wallpaper.

## Other

- [app-path-cli ★14 ⏳1Y](https://github.com/sindresorhus/app-path-cli) - Get the path to an app (macOS).
- [Bible.Js CLI client ★115 ⏳1Y](https://github.com/BibleJS/BibleApp) - :book: Bible.JS CLI client. Read the Holy Bible via the command line.
- [birthday ★16](https://github.com/IonicaBizau/birthday) - Know when a friend's birthday is coming.
...
- [get-port-cli ★41](https://github.com/sindresorhus/get-port-cli) - Get an available port.
...
- [yosay ★127](https://github.com/yeoman/yosay) - Like cowsay, but for yeoman.
- [gdb-dashboard ★3611](https://github.com/cyrus-and/gdb-dashboard) - Modular visual interface for GDB in Python.
- [weather-cli ★13](https://github.com/riyadhalnur/weather-cli) - Check the weather for your city from your terminal.
- [hget ★227](https://github.com/bevacqua/hget) - Render websites in plain text from your terminal.
- [ponysay ★553](https://github.com/erkin/ponysay) - Pony rewrite of cowsay.
...
- [trino ★64](https://github.com/eneserdogan/trino) - Trino CLI allows a quick and easy translation of words and phrases entered in the command line.

## Other Awesome Lists

- [awesome-git-addons ★468](https://github.com/stevemao/awesome-git-addons) - A curated list of addons that extends git cli.
