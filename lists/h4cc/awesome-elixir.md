...
* [exactor ★487](https://github.com/sasa1977/exactor) - Helpers for easier implementation of actors in Elixir.
* [exos](https://github.com/awetzel/exos) - A Port Wrapper which forwards cast and call to a linked Port.
* [flowex ★171](https://github.com/antonmi/flowex) - Railway Flow-Based Programming with Elixir GenStage.
...
* [poolboy ★965](https://github.com/devinus/poolboy) - A hunky Erlang worker pool factory.
* [pooler ★246](https://github.com/seth/pooler) - An OTP Process Pool Application.
* [sbroker ★82](https://github.com/fishcakez/sbroker) - Sojourn-time based active queue management library.
...
* [exconstructor ★144](https://github.com/appcues/exconstructor) - An Elixir library for generating struct constructors that handle external data with ease.
...
* [exmatrix ★46 ⏳1Y](https://github.com/a115/exmatrix) - ExMatrix is a small library for working with matrices, originally developed for testing matrix multiplication in parallel.
...
* [fsm ★226](https://github.com/sasa1977/fsm) - Finite state machine as a functional data structure.
* [fuse ★294](https://github.com/jlouis/fuse) - This application implements a so-called circuit-breaker for Erlang.
...
* [loom ★151](https://github.com/asonge/loom) - A CRDT library with δ-CRDT support.
...
* [memoize ★26](https://github.com/os6sense/DefMemo) - A memoization macro (defmemo) for elixir using a genserver backing store.
* [merkle_tree ★33](https://github.com/yosriady/merkle_tree) - A Merkle hash tree implementation in Elixir.
...
* [monadex ★237](https://github.com/rob-brown/MonadEx) - Upgrade your Elixir pipelines with monads.
...
* [paratize ★21](https://github.com/seantanly/elixir-paratize) - Elixir library providing some handy parallel processing (execution) facilities that support configuring number of workers and timeout.
...
* [ratio ★8](https://github.com/Qqwy/elixir-rational) - Adds Rational Numbers and allows them to be used in common arithmatic operations. Also supports conversion between Floats and Rational Numbers.
* [red_black_tree ★22](https://github.com/SenecaSystems/red_black_tree) - Red-Black tree implementation in Elixir.
* [remodel ★102](https://github.com/stavro/remodel) - An Elixir presenter package used to transform map structures.
* [rendezvous ★5 ⏳2Y](https://github.com/timdeputter/Rendezvous) - Implementation of the Rendezvous or Highest Random Weight (HRW) hashing algorithm in Elixir.
* [rock ★2](https://github.com/ayrat555/rock) - Elixir implementation of ROCK: A Robust Clustering Algorithm for Categorical Attributes.
...
* [trie ★95](https://github.com/okeuday/trie) - Erlang Trie Implementation.
* [witchcraft ★197](https://github.com/expede/witchcraft) - Common algebraic structures and functions for Elixir.
...
* [bpe ★84](https://github.com/spawnproc/bpe) - Business Process Engine in Erlang.
...
* [ExChat ★176](https://github.com/tony612/exchat) - A Slack-like app by Elixir, Phoenix & React(redux).
...
* [ExShop ★155 ⏳1Y](https://github.com/authentic-pixels/ex-shop) - Digital goods shop & blog created using Phoenix framework.
...
* [Startup Job ★36](https://github.com/tsurupin/job_search) - An umbrella project to search startup jobs scraped from websites written in Elixir/Phoenix and React/Redux.
* [tty2048 ★135 ⏳1Y](https://github.com/lexmag/tty2048) - Terminal-based 2048 game written in Elixir.

## Artificial Intelligence
*When your code becomes smarter than you.*

* [Exnn ★54](https://github.com/zampino/exnn) - Evolutive Neural Networks framework à la G.Sher written in Elixir.
* [Neat-Ex](https://gitlab.com/onnoowl/Neat-Ex) - An Elixir implementation of the NEAT algorithm.
* [simple_bayes ★282](https://github.com/fredwu/simple_bayes) - A Simple Bayes / Naive Bayes implementation in Elixir.
...
* [goth ★55](https://github.com/peburrows/goth) - OAuth 2.0 library for server to server applications via Google Cloud APIs.
* [guardian ★1835](https://github.com/ueberauth/guardian) - An authentication framework for use with Elixir applications.
...
* [oauth2 ★373](https://github.com/scrogson/oauth2) - An OAuth 2.0 client library for Elixir.
...
* [oauther ★36](https://github.com/lexmag/oauther) - An OAuth 1.0 implementation for Elixir.
* [openmaize ★206](https://github.com/riverrun/openmaize) - Authentication library for Elixir.
* [sesamex ★8](https://github.com/khusnetdinov/sesamex) - Another simple and flexible authentication solution in 5 minutes!.
* [shield ★133](https://github.com/mustafaturan/shield) - An OAuth 2.0 provider library and implementation for Phoenix Framework.
...
* [ueberauth ★616](https://github.com/ueberauth/ueberauth) - An Elixir Authentication System for Plug-based Web Applications.
...
* [ueberauth_facebook ★36](https://github.com/ueberauth/ueberauth_Facebook) - Facebook OAuth2 Strategy for Überauth.
...
* [ueberauth_identity ★42](https://github.com/ueberauth/ueberauth_identity) - A simple username/password strategy for Überauth.
...
* [ueberauth_vk ★8](https://github.com/sobolevn/ueberauth_vk) - [vk.com](https://vk.com) Strategy for Überauth.
...
* [bodyguard ★157](https://github.com/schrockwell/bodyguard) - A flexible authorization library for Phoenix applications.
* [canada ★144](https://github.com/jarednorman/canada) - A simple authorization library that provides a friendly interface using declarative permission rules.
* [canary ★303](https://github.com/cpjk/canary) - An authorization library for Elixir applications that restricts what resources the current user is allowed to access.

## Behaviours and Interfaces
*Definitions how something should behave, like Interfaces from OOP-World*

* [connection ★152](https://github.com/fishcakez/connection) - Connection behaviour for connection processes. The API is superset of the GenServer API.
* [gen_state_machine ★88](https://github.com/antipax/gen_state_machine) - Elixir wrapper for gen_statem.
...
* [benchee ★276](https://github.com/PragTob/benchee) - Easy and extensible benchmarking in Elixir!
* [benchfella ★290](https://github.com/alco/benchfella) - Benchmarking tool for Elixir.
* [bmark ★54](https://github.com/joekain/bmark) - A benchmarking tool for Elixir.
...
* [con_cache ★361](https://github.com/sasa1977/con_cache) - ConCache is an ETS based key/value storage.
...
* [cog ★774](https://github.com/operable/cog) - Cog is an open chatops platform that gives you a secure, collaborative command line right in your chat window.
* [ExIrc ★92](https://github.com/bitwalker/exirc) - IRC client adapter for Elixir projects.
* [ExMustang ★39](https://github.com/techgaun/ex_mustang) - A simple, clueless slackbot and collection of responders.
* [Guri ★16 ⏳1Y](https://github.com/elvio/guri) - Automate tasks using chat messages.
* [hedwig ★367](https://github.com/hedwig-im/hedwig) - XMPP Client/Bot Framework for Elixir.
* [kaguya ★57](https://github.com/Luminarys/Kaguya) - A small, powerful, and modular IRC bot.
...
* [aws ★156](https://github.com/jkakar/aws-elixir) - AWS clients for Elixir.
...
* [Kubex ★28 ⏳2Y](https://github.com/ingerslevio/kubex) - Kubernetes client and integration for Elixir, written in pure Elixir.
* [Leaseweb ★0](https://github.com/Ahamtech/elixir-leaseweb) - Elixir Wrapper for Leaseweb infrastructure.
* [libcluster ★322](https://github.com/bitwalker/libcluster) - Automatic cluster formation/healing for Elixir applications.
* [nodefinder ★35](https://github.com/okeuday/nodefinder) - Strategies for automatic node discovery in Erlang.
...
* [coverex ★71](https://github.com/alfert/coverex) - Coverage Reports for Elixir.
* [credo ★2116](https://github.com/rrrene/credo) - A static code analysis tool with a focus on code consistency and teaching Elixir.
* [dialyxir ★586](https://github.com/jeremyjh/dialyxir) - Mix tasks to simplify use of Dialyzer in Elixir projects.
* [dogma ★434](https://github.com/lpil/dogma) - A code style linter for Elixir, powered by shame.
* [excoveralls ★305](https://github.com/parroty/excoveralls) - Coverage report tool for Elixir with coveralls.io integration.
* [exprof ★73](https://github.com/parroty/exprof) - A simple code profiler for Elixir, using eprof.
...
* [getopt ★200 ⏳1Y](https://github.com/jcomellas/getopt) - Command-line options parser for Erlang.
...
* [progress_bar ★183](https://github.com/henrik/progress_bar) - Command-line progress bars and spinners.
* [table_rex ★65](https://github.com/djm/table_rex) - Generate configurable ASCII style tables for display.
...
* [confex ★76](https://github.com/Nebo15/confex) - Helper module that provides a nice way to read environment configuration at runtime.
* [configparser_ex ★6](https://github.com/easco/configparser_ex) - A simple Elixir parser for the same kind of files that Python's configparser library handles.
* [conform ★292](https://github.com/bitwalker/conform) - Easy release configuration for Elixir apps.
...
* [comeonin ★662](https://github.com/riverrun/comeonin) - Password authorization (bcrypt, pbkdf2_sha512 and one-time passwords) library for Elixir.
...
* [csv ★230](https://github.com/beatrichartz/csv) - CSV Decoding and Encoding for Elixir.
...
* [nimble_csv ★211](https://github.com/plataformatec/nimble_csv) - A simple and fast CSV parsing and dumping library for Elixir.
...
* [crontab ★10](https://github.com/jshmrtn/crontab) - A Cron Expressions Parser, Composer & Date Candidate Finder.
* [ex_ical ★16](https://github.com/fazibear/ex_ical) - ICalendar parser.
* [filtrex ★33](https://github.com/rcdilorenzo/filtrex) - A library for performing and validating complex SQL-like filters from a client (e.g. smart filters).
...
* [quantum ★771](https://github.com/c-rack/quantum-elixir) - Cron-like job scheduler for Elixir applications.
* [repeatex ★27](https://github.com/rcdilorenzo/repeatex) - Natural language parsing for repeating dates.
* [timelier ★9](https://github.com/ausimian/timelier) - A cron-style scheduler for Elixir.
* [timex ★780](https://github.com/bitwalker/timex) - Easy to use Date and Time modules for Elixir.
...
* [tzdata ★51](https://github.com/lau/tzdata) - The timezone database in Elixir.

## Debugging
*Libraries and tools for debugging code and applications.*

* [beaker ★268](https://github.com/hahuang65/beaker) - Statistics and Metrics library for Elixir.
...
* [visualixir ★651](https://github.com/koudelka/visualixir) - A process visualizer for remote BEAM nodes.
...
* [gatling ★402](https://github.com/hashrocket/gatling) - Collection of mix tasks to automatically create a exrm release from git and launch/upgrade it on your server.
...
* [heroku-buildpack-elixir ★561](https://github.com/HashNuke/heroku-buildpack-elixir) - Heroku buildpack to deploy Elixir apps to Heroku.
...
* [bureaucrat ★131](https://github.com/api-hogs/bureaucrat) - Generate Phoenix API documentation from tests.
* [ex_doc ★469](https://github.com/elixir-lang/ex_doc) - ExDoc is a tool to generate documentation for your Elixir projects.
...
* [phoenix_swagger ★229](https://github.com/xerions/phoenix_swagger) - Provides swagger integration to the Phoenix framework.

## Domain-specific language
*Specialized computer languages for a particular application domain.*

* [Absinthe Graphql ★1276](https://github.com/absinthe-graphql/absinthe) - Fully featured GraphQL library.
* [graphql ★737](https://github.com/graphql-elixir/graphql) - An Elixir implementation of Facebook's GraphQL.
...
* [phoenix_gon ★29](https://github.com/khusnetdinov/phoenix_gon) - Allow you to pass Phoenix environment or controller variables to JavaScript without problems.

## Email
*Working with Email and stuff.*

* [bamboo ★728](https://github.com/thoughtbot/bamboo) - Composable, testable and adapter based email library. Out of the box support for rendering with Phoenix and a plug for previewing sent emails in dev.
...
* [gen_smtp ★430](https://github.com/Vagabond/gen_smtp) - A generic Erlang SMTP server and client that can be extended via callback modules.
...
* [ravenx ★47](https://github.com/acutario/ravenx) - Notification dispatch library for Elixir applications.
* [smoothie ★23](https://github.com/jfrolich/smoothie) - Smoothie inline styles of your email templates, and generates a plain text version from the HTML.
* [swoosh ★347](https://github.com/swoosh/swoosh) - Compose, deliver and test your Emails easily in Elixir with adapters for SMTP, Sendgrid, Mandrill, Mailgun, Postmark and Phoenix integration with mailbox preview.
...
* [ex_rlp ★4](https://github.com/exthereum/ex_rlp) - Elixir implementation of Ethereum's RLP (Recursive Length Prefix) encoding.
* [huffman ★15 ⏳2Y](https://github.com/SenecaSystems/huffman) - Huffman encoding and decoding in Elixir.

## Errors and Exception Handling
*Working with errors and exceptions.*

* [exceptional ★83](https://github.com/expede/exceptional) - Helpers for happy-path programming & exception handling.
* [happy ★25](https://github.com/vic/happy) - Happy path programming, alternative to elixir `with` form.
* [OK ★139](https://github.com/CrowdHailer/OK) - Elegant error handling with result monads, featuring a simple & powerful `with` construct and a happy path pipe operator.
* [ok_jose ★51](https://github.com/vic/ok_jose) - Pipe elixir functions that match `{:ok,_}`, `{:error,_}` tuples or custom patterns.
* [sentry-elixir ★154](https://github.com/getsentry/sentry-elixir) - The Official Elixir client for [Sentry](https://sentry.io/).
...
* [elixir_koans ★739](https://github.com/elixirkoans/elixir-koans) - [Elixir koans](http://elixirkoans.io/) is a fun, easy way to get started with the elixir programming language.
...
* [hello_phoenix ★118 ⏳1Y](https://github.com/bigardone/phoenix-react-redux-template) - Application template for SPAs with Phoenix, React and Redux.
* [kaisuu ★60 ⏳1Y](https://github.com/SebastianSzturo/kaisuu) - Watch Japan's Kanji Usage on Twitter in Realtime.
* [koans ★247 ⏳1Y](https://github.com/dojo-toulouse/elixir-koans) - Learn Elixir by using elixir-koans.
...
* [magnetissimo ★2004](https://github.com/sergiotapia/magnetissimo) - Web application that indexes all popular torrent sites, and saves it to the local database.
...
* [fun_with_flags ★62](https://github.com/tompave/fun_with_flags) - A feature toggle library using Redis or Ecto for persistance, an ETS cache for speed and PubSub for distributed cache busting. Comes with a management web UI for Phoenix and Plug.
* [molasses ★53](https://github.com/securingsincity/molasses) - A feature toggle library using redis or SQL (using Ecto) as a backing service.
...
* [eye_drops ★37](https://github.com/rkotze/eye_drops) - Configurable mix task to watch file changes and run the corresponding command.
...
* [addict ★594](https://github.com/trenpixster/addict) - User authentication for Phoenix Framework.
...
* [commanded ★279](https://github.com/slashdotdash/commanded) - Command handling middleware for Command Query Responsibility Segregation (CQRS) applications.
...
* [filterable ★21](https://github.com/omohokcoj/filterable) - Simple query params filtering for Phoenix framework inspired by Rails has_scope.
* [graphql_parser](https://github.com/graphql-elixir/graphql_parser) - An Elixir binding for [libgraphqlparser ★447](https://github.com/graphql/libgraphqlparser).
...
* [kerosene ★135](https://github.com/elixirdrops/kerosene) - Pagination for Ecto and Phoenix.
* [mellon ★12 ⏳1Y](https://github.com/sajmoon/mellon) - An authentication module for Plug applications.
* [multiverse ★22](https://github.com/Nebo15/multiverse) - Plug that allows to add version compatibility layers via API Request/Response Gateways.
* [params ★81](https://github.com/vic/params) - Use Ecto to enforce/validate parameters structure, akin to Rails' strong parameters.
* [passport ★154](https://github.com/opendrops/passport) - Passport provides authentication for Phoenix applications.
* [phoenix_ecto ★128](https://github.com/phoenixframework/phoenix_ecto) - Phoenix and Ecto integration.
* [phoenix_haml ★126](https://github.com/chrismccord/phoenix_haml) - Phoenix Template Engine for Haml.
* [phoenix_html ★117](https://github.com/phoenixframework/phoenix_html) - Phoenix.HTML functions for working with HTML strings and templates.
* [phoenix_html_sanitizer ★13](https://github.com/elixirstatus/phoenix_html_sanitizer) - HTML Sanitizer integration for Phoenix.
* [phoenix_html_simplified_helpers ★15](https://github.com/ikeikeikeike/phoenix_html_simplified_helpers) - Some helpers for phoenix html (truncate, time_ago_in_words, number_with_delimiter).
...
* [plug_and_play ★10](https://github.com/henrik/plug_and_play) - Set up a Plug application with less boilerplate.
...
* [plug_heartbeat ★11 ⏳2Y](https://github.com/whatyouhide/plug_heartbeat) - A plug for responding to heartbeat requests.
...
* [react_phoenix ★172](https://github.com/geolessel/react-phoenix) - Render React.js components in Phoenix views focusing on easy installation and Brunch compatibility.
...
* [scrivener ★346](https://github.com/drewolson/scrivener) - Paginate your Ecto queries.
* [scrivener_headers ★33](https://github.com/doomspork/scrivener_headers) - Helpers for paginating API responses with Scrivener and HTTP headers.
* [scrivener_html ★61](https://github.com/mgwidmann/scrivener_html) - Helpers built to work with Scrivener's page struct to easily build HTML output for various CSS frameworks.
* [sentinel ★97](https://github.com/britton-jb/sentinel) - An authentication framework for Phoenix extending guardian with routing and other basic functionality.
* [trailing_format_plug ★18](https://github.com/mschae/trailing_format_plug) - An Elixir plug to support legacy APIs that use a rails-like trailing format.
...
* [kitto ★581](https://github.com/kittoframework/kitto) - A framework for interactive dashboards.
* [phoenix ★10403](https://github.com/phoenixframework/phoenix) - Elixir Web Framework targeting full-featured, fault tolerant applications with realtime functionality.
* [placid ★141](https://github.com/slogsdon/placid) - A REST toolkit for building highly-scalable and fault-tolerant HTTP APIs with Elixir.
* [rackla ★200 ⏳1Y](https://github.com/AntonFagerberg/rackla) - API Gateways in Elixir.
* [relax ★126 ⏳1Y](https://github.com/AgilionApps/relax) - Simple Elixir implementation of a [jsonapi.org](http://jsonapi.org) server.
* [rest ★45](https://github.com/synrc/rest) - Micro-REST framework with typed JSON.
* [sugar ★330](https://github.com/sugar-framework/sugar) - Modular web framework for Elixir.
* [trot ★228](https://github.com/hexedpackets/trot) - An Elixir web micro-framework.

## Games
*Libraries for and implementations of games.*

* [entice ★66 ⏳1Y](https://github.com/entice/entice) - A distributed Entity-Component-System framework, providing its own example MMORPG server.
* [mines ★22](https://github.com/kevlar1818/mines) - A minesweeper clone in the terminal.
...
* [geo ★290](https://github.com/bryanjos/geo) - A collection of GIS functions for Elixir.
...
* [topo ★27](https://github.com/pkinney/topo) - A Geometry library for Elixir that calculates spatial relationships between two geometries.

## Hardware
*Hardware related things like I/O interfaces and such.*

* [elixir_ale ★218](https://github.com/fhunleth/elixir_ale) - Elixir access to hardware I/O interfaces such as GPIO, I2C, and SPI.
* [nerves ★556](https://github.com/nerves-project/nerves) - Framework for building firmware for platforms like Raspberry Pi and BeagleBone Black.
...
* [elli ★649](https://github.com/knutin/elli) - Elli is a webserver you can run inside your Erlang application to expose an HTTP API.
* [explode ★12](https://github.com/pkinney/explode) - An easy utility for responding with standard HTTP/JSON error payloads in Plug- and Phoenix-based applications.
* [exvcr ★315](https://github.com/parroty/exvcr) - HTTP request/response recording library for Elixir, inspired by VCR.
...
* [hackney ★731](https://github.com/benoitc/hackney) - Simple HTTP client written in Erlang.
...
* [httpoison ★1108](https://github.com/edgurgel/httpoison) - Yet Another HTTP client for Elixir powered by hackney.
* [httpotion ★597](https://github.com/myfreeweb/httpotion) - Fancy HTTP client for Elixir, based on ibrowse.
...
* [mochiweb ★1543](https://github.com/mochi/mochiweb) - MochiWeb is an Erlang library for building lightweight HTTP servers.
* [neuron ★44](https://github.com/uesteibar/neuron) - A GraphQL client for Elixir.
...
* [scrape ★183](https://github.com/Anonyfox/elixir-scrape) - Scrape any website, article or RSS/Atom Feed with ease.
* [spell ★51](https://github.com/MyMedsAndMe/spell) - Spell is a [Web Application Messaging Protocol](http://wamp-proto.org/) (WAMP) client implementation in Elixir.
* [tesla ★425](https://github.com/teamon/tesla) - HTTP client library, with support for middleware and multiple adapters.
...
* [web_socket ★45](https://github.com/slogsdon/plug-web-socket) - An exploration into a stand-alone library for Plug applications to easily adopt WebSockets.
* [webdriver ★83 ⏳1Y](https://github.com/stuart/elixir-webdriver) - This is an implementation of the WebDriver protocol client. It currently supports PhantomJS, FireFox, ChromeDriver and remote webdriver servers (e.g. Selenium).
...
* [alchemic_avatar ★31 ⏳1Y](https://github.com/zhangsoledad/alchemic_avatar) - Elixir library for generating letter avatar from string.
...
* [cloudex ★32](https://github.com/smeevil/cloudex) - Cloudex is an Elixir library that can upload image files or urls to Cloudinary.
...
* [exexif ★14](https://github.com/pragdave/exexif) - Pure Elixir library to extract TIFF and EFIX metadata from jpeg files.
...
* [imagineer ★83](https://github.com/SenecaSystems/imagineer) - Image parsing in Elixir.
* [imgex ★15](https://github.com/ianwalter/imgex) - Unofficial client library for generating imgix URLs in Elixir.
* [mogrify ★204](https://github.com/route/mogrify) - An Elixir wrapper for ImageMagick command line.
...
* [thumbnex ★15](https://github.com/talklittle/thumbnex) - Create thumbnails from images and video screenshots.

## Instrumenting / Monitoring
*Libraries for collecting and exporting metrics.*

* [appsignal-elixir ★51](https://github.com/appsignal/appsignal-elixir) - Collects error and performance data from your Elixir applications and sends it to [AppSignal](https://appsignal.com/).
* [elixometer ★578](https://github.com/pinterest/elixometer) - A light Elixir wrapper around exometer.
* [erlang-metrics ★44](https://github.com/benoitc/erlang-metrics) - A generic interface to different metrics systems in Erlang.
* [exometer ★405](https://github.com/Feuerlabs/exometer) - Basic measurement objects and probe behavior in Erlang.
...
* [instream ★88](https://github.com/mneudert/instream) - InfluxDB driver for Elixir.
...
* [newrelic.ex ★44](https://github.com/romul/newrelic.ex) - Collects metrics from your Elixir/Phoenix application and sends them to [NewRelic](https://newrelic.com/).
* [prometheus ★88](https://github.com/deadtrickster/prometheus.erl) - [Prometheus.io](https://prometheus.io) monitoring system and time series database client in Erlang.
...
* [prometheus.ex ★101](https://github.com/deadtrickster/prometheus.ex) - Elixir-friendly [Prometheus.io](https://prometheus.io) monitoring system and time series database client.
...
* [exjsx ★147](https://github.com/talentdeficit/exjsx) - JSON for Elixir, based on `jsx`.
...
* [joken ★326](https://github.com/bryanjos/joken) - Encodes and decodes JSON Web Tokens.
* [jose ★112](https://github.com/potatosalad/erlang-jose) - JSON Object Signing and Encryption (JOSE) for Erlang and Elixir.
* [json ★185](https://github.com/cblage/elixir-json) - Native JSON library for Elixir.
...
* [json_web_token_ex ★110](https://github.com/garyf/json_web_token_ex) - An Elixir implementation of the JSON Web Token (JWT) Standards Track (RFC 7519).
* [jsonapi ★215](https://github.com/jeregrine/jsonapi) - A project that will render your data models into [JSONAPI Documents](http://jsonapi.org/format/).
* [jsx ★534](https://github.com/talentdeficit/jsx) - An Erlang application for consuming, producing, and manipulating json.
* [jsxn ★30 ⏳2Y](https://github.com/talentdeficit/jsxn) - jsx but with maps.
...
* [poison ★1213](https://github.com/devinus/poison) - Poison is a new JSON library for Elixir focusing on wicked-fast speed without sacrificing simplicity, completeness, or correctness.
...
* [ex_abnf ★23](https://github.com/marcelog/ex_abnf) - Parser for ABNF Grammars in Elixir.
...
* [lager ★21](https://github.com/basho/lager) - A logging framework for Erlang/OTP by basho.com.
* [lager_logger ★18](https://github.com/PSPDFKit-labs/lager_logger) - A lager backend that forwards all log messages to Elixir's Logger.
...
* [logster ★69](https://github.com/navinpeiris/logster) - Easily parsable, one-line logging for Phoenix and Plug applications, inspired by Lograge.
...
* [rollbax ★136](https://github.com/elixir-addicts/rollbax) - Exception tracking and logging to [Rollbar](https://rollbar.com/).
...
* [timber ★60](https://github.com/timberio/timber-elixir) - Structured logging platform; turns raw text logs into rich structured events.
...
* [eventsourced ★77](https://github.com/slashdotdash/eventsourced) - Build functional, event-sourced domain models.
* [exceptional ★83](https://github.com/expede/exceptional) - Helpers for happy-path programming & exception handling.
...
* [mdef ★36 ⏳2Y](https://github.com/pragdave/mdef) - Easily define multiple function heads in Elixir.
* [named_args ★11 ⏳1Y](https://github.com/mgwidmann/named_args) - Allows named arg style arguments in Elixir.
* [OK ★139](https://github.com/CrowdHailer/OK) - Macros for elegant happy path coding, maximizing power and readability.
* [ok_jose ★51](https://github.com/vic/ok_jose) - Pipe elixir functions that match `{:ok,_}`, `{:error,_}` tuples or custom patterns.
...
* [pipe_to ★25 ⏳1Y](https://github.com/taiansu/pipe_to) - The enhanced pipe operator which can specify the target position.
...
* [cmark ★39](https://github.com/asaaki/cmark.ex) - Elixir NIF for CommonMark (in C), a parser following the CommonMark spec.
* [discount ★20 ⏳2Y](https://github.com/asaaki/discount.ex) - Elixir NIF for discount, a Markdown parser.
* [earmark ★318](https://github.com/pragdave/earmark) - Markdown parser for Elixir.
...
* [ecto_autoslug_field ★41](https://github.com/sobolevn/ecto_autoslug_field) - Automatically creates slugs for your Ecto models.
...
* [exsync ★30](https://github.com/falood/exsync) - Yet another Elixir reloader.
...
* [phone ★47](https://github.com/fcevado/phone) - A parser to get useful info from telephone numbers.
* [porcelain ★540](https://github.com/alco/porcelain) - Porcelain implements a saner approach to launching and communicating with external OS processes from Elixir.
...
* [ejabberd ★3162](https://github.com/processone/ejabberd) - Robust, ubiquitous and massively scalable Jabber/XMPP Instant Messaging platform.
...
* [socket ★493](https://github.com/meh/elixir-socket) - Socket wrapping for Elixir.
* [sshex ★79](https://github.com/rubencaro/sshex) - Simple SSH helpers for Elixir.
...
* [amnesia ★422](https://github.com/meh/amnesia) - Mnesia wrapper for Elixir.
* [arbor ★64](https://github.com/coryodaniel/arbor) - Ecto adjacency list and tree traversal.
* [arc_ecto ★155](https://github.com/stavro/arc_ecto) - Arc.Ecto provides an integration with Arc and Ecto.
* [atlas ★192 ⏳2Y](https://github.com/chrismccord/atlas) - Object Relational Mapper for Elixir.
* [Bolt.Sips ★62](https://github.com/florinpatrascu/bolt_sips) - Neo4j driver for Elixir using the Bolt protocol.
...
* [diver ★41 ⏳1Y](https://github.com/novabyte/diver) - A HBase driver for Erlang/Elixir using Jinterface and the Asynchbase Java client to query the database.
...
* [ecto ★2970](https://github.com/elixir-ecto/ecto) - A database wrapper and language integrated query for Elixir.
* [ecto_enum ★198](https://github.com/gjaldon/ecto_enum) - Ecto extension to support enums in models.
* [ecto_factory](https://hex.pm/packages/ecto_factory) - Easily generate structs based on your ecto schemas.
* [ecto_fixtures ★98](https://github.com/DockYard/ecto_fixtures) - Fixtures for Elixir apps using Ecto.
...
* [ecto_mnesia ★74](https://github.com/Nebo15/ecto_mnesia) - Ecto adapter for Mnesia Erlang term database.
...
* [ecto_rut ★62](https://github.com/sheharyarn/ecto_rut) - Simple and Powerful Ecto Shortcuts to simplify and speed up development.
...
* [elastix ★101](https://github.com/werbitzky/elastix) - A simple Elastic REST client written in Elixir.
* [eredis ★508](https://github.com/wooga/eredis) - Erlang Redis client.
* [erlastic_search ★115](https://github.com/tsloughter/erlastic_search) - An Erlang app for communicating with Elastic Search's rest interface.
...
* [eventstore ★260](https://github.com/slashdotdash/eventstore) - A CQRS EventStore using Postgres for persistence, written in Elixir.
...
* [exnumerator ★31](https://github.com/KamilLelonek/exnumerator) - Elixir enumerable type definition in a simple way to be used with any database.
* [exredis ★301](https://github.com/artemeff/exredis) - Redis client for Elixir.
...
* [extreme ★63](https://github.com/exponentially/extreme) - An Elixir library using [Eventstore](https://geteventstore.com) for persistance of events generated by aggregates (CQRS).
* [exts ★7](https://github.com/meh/exts) - Elixir Terms Storage, ets wrapper.
* [github_ecto ★99](https://github.com/wojtekmach/github_ecto) - Ecto adapter for GitHub API.
* [hstore ★9 ⏳2Y](https://github.com/senecasystems/hstore) - Hstore support for Postgrex.
* [inquisitor ★111](https://github.com/dockyard/inquisitor) - Composable query builder for Ecto.
* [isn ★8](https://github.com/Frost/isn) - Ecto types for the postgreSQL isn extension.
* [kalecto ★115](https://github.com/lau/calecto) - Glue between Kalends and Ecto for saving dates, times and datetimes.
* [kst ★123](https://github.com/synrc/kvs) - Erlang Abstract Term Database.
...
* [mariaex ★182](https://github.com/xerions/mariaex) - MariaDB/MySQL driver for Elixir.
* [moebius ★439](https://github.com/robconery/moebius) - A functional query tool for Elixir and PostgreSQL.
* [mongo ★101 ⏳1Y](https://github.com/checkiz/elixir-mongo) - MongoDB driver for Elixir.
...
* [mysql ★210](https://github.com/mysql-otp/mysql-otp) - MySQL/OTP – MySQL driver for Erlang/OTP.
* [mysqlex ★2](https://github.com/tjheeta/mysqlex) - An Ecto-compatible wrapper around the mysql-otp library.
* [neo4j_sips ★66](https://github.com/florinpatrascu/neo4j_sips) - Neo4j driver for Elixir.
...
* [paper_trail ★132](https://github.com/izelnakri/paper_trail) - Ecto plugin for tracking and recording all the changes in your database.
...
* [shards ★168](https://github.com/cabol/shards) - Transparent and out-of-box Sharding support for Erlang/Elixir ETS tables.
...
* [tds ★29](https://github.com/livehelpnow/tds) - MSSQL / TDS Database driver for Elixir.
* [tds_ecto ★47](https://github.com/livehelpnow/tds_ecto) - MSSQL / TDS Adapter for Ecto.
* [timex_ecto ★111](https://github.com/bitwalker/timex_ecto) - An adapter for using Timex DateTimes with Ecto.
* [tirexs ★370](https://github.com/Zatvobor/tirexs) - An Elixir flavored DSL for building JSON based requests to Elasticsearch engine.
...
* [erlexec ★277](https://github.com/saleyn/erlexec) - Execute and control OS processes from Erlang/OTP.
* [immortal ★108 ⏳1Y](https://github.com/danielberkompas/immortal) - Immortal is a small collection of helper modules intended to make it easier to build a fault-tolerant OTP application.
...
* [gutenex ★169](https://github.com/SenecaSystems/gutenex) - Native PDF generation for Elixir.
* [pdf2htmlex ★36 ⏳1Y](https://github.com/ricn/pdf2htmlex) - Convert PDF docs to beautiful HTML files without losing text or format.
* [pdf_generator ★86](https://github.com/gutschilla/elixir-pdf-generator) - A simple wrapper for wkhtmltopdf (HTML to PDF) for use in Elixir projects.
...
* [grpc-elixir ★184](https://github.com/tony612/grpc-elixir) - The Elixir implementation of gRPC.
* [message_pack ★50](https://github.com/mururu/msgpack-elixir) - MessagePack Implementation for Elixir.
* [msgpax ★131](https://github.com/lexmag/msgpax) - MessagePack (de)serializer implementation for Elixir.
...
* [SMPPEX ★21](https://github.com/savonarola/smppex) - SMPP 3.4 protocol and framework implementation in Elixir.
...
* [amqp ★258](https://github.com/pma/amqp) - Simple Elixir wrapper for the Erlang RabbitMQ client, based on Langohr.
...
* [enm ★91](https://github.com/basho/enm) - enm is an Erlang port driver that wraps the nanomsg C library.
* [exdisque](https://github.com/mosic/exdisque) - Elixir client for [Disque ★6374](https://github.com/antirez/disque), an in-memory, distributed job queue.
* [exq ★687](https://github.com/akira/exq) - Job processing library for Elixir - compatible with Resque/Sidekiq.
* [exrabbit ★48 ⏳2Y](https://github.com/d0rc/exrabbit) - RabbitMQ bindings and DSL for Elixir.
* [heapq ★5 ⏳1Y](https://github.com/takscape/elixir-heapq) - A Heap-based Priority Queue Implementation in Elixir.
* [honeydew ★187](https://github.com/koudelka/honeydew) - Honeydew is a worker pool library for Elixir.
* [hulaaki ★83](https://github.com/suvash/hulaaki) - An MQTT 3.1.1 client library written in Elixir.
* [kafka_consumer ★17](https://github.com/anoskov/kafka-consumer) - Consumer for Kafka using kafka_ex.
* [kafka_ex ★206](https://github.com/kafkaex/kafka_ex) - Kafka client library for Elixir.
...
* [que ★245](https://github.com/sheharyarn/que) - Simple Background Job Processing with Mnesia.
...
* [task_bunny ★100](https://github.com/shinyscorpion/task_bunny) - background processing application written in Elixir and uses RabbitMQ as a messaging backend.
* [toniq ★241](https://github.com/joakimk/toniq) - Simple and reliable background job library for Elixir.
* [verk ★377](https://github.com/edgurgel/verk) - Verk is a job processing system backed by Redis. It uses the same job definition of Sidekiq/Resque.
...
* [distillery ★1362](https://github.com/bitwalker/distillery) - A pure Elixir implementation of release packaging functionality for the Erlang VM.
* [eliver ★25](https://github.com/glasnoster/eliver) - Interactive semantic versioning for Elixir packages.
* [exrm ★929](https://github.com/bitwalker/exrm) - Automatically generate a release for your Elixir project.
* [exrm_deb ★71](https://github.com/johnhamelink/exrm_deb) - Create a deb for your Elixir release with ease.
...
* [mix_docker ★255](https://github.com/Recruitee/mix_docker) - Put your Elixir app production release inside minimal docker image.
...
* [detergent ★48](https://github.com/devinus/detergent) - An emulsifying Erlang SOAP library.
...
* [blogit ★11](https://github.com/meddle0x53/blogit) - An OTP application for generating blogs from git repositories containing markdown files.
* [coil ★51 ⏳3Y](https://github.com/badosu/coil) - Minimalistic static content engine.
* [obelisk ★261](https://github.com/BennyHallett/obelisk) - Static blog and website generator.
* [serum ★48](https://github.com/Dalgona/Serum) - A simple static website generator written in Elixir.
...
* [numerix ★57](https://github.com/safwank/Numerix) - A collection of useful mathematical functions with a slant towards statistics, linear algebra and machine learning.
* [statistics ★52](https://github.com/msharp/elixir-statistics) - Some basic statistical functions for Elixir.
...
* [bbmustache ★66](https://github.com/soranoba/bbmustache) - Binary pattern match Based Mustache template engine for Erlang/OTP.
* [eml ★79](https://github.com/zambal/eml) - Library for writing and manipulating (HTML) markup in Elixir.
...
* [mustache ★17](https://github.com/schultyy/Mustache.ex) - Mustache templates for Elixir.
...
* [espec ★458](https://github.com/antonmi/espec) - BDD test framework for Elixir inspired by RSpec.
* [espec_phoenix ★94](https://github.com/antonmi/espec_phoenix) - ESpec for Phoenix web framework.
* [ex_machina ★802](https://github.com/thoughtbot/ex_machina) - Flexible test factories for Elixir. Works out of the box with Ecto and Ecto associations.
* [ex_parameterized ★9](https://github.com/KazuCocoa/ex_parameterized) - Simple macro for parameterized testing.
...
* [ex_unit_notifier ★55](https://github.com/navinpeiris/ex_unit_notifier) - Desktop notifications for ExUnit.
* [excheck ★240](https://github.com/parroty/excheck) - Property-based testing library for Elixir (QuickCheck style).
...
* [faker ★319](https://github.com/igas/faker) - Faker is a pure Elixir library for generating fake data.
...
* [hound ★851](https://github.com/HashNuke/hound) - Elixir library for writing integration tests and browser automation.
...
* [mix_test_watch ★341](https://github.com/lpil/mix-test.watch) - Automatically run your Elixir project's tests each time you save a file.
* [mixunit ★2 ⏳2Y](https://github.com/talentdeficit/mixunit) - An EUnit task for Mix based projects.
* [mock ★257](https://github.com/jjh42/mock) - Mocking library for the Elixir language.
...
* [ponos ★99 ⏳1Y](https://github.com/klarna/ponos) - Ponos is an Erlang application that exposes a flexible load generator API.
...
* [proper ★551](https://github.com/manopapad/proper) - PropEr (PROPerty-based testing tool for ERlang) is a QuickCheck-inspired open-source property-based testing tool for Erlang.
...
* [wallaby ★518](https://github.com/keathley/wallaby) - Wallaby helps test your web applications by simulating user interactions concurrently and manages browsers.
* [white_bread ★128](https://github.com/meadsteve/white-bread) - Story based BDD in Elixir using the gherkin syntax.
...
* [decimal ★142](https://github.com/ericmj/decimal) - Arbitrary precision decimal arithmetic for Elixir.
* [dicer ★3 ⏳2Y](https://github.com/olhado/dicer) - A dice roller expression evaluator.
* [eden](https://github.com/jfacorro/Eden) - [EDN ★1523 ⏳1Y](https://github.com/edn-format/edn) encoder/decoder for Elixir.
* [elixilorem ★6](https://github.com/mgamini/elixilorem) - Lorem Ipsum generator for Elixir.
...
* [erldn](https://github.com/marianoguerra/erldn) - [EDN ★1523 ⏳1Y](https://github.com/edn-format/edn) format parser for the Erlang platform.
...
* [hashids ★132](https://github.com/alco/hashids-elixir) - Hashids lets you obfuscate numerical identifiers via reversible mapping.
* [hexate ★20](https://github.com/rjsamson/hexate) - Simple module for Hex encoding / decoding in Elixir.
* [html_sanitize_ex ★80](https://github.com/rrrene/html_sanitize_ex) - HTML sanitizer for Elixir.
...
* [inflex ★109](https://github.com/nurugger07/inflex) - An Inflector library for Elixir.
...
* [mbcs ★15](https://github.com/woxtu/elixir-mbcs) - Wrapper for erlang-mbcs. This module provides functions for character encoding conversion.
* [mimetype_parser ★3](https://github.com/camshaft/mimetype_parser) - parse mimetypes.
* [monetized ★31](https://github.com/theocodes/monetized) - A lightweight solution for handling and storing money.
* [money ★134](https://github.com/liuggio/money) - Working with Money safer, easier, and fun, interpretation of the Fowler's Money pattern.
...
* [number ★74](https://github.com/danielberkompas/number) - Number is a pretentiously-named Elixir library which provides functions to convert numbers into a variety of different formats.
...
* [slime ★166](https://github.com/slime-lang/slime) - An Elixir library for rendering slim-like templates.
* [slugger ★92](https://github.com/h4cc/slugger) - Slugger can generate slugs from given strings that can be used in URLs or file names.
...
* [ua_inspector ★29](https://github.com/elixytics/ua_inspector) - User agent parser library like `piwik/device-detector`.
...
* [uuid ★176](https://github.com/zyro/elixir-uuid) - UUID generator and utilities for Elixir.
* [uuid_erl ★136](https://github.com/okeuday/uuid) - Erlang Native UUID Generation.
...
* [cashier ★17](https://github.com/swelham/cashier) - Payment gateway offering a common interface into multiple payment providers.
...
* [commerce_billing ★123](https://github.com/joshnuss/commerce_billing) - A payment-processing library for Elixir that supports multiple gateways (e.g. Bogus & Stripe).
...
* [diplomat ★47](https://github.com/peburrows/diplomat) - A [Google Cloud Datastore](https://cloud.google.com/datastore/) client.
...
* [elixir_authorizenet ★6](https://github.com/marcelog/elixir_authorizenet) - Unofficial client for the Authorize.Net merchant API.
...
* [elixtagram ★54](https://github.com/zensavona/elixtagram) - Instagram API client for Elixir.
...
* [exstagram ★10 ⏳1Y](https://github.com/arthurcolle/exstagram) - Elixir library for Instagram v1 API.
* [extripe ★20](https://github.com/princemaple/extripe) - Feature complete Stripe API wrapper.
* [extwitter ★272](https://github.com/parroty/extwitter) - Twitter client library for Elixir.
* [exurban ★1 ⏳2Y](https://github.com/oscar-lopez/exurban) - Elixir wrapper for UrbanAirship API.
* [facebook ★75](https://github.com/mweibel/facebook.ex) - Facebook Graph API Wrapper written in Elixir.
...
* [forcex ★30](https://github.com/jeffweiss/forcex) - Elixir library for the Force.com REST API.
...
* [statix ★83](https://github.com/lexmag/statix) - Expose app metrics in the StatsD protocol.
...
* [dress ★37](https://github.com/veelenga/dress) - Cli app that makes your stdout fancy.
* [erlang-history ★462](https://github.com/ferd/erlang-history) - Hacks to add shell history to Erlang's shell.
...
* [erlware_commons ★157](https://github.com/erlware/erlware_commons) - Additional standard library for Erlang.
...
* [retry ★85](https://github.com/safwank/ElixirRetry) - Simple Elixir macros for linear retry, exponential backoff and wait with composable delays.
...
* [sitemap ★48](https://github.com/ikeikeikeike/sitemap) - Sitemap is the easiest way to generate Sitemaps in Elixir.
...
* [exop ★36](https://github.com/madeinussr/exop) - A library that allows to encapsulate business logic and validate params with predefined contract.
...
* [vex ★254](https://github.com/CargoSense/vex) - An extensible data validation library for Elixir.
...
* [ffmpex ★50](https://github.com/talklittle/ffmpex) - FFmpeg command line wrapper.
...
* [erlsom ★181](https://github.com/willemdj/erlsom) - Erlsom is an Erlang library to parse (and generate) XML documents.
...
* [floki ★679](https://github.com/philss/floki) - A simple HTML parser that enables searching using CSS like selectors.
...
* [yamerl ★118](https://github.com/yakaz/yamerl) - YAML 1.2 parser in Erlang.
...
* [Getting Started - Elixir ★62 ⏳1Y](https://github.com/potatogopher/elixir-getting-started) - PDF, MOBI, and EPUB documents for Elixir's Getting Started tutorial (2016).
...
* [Études for Elixir](http://chimera.labs.oreilly.com/books/1234000001642) - A collection of exercises to program in Elixir by J. David Eisenberg (2013) ([Github Repo ★416](https://github.com/oreillymedia/etudes-for-elixir)).
...
* [Alchemist ★690](https://github.com/tonini/alchemist.el) - Elixir Tooling Integration Into Emacs.
* [Alchemist-Server ★172](https://github.com/tonini/alchemist-server) - Editor/IDE independent background server to inform about Elixir mix projects.
* [Alchemist.vim ★393](https://github.com/slashmili/alchemist.vim) - Elixir Tooling Integration Into Vim.
* [Atom](https://atom.io/packages/language-elixir) - Elixir language support for Atom.
* [atom-elixir ★403](https://github.com/msaraiva/atom-elixir) - An Atom package for Elixir.
...
* [ElixirSublime ★348](https://github.com/vishnevskiy/ElixirSublime) - Elixir plugin for SublimeText 3 that provides code completion and linting.
...
* [vscode-elixir ★0](https://github.com/mat-mcloughlin/vscode-elixir) - Elixir Support for Visual Studio Code.
...
## Other Awesome Lists
*Other amazingly awesome lists can be found at [jnv/lists](https://github.com/jnv/lists#lists-of-lists) or [bayandin/awesome-awesomeness ★19700](https://github.com/bayandin/awesome-awesomeness#awesome-awesomeness).*

* [Awesome Elixir by LibHunt](https://elixir.libhunt.com) - A curated list of awesome Elixir and Erlang packages and resources.
* [Awesome Erlang ★735](https://github.com/drobakowski/awesome-erlang) - A curated list of awesome Erlang libraries, resources and shiny things.
* [Erlang Bookmarks ★996](https://github.com/0xAX/erlang-bookmarks) - A collection of links for Erlang developers.
...
* [Elixir Functional Programming ★212](https://github.com/kblake/functional-programming) - Material to introduce functional programming using the Elixir language.
...
* [christopheradams/elixir_style_guide ★2365](https://github.com/christopheradams/elixir_style_guide) - A community-driven style guide for Elixir.
* [lexmag/elixir-style-guide ★267](https://github.com/lexmag/elixir-style-guide) - An opinionated Elixir style guide.
* [rrrene/elixir-style-guide](https://github.com/rrrene/elixir-style-guide) - Style guide checked by [Credo ★2116](https://github.com/rrrene/credo).

## Websites
*Useful Elixir-related websites.*

* [30 Days of Elixir ★2111](https://github.com/seven1m/30-days-of-elixir) - A walk through the Elixir language in 30 exercises.
...
* [Elixir China ★194](https://github.com/jw2013/elixir-china) - Chinese Elixir website [elixir-cn.com](http://elixir-cn.com/).
...
* [Elixir Github Repository ★11088](https://github.com/elixir-lang/elixir) - The project repository.
* [Elixir Github Wiki](https://github.com/elixir-lang/elixir/wiki) - The project's wiki, containing much useful information.
* [Elixir Job Board](http://jobs.elixirdose.com) - A job board for Elixir, and community of Elixir developers, [written using Phoenix ★81](https://github.com/rizafahmi/elixirjobs).
