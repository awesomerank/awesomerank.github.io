...
* [exactor ★462](https://github.com/sasa1977/exactor) - Helpers for easier implementation of actors in Elixir.
* [exos](https://github.com/awetzel/exos) - A Port Wrapper which forwards cast and call to a linked Port.
* [flowex ★134](https://github.com/antonmi/flowex) - Railway Flow-Based Programming with Elixir GenStage.
...
* [poolboy ★912](https://github.com/devinus/poolboy) - A hunky Erlang worker pool factory.
* [pooler ★239](https://github.com/seth/pooler) - An OTP Process Pool Application.
* [sbroker ★73](https://github.com/fishcakez/sbroker) - Sojourn-time based active queue management library.
...
* [cuid ★18 ⏳2Y](https://github.com/duailibe/cuid) - Collision-resistant ids optimized for horizontal scaling and sequential lookup performance, written in Elixir.
* [data_morph](https://hex.pm/packages/data_morph) - Create Elixir structs from data.
* [dataframe ★13](https://github.com/JordiPolo/dataframe) - Package providing functionality similar to Python's Pandas or R's data.frame().
* [datastructures ★164](https://github.com/meh/elixir-datastructures) - A collection of protocols, implementations and wrappers to work with data structures.
...
* [ecto_state_machine ★36](https://github.com/asiniy/ecto_state_machine) - Finite state machine pattern implemented on Elixir and  adopted for Ecto.
...
* [exconstructor ★131](https://github.com/appcues/exconstructor) - An Elixir library for generating struct constructors that handle external data with ease.
...
* [fsm ★206](https://github.com/sasa1977/fsm) - Finite state machine as a functional data structure.
* [fuse ★276](https://github.com/jlouis/fuse) - This application implements a so-called circuit-breaker for Erlang.
* [gen_fsm ★31 ⏳1Y](https://github.com/pavlos/gen_fsm) - A generic finite state-machine - Elixir wrapper around OTP's gen_fsm.
* [graphmath ★41](https://github.com/crertel/graphmath) - An Elixir library for performing 2D and 3D mathematics.
...
* [loom ★143](https://github.com/asonge/loom) - A CRDT library with δ-CRDT support.
...
* [merkle_tree ★27](https://github.com/yosriady/merkle_tree) - A Merkle hash tree implementation in Elixir.
...
* [monad ★102 ⏳1Y](https://github.com/rmies/monad) - Haskell inspired monads in Elixir stylish syntax.
* [monadex ★221](https://github.com/rob-brown/MonadEx) - Upgrade your Elixir pipelines with monads.
...
* [paratize ★18](https://github.com/seantanly/elixir-paratize) - Elixir library providing some handy parallel processing (execution) facilities that support configuring number of workers and timeout.
...
* [remodel ★91](https://github.com/stavro/remodel) - An Elixir presenter package used to transform map structures.
...
* [witchcraft ★103](https://github.com/expede/witchcraft) - Common algebraic structures and functions for Elixir.
...
* [bpe ★78](https://github.com/spawnproc/bpe) - Business Process Engine in Erlang.
...
* [ExChat ★163](https://github.com/tony612/exchat) - A Slack-like app by Elixir, Phoenix & React(redux).
...
* [ExShop ★145](https://github.com/authentic-pixels/ex-shop) - Digital goods shop & blog created using Phoenix framework.
* [Hydra ★35 ⏳1Y](https://github.com/doomspork/hydra) - A multi-headed beast: API gateway, request cache, and data transformations.
...
* [n2o ★1052](https://github.com/synrc/n2o) - WebSocket Application Server.
* [Nvjorn ★6](https://github.com/tchoutri/Nvjorn) - A multi-protocol network services monitor written in Elixir using Poolboy.
* [Phoenix Battleship ★386](https://github.com/bigardone/phoenix-battleship) - The Good Old game built with Elixir, Phoenix Framework, React and Redux.
...
* [Phoenix Trello ★1822](https://github.com/bigardone/phoenix-trello) - Trello tribute done in Elixir, Phoenix Framework, React and Redux.
* [poxa ★602](https://github.com/edgurgel/poxa) - Open Pusher implementation, compatible with Pusher libraries.
* [Queerlink ★19 ⏳1Y](https://github.com/Queertoo/Queerlink) - A simple yet efficient URL shortening service written in Elixir.
* [Sprint Poker ★142](https://github.com/elpassion/sprint-poker) - Online estimation tool for Agile teams, written using Elixir Lang, Phoenix Framework and React.
* [Startup Job ★24](https://github.com/tsurupin/job_search) - An umbrella project to search startup jobs scraped from websites written in Elixir/Phoenix and React/Redux.
* [tty2048 ★131 ⏳1Y](https://github.com/lexmag/tty2048) - Terminal-based 2048 game written in Elixir.

## Artificial Intelligence
*When your code becomes smarter than you.*

* [Exnn ★47](https://github.com/zampino/exnn) - Evolutive Neural Networks framework à la G.Sher written in Elixir.
* [Neat-Ex](https://gitlab.com/onnoowl/Neat-Ex) - An Elixir implementation of the NEAT algorithm.
* [simple_bayes ★259](https://github.com/fredwu/simple_bayes) - A Simple Bayes / Naive Bayes implementation in Elixir.

## Audio and Sounds
*Libraries working with sounds and tones.*

* [erlaudio ★16 ⏳1Y](https://github.com/asonge/erlaudio) - Erlang PortAudio bindings.
* [synthex ★25](https://github.com/bitgamma/synthex) - A signal synthesis library.
...
* [coherence ★553](https://github.com/smpallen99/coherence) - Coherence is a full featured, configurable authentication system for Phoenix.
...
* [goth ★47](https://github.com/peburrows/goth) - OAuth 2.0 library for server to server applications via Google Cloud APIs.
* [guardian ★1664](https://github.com/ueberauth/guardian) - An authentication framework for use with Elixir applications.
...
* [oauth2 ★350](https://github.com/scrogson/oauth2) - An OAuth 2.0 client library for Elixir.
...
* [oauther ★34](https://github.com/lexmag/oauther) - An OAuth 1.0 implementation for Elixir.
...
* [shield ★113](https://github.com/mustafaturan/shield) - An OAuth 2.0 provider library and implementation for Phoenix Framework.
...
* [ueberauth ★551](https://github.com/ueberauth/ueberauth) - An Elixir Authentication System for Plug-based Web Applications.
...
* [ueberauth_facebook ★34](https://github.com/ueberauth/ueberauth_Facebook) - Facebook OAuth2 Strategy for Überauth.
* [ueberauth_foursquare ★0](https://github.com/borodiychuk/ueberauth_foursquare) - Foursquare OAuth2 Strategy for Überauth.
* [ueberauth_github ★31](https://github.com/ueberauth/ueberauth_github) - A GitHub strategy for Überauth.
...
* [authorize ★30](https://github.com/jfrolich/authorize) - Rule based authorization, for advanced authorization rules.
* [bodyguard ★117](https://github.com/schrockwell/bodyguard) - A flexible authorization library for Phoenix applications.
* [canada ★123](https://github.com/jarednorman/canada) - A simple authorization library that provides a friendly interface using declarative permission rules.
* [canary ★274](https://github.com/cpjk/canary) - An authorization library for Elixir applications that restricts what resources the current user is allowed to access.

## Behaviours and Interfaces
*Definitions how something should behave, like Interfaces from OOP-World*

* [connection ★143](https://github.com/fishcakez/connection) - Connection behaviour for connection processes. The API is superset of the GenServer API.
* [gen_state_machine ★73](https://github.com/antipax/gen_state_machine) - Elixir wrapper for gen_statem.
...
* [benchee ★219](https://github.com/PragTob/benchee) - Easy and extensible benchmarking in Elixir!
* [benchfella ★241](https://github.com/alco/benchfella) - Benchmarking tool for Elixir.
...
* [pc ★26](https://github.com/blt/port_compiler) - A rebar3 port compiler.
...
* [relx ★453](https://github.com/erlware/relx) - A release assembler for Erlang.
* [remix ★65](https://github.com/AgilionApps/remix) - Automatic recompilation of Mix code on file change.
...
* [con_cache ★320](https://github.com/sasa1977/con_cache) - ConCache is an ETS based key/value storage.
...
* [locker ★130 ⏳1Y](https://github.com/wooga/locker) - Atomic distributed "check and set" for short-lived keys.
...
* [ExMustang ★34](https://github.com/techgaun/ex_mustang) - A simple, clueless slackbot and collection of responders.
* [Guri ★14 ⏳1Y](https://github.com/elvio/guri) - Automate tasks using chat messages.
* [hedwig ★338](https://github.com/hedwig-im/hedwig) - XMPP Client/Bot Framework for Elixir.
* [kaguya ★53](https://github.com/Luminarys/Kaguya) - A small, powerful, and modular IRC bot.
* [slacker ★72 ⏳1Y](https://github.com/koudelka/slacker) - A bot library for the Slack chat service.
* [yocingo ★27](https://github.com/Yawolf/yocingo) - Create your own Telegram Bot.

## Cloud Infrastructure and Management
*Applications, tools and libraries for your own cloud service.*

* [aws ★142](https://github.com/jkakar/aws-elixir) - AWS clients for Elixir.
* [Cloudi](http://cloudi.org/) - CloudI is for back-end server processing tasks that require soft-realtime transaction.
* [discovery ★194](https://github.com/undeadlabs/discovery) - An OTP application for auto-discovering services with Consul.
* [erlcloud ★500](https://github.com/erlcloud/erlcloud) - Cloud Computing library for Erlang (Amazon EC2, S3, SQS, SimpleDB, Mechanical Turk, ELB).
* [ex_aws ★429](https://github.com/CargoSense/ex_aws) - AWS client, supporting Dynamo, Kinesis, Lambda, SQS, and S3.
...
* [IElixir ★118](https://github.com/pprzetacznik/IElixir) - Jupyter's kernel for Elixir programming language.
...
* [libcluster ★250](https://github.com/bitwalker/libcluster) - Automatic cluster formation/healing for Elixir applications.
...
* [dogma ★391](https://github.com/lpil/dogma) - A code style linter for Elixir, powered by shame.
* [excoveralls ★269](https://github.com/parroty/excoveralls) - Coverage report tool for Elixir with coveralls.io integration.
* [exprof ★64 ⏳1Y](https://github.com/parroty/exprof) - A simple code profiler for Elixir, using eprof.

## Command Line Applications
*Anything helpful for building CLI applications.*

* [anubis ★79](https://github.com/bennyhallett/anubis) - Command-Line application framework for Elixir.
...
* [getopt ★197 ⏳1Y](https://github.com/jcomellas/getopt) - Command-line options parser for Erlang.
...
* [optimus ★21](https://github.com/savonarola/optimus) - Command-line option parser for Elixir inspired by [clap.rs](https://clap.rs/).
* [progress_bar ★169](https://github.com/henrik/progress_bar) - Command-line progress bars and spinners.
* [table_rex ★59](https://github.com/djm/table_rex) - Generate configurable ASCII style tables for display.
...
* [confex ★40](https://github.com/Nebo15/confex) - Helper module that provides a nice way to read environment configuration at runtime.
...
* [conform ★255](https://github.com/bitwalker/conform) - Easy release configuration for Elixir apps.
* [dotenv ★125](https://github.com/avdi/dotenv_elixir) - A port of dotenv to Elixir.
...
* [cipher ★21](https://github.com/rubencaro/cipher) - Elixir crypto library to encrypt/decrypt arbitrary binaries.
* [cloak ★136](https://github.com/danielberkompas/cloak) - Cloak makes it easy to use encryption with Ecto.
* [comeonin ★588](https://github.com/riverrun/comeonin) - Password authorization (bcrypt, pbkdf2_sha512 and one-time passwords) library for Elixir.
...
* [ex_crypto ★30](https://github.com/ntrepid8/ex_crypto) - Elixir wrapper for Erlang `crypto` and `public_key` modules. Provides sensible defaults for many crypto functions to make them easier to use.
* [exgpg ★7 ⏳1Y](https://github.com/rozap/exgpg) - Use gpg from Elixir.
* [pot ★43](https://github.com/yuce/pot) - Erlang library for generating one time passwords compatible with Google Authenticator.
...
* [csv ★206](https://github.com/beatrichartz/csv) - CSV Decoding and Encoding for Elixir.
...
* [nimble_csv ★181](https://github.com/plataformatec/nimble_csv) - A simple and fast CSV parsing and dumping library for Elixir.
...
* [calendar ★263](https://github.com/lau/calendar) - Calendar is a date and time library for Elixir.
...
* [filtrex ★31](https://github.com/rcdilorenzo/filtrex) - A library for performing and validating complex SQL-like filters from a client (e.g. smart filters).
...
* [quantum ★709](https://github.com/c-rack/quantum-elixir) - Cron-like job scheduler for Elixir applications.
...
* [timex ★712](https://github.com/bitwalker/timex) - Easy to use Date and Time modules for Elixir.
...
* [beaker ★264](https://github.com/hahuang65/beaker) - Statistics and Metrics library for Elixir.
* [booter ★13 ⏳2Y](https://github.com/eraserewind/booter) - Boot an Elixir application, step by step.
* [dbg ★112](https://github.com/fishcakez/dbg) - Distributed tracing for Elixir.
* [eflame ★241](https://github.com/proger/eflame) - Flame Graph profiler for Erlang.
* [eh ★14 ⏳1Y](https://github.com/Frost/eh) - A tool to look up Elixir documentation from the command line.
* [eper ★392](https://github.com/massemanet/eper) - Erlang performance and debugging tools.
...
* [observer_cli ★328](https://github.com/zhongwencool/observer_cli) - Visualize Elixir & Erlang nodes on the command line, it aims to helpe developers debug production systems.
* [quaff ★56](https://github.com/qhool/quaff) - The Debug module provides a simple helper interface for running Elixir code in the erlang graphical debugger.
...
* [ansible-elixir-stack ★248](https://github.com/HashNuke/ansible-elixir-stack) - 1-command setup & deploys to servers, with first-class support for Phoenix apps.
...
* [gatling ★362](https://github.com/hashrocket/gatling) - Collection of mix tasks to automatically create a exrm release from git and launch/upgrade it on your server.
* [heroku-buildpack-elixir ★528](https://github.com/HashNuke/heroku-buildpack-elixir) - Heroku buildpack to deploy Elixir apps to Heroku.
* [Nanobox ★957](https://github.com/nanobox-io/nanobox) - A micro-PaaS (μPaaS) for creating consistent, isolated, development environments deployable anywhere https://nanobox.io.

## Documentation
*Libraries and tools for creating documentation.*

* [bureaucrat ★121](https://github.com/api-hogs/bureaucrat) - Generate Phoenix API documentation from tests.
* [ex_doc ★414](https://github.com/elixir-lang/ex_doc) - ExDoc is a tool to generate documentation for your Elixir projects.
...
* [phoenix_swagger ★197](https://github.com/xerions/phoenix_swagger) - Provides swagger integration to the Phoenix framework.

## Domain-specific language
*Specialized computer languages for a particular application domain.*

* [Absinthe Graphql ★1035](https://github.com/absinthe-graphql/absinthe) - Fully featured GraphQL library.
* [graphql ★681](https://github.com/graphql-elixir/graphql) - An Elixir implementation of Facebook's GraphQL.
...
* [phoenix_gon ★17](https://github.com/khusnetdinov/phoenix_gon) - Allow you to pass Phoenix environment or controller variables to JavaScript without problems.

## Email
*Working with Email and stuff.*

* [bamboo ★653](https://github.com/thoughtbot/bamboo) - Composable, testable and adapter based email library. Out of the box support for rendering with Phoenix and a plug for previewing sent emails in dev.
...
* [gen_smtp ★424](https://github.com/Vagabond/gen_smtp) - A generic Erlang SMTP server and client that can be extended via callback modules.
* [gmail ★34](https://github.com/craigp/elixir-gmail) - A simple Gmail REST API client for Elixir.
* [mail ★250](https://github.com/DockYard/elixir-mail) - An RFC2822 implementation in Elixir, built for composability.
...
* [mailman ★139](https://github.com/kamilc/mailman) - Mailman provides a clean way of defining mailers in your Elixir applications.
...
* [ravenx ★42](https://github.com/acutario/ravenx) - Notification dispatch library for Elixir applications.
* [smoothie ★18](https://github.com/jfrolich/smoothie) - Smoothie inline styles of your email templates, and generates a plain text version from the HTML.
* [swoosh ★321](https://github.com/swoosh/swoosh) - Compose, deliver and test your Emails easily in Elixir with adapters for SMTP, Sendgrid, Mandrill, Mailgun, Postmark and Phoenix integration with mailbox preview.
...
* [OK ★114](https://github.com/CrowdHailer/OK) - Elegant error handling with result monads, featuring a simple & powerful `with` construct and a happy path pipe operator.
* [ok_jose ★47](https://github.com/vic/ok_jose) - Pipe elixir functions that match `{:ok,_}`, `{:error,_}` tuples or custom patterns.
* [sentry-elixir ★124](https://github.com/getsentry/sentry-elixir) - The Official Elixir client for [Sentry](https://sentry.io/).

## Eventhandling
*Sending/Emitting and receiving/handling Events in Elixir.*

* [goldrush ★58](https://github.com/DeadZen/goldrush) - Small, Fast event processing and monitoring for Erlang/OTP applications.
* [reaxive ★135 ⏳1Y](https://github.com/alfert/reaxive) - Reaxive is a reactive event handling library, inspired by [Elm](http://elm-lang.org) and Reactive Extensions.
...
* [elixir_koans ★586](https://github.com/elixirkoans/elixir-koans) - [Elixir koans](http://elixirkoans.io/) is a fun, easy way to get started with the elixir programming language.
...
* [kaisuu ★59 ⏳1Y](https://github.com/SebastianSzturo/kaisuu) - Watch Japan's Kanji Usage on Twitter in Realtime.
...
* [magnetissimo ★1938](https://github.com/sergiotapia/magnetissimo) - Web application that indexes all popular torrent sites, and saves it to the local database.
* [oop ★113](https://github.com/wojtekmach/oop) - OOP in Elixir!
...
* [portal ★31](https://github.com/josevalim/portal) - A shooting fault-tolerant doors for distributed portal data-transfer application in Elixir.
...
* [weather ★60 ⏳1Y](https://github.com/tacticiankerala/elixir-weather) - A command line weather app built using Elixir.
...
* [feeder_ex ★40](https://github.com/manukall/feeder_ex) - RSS feed parser. Simple wrapper for feeder.
...
* [arc ★602](https://github.com/stavro/arc) - Flexible file upload and attachment library for Elixir.
...
* [exfile ★58](https://github.com/keichan34/exfile) - File upload handling, persistence, and processing in Elixir and Plug.
...
* [fs ★128](https://github.com/synrc/fs) - Erlang FileSystem Listener.
...
* [absinthe_plug ★62](https://github.com/absinthe-graphql/absinthe_plug) - Plug support for Absinthe.
* [addict ★573](https://github.com/trenpixster/addict) - User authentication for Phoenix Framework.
...
* [commanded ★213](https://github.com/slashdotdash/commanded) - Command handling middleware for Command Query Responsibility Segregation (CQRS) applications.
* [cors_plug ★123](https://github.com/mschae/cors_plug) - An Elixir plug that adds CORS headers to requests and responds to preflight requests (OPTIONS).
* [corsica ★184](https://github.com/whatyouhide/corsica) - Elixir library for dealing with CORS requests.
* [crudex ★13 ⏳2Y](https://github.com/bitgamma/crudex) - CRUD utilities for Phoenix and Ecto.
* [dayron ★124](https://github.com/inaka/Dayron) - A repository _similar_ to `Ecto.Repo` that works with REST API requests instead of a database.
* [ex_admin ★754](https://github.com/smpallen99/ex_admin) - ExAdmin is an auto administration package for Elixir and the Phoenix Framework.
...
* [graphql_parser](https://github.com/graphql-elixir/graphql_parser) - An Elixir binding for [libgraphqlparser ★413](https://github.com/graphql/libgraphqlparser).
...
* [kerosene ★129](https://github.com/elixirdrops/kerosene) - Pagination for Ecto and Phoenix.
...
* [params ★62](https://github.com/vic/params) - Use Ecto to enforce/validate parameters structure, akin to Rails' strong parameters.
* [passport ★148](https://github.com/opendrops/passport) - Passport provides authentication for Phoenix applications.
* [phoenix_ecto ★117](https://github.com/phoenixframework/phoenix_ecto) - Phoenix and Ecto integration.
* [phoenix_haml ★123](https://github.com/chrismccord/phoenix_haml) - Phoenix Template Engine for Haml.
* [phoenix_html ★101](https://github.com/phoenixframework/phoenix_html) - Phoenix.HTML functions for working with HTML strings and templates.
* [phoenix_html_sanitizer ★12](https://github.com/elixirstatus/phoenix_html_sanitizer) - HTML Sanitizer integration for Phoenix.
* [phoenix_html_simplified_helpers ★12](https://github.com/ikeikeikeike/phoenix_html_simplified_helpers) - Some helpers for phoenix html (truncate, time_ago_in_words, number_with_delimiter).
...
* [phoenix_live_reload ★82](https://github.com/phoenixframework/phoenix_live_reload) - Provides live-reload functionality for Phoenix.
...
* [phoenix_pubsub_redis ★64](https://github.com/phoenixframework/phoenix_pubsub_redis) - The Redis PubSub adapter for the Phoenix framework.
...
* [phoenix_slime ★142](https://github.com/slime-lang/phoenix_slime) - Slim template support for Phoenix.
...
* [plug ★1403](https://github.com/elixir-lang/plug) - A specification and conveniences for composable modules in between web applications.
...
* [plug_graphql ★118](https://github.com/graphql-elixir/plug_graphql) - Phoenix Plug integration for [GraphQL Elixir](http://graphql-elixir.org/).
...
* [plug_rails_cookie_session_store ★63](https://github.com/cconstantin/plug_rails_cookie_session_store) - Rails compatible Plug session store.
...
* [plug_statsd ★42](https://github.com/jeffweiss/plug_statsd) - A plug for automatically sending timing and count metrics to statsd.
* [plugs ★15 ⏳1Y](https://github.com/sugar-framework/plugs) - Collection of Plug middleware for web applications.
* [plugsnag ★38](https://github.com/jarednorman/plugsnag) - Bugsnag notifier for Elixir's plug.
* [raygun ★15](https://github.com/cobenian/raygun) - Capture bugs and send them to Raygun.
* [react_phoenix ★134](https://github.com/geolessel/react-phoenix) - Render React.js components in Phoenix views focusing on easy installation and Brunch compatibility.
...
* [scrivener ★331](https://github.com/drewolson/scrivener) - Paginate your Ecto queries.
* [scrivener_headers ★31](https://github.com/doomspork/scrivener_headers) - Helpers for paginating API responses with Scrivener and HTTP headers.
* [scrivener_html ★56](https://github.com/mgwidmann/scrivener_html) - Helpers built to work with Scrivener's page struct to easily build HTML output for various CSS frameworks.
* [sentinel ★83](https://github.com/britton-jb/sentinel) - An authentication framework for Phoenix extending guardian with routing and other basic functionality.
...
* [kitto ★549](https://github.com/kittoframework/kitto) - A framework for interactive dashboards.
* [phoenix ★9822](https://github.com/phoenixframework/phoenix) - Elixir Web Framework targeting full-featured, fault tolerant applications with realtime functionality.
* [placid ★137](https://github.com/slogsdon/placid) - A REST toolkit for building highly-scalable and fault-tolerant HTTP APIs with Elixir.
* [rackla ★194](https://github.com/AntonFagerberg/rackla) - API Gateways in Elixir.
* [relax ★123 ⏳1Y](https://github.com/AgilionApps/relax) - Simple Elixir implementation of a [jsonapi.org](http://jsonapi.org) server.
* [rest ★46 ⏳1Y](https://github.com/synrc/rest) - Micro-REST framework with typed JSON.
* [sugar ★326](https://github.com/sugar-framework/sugar) - Modular web framework for Elixir.
* [trot ★215](https://github.com/hexedpackets/trot) - An Elixir web micro-framework.

## Games
*Libraries for and implementations of games.*

* [entice ★58 ⏳1Y](https://github.com/entice/entice) - A distributed Entity-Component-System framework, providing its own example MMORPG server.
* [mines ★2](https://github.com/kevlar1818/mines) - A minesweeper clone in the terminal.
...
* [geo ★270](https://github.com/bryanjos/geo) - A collection of GIS functions for Elixir.
...
* [ip2location ★11 ⏳1Y](https://github.com/nazipov/ip2location-elixir) - An Elixir library for IP2Location database.
...
* [topo ★12](https://github.com/pkinney/topo) - A Geometry library for Elixir that calculates spatial relationships between two geometries.

## Hardware
*Hardware related things like I/O interfaces and such.*

* [elixir_ale ★202](https://github.com/fhunleth/elixir_ale) - Elixir access to hardware I/O interfaces such as GPIO, I2C, and SPI.
* [nerves ★446](https://github.com/nerves-project/nerves) - Framework for building firmware for platforms like Raspberry Pi and BeagleBone Black.
...
* [elli ★646](https://github.com/knutin/elli) - Elli is a webserver you can run inside your Erlang application to expose an HTTP API.
* [explode ★7](https://github.com/pkinney/explode) - An easy utility for responding with standard HTTP/JSON error payloads in Plug- and Phoenix-based applications.
* [exvcr ★293](https://github.com/parroty/exvcr) - HTTP request/response recording library for Elixir, inspired by VCR.
...
* [hackney ★692](https://github.com/benoitc/hackney) - Simple HTTP client written in Erlang.
...
* [httpoison ★984](https://github.com/edgurgel/httpoison) - Yet Another HTTP client for Elixir powered by hackney.
* [httpotion ★576](https://github.com/myfreeweb/httpotion) - Fancy HTTP client for Elixir, based on ibrowse.
...
* [tesla ★372](https://github.com/teamon/tesla) - HTTP client library, with support for middleware and multiple adapters.
...
* [web_socket ★42](https://github.com/slogsdon/plug-web-socket) - An exploration into a stand-alone library for Plug applications to easily adopt WebSockets.
* [webdriver ★76 ⏳1Y](https://github.com/stuart/elixir-webdriver) - This is an implementation of the WebDriver protocol client. It currently supports PhantomJS, FireFox, ChromeDriver and remote webdriver servers (e.g. Selenium).
...
* [cloudex ★23](https://github.com/smeevil/cloudex) - Cloudex is an Elixir library that can upload image files or urls to Cloudinary.
...
* [imagineer ★75](https://github.com/SenecaSystems/imagineer) - Image parsing in Elixir.
* [imgex ★13](https://github.com/ianwalter/imgex) - Unofficial client library for generating imgix URLs in Elixir.
* [mogrify ★179](https://github.com/route/mogrify) - An Elixir wrapper for ImageMagick command line.
...
* [thumbnex ★10](https://github.com/talklittle/thumbnex) - Create thumbnails from images and video screenshots.

## Instrumenting / Monitoring
*Libraries for collecting and exporting metrics.*

* [appsignal-elixir ★39](https://github.com/appsignal/appsignal-elixir) - Collects error and performance data from your Elixir applications and sends it to [AppSignal](https://appsignal.com/).
* [elixometer ★531](https://github.com/pinterest/elixometer) - A light Elixir wrapper around exometer.
* [erlang-metrics ★38](https://github.com/benoitc/erlang-metrics) - A generic interface to different metrics systems in Erlang.
* [exometer ★396](https://github.com/Feuerlabs/exometer) - Basic measurement objects and probe behavior in Erlang.
...
* [instream ★80](https://github.com/mneudert/instream) - InfluxDB driver for Elixir.
...
* [newrelic.ex ★39](https://github.com/romul/newrelic.ex) - Collects metrics from your Elixir/Phoenix application and sends them to [NewRelic](https://newrelic.com/).
* [prometheus ★73](https://github.com/deadtrickster/prometheus.erl) - [Prometheus.io](https://prometheus.io) monitoring system and time series database client in Erlang.
* [prometheus-ecto ★15](https://github.com/deadtrickster/prometheus-ecto) - Ecto instrumenter for prometheus.ex.
* [prometheus-phoenix ★16](https://github.com/deadtrickster/prometheus-phoenix) - Phoenix instrumenter for prometheus.ex.
* [prometheus-plugs ★14](https://github.com/deadtrickster/prometheus-plugs) - Plugs instrumenters/exporter for prometheus.ex.
* [prometheus.ex ★86](https://github.com/deadtrickster/prometheus.ex) - Elixir-friendly [Prometheus.io](https://prometheus.io) monitoring system and time series database client.
...
* [jazz ★62 ⏳2Y](https://github.com/meh/jazz) - Yet another library to handle JSON in Elixir.
* [joken ★310](https://github.com/bryanjos/joken) - Encodes and decodes JSON Web Tokens.
* [jose ★106](https://github.com/potatosalad/erlang-jose) - JSON Object Signing and Encryption (JOSE) for Erlang and Elixir.
* [json ★176](https://github.com/cblage/elixir-json) - Native JSON library for Elixir.
...
* [json_web_token_ex ★100](https://github.com/garyf/json_web_token_ex) - An Elixir implementation of the JSON Web Token (JWT) Standards Track (RFC 7519).
* [jsonapi ★201](https://github.com/jeregrine/jsonapi) - A project that will render your data models into [JSONAPI Documents](http://jsonapi.org/format/).
* [jsx ★522](https://github.com/talentdeficit/jsx) - An Erlang application for consuming, producing, and manipulating json.
...
* [poison ★1109](https://github.com/devinus/poison) - Poison is a new JSON library for Elixir focusing on wicked-fast speed without sacrificing simplicity, completeness, or correctness.
...
* [Monkey ★70](https://github.com/fabrik42/writing_an_interpreter_in_elixir) - Elixir implementation of an interpreter and REPL for the js-like Monkey programming language.
...
* [exlager ★56](https://github.com/khia/exlager) - Elixir binding for lager.
* [exsentry ★24](https://github.com/appcues/exsentry) - Error logging to [Sentry](https://getsentry.com/).
* [gelf_logger ★11](https://github.com/jschniper/gelf_logger) - A Logger backend that will generate Graylog Extended Log Format (GELF) messages.
...
* [logger_logstash_backend ★35](https://github.com/marcelog/logger_logstash_backend) - A backend for the Elixir Logger that will send logs to the Logstash UDP input.
...
* [rollbax ★126](https://github.com/elixir-addicts/rollbax) - Exception tracking and logging to [Rollbar](https://rollbar.com/).
...
* [timber ★34](https://github.com/timberio/timber-elixir) - Structured logging platform; turns raw text logs into rich structured events.
...
* [named_args ★10 ⏳1Y](https://github.com/mgwidmann/named_args) - Allows named arg style arguments in Elixir.
* [OK ★114](https://github.com/CrowdHailer/OK) - Macros for elegant happy path coding, maximizing power and readability.
* [ok_jose ★47](https://github.com/vic/ok_jose) - Pipe elixir functions that match `{:ok,_}`, `{:error,_}` tuples or custom patterns.
...
* [pipe_to ★24](https://github.com/taiansu/pipe_to) - The enhanced pipe operator which can specify the target position.
* [pipes ★289](https://github.com/batate/elixir-pipes) - Macros for more flexible composition with the Elixir Pipe operator.
...
* [earmark ★302](https://github.com/pragdave/earmark) - Markdown parser for Elixir.
* [Markdown ★54](https://github.com/devinus/markdown) - Implemented entirely as a NIF binding to the Hoedown library.
...
* [Apex ★186](https://github.com/bjro/apex) - Awesome Print for Elixir.
...
* [ecto_autoslug_field ★32](https://github.com/sobolevn/ecto_autoslug_field) - Automatically creates slugs for your Ecto models.
* [egaugex ★1](https://github.com/Brightergy/egaugex) - Client to fetch and parse realtime data from egauge devices.
* [elixir-browser ★26](https://github.com/tuvistavie/elixir-browser) - Browser detection for Elixir.
...
* [ex_rated ★113](https://github.com/grempe/ex_rated) - Simple and flexible rate-limiting for API's or anything.
* [exfcm ★1](https://github.com/Hajto/ExFCM) - Simple wrapper for posting Firebase Cloud Messages.
* [exldap ★21](https://github.com/jmerriweather/exldap) - A module for working with LDAP from Elixir.
...
* [exprint ★22](https://github.com/parroty/exprintf) - A printf / sprintf library for Elixir, works as a wrapper for :io.format.
* [exquisite ★49](https://github.com/meh/exquisite) - LINQ-like match_spec generation for Elixir.
...
* [huex ★24](https://github.com/xavier/huex) - Elixir client for Philips Hue connected light bulbs.
...
* [phone ★38](https://github.com/fcevado/phone) - A parser to get useful info from telephone numbers.
* [porcelain ★493](https://github.com/alco/porcelain) - Porcelain implements a saner approach to launching and communicating with external OS processes from Elixir.
...
* [spotify_ex ★30](https://github.com/jsncmgs1/spotify_ex) - An Elixir wrapper for the Spotify Web API.
...
* [Rustler ★615](https://github.com/hansihe/Rustler) - Library for writing NIFs for Erlang or Elixir safely in Rust. No segfaults.
...
* [ejabberd ★3052](https://github.com/processone/ejabberd) - Robust, ubiquitous and massively scalable Jabber/XMPP Instant Messaging platform.
...
* [socket ★461](https://github.com/meh/elixir-socket) - Socket wrapping for Elixir.
...
* [amnesia ★398](https://github.com/meh/amnesia) - Mnesia wrapper for Elixir.
* [arbor ★58](https://github.com/coryodaniel/arbor) - Ecto adjacency list and tree traversal.
* [arc_ecto ★139](https://github.com/stavro/arc_ecto) - Arc.Ecto provides an integration with Arc and Ecto.
* [atlas ★192 ⏳1Y](https://github.com/chrismccord/atlas) - Object Relational Mapper for Elixir.
* [Bolt.Sips ★57](https://github.com/florinpatrascu/bolt_sips) - Neo4j driver for Elixir using the Bolt protocol.
* [boltun ★86](https://github.com/bitgamma/boltun) - Transforms notifications from the Postgres LISTEN/NOTIFY mechanism into callback execution.
* [cassandra_ecto ★17](https://github.com/vintikzzz/cassandra_ecto) - Ecto adapter for Apache Cassandra.
...
* [ecto ★2767](https://github.com/elixir-ecto/ecto) - A database wrapper and language integrated query for Elixir.
* [ecto_enum ★167](https://github.com/gjaldon/ecto_enum) - Ecto extension to support enums in models.
* [ecto_factory](https://hex.pm/packages/ecto_factory) - Easily generate structs based on your ecto schemas.
* [ecto_fixtures ★91](https://github.com/DockYard/ecto_fixtures) - Fixtures for Elixir apps using Ecto.
...
* [ecto_rut ★54](https://github.com/sheharyarn/ecto_rut) - Simple and Powerful Ecto Shortcuts to simplify and speed up development.
...
* [elastic ★17](https://github.com/radar/elastic) - A thin-veneer over HTTPotion to help you talk to Elastic Search.
* [elastix ★85](https://github.com/werbitzky/elastix) - A simple Elastic REST client written in Elixir.
* [eredis ★502](https://github.com/wooga/eredis) - Erlang Redis client.
* [erlastic_search ★108](https://github.com/tsloughter/erlastic_search) - An Erlang app for communicating with Elastic Search's rest interface.
...
* [eventstore ★220](https://github.com/slashdotdash/eventstore) - A CQRS EventStore using Postgres for persistence, written in Elixir.
...
* [exnumerator ★29](https://github.com/KamilLelonek/exnumerator) - Elixir enumerable type definition in a simple way to be used with any database.
* [exredis ★292](https://github.com/artemeff/exredis) - Redis client for Elixir.
...
* [extreme ★60](https://github.com/exponentially/extreme) - An Elixir library using [Eventstore](https://geteventstore.com) for persistance of events generated by aggregates (CQRS).
* [exts ★7](https://github.com/meh/exts) - Elixir Terms Storage, ets wrapper.
* [github_ecto ★97](https://github.com/wojtekmach/github_ecto) - Ecto adapter for GitHub API.
* [hstore ★9 ⏳1Y](https://github.com/senecasystems/hstore) - Hstore support for Postgrex.
* [inquisitor ★107](https://github.com/dockyard/inquisitor) - Composable query builder for Ecto.
* [isn ★8](https://github.com/Frost/isn) - Ecto types for the postgreSQL isn extension.
* [kalecto ★108](https://github.com/lau/calecto) - Glue between Kalends and Ecto for saving dates, times and datetimes.
...
* [mariaex ★161](https://github.com/xerions/mariaex) - MariaDB/MySQL driver for Elixir.
* [moebius ★424](https://github.com/robconery/moebius) - A functional query tool for Elixir and PostgreSQL.
...
* [mongodb_ecto ★216](https://github.com/michalmuskala/mongodb_ecto) - MongoDB adapter for Ecto.
* [mysql ★196](https://github.com/mysql-otp/mysql-otp) - MySQL/OTP – MySQL driver for Erlang/OTP.
...
* [paper_trail ★117](https://github.com/izelnakri/paper_trail) - Ecto plugin for tracking and recording all the changes in your database.
* [postgrex ★430](https://github.com/elixir-ecto/postgrex) - PostgreSQL driver for Elixir.
* [red ★15](https://github.com/rodrigues/red) - Persist relationships between objects in Redis, in a graph-like way.
* [redix ★300](https://github.com/whatyouhide/redix) - Superfast, pipelined, resilient Redis driver for Elixir.
* [redo ★16](https://github.com/heroku/redo) - Heroku's pipelining redis client for erlang.
* [rethinkdb ★460](https://github.com/hamiltop/rethinkdb-elixir) - Rethinkdb client in pure Elixir using JSON protocol.
* [riak ★155](https://github.com/drewkerrigan/riak-elixir-client) - A Riak client written in Elixir.
* [riak_ecto ★24](https://github.com/pma/riak_ecto) - Riak adapter for Ecto.
* [shards ★161](https://github.com/cabol/shards) - Transparent and out-of-box Sharding support for Erlang/Elixir ETS tables.
* [sql_dust ★92](https://github.com/bettyblocks/sql_dust) - Generate (complex) SQL queries using magical Elixir SQL dust.
* [sqlite_ecto ★63](https://github.com/jazzyb/sqlite_ecto) - SQLite3 adapter for Ecto.
...
* [tds_ecto ★42](https://github.com/livehelpnow/tds_ecto) - MSSQL / TDS Adapter for Ecto.
* [timex_ecto ★100](https://github.com/bitwalker/timex_ecto) - An adapter for using Timex DateTimes with Ecto.
* [tirexs ★352](https://github.com/Zatvobor/tirexs) - An Elixir flavored DSL for building JSON based requests to Elasticsearch engine.
...
* [erlexec ★256](https://github.com/saleyn/erlexec) - Execute and control OS processes from Erlang/OTP.
* [immortal ★97](https://github.com/danielberkompas/immortal) - Immortal is a small collection of helper modules intended to make it easier to build a fault-tolerant OTP application.
...
* [gutenex ★162](https://github.com/SenecaSystems/gutenex) - Native PDF generation for Elixir.
* [pdf2htmlex ★31 ⏳1Y](https://github.com/ricn/pdf2htmlex) - Convert PDF docs to beautiful HTML files without losing text or format.
* [pdf_generator ★72](https://github.com/gutschilla/elixir-pdf-generator) - A simple wrapper for wkhtmltopdf (HTML to PDF) for use in Elixir projects.
...
* [exprotobuf ★264](https://github.com/bitwalker/exprotobuf) - Protocol Buffers in Elixir, made easy.
* [grpc-elixir ★146](https://github.com/tony612/grpc-elixir) - The Elixir implementation of gRPC.
* [message_pack ★45](https://github.com/mururu/msgpack-elixir) - MessagePack Implementation for Elixir.
* [msgpax ★126](https://github.com/lexmag/msgpax) - MessagePack (de)serializer implementation for Elixir.
* [protox ★6](https://github.com/ahamez/protox) - Elixir implementation for Protocol Buffers.
* [riffed ★235](https://github.com/pinterest/riffed) - Provides idiomatic Elixir bindings for Apache Thrift.
* [Sippet ★7](https://github.com/balena/elixir-sippet) - An Elixir library designed to be used as SIP protocol middleware.
* [SMPPEX ★16](https://github.com/savonarola/smppex) - SMPP 3.4 protocol and framework implementation in Elixir.
...
* [amqp ★238](https://github.com/pma/amqp) - Simple Elixir wrapper for the Erlang RabbitMQ client, based on Langohr.
...
* [enm ★84](https://github.com/basho/enm) - enm is an Erlang port driver that wraps the nanomsg C library.
* [exdisque](https://github.com/mosic/exdisque) - Elixir client for [Disque ★6246](https://github.com/antirez/disque), an in-memory, distributed job queue.
* [exq ★632](https://github.com/akira/exq) - Job processing library for Elixir - compatible with Resque/Sidekiq.
...
* [honeydew ★161](https://github.com/koudelka/honeydew) - Honeydew is a worker pool library for Elixir.
...
* [task_bunny ★91](https://github.com/shinyscorpion/task_bunny) - background processing application written in Elixir and uses RabbitMQ as a messaging backend.
* [toniq ★224](https://github.com/joakimk/toniq) - Simple and reliable background job library for Elixir.
* [verk ★340](https://github.com/edgurgel/verk) - Verk is a job processing system backed by Redis. It uses the same job definition of Sidekiq/Resque.
...
* [distillery ★1142](https://github.com/bitwalker/distillery) - A pure Elixir implementation of release packaging functionality for the Erlang VM.
* [eliver ★22](https://github.com/glasnoster/eliver) - Interactive semantic versioning for Elixir packages.
* [exrm ★915](https://github.com/bitwalker/exrm) - Automatically generate a release for your Elixir project.
* [exrm_deb ★56](https://github.com/johnhamelink/exrm_deb) - Create a deb for your Elixir release with ease.
...
* [mix_docker ★186](https://github.com/Recruitee/mix_docker) - Put your Elixir app production release inside minimal docker image.
...
* [detergent ★45](https://github.com/devinus/detergent) - An emulsifying Erlang SOAP library.
...
* [numerix ★49](https://github.com/safwank/Numerix) - A collection of useful mathematical functions with a slant towards statistics, linear algebra and machine learning.
* [statistics ★49](https://github.com/msharp/elixir-statistics) - Some basic statistical functions for Elixir.
...
* [bbmustache ★63](https://github.com/soranoba/bbmustache) - Binary pattern match Based Mustache template engine for Erlang/OTP.
* [eml ★76](https://github.com/zambal/eml) - Library for writing and manipulating (HTML) markup in Elixir.
* [exgen ★20](https://github.com/rwdaigle/exgen) - A templating library for quickly generating Elixir projects.
* [expug ★49](https://github.com/rstacruz/expug) - Pug templates for Elixir.
...
* [blacksmith ★143](https://github.com/batate/blacksmith) - Data generation framework for Elixir.
* [blitzy ★60](https://github.com/benjamintanweihao/blitzy) - A simple HTTP load tester in Elixir.
* [bypass ★295](https://github.com/pspdfkit-labs/bypass) - Bypass provides a quick way to create a mock HTTP server with a custom plug.
...
* [double ★15](https://github.com/sonerdy/double) - Create stub dependencies for testing without overwriting global modules.
...
* [espec ★416](https://github.com/antonmi/espec) - BDD test framework for Elixir inspired by RSpec.
* [espec_phoenix ★91](https://github.com/antonmi/espec_phoenix) - ESpec for Phoenix web framework.
* [ex_machina ★717](https://github.com/thoughtbot/ex_machina) - Flexible test factories for Elixir. Works out of the box with Ecto and Ecto associations.
...
* [ex_unit_notifier ★49](https://github.com/navinpeiris/ex_unit_notifier) - Desktop notifications for ExUnit.
* [excheck ★225](https://github.com/parroty/excheck) - Property-based testing library for Elixir (QuickCheck style).
...
* [faker ★274](https://github.com/igas/faker) - Faker is a pure Elixir library for generating fake data.
* [faker_elixir ★99](https://github.com/GesJeremie/faker-elixir) - FakerElixir is an Elixir package that generates fake data for you.
...
* [hound ★810](https://github.com/HashNuke/hound) - Elixir library for writing integration tests and browser automation.
...
* [meck ★514](https://github.com/eproxus/meck) - A mocking library for Erlang.
...
* [mix_test_watch ★295](https://github.com/lpil/mix-test.watch) - Automatically run your Elixir project's tests each time you save a file.
* [mixunit ★2 ⏳2Y](https://github.com/talentdeficit/mixunit) - An EUnit task for Mix based projects.
* [mock ★228](https://github.com/jjh42/mock) - Mocking library for the Elixir language.
...
* [ponos ★98 ⏳1Y](https://github.com/klarna/ponos) - Ponos is an Erlang application that exposes a flexible load generator API.
...
* [proper ★539](https://github.com/manopapad/proper) - PropEr (PROPerty-based testing tool for ERlang) is a QuickCheck-inspired open-source property-based testing tool for Erlang.
...
* [wallaby ★452](https://github.com/keathley/wallaby) - Wallaby helps test your web applications by simulating user interactions concurrently and manages browsers.
...
* [calliope ★159](https://github.com/nurugger07/calliope) - An Elixir HAML parser.
* [ccc ★4](https://github.com/Joe-noh/ccc) - Character Code Converter.
* [chinese_translation ★68 ⏳2Y](https://github.com/tyrchen/chinese_translation) - Translate between traditional chinese and simplified chinese based on wikipedia data, and translate chinese words/characters to pinyin (or slug with or without tone).
...
* [decimal ★124](https://github.com/ericmj/decimal) - Arbitrary precision decimal arithmetic for Elixir.
* [dicer ★3 ⏳2Y](https://github.com/olhado/dicer) - A dice roller expression evaluator.
* [eden](https://github.com/jfacorro/Eden) - [EDN ★1484](https://github.com/edn-format/edn) encoder/decoder for Elixir.
...
* [erldn](https://github.com/marianoguerra/erldn) - [EDN ★1484](https://github.com/edn-format/edn) format parser for the Erlang platform.
...
* [exmoji ★50](https://github.com/mroth/exmoji) - Emoji encoding Swiss Army knife for Elixir/Erlang.
...
* [hashids ★121](https://github.com/alco/hashids-elixir) - Hashids lets you obfuscate numerical identifiers via reversible mapping.
* [hexate ★18](https://github.com/rjsamson/hexate) - Simple module for Hex encoding / decoding in Elixir.
* [html_sanitize_ex ★72](https://github.com/rrrene/html_sanitize_ex) - HTML sanitizer for Elixir.
* [inet_cidr ★8](https://github.com/cobenian/inet_cidr) - Classless Inter-Domain Routing (CIDR) for Elixir that is compatible with :inet and supports both IPv4 and IPv6.
...
* [mbcs ★12 ⏳1Y](https://github.com/woxtu/elixir-mbcs) - Wrapper for erlang-mbcs. This module provides functions for character encoding conversion.
...
* [money ★120](https://github.com/liuggio/money) - Working with Money safer, easier, and fun, interpretation of the Fowler's Money pattern.
...
* [number ★70](https://github.com/danielberkompas/number) - Number is a pretentiously-named Elixir library which provides functions to convert numbers into a variety of different formats.
...
* [secure_random ★60](https://github.com/patricksrobertson/secure_random.ex) - Convenience library for random base64 strings modeled after my love for Ruby's SecureRandom.
...
* [slime ★145](https://github.com/slime-lang/slime) - An Elixir library for rendering slim-like templates.
* [slugger ★81](https://github.com/h4cc/slugger) - Slugger can generate slugs from given strings that can be used in URLs or file names.
* [stemmer ★113](https://github.com/fredwu/stemmer) - An English (Porter2) stemming implementation in Elixir.
...
* [uuid ★157](https://github.com/zyro/elixir-uuid) - UUID generator and utilities for Elixir.
* [uuid_erl ★133](https://github.com/okeuday/uuid) - Erlang Native UUID Generation.
...
* [airbrake ★16](https://github.com/romul/airbrake-elixir) - An Elixir notifier for the Airbrake.
...
* [anilixir ★1 ⏳1Y](https://github.com/sotojuan/anilixir) - Elixir client for the Anilist API.
...
* [cashier ★12](https://github.com/swelham/cashier) - Payment gateway offering a common interface into multiple payment providers.
* [cleverbot ★2 ⏳1Y](https://github.com/BlakeWilliams/Elixir-Cleverbot) - Simple implementation of the Cleverbot API in Elixir.
* [coinbase ★7 ⏳1Y](https://github.com/gregpardo/coinbase-elixir) - A unofficial Coinbase API v1 Client.
* [commerce_billing ★116](https://github.com/joshnuss/commerce_billing) - A payment-processing library for Elixir that supports multiple gateways (e.g. Bogus & Stripe).
...
* [digitalocean ★9](https://github.com/lukeed/elixir-digitalocean) - Elixir wrapper for the Digital Ocean API v2.
...
* [docker ★11 ⏳1Y](https://github.com/hexedpackets/docker-elixir) - Elixir client for the Docker Remote API.
...
* [elixir_ipfs_api ★15 ⏳1Y](https://github.com/zabirauf/elixir-ipfs-api) - IPFS (InterPlanetary File System) API client for Elixir.
* [elixirfm ★6](https://github.com/jrichocean/Elixirfm) - Last.fm API wrapper for Elixir.
* [elixtagram ★50](https://github.com/zensavona/elixtagram) - Instagram API client for Elixir.
* [ethereumex ★5](https://github.com/exthereum/ethereumex) - Elixir JSON-RPC client for the Ethereum blockchain.
...
* [ex_statsd ★75](https://github.com/CargoSense/ex_statsd) - A statsd client implementation for Elixir.
* [ex_twilio ★118](https://github.com/danielberkompas/ex_twilio) - Twilio API client for Elixir.
...
* [extwitter ★261](https://github.com/parroty/extwitter) - Twitter client library for Elixir.
...
* [forcex ★25](https://github.com/jeffweiss/forcex) - Elixir library for the Force.com REST API.
...
* [kane ★36](https://github.com/peburrows/kane) - A [Google Cloud Pub/Sub](https://cloud.google.com/pubsub/overview) client.
...
* [mailgun ★150](https://github.com/chrismccord/mailgun) - Elixir Mailgun Client.
...
* [nadia ★112](https://github.com/zhyu/nadia) - Telegram Bot API Wrapper written in Elixir.
...
* [pigeon ★122](https://github.com/codedge-llc/pigeon) - HTTP2-compliant wrapper for sending iOS and Android push notifications.
...
* [riemann ★35](https://github.com/koudelka/elixir-riemann) - A [Riemann](http://riemann.io/) client for Elixir.
* [semver ★2 ⏳1Y](https://github.com/lee-dohm/semver) - Utilities for working with semver.org-compliant version strings.
* [sendgrid ★27](https://github.com/alexgaribay/sendgrid_elixir) - Send composable, transactional emails with SendGrid.
...
* [slack ★342](https://github.com/BlakeWilliams/Elixir-Slack) - Slack real time messaging client in Elixir.
* [sparkpost ★29](https://github.com/SparkPost/elixir-sparkpost) - An Elixir library for sending email using SparkPost.
* [statix ★73](https://github.com/lexmag/statix) - Expose app metrics in the StatsD protocol.
...
* [tentacat ★205](https://github.com/edgurgel/tentacat) - Simple Elixir wrapper for the GitHub API.
...
* [trans ★68](https://github.com/belaustegui/trans) - A Elixir library to manage embedded translations into models leveraging PostgreSQL JSONB datatype.
...
* [crutches ★117](https://github.com/mykewould/crutches) - Utility library for Elixir, designed to complement the standard library bundled with the language.
...
* [erlang-history ★444](https://github.com/ferd/erlang-history) - Hacks to add shell history to Erlang's shell.
...
* [mnemonix ★16](https://github.com/christhekeele/mnemonix) - A unified interface to key/value stores.
...
* [pubsub ★24](https://github.com/simonewebdesign/elixir_pubsub) - A Publish-Subscribe utility library that implements a pub-sub mechanism to ease the burden of communication on the business logic processes.
...
* [retry ★60](https://github.com/safwank/ElixirRetry) - Simple Elixir macros for linear retry, exponential backoff and wait with composable delays.
...
* [sitemap ★37](https://github.com/ikeikeikeike/sitemap) - Sitemap is the easiest way to generate Sitemaps in Elixir.
...
* [exop ★28](https://github.com/madeinussr/exop) - A library that allows to encapsulate business logic and validate params with predefined contract.
...
* [vex ★227](https://github.com/CargoSense/vex) - An extensible data validation library for Elixir.
...
* [ffmpex ★37](https://github.com/talklittle/ffmpex) - FFmpeg command line wrapper.
...
* [erlsom ★171](https://github.com/willemdj/erlsom) - Erlsom is an Erlang library to parse (and generate) XML documents.
...
* [floki ★624](https://github.com/philss/floki) - A simple HTML parser that enables searching using CSS like selectors.
* [meeseeks ★43](https://github.com/mischov/meeseeks) - A library for parsing and extracting data from HTML and XML with CSS or XPath selectors.
* [quinn ★30](https://github.com/nhu313/Quinn) - XML parser for Elixir.
* [readability ★80](https://github.com/keepcosmos/readability) - Readability is for extracting and curating articles.
...
* [yaml_elixir ★34](https://github.com/KamilLelonek/yaml-elixir) - Yaml parser for Elixir based on native Erlang implementation.
...
* [Getting Started - Elixir ★58](https://github.com/potatogopher/elixir-getting-started) - PDF, MOBI, and EPUB documents for Elixir's Getting Started tutorial (2016).
...
* [Études for Elixir](http://chimera.labs.oreilly.com/books/1234000001642) - A collection of exercises to program in Elixir by J. David Eisenberg (2013) ([Github Repo ★409](https://github.com/oreillymedia/etudes-for-elixir)).
...
* [Alchemist ★659](https://github.com/tonini/alchemist.el) - Elixir Tooling Integration Into Emacs.
* [Alchemist-Server ★161](https://github.com/tonini/alchemist-server) - Editor/IDE independent background server to inform about Elixir mix projects.
* [Alchemist.vim ★336](https://github.com/slashmili/alchemist.vim) - Elixir Tooling Integration Into Vim.
* [Atom](https://atom.io/packages/language-elixir) - Elixir language support for Atom.
* [atom-elixir ★385](https://github.com/msaraiva/atom-elixir) - An Atom package for Elixir.
* [atom-iex ★15](https://github.com/indiejames/atom-iex) - Run an IEx session in Atom.
* [elixir-tmbundle ★183](https://github.com/elixir-lang/elixir-tmbundle) - A TextMate and SublimeText bundle for Elixir.
...
* [ElixirSublime ★337](https://github.com/vishnevskiy/ElixirSublime) - Elixir plugin for SublimeText 3 that provides code completion and linting.
...
* [TextMate ★183](https://github.com/elixir-lang/elixir-tmbundle) - Elixir syntax highlighting for TextMate.
* [vim-elixir ★726](https://github.com/elixir-lang/vim-elixir) - Vim configuration files for Elixir.
...
## Other Awesome Lists
*Other amazingly awesome lists can be found at [jnv/lists](https://github.com/jnv/lists#lists-of-lists) or [bayandin/awesome-awesomeness ★19183](https://github.com/bayandin/awesome-awesomeness#awesome-awesomeness).*

* [Awesome Elixir by LibHunt](https://elixir.libhunt.com) - A curated list of awesome Elixir and Erlang packages and resources.
* [Awesome Erlang ★692](https://github.com/drobakowski/awesome-erlang) - A curated list of awesome Erlang libraries, resources and shiny things.
* [Erlang Bookmarks ★973](https://github.com/0xAX/erlang-bookmarks) - A collection of links for Erlang developers.
...
* [Elixir Functional Programming ★201](https://github.com/kblake/functional-programming) - Material to introduce functional programming using the Elixir language.
* [Elixir School](https://elixirschool.com/) - Lessons about the Elixir programming language.
* [The Little Schemer in Elixir ★313 ⏳1Y](https://github.com/jwhiteman/a-little-elixir-goes-a-long-way) - Exercises and algorithms from the Little Schemer book, ported to Elixir.
...
* [christopheradams/elixir_style_guide ★2200](https://github.com/christopheradams/elixir_style_guide) - A community-driven style guide for Elixir.
* [lexmag/elixir-style-guide ★184](https://github.com/lexmag/elixir-style-guide) - An opinionated Elixir style guide.
* [rrrene/elixir-style-guide](https://github.com/rrrene/elixir-style-guide) - Style guide checked by [Credo ★1921](https://github.com/rrrene/credo).

## Websites
*Useful Elixir-related websites.*

* [30 Days of Elixir ★1965](https://github.com/seven1m/30-days-of-elixir) - A walk through the Elixir language in 30 exercises.
...
* [Elixir Github Repository ★10421](https://github.com/elixir-lang/elixir) - The project repository.
* [Elixir Github Wiki](https://github.com/elixir-lang/elixir/wiki) - The project's wiki, containing much useful information.
* [Elixir Job Board](http://jobs.elixirdose.com) - A job board for Elixir, and community of Elixir developers, [written using Phoenix ★69](https://github.com/rizafahmi/elixirjobs).
