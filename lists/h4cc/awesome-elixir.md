...
<p align="center">
	This list is a copy of <a href="https://github.com/h4cc/awesome-elixir">https://github.com/h4cc/awesome-elixir</a> with ranks
</p>
---
...
* [pool_ring ★1 ⏳1Y](https://github.com/camshaft/pool_ring) - Create a pool based on a hash ring.
...
* [count_buffer ★1 ⏳1Y](https://github.com/camshaft/count_buffer) - Buffer a large set of counters and flush periodically.
...
* [cuid ★15 ⏳2Y](https://github.com/duailibe/cuid) - Collision-resistant ids optimized for horizontal scaling and sequential lookup performance, written in Elixir.
...
* [natural_sort ★3 ⏳1Y](https://github.com/DanCouper/natural_sort) - Elixir natural sort implementation for lists of strings.
...
* [red_black_tree ★21 ⏳1Y](https://github.com/SenecaSystems/red_black_tree) - Red-Black tree implementation in Elixir.
...
* [sorted_set ★13 ⏳1Y](https://github.com/SenecaSystems/sorted_set) - Sorted Sets for Elixir.
...
* [tfidf ★10 ⏳1Y](https://github.com/OCannings/tf-idf) - An Elixir implementation of term frequency–inverse document frequency.
...
* [Hydra ★33 ⏳1Y](https://github.com/doomspork/hydra) - A multi-headed beast: API gateway, request cache, and data transformations.
...
* [apache_passwd_md5 ★3 ⏳2Y](https://github.com/kevinmontuori/Apache.PasswdMD5) - Apache/APR Style Password Hashing.
...
* [htpasswd ★1 ⏳2Y](https://github.com/kevinmontuori/Apache.htpasswd) - Apache htpasswd file reader/writer in Elixir.
...
* [rebar3_abnfc_plugin ★0 ⏳1Y](https://github.com/surik/rebar3_abnfc_plugin) - Rebar3 abnfc compiler.
...
* [locker ★127 ⏳1Y](https://github.com/wooga/locker) - Atomic distributed "check and set" for short-lived keys.
...
* [Guri ★12 ⏳1Y](https://github.com/elvio/guri) - Automate tasks using chat messages.
...
* [Kubex ★25 ⏳1Y](https://github.com/ingerslevio/kubex) - Kubernetes client and integration for Elixir, written in pure Elixir.
...
* [exprof ★59 ⏳1Y](https://github.com/parroty/exprof) - A simple code profiler for Elixir, using eprof.
...
* [cesso ★19 ⏳2Y](https://github.com/meh/cesso) - CSV handling library for Elixir.
...
* [moment ★24 ⏳1Y](https://github.com/atabary/moment) - Parse, validate, manipulate, and display dates in Elixir.
...
* [echo ★23 ⏳1Y](https://github.com/zmoshansky/echo) - A meta-notification system; Echo checks notification preferences & dispatches notifications.
...
* [huffman ★12 ⏳1Y](https://github.com/SenecaSystems/huffman) - Huffman encoding and decoding in Elixir.
...
* [reaxive ★127 ⏳1Y](https://github.com/alfert/reaxive) - Reaxive is a reactive event handling library, inspired by [Elm](http://elm-lang.org) and Reactive Extensions.
...
* [koans ★237 ⏳1Y](https://github.com/dojo-toulouse/elixir-koans) - Learn Elixir by using elixir-koans.
...
* [weather ★58 ⏳1Y](https://github.com/tacticiankerala/elixir-weather) - A command line weather app built using Elixir.
...
* [exrecaptcha ★7 ⏳1Y](https://github.com/adanselm/exrecaptcha) - Simple reCaptcha display/verify code for Elixir applications.
...
* [phoenix_linguist ★14 ⏳1Y](https://github.com/jxs/phoenix_linguist) - A project that integrates Phoenix with Linguist, providing a plug and view helpers.
...
* [phoenix_pubsub_rabbitmq ★28 ⏳1Y](https://github.com/pma/phoenix_pubsub_rabbitmq) - RabbitMQ adapter for Phoenix's PubSub layer.
...
* [plug_forward_peer ★13 ⏳1Y](https://github.com/awetzel/plug_forwarded_peer) - Very simple plug which reads X-Forwarded-For or Forwarded header according to RFC7239 and fill conn.remote_ip with the root client ip.
...
* [scaffold ★5 ⏳1Y](https://github.com/gausby/scaffold) - A mix task for creating new projects based on templates fetched from a Git-repo.
...
* [exelli ★11 ⏳1Y](https://github.com/pigmej/exelli) - An Elli Elixir wrapper with some sugar syntax goodies.
...
* [entice ★56 ⏳1Y](https://github.com/entice/entice) - A distributed Entity-Component-System framework, providing its own example MMORPG server.
...
* [ip2location ★9 ⏳1Y](https://github.com/nazipov/ip2location-elixir) - An Elixir library for IP2Location database.
...
* [segseg ★1 ⏳1Y](https://github.com/pkinney/segseg_ex) - Segment-segment intersection classifier and calculator.
...
* [artifact ★33 ⏳1Y](https://github.com/doomspork/artifact) - File upload and on-the-fly processing for Elixir.
...
* [exfavicon ★4 ⏳1Y](https://github.com/ikeikeikeike/exfavicon) - An Elixir library for discovering favicons.
...
* [png ★6 ⏳1Y](https://github.com/yuce/png) - A pure Erlang library for creating PNG images. It can currently create 8 and 16 bit RGB, RGB with alpha, indexed, grayscale and grayscale with alpha images.
...
* [ok_jose ★41](https://github.com/vic/ok_jose) - Pipe elixir functions that match `{:ok,_}`, `{:error,_}` tuples or custom patterns.
* [pattern_tap ★35 ⏳1Y](https://github.com/mgwidmann/elixir-pattern_tap) - Macro for tapping into a pattern match while using the pipe operator.
...
* [rebind ★0 ⏳1Y](https://github.com/camshaft/rebind) - rebind parse transform for Erlang.
...
* [html_entities ★27 ⏳1Y](https://github.com/martinsvalin/html_entities) - Elixir module for decoding HTML entities in a string.
...
* [hsnif ★15 ⏳3Y](https://github.com/urbanserj/hsnif) - Tool that allows to write Erlang NIF libraries in Haskell.
...
* [wifi ★25 ⏳1Y](https://github.com/gausby/wifi) - Various utility functions for working with the local Wifi network in Elixir.
...
* [database_url ★5 ⏳1Y](https://github.com/s-m-i-t-a/database_url) - Parse database URL and return keyword list for use with Ecto.
* [datomex ★29 ⏳1Y](https://github.com/edubkendo/datomex) - Elixir driver for the Datomic REST API.
...
* [ex_bitcask ★8 ⏳2Y](https://github.com/JonGretar/ExBitcask) - Elixir wrapper of Basho's Bitcask Key/Value store.
...
* [hstore ★8 ⏳1Y](https://github.com/senecasystems/hstore) - Hstore support for Postgrex.
...
* [mongo ★98 ⏳1Y](https://github.com/checkiz/elixir-mongo) - MongoDB driver for Elixir.
...
* [pdf2htmlex ★30 ⏳1Y](https://github.com/ricn/pdf2htmlex) - Convert PDF docs to beautiful HTML files without losing text or format.
...
* [message_pack ★41 ⏳1Y](https://github.com/mururu/msgpack-elixir) - MessagePack Implementation for Elixir.
...
* [work_queue ★29 ⏳1Y](https://github.com/pragdave/work_queue) - Simple implementation of the hungry-consumer model in Elixir.
...
* [exrm_heroku ★42 ⏳1Y](https://github.com/epsanchezma/exrm-heroku) - Publish your Elixir releases to Heroku with ease.
...
* [coil ★49 ⏳3Y](https://github.com/badosu/coil) - Minimalistic static content engine.
...
* [factory_girl_elixir ★36 ⏳1Y](https://github.com/sinetris/factory_girl_elixir) - Minimal implementation of Ruby's factory_girl in Elixir.
...
* [hypermock ★21 ⏳1Y](https://github.com/stevegraham/hypermock) - HTTP request stubbing and expectation Elixir library.
...
* [chinese_translation ★66 ⏳2Y](https://github.com/tyrchen/chinese_translation) - Translate between traditional chinese and simplified chinese based on wikipedia data, and translate chinese words/characters to pinyin (or slug with or without tone).
...
* [colors ★3 ⏳2Y](https://github.com/lidashuang/colors) - Colors util written in Elixir.
* [convertat ★8 ⏳1Y](https://github.com/whatyouhide/convertat) - An Elixir library for converting from and to arbitrary bases.
...
* [dicer ★3 ⏳1Y](https://github.com/olhado/dicer) - A dice roller expression evaluator.
* [eden](https://github.com/jfacorro/Eden) - [EDN ★1452](https://github.com/edn-format/edn) encoder/decoder for Elixir.
* [elixilorem ★7 ⏳1Y](https://github.com/mgamini/elixilorem) - Lorem Ipsum generator for Elixir.
...
* [elixir_bencode ★10 ⏳1Y](https://github.com/AntonFagerberg/elixir_bencode) - Bencode implemented in Elixir.
...
* [faust ★18 ⏳1Y](https://github.com/jquadrin/faust) - Markov Text Generator for Elixir.
...
* [pinyin ★12 ⏳1Y](https://github.com/lidashuang/pinyin) - Chinese Pinyin lib for Elixir.
...
* [bitpay ★19 ⏳1Y](https://github.com/bitpay/elixir-client) - Elixir core library for connecting to bitpay.com.
...
* [coinbase ★5 ⏳1Y](https://github.com/gregpardo/coinbase-elixir) - A unofficial Coinbase API v1 Client.
...
* [digoc ★11 ⏳2Y](https://github.com/kevinmontuori/digoc) - Digital Ocean API v2 Elixir Client.
...
* [everex ★8 ⏳1Y](https://github.com/jwarlander/everex) - Evernote API client for Elixir.
...
* [redtube ★6 ⏳1Y](https://github.com/kkirsche/Redtube_Elixir) - Redtube API Wrapper written in Elixir.
...
* [telephonist ★23 ⏳1Y](https://github.com/danielberkompas/telephonist) - Elixir state machines for Twilio calls.
...
* [ar2ecto ★9 ⏳1Y](https://github.com/aforward/ar2ecto) - Ar2ecto is a set of mix tasks to help you migrate from ActiveRecord to Ecto.
...
* [global ★2 ⏳1Y](https://github.com/mgwidmann/global) - Wrapper of the Erlang `:global` module.
...
* [shape ★6 ⏳1Y](https://github.com/prio/shape) - A data validation library for Elixir based on Prismatic Scheme.
...
* [voorhees ★38 ⏳1Y](https://github.com/danmcclain/voorhees) - A library for validating JSON responses.

## Version Control
*Working with version control like git, mercury, subversion ...*

* [gitex ★36 ⏳1Y](https://github.com/awetzel/gitex) - Elixir implementation of the Git object storage, but with the goal to implement the same semantic with other storage and topics.
