...
---
# Awesome Elixir [![Build Status](https://api.travis-ci.org/h4cc/awesome-elixir.svg?branch=master)](https://travis-ci.org/h4cc/awesome-elixir) [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★63835](https://github.com/sindresorhus/awesome)
A curated list of amazingly awesome Elixir libraries, resources, and shiny things inspired by [awesome-php ★16252](https://github.com/ziadoz/awesome-php).
...
* [exactor ★471](https://github.com/sasa1977/exactor) - Helpers for easier implementation of actors in Elixir.
* [exos](https://github.com/awetzel/exos) - A Port Wrapper which forwards cast and call to a linked Port.
* [flowex ★163](https://github.com/antonmi/flowex) - Railway Flow-Based Programming with Elixir GenStage.
...
* [poolboy ★941](https://github.com/devinus/poolboy) - A hunky Erlang worker pool factory.
* [pooler ★244](https://github.com/seth/pooler) - An OTP Process Pool Application.
* [sbroker ★78](https://github.com/fishcakez/sbroker) - Sojourn-time based active queue management library.
* [workex ★57 ⏳1Y](https://github.com/sasa1977/workex) - Backpressure and flow control in EVM processes.
...
* [combination ★12](https://github.com/seantanly/elixir-combination) - Elixir library to generate combinations and permutations from Enumerable collection.
...
* [ecto_materialized_path ★4](https://github.com/asiniy/ecto_materialized_path) - Tree structure, hierarchy and ancestry for the ecto models.
...
* [exconstructor ★137](https://github.com/appcues/exconstructor) - An Elixir library for generating struct constructors that handle external data with ease.
...
* [exmatrix ★45 ⏳1Y](https://github.com/a115/exmatrix) - ExMatrix is a small library for working with matrices, originally developed for testing matrix multiplication in parallel.
...
* [fsm ★218](https://github.com/sasa1977/fsm) - Finite state machine as a functional data structure.
* [fuse ★283](https://github.com/jlouis/fuse) - This application implements a so-called circuit-breaker for Erlang.
...
* [loom ★150](https://github.com/asonge/loom) - A CRDT library with δ-CRDT support.
...
* [monad ★107 ⏳1Y](https://github.com/rmies/monad) - Haskell inspired monads in Elixir stylish syntax.
...
* [witchcraft ★137](https://github.com/expede/witchcraft) - Common algebraic structures and functions for Elixir.
...
* [ExShop ★156](https://github.com/authentic-pixels/ex-shop) - Digital goods shop & blog created using Phoenix framework.
...
* [Phoenix Battleship ★396](https://github.com/bigardone/phoenix-battleship) - The Good Old game built with Elixir, Phoenix Framework, React and Redux.
...
* [Phoenix Trello ★1878](https://github.com/bigardone/phoenix-trello) - Trello tribute done in Elixir, Phoenix Framework, React and Redux.
* [poxa ★607](https://github.com/edgurgel/poxa) - Open Pusher implementation, compatible with Pusher libraries.
* [Queerlink ★20 ⏳1Y](https://github.com/Queertoo/Queerlink) - A simple yet efficient URL shortening service written in Elixir.
* [Sprint Poker ★144](https://github.com/elpassion/sprint-poker) - Online estimation tool for Agile teams, written using Elixir Lang, Phoenix Framework and React.
...
* [simple_bayes ★273](https://github.com/fredwu/simple_bayes) - A Simple Bayes / Naive Bayes implementation in Elixir.

## Audio and Sounds
*Libraries working with sounds and tones.*

* [erlaudio ★19 ⏳2Y](https://github.com/asonge/erlaudio) - Erlang PortAudio bindings.
* [synthex ★28 ⏳1Y](https://github.com/bitgamma/synthex) - A signal synthesis library.
...
* [coherence ★601](https://github.com/smpallen99/coherence) - Coherence is a full featured, configurable authentication system for Phoenix.
...
* [guardian ★1758](https://github.com/ueberauth/guardian) - An authentication framework for use with Elixir applications.
...
* [oauth2 ★364](https://github.com/scrogson/oauth2) - An OAuth 2.0 client library for Elixir.
...
* [openmaize ★202](https://github.com/riverrun/openmaize) - Authentication library for Elixir.
* [sesamex ★8](https://github.com/khusnetdinov/sesamex) - Another simple and flexible authentication solution in 5 minutes!.
* [shield ★126](https://github.com/mustafaturan/shield) - An OAuth 2.0 provider library and implementation for Phoenix Framework.
...
* [ueberauth ★582](https://github.com/ueberauth/ueberauth) - An Elixir Authentication System for Plug-based Web Applications.
...
* [ueberauth_github ★33](https://github.com/ueberauth/ueberauth_github) - A GitHub strategy for Überauth.
...
* [ueberauth_twitter ★19](https://github.com/ueberauth/ueberauth_twitter) - Twitter Strategy for Überauth.
...
* [bodyguard ★139](https://github.com/schrockwell/bodyguard) - A flexible authorization library for Phoenix applications.
* [canada ★138](https://github.com/jarednorman/canada) - A simple authorization library that provides a friendly interface using declarative permission rules.
* [canary ★292](https://github.com/cpjk/canary) - An authorization library for Elixir applications that restricts what resources the current user is allowed to access.

## Behaviours and Interfaces
*Definitions how something should behave, like Interfaces from OOP-World*

* [connection ★149](https://github.com/fishcakez/connection) - Connection behaviour for connection processes. The API is superset of the GenServer API.
* [gen_state_machine ★82](https://github.com/antipax/gen_state_machine) - Elixir wrapper for gen_statem.
...
* [benchee ★259](https://github.com/PragTob/benchee) - Easy and extensible benchmarking in Elixir!
* [benchfella ★285](https://github.com/alco/benchfella) - Benchmarking tool for Elixir.
...
* [mad ★116](https://github.com/synrc/mad) - Small and Fast Rebar Replacement.
...
* [rebar3_abnfc_plugin ★1 ⏳2Y](https://github.com/surik/rebar3_abnfc_plugin) - Rebar3 abnfc compiler.
...
* [hedwig ★354](https://github.com/hedwig-im/hedwig) - XMPP Client/Bot Framework for Elixir.
...
* [aws ★153](https://github.com/jkakar/aws-elixir) - AWS clients for Elixir.
* [Cloudi](http://cloudi.org/) - CloudI is for back-end server processing tasks that require soft-realtime transaction.
* [discovery ★202](https://github.com/undeadlabs/discovery) - An OTP application for auto-discovering services with Consul.
...
* [coverex ★70](https://github.com/alfert/coverex) - Coverage Reports for Elixir.
* [credo ★2026](https://github.com/rrrene/credo) - A static code analysis tool with a focus on code consistency and teaching Elixir.
* [dialyxir ★557](https://github.com/jeremyjh/dialyxir) - Mix tasks to simplify use of Dialyzer in Elixir projects.
* [dogma ★411](https://github.com/lpil/dogma) - A code style linter for Elixir, powered by shame.
* [excoveralls ★288](https://github.com/parroty/excoveralls) - Coverage report tool for Elixir with coveralls.io integration.
* [exprof ★70 ⏳1Y](https://github.com/parroty/exprof) - A simple code profiler for Elixir, using eprof.
...
* [optimus ★25](https://github.com/savonarola/optimus) - Command-line option parser for Elixir inspired by [clap.rs](https://clap.rs/).
* [progress_bar ★178](https://github.com/henrik/progress_bar) - Command-line progress bars and spinners.
* [table_rex ★62](https://github.com/djm/table_rex) - Generate configurable ASCII style tables for display.
* [tabula ★29](https://github.com/aerosol/tabula) - Pretty print list of Ecto query results / maps in ascii tables (GitHub Markdown/OrgMode).
...
* [conform ★279](https://github.com/bitwalker/conform) - Easy release configuration for Elixir apps.
* [dotenv ★131](https://github.com/avdi/dotenv_elixir) - A port of dotenv to Elixir.
...
* [weave ★44](https://github.com/GT8Online/weave) - JIT configuration loader that works with Kubernetes and Docker Swarm.
...
* [cipher ★25](https://github.com/rubencaro/cipher) - Elixir crypto library to encrypt/decrypt arbitrary binaries.
* [cloak ★141](https://github.com/danielberkompas/cloak) - Cloak makes it easy to use encryption with Ecto.
* [comeonin ★623](https://github.com/riverrun/comeonin) - Password authorization (bcrypt, pbkdf2_sha512 and one-time passwords) library for Elixir.
* [crypto_rsassa_pss ★4](https://github.com/potatosalad/erlang-crypto_rsassa_pss) - RSASSA-PSS Public Key Cryptographic Signature Algorithm for Erlang.
...
* [pot ★48](https://github.com/yuce/pot) - Erlang library for generating one time passwords compatible with Google Authenticator.
...
* [csv ★220](https://github.com/beatrichartz/csv) - CSV Decoding and Encoding for Elixir.
...
* [nimble_csv ★199](https://github.com/plataformatec/nimble_csv) - A simple and fast CSV parsing and dumping library for Elixir.
...
* [calendar ★273](https://github.com/lau/calendar) - Calendar is a date and time library for Elixir.
...
* [quantum ★740](https://github.com/c-rack/quantum-elixir) - Cron-like job scheduler for Elixir applications.
* [repeatex ★25](https://github.com/rcdilorenzo/repeatex) - Natural language parsing for repeating dates.
* [timelier ★9](https://github.com/ausimian/timelier) - A cron-style scheduler for Elixir.
* [timex ★752](https://github.com/bitwalker/timex) - Easy to use Date and Time modules for Elixir.
...
* [ex_debug_toolbar ★189](https://github.com/kagux/ex_debug_toolbar) - A toolbar for Phoenix projects to interactively debug code and display useful information about requests: logs, timelines, database queries etc.
...
* [visualixir ★636](https://github.com/koudelka/visualixir) - A process visualizer for remote BEAM nodes.
...
* [bootleg ★116](https://github.com/labzero/bootleg) - Simple deployment and server automation for Elixir.
...
* [gatling ★386](https://github.com/hashrocket/gatling) - Collection of mix tasks to automatically create a exrm release from git and launch/upgrade it on your server.
...
* [heroku-buildpack-elixir ★544](https://github.com/HashNuke/heroku-buildpack-elixir) - Heroku buildpack to deploy Elixir apps to Heroku.
...
* [ex_doc ★441](https://github.com/elixir-lang/ex_doc) - ExDoc is a tool to generate documentation for your Elixir projects.
...
* [phoenix_swagger ★216](https://github.com/xerions/phoenix_swagger) - Provides swagger integration to the Phoenix framework.

## Domain-specific language
*Specialized computer languages for a particular application domain.*

* [Absinthe Graphql ★1158](https://github.com/absinthe-graphql/absinthe) - Fully featured GraphQL library.
* [graphql ★711](https://github.com/graphql-elixir/graphql) - An Elixir implementation of Facebook's GraphQL.
...
* [phoenix_gon ★23](https://github.com/khusnetdinov/phoenix_gon) - Allow you to pass Phoenix environment or controller variables to JavaScript without problems.

## Email
*Working with Email and stuff.*

* [bamboo ★687](https://github.com/thoughtbot/bamboo) - Composable, testable and adapter based email library. Out of the box support for rendering with Phoenix and a plug for previewing sent emails in dev.
...
* [gen_smtp ★429](https://github.com/Vagabond/gen_smtp) - A generic Erlang SMTP server and client that can be extended via callback modules.
* [gmail ★35](https://github.com/craigp/elixir-gmail) - A simple Gmail REST API client for Elixir.
* [mail ★255](https://github.com/DockYard/elixir-mail) - An RFC2822 implementation in Elixir, built for composability.
...
* [ravenx ★46](https://github.com/acutario/ravenx) - Notification dispatch library for Elixir applications.
...
* [swoosh ★334](https://github.com/swoosh/swoosh) - Compose, deliver and test your Emails easily in Elixir with adapters for SMTP, Sendgrid, Mandrill, Mailgun, Postmark and Phoenix integration with mailbox preview.
...
* [exceptional ★78](https://github.com/expede/exceptional) - Helpers for happy-path programming & exception handling.
* [happy ★25](https://github.com/vic/happy) - Happy path programming, alternative to elixir `with` form.
* [OK ★129](https://github.com/CrowdHailer/OK) - Elegant error handling with result monads, featuring a simple & powerful `with` construct and a happy path pipe operator.
* [ok_jose ★48](https://github.com/vic/ok_jose) - Pipe elixir functions that match `{:ok,_}`, `{:error,_}` tuples or custom patterns.
* [sentry-elixir ★136](https://github.com/getsentry/sentry-elixir) - The Official Elixir client for [Sentry](https://sentry.io/).

## Eventhandling
*Sending/Emitting and receiving/handling Events in Elixir.*

* [event_bus ★43](https://github.com/mustafaturan/event_bus) - Simple event bus implementation with topic filtering and built-in event store and event watcher.
* [goldrush ★60](https://github.com/DeadZen/goldrush) - Small, Fast event processing and monitoring for Erlang/OTP applications.
* [reaxive ★138 ⏳1Y](https://github.com/alfert/reaxive) - Reaxive is a reactive event handling library, inspired by [Elm](http://elm-lang.org) and Reactive Extensions.
...
* [elixir_koans ★681](https://github.com/elixirkoans/elixir-koans) - [Elixir koans](http://elixirkoans.io/) is a fun, easy way to get started with the elixir programming language.
...
* [magnetissimo ★1976](https://github.com/sergiotapia/magnetissimo) - Web application that indexes all popular torrent sites, and saves it to the local database.
...
* [fun_with_flags ★55](https://github.com/tompave/fun_with_flags) - A feature toggle library using Redis or Ecto for persistance, an ETS cache for speed and PubSub for distributed cache busting. Comes with a management web UI for Phoenix and Plug.
...
* [feeder ★23](https://github.com/michaelnisi/feeder) - Parse RSS and Atom feeds.
...
* [arc ★635](https://github.com/stavro/arc) - Flexible file upload and attachment library for Elixir.
...
* [exfile ★62](https://github.com/keichan34/exfile) - File upload handling, persistence, and processing in Elixir and Plug.
...
* [absinthe_plug ★69](https://github.com/absinthe-graphql/absinthe_plug) - Plug support for Absinthe.
* [addict ★583](https://github.com/trenpixster/addict) - User authentication for Phoenix Framework.
...
* [commanded ★235](https://github.com/slashdotdash/commanded) - Command handling middleware for Command Query Responsibility Segregation (CQRS) applications.
* [cors_plug ★134](https://github.com/mschae/cors_plug) - An Elixir plug that adds CORS headers to requests and responds to preflight requests (OPTIONS).
...
* [ex_admin ★803](https://github.com/smpallen99/ex_admin) - ExAdmin is an auto administration package for Elixir and the Phoenix Framework.
...
* [graphql_parser](https://github.com/graphql-elixir/graphql_parser) - An Elixir binding for [libgraphqlparser ★426](https://github.com/graphql/libgraphqlparser).
...
* [kerosene ★134](https://github.com/elixirdrops/kerosene) - Pagination for Ecto and Phoenix.
...
* [params ★75](https://github.com/vic/params) - Use Ecto to enforce/validate parameters structure, akin to Rails' strong parameters.
...
* [phoenix_html ★110](https://github.com/phoenixframework/phoenix_html) - Phoenix.HTML functions for working with HTML strings and templates.
...
* [phoenix_slime ★155](https://github.com/slime-lang/phoenix_slime) - Slim template support for Phoenix.
* [phoenix_token_auth ★163 ⏳1Y](https://github.com/manukall/phoenix_token_auth) - Token authentication solution for Phoenix. Useful for APIs or single page apps.
...
* [react_phoenix ★155](https://github.com/geolessel/react-phoenix) - Render React.js components in Phoenix views focusing on easy installation and Brunch compatibility.
...
* [trailing_format_plug ★17](https://github.com/mschae/trailing_format_plug) - An Elixir plug to support legacy APIs that use a rails-like trailing format.
...
* [kitto ★567](https://github.com/kittoframework/kitto) - A framework for interactive dashboards.
* [phoenix ★10137](https://github.com/phoenixframework/phoenix) - Elixir Web Framework targeting full-featured, fault tolerant applications with realtime functionality.
...
* [entice ★61 ⏳1Y](https://github.com/entice/entice) - A distributed Entity-Component-System framework, providing its own example MMORPG server.
* [mines ★14](https://github.com/kevlar1818/mines) - A minesweeper clone in the terminal.
...
* [topo ★18](https://github.com/pkinney/topo) - A Geometry library for Elixir that calculates spatial relationships between two geometries.

## Hardware
*Hardware related things like I/O interfaces and such.*

* [elixir_ale ★211](https://github.com/fhunleth/elixir_ale) - Elixir access to hardware I/O interfaces such as GPIO, I2C, and SPI.
* [nerves ★493](https://github.com/nerves-project/nerves) - Framework for building firmware for platforms like Raspberry Pi and BeagleBone Black.
...
* [elli ★645](https://github.com/knutin/elli) - Elli is a webserver you can run inside your Erlang application to expose an HTTP API.
...
* [exvcr ★305](https://github.com/parroty/exvcr) - HTTP request/response recording library for Elixir, inspired by VCR.
...
* [hackney ★712](https://github.com/benoitc/hackney) - Simple HTTP client written in Erlang.
...
* [httpoison ★1046](https://github.com/edgurgel/httpoison) - Yet Another HTTP client for Elixir powered by hackney.
* [httpotion ★588](https://github.com/myfreeweb/httpotion) - Fancy HTTP client for Elixir, based on ibrowse.
...
* [mochiweb ★1531](https://github.com/mochi/mochiweb) - MochiWeb is an Erlang library for building lightweight HTTP servers.
* [neuron ★40](https://github.com/uesteibar/neuron) - A GraphQL client for Elixir.
...
* [scrape ★180](https://github.com/Anonyfox/elixir-scrape) - Scrape any website, article or RSS/Atom Feed with ease.
* [spell ★50](https://github.com/MyMedsAndMe/spell) - Spell is a [Web Application Messaging Protocol](http://wamp-proto.org/) (WAMP) client implementation in Elixir.
* [tesla ★393](https://github.com/teamon/tesla) - HTTP client library, with support for middleware and multiple adapters.
...
* [web_socket ★44](https://github.com/slogsdon/plug-web-socket) - An exploration into a stand-alone library for Plug applications to easily adopt WebSockets.
...
* [imgex ★15](https://github.com/ianwalter/imgex) - Unofficial client library for generating imgix URLs in Elixir.
* [mogrify ★195](https://github.com/route/mogrify) - An Elixir wrapper for ImageMagick command line.
...
* [elixometer ★559](https://github.com/pinterest/elixometer) - A light Elixir wrapper around exometer.
...
* [prometheus.ex ★94](https://github.com/deadtrickster/prometheus.ex) - Elixir-friendly [Prometheus.io](https://prometheus.io) monitoring system and time series database client.
...
* [exjsx ★146](https://github.com/talentdeficit/exjsx) - JSON for Elixir, based on `jsx`.
* [ja_serializer](https://github.com/AgilionApps/ja_serializer) - JSONAPI.org Serialization in Elixir.
* [jazz ★63 ⏳3Y](https://github.com/meh/jazz) - Yet another library to handle JSON in Elixir.
* [joken ★320](https://github.com/bryanjos/joken) - Encodes and decodes JSON Web Tokens.
* [jose ★108](https://github.com/potatosalad/erlang-jose) - JSON Object Signing and Encryption (JOSE) for Erlang and Elixir.
* [json ★179](https://github.com/cblage/elixir-json) - Native JSON library for Elixir.
* [json_pointer ★7 ⏳2Y](https://github.com/xavier/json_pointer) - Implementation of RFC 6901 which defines a string syntax for identifying a specific value within a JSON document.
...
* [lighthouse_scheme ★27](https://github.com/jwhiteman/lighthouse-scheme) - A small Lisp-like language and interactive REPL, built in Elixir.
...
* [timber ★41](https://github.com/timberio/timber-elixir) - Structured logging platform; turns raw text logs into rich structured events.
...
* [OK ★129](https://github.com/CrowdHailer/OK) - Macros for elegant happy path coding, maximizing power and readability.
* [ok_jose ★48](https://github.com/vic/ok_jose) - Pipe elixir functions that match `{:ok,_}`, `{:error,_}` tuples or custom patterns.
...
* [shorter_maps ★67](https://github.com/meyercm/shorter_maps) - ~M sigil for map shorthand. `~M{id name} ~> %{id: id, name: name}`.

## Markdown
*Libraries and tools working with Markdown and such.*

* [cmark ★38](https://github.com/asaaki/cmark.ex) - Elixir NIF for CommonMark (in C), a parser following the CommonMark spec.
* [discount ★20 ⏳1Y](https://github.com/asaaki/discount.ex) - Elixir NIF for discount, a Markdown parser.
* [earmark ★310](https://github.com/pragdave/earmark) - Markdown parser for Elixir.
...
* [Apex ★194](https://github.com/bjro/apex) - Awesome Print for Elixir.
...
* [ex_rated ★124](https://github.com/grempe/ex_rated) - Simple and flexible rate-limiting for API's or anything.
...
* [spotify_ex ★32](https://github.com/jsncmgs1/spotify_ex) - An Elixir wrapper for the Spotify Web API.
...
* [Rustler ★677](https://github.com/hansihe/Rustler) - Library for writing NIFs for Erlang or Elixir safely in Rust. No segfaults.
...
* [download ★2](https://github.com/asiniy/download) - Download files from the internet easily.
* [eio ★9 ⏳1Y](https://github.com/falood/eio) - Elixir server of engine.io.
* [ejabberd ★3108](https://github.com/processone/ejabberd) - Robust, ubiquitous and massively scalable Jabber/XMPP Instant Messaging platform.
...
* [socket ★482](https://github.com/meh/elixir-socket) - Socket wrapping for Elixir.
* [sshex ★73](https://github.com/rubencaro/sshex) - Simple SSH helpers for Elixir.
...
* [amnesia ★414](https://github.com/meh/amnesia) - Mnesia wrapper for Elixir.
...
* [boltun ★89](https://github.com/bitgamma/boltun) - Transforms notifications from the Postgres LISTEN/NOTIFY mechanism into callback execution.
* [cassandra_ecto ★18](https://github.com/vintikzzz/cassandra_ecto) - Ecto adapter for Apache Cassandra.
* [caylir ★14](https://github.com/mneudert/caylir) - Cayley driver for Elixir.
...
* [ecto ★2856](https://github.com/elixir-ecto/ecto) - A database wrapper and language integrated query for Elixir.
...
* [ecto_mnesia ★69](https://github.com/Nebo15/ecto_mnesia) - Ecto adapter for Mnesia Erlang term database.
* [ecto_ordered ★26](https://github.com/zovafit/ecto-ordered) - Ecto extension for ordered models.
...
* [mariaex ★171](https://github.com/xerions/mariaex) - MariaDB/MySQL driver for Elixir.
* [moebius ★436](https://github.com/robconery/moebius) - A functional query tool for Elixir and PostgreSQL.
...
* [mongodb_ecto ★230](https://github.com/michalmuskala/mongodb_ecto) - MongoDB adapter for Ecto.
* [mysql ★198](https://github.com/mysql-otp/mysql-otp) - MySQL/OTP – MySQL driver for Erlang/OTP.
...
* [paper_trail ★125](https://github.com/izelnakri/paper_trail) - Ecto plugin for tracking and recording all the changes in your database.
* [postgrex ★450](https://github.com/elixir-ecto/postgrex) - PostgreSQL driver for Elixir.
* [red ★15](https://github.com/rodrigues/red) - Persist relationships between objects in Redis, in a graph-like way.
* [redix ★319](https://github.com/whatyouhide/redix) - Superfast, pipelined, resilient Redis driver for Elixir.
* [redo ★16](https://github.com/heroku/redo) - Heroku's pipelining redis client for erlang.
* [rethinkdb ★465](https://github.com/hamiltop/rethinkdb-elixir) - Rethinkdb client in pure Elixir using JSON protocol.
* [riak ★158](https://github.com/drewkerrigan/riak-elixir-client) - A Riak client written in Elixir.
...
* [tirexs ★364](https://github.com/Zatvobor/tirexs) - An Elixir flavored DSL for building JSON based requests to Elasticsearch engine.
...
* [gutenex ★168](https://github.com/SenecaSystems/gutenex) - Native PDF generation for Elixir.
* [pdf2htmlex ★34 ⏳1Y](https://github.com/ricn/pdf2htmlex) - Convert PDF docs to beautiful HTML files without losing text or format.
* [pdf_generator ★82](https://github.com/gutschilla/elixir-pdf-generator) - A simple wrapper for wkhtmltopdf (HTML to PDF) for use in Elixir projects.
...
* [exprotobuf ★278](https://github.com/bitwalker/exprotobuf) - Protocol Buffers in Elixir, made easy.
* [grpc-elixir ★173](https://github.com/tony612/grpc-elixir) - The Elixir implementation of gRPC.
...
* [riffed ★246](https://github.com/pinterest/riffed) - Provides idiomatic Elixir bindings for Apache Thrift.
* [Sippet ★8](https://github.com/balena/elixir-sippet) - An Elixir library designed to be used as SIP protocol middleware.
...
* [amqp ★248](https://github.com/pma/amqp) - Simple Elixir wrapper for the Erlang RabbitMQ client, based on Langohr.
...
* [enm ★87](https://github.com/basho/enm) - enm is an Erlang port driver that wraps the nanomsg C library.
* [exdisque](https://github.com/mosic/exdisque) - Elixir client for [Disque ★6313](https://github.com/antirez/disque), an in-memory, distributed job queue.
* [exq ★665](https://github.com/akira/exq) - Job processing library for Elixir - compatible with Resque/Sidekiq.
...
* [honeydew ★165](https://github.com/koudelka/honeydew) - Honeydew is a worker pool library for Elixir.
* [hulaaki ★75](https://github.com/suvash/hulaaki) - An MQTT 3.1.1 client library written in Elixir.
* [kafka_consumer ★17](https://github.com/anoskov/kafka-consumer) - Consumer for Kafka using kafka_ex.
* [kafka_ex ★196](https://github.com/kafkaex/kafka_ex) - Kafka client library for Elixir.
...
* [que ★237](https://github.com/sheharyarn/que) - Simple Background Job Processing with Mnesia.
...
* [task_bunny ★96](https://github.com/shinyscorpion/task_bunny) - background processing application written in Elixir and uses RabbitMQ as a messaging backend.
* [toniq ★232](https://github.com/joakimk/toniq) - Simple and reliable background job library for Elixir.
* [verk ★363](https://github.com/edgurgel/verk) - Verk is a job processing system backed by Redis. It uses the same job definition of Sidekiq/Resque.
...
* [distillery ★1257](https://github.com/bitwalker/distillery) - A pure Elixir implementation of release packaging functionality for the Erlang VM.
* [eliver ★23](https://github.com/glasnoster/eliver) - Interactive semantic versioning for Elixir packages.
* [exrm ★927](https://github.com/bitwalker/exrm) - Automatically generate a release for your Elixir project.
...
* [mix_docker ★221](https://github.com/Recruitee/mix_docker) - Put your Elixir app production release inside minimal docker image.
...
* [plug_rest ★32](https://github.com/christopheradams/plug_rest) - REST behaviour and Plug router for hypermedia web applications.
...
* [coil ★51 ⏳3Y](https://github.com/badosu/coil) - Minimalistic static content engine.
* [obelisk ★254](https://github.com/BennyHallett/obelisk) - Static blog and website generator.
...
* [bbmustache ★64](https://github.com/soranoba/bbmustache) - Binary pattern match Based Mustache template engine for Erlang/OTP.
...
* [blacksmith ★145](https://github.com/batate/blacksmith) - Data generation framework for Elixir.
* [blitzy ★63](https://github.com/benjamintanweihao/blitzy) - A simple HTTP load tester in Elixir.
* [bypass ★309](https://github.com/pspdfkit-labs/bypass) - Bypass provides a quick way to create a mock HTTP server with a custom plug.
...
* [double ★19](https://github.com/sonerdy/double) - Create stub dependencies for testing without overwriting global modules.
...
* [espec ★442](https://github.com/antonmi/espec) - BDD test framework for Elixir inspired by RSpec.
* [espec_phoenix ★94](https://github.com/antonmi/espec_phoenix) - ESpec for Phoenix web framework.
* [ex_machina ★768](https://github.com/thoughtbot/ex_machina) - Flexible test factories for Elixir. Works out of the box with Ecto and Ecto associations.
...
* [excheck ★235](https://github.com/parroty/excheck) - Property-based testing library for Elixir (QuickCheck style).
...
* [faker ★297](https://github.com/igas/faker) - Faker is a pure Elixir library for generating fake data.
...
* [hound ★832](https://github.com/HashNuke/hound) - Elixir library for writing integration tests and browser automation.
...
* [mix_test_watch ★319](https://github.com/lpil/mix-test.watch) - Automatically run your Elixir project's tests each time you save a file.
* [mixunit ★2 ⏳2Y](https://github.com/talentdeficit/mixunit) - An EUnit task for Mix based projects.
* [mock ★248](https://github.com/jjh42/mock) - Mocking library for the Elixir language.
...
* [proper ★547](https://github.com/manopapad/proper) - PropEr (PROPerty-based testing tool for ERlang) is a QuickCheck-inspired open-source property-based testing tool for Erlang.
...
* [wallaby ★491](https://github.com/keathley/wallaby) - Wallaby helps test your web applications by simulating user interactions concurrently and manages browsers.
...
* [eden](https://github.com/jfacorro/Eden) - [EDN ★1497 ⏳1Y](https://github.com/edn-format/edn) encoder/decoder for Elixir.
...
* [erldn](https://github.com/marianoguerra/erldn) - [EDN ★1497 ⏳1Y](https://github.com/edn-format/edn) format parser for the Erlang platform.
...
* [haikunator ★17 ⏳1Y](https://github.com/knrz/Haikunator) - Generate Heroku-like memorable random names to use in your apps or anywhere else.
* [hashids ★129](https://github.com/alco/hashids-elixir) - Hashids lets you obfuscate numerical identifiers via reversible mapping.
* [hexate ★19](https://github.com/rjsamson/hexate) - Simple module for Hex encoding / decoding in Elixir.
* [html_sanitize_ex ★78](https://github.com/rrrene/html_sanitize_ex) - HTML sanitizer for Elixir.
...
* [number ★73](https://github.com/danielberkompas/number) - Number is a pretentiously-named Elixir library which provides functions to convert numbers into a variety of different formats.
...
* [quickrand ★18](https://github.com/okeuday/quickrand) - Quick Random Number Generation.
...
* [sentient ★27](https://github.com/dantame/sentient) - Simple sentiment analysis based on the AFINN-111 wordlist.
* [simetric ★33](https://github.com/lexmag/simetric) - String similarity metrics for Elixir.
* [slime ★157](https://github.com/slime-lang/slime) - An Elixir library for rendering slim-like templates.
* [slugger ★86](https://github.com/h4cc/slugger) - Slugger can generate slugs from given strings that can be used in URLs or file names.
...
* [tomlex ★28](https://github.com/zamith/tomlex) - A TOML parser for Elixir.
...
* [uuid ★166](https://github.com/zyro/elixir-uuid) - UUID generator and utilities for Elixir.
* [uuid_erl ★132](https://github.com/okeuday/uuid) - Erlang Native UUID Generation.
* [veritaserum ★34](https://github.com/uesteibar/veritaserum) - Sentiment analysis based on afinn-165, emojis and some enhancements.
...
* [commerce_billing ★119](https://github.com/joshnuss/commerce_billing) - A payment-processing library for Elixir that supports multiple gateways (e.g. Bogus & Stripe).
...
* [elixir_ipfs_api ★18 ⏳1Y](https://github.com/zabirauf/elixir-ipfs-api) - IPFS (InterPlanetary File System) API client for Elixir.
...
* [ethereumex ★11](https://github.com/exthereum/ethereumex) - Elixir JSON-RPC client for the Ethereum blockchain.
...
* [ex_statsd ★83](https://github.com/CargoSense/ex_statsd) - A statsd client implementation for Elixir.
...
* [extwitter ★270](https://github.com/parroty/extwitter) - Twitter client library for Elixir.
...
* [google_sheets ★27](https://github.com/GrandCru/GoogleSheets) - Elixir library for fetching and polling Google spreadsheet data in CSV format.
...
* [pigeon ★141](https://github.com/codedge-llc/pigeon) - HTTP2-compliant wrapper for sending iOS and Android push notifications.
...
* [slack ★358](https://github.com/BlakeWilliams/Elixir-Slack) - Slack real time messaging client in Elixir.
* [sparkpost ★29](https://github.com/SparkPost/elixir-sparkpost) - An Elixir library for sending email using SparkPost.
* [statix ★81](https://github.com/lexmag/statix) - Expose app metrics in the StatsD protocol.
...
* [trans ★72](https://github.com/belaustegui/trans) - A Elixir library to manage embedded translations into models leveraging PostgreSQL JSONB datatype.
...
* [erlang-history ★452](https://github.com/ferd/erlang-history) - Hacks to add shell history to Erlang's shell.
...
* [sitemap ★42](https://github.com/ikeikeikeike/sitemap) - Sitemap is the easiest way to generate Sitemaps in Elixir.
...
* [exop ★33](https://github.com/madeinussr/exop) - A library that allows to encapsulate business logic and validate params with predefined contract.
...
* [vex ★242](https://github.com/CargoSense/vex) - An extensible data validation library for Elixir.
...
* [ffmpex ★44](https://github.com/talklittle/ffmpex) - FFmpeg command line wrapper.
...
* [erlsom ★177](https://github.com/willemdj/erlsom) - Erlsom is an Erlang library to parse (and generate) XML documents.
...
* [floki ★656](https://github.com/philss/floki) - A simple HTML parser that enables searching using CSS like selectors.
...
* [readability ★87](https://github.com/keepcosmos/readability) - Readability is for extracting and curating articles.
...
* [yaml_elixir ★37](https://github.com/KamilLelonek/yaml-elixir) - Yaml parser for Elixir based on native Erlang implementation.
...
* [Alchemist ★677](https://github.com/tonini/alchemist.el) - Elixir Tooling Integration Into Emacs.
* [Alchemist-Server ★171](https://github.com/tonini/alchemist-server) - Editor/IDE independent background server to inform about Elixir mix projects.
* [Alchemist.vim ★368](https://github.com/slashmili/alchemist.vim) - Elixir Tooling Integration Into Vim.
* [Atom](https://atom.io/packages/language-elixir) - Elixir language support for Atom.
* [atom-elixir ★396](https://github.com/msaraiva/atom-elixir) - An Atom package for Elixir.
...
* [ElixirSublime ★344](https://github.com/vishnevskiy/ElixirSublime) - Elixir plugin for SublimeText 3 that provides code completion and linting.
...
## Other Awesome Lists
*Other amazingly awesome lists can be found at [jnv/lists](https://github.com/jnv/lists#lists-of-lists) or [bayandin/awesome-awesomeness ★19487](https://github.com/bayandin/awesome-awesomeness#awesome-awesomeness).*

* [Awesome Elixir by LibHunt](https://elixir.libhunt.com) - A curated list of awesome Elixir and Erlang packages and resources.
* [Awesome Erlang ★708](https://github.com/drobakowski/awesome-erlang) - A curated list of awesome Erlang libraries, resources and shiny things.
* [Erlang Bookmarks ★984](https://github.com/0xAX/erlang-bookmarks) - A collection of links for Erlang developers.
...
* [Elixir Functional Programming ★205](https://github.com/kblake/functional-programming) - Material to introduce functional programming using the Elixir language.
...
* [christopheradams/elixir_style_guide ★2283](https://github.com/christopheradams/elixir_style_guide) - A community-driven style guide for Elixir.
* [lexmag/elixir-style-guide ★210](https://github.com/lexmag/elixir-style-guide) - An opinionated Elixir style guide.
* [rrrene/elixir-style-guide](https://github.com/rrrene/elixir-style-guide) - Style guide checked by [Credo ★2026](https://github.com/rrrene/credo).

## Websites
*Useful Elixir-related websites.*

* [30 Days of Elixir ★2038](https://github.com/seven1m/30-days-of-elixir) - A walk through the Elixir language in 30 exercises.
...
* [Elixir China ★188](https://github.com/jw2013/elixir-china) - Chinese Elixir website [elixir-cn.com](http://elixir-cn.com/).
...
* [Elixir Github Repository ★10822](https://github.com/elixir-lang/elixir) - The project repository.
* [Elixir Github Wiki](https://github.com/elixir-lang/elixir/wiki) - The project's wiki, containing much useful information.
* [Elixir Job Board](http://jobs.elixirdose.com) - A job board for Elixir, and community of Elixir developers, [written using Phoenix ★72](https://github.com/rizafahmi/elixirjobs).
