...
> A curated list of awesome [gulp ★28388](https://github.com/gulpjs/gulp) resources, plugins, and boilerplates for a better development workflow automation.
...
* [Github Repository ★28388](https://github.com/gulpjs/gulp)
...
* [Gulp Cheatsheet ★1375 ⏳1Y](https://github.com/osscafe/gulp-cheatsheet)
* [Playground for Gulp Recipes ★524](https://github.com/johnpapa/gulp-patterns)

## Plugins
### Compilation
* [gulp-sass](https://github.com/dlmanning/gulp-sass) - Sass → CSS with [libsass ★3654](https://github.com/sass/libsass).
* [gulp-ruby-sass ★485](https://github.com/sindresorhus/gulp-ruby-sass) - Sass → CSS with Ruby Sass.
...
* [gulp-stylus](https://github.com/stevelacy/gulp-stylus) - [Stylus ★8771](https://github.com/stylus/stylus) → CSS.
...
* [gulp-coffee](https://github.com/contra/gulp-coffee) - [Coffeescript ★14500](https://github.com/jashkenas/coffeescript) → JavaScript.
...
* [webpack-stream](https://github.com/shama/webpack-stream) - Run [webpack ★35039](https://github.com/webpack/webpack) as a stream to conveniently integrate with gulp.
...
* [gulp-myth](https://github.com/sindresorhus/gulp-myth) - [Myth ★4389](https://github.com/segmentio/myth) - a polyfill for future versions of the CSS spec.
* [gulp-cssnext](https://github.com/MoOx/gulp-cssnext) - [:no_entry:] Use tomorrow's CSS syntax, today, using [cssnext ★4884](https://github.com/MoOx/postcss-cssnext).

### Concatenation
* [gulp-concat ★698](https://github.com/contra/gulp-concat) - Concatenate files.
...
* [gulp-svgmin ★301](https://github.com/ben-eb/gulp-svgmin) - Minify SVG files with gulp.

### Optimization
* [gulp-uncss](https://github.com/ben-eb/gulp-uncss) - Remove unused CSS selectors with [UnCSS ★7207](https://github.com/giakki/uncss).
...
* [gulp-responsive ★397](https://github.com/mahnunchik/gulp-responsive) - Generate images at different sizes.
* [gulp-svgstore ★583](https://github.com/w0rm/gulp-svgstore) - Combine svg files into one with <symbol> elements.
* [gulp-iconfont ★684](https://github.com/nfroidure/gulp-iconfont) - Create icon fonts from several SVG icons.

### Injecting Assets
* [gulp-useref ★661](https://github.com/jonkemp/gulp-useref) - Parse build blocks in HTML files to replace references to non-optimized scripts or stylesheets.
* [gulp-inject ★733](https://github.com/klei/gulp-inject) - Transform each file to a string and inject each transformed string into placeholders in the target stream files.
* [wiredep ★1183](https://github.com/taptapship/wiredep) - Wire Bower dependencies to your source code.

### Templating
* [gulp-angular-templatecache ★516](https://github.com/miickel/gulp-angular-templatecache) - Concatenate and register AngularJS templates in the $templateCache.
...
* [gulp-markdown ★135](https://github.com/sindresorhus/gulp-markdown) - Markdown → HTML.
...
* [gulp-swig](https://github.com/colynb/gulp-swig) - [Swig ★3037](https://github.com/paularmstrong/swig) templates → HTML.
...
* [gulp-coffeelint](https://github.com/janraasch/gulp-coffeelint) - A style checker that helps keep [CoffeeScript ★14500](https://github.com/jashkenas/coffeescript) code clean.
...
* [gulp-eslint ★504](https://github.com/adametry/gulp-eslint) - Identify and report on patterns found in ECMAScript/JavaScript code.
...
* [gulp-check-unused-css ★354](https://github.com/zalando/gulp-check-unused-css) - Check your HTML templates for unused CSS classes.
...
* [gulp-livereload ★764](https://github.com/vohof/gulp-livereload) - Gulp plugin for livereload.

### Caching
* [gulp-changed ★678](https://github.com/sindresorhus/gulp-changed) - Only pass through changed files.
* [gulp-cached ★424 ⏳1Y](https://github.com/contra/gulp-cached) - A simple in-memory file cache.
* [gulp-remember ★143](https://github.com/ahaurw01/gulp-remember) - Remember and recall files passed through it.
* [gulp-newer ★201](https://github.com/tschaub/gulp-newer) - Pass through newer source files only.

### Flow Control
* [merge-stream ★133](https://github.com/grncdr/merge-stream) - Merge multiple streams into one interleaved stream.
* [streamqueue ★58](https://github.com/nfroidure/StreamQueue) - Pipe queued streams progressively.
* [run-sequence ★924](https://github.com/OverZealous/run-sequence) - Run a series of dependent gulp tasks in order.
* [gulp-if ★567 ⏳1Y](https://github.com/robrich/gulp-if) - Conditionally run a task.

### Logging
* [gulp-notify ★568](https://github.com/mikaelbr/gulp-notify) - Notification plugin for gulp.
* [gulp-size ★213](https://github.com/sindresorhus/gulp-size) - Display the size of your project.
* [gulp-debug ★197](https://github.com/sindresorhus/gulp-debug) - Debug vinyl file streams to see what files are run through your gulp pipeline.
...
* [gulp-util ★812](https://github.com/gulpjs/gulp-util) - Set of useful utilities.
* [gulp-plumber ★745](https://github.com/floatdrop/gulp-plumber) - Prevent pipe breaking caused by errors.
* [gulp-load-plugins ★728](https://github.com/jackfranklin/gulp-load-plugins) - Automatically load in gulp plugins.
* [main-bower-files ★595 ⏳1Y](https://github.com/ck86/main-bower-files) - Simplify build process setup by dynamically getting the library files.
* [autoprefixer ★14383](https://github.com/postcss/autoprefixer) - Parse CSS and add vendor prefixes to rules by Can I Use.
* [gulp-sourcemaps](https://github.com/floridoo/gulp-sourcemaps) - Provide source map support.
* [gulp-replace ★387](https://github.com/lazd/gulp-replace) - A string replace plugin for gulp.
* [gulp-rename ★571](https://github.com/hparra/gulp-rename) - Rename files easily.
* [gulp-rev ★1361](https://github.com/sindresorhus/gulp-rev) - Static asset revisioning by appending content hash to filenames: unicorn.css → unicorn-d41d8cd98f.css.
* [del ★730](https://github.com/sindresorhus/del) - Delete files/folders using globs.
* [gulp-exec ★126](https://github.com/robrich/gulp-exec) - Run a shell command.
* [gulp-strip-debug ★211](https://github.com/sindresorhus/gulp-strip-debug) - Strip console, alert, and debugger statements from JavaScript code.
...
* [gulp-gh-pages ★580](https://github.com/shinnn/gulp-gh-pages) - Publish contents to Github pages.
...
* [gulp-file-include ★484](https://github.com/coderhaoxin/gulp-file-include) - Include files with gulp.
* [gulp-zip ★217](https://github.com/sindresorhus/gulp-zip) - ZIP compress files.
* [gulp-git ★373](https://github.com/stevelacy/gulp-git) - Run Git commands with gulp.
* [gulp-filter ★278](https://github.com/sindresorhus/gulp-filter) - Filter files in a vinyl stream using globbing.
...
## Scaffolding
### Boilerplates
* [web-starter-kit ★17922](https://github.com/google/web-starter-kit) - Google Web Starter Kit.
* [gulp-plugin-boilerplate ★59](https://github.com/sindresorhus/gulp-plugin-boilerplate) - Boilerplate to kickstart creating gulp plugins.
* [polymer-starter-kit ★2452](https://github.com/polymerelements/polymer-starter-kit) - A starting point for Polymer 1.0 apps.
* [este ★5306](https://github.com/este/este) - The most complete React/Flux dev stack and starter kit for isomorphic functional web apps.
* [mnml ★726](https://github.com/mrmrs/mnml) - Minimal boilerplate to start a responsive HTML5/Sass project.
* [kraken ★668 ⏳1Y](https://github.com/cferdinandi/kraken) - A lightweight, mobile-first boilerplate for front-end web developers.
* [angularjs-gulp-browserify-boilerplate ★1069](https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate) - Boilerplate using AngularJS, Sass, gulp, and Browserify.
...
* [react-starterkit ★356](https://github.com/wbkd/react-starterkit) - React starter kit that contains react-router, Reflux, jest, webpack, gulp and Stylus.

### Yeoman Generators
* [generator-gulp-webapp](https://github.com/yeoman/generator-gulp-webapp) - A gulp generator for modern webapps.
* [generator-gulp-angular ★3886 ⏳1Y](https://github.com/Swiip/generator-gulp-angular) - Yeoman generator for AngularJS with gulp.
...
* [generator-gulp-plugin-boilerplate](https://github.com/sindresorhus/generator-gulp-plugin-boilerplate) - Scaffold out a [gulp plugin boilerplate ★59](https://github.com/sindresorhus/gulp-plugin-boilerplate).
* [generator-jekyllized ★336](https://github.com/sondr3/generator-jekyllized) - Jekyll workflow with gulp, Sass, AutoPrefixer, asset optimization and cache busting and much more.
