...
---
# Awesome Gulp [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★65640](https://github.com/sindresorhus/awesome)

> A curated list of awesome [gulp ★27537](https://github.com/gulpjs/gulp) resources, plugins, and boilerplates for a better development workflow automation.

*Looking for something else? Take a look at other [awesome lists ★65640](https://github.com/sindresorhus/awesome).*
...
* [Github Repository ★27537](https://github.com/gulpjs/gulp)
...
* [Gulp Cheatsheet ★1365 ⏳1Y](https://github.com/osscafe/gulp-cheatsheet)
* [Playground for Gulp Recipes ★523 ⏳1Y](https://github.com/johnpapa/gulp-patterns)
...
### Concatenation
* [gulp-concat ★679](https://github.com/contra/gulp-concat) - Concatenate files.
...
### Optimization
* [gulp-uncss](https://github.com/ben-eb/gulp-uncss) - Remove unused CSS selectors with [UnCSS ★7037](https://github.com/giakki/uncss).
...
### Injecting Assets
* [gulp-useref ★647 ⏳1Y](https://github.com/jonkemp/gulp-useref) - Parse build blocks in HTML files to replace references to non-optimized scripts or stylesheets.
* [gulp-inject ★717](https://github.com/klei/gulp-inject) - Transform each file to a string and inject each transformed string into placeholders in the target stream files.
...
* [gulp-handlebars](https://github.com/lazd/gulp-handlebars) - [Handlebars ★12421](https://github.com/wycats/handlebars.js) templates → JavaScript.
* [gulp-hb](https://github.com/shannonmoeller/gulp-hb) - [Handlebars ★12421](https://github.com/wycats/handlebars.js) templates → HTML.
* [gulp-nunjucks](https://github.com/sindresorhus/gulp-nunjucks) - [Nunjucks ★4562](https://github.com/mozilla/nunjucks) templates → JavaScript.
* [gulp-dustjs](https://github.com/sindresorhus/gulp-dust) - [Dust ★2639](https://github.com/linkedin/dustjs) templates → JavaScript.
* [gulp-riot](https://github.com/e-jigsaw/gulp-riot) - [Riot ★12356](https://github.com/riot/riot) templates → JavaScript.
* [gulp-markdown ★129 ⏳1Y](https://github.com/sindresorhus/gulp-markdown) - Markdown → HTML.
* [gulp-template](https://github.com/sindresorhus/gulp-template) - [Lodash  ★26223](https://github.com/lodash/lodash) templates → JavaScript.
* [gulp-swig](https://github.com/colynb/gulp-swig) - [Swig ★2980](https://github.com/paularmstrong/swig) templates → HTML.
* [gulp-remark](https://github.com/denysdovhan/gulp-remark) - Gulp plugin for [remark ★1081](https://github.com/wooorm/remark) - markdown processor powered by plugins
...
* [gulp-check-unused-css ★348](https://github.com/zalando/gulp-check-unused-css) - Check your HTML templates for unused CSS classes.
...
* [gulp-livereload ★750 ⏳1Y](https://github.com/vohof/gulp-livereload) - Gulp plugin for livereload.

### Caching
* [gulp-changed ★657](https://github.com/sindresorhus/gulp-changed) - Only pass through changed files.
* [gulp-cached ★415](https://github.com/contra/gulp-cached) - A simple in-memory file cache.
* [gulp-remember ★139 ⏳1Y](https://github.com/ahaurw01/gulp-remember) - Remember and recall files passed through it.
* [gulp-newer ★190](https://github.com/tschaub/gulp-newer) - Pass through newer source files only.
...
* [gulp-size ★209 ⏳1Y](https://github.com/sindresorhus/gulp-size) - Display the size of your project.
* [gulp-debug ★188](https://github.com/sindresorhus/gulp-debug) - Debug vinyl file streams to see what files are run through your gulp pipeline.

### Testing
* [gulp-mocha](https://github.com/sindresorhus/gulp-mocha) - Run [Mocha ★13294](https://github.com/mochajs/mocha) tests.
* [gulp-jasmine](https://github.com/sindresorhus/gulp-jasmine) - Run [Jasmine 2 ★12849](https://github.com/jasmine/jasmine) tests in Node.js.
* [gulp-protractor](https://github.com/mllrsohn/gulp-protractor) - Gulp wrapper for [Protractor ★6921](https://github.com/angular/protractor) tests.
...
* [gulp-util ★791](https://github.com/gulpjs/gulp-util) - Set of useful utilities.
* [gulp-plumber ★726](https://github.com/floatdrop/gulp-plumber) - Prevent pipe breaking caused by errors.
* [gulp-load-plugins ★716](https://github.com/jackfranklin/gulp-load-plugins) - Automatically load in gulp plugins.
* [main-bower-files ★593 ⏳1Y](https://github.com/ck86/main-bower-files) - Simplify build process setup by dynamically getting the library files.
* [autoprefixer ★13674](https://github.com/postcss/autoprefixer) - Parse CSS and add vendor prefixes to rules by Can I Use.
* [gulp-sourcemaps](https://github.com/floridoo/gulp-sourcemaps) - Provide source map support.
* [gulp-replace ★366](https://github.com/lazd/gulp-replace) - A string replace plugin for gulp.
* [gulp-rename ★557](https://github.com/hparra/gulp-rename) - Rename files easily.
* [gulp-rev ★1297](https://github.com/sindresorhus/gulp-rev) - Static asset revisioning by appending content hash to filenames: unicorn.css → unicorn-d41d8cd98f.css.
...
* [gulp-strip-debug ★201](https://github.com/sindresorhus/gulp-strip-debug) - Strip console, alert, and debugger statements from JavaScript code.
...
* [gulp-inline-css ★225](https://github.com/jonkemp/gulp-inline-css) - Inline your CSS properties into the style attribute in an HTML file.
* [gulp-gh-pages ★562](https://github.com/shinnn/gulp-gh-pages) - Publish contents to Github pages.
* [gulp-ng-annotate](https://github.com/Kagami/gulp-ng-annotate) - Add AngularJS dependency injection annotations with [ng-annotate ★2080](https://github.com/olov/ng-annotate).
* [gulp-bump ★243](https://github.com/stevelacy/gulp-bump) - Bump any semver JSON version.
* [gulp-file-include ★453](https://github.com/coderhaoxin/gulp-file-include) - Include files with gulp.
* [gulp-zip ★209](https://github.com/sindresorhus/gulp-zip) - ZIP compress files.
* [gulp-git ★367](https://github.com/stevelacy/gulp-git) - Run Git commands with gulp.
* [gulp-filter ★273](https://github.com/sindresorhus/gulp-filter) - Filter files in a vinyl stream using globbing.
...
## Scaffolding
### Boilerplates
* [web-starter-kit ★17649](https://github.com/google/web-starter-kit) - Google Web Starter Kit.
* [gulp-plugin-boilerplate ★58 ⏳1Y](https://github.com/sindresorhus/gulp-plugin-boilerplate) - Boilerplate to kickstart creating gulp plugins.
* [polymer-starter-kit ★2431](https://github.com/polymerelements/polymer-starter-kit) - A starting point for Polymer 1.0 apps.
* [este ★5205](https://github.com/este/este) - The most complete React/Flux dev stack and starter kit for isomorphic functional web apps.
* [mnml ★729](https://github.com/mrmrs/mnml) - Minimal boilerplate to start a responsive HTML5/Sass project.
* [kraken ★657](https://github.com/cferdinandi/kraken) - A lightweight, mobile-first boilerplate for front-end web developers.
* [angularjs-gulp-browserify-boilerplate ★1077](https://github.com/jakemmarsh/angularjs-gulp-browserify-boilerplate) - Boilerplate using AngularJS, Sass, gulp, and Browserify.
* [hapi-ninja ★395 ⏳2Y](https://github.com/poeticninja/hapi-ninja) - A Node.js, Hapi, and Swig boilerplate.
...
* [generator-ionic-gulp ★139 ⏳1Y](https://github.com/tmaximini/generator-ionic-gulp) - A Yeoman generator for Ionic Projects with gulp.
* [generator-gulp-plugin-boilerplate](https://github.com/sindresorhus/generator-gulp-plugin-boilerplate) - Scaffold out a [gulp plugin boilerplate ★58 ⏳1Y](https://github.com/sindresorhus/gulp-plugin-boilerplate).
* [generator-jekyllized ★332](https://github.com/sondr3/generator-jekyllized) - Jekyll workflow with gulp, Sass, AutoPrefixer, asset optimization and cache busting and much more.
