...
* [Github Repository ★27847](https://github.com/gulpjs/gulp)
...
* [Gulp Cheatsheet ★1374 ⏳1Y](https://github.com/osscafe/gulp-cheatsheet)
* [Playground for Gulp Recipes ★521](https://github.com/johnpapa/gulp-patterns)

## Plugins
### Compilation
* [gulp-sass](https://github.com/dlmanning/gulp-sass) - Sass → CSS with [libsass ★3618](https://github.com/sass/libsass).
* [gulp-ruby-sass ★481 ⏳1Y](https://github.com/sindresorhus/gulp-ruby-sass) - Sass → CSS with Ruby Sass.
...
* [gulp-cssnext](https://github.com/MoOx/gulp-cssnext) - [:no_entry:] Use tomorrow's CSS syntax, today, using [cssnext ★4721](https://github.com/MoOx/postcss-cssnext).
...
### Optimization
* [gulp-uncss](https://github.com/ben-eb/gulp-uncss) - Remove unused CSS selectors with [UnCSS ★7080](https://github.com/giakki/uncss).
...
* [gulp-responsive ★392](https://github.com/mahnunchik/gulp-responsive) - Generate images at different sizes.
* [gulp-svgstore ★577 ⏳1Y](https://github.com/w0rm/gulp-svgstore) - Combine svg files into one with <symbol> elements.
* [gulp-iconfont ★669](https://github.com/nfroidure/gulp-iconfont) - Create icon fonts from several SVG icons.

### Injecting Assets
* [gulp-useref ★654](https://github.com/jonkemp/gulp-useref) - Parse build blocks in HTML files to replace references to non-optimized scripts or stylesheets.
* [gulp-inject ★724](https://github.com/klei/gulp-inject) - Transform each file to a string and inject each transformed string into placeholders in the target stream files.
* [wiredep ★1175](https://github.com/taptapship/wiredep) - Wire Bower dependencies to your source code.
...
### Live Reload
* [browser-sync](https://github.com/BrowserSync/browser-sync) - Keep multiple browsers & devices in sync when building websites ([recipes ★395](https://github.com/BrowserSync/gulp-browser-sync)).
* [gulp-livereload ★753 ⏳1Y](https://github.com/vohof/gulp-livereload) - Gulp plugin for livereload.

### Caching
* [gulp-changed ★664](https://github.com/sindresorhus/gulp-changed) - Only pass through changed files.
* [gulp-cached ★417](https://github.com/contra/gulp-cached) - A simple in-memory file cache.
* [gulp-remember ★138 ⏳1Y](https://github.com/ahaurw01/gulp-remember) - Remember and recall files passed through it.
* [gulp-newer ★195](https://github.com/tschaub/gulp-newer) - Pass through newer source files only.
...
* [run-sequence ★904](https://github.com/OverZealous/run-sequence) - Run a series of dependent gulp tasks in order.
* [gulp-if ★557 ⏳1Y](https://github.com/robrich/gulp-if) - Conditionally run a task.

### Logging
* [gulp-notify ★567](https://github.com/mikaelbr/gulp-notify) - Notification plugin for gulp.
* [gulp-size ★210 ⏳1Y](https://github.com/sindresorhus/gulp-size) - Display the size of your project.
...
* [gulp-util ★801](https://github.com/gulpjs/gulp-util) - Set of useful utilities.
* [gulp-plumber ★729](https://github.com/floatdrop/gulp-plumber) - Prevent pipe breaking caused by errors.
* [gulp-load-plugins ★721](https://github.com/jackfranklin/gulp-load-plugins) - Automatically load in gulp plugins.
...
* [autoprefixer ★13913](https://github.com/postcss/autoprefixer) - Parse CSS and add vendor prefixes to rules by Can I Use.
...
* [gulp-inline-css ★228](https://github.com/jonkemp/gulp-inline-css) - Inline your CSS properties into the style attribute in an HTML file.
* [gulp-gh-pages ★566](https://github.com/shinnn/gulp-gh-pages) - Publish contents to Github pages.
* [gulp-ng-annotate](https://github.com/Kagami/gulp-ng-annotate) - Add AngularJS dependency injection annotations with [ng-annotate ★2086](https://github.com/olov/ng-annotate).
* [gulp-bump ★242](https://github.com/stevelacy/gulp-bump) - Bump any semver JSON version.
* [gulp-file-include ★462](https://github.com/coderhaoxin/gulp-file-include) - Include files with gulp.
* [gulp-zip ★213](https://github.com/sindresorhus/gulp-zip) - ZIP compress files.
* [gulp-git ★370](https://github.com/stevelacy/gulp-git) - Run Git commands with gulp.
* [gulp-filter ★271](https://github.com/sindresorhus/gulp-filter) - Filter files in a vinyl stream using globbing.
...
## Scaffolding
### Boilerplates
* [web-starter-kit ★17759](https://github.com/google/web-starter-kit) - Google Web Starter Kit.
...
* [polymer-starter-kit ★2446](https://github.com/polymerelements/polymer-starter-kit) - A starting point for Polymer 1.0 apps.
* [este ★5245](https://github.com/este/este) - The most complete React/Flux dev stack and starter kit for isomorphic functional web apps.
...
* [generator-gulp-angular ★3900](https://github.com/Swiip/generator-gulp-angular) - Yeoman generator for AngularJS with gulp.
* [generator-react-gulp-browserify ★427 ⏳1Y](https://github.com/randylien/generator-react-gulp-browserify) - A Yeoman Generator for React library. It includes gulp, Browserify, Browsersync and Bootstrap.
