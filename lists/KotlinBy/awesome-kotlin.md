...
[![List of Awesome List Badge](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) [![Travis CI Build Status Badge](https://api.travis-ci.org/KotlinBy/awesome-kotlin.svg?branch=master)](https://travis-ci.org/KotlinBy/awesome-kotlin) [![Awesome Kotlin Badge](https://kotlin.link/awesome-kotlin.svg) ★2572](https://github.com/KotlinBy/awesome-kotlin)
...
```markdown
[![Awesome Kotlin Badge](https://kotlin.link/awesome-kotlin.svg) ★2572](https://github.com/KotlinBy/awesome-kotlin)
```
...
* [JetBrains/kotlin ★16670](https://github.com/jetbrains/kotlin)
...
* [Kotlin/KEEP ★453](https://github.com/Kotlin/KEEP) - Kotlin Evolution and Enhancement Process
...
* [From Java To Kotlin ★265](https://github.com/fabiomsr/from-java-to-kotlin)
* [dbacinski/Design-Patterns-In-Kotlin ★1143](https://github.com/dbacinski/Design-Patterns-In-Kotlin) - Design Patterns implemented in Kotlin.
...
* [Kotlin/ktor ★1217](https://github.com/Kotlin/ktor) - Web backend framework for Kotlin.
* [TinyMission/kara ★445](https://github.com/TinyMission/kara) - Web framework written in Kotlin.
* [http4k/http4k](http://www.http4k.org) - Toolkit for serving and consuming HTTP services in a functional and consistent way.
* [jean79/yested ★76](https://github.com/jean79/yested) - A Kotlin framework for building web applications in Javascript.
* [hhariri/wasabi ★459](https://github.com/wasabifx/wasabi) - An HTTP Framework built with Kotlin for the JVM.
* [Kotlin/kotlinx.html ★169](https://github.com/Kotlin/kotlinx.html) - Kotlin DSL for HTML.
* [MarioAriasC/KotlinPrimavera ★57](https://github.com/MarioAriasC/KotlinPrimavera) - Spring support libraries for Kotlin.
* [kohesive/kovert ★75](https://github.com/kohesive/kovert) - An invisible, super easy and powerful REST and Web framework over Vert.x or Undertow.
* [sdeleuze/spring-kotlin ★151](https://github.com/sdeleuze/spring-kotlin) - Kotlin extensions for Spring projects.
* [pgutkowski/KGraphQL ★14](https://github.com/pgutkowski/KGraphQL) - A GraphQL implementation written in Kotlin
...
* [vert-x3/vertx-lang-kotlin ★27](https://github.com/vert-x3/vertx-lang-kotlin) - This module provides Kotlin language bindings including DSL and extension functions for vert.x 3
* [jooby/kotlin](http://jooby.org/doc/lang-kotlin) - Kotlin idioms for Jooby microframework
* [gimlet2/kottpd ★19](https://github.com/gimlet2/kottpd) - REST framework in pure Kotlin, inspired by spark-java
* [kwebio/core ★54](https://github.com/kwebio/core) -  A Kotlin interface to one or more remote web-browsers.
* [brianmadden/krawler ★30](https://github.com/brianmadden/krawler) - A web crawling framework written in Kotlin
...
* [perwendel/spark-kotlin ★268](https://github.com/perwendel/spark-kotlin) - A DSL in idiomatic Kotlin for the Spark web framework.
...
* [danneu/kog ★22](https://github.com/danneu/kog) - A web framework focused on simplicity, middleware, and functional composition

### <a name="libraries-frameworks-tests"></a>Tests <sup>[Back ⇈](#libraries-frameworks-tests-subcategory)</sup>
* [JetBrains/spek ★756](https://github.com/jetbrains/spek) - A specification framework for Kotlin.
* [npryce/hamkrest ★131](https://github.com/npryce/hamkrest) - A reimplementation of Hamcrest to take advantage of Kotlin language features.
* [nhaarman/mockito-kotlin ★596](https://github.com/nhaarman/mockito-kotlin) - Using Mockito with Kotlin.
* [MarkusAmshove/Kluent ★170](https://github.com/MarkusAmshove/Kluent) - Fluent Assertion-Library for Kotlin.
* [winterbe/expekt ★76](https://github.com/winterbe/expekt) - BDD assertion library for Kotlin.
* [kotlintest/kotlintest ★440](https://github.com/kotlintest/kotlintest) - KotlinTest is a flexible and comprehensive testing tool for the Kotlin ecosystem based on and heavily inspired by the superb Scalatest.
...
* [EPadronU/balin ★21](https://github.com/EPadronU/balin) - Balin is a browser automation library for Kotlin. It's basically a Selenium-WebDriver wrapper library inspired by Geb.
...
* [qwertukg/SeleniumBuilder ★14](https://github.com/qwertukg/SeleniumBuilder) - DSL for Selenium 2.0. Provide a possibility to write tests in Kotlin builder style.
...
* [SalomonBrys/Kodein ★539](https://github.com/SalomonBrys/Kodein) - Painless Kotlin Dependency Injection .
* [kohesive/injekt ★200](https://github.com/kohesive/injekt) - (Deprecated, @see Kodein) Dependency Injection / Object Factory for Kotlin.
* [kailan/kodeinject ★9](https://github.com/kailan/kodeinject) - Constructor dependency injection for Kodein.
* [traversals/kapsule ★76](https://github.com/traversals/kapsule) - Minimalist dependency injection library for Kotlin.
...
* [Ekito/koin ★84](https://github.com/Ekito/koin) - A functional Kotlin dependency injection framework for Android and JVM.

### <a name="libraries-frameworks-coroutines"></a>Coroutines <sup>[Back ⇈](#libraries-frameworks-coroutines-subcategory)</sup>
* [Kotlin/kotlin-coroutines ★380](https://github.com/Kotlin/kotlin-coroutines) - Design documents and examples for coroutines in Kotlin.
* [Kotlin/kotlinx.coroutines ★698](https://github.com/Kotlin/kotlinx.coroutines) - Libraries built upon Kotlin coroutines.
* [soywiz/korio ★43](https://github.com/soywiz/korio) - Korio: Kotlin cORoutines I/O: Streams + Async TCP Client/Server + Virtual File System for JVM, Node.JS and Browser.
* [soywiz/korim ★9](https://github.com/soywiz/korim) - Korim: Kotlin cORoutines IMaging utilities depending on Korio.
* [soywiz/korui ★8](https://github.com/soywiz/korui) - Korui: Kotlin cORoutines User Interfaces: korio + kimage + korui
* [konrad-kaminski/spring-kotlin-coroutine ★31](https://github.com/konrad-kaminski/spring-kotlin-coroutine) - Kotlin coroutine support for Spring.
...
* [MarioAriasC/funKTionale ★488](https://github.com/MarioAriasC/funKTionale) - Functional constructs for Kotlin.
* [ReactiveX/RxKotlin ★2463](https://github.com/ReactiveX/RxKotlin) - RxJava bindings for Kotlin.
* [kittinunf/Result ★179](https://github.com/kittinunf/Result) - The modelling for success/failure of operations in Kotlin.
* [brianegan/bansa ★340](https://github.com/brianegan/bansa) - A state container for Kotlin & Java, inspired by Elm & Redux.
* [pardom/redux-kotlin ★150](https://github.com/pardom/redux-kotlin) - Direct port of Redux for Kotlin.
* [beyondeye/Reduks ★88](https://github.com/beyondeye/Reduks) - A "batteries included" port of Reduxjs for Kotlin+Android
* [pakoito/Komprehensions ★43](https://github.com/pakoito/Komprehensions) - Do comprehensions for Kotlin and 3rd party libraries.
* [h0tk3y/kotlin-monads ★43](https://github.com/h0tk3y/kotlin-monads) - Monads for Kotlin
...
* [cbeust/klaxon ★277](https://github.com/cbeust/klaxon) - Lightweight library to parse JSON in Kotlin.
* [SalomonBrys/Kotson ★349](https://github.com/SalomonBrys/Kotson) - Gson for Kotlin, Kotson enables you to parse and write JSON with Google's Gson using a conciser and easier syntax.
* [FasterXML/jackson-module-kotlin ★271](https://github.com/FasterXML/jackson-module-kotlin) - Jackson module that adds support for serialization/deserialization of Kotlin classes and data classes.
* [fboldog/ext4klaxon ★4 ⏳1Y](https://github.com/fboldog/ext4klaxon) - Type Extensions (Long, Int, Enum, Date) for Klaxon.
* [Jire/KTON ★18 ⏳1Y](https://github.com/Jire/KTON) - Object notation in pure Kotlin!

### <a name="libraries-frameworks-database"></a>Database <sup>[Back ⇈](#libraries-frameworks-database-subcategory)</sup>
* [JetBrains/Exposed ★665](https://github.com/jetbrains/Exposed) - Exposed is a prototype for a lightweight SQL library written over JDBC driver for Kotlin language.
* [cheptsov/kotlin-nosql ★153 ⏳1Y](https://github.com/cheptsov/kotlin-nosql) - NoSQL database query and access library for Kotlin.
* [jankotek/mapdb ★2728](https://github.com/jankotek/mapdb) - MapDB provides concurrent Maps, Sets and Queues backed by disk storage or off-heap-memory. It is a fast and easy to use embedded Java database engine.
* [seratch/kotliquery ★41](https://github.com/seratch/kotliquery) - A handy database access library in Kotlin.
* [andrewoma/kwery ★126](https://github.com/andrewoma/kwery) - Kwery is an SQL library for Kotlin.
* [square/sqldelight ★1474](https://github.com/square/sqldelight) - Generates Java models from CREATE TABLE statements.
* [x2bool/kuery ★68](https://github.com/x2bool/kuery) - Typesafe SQL with Kotlin.
* [Litote/kmongo ★38](https://github.com/Litote/kmongo) - KMongo - Kotlin toolkit for Mongo
...
* [s4kibs4mi/PultusORM ★59](https://github.com/s4kibs4mi/PultusORM) - PultusORM is a sqlite ORM library for kotlin on top of sqlite jdbc driver.
...
* [Kotlin/dokka ★312](https://github.com/Kotlin/dokka) - Documentation Engine for Kotlin.
...
* [holgerbrandl/kscript ★119](https://github.com/holgerbrandl/kscript) - Scripting utils for Kotlin.
* [kohesive/keplin ★10](https://github.com/kohesive/keplin) - Secure Kotlin scripting and binary lambda-scripts.
* [shyiko/ktlint ★359](https://github.com/shyiko/ktlint) - Kotlin linter.
* [jtransc/jtransc ★173](https://github.com/jtransc/jtransc) - JVM AOT compiler created in Kotlin.
* [arturbosch/detekt ★473](https://github.com/arturbosch/detekt) - Static code analysis for Kotlin.
...
* [edvin/tornadofx ★765](https://github.com/edvin/tornadofx) - Lightweight JavaFX Framework for Kotlin/

### <a name="libraries-frameworks-http-clients"></a>Http Clients <sup>[Back ⇈](#libraries-frameworks-http-clients-subcategory)</sup>
* [kittinunf/Fuel ★896](https://github.com/kittinunf/Fuel) - The easiest HTTP networking library for Kotlin/Android.
* [jkcclemens/khttp ★112](https://github.com/jkcclemens/khttp) - Kotlin HTTP requests library.

### <a name="libraries-frameworks-editors"></a>Editors <sup>[Back ⇈](#libraries-frameworks-editors-subcategory)</sup>
* [JetBrains/intellij-community ★4669](https://github.com/JetBrains/intellij-community) - IntelliJ IDEA Community Edition
...
* [vkostyukov/kotlin-sublime-package ★39](https://github.com/vkostyukov/kotlin-sublime-package) - A Sublime Package for Kotlin.
* [udalov/kotlin-vim ★127](https://github.com/udalov/kotlin-vim) - Kotlin Syntax Highlighter for Vim.
* [sargunster/kotlin-textmate-bundle](https://github.com/sargunster/kotlin-textmate-bundle) - Kotlin bundle for TextMate.
* [ice1000/NppExtension ★13](https://github.com/ice1000/NppExtension) - Kotlin Language extension for Notepad++
* [ftomassetti/kanvas ★43](https://github.com/ftomassetti/kanvas) - A truly hackable editor: simple, lightweight, understandable.
* [mathiasfrohlich/vscode-kotlin ★34](https://github.com/mathiasfrohlich/vscode-kotlin) - Kotlin language support for VS Code.
...
* [jneen/rouge ★2017](https://github.com/jneen/rouge) - A pure-ruby code highlighter that is compatible with pygments. (wip)
* [isagalaev/highlight.js ★10429](https://github.com/isagalaev/highlight.js) - Javascript syntax highlighter. (out-of-date)
* [github/linguist ★4935](https://github.com/github/linguist) - For Ruby/Github, uses Sublime package
...
* [libktx/ktx ★164](https://github.com/libktx/ktx) - Kotlin utilities for LibGDX applications.
* [AlmasB/FXGL ★348](https://github.com/AlmasB/FXGL) - JavaFX 8 Game Library written in Java + Kotlin
* [icela/FriceEngine ★132](https://github.com/icela/FriceEngine) - Make game developing easy again!

### <a name="libraries-frameworks-misc"></a>Misc <sup>[Back ⇈](#libraries-frameworks-misc-subcategory)</sup>
* [Kotlin/kotlinx.reflect.lite ★24 ⏳1Y](https://github.com/Kotlin/kotlinx.reflect.lite) - Lightweight library allowing to introspect basic stuff about Kotlin symbols.
* [puniverse/quasar](https://github.com/puniverse/quasar/tree/master/quasar-kotlin) - Fibers, Channels and Actors for the JVM.
* [MehdiK/Humanizer.jvm ★101 ⏳1Y](https://github.com/MehdiK/Humanizer.jvm) - Humanizer.jvm meets all your jvm needs for manipulating and displaying strings, enums, dates, times, timespans, numbers and quantities.
* [mplatvoet/kovenant ★425](https://github.com/mplatvoet/kovenant) - Promises for Kotlin and Android
* [kohesive/klutter ★80](https://github.com/kohesive/klutter) - A mix of random small libraries for Kotlin, the smallest reside here until big enough for their own repository.
* [kohesive/solr-undertow ★80](https://github.com/kohesive/solr-undertow) - Solr Standalone Tiny and High performant server.
* [leprosus/kotlin-hashids ★26 ⏳2Y](https://github.com/leprosus/kotlin-hashids) - Library that generates short, unique, non-sequential hashes from numbers.
...
* [hotchemi/khronos ★136](https://github.com/hotchemi/khronos) - An intuitive Date extensions in Kotlin.
* [yole/kxdate ★37](https://github.com/yole/kxdate) - Kotlin extensions for Java 8 java.time API
* [ingokegel/jclasslib ★392](https://github.com/ingokegel/jclasslib) - jclasslib bytecode viewer is a tool that visualizes all aspects of compiled Java class files and the contained bytecode.
* [holgerbrandl/krangl ★38](https://github.com/holgerbrandl/krangl) - krangl is a {K}otlin library for data w{rangl}ing
* [debop/koda-time ★23](https://github.com/debop/koda-time) - Joda Time Extensions in Kotlin. (From Java 8 use java.time instead)
* [MicroUtils/kotlin-logging ★237](https://github.com/MicroUtils/kotlin-logging) - Lightweight logging framework for Kotlin. Used as a wrapper for slf4j with Kotlin extensions.
* [cesarferreira/kotlin-pluralizer ★22](https://github.com/cesarferreira/kotlin-pluralizer) - Kotlin extension to pluralize and singularize strings.
* [JoelW-S/groothy ★3](https://github.com/JoelW-S/groothy) - Kotlin implementation of Groovy Truth.
* [Jire/Strukt ★25](https://github.com/Jire/Strukt) - Value types on the JVM, today!
* [moshbit/Kotlift ★261 ⏳1Y](https://github.com/moshbit/Kotlift) - Kotlift is the first source-to-source language transpiler from Kotlin to Swift.
* [consoleau/kassava ★25](https://github.com/consoleau/kassava) - This library provides some useful kotlin extension functions for implementing toString() and equals() without all of the boilerplate.
* [moove-it/fakeit ★230](https://github.com/moove-it/fakeit) - Generates realistic fake data — like names, emails, dates, countries — to be used in your Android development environment.
* [czyzby/kotlin-times ★25](https://github.com/czyzby/kotlin-times) - A simple utility library for readable loops.
* [phxql/aleksa ★22](https://github.com/phxql/aleksa) - Aleksa is a small framework for writing Alexa Skills in Kotlin.
* [cretz/asmble ★72](https://github.com/cretz/asmble) - Compile WebAssembly to JVM and other WASM tools.
* [h0tk3y/better-parse ★12](https://github.com/h0tk3y/better-parse) - A nice parser combinator library for Kotlin

### <a name="libraries-frameworks-extensions"></a>Extensions <sup>[Back ⇈](#libraries-frameworks-extensions-subcategory)</sup>
* [Kotlin/kotlinx.support ★41 ⏳1Y](https://github.com/Kotlin/kotlinx.support) - Extension and top-level functions to use JDK7/JDK8 features in Kotlin 1.0.

### <a name="libraries-frameworks-configuration"></a>Configuration <sup>[Back ⇈](#libraries-frameworks-configuration-subcategory)</sup>
* [npryce/konfig ★67](https://github.com/npryce/konfig) - A Type Safe Configuration API for Kotlin
* [mariomac/kaconf ★17](https://github.com/mariomac/kaconf) - KickAss Configuration. An annotation-based configuration system for Java and Kotlin
* [config4k/config4k ★12](https://github.com/config4k/config4k) - A Kotlin wrapper for Typesafe Config
* [jdiazcano/cfg4k ★14](https://github.com/jdiazcano/cfg4k) - Flexible and easy to use config library written in kotlin.
* [daviddenton/configur8 ★4](https://github.com/daviddenton/configur8) - A Kotlin port of Configur8 - A Type Safe Configuration API for Kotlin, extendable to user-defined types.
...
* [uchuhimo/konf ★2](https://github.com/uchuhimo/konf) - A type-safe cascading configuration library for Kotlin/Java, supporting most configuration formats

### <a name="libraries-frameworks-graphics"></a>Graphics <sup>[Back ⇈](#libraries-frameworks-graphics-subcategory)</sup>
* [kotlin-graphics/glm ★6](https://github.com/kotlin-graphics/glm) - g-truck glm port, opengl mathematics library
* [kotlin-graphics/kotlin-unsigned ★19](https://github.com/kotlin-graphics/kotlin-unsigned) - Unsigned operators and boxed types (Ubyte, Uint, Ulong and Ushort) for unsigned support.
* [kotlin-graphics/gli ★2](https://github.com/kotlin-graphics/gli) - g-truck gli port, image library
* [kotlin-graphics/uno-sdk ★3](https://github.com/kotlin-graphics/uno-sdk) - Unofficial OpenGL SDK
...
* [kotlin-graphics/assimp ★9](https://github.com/kotlin-graphics/assimp) - Open Asset Import Library port
* [GlimpseFramework/glimpse-framework ★8](https://github.com/GlimpseFramework/glimpse-framework) - OpenGL made simple.
* [java-opengl-labs/modern-jogl-examples ★30](https://github.com/java-opengl-labs/modern-jogl-examples) - port of 'Learning Modern 3D Graphic Programming' by J.L.McKesson (jogl)
* [java-opengl-labs/learn-OpenGL ★6](https://github.com/java-opengl-labs/learn-OpenGL) - port of https://learnopengl.com/ tutorial (lwjgl)
* [kotlin-graphics/imgui ★16](https://github.com/kotlin-graphics/imgui) - jvm port of imgui
* [Jonatino/JOGL2D ★7](https://github.com/Jonatino/JOGL2D) - Zero-overhead 2D rendering library for JOGL using Kotlin.
...
* [thomasnield/kotlin-statistics ★198](https://github.com/thomasnield/kotlin-statistics) - Advanced math and statistical extensions for Kotlin.
* [holgerbrandl/krangl ★38](https://github.com/holgerbrandl/krangl) - krangl is a {K}otlin library for data w{rangl}ing.
* [kyonifer/koma ★82](https://github.com/kyonifer/koma) - A scientific computing library for Kotlin.
* [MarcinMoskala/KotlinDiscreteMathToolkit ★43](https://github.com/MarcinMoskala/KotlinDiscreteMathToolkit) - Set of extensions for Kotlin that provides Discrete Math functionalities as an Kotlin extension functions.
* [sekwiatkowski/Komputation ★127](https://github.com/sekwiatkowski/Komputation) - A neural network framework written in Kotlin.
...
* [leprosus/kotlin-cli ★22 ⏳1Y](https://github.com/leprosus/kotlin-cli) - Kotlin-CLI - command line interface options parser for Kotlin.
* [jimschubert/kopper ★35](https://github.com/jimschubert/kopper) - A simple Kotlin option parser
* [xenomachina/kotlin-argparser ★146](https://github.com/xenomachina/kotlin-argparser) - Easy to use and concise yet powerful and robust command line argument parsing for Kotlin.

### <a name="libraries-frameworks-browsers"></a>Browsers <sup>[Back ⇈](#libraries-frameworks-browsers-subcategory)</sup>
* [wendigo/chrome-reactive-kotlin ★8](https://github.com/wendigo/chrome-reactive-kotlin) - Chrome Debugging Protocol for Kotlin (with RxJava2)


## <a name="projects"></a>Projects <sup>[Back ⇈](#projects-category)</sup>
### <a name="projects-web"></a>Web <sup>[Back ⇈](#projects-web-subcategory)</sup>
* [sdeleuze/spring-boot-kotlin-demo ★209](https://github.com/sdeleuze/spring-boot-kotlin-demo) - Basic Spring Boot app in Kotlin.
...
* [corda/corda ★866](https://github.com/corda/corda) - Corda is a distributed ledger platform designed to record, manage and automate legal agreements between business partners.
...
* [mixitconf/mixit ★236](https://github.com/mixitconf/mixit) - MiXiT website
* [derveloper/kiny ★23](https://github.com/derveloper/kiny) - Your super simple private serverless service running your kotlin functions like AWS lambda.
* [ssouris/petclinic-spring5-reactive ★16](https://github.com/ssouris/petclinic-spring5-reactive) - Spring 5 Reactive Petclinic app written in Kotlin.

### <a name="projects-build-tools"></a>Build tools <sup>[Back ⇈](#projects-build-tools-subcategory)</sup>
* [cbeust/kobalt ★281](https://github.com/cbeust/kobalt) - Build system inspired by Gradle.
...
* [lice-lang/lice ★39](https://github.com/lice-lang/lice) - A Lisp-like language's interpreter written in Kotlin
...
* [borisf/classyshark-bytecode-viewer ★107](https://github.com/borisf/classyshark-bytecode-viewer) - View your Kotlin generated classes as Java and bytecode format.

### <a name="projects-desktop"></a>Desktop <sup>[Back ⇈](#projects-desktop-subcategory)</sup>
* [ice1000/Dekoder ★1](https://github.com/ice1000/Dekoder) -  A kotlin music player, materially designed.

### <a name="projects-examples"></a>Examples <sup>[Back ⇈](#projects-examples-subcategory)</sup>
* [Kotlin/kotlin-koans ★1232](https://github.com/Kotlin/kotlin-koans) - Kotlin Koans are a series of exercises to get you familiar with the Kotlin Syntax.
* [JetBrains/kotlin-examples ★1040](https://github.com/JetBrains/kotlin-examples) - Various examples for Kotlin.
* [JetBrains/swot ★299](https://github.com/jetbrains/swot) - Identify email addresses or domains names that belong to colleges or universities. Help automate the process of approving or rejecting academic discounts.
...
* [dodyg/Kotlin101 ★108 ⏳1Y](https://github.com/dodyg/Kotlin101) - 101 examples for Kotlin Programming language.
* [dkandalov/kotlin-99 ★241](https://github.com/dkandalov/kotlin-99) - Solve 99 problems with Kotlin!
...
* [vicboma1/Kotlin-Koans ★56](https://github.com/vicboma1/Kotlin-Koans) - hese are the simple solutions of the kotlin koans online with intellij project.
* [vicboma1/GettingStartedKotlin ★15](https://github.com/vicboma1/GettingStartedKotlin) - Learn the basics of getting started with kotlin.
...
* [intellij-rust/intellij-rust ★1393](https://github.com/intellij-rust/intellij-rust) - Rust IDE built using the IntelliJ Platform.
* [dkandalov/activity-tracker ★29](https://github.com/dkandalov/activity-tracker) - Plugin for IntelliJ IDEs to track and record user activity.
...
* [nsk-mironov/kotlin-jetpack ★135 ⏳1Y](https://github.com/nsk-mironov/kotlin-jetpack) - A collection of useful extension methods for Android.
...
* [chibatching/Kotpref ★152](https://github.com/chibatching/Kotpref) - Android SharedPreference delegation for Kotlin.
...
* [mcxiaoke/kotlin-koi ★270](https://github.com/mcxiaoke/kotlin-koi) - Koi, a lightweight kotlin library for Android Development.
* [BennyWang/KBinding ★351](https://github.com/BennyWang/KBinding) - Android View Model binding framework write in kotlin, base on anko, simple but powerful.
* [inaka/KillerTask ★10 ⏳1Y](https://github.com/inaka/KillerTask) -  Android AsyncTask wrapper library, written in Kotlin.
* [grandstaish/paperparcel ★394](https://github.com/grandstaish/paperparcel) - Boilerplate reduction library written specifically for working with Kotlin data classes on Android.
* [andre-artus/AnvilKotlin ★2 ⏳1Y](https://github.com/andre-artus/AnvilKotlin) - Minimal UI library for Android inspired by React.
...
* [nitrico/LastAdapter ★434](https://github.com/nitrico/LastAdapter) - Don't write a RecyclerView adapter again. Not even a ViewHolder!.
* [denisidoro/krouter ★53](https://github.com/denisidoro/krouter) - A lightweight Android activity router.
* [metalabdesign/AsyncAwait ★293](https://github.com/metalabdesign/AsyncAwait) - async/await for Android built upon coroutines introduced in Kotlin 1.1.
...
* [DanielMartinus/Stepper-Touch ★223](https://github.com/DanielMartinus/Stepper-Touch) - Fun playful Android stepper widget for counting, written in Kotlin.
...
* [infotech-group/android-drawable-dsl ★90](https://github.com/infotech-group/android-drawable-dsl) - DSL for constructing the drawables in Kotlin instead of in XML.
* [zsmb13/MaterialDrawerKt ★89](https://github.com/zsmb13/MaterialDrawerKt) - A DSL for creating Material Design navigation drawers without any XML.
* [SnowdreamFramework/ToyBricks ★20](https://github.com/SnowdreamFramework/ToyBricks) - Android Library that provide simpler way to achieve modularity.
* [DanielMartinus/Konfetti ★549](https://github.com/DanielMartinus/Konfetti) - Lightweight particle system to create realistic confetti
...
* [antoniolg/Kotlin-for-Android-Developers ★924](https://github.com/antoniolg/Kotlin-for-Android-Developers) - Companion App for the book "Kotlin Android Developers".
* [damianpetla/kotlin-dagger-example ★396](https://github.com/damianpetla/kotlin-dagger-example) - Example of Android project showing integration with Kotlin and Dagger 2.
* [dodyg/AndroidRivers ★279 ⏳1Y](https://github.com/dodyg/AndroidRivers) - RSS Readers for Android.
...
* [SidneyXu/AndroidDemoIn4Languages ★181](https://github.com/SidneyXu/AndroidDemoIn4Languages) - Comparison between Java, Groovy, Scala, Kotlin in Android Development.
* [inorichi/tachiyomi ★738](https://github.com/inorichi/tachiyomi) -  Free and open source manga reader for Android.
* [ziggy42/Blum-kotlin](https://github.com/ziggy42/Blum-kotlin) - A simple android Twitter client written in Kotlin
* [TwidereProject/Twidere-Android ★1347](https://github.com/TwidereProject/Twidere-Android) - Material Design ready and feature rich Twitter app for Android 4.0+
* [SimpleMobileTools/Simple-Calendar ★492](https://github.com/SimpleMobileTools/Simple-Calendar) - A simple calendar with events, customizable widget and no ads.
* [SimpleMobileTools/Simple-Camera ★99](https://github.com/SimpleMobileTools/Simple-Camera) - A camera with flash, zoom and no ads.
* [SimpleMobileTools/Simple-Draw ★40](https://github.com/SimpleMobileTools/Simple-Draw) - A canvas you can draw on with different colors.
* [SimpleMobileTools/Simple-File-Manager ★75](https://github.com/SimpleMobileTools/Simple-File-Manager) - A simple file manager for browsing and editing files and directories.
* [SimpleMobileTools/Simple-Gallery ★190](https://github.com/SimpleMobileTools/Simple-Gallery) - A gallery for viewing photos and videos without ads.
* [SimpleMobileTools/Simple-Notes ★49](https://github.com/SimpleMobileTools/Simple-Notes) - A simple textfield for adding quick notes without ads.
* [ahong222/happy21 ★2](https://github.com/ahong222/happy21) - A simple game of Black-Jack write with kotlin
* [AllanWang/KAU ★15](https://github.com/AllanWang/KAU) - An extensive collection of Kotlin Android Utils

### <a name="android-extensions"></a>Extensions <sup>[Back ⇈](#android-extensions-subcategory)</sup>
* [ajalt/timberkt ★68](https://github.com/ajalt/timberkt) - Easy Android logging with Kotlin and Timber.

### <a name="android-tools"></a>Tools <sup>[Back ⇈](#android-tools-subcategory)</sup>
* [kiruto/debug-bottle ★670](https://github.com/kiruto/debug-bottle) - Debug Bottle is an Android runtime debug / develop tools written using kotlin language.
...
* [andrewoma/reakt ★203](https://github.com/andrewoma/reakt) - Reakt is a Kotlin wrapper for facebook's React library.
* [pixijs/pixi-native ★35](https://github.com/pixijs/pixi-native) - The aim of this project is to provide a fast lightweight 2D library that works across all devices.
* [shafirov/klogging ★14](https://github.com/shafirov/klogging) - Kotlin logging, both js and jvm.
* [stangls/kotlin-js-jquery ★6](https://github.com/stangls/kotlin-js-jquery) - A small framework for writing client -side web -applications in Kotlin.
* [Kotlin/kotlin-fullstack-sample ★418](https://github.com/Kotlin/kotlin-fullstack-sample) - Kotlin Full-stack Application Example.
* [danfma/kodando ★30](https://github.com/danfma/kodando) - Kotlin JS bindings and libraries.
...
* [Kotlin/kotlin-frontend-plugin ★121](https://github.com/Kotlin/kotlin-frontend-plugin) - Gradle Kotlin plugin for frontend development.
* [huston007/kotlin-loader ★21](https://github.com/huston007/kotlin-loader) - Kotlin webpack loader.

### <a name="kotlin-javascript-integration"></a>Integration <sup>[Back ⇈](#kotlin-javascript-integration-subcategory)</sup>
* [kotlin/ts2kt ★115](https://github.com/kotlin/ts2kt) - Converter of TypeScript definition files to Kotlin declarations (stubs).
...
* [JetBrains/kotlin-native ★1738](https://github.com/JetBrains/kotlin-native) - Kotlin/Native is a LLVM backend for the Kotlin compiler, runtime implementation and native code generation facility using LLVM toolchain.
