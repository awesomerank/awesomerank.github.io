...
GitHub uses [Linguist ★5370](https://github.com/github/linguist) to perform language detection and syntax highlighting. You can find out which keywords are valid by perusing the [languages YAML file](https://github.com/github/linguist/blob/master/lib/linguist/languages.yml).
...
The full list of supported Emojis on GitHub can be found at [emoji-cheat-sheet.com](http://www.emoji-cheat-sheet.com/) or [scotch-io/All-Github-Emoji-Icons ★606](https://github.com/scotch-io/All-Github-Emoji-Icons).
...
### Hub
[Hub ★12000](https://github.com/github/hub) is a command line Git wrapper that gives you extra features and commands that make working with GitHub easier.
...
[*Check out some more cool commands Hub has to offer.* ★12002](https://github.com/github/hub#commands)
...
*This can be aliased using the instructions found [here ★24059](https://github.com/tiimgreen/github-cheat-sheet#aliases).*
