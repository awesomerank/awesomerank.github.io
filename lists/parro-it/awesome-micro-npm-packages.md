...
---
# Awesome Micro npm Packages [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★65640](https://github.com/sindresorhus/awesome)
...
* [arr-flatten ★23](https://github.com/jonschlinkert/arr-flatten) - Recursively flatten an array or arrays.
* [dedupe ★10](https://github.com/seriousManual/dedupe) - Remove duplicates from an array.
...
* [decamelize ★64 ⏳1Y](https://github.com/sindresorhus/decamelize) - Convert a camelized string into a lowercased one with a custom separator: unicornRainbow → unicorn_rainbow.
* [pad-left ★29](https://github.com/jonschlinkert/pad-left) - Left pad a string with zeros or a specified string.
* [to-camel-case ★20 ⏳1Y](https://github.com/ianstormtaylor/to-camel-case) - Convert a string to a camel case.
...
* [node-slug ★819](https://github.com/dodo/node-slug) - slugifies even utf-8 chars.
...
* [fecha ★1151](https://github.com/taylorhakes/fecha) - Javascript Date formatting and parsing.
...
* [timeago.js ★2790](https://github.com/hustcc/timeago.js) - A tiny(~1.7kb) library used to format date with `*** time ago` statement.

### Object

* [map-obj ★41](https://github.com/sindresorhus/map-obj) - Map object keys and values into a new object.
* [filter-obj ★22](https://github.com/sindresorhus/filter-obj) - Filter object keys and values into a new object.
...
* [just-pluck ★4 ⏳1Y](https://github.com/jarofghosts/just-pluck) - Pluck without the madness.
* [deep-equal ★240](https://github.com/substack/node-deep-equal) - Node's assert.deepEqual() algorithm as a standalone module.
* [deep-assign ★225](https://github.com/sindresorhus/deep-assign) - Recursive Object.assign().
...
* [get-value ★37 ⏳1Y](https://github.com/jonschlinkert/get-value) - Use property paths (a.b.c) to get a nested value from an object.
...
* [stringify-object ★133](https://github.com/yeoman/stringify-object) - Stringify an object/array like JSON.stringify just without all the double-quotes.
...
* [compose-function ★27 ⏳1Y](https://github.com/stoeffel/compose-function) - Compose a new function from smaller functions `f(g(x)).
* [curry ★261 ⏳1Y](https://github.com/dominictarr/curry) - A curry function without anything too clever.
* [once ★127](https://github.com/isaacs/once) - Run a function exactly one time.
...
* [mem ★296](https://github.com/sindresorhus/mem) - An optimization technique used to speed up consecutive function calls by caching the result of calls with identical input.

### Math

* [is-number ★26 ⏳1Y](https://github.com/jonschlinkert/is-number) - Returns `true` if the value is a number.

### Stream
* [through2 ★1192](https://github.com/rvagg/through2) - Tiny wrapper around Node streams2 Transform to avoid explicit subclassing noise.
...
* [concat-stream ★419](https://github.com/maxogden/concat-stream) - writable stream that concatenates strings or data and calls a callback with the result.
...
* [pump ★389](https://github.com/mafintosh/pump) - pipe streams together and close all of them if one of them closes.
* [split ★274](https://github.com/dominictarr/split) - Break up a stream and reassemble it so that each line is a chunk.
...
* [sleep-promise ★23 ⏳1Y](https://github.com/brummelte/sleep-promise) - Resolves a promise after a specified delay.
* [is-promise ★43 ⏳1Y](https://github.com/then/is-promise) - Test whether an object looks like a promises-a+ promise.

### File System

* [rimraf ★1917](https://github.com/isaacs/rimraf) - A deep deletion module for node (like rm -rf).
* [mkdirp ★1484](https://github.com/substack/node-mkdirp) - Recursively mkdir, like mkdir -p.
* [du ★20](https://github.com/rvagg/node-du) - A simple JavaScript implementation of du -sb.
* [file-size ★193 ⏳2Y](https://github.com/Nijikokun/file-size) - Lightweight filesize to human-readable / proportions w/o dependencies.
* [tmp ★316](https://github.com/raszi/node-tmp) - Temporary file and directory creator for node.js.
...
* [semver ★1903](https://github.com/npm/node-semver) - The semantic version parser used by npm.
...
* [awesome-nodejs ★18802](https://github.com/sindresorhus/awesome-nodejs) - A curated list of delightful Node.js packages and resources.
* [awesome-npm ★2553](https://github.com/sindresorhus/awesome-npm) - Awesome npm resources and tips.
