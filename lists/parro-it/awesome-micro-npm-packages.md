...
* [node-slug ★803](https://github.com/dodo/node-slug) - slugifies even utf-8 chars.
...
* [timeago.js ★2742](https://github.com/hustcc/timeago.js) - A tiny(~1.7kb) library used to format date with `*** time ago` statement.

### Object

* [map-obj ★40](https://github.com/sindresorhus/map-obj) - Map object keys and values into a new object.
...
* [deep-equal ★232](https://github.com/substack/node-deep-equal) - Node's assert.deepEqual() algorithm as a standalone module.
...
* [stringify-object ★132](https://github.com/yeoman/stringify-object) - Stringify an object/array like JSON.stringify just without all the double-quotes.
...
* [curry ★254 ⏳1Y](https://github.com/dominictarr/curry) - A curry function without anything too clever.
...
* [delegate ★70](https://github.com/zenorocha/delegate) - Lightweight event delegation.
* [insert-css ★177](https://github.com/substack/insert-css) - Insert a string of css into the head
...
* [document-ready ★25](https://github.com/bendrucker/document-ready) - Document ready listener for modern browsers.
...
* [node-uuid ★122](https://github.com/broofa/node-uuid) - Generate RFC-compliant UUIDs in JavaScript.
* [node-mime ★965](https://github.com/broofa/node-mime) - Comprehensive MIME type mapping API based on mime-db module.
