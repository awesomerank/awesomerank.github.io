...
For a list of free hacking books available for download, go [here ★620](https://github.com/Hack-with-Github/Free-Security-eBooks)
...
## Tools
 * [Metasploit ★8218](https://github.com/rapid7/metasploit-framework) A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
 * [mimikatz ★3506](https://github.com/gentilkiwi/mimikatz) - A little tool to play with Windows security
 ...
 * `docker pull bkimminich/juice-shop` - [OWASP Juice Shop ★327](https://github.com/bkimminich/juice-shop#docker-container--)
 ...
 * [dex2jar ★3074](https://github.com/pxb1988/dex2jar) - Tools to work with Android .dex and Java .class files
 ...
 * [ScratchABit ★218](https://github.com/pfalcon/ScratchABit) - Easily retargetable and hackable interactive disassembler with IDAPython-compatible plugin API
...
## Tools
 * [sqlmap ★8456](https://github.com/sqlmapproject/sqlmap) - Automatic SQL injection and database takeover tool
 ...
 * [Nipe ★194](https://github.com/GouveaHeitor/nipe) - A script to make Tor Network your default gateway. 
 ...
 * [sleuthkit ★893](https://github.com/sleuthkit/sleuthkit) - A library and collection of command-line digital forensics tools
 ...
 * [Pentest Cheat Sheets ★94](https://github.com/coreb1t/awesome-pentest-cheat-sheets) - Collection of cheat sheets useful for pentesting
