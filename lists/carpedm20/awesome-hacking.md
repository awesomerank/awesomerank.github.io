...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning ★29088](https://github.com/josephmisiti/awesome-machine-learning)
...
For a list of free hacking books available for download, go [here ★1165](https://github.com/Hack-with-Github/Free-Security-eBooks)
...
## Tools
 * [Metasploit ★10761](https://github.com/rapid7/metasploit-framework) A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
 * [mimikatz ★5023](https://github.com/gentilkiwi/mimikatz) - A little tool to play with Windows security
 ...
 * `docker pull bkimminich/juice-shop` - [OWASP Juice Shop ★754](https://github.com/bkimminich/juice-shop#docker-container--)
...
## Tools
 * [nudge4j ★96](https://github.com/lorenzoongithub/nudge4j) - Java tool to let the browser talk to the JVM
 ...
 * [dex2jar ★4018](https://github.com/pxb1988/dex2jar) - Tools to work with Android .dex and Java .class files
 ...
 * [ILSpy ★4347](https://github.com/icsharpcode/ILSpy) - an open-source .NET assembly browser and decompiler
 * [dnSpy ★3596](https://github.com/0xd4d/dnSpy) - .NET assembly editor, decompiler, and debugger 
 * [de4dot ★1916](https://github.com/0xd4d/de4dot) - .NET deobfuscator and unpacker. 
 * [antinet ★109 ⏳3Y](https://github.com/0xd4d/antinet) - .NET anti-managed debugger and anti-profiler code 
 ...
 * [ScratchABit ★254](https://github.com/pfalcon/ScratchABit) - Easily retargetable and hackable interactive disassembler with IDAPython-compatible plugin API
...
## Tools
 * [sqlmap ★10327](https://github.com/sqlmapproject/sqlmap) - Automatic SQL injection and database takeover tool
 ...
 * [Scapy ★1905](https://github.com/secdev/scapy) - A Python tool and library for low level packet creation and maniputalion
 ...
 * [sleuthkit ★1064](https://github.com/sleuthkit/sleuthkit) - A library and collection of command-line digital forensics tools
 ...
 * [Pentest Cheat Sheets ★657](https://github.com/coreb1t/awesome-pentest-cheat-sheets) - Collection of cheat sheets useful for pentesting
