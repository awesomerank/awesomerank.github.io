...
---
# Awesome Hacking [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)

A curated list of awesome Hacking. Inspired by [awesome-machine-learning ★22923](josephmisiti/awesome-machine-learning)
...
For a list of free hacking books available for download, go [here ★723](Hack-with-Github/Free-Security-eBooks)
...
## Tools
 * [Metasploit ★8757](rapid7/metasploit-framework) A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
 * [mimikatz ★3654](gentilkiwi/mimikatz) - A little tool to play with Windows security
 ...
 * `docker pull bkimminich/juice-shop` - [OWASP Juice Shop ★348](bkimminich/juice-shop#docker-container--)
 ...
 * [dex2jar ★3166](pxb1988/dex2jar) - Tools to work with Android .dex and Java .class files
 ...
 * [ILSpy ★3514](icsharpcode/ILSpy) - an open-source .NET assembly browser and decompiler
 * [dnSpy ★2203](0xd4d/dnSpy) - .NET assembly editor, decompiler, and debugger 
 * [de4dot ★1498](0xd4d/de4dot) - .NET deobfuscator and unpacker. 
 * [antinet ★92 ⏳3Y](0xd4d/antinet) - .NET anti-managed debugger and anti-profiler code 
 ...
 * [ScratchABit ★221](pfalcon/ScratchABit) - Easily retargetable and hackable interactive disassembler with IDAPython-compatible plugin API
...
## Tools
 * [sqlmap ★8678](sqlmapproject/sqlmap) - Automatic SQL injection and database takeover tool
 ...
 * [mitmsocks4j ★20 ⏳4Y](Akdeniz/mitmsocks4j) - Man-in-the-middle SOCKS Proxy for Java
 ...
 * [Nipe ★196](GouveaHeitor/nipe) - A script to make Tor Network your default gateway. 
 ...
 * [sleuthkit ★913](sleuthkit/sleuthkit) - A library and collection of command-line digital forensics tools
 ...
 * [Pentest Cheat Sheets ★118](coreb1t/awesome-pentest-cheat-sheets) - Collection of cheat sheets useful for pentesting
