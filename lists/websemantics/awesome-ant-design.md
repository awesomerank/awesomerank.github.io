...
- [Antd Init ★501](https://github.com/ant-design/antd-init) - Ant Design boilerplate generator (for demo only, use dva-cli).
- [Dva Cli](https://github.com/dvajs/dva-cli) - Create Ant Design projects based on [Dva.js ★3927](https://github.com/dvajs/dva), a
lightweight front-end framework based on Redux and React and inspired by [Elm](http://elm-lang.org) and [Choo ★3811](https://github.com/yoshuawuyts/choo).
...
- [Semantic Ant ★16](https://github.com/websemantics/semantic-ant) - Custom theme for building beautiful modern Web apps with the combined awesomeness of Semantic-UI framework and the elegant minimal styles of Ant Design for beautiful and responsive layouts.

## Vue.js

Projects that are built with Vue.js and Ant Design,

- [iView ★6461](https://github.com/iview/iview), High quality UI Components Library with Vue.js
- [Ant Design of Vue.js](http://okoala.github.io/vue-antd/#!/components) - Vue.js UI components for Ant Design.
- [Vue.js Beauty ★728](https://github.com/FE-Driver/vue-beauty) - Beautiful UI components build with Vue.js and Ant Design.
...
- [react-lz-editor ★125](https://github.com/leejaen/react-lz-editor) - An open source rich react editor based on draft-Js and ant design.
- [React Grid ★10](https://github.com/kagawagao/react-grid) __[Deprecated]__ - Grid React UI Component based on Ant Design.
- [Antd Kit ★16](https://github.com/huhulab/antd-kit) - Advanced Ant Design components.

## Applications

A list of mature apps built with Ant Design,

- [Eevee ★98 ⏳1Y](https://github.com/pizn/eevee) - Based on Github page online editing blog platform. The project is based React, Ant Design and GitHub API.
- [Productivity Application ★74](https://github.com/dhruv-kumar-jha/productivity-frontend) - Kanban style, Trello inspired Productivity application built using React, Ant Design and other fantastic modules.

## Frameworks

A list of frameworks using Ant Design,

- [R2 ★56](https://github.com/dog-days/r2) - Framework to scaffold apps based on [Ant Design React Components](http://ant.design/#/docs/react/introduce) that is built with React and Redux. R2 comes with a page builder, layout manager and many other features that will speed up the development process. Check out the [demo app](https://console.topvdn.com). You will need to register and validate email to view the admin panel.

## Boilerplates

A list of starter projects and boilerplates built with Ant Design,

- [Antd Admin ★982](https://github.com/zuiidea/antd-admin) - A admin dashboard application demo built upon Ant Design and Dva.js.
- [React SPA ★366](https://github.com/JasonBai007/reactSPA) - Building SPA with React, Router, ES6, Fetch, Babel, Webpack, Npm, MockJs, FontAwesome, AnimateCSS, Ant Design, LESS and jQuery.
- [React Admin ★278](https://github.com/fireyy/react-antd-admin) - React Admin UI built on Ant Design (username: admin, password: 123456).
- [React Redux ★212](https://github.com/Justin-lu/react-redux-antd) - React Redux for CMS/Enterprise class apps (ERP/Admin) built with Ant Design.
- [React Antd Starter ★65 ⏳1Y](https://github.com/yuzhouisme/react-antd-redux-router-starter) - This project is designed to develop website/web apps using Ant Design and Redux.
- [Webbf ★146](https://github.com/peterchenhdu/webbf) - Java demo that uses Maven to build the backend with Spring, Spring MVC and Mybatis. React, Reflux, Eebpack, jQuery, React-bootstrap and Ant Design.
- [React Redux Antd Starter ★47](https://github.com/BetaRabbit/react-redux-antd-starter) - Front-end boilerplate built with React, Redux and Ant Design.
- [Koa ★40](https://github.com/yukrain/koa-antd-admin) - Example app to build Admin UI built with React, Ant Design and Koa.
- [Star Admin ★61](https://github.com/pookpal/star-initReact-example) - Demo app built with React, Ant Design, Redux, React-router, Webpack and Babel.
- [React Redux Intro ★28](https://github.com/LeuisKen/react-redux-intro) - Demo app built with Ant Design and can be configured to initialize a Redux dependencies.
- [React Start Kit ★81](https://github.com/jovey-zheng/react-start-kit) - SPA Boilerplate built with React, Webpack, ES6+, Redux, Router, Babel, Express, Ant Design.
- [CL React ★26](https://github.com/chenliang2016/CLReactAntDesign) - Based on Ant Design front-end framework structures for enterprise back-office software.
- [TODO MVC ★6](https://github.com/cupools/todoMVC-react) - Todo list built with React and Ant Design.
- [React Boilerplate ★18 ⏳1Y](https://github.com/huhulab/react-frontend-boilerplate) - React Admin front-end boilerplate built with Ant Design.
- [Dva Antd Starter ★6](https://github.com/xlsdg/dva-antd-starter) - Get started with Dva.js and Ant Design.
...
- [React Redux Universal ★4](https://github.com/subenksaha/react-redux-universal) - Universal/Isomorphic boilerplate using react router 4 and webpack 2.5+. All latest packages.
