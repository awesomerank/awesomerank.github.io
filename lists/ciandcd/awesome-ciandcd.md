...
* [SimpleCI ★45](https://github.com/simpleci/simpleci) Docker-based self-hosted ci system. Supports distributed build cache, external providers (GCE), real-time build log, etc.  
* [pulse](http://zutubi.com) no free version.  
* [PHP Censor ★192](https://github.com/corpsee/php-censor) PHP Censor is a open source self-hosted continuous integration server for PHP projects (Fork of [PHPCI](https://www.phptesting.org))
...
* [veewee ★4088](https://github.com/jedi4ever/veewee) Easing the building of vagrant boxes  
...
* [murder ★2395](https://github.com/lg/murder)  Large scale server deploys using BitTorrent and the BitTornado library from twitter.com  
...
* [awesome-python ★35497](https://github.com/vinta/awesome-python)  
* [awesome-perl ★344](https://github.com/hachiojipm/awesome-perl)  
...
* [ci tools compare 3 ★364](https://github.com/ligurio/Continuous-Integration-services)
* [awesome-docker ★7473](https://github.com/veggiemonk/awesome-docker)  
