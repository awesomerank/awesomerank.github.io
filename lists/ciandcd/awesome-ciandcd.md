...
* [SimpleCI ★54](https://github.com/simpleci/simpleci) Docker-based self-hosted ci system. Supports distributed build cache, external providers (GCE), real-time build log, etc.  
...
* [veewee ★4173](https://github.com/jedi4ever/veewee) Easing the building of vagrant boxes  
...
* [herd ★404 ⏳1Y](https://github.com/russss/Herd) A single-command bittorrent distribution system, based on Twitter's Murder     
* [murder ★2460 ⏳1Y](https://github.com/lg/murder)  Large scale server deploys using BitTorrent and the BitTornado library from twitter.com  
...
* [awesome-docker ★11471](https://github.com/veggiemonk/awesome-docker)  
