...
For awesome *software*, see [lisp-lang.org's success stories](http://lisp-lang.org/success/) and the [awesome-cl-software ★85](https://github.com/azzamsa/awesome-cl-software) list.
...
* [asdf-linguist ★18 ⏳2Y](https://github.com/eudoxia0/asdf-linguist) - Extensions for ASDF. [Expat][14].
* [asdf-viz ★18](https://github.com/guicho271828/asdf-viz) - a tool to visualize the library dependencies of ASDF systems, the call graph of a function and the class inheritances. [LLGPL][8].
...
* [cmacro ★644 ⏳3Y](https://github.com/eudoxia0/cmacro) - Lisp macros for C. [MIT][200].
* [C-mera ★172](https://github.com/kiselgra/c-mera) - a source-to-source compiler that utilizes Lisp's macro system for meta programming of C-like languages. [GPL3][2].
* [lispc ★390 ⏳2Y](https://github.com/eratosthenesia/lispc) - a powerful "lispsy" macrolanguage for C. [MIT][200].
...
* [crypto-shortcuts ★11](https://github.com/Shinmera/crypto-shortcuts) - Collection of common crypto shortcuts. [Artistic License 2.0][51].
* [Ironclad ★8](https://github.com/sharplispers/ironclad) - A library of crypto functions for Common Lisp. Not considered secure, but is still useful for the message digest functions. [Expat][14].
* [trivial-ssh ★18 ⏳1Y](https://github.com/eudoxia0/trivial-ssh) - An SSH client library. [Expat][14].

Cryptocurrencies
================

* [cl-monero-tools ★2](https://github.com/glv2/cl-monero-tools) -  Common Lisp toolbox to work with the Monero cryptocurrency. [GPL3][2]. Not in Quicklisp.
* [emotiq ★70](https://github.com/emotiq/emotiq) - a next-generation blockchain with an innovative natural-language approach to smart contracts. [MIT][200].
* [peercoin-blockchain-parser ★1 ⏳2Y](https://github.com/glv2/peercoin-blockchain-parser) - parse the blockchain contained in a file and export some of its data to a text file, a SQL script or a database. It can also create a database using the RPC of a Peercoin daemon as source of data instead of a blockchain file. LGPL3. Not in Quicklisp.
* [peercoin-calculator ★0 ⏳2Y](https://github.com/glv2/peercoin-calculator) - This program gives you the probability of generating a POS or POW block within 10 minutes, 24 hours, 31 days, 90 days and 1 year, as well as the reward that can be expected. GUI in Qt. [GPL3][2]. Not in Quicklisp.
* [peercoin-vote ★4 ⏳3Y](https://github.com/glv2/peercoin-vote) -  A voting system based on data from the blockchain (addresses and balances). [GPL3][2]. Not in Quicklisp.

Database
========

* [cl-dbi ★106](https://github.com/fukamachi/cl-dbi) - A database-independent interface for Common Lisp. [LLGPL][8].
* [cl-memcached ★16 ⏳3Y](https://github.com/quasi/cl-memcached) - Fast, thread-safe interface to the Memcached object caching system. [Expat][14].
...
* [crane ★171 ⏳1Y](https://github.com/eudoxia0/crane) - Another ORM. [Expat][14].
* [datafly ★66 ⏳1Y](https://github.com/fukamachi/datafly) - A lightweight database library. [3-clause BSD][15].
* [mito](https://github.com/fukamachi/mito) - An ORM for Common Lisp with migrations, relationships and PostgreSQL support [LLGPL][8]. [mitho-auth](https://github.com/fukamachi/mito-auth), a mixin class for use authorization; [mito-attachment ★6 ⏳2Y](https://github.com/fukamachi/mito-attachment), a mixin class for file management outside of RDBMS.
* [postmodern](http://marijnhaverbeke.nl/postmodern/) - A library for interacting with PostgreSQL. [zlib][33].
* [pgloader ★1551](https://github.com/dimitri/pgloader) - a data loading tool for PostgreSQL. [PostgreSQL Licence][205].
* [sxql ★123](https://github.com/fukamachi/sxql) - A DSL for generating SQL. [3-clause BSD][15].
* [bknr.datastore ★31 ⏳1Y](https://github.com/hanshuebner/bknr-datastore) - a CLOS-based lisp-only database in RAM with transaction logging persistence. [licence](http://bknr.net/html/license.html). (see also chap. 21 of "Common Lisp Recipes")
...
* [ubiquitous ★10](https://github.com/Shinmera/ubiquitous) - A library providing easy-to-use persistent configuration storage. [Artistic License 2.0][51].

To third parties:

* [dyna ★13](https://github.com/Rudolph-Miller/dyna) - an AWS DynamoDB ORM. [MIT][200].
* [cl-influxdb ★13 ⏳1Y](https://github.com/mmaul/cl-influxdb) - an interface to the Time Series Database InfluxDB. [MIT][200].
...
* [CFFI ★176](https://github.com/cffi/cffi) - Portable, easy-to-use C foreign function interface. [Expat][14].
* [cl-autowrap ★104](https://github.com/rpav/cl-autowrap) - Automatically parses header files into CFFI definitions. [FreeBSD][39].
...
* [objc-lisp-bridge ★11](https://github.com/fiddlerwoaroof/objc-lisp-bridge) -  A portable reader and bridge for interacting with Objective-C and Cocoa. [MIT][200].

## Python ##

* [burgled-batteries ★56](https://github.com/pinterface/burgled-batteries) - A bridge between Python and Common Lisp. Not available on Quicklisp. No license specified.

Game Development
================

* [Xelf](http://xelf.me/) - Extensible game library. Not available on Quicklisp. [GNU LGPL2.1][11].
* [Trial ★64](https://github.com/shirakumo/trial) - Trial is an OpenGL
...
* [cl-cairo2 ★41 ⏳1Y](https://github.com/rpav/cl-cairo2) - Cairo bindings. [Boost 1.0][54]
* [cl-gd](http://weitz.de/cl-gd/) - A library providing an interface to the GD graphics library. [FreeBSD][39].
* [cl-horde3d ★14 ⏳4Y](https://github.com/anwyn/cl-horde3d) - FFI bindings to the Horde3D graphics library. Not available on Quicklisp. [EPL 1.0][59]
* [cl-opengl ★180](https://github.com/3b/cl-opengl) - CFFI bindings to OpenGL, GLU and GLUT APIs. [3-clause BSD][15].
* [cl-sdl2 ★131](https://github.com/lispgames/cl-sdl2) - Bindings for SDL2 using C2FFI. [Expat][14].
* [cl-svg ★11](https://github.com/wmannis/cl-svg) - A basic library for producing SVG files. [Expat][14].
* [CLinch ★212 ⏳1Y](https://github.com/BradWBeer/CLinch) - Common Lisp 2D/3D graphics engine for OpenGL. [FreeBSD][39].
* [donuts ★13 ⏳1Y](https://github.com/tkych/donuts) - Graph drawing DSL for Common Lisp. [Expat][14].
* [dufy ★19](https://github.com/privet-kitty/dufy) - exact color manipulation and conversion in various color models. [MIT][200].
* [lispbuilder-sdl ★101](https://github.com/lispbuilder/lispbuilder) - A set of bindings for SDL. [Expat][14].
...
* [opticl ★120](https://github.com/slyrus/opticl) - a library for representing and processing images. [BSD_2Clause][17].
* [Varjo ★116](https://github.com/cbaggers/varjo) - Lisp to GLSL translator. [BSD_2Clause][17].
...
* [Sketch ★709](https://github.com/vydd/sketch) - A CL framework for the creation of electronic art, graphics, and lots more. [MIT][200].

GUI
===

* [cl-cffi-gtk](http://www.crategus.com/books/cl-cffi-gtk/) - Binding for GTK+3. [GNU LGPL2.1][11].
* [cl-gtk2 ★38 ⏳2Y](https://github.com/dmitryvk/cl-gtk2) - A binding for GTK+2. [LLGPL][8].
* [cl-xul ★30 ⏳2Y](https://github.com/mmontone/cl-xul) - Mozilla XUL bindings. [Expat][14].
* [CommonQt ★70](https://github.com/commonqt/commonqt) - A Common Lisp binding for Qt4 via QtSmoke. [FreeBSD][39].
* [Qtools ★92](https://github.com/Shinmera/qtools) - A Qt toolkit, based on CommonQt. [Artistic License 2.0][51]
...
* [CocoaInterface ★8](https://github.com/plkrueger/CocoaInterface) -
...
* [cl-webkit ★25](https://github.com/joachifm/cl-webkit) - A binding to WebKitGTK+. Also adds web browsing capabilities to an application, leveraging the full power of the WebKit browsing engine. [MIT][200].
...
* [cl21 ★698](https://github.com/cl21/cl21) - An experimental project to move Common Lisp into the 21st century. [Expat][14].
* [alexandria](https://common-lisp.net/project/alexandria/) - A general-purpose utility library. Public domain.
* [serapeum ★90](https://github.com/TBRSS/serapeum) - Another general-purpose utility library. [Expat][14].
* [anaphora](https://common-lisp.net/project/anaphora/) - A collection of anaphoric macros. Public domain.
* [cl-algebraic-data-type ★7](https://github.com/tarballs-are-good/cl-algebraic-data-type) - A library for defining algebraic data types in a similar spirit to Haskell or ML. [3-clause BSD][15].
...
* [optima ★217](https://github.com/m2ym/optima) - Optimized pattern-matching library. [LLGPL][8].
* [str ★49](https://github.com/vindarel/cl-str) - a modern, simple and consistent string manipulation library. [MIT][200].
* [trivial-types ★33](https://github.com/m2ym/trivial-types) - Trivial type definitions. [LLGPL][8].
* [interface](https://bitbucket.org/tarballs_are_good/interface) - A protocol library. [3-clause BSD][15].
* [cl-syntax ★31 ⏳2Y](https://github.com/m2ym/cl-syntax) - Reader syntax conventions. [LLGPL][8].
...
* [defclass-std ★13 ⏳2Y](https://github.com/EuAndreh/defclass-std) - a shortcut macro to write DEFCLASS forms quickly. [LLGPL][8].


Non-deterministic, logic programming
------------------------------------

* [cl-prolog2 ★11](https://github.com/guicho271828/cl-prolog2) - Common Interface to ISO Prolog implementations from Common Lisp. [MIT][200].
* [Screamer ★121 ⏳3Y](https://github.com/nikodemus/screamer) - augment Common
  Lisp with practically all of the functionality of both Prolog and
  constraint logic programming
  languages. [MIT][200]. [Screamer+ ★5](https://github.com/ysz/screamer-plus) -
...
* [Roswell ★760](https://github.com/roswell/roswell) - a Lisp implementation installer, script launcher and more. [MIT][200].
* [qlot ★138](https://github.com/fukamachi/qlot) - A project-local library installer, similar to Bundler or Carton. [Expat][14].
* [Quicklisp][16] - A library manager containing many libraries, with easy depencency management. [Expat][14].
* [Quickutil ★63 ⏳1Y](https://github.com/tarballs-are-good/quickutil) - A utility manager, similar to Quicklisp, but for small utilities rather than whole libraries. [3-clause BSD][15].
* [Qi ★57](https://github.com/CodyReichert/qi) - A package manager with a traditionnal approach. [BSD][15].

might help:

* [print-licenses ★9](https://github.com/vindarel/print-licenses) - print licenses used by a project and its dependencies. Not in Quicklips. [MIT][200].
...
* [ql-to-deb ★16](https://github.com/dimitri/ql-to-deb) -  Update cl-* debian packages from Quicklisp releases. WTFPL.

Machine Learning
================

* [clml ★131](https://github.com/mmaul/clml) - originally developped by Mathematicl Systems Inc., a Japanese company. With a [tutorial](https://mmaul.github.io/clml.tutorials//2015/08/08/CLML-Time-Series-Part-1.html). [LLGPL][8].
* [mgl](https://github.com/melisgl/mgl) - used by its [author](http://quotenil.com/) to [win ★111 ⏳3Y](https://github.com/melisgl/higgsml) the Higgs Boson Machine Learning Challenge. [MIT][200].
* [antik](https://www.common-lisp.net/project/antik/) -  a foundation for scientific and engineering computation in Common Lisp. GPL. Also [mgl-mat](https://github.com/melisgl/mgl-mat) and [LLA ★72](https://github.com/tpapp/lla).
...
* [cl-nlp ★126](https://github.com/vseloved/cl-nlp) - Natural language processing toolset. [Apache2.0][89].
...
HTTP clients
------------
* [Dexador ★105](https://github.com/fukamachi/dexador) - An HTTP client, that aims at [replacing Drakma](http://quickdocs.org/dexador/). [MIT][200].

HTTP Servers
------------
* [Clack ★687](https://github.com/fukamachi/clack) - A web application environment inspired by Rack and WSGI. [LLGPL][8].  Provides a unified interface to a webserver of choice (default is Hunchentoot).
* [Hunchentoot](http://weitz.de/hunchentoot/) - A web server. [2-clause BSD][207]
* [aserve ★85](https://github.com/franzinc/aserve) - AllegroServe; a web server. [LLGPL][8].
* [wookie ★145 ⏳1Y](https://github.com/orthecreedence/wookie) - Asynchronous HTTP server. [Expat][14].
* [woo ★662](https://github.com/fukamachi/woo) - A fast non-blocking HTTP server on top of libev. [MIT][200].

### Clack plugins

* [clack-errors ★19 ⏳2Y](https://github.com/eudoxia0/clack-errors) - Error page middleware for Clack. [LLGPL][8].
* [clath ★10](https://github.com/BnMcGn/clath) - a single sign-on
...
* [clack-pretend ★6](https://github.com/BnMcGn/clack-pretend) - a testing
  and debugging tool for clack. [Apache2.0][89].
* [hermetic ★19 ⏳1Y](https://github.com/eudoxia0/hermetic) - Security for Clack-based web applications. [Expat][14].

Web frameworks
--------------
* [Caveman ★490](https://github.com/fukamachi/caveman) - A powerful web framework. [LLGPL][8].
...
* [ningle](https://github.com/fukamachi/ningle) - A super-micro web framework. [LLGPL][8]. [ninglex ★10](https://github.com/defunkydrummer/ninglex), an extended and noob-friendly ningle (mostly easier handling of query parameters). [MIT][200].
* [radiance ★90](https://github.com/Shirakumo/radiance) - An extensible framework library and multi-application CMS. [Artistic License 2.0][51].
* [Lucerne ★104](https://github.com/eudoxia0/lucerne) - A minimal web framework built on Clack, inspired by Flask. [MIT][200].
* [Snooze ★53](https://github.com/joaotavora/snooze) - A RESTful web framework, built on Clack, where routes are just functions and HTTP conditions are just Lisp conditions. [LLGPL][8].
...
* [Rock ★31 ⏳3Y](https://github.com/eudoxia0/rock) - an asset manager for
...
Parsing html
------------
* [http-parse ★17 ⏳3Y](https://github.com/orthecreedence/http-parse) - An HTTP parser in Common Lisp. [Expat][14].
* [Plump][71] - A lenient HTTP/XML parser, tolerand on malformed markup. [Artistic License 2.0][51]. Best used with [lquery][72] and [clss ★15](https://github.com/Shinmera/CLSS).
...
* [spinneret ★67](https://github.com/ruricolist/spinneret) - Common Lisp HTML5 generator. [Expat][14].
* [cl-markup ★45 ⏳2Y](https://github.com/arielnetworks/cl-markup) - Modern markup generation library. [LLGPL][8].
* [Djula ★65](https://github.com/mmontone/djula) - A port of Django's template engine to Common Lisp. [Expat][14].
* [eco ★19](https://github.com/eudoxia0/eco) - Fast, flexible, designer-friendly template engine. [Expat][14].

URI handling
------------

* [quri ★51 ⏳1Y](https://github.com/fukamachi/quri) - Another URI library for
...
* [cl-slug ★16 ⏳1Y](https://github.com/EuAndreh/cl-slug) - a small library to make slugs, mainly for URIs, transform in CamelCase, remove accentuation and punctuation, for english and beyound. [LLGPL][8].

Javascript
----------

* [Parenscript](https://github.com/vsedach/Parenscript) - A translator from Common Lisp to Javascript. [3-clause BSD][15]. See [Trident-mode ★37 ⏳5Y](https://github.com/johnmastro/trident-mode.el), an Emacs mode that provides live interaction with the browser.[unlicence][5].
...
* [websocket-driver ★52](https://github.com/fukamachi/websocket-driver) - a WebSocket server/client implementation, backend agnostic (Clack). [3-clause BSD][15].
...
* [Aws-sign4 ★10](https://github.com/rotatef/aws-sign4) - Common Lisp library for Amazon Web Services signing version 4. [GNU GPL3][2].
...
* [avatar-api ★8 ⏳3Y](https://github.com/eudoxia0/avatar-api) - Get avatars from Google+, Gravatar and others. [Expat][14].
* [chirp ★43](https://github.com/Shinmera/chirp) - A Twitter client library. [Artistic License 2.0][51].
* [cl-irc](https://www.common-lisp.net/project/cl-irc/) - An IRC client library. [Expat][14].
* [cl-mediawiki ★13 ⏳1Y](https://github.com/AccelerationNet/cl-mediawiki) - a wrapper around the MediaWiki api. [MIT][200].
...
* [cl-ses ★11 ⏳2Y](https://github.com/CodyReichert/cl-ses) - Library for AWS SES. [Expat][14].
...
* [colleen ★30](https://github.com/Shinmera/colleen) - IRC bot with a modular framework. [Artistic License 2.0][51].
* [css-lite ★53 ⏳6Y](https://github.com/paddymul/css-lite) - A CSS grammar. [Expat][14].
* [find-port ★6 ⏳2Y](https://github.com/eudoxia0/find-port) -  Programmatically find open ports. [MIT][200].
* [Cl-forms ★7](https://github.com/mmontone/cl-forms) -  Web forms handling library for Common lisp. [MIT][200].
* [Postmaster ★3 ⏳3Y](https://github.com/eudoxia0/postmaster) - A simple, easy-to-use SMTP/IMAP library. [Expat][14].
* [cl-selenium-webdriver ★9](https://github.com/TatriX/cl-selenium-webdriver) - a binding library to Selenium 2.0.
* [usocket ★79](https://github.com/usocket/usocket) - A portable TCP and UDP socket interface. [Expat][14].

Numerical and Scientific
========================

* [cl-spark ★54 ⏳3Y](https://github.com/tkych/cl-spark) - Generates sparkline strings for lists of numbers. [Expat][14].
...
* [common-lisp-stat ★139](https://github.com/blindglobe/common-lisp-stat) - Common Lisp statistics library. [FreeBSD][39].
* [magicl ★39](https://github.com/rigetticomputing/magicl) - Matrix Algebra proGrams In Common Lisp based on BLAS/LAPACK and Expokit, by Rigetti Computing. [BSD_3Clause][15].
* [maxima](http://maxima.sourceforge.net/) - Computer algebra system. Not available on Quicklisp. [GNU GPL3][2].
* [lisp-matrix ★48](https://github.com/blindglobe/lisp-matrix) - A matrix package. [FreeBSD][39].
...
* [chanl ★105](https://github.com/zkat/chanl) - Portable, channel-based concurrency. [Expat][14], with parts under [3-clause BSD][15].
* [cl-async ★176](https://github.com/orthecreedence/cl-async) - A library for general-purpose, non-blocking programming. [Expat][14].
...
* [lparallel ★133 ⏳1Y](https://github.com/lmj/lparallel) - A library for parallel programming. [3-clause BSD][15].
* [Xecto ★30 ⏳2Y](https://github.com/pkhuong/Xecto) - A library for regular array parallelism. [3-clause BSD][15].
* [Moira ★16](https://github.com/TBRSS/moira) -  Monitor and restart background threads. In-lisp process supervisor. No license specified.
* [simple-tasks ★7](https://github.com/Shinmera/simple-tasks) - A very
  simple task scheduling framework. [Artistic License 2.0][51].
* [deeds ★6](https://github.com/Shinmera/deeds) - Deeds is an Extensible
...
* [cl-flow ★20](https://github.com/borodust/cl-flow) -  Data-flowish computation tree library for non-blocking concurrent Common Lisp. [MIT][200].

Job processing
--------------

* [psychiq ★31](https://github.com/fukamachi/psychiq) - redis-based background job processing for Common Lisp applications. Inspired by Ruby's Sidekiq and compatible with its web UI. [LLGPL][8].
...
* [Roswell ★760](https://github.com/roswell/roswell#scripting-with-roswell) -
  a lisp installer and scripting environment (helper, launcher,
  installer) and more. [MIT][200].
* [Shelly ★65 ⏳3Y](https://github.com/fukamachi/shelly) - execute Common Lisp
...
* [cl-readline ★20](https://github.com/vindarel/cl-readline) - a set of
...
* [CLON ★24 ⏳1Y](https://github.com/didierverna/clon) - Command Line Options
  Nuker. [ISC](https://github.com/didierverna/clon/blob/master/LICENSE).
* [cl-ansi-term ★8](https://github.com/vindarel/cl-ansi-term) - print
  colorized text, horizontal lines, progress bars, (un)ordered lists
  and tables on ANSI-compliant terminals. [GPL3][2].
* [cl-charms ★57](https://github.com/HiTECNOLOGYs/cl-charms) - an
...
* [Deploy ★28](https://github.com/Shinmera/deploy) - a system to help you
...
* [Slime ★938](https://github.com/slime/slime) - Superior Lisp Interaction Mode for Emacs; a full-blown environment for Common Lisp inside of Emacs. Public domain.
* [Sly ★306](https://github.com/joaotavora/sly) - SLY is a fork of SLIME and contains multiple improvements upon it.
...
* [SLIMV ★250](https://github.com/kovisoft/slimv) - Superior Lisp Interaction Mode for Vim; a full-blown environment for Common Lisp inside of Vim. No license specified.
* [Vlime ★88](https://github.com/l04m33/vlime) - VLIME: Vim plus Lisp Is Mostly Evil. A Common Lisp dev environment for Vim (and Neovim). [MIT][200].

## Lem ##

* [Lem ★177](https://github.com/cxxxr/lem) - a ready to use, Emacs-like, Slime-based
...
* [cl-jupyter ★131](https://github.com/fredokun/cl-jupyter) - A Common Lisp kernel for Jupyter notebooks [custom licence](https://github.com/fredokun/cl-jupyter/blob/master/LICENSE).
* [Darkmatter ★288](https://github.com/tamamu/darkmatter) - A
  notebook-style Common Lisp environment. [MIT][200].

## REPLs ##

* [cl-repl](https://github.com/koji-kojiro/cl-repl) - an ipython-like REPL. With completion, shell commands, magic commands, debugger, etc. [MIT][200]. With [colorthemes ★7](https://github.com/koji-kojiro/lem-pygments-colorthemes).

Text Processing
===============

* [montezuma ★16 ⏳1Y](https://github.com/sharplispers/montezuma) -  Full-text indexing and search for Common Lisp. [Expat][14].
* [mk-string-metrics ★13](https://github.com/cbaggers/mk-string-metrics) -
  Calculate various string metrics efficiently in Common Lisp
  (Damerau-Levenshtein, Hamming, Jaro, Jaro-Winkler, Levenshtein,
  etc). [MIT][200].
* [cl-yacc ★32](https://github.com/jech/cl-yacc) - a LALR(1) parser generator. [MIT][200].
* [wiki-lang-detect ★19](https://github.com/vseloved/wiki-lang-detect) -
...
* [lake ★41 ⏳1Y](https://github.com/takagi/lake) - a GNU make like build utility. [MIT][200].


Unit Testing
============

* [FiveAM ★91](https://github.com/sionescu/fiveam) - Simple regression testing framework. [FreeBSD][39].
* [CLUnit ★16](https://github.com/tgutu/clunit) - A unit testing library. [Expat][14].
* [Prove ★171](https://github.com/fukamachi/prove) - Yet another unit testing framework [Expat][14].
...
* [Mockingbird ★8 ⏳1Y](https://github.com/Chream/mockingbird) - A small
  ...
  arguments. [MIT][200].
* [Check-it ★23 ⏳1Y](https://github.com/DalekBaldwin/check-it) - A QuickCheck-style randomized property-based testing. [LLGPL][8].
* [cl-coveralls ★20 ⏳2Y](https://github.com/fukamachi/cl-coveralls) - a helper
...
* [envy ★33 ⏳1Y](https://github.com/fukamachi/envy) - Configuration switcher. [FreeBSD][39].
...
* [cl-csv ★58](https://github.com/AccelerationNet/cl-csv) - A library for parsing CSV files. [3-clause BSD][15].
...
* [cl-date-time-parser ★10 ⏳3Y](https://github.com/tkych/cl-date-time-parser) - Parse date-time-string, liberally. Hides the difference between date-time formats, and enables to manage date and time as the one date-time format. [MIT][200].
...
* [local-time-duration ★9](https://github.com/enaeher/local-time-duration) -
...
* [sphinxcontrib-cldomain ★10 ⏳1Y](https://github.com/russell/sphinxcontrib-cldomain) -
  Extending Sphinx to cover Common Lisp. To build documentation with
  the same ease as sphinx would a Python project. [GPL3][2]
* [Codex ★56](https://github.com/CommonDoc/codex) - A beautiful
  documentation system for Common Lisp. [MIT][200].
* [Staple ★13](https://github.com/Shinmera/staple) - a tool to generate
...
* [archive ★18](https://github.com/froydnj/archive) - a library for reading and creating archive (tar, cpio) files. [BSD_3Clause][15]. A pure Common Lisp replacement for the 'tar' program.
...
* [cl-locale ★16 ⏳2Y](https://github.com/fukamachi/cl-locale) - A simple i18n library. [LLGPL][8].

Linting
-------

* [sblint ★29](https://github.com/fukamachi/sblint) - a linter for Common
...
* [cl-fluent-logger ★8](https://github.com/fukamachi/cl-fluent-logger) - A Common Lisp structured logger for [Fluentd](https://www.fluentd.org/).


Markdown
--------

* [3bmd ★39](https://github.com/3b/3bmd) - a markdown -> html converter. [MIT][200].

Plotting
--------

* [vgplot ★20 ⏳1Y](https://github.com/volkers/vgplot) - an interface to the
  gnuplot plotting utility with the intention to resemble some of
  the plot commands of octave or matlab. [GPL3][2].
* [eazy-gnuplot ★21](https://github.com/guicho271828/eazy-gnuplot) - a
...
* [chipz ★12](https://github.com/froydnj/chipz) - A decompression library. [3-clause BSD][15].
* [cl-cuda ★129](https://github.com/takagi/cl-cuda) - A library to use NVIDIA CUDA in Common Lisp programs. [LLGPL][8].
* [corona ★35 ⏳1Y](https://github.com/eudoxia0/corona) -  Create and manage virtual machines from Common Lisp http://eudoxia.me/corona [MIT][200].
* [esrap ★78 ⏳1Y](https://github.com/nikodemus/esrap) - Packrat parser. [Expat][14].
* [fast-io ★98](https://github.com/rpav/fast-io) - Fast octet-vector/stream I/O. [3-clause BSD][15].
* [glyphs ★19](https://github.com/ahungry/glyphs) - A library for cutting down the verboseness of Common Lisp in places. [GNU GPL3][2].
* [iolib ★111](https://github.com/sionescu/iolib) - I/O library. [Expat][14].
* [mixalot ★22 ⏳2Y](https://github.com/ahefner/mixalot) - A loosely-coupled collection of audio libraries. No license specified.
* [named-readtables ★16](https://github.com/melisgl/named-readtables) - Provides a readtable namespace, akin to package namespaces. [3-clause BSD][15].
...
* [simple-currency ★4](https://github.com/a0-prw/simple-currency) - A currency conversion library using daily information published by the ECB. [FreeBSD][39].
...
* [trivial-benchmark ★18](https://github.com/Shinmera/trivial-benchmark) - Tiny benchmarking library. [Artistic Licence 2.0][51].
* [trivial-garbage ★19 ⏳1Y](https://github.com/trivial-garbage/trivial-garbage) - A portable finalizer, weak hash-table and weak pointer API. Public domain.
...
* [cl-feedparser ★9](https://github.com/TBRSS/cl-feedparser) - A Common Lisp (RSS, Atom) feed parser. [LLGPL][8]
