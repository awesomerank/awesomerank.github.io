...
- [Awesome Common Lisp ★59088](https://github.com/sindresorhus/awesome)
...
* [asdf-linguist ★13 ⏳1Y](https://github.com/eudoxia0/asdf-linguist) - Extensions for ASDF. [Expat][14].
...
* [cl-redis ★108](https://github.com/vseloved/cl-redis) - Redis client. [Expat][14].
* [cl-disque ★8 ⏳1Y](https://github.com/CodyReichert/cl-disque) - Disque client. [3-clause BSD][15].
* [cl-rethinkdb ★41](https://github.com/orthecreedence/cl-rethinkdb) - RethinkDB client. [Expat][14].
...
* [crane ★152](https://github.com/eudoxia0/crane) - Another ORM. [Expat][14].
...
* [pgloader ★1053](https://github.com/dimitri/pgloader) - a data loading tool for PostgreSQL. [PostgreSQL Licence][205].
* [sxql ★91](https://github.com/fukamachi/sxql) - A DSL for generating SQL. [3-clause BSD][15].
* [bknr.datastore ★29](https://github.com/hanshuebner/bknr-datastore) - a CLOS-based lisp-only database in RAM with transaction logging persistence. [licence](http://bknr.net/html/license.html). (see also chap. 21 of "Common Lisp Recipes")
...
* [CFFI ★156](https://github.com/cffi/cffi) - Portable, easy-to-use C foreign function interface. [Expat][14].
* [cl-autowrap ★90](https://github.com/rpav/cl-autowrap) - Automatically parses header files into CFFI definitions. [FreeBSD][39].
...
* [cl-cairo2 ★38](https://github.com/rpav/cl-cairo2) - Cairo bindings. [Boost 1.0][54]
...
* [cl-opengl ★164](https://github.com/3b/cl-opengl) - CFFI bindings to OpenGL, GLU and GLUT APIs. [3-clause BSD][15].
* [cl-sdl2 ★105](https://github.com/lispgames/cl-sdl2) - Bindings for SDL2 using C2FFI. [Expat][14].
* [cl-svg](https://code.google.com/archive/p/cl-svg) - A basic library for producing SVG files. [Expat][14].
* [CLinch ★194](https://github.com/BradWBeer/CLinch) - Common Lisp 2D/3D graphics engine for OpenGL. [FreeBSD][39].
* [donuts ★11](https://github.com/tkych/donuts) - Graph drawing DSL for Common Lisp. [Expat][14].
* [lispbuilder-sdl ★76](https://github.com/lispbuilder/lispbuilder) - A set of bindings for SDL. [Expat][14].
* [okra ★20 ⏳2Y](https://github.com/aerique/okra) - CFFI bindings to Ogre. Not available on Quicklisp. [3-clause BSD][15].
* [Varjo ★91](https://github.com/cbaggers/varjo) - Lisp to GLSL translator. Not available on Quicklisp. [LLGPL][8].
...
* [cl-json ★40](https://github.com/hankhero/cl-json) - A JSON encoder and decoder. [Expat][14].
...
* [Roswell ★553](https://github.com/roswell/roswell) - a Lisp implementation installer, script launcher and more. [MIT][200].
* [qlot ★95](https://github.com/fukamachi/qlot) - A project-local library installer, similar to Bundler or Carton. [Expat][14].
* [Quicklisp][16] - A library manager containing many libraries, with easy depencency management. [Expat][14].
* [Quickutil ★55](https://github.com/tarballs-are-good/quickutil) - A utility manager, similar to Quicklisp, but for small utilities rather than whole libraries. [3-clause BSD][15].
...
HTTP Servers
------------
* [Clack ★606](https://github.com/fukamachi/clack) - A web application environment inspired by Rack and WSGI. [LLGPL][8].  Provides a unified interface to a webserver of choice (default is Hunchentoot).
* [Hunchentoot](http://weitz.de/hunchentoot/) - A web server. [2-clause BSD][207]
* [aserve ★73](https://github.com/franzinc/aserve) - AllegroServe; a web server. [LLGPL][8].
...
* [wookie ★139](https://github.com/orthecreedence/wookie) - Asynchronous HTTP server. [Expat][14].
* [woo ★531](https://github.com/fukamachi/woo) - A fast non-blocking HTTP server on top of libev. [MIT][200].

Web frameworks
--------------
* [Caveman ★421](https://github.com/fukamachi/caveman) - A powerful web framework. [LLGPL][8].
...
* [radiance ★55](https://github.com/Shirakumo/radiance) - An extensible framework library and multi-application CMS. [Artistic License 2.0][51].
* [Lucerne ★92 ⏳1Y](https://github.com/eudoxia0/lucerne) - A minimal web framework built on Clack, inspired by Flask. [MIT][200].

There are more projects, more or less discontinued but interesting. See the other ressources.

Parsing html
------------
* [http-parse ★14 ⏳2Y](https://github.com/orthecreedence/http-parse) - An HTTP parser in Common Lisp. [Expat][14].
...
* [spinneret ★43](https://github.com/ruricolist/spinneret) - Common Lisp HTML5 generator. [Expat][14].
* [cl-markup ★42 ⏳1Y](https://github.com/arielnetworks/cl-markup) - Modern markup generation library. [LLGPL][8].
* [Djula ★54](https://github.com/mmontone/djula) - A port of Django's template engine to Common Lisp. [Expat][14].
* [eco ★13 ⏳2Y](https://github.com/eudoxia0/eco) - Fast, flexible, designer-friendly template engine. [Expat][14].

URI handling
------------

* [puri-unicode ★11 ⏳2Y](https://github.com/archimag/puri-unicode) - Pure URI library with Unicode support. [LLGPL][8].
* [cl-slug ★14](https://github.com/EuAndreh/cl-slug) - a small library to make slugs, mainly for URIs, transform in CamelCase, remove accentuation and punctuation, for english and beyound. [LLGPL][8].

Javascript
----------

* [Parenscript](https://github.com/vsedach/Parenscript) - A translator from Common Lisp to Javascript. [3-clause BSD][15]. See [Trident-mode ★34 ⏳3Y](https://github.com/johnmastro/trident-mode.el), an Emacs mode that provides live interaction with the browser.[unlicence][5].
* [parse-js](http://marijnhaverbeke.nl/parse-js/) - A package for parsing ECMAScript 3. [zlib][33].
* [JSCL ★353](https://github.com/jscl-project/jscl) - A CL-to-JS compiler designed to be self-hosting from day one. Lacks CLOS, format and loop.
...
* [Panic ★21](https://github.com/michaeljforster/panic), a Parenscript library for React. Not in Quicklisp. [MIT][200]. Its [TodoMVC example](https://github.com/40ants/todomvc/blob/common-lisp-example/examples/common-lisp-react/src/app.lisp).

Websockets
----------

* [websocket-driver ★30](https://github.com/fukamachi/websocket-driver) - a WebSocket server/client implementation, backend agnostic (Clack). [3-clause BSD][15].
...
* [colleen ★25](https://github.com/Shinmera/colleen) - IRC bot with a modular framework. [Artistic License 2.0][51].
...
* [usocket ★46](https://github.com/usocket/usocket) - A portable TCP and UDP socket interface. [Expat][14].


Numerical and Scientific
========================

* [cl-spark ★51 ⏳2Y](https://github.com/tkych/cl-spark) - Generates sparkline strings for lists of numbers. [Expat][14].
...
* [common-lisp-stat ★130 ⏳2Y](https://github.com/blindglobe/common-lisp-stat) - Common Lisp statistics library. [FreeBSD][39].
...
* [cl-async ★147](https://github.com/orthecreedence/cl-async) - A library for general-purpose, non-blocking programming. [Expat][14].
...
* [SLIME ★760](https://github.com/slime/slime) - Superior Lisp Interaction Mode for Emacs; a full-blown environment for Common Lisp inside of Emacs. Public domain.
...
* [SLIMV ★212](https://github.com/kovisoft/slimv) - Superior Lisp Interaction Mode for Vim; a full-blown environment for Common Lisp inside of Vim. No license specified.
...
* [cl-project ★78](https://github.com/fukamachi/cl-project) - General modern project skeletons. [LLGPL][8].


Unit Testing
============

* [FiveAM ★81](https://github.com/sionescu/fiveam) - Simple regression testing framework. [FreeBSD][39].
...
* [Prove ★129](https://github.com/fukamachi/prove) - Yet another unit testing framework [Expat][14].
...
* [optima ★192](https://github.com/m2ym/optima) - Optimized pattern-matching library. [LLGPL][8].
...
* [cl-csv ★52](https://github.com/AccelerationNet/cl-csv) - A library for parsing CSV files. [3-clause BSD][15].
...
* [chipz ★9 ⏳1Y](https://github.com/froydnj/chipz) - A decompression library. [3-clause BSD][15].
...
* [cl-annot ★85 ⏳2Y](https://github.com/m2ym/cl-annot) - Python-like annotations for Common Lisp. [LLGPL][8].
* [cl-cuda ★108](https://github.com/takagi/cl-cuda) - A library to use NVIDIA CUDA in Common Lisp programs. [LLGPL][8].
...
* [envy ★21](https://github.com/fukamachi/envy) - Configuration switcher. [FreeBSD][39].
* [esrap ★68](https://github.com/nikodemus/esrap) - Packrat parser. [Expat][14].
* [fast-io ★83](https://github.com/rpav/fast-io) - Fast octet-vector/stream I/O. [3-clause BSD][15].
...
* [serapeum ★56](https://github.com/TBRSS/serapeum) - Another general-purpose utility library. [Expat][14].
