...
- [Awesome Common Lisp ★57421](https://github.com/sindresorhus/awesome)
...
* [asdf-linguist ★14](https://github.com/eudoxia0/asdf-linguist) - Extensions for ASDF. [Expat][14].
...
* [trivial-ssh ★14](https://github.com/eudoxia0/trivial-ssh) - An SSH client library. [Expat][14].

Database
========

* [cl-dbi ★79](https://github.com/fukamachi/cl-dbi) - A database-independent interface for Common Lisp. [LLGPL][8].
* [cl-memcached ★16](https://github.com/quasi/cl-memcached) - Fast, thread-safe interface to the Memcached object caching system. [Expat][14].
* [cl-mongo ★109](https://github.com/fons/cl-mongo) - MongoDB client. [Expat][14].
* [cl-redis ★107](https://github.com/vseloved/cl-redis) - Redis client. [Expat][14].
* [cl-disque ★8](https://github.com/CodyReichert/cl-disque) - Disque client. [3-clause BSD][15].
* [cl-rethinkdb ★42](https://github.com/orthecreedence/cl-rethinkdb) - RethinkDB client. [Expat][14].
* [cl-sqlite ★30](https://github.com/dmitryvk/cl-sqlite) - Bindings for SQLite. Public domain.
* [clsql](http://www.cliki.net/CLSQL) - An SQL database with a Common Lisp interface. [LLGPL][8].
* [clache ★0](https://github.com/html/clache) - General caching facility. No license specified.
* [clouchdb](https://common-lisp.net/project/clouchdb/) - Library for interacting with CouchDB. [FreeBSD][39].
* [crane ★153](https://github.com/eudoxia0/crane) - Another ORM. [Expat][14].
* [datafly ★51](https://github.com/fukamachi/datafly) - A lightweight database library. [3-clause BSD][15].
* [mito ★39](https://github.com/fukamachi/mito) - An ORM for Common Lisp with migrations, relationships and PostgreSQL support [LLGPL][8].
* [postmodern](http://marijnhaverbeke.nl/postmodern/) - A library for interacting with PostgreSQL. [zlib][33].
* [pgloader ★1025](https://github.com/dimitri/pgloader) - a data loading tool for PostgreSQL. [PostgreSQL Licence][205].
* [sxql ★92](https://github.com/fukamachi/sxql) - A DSL for generating SQL. [3-clause BSD][15].
...
* [CFFI ★152](https://github.com/cffi/cffi) - Portable, easy-to-use C foreign function interface. [Expat][14].
* [cl-autowrap ★87](https://github.com/rpav/cl-autowrap) - Automatically parses header files into CFFI definitions. [FreeBSD][39].
...
* [burgled-batteries ★34](https://github.com/pinterface/burgled-batteries) - A bridge between Python and Common Lisp. Not available on Quicklisp. No license specified.
...
* [cl-horde3d ★14](https://github.com/anwyn/cl-horde3d) - FFI bindings to the Horde3D graphics library. Not available on Quicklisp. [EPL 1.0][59]
* [cl-opengl ★163](https://github.com/3b/cl-opengl) - CFFI bindings to OpenGL, GLU and GLUT APIs. [3-clause BSD][15].
* [cl-sdl2 ★102](https://github.com/lispgames/cl-sdl2) - Bindings for SDL2 using C2FFI. [Expat][14].
* [cl-svg](https://code.google.com/archive/p/cl-svg) - A basic library for producing SVG files. [Expat][14].
* [CLinch ★189](https://github.com/BradWBeer/CLinch) - Common Lisp 2D/3D graphics engine for OpenGL. [FreeBSD][39].
* [donuts ★11](https://github.com/tkych/donuts) - Graph drawing DSL for Common Lisp. [Expat][14].
* [lispbuilder-sdl ★70](https://github.com/lispbuilder/lispbuilder) - A set of bindings for SDL. [Expat][14].
* [okra ★20](https://github.com/aerique/okra) - CFFI bindings to Ogre. Not available on Quicklisp. [3-clause BSD][15].
* [Varjo ★88](https://github.com/cbaggers/varjo) - Lisp to GLSL translator. Not available on Quicklisp. [LLGPL][8].
...
* [cl-xul ★28](https://github.com/mmontone/cl-xul) - Mozilla XUL bindings. [Expat][14].
* [CommonQt ★61](https://github.com/commonqt/commonqt) - A Common Lisp binding for Qt4 via QtSmoke. [FreeBSD][39].
...
* [cl-json ★37](https://github.com/hankhero/cl-json) - A JSON encoder and decoder. [Expat][14].
* [jsown ★43](https://github.com/madnificent/jsown) - A reader and writer for the JSON format. [Expat][14].
...
* [Roswell ★546](https://github.com/roswell/roswell) - a Lisp implementation installer, script launcher and more. [MIT][200].
* [qlot ★93](https://github.com/fukamachi/qlot) - A project-local library installer, similar to Bundler or Carton. [Expat][14].
...
* [cl-nlp ★102](https://github.com/vseloved/cl-nlp) - Natural language processing toolset. [Apache2.0][89].
...
HTTP clients
------------
* [Dexador ★68](https://github.com/fukamachi/dexador) - An HTTP client, that aims at [replacing Drakma](http://quickdocs.org/dexador/). [MIT][200].
...
* [aserve ★72](https://github.com/franzinc/aserve) - AllegroServe; a web server. [LLGPL][8].
* [clack-errors ★18](https://github.com/eudoxia0/clack-errors) - Error page middleware for Clack. [LLGPL][8].
* [hermetic ★17](https://github.com/eudoxia0/hermetic) - Security for Clack-based web applications. [Expat][14].
* [wookie ★137](https://github.com/orthecreedence/wookie) - Asynchronous HTTP server. [Expat][14].
* [woo ★526](https://github.com/fukamachi/woo) - A fast non-blocking HTTP server on top of libev. [MIT][200].

Web frameworks
--------------
* [Caveman ★418](https://github.com/fukamachi/caveman) - A powerful web framework. [LLGPL][8].
  Example projects: [Quickdocs](https://github.com/quickdocs)
* [hh-web ★31](https://github.com/hargettp/hh-web) - Framework for building modern web apps. [Expat][14].
* [ningle ★122](https://github.com/fukamachi/ningle) - A super-micro web framework. [LLGPL][8].
* [radiance ★52](https://github.com/Shirakumo/radiance) - An extensible framework library and multi-application CMS. [Artistic License 2.0][51].
* [Lucerne ★91](https://github.com/eudoxia0/lucerne) - A minimal web framework built on Clack, inspired by Flask. [MIT][200].

There are more projects, more or less discontinued but interesting. See the other ressources.

Parsing html
------------
* [http-parse ★14](https://github.com/orthecreedence/http-parse) - An HTTP parser in Common Lisp. [Expat][14].
* [Plump][71] - A lenient HTTP/XML parser, tolerand on malformed markup. [Artistic License 2.0][51]. Best used with [lquery][72] and [clss ★10](https://github.com/Shinmera/CLSS).
...
* [spinneret ★40](https://github.com/ruricolist/spinneret) - Common Lisp HTML5 generator. [Expat][14].
* [cl-markup ★42](https://github.com/arielnetworks/cl-markup) - Modern markup generation library. [LLGPL][8].
* [Djula ★53](https://github.com/mmontone/djula) - A port of Django's template engine to Common Lisp. [Expat][14].
* [eco ★13](https://github.com/eudoxia0/eco) - Fast, flexible, designer-friendly template engine. [Expat][14].

URI handling
------------

* [puri-unicode ★11](https://github.com/archimag/puri-unicode) - Pure URI library with Unicode support. [LLGPL][8].
* [cl-slug ★12](https://github.com/EuAndreh/cl-slug) - a small library to make slugs, mainly for URIs, transform in CamelCase, remove accentuation and punctuation, for english and beyound. [LLGPL][8].

Javascript
----------

* [Parenscript](https://github.com/vsedach/Parenscript) - A translator from Common Lisp to Javascript. [3-clause BSD][15]. See [Trident-mode ★32](https://github.com/johnmastro/trident-mode.el), an Emacs mode that provides live interaction with the browser.[unlicence][5].
* [parse-js](http://marijnhaverbeke.nl/parse-js/) - A package for parsing ECMAScript 3. [zlib][33].
* [JSCL ★347](https://github.com/jscl-project/jscl) - A CL-to-JS compiler designed to be self-hosting from day one. Lacks CLOS, format and loop.
...
* [Wuwei ★58](https://github.com/mtravers/wuwei) - A toolkit to build Ajax-based web pages. [MIT][200].

Websockets
----------

* [websocket-driver ★31](https://github.com/fukamachi/websocket-driver) - a WebSocket server/client implementation, backend agnostic (Clack). [3-clause BSD][15].
...
* [avatar-api ★7](https://github.com/eudoxia0/avatar-api) - Get avatars from Google+, Gravatar and others. [Expat][14].
* [chirp ★38](https://github.com/Shinmera/chirp) - A Twitter client library. [Artistic License 2.0][51].
* [cl-closure-template ★61](https://github.com/archimag/cl-closure-template) - Implementation of Google's Closure templates. [LLGPL][8].
...
* [cl-ses ★10](https://github.com/CodyReichert/cl-ses) - Library for AWS SES. [Expat][14].
* [colleen ★26](https://github.com/Shinmera/colleen) - IRC bot with a modular framework. [Artistic License 2.0][51].
* [css-lite ★51](https://github.com/paddymul/css-lite) - A CSS grammar. [Expat][14].
* [humbler ★7](https://github.com/Shinmera/humbler) - A Tumblr API interface. [Artistic License 2.0][51].
* [Postmaster ★3](https://github.com/eudoxia0/postmaster) - A simple, easy-to-use SMTP/IMAP library. [Expat][14].
* [usocket ★44](https://github.com/usocket/usocket) - A portable TCP and UDP socket interface. [Expat][14].


Numerical and Scientific
========================

* [cl-spark ★51](https://github.com/tkych/cl-spark) - Generates sparkline strings for lists of numbers. [Expat][14].
...
* [common-lisp-stat ★132](https://github.com/blindglobe/common-lisp-stat) - Common Lisp statistics library. [FreeBSD][39].
* [lisp-matrix ★44](https://github.com/blindglobe/lisp-matrix) - A matrix package. [FreeBSD][39].
...
* [chanl ★92](https://github.com/zkat/chanl) - Portable, channel-based concurrency. [Expat][14], with parts under [3-clause BSD][15].
* [cl-async ★146](https://github.com/orthecreedence/cl-async) - A library for general-purpose, non-blocking programming. [Expat][14].
* [lesque ★14](https://github.com/fukamachi/lesque) - A clone of Resque. Not available on Quicklisp. [Expat][14].
* [lparallel ★109](https://github.com/lmj/lparallel) - A library for parallel programming. [3-clause BSD][15].
* [Xecto ★30](https://github.com/pkhuong/Xecto) - A library for regular array parallelism. [3-clause BSD][15].
...
* [SLIME ★752](https://github.com/slime/slime) - Superior Lisp Interaction Mode for Emacs; a full-blown environment for Common Lisp inside of Emacs. Public domain.
...
* [LISP-MACHINE ★7](https://github.com/listp/lisp-machine) - A Common Lisp IDE in a Docker Container:  Roswell Managed, Clozure CL, Spacemacs, Quicklisp, CLHS

## Vim ##

* [SLIMV ★211](https://github.com/kovisoft/slimv) - Superior Lisp Interaction Mode for Vim; a full-blown environment for Common Lisp inside of Vim. No license specified.
...
* [quickapp-cli ★3](https://github.com/triclops200/quickapp-cli) - [quickapp][188] as a command-line utility. [3-clause BSD][15].
* [quicksearch ★19](https://github.com/tkych/quicksearch) - Look up online libraries from the REPL. [Expat][14].
* [SWIG](http://www.swig.org/) - A tool for generating FFI code from C/C++ header files. [GNU GPL3][2].
* [cl-project ★77](https://github.com/fukamachi/cl-project) - General modern project skeletons. [LLGPL][8].


Unit Testing
============

* [FiveAM ★80](https://github.com/sionescu/fiveam) - Simple regression testing framework. [FreeBSD][39].
* [CLUnit ★15](https://github.com/tgutu/clunit) - A unit testing library. [Expat][14].
* [Lift ★19](https://github.com/gwkkwg/lift) - Another testing framework. [A range of licenses, all free][176].
...
* [Prove ★127](https://github.com/fukamachi/prove) - Yet another unit testing framework [Expat][14].
...
* [cl21 ★616](https://github.com/cl21/cl21) - An experimental project to move Common Lisp into the 21st century. [Expat][14].
...
* [optima ★193](https://github.com/m2ym/optima) - Optimized pattern-matching library. [LLGPL][8].
* [trivial-types ★25](https://github.com/m2ym/trivial-types) - Trivial type definitions. [LLGPL][8].
...
* [ratify ★4](https://github.com/Shinmera/ratify) - A collection of utilities to ratify, validate and parse inputs. [Artistic License 2.0][51].

CSV
---

* [cl-csv ★51](https://github.com/AccelerationNet/cl-csv) - A library for parsing CSV files. [3-clause BSD][15].
...
* [babel ★40](https://github.com/cl-babel/babel) - A charset encoding/decoding library. [Expat][14].
* [chipz ★10](https://github.com/froydnj/chipz) - A decompression library. [3-clause BSD][15].
...
* [cl-annot ★85](https://github.com/m2ym/cl-annot) - Python-like annotations for Common Lisp. [LLGPL][8].
* [cl-cuda ★109](https://github.com/takagi/cl-cuda) - A library to use NVIDIA CUDA in Common Lisp programs. [LLGPL][8].
...
* [cl-locale ★14](https://github.com/fukamachi/cl-locale) - A simple i18n library. [LLGPL][8].
* [cl-syntax ★30](https://github.com/m2ym/cl-syntax) - Reader syntax conventions. [LLGPL][8].
* [closer-mop](http://cliki.net/closer-mop) - A compatibility layer that rectifies many absent or incorrect MOP features. [Expat][14].
* [envy ★22](https://github.com/fukamachi/envy) - Configuration switcher. [FreeBSD][39].
* [esrap ★68](https://github.com/nikodemus/esrap) - Packrat parser. [Expat][14].
* [fast-io ★84](https://github.com/rpav/fast-io) - Fast octet-vector/stream I/O. [3-clause BSD][15].
* [glyphs ★15](https://github.com/ahungry/glyphs) - A library for cutting down the verboseness of Common Lisp in places. [GNU GPL3][2].
* [iolib ★98](https://github.com/sionescu/iolib) - I/O library. [Expat][14].
* [log4cl ★66](https://github.com/7max/log4cl) - Logging framework modelled after Log4J. [Apache2.0][89].
* [mixalot ★19](https://github.com/ahefner/mixalot) - A loosely-coupled collection of audio libraries. No license specified.
* [named-readtables ★13](https://github.com/melisgl/named-readtables) - Provides a readtable namespace, akin to package namespaces. [3-clause BSD][15].
...
* [serapeum ★57](https://github.com/TBRSS/serapeum) - Another general-purpose utility library. [Expat][14].
...
* [trivial-benchmark ★10](https://github.com/Shinmera/trivial-benchmark) - Tiny benchmarking library. [Artistic Licence 2.0][51].
