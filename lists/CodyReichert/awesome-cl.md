...
<p align="center">
	This list is a copy of <a href="https://github.com/CodyReichert/awesome-cl">https://github.com/CodyReichert/awesome-cl</a> with ranks
</p>
---
<div align="center">
...
* [asdf-linguist ★14 ⏳1Y](https://github.com/eudoxia0/asdf-linguist) - Extensions for ASDF. [Expat][14].
...
* [cl-memcached ★16 ⏳1Y](https://github.com/quasi/cl-memcached) - Fast, thread-safe interface to the Memcached object caching system. [Expat][14].
* [cl-mongo ★109 ⏳1Y](https://github.com/fons/cl-mongo) - MongoDB client. [Expat][14].
...
* [cl-cairo2 ★39 ⏳1Y](https://github.com/rpav/cl-cairo2) - Cairo bindings. [Boost 1.0][54]
...
* [cl-xul ★28 ⏳1Y](https://github.com/mmontone/cl-xul) - Mozilla XUL bindings. [Expat][14].
* [CommonQt ★61 ⏳1Y](https://github.com/commonqt/commonqt) - A Common Lisp binding for Qt4 via QtSmoke. [FreeBSD][39].
...
* [jsown ★43 ⏳1Y](https://github.com/madnificent/jsown) - A reader and writer for the JSON format. [Expat][14].
...
* [hh-web ★31 ⏳2Y](https://github.com/hargettp/hh-web) - Framework for building modern web apps. [Expat][14].
...
* [Lucerne ★91 ⏳1Y](https://github.com/eudoxia0/lucerne) - A minimal web framework built on Clack, inspired by Flask. [MIT][200].

There are more projects, more or less discontinued but interesting. See the other ressources.

Parsing html
------------
* [http-parse ★14 ⏳1Y](https://github.com/orthecreedence/http-parse) - An HTTP parser in Common Lisp. [Expat][14].
...
* [cl-markup ★42 ⏳1Y](https://github.com/arielnetworks/cl-markup) - Modern markup generation library. [LLGPL][8].
* [Djula ★53](https://github.com/mmontone/djula) - A port of Django's template engine to Common Lisp. [Expat][14].
* [eco ★13 ⏳1Y](https://github.com/eudoxia0/eco) - Fast, flexible, designer-friendly template engine. [Expat][14].
...
* [Parenscript](https://github.com/vsedach/Parenscript) - A translator from Common Lisp to Javascript. [3-clause BSD][15]. See [Trident-mode ★32 ⏳3Y](https://github.com/johnmastro/trident-mode.el), an Emacs mode that provides live interaction with the browser.[unlicence][5].
...
* [avatar-api ★7 ⏳1Y](https://github.com/eudoxia0/avatar-api) - Get avatars from Google+, Gravatar and others. [Expat][14].
* [chirp ★38](https://github.com/Shinmera/chirp) - A Twitter client library. [Artistic License 2.0][51].
* [cl-closure-template ★61 ⏳1Y](https://github.com/archimag/cl-closure-template) - Implementation of Google's Closure templates. [LLGPL][8].
...
* [css-lite ★51 ⏳5Y](https://github.com/paddymul/css-lite) - A CSS grammar. [Expat][14].
...
* [cl-spark ★51 ⏳1Y](https://github.com/tkych/cl-spark) - Generates sparkline strings for lists of numbers. [Expat][14].
...
* [common-lisp-stat ★132 ⏳2Y](https://github.com/blindglobe/common-lisp-stat) - Common Lisp statistics library. [FreeBSD][39].
* [lisp-matrix ★44 ⏳2Y](https://github.com/blindglobe/lisp-matrix) - A matrix package. [FreeBSD][39].
...
* [quickapp-cli ★3 ⏳1Y](https://github.com/triclops200/quickapp-cli) - [quickapp][188] as a command-line utility. [3-clause BSD][15].
...
* [chipz ★10 ⏳1Y](https://github.com/froydnj/chipz) - A decompression library. [3-clause BSD][15].
...
* [cl-annot ★85 ⏳1Y](https://github.com/m2ym/cl-annot) - Python-like annotations for Common Lisp. [LLGPL][8].
...
* [cl-locale ★14 ⏳1Y](https://github.com/fukamachi/cl-locale) - A simple i18n library. [LLGPL][8].
...
* [glyphs ★15 ⏳1Y](https://github.com/ahungry/glyphs) - A library for cutting down the verboseness of Common Lisp in places. [GNU GPL3][2].
...
* [mixalot ★19 ⏳1Y](https://github.com/ahefner/mixalot) - A loosely-coupled collection of audio libraries. No license specified.
* [named-readtables ★13 ⏳1Y](https://github.com/melisgl/named-readtables) - Provides a readtable namespace, akin to package namespaces. [3-clause BSD][15].
