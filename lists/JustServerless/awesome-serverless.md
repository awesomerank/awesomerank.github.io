...
- [Serverless working group ★49](https://github.com/cncf/wg-serverless) - CNCF serverless working group.
...
- [Serverless Stack](https://serverless-stack.com) - Building and deploying full-stack apps using the Serverless Framework and React on AWS ([GitHub repo ★502](https://github.com/AnomalyInnovations/serverless-stack-com)).
...
- [MoonMail technology stack](https://blog.moonmail.io/what-is-the-technology-stack-and-architecture-behind-moonmail-4d7d6a113ed6#.r2i0cxph6) - Post about the architecture of the [MoonMail ★1057](https://github.com/microapps/MoonMail) open source project.
...
- [Gain more visiblity into your Github Projects using Scope](https://serverless.com/blog/scope-the-open-source-serverless-status-board/) - Blog post which showcases the Open Source serverless application ["Scope" ★397](https://github.com/serverless/scope).
...
- [Scope: A Serverless Project to Manage Open Source Projects](https://thenewstack.io/scope-serverless-project-manage-open-source-projects/) - The New Stack blog post about the open source project ["Scope" ★397](https://github.com/serverless/scope).
...
- [The "Post Scheduler" Serverless project](https://serverless.com/blog/static-site-post-scheduler/) - Post about the ["Post Scheduler" ★122](https://github.com/serverless/post-scheduler) project.
...
- [Introducing NoDB - a Pythonic Object Store for S3](https://blog.zappa.io/posts/introducing-nodb-pythonic-data-store-s3) - Intorduction blog post about the [NoDB ★146](https://github.com/Miserlou/NoDB) project.
...
- [The AWS Lambda power tuning project](https://www.linkedin.com/pulse/aws-lambda-power-tuning-alex-casalboni) - Introduction blog post about the [AWS Lambda power tuning project ★144](https://github.com/alexcasalboni/aws-lambda-power-tuning).
...
- [Real-time serverless malware detection with BinaryAlert](https://medium.com/airbnb-engineering/binaryalert-real-time-serverless-malware-detection-ca44370c1b90) - Announcement blog post of the OpenSource project [BinaryAlert ★512](https://github.com/airbnb/binaryalert) by Airbnb.
...
- [Serverless with R scripts on Azure Functions](https://azure.microsoft.com/en-us/blog/azure-function-r) - How to use R in serverless functions on Azure ([Code / Tutorial repository ★24](https://github.com/thdeltei/azure-function-r)).
...
- [AWS Lambda face](http://blog.johnemmons.com/post/awslambdaface) - How to do serverless face recognition with AWS Lambda ([Code repository ★66](https://github.com/excamera/AWSLambdaFace)).
...
- [Event Gateway - The missing piece of serverless architectures](https://serverless.com/blog/introducing-serverless-event-gateway/) - Announcement blog post of Serverless Inc. introducing then [Event Gateway ★671](https://github.com/serverless/event-gateway) product.
- [Serverless launches open source Event Gateway](https://venturebeat.com/2017/08/17/serverless-launches-open-source-event-gateway-to-tie-cloud-functions-together/) - Post about the recently launched [Event Gateway ★671](https://github.com/serverless/event-gateway) Open Source project.
...
- [Building a serverless analytics service](https://sbstjn.com/serverless-analytics-with-kinesis-stream-lambda.html) - Post about the [Serverless Analytics ★62](https://github.com/sbstjn/serverless-analytics) project.
...
- [Definitive guide to serverless architectures](https://serverless.com/blog/definitive-guide-to-serverless-architectures/) - Announcement post about the new [Serverless Guide ★213](https://github.com/serverless/guide) project.
...
- [How (and why) we designed the Event Gateway](https://serverless.com/blog/designing-pragmatic-tool-event-gateway/) - Design decisions, Serverless, Inc. made to build the [Event Gateway ★671](https://github.com/serverless/event-gateway).
...
- [Building the communication fabric for an event-driven system](https://serverless.com/blog/austen-collins-communication-fabric-event-driven-system-emit-2017/) - Post about the [Event Gateway ★671](https://github.com/serverless/event-gateway) project by Serverless, inc.
...
- [Nuclio and the future of serverless computing](https://thenewstack.io/whats-next-serverless/) - Post about the [Nuclio ★128](https://github.com/nuclio/nuclio) serverless project.
...
- [Scope - The Serverless open source status board](https://www.youtube.com/playlist?list=PLIIjEI2fYC-BtxWcDeTziRp7cIZVEepB3) -  Video series about the serverless open source software ["Scope" ★397](https://github.com/serverless/scope).
...
- [How the static site post scheduler works](https://www.youtube.com/watch?v=RaJw_6s5nWc) - Walktrough of the ["Post Scheduler" ★122](https://github.com/serverless/post-scheduler) project.
...
- [Using the Serverless step functions plugin](https://www.youtube.com/watch?v=bEB0zDHXXG4) - How to use the [step functions plugin ★176](https://github.com/horike37/serverless-step-functions) for the Serverless Framework.
...
- [Official Serverless Examples ★1180](https://github.com/serverless/examples) - Examples from the Serverless Framework team and community.
...
- [GraphQL Blog ★671](https://github.com/serverless/serverless-graphql-blog) - A Blog powered by GraphQL and Serverless.
...
- [Lambda-React-SSR ★63 ⏳1Y](https://github.com/dherault/Lambda-React-SSR) - Server-side rendering with React on Lambda.
- [Authentication boilerplate ★303](https://github.com/laardee/serverless-authentication-boilerplate) - Authentication boilerplate for Serverless.
- [Blog ★4 ⏳1Y](https://github.com/charltones/serverless_blog) - Blog example using Serverless.
- [MoonMail ★1057](https://github.com/microapps/MoonMail) - Serverless newsletter service.
...
- [Facebook messenger bot ★33](https://github.com/michalsanger/serverless-facebook-messenger-bot) - Feature rich Facebook messenger chatbot.
- [Discuss ★80](https://github.com/JustServerless/discuss) - Forum software powered by Serverless, GraphQL, React and Redux.
...
- [Serverless (v1.0) Python Sample ★39](https://github.com/bennybauer/serverless-python-sample) - A simple Serverless Python sample with REST API endpoints and dependencies.
...
- [PhantomJS Lambda pack ★49 ⏳1Y](https://github.com/justengland/phantomjs-lambda-pack) - PhantomJS wrapper for AWS Lambda.
...
- [CRUD ★76](https://github.com/pmuens/serverless-crud) - CRUD service.
- [Mailer ★92](https://github.com/eahefnawy/serverless-mailer) - Service for sending E-Mails.
- [Kinesis streams ★14 ⏳1Y](https://github.com/pmuens/serverless-kinesis-streams) - Service to showcase Kinesis stream support.
- [DynamoDB streams ★16 ⏳1Y](https://github.com/pmuens/serverless-dynamodb-streams) - Service to showcase DynamoDB stream support.
- [Landingpage backend ★16 ⏳1Y](https://github.com/pmuens/serverless-landingpage-backend) - Landingpage backend service to store E-Mail addresses.
...
- [Serverless Sharp Image ★63](https://github.com/adieuadieu/serverless-sharp-image) - function triggered by S3 events to resize images with the awesome Sharp library
- [Serverles Artillery workshop ★47](https://github.com/Nordstrom/serverless-artillery-workshop) - Step by step workshop to create a load testing service which combines [Serverless](http://serverless.com) and [Artillery](http://artillery.io).
...
- [Serverless HTTP ★88](https://github.com/dougmoscrop/serverless-http) - Middleware wrapper for serverless use.
...
- [S3 CRUD ★28](https://github.com/tscanlin/serverless-s3-crud) - Serverless CRUD service using S3.
...
- [CloudWatch RDS Custom Metrics ★9](https://github.com/AndrewFarley/serverless-cloudwatch-rds-custom-metrics) - Serverless MySQL RDS Data Collection script to push Custom Metrics to CloudWatch on AWS.
- [Clouden Xmas](https://github.com/cloudenoy/clouden-xmas) - Serverless Project which uses IoT, MQTT and more.
- [Hello Retail ★134](https://github.com/Nordstrom/hello-retail) - Project with stream processing.
- [Slack app ★63](https://github.com/johnagan/serverless-slack-app) - Slack App Boilerplate with OAuth and Bot actions.
...
- [Swift service template ★104](https://github.com/choefele/swift-lambda-app) - Full-featured project template to develop Lambda functions in Swift.
...
- [Alexa Skill starter template ★59](https://github.com/rmtuckerphx/alexa-skill-serverless-starter-template) - Alexa Skill template that uses the Serverless Framework and the Alexa Skills Kit SDK for Node.js.
- [Golang](https://github.com/yunspace/serverless-golang) - Example project which uses [AWS Lambda Go Shim ★607](https://github.com/eawsy/aws-lambda-go-shim) to run Go in a Lambda.
- [Web monitor ★6](https://github.com/haw-itn/serverless-web-monitor) - Web monitor written in a serverless way.
- [GraphQL Apollo ★662](https://github.com/serverless/serverless-graphql-apollo) - GraphQL boilerplate using Apollo.
...
- [Blog to podcast ★22](https://github.com/SC5/serverless-blog-to-podcast) - Convert blog content to podcasts.
- [Serverless Todos ★12](https://github.com/nerdguru/serverlessTodos) - Enhanched todos application which uses Mocha tests and AWS CodePipeline as a CI / CD system.
- [Practical ★8](https://github.com/asantibanez/practical) - Practical ActiveRecord for DynamoDB.
- [Faceswap ★23](https://github.com/johncmckim/serverless-emoticon-faceswap) - A Serverless Project that overlays an Emoji on a face.
...
- [Scope ★397](https://github.com/serverless/scope) - Customizable birdeye's view of your GitHub project.
...
- [URL shortener ★37](https://github.com/aletheia/serverless-url-shortener) - A simple url-shortener, using Serverless Framework.
- [Falke ★1](https://github.com/sbstjn/falke) - Alexa skill to check when a Tatort is broadcasted.
- [LambdaAuth ★1095](https://github.com/danilop/LambdAuth) - Serverless authentication service.
- [Elasticpypi ★132](https://github.com/khornberg/elasticpypi) - Serverless PyPI service.
- [Lambda coding round evaluator ★21](https://github.com/shekhargulati/lambda-coding-round-evaluator) - Services which help to implement a code evaluator that organizations can use to automate coding round interviews.
- [TDD service ★2](https://github.com/laardee/my-tdd-service) - TDD example service.
- [HTML PDF ★29](https://github.com/calvintychan/serverless-html-pdf) - Convert HTML to PDF thru a lambda function using PhantomJS.
- [Codebox npm ★199](https://github.com/craftship/codebox-npm) - Serverless private npm registry.
...
- [Post Scheduler ★122](https://github.com/serverless/post-scheduler) - Service which helps you to schedule posts for static site generators (Jekyll, Hugo, Phenomic etc.).
- [Bucket events ★1](https://github.com/manwaring/serverless-bucket-events) - Service to test bucket events.
- [Cached RDS WS ★13](https://github.com/mugglmenzel/serverless-examples-cached-rds-ws) - Service that uses API Gateway, ElastiCache, and RDS PostgreSQL.
...
- [Policy generator ★36](https://github.com/dancrumb/generator-serverless-policy) - Yeoman Generator to create IAM policy for deploying a Serverless service.
...
- ["Hello, Retail!" workshop ★84](https://github.com/Nordstrom/hello-retail-workshop) - A workshop to accompany the 100% serverless, event-driven "Hello, Retail!" code base.
...
- [Midsomerplots ★6](https://github.com/matthewberryman/midsomerplots) - Midsomer murder plot generator bot.
- [Proxy ★5](https://github.com/dan-turner/serverless-proxy) - Run your existing HTTP middleware based apps in Serverless.
- [Chrome ★887](https://github.com/adieuadieu/serverless-chrome) - Run headless Chrome on AWS Lambda.
...
- [Serverless SQS worker ★49](https://github.com/sbstjn/sqs-worker-serverless) - Example for SQS worker in AWS Lambda using Serverless.
- [Serverlecs ★1](https://github.com/tobyhede/serverlecs) - Deploys a set of applications to containers in an ECS cluster.
- [Leto ★9](https://github.com/helixone/leto-serverless) - Angular server(less) side rendering.
- [Open bot ★125](https://github.com/open-bot/open-bot) - An unoptionated bot driven by a configuration file in the repository.
...
- [Serverless PHP ★20](https://github.com/araines/serverless-php) - PHP for AWS Lambda via Serverless Framework.
- [Video preview and analysis ★16](https://github.com/laardee/video-preview-and-analysis-service) - Service for creating preview animation and labels from video file.
- [AWS Lambda power tuning ★144](https://github.com/alexcasalboni/aws-lambda-power-tuning) - Step Functions state machine generator for AWS Lambda power tuning.
...
- [Ruby ★42](https://github.com/stewartlord/serverless-ruby) - Call a Ruby function from AWS Lambda.
...
- [GitHub CodeBuild webhook ★40](https://github.com/svdgraaf/github-codebuild-webhook) - Service which shows how one can integrate CodeBuild and GitHub.
- [GraphQL API ★66](https://github.com/boazdejong/serverless-graphql-api) - GraphQL API using Lambda and DynamoDB.
- [Bittman ★4](https://github.com/rhlsthrm/bittman) - Follows a stock trading algorithm and uses scheduled functions to save data to DynamoDB and send emails through Mailgun.
...
- [AWS SES example ★13](https://github.com/lakshmantgld/aws-ses-serverless-example) - AWS SES example in Node.js using Lambda.
- [ES6 / 7 CRUD API ★74](https://github.com/AnomalyInnovations/serverless-stack-demo-api) - [Serverless Stack](http://serverless-stack.com) examples of backend CRUD APIs (DynamoDB + Lambda + API Gateway + Cognito User Pool authorizer) for [React.js single-page app](http://demo.serverless-stack.com).
...
- [AWS IAM manager ★32](https://github.com/netguru/aws-iam-manager) - AWS IAM Manager as code.
...
- [Kinesis Streams fan-out ★28](https://github.com/alexcasalboni/kinesis-streams-fan-out-kinesis-analytics) - Amazon Kinesis Streams fan-out via Kinesis Analytics (powered by the Serverless Framework).
- [X-Ray ★2](https://github.com/e-r-w/serverless-xray-test) - Example service to test the AWS X-Ray integration.
- [Faultline ★50](https://github.com/faultline/faultline) - Error tracking tool on AWS managed services.
...
- [FaunaDB CRUD ★18](https://github.com/fauna/serverless-crud) - CRUD service which uses FaunaDB for data persistence.
...
- [Coinboss ★29](https://github.com/nicka/coinboss) - Serverless Coinbase tradingbot.
...
- [Chromeless ★10765](https://github.com/graphcool/chromeless) - Runs Chrome automation locally or headless on AWS Lambda.
...
- [Image resizer ★11](https://github.com/nicholasgubbins/Serverless-Image-Resizer) - Image resizer like imgix on API Gateway & Lambda.
...
- [Analytics ★62](https://github.com/sbstjn/serverless-analytics) - Track website visitors with serverless analytics.
- [Medium TTS ★52](https://github.com/RafalWilinski/serverless-medium-text-to-speech) - Serverless-based, text-to-speech service for Medium articles.
...
- [Lambda config demo ★12](https://github.com/theburningmonk/lambda-config-demo) - Demo of approaches to config management for AWS Lambda.
- [Flask ★4](https://github.com/alexdebrie/serverless-flask) - Serverless Framework template for a Flask application.
- [jwtAuthorizr ★5](https://github.com/serverlessbuch/jwtAuthorizr) - Custom JWT authorizer Lambda function for Amazon API Gateway with bearer JWT.
- [honeyLambda ★339](https://github.com/0x4D31/honeyLambda) - Simple serverless application designed to create and monitor URL {honey}tokens, on top of AWS Lambda and Amazon API Gateway.
...
- [Start with React example ★3](https://github.com/anoora17/serverlessStartwithReactexample) - Serverless React example app.
...
- [DataFire ★104](https://github.com/DataFire/DataFire) - Open Integration Framework.
...
- [IronFunctions ★1787](https://github.com/iron-io/functions) - The Serverless Microservices Platform.
- [Dromedary Serverless ★29](https://github.com/stelligent/dromedary-serverless) - Project which deploys dromedary in AWS Lambda and also demonstrates the use of CodePipeline.
...
- [AWS profile manager ★19](https://github.com/DavidWells/aws-profile-manager) - GUI tool to manage your AWS profiles.
- [Crop ★5](https://github.com/ryansb/crop) - Cloudformation'd Repeatable Operator Packages.
- [Microcule ★329](https://github.com/stackvana/microcule) - Think of it as serverless functions meets Unix Philosophy.
- [Azure Functions Introduction ★71](https://github.com/guitarrapc/AzureFunctionsIntroduction) - Sample Code for Azure Functions.
- [Hands-On serverless guide ★121](https://github.com/shekhargulati/hands-on-serverless-guide) - A hands-on guide for building serverless applications.
...
- [Localstack ★9024](https://github.com/localstack/localstack) - A fully functional local AWS cloud stack.
...
- [Azure Functions ★254](https://github.com/Azure/Azure-Functions) - Overview repository about Azure Functions.
...
- [Gcdt ★19](https://github.com/glomex/gcdt) - Glomex cloud deployment tools to use infrastructure as code (IaC) on AWS.
- [NoDB ★146](https://github.com/Miserlou/NoDB) - Serverless database built atop of S3.
...
- [Lambda Framework ★215](https://github.com/lambadaframework/lambadaframework) - Build serverless REST API's with Java.
- [Node dash ★13](https://github.com/seriousme/node-dash) - Serverless setup using Node.js.
- [FaaSlang ★178](https://github.com/faaslang/faaslang) - FaaSlang defines FaaS execution semantics and type-safety mechanisms.
- [FDK ★51](https://github.com/serverless/fdk) - The serverless function development kit (FDK).
...
- [Open Lambda ★430](https://github.com/open-lambda/open-lambda) - Serverless computing project, written in Go and based on Linux containers.
- [Serverless patterns ★70](https://github.com/yochay/serverlesspatterns) - Repo with a collection of common serverless design patterns.
...
- [Node Lambda ★915](https://github.com/motdotla/node-lambda) - Command line tool to locally run and deploy your Node.js application to AWS Lambda.
...
- [Moleculer ★404](https://github.com/ice-services/moleculer) - Fast & powerful microservices framework for Node.js.
- [Serverless Architectures on AWS code ★48](https://github.com/sbarski/serverless-architectures-aws) - The code repository for the Serverless Architectures on AWS book.
- [Lambdacult](https://lambdacult.com) - Services on top of AWS Lambda.
- [Scar ★114](https://github.com/grycap/scar) - Serverless Container-aware ARchitectures (e.g. Docker containers in AWS Lambda).
...
- [Lambda session auth ★15](https://github.com/sedenardi/lambda-session-auth) - Cookie-based session authentication using AWS Lambda and Node.js.
- [CloudBoost ★1136](https://github.com/cloudboost/cloudboost) - One complete serverless platform for the next web.
- [Lambda test ★65 ⏳1Y](https://github.com/berezovskyi/lambda-test) - Test (pseudo) AWS Lambda runtime startup time.
- [StdLib ★2730](https://github.com/stdlib/lib) - The standard library for Functions as a Service ([StdLib](https://stdlib.com)).
...
- [Spring Cloud Functions ★209](https://github.com/spring-cloud/spring-cloud-function) - A new programming model for Spring Boot applications.
- [Azure Functions Durable extension ★36](https://github.com/Azure/azure-functions-durable-extension) - Durable Task Framework extension for Azure Functions.
...
- [Cloudfunc ★91](https://github.com/flowup/cloudfunc) - Deploying Google Cloud Functions written in Go with ease.
...
- [Serverless Java Container ★251](https://github.com/awslabs/aws-serverless-java-container) - Java wrapper to run Spring, Jersey, Spark, and other apps inside AWS Lambda.
- [Architect](https://arc.codes) - Provision and deploy cloud architecture as text.
- [BinaryAlert ★512](https://github.com/airbnb/binaryalert) - Real-time serverless malware detection.
- [Lambda ★174](https://github.com/smallwins/lambda) - Authoring tools for AWS Lambda functions.
...
- [AWS Chalice ★3426](https://github.com/aws/chalice) - Python serverless microframework for AWS.
- [Lambda RESTify ★6](https://github.com/kksharma1618/lambda-restify) - A restify / expressjs like interface for AWS Lamda with API Gateway event.
- [AWS SAM Local ★959](https://github.com/awslabs/aws-sam-local) - Toolset to develop AWS SAM projects locally.
...
- [Zappa ★5152](https://github.com/Miserlou/Zappa) - Serverless Python web services.
- [Serverless guide ★213](https://github.com/serverless/guide) - The "definitive guide" to serverless architectures.
- [Seed](https://seed.run) - CI / CD solution for serverless applications.
- [Slspress ★11](https://github.com/withreason/slspress) - Library for rapidly developing serverless applications.
...
- [Lambda SES forwarder ★440](https://github.com/arithmetric/aws-lambda-ses-forwarder) - Serverless E-Mail forwarding using AWS Lambda and SES.
...
- [Derek ★120](https://github.com/alexellis/derek) - A serverless bot to manage PRs and issues.
- [Serverless By Design ★56](https://github.com/danilop/ServerlessByDesign) - Visual tool to create serverless architectures.
- [Serverless Blog](https://serverlessblog.com) - Run your blog on AWS Lambda using [Flask-Blogging ★352](https://github.com/gouthambs/Flask-Blogging).
...
- [Fission Workflows ★52](https://github.com/fission/fission-workflows) -  Fast, reliable and lightweight serverless function composition.
- [AWS Mobile React Native starter ★1596](https://github.com/awslabs/aws-mobile-react-native-starter) - AWS Mobile React Native starter app which runs on a serverless infrastructure.
- [Stackery](https://www.stackery.io) - Serverless operations console.
- [Serverless chat ★41](https://github.com/danilop/serverless-chat) - Web chat built using AWS Lambda, AWS IoT (for WebSockets) and Amazon DynamoDB.
- [Fn Project](http://fnproject.io) - The container native serverless framework ([GitHub repository ★1586](https://github.com/fnproject/fn)).
...
- [Google Cloud Functions ★122](https://github.com/serverless/serverless-google-cloudfunctions) - Adds Google Cloud Functions support to the Serverless Framework.
...
- [AWS documentation ★64](https://github.com/9cookies/serverless-aws-documentation) - Add documentation and models to the serverless generated API Gateway.
...
- [Python requirements ★91](https://github.com/UnitedIncome/serverless-python-requirements) - Serverless plugin to bundle Python packages.
- [Subscription filter ★11](https://github.com/tsub/serverless-plugin-subscription-filter) - Extend subscription filter events.
- [Step Functions ★176](https://github.com/horike37/serverless-step-functions) - AWS Step Functions support for Serverless.
...
- [Plugin scripts ★15](https://github.com/mvila/serverless-plugin-scripts) - Adds scripting capabilities to the Serverless Framework.
- [Bind deployment id ★11](https://github.com/jacob-meacham/serverless-plugin-bind-deployment-id) - Bind the randomly generated deployment resource to your custom resources.
...
- [Jest ★31](https://github.com/SC5/serverless-jest-plugin) - Adds support for test-driven development using Jest.
- [Postgraphql ★57](https://github.com/rentrop/serverless-postgraphql) - GraphQL endpoint for PostgreSQL using postgraphql.
...
- [AWS alerts ★50](https://github.com/ACloudGuru/serverless-plugin-aws-alerts) - Easily add CloudWatch alarms to functions.
...
- [Additional stacks ★13](https://github.com/SC5/serverless-plugin-additional-stacks) - Support for managing multiple AWS CloudFormation stacks.
- [Prune ★27](https://github.com/claygregory/serverless-prune-plugin) - Deletes old versions of functions from AWS, preserving recent and aliased versions.
- [Offline scheduler ★16](https://github.com/ajmath/serverless-offline-scheduler) - Runs scheduled functions offline while integrating with serverless-offline.
...
- [Alias ★34](https://github.com/HyperBrain/serverless-aws-alias) - Alias support for Serverless 1.6+.
...
- [Select ★10](https://github.com/FidelLimited/serverless-plugin-select) - Select which functions are to be deployed based on region and stage.
- [Webpack ★30](https://github.com/goldwasserexchange/serverless-plugin-webpack) - Plugin to automatically bundle your functions individually with Webpack.
- [OpenWhisk ★59](https://github.com/serverless/serverless-openwhisk) - Add OpenWhisk support to the Serverless Framework.
- [Warmup ★73](https://github.com/FidelLimited/serverless-plugin-warmup) - Keep Lambdas warm so to avoid slow cold starts.
- [ReasonML ★21](https://github.com/ReasonVienna/serverless-reason-plugin) - Use ReasonML with Serverless.
...
- [Git variables ★12](https://github.com/jacob-meacham/serverless-plugin-git-variables) - Expose git variables to Serverless.
- [Dynalite ★4](https://github.com/sdd/serverless-dynalite) - Run dynalite locally (no JVM, all JS) to simulate DynamoDB.
- [TypeScript ★93](https://github.com/graphcool/serverless-plugin-typescript) - Zero-config TypeScript support.
...
- [IOpipe ★6](https://github.com/iopipe/serverless-plugin-iopipe) - Automatically wrap your serverless framework functions with IOpipe.
...
- [Split stacks ★15](https://github.com/dougmoscrop/serverless-plugin-split-stacks) - Generates nested stacks to get around the 200 resource CloudFormation limit.
- [FaaS](https://github.com/alexellis/serverless-faas) - Provider plugin for the [FaaS project](https://github.com/alexellis/faas).
- [Package Python functions ★12](https://github.com/ubaniabalogun/serverless-package-python-functions) - Packaging Python Lambda functions with only the dependencies/requirements they need.
...
- [SAM ★27](https://github.com/SAPessi/serverless-sam) - Exports an AWS SAM template for a service created with the Serverless Framework.
- [ElasticBeanstalk ★5](https://github.com/rawphp/serverless-plugin-elastic-beanstalk) - Deploy applications to AWS ElasticBeanstalk.
...
- [KMS secrets ★35](https://github.com/SC5/serverless-kms-secrets) - Allows to easily encrypt and decrypt secrets using KMS from the serverless CLI.
...
- [Custom domain ★22](https://github.com/dougmoscrop/serverless-plugin-custom-domain) - Add API Gateway custom domain BasePathMappings reliably.
...
- [Domain manager ★49](https://github.com/amplify-education/serverless-domain-manager) - Plugin for managing custom domains with API Gateways.
- [Encrypted ★6](https://github.com/nalbion/serverless-plugin-encrypted) - Encrypts Lambda environment variables using a KMS key.
- [Localstack ★43](https://github.com/temyers/serverless-localstack) - Plugin for running against Atalssian Localstack.
...
- [API Gateway binary ★25](https://github.com/maciejtreder/serverless-apigw-binary) - Enable binary support in AWS API Gateway.
...
- [Browserifier ★5](https://github.com/digitalmaas/serverless-plugin-browserifier) - Reduce the size and speed up your Node.js based Lambdas using Browserify.
...
[Offline ★757](https://github.com/dherault/serverless-offline) - Emulate AWS λ and API Gateway locally when developing on Serverless projects.
- [Stack output ★8](https://github.com/sbstjn/serverless-stack-output) - Store output from your AWS CloudFormation Stack in JSON/YAML/TOML files, or to pass it to a JavaScript function for further processing.
- [OpenAPI documentation ★11](https://github.com/temando/serverless-openapi-documentation) - Generate OpenAPI V3 documentation from a Serverless configuration.
...
- [Sentry ★34](https://github.com/arabold/serverless-sentry-plugin) - Sentry integration for Serverless v1.
- [Finch ★14](https://github.com/fernando-mc/serverless-finch) - Plugin for static site deployments.
- [Env generator ★11](https://github.com/DieProduktMacher/serverless-env-generator) - Manage environment variables with YAML and turn them into a .env file on deployment.
- [Local dev server ★6](https://github.com/DieProduktMacher/serverless-local-dev-server) - Local development server to speed up the development of Alexa Skills, chatbots, APIs and more.
- [Log forward ★10](https://github.com/amplify-education/serverless-log-forwarding) - Forwarding CloudWatch logs to another Lambda function.
...
- [DynamoDB autoscaling ★61](https://github.com/sbstjn/serverless-dynamodb-autoscaling) - Configure Amazon DynamoDB native auto-scaling for your table capacities.
- [Bespoken ★12](https://github.com/bespoken/serverless-plugin-bespoken) - Creates a local server and a proxy so you don't have to deploy anytime you want to test your code for your [Bespoken](http://bespoken.tools) application.
- [S3 bucket sync ★9](https://github.com/sbstjn/serverless-s3bucket-sync) - Sync local folders with an S3 bucket.
- [S3 sync ★18](https://github.com/k1LoW/serverless-s3-sync) - Sync local directories and S3 prefixes.
...
- [Kubeless ★50](https://github.com/serverless/serverless-kubeless) - Official provider plugin to deploy functions to Kubeless.
...
- [PureSec CLI ★32](https://github.com/puresec/serverless-puresec-cli) - Plugin for least privileges.
...
- [AWS Step Functions demo ★10](https://github.com/AgileVisionCompany/step-functions-demo) - AWS Step Functions demo service.
...
- [Lambda@Edge ★14](https://github.com/silvermine/serverless-plugin-cloudfront-lambda-edge) - Adds Lambda@Edge support to Serverless.
...
- [Offline Kinesis events ★2](https://github.com/DopplerLabs/serverless-plugin-offline-kinesis-events) - Allows offline testing of serverless functions that are triggered by Kinesis events.
- [Develop ★6](https://github.com/RafalWilinski/serverless-develop) - Deploy your functions to AWS Lambda as you code, in realtime.
- [Micro ★10](https://github.com/barstoolsports/serverless-micro) - Plugin to help manage multiple microservices under one main service.
- [API Gateway <--> CloudFront ★22](https://github.com/Droplr/serverless-api-cloudfront) - Adds CloudFront distribution in front of your API Gateway for custom domain, CDN caching and access log.
...
- [Serverless book - By the Serverless team ★88](https://github.com/pmuens/serverless-book) - Book focused on v1 of the [serverless.com](http://serverless.com) framework.
...
- [Lambda prune ★18 ⏳1Y](https://github.com/Nopik/serverless-lambda-prune-plugin) - Automatically remove unused Lambda functions.
...
- [Serve ★101 ⏳1Y](https://github.com/Nopik/serverless-serve) - Test your lambda functionality locally.
...
- [Meta Sync ★42 ⏳1Y](https://github.com/serverless/serverless-meta-sync) - Synchronize project credentials via AWS.
...
- [Mocha ★68](https://github.com/SC5/serverless-mocha-plugin) - Plugin to use Mocha.js.
- [Package ★5 ⏳1Y](https://github.com/HyperBrain/serverless-package-plugin) - Adds function packaging.
- [Sentry ★34](https://github.com/arabold/serverless-sentry-plugin) - Sentry integration for Serverless.
...
- [Swagger export ★13](https://github.com/kennu/serverless-plugin-swagger-export) - Generate a Swagger JSON definition from your Serverless project.
...
- [Slack ★33 ⏳1Y](https://github.com/serverless/serverless-slack) - Slack boilerplate functionality.
- [Examples ★33 ⏳1Y](https://github.com/remicastaing/serverless-examples) - Module with example functions.
