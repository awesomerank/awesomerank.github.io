...
1. [Androwarn ★161 ⏳4Y](https://github.com/maaaaz/androwarn) - detect and warn the user about potential malicious behaviours developped by an Android application.
* [ApkAnalyser ★814 ⏳4Y](https://github.com/sonyxperiadev/ApkAnalyser)
* [APKInspector ★502 ⏳4Y](https://github.com/honeynet/apkinspector)
...
* [Smali CFG generator ★63 ⏳3Y](https://github.com/EugenioDelfa/Smali-CFGs)
...
* [SmaliSCA ★179](https://github.com/dorneanu/smalisca) - Smali Static Code Analysis
* [CFGScanDroid ★22 ⏳2Y](https://github.com/douggard/CFGScanDroid) - Scans and compares CFG against CFG of malicious applications
* [Madrolyzer ★52 ⏳2Y](https://github.com/maldroid/maldrolyzer) - extracts actionable data like C&C, phone number etc.
...
1. [QARK ★1366](https://github.com/linkedin/qark) - QARK by LinkedIn is for app developers to scan app for security issues
* [AndroBugs ★421](https://github.com/AndroBugs/AndroBugs_Framework)
* [Nogotofail ★2150](https://github.com/google/nogotofail)
* [Devknox](https://devknox.io/) - Autocorrect security issues as if it was spell check from your IDE
* [JAADAS ★154](https://github.com/flankerhqd/JAADAS) - Joint intraprocedure and interprocedure program analysis tool to find vulnerabilities in Android apps, built on Soot and Scala

Dynamic Analysis Tools
----

1. [Android DBI frameowork](http://www.mulliner.org/blog/blosxom.cgi/security/androiddbiv02.html)
2. [Androl4b ★421](https://github.com/sh4hin/Androl4b)- A Virtual Machine For Assessing Android applications, Reverse Engineering and Malware Analysis
...
* [Mobile-Security-Framework MobSF ★1976](https://github.com/MobSF/Mobile-Security-Framework-MobSF) - Mobile Security Framework is an intelligent, all-in-one open source mobile application (Android/iOS) automated pen-testing framework capable of performing static, dynamic analysis and web API testing.
...
* [Droidbox ★291 ⏳1Y](https://github.com/pjlantz/droidbox)
* ~~[Mercury](https://labs.mwrinfosecurity.com/tools/2012/03/16/mercury/)~~
* [Drozer ★1096](https://github.com/mwrlabs/drozer)
...
* [Inspeckage ★642](https://github.com/ac-pm/Inspeckage) - Android Package Inspector - dynamic analysis with api hooks, start unexported activities and more. (Xposed Module)
* [Android Hooker ★282 ⏳1Y](https://github.com/AndroidHooker/hooker) - Dynamic Java code instrumentation (requires the Substrate Framework)
* [ProbeDroid ★119](https://github.com/ZSShen/ProbeDroid) - Dynamic Java code instrumentation
* [Android Tamer](https://androidtamer.com/) - Virtual / Live Platform for Android Security Professionals
* [DECAF ★194](https://github.com/sycurelab/DECAF) - Dynamic Executable Code Analysis Framework based on QEMU (DroidScope is now an extension to DECAF)
* [CuckooDroid ★284](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
...
* [Android Linux Kernel modules ★90 ⏳2Y](https://github.com/strazzere/android-lkms)
...
* [Vezir Project ★49 ⏳1Y](https://github.com/oguzhantopgul/Vezir-Project) - Virtual Machine for Mobile Application Pentesting and Mobile Malware Analysis
* [MARA ★176](https://github.com/xtiankisutsa/MARA_Framework) - Mobile Application Reverse engineering and Analysis Framework
...
1. [Smali/Baksmali ★1993](https://github.com/JesusFreke/smali) – apk decompilation
* [emacs syntax coloring for smali files ★21 ⏳1Y](https://github.com/strazzere/Emacs-Smali)
* [vim syntax coloring for smali files](http://codetastrophe.com/smali.vim)
* [AndBug ★401 ⏳1Y](https://github.com/swdunlop/AndBug)
* [Androguard ★1606](https://github.com/androguard/androguard) – powerful, integrates well with other tools
* [Apktool](https://ibotpeaches.github.io/Apktool/) – really useful for compilation/decompilation (uses smali)
* [Android Framework for Exploitation ★121 ⏳1Y](https://github.com/appknox/AFE)
* [Bypass signature and permission checks for IPCs ★44 ⏳3Y](https://github.com/iSECPartners/Android-KillPermAndSigChecks)
* [Android OpenDebug ★58 ⏳3Y](https://github.com/iSECPartners/Android-OpenDebug) – make any application on device debuggable (using cydia substrate).
* [Dare](http://siis.cse.psu.edu/dare/index.html) – .dex to .class converter
* [Dex2Jar ★3424](https://github.com/pxb1988/dex2jar) - dex to jar converter
* [Enjarify ★1950](https://github.com/google/enjarify) - dex to jar converter from Google
* [Dedexer](http://dedexer.sourceforge.net)
* [Fino ★75 ⏳2Y](https://github.com/sysdream/fino)
* [Frida](https://www.frida.re/) - inject javascript to explore applications and a [GUI tool ★72](https://github.com/antojoseph/diff-gui) for it
...
* [Introspy ★307 ⏳3Y](https://github.com/iSECPartners/Introspy-Android)
* [Jad]( https://varaneckas.com/jad/) - Java decompiler
* [JD-GUI ★3585](https://github.com/java-decompiler/jd-gui) - Java decompiler
* [CFR](http://www.benf.org/other/cfr/) - Java decompiler
* [Krakatau ★720](https://github.com/Storyyeller/Krakatau) - Java decompiler
* [Procyon](https://bitbucket.org/mstrobel/procyon/wiki/Java%20Decompiler) - Java decompiler
* [FernFlower ★763](https://github.com/fesh0r/fernflower) - Java decompiler
...
* [Simplify Android deobfuscator ★703](https://github.com/CalebFenton/simplify)
* [Bytecode viewer ★1791](https://github.com/Konloch/bytecode-viewer)
* [Radare2 ★5092](https://github.com/radare/radare2)

Fuzz Testing
----

1. [IntentFuzzer](https://www.nccgroup.trust/us/about-us/resources/intent-fuzzer/)
* [Radamsa Fuzzer ★31 ⏳1Y](https://github.com/anestisb/radamsa-android)
* [Honggfuzz ★808](https://github.com/google/honggfuzz)
...
1. [Google play crawler (Java) ★341](https://github.com/Akdeniz/google-play-crawler)
* [Google play crawler (Python) ★633](https://github.com/egirault/googleplay-api)
* [Google play crawler (Node)  ★113](https://github.com/dweinstein/node-google-play) - get app details and download apps from official Google Play Store.
...
* [adb autocomplete ★164 ⏳1Y](https://github.com/mbrubeck/android-completion)
...
* [GoatDroid ★153 ⏳3Y](https://github.com/jackMannino/OWASP-GoatDroid-Project) - for practice
* [mitmproxy ★8196](https://github.com/mitmproxy/mitmproxy)
* [dockerfile/androguard ★28](https://github.com/dweinstein/dockerfile-androguard)
* [Android Vulnerability Test Suite ★848](https://github.com/AndroidVTS/android-vts) - android-vts scans a device for set of vulnerabilities
...
* [Android security related presentations ★76 ⏳2Y](https://github.com/jacobsoo/AndroidSlides)
...
Others
----
1. [OWASP Mobile Security Testing Guide Manual ★1344](https://github.com/OWASP/owasp-mstg) 
* [Android Reverse Engineering 101 by Daniele Altomare](http://www.fasteque.com/android-reverse-engineering-101-part-1/)
* [doridori/Android-Security-Reference ★378](https://github.com/doridori/Android-Security-Reference)
* [android app security checklist ★232](https://github.com/b-mueller/android_app_security_checklist)
...
* [Android Malware Github repo ★101](https://github.com/ashishb/android-malware)
