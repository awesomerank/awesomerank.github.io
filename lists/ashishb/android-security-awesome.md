...
---
android-security-awesome [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg) ★59088](sindresorhus/awesome)
========================
...
1. [Androwarn ★153 ⏳4Y](maaaaz/androwarn) - detect and warn the user about potential malicious behaviours developped by an Android application.
* [ApkAnalyser ★796 ⏳4Y](sonyxperiadev/ApkAnalyser)
* [APKInspector ★486 ⏳4Y](honeynet/apkinspector)
...
* [Smali CFG generator ★56 ⏳2Y](EugenioDelfa/Smali-CFGs)
...
* [SmaliSCA ★174](dorneanu/smalisca) - Smali Static Code Analysis
* [CFGScanDroid ★21 ⏳2Y](douggard/CFGScanDroid) - Scans and compares CFG against CFG of malicious applications
* [Madrolyzer ★51 ⏳2Y](maldroid/maldrolyzer) - extracts actionable data like C&C, phone number etc.
...
* [ConDroid ★16 ⏳1Y](JulianSchuette/ConDroid) - Performs a combination of symoblic + concrete execution of the app
* [DroidRA ★10](serval-snt-uni-lu/DroidRA)

App Vulnerability Scanners
----

1. [QARK ★1313](linkedin/qark) - QARK by LinkedIn is for app developers to scan app for security issues
* [AndroBugs ★398](AndroBugs/AndroBugs_Framework)
* [Nogotofail ★2101](google/nogotofail)
* [Devknox](https://devknox.io/) - Autocorrect security issues as if it was spell check from your IDE
* [JAADAS ★147](flankerhqd/JAADAS) - Joint intraprocedure and interprocedure program analysis tool to find vulnerabilities in Android apps, built on Soot and Scala

Dynamic Analysis Tools
----

1. [Android DBI frameowork](http://www.mulliner.org/blog/blosxom.cgi/security/androiddbiv02.html)
2. [Androl4b ★378](sh4hin/Androl4b)- A Virtual Machine For Assessing Android applications, Reverse Engineering and Malware Analysis
...
* [Inspeckage ★579](ac-pm/Inspeckage) - Android Package Inspector - dynamic analysis with api hooks, start unexported activities and more. (Xposed Module)
* [Android Hooker ★271](AndroidHooker/hooker) - Dynamic Java code instrumentation (requires the Substrate Framework)
* [ProbeDroid ★115](ZSShen/ProbeDroid) - Dynamic Java code instrumentation
...
* [Aurasium ★16 ⏳2Y](xurubin/aurasium) – Practical security policy enforcement for Android apps via bytecode rewriting and in-place reference monitor.
* [Android Linux Kernel modules ★86 ⏳2Y](strazzere/android-lkms)
...
* [StaDynA ★3](zyrikby/StaDynA) - a system supporting security app analysis in the presence of dynamic code update features (dynamic class loading and reflection). This tool combines static and dynamic analysis of Android applications in order to reveal the hidden/updated behavior and extend static analysis results with this information.
* [DroidAnalytics ★19 ⏳2Y](zhengmin1989/DroidAnalytics) - incomplete
* [Vezir Project ★48 ⏳1Y](oguzhantopgul/Vezir-Project) - Virtual Machine for Mobile Application Pentesting and Mobile Malware Analysis
* [MARA ★160](xtiankisutsa/MARA_Framework) - Mobile Application Reverse engineering and Analysis Framework
...
1. [Smali/Baksmali ★1823](JesusFreke/smali) – apk decompilation
* [emacs syntax coloring for smali files ★19 ⏳1Y](strazzere/Emacs-Smali)
* [vim syntax coloring for smali files](http://codetastrophe.com/smali.vim)
* [AndBug ★393](swdunlop/AndBug)
* [Androguard ★1498](androguard/androguard) – powerful, integrates well with other tools
* [Apktool](https://ibotpeaches.github.io/Apktool/) – really useful for compilation/decompilation (uses smali)
* [Android Framework for Exploitation ★119 ⏳1Y](appknox/AFE)
* [Bypass signature and permission checks for IPCs ★43 ⏳3Y](iSECPartners/Android-KillPermAndSigChecks)
* [Android OpenDebug ★54 ⏳3Y](iSECPartners/Android-OpenDebug) – make any application on device debuggable (using cydia substrate).
* [Dare](http://siis.cse.psu.edu/dare/index.html) – .dex to .class converter
* [Dex2Jar ★3166](pxb1988/dex2jar) - dex to jar converter
* [Enjarify ★1901](google/enjarify) - dex to jar converter from Google
* [Dedexer](http://dedexer.sourceforge.net)
* [Fino ★73 ⏳2Y](sysdream/fino)
* [Frida](http://www.frida.re/) - inject javascript to explore applications and a [GUI tool ★65](antojoseph/diff-gui) for it
...
* [Introspy ★289 ⏳3Y](iSECPartners/Introspy-Android)
* [Jad]( http://varaneckas.com/jad/) - Java decompiler
* [JD-GUI ★3383](java-decompiler/jd-gui) - Java decompiler
* [CFR](http://www.benf.org/other/cfr/) - Java decompiler
* [Krakatau ★702](Storyyeller/Krakatau) - Java decompiler
* [Procyon](https://bitbucket.org/mstrobel/procyon/wiki/Java%20Decompiler) - Java decompiler
* [FernFlower ★708](fesh0r/fernflower) - Java decompiler
* [Redexer ★98](plum-umd/redexer) – apk manipulation
...
* [Simplify Android deobfuscator ★652](CalebFenton/simplify)
* [Bytecode viewer ★1704](Konloch/bytecode-viewer)
* [Radare2 ★4714](radare/radare2)

Fuzz Testing
----

1. [IntentFuzzer](https://www.nccgroup.trust/us/about-us/resources/intent-fuzzer/)
* [Radamsa Fuzzer ★29 ⏳1Y](anestisb/radamsa-android)
* [Honggfuzz ★682](google/honggfuzz)
* [An Android port of the melkor ELF fuzzer ★43 ⏳2Y](anestisb/melkor-android)
* [Media Fuzzing Framework for Android ★204 ⏳1Y](fuzzing/MFFA)
* [AndroFuzz ★23 ⏳2Y](jonmetz/AndroFuzz)

App Repackaging Detectors
----

1. [FSquaDRA ★33 ⏳1Y](zyrikby/FSquaDRA) - a tool for detection of repackaged Android applications based on app resources hash comparison.

Market Crawlers
----

1. [Google play crawler (Java) ★325](Akdeniz/google-play-crawler)
* [Google play crawler (Python) ★614](egirault/googleplay-api)
* [Google play crawler (Node)  ★91](dweinstein/node-google-play) - get app details and download apps from official Google Play Store.
* [Aptoide downloader (Node) ★12 ⏳1Y](dweinstein/node-aptoide) - download apps from Aptoide third-party Android market
* [Appland downloader (Node) ★5 ⏳1Y](dweinstein/node-appland) - download apps from Appland third-party Android market
...
* [adb autocomplete ★158](mbrubeck/android-completion)
...
* [GoatDroid ★148 ⏳2Y](jackMannino/OWASP-GoatDroid-Project) - for practice
* [mitmproxy ★7819](mitmproxy/mitmproxy)
* [dockerfile/androguard ★26](dweinstein/dockerfile-androguard)
* [Android Vulnerability Test Suite ★829](AndroidVTS/android-vts) - android-vts scans a device for set of vulnerabilities
...
* [Android security related presentations ★70 ⏳2Y](jacobsoo/AndroidSlides)
...
Others
----
1. [OWASP Mobile Security Testing Guide Manual ★1024](OWASP/owasp-mstg) 
* [Android Reverse Engineering 101 by Daniele Altomare](http://www.fasteque.com/android-reverse-engineering-101-part-1/)
* [doridori/Android-Security-Reference ★363](doridori/Android-Security-Reference)
...
* [Android Malware Github repo ★76](ashishb/android-malware)
