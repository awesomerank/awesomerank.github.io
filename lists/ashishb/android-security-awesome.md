...
1. [Androwarn ★158 ⏳4Y](https://github.com/maaaaz/androwarn) - detect and warn the user about potential malicious behaviours developped by an Android application.
* [ApkAnalyser ★809 ⏳4Y](https://github.com/sonyxperiadev/ApkAnalyser)
* [APKInspector ★494 ⏳4Y](https://github.com/honeynet/apkinspector)
...
* [Smali CFG generator ★58 ⏳3Y](https://github.com/EugenioDelfa/Smali-CFGs)
...
* [SmaliSCA ★176](https://github.com/dorneanu/smalisca) - Smali Static Code Analysis
...
1. [QARK ★1342](https://github.com/linkedin/qark) - QARK by LinkedIn is for app developers to scan app for security issues
* [AndroBugs ★408](https://github.com/AndroBugs/AndroBugs_Framework)
* [Nogotofail ★2125](https://github.com/google/nogotofail)
* [Devknox](https://devknox.io/) - Autocorrect security issues as if it was spell check from your IDE
* [JAADAS ★152](https://github.com/flankerhqd/JAADAS) - Joint intraprocedure and interprocedure program analysis tool to find vulnerabilities in Android apps, built on Soot and Scala

Dynamic Analysis Tools
----

1. [Android DBI frameowork](http://www.mulliner.org/blog/blosxom.cgi/security/androiddbiv02.html)
2. [Androl4b ★388](https://github.com/sh4hin/Androl4b)- A Virtual Machine For Assessing Android applications, Reverse Engineering and Malware Analysis
...
* [Droidbox ★274 ⏳1Y](https://github.com/pjlantz/droidbox)
* ~~[Mercury](https://labs.mwrinfosecurity.com/tools/2012/03/16/mercury/)~~
* [Drozer ★1043](https://github.com/mwrlabs/drozer)
...
* [Inspeckage ★606](https://github.com/ac-pm/Inspeckage) - Android Package Inspector - dynamic analysis with api hooks, start unexported activities and more. (Xposed Module)
* [Android Hooker ★280](https://github.com/AndroidHooker/hooker) - Dynamic Java code instrumentation (requires the Substrate Framework)
* [ProbeDroid ★117](https://github.com/ZSShen/ProbeDroid) - Dynamic Java code instrumentation
* [Android Tamer](https://androidtamer.com/) - Virtual / Live Platform for Android Security Professionals
* [DECAF ★186](https://github.com/sycurelab/DECAF) - Dynamic Executable Code Analysis Framework based on QEMU (DroidScope is now an extension to DECAF)
* [CuckooDroid ★250](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
...
* [Android Linux Kernel modules ★88 ⏳2Y](https://github.com/strazzere/android-lkms)
...
* [DroidAnalytics ★20 ⏳2Y](https://github.com/zhengmin1989/DroidAnalytics) - incomplete
...
* [MARA ★167](https://github.com/xtiankisutsa/MARA_Framework) - Mobile Application Reverse engineering and Analysis Framework
...
1. [Smali/Baksmali ★1899](https://github.com/JesusFreke/smali) – apk decompilation
...
* [AndBug ★396](https://github.com/swdunlop/AndBug)
* [Androguard ★1558](https://github.com/androguard/androguard) – powerful, integrates well with other tools
* [Apktool](https://ibotpeaches.github.io/Apktool/) – really useful for compilation/decompilation (uses smali)
* [Android Framework for Exploitation ★120 ⏳1Y](https://github.com/appknox/AFE)
* [Bypass signature and permission checks for IPCs ★43 ⏳3Y](https://github.com/iSECPartners/Android-KillPermAndSigChecks)
* [Android OpenDebug ★56 ⏳3Y](https://github.com/iSECPartners/Android-OpenDebug) – make any application on device debuggable (using cydia substrate).
* [Dare](http://siis.cse.psu.edu/dare/index.html) – .dex to .class converter
* [Dex2Jar ★3285](https://github.com/pxb1988/dex2jar) - dex to jar converter
* [Enjarify ★1930](https://github.com/google/enjarify) - dex to jar converter from Google
* [Dedexer](http://dedexer.sourceforge.net)
* [Fino ★75 ⏳2Y](https://github.com/sysdream/fino)
* [Frida](http://www.frida.re/) - inject javascript to explore applications and a [GUI tool ★69](https://github.com/antojoseph/diff-gui) for it
...
* [Introspy ★299 ⏳3Y](https://github.com/iSECPartners/Introspy-Android)
* [Jad]( http://varaneckas.com/jad/) - Java decompiler
* [JD-GUI ★3470](https://github.com/java-decompiler/jd-gui) - Java decompiler
* [CFR](http://www.benf.org/other/cfr/) - Java decompiler
* [Krakatau ★709](https://github.com/Storyyeller/Krakatau) - Java decompiler
* [Procyon](https://bitbucket.org/mstrobel/procyon/wiki/Java%20Decompiler) - Java decompiler
* [FernFlower ★740](https://github.com/fesh0r/fernflower) - Java decompiler
...
* [Simplify Android deobfuscator ★666](https://github.com/CalebFenton/simplify)
* [Bytecode viewer ★1756](https://github.com/Konloch/bytecode-viewer)
* [Radare2 ★4903](https://github.com/radare/radare2)
...
* [Honggfuzz ★732](https://github.com/google/honggfuzz)
* [An Android port of the melkor ELF fuzzer ★43 ⏳2Y](https://github.com/anestisb/melkor-android)
* [Media Fuzzing Framework for Android ★211 ⏳1Y](https://github.com/fuzzing/MFFA)
...
1. [Google play crawler (Java) ★335](https://github.com/Akdeniz/google-play-crawler)
* [Google play crawler (Python) ★626](https://github.com/egirault/googleplay-api)
* [Google play crawler (Node)  ★102](https://github.com/dweinstein/node-google-play) - get app details and download apps from official Google Play Store.
...
* [adb autocomplete ★160](https://github.com/mbrubeck/android-completion)
...
* [GoatDroid ★153 ⏳2Y](https://github.com/jackMannino/OWASP-GoatDroid-Project) - for practice
* [mitmproxy ★7992](https://github.com/mitmproxy/mitmproxy)
* [dockerfile/androguard ★28](https://github.com/dweinstein/dockerfile-androguard)
* [Android Vulnerability Test Suite ★838](https://github.com/AndroidVTS/android-vts) - android-vts scans a device for set of vulnerabilities
...
* [Android security related presentations ★71 ⏳2Y](https://github.com/jacobsoo/AndroidSlides)
...
Others
----
1. [OWASP Mobile Security Testing Guide Manual ★1170](https://github.com/OWASP/owasp-mstg) 
* [Android Reverse Engineering 101 by Daniele Altomare](http://www.fasteque.com/android-reverse-engineering-101-part-1/)
* [doridori/Android-Security-Reference ★372](https://github.com/doridori/Android-Security-Reference)
...
* [Android Malware Github repo ★92](https://github.com/ashishb/android-malware)
