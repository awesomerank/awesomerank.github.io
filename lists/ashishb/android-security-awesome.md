...
1.  [Androwarn ★165 ⏳4Y](https://github.com/maaaaz/androwarn) - detect and warn the user about potential malicious behaviours developped by an Android application.
2. [ApkAnalyser ★822 ⏳4Y](https://github.com/sonyxperiadev/ApkAnalyser)
3. [APKInspector ★525 ⏳4Y](https://github.com/honeynet/apkinspector)
...
12. [SmaliSCA ★185](https://github.com/dorneanu/smalisca) - Smali Static Code Analysis
13. [CFGScanDroid ★22 ⏳2Y](https://github.com/douggard/CFGScanDroid) - Scans and compares CFG against CFG of malicious applications
...
16. [ConDroid ★21 ⏳1Y](https://github.com/JulianSchuette/ConDroid) - Performs a combination of symoblic + concrete execution of the app
...
19. [SUPER ★123](https://github.com/SUPERAndroidAnalyzer/super) - Secure, Unified, Powerful and Extensible Rust Android Analyzer
20. [ClassyShark ★4052](https://github.com/google/android-classyshark) - Standalone binary inspection tool which can browse any Android executable and show important infos.

App Vulnerability Scanners
----

1. [QARK ★1406](https://github.com/linkedin/qark) - QARK by LinkedIn is for app developers to scan app for security issues
2. [AndroBugs ★441](https://github.com/AndroBugs/AndroBugs_Framework)
3. [Nogotofail ★2175](https://github.com/google/nogotofail)
4. [Devknox](https://devknox.io/) - Autocorrect security issues as if it was spell check from your IDE
5. [JAADAS ★170](https://github.com/flankerhqd/JAADAS) - Joint intraprocedure and interprocedure program analysis tool to find vulnerabilities in Android apps, built on Soot and Scala
...
4. [Mobile-Security-Framework MobSF ★2116](https://github.com/MobSF/Mobile-Security-Framework-MobSF) - Mobile Security Framework is an intelligent, all-in-one open source mobile application (Android/iOS) automated pen-testing framework capable of performing static, dynamic analysis and web API testing.
...
8. [Droidbox ★313 ⏳2Y](https://github.com/pjlantz/droidbox)
9. ~~[Mercury](https://labs.mwrinfosecurity.com/tools/2012/03/16/mercury/)~~
10. [Drozer ★1165](https://github.com/mwrlabs/drozer)
...
12. [Inspeckage ★699](https://github.com/ac-pm/Inspeckage) - Android Package Inspector - dynamic analysis with api hooks, start unexported activities and more. (Xposed Module)
13. [Android Hooker ★285 ⏳1Y](https://github.com/AndroidHooker/hooker) - Dynamic Java code instrumentation (requires the Substrate Framework)
14. [ProbeDroid ★122](https://github.com/ZSShen/ProbeDroid) - Dynamic Java code instrumentation
15. [Android Tamer](https://androidtamer.com/) - Virtual / Live Platform for Android Security Professionals
16. [DECAF ★206](https://github.com/sycurelab/DECAF) - Dynamic Executable Code Analysis Framework based on QEMU (DroidScope is now an extension to DECAF)
17. [CuckooDroid ★304](https://github.com/idanr1986/cuckoo-droid) - Android extension for Cuckoo sandbox
...
24. [Android Linux Kernel modules ★93 ⏳3Y](https://github.com/strazzere/android-lkms)
...
28. [Vezir Project ★50 ⏳1Y](https://github.com/oguzhantopgul/Vezir-Project) - Virtual Machine for Mobile Application Pentesting and Mobile Malware Analysis
29. [MARA ★193](https://github.com/xtiankisutsa/MARA_Framework) - Mobile Application Reverse engineering and Analysis Framework
30. ~~[Taintdroid](https://appanalysis.org/download.html)~~ - requires AOSP compilation

Reverse Engineering
----

1. [Smali/Baksmali ★2150](https://github.com/JesusFreke/smali) – apk decompilation
...
4. [AndBug ★412 ⏳1Y](https://github.com/swdunlop/AndBug)
5. [Androguard ★1674](https://github.com/androguard/androguard) – powerful, integrates well with other tools
...
9. [Android OpenDebug ★59 ⏳3Y](https://github.com/iSECPartners/Android-OpenDebug) – make any application on device debuggable (using cydia substrate).
...
18. [Introspy ★314 ⏳3Y](https://github.com/iSECPartners/Introspy-Android)
19. [Jad]( https://varaneckas.com/jad/) - Java decompiler
20. [JD-GUI ★3786](https://github.com/java-decompiler/jd-gui) - Java decompiler
21. [CFR](http://www.benf.org/other/cfr/) - Java decompiler
22. [Krakatau ★761](https://github.com/Storyyeller/Krakatau) - Java decompiler
23. [Procyon](https://bitbucket.org/mstrobel/procyon/wiki/Java%20Decompiler) - Java decompiler
24. [FernFlower ★841](https://github.com/fesh0r/fernflower) - Java decompiler
...
28. [Simplify Android deobfuscator ★731](https://github.com/CalebFenton/simplify)
29. [Bytecode viewer ★1945](https://github.com/Konloch/bytecode-viewer)
30. [Radare2 ★5530](https://github.com/radare/radare2)

Fuzz Testing
----

1. [IntentFuzzer](https://www.nccgroup.trust/us/about-us/resources/intent-fuzzer/)
2. [Radamsa Fuzzer ★32](https://github.com/anestisb/radamsa-android)
3. [Honggfuzz ★846](https://github.com/google/honggfuzz)
4. [An Android port of the melkor ELF fuzzer ★44 ⏳3Y](https://github.com/anestisb/melkor-android)
5. [Media Fuzzing Framework for Android ★219 ⏳1Y](https://github.com/fuzzing/MFFA)
6. [AndroFuzz ★23 ⏳3Y](https://github.com/jonmetz/AndroFuzz)
...
1. [Google play crawler (Java) ★357](https://github.com/Akdeniz/google-play-crawler)
2. [Google play crawler (Python) ★655](https://github.com/egirault/googleplay-api)
3. [Google play crawler (Node)  ★131](https://github.com/dweinstein/node-google-play) - get app details and download apps from official Google Play Store.
4. [Aptoide downloader (Node) ★12 ⏳2Y](https://github.com/dweinstein/node-aptoide) - download apps from Aptoide third-party Android market
5. [Appland downloader (Node) ★5 ⏳2Y](https://github.com/dweinstein/node-appland) - download apps from Appland third-party Android market
...
4. [adb autocomplete ★165 ⏳1Y](https://github.com/mbrubeck/android-completion)
...
8. [GoatDroid ★159 ⏳3Y](https://github.com/jackMannino/OWASP-GoatDroid-Project) - for practice
9. [mitmproxy ★8443](https://github.com/mitmproxy/mitmproxy)
10. [dockerfile/androguard ★28](https://github.com/dweinstein/dockerfile-androguard)
11. [Android Vulnerability Test Suite ★876](https://github.com/AndroidVTS/android-vts) - android-vts scans a device for set of vulnerabilities
12. [AppMon ★416](https://github.com/dpnishant/appmon)- AppMon is an automated framework for monitoring and tampering system API calls of native macOS, iOS and android apps. It is based on Frida.
----
...
Others
----
1. [OWASP Mobile Security Testing Guide Manual ★1464](https://github.com/OWASP/owasp-mstg) 
2. [Android Reverse Engineering 101 by Daniele Altomare](http://www.fasteque.com/android-reverse-engineering-101-part-1/)
3. [doridori/Android-Security-Reference ★399](https://github.com/doridori/Android-Security-Reference)
4. [android app security checklist ★277](https://github.com/b-mueller/android_app_security_checklist)
5. [Mobile App Pentest Cheat Sheet ★899](https://github.com/tanprathan/MobileApp-Pentest-Cheatsheet)
...
2. [Android Malware Github repo ★137](https://github.com/ashishb/android-malware)
